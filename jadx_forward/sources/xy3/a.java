...
public class a extends qt5.c {
    public void q() {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", java.lang.String.format("closeFlash, camera: %s, isPreviewing: %s", this.f448189a, java.lang.Boolean.valueOf(this.f448191c)));
        ...
        try {
            ...
            if (supportedFlashModes == null || !supportedFlashModes.contains("off")) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", "camera not support close flash!!");
            } else {
                parameters.setFlashMode("off");
                this.f448189a.setParameters(parameters);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", "close flash");
            }
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.WxScanCamera", "closeFlash error: " + e17.getMessage());
        }
    }
    ...
    */
    public void r(boolean r10) {
        /*
            ...
            android.hardware.Camera r1 = r9.f448189a     // Catch: java.lang.Exception -> Lae
            if (r1 == 0) goto Lc4
        ...
        L35:
            ...
            int r10 = r10 / 5
            r9.f448204p = r10     // Catch: java.lang.Exception -> Lae
            ...
            goto L56
        L54:
            r9.f448204p = r3     // Catch: java.lang.Exception -> Lae
        L56:
            int r10 = r1.size()     // Catch: java.lang.Exception -> Lae
            ...
            r9.f448205q = r10     // Catch: java.lang.Exception -> Lae
            int r2 = r9.f448204p     // Catch: java.lang.Exception -> Lae
            if (r10 >= r2) goto L68
            r9.f448205q = r2     // Catch: java.lang.Exception -> Lae
            goto L7c
        L68:
            java.lang.Object r10 = r1.get(r10)     // Catch: java.lang.Exception -> Lae
            java.lang.Integer r10 = (java.lang.Integer) r10     // Catch: java.lang.Exception -> Lae
        ...
        L7c:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r0, r10, r2)     // Catch: java.lang.Exception -> Lae
            goto Lc4
        La7:
            return
        La8:
            java.lang.String r10 = "not support zoom"
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r0, r10)     // Catch: java.lang.Exception -> Lae
            return
        Lae:
            r10 = move-exception
    ...
    public boolean s() {
        ...
        if (this.f448202n < 0) {
            if (this.f448189a != null && this.f448191c) {
                try {
                    supportedFlashModes = this.f448189a.getParameters().getSupportedFlashModes();
                } catch (java.lang.Exception e17) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.WxScanCamera", "isFlashSupported error: " + e17.getMessage());
                }
                if (supportedFlashModes == null || !supportedFlashModes.contains("torch")) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", "camera not support flash!!");
                } else {
                    i17 = 1;
                    this.f448202n = i17;
                }
        ...
        return this.f448202n == 1;
    }

    public void t() {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", java.lang.String.format("openFlash, camera: %s, isPreviewing: %s", this.f448189a, java.lang.Boolean.valueOf(this.f448191c)));
        if (this.f448189a == null || !this.f448191c) {
            return;
        }
        try {
            ...
            if (supportedFlashModes == null || !supportedFlashModes.contains("torch")) {
                ...
                this.f448189a.setParameters(parameters);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", "open flash");
            }
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.WxScanCamera", "openFlash error: " + e17.getMessage());
        }
    }

    public void u() {
        try {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WxScanCamera", "set picture focus");
            android.hardware.Camera.Parameters parameters = this.f448189a.getParameters();
            if (parameters == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.WxScanCamera", "camera parameters is null");
                return;
            }
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.WxScanCamera", "setPictureFocus error: %s", e17.getMessage());
        }
    }
}
