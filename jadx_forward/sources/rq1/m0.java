...
public class m0 extends i95.w implements rq1.l0 {
    ...
    public static final java.util.List f480291g = new java.util.ArrayList();

    /* renamed from: h, reason: collision with root package name */
    public static final int[] f480292h = {3, 3, 3, 3, 3, 3, 3, 3, 6, 6, 6, 6, 6, 6, 6, 6};

    /* renamed from: i, reason: collision with root package name */
    public static final java.util.HashMap f480293i = new java.util.HashMap();

    /* renamed from: m, reason: collision with root package name */
    public static long f480294m = 0;

    /* renamed from: n, reason: collision with root package name */
    public static final int[] f480295n;

    /* renamed from: d, reason: collision with root package name */
    public final rq1.a f480296d = new rq1.a();

    /* renamed from: e, reason: collision with root package name */
    public android.util.Pair f480297e = new android.util.Pair("", new rq1.k0());

    /* renamed from: f, reason: collision with root package name */
    public boolean f480298f = false;
    ...
    static {
        ...
        for (int i17 = 0; i17 < 16; i17++) {
            f480291g.add(java.util.regex.Pattern.compile(strArr[i17]));
        }
        f480295n = new int[]{64};
    }

    public static java.lang.String Di() {
        return new com.p314xaae8f345.mm.vfs.r6(new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.p1006xc5476f33.p2393xf1c361fc.l2.g(2).l()).s(), "flight.txt").o();
    }
    ...
    */
    public static void bj(java.lang.String r9, boolean r10) {
        /*
            ...
            com.tencent.mm.plugin.box.HotWordSearchUtilNative r1 = com.p314xaae8f345.mm.p1006xc5476f33.box.C12961x71d22178.f35372x4fbc8495
            java.lang.Runnable r2 = r1.m54280xe9dbc901()
            java.lang.String r3 = "HotWordSearchNative"
            ku5.t0 r0 = (ku5.t0) r0
            r0.h(r2, r3)
            r1.m54293x5e424f16(r9)
            int r0 = r1.m54276x95f919cf()
            int r1 = r1.m54290x46aa4c1b(r9)
        ...
        L25:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r4, r2, r0)
            goto L50
        L35:
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)
            java.lang.Integer r1 = java.lang.Integer.valueOf(r1)
            ...
            r0.h(r1, r4)
        L50:
            rq1.v r0 = rq1.v.f480317a
            boolean r0 = r0.a()
            if (r0 != 0) goto Lfd
            int r0 = rq1.e0.c()
            r1 = -1
            java.util.zip.ZipInputStream r5 = new java.util.zip.ZipInputStream     // Catch: java.io.IOException -> Lb3
            java.io.InputStream r6 = com.p314xaae8f345.mm.vfs.w6.E(r9)     // Catch: java.io.IOException -> Lb3
        ...
        Lb3:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r8, r5, r6, r7)
        Lcb:
            if (r1 >= r0) goto Le0
            if (r10 == 0) goto Ld0
            goto Le0
        Ld0:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r4, r2, r9)
            goto Lfd
        Le0:
            java.lang.Integer r10 = java.lang.Integer.valueOf(r0)
            java.lang.Integer r0 = java.lang.Integer.valueOf(r1)
            java.lang.Object[] r10 = new java.lang.Object[]{r10, r0}
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r4, r3, r10)
            ku5.u0 r10 = ku5.t0.f394148d
    ...
    public java.lang.String Ai(java.lang.String str) {
        rq1.k0 Bi = Bi(str);
        return Bi == null ? "" : Bi.f480284a;
    }

    public rq1.k0 Bi(final java.lang.String str) {
        int i17;
        android.util.Pair pair = this.f480297e;
        if (pair != null && ((java.lang.String) pair.first).equals(str)) {
            return (rq1.k0) this.f480297e.second;
        }
        ...
        ku5.f p17 = ((ku5.t0) ku5.t0.f394148d).p("PluginBox.checkFirstHotWord");
        try {
            p17.submit(new java.lang.Runnable() { // from class: rq1.m0$$b
                ...
                */
                public final void run() {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: rq1.RunnableC30107x6165f9f.run():void");
                }
            }).get(i17, java.util.concurrent.TimeUnit.MILLISECONDS);
            p17.shutdown();
            this.f480297e = new android.util.Pair(((rq1.k0) atomicReference.get()).f480284a, (rq1.k0) atomicReference.get());
    ...
    public java.lang.String Ni(java.lang.String str) {
        ...
        ((com.p314xaae8f345.mm.p1006xc5476f33.p2393xf1c361fc.w1) ((su4.x0) i95.n0.c(su4.x0.class))).getClass();
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.WebSearch.PluginWebSearch", th6, "getExposedWord:%s", "express");
            return "";
        }
    }
    ...
    public final java.lang.String Ri(java.lang.String str) {
        ...
        java.util.HashMap hashMap = f480293i;
        if (hashMap.containsKey(str)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Box.PluginBox", " getHotWordHighPriority text = %s, hit = %s.", str, hashMap.get(str));
            return (java.lang.String) hashMap.get(str);
        }
        if (hashMap.size() > 32 || f480294m > 500) {
            hashMap.clear();
            f480294m = 0L;
        }
        ...
        while (true) {
            ...
            int i18 = f480292h[i17];
            java.util.regex.Matcher matcher = pattern.matcher(str);
            if (matcher.find() && i18 <= matcher.groupCount()) {
                java.lang.String group = matcher.group(i18);
                if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(group) && !arrayList.contains(group)) {
                    int i19 = 0;
                    while (true) {
                        ...
                        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str2) && str2.contains(group)) {
                            z17 = true;
                            break;
                        }
                        i19++;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Box.PluginBox", "getHotWordHighPriority time = " + (java.lang.System.currentTimeMillis() - currentTimeMillis));
        if (arrayList.size() < 1 || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0((java.lang.String) arrayList.get(0))) {
            return null;
        }
        f480294m += ((java.lang.String) arrayList.get(0)).length();
    ...
    public java.lang.String Ui(java.lang.String str, java.lang.String str2) {
        if ("$Express$".equals(str)) {
            java.util.regex.Matcher matcher = sq1.b.f492872a.matcher(str2);
            if (matcher.find()) {
        ...
        return !com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(Ri) ? Ri : str;
    }

    public int Vi() {
        return rq1.v.f480317a.a() ? com.p314xaae8f345.mm.p1006xc5476f33.box.C12961x71d22178.f35372x4fbc8495.m54287xf864bc52() : java.lang.Math.max(rq1.e0.f480275n, 1);
    }

    public java.lang.String Zi() {
        java.util.concurrent.atomic.AtomicBoolean atomicBoolean = rq1.e0.f480262a;
        return rq1.e0.c() + "_" + rq1.e0.f480268g;
    }
    ...
    public void aj() {
        ...
        ((ku5.t0) ku5.t0.f394148d).h(new rq1.p0(this), "Box.LoadFlightNumberAsync");
    }
    ...
    public void mo204xfac946a6(android.content.Context context) {
        aj();
        ((ku5.t0) ku5.t0.f394148d).h(com.p314xaae8f345.mm.p1006xc5476f33.box.C12961x71d22178.f35372x4fbc8495.m54280xe9dbc901(), com.p314xaae8f345.mm.p1006xc5476f33.box.C12961x71d22178.TAG);
        com.p314xaae8f345.mm.sdk.p2603x2137b148.o4 R = com.p314xaae8f345.mm.sdk.p2603x2137b148.o4.R("MicroMsg.Box.PluginBox");
        long q17 = R.q("last_check_res_time", 0L);
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        long abs = java.lang.Math.abs(currentTimeMillis - q17);
        if (abs < 86400000) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Box.PluginBox", "manualCheckRes return lastCheckTime %d, current %d, gap %d", java.lang.Long.valueOf(q17), java.lang.Long.valueOf(currentTimeMillis), java.lang.Long.valueOf(abs));
            return;
        }
        R.B("last_check_res_time", currentTimeMillis);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Box.PluginBox", "manualCheckRes");
        com.p314xaae8f345.mm.sdk.p2603x2137b148.u3.i(new rq1.r0(this), 3000L);
    }
    ...
    */
    public rq1.k0 wi(java.lang.String r12) {
        /*
            ...
            r2.<init>()
            java.util.regex.Pattern r3 = sq1.b.f492872a
        ...
        L42:
            ...
            boolean r9 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(r8)
            if (r9 != 0) goto L58
            r1.add(r8)
            if (r7 != 0) goto L53
            r4 = 3
        ...
        L53:
            ...
            r2.add(r8)
        L58:
            rq1.v r8 = rq1.v.f480317a
            boolean r8 = r8.a()
            java.lang.String r9 = "1"
            if (r8 == 0) goto L9b
            com.tencent.mm.plugin.box.HotWordSearchUtilNative r8 = com.p314xaae8f345.mm.p1006xc5476f33.box.C12961x71d22178.f35372x4fbc8495
            java.util.List r12 = r8.m54272xd27131e7(r12)
        ...
        L74:
            ...
            java.lang.String r10 = r10.f456609d
            r1.add(r10)
            r2.add(r9)
            goto L74
        L89:
            ...
            java.lang.String r12 = r12.f456609d
            r3 = r12
            goto Ld2
        L9b:
        ...
        Lc0:
            ...
            java.lang.Object r12 = r12.get(r6)
            r45.gb7 r12 = (r45.gb7) r12
            java.lang.String r3 = r12.f456609d
            goto Ld2
        Ld1:
            r5 = r4
        Ld2:
            java.lang.String r12 = "|"
            java.lang.String r1 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.c1(r1, r12)
            r0.f480286c = r1
            java.lang.String r12 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.c1(r2, r12)
            r0.f480287d = r12
            r0.f480284a = r3
            r0.f480285b = r5
            return r0
