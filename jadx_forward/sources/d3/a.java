...
public class a {
    ...
    public final float f307608c;

    /* renamed from: d, reason: collision with root package name */
    public final float f307609d;

    /* renamed from: e, reason: collision with root package name */
    public final float f307610e;

    /* renamed from: f, reason: collision with root package name */
    public final float f307611f;
    ...
    public static d3.a a(int i17) {
        ...
        float f67 = f59 * sVar.f307646b;
        float f68 = sVar.f307645a;
        double d18 = f67 / f68;
        float f69 = sVar.f307654j;
        float f76 = sVar.f307648d;
        float pow4 = ((float) java.lang.Math.pow(d18, f69 * f76)) * 100.0f;
        float sqrt = (4.0f / f76) * ((float) java.lang.Math.sqrt(pow4 / 100.0f)) * (f68 + 4.0f);
        float f77 = sVar.f307653i;
        float f78 = sqrt * f77;
        float sqrt2 = ((float) java.lang.Math.sqrt(pow4 / 100.0d)) * ((float) java.lang.Math.pow(1.64d - java.lang.Math.pow(0.29d, sVar.f307650f), 0.73d)) * ((float) java.lang.Math.pow((((((((float) (java.lang.Math.cos((((((double) atan2) < 20.14d ? 360.0f + atan2 : atan2) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * sVar.f307649e) * sVar.f307647c) * ((float) java.lang.Math.sqrt((f48 * f48) + (f49 * f49)))) / (f58 + 0.305f), 0.9d));
        float f79 = f77 * sqrt2;
    ...
    public static d3.a b(float f17, float f18, float f19) {
        d3.s sVar = d3.s.f307644k;
        float sqrt = (4.0f / sVar.f307648d) * ((float) java.lang.Math.sqrt(f17 / 100.0d));
        float f27 = sVar.f307645a + 4.0f;
        float f28 = sVar.f307653i;
        float f29 = sqrt * f27 * f28;
        float f37 = f28 * f18;
        float sqrt2 = ((float) java.lang.Math.sqrt(((f18 / ((float) java.lang.Math.sqrt(r4))) * sVar.f307648d) / f27)) * 50.0f;
    ...
    public int c(d3.s sVar) {
        double d17 = this.f307607b;
        float f17 = this.f307608c;
        float pow = (float) java.lang.Math.pow(((d17 == 0.0d || ((double) f17) == 0.0d) ? 0.0f : r2 / ((float) java.lang.Math.sqrt(f17 / 100.0d))) / java.lang.Math.pow(1.64d - java.lang.Math.pow(0.29d, sVar.f307650f), 0.73d), 1.1111111111111112d);
        double d18 = (this.f307606a * 3.1415927f) / 180.0f;
        float cos = ((float) (java.lang.Math.cos(2.0d + d18) + 3.8d)) * 0.25f;
        float pow2 = sVar.f307645a * ((float) java.lang.Math.pow(f17 / 100.0d, (1.0d / sVar.f307648d) / sVar.f307654j));
        float f18 = cos * 3846.1538f * sVar.f307649e * sVar.f307647c;
        float f19 = pow2 / sVar.f307646b;
