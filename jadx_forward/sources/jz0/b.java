...
public final class b extends android.view.GestureDetector.SimpleOnGestureListener {
    ...
    public final /* synthetic */ jz0.k f384097d;
    ...
    public void onLongPress(android.view.MotionEvent e17) {
        ...
        java.lang.Object[] array = arrayList.toArray();
        arrayList.clear();
        yj0.a.b("com/tencent/mm/mj_template/sns/backgroundwork/ui/MaasFakeVideoAniUIC$onCreate$1", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.f69928x24728b, "(Landroid/view/MotionEvent;)V", this, array);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(e17, "e");
        this.f384097d.f384132w = true;
        super.onLongPress(e17);
        yj0.a.h(this, "com/tencent/mm/mj_template/sns/backgroundwork/ui/MaasFakeVideoAniUIC$onCreate$1", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.f69928x24728b, "(Landroid/view/MotionEvent;)V");
    }
    ...
    public boolean onScroll(android.view.MotionEvent motionEvent, android.view.MotionEvent e27, float f17, float f18) {
        ...
        jz0.k kVar = this.f384097d;
        if (abs > kVar.h().getWidth() || java.lang.Math.abs(rawY) > kVar.h().getHeight() || !kVar.f384131v) {
            return true;
        }
