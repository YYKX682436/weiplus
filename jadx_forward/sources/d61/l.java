...
public final class l {
    ...
    public static final d61.l f308284a = new d61.l();

    public final void a(boolean z17, long j17, int i17) {
        jz5.o oVar;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Mp4ParserStat", "markParseCost, useLazy:" + z17 + ", cost:" + j17 + ", timetTableLength:" + i17);
        if (j17 < 0 || i17 < 0) {
            return;
        }
        if (z17) {
