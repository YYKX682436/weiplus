...
public final class l0 implements android.view.View.OnClickListener {
    ...
    public static final f41.l0 f341027d = new f41.l0();
    ...
    public final void onClick(android.view.View view) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.OVC.SendMsgCard", "contentContainer clicked, event consumed (should not trigger close)");
