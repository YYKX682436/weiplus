...
public final class p implements r5.j {
    ...
    public final c6.c f474090b;

    /* renamed from: c, reason: collision with root package name */
    public final s5.a f474091c;

    /* renamed from: d, reason: collision with root package name */
    public final a6.s f474092d;

    /* renamed from: e, reason: collision with root package name */
    public final r5.f f474093e;

    /* renamed from: f, reason: collision with root package name */
    public final h6.j f474094f;

    /* renamed from: g, reason: collision with root package name */
    public final p3325xe03a0797.p3326xc267989b.y0 f474095g;

    /* renamed from: h, reason: collision with root package name */
    public final a6.a f474096h;

    /* renamed from: i, reason: collision with root package name */
    public final a6.n f474097i;

    /* renamed from: j, reason: collision with root package name */
    public final a6.z f474098j;

    /* renamed from: k, reason: collision with root package name */
    public final java.util.List f474099k;

    /* renamed from: l, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicBoolean f474100l;
    ...
    public p(android.content.Context context, c6.c defaults, s5.a bitmapPool, a6.s memoryCache, l36.m callFactory, r5.f eventListenerFactory, r5.c componentRegistry, h6.j options, h6.k kVar) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(defaults, "defaults");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(bitmapPool, "bitmapPool");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(memoryCache, "memoryCache");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(callFactory, "callFactory");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(eventListenerFactory, "eventListenerFactory");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(componentRegistry, "componentRegistry");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(options, "options");
        this.f474090b = defaults;
        this.f474091c = bitmapPool;
        this.f474092d = memoryCache;
        this.f474093e = eventListenerFactory;
        this.f474094f = options;
        oz5.i a17 = p3325xe03a0797.p3326xc267989b.t3.a(null, 1, null);
        p3325xe03a0797.p3326xc267989b.p0 p0Var = p3325xe03a0797.p3326xc267989b.q1.f392101a;
        this.f474095g = p3325xe03a0797.p3326xc267989b.z0.a(((p3325xe03a0797.p3326xc267989b.c3) a17).mo7096x348d9a(((t26.a) p3325xe03a0797.p3326xc267989b.p3329x21ffc6bd.b0.f392017a).f496880h).mo7096x348d9a(new r5.o(p3325xe03a0797.p3326xc267989b.q0.f392100d, this)));
        s5.c cVar = memoryCache.f83225c;
        this.f474096h = new a6.a(this, cVar, null);
        a6.n nVar = new a6.n(cVar, memoryCache.f83223a, memoryCache.f83224b);
        this.f474097i = nVar;
        a6.z zVar = new a6.z(null);
        this.f474098j = zVar;
        v5.h hVar = new v5.h(bitmapPool);
        h6.l lVar = new h6.l(this, context, options.f360660c);
        ...
        bVar.a(new x5.h(options.f360658a), java.io.File.class);
        ...
        java.util.List list = bVar.f474049d;
        ((java.util.ArrayList) list).add(cVar2);
        java.util.List S0 = kz5.n0.S0(bVar.f474046a);
        this.f474099k = kz5.n0.u0(S0, new y5.c(new r5.c(S0, kz5.n0.S0(bVar.f474047b), kz5.n0.S0(bVar.f474048c), kz5.n0.S0(list)), bitmapPool, memoryCache.f83225c, memoryCache.f83223a, nVar, zVar, lVar, hVar, null));
        this.f474100l = new java.util.concurrent.atomic.AtomicBoolean(false);
    }
    ...
    */
    public static final java.lang.Object a(r5.p r25, c6.j r26, int r27, p3321xbce91901.p3322xc267989b.InterfaceC29045xdcb5ca57 r28) {
        /*
    ...
    public c6.e b(c6.j request) {
        ...
        p3325xe03a0797.p3326xc267989b.r2 d17 = p3325xe03a0797.p3326xc267989b.l.d(this.f474095g, null, null, new r5.k(this, request, null), 3, null);
        e6.b bVar = request.f120364c;
        return bVar instanceof e6.c ? new c6.r(h6.d.b(((p135x2eae8f.p139xcb7e7191.C1422x9d6d031) ((e6.c) bVar)).f125447d).a(d17), (e6.c) bVar) : new c6.a(d17);
    }
}
