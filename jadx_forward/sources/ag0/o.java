...
public class o extends i95.w implements bg0.w {
    public java.lang.String Ai() {
        return com.p314xaae8f345.mm.p1006xc5476f33.p2324x37470e.p2325x633fb29.e0.f257119b;
    }
    ...
    public void wi(rm5.v vVar, int i17, int i18, java.lang.Integer num) {
        ...
        ?? r17 = i18;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("HDRUtilService", "try enable hdr lut, colorStandard = " + i17 + ", colorTransfer = " + r17);
        if (r17 == 6) {
            com.p314xaae8f345.tav.p2965xf0edce24.C25822x78481d21.m97985x56b6a2a5(new com.p314xaae8f345.mm.p1006xc5476f33.p2324x37470e.p2325x633fb29.f1());
        } else {
        ...
        if (context != null) {
            ...
            try {
                try {
                    try {
                        ...
                        e = e17;
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("HDRUtilService", "open lut fail", e);
                        com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.v1(r17);
                        vVar2 = vVar;
                        bitmap = bitmap3;
                        vVar2.f479119n = bitmap;
                    }
            ...
            if (i17 == 6 && r17 == 6) {
                ...
                if (!z17 || num == null || (num.intValue() != 11 && num.intValue() != 12)) {
                    bitmap2 = null;
                    com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.v1(r57);
                    vVar2 = vVar;
                    bitmap = bitmap2;
                    vVar2.f479119n = bitmap;
                }
