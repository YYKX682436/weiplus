...
public final class l2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ bp4.p2 f104779d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ ju3.d0 f104780e;
    ...
    public final void onClick(android.view.View view) {
        ...
        bp4.p2 p2Var = this.f104779d;
        if (p2Var.f104873i) {
            p2Var.A();
            c0Var = ju3.c0.f383428p1;
        } else {
            p2Var.B();
            c0Var = ju3.c0.f383446x1;
        }
        p2Var.f104874m = p2Var.f104873i;
        android.os.Bundle bundle = new android.os.Bundle();
        bundle.putBoolean("PARAM_1_BOOLEAN", true);
        this.f104780e.w(c0Var, bundle);
