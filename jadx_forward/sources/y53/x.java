...
public final class x extends i95.w implements u53.y {
    ...
    public final java.util.concurrent.ConcurrentHashMap f541044d = new java.util.concurrent.ConcurrentHashMap();
    ...
    public void Bi(java.util.List list, u53.x callback) {
        ...
        while (true) {
            ...
            concurrentHashMap = this.f541044d;
            if (!hasNext) {
                break;
            }
        ...
        android.database.Cursor f17 = Ri.f541002d.f(sb9, null, 2);
        try {
            if (f17.moveToFirst()) {
                while (!f17.isAfterLast()) {
                    y53.m mVar2 = new y53.m();
                    mVar2.mo9015xbf5d97fd(f17);
            ...
            sVar.mo149xb9724478(hashMap2, arrayList);
        } finally {
        }
    }
    ...
    public y53.m Di(java.lang.String str) {
        ...
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = this.f541044d;
        y53.m mVar = (y53.m) concurrentHashMap.get(str);
        if (mVar != null) {
            return mVar;
        }
    ...
    public void Ni(java.lang.String username, u53.v callback) {
        ...
        if (username.length() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("GameLife.ContactService", "isBlackListAssociateWithWAGame username null!");
            callback.a(false, false);
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GameLife.ContactService", "isBlackListAssociateWithWAGame username:%s", username);
        new w53.a(username).l().H(new y53.v(username, callback));
    }

    public void Ri(java.lang.String str, boolean z17, boolean z18, u53.w wVar) {
        if (!(str == null || str.length() == 0)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GameLife.ContactService", "setBlackListAssociateWithWAGame username:%s,setBlack:%b,isAssociate:%b", str, java.lang.Boolean.valueOf(z17), java.lang.Boolean.valueOf(z18));
            new w53.e(str, z17, z18).l().H(new y53.w(wVar));
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("GameLife.ContactService", "setBlackListAssociateWithWAGame username null!");
            if (wVar != null) {
                wVar.a(false);
            }
        }
    ...
    public void wi(java.lang.String str) {
        if (str == null || str.length() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("GameLife.ContactService", "checkContactExpired userName empty");
            return;
        }
        y53.m Di = Di(str);
        if (Di == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("GameLife.ContactService", "checkContactExpired contact null username:%s", str);
            return;
        }
        long c17 = c01.id.c() - Di.f67432xa783a79b;
        if (c17 >= 86400000) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GameLife.ContactService", "[checkContactExpired] diff:" + c17 + " limit:86400000 username:" + str);
            java.util.List c18 = kz5.b0.c(str);
            new w53.d(new java.util.LinkedList(c18)).l().H(new y53.u(c18, y53.q.f541029a, new java.util.HashMap(), this));
        }
    }
}
