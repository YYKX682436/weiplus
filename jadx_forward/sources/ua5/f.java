...
public final class f {
    ...
    public final android.os.Handler f507519a = new android.os.Handler(android.os.Looper.getMainLooper());

    /* renamed from: b, reason: collision with root package name */
    public final java.util.List f507520b = new java.util.ArrayList();

    /* renamed from: c, reason: collision with root package name */
    public final java.util.List f507521c = new java.util.ArrayList();

    /* renamed from: d, reason: collision with root package name */
    public final java.util.List f507522d = new java.util.ArrayList();
    ...
    public final u3.u a(android.view.View view) {
        ...
        vVar.a(1.0f);
        vVar.b(400.0f);
        u3.u uVar = new u3.u(view, u3.s.f505757s);
        uVar.f505769t = vVar;
        uVar.f505758a = 0.0f;
        boolean z17 = uVar.f505763f;
        if (!z17) {
            if (z17) {
                throw new java.lang.UnsupportedOperationException("Error: Update listeners must be added beforethe animation.");
            }
            java.util.ArrayList arrayList2 = uVar.f505768k;
        ...
        uVar.e();
        h0Var.f391656d = uVar;
        ((java.util.ArrayList) this.f507521c).add(uVar);
        return (u3.u) h0Var.f391656d;
    }

    public final boolean b() {
        return (this.f507520b.isEmpty() ^ true) || (this.f507521c.isEmpty() ^ true) || (this.f507522d.isEmpty() ^ true);
    }
}
