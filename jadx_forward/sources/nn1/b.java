...
public class b implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ int f420175d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ nn1.a f420176e;
    ...
    public void onClick(android.view.View view) {
        ...
        nn1.a aVar = this.f420176e;
        java.util.HashSet hashSet = aVar.f420170e;
        int i17 = this.f420175d;
        if (hashSet.contains(java.lang.Integer.valueOf(i17))) {
            aVar.f420170e.remove(java.lang.Integer.valueOf(i17));
        } else {
            aVar.f420170e.add(java.lang.Integer.valueOf(i17));
        }
        aVar.notifyDataSetChanged();
        aVar.f420169d.d7(aVar.f420170e);
