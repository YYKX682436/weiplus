...
public final class e {
    ...
    public static volatile boolean f529997b;

    /* renamed from: e, reason: collision with root package name */
    public static com.p314xaae8f345.mm.p2809x52b77bcb.AbstractC22913x8bd6f566 f530000e;

    /* renamed from: f, reason: collision with root package name */
    public static com.p314xaae8f345.mm.p2809x52b77bcb.AbstractC22918x7a015163 f530001f;

    /* renamed from: a, reason: collision with root package name */
    public static final wp5.e f529996a = new wp5.e();

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.Object f529998c = new java.lang.Object();

    /* renamed from: d, reason: collision with root package name */
    public static final xp5.a f529999d = new xp5.a();
    ...
    */
    public static final void a(android.content.Context r3, wp5.a r4) {
        /*
            ...
            boolean r0 = wp5.e.f529997b
            if (r0 == 0) goto Lf
            return
        Lf:
            java.lang.Object r0 = wp5.e.f529998c
            monitor-enter(r0)
            boolean r1 = wp5.e.f529997b     // Catch: java.lang.Throwable -> L61
            if (r1 == 0) goto L18
            monitor-exit(r0)
            return
        L18:
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(r3, r1)     // Catch: java.lang.Throwable -> L61
            android.content.Context r1 = p000.j.f377705a     // Catch: java.lang.Throwable -> L61
            r2 = 1
            if (r1 == 0) goto L33
            if (r1 == r3) goto L33
        ...
        L34:
            ...
            p000.j.f377705a = r1     // Catch: java.lang.Throwable -> L61
            ...
            wp5.e.f530001f = r3     // Catch: java.lang.Throwable -> L61
            r3.m83310x316510()     // Catch: java.lang.Throwable -> L61
            wp5.e r3 = wp5.e.f529996a     // Catch: java.lang.Throwable -> L61
            r3.b()     // Catch: java.lang.Throwable -> L61
            wp5.e.f529997b = r2     // Catch: java.lang.Throwable -> L61
            monitor-exit(r0)
            return
        L55:
    ...
    public final void b() {
        ...
        synchronized (aVar.f537496d) {
            if (!aVar.f537494b.contains(dVar)) {
                aVar.f537494b.add(dVar);
            }
        }
    }
}
