...
public abstract class v {
    public static final x36.l a(x36.f0 buffer) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(buffer, "$this$buffer");
    ...
    public static final boolean c(java.lang.AssertionError isAndroidGetsocknameError) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(isAndroidGetsocknameError, "$this$isAndroidGetsocknameError");
    ...
    public static final x36.h0 e(java.io.File source) {
        java.util.logging.Logger logger = x36.w.f533247a;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(source, "$this$source");
