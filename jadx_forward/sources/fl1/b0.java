...
public class b0 extends android.animation.AnimatorListenerAdapter {
    ...
    public final /* synthetic */ android.view.View f345231d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ fl1.b2 f345232e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ fl1.c0 f345233f;
    ...
    public void onAnimationEnd(android.animation.Animator animator) {
        boolean z17;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandDialogContainerLayout", "on dialogView exit animation end");
        fl1.c0 c0Var = this.f345233f;
        java.util.LinkedList linkedList = c0Var.f345249h;
        int size = linkedList.size();
        if (1 == size) {
            c0Var.f345261w = false;
            z17 = true;
        } else {
            z17 = false;
        }
        ...
        if (h2Var != null) {
            ...
            java.util.HashMap hashMap = uVar.f345405b;
            java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
            for (java.util.Map.Entry entry : hashMap.entrySet()) {
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(dialogContainer, entry.getKey()) ? false : ((fl1.t) entry.getValue()).f345402c) {
                    linkedHashMap.put(entry.getKey(), entry.getValue());
                }
            }
            java.util.Set keySet = linkedHashMap.keySet();
            boolean isEmpty = keySet.isEmpty();
            java.lang.String str = uVar.f345404a;
            if (isEmpty) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str, "onDialogDismissed, othersShownContainer is empty");
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (a17.contains(dialogContainer)) {
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str, "onDialogDismissed, otherShownContainer cover me");
                            break;
                        }
                        arrayList.add(a17);
                    } else {
        ...
        android.view.View view = this.f345231d;
        ...
        c0Var.f345249h.remove(this.f345232e);
        c0Var.f345252n = null;
