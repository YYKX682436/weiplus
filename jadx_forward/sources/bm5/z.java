...
public abstract class z {
    public static final java.lang.String a(bm5.y yVar, boolean z17, boolean z18) {
        ...
        bm5.v vVar = yVar.f104296f;
        java.lang.String str = yVar.f104291a;
        if (str == null) {
            str = "";
        }
    ...
    public static final java.lang.String c(bm5.y yVar, java.lang.String str, boolean z17) {
        ...
        bm5.c0 c0Var = bm5.c0.f104083a;
        bm5.v vVar = yVar.f104296f;
        bm5.f0 f0Var = yVar.f104297g;
        java.lang.String str2 = yVar.f104291a;
        java.lang.String k17 = c0Var.k(vVar, f0Var, str2 == null ? "" : str2, false, yVar.f104293c, str, true, z17);
        if (com.p314xaae8f345.mm.vfs.w6.j(k17)) {
            return k17;
        }
        long j17 = yVar.f104293c;
        if (j17 != 0) {
            return bm5.c0.m(c0Var, yVar.f104296f, yVar.f104297g, str2 == null ? "" : str2, false, j17, str, false, z17, 64, null);
        }
        return bm5.c0.m(c0Var, yVar.f104296f, yVar.f104297g, yVar.f104291a, true, yVar.f104292b, str, false, z17, 64, null);
    }
    ...
    public static final java.lang.String f(bm5.y yVar) {
        ...
        return c0Var.o(vVar, str, yVar.f104292b, true, false);
    }
    ...
    public static java.lang.String g(bm5.y yVar, bm5.f0 f0Var, java.lang.String str, java.lang.Boolean bool, java.lang.String str2, boolean z17, int i17, java.lang.Object obj) {
        ...
        java.lang.String str5 = yVar.f104291a;
        long j17 = yVar.f104292b;
        long j18 = yVar.f104293c;
        long j19 = yVar.f104294d;
        java.lang.String str6 = str3 == null ? yVar.f104295e : str3;
        bm5.v vVar = yVar.f104296f;
        if (f0Var2 == null) {
            f0Var2 = yVar.f104297g;
        }
        ...
        bm5.v vVar2 = bm5.v.f104276f;
        bm5.v vVar3 = yVar.f104296f;
        return vVar2 == vVar3 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).Vi(c17, null, null, z18, z18) : bm5.v.f104277g == vVar3 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).qj(c17, z18) : bm5.v.f104278h == vVar3 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).Ui(c17, str4, z18) : bm5.v.f104279i != vVar3 ? bm5.v.f104280m == vVar3 ? i(c17, str4, null, false, 6, null) : bm5.v.f104281n == vVar3 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).Ri(c17) : bm5.v.f104282o == vVar3 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).wj(c17, str3, true, z18) : i18 : i18;
    }
    ...
    public static java.lang.String h(bm5.y yVar, java.lang.Boolean bool, boolean z17, int i17, java.lang.Object obj) {
        ...
        bm5.v vVar2 = yVar.f104296f;
        if (vVar == vVar2 || bm5.v.f104279i == vVar2) {
            return ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).Vi(yVar, null, null, z18, z18);
        }
        if (bm5.v.f104277g == vVar2) {
            return ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).qj(yVar, z18);
        }
        if (bm5.v.f104278h != vVar2) {
            return bm5.v.f104280m == vVar2 ? i(yVar, null, null, false, 7, null) : bm5.v.f104281n == vVar2 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).Ri(yVar) : bm5.v.f104282o == vVar2 ? ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).wj(yVar, yVar.f104295e, true, z18) : i18;
        }
    ...
    public static java.lang.String i(bm5.y yVar, java.lang.String str, java.lang.Boolean bool, boolean z17, int i17, java.lang.Object obj) {
        ...
        if (j17 != 0) {
            str2 = str5;
            str3 = bm5.c0.m(bm5.c0.f104083a, yVar.f104296f, yVar.f104297g, str5 == null ? "" : str5, false, j17, str4, z18, false, 128, null);
        } else {
            str2 = str5;
            str3 = "";
        }
        ...
        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(bool2, java.lang.Boolean.TRUE)) {
            long j18 = yVar.f104293c;
            if (j18 != 0) {
                java.lang.String k17 = bm5.c0.f104083a.k(yVar.f104296f, yVar.f104297g, str2 == null ? "" : str2, false, j18, str4, true, z18);
                if (com.p314xaae8f345.mm.vfs.w6.j(k17)) {
                    return k17;
                }
            }
        }
        return bm5.c0.m(bm5.c0.f104083a, yVar.f104296f, yVar.f104297g, yVar.f104291a, true, yVar.f104292b, str4, false, z18, 64, null);
    }

    public static final java.lang.String j(bm5.y yVar) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(yVar, "<this>");
        return "c2c://" + yVar.f104296f.f104286d + '&' + yVar.f104297g.f104111d + '&' + yVar.f104291a + '&' + yVar.f104292b + '&' + yVar.f104293c + '&' + yVar.f104294d + '&' + yVar.f104295e;
    }
}
