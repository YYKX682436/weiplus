...
public final class a implements w16.g {
    ...
    public final java.util.List f523783b;
    ...
    public void a(a16.l context_receiver_0, o06.g thisDescriptor, java.util.List result) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context_receiver_0, "$context_receiver_0");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(thisDescriptor, "thisDescriptor");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(result, "result");
        java.util.Iterator it = this.f523783b.iterator();
        while (it.hasNext()) {
    ...
    public r06.f1 h(a16.l context_receiver_0, o06.g thisDescriptor, r06.f1 propertyDescriptor) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context_receiver_0, "$context_receiver_0");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(thisDescriptor, "thisDescriptor");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(propertyDescriptor, "propertyDescriptor");
        java.util.Iterator it = this.f523783b.iterator();
        while (it.hasNext()) {
