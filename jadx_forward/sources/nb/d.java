...
public class d implements nb.f {
    ...
    public final android.os.IBinder f417560d;

    public d(android.os.IBinder iBinder) {
        this.f417560d = iBinder;
    }

    @Override // android.os.IInterface
    public android.os.IBinder asBinder() {
        return this.f417560d;
    }
    ...
    public android.os.Bundle e() {
        ...
        try {
            ...
            this.f417560d.transact(5, obtain, obtain2, 0);
    ...
    public int g(nb.c cVar) {
        ...
        try {
            ...
            this.f417560d.transact(3, obtain, obtain2, 0);
            obtain2.readException();
