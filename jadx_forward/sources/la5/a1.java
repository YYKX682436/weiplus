...
public class a1 extends android.view.View.AccessibilityDelegate {

    /* renamed from: b, reason: collision with root package name */
    public static final /* synthetic */ int f399131b = 0;

    /* renamed from: a, reason: collision with root package name */
    public final boolean f399132a;

    public a1() {
        this.f399132a = false;
        this.f399132a = la5.b.f399133a.h();
    }
    ...
    public void sendAccessibilityEvent(android.view.View view, int i17) {
        ...
        if (cVar.g(true)) {
            boolean z17 = this.f399132a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSecureAccessibilityDelegate", "sendAccessibilityEvent shouldSpeakPassWord: %s, eventType: %s", java.lang.Boolean.valueOf(z17), java.lang.Integer.valueOf(i17));
            if (!z17) {
                if (view != null) {
                    if (i17 == 128 || i17 == 1) {
                        cVar.e(view);
