...
public final class j extends p012xc85e97e9.p114xa324943e.p115xd1075a44.a {

    /* renamed from: d, reason: collision with root package name */
    public final java.util.List f440171d;
    ...
    public int mo8338x7444f759() {
        return this.f440171d.size();
    }

    @Override // p012xc85e97e9.p114xa324943e.p115xd1075a44.a
    /* renamed from: getPageTitle */
    public java.lang.CharSequence mo8340x337c8253(int i17) {
        sw0.c cVar = (sw0.c) kz5.n0.a0(this.f440171d, i17);
        if (cVar != null) {
            return cVar.f494952a;
        }
        return null;
    }
    ...
    public java.lang.Object mo7744x8d1aed1d(android.view.ViewGroup container, int i17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(container, "container");
        android.view.View view = ((sw0.c) this.f440171d.get(i17)).f494954c;
