...
public final class m {
    ...
    public static final qi3.m f445280a = new qi3.m();

    public static final boolean b(int i17) {
        return (i17 == 2 || i17 == 4 || i17 == 6 || i17 == 19 || i17 == 3 || i17 == 43 || i17 == 1090519089) ? false : true;
    }

    public static final boolean c(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var) {
        if (f9Var == null) {
            return false;
        }
        if (!f9Var.k2()) {
            return b(f9Var.mo78013xfb85f7b0());
        }
        ...
        v05.b k17 = cVar.k();
        java.lang.Integer valueOf = k17 != null ? java.lang.Integer.valueOf(k17.m75939xb282bd08(k17.f449898d + 6)) : null;
