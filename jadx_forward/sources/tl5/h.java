...
public final class h {
    ...
    public static final tl5.h f501882a = new tl5.h();
    ...
    public final java.util.List c(java.util.List snapshots) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(snapshots, "snapshots");
        if (snapshots.isEmpty()) {
            return kz5.p0.f395529d;
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        for (java.lang.Object obj : snapshots) {
            if (true ^ ((tl5.j) obj).f501899e) {
                arrayList.add(obj);
            }
        }
        java.util.List<tl5.j> F0 = kz5.n0.F0(arrayList, mz5.a.a(tl5.f.f501880d, tl5.g.f501881d));
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        java.util.ArrayList arrayList3 = null;
        int i17 = -1;
        for (tl5.j jVar : F0) {
            if (arrayList3 != null) {
                if (((tl5.e) arrayList3.get(0)).f501877a.f501895a.top == jVar.f501895a.top) {
