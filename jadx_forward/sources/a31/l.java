...
public final class l implements java.lang.Runnable {
    ...
    public final /* synthetic */ a31.m f82498d;
    ...
    public void run() {
        ...
        java.lang.CharSequence charSequence = bVar.f82477a;
        int length = charSequence.length();
        int f17 = e06.p.f(mVar.f82521v, 0, length);
        int i17 = length - f17;
        if (i17 <= 0) {
            if (mVar.M == bVar) {
                mVar.M = null;
        ...
        int i18 = bVar.f82478b;
        if (i18 == -1) {
            int i19 = bVar.f82479c;
            if (f17 == 0) {
