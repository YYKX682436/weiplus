...
public final class c0 implements n8.f {
    ...
    public int f417008b = -1;

    /* renamed from: c, reason: collision with root package name */
    public int f417009c = -1;

    /* renamed from: d, reason: collision with root package name */
    public int f417010d = 0;

    /* renamed from: e, reason: collision with root package name */
    public java.nio.ByteBuffer f417011e;

    /* renamed from: f, reason: collision with root package name */
    public java.nio.ByteBuffer f417012f;

    /* renamed from: g, reason: collision with root package name */
    public boolean f417013g;

    public c0() {
        java.nio.ByteBuffer byteBuffer = n8.f.f417052a;
        this.f417011e = byteBuffer;
        this.f417012f = byteBuffer;
    }

    @Override // n8.f
    public boolean a() {
        int i17 = this.f417010d;
    ...
    */
    public void b(java.nio.ByteBuffer r8) {
        ...
        L21:
            int r2 = r2 * 2
        L23:
            java.nio.ByteBuffer r3 = r7.f417011e
            int r3 = r3.capacity()
            if (r3 >= r2) goto L3a
            ...
            goto L3f
        L3a:
            java.nio.ByteBuffer r2 = r7.f417011e
            r2.clear()
        L3f:
            int r2 = r7.f417010d
            if (r2 == r5) goto L81
        ...
        L9c:
            int r0 = r8.limit()
            r8.position(r0)
            java.nio.ByteBuffer r8 = r7.f417011e
            r8.flip()
            java.nio.ByteBuffer r8 = r7.f417011e
            r7.f417012f = r8
            return
    ...
    public java.nio.ByteBuffer f() {
        java.nio.ByteBuffer byteBuffer = this.f417012f;
        this.f417012f = n8.f.f417052a;
        return byteBuffer;
    }
    ...
    public boolean g(int i17, int i18, int i19) {
        ...
        if (this.f417008b == i17 && this.f417009c == i18 && this.f417010d == i19) {
            return false;
        }
        this.f417008b = i17;
        this.f417009c = i18;
        ...
        this.f417011e = n8.f.f417052a;
        return true;
    }

    @Override // n8.f
    public boolean h() {
        return this.f417013g && this.f417012f == n8.f.f417052a;
    }
