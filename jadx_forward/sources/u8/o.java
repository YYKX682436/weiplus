...
public final class o implements q8.e, q8.m {
    ...
    public static final int f506867p = t9.d0.f("qt  ");
    ...
    public long f506874g;

    /* renamed from: h, reason: collision with root package name */
    public int f506875h;

    /* renamed from: i, reason: collision with root package name */
    public t9.p f506876i;
    ...
    public q8.g f506879l;

    /* renamed from: m, reason: collision with root package name */
    public u8.n[] f506880m;

    /* renamed from: n, reason: collision with root package name */
    public long f506881n;

    /* renamed from: o, reason: collision with root package name */
    public boolean f506882o;

    /* renamed from: c, reason: collision with root package name */
    public final t9.p f506870c = new t9.p(16);

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Stack f506871d = new java.util.Stack();

    /* renamed from: a, reason: collision with root package name */
    public final t9.p f506868a = new t9.p(t9.n.f498065a);

    /* renamed from: b, reason: collision with root package name */
    public final t9.p f506869b = new t9.p(4);
    ...
    public long d(long j17) {
        ...
        for (u8.n nVar : nVarArr) {
            ...
            while (true) {
                ...
                if ((tVar.f506922f[c17] & 1) != 0) {
                    break;
                }
                c17--;
            }
            if (c17 == -1) {
                long[] jArr = tVar.f506921e;
                int b17 = t9.d0.b(jArr, j17, true, false);
                while (true) {
                    if (b17 >= jArr.length) {
                        break;
                    }
                    if ((tVar.f506922f[b17] & 1) != 0) {
                        i17 = b17;
                        break;
                    }
                    b17++;
    ...
    */
    ...
    public void mo131097x35ce78(long j17, long j18) {
        ...
        if (nVarArr != null) {
            for (u8.n nVar : nVarArr) {
                u8.t tVar = nVar.f506864b;
                int c17 = t9.d0.c(tVar.f506921e, j18, true, false);
                while (true) {
                    i17 = -1;
                    if (c17 < 0) {
                        c17 = -1;
                        break;
                    } else if ((tVar.f506922f[c17] & 1) != 0) {
                        break;
                    } else {
                        c17--;
                    }
