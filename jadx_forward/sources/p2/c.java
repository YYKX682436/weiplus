...
public final class c {
    ...
    public static final p2.b f432906b = new p2.b(null);

    /* renamed from: c, reason: collision with root package name */
    public static final int[] f432907c = {18, 20, 17, 15};

    /* renamed from: d, reason: collision with root package name */
    public static final int[] f432908d = {65535, 262143, 32767, 8191};

    /* renamed from: e, reason: collision with root package name */
    public static final int[] f432909e = {32767, 8191, 65535, 262143};

    /* renamed from: a, reason: collision with root package name */
    public final long f432910a;
    ...
    public static long a(long j17, int i17, int i18, int i19, int i27, int i28, java.lang.Object obj) {
        ...
        if (z17) {
            return f432906b.b(i17, i18, i19, i27);
        }
    ...
    public static final boolean c(long j17) {
        int i17 = (int) (3 & j17);
        return (((int) (j17 >> (f432907c[i17] + 31))) & f432909e[i17]) != 0;
    }

    public static final boolean d(long j17) {
        return (((int) (j17 >> 33)) & f432908d[(int) (3 & j17)]) != 0;
    }
    ...
    public static final int g(long j17) {
        int i17 = (int) (3 & j17);
        int i18 = ((int) (j17 >> (f432907c[i17] + 31))) & f432909e[i17];
        if (i18 == 0) {
    ...
    public static final int h(long j17) {
        int i17 = ((int) (j17 >> 33)) & f432908d[(int) (3 & j17)];
        if (i17 == 0) {
            return Integer.MAX_VALUE;
        }
        return i17 - 1;
    ...
    public static final int i(long j17) {
        int i17 = (int) (3 & j17);
        return ((int) (j17 >> f432907c[i17])) & f432909e[i17];
    }

    public static final int j(long j17) {
        return ((int) (j17 >> 2)) & f432908d[(int) (3 & j17)];
    }
    ...
    /* renamed from: equals */
    public boolean m157729xb2c87fbf(java.lang.Object obj) {
        if (obj instanceof p2.c) {
            return this.f432910a == ((p2.c) obj).f432910a;
        }
        return false;
    }

    /* renamed from: hashCode */
    public int m157730x8cdac1b() {
        return java.lang.Long.hashCode(this.f432910a);
    }

    /* renamed from: toString */
    public java.lang.String m157731x9616526c() {
        return k(this.f432910a);
    }
}
