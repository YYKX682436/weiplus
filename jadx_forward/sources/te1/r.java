...
public class r {
    ...
    public static final java.util.concurrent.atomic.AtomicInteger f499339m = new java.util.concurrent.atomic.AtomicInteger(10000);

    /* renamed from: n, reason: collision with root package name */
    public static final java.util.concurrent.atomic.AtomicInteger f499340n = new java.util.concurrent.atomic.AtomicInteger(10000);

    /* renamed from: c, reason: collision with root package name */
    public re1.b f499343c;

    /* renamed from: d, reason: collision with root package name */
    public int f499344d;

    /* renamed from: e, reason: collision with root package name */
    public java.net.ServerSocket f499345e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.concurrent.ExecutorService f499346f;

    /* renamed from: g, reason: collision with root package name */
    public final te1.v f499347g;

    /* renamed from: a, reason: collision with root package name */
    public int f499341a = 0;

    /* renamed from: b, reason: collision with root package name */
    public boolean f499342b = true;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.Map f499348h = new java.util.HashMap();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.concurrent.ConcurrentHashMap f499349i = new java.util.concurrent.ConcurrentHashMap(8, 0.75f, 2);

    /* renamed from: j, reason: collision with root package name */
    public final java.util.Map f499350j = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: k, reason: collision with root package name */
    public final java.util.Map f499351k = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: l, reason: collision with root package name */
    public final java.util.Map f499352l = new java.util.concurrent.ConcurrentHashMap();
    ...
    public r() {
        ...
        if (android.text.TextUtils.isEmpty(b17)) {
            this.f499343c = null;
            ((lm1.c) qe1.a.a().f443562n).g(-1);
            ((oe1.t1) qe1.a.a().f443563o).f426274a.f426281e = false;
        } else {
            if (!android.text.TextUtils.isEmpty(b17)) {
                try {
                ...
                long min = java.lang.Math.min(j17, qe1.a.a().f443558j);
                ...
                this.f499343c = new re1.m(new com.p314xaae8f345.mm.vfs.r6(b17), kVar);
            }
            j17 = -1;
            long min2 = java.lang.Math.min(j17, qe1.a.a().f443558j);
    ...
    */
    public final com.p314xaae8f345.mm.vfs.r6 a(se1.g r46, se1.i r47, java.lang.String r48, te1.s r49) {
        /*
    ...
    public java.lang.String b(java.lang.String str, boolean z17, boolean z18, java.lang.String str2, int i17) {
        ...
        if (qe1.a.a().f443551c && this.f499341a <= 3) {
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor = (java.util.concurrent.ThreadPoolExecutor) this.f499346f;
            if (!threadPoolExecutor.isShutdown() && !threadPoolExecutor.isTerminated()) {
                ...
                try {
                    str5 = java.net.URLEncoder.encode(str3, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
                ...
                sb6.append("http://127.0.0.1:" + this.f499344d);
                sb6.append("/");
                ...
                if (!android.text.TextUtils.isEmpty(str4)) {
                    try {
                        str6 = java.net.URLEncoder.encode(str4, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
                ...
                if (z17) {
                    str7 = java.lang.System.currentTimeMillis() + "" + f499339m.getAndIncrement();
                } else {
                    str7 = null;
                }
                if (str7 != null) {
    ...
    public final te1.o c(se1.g gVar, se1.i iVar, java.lang.String str, java.lang.String str2, te1.s sVar, java.net.Socket socket, java.lang.String str3, long j17, long j18, long j19) {
        te1.v vVar = this.f499347g;
        java.util.Map map = this.f499348h;
        te1.o oVar = new te1.o(this, null);
        oVar.f499329a = j17;
        ve1.g.p(4, str2, "openDataSource, dataSpec=" + iVar.m164337x9616526c(), null);
        if (ve1.g.m(str)) {
            try {
                com.p314xaae8f345.mm.vfs.r6 a17 = qe1.a.a().f443565q != null ? ((cg.a) qe1.a.a().f443565q).a(str) : null;
                if (a17 == null || !a17.m()) {
                    oVar.f499332d = a(gVar, iVar, str, sVar);
                } else {
                    oVar.f499332d = a17;
                }
                if (oVar.f499332d == null) {
                    if (sVar.f499361h == 90) {
                        oVar.f499329a = ve1.g.f(18, j18);
                        p001xcca8366f.p003x91727fcf.v4.p009x62f6fe4.f.a(((java.util.HashMap) map).get(str3));
                    }
                ...
                ve1.g.p(4, str2, "openDataSource, localPlaylist generate success:" + oVar.f499332d.m82469x9616526c(), null);
                te1.n nVar = new te1.n(this);
                nVar.c(new se1.i(android.net.Uri.fromFile(new java.io.File(com.p314xaae8f345.mm.vfs.w6.i(oVar.f499332d.u(), false))), iVar.f488306b, iVar.f488307c, iVar.f488308d, iVar.f488309e, iVar.f488310f, iVar.f488311g, iVar.f488312h));
                oVar.f499331c = nVar;
            } catch (te1.e e18) {
                ve1.g.p(6, "VideoProxy/" + sVar.f499359f, "openDataSource, localPlaylist generate livePlayListException " + e18, null);
                int i17 = e18.getCause() != null ? ((e18.getCause() instanceof se1.r) || (e18.getCause() instanceof se1.s)) ? 0 : 17 : 16;
                if (sVar.f499361h == 90 && i17 != 0) {
                    oVar.f499329a = ve1.g.f(i17, j18);
                    p001xcca8366f.p003x91727fcf.v4.p009x62f6fe4.f.a(((java.util.HashMap) map).get(str3));
                }
                try {
                    socket.close();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:154:0x1111, code lost:
        ...
        ve1.g.o(4, r2, r3 + r33.m82469x9616526c());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:158:0x113d, code lost:
        ...
        ve1.g.o(5, r2, r1 + r33.m82469x9616526c());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:290:0x0d48, code lost:
        ...
        r6 = (android.net.ConnectivityManager) com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSystemService("connectivity");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:363:0x0ace, code lost:
        ...
        if (r10.m166294xb2c87fbf(te1.b.f499301c) != false) goto L435;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:367:0x0af9, code lost:
        ...
        r7.write(r11.getBytes(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));
        r7.flush();
        r7.close();
     */
