...
public class h implements mb.j {
    ...
    public final android.os.IBinder f406819d;

    public h(android.os.IBinder iBinder) {
        this.f406819d = iBinder;
    }

    @Override // android.os.IInterface
    public android.os.IBinder asBinder() {
        return this.f406819d;
    }
    ...
    public void d(mb.g gVar) {
        ...
        try {
            ...
            this.f406819d.transact(3, obtain, obtain2, 0);
    ...
    public int[] e(mb.g gVar) {
        ...
        try {
            obtain.writeInterfaceToken("com.huawei.securitymgr.IAuthenticationService");
            obtain.writeStrongBinder(gVar != null ? gVar.asBinder() : null);
            this.f406819d.transact(5, obtain, obtain2, 0);
            obtain2.readException();
    ...
    public void g(mb.g gVar) {
        ...
        try {
            obtain.writeInterfaceToken("com.huawei.securitymgr.IAuthenticationService");
            obtain.writeStrongBinder(gVar != null ? gVar.asBinder() : null);
            this.f406819d.transact(4, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public int j(mb.g gVar, int[] iArr, byte[] bArr) {
        ...
        try {
            ...
            this.f406819d.transact(2, obtain, obtain2, 0);
            obtain2.readException();
