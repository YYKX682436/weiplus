...
public final class c1 implements java.util.List, zz5.d {
    ...
    public final x0.i0 f532402d;

    /* renamed from: e, reason: collision with root package name */
    public final int f532403e;
    ...
    public c1(x0.i0 parentList, int i17, int i18) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(parentList, "parentList");
        this.f532402d = parentList;
        this.f532403e = i17;
        this.f532404f = parentList.h();
        this.f532405g = i18 - i17;
    }

    @Override // java.util.List, java.util.Collection
    public boolean add(java.lang.Object obj) {
        d();
        int i17 = this.f532403e + this.f532405g;
        x0.i0 i0Var = this.f532402d;
        i0Var.add(i17, obj);
        this.f532405g++;
        this.f532404f = i0Var.h();
        return true;
    }
    ...
    public boolean addAll(java.util.Collection elements) {
        ...
        return addAll(this.f532405g, elements);
    }
    ...
    public void clear() {
        ...
        if (this.f532405g > 0) {
            d();
            x0.i0 i0Var = this.f532402d;
            int i19 = this.f532403e;
            int i27 = this.f532405g + i19;
            i0Var.getClass();
            do {
                java.lang.Object obj = x0.j0.f532432a;
                synchronized (obj) {
                    x0.f0 f0Var = (x0.f0) x0.z.h((x0.f0) i0Var.f532429d, x0.z.i());
                    i17 = f0Var.f532421d;
                    eVar = f0Var.f532420c;
                }
                ...
                p0.e g17 = ((q0.h) x17).g();
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(g17, eVar)) {
                    break;
                }
                synchronized (obj) {
                    x0.f0 f0Var2 = (x0.f0) i0Var.f532429d;
                    synchronized (x0.z.f532496b) {
                        i18 = x0.z.i();
                        x0.f0 f0Var3 = (x0.f0) x0.z.u(f0Var2, i0Var, i18);
                        if (f0Var3.f532421d == i17) {
                            f0Var3.c(g17);
                            z17 = true;
                            f0Var3.f532421d++;
                        } else {
    ...
    public final void d() {
        if (this.f532402d.h() != this.f532404f) {
    ...
    public java.lang.Object get(int i17) {
        d();
        x0.j0.a(i17, this.f532405g);
        return this.f532402d.get(this.f532403e + i17);
    }

    @Override // java.util.List
    public int indexOf(java.lang.Object obj) {
        d();
        int i17 = this.f532405g;
        int i18 = this.f532403e;
        java.util.Iterator it = e06.p.m(i18, i17 + i18).iterator();
        while (it.hasNext()) {
            int b17 = ((kz5.x0) it).b();
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(obj, this.f532402d.get(b17))) {
                return b17 - i18;
            }
        }
        return -1;
    ...
    public int lastIndexOf(java.lang.Object obj) {
        ...
        for (int i19 = (i17 + i18) - 1; i19 >= i18; i19--) {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(obj, this.f532402d.get(i19))) {
                return i19 - i18;
            }
        }
        return -1;
    ...
    public final int size() {
        return this.f532405g;
    }

    @Override // java.util.List
    public java.util.List subList(int i17, int i18) {
        if (!((i17 >= 0 && i17 <= i18) && i18 <= this.f532405g)) {
            throw new java.lang.IllegalArgumentException("Failed requirement.".toString());
        }
        d();
        int i19 = this.f532403e;
        return new x0.c1(this.f532402d, i17 + i19, i18 + i19);
    }
