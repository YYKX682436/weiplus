    ...
    public void run() {
        ...
        if (eVar != null) {
            ...
            if (!z17 && m75942xfb822ef2 == j17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Finder.FinderLiveService", "heartBeat manual recovery liveId:" + m75942xfb822ef2);
                pm0.z.b(xy2.b.f539688b, "liveHeartBeatBreak_manualRecovery", false, null, null, false, false, new dk2.wc(m75942xfb822ef2), 60, null);
