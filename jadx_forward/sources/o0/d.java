...
public final class d implements java.util.Set, zz5.a {
    ...
    public java.lang.Object[] f423372e = new java.lang.Object[16];
    ...
    public final void clear() {
        int i17 = this.f423371d;
        for (int i18 = 0; i18 < i17; i18++) {
            this.f423372e[i18] = null;
        }
        this.f423371d = 0;
    }
    ...
    public final int d(java.lang.Object obj) {
        int i17 = this.f423371d - 1;
        int identityHashCode = java.lang.System.identityHashCode(obj);
        int i18 = 0;
        while (i18 <= i17) {
            int i19 = (i18 + i17) >>> 1;
            java.lang.Object obj2 = this.f423372e[i19];
            if (obj2 == null) {
            ...
            if (identityHashCode2 < identityHashCode) {
                ...
                if (identityHashCode2 <= identityHashCode) {
                    ...
                    for (int i27 = i19 - 1; -1 < i27; i27--) {
                        java.lang.Object obj3 = this.f423372e[i27];
                        if (obj3 == obj) {
                            return i27;
                        }
                    ...
                    int i28 = i19 + 1;
                    int i29 = this.f423371d;
                    while (true) {
                        if (i28 >= i29) {
                            i28 = this.f423371d;
                            break;
                        }
                        java.lang.Object obj4 = this.f423372e[i28];
                        if (obj4 == obj) {
                            return i28;
                        }
