...
public enum u {
    ...
    public final int f507014d;

    static {
        android.util.SparseIntArray sparseIntArray = new android.util.SparseIntArray(m167699xcee59d22().length);
        for (u81.u uVar : m167699xcee59d22()) {
            if (sparseIntArray.indexOfKey(uVar.f507014d) >= 0) {
                iz5.a.h(java.lang.String.format(java.util.Locale.ENGLISH, "duplicated defined intValue in %s", uVar.name()));
                throw null;
            }
            sparseIntArray.put(uVar.f507014d, 1);
        }
    }
