...
public final class x extends com.p176xb6135e39.p283xc50a8b8b.q5 implements com.p176xb6135e39.p283xc50a8b8b.r8 {
    ...
    public java.lang.Object f331780e;

    /* renamed from: f, reason: collision with root package name */
    public java.util.List f331781f;

    /* renamed from: g, reason: collision with root package name */
    public com.p176xb6135e39.p283xc50a8b8b.p9 f331782g;

    public x(e83.a aVar) {
        super(null);
        boolean z17;
        this.f331780e = "";
        this.f331781f = java.util.Collections.emptyList();
    ...
    public com.p176xb6135e39.p283xc50a8b8b.k8 mo20556x59bc66e() {
        e83.y mo20557x85702333 = mo20557x85702333();
    ...
    public e83.y mo20557x85702333() {
        e83.y yVar = new e83.y(this, null);
        int i17 = (this.f331779d & 1) == 0 ? 0 : 1;
        yVar.f331786e = this.f331780e;
        com.p176xb6135e39.p283xc50a8b8b.p9 p9Var = this.f331782g;
        if (p9Var == null) {
            if ((this.f331779d & 2) != 0) {
                this.f331781f = java.util.Collections.unmodifiableList(this.f331781f);
                this.f331779d &= -3;
            }
            yVar.f331787f = this.f331781f;
        } else {
            yVar.f331787f = p9Var.g();
        }
        yVar.f331785d = i17;
        m20880xaf619bdf();
        return yVar;
    ...
    /* renamed from: clone */
    public java.lang.Object m127179x5a5dd5d() {
        return (e83.x) m45490x5a5dd5d();
    }

    public final com.p176xb6135e39.p283xc50a8b8b.p9 d() {
        if (this.f331782g == null) {
            this.f331782g = new com.p176xb6135e39.p283xc50a8b8b.p9(this.f331781f, (this.f331779d & 2) != 0, m20872x3e6b6e28(), m20879x7a8e633f());
            this.f331781f = null;
        }
        return this.f331782g;
    }
    ...
    */
    public e83.x e(com.p176xb6135e39.p283xc50a8b8b.d0 r2, com.p176xb6135e39.p283xc50a8b8b.t4 r3) {
        /*
            r1 = this;
            com.google.protobuf.e9 r0 = e83.y.f331784i     // Catch: java.lang.Throwable -> Le com.p176xb6135e39.p283xc50a8b8b.y6 -> L10
            e83.w r0 = (e83.w) r0     // Catch: java.lang.Throwable -> Le com.p176xb6135e39.p283xc50a8b8b.y6 -> L10
            java.lang.Object r2 = r0.mo20549xc7f9c18(r2, r3)     // Catch: java.lang.Throwable -> Le com.p176xb6135e39.p283xc50a8b8b.y6 -> L10
            e83.y r2 = (e83.y) r2     // Catch: java.lang.Throwable -> Le com.p176xb6135e39.p283xc50a8b8b.y6 -> L10
            r1.f(r2)
            return r1
        Le:
            r2 = move-exception
    ...
    public e83.x f(e83.y yVar) {
        ...
        if (yVar == e83.y.f331783h) {
            return this;
        }
        if ((yVar.f331785d & 1) != 0) {
            this.f331779d |= 1;
            this.f331780e = yVar.f331786e;
            m20881x7bb163d5();
        }
        if (this.f331782g == null) {
            if (!yVar.f331787f.isEmpty()) {
                if (this.f331781f.isEmpty()) {
                    this.f331781f = yVar.f331787f;
                    this.f331779d &= -3;
                } else {
                    if ((this.f331779d & 2) == 0) {
                        this.f331781f = new java.util.ArrayList(this.f331781f);
                        this.f331779d |= 2;
                    }
                    this.f331781f.addAll(yVar.f331787f);
                }
                m20881x7bb163d5();
            }
        } else if (!yVar.f331787f.isEmpty()) {
            if (this.f331782g.p()) {
                this.f331782g.f126942a = null;
                this.f331782g = null;
                this.f331781f = yVar.f331787f;
                this.f331779d &= -3;
                z17 = com.p176xb6135e39.p283xc50a8b8b.l6.f7872x2df6253a;
                this.f331782g = z17 ? d() : null;
            } else {
                this.f331782g.b(yVar.f331787f);
            }
        }
    ...
    public com.p176xb6135e39.p283xc50a8b8b.a m45492xba8a5e4b(com.p176xb6135e39.p283xc50a8b8b.wa waVar) {
        return (e83.x) m45492xba8a5e4b(waVar);
    }
    ...
    public x(com.p176xb6135e39.p283xc50a8b8b.r5 r5Var, e83.a aVar) {
        super(r5Var);
        boolean z17;
        this.f331780e = "";
        this.f331781f = java.util.Collections.emptyList();
