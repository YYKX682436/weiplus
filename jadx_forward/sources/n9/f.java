...
public final class f implements i9.d {
    ...
    public final n9.c f417304d;

    /* renamed from: e, reason: collision with root package name */
    public final long[] f417305e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.Map f417306f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.Map f417307g;

    public f(n9.c cVar, java.util.Map map, java.util.Map map2) {
        this.f417304d = cVar;
        this.f417307g = map2;
        this.f417306f = map != null ? java.util.Collections.unmodifiableMap(map) : java.util.Collections.emptyMap();
        cVar.getClass();
    ...
    public long a(int i17) {
        return this.f417305e[i17];
    }

    @Override // i9.d
    public int h() {
        return this.f417305e.length;
    }

    @Override // i9.d
    public int i(long j17) {
        long[] jArr = this.f417305e;
    ...
    public java.util.List j(long j17) {
        int i17;
        int i18;
        n9.c cVar = this.f417304d;
        cVar.getClass();
        java.util.TreeMap treeMap = new java.util.TreeMap();
        cVar.e(j17, false, cVar.f417280g, treeMap);
        cVar.d(this.f417306f, treeMap);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        for (java.util.Map.Entry entry : treeMap.entrySet()) {
            n9.d dVar = (n9.d) this.f417307g.get(entry.getKey());
            ...
            arrayList.add(new i9.a(spannableStringBuilder, null, dVar.f417287c, dVar.f417288d, dVar.f417289e, dVar.f417286b, Integer.MIN_VALUE, dVar.f417290f));
        }
        return arrayList;
    }
}
