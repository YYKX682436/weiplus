...
public class i {
    ...
    public final android.content.Context f99749a;

    /* renamed from: b, reason: collision with root package name */
    public j6.c f99750b;

    /* renamed from: c, reason: collision with root package name */
    public android.content.ServiceConnection f99751c;

    /* renamed from: d, reason: collision with root package name */
    public boolean f99752d = false;

    /* renamed from: e, reason: collision with root package name */
    public int f99753e;

    /* renamed from: f, reason: collision with root package name */
    public b73.h f99754f;
    ...
    */
    public static void a(b73.i r3, java.lang.String r4) {
        ...
        L27:
            j6.c r1 = r3.f99750b     // Catch: android.os.RemoteException -> L4b
            android.content.Context r3 = r3.f99749a     // Catch: android.os.RemoteException -> L4b
    ...
    public static int b(b73.i iVar, android.content.Intent intent, java.lang.String str) {
        android.content.Context context = iVar.f99749a;
        ...
        do {
            ...
            try {
                ...
                aVar.f379371d.transact(4, obtain, obtain2, 0);
    ...
    public final void c(java.lang.String str) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IabHelper", "Illegal state for operation (" + str + "): IAB helper is not set up.");
        throw new java.lang.IllegalStateException("IAB helper is not set up. Can't perform operation: " + str);
    }

    public void d() {
        this.f99752d = false;
        android.content.ServiceConnection serviceConnection = this.f99751c;
        if (serviceConnection != null) {
            try {
                android.content.Context context = this.f99749a;
                if (context != null) {
                    context.unbindService(serviceConnection);
                }
            } catch (java.lang.IllegalArgumentException e17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IabHelper", e17.toString());
            }
            this.f99751c = null;
            this.f99750b = null;
        }
    ...
    public final void g(java.lang.String str) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IabHelper", "In-app billing error: " + str);
    }
    ...
    public void h(b73.g gVar) {
        ...
        this.f99751c = new b73.b(this, gVar);
        ...
        if (context != null && context.getPackageManager() != null && context.getPackageManager().queryIntentServices(intent, 0) != null && !context.getPackageManager().queryIntentServices(intent, 0).isEmpty()) {
            context.bindService(intent, this.f99751c, 1);
        } else if (gVar != null) {
