...
public final class l0 implements s1.l2 {
    ...
    public p2.s f483564d = p2.s.Rtl;

    /* renamed from: e, reason: collision with root package name */
    public float f483565e;

    /* renamed from: f, reason: collision with root package name */
    public float f483566f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ s1.q0 f483567g;
    ...
    public java.util.List b(java.lang.Object obj, yz5.p content) {
        ...
        s1.q0 q0Var = this.f483567g;
        q0Var.getClass();
        q0Var.b();
        u1.w wVar = q0Var.f483594a;
        u1.c0 c0Var = wVar.f505224o;
        ...
        java.util.LinkedHashMap linkedHashMap = (java.util.LinkedHashMap) q0Var.f483599f;
        java.lang.Object obj2 = linkedHashMap.get(obj);
        if (obj2 == null) {
            obj2 = (u1.w) q0Var.f483601h.remove(obj);
            if (obj2 != null) {
                int i17 = q0Var.f483604k;
                if (!(i17 > 0)) {
                    throw new java.lang.IllegalStateException("Check failed.".toString());
                }
                q0Var.f483604k = i17 - 1;
            } else {
                obj2 = q0Var.d(obj);
                if (obj2 == null) {
                    int i18 = q0Var.f483597d;
