...
public class h implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ rb5.l f475403d;
    ...
    public void onClick(android.view.View view) {
        ...
        rb5.l lVar = this.f475403d;
        if (!lVar.f475421o) {
            lVar.f475427u.mo50300x3fa464aa(lVar.A);
            wn.r rVar = lVar.f475429w;
            if (rVar != null) {
                rVar.mo64779x42fe6352();
            }
            lVar.f475413d.finish();
        }
