...
public final class g {
    ...
    public final float f82250d;

    /* renamed from: e, reason: collision with root package name */
    public final float f82251e;

    /* renamed from: f, reason: collision with root package name */
    public final int f82252f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.List f82253g;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.List f82254h;

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v9, types: [java.util.List] */
    public g(a2.j jVar, long j17, int i17, boolean z17, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
        boolean z18;
        int i18;
        int g17;
        int i19;
        ...
        java.util.ArrayList arrayList2 = (java.util.ArrayList) jVar.f82285e;
        ...
        while (i27 < size) {
            ...
            a2.o paragraphIntrinsics = nVar.f82317a;
            int h17 = p2.c.h(j17);
            if (p2.c.c(j17)) {
                i18 = i27;
            ...
            int i29 = this.f82248b - i28;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(paragraphIntrinsics, "paragraphIntrinsics");
            i2.c cVar = new i2.c((i2.e) paragraphIntrinsics, i29, z17, b17, null);
            float b18 = cVar.b() + f17;
            b2.t tVar = cVar.f369383d;
            int i37 = i28 + tVar.f98850c;
            arrayList.add(new a2.m(cVar, nVar.f82318b, nVar.f82319c, i28, i37, f17, b18));
            if (!tVar.f98848a) {
                if (i37 == this.f82248b) {
                    i19 = i18;
                    if (i19 != kz5.c0.h(this.f82247a.f82285e)) {
                    }
                } else {
                    i19 = i18;
                }
        ...
        this.f82252f = i28;
        this.f82249c = z18;
        this.f82254h = arrayList;
        this.f82250d = p2.c.h(j17);
        ...
        for (int i38 = 0; i38 < size2; i38++) {
            ...
            java.util.List list = ((i2.c) mVar.f82306a).f369384e;
        ...
        if (size4 < this.f82247a.f82282b.size()) {
            int size5 = this.f82247a.f82282b.size() - arrayList3.size();
    ...
    public final void a(e1.u canvas, e1.r brush, e1.z0 z0Var, l2.g gVar) {
        ...
        canvas.c();
        java.util.ArrayList arrayList = (java.util.ArrayList) this.f82254h;
        int size = arrayList.size();
        for (int i17 = 0; i17 < size; i17++) {
            a2.m mVar = (a2.m) arrayList.get(i17);
            i2.c cVar = (i2.c) mVar.f82306a;
            cVar.getClass();
            i2.f fVar = cVar.f369380a.f369389c;
            long j17 = cVar.f369382c;
            ...
            canvas.e(0.0f, ((i2.c) mVar.f82306a).b());
        }
        canvas.b();
    }
    ...
    public final void b(e1.u canvas, long j17, e1.z0 z0Var, l2.g gVar) {
        ...
        for (int i17 = 0; i17 < size; i17++) {
            ...
            if (tVar.f98848a) {
                canvas3.save();
                canvas3.clipRect(0.0f, 0.0f, p2.c.h(cVar.f369382c), cVar.b());
            }
            tVar.f(canvas3);
            if (tVar.f98848a) {
                canvas3.restore();
