...
public abstract class e {
    ...
    public static final a2.d f82220a = new a2.d("", null, null, 6, null);
    ...
    public static final java.util.List a(java.util.List list, int i17, int i18) {
        ...
        for (int i19 = 0; i19 < size; i19++) {
            ...
            a2.c cVar = (a2.c) obj;
            if (b(i17, i18, cVar.f82209b, cVar.f82210c)) {
                arrayList.add(obj);
            }
        }
        ...
        for (int i27 = 0; i27 < size2; i27++) {
            ...
            arrayList2.add(new a2.c(cVar2.f82208a, java.lang.Math.max(i17, cVar2.f82209b) - i17, java.lang.Math.min(i18, cVar2.f82210c) - i17, cVar2.f82211d));
        }
        return arrayList2;
    }
