...
public class h extends java.io.InputStream {
    ...
    public final java.io.RandomAccessFile f360561d;

    /* renamed from: e, reason: collision with root package name */
    public long f360562e;

    /* renamed from: f, reason: collision with root package name */
    public long f360563f;

    /* renamed from: g, reason: collision with root package name */
    public long f360564g;

    /* renamed from: h, reason: collision with root package name */
    public final long f360565h;

    public h(java.io.File file) {
        long length = file.length();
        this.f360562e = -1L;
        this.f360561d = new java.io.RandomAccessFile(file, "r");
        this.f360565h = file.length();
        a(0L, length);
    }
    ...
    public int available() {
        long filePointer = this.f360564g - (this.f360561d.getFilePointer() - this.f360563f);
    ...
    public void mark(int i17) {
        try {
            this.f360562e = this.f360561d.getFilePointer();
    ...
    public int read() {
        ...
        return this.f360561d.read();
    }

    @Override // java.io.InputStream
    public void reset() {
        long j17 = this.f360562e;
        if (j17 < 0) {
            throw new java.io.IOException("mark not set");
        }
        this.f360561d.seek(j17);
    }
    ...
    public long skip(long j17) {
        ...
        java.io.RandomAccessFile randomAccessFile = this.f360561d;
        long j18 = min;
    ...
    public int read(byte[] bArr, int i17, int i18) {
        ...
        return this.f360561d.read(bArr, i17, java.lang.Math.min(i18, available));
    }
