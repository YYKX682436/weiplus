...
public final class c0 extends jm0.o implements bc0.i {
    ...
    public static final java.util.Map f448373m;

    static {
        java.util.HashMap hashMap = new java.util.HashMap();
        final r25.h hVar = r25.h.f450396a;
        ...
        final r25.c cVar = r25.c.f450389a;
    ...
    public boolean Zi(java.lang.String str) {
        ...
        if (parse == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.DeepLinkService", "canHandleDeepLink: false, uri parse failed, uriStr: " + str);
            return false;
        }
        java.lang.String aj6 = aj(parse);
        if (aj6 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.DeepLinkService", "canHandleDeepLink: false, uriPrefix decode failed, uriStr: " + str + ", uri: " + parse);
            return false;
        }
        r25.i iVar = (r25.i) ((java.util.HashMap) f448373m).get(aj6);
        if (iVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.DeepLinkService", "canHandleDeepLink: false, handler not found, uriStr: " + str + ", uri: " + parse + ", uriPrefix: " + aj6);
            return false;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.DeepLinkService", "canHandleDeepLink: true, uriStr: " + str + ", uri: " + parse + ", uriPrefix: " + aj6 + ", handler: " + iVar);
        return true;
    }
