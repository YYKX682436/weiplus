...
public abstract class e {
    public static f1.d a(f1.d dVar, f1.a0 whitePoint, f1.b adaptation, int i17, java.lang.Object obj) {
        if ((i17 & 2) != 0) {
            adaptation = f1.b.f339997b;
        }
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(dVar, "<this>");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(whitePoint, "whitePoint");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(adaptation, "adaptation");
        if (!f1.c.a(dVar.f340005b, f1.c.f339999a)) {
            return dVar;
        }
        f1.y yVar = (f1.y) dVar;
        if (c(yVar.f340056d, whitePoint)) {
            return dVar;
        }
        float[] a17 = whitePoint.a();
        return new f1.y(yVar.f340004a, yVar.f340060h, whitePoint, f(b(adaptation.f339998a, yVar.f340056d.a(), a17), yVar.f340061i), yVar.f340063k, yVar.f340065m, yVar.f340057e, yVar.f340058f, yVar.f340059g, -1);
    }
    ...
    public static final float[] b(float[] matrix, float[] srcWhitePoint, float[] dstWhitePoint) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(srcWhitePoint, "srcWhitePoint");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(dstWhitePoint, "dstWhitePoint");
    ...
    public static final boolean c(f1.a0 a17, f1.a0 b17) {
        ...
        return java.lang.Math.abs(a17.f339995a - b17.f339995a) < 0.001f && java.lang.Math.abs(a17.f339996b - b17.f339996b) < 0.001f;
    }

    public static f1.k d(f1.d connect, f1.d destination, int i17, int i18, java.lang.Object obj) {
        if ((i18 & 1) != 0) {
            f1.h hVar = f1.h.f340009a;
            destination = f1.h.f340012d;
        }
        if ((i18 & 2) != 0) {
            i17 = 0;
        }
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(connect, "$this$connect");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(destination, "destination");
        if (connect == destination) {
            return new f1.i(connect, 1);
        }
        long j17 = f1.c.f339999a;
        return (f1.c.a(connect.f340005b, j17) && f1.c.a(destination.f340005b, j17)) ? new f1.j((f1.y) connect, (f1.y) destination, i17, null) : new f1.k(connect, destination, i17, null);
    }
    ...
    public static final float[] f(float[] lhs, float[] rhs) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(lhs, "lhs");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(rhs, "rhs");
