...
public final class n extends f1.d {
    ...
    public static final float[] f340042d;

    /* renamed from: e, reason: collision with root package name */
    public static final float[] f340043e;

    /* renamed from: f, reason: collision with root package name */
    public static final float[] f340044f;

    /* renamed from: g, reason: collision with root package name */
    public static final float[] f340045g;

    static {
        float[] f17 = f1.e.f(new float[]{0.818933f, 0.032984544f, 0.0482003f, 0.36186674f, 0.9293119f, 0.26436627f, -0.12885971f, 0.03614564f, 0.6338517f}, f1.e.b(f1.b.f339997b.f339998a, new float[]{0.34567f / 0.3585f, 1.0f, ((1.0f - 0.34567f) - 0.3585f) / 0.3585f}, new float[]{0.31271f / 0.32902f, 1.0f, ((1.0f - 0.31271f) - 0.32902f) / 0.32902f}));
        f340042d = f17;
        float[] fArr = {0.21045426f, 1.9779985f, 0.025904037f, 0.7936178f, -2.4285922f, 0.78277177f, -0.004072047f, 0.4505937f, -0.80867577f};
        f340043e = fArr;
        f340044f = f1.e.e(f17);
        f340045g = f1.e.e(fArr);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(java.lang.String name, int i17) {
        super(name, f1.c.f340001c, i17, null);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(name, "name");
        int i18 = f1.c.f340003e;
    }
