...
public abstract class b {
    ...
    public static java.lang.String b() {
        ...
        return com.p314xaae8f345.p592x631407a.p600x38b7655d.C4777x7a3dad2b.f20438x62193627 ? com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4754xfbd52878.m41597x160af7ba(str) : str.equals(com.p314xaae8f345.p592x631407a.api.C4727x8a3e11bd.f20061xcc101583) ? "dev.api.unipay.qq.com" : str.equals("test") ? "sandbox.api.unipay.qq.com" : "api.unipay.qq.com";
    }
    ...
    public static boolean d() {
        ...
        if (currentTimeMillis - f507524a < 3000) {
            return true;
        }
        f507524a = currentTimeMillis;
        return false;
    }
    ...
    public static java.lang.String e(java.lang.String str, int i17) {
        ...
        if (android.text.TextUtils.isEmpty(str)) {
            com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.w("", "解码内容为空");
        } else {
            if (i17 <= 0) {
                return str;
            }
            ...
            while (i18 < i17) {
                try {
                    str2 = java.net.URLDecoder.decode(str, com.p314xaae8f345.p3085x8ea91595.p3100xc50a8e98.C26737xe7fcda6e.f56575x346c99d6);
                } catch (java.lang.Exception e17) {
                    com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.i("urlEncode", e17.toString());
                }
                i18++;
                str = str2;
            }
    ...
    public static java.lang.String f(java.lang.String str, int i17) {
        java.lang.String str2 = "";
        if (android.text.TextUtils.isEmpty(str)) {
            com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.i("urlEncode", "编码内容为空");
        } else {
            if (i17 <= 0) {
                return str;
            }
            ...
            while (i18 < i17) {
                try {
                    str2 = java.net.URLEncoder.encode(str, com.p314xaae8f345.p3085x8ea91595.p3100xc50a8e98.C26737xe7fcda6e.f56575x346c99d6);
                } catch (java.lang.Exception e17) {
                    com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.i("urlEncode", e17.toString());
                }
                i18++;
