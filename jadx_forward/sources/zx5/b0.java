...
public class b0 extends by5.u0 {
    ...
    public java.lang.String f558749f = "0";

    /* renamed from: g, reason: collision with root package name */
    public yx5.b f558750g;
        ...
        if (hashMapArr != null && hashMapArr.length > 0) {
            ...
            if (hashMap != null) {
                ...
                if (str == null) {
                    ...
                    zx5.p.Z().T();
                } else if (this.f558749f.equals("2")) {
                    zx5.p.Z().T();
                    by5.s0.d(93L, 1);
                } else if (this.f558749f.equals("3")) {
                    zx5.p.Z().i().f118103i = true;
                    by5.s0.d(94L, 1);
                }
            }
            by5.c4.f("XWebRuntimeUpdateChecker", "initConfigs, notifyType:" + this.f558749f + " [0:timer/1:notify/2:force/4:embed/5:config/7:auto]");
        }
        return k() ? 1 : 0;
    }
    ...
    public void g(java.lang.Object obj) {
        ...
        rVar.f558790a = by5.e4.a();
        rVar.f558791b = org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.f429503c.getDir("xwalkconfig", 0).getAbsolutePath() + java.io.File.separator + "updateConfig.xml";
        by5.c4.f("XWebRuntimeUpdateChecker", "fetchConfig start, url:" + rVar.f558790a + ", path:" + rVar.f558791b);
    ...
    public boolean k() {
        ...
        if (!(2000 <= org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.h()) && !zx5.p.Z().x()) {
