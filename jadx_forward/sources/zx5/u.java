...
public class u extends by5.u0 {
    ...
    public zx5.b f558805f = null;

    /* renamed from: g, reason: collision with root package name */
    public zx5.r f558806g = null;

    /* renamed from: h, reason: collision with root package name */
    public int f558807h = 0;

    /* renamed from: i, reason: collision with root package name */
    public java.util.Timer f558808i = null;

    /* renamed from: j, reason: collision with root package name */
    public long f558809j = 0;
    ...
    public static void k(zx5.r rVar, zx5.b bVar) {
        ...
        uVar.f558806g = rVar;
        uVar.f558807h = 0;
        uVar.f558809j = java.lang.System.currentTimeMillis();
        uVar.e(uVar.f558806g);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:91:0x0101, code lost:
        ...
        r6.f558800i = r12.getHeaderField("X-NWS-LOG-UUID");
        r6.f558801j = r12.getHeaderField("X-COS-META-MD5");
        r6.f558802k = r12.getHeaderField("server_ip");
        r6.f558803l = new java.text.SimpleDateFormat(com.p314xaae8f345.tav.p2957xa228aba5.C25746x8808ec8f.f47897xee1ddd9f).format(new java.util.Date());
        by5.c4.f(r5, "response, uuid:" + r6.f558800i + ", md5:" + r6.f558801j + ", serverip:" + r6.f558802k + ", downloadTime:" + r6.f558803l);
        r6.f558798g = r7;
        r6.f558797f = java.lang.System.currentTimeMillis() - r17.f558809j;
        r6.f558804m = java.net.InetAddress.getByName(r11.getHost()).getHostAddress();
        r0 = new java.lang.StringBuilder();
        r0.append("response, DNSServerIP:");
        r0.append(r6.f558802k);
    ...
    */
    ...
    public void g(java.lang.Object obj) {
        ...
        if (tVar.f558794c == 0) {
            ...
            this.f558805f.d(tVar);
            return;
        }
        by5.c4.a("XWebHttpTask", "task failed! mRetCode = " + tVar.f558794c + " mRetrytimes = " + this.f558807h);
        int i18 = this.f558807h;
        if (!((i18 >= 2 || (i17 = tVar.f558794c) == -10001 || i17 == -10004) ? false : true)) {
            this.f558805f.a(tVar);
            return;
        }
        this.f558807h = i18 + 1;
        by5.c4.a("XWebHttpTask", "task retry! mRetrytimes = " + this.f558807h);
        java.util.Timer timer = new java.util.Timer();
        this.f558808i = timer;
        timer.schedule(new zx5.q(this), this.f558807h * 3000);
    }
    ...
    public void i(java.lang.Object[] objArr) {
        ...
        this.f558805f.b(sVarArr[0]);
    }

    public final java.lang.String l() {
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("XWebSdk/20260502 ");
        sb6.append("XWebApk/" + org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.h() + " ");
        ...
        sb6.append("APPINFO/dump (" + org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.m156975x966e5ddb() + ") ");
        sb6.append("ProcessName/" + org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.m156976xe5e58464() + " ");
        return sb6.toString();
    }
