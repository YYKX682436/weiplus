...
public class y implements zx5.b {
    ...
    public final /* synthetic */ zx5.b0 f558814a;
    ...
    public void a(zx5.t tVar) {
        by5.c4.f("XWebRuntimeUpdateChecker", "fetchConfig onTaskFailed, get config fail, retCode:" + tVar.f558794c);
        zx5.i0.c(1);
        com.p314xaae8f345.p3210x3857dc.n1 n1Var = by5.s0.f118128c;
        if (n1Var != null) {
            n1Var.b(577L, 21L, 1L);
        }
        xx5.q.a(tVar, this.f558814a.f558749f, "0");
    }
