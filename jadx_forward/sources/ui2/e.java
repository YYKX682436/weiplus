...
public final class e implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ vi2.b f509626d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ ui2.f f509627e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ int f509628f;
    ...
    public final void onClick(android.view.View view) {
        ...
        vi2.b bVar = this.f509626d;
        boolean z17 = bVar.f519073m;
        int i17 = this.f509628f;
        ui2.f fVar = this.f509627e;
        if (z17) {
            si2.a aVar = fVar.f509629e;
            if (aVar != null) {
                aVar.f(i17, bVar.f519077d);
            }
        } else {
            si2.a aVar2 = fVar.f509629e;
            if (aVar2 != null) {
