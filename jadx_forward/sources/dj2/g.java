...
public final class g extends dj2.b {
    ...
    public void g(int i17, android.view.View view) {
        ...
        if (view instanceof lj2.j) {
            ((lj2.j) view).l(pm2.a.f438390m, b(i17));
        }
    }
    ...
    public android.view.View h(xh2.a data, int i17) {
        ...
        if (i17 == 1) {
            return new uj2.b(context, v0Var, x0Var);
        }
        if (i17 == 2) {
            return new uj2.c(context, v0Var, x0Var);
        }
        if (i17 != 3) {
            if (i17 == 4) {
                return new wj2.h0(context, v0Var, x0Var);
            }
            if (i17 != 7) {
                return new android.view.View(context);
            }
        }
        return new uj2.a(context, v0Var, x0Var);
    }
