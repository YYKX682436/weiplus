...
public final class x {
    ...
    public static final ax1.x f96560a = new ax1.x();
    ...
    public final void a(android.content.Context context, android.view.View view, android.graphics.Bitmap bitmap, java.lang.String md5Key) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(md5Key, "md5Key");
        if (view == null) {
            return;
        }
        ...
        ((ku5.t0) ku5.t0.f394148d).a(new ax1.u(bitmap, height, width, md5Key, context, view));
    }
}
