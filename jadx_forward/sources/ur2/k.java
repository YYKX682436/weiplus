...
public final class k implements java.lang.Runnable {
    ...
    public final /* synthetic */ ur2.o f511933d;
    ...
    public final void run() {
        ...
        ur2.o oVar = this.f511933d;
        android.view.View decorView = oVar.f511940d.getWindow().getDecorView();
        ...
        if (frameLayout != null) {
            frameLayout.addView(oVar.f511947n, layoutParams);
        }
        android.view.View view = oVar.f511947n;
