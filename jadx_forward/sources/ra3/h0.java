...
public abstract class h0 {
    ...
    public static final com.p314xaae8f345.mm.sdk.p2603x2137b148.n3 f475041a = new com.p314xaae8f345.mm.sdk.p2603x2137b148.n3(xu5.b.a("LiteAppUtils"));

    /* renamed from: b, reason: collision with root package name */
    public static final android.os.Handler f475042b = new android.os.Handler(android.os.Looper.getMainLooper());

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.String[] f475043c = {"_display_name", "_data", "date_added"};

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.Map f475044d = new ra3.c0();

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.Map f475045e = new ra3.d0();

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.HashSet f475046f = new java.util.HashSet(java.util.Collections.singletonList(com.p314xaae8f345.p347x615374d.p349x208df1fe.p353xff11797b.C3192xff8cc88a.WX_PAY_CASHIER_LITE_APP_ID));

    /* renamed from: g, reason: collision with root package name */
    public static final byte[] f475047g = "ASCII\u0000\u0000\u0000".getBytes(java.nio.charset.StandardCharsets.US_ASCII);

    /* renamed from: h, reason: collision with root package name */
    public static final byte[] f475048h = "UNICODE\u0000".getBytes(java.nio.charset.StandardCharsets.US_ASCII);

    public static int a(org.json.JSONObject jSONObject) {
        if (!jSONObject.has("nextAnimIn")) {
            return com.p314xaae8f345.mm.R.C30854x2dc211.f559419ea;
        }
        java.lang.String string = jSONObject.getString("nextAnimIn");
        java.util.Map map = f475044d;
        return !((java.util.HashMap) map).containsKey(string) ? com.p314xaae8f345.mm.R.C30854x2dc211.f559419ea : ((java.lang.Integer) ((java.util.HashMap) map).get(string)).intValue();
    }

    public static int b(org.json.JSONObject jSONObject) {
        if (!jSONObject.has("currentAnimOut")) {
            return com.p314xaae8f345.mm.R.C30854x2dc211.f559415e6;
        }
        java.lang.String string = jSONObject.getString("currentAnimOut");
        java.util.Map map = f475045e;
        return !((java.util.HashMap) map).containsKey(string) ? com.p314xaae8f345.mm.R.C30854x2dc211.f559415e6 : ((java.lang.Integer) ((java.util.HashMap) map).get(string)).intValue();
    }

    public static boolean c(android.graphics.Bitmap bitmap, java.lang.String str) {
        if (bitmap == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppUtils", "bitmap is null");
            return false;
        }
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppUtils", "save temp file failed. path: %s", str);
            return false;
        }
    }
    ...
    */
    public static void d(java.lang.String r7, byte[] r8) {
        /*
            boolean r0 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x.f274597a
            ...
            java.lang.String r1 = r2.m7340x351be6(r1)     // Catch: java.lang.Exception -> L41
            if (r1 != 0) goto L2f
            ...
            byte[] r8 = com.p314xaae8f345.mm.p1006xc5476f33.gif.C16080x6bc1f265.m64973x2abfde78(r8)     // Catch: java.lang.Exception -> L41
            if (r8 == 0) goto L50
        ...
        L2f:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r0, r8, r2)     // Catch: java.lang.Exception -> L41
            goto L50
        L41:
            r8 = move-exception
        ...
        L50:
            ...
            r0 = 1
            byte[] r2 = ra3.h0.f475048h
            byte[] r3 = ra3.h0.f475047g
            r4 = 0
            if (r8 == 0) goto L7f
            int r5 = r8.length
            r6 = 8
        ...
        Lc8:
            ...
            r1.<init>(r8, r0)
        Lcf:
            com.p314xaae8f345.mm.sdk.p2603x2137b148.x.L0(r1, r7)
            goto Ldb
        Ld3:
            java.lang.String r7 = "LiteAppUtils"
            java.lang.String r8 = "userComment is null or empty"
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r7, r8)
        Ldb:
            return
        */
    ...
    public static java.lang.String[] e(java.lang.String str, boolean z17) {
        ...
        if (z17) {
            try {
                str = java.net.URLDecoder.decode(str, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
            } catch (java.lang.Exception e17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("LiteAppUtils", e17, "", new java.lang.Object[0]);
            }
        }
