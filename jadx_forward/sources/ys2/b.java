...
public final class b implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ ys2.d f546678d;
    ...
    public final void onClick(android.view.View view) {
        ...
        ys2.d dVar = this.f546678d;
        ((mm2.c1) dVar.m56788xbba4bfc0(mm2.c1.class)).N1 = true;
        android.os.Bundle bundle = new android.os.Bundle();
        bundle.putBoolean("PARAM_FINDER_LIVE_SCREEN_CLEAR", true);
        dVar.X6(qo0.b.Z2, bundle);
        at2.y0 y0Var = (at2.y0) dVar.m56789x25fe639c(at2.y0.class);
        if (y0Var != null && (d0Var = y0Var.f95312n) != null) {
            d0Var.d(0);
        }
