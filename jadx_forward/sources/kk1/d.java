...
public abstract class d {
    public static java.lang.CharSequence a(java.lang.String str, boolean z17, kk1.c cVar) {
        ...
        for (android.text.style.URLSpan uRLSpan : uRLSpanArr) {
            ...
            spannableStringBuilder.setSpan(new com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1212x6a710b1.p1213x3107ab.C12736x29c08888(uRLSpan.getURL(), cVar, z17), spannable.getSpanStart(uRLSpan), spannable.getSpanEnd(uRLSpan), 34);
        }
