...
public class e implements java.util.concurrent.Executor {
    ...
    public final java.lang.ThreadLocal f433503d = new java.lang.ThreadLocal();

    public e(p5.d dVar) {
    }

    public final int a() {
        java.lang.ThreadLocal threadLocal = this.f433503d;
    ...
    public void execute(java.lang.Runnable runnable) {
        ...
        try {
            if (intValue <= 15) {
                ...
                p5.f.f433504c.f433505a.execute(runnable);
            }
            a();
