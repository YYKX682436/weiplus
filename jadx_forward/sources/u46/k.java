...
public abstract class k {
    ...
    public static java.lang.String c(java.lang.String str) {
        ...
        try {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                char charAt = str.charAt(i17);
                java.lang.String a17 = ((u46.d) fVar.f506211a).a(charAt);
                if (a17 != null) {
    ...
    public static void f(java.io.Writer writer, java.lang.String str) {
        ...
        for (int i17 = 0; i17 < length; i17++) {
            ...
            if (z18) {
                ...
                if (aVar.f533473e == 4) {
                    try {
                        writer.write((char) java.lang.Integer.parseInt(aVar.m175002x9616526c(), 16));
                        int i18 = aVar.f533473e;
                        if (i18 > 0) {
                            aVar.f533473e = 0;
                        } else if (i18 < 0) {
                            aVar.d(0);
                            aVar.f533473e = 0;
                            for (int i19 = aVar.f533473e; i19 < 0; i19++) {
                                aVar.f533472d[i19] = 0;
                            }
                        }
                        z17 = false;
