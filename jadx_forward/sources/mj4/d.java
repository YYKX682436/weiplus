...
public abstract class d {
    public static final java.lang.String a(mj4.h hVar) {
        ...
        mj4.c cVar = mj4.c.f408590a;
        if (cVar.a() != 0) {
            java.lang.String str = "";
            if (cVar.a() == 1) {
                pj4.x c17 = c(xe0.j0.a(hVar, false, 1, null));
                java.lang.String str2 = c17 != null ? c17.f436855d : null;
                if (str2 != null) {
                    str = str2;
                }
            }
            if (r26.n0.N(str)) {
                pj4.x xVar = xe0.j0.a(hVar, false, 1, null).f436756q;
                str = java.lang.String.valueOf(xVar != null ? xVar.f436855d : null);
            }
            if (!r26.n0.N(str)) {
                return str;
            }
    ...
    public static final java.lang.String b(pj4.o0 r5) {
        /*
            ...
            r3 = 0
            if (r0 == 0) goto L2a
            java.lang.String r4 = r0.f436858g
            if (r4 == 0) goto L24
        ...
        L25:
            if (r4 != 0) goto L2a
            java.lang.String r5 = r0.f436858g
            goto L40
        L2a:
            java.lang.String r0 = r5.f436755p
            if (r0 == 0) goto L36
        ...
        L36:
            if (r2 != 0) goto L3b
            java.lang.String r5 = r5.f436755p
            goto L40
        L3b:
            java.lang.String r5 = r5.f436746d
            if (r5 != 0) goto L40
            goto L41
        L40:
            r1 = r5
    ...
    public static final pj4.x c(pj4.o0 o0Var) {
        ...
        java.util.LinkedList clusterPresents = o0Var.f436759t;
        if (clusterPresents == null || clusterPresents.isEmpty()) {
            return o0Var.f436756q;
        }
        java.util.LinkedList key_value_items = bk4.i.a().p().f436687e;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(key_value_items, "key_value_items");
        ...
        while (true) {
            ...
            if (l0Var.f436702d.equals("cluster_present_type")) {
                str = l0Var.f436703e;
                break;
            }
        }
        if (!(str == null || str.length() == 0)) {
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(clusterPresents, "clusterPresents");
            ...
            while (true) {
                ...
                if (xVar2.f436860i <= 1 && xVar2.f436859h.equals(str)) {
                    xVar = xVar2;
                    break;
                }
            }
