...
public final class t extends cc1.p {
    ...
    public static final int f4290x366c91de = 1282;

    /* renamed from: NAME */
    public static final java.lang.String f4291x24728b = "cryptoGenerateKey";
    ...
    public java.lang.Object C(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.l lVar, org.json.JSONObject jSONObject, p3321xbce91901.p3322xc267989b.InterfaceC29045xdcb5ca57 interfaceC29045xdcb5ca57) {
        ...
        if (((java.util.ArrayList) cc1.p.f121977g.d(lVar)).size() > 20) {
            throw new cc1.n(jc1.i.f380478b);
        }
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrand.JsApiCryptoGenerateKey", "genkey alg=" + optString + " blockModes=" + arrayList2 + " keyAlias=" + uuid + " keySize=" + optInt);
        ...
        if (kz5.z.G(cc1.p.f121979i, optString)) {
            java.util.Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
                java.util.Iterator it6 = it;
                java.lang.String str3 = (java.lang.String) it.next();
                java.lang.String str4 = str2;
                if (!kz5.z.G(cc1.p.f121978h, str3)) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrand.JsApiCryptoGenerateKey", str2 + isInsideSecureHardware);
        ...
        if (!kz5.z.G(cc1.p.f121980m, optString)) {
        ...
        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(optString, "EC")) {
            numArr = new java.lang.Integer[]{224, 256, 384, 521};
            z17 = false;
        } else if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(optString, "RSA")) {
            z17 = false;
        ...
        if (!kz5.z.G(numArr, java.lang.Integer.valueOf(optInt))) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrand.JsApiCryptoGenerateKey", "invalid keysize " + optInt);
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.e(keySpec2, "null cannot be cast to non-null type android.security.keystore.KeyInfo");
        boolean isInsideSecureHardware2 = ((android.security.keystore.KeyInfo) keySpec2).isInsideSecureHardware();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrand.JsApiCryptoGenerateKey", "doPerform, isInsideSecureHardware: " + isInsideSecureHardware2);
        java.lang.String x17 = x(lVar, jc1.f.f380445a, kz5.c1.i(new jz5.l("publicKey", java.nio.ByteBuffer.wrap(genKeyPair.getPublic().getEncoded())), new jz5.l("keyAlias", uuid), new jz5.l("inSecureHardware", java.lang.Boolean.valueOf(isInsideSecureHardware2))));
