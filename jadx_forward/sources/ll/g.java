...
public class g extends ll.d {
    ...
    public android.media.MediaExtractor f400634u;

    /* renamed from: v, reason: collision with root package name */
    public wo.i1 f400635v;

    /* renamed from: w, reason: collision with root package name */
    public ll.k f400636w;

    /* renamed from: x, reason: collision with root package name */
    public java.lang.String f400637x;

    /* renamed from: y, reason: collision with root package name */
    public int f400638y;

    /* renamed from: z, reason: collision with root package name */
    public long f400639z;
    ...
    public void C(hl.d dVar) {
        ...
        kVar.d();
        il.e c17 = il.e.c();
        java.lang.String str = dVar.f363553c;
        synchronized (c17) {
            int i17 = rl.b.f478676a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Mix.AudioCachePathMgr", "append path:%s", str);
            java.lang.String a17 = rl.d.a("" + str.hashCode());
            if (!c17.f373516a.contains(a17)) {
                c17.f373516a.add(a17);
            }
        }
        if (i()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Mix.AudioDecoderMediaCodec", "flushCache", null);
            this.f400617e.b();
        } else if (!h()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Mix.AudioDecoderMediaCodec", "writeCacheAndPlay", null);
            A(dVar);
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Mix.AudioDecoderMediaCodec", "flushCache and readCacheAndPlay", null);
            this.f400617e.b();
            u();
        }
    }
    ...
    public void D(hl.d dVar, java.nio.ByteBuffer byteBuffer, int i17) {
        ...
        this.f400614b.b().getClass();
        this.f400617e.a(this.D);
    }
    ...
    public void E(hl.d dVar, java.nio.ByteBuffer byteBuffer, int i17) {
        ...
        if (bArr == null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Mix.AudioDecoderMediaCodec", "pushBuffer chunk is null", null);
            return;
        }
    ...
    public final void F() {
        try {
            ...
            int i17 = rl.b.f478676a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.Mix.AudioDecoderMediaCodec", e17, "releaseMediaCodec", new java.lang.Object[0]);
        }
    }

    public final void G() {
        try {
            android.media.MediaExtractor mediaExtractor = this.f400634u;
            ...
            int i17 = rl.b.f478676a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.Mix.AudioDecoderMediaCodec", e17, "releaseMediaExtractor", new java.lang.Object[0]);
        }
        try {
            ll.k kVar = this.f400636w;
            if (kVar != null) {
                kVar.close();
                this.f400636w = null;
            }
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.Mix.AudioDecoderMediaCodec", e18, "releaseDataSource", new java.lang.Object[0]);
        }
    }
    ...
    public void H(hl.d dVar, byte[] bArr) {
        hl.e b17 = il.i.a().b();
        b17.f363571f = bArr;
        b17.f363567b = this.f400627o;
        b17.f363568c = this.f400628p;
        b17.f363569d = this.f400638y;
        dVar.m(b17);
        z(b17);
    }
    ...
    public void b() {
        ...
        if (kVar != null) {
            kVar.d();
            this.f400617e.mo143607x41012807();
            this.f400617e = null;
        }
        this.f400618f = null;
        this.f400637x = null;
