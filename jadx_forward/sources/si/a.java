...
public class a {
    ...
    */
    ...
    public final dc.j b(java.lang.String str, dc.m mVar) {
        ...
        fc.n nVar = c17.f310145q;
        int i17 = nVar.f342433d;
        java.lang.Object[] objArr = new java.lang.Object[i17];
        java.lang.Object[] objArr2 = nVar.f342450i;
        ...
        for (int i29 = 0; i29 < i17; i29++) {
            i28 += ((java.util.ArrayList) ((dc.d) objArr[i29]).f310138a).size();
        }
        java.util.ArrayList arrayList2 = new java.util.ArrayList(i28);
        int i37 = nVar.f342433d;
        int[] iArr = new int[i37];
        int[] iArr2 = nVar.f342451m;
        java.lang.Object[] objArr3 = nVar.f342450i;
        ...
        for (int i47 = 0; i47 < i37; i47++) {
            ...
            arrayList2.addAll(dVar == null ? new java.util.ArrayList(0) : dVar.f310138a);
        }
