...
public final class p extends android.media.MediaCodec.Callback {
    ...
    public final /* synthetic */ v22.q f514381a;
    ...
    public void onError(android.media.MediaCodec codec, android.media.MediaCodec.CodecException e17) {
        ...
        v22.q qVar = this.f514381a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(qVar.f514383d, "onError, codec:" + codec + ", " + e17.isRecoverable() + ' ' + e17.isTransient() + ' ' + e17.getDiagnosticInfo());
        if (e17.isRecoverable() || e17.isTransient()) {
            return;
        }
        java.lang.String str = qVar.f514383d;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str, "sendDecoderEos");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str, "release");
        try {
            qVar.f514390k.quit();
            wo.i1 i1Var = qVar.f514384e;
            if (i1Var != null) {
                i1Var.y();
            }
            wo.i1 i1Var2 = qVar.f514384e;
            if (i1Var2 != null) {
                i1Var2.q();
            }
        } catch (java.lang.Exception unused) {
        }
        yz5.a aVar = qVar.f514334b;
        if (aVar != null) {
            aVar.mo152xb9724478();
        }
    }
    ...
    */
    public void onInputBufferAvailable(android.media.MediaCodec r12, int r13) {
        /*
            ...
            v22.q r12 = r11.f514381a
            java.lang.String r1 = r12.f514383d
            ...
            if (r13 < 0) goto La3
            r1 = 0
            boolean r2 = r12.f514388i     // Catch: java.lang.Exception -> L39
            if (r2 != 0) goto La3
            wo.i1 r2 = r12.f514384e     // Catch: java.lang.Exception -> L39
            if (r2 == 0) goto L2e
        ...
        L2f:
            if (r2 != 0) goto L3b
            java.lang.String r13 = r12.f514383d     // Catch: java.lang.Exception -> L39
            java.lang.String r0 = "inputBuffer is null"
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(r13, r0)     // Catch: java.lang.Exception -> L39
            return
        L39:
            r13 = move-exception
            goto L99
        L3b:
            ...
            gp.c r3 = r12.f514386g     // Catch: java.lang.Exception -> L39
            ...
            gp.c r2 = r12.f514386g     // Catch: java.lang.Exception -> L39
            long r8 = r2.b()     // Catch: java.lang.Exception -> L39
            java.lang.String r2 = r12.f514383d     // Catch: java.lang.Exception -> L39
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r2, r0)     // Catch: java.lang.Exception -> L39
            long r2 = r12.f514389j     // Catch: java.lang.Exception -> L39
            int r0 = (r8 > r2 ? 1 : (r8 == r2 ? 0 : -1))
            if (r0 <= 0) goto L73
            r12.f514389j = r8     // Catch: java.lang.Exception -> L39
        L73:
            if (r7 < 0) goto L7e
            r2 = 0
            int r0 = (r8 > r2 ? 1 : (r8 == r2 ? 0 : -1))
        ...
        L7c:
            ...
            goto L87
        L7e:
            java.lang.String r0 = r12.f514383d     // Catch: java.lang.Exception -> L39
            java.lang.String r2 = "read sample end"
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r0, r2)     // Catch: java.lang.Exception -> L39
            r0 = 1
        L87:
            r12.f514388i = r0     // Catch: java.lang.Exception -> L39
            wo.i1 r4 = r12.f514384e     // Catch: java.lang.Exception -> L39
            if (r4 == 0) goto La3
            r6 = 0
            if (r0 == 0) goto L93
            r0 = 4
        ...
        L94:
            ...
            goto La3
        L99:
            java.lang.String r12 = r12.f514383d
            java.lang.String r0 = "onInputBufferAvailable"
            java.lang.Object[] r1 = new java.lang.Object[r1]
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r12, r13, r0, r1)
        La3:
            return
        */
    ...
    */
    public void onOutputBufferAvailable(android.media.MediaCodec r9, int r10, android.media.MediaCodec.BufferInfo r11) {
        /*
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(r11, r9)
            v22.q r9 = r8.f514381a
            java.lang.String r1 = r9.f514383d
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            ...
            long r6 = r9.f514389j     // Catch: java.lang.Exception -> La3
            r5.append(r6)     // Catch: java.lang.Exception -> La3
            java.lang.String r0 = r5.toString()     // Catch: java.lang.Exception -> La3
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r0)     // Catch: java.lang.Exception -> La3
            wo.i1 r0 = r9.f514384e     // Catch: java.lang.Exception -> La3
            r5 = 1
            if (r0 == 0) goto L59
            r0.s(r10, r5)     // Catch: java.lang.Exception -> La3
        L59:
            v22.q.d(r9, r11)     // Catch: java.lang.Exception -> La3
            boolean r10 = r9.f514388i     // Catch: java.lang.Exception -> La3
            if (r10 == 0) goto L70
            r6 = 0
        ...
        L76:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r10)     // Catch: java.lang.Exception -> La3
            android.os.HandlerThread r10 = r9.f514390k     // Catch: java.lang.Exception -> L9b
            r10.quit()     // Catch: java.lang.Exception -> L9b
            wo.i1 r10 = r9.f514384e     // Catch: java.lang.Exception -> L9b
            if (r10 == 0) goto L94
        ...
        L9b:
            yz5.a r9 = r9.f514334b     // Catch: java.lang.Exception -> La3
            if (r9 == 0) goto La2
            r9.mo152xb9724478()     // Catch: java.lang.Exception -> La3
        La2:
            return
        La3:
            r9 = move-exception
            goto Lad
        La5:
            wo.i1 r9 = r9.f514384e     // Catch: java.lang.Exception -> La3
            if (r9 == 0) goto Lb5
        ...
        Lad:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r1, r9, r10, r11)
        Lb5:
            return
        */
    ...
    public void onOutputFormatChanged(android.media.MediaCodec codec, android.media.MediaFormat format) {
        ...
        v22.q qVar = this.f514381a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(qVar.f514383d, "onOutputFormatChanged " + format);
        qVar.f514385f = format;
    }
}
