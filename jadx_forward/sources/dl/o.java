...
public class o implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ dl.t f316648d;
    ...
    public void onAnimationUpdate(android.animation.ValueAnimator valueAnimator) {
        ...
        dl.t tVar = this.f316648d;
        xk0.c cVar = tVar.D;
        cVar.getClass();
        xk0.c.f536462t.setAlpha(intValue2);
        xk0.c.f536458p.setAlpha(intValue2);
        int i17 = (int) (intValue2 * 0.7058824f);
        cVar.f536467g = i17;
        xk0.c.f536461s.setAlpha(i17);
        cVar.f536468h = cVar.f536467g;
        tVar.D.getClass();
        xk0.c.f536460r.setAlpha((int) (intValue * 0.9019608f));
        tVar.r();
    }
}
