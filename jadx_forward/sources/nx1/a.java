...
public class a extends android.text.SpannableString {
    ...
    public java.lang.Object[] f422808d;
    ...
    public a(java.lang.CharSequence charSequence) {
        ...
        this.f422808d = new java.lang.Object[20];
        this.f422809e = new int[60];
    ...
    public int getSpanEnd(java.lang.Object obj) {
        int i17 = this.f422810f;
        java.lang.Object[] objArr = this.f422808d;
        int[] iArr = this.f422809e;
    ...
    public void setSpan(java.lang.Object obj, int i17, int i18, int i19) {
        ...
        if (i28 >= objArr.length) {
            ...
            java.lang.System.arraycopy(this.f422809e, 0, iArr, 0, this.f422810f * 3);
            this.f422808d = objArr2;
            this.f422809e = iArr;
        }
        java.lang.Object[] objArr3 = this.f422808d;
        int i37 = this.f422810f;
        objArr3[i37] = obj;
        int[] iArr2 = this.f422809e;
        iArr2[(i37 * 3) + 0] = i17;
        iArr2[(i37 * 3) + 1] = i18;
        iArr2[(i37 * 3) + 2] = i19;
        this.f422810f = i37 + 1;
