...
public final class x implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.widget.TextView f538625d;

    public x(android.widget.TextView textView) {
        this.f538625d = textView;
    }
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator it) {
        ...
        android.widget.TextView textView = this.f538625d;
