...
public final class v implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ k23.x f385237d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.animation.ValueAnimator f385238e;

    public v(k23.x xVar, android.animation.ValueAnimator valueAnimator) {
        this.f385237d = xVar;
        this.f385238e = valueAnimator;
    }

    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    public final void onAnimationUpdate(android.animation.ValueAnimator it) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(it, "it");
        android.view.View view = this.f385237d.f385278q;
        java.lang.Object animatedValue = this.f385238e.getAnimatedValue();
