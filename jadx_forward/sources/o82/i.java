...
public final class i extends i95.w implements o72.u4 {
    public void Ai(android.content.Intent intent, java.lang.String searchId, long j17, int i17) {
        ...
        try {
            fq0Var.mo11468x92b714fd(intent.getByteArrayExtra("key_fav_search_report_obj"));
            v82.b bVar = new v82.b();
            if (!bVar.d(fq0Var)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ReportSearchCTR", "this FavSearchReportObj is null");
                return;
            }
            bVar.f515606g = searchId;
            bVar.f515600a = i17;
            bVar.f515603d = ((int) (java.lang.System.currentTimeMillis() - j17)) / 1000;
            bVar.b();
    ...
    public void wi(android.content.Context context, java.lang.String searchId, long j17, int i17) {
        ...
        v82.b bVar = new v82.b();
        if (!bVar.d(fq0Var)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ReportSearchCTR", "this page is not open from fav search");
            return;
        }
        bVar.f515606g = searchId;
        bVar.f515600a = i17;
