    ...
    */
    public final android.content.ServiceConnection a(android.content.Intent r7, android.content.ServiceConnection r8) {
        /*
            ...
            r2 = 0
            if (r7 == 0) goto L4a
            android.content.Context r3 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a     // Catch: java.lang.Throwable -> La2
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(r7, r3)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L30 java.lang.Throwable -> La2
        ...
        L32:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(r4, r7)     // Catch: java.lang.Throwable -> La2
        L47:
            r7 = r2
            r2 = r3
            goto L4b
        ...
        L4b:
            ...
            if (r1 != 0) goto La0
            l85.r0 r1 = l85.s0.f398741d     // Catch: java.lang.Throwable -> La2
            jz5.g r1 = l85.s0.f398742e     // Catch: java.lang.Throwable -> La2
            java.lang.Object r1 = r1.mo141623x754a37bb()     // Catch: java.lang.Throwable -> La2
            java.util.HashMap r1 = (java.util.HashMap) r1     // Catch: java.lang.Throwable -> La2
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(r2)     // Catch: java.lang.Throwable -> La2
        ...
        L6c:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r0)     // Catch: java.lang.Throwable -> La2
