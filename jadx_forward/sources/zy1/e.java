...
public final class e {
    ...
    public static final zy1.e f558858a = new zy1.e();

    /* renamed from: b, reason: collision with root package name */
    public static final android.util.SparseArray f558859b = new android.util.SparseArray();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.HashMap f558860c = new java.util.HashMap();

    /* renamed from: d, reason: collision with root package name */
    public static final android.util.SparseArray f558861d = new android.util.SparseArray();

    public final jx3.a a(int i17, boolean z17) {
        jx3.a aVar;
        android.util.SparseArray sparseArray = f558859b;
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.KVReportManager", "getInstance " + i17 + " error");
            aVar = null;
        }
        jx3.a aVar3 = aVar;
    ...
    public final void b(int i17, java.lang.String key, int i18) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.e(f17, "null cannot be cast to non-null type kotlin.Int");
    ...
    public final void c(int i17, java.lang.String key) {
        long longValue;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        java.lang.Long l17 = (java.lang.Long) f558860c.remove(i17 + '-' + key);
        if (l17 == null) {
            l17 = -1L;
        }
        long longValue2 = l17.longValue();
        if (longValue2 <= 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.KVReportManager", "report:" + i17 + " key:" + key + " error!");
            return;
        }
        jx3.a a17 = a(i17, true);
        if (a17 == null) {
    ...
    public final void d(int i17, java.lang.String key) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        java.util.HashMap hashMap = f558860c;
    ...
    public final void e(int i17, java.lang.String key, java.lang.Object unique) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(unique, "unique");
        android.util.SparseArray sparseArray = f558861d;
        ...
        while (true) {
            if (!it.hasNext()) {
                ...
                obj = it.next();
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((zy1.h) obj).f558865a, key)) {
                    break;
                }
            }
        }
        ...
        hVar.f558866b.add(unique.toString());
        unique.toString();
        hVar.f558866b.size();
    }
}
