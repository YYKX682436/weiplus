...
public final class f extends lf3.n implements zf3.a {
    ...
    public final void W6(java.lang.String str, java.lang.String str2, mf3.k kVar) {
        if (kVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MediaGallery.DiskForwardComponent", "onUserConfirmed return, data null");
            return;
        }
        int ordinal = kVar.mo2109xfb85f7b0().ordinal();
        ...
        if (ordinal == 1) {
            ...
            if (strArr.length == 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MediaGallery.DiskForwardComponent", "want to send record msg, but toUser is null");
                return;
            }
            ...
            ((ku5.t0) ku5.t0.f394148d).g(new fi5.c(strArr, this, kVar, str2, new fi5.d(Q)));
            return;
        }
        if (ordinal != 2) {
            return;
        ...
        if (cVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MediaGallery.DiskForwardComponent", "parser recordMediaInfo null");
            return;
        }
        ...
        for (java.lang.String str3 : strArr2) {
            ...
            r45.gp0 gp0Var = cVar.f86740a;
            com.p314xaae8f345.mm.p1006xc5476f33.fav.ui.x5.j(m158354x19263085, str3, g19, h17, gp0Var.f456981y, "", eVar, gp0Var.f456964q2);
    ...
    public void mo2273x9d4787cb(int i17, int i18, android.content.Intent intent) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MediaGallery.DiskForwardComponent", "onActivityResult return, data invalid. toUsers: ".concat(str));
    }
    ...
    public void z4(mf3.k mediaInfo, java.lang.String userName) {
        ...
        this.f344611d = mediaInfo;
        if (!(userName.length() == 0)) {
            fi5.a aVar = new fi5.a(this, userName, mediaInfo);
            co.a V6 = V6(mediaInfo);
            if (V6 == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MediaGallery.DiskForwardComponent", "openConfirmDialog return, model invalid");
                return;
            }
