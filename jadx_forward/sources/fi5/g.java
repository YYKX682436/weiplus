...
public final class g extends lf3.n implements qf3.b, wf3.a {
    ...
    public void mo2275x62f76871(android.content.Intent intent) {
        if (m158359x1e885992().getBooleanExtra("view_only", true)) {
            super.mo2275x62f76871(intent);
            return;
        }
        android.content.Intent intent2 = new android.content.Intent(intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.Iterator<E> it = this.f344613e.iterator();
        while (it.hasNext()) {
