...
public class e {
    ...
    public static final java.util.regex.Pattern f530233b = java.util.regex.Pattern.compile("-?(?:0|[1-9]\\d*)(?:\\.\\d+)?(?:[eE][+-]?\\d+)?");

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.Object f530234c = new wq5.d(null);

    /* renamed from: a, reason: collision with root package name */
    public final java.util.Map f530235a;

    public e() {
        this.f530235a = new java.util.HashMap();
    }
    ...
    */
    ...
    public static java.lang.Object j(java.lang.Object obj) {
        try {
            java.lang.Object obj2 = f530234c;
            if (obj2.equals(obj)) {
                return obj2;
            }
    ...
    public static final java.io.Writer l(java.io.Writer writer, java.lang.Object obj, int i17, int i18) {
        if (obj == null || obj.equals(null)) {
            ...
            if (f530233b.matcher(obj2).matches()) {
                writer.write(obj2);
            } else {
                f(obj2, writer);
            }
    ...
    public wq5.e e(java.lang.String str, java.lang.Object obj) {
        ...
        java.util.Map map = this.f530235a;
        if (obj != null) {
            i(obj);
    ...
    public java.lang.String m174329x9616526c() {
        java.lang.String obj;
        try {
            java.io.StringWriter stringWriter = new java.io.StringWriter();
            synchronized (stringWriter.getBuffer()) {
    ...
    public e(java.util.Map map) {
        ...
        this.f530235a = new java.util.HashMap(map.size());
        for (java.util.Map.Entry entry : map.entrySet()) {
            if (entry.getKey() != null) {
                java.lang.Object value = entry.getValue();
                if (value != null) {
                    this.f530235a.put(java.lang.String.valueOf(entry.getKey()), j(value));
                }
            } else {
                throw new java.lang.NullPointerException("Null key.");
            }
