...
public abstract class u {
    ...
    public static final o11.g f528842a;

    /* renamed from: b, reason: collision with root package name */
    public static final o11.g f528843b;

    /* renamed from: c, reason: collision with root package name */
    public static long f528844c;
    ...
    static {
        ...
        fVar2.f423611b = true;
        fVar2.f423612c = true;
        fVar2.f423624o = com.p314xaae8f345.mm.R.C30861xcebc809e.bhm;
        f528843b = fVar2.a();
        f528844c = 0L;
    }
    ...
    public static void a(java.util.List list) {
        ...
        yVar.f528850a = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.lpz);
        yVar.f528851b = 20002;
        yVar.f528854e = m(20002);
        yVar.f528853d = 14;
        yVar.f528852c = 1011;
        list.add(yVar);
    }
    ...
    public static int d(java.lang.String str) {
        ...
        xVar.f528849a = ((wn2.f) ((zy2.sb) i95.n0.c(zy2.sb.class))).Bi();
        ...
        while (true) {
            ...
            if (yVar.f528869t.equals(str)) {
                return yVar.f528851b;
            }
            i17++;
        }
    }
    ...
    public static org.json.JSONObject f(wm4.y yVar) {
        ...
        try {
            ...
            for (int i17 = 0; i17 < jSONArray.length(); i17++) {
                ...
                if (jSONObject.getInt("category") == yVar.f528851b) {
                    return jSONObject;
                }
            }
        } catch (org.json.JSONException e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.TopStory.TopStoryUILogic", "parse cur tab config failed: %s", e17.getMessage());
        }
        return new org.json.JSONObject();
    }
    ...
    public static int g() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TopStory.TopStoryUILogic", "getEnterTabCategory, lastTabCategoryFix:%s enterTabCategory:%s", java.lang.Integer.valueOf(k17), java.lang.Integer.valueOf(u17));
        return u17;
    }

    public static int h(com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1449xdb7d1c3f.p1450xc846b718.jb jbVar) {
        int m75939xb282bd08;
        if (jbVar != null && jbVar.f65874xb5f7102a.f470021f != null) {
            try {
                r45.xs2 xs2Var = new r45.xs2();
                com.p314xaae8f345.mm.p2495xc50a8b8b.g gVar = jbVar.f65874xb5f7102a.f470021f;
                java.util.Objects.requireNonNull(gVar);
                xs2Var.mo11468x92b714fd(gVar.f273689a);
                m75939xb282bd08 = xs2Var.m75939xb282bd08(9);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TopStory.TopStoryUILogic", "getEnterTabCategoryByRedDotCtrInfo: displayTabType:%s", java.lang.Integer.valueOf(m75939xb282bd08));
            } catch (java.lang.Throwable th6) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.TopStory.TopStoryUILogic", th6, "getEnterTabCategoryByRedDotCtrInfo", new java.lang.Object[0]);
            }
            if (m75939xb282bd08 == 9) {
                return 20002;
            }
    ...
    public static final java.lang.String i() {
        ...
        c6172x8b8bc1ba.f136431g.f88042a = 3;
        c6172x8b8bc1ba.e();
        r45.in6 in6Var = c6172x8b8bc1ba.f136432h.f88151b;
        java.lang.String str = in6Var != null ? in6Var.f458724p : "";
        return com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) ? java.util.UUID.randomUUID().toString() : str;
    }

    public static int j() {
        int r17 = gm0.j1.u().c().r(com.p314xaae8f345.mm.p2621x8fb0427b.u3.USERINFO_TOP_STORY_LAST_ENTER_TAB_REC_INT, 0);
        if (!pm4.w.l(r17) || gm0.j1.u().c().r(com.p314xaae8f345.mm.p2621x8fb0427b.u3.USERINFO_TOP_STORY_HAS_HAOKAN_RESULT_INT, 1) == 1) {
            return r17;
        }
        return 700;
    }
    ...
    public static int k() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TopStory.TopStoryUILogic", "getLastTabCategoryFix, haokanFirst:%s showNewLifeEntry:%s", java.lang.Boolean.valueOf(z17), java.lang.Boolean.FALSE);
        int j17 = j();
        ...
        try {
            ...
            while (true) {
                ...
                if (i17 < jSONArray.length()) {
                    org.json.JSONObject jSONObject = jSONArray.getJSONObject(i17);
                    wm4.y yVar = new wm4.y();
                    yVar.f528851b = jSONObject.getInt("category");
                    yVar.f528852c = jSONObject.optInt("searchScene", 0);
                    yVar.f528853d = jSONObject.optInt("searchType", 0);
                    yVar.f528868s = jSONObject.optInt("reddotTabType", 0);
                    yVar.f528869t = jSONObject.optString("reddotPath", "");
                    yVar.f528870u = jSONObject.optInt("finderCommentScene", 0);
                    java.lang.String d17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.m2.d();
                    if (d17.equals("zh_TW")) {
                        yVar.f528850a = jSONObject.getString("wording_tw");
                    } else if (d17.equals("zh_HK")) {
                        yVar.f528850a = jSONObject.getString("wording_hk");
                    } else if (d17.equals("zh_CN")) {
                        yVar.f528850a = jSONObject.getString("wording_cn");
                    } else {
                        yVar.f528850a = jSONObject.getString("wording_en");
                    }
                    if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(yVar.f528850a)) {
                        arrayList.clear();
                        return arrayList;
                    }
                    jSONObject.getInt("showWhenRedDot");
                    yVar.f528854e = jSONObject.getString("tabInfo");
                    if (pm4.w.l(yVar.f528851b)) {
                        ...
                        if (s17 > 0 && (r17 = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().r()) != null) {
                            yVar.f528861l = r17.f465646d;
                        }
                        if (yVar.f528855f > 0 && (qn6Var = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().f427967b) != null) {
                            yVar.f528857h = qn6Var.f465646d;
                        }
                    } else if (pm4.w.m(yVar.f528851b)) {
                        if (!((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().d()) {
                            i19 = 0;
                        }
                        yVar.f528855f = i19;
                        if (i19 > 0) {
                            yVar.f528857h = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().f427966a.f465646d;
                        }
                    } else if (pm4.w.n(yVar.f528851b)) {
                        int i27 = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().f() ? 1 : 0;
                        yVar.f528855f = i27;
                        if (i27 > 0) {
                            yVar.f528857h = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().f427968c.f465646d;
                        }
                        if (xVar != null && xVar.f528849a == 1) {
                            yVar.f528850a = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.lpz);
                            yVar.f528851b = 20002;
                            yVar.f528854e = m(20002);
                            yVar.f528871v = 50030;
                            yVar.f528872w = com.p314xaae8f345.p3006xb8ff1437.api.C26181xd678f817.f50613xc9bdf6cd;
                    ...
                    arrayList.add(yVar);
                    if (pm4.w.n(yVar.f528851b) && xVar != null && xVar.f528849a == 2) {
                        a(arrayList);
                    }
                    i17++;
                } else if (xVar != null && xVar.f528849a == 1) {
                    if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L0(arrayList)) {
                        for (int i28 = 0; i28 < arrayList.size(); i28++) {
                            wm4.y yVar2 = (wm4.y) arrayList.get(i28);
                            if (!pm4.w.n(yVar2.f528851b) && !pm4.w.k(yVar2.f528851b)) {
                            }
                            z17 = true;
                        }
                    }
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.TopStory.TopStoryUILogic", "parse tabconfig failed: %s", e17.getMessage());
            arrayList.clear();
        }
        return arrayList;
    }
    ...
    public static wm4.y n(int i17, java.util.List list) {
        ...
        for (int i18 = 0; i18 < list.size(); i18++) {
            if (((wm4.y) list.get(i18)).f528851b == i17 || (((wm4.y) list.get(i18)).f528851b == 700 && pm4.w.l(i17))) {
    ...
    public static final java.lang.String p(int i17) {
        java.lang.String string = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getString(com.p314xaae8f345.mm.R.C30867xcad56011.k08);
        if (j65.c.b(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a) >= i65.a.s(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a)) {
            return string;
        }
        if (i17 > 0 && "zh_CN".equalsIgnoreCase(com.p314xaae8f345.mm.sdk.p2603x2137b148.m2.f(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a))) {
            if (i17 > 99999) {
                return string + java.lang.String.format(" 10%s+", com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getString(com.p314xaae8f345.mm.R.C30867xcad56011.jzv));
            }
            if (i17 > 9999) {
                return string + java.lang.String.format(" %.1f%s", java.lang.Float.valueOf(i17 / 10000.0f), com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getString(com.p314xaae8f345.mm.R.C30867xcad56011.jzv));
            }
            return string + " " + i17;
        }
        if (i17 > 99999) {
            return string + java.lang.String.format(" 100%s+", com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getString(com.p314xaae8f345.mm.R.C30867xcad56011.jzu));
        }
        if (i17 > 999) {
            return string + java.lang.String.format(" %.1f%s", java.lang.Float.valueOf(i17 / 1000.0f), com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getString(com.p314xaae8f345.mm.R.C30867xcad56011.jzu));
        }
        if (i17 <= 0) {
            return string;
        }
    ...
    public static boolean q() {
        if (!((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.d0.clicfg_topstory_top_multitask, false) && bm5.o1.f104252a.h(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2567xc9fa65a8.C20682x748019a9()) != 1) {
            return false;
        }
        ((ra0.v) i95.n0.c(ra0.v.class)).getClass();
    ...
    public static boolean r() {
        return ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.d0.clicfg_topstory_videotab_liteapp_android, false) || bm5.o1.f104252a.h(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2567xc9fa65a8.C20683xb1e9a974()) == 1;
    }
    ...
    public static void s(java.util.List list, java.lang.String str, java.lang.String str2, boolean z17) {
        ...
        x50Var.f471321d = "redPointMsgId";
        x50Var.f471323f = java.lang.String.valueOf(str);
        list.add(x50Var);
        r45.x50 x50Var2 = new r45.x50();
        x50Var2.f471321d = "currentPage";
        x50Var2.f471322e = 1L;
        list.add(x50Var2);
        r45.x50 x50Var3 = new r45.x50();
        x50Var3.f471321d = "is_prefetch";
        x50Var3.f471322e = 0L;
        list.add(x50Var3);
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str2)) {
            r45.x50 x50Var4 = new r45.x50();
            x50Var4.f471321d = com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.Common.f54497x63979feb;
            x50Var4.f471323f = str2;
            list.add(x50Var4);
            r45.x50 x50Var5 = new r45.x50();
            x50Var5.f471321d = "requestId";
            x50Var5.f471323f = str2;
            list.add(x50Var5);
        }
        r45.x50 x50Var6 = new r45.x50();
        x50Var6.f471321d = "recType";
        x50Var6.f471322e = 0L;
        list.add(x50Var6);
        if (z17) {
            r45.x50 x50Var7 = new r45.x50();
            x50Var7.f471321d = com.p314xaae8f345.map.p490x3f94e06.p491x35c0ce.InterfaceC4218x687499fa.f16225x785081d0;
            x50Var7.f471322e = 1L;
            list.add(x50Var7);
            r45.x50 x50Var8 = new r45.x50();
            x50Var8.f471321d = "time_zone_min";
            java.util.TimeZone timeZone = java.util.TimeZone.getDefault();
            x50Var8.f471323f = "" + (((0 - timeZone.getOffset(java.util.Calendar.getInstance(timeZone).getTimeInMillis())) / 1000) / 60);
            list.add(x50Var8);
        }
    }
    ...
    public static void t(android.content.Context context, java.lang.String str) {
        ...
        if (q()) {
            com.p314xaae8f345.mm.p1006xc5476f33.p2393xf1c361fc.l2.i(context, ".ui.home.TopStoryTabSettingAffinityUI", intent);
        } else {
            com.p314xaae8f345.mm.p1006xc5476f33.p2393xf1c361fc.l2.i(context, ".ui.home.TopStorySettingUI", intent);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0082, code lost:
        ...
        if (r5.f465657r > (-1)) goto L16;
     */
    /* JADX WARN: Code restructure failed: missing block: B:187:0x0865, code lost:
    
        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(r0, ra0.a0.f474992b) != false) goto L317;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x00db, code lost:
    
        if (r13.f465657r > r16) goto L30;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:331:0x0328, code lost:
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.TopStory.TopStoryUILogic", r0, "parse msg.params extReqParam", new java.lang.Object[0]);
     */
    ...
    */
    ...
    public static void v(android.content.Context context, r45.in6 in6Var) {
        ...
        org.json.JSONObject jSONObject = new org.json.JSONObject();
        try {
            jSONObject.put(com.p314xaae8f345.p347x615374d.p349x208df1fe.p358xd1075a44.p360x696c9db.C3365xfbc5fb5e.f13305x20d82714, "good-look-history");
            jSONObject.put("subscene", 6);
            jSONObject.put("tagId", 10802);
            jSONObject.put("nickname", java.net.URLEncoder.encode(gm0.j1.u().c().l(4, null) != null ? (java.lang.String) gm0.j1.u().c().l(4, null) : "", com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.TopStory.TopStoryUILogic", e17, "goUserProfiler", new java.lang.Object[0]);
        }
        java.util.HashMap hashMap = new java.util.HashMap();
        hashMap.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54548xbbf10811, java.lang.String.valueOf(21));
        hashMap.put(com.p314xaae8f345.p362xadfe2b3.p372x8fb0427b.C3712x3ed8a441.f14354xe2e3e984, in6Var.f458716e);
        ...
        hashMap.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.Common.f54497x63979feb, valueOf);
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.TopStory.TopStoryUILogic", e18, "", new java.lang.Object[0]);
        }
        ...
        in6Var2.f458715d = "";
        in6Var2.f458719h = "";
        in6Var2.f458722n = valueOf;
        in6Var2.f458716e = in6Var.f458716e;
        in6Var2.f458717f = in6Var.f458717f;
        in6Var2.f458729u = 2;
        in6Var2.f458721m = pm4.w.e(hashMap);
        in6Var2.f458730v = context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.k09);
        in6Var2.f458727s = 10802;
        in6Var2.f458731w = com.p314xaae8f345.mm.p1006xc5476f33.p2393xf1c361fc.l2.b();
        in6Var2.f458734z = context.getResources().getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.aaw);
        r45.x50 x50Var = new r45.x50();
        x50Var.f471321d = "rec_category";
        int i17 = in6Var.f458727s;
        x50Var.f471322e = i17;
        x50Var.f471323f = java.lang.String.valueOf(i17);
    ...
    public static void w(android.content.Context context, r45.in6 in6Var, java.lang.String str, boolean z17, int i17) {
        s(in6Var.f458723o, "", str, false);
        long c17 = c01.id.c();
        pm4.y.f(in6Var, "clickTopStory", c17);
        java.util.LinkedList linkedList = in6Var.f458725q;
        if (linkedList.size() == 0) {
            r45.tn6 tn6Var = new r45.tn6();
            tn6Var.f468150d = "clickTopStory";
            tn6Var.f468151e = c17;
            linkedList.add(tn6Var);
        }
        android.content.Intent intent = new android.content.Intent();
        try {
            intent.putExtra("key_context", in6Var.mo14344x5f01b1f6());
        } catch (java.io.IOException unused) {
        }
        intent.putExtra("key_navbarbgcolortype", i17);
        com.p314xaae8f345.mm.p1006xc5476f33.p2393xf1c361fc.l2.i(context, ".ui.home.TopStoryTabHomeUI", intent);
    }

    public static final java.lang.String x(r45.in6 in6Var) {
        java.util.LinkedList linkedList;
        java.util.Collections.sort(in6Var.f458725q, new wm4.v());
        java.lang.StringBuffer stringBuffer = new java.lang.StringBuffer();
        int i17 = 1;
        while (true) {
            linkedList = in6Var.f458725q;
            if (i17 >= linkedList.size()) {
                break;
            }
            int i18 = i17 - 1;
            stringBuffer.append(((r45.tn6) linkedList.get(i18)).f468150d);
            stringBuffer.append("->");
            stringBuffer.append(((r45.tn6) linkedList.get(i17)).f468150d);
            stringBuffer.append(":");
            stringBuffer.append(((r45.tn6) linkedList.get(i17)).f468151e - ((r45.tn6) linkedList.get(i18)).f468151e);
            stringBuffer.append("\n");
            i17++;
        }
        if (linkedList.size() > 2) {
            stringBuffer.append("TotalUseTime:");
            stringBuffer.append(((r45.tn6) linkedList.get(linkedList.size() - 1)).f468151e - ((r45.tn6) linkedList.get(0)).f468151e);
            stringBuffer.append("\n");
        }
        linkedList.clear();
    ...
    public static final java.lang.String y(wm4.x xVar, java.util.List list) {
        if (list == null || list.size() == 0) {
            ...
            return "longVideoSwitch=" + xVar.f528849a;
        }
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        if (xVar != null) {
            sb6.append("longVideoSwitch=");
            sb6.append(xVar.f528849a);
            sb6.append(";");
        }
