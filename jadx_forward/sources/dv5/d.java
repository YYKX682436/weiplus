...
public final class d {
    ...
    public void a(dv5.e eVar) {
        int i17;
        int i18;
        dv5.g gVar = this.f325572a;
        int i19 = 0;
        gVar.f325568a.f348556f = 0;
        gVar.f325569b = 0;
        while (true) {
            int i27 = gVar.f325569b;
            boolean z17 = true;
            if ((i27 < gVar.f325596c.length ? 1 : i19) == 0) {
                return;
            }
            int b17 = gVar.b();
            int i28 = b17 & 255;
