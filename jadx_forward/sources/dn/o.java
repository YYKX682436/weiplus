...
public class o extends dn.m {
    ...
    public boolean f323346a2;

    /* renamed from: b2, reason: collision with root package name */
    public java.lang.String f323347b2;

    /* renamed from: c2, reason: collision with root package name */
    public dn.n f323348c2;
    ...
    public java.lang.String mo122618x9616526c() {
        ...
        stringBuffer.append(this.f69610x4f5245a8);
        stringBuffer.append(" initialDownloadLength : ");
        stringBuffer.append(this.f323336v);
        stringBuffer.append(" initialDownloadOffset : ");
        stringBuffer.append(this.f323337w);
        ...
        if (i()) {
            ...
            stringBuffer.append(this.f69601xaca5bdda);
        }
        stringBuffer.append(" fileid : ");
        stringBuffer.append(this.f69591xf9dbbe9c);
        stringBuffer.append(" fileaeskey: ");
        stringBuffer.append(this.f69575xf11df5f5);
        stringBuffer.append(" field_preloadRatio:");
        stringBuffer.append(this.f69608x6ac8fea7);
        ...
        stringBuffer.append(this.f323347b2);
        stringBuffer.append(" concurrentCount: ");
        stringBuffer.append(this.f323342y0);
        stringBuffer.append("}");
