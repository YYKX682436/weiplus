...
public final class a0 extends gl5.q {
    ...
    public int mo131738x43d18c6c() {
        boolean u17 = u();
        gl5.e0 e0Var = this.V;
        return u17 ? e0Var.U.m81687x6f2c472c() : e0Var.U.m81686xffd93625();
    }
    ...
    public void n(int i17, boolean z17, boolean z18) {
        ...
        if (i17 != -1) {
            kl5.b q17 = this.V.q();
            q17.b(i17);
            if (!q17.f390513d.isBoundary(i17)) {
                z19 = true;
                this.P = z19;
            }
        }
    ...
    */
    ...
    public void s(int i17) {
        ...
        gl5.e0 e0Var = this.V;
        if (u17) {
            android.text.Selection.setSelection((android.text.Spannable) e0Var.U.mo81602xfb85ada3(), i17, e0Var.U.m81686xffd93625());
        } else {
            android.text.Selection.setSelection((android.text.Spannable) e0Var.U.mo81602xfb85ada3(), e0Var.U.m81687x6f2c472c(), i17);
        }
        p(false);
    ...
    public final void v(int i17, boolean z17) {
        boolean u17 = u();
        gl5.e0 e0Var = this.V;
        int m81686xffd93625 = u17 ? e0Var.U.m81686xffd93625() : e0Var.U.m81687x6f2c472c();
        if ((u() && i17 >= m81686xffd93625) || (!u() && i17 <= m81686xffd93625)) {
            this.Q = 0.0f;
            android.text.Layout m81661x22f21e20 = e0Var.U.m81661x22f21e20();
            if (m81661x22f21e20 != null && i17 != m81686xffd93625) {
                float t17 = t(m81661x22f21e20, i17, u());
                float t18 = t(m81661x22f21e20, m81686xffd93625, !u());
                float t19 = t(m81661x22f21e20, this.f354610z, u());
                if ((t19 < t18 && t17 < t18) || (t19 > t18 && t17 > t18)) {
                    int mo131738x43d18c6c = mo131738x43d18c6c();
                    if (!u()) {
                        java.lang.Math.max(mo131738x43d18c6c - 1, 0);
                    }
                    n(u() ? (int) 0 : jl5.b.c(0L), false, z17);
                    return;
                }
            }
            i17 = e0Var.l(m81686xffd93625, !u());
        }
        n(i17, false, z17);
    }
}
