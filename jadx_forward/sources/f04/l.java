...
public abstract class l {
    ...
    public static final int[] f339960a = {480, com.p314xaae8f345.p3121x37984a.C26884x28705875.f57795xccece4df, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.km.f131633e, 240};
    ...
    public static byte[] a(android.graphics.Bitmap bitmap, int i17) {
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ScanImageJpegCompressUtils", e17, "compressImageByQuality exception", new java.lang.Object[0]);
            return null;
        }
    }
    ...
    */
    ...
    public static android.graphics.Bitmap c(java.lang.String str, int i17) {
        ...
        try {
            ...
            int i29 = point.x;
            int i37 = point.y;
            options.inSampleSize = com.p314xaae8f345.mm.sdk.p2603x2137b148.x.f(options.outWidth, options.outHeight, i29, i37);
            options.inJustDecodeBounds = false;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ScanImageJpegCompressUtils", "resizeImage width: %d, height: %d, targetWidth: %d, targetHeight: %d, sampleSize: %d", java.lang.Integer.valueOf(options.outWidth), java.lang.Integer.valueOf(options.outHeight), java.lang.Integer.valueOf(i29), java.lang.Integer.valueOf(i37), java.lang.Integer.valueOf(options.inSampleSize));
            android.graphics.Bitmap J2 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x.J(str, options);
            return (J2 == null || J2.isRecycled() || J2.getWidth() <= i29) ? J2 : com.p314xaae8f345.mm.sdk.p2603x2137b148.x.S(J2, i37, i29, false, true);
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ScanImageJpegCompressUtils", e17, "resizeImage exception", new java.lang.Object[0]);
            return null;
        }
    }
}
