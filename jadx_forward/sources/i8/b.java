...
public class b extends java.io.FilterInputStream {
    ...
    public void mark(int i17) {
        try {
            this.f371039d = ((java.io.FileInputStream) ((java.io.FilterInputStream) this).in).getChannel().position();
    ...
    @Override // java.io.FilterInputStream, java.io.InputStream
    public void reset() {
        ((java.io.FileInputStream) ((java.io.FilterInputStream) this).in).getChannel().position(this.f371039d);
    }
}
