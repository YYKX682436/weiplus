...
public class y implements u32.a0 {
    ...
    public final android.os.IBinder f505931d;

    public y(android.os.IBinder iBinder) {
        this.f505931d = iBinder;
    }
    ...
    public boolean Di(u32.d0 d0Var) {
        ...
        try {
            ...
            this.f505931d.transact(9, obtain, obtain2, 0);
    ...
    public boolean Hg(long j17) {
        ...
        try {
            ...
            this.f505931d.transact(17, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public long L1(u32.w0 w0Var) {
        ...
        try {
            ...
            this.f505931d.transact(7, obtain, obtain2, 0);
            obtain2.readException();
    ...
    public long[] N3() {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.exdevice.service.IBTDeviceManager_AIDL");
            this.f505931d.transact(3, obtain, obtain2, 0);
            obtain2.readException();
    ...
    public boolean N9(java.lang.String str, boolean z17, u32.z0 z0Var) {
        ...
        try {
            ...
            this.f505931d.transact(13, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean b5(int i17, u32.g0 g0Var) {
        ...
        try {
            ...
            this.f505931d.transact(14, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean b7(long j17, int i17, u32.j0 j0Var) {
        ...
        try {
            ...
            this.f505931d.transact(4, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean gi(int i17, u32.g0 g0Var) {
        ...
        try {
            ...
            obtain.writeInt(i17);
            obtain.writeStrongInterface(g0Var);
            this.f505931d.transact(2, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public void ma(long j17, byte[] bArr) {
        ...
        try {
            ...
            this.f505931d.transact(12, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public boolean n6(long j17, byte[] bArr, u32.g1 g1Var) {
        ...
        try {
            ...
            this.f505931d.transact(19, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean n7(int i17, u32.g0 g0Var) {
        ...
        try {
            ...
            obtain.writeInt(i17);
            obtain.writeStrongInterface(g0Var);
            this.f505931d.transact(1, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean oe(long j17, int i17, u32.j0 j0Var) {
        ...
        try {
            ...
            obtain.writeInt(i17);
            obtain.writeStrongInterface(j0Var);
            this.f505931d.transact(16, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean rc(int i17, u32.g0 g0Var) {
        ...
        try {
            ...
            obtain.writeInt(i17);
            obtain.writeStrongInterface(g0Var);
            this.f505931d.transact(15, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean vf(long j17) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.exdevice.service.IBTDeviceManager_AIDL");
            obtain.writeLong(j17);
            this.f505931d.transact(5, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public boolean wi(u32.d1 d1Var) {
        ...
        try {
            ...
            this.f505931d.transact(18, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt() != 0;
        } finally {
            obtain2.recycle();
    ...
    public void xc(u32.q0 q0Var) {
        ...
        try {
            ...
            this.f505931d.transact(11, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
