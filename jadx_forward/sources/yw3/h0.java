...
public final class h0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.demo.RepairerConversationDemoUI f548289d;

    public h0(com.tencent.mm.plugin.repairer.ui.demo.RepairerConversationDemoUI repairerConversationDemoUI) {
        this.f548289d = repairerConversationDemoUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.repairer.ui.demo.RepairerConversationDemoUI repairerConversationDemoUI = this.f548289d;
        android.content.Intent className = new android.content.Intent().setClassName((android.content.Context) this.f548289d, "com.tencent.mm.plugin.repairer.ui.demo.RepairerConversationDemoUI");
