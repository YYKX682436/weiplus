...
public final class q0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.demo.RepairerDBSelectDemoUI f548386d;

    public q0(com.tencent.mm.plugin.repairer.ui.demo.RepairerDBSelectDemoUI repairerDBSelectDemoUI) {
        this.f548386d = repairerDBSelectDemoUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.repairer.ui.demo.RepairerDBSelectDemoUI repairerDBSelectDemoUI = this.f548386d;
        ...
        if (textView == null || (text = textView.getText()) == null || (obj = text.toString()) == null) {
            ...
            bArr = obj.getBytes(r26.c.f450398a);
