    ...
    public static final void b(android.view.View view, boolean z17, android.animation.Animator.AnimatorListener animatorListener) {
        ...
        if (z17) {
            if (!(view.getAlpha() == 0.0f)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ScanViewUtils", "animateAlpha show ignore, view: %s", view);
                return;
            }
        }
        if (!z17) {
            if (!(view.getAlpha() == 1.0f)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ScanViewUtils", "animateAlpha hide ignore, view: %s", view);
                return;
            }
        }
