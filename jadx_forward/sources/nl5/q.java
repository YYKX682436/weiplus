...
public final class q implements nl5.a0 {
    ...
    public final /* synthetic */ nl5.s f419868a;
    ...
    public void a(android.view.View v17, nl5.z item, java.lang.String curSelect) {
        ...
        nl5.s sVar = this.f419868a;
        sVar.getClass();
        int i19 = item.f419931b;
        nl5.s0 s0Var = sVar.f419872a;
        if (i19 != 1) {
            switch (i19) {
                case android.R.id.selectAll:
                    ...
                    s0Var.f419906x = false;
                    textView.post(new nl5.r(sVar));
                    textView.setCursorVisible(false);
                    break;
                case android.R.id.cut:
                    java.lang.Object systemService = s0Var.f419889g.getSystemService("clipboard");
                    ...
                    nl5.b0 b0Var = s0Var.f419888f;
                    java.lang.String str = b0Var.f419780c;
                    ((android.content.ClipboardManager) systemService).setPrimaryClip(android.content.ClipData.newPlainText(str, str));
                    s0Var.l();
                    s0Var.k();
                    android.widget.TextView textView2 = s0Var.f419890h;
                    ...
                    android.content.Context context = s0Var.f419889g;
                    try {
                        android.widget.Toast.makeText(context, context.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.gui), 0).show();
                    } catch (java.lang.Throwable th6) {
                        com.p314xaae8f345.mm.ui.yk.d("EditHelper.OperateWindow", th6, "show toast err", new java.lang.Object[0]);
                    }
                    textView2.setCursorVisible(true);
                    break;
                case android.R.id.copy:
                    java.lang.Object systemService2 = s0Var.f419889g.getSystemService("clipboard");
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.e(systemService2, "null cannot be cast to non-null type android.content.ClipboardManager");
                    java.lang.String str2 = s0Var.f419888f.f419780c;
                    ...
                    if (!(!android.text.TextUtils.isEmpty(str3) && str3.equalsIgnoreCase("samsung")) || android.os.Build.VERSION.SDK_INT <= 32) {
                        android.content.Context context2 = s0Var.f419889g;
                        try {
                            android.widget.Toast.makeText(context2, context2.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.guh), 0).show();
                        } catch (java.lang.Throwable th7) {
                            com.p314xaae8f345.mm.ui.yk.d("EditHelper.OperateWindow", th7, "show toast err", new java.lang.Object[0]);
                        }
                    }
                    android.widget.TextView textView3 = s0Var.f419890h;
                ...
                case android.R.id.paste:
                    s0Var.f419890h.onTextContextMenuItem(android.R.id.paste);
                    android.widget.TextView textView4 = s0Var.f419890h;
            ...
            s0Var.k();
            android.widget.TextView textView5 = s0Var.f419890h;
        ...
        if (((java.util.HashMap) s0Var.H).containsKey(java.lang.Integer.valueOf(i19))) {
            android.widget.TextView textView6 = s0Var.f419890h;
            textView6.onTextContextMenuItem(i19);
            s0Var.l();
            s0Var.k();
            textView6.setCursorVisible(true);
        }
        nl5.a0 a0Var = s0Var.f419901s;
        if (a0Var != null) {
