...
public final class f0 implements android.view.View.OnKeyListener {
    ...
    public final /* synthetic */ nl5.s0 f419802d;
    ...
    public final boolean onKey(android.view.View view, int i17, android.view.KeyEvent keyEvent) {
        ...
        boolean z17 = false;
        com.p314xaae8f345.mm.ui.yk.a("SelectableEditTextHelper", "init() called with: view = " + view + ", i = " + i17 + ", keyEvent = " + keyEvent, new java.lang.Object[0]);
        nl5.s0 s0Var = this.f419802d;
        s0Var.getClass();
        if (s0Var.f419908z) {
