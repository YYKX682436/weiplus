...
public final class z extends android.animation.AnimatorListenerAdapter {
    ...
    public final /* synthetic */ ck3.a0 f124059d;
    ...
    public void onAnimationStart(android.animation.Animator animation) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(animation, "animation");
        android.animation.AnimatorListenerAdapter animatorListenerAdapter = this.f124059d.f123995y;
        if (animatorListenerAdapter == null || animatorListenerAdapter == null) {
            return;
        }
