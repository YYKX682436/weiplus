...
public final class f {
    ...
    public static void b(dx1.f fVar, java.lang.String sessionId, boolean z17, boolean z18, int i17, java.lang.Object obj) {
        ...
        fVar.c((dx1.c) dx1.g.f326023b.get(sessionId), z17, z18);
    }
    ...
    public static int n(dx1.f fVar, java.lang.String sessionId, java.lang.String key, java.lang.String valueKey, java.lang.Object value, bx1.u opeartionState, boolean z17, java.lang.String tdName, java.lang.String divider, int i17, java.lang.Object obj) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(valueKey, "valueKey");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(value, "value");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(opeartionState, "opeartionState");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(tdName, "tdName");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(divider, "divider");
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = fVar.e(sessionId).f326011b;
        ...
        if (optJSONObject != null) {
            if (opeartionState == bx1.u.f117843e) {
    ...
    public final void a(java.lang.String sessionId) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(sessionId, "sessionId");
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = dx1.g.f326024c;
    ...
    public final void c(dx1.c cVar, boolean z17, boolean z18) {
        if (cVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StaticKvStat", "commit  session is null ");
            return;
        }
        if (!z17 && cVar.f326012c.size() != 0) {
            int i17 = cVar.f326013d + 1;
            cVar.f326013d = i17;
            if (i17 > 20) {
                c(cVar, true, z18);
                return;
            } else {
                ((ku5.t0) ku5.t0.f394148d).k(new dx1.d(cVar, z17, z18), 100L);
                return;
            }
        }
        if (cVar.f326010a != null) {
            try {
                for (java.util.Map.Entry entry : cVar.f326011b.entrySet()) {
                    jx3.a aVar = cVar.f326010a;
                ...
                for (java.util.Map.Entry entry2 : cVar.f326014e.entrySet()) {
                    jx3.a aVar2 = cVar.f326010a;
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.StaticKvStat", e17, " writeValue  error", new java.lang.Object[0]);
            }
            jx3.a aVar3 = cVar.f326010a;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(aVar3);
            aVar3.k();
        }
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = cVar.f326012c;
        ...
        for (java.util.Map.Entry entry4 : dx1.g.f326023b.entrySet()) {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(entry4.getValue(), cVar)) {
                dx1.g.f326023b.remove(entry4.getKey());
                return;
            }
        }
    }
    ...
    public final java.lang.Object d(java.lang.String sessionId, java.lang.String key) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(sessionId, "sessionId");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        return e(sessionId).f326011b.get(key);
    }

    public final dx1.c e(java.lang.String sessionId) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(sessionId, "sessionId");
        java.util.concurrent.locks.ReentrantLock reentrantLock = dx1.g.f326025d;
        reentrantLock.lock();
        dx1.c cVar = (dx1.c) dx1.g.f326023b.get(sessionId);
        if (cVar == null) {
            cVar = (dx1.c) dx1.g.f326024c.get(sessionId);
        }
        if (cVar == null) {
            cVar = new dx1.c();
            dx1.g.f326024c.put(sessionId, cVar);
        }
    ...
    public final void g(java.lang.String sessionId, java.lang.String clazz) {
        ...
        cVar.f326010a = (jx3.a) newInstance;
        java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = dx1.g.f326023b;
        if (concurrentHashMap2.containsKey(sessionId)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StaticKvStat", "sessionid " + sessionId + " is duplicate, should remove it");
    ...
    public final void h(dx1.c session, java.lang.String key, java.lang.Object value, bx1.u opeartionState, java.lang.String separator) {
        ...
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = session.f326011b;
        if (ordinal == 0) {
        ...
        if (ordinal == 1) {
            ...
            if (f(obj) && f(value)) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StaticKvStat", "report sessionid: key:" + key + " value:" + value + " is not long value,append failed");
            }
            concurrentHashMap.put(key, value);
            return;
        }
        if (ordinal == 2) {
            java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = session.f326014e;
        ...
        if (f(obj3) && f(value)) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StaticKvStat", "report sessionid: key:" + key + " value:" + value + " is not long value,elapse failed");
        }
        concurrentHashMap.put(key, value);
    }
    ...
    public final void i(java.lang.String sessionId, java.lang.String key, java.lang.Object value) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(value, "value");
        k(sessionId, key, value, bx1.u.f117842d, "#");
    }
    ...
    public final void m(java.lang.String sessionId, java.lang.String key, java.lang.Object valueKey, java.lang.Object value, bx1.u opeartionState, java.lang.String separator) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(opeartionState, "opeartionState");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(separator, "separator");
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = e(sessionId).f326011b;
        if (concurrentHashMap.get(key) == null) {
        ...
        if (obj instanceof dx1.a) {
            ...
            if (bx1.u.f117847i == opeartionState) {
                aVar.put(valueKey, value);
                return;
            }
            if (bx1.u.f117843e == opeartionState) {
    ...
    public final void o(java.lang.String sessionKey, java.lang.String sessionId, java.lang.String key, java.lang.Object value) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(value, "value");
        p(sessionKey, sessionId, key, value, bx1.u.f117842d, "#");
    }
    ...
    public final void p(java.lang.String sessionKey, java.lang.String sessionId, java.lang.String key, java.lang.Object value, bx1.u opeartionState, java.lang.String separator) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(opeartionState, "opeartionState");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(separator, "separator");
        java.util.concurrent.locks.ReentrantLock reentrantLock = dx1.g.f326026e;
        reentrantLock.lock();
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = dx1.g.f326027f;
    ...
    public final void q(java.lang.String sessionId, java.lang.String key, yz5.a callback) {
        ...
        dx1.c cVar = (dx1.c) dx1.g.f326023b.get(sessionId);
        if (cVar == null || (concurrentHashMap = cVar.f326012c) == null) {
            return;
        }
