...
public class c implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ wl5.x f528639d;
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        com.p314xaae8f345.mm.ui.yk.a("SelectableTextHelper", "interceptor onTouch. event.getAction():%s", java.lang.Integer.valueOf(motionEvent.getAction()));
        int x17 = (int) motionEvent.getX();
        int y17 = (int) motionEvent.getY();
        int action = motionEvent.getAction();
        wl5.x xVar = this.f528639d;
        if (action == 0 && (x17 < 0 || x17 >= xVar.f528688a.getWidth() || y17 < 0 || y17 >= xVar.f528688a.getHeight())) {
            com.p314xaae8f345.mm.ui.yk.a("SelectableTextHelper", "interceptor onTouch, down, outside.", new java.lang.Object[0]);
            xVar.f528698j.postDelayed(xVar.V, 100L);
        ...
        com.p314xaae8f345.mm.ui.yk.a("SelectableTextHelper", "interceptor onTouch, outside.", new java.lang.Object[0]);
        xVar.f528698j.postDelayed(xVar.V, 100L);
        yj0.a.i(true, this, "com/tencent/mm/ui/widget/textview/SelectableTextHelper$11", "android/view/View$OnTouchListener", "onTouch", "(Landroid/view/View;Landroid/view/MotionEvent;)Z");
        return true;
    }
