...
public class r {
    ...
    public static final p13.n f432661f = new p13.m();

    /* renamed from: a, reason: collision with root package name */
    public java.lang.String f432662a;

    /* renamed from: b, reason: collision with root package name */
    public java.lang.String f432663b;

    /* renamed from: c, reason: collision with root package name */
    public java.lang.String[] f432664c;

    /* renamed from: d, reason: collision with root package name */
    public java.lang.String[] f432665d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.List f432666e = new java.util.ArrayList();

    public static p13.r b(java.lang.String str, boolean z17) {
        return c(str, z17, f432661f);
    }
    ...
    public static p13.r c(java.lang.String str, boolean z17, p13.n nVar) {
        ...
        if (!((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.c0.clicfg_android_global_search_enable_more_split_char, true)) {
            ...
            rVar.f432662a = str != null ? str : "";
            java.lang.String trim = o13.s.c(str.toLowerCase()).replaceAll("['*\":&\\-.]", " ").trim();
            rVar.f432663b = trim;
            rVar.f432664c = nVar.b(trim);
            rVar.f432665d = nVar.a(rVar.f432663b, 2);
            java.lang.String[] strArr = rVar.f432664c;
            int length = strArr.length;
            while (i17 < length) {
                ((java.util.ArrayList) rVar.f432666e).add(e(strArr[i17], z17));
                i17++;
            }
            return rVar;
        }
        ...
        if (str2.equals("")) {
            rVar2.f432663b = "";
            rVar2.f432664c = new java.lang.String[0];
            rVar2.f432665d = new java.lang.String[0];
            return rVar2;
        }
        boolean matches = rVar2.f432662a.matches("^['\\*\":&\\\\\\-\\.;；,，、 ]+$");
        java.util.List list = rVar2.f432666e;
        if (matches) {
            java.lang.String trim2 = rVar2.f432662a.trim();
            rVar2.f432663b = trim2;
            rVar2.f432664c = nVar.b(trim2);
            rVar2.f432665d = nVar.a(rVar2.f432663b, 2);
            java.lang.String[] strArr2 = rVar2.f432664c;
        ...
        java.lang.String str3 = rVar2.f432662a;
        int i18 = 0;
        while (true) {
            c17 = ' ';
            if (i18 >= str3.length()) {
        ...
        if (!java.util.regex.Pattern.compile("['\\*\":&\\\\\\-\\.;；,，、]").matcher(rVar2.f432662a).find()) {
            java.lang.String trim4 = rVar2.f432662a.trim();
            rVar2.f432663b = trim4;
            rVar2.f432664c = nVar.b(trim4);
            rVar2.f432665d = nVar.a(rVar2.f432663b, 2);
            java.lang.String[] strArr3 = rVar2.f432664c;
        ...
        java.lang.String str4 = rVar2.f432662a;
        ...
        rVar2.f432663b = trim6;
        rVar2.f432664c = nVar.b(trim6);
        rVar2.f432665d = nVar.a(rVar2.f432662a, 2);
        java.lang.String[] strArr4 = rVar2.f432664c;
    ...
    public static p13.r d(java.util.List list) {
        ...
        while (it.hasNext()) {
            ...
            ((java.util.ArrayList) rVar.f432666e).add(pVar);
        }
        return rVar;
    }
    ...
    public static p13.p e(java.lang.String str, boolean z17) {
        ...
        java.util.List list = pVar.f432656a;
        if (z18) {
            ...
            while (true) {
                ...
                if (bVar.f441217b.f441218a[c17 - 'a'] == null) {
                    arrayList.clear();
                    break;
                }
            ...
            if (arrayList.size() > 0) {
                p13.o oVar = new p13.o();
                oVar.f432653a = p13.q.ShortPY;
                oVar.f432654b = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.c1(arrayList, "\u200b");
                oVar.f432655c = arrayList;
                ((java.util.ArrayList) list).add(oVar);
            }
            q13.b bVar2 = o13.s.f423797j;
            bVar2.getClass();
            ...
            while (!arrayDeque.isEmpty() && (aVar = (q13.a) arrayDeque.poll()) != null) {
                int i19 = aVar.f441212b;
                q13.c cVar = bVar2.f441217b;
                for (int i27 = i19; i27 < charArray2.length; i27++) {
                    cVar = cVar.f441218a[charArray2[i27] - 'a'];
                    if (cVar == null) {
                        break;
                    }
                    if (cVar.f441219b || i27 == charArray2.length - 1) {
                        if (aVar.f441214d == null) {
                            aVar.f441214d = new java.util.ArrayList();
                        }
                        int i28 = i27 + 1;
                        q13.a aVar2 = new q13.a(i19, i28, aVar);
                        ((java.util.ArrayList) aVar.f441214d).add(aVar2);
                ...
                if (aVar.f441215e) {
                    ...
                    while (aVar != null) {
                        int i29 = aVar.f441212b;
                        int i37 = aVar.f441211a;
                        if (i29 > i37) {
            ...
            if (arrayList2.size() > 0) {
                ...
                while (it.hasNext()) {
                    ...
                    if (list2.size() > 0) {
                        ...
                        oVar2.f432653a = p13.q.FullPY;
                        oVar2.f432654b = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.c1(list2, "\u200b");
                        oVar2.f432655c = list2;
    ...
    public boolean a() {
        return com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(this.f432662a.trim()) || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(this.f432663b.trim());
    }
    ...
    public java.lang.String f() {
        ...
        int i17 = 0;
        while (true) {
            java.util.List list = this.f432666e;
