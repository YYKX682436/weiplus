...
public final class b0 implements android.view.View.OnClickListener {
    ...
    public final android.view.View.OnClickListener f391468d;

    public b0(android.view.View.OnClickListener onClickListener) {
        this.f391468d = onClickListener;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        java.util.Map map = ko3.d0.f391471a;
        synchronized (map) {
            if (((java.util.WeakHashMap) map).containsKey(view)) {
                java.util.Map map2 = ko3.d0.f391472b;
                synchronized (map2) {
                    try {
                        if (((java.util.WeakHashMap) map2).containsKey(view)) {
                            ...
                            if (cls != null) {
                                ((com.p314xaae8f345.mm.sdk.p2600x5c6729a.AbstractC20979x809547d1) cls.newInstance()).e();
                            }
                        }
                    } catch (java.lang.Throwable th6) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.CBCH", th6, "failure to instantiate event class: ".concat(cls.getName()), new java.lang.Object[0]);
                    } finally {
                    }
                }
            }
        }
        android.view.View.OnClickListener onClickListener = this.f391468d;
