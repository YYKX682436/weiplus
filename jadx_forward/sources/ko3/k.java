...
public final class k implements android.os.Handler.Callback {
    ...
    public final java.lang.ref.WeakReference f391510d;

    /* renamed from: e, reason: collision with root package name */
    public final android.os.Handler.Callback f391511e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ko3.u f391512f;

    public k(ko3.u uVar, java.lang.Object obj, android.os.Handler.Callback callback) {
        this.f391512f = uVar;
        this.f391510d = new java.lang.ref.WeakReference(obj);
        this.f391511e = callback;
    }

    public final boolean a(android.os.Message message) {
        android.os.Handler.Callback callback = this.f391511e;
        if (callback != null) {
