...
public final class n0 extends jm0.g {
    ...
    public static final boolean f83617m;

    /* renamed from: n, reason: collision with root package name */
    public static final int f83618n;

    /* renamed from: f, reason: collision with root package name */
    public final jz5.g f83619f;

    /* renamed from: g, reason: collision with root package name */
    public final jz5.g f83620g;

    /* renamed from: h, reason: collision with root package name */
    public final jz5.g f83621h;

    /* renamed from: i, reason: collision with root package name */
    public final boolean f83622i;

    static {
        f83617m = j62.e.g().c(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2535xb5e903a3.C20249x595ddc1d()) == 1;
        f83618n = j62.e.g().c(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2535xb5e903a3.C20247xabbd3edf());
    }
    ...
    public n0(jm0.o service) {
        ...
        this.f83619f = jz5.h.b(a82.l0.f83604d);
        this.f83620g = jz5.h.b(a82.f0.f83526d);
        this.f83621h = jz5.h.b(new a82.g0(service));
        this.f83622i = j62.e.g().c(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2535xb5e903a3.C20248x9ad5dc65()) == 1;
    }

    public final boolean T6(java.lang.String str, java.lang.String str2, r45.gp0 gp0Var, java.lang.String str3) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavCheckCdnFSC", "copyDownloadData " + str3);
        ...
        if (x17) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavCheckCdnFSC", str3 + "  fullSize:" + k17 + ", dataMd5:" + p17 + ", dataShortMd5:" + f17);
            if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(p17) || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(f17)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavCheckCdnFSC", "dataMd5 or dataShortMd5 is null");
            } else {
                gp0Var.p0(p17);
                gp0Var.r0(f17);
            }
    ...
    public final boolean U6(java.lang.String str, java.lang.String str2, r45.gp0 gp0Var, java.lang.String str3) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavCheckCdnFSC", "copyDownloadThumb " + str3);
        boolean z17 = true;
        boolean x17 = com.p314xaae8f345.mm.vfs.w6.x(str, str2, true);
        if (x17) {
            long k17 = com.p314xaae8f345.mm.vfs.w6.k(str2);
            ...
            java.lang.String p17 = com.p314xaae8f345.mm.vfs.w6.p(str2);
            java.lang.String f17 = kk.k.f(str2, 0, 256);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavCheckCdnFSC", str3 + "  thumbFullSize:" + k17 + ", thumbMd5:" + p17 + ", thumbShortMd5:" + f17);
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavCheckCdnFSC", "thumbMd5 or thumbShortMd5 is null");
        }
        return x17;
    }
    ...
    */
    ...
    public final void W6(java.util.Map map, java.util.Map map2, o72.r2 r2Var, java.util.List list, java.util.Map map3, java.util.List list2, java.util.List list3, java.util.List list4) {
        ...
        for (java.util.Map.Entry entry : map.entrySet()) {
            ...
            if (gp0Var != null) {
                a82.x0 a17 = a82.y0.f83768a.a(r2Var, gp0Var);
                a17.f83750c = 1;
                a17.f83751d = intValue;
                list.add(a17);
            }
        }
        ...
        while (true) {
            ...
            if (gp0Var2 != null) {
                ...
                while (true) {
                    ...
                    if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((a82.x0) next).f83748a, str2)) {
                        obj4 = next;
                        break;
                    }
                }
                ...
                if (x0Var == null) {
                    x0Var = a82.y0.f83768a.a(r2Var, gp0Var2);
                    list.add(x0Var);
                }
                x0Var.f83756i = 1;
                x0Var.f83757j = intValue2;
            }
        }
        int i17 = 0;
        int i18 = 0;
        for (java.lang.Object obj5 : list2) {
            ...
            boolean j17 = com.p314xaae8f345.mm.vfs.w6.j(X);
            java.util.Iterator it7 = list.iterator();
            while (true) {
                if (it7.hasNext()) {
                    obj3 = it7.next();
                    if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((a82.x0) obj3).f83748a, gp0Var3.T)) {
                        break;
                    }
                } else {
                    obj3 = null;
        ...
        for (java.lang.Object obj6 : list4) {
            ...
            boolean j18 = com.p314xaae8f345.mm.vfs.w6.j(x17);
            java.util.Iterator it8 = list.iterator();
            while (true) {
                if (it8.hasNext()) {
                    obj = it8.next();
                    if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((a82.x0) obj).f83748a, gp0Var4.T)) {
                        break;
                    }
                } else {
                    obj = null;
            ...
            if (!j18 && x0Var3 != null) {
                ...
                while (true) {
                    if (it9.hasNext()) {
                        obj2 = it9.next();
                        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((a82.x0) obj2).f83748a, x0Var3.f83748a)) {
                            break;
                        }
                    } else {
                        obj2 = null;
    ...
    public final void Y6(o72.r2 r2Var, int i17) {
        ...
        if (!((y30.q) ((z30.u) i95.n0.c(z30.u.class))).wi() || i17 == 6 || (bq0Var = r2Var.f67640x5ab01132) == null || (linkedList = bq0Var.f452497f) == null) {
            return;
        }
        for (r45.gp0 gp0Var : linkedList) {
            boolean z17 = true;
            if (gp0Var.I != 1) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavCheckCdnFSC", "[#FavPost#] dataItem: htmlId=" + gp0Var.P1 + ", dataId=" + gp0Var.T + ", notCheckData=" + gp0Var.B1 + ", fullMd5=" + gp0Var.M + ", fullSize=" + gp0Var.R);
                if (gp0Var.I == 20) {
    ...
    /*  JADX ERROR: Types fix failed
        jadx.core.utils.exceptions.JadxOverflowException: Type update terminated with stack overflow, arg: (r41v42 java.util.LinkedHashMap), method size: 10858
    ...
    public final java.lang.Object a7(o72.r2 r98, p3321xbce91901.p3322xc267989b.InterfaceC29045xdcb5ca57 r99) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object b7(java.lang.String r23, r45.gp0 r24, java.lang.String r25, p3321xbce91901.p3322xc267989b.InterfaceC29045xdcb5ca57 r26) {
        /*
