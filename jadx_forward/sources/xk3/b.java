...
public final class b extends xk3.i {
    ...
    public void h(in5.s0 holder, in5.c cVar, int i17, int i18, boolean z17, java.util.List list) {
        ...
        java.lang.String m75945x2fec8307 = item.f510057d.v0().m75945x2fec8307(4);
        java.lang.Boolean bool = qp1.w.f447288a;
        java.lang.Integer b17 = qp1.a0.b(m75945x2fec8307);
        if (b17 == null) {
            b17 = qp1.a0.b(com.p159x477cd522.p160x333422.C1461x7397cc93.f4739x19d1382a);
        }
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(b17);
        c22643xbdaadc7d.setImageResource(b17.intValue());
    }
    ...
    public java.lang.String n(android.content.Context context, uk3.a item) {
        ...
        if (m75945x2fec8307 != null) {
            str = m75945x2fec8307.toUpperCase();
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(str, "toUpperCase(...)");
        } else {
            str = null;
        }
        sb6.append(str);
        sb6.append(context.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.gvc));
        return sb6.toString();
    }
}
