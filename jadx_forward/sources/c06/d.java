...
public final class d extends c06.e implements java.io.Serializable {
    ...
    public int a(int i17) {
        return c06.e.f119250e.a(i17);
    }

    @Override // c06.e
    public float b() {
        return c06.e.f119250e.b();
    }

    @Override // c06.e
    public int c() {
        return c06.e.f119250e.c();
    }

    @Override // c06.e
    public int d(int i17) {
        return c06.e.f119250e.d(i17);
    }

    @Override // c06.e
    public int e(int i17, int i18) {
        return c06.e.f119250e.e(i17, i18);
    }

    @Override // c06.e
    public long f() {
        return c06.e.f119250e.f();
    }

    @Override // c06.e
    public long g(long j17) {
        return c06.e.f119250e.g(j17);
    }

    @Override // c06.e
    public long h(long j17, long j18) {
        return c06.e.f119250e.h(j17, j18);
    }

    public double i() {
        return ((c06.a) c06.e.f119250e).i().nextDouble();
    }
