...
public abstract class u {
    ...
    public static java.lang.String f414885a;

    /* renamed from: b, reason: collision with root package name */
    public static java.util.ArrayList f414886b;

    public static void a() {
        java.util.ArrayList arrayList = f414886b;
        if (arrayList != null) {
            arrayList.clear();
        }
        f414885a = "";
    ...
    */
    public static java.util.ArrayList b() {
        /*
            ...
            r0.<init>()
            java.util.ArrayList r1 = mz4.u.f414886b
            if (r1 != 0) goto La
            return r0
        La:
        ...
        L33:
            ...
            r7 = r2
            iz4.f r7 = (iz4.f) r7
            java.lang.String r7 = r7.f377671t
            goto L44
        L3f:
            r7 = r2
            iz4.o r7 = (iz4.o) r7
            java.lang.String r7 = r7.f377668s
        L44:
    ...
    public static int c(android.content.Context context) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("WNNoteClipboardManager", "get clipboard data error : ", e17);
            str = "";
        }
        return str.equals(f414885a) ? 3 : 2;
    }

    public static boolean d(android.content.Context context) {
        return com.p314xaae8f345.mm.sdk.p2603x2137b148.b0.b(context).length() >= 16384 || qz4.c.i(com.p314xaae8f345.mm.sdk.p2603x2137b148.b0.b(context).toString()) >= 16384;
    }

    public static void e(android.content.Context context, java.util.ArrayList arrayList) {
        java.util.ArrayList arrayList2 = f414886b;
        if (arrayList2 != null) {
            arrayList2.clear();
        }
        f414886b = arrayList;
        java.util.HashSet hashSet = new java.util.HashSet();
        java.util.ArrayList arrayList3 = f414886b;
        if (arrayList3 != null) {
            java.util.Iterator it = arrayList3.iterator();
            while (it.hasNext()) {
                iz4.c cVar = (iz4.c) it.next();
                kk.j jVar = qz4.c.f449470a;
                java.lang.String str = cVar == null ? "" : cVar.d() == 2 ? ((iz4.f) cVar).f377671t : ((iz4.o) cVar).f377668s;
        ...
        if (f414886b != null) {
            for (int i17 = 0; i17 < f414886b.size(); i17++) {
                if (i17 != f414886b.size() - 1) {
                    sb6.append(qz4.c.b(context, (iz4.c) f414886b.get(i17)));
                    sb6.append("<br/>");
                } else {
                    sb6.append(qz4.c.b(context, (iz4.c) f414886b.get(i17)));
                }
        ...
        f414885a = replaceAll;
        com.p314xaae8f345.mm.sdk.p2603x2137b148.b0.e(kz4.a.a(replaceAll));
    }
}
