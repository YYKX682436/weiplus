...
public class h3 implements gm5.a {
    ...
    public final /* synthetic */ zw1.i3 f558186a;
    ...
    public java.lang.Object mo1059x2e7a5e(java.lang.Object obj) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WalletCollectQrCodeSettingUI", "CgiF2fShortTermQrcode cgiBack.errType:%s，cgiBack.errCode：%s", java.lang.Integer.valueOf(fVar2.f152148a), java.lang.Integer.valueOf(fVar2.f152149b));
        zw1.i3 i3Var = this.f558186a;
        if (!i3Var.f558196d.isFinishing()) {
            ...
            if (!activityC13148x64d0f1c5.isDestroyed() && (fVar = fVar2.f152151d) != null) {
                ...
                } else if (((r45.nw) fVar).f463234f == 2) {
                    android.content.Intent intent = new android.content.Intent();
                    intent.putExtra("ftf_pay_url", ((r45.nw) fVar2.f152151d).f463232d);
                    intent.putExtra("key_error_level", ((r45.nw) fVar2.f152151d).f463233e);
                    intent.putExtra("ftf_fixed_fee", (int) ((r45.nw) fVar2.f152151d).f463235g);
                    intent.putExtra("ftf_fixed_fee_type", "1");
                    intent.putExtra("ftf_fixed_desc", ((r45.nw) fVar2.f152151d).f463236h);
