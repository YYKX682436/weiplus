...
public class g2 implements android.view.animation.Animation.AnimationListener {
    ...
    public final /* synthetic */ zw1.f2 f558168a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ zw1.i2 f558169b;
    ...
    public void onAnimationEnd(android.view.animation.Animation animation) {
        zw1.i2 i2Var = this.f558169b;
        android.view.View view = i2Var.f558195c.C;
        ...
        zw1.f2 f2Var = this.f558168a;
        java.lang.String str = f2Var.f531729e;
        int i17 = 0;
        while (true) {
            if (i17 >= ((java.util.LinkedList) i2Var.f558195c.R).size()) {
                break;
            }
            if (((zw1.f2) ((java.util.LinkedList) i2Var.f558195c.R).get(i17)).f531729e.equals(f2Var.f531729e)) {
                ((zw1.f2) ((java.util.LinkedList) i2Var.f558195c.R).get(i17)).f558155s = true;
                java.lang.String str2 = f2Var.f531729e;
                break;
            }
            i17++;
        }
        i2Var.f558195c.n7();
        i2Var.f558193a = false;
        i2Var.a();
    }
