...
public final class h extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.l {
    ...
    public static final qu2.h f448315d = new qu2.h();
    ...
    public java.lang.Object mo146xb9724478(java.lang.Object obj) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(dataStream, "dataStream");
        ...
        if (it.hasNext()) {
            float f17 = ((qu2.g) next).f448314a;
            do {
                java.lang.Object next2 = it.next();
                float f18 = ((qu2.g) next2).f448314a;
        ...
        objArr[0] = java.lang.Float.valueOf(((qu2.g) next).f448314a);
        ...
        while (it6.hasNext()) {
            arrayList.add(java.lang.Float.valueOf(((qu2.g) it6.next()).f448314a));
        }
        ...
        while (it7.hasNext()) {
            arrayList2.add(java.lang.Float.valueOf(((qu2.g) it7.next()).f448314a));
        }
