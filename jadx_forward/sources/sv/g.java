...
public class g implements vg3.p4 {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:209:0x0097, code lost:
        ...
        if ((r11.d1() + r34.f535946d) >= 0) goto L38;
     */
    ...
    */
    public void S0(com.p314xaae8f345.mm.p2621x8fb0427b.f9 r31, com.p314xaae8f345.mm.p2621x8fb0427b.l4 r32, boolean r33, xg3.l0 r34) {
        /*
    ...
    public void W(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, com.p314xaae8f345.mm.p2621x8fb0427b.l4 l4Var, boolean z17, xg3.l0 l0Var) {
        ((r01.s1) i95.n0.c(r01.s1.class)).Ai().getClass();
        if (l0Var == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.BizConversationStorage", "compose notifyInfo is null");
            return;
        }
        java.lang.String username = l0Var.f535943a;
        if (z17) {
            if (f9Var != null && f9Var.A0() != 1 && (c01.ia.g(f9Var) & 1) != 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizConversationStorage", "create a temp session conversation.");
                l4Var.c2(4194304);
            }
            if (f9Var != null && r01.z.g(username)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizConversationStorage", "create a bitChat conversation.");
                l4Var.c2(8388608);
            }
        } else {
            ...
            if (n17 != null && n17.k2() && !n17.r2() && f9Var != null && f9Var.A0() != 1 && !l4Var.d2(4194304) && (l4Var.w0() < r01.q3.rj() || (c01.ia.g(f9Var) & 1) != 0)) {
                l4Var.c2(4194304);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizConversationStorage", "onNotifyChange is old temp session, %s", username);
            }
            if (f9Var != null && r01.z.g(username)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizConversationStorage", "onNotifyChange a bitChat conversation, %s", username);
                l4Var.c2(8388608);
            }
        }
        ...
        l4Var.M1(((com.p314xaae8f345.mm.p2621x8fb0427b.f9) arrayList.get(0)).A0());
        if (l0Var.f535944b.equals("insert")) {
            l4Var.f276617f2 = (com.p314xaae8f345.mm.p2621x8fb0427b.f9) arrayList.get(arrayList.size() - 1);
            if (!r01.z.n(username) || arrayList.get(arrayList.size() - 1) == null) {
                return;
            }
            long m124847x74d37ac6 = ((com.p314xaae8f345.mm.p2621x8fb0427b.f9) arrayList.get(arrayList.size() - 1)).m124847x74d37ac6();
            eq1.e0 e0Var = eq1.e0.f337332a;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(username, "username");
            ((java.util.HashMap) eq1.e0.f337334c).put(username, java.lang.Long.valueOf(m124847x74d37ac6));
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BrandServiceConversationReporter", username + " receive new message, msgId=" + m124847x74d37ac6);
        }
    }
}
