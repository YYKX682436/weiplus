...
public final class c {
    ...
    public static final ck4.c f124081a = new ck4.c();
    ...
    */
    ...
    public final ck4.b b(java.lang.String mediaId, java.lang.String url, java.lang.String path, int i17, java.lang.String fileFormat, java.lang.String urlToken, java.lang.String str, java.lang.String str2, dn.n nVar, java.lang.String tag) {
        ...
        bVar.f323318d = "task_TPPlayUtil";
        bVar.f69601xaca5bdda = mediaId;
        bVar.M1 = url.concat(urlToken);
        bVar.A = 60;
        bVar.B = 60;
        bVar.H1 = 1;
        bVar.Z = 8;
        bVar.f69610x4f5245a8 = i17;
        bVar.f69595x6d25b0d9 = path;
        bVar.f323342y0 = 4;
        bVar.f323339x0 = 4;
        bVar.Y1 = str;
        bVar.f323348c2 = nVar;
        ...
        bVar.f323346a2 = true;
        bVar.X1 = str2;
        bVar.f124068e2 = fileFormat;
        bVar.f124069f2 = url;
        bVar.f124070g2 = urlToken;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(tag, "[createVideoPlayCDNTask] finder video, reqFormat=" + i17 + " fileFormat=" + fileFormat + ", decodeKey=" + str + ' ' + urlToken + " mediaId=" + mediaId + " url=" + bVar.M1 + ' ');
        return bVar;
    }
}
