...
public final class r extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.a {
    ...
    public final /* synthetic */ aj0.s f86811d;
    ...
    public java.lang.Object mo152xb9724478() {
        ...
        aj0.s sVar = this.f86811d;
        int i18 = sVar.f86812a;
        ...
        android.opengl.EGL14.eglChooseConfig(eglGetDisplay, aj0.t.f86821b, 0, eGLConfigArr, 0, 1, new int[1], 0);
        aj0.a aVar = null;
        ...
        io.p3284xd2ae381c.Log.i("PreRenderGLUtil", "create eglContext: " + eglCreateContext.getNativeHandle());
        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(eglCreateContext, android.opengl.EGL14.EGL_NO_CONTEXT)) {
            io.p3284xd2ae381c.Log.e("PreRenderGLUtil", "create EGL context failed");
        } else {
            android.opengl.EGLSurface eglCreatePbufferSurface = android.opengl.EGL14.eglCreatePbufferSurface(eglGetDisplay, eGLConfigArr[0], (i18 <= 0 || (i17 = sVar.f86813b) <= 0) ? new int[]{12344} : new int[]{12375, i18, 12374, i17, 12344}, 0);
