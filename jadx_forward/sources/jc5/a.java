...
public final class a extends hc5.a {
    ...
    */
    ...
    public java.lang.String h(rd5.d msgInfo) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(msgInfo, "msgInfo");
        if (j62.e.g().c(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2551x5025ce89.C20544xcfdbf979()) == 0 || !msgInfo.f475787d.f526833b.W2()) {
            return null;
        }
        jc5.b bVar = jc5.b.f380549a;
        com.p314xaae8f345.mm.p2621x8fb0427b.f9 msg = msgInfo.f475787d.f526833b;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(msg, "msg");
        java.lang.String b17 = bVar.b(msg);
        boolean z17 = false;
        boolean z18 = true;
        if (!(b17.length() == 0)) {
            java.util.List list = (java.util.List) ((java.util.LinkedHashMap) jc5.b.f380550b).get(msg.Q0());
        ...
        java.lang.String b18 = bVar.b(msgInfo.f475787d.f526833b);
        if (r26.n0.N(b18)) {
            return null;
        }
        return b18;
