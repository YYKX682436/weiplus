...
public class q {
    public static final void a(qd2.q qVar, android.app.Activity context, int i17, r45.j41 j41Var, int i18) {
        qVar.getClass();
        int m75939xb282bd08 = j41Var.m75939xb282bd08(3);
        ...
        r45.m41 m41Var = (r45.m41) j41Var.m75936x14adae67(2);
        if (m41Var != null) {
            java.lang.String str = (java.lang.String) qVar.c(m41Var).f384367e;
    ...
    public final ex2.a b(r45.j41 j41Var, com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.p3 p3Var) {
        return new ex2.a(j41Var.m75945x2fec8307(0), j41Var.m75939xb282bd08(1) == 0 ? 6 : 0, j41Var.m75939xb282bd08(3) == 1, p3Var);
    }
    ...
    */
    public final jz5.l c(r45.m41 r7) {
        /*
            ...
            r4 = 1
            if (r7 == 0) goto L14
            java.lang.String r5 = r7.m75945x2fec8307(r4)     // Catch: java.lang.Exception -> L68
            goto L15
        L14:
            r5 = r2
        L15:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r0, r3)     // Catch: java.lang.Exception -> L68
        ...
        L2a:
            ...
            r5 = 0
            if (r7 == 0) goto L38
            int r7 = r7.m75939xb282bd08(r5)     // Catch: java.lang.Exception -> L68
        ...
        L4e:
            ...
            java.lang.String r7 = r3.mo15074x2fec8307(r7)     // Catch: java.lang.Exception -> L68
            if (r7 != 0) goto L59
            r7 = r1
        L59:
            java.lang.String r2 = "h5_link"
            java.lang.String r2 = r3.mo15074x2fec8307(r2)     // Catch: java.lang.Exception -> L68
            if (r2 != 0) goto L62
            r2 = r1
        L62:
    ...
    public final void d(android.app.Activity context, int i17, java.lang.String str, int i18) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderJumpErrHelper", "[handleJumpError] errMsg: " + str);
        ...
        try {
            ...
            if (optInt == 0) {
                ...
                az2.m.f97677a.a(context, str, i18);
                f(3, false, false);
                return;
            }
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("FinderJumpErrHelper", "[handleJumpError] catch exception:" + e17.getMessage());
        }
        f(0, true, false);
    }

    public void f(int i17, boolean z17, boolean z18) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderJumpErrHelper", "[handleOnEndCheck] enterType:" + i17 + " confirm:" + z17 + " fromDialog:" + z18);
    }
    ...
    */
    public final r45.j41 g(cl0.g r8) {
        /*
            ...
            java.lang.String r1 = r8.mo15082x48bce8a4(r1)     // Catch: java.lang.Exception -> L4d
    ...
    public final r45.l41 h(cl0.g gVar) {
        try {
            ...
            l41Var.set(0, mo15082x48bce8a4);
            l41Var.set(1, mo15082x48bce8a42);
            l41Var.set(2, mo15082x48bce8a43);
            l41Var.set(3, b17 != null ? i(b17) : null);
            int mo15056xbe0e3ae6 = f17 != null ? f17.mo15056xbe0e3ae6() : 0;
            for (int i17 = 0; i17 < mo15056xbe0e3ae6; i17++) {
                if (f17 != null) {
                    r45.j41 g17 = g(f17.k(i17));
                    if (g17 != null) {
                        l41Var.m75941xfb821914(4).add(g17);
                    }
                }
            }
            return l41Var;
        } catch (org.json.JSONException e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("FinderJumpErrHelper", "[jsonToToastConfig] catch exception:" + e17.getMessage());
            return null;
        }
    }
    ...
    public final r45.m41 i(cl0.g gVar) {
        try {
            int mo15072xb58848b9 = gVar.mo15072xb58848b9("ext_type");
            byte[] decode = android.util.Base64.decode(gVar.mo15074x2fec8307("ext_params"), 0);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(decode, "decode(...)");
            java.lang.String str = new java.lang.String(decode, r26.c.f450398a);
            r45.m41 m41Var = new r45.m41();
            m41Var.set(0, java.lang.Integer.valueOf(mo15072xb58848b9));
            m41Var.set(1, str);
            return m41Var;
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("FinderJumpErrHelper", "[jsonToToastExtConfig] catch exception:" + e17.getMessage());
            return null;
        }
    }
    ...
    public final void k(android.app.Activity activity, android.view.View view, java.lang.String str, int i17, int i18, int i19, java.lang.String str2) {
        ...
        aVar.Ai(view, new qd2.m(Sj != null ? ((com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1679xa3009fa4.p1680xac8f1cfd.ny) Sj).V6() : null));
    }
    ...
    public final void m(android.app.Activity context, int i17, r45.l41 toastConfig, int i18) {
        ...
        int i19;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(toastConfig, "toastConfig");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderJumpErrHelper", "[showTipsDialog] buttons.size:" + toastConfig.m75941xfb821914(4).size());
        boolean z17 = toastConfig.m75941xfb821914(4).size() > 1;
        int i27 = z17 ? 2 : 1;
        int i28 = i17 != 1 ? i17 != 2 ? 0 : 2 : 1;
        java.lang.String m75945x2fec8307 = toastConfig.m75945x2fec8307(0);
        r45.m41 m41Var = (r45.m41) toastConfig.m75936x14adae67(3);
        android.view.View inflate = com.p314xaae8f345.mm.ui.id.b(context).inflate(com.p314xaae8f345.mm.R.C30864xbddafb2a.b8b, (android.view.ViewGroup) null, false);
        android.widget.TextView textView = (android.widget.TextView) inflate.findViewById(com.p314xaae8f345.mm.R.id.g1s);
        if (textView != null) {
            textView.setText(m75945x2fec8307);
        }
        android.widget.TextView textView2 = (android.widget.TextView) inflate.findViewById(com.p314xaae8f345.mm.R.id.g1r);
        if (textView2 != null) {
            jz5.l c17 = c(m41Var);
            java.lang.CharSequence charSequence = (java.lang.CharSequence) c17.f384366d;
            if (charSequence.length() > 0) {
                textView2.setText(charSequence);
            }
            if (((java.lang.CharSequence) c17.f384367e).length() > 0) {
        ...
        r45.j41 j41Var = (r45.j41) toastConfig.m75941xfb821914(4).get(i19);
        ex2.e eVar = ex2.e.f338737a;
        if (!z17) {
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(j41Var);
            android.widget.Button button = eVar.d(context, view, b(j41Var, new qd2.p(this, context, j41Var, i18)), null).f293605x;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(button, "getBtnSingle(...)");
            k(context, button, "describe_general_button", i27, i28, 40, j41Var.m75945x2fec8307(i19));
            return;
        }
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(j41Var);
        ex2.a b17 = b(j41Var, new qd2.n(this, context, j41Var, i18));
        r45.j41 j41Var2 = (r45.j41) toastConfig.m75941xfb821914(4).get(1);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(j41Var2);
        com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.z2 c18 = eVar.c(context, view, b17, b(j41Var2, new qd2.o(this, context, j41Var2, i18)), null);
        android.widget.Button button2 = c18.f293601t;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(button2, "getBtnLeft(...)");
        int i29 = i27;
        int i37 = i28;
        k(context, button2, "describe_general_button", i29, i37, 40, j41Var.m75945x2fec8307(i19));
        android.widget.Button button3 = c18.f293602u;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(button3, "getBtnRight(...)");
        k(context, button3, "describe_general_button", i29, i37, 40, j41Var2.m75945x2fec8307(i19));
    }
}
