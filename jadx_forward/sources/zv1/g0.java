...
public final class g0 {
    ...
    public static final zv1.g0 f557833a = new zv1.g0();
    ...
    public static long d(zv1.g0 g0Var, zv1.r continuation, java.util.List paths, boolean z17, int i17, java.lang.Object obj) {
        ...
        if ((i17 & 4) != 0) {
            ...
            z18 = p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).aj("clicfg_auto_clean_cache_fast_list", "1"), "1");
        } else {
            z18 = z17;
        }
        g0Var.getClass();
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p1323x5a5b649.p1324x5a0af82.EnumC13101x40600c60 a17 = continuation.f557892a.a();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "scanSizeForPaths: " + a17 + ", pathSize=" + paths.size() + ", useFastList=" + z18);
        if (paths.isEmpty()) {
            return 0L;
        }
        com.p314xaae8f345.p3121x37984a.p3130x91727fcf.C26987xeef691ab c26987xeef691ab = continuation.f557897f;
        boolean z27 = continuation.f557898g;
        try {
            if (z18 && !z27) {
                long e17 = com.p314xaae8f345.mm.vfs.C22748x3d92d33a.e(paths);
            ...
            if (arrayList != null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "=== Bgn Scan_Files_Analysis (" + a17 + ") ===");
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "Exempted files: exemptedCount=" + arrayList3.size() + ", exemptedSize=" + (j28 / j19) + " MB, rate=" + f557833a.c(j28, j18) + '%');
                j17 = 0;
                try {
                    zv1.a1.f557792f.b(continuation, arrayList, 0L);
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "=== End Scan_Files_Analysis (" + a17 + ") ===\n");
                } catch (java.lang.Exception e18) {
                    e = e18;
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.CleanCache.Utils", "scanSizeForPaths error: " + paths + ", error=" + e);
                    return j17;
                }
            }
            return j18;
    ...
    public final java.util.List a(zv1.r rVar, java.lang.String str) {
        ...
        try {
            ...
            if (r6Var.A()) {
                ...
                long j17 = m17.f294767d;
                long j18 = m17.f294768e;
                zv1.w0 d17 = rVar.f557892a.d();
            ...
            if (G != null) {
                for (com.p314xaae8f345.mm.vfs.r6 r6Var2 : G) {
                    com.p314xaae8f345.p3121x37984a.p3130x91727fcf.C26987xeef691ab c26987xeef691ab = rVar.f557897f;
                    if (c26987xeef691ab != null) {
                        c26987xeef691ab.m108011xf4ed245c();
                    }
                    zv1.g0 g0Var = f557833a;
            ...
            if (rVar.f557894c) {
                com.p314xaae8f345.p3121x37984a.p3130x91727fcf.C26987xeef691ab c26987xeef691ab2 = rVar.f557897f;
                if (c26987xeef691ab2 != null) {
                    c26987xeef691ab2.m108011xf4ed245c();
                }
                com.p314xaae8f345.mm.vfs.x1 m18 = com.p314xaae8f345.mm.vfs.w6.m(str);
                if (m18 != null) {
                    java.util.Iterator it = arrayList.iterator();
                    if (it.hasNext()) {
                        next = it.next();
                        if (it.hasNext()) {
                            long j19 = ((zv1.e1) next).f557828c;
                            do {
                                java.lang.Object next2 = it.next();
                                long j27 = ((zv1.e1) next2).f557828c;
                                if (j19 < j27) {
                                    next = next2;
                                    j19 = j27;
                                }
                    ...
                    long j28 = e1Var != null ? e1Var.f557828c : 0L;
                    long j29 = m18.f294767d;
                    long j37 = m18.f294768e;
                    if (j37 >= j28) {
                        j28 = j37;
                    }
                    zv1.w0 d18 = rVar.f557892a.d();
                    arrayList.add(new zv1.e1(str, j29, j28, true, d18 != null ? d18.c(str) : null));
                }
            }
            return arrayList;
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.CleanCache.Utils", "collectFilesForTimeThreshold error: " + str + ", error=" + e17);
            return p0Var;
        }
    }
    ...
    */
    public final long b(zv1.r r31, java.lang.String r32, long r33, boolean r35, com.p314xaae8f345.p3121x37984a.p3130x91727fcf.C26987xeef691ab r36, java.util.List r37) {
        /*
        ...
        try {
            ...
            try {
                if (r6Var.A()) {
                    ...
                    j18 = j19 + m18.f294767d;
                    if (list != null) {
                        long j28 = m18.f294768e;
                        zv1.w0 d18 = rVar.f557892a.d();
                ...
                e = e17;
                j19 = j17;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.CleanCache.Utils", "scanSizeRecursive error: " + str + ", error=" + e);
                return j19;
            }
        } catch (java.lang.Exception e18) {
            e = e18;
