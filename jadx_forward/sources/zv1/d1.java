...
public final class d1 {
    ...
    public final void a(zv1.r rVar, java.util.List list, java.lang.String str, int i17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", str + " - TOP " + min + " files:");
        int i18 = 0;
        while (i18 < min) {
            zv1.e1 e1Var = (zv1.e1) list.get(i18);
            float f17 = ((float) e1Var.f557827b) / 1000000;
            i18++;
            java.lang.String format = java.lang.String.format("[%2d] %s - %.2f MB (%s) - EXEMPTED(%s)", java.util.Arrays.copyOf(new java.lang.Object[]{java.lang.Integer.valueOf(i18), e1Var.f557826a, java.lang.Float.valueOf(f17), zv1.i0.a().format(new java.util.Date(e1Var.f557828c)), e1Var.f557830e}, 5));
    ...
    public final void b(zv1.r continuation, java.util.List fileInfoList, int i17, long j17) {
        ...
        if (i17 < 0 || i17 >= fileInfoList.size()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.CleanCache.Utils", "dumpTopNFiles invalid index: " + i17 + ", size: " + fileInfoList.size());
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "TimeThreshold: " + j17 + " (" + zv1.i0.a().format(new java.util.Date(j17)) + ')');
        ...
        java.util.List subList2 = i18 < fileInfoList.size() ? fileInfoList.subList(i18, fileInfoList.size()) : kz5.p0.f395529d;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "Files to clean (older than threshold): " + subList.size());
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CleanCache.Utils", "Files to keep (newer than threshold): " + subList2.size());
        java.util.Iterator it = subList.iterator();
        long j18 = 0;
        while (it.hasNext()) {
            j18 += ((zv1.e1) it.next()).f557827b;
        }
        java.util.Iterator it6 = subList2.iterator();
        long j19 = 0;
        while (it6.hasNext()) {
            j19 += ((zv1.e1) it6.next()).f557827b;
            subList = subList;
        }
