...
public class b extends a46.b {
    ...
    public boolean f120084h;

    /* renamed from: m, reason: collision with root package name */
    public int f120086m;

    /* renamed from: n, reason: collision with root package name */
    public r46.a f120087n;

    /* renamed from: o, reason: collision with root package name */
    public final boolean f120088o;
    ...
    public final c46.c f120085i = new c46.c();

    /* renamed from: p, reason: collision with root package name */
    public int f120089p = 1;

    public b(java.io.InputStream inputStream, boolean z17) {
        this.f120087n = new r46.a(inputStream == java.lang.System.in ? new r46.f(inputStream) : inputStream, java.nio.ByteOrder.BIG_ENDIAN);
        this.f120088o = z17;
        i(true);
        j();
    }
    ...
    public final void f() {
        int i17 = ~this.f120085i.f120101a;
        int i18 = this.f120090q;
        if (i18 == i17) {
            int i19 = this.f120092s;
            this.f120092s = i17 ^ ((i19 >>> 31) | (i19 << 1));
        } else {
            int i27 = this.f120091r;
            this.f120092s = ((i27 >>> 31) | (i27 << 1)) ^ i18;
    ...
    public final boolean i(boolean z17) {
        ...
        int a18 = (int) this.f120087n.a(8);
        int a19 = (int) this.f120087n.a(8);
    ...
    public final void j() {
        ...
        do {
            ...
            if (b17 != 23 || b18 != 'r' || b19 != 'E' || b27 != '8' || b28 != 'P' || b29 != 144) {
                ...
                this.f120090q = b(aVar3, 32);
                this.f120084h = b(aVar3, 1) == 1;
                if (this.C == null) {
                    this.C = new c46.a(this.f120083g);
                }
                r46.a aVar4 = this.f120087n;
                this.f120082f = b(aVar4, 24);
                r46.a aVar5 = this.f120087n;
                c46.a aVar6 = this.C;
                boolean[] zArr = aVar6.f120066a;
                int i48 = 0;
                ...
                c46.a aVar7 = this.C;
                boolean[] zArr2 = aVar7.f120066a;
                int i66 = 0;
                for (int i67 = 0; i67 < 256; i67++) {
                    if (zArr2[i67]) {
                        aVar7.f120067b[i66] = (byte) i67;
                        i66++;
                    }
                }
                this.f120086m = i66;
                ...
                c(i68, com.p314xaae8f345.p542x3306d5.cdn.p545x65fc9e8.EnumC4451x33e61cdb.f18263x2b3a4fa4, "alphaSize");
                c(b37, 7, "nGroups");
                int i69 = 0;
                while (true) {
                    bArr = aVar6.f120069d;
                ...
                for (int i78 = 0; i78 < b38; i78++) {
                    ...
                    bArr2[0] = b39;
                    aVar6.f120068c[i78] = b39;
                }
                for (int i87 = 0; i87 < b37; i87++) {
                    int b47 = b(aVar5, 5);
                    char[] cArr2 = aVar6.f120077l[i87];
                ...
                while (i89 < b37) {
                    ...
                    int[] iArr6 = aVar8.f120071f[i89];
                    int[] iArr7 = aVar8.f120072g[i89];
                    int[] iArr8 = aVar8.f120073h[i89];
                    ...
                    aVar8.f120074i[i89] = c27;
                    i89++;
                    c17 = 0;
                }
                c46.a aVar9 = this.C;
                byte[] bArr4 = aVar9.f120080o;
                int i110 = this.f120083g * 100000;
                int i111 = 256;
                while (true) {
                    i111--;
                    iArr = aVar9.f120070e;
                ...
                int i112 = this.f120086m + 1;
                c46.a aVar10 = this.C;
                int i113 = aVar10.f120068c[0] & 255;
                c(i113, 6, "zt");
                int i114 = aVar10.f120074i[i113];
                java.lang.String str3 = "zn";
                c(i114, 258, "zn");
                int b48 = b(this.f120087n, i114);
                for (int[] iArr9 = aVar10.f120071f[i113]; b48 > iArr9[i114]; iArr9 = iArr9) {
                    i114++;
                    c(i114, 258, "zn");
                    b48 = (b48 << 1) | b(this.f120087n, 1);
                }
                int i115 = b48 - aVar10.f120072g[i113][i114];
                c(i115, 258, "zvec");
                int i116 = aVar10.f120073h[i113][i115];
                byte[] bArr5 = aVar9.f120068c;
                int i117 = bArr5[0] & 255;
                c(i117, 6, "zt");
                int[][] iArr10 = aVar9.f120072g;
                int[] iArr11 = iArr10[i117];
                int[][] iArr12 = aVar9.f120071f;
                int[] iArr13 = iArr12[i117];
                int[] iArr14 = iArr11;
                int[][] iArr15 = aVar9.f120073h;
                int[] iArr16 = iArr15[i117];
                int[] iArr17 = aVar9.f120074i;
                ...
                while (i122 != i112) {
                    ...
                    int i144 = i135;
                    str = str8;
                    c(i136, this.C.f120080o.length, "s");
                    char c47 = cArr[0];
                    c(c47, 256, "yy");
                    byte b59 = bArr6[c47];
                    int i145 = b59 & 255;
                    ...
                    int i146 = i28 + 1;
                    int i147 = i136 + i146;
                    c(i147, this.C.f120080o.length, "lastShadow");
                    bArr3 = bArr7;
                ...
                this.f120081e = i118;
                this.f120085i.f120101a = -1;
                this.f120089p = 1;
                return;
            }
            int b67 = b(this.f120087n, 32);
            this.f120091r = b67;
            this.f120089p = 0;
            this.C = null;
            if (b67 != this.f120092s) {
                throw new java.io.IOException("BZip2 CRC error");
            }
            if (!this.f120088o || !i(false)) {
                c17 = 1;
            }
        } while (c17 == 0);
    }
    ...
    public final int k() {
        switch (this.f120089p) {
            ...
            case 3:
                if (this.f120094u != this.f120095v) {
                    this.f120089p = 2;
                    this.f120093t = 1;
                    return v();
                }
                int i17 = this.f120093t + 1;
                this.f120093t = i17;
                if (i17 < 4) {
                    this.f120089p = 2;
                    return v();
                ...
                c46.a aVar = this.C;
                byte[] bArr = aVar.f120080o;
                int i18 = this.A;
                this.B = (char) (bArr[i18] & 255);
                c(i18, aVar.f120079n.length, "su_tPos");
                this.A = this.C.f120079n[this.A];
                int i19 = this.f120098y;
                if (i19 == 0) {
                    int i27 = this.f120099z;
                    this.f120098y = c46.d.f120102a[i27] - 1;
                    int i28 = i27 + 1;
                    this.f120099z = i28;
                    if (i28 == 512) {
                        this.f120099z = 0;
            ...
            case 6:
                ...
                int i29 = this.f120093t + 1;
                this.f120093t = i29;
                if (i29 < 4) {
                    return p();
                }
                c(this.A, this.C.f120080o.length, "su_tPos");
                c46.a aVar2 = this.C;
                byte[] bArr2 = aVar2.f120080o;
                int i37 = this.A;
                this.B = (char) (bArr2[i37] & 255);
                this.A = aVar2.f120079n[i37];
                this.f120097x = 0;
                return q();
            case 7:
                return q();
    ...
    public final int l() {
        c46.a aVar;
        if (this.f120089p == 0 || (aVar = this.C) == null) {
            return -1;
        }
        int[] iArr = aVar.f120075j;
        int i17 = this.f120081e + 1;
        int[] iArr2 = aVar.f120079n;
        ...
        byte[] bArr = aVar.f120080o;
        iArr[0] = 0;
        java.lang.System.arraycopy(aVar.f120070e, 0, iArr, 1, 256);
        int i18 = iArr[0];
        for (int i19 = 1; i19 <= 256; i19++) {
            i18 += iArr[i19];
            iArr[i19] = i18;
        }
        int i27 = this.f120081e;
    ...
    public final int p() {
        if (this.f120096w > this.f120081e) {
            this.f120089p = 5;
            f();
            j();
            return l();
        }
        this.f120095v = this.f120094u;
        c46.a aVar = this.C;
        byte[] bArr = aVar.f120080o;
        int i17 = this.A;
        int i18 = bArr[i17] & 255;
        this.f120094u = i18;
        c(i17, aVar.f120079n.length, "su_tPos");
        this.A = this.C.f120079n[this.A];
        this.f120096w++;
        this.f120089p = 6;
        this.f120085i.a(i18);
    ...
    public final int q() {
        if (this.f120097x >= this.B) {
            this.f120096w++;
            this.f120093t = 0;
            return p();
        }
        int i17 = this.f120094u;
        this.f120085i.a(i17);
        this.f120097x++;
        this.f120089p = 7;
        return i17;
    ...
    public final int v() {
        ...
        int i29 = i18 ^ (this.f120098y == 1 ? 1 : 0);
        this.f120094u = i29;
        this.f120096w++;
        this.f120089p = 3;
        this.f120085i.a(i29);
    ...
    public final int w() {
        if (this.f120097x < this.B) {
            this.f120085i.a(this.f120094u);
            this.f120097x++;
            return this.f120094u;
        }
        this.f120089p = 2;
        this.f120096w++;
        this.f120093t = 0;
