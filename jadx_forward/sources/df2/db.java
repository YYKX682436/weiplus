...
public final class db implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ df2.zb f311495d;
    ...
    public final void onClick(android.view.View view) {
        ...
        df2.zb zbVar = this.f311495d;
        boolean t17 = r4Var.t1(zbVar.getStore().getLiveRoomData());
        r45.n72 n72Var = r45.n72.kActionType_AiassistantExposed;
        if (t17 && zbVar.n7()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(zbVar.f313472m, "[aiAssistant] smallBanner clicked, voice dialog enabled, trigger wakeup");
            zbVar.q7(2);
            zbVar.s7(n72Var, 2, "");
            zbVar.o7("banner_click");
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(zbVar.f313472m, "[aiAssistant] smallBanner clicked, expand normal banner");
