...
public final class d extends ym3.a implements o75.a {

    /* renamed from: d, reason: collision with root package name */
    public final java.util.ArrayList f500493d = new java.util.ArrayList();

    /* renamed from: e, reason: collision with root package name */
    public final jz5.g f500494e = jz5.h.b(tf5.c.f500491d);

    /* renamed from: f, reason: collision with root package name */
    public com.p314xaae8f345.mm.p1006xc5476f33.p1925x6c8df6be.C16718x7059cefe f500495f;
    ...
    public p3325xe03a0797.p3326xc267989b.p3328x30012e.j a(v65.i scope, ym3.c request) {
        ...
        java.util.ArrayList arrayList = this.f500493d;
        ...
        if (i17 < size) {
            ...
            for (com.p314xaae8f345.mm.p2621x8fb0427b.z3 z3Var : g95.e.f351334a.f(arrayList2)) {
                if (((int) z3Var.E2) != 0) {
                    dVar.f544682c.add(new tf5.g(z3Var, 1, 32));
                }
            }
        }
        k0Var.e(dVar);
    ...
    public boolean d(tf5.g item) {
        ...
        return z3Var.t2() && z3Var.r2() && !z3Var.o2();
    }
    ...
    public final void e(o75.c cVar) {
        ...
        if (z3Var != null) {
            tf5.g gVar = new tf5.g(z3Var, 1, 32);
            ...
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(bVar3, bVar2)) {
                if (!d(gVar) || (c16718x7059cefe2 = this.f500495f) == null) {
                    return;
                }
            ...
            if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(bVar3, o75.b.f425116d)) {
                if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(bVar3, o75.b.f425117e) || (c16718x7059cefe = this.f500495f) == null) {
                    return;
                }
            ...
            if (d(gVar)) {
                com.p314xaae8f345.mm.p1006xc5476f33.p1925x6c8df6be.C16718x7059cefe c16718x7059cefe3 = this.f500495f;
            ...
            com.p314xaae8f345.mm.p1006xc5476f33.p1925x6c8df6be.C16718x7059cefe c16718x7059cefe4 = this.f500495f;
    ...
    public void mo10202x3e5a77bb() {
        ...
        p75.d dVar = dm.e2.P1;
        p75.m c17 = dVar.s(arrayList2).c(dm.e2.T1.g(64, 64));
        g95.d dVar2 = g95.e.f351334a;
        p75.y yVar = (p75.y) c17;
        yVar.f(dVar2.g());
        p75.i0 g17 = dm.e2.N1.g(kz5.b0.c(dVar));
        g17.f434189c = "MicroMsg.Mvvm.AddressFavorDataSource";
        g17.f434190d = yVar;
        g17.f434192f = dVar2.h();
        java.util.Iterator it = g17.a().k(((jm0.l) ((jz5.n) this.f500494e).mo141623x754a37bb()).Q4(), com.p314xaae8f345.mm.p2621x8fb0427b.z3.class).iterator();
        while (it.hasNext()) {
            arrayList.add(((com.p314xaae8f345.mm.p2621x8fb0427b.z3) it.next()).d1());
        }
    }
}
