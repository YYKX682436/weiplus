...
public final class r implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.content.Context f479537d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.y1 f479538e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ po1.d f479539f;

    public r(android.content.Context context, com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.y1 y1Var, po1.d dVar) {
        this.f479537d = context;
        this.f479538e = y1Var;
        this.f479539f = dVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.y1 y1Var = this.f479538e;
        android.content.Context context = this.f479537d;
        if (Ui) {
        ...
        intent.putExtra("deviceInfo", this.f479539f.c());
        intent.setFlags(335544320);
        android.content.Context context2 = this.f479537d;
