...
public final class s extends os0.a {
    ...
    public s(int i17, int i18, int i19, int i27, int i28, int i29, int i37, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
        ...
        this.f307724J = android.opengl.GLES20.glGetUniformLocation(t17, "calcRoundCorner");
    ...
    public void g() {
        ...
        floatBuffer.put(this.f429528d - rect.bottom);
        floatBuffer.put(rect.right);
        floatBuffer.put(this.f429528d - rect.top);
    }
    ...
    public void p() {
        ...
        android.graphics.Rect rect = this.O;
        android.opengl.GLES20.glViewport(rect.left, this.f429528d - rect.bottom, rect.width(), rect.height());
        ...
        android.opengl.GLES20.glUniformMatrix4fv(this.F, 1, false, this.f429536l, 0);
        ...
        android.opengl.GLES20.glUniform1i(this.f307724J, this.L ? 1 : 0);
