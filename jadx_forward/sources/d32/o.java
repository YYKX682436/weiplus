...
public final class o extends os0.a {
    ...
    public o(int i17, int i18, int i19, int i27, int i28, int i29) {
        ...
        this.f307722J = android.opengl.GLES20.glGetUniformLocation(b17, "calcRoundCorner");
    ...
    public void g() {
        ...
        floatBuffer.put(this.f429527c);
        floatBuffer.put(this.f429528d);
    }
    ...
    public void p() {
        ...
        android.opengl.GLES20.glUniform1f(this.I, java.lang.Math.max(this.f429527c, this.f429528d) * 0.06666667f);
        android.opengl.GLES20.glUniform1i(this.f307722J, 1);
        ...
        android.opengl.GLES20.glVertexAttribPointer(this.D, 2, 5126, false, 0, (java.nio.Buffer) this.f429531g);
        int i18 = this.D;
