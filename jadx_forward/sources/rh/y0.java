...
public class y0 implements wh.t0 {
    ...
    public final /* synthetic */ rh.z0 f477091a;
    ...
    public void mo40853xab27b508(java.lang.Object obj) {
        ...
        double d19;
        rh.f1 f1Var = (rh.f1) ((rh.o2) obj).f477019c;
        rh.z0 z0Var = this.f477091a;
        long a17 = z0Var.f477104b.a(null);
        wh.n1 n1Var = z0Var.f477105c;
        java.lang.Double valueOf = java.lang.Double.valueOf(uh.i.f(n1Var, a17) + uh.i.h(n1Var, f1Var, a17) + uh.i.k(n1Var, f1Var, a17));
        java.util.Map map3 = z0Var.f477106d;
        map3.put("power-cpu-devDiff", valueOf);
        rh.x0 x0Var = z0Var.f477103a.f476866o;
        if (x0Var == null || !x0Var.a(n1Var)) {
            return;
        }
        long a18 = z0Var.f477104b.a(null);
        ...
        if (a18 > 0) {
            ...
            int i17 = 0;
            while (true) {
                arrayList = (java.util.ArrayList) x0Var.f477080b;
