...
public class c extends i95.w implements zb0.y {
    public boolean wi(android.content.Context context, java.lang.String str) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ApplicationUtil", "app not installed, packageName = ".concat("com.android.vending"));
            packageInfo = null;
        }
        if (packageInfo != null) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ApplicationUtil", "installAppWithGP first, ex = %s", e17.getMessage());
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ApplicationUtil", "installAppWithGP second, ex = %s", e18.getMessage());
                return false;
            }
        }
        return true;
