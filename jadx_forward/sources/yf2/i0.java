...
public final class i0 extends android.text.style.ClickableSpan {
    ...
    public final /* synthetic */ java.lang.String f543247d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f543248e;

    public i0(java.lang.String str, android.content.Context context) {
        this.f543247d = str;
        this.f543248e = context;
    }
    ...
    public void onClick(android.view.View widget) {
        ...
        intent.putExtra("rawUrl", this.f543247d);
        j45.l.j(this.f543248e, "webview", ".ui.tools.WebViewUI", intent, null);
    ...
    public void updateDrawState(android.text.TextPaint ds6) {
        ...
        ds6.setColor(this.f543248e.getResources().getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77827x4b0c744c));
