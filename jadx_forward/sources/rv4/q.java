...
public final class q {
    ...
    public static final rv4.q f482077a = new rv4.q();

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.ref.WeakReference f482078b = null;

    /* renamed from: c, reason: collision with root package name */
    public static long f482079c = 0;

    /* renamed from: d, reason: collision with root package name */
    public static volatile boolean f482080d = false;

    /* renamed from: e, reason: collision with root package name */
    public static int f482081e = 0;

    /* renamed from: f, reason: collision with root package name */
    public static java.lang.String f482082f = "";

    /* renamed from: g, reason: collision with root package name */
    public static java.lang.String f482083g = "";
    ...
    public final void a() {
        ...
        f482083g = "";
        f482080d = false;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] data reference and request state cleared, isRequesting set to false");
    }
    ...
    public final void b(org.json.JSONObject jSONObject, android.content.Context context, java.lang.String str, boolean z17) {
        ...
        try {
            ...
            java.lang.String optString3 = optJSONObject3.optString(com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3068x36f002.C26514x6b29e485.f54270xd8c04b24, "");
            org.json.JSONObject optJSONObject4 = optJSONObject2.optJSONObject("config");
            if (optJSONObject4 != null) {
                str2 = optString3;
                z18 = optBoolean;
                str3 = optJSONObject4.optString(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37660xb6ae3b28, context.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.o4i));
            } else {
                z18 = optBoolean;
                str2 = optString3;
                str3 = null;
            ...
            if (str3 == null) {
                str3 = context.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.o4i);
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(str3, "getString(...)");
            }
            java.lang.String optString4 = jSONObject.optString("searchID", "");
            if (z17) {
                str5 = f482083g;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "extractAndSaveConfigInfo: refreshCacheKey=true, using currentSessionId: " + str5);
            } else {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "extractAndSaveConfigInfo: refreshCacheKey=false, keeping existing cache_key: ".concat(str5));
            }
            ...
            cVar.c(jSONObject2);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "extractAndSaveConfigInfo: clientExpireTime=" + optInt + ", ctx=" + optString + ", guessTitle=" + str3 + ", searchId=" + optString4 + ", requestId=" + str + ", cacheKey=" + str5 + ", refreshCacheKey=" + z17);
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FTSGlobalTeachHotSearchDataSource", "extractAndSaveConfigInfo error", e17);
        }
    }
    ...
    public final void c(java.lang.String json) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] handleNetworkResponse: jsonLength=" + json.length() + ", responseTime=" + currentTimeMillis + ", requestTime=" + f482079c);
        try {
            try {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] handleNetworkResponse: json=".concat(json));
                e(json);
                java.lang.ref.WeakReference weakReference = f482078b;
                rv4.p pVar2 = weakReference != null ? (rv4.p) weakReference.get() : null;
                if (pVar2 != null) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] handleNetworkResponse: data object found, calling callback");
                    pVar2.i(json, f482079c, currentTimeMillis);
                } else {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] handleNetworkResponse: data object has been recycled");
                }
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] handleNetworkResponse: success");
            } catch (java.lang.Exception e17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FTSGlobalTeachHotSearchDataSource", "[ftshotsearch] handleNetworkResponse error", e17);
                java.lang.ref.WeakReference weakReference2 = f482078b;
                if (weakReference2 != null && (pVar = (rv4.p) weakReference2.get()) != null) {
                    pVar.i("", f482079c, currentTimeMillis);
                }
            }
        } finally {
            a();
    ...
    */
    public final void e(java.lang.String r7) {
        ...
        L2a:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r5, r4)     // Catch: java.lang.Exception -> L6b
        ...
        L52:
            java.lang.String r7 = rv4.q.f482082f     // Catch: java.lang.Exception -> L6b
            int r4 = rv4.q.f482081e     // Catch: java.lang.Exception -> L6b
            if (r4 != 0) goto L59
            goto L5a
        L59:
            r1 = r2
        L5a:
            android.content.Context r2 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a     // Catch: java.lang.Exception -> L6b
            java.lang.String r4 = "getContext(...)"
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(r2, r4)     // Catch: java.lang.Exception -> L6b
            r6.b(r0, r2, r7, r1)     // Catch: java.lang.Exception -> L6b
            java.lang.String r7 = "saveSearchGuideResponse: saved successfully"
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r3, r7)     // Catch: java.lang.Exception -> L6b
            goto L76
        L6b:
            r7 = move-exception
    ...
    */
    public final java.util.List f(int r15) {
        ...
        L2e:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r15)
            goto L77
        L3f:
        ...
        L6c:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r1, r3, r15)
        L77:
