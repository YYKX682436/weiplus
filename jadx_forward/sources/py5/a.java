...
public final class a implements javax.net.ssl.X509TrustManager {
    ...
    public final javax.net.ssl.X509TrustManager f440627a;

    /* renamed from: b, reason: collision with root package name */
    public final android.net.http.X509TrustManagerExtensions f440628b;

    /* renamed from: c, reason: collision with root package name */
    public final java.lang.String f440629c;
    ...
    public a(java.lang.String str) {
        ...
        this.f440627a = x509TrustManager;
        this.f440628b = new android.net.http.X509TrustManagerExtensions(x509TrustManager);
    }

    @Override // javax.net.ssl.X509TrustManager
    public final void checkClientTrusted(java.security.cert.X509Certificate[] x509CertificateArr, java.lang.String str) {
        javax.net.ssl.X509TrustManager x509TrustManager = this.f440627a;
    ...
    public final void checkServerTrusted(java.security.cert.X509Certificate[] x509CertificateArr, java.lang.String str) {
        boolean z17;
        java.lang.String str2 = this.f440629c;
        android.net.http.X509TrustManagerExtensions x509TrustManagerExtensions = this.f440628b;
    ...
    public final java.security.cert.X509Certificate[] getAcceptedIssuers() {
        return this.f440627a.getAcceptedIssuers();
    }
}
