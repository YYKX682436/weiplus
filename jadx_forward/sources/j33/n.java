...
public abstract class n {
    public static android.graphics.Bitmap a(java.lang.String str, int i17) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.GalleryBitmapUtil", "imgPath is invalid.");
            return null;
        }
        android.graphics.BitmapFactory.Options options = new android.graphics.BitmapFactory.Options();
        try {
            byte[] m7352x4ebbc236 = new p012xc85e97e9.p085x39fce629.p086x62f6fe4.C1098xe10e35e9(str).m7352x4ebbc236();
            if (m7352x4ebbc236 != null && (b17 = b(m7352x4ebbc236, options, i17)) != null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.GalleryBitmapUtil", "decode thumb success from exif.");
                return b17;
            }
        } catch (java.io.FileNotFoundException e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", e17, "failed to find file to read thumbnail: %s.", str);
        } catch (java.io.IOException e18) {
            e = e18;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", e, "failed to get thumbnail from: %s.", str);
        } catch (java.lang.IndexOutOfBoundsException e19) {
            e = e19;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", e, "failed to get thumbnail from: %s.", str);
        } catch (java.lang.Exception e27) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", e27, "failed to get thumbnail from: %s.", str);
        } catch (java.lang.OutOfMemoryError e28) {
            e = e28;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", e, "failed to get thumbnail from: %s.", str);
        }
        try {
            return c(com.p314xaae8f345.mm.vfs.w6.z(com.p314xaae8f345.mm.vfs.z7.a(str), null, "r").getFileDescriptor(), options, i17);
        } catch (java.lang.Exception e29) {
            e = e29;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", e, "decodeThumbnail fail!!!", new java.lang.Object[0]);
            return null;
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.GalleryBitmapUtil", th6, "err!!", new java.lang.Object[0]);
            return null;
        }
    }
    ...
    public static android.graphics.Bitmap c(java.io.FileDescriptor fileDescriptor, android.graphics.BitmapFactory.Options options, int i17) {
        ...
        if (i28 == -1 || i29 == -1) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.GalleryBitmapUtil", "decode error, get invalid picture size");
            return null;
        }
