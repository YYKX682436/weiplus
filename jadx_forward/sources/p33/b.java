...
public class b extends r45.mr5 {
    ...
    public p33.a f433053d;

    @Override // com.p314xaae8f345.mm.p2495xc50a8b8b.f
    /* renamed from: compareContent */
    public boolean mo516x5c5a33d4(com.p314xaae8f345.mm.p2495xc50a8b8b.f fVar) {
        if (fVar == null || !(fVar instanceof p33.b)) {
            return false;
        }
        p33.b bVar = (p33.b) fVar;
        return n51.f.a(this.f76494x2de60e5e, bVar.f76494x2de60e5e) && n51.f.a(this.f433053d, bVar.f433053d);
    }
    ...
    public final int op(int i17, java.lang.Object... objArr) {
        if (i17 == 0) {
            ...
            p33.a aVar = this.f433053d;
            if (aVar != null) {
                fVar.i(2, aVar.mo75928xcd1e8d8());
                this.f433053d.mo75956x3d5d1f78(fVar);
            }
            return 0;
        }
        if (i17 == 1) {
            ...
            p33.a aVar2 = this.f433053d;
            return aVar2 != null ? i18 + b36.f.i(2, aVar2.mo75928xcd1e8d8()) : i18;
        }
        if (i17 == 2) {
