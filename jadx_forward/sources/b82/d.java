...
public class d extends l75.n0 implements o72.k4 {
    ...
    public int Ah(int i17) {
        try {
            android.database.Cursor f17 = this.f99841d.f("select count(*) from FavItemInfo where id>" + i17, null, 2);
            if (f17 == null) {
                return -1;
            }
            if (f17.getCount() == 0) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "getFavHomePosition failed with throwable: " + th6.getMessage());
            return -1;
        }
    }
    ...
    public o72.r2 F(long j17) {
        l75.k0 k0Var = this.f99841d;
        if (k0Var == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "getBtLocalId, but db is null, return");
            return null;
        }
        android.database.Cursor D = k0Var.D("FavItemInfo", null, "localId=?", new java.lang.String[]{"" + j17}, null, null, null, 2);
        if (!D.moveToFirst()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "klem getByLocalId:%d, no data", java.lang.Long.valueOf(j17));
            D.close();
            return null;
        }
        o72.r2 r2Var = new o72.r2();
        try {
            r2Var.mo9015xbf5d97fd(D);
            D.close();
            return r2Var;
        } catch (java.lang.Exception unused) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "getByLocalId convertFrom(cu) cause IlleagalStateException, return null");
            D.close();
            return null;
        }
    }
    ...
    public java.util.List I0(int i17) {
        ...
        g17.b(linkedList3);
        g17.c(i17, 0);
        return g17.a().k(this.f99841d, o72.r2.class);
    }
    ...
    public void Re(dm.n3 n3Var) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "deleteItem itemLocalId:%s itemFavId:%s", java.lang.Long.valueOf(n3Var.f67645x88be67a1), java.lang.Integer.valueOf(n3Var.f67643xc8a07680));
        this.f99841d.A("FavItemInfo", "delete from FavItemInfo where localId = " + n3Var.f67645x88be67a1);
    ...
    public java.util.List V1(int i17, int i18, java.util.List list, java.util.Set set, o72.i4 i4Var) {
        ...
        if (set != null && set.contains(java.lang.Integer.valueOf(i17))) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "getFirstPageList::block set contains target type, error, do return null");
            return null;
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        if (i17 != -1) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "[getFirstPageList] sql = " + str2);
        android.database.Cursor f17 = this.f99841d.f(str2, null, 2);
        if (f17 == null) {
            return arrayList;
        }
        while (f17.moveToNext()) {
            ...
            if (i4Var == null || !((o72.b3) i4Var).c(r2Var, false, false)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "[getFirstPageList] id[%d] type[%d] match filter", java.lang.Integer.valueOf(r2Var.f67643xc8a07680), java.lang.Integer.valueOf(r2Var.f67657x2262335f));
                arrayList.add(r2Var);
            } else {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "id[%d] type[%d] match filter", java.lang.Integer.valueOf(r2Var.f67643xc8a07680), java.lang.Integer.valueOf(r2Var.f67657x2262335f));
            }
        }
        f17.close();
        return arrayList;
    ...
    public java.util.List Wh(o72.j2 j2Var, int i17) {
        ...
        if (j2Var != null) {
            java.util.Iterator it = j2Var.f424903a.iterator();
            while (it.hasNext()) {
        ...
        android.database.Cursor B = this.f99841d.B(i17 == 0 ? str5 + " order by datatotalsize desc" : str5 + " order by updateTime asc", null);
        if (B == null) {
            return arrayList;
        }
        if (B.getCount() == 0) {
        ...
        B.close();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "getCleanList cu.getCount() = %d,used %dms", java.lang.Integer.valueOf(arrayList.size()), java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis));
        return arrayList;
    }
    ...
    public long X(long j17, int i17, int i18) {
        ...
        l75.k0 k0Var = this.f99841d;
        if (k0Var == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "getNextUpdateTime, but db is null, return");
            return 0L;
        }
        if (j17 == 0) {
            if (i18 != -1) {
    ...
    public java.lang.Long Y6() {
        android.database.Cursor f17 = this.f99841d.f("select localId from FavItemInfo order by localId desc limit 1", null, 2);
    ...
    public long Z0(long j17, int i17, int i18) {
        ...
        l75.k0 k0Var = this.f99841d;
        if (k0Var == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "getMinBatchGetUpdateTime, but db is null, return");
            return 0L;
        }
        if (j17 == 0) {
            if (i18 != -1) {
    ...
    public boolean a3(long j17, int i17) {
        ...
        android.database.Cursor f17 = this.f99841d.f(str, null, 2);
        if (f17 == null) {
            return true;
        }
        f17.moveToFirst();
    ...
    public boolean b6(o72.j4 j4Var) {
        ...
        try {
            try {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "begin transaction, thread id:" + java.lang.Thread.currentThread().getId());
            ...
            try {
                ...
                e = e18;
                z17 = false;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.Fav.FavItemInfoStorage", e, "runTransaction", new java.lang.Object[0]);
                return z17;
            }
            try {
                if (z17) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "run transaction successfully, thread id:" + java.lang.Thread.currentThread().getId());
                    k0Var.r();
                } else {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "run transaction failed, thread id:" + java.lang.Thread.currentThread().getId());
                }
    ...
    public boolean mo880xb970c2b9(o72.r2 r2Var) {
        ...
        if (jq0Var != null) {
            ...
            if (i17 <= 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "insert::favid %d favlocalid %d type %d, sourceTypeError %d", java.lang.Integer.valueOf(r2Var.f67643xc8a07680), java.lang.Long.valueOf(r2Var.f67645x88be67a1), java.lang.Integer.valueOf(r2Var.f67657x2262335f), java.lang.Integer.valueOf(jq0Var.f459567d));
                jq0Var.g(1);
            } else {
                jq0Var.g(i17);
            }
        ...
        o72.x1.b(r2Var);
        boolean mo51731x24249762 = mo51731x24249762(r2Var, false);
        if (mo51731x24249762) {
            mo142179xf35bbb4(r2Var.f67645x88be67a1 + "", 2, java.lang.Long.valueOf(r2Var.f67645x88be67a1));
        }
    ...
    public void d5(int i17, long j17) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "setStatus status:%d localId:%d", java.lang.Integer.valueOf(i17), java.lang.Long.valueOf(j17));
        this.f99841d.A("FavItemInfo", "update FavItemInfo set itemStatus = " + i17 + " where localId = " + j17);
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        sb6.append(j17);
        sb6.append("");
        mo145247xf35bbb4(sb6.toString());
    }
    ...
    public void di() {
        ...
        int i18;
        long j17;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "calDataBaseDataTotalLength");
        int[] iArr = o72.a.f424836b;
        java.lang.String str = "";
        int i19 = 0;
        java.lang.String str2 = "";
        ...
        if (B == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "calDataBaseDataTotalLength cu = null");
            return;
        }
        if (B.getCount() == 0) {
            B.close();
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "calDataBaseDataTotalLength cu.getCount() = 0");
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "calDataBaseDataTotalLength cu.getCount() = " + B.getCount());
        long F = k0Var != null ? k0Var.F(java.lang.Long.valueOf(java.lang.Thread.currentThread().getId())) : 0L;
        while (B.moveToNext()) {
            o72.r2 r2Var = new o72.r2();
            r2Var.mo9015xbf5d97fd(B);
            int i37 = r2Var.f67644x3059914a;
            int i38 = i19;
            while (true) {
                if (i38 >= i17) {
                    i18 = i19;
            ...
            if (i18 != 0) {
                ...
                mo9952xce0038c9(r2Var, dm.i4.f66867x2a5c95c7);
            }
            i19 = 0;
            i17 = 3;
            i28 = 1;
        ...
        B.close();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "calDataBaseDataTotalLength end");
    }
    ...
    public java.util.List j6() {
        ...
        android.database.Cursor B = this.f99841d.B((str3 + " and type in (" + str + ")") + " order by datatotalsize desc", null);
        if (B == null) {
            return arrayList;
        }
        if (B.getCount() == 0) {
    ...
    public boolean mo9952xce0038c9(final o72.r2 r2Var, java.lang.String... strArr) {
        ...
        if (o72.d3.f424858e) {
            ...
            if (F != null && F.f67658x266f95d1 > r2Var.f67658x266f95d1) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "update: favId=%d favLocalId=%d type=%d, updateSeq=%d, oldUpdateSeq=%d, version=%d", objArr);
                com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.d1.f239691b.d("update_fav_item_db_seq_error", true, pm0.w.f438337e, null, true, false, new yz5.a() { // from class: b82.d$$a
                    @Override // yz5.a
                    /* renamed from: invoke */
            ...
            if (F != null && (i17 = F.f67643xc8a07680) > 0 && i17 != r2Var.f67643xc8a07680) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "update: error fav id, oldFavId=%d, newFavId=%d favLocalId=%d type=%d, updateSeq=%d, oldUpdateSeq=%d, version=%d", objArr2);
                r2Var.f67643xc8a07680 = F.f67643xc8a07680;
                com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.d1.f239691b.d("update_fav_item_db_error_fav_id", true, pm0.w.f438337e, null, true, false, new yz5.a() { // from class: b82.d$$b
                    @Override // yz5.a
                    /* renamed from: invoke */
                    public final java.lang.Object mo152xb9724478() {
        ...
        if (jq0Var != null) {
            ...
            if (i18 <= 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "update::favid %d favlocalid %d type %d, sourceTypeError %d", java.lang.Integer.valueOf(r2Var.f67643xc8a07680), java.lang.Long.valueOf(r2Var.f67645x88be67a1), java.lang.Integer.valueOf(r2Var.f67657x2262335f), java.lang.Integer.valueOf(jq0Var.f459567d));
                jq0Var.g(1);
            } else {
                jq0Var.g(i18);
            }
        ...
        if (r2Var.f67640x5ab01132 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "FavProtoItem null, info localid:" + r2Var.f67645x88be67a1 + ", type:" + r2Var.f67657x2262335f);
            jx3.f.INSTANCE.d(22021, 20251031, java.lang.Integer.valueOf(r2Var.f67657x2262335f), "FavProtoItem null");
            com.p314xaae8f345.mm.sdk.p2603x2137b148.Log.c("MicroMsg.Fav.FavItemInfoStorage", "FavProtoItem null", new java.lang.Object[0]);
        }
        o72.x1.b(r2Var);
        boolean mo51732xbf274172 = super.mo51732xbf274172(r2Var, false, strArr);
        if (mo51732xbf274172) {
            mo142179xf35bbb4(r2Var.f67645x88be67a1 + "", 3, java.lang.Long.valueOf(r2Var.f67645x88be67a1));
        }
        com.p314xaae8f345.mm.sdk.p2603x2137b148.z3.b(true);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "update favItem localId:%s favId:%s update time:%s xml:%s ret:%s", java.lang.Long.valueOf(r2Var.f67645x88be67a1), java.lang.Integer.valueOf(r2Var.f67643xc8a07680), java.lang.Long.valueOf(r2Var.f67659xa783a79b), r2Var.f67660x4b6e9352, java.lang.Boolean.valueOf(mo51732xbf274172));
    ...
    public boolean ma(long j17, int i17, java.util.List list, java.util.Set set, o72.i4 i4Var) {
        if (set != null && set.contains(java.lang.Integer.valueOf(i17))) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "hasShowAllValidItem::block set contains target type, error, do return true");
            return true;
        }
        java.lang.String str = "select count(updateTime) from FavItemInfo where updateTime < " + j17;
        if (i17 != -1) {
        ...
        android.database.Cursor f17 = this.f99841d.f(str + " and itemStatus > 0", null, 2);
        if (f17 == null) {
            return true;
        }
        f17.moveToFirst();
    ...
    public o72.r2 rc(java.lang.String str) {
        android.database.Cursor D = this.f99841d.D("FavItemInfo", null, "sourceId=?", new java.lang.String[]{"" + str}, null, null, null, 2);
        if (!D.moveToFirst()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "klem getBySourceId:%s, no data", str);
            D.close();
            return null;
        }
        o72.r2 r2Var = new o72.r2();
    ...
    public o72.r2 re(long j17) {
        android.database.Cursor B = this.f99841d.B("Select * from FavItemInfo where id = " + j17, null);
        if (B.getCount() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "klem getByFavId:%d, no data", java.lang.Long.valueOf(j17));
            B.close();
            return null;
        }
        o72.r2 r2Var = new o72.r2();
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.Fav.FavItemInfoStorage", e17, "", new java.lang.Object[0]);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "getByFavId(%d),info.convertFrom error", java.lang.Long.valueOf(j17));
            B.close();
            return null;
        }
    }
    ...
    public java.util.List v0() {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        android.database.Cursor f17 = this.f99841d.f("select localId from FavItemInfo order by updateTime desc", null, 2);
        if (f17 == null) {
            return arrayList;
        }
        if (f17.getCount() == 0) {
    ...
    public java.util.LinkedList vh(long j17, int i17) {
        ...
        android.database.Cursor f17 = this.f99841d.f((str + " and updateSeq > localSeq") + " order by updateTime desc", null, 2);
        if (f17 == null) {
            return linkedList;
        }
        while (f17.moveToNext()) {
    ...
    public java.util.ArrayList wa(java.util.List list, java.util.List list2, java.util.Set set, o72.i4 i4Var, boolean z17) {
        ...
        if (list != null && list.size() != 0 && list.size() <= 20) {
            ...
            android.database.Cursor f17 = this.f99841d.f(stringBuffer.toString(), null, 2);
            if (f17 == null) {
                return null;
            }
            if (f17.moveToFirst()) {
                ...
                do {
                    ...
                    try {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.Fav.FavItemInfoStorage", th6, "convertfrom err", new java.lang.Object[0]);
                    }
                } while (f17.moveToNext());
                arrayList = arrayList2;
            }
    ...
    public boolean xb(o72.r2 r2Var, java.lang.String... strArr) {
        ...
        return super.mo51732xbf274172(r2Var, false, strArr);
    }

    @Override // o72.k4
    public java.util.List z4(long j17, int i17, java.util.List list, java.util.Set set, o72.i4 i4Var) {
        if (set != null && set.contains(java.lang.Integer.valueOf(i17))) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.Fav.FavItemInfoStorage", "getList::block set contains target type, error, do return null");
            return null;
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Fav.FavItemInfoStorage", "[getList] sql = " + str2 + ", updateTime = " + j17);
        android.database.Cursor f17 = this.f99841d.f(str2, null, 2);
        if (f17 == null) {
            return arrayList;
        }
        while (f17.moveToNext()) {
            ...
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.Fav.FavItemInfoStorage", "fav getlist convertfrom (cu) error,continue");
            }
        }
        f17.close();
        return arrayList;
