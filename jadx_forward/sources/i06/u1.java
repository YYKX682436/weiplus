...
public abstract class u1 implements p3321xbce91901.jvm.p3324x21ffc6bd.f {

    /* renamed from: d, reason: collision with root package name */
    public static final r26.t f368289d = new r26.t("<v#(\\d+)>");
    ...
    public final void i(java.util.List list, java.lang.String str, boolean z17) {
        ...
        if (!z17) {
            ...
            list.remove(p3321xbce91901.jvm.p3324x21ffc6bd.i.class);
            list.add(p3321xbce91901.jvm.p3324x21ffc6bd.i.class);
        }
    }
    ...
    */
    public final java.util.Collection n(y16.s r9, i06.p1 r10) {
        ...
        L20:
            ...
            r4 = r3
            o06.d r4 = (o06.d) r4
            o06.g0 r5 = r4.mo9617x61f71b08()
            o06.g0 r6 = o06.f0.f423481h
    ...
    public java.lang.Class o() {
        ...
        java.util.List list = u06.i.f505038a;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(f17, "<this>");
        java.lang.Class cls = (java.lang.Class) u06.i.f505040c.get(f17);
    ...
    public final java.lang.Class s(java.lang.String str, int i17, int i18) {
        ...
        if (charAt == 'L') {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(loadClass, "loadClass(...)");
            return loadClass;
        }
        if (charAt == '[') {
            java.lang.Class s17 = s(str, i17 + 1, i18);
            n16.c cVar = i06.o4.f368248a;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(s17, "<this>");
    ...
    public final java.lang.reflect.Method t(java.lang.Class cls, java.lang.String str, java.lang.Class[] clsArr, java.lang.Class cls2) {
        try {
            ...
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(declaredMethod.getReturnType(), cls2)) {
            ...
            for (java.lang.reflect.Method method : declaredMethods) {
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(method.getName(), str) && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(method.getReturnType(), cls2) && java.util.Arrays.equals(method.getParameterTypes(), clsArr)) {
                    return method;
                }
            }
            return null;
