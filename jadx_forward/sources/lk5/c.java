...
public final class c {
    ...
    public final boolean a() {
        ...
        if (lk5.d.f400558c != z17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.IntentWrapper", "clicfg_vas_intent_wrapper_flag changed from " + lk5.d.f400558c + " to " + z17);
            lk5.d.f400558c = z17;
        }
        if (z17) {
            return true;
    ...
    public final int b(java.lang.Object obj) {
        ...
        if (obj instanceof android.os.Bundle) {
            ...
            while (it.hasNext()) {
                i17 += lk5.d.f400556a.b(bundle.get((java.lang.String) it.next()));
            }
        }
        return i17;
    }
    ...
    public final boolean c(android.content.Intent intent) {
        ...
        java.util.Iterator it = lk5.d.f400557b.iterator();
        do {
            z17 = false;
            if (!it.hasNext()) {
                return false;
    ...
    public final java.lang.String d(android.content.Intent intent, java.lang.String str, long j17, java.lang.Object value, java.lang.String str2) {
        ...
        d75.d dVar = d75.e.f308423a;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(value, "value");
        d75.e.f308424b.put(key, value);
    ...
    public final void e(android.content.Intent intent, java.lang.String str, java.lang.String str2, java.lang.String str3) {
        ...
        if (hashCode == -1377881982) {
            if (str3.equals("bundle")) {
                intent.putExtra(str, (android.os.Bundle) d75.e.f308423a.a(str4));
            }
        } else if (hashCode == -1374008726) {
            if (str3.equals("byte[]")) {
                intent.putExtra(str, (byte[]) d75.e.f308423a.a(str4));
            }
        } else if (hashCode == -891985903 && str3.equals("string")) {
            intent.putExtra(str, (java.lang.String) d75.e.f308423a.a(str4));
        }
    }
                ...
                if (extras2 != null) {
                    ...
                    if (stringArrayList != null) {
                        for (java.lang.String str : stringArrayList) {
                            ...
                            lk5.d.f400556a.e(intent, (java.lang.String) f07.get(0), (java.lang.String) f07.get(1), (java.lang.String) f07.get(2));
                            intent.removeExtra("__transfer__");
                        }
                    }
                }
            } catch (java.lang.Throwable th6) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.IntentWrapper", th6, "unWrap err", new java.lang.Object[0]);
            }
        }
    }
