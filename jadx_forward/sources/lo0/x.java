...
public final class x extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.l {
    ...
    public final /* synthetic */ java.util.HashMap f401623d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.util.List f401624e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(java.util.HashMap hashMap, java.util.List list) {
        super(1);
        this.f401623d = hashMap;
        this.f401624e = list;
    }
    ...
    public java.lang.Object mo146xb9724478(java.lang.Object obj) {
        ...
        try {
            this.f401624e.add(new lo0.j(groupObj, this.f401623d));
        } catch (lo0.u unused) {
        }
