...
public final class j2 extends i95.w implements ct.y2 {
    public final java.lang.Object Ai(java.lang.Object obj) {
        if (obj instanceof java.util.Map) {
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(obj, "null cannot be cast to non-null type kotlin.collections.MutableMap<kotlin.String, kotlin.Any?>");
            return wi(p3321xbce91901.jvm.p3324x21ffc6bd.m0.c(obj));
        }
        ...
        try {
            for (java.util.Map.Entry entry : map.entrySet()) {
                ...
                if (value instanceof java.util.Map) {
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.e(value, "null cannot be cast to non-null type kotlin.collections.MutableMap<kotlin.String, kotlin.Any?>");
                    value = wi(p3321xbce91901.jvm.p3324x21ffc6bd.m0.c(value));
