...
public final class d extends android.text.style.ReplacementSpan implements gb5.a, xe0.h0 {
    ...
    public final java.lang.String f87136d;

    /* renamed from: e, reason: collision with root package name */
    public java.lang.String f87137e;

    /* renamed from: f, reason: collision with root package name */
    public final bi4.d f87138f;

    /* renamed from: g, reason: collision with root package name */
    public final bi4.c f87139g;

    /* renamed from: h, reason: collision with root package name */
    public final xe0.u0 f87140h;

    /* renamed from: i, reason: collision with root package name */
    public mj4.h f87141i;

    /* renamed from: m, reason: collision with root package name */
    public final android.view.View.OnClickListener f87142m;

    /* renamed from: n, reason: collision with root package name */
    public boolean f87143n;

    /* renamed from: o, reason: collision with root package name */
    public boolean f87144o;

    /* renamed from: p, reason: collision with root package name */
    public boolean f87145p;

    /* renamed from: q, reason: collision with root package name */
    public android.graphics.drawable.Drawable f87146q;

    /* renamed from: r, reason: collision with root package name */
    public boolean f87147r;

    /* renamed from: s, reason: collision with root package name */
    public long f87148s;

    /* renamed from: t, reason: collision with root package name */
    public java.lang.String f87149t;

    /* renamed from: u, reason: collision with root package name */
    public java.lang.ref.WeakReference f87150u;

    /* renamed from: v, reason: collision with root package name */
    public final ak4.k f87151v;

    /* renamed from: w, reason: collision with root package name */
    public java.lang.String f87152w;

    /* renamed from: x, reason: collision with root package name */
    public final float f87153x;

    /* renamed from: y, reason: collision with root package name */
    public final float f87154y;

    /* renamed from: z, reason: collision with root package name */
    public final boolean f87155z;
    ...
    public d(android.view.View view, java.lang.String str, java.lang.String str2, bi4.d iconType, bi4.c cVar, xe0.u0 style, mj4.h hVar, android.view.View.OnClickListener onClickListener) {
        ...
        this.f87136d = str;
        this.f87137e = str2;
        this.f87138f = iconType;
        this.f87139g = cVar;
        this.f87140h = style;
        this.f87141i = hVar;
        this.f87142m = onClickListener;
        this.f87143n = c(hVar, null);
        this.f87151v = new ak4.k();
        this.f87152w = l(this.f87141i);
        float f17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getResources().getDisplayMetrics().density;
        this.f87153x = f17;
        float f18 = style.f535337e;
        this.f87154y = f18 <= 0.0f ? (style.f535333a * 0.5f) + (f17 * 4.0f) : f18;
        this.f87155z = style.f535342j != xe0.p0.f535300d;
        this.A = -1.0f;
        this.C = -1;
        this.P = "MicroMsg.TextStatus.TSItemSpan@" + hashCode();
        this.f87150u = view != null ? new java.lang.ref.WeakReference(view) : null;
        mj4.h hVar2 = this.f87141i;
        h(hVar2 != null ? ((mj4.k) hVar2).z() : false, com.p314xaae8f345.p592x631407a.p601x2eefaa.C4783xfba32e6c.f20537xdb4c7a82);
    ...
    public final boolean c(mj4.h hVar, java.lang.Boolean bool) {
        ...
        java.lang.String str = this.f87136d;
        if (str == null || r26.n0.N(str)) {
            return booleanValue;
        }
        if (str != null ? p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, en1.a.a()) : false) {
            return true;
        }
        return booleanValue;
    }
    ...
    public final boolean d(int i17, int i18) {
        ...
        if (!this.N) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(this.P, "[TSSpanHit] containsPoint skip: lastDrawValid=false");
            return false;
        }
        boolean z17 = this.f87143n;
        xe0.u0 u0Var = this.f87140h;
        xe0.t0 t0Var = z17 ? u0Var.f535350r : u0Var.f535349q;
        int i19 = this.f87135J - t0Var.f535330b;
        int i27 = this.K - t0Var.f535329a;
        int i28 = this.L + t0Var.f535332d;
        int i29 = this.M + t0Var.f535331c;
        if (i19 <= i17 && i17 <= i28) {
    ...
    */
    ...
    public final android.view.View f() {
        java.lang.ref.WeakReference weakReference = this.f87150u;
    ...
    public final boolean g() {
        java.lang.String str = this.f87137e;
        if (str == null || r26.n0.N(str)) {
            return this.f87152w.length() == 0;
        }
        return false;
    }
    ...
    public int getSize(android.graphics.Paint paint, java.lang.CharSequence charSequence, int i17, int i18, android.graphics.Paint.FontMetricsInt fontMetricsInt) {
        ...
        ak4.i i19 = i(paint);
        boolean z17 = this.f87140h.f535340h;
        ...
        if (!this.I) {
            ...
            if (textView != null) {
                java.lang.String str4 = this.f87137e;
                if (str4 != null && (j17 = bk4.f0.f102998a.j(str4)) != null) {
    ...
    public final void h(boolean z17, java.lang.String str) {
        ...
        java.lang.String str2 = this.f87136d;
        if (str2 == null || r26.n0.N(str2)) {
            return;
        }
        if ((str2 != null ? p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str2, en1.a.a()) : false) && !z17) {
            this.f87144o = true;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(this.P, "[TSItemSpan] isRead selfOverride username=" + str2 + " rawIsRead=false finalIsRead=true scene=" + str);
        }
    }
    ...
    */
    ...
    public final void k(java.lang.String str, boolean z17) {
        ...
        if (f17 == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(str3, "[TSItemSpan] refreshHost skip: host null/dead u=" + str2 + " reason=" + str);
            return;
        }
        if (f17 instanceof bi4.j0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str3, "[TSItemSpan] refreshHost via IRefreshContent u=" + str2 + " reason=" + str + " host=" + f17.getClass().getSimpleName());
            ((bi4.j0) f17).a();
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str3, "[TSItemSpan] refreshHost via View.post u=" + str2 + " reason=" + str + " host=" + f17.getClass().getSimpleName() + " requestLayout=" + z17);
    ...
    public final java.lang.String l(mj4.h hVar) {
        ...
        if (z17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str3, "resolveWording empty: reason=iconId-null username=" + str2);
            return "";
        }
        pj4.o1 j17 = bk4.f0.f102998a.j(str);
        if (j17 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str3, "resolveWording empty: reason=iconItem-null iconId=" + str + " username=" + str2);
            return "";
        }
        if (bk4.i.a().a(this.f87137e)) {
            java.lang.String str5 = hVar != null ? xe0.j0.a(hVar, false, 1, null).f436751i : null;
            if (str5 != null) {
                str4 = str5;
            }
        }
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str3, "resolveWording iconId=" + str + " desc='" + str4 + "' username=" + str2);
        return str4;
    }

    /* renamed from: onClick */
    public final void m2166xaf6b9ae9(android.view.View view) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(view, "view");
        android.view.View.OnClickListener onClickListener = this.f87142m;
