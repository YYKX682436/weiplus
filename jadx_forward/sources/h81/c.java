...
public class c implements bi3.a {
    public bi3.b a(java.lang.String str, java.lang.String str2, int i17, int i18, int i19, int i27, long j17, long j18, int i28, int i29) {
        int i37 = wo.v1.f529362i.f529229j;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSightPresendRemuxerImpl", "get, configRemuxerType: %s", java.lang.Integer.valueOf(i37));
        if (i37 != -1) {
            if (i37 == 1) {
