...
public abstract class h {
    ...
    public static final java.lang.Object[] f391655a = new java.lang.Object[0];
    ...
    public static final java.lang.Object[] a(java.util.Collection collection) {
        ...
        java.lang.Object[] objArr = f391655a;
        if (size == 0) {
            return objArr;
        }
        ...
        while (true) {
            ...
            if (i18 >= objArr2.length) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(objArr2, "copyOf(...)");
            } else if (!it.hasNext()) {
    ...
    public static final java.lang.Object[] b(java.util.Collection collection, java.lang.Object[] objArr) {
        ...
        if (size <= objArr.length) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(newInstance, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
