...
public abstract class p extends yp.a {
    ...
    public yp.o b(wp.a aVar) {
        wp.i iVar = (wp.i) aVar;
        int j17 = j(iVar.f529887y);
        yp.o a17 = yp.f.f545911a.a(j17, this);
        l(j17, a17, iVar);
        yp.o oVar = iVar.H;
    ...
    public void f(android.graphics.Canvas canvas, wp.a aVar, xp.d dVar, float f17, float f18) {
        ...
        boolean z17 = iVar.I;
        android.view.View view = oVar.f545927a;
        if (!z17) {
        ...
        android.graphics.RectF rectF = oVar.f545928b;
        rectF.set(0.0f, 0.0f, view.getMeasuredWidth(), view.getMeasuredHeight());
        android.graphics.Paint paint = oVar.f545929c;
    ...
    public final wp.b i(wp.i iVar, yp.o oVar) {
        oVar.e(android.view.View.MeasureSpec.makeMeasureSpec(iVar.h(), Integer.MIN_VALUE), android.view.View.MeasureSpec.makeMeasureSpec(xp.d.f().f537387k, Integer.MIN_VALUE));
        oVar.f545927a.layout(0, 0, oVar.b(), oVar.a());
        iVar.H = oVar;
        iVar.f529883u = oVar.b();
        iVar.f529884v = oVar.a();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("ViewDanmakuRender", "executeMeasureViewHolder: width = %d, height = %d", java.lang.Integer.valueOf(oVar.b()), java.lang.Integer.valueOf(oVar.a()));
    ...
    public void g(wp.i iVar, xp.d dVar, float f17, float f18, android.view.View view) {
        ...
        boolean z17 = iVar.I;
        android.view.View view2 = oVar.f545927a;
        boolean z18 = false;
        if (!z17) {
            oVar.e(android.view.View.MeasureSpec.makeMeasureSpec(oVar.b(), 1073741824), android.view.View.MeasureSpec.makeMeasureSpec(oVar.a(), 1073741824));
        ...
        if (!(view instanceof com.p314xaae8f345.mm.p672x55b6590f.p673xc84b4196.C10429x362d5b9d)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("ViewDanmakuRender", "onDrawNative: error, danmakuView=" + view);
            return;
        }
        if (view2.getParent() != view) {
            ...
            ((com.p314xaae8f345.mm.p672x55b6590f.p673xc84b4196.C10429x362d5b9d) view).addView(view2, oVar.b(), oVar.a());
        } else if (iVar.f529880r) {
            view2.bringToFront();
        }
