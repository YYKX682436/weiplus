...
public final class a extends android.text.style.CharacterStyle implements android.text.style.UpdateAppearance {
    ...
    public final java.util.LinkedList f356283d;

    public a(java.util.LinkedList colorList) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(colorList, "colorList");
        this.f356283d = colorList;
    }

    @Override // android.text.style.CharacterStyle
    public void updateDrawState(android.text.TextPaint textPaint) {
        if (textPaint != null) {
            java.util.LinkedList linkedList = this.f356283d;
            java.util.ArrayList arrayList = new java.util.ArrayList(kz5.d0.q(linkedList, 10));
            java.util.Iterator it = linkedList.iterator();
            while (it.hasNext()) {
                arrayList.add(java.lang.Integer.valueOf(zl2.q4.f555466a.O((java.lang.String) it.next())));
            }
