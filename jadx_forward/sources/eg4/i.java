...
public final class i implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ eg4.t f334259d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f334260e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ y35.r f334261f;

    public i(eg4.t tVar, android.content.Context context, y35.r rVar) {
        this.f334259d = tVar;
        this.f334260e = context;
        this.f334261f = rVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        eg4.t tVar = this.f334259d;
        tVar.getClass();
        ns.k kVar = (ns.k) i95.n0.c(ns.k.class);
        android.content.Context context = this.f334260e;
        ((ms.a) kVar).Ai(context, new eg4.h(context, this.f334261f, tVar));
