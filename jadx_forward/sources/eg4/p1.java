...
public class p1 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ eg4.t1 f334309d;
    ...
    public void onClick(android.view.View view) {
        ...
        if (view.getTag() instanceof y35.r) {
            ...
            ((ms.a) ((ns.k) i95.n0.c(ns.k.class))).Ai(this.f334309d.f334344o, new ns.j() { // from class: eg4.p1$$a
                @Override // ns.j
                public final void a(boolean z17) {
                    eg4.p1 p1Var = eg4.p1.this;
                    eg4.t1 t1Var = p1Var.f334309d;
                    y35.r rVar2 = rVar;
                    if (!z17) {
                        eg4.t1.u(t1Var, rVar2);
                        return;
                    }
                    ((ms.a) ((ns.k) i95.n0.c(ns.k.class))).Bi(t1Var.f334344o, 3, rVar2.f540765a, new eg4.q1(p1Var, rVar2));
                }
            });
        }
