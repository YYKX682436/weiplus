...
public class t implements d50.o {
    ...
    public final /* synthetic */ nz2.b f423105a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ nz2.x f423106b;
    ...
    public void b(eu5.a aVar) {
        ...
        this.f423106b.getClass();
        nz2.b bVar = this.f423105a;
        if (bVar != null) {
            bVar.a(nz2.c.b(aVar));
        }
    }
    ...
    public void c(int i17, eu5.a aVar) {
        ...
        if (aVar.f557138a == 1021) {
            ((ne4.n) this.f423106b.f423113d).a(true);
        }
        if (bVar != null) {
            bVar.a(nz2.c.b(aVar));
        }
