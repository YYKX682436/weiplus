...
public class i extends android.hardware.fingerprint.FingerprintManager.AuthenticationCallback {
    ...
    public final /* synthetic */ xt5.j f538701a;
    ...
    public void onAuthenticationHelp(int i17, java.lang.CharSequence charSequence) {
        ...
        zt5.h.e("Soter.FingerprintManagerCompat", "soter: using system anti brute force strategy", new java.lang.Object[0]);
        aVar.f538695b.d(i17, charSequence);
    }
    ...
    */
    public void onAuthenticationSucceeded(android.hardware.fingerprint.FingerprintManager.AuthenticationResult r7) {
        ...
        L58:
            ...
            goto L84
        L67:
            javax.crypto.Cipher r3 = r2.f538703b
            if (r3 == 0) goto L71
            xt5.e r1 = new xt5.e
            r1.<init>(r3)
            goto L84
        L71:
            java.security.Signature r3 = r2.f538702a
            if (r3 == 0) goto L7b
            xt5.e r1 = new xt5.e
            r1.<init>(r3)
            goto L84
        L7b:
            javax.crypto.Mac r2 = r2.f538704c
            if (r2 == 0) goto L84
            xt5.e r1 = new xt5.e
            r1.<init>(r2)
        L84:
            r0.<init>(r1)
            xt5.c r7 = r7.f538695b
            r7.e(r0)
        L8c:
            return
        */
