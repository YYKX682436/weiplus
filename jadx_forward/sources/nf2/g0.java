...
public final class g0 {
    ...
    public final nf2.e1 f418272a;

    /* renamed from: b, reason: collision with root package name */
    public final nf2.f1 f418273b;

    /* renamed from: c, reason: collision with root package name */
    public android.graphics.Rect f418274c;
    ...
    public final jz5.l a(float f17, float f18) {
        ...
        if (b17 != null && (rect = this.f418274c) != null) {
            nf2.e1 e1Var = this.f418272a;
            boolean z17 = ((nf2.d1) e1Var).f418233u;
            ...
            if (z17) {
                ...
                if (height2 > i18) {
                    f18 = (this.f418276e - height2) / 2.0f;
                } else {
                    int i47 = rect.top;
                    if (f18 < i47) {
                        f18 = i47;
    ...
    public final android.view.View b() {
        return ((nf2.d1) this.f418272a).f418218f;
    }
    ...
    public final jz5.l c() {
        ...
        if (this.f418275d <= 0 || this.f418276e <= 0) {
            return new jz5.l(valueOf, valueOf);
        }
        return new jz5.l(java.lang.Float.valueOf((b17.getX() + (b17.getWidth() / 2.0f)) / this.f418275d), java.lang.Float.valueOf((b17.getY() + (b17.getHeight() / 2.0f)) / this.f418276e));
    }
    ...
    public final void d() {
        ...
        int i17 = this.f418276e;
        nf2.f1 f1Var = this.f418273b;
        int i18 = (int) (i17 * f1Var.f418259h);
        int i19 = (int) (i17 * (1 - f1Var.f418260i));
        int a17 = ym5.x.a(context, f1Var.f418261j);
        int a18 = ym5.x.a(context, f1Var.f418262k);
        this.f418274c = new android.graphics.Rect(a17, i18 + a18, this.f418275d - a17, i19 - a18);
    }
