...
public final class z2 extends kh.a3 {
    ...
    public int a(kh.f3 threadIdCard) {
        ...
        java.lang.String str2 = this.f389497f;
        if (!r26.i0.A(str, str2, false, 2, null)) {
            if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, str2 + 'J')) {
                return 0;
            }
        }
        return this.f389498g;
    }

    public /* synthetic */ z2(java.lang.String str, int i17, int i18, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
