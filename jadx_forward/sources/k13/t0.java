...
public final class t0 implements l13.c {
    ...
    public final /* synthetic */ k13.l1 f384799a;
    ...
    public void b(android.view.View view, int i17, int i18, float f17, android.view.View view2, android.view.View view3) {
        ...
        int i19 = i17 - i18;
        k13.l1 l1Var = this.f384799a;
        int max = 255 - ((int) ((java.lang.Math.max(0.0f, i19 - f17) * (l1Var.f384746g ? 0.2f : 0.05f)) * 255));
        ...
        if (i19 == 0 && i18 == l1Var.f384772q.size() - 2 && (view5 = l1Var.f384770o) != null) {
        ...
        if (i19 == 0 && i18 == l1Var.f384772q.size() - 1 && (view4 = l1Var.f384770o) != null) {
