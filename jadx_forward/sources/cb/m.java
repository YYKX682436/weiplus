...
public final class m {
    ...
    public static int f121679g;

    /* renamed from: h, reason: collision with root package name */
    public static android.app.PendingIntent f121680h;

    /* renamed from: b, reason: collision with root package name */
    public final android.content.Context f121682b;

    /* renamed from: c, reason: collision with root package name */
    public final cb.f f121683c;

    /* renamed from: e, reason: collision with root package name */
    public android.os.Messenger f121685e;

    /* renamed from: f, reason: collision with root package name */
    public com.p176xb6135e39.p271xde6bf207.iid.zzi f121686f;

    /* renamed from: a, reason: collision with root package name */
    public final x.n f121681a = new x.n();

    /* renamed from: d, reason: collision with root package name */
    public final android.os.Messenger f121684d = new android.os.Messenger(new cb.n(this, android.os.Looper.getMainLooper()));

    public m(android.content.Context context, cb.f fVar) {
        this.f121682b = context;
        this.f121683c = fVar;
    }

    public final void a(java.lang.String str, android.os.Bundle bundle) {
        synchronized (this.f121681a) {
            com.p176xb6135e39.p177xcca8366f.gms.p241x6907b8e.C2440x4f4de6dc c2440x4f4de6dc = (com.p176xb6135e39.p177xcca8366f.gms.p241x6907b8e.C2440x4f4de6dc) this.f121681a.m174754xc84af884(str);
            if (c2440x4f4de6dc != null) {
                c2440x4f4de6dc.m19604x209a1f1f(bundle);
                return;
            }
    ...
    public final android.os.Bundle b(android.os.Bundle bundle) {
        ...
        android.content.Context context = this.f121682b;
        synchronized (cb.j0.class) {
            if (cb.j0.f121664e == null) {
                cb.j0.f121664e = new cb.j0(context, java.util.concurrent.Executors.newSingleThreadScheduledExecutor());
            }
            j0Var = cb.j0.f121664e;
        }
        synchronized (j0Var) {
            i18 = j0Var.f121668d;
            j0Var.f121668d = i18 + 1;
        }
        try {
            return (android.os.Bundle) com.p176xb6135e39.p177xcca8366f.gms.p241x6907b8e.C2442x4cd8b6e.m19608x58e7956(j0Var.a(new cb.e(i18, 1, bundle)));
            ...
            if (!(e17.getCause() instanceof cb.d) || ((cb.d) e17.getCause()).f121648d != 4) {
                return null;
            }
