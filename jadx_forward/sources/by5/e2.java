...
public class e2 implements qx5.j {
    ...
    public qx5.a a(android.content.Context context, android.net.Uri uri, qx5.l lVar) {
        if (lVar != null && lVar.mo161097x86b9ebe3() != null) {
            com.p314xaae8f345.p3210x3857dc.C27816xac2547f9 mo161097x86b9ebe3 = lVar.mo161097x86b9ebe3();
                    ...
                    if (listFiles2 == null || listFiles2.length == 0) {
                        ...
                        for (int i17 = 0; i17 < listFiles2.length; i17++) {
                            if (listFiles2[i17].getName().endsWith(".zip")) {
                                ...
                                new android.app.AlertDialog.Builder(context).setTitle("提示").setMessage("确定加载:" + name + "?").setPositiveButton("确定", new qx5.k0(mo161097x86b9ebe3, str, absolutePath, name)).setNegativeButton("取消", new qx5.j0()).show();
                                break;
                            }
                        }
                        by5.a1.g(context, "xweb_dump目录下没有.zip文件", true);
