...
public abstract class d1 {
    ...
    public static java.util.HashSet f117963a;
    ...
    public static qx5.c a(java.lang.String str) {
        if (f117963a == null || android.text.TextUtils.isEmpty(str)) {
            return null;
        }
        java.util.Iterator it = f117963a.iterator();
        while (it.hasNext()) {
            qx5.c cVar = (qx5.c) it.next();
            if (cVar.f449016a.equals(str) || str.equals(cVar.f449017b)) {
                return cVar;
            }
        }
        return null;
    ...
    */
    ...
    public static void d(java.lang.String str, boolean z17, qx5.j jVar) {
        ...
        f117963a.add(new qx5.c(str, z17, jVar));
    }
}
