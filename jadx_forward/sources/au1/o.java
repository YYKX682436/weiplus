...
public final class o extends au1.s {
    public o(java.lang.String marchantId, long j17, double d17, double d18, int i17, int i18) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CgiGetCardPkgMchInfo", "marchantid: %s, lastReceiveTime: %s, lat: %s, long: %s", marchantId, java.lang.Long.valueOf(j17), java.lang.Double.valueOf(d17), java.lang.Double.valueOf(d18));
    }
}
