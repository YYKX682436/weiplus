...
public final class a extends i9.b {
    ...
    public static final java.util.regex.Pattern f398777r = java.util.regex.Pattern.compile("(?:(\\d+):)?(\\d+):(\\d+)(?::|\\.)(\\d+)");

    /* renamed from: m, reason: collision with root package name */
    public final boolean f398778m;
    ...
    public static long h(java.lang.String str) {
        java.util.regex.Matcher matcher = f398777r.matcher(str);
        if (matcher.matches()) {
            return (java.lang.Long.parseLong(matcher.group(1)) * 60 * 60 * 1000000) + (java.lang.Long.parseLong(matcher.group(2)) * 60 * 1000000) + (java.lang.Long.parseLong(matcher.group(3)) * 1000000) + (java.lang.Long.parseLong(matcher.group(4)) * com.p314xaae8f345.tav.p2959x5befac44.C25764x27f5008f.f48024x857b539d);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x003f, code lost:
        ...
        if (r11.f398779n != 0) goto L49;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0042, code lost:
    
        r2 = r2.substring(10).split(",", r11.f398779n);
        r3 = h(r2[r11.f398780o]);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x007a, code lost:
        ...
        r14.add(new i9.a(r2[r11.f398782q].replaceAll("\\{.*?\\}", "").replaceAll("\\\\N", "\n").replaceAll("\\\\n", "\n")));
     */
    ...
    */
    ...
    public final void g(java.lang.String str) {
        ...
        this.f398779n = split.length;
        this.f398780o = -1;
        this.f398781p = -1;
        this.f398782q = -1;
        for (int i17 = 0; i17 < this.f398779n; i17++) {
            ...
            switch (j17.hashCode()) {
                case 100571:
                    ...
                    break;
                case 3556653:
                    if (j17.equals(com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3068x36f002.C26514x6b29e485.f54270xd8c04b24)) {
                        c17 = 1;
                        break;
                    }
                    break;
