...
public final class n extends com.p176xb6135e39.p283xc50a8b8b.q5 implements kg.q {

    /* renamed from: d, reason: collision with root package name */
    public int f389109d;

    /* renamed from: e, reason: collision with root package name */
    public java.lang.Object f389110e;
    ...
    public com.p176xb6135e39.p283xc50a8b8b.k8 mo20556x59bc66e() {
        kg.p mo20557x85702333 = mo20557x85702333();
    ...
    public kg.p mo20557x85702333() {
        kg.p pVar = new kg.p(this);
        if (this.f389109d == 1) {
            pVar.f72584x5a5c70f = this.f389110e;
        }
        if (this.f389109d == 2) {
            pVar.f72584x5a5c70f = this.f389110e;
        }
        ...
        pVar.f72583x9ee0e9bf = this.f389109d;
        m20880xaf619bdf();
        return pVar;
    }

    /* renamed from: clone */
    public java.lang.Object m142968x5a5dd5d() {
        return (kg.n) m45490x5a5dd5d();
    }
    ...
    */
    public kg.n d(com.p176xb6135e39.p283xc50a8b8b.d0 r3, com.p176xb6135e39.p283xc50a8b8b.t4 r4) {
        /*
            r2 = this;
            r0 = 0
            com.google.protobuf.e9 r1 = kg.p.m143061x23f4f150()     // Catch: java.lang.Throwable -> L11 com.p176xb6135e39.p283xc50a8b8b.y6 -> L13
            java.lang.Object r3 = r1.mo20549xc7f9c18(r3, r4)     // Catch: java.lang.Throwable -> L11 com.p176xb6135e39.p283xc50a8b8b.y6 -> L13
            kg.p r3 = (kg.p) r3     // Catch: java.lang.Throwable -> L11 com.p176xb6135e39.p283xc50a8b8b.y6 -> L13
            if (r3 == 0) goto L10
            r2.e(r3)
        L10:
            return r2
    ...
    public kg.n e(kg.p pVar) {
        ...
        if (pVar == kg.p.m143062x7c90cfc0()) {
            return this;
        }
        int ordinal = pVar.m143081xb286a816().ordinal();
        if (ordinal == 0) {
            kg.l0 m143082xcb0e0c95 = pVar.m143082xcb0e0c95();
            if (this.f389109d != 1 || this.f389110e == kg.l0.m142938x7c90cfc0()) {
                this.f389110e = m143082xcb0e0c95;
            } else {
                kg.k0 m142941x3136c9db = kg.l0.m142941x3136c9db((kg.l0) this.f389110e);
                m142941x3136c9db.e(m143082xcb0e0c95);
                this.f389110e = m142941x3136c9db.mo20557x85702333();
            }
            m20881x7bb163d5();
            this.f389109d = 1;
        } else if (ordinal == 1) {
            kg.o2 m143085x4ed8e7b5 = pVar.m143085x4ed8e7b5();
            if (this.f389109d != 2 || this.f389110e == kg.o2.m143026x7c90cfc0()) {
                this.f389110e = m143085x4ed8e7b5;
            } else {
                kg.n2 m143029x3136c9db = kg.o2.m143029x3136c9db((kg.o2) this.f389110e);
                m143029x3136c9db.e(m143085x4ed8e7b5);
                this.f389110e = m143029x3136c9db.mo20557x85702333();
            }
            m20881x7bb163d5();
            this.f389109d = 2;
        } else if (ordinal == 2) {
            kg.j m143079xa9d4990 = pVar.m143079xa9d4990();
            if (this.f389109d != 3 || this.f389110e == kg.j.m142827x7c90cfc0()) {
                this.f389110e = m143079xa9d4990;
            } else {
                kg.i m142830x3136c9db = kg.j.m142830x3136c9db((kg.j) this.f389110e);
                m142830x3136c9db.e(m143079xa9d4990);
                this.f389110e = m142830x3136c9db.mo20557x85702333();
            }
            m20881x7bb163d5();
            this.f389109d = 3;
        }
        waVar = ((com.p176xb6135e39.p283xc50a8b8b.l6) pVar).f7874x4f0c37a3;
        m20881x7bb163d5();
        return this;
    }
    ...
    public com.p176xb6135e39.p283xc50a8b8b.a m45492xba8a5e4b(com.p176xb6135e39.p283xc50a8b8b.wa waVar) {
        return (kg.n) m45492xba8a5e4b(waVar);
    }
    ...
    public n(com.p176xb6135e39.p283xc50a8b8b.r5 r5Var, kg.b bVar) {
        super(r5Var);
        boolean unused;
        this.f389109d = 0;
        unused = com.p176xb6135e39.p283xc50a8b8b.l6.f7872x2df6253a;
