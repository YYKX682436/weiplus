...
public abstract class s {
    public static byte[] a(java.lang.String str, java.lang.String str2) {
        return com.p314xaae8f345.mm.p1006xc5476f33.p1409x9e7e39d6.p1410x4e42091.C13537xa00bccff.m55291xa0333265(str, str2, str2.getBytes().length);
    }

    public static byte[] b(java.lang.String str, byte[] bArr, boolean z17) {
        org.json.JSONObject jSONObject = new org.json.JSONObject();
        java.lang.String m55292xbee3dde1 = com.p314xaae8f345.mm.p1006xc5476f33.p1409x9e7e39d6.p1410x4e42091.C13537xa00bccff.m55292xbee3dde1(bArr, bArr.length);
        jSONObject.put("face_lib_version", 3);
        jSONObject.put("md5", m55292xbee3dde1);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FaceFlashDataUtil", "getBioHeader md5:%s", m55292xbee3dde1);
    ...
    public static org.json.JSONArray c(org.json.JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FaceFlashManagerError", "LIVE_REFLECTION cameraData : JSONException");
            }
        } else {
            jSONArray = null;
        }
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FaceFlashManagerError", "LIVE_REFLECTION does not have cameraData");
        return jSONArray2;
    }
    ...
    public static byte[] d(org.json.JSONObject jSONObject, java.lang.String str) {
        ...
        jSONObject8.put("face_image", com.p314xaae8f345.mm.p1006xc5476f33.p1404x3e850340.C13511x29b1cb27.m55189x18326393(str, string2, string));
    ...
    public static org.json.JSONObject e(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4, int i17, org.json.JSONObject jSONObject) {
        ...
        jSONObject3.put(com.p314xaae8f345.p347x615374d.p349x208df1fe.p358xd1075a44.p360x696c9db.C3365xfbc5fb5e.f13298xf9601dcd, str2);
        jSONObject3.put("business_name", str3);
        jSONObject3.put("person_id", str4);
        jSONObject3.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.LiveExKeys.f54530xa4e1ea94, i17);
        ...
        if (i17 == 2) {
            ...
            if (jSONObject2 == null) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FaceFlashManagerError", "LIVE_REFLECTION does not have livedata");
            }
            if (jSONObject2.has("select_data")) {
                org.json.JSONObject jSONObject5 = new org.json.JSONObject();
        ...
        org.json.JSONObject jSONObject7 = new org.json.JSONObject();
        if (i17 == 2) {
            jSONObject7.put("face_image", com.p314xaae8f345.mm.p1006xc5476f33.p1409x9e7e39d6.p1410x4e42091.C13537xa00bccff.m55293x10daa963(str, jSONObject.getJSONObject("livedata").getJSONArray("frames").getJSONObject(0).getString("image")));
            org.json.JSONArray jSONArray2 = new org.json.JSONArray();
            ...
            jSONObject7.put("face_image", com.p314xaae8f345.mm.p1006xc5476f33.p1409x9e7e39d6.p1410x4e42091.C13537xa00bccff.m55293x10daa963(str, jSONObject.getJSONObject("live_image").getString("image")));
            ...
            for (int i19 = 0; i19 < jSONArray3.length(); i19 = i19 + 1 + 1) {
                ...
                jSONObject9.put("x", com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L(java.lang.String.valueOf(jSONArray3.get(i19)), 0.0f));
                jSONObject9.put("y", com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L(java.lang.String.valueOf(jSONArray3.get(r9)), 0.0f));
