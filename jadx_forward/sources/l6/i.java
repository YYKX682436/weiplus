...
public class i extends l6.c {
    ...
    public static final java.util.concurrent.atomic.AtomicInteger f398261d = new java.util.concurrent.atomic.AtomicInteger();

    /* renamed from: b, reason: collision with root package name */
    public final android.os.Vibrator f398262b;

    /* renamed from: c, reason: collision with root package name */
    public final java.lang.Class f398263c;

    public i(android.content.Context context) {
        this.f398262b = (android.os.Vibrator) context.getSystemService("vibrator");
        try {
            this.f398263c = java.lang.Class.forName("android.os.RichTapVibrationEffect");
        } catch (java.lang.ClassNotFoundException unused) {
        }
        if (this.f398263c == null) {
            try {
                this.f398263c = java.lang.Class.forName("android.os.VibrationEffect");
    ...
    public void a(java.lang.String str, int i17, int i18, int i19, int i27) {
        int i28;
        android.os.Vibrator vibrator = this.f398262b;
        if (vibrator != null && i17 >= 1) {
            try {
                ...
                if (l6.m.f398274c) {
                    ...
                    int i37 = l6.m.f398272a;
                    if (!f(i37, l6.m.f398273b, i29)) {
                ...
                if (m17 != null && m17.length != 0) {
                    int andIncrement = f398261d.getAndIncrement();
                    ...
                    while (i38 < ((int) java.lang.Math.ceil(m17.length / 4.0d))) {
                        ...
                        try {
                            if (android.os.Build.VERSION.SDK_INT >= 26) {
                                java.lang.Class cls = this.f398263c;
    ...
    public void e() {
        try {
            if (android.os.Build.VERSION.SDK_INT >= 26) {
                java.lang.Class cls = this.f398263c;
                java.lang.Class<?> cls2 = java.lang.Integer.TYPE;
                this.f398262b.vibrate((android.os.VibrationEffect) cls.getMethod("createPatternHeParameter", cls2, cls2, cls2).invoke(null, 0, 0, 0));
            }
        } catch (java.lang.Exception unused) {
        }
    }
    ...
    public int[] g(int i17, int i18, int i19, int i27, int i28, int i29, l6.f[] fVarArr) {
        ...
        while (i47 < i19) {
            ...
            iArr2[0] = i49;
            iArr2[c17] = fVar.f398256a;
            l6.e[] eVarArr = fVar.f398257b;
