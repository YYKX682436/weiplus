...
public final class n0 extends rs.k {
    ...
    public void E(p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var) {
        ...
        animate.setDuration(200L).alpha(0.0f).translationY(k3Var.f3639x46306858.getContext().getResources().getDimension(com.p314xaae8f345.mm.R.C30860x5b28f31.f561256df)).setStartDelay(0L).setListener(new uw2.m0(this, k3Var, itemView, animate)).start();
    }
    ...
    public boolean t(p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 holder) {
        ...
        view2.setTranslationY(-view2.getContext().getResources().getDimension(com.p314xaae8f345.mm.R.C30860x5b28f31.f561256df));
