...
public abstract class g {
    public static final void a(q1.f fVar, p1.s event) {
        ...
        java.util.List list = event.f432421j;
        if (list == null) {
        ...
        int i17 = 0;
        while (true) {
            q1.b[] bVarArr = fVar.f441026a;
            if (i17 >= size) {
                long j17 = event.f432413b;
                long j18 = event.f432414c;
                int i18 = (fVar.f441027b + 1) % 20;
                fVar.f441027b = i18;
                bVarArr[i18] = new q1.b(j18, j17, null);
                return;
            }
            p1.e eVar = (p1.e) list.get(i17);
            long j19 = eVar.f432343a;
            long j27 = eVar.f432344b;
            int i19 = (fVar.f441027b + 1) % 20;
            fVar.f441027b = i19;
    ...
    public static final q1.c b(java.util.List x17, java.util.List y17, int i17) {
        ...
        int i37 = 0;
        while (true) {
            q1.d[] dVarArr = aVar2.f441014a;
            if (i37 >= i27) {
                q1.d dVar = new q1.d(size2);
                for (int i38 = 0; i38 < size2; i38++) {
                    dVar.f441020b[i38] = java.lang.Float.valueOf(((java.lang.Number) y17.get(i38)).floatValue() * 1.0f);
                }
                int i39 = i27 - 1;
            ...
            int i76 = 0;
            while (i76 < i27) {
                aVar3.b(i37, i76, i76 < i37 ? 0.0f : dVarArr[i37].a(aVar.f441014a[i76]));
                i76++;
            }
            i37++;
        }
