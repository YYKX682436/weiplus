...
public class o implements b3.n {
    ...
    public final java.lang.String f99083a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.HashMap f99084b = new java.util.HashMap();
    ...
    public java.io.File a(android.net.Uri uri) {
        ...
        java.io.File file = (java.io.File) this.f99084b.get(decode);
        if (file == null) {
