...
public final class a0 implements f2.y {
    ...
    public android.graphics.Typeface b(f2.s name, f2.r fontWeight, int i17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(fontWeight, "fontWeight");
        java.lang.String name2 = name.f340359b;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(name2, "name");
        int i18 = fontWeight.f340358d / 100;
        boolean z17 = false;
        if (i18 >= 0 && i18 < 2) {
        ...
        if (!(str.length() == 0)) {
            ...
            if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(c17, android.graphics.Typeface.create(android.graphics.Typeface.DEFAULT, f2.c.a(fontWeight, i17))) && !p3321xbce91901.jvm.p3324x21ffc6bd.o.b(c17, c(null, fontWeight, i17))) {
                z17 = true;
            }
            if (z17) {
                typeface = c17;
    ...
    public final android.graphics.Typeface c(java.lang.String str, f2.r rVar, int i17) {
        ...
        if (i17 == 0) {
            ...
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(rVar, f2.r.f340355i)) {
                if (str == null || str.length() == 0) {
                    android.graphics.Typeface DEFAULT = android.graphics.Typeface.DEFAULT;
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.f(DEFAULT, "DEFAULT");
                    return DEFAULT;
                }
            }
        }
        ...
        if (z17) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(defaultFromStyle, "{\n            Typeface.d…le(targetStyle)\n        }");
            return defaultFromStyle;
        }
        android.graphics.Typeface create = android.graphics.Typeface.create(str, a17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(create, "{\n            Typeface.c…y, targetStyle)\n        }");
        return create;
    }
}
