...
public final class z implements f2.y {
    ...
    public android.graphics.Typeface b(f2.s name, f2.r fontWeight, int i17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(fontWeight, "fontWeight");
        return c(name.f340359b, fontWeight, i17);
    }
    ...
    public final android.graphics.Typeface c(java.lang.String str, f2.r rVar, int i17) {
        ...
        android.graphics.Typeface create = android.graphics.Typeface.create(str == null ? android.graphics.Typeface.DEFAULT : android.graphics.Typeface.create(str, 0), rVar.f340358d, i17 == 1);
