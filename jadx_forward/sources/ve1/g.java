...
public abstract class g {
    ...
    public static final int f517615a = android.os.Build.VERSION.SDK_INT;

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.HashMap f517616b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.HashMap f517617c;

    static {
        new java.util.concurrent.atomic.AtomicInteger(1);
        f517617c = new java.util.HashMap();
    }
    ...
    public static java.lang.String[] j() {
        try {
            ...
            qe1.a.a().getClass();
            java.lang.Object invoke = method.invoke((android.net.ConnectivityManager) com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSystemService("connectivity"), new java.lang.Object[0]);
            if (invoke == null) {
                return null;
            }
            return k(invoke);
    ...
    */
    ...
    public static boolean m(java.lang.String str) {
        java.util.HashMap hashMap = f517617c;
    ...
    public static void p(int i17, java.lang.String str, java.lang.String str2, java.lang.Throwable th6) {
        ...
        if (qe1.a.a().f443561m == null) {
            return;
        }
        if (i17 == 4) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("WxPlayer/" + str, str2);
        } else if (i17 == 5) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("WxPlayer/" + str, str2);
        } else {
            if (i17 != 6) {
                return;
            }
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("WxPlayer/" + str, str2);
        }
    }
    ...
    public static java.lang.String u(java.lang.String str) {
        ...
        java.util.HashMap hashMap = f517616b;
        if (!isEmpty) {
        ...
        if (android.webkit.URLUtil.isNetworkUrl(str)) {
            ...
            if (url != null) {
                str2 = com.p314xaae8f345.mm.sdk.p2603x2137b148.w2.a(substring).substring(0, 20);
            }
        } else {
            str2 = str;
        }
