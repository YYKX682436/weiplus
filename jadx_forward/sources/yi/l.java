...
public class l extends yi.j {
    ...
    public final java.io.OutputStream f544007b;

    /* renamed from: c, reason: collision with root package name */
    public int f544008c;

    /* renamed from: d, reason: collision with root package name */
    public final java.io.ByteArrayOutputStream f544009d;

    public l(java.io.OutputStream outputStream) {
        super(null);
        this.f544008c = 0;
        this.f544009d = new java.io.ByteArrayOutputStream();
        this.f544007b = outputStream;
    }
    ...
    public void b(java.lang.String str, int i17, long j17) {
        java.io.OutputStream outputStream = this.f544007b;
        try {
            if (i17 <= 0 || i17 >= 1073741823) {
                throw new java.io.IOException("bad idSize: " + i17);
            }
            this.f544008c = i17;
            outputStream.write(str.getBytes(java.nio.charset.Charset.forName(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c)));
    ...
    public void d(int i17, zi.b bVar, int i18, zi.b bVar2, int i19, long j17) {
        ...
        try {
            ...
            aj.a.i(outputStream, i17);
            outputStream.write(bVar.f554609a);
            aj.a.i(outputStream, i18);
            outputStream.write(bVar2.f554609a);
        } catch (java.lang.Throwable th6) {
            throw new java.lang.RuntimeException(th6);
        }
    }
    ...
    public void e(zi.b bVar, zi.b bVar2, zi.b bVar3, zi.b bVar4, int i17, int i18, int i19, long j17) {
        ...
        try {
            ...
            outputStream.write(bVar.f554609a);
            outputStream.write(bVar2.f554609a);
            outputStream.write(bVar3.f554609a);
            outputStream.write(bVar4.f554609a);
            aj.a.i(outputStream, i17);
            aj.a.i(outputStream, i18);
        } catch (java.lang.Throwable th6) {
            throw new java.lang.RuntimeException(th6);
    ...
    public void g(zi.b bVar, java.lang.String str, int i17, long j17) {
        ...
        try {
            ...
            aj.a.i(outputStream, (int) j17);
            outputStream.write(bVar.f554609a);
            outputStream.write(str.getBytes(java.nio.charset.Charset.forName(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c)), 0, str.length());
        } catch (java.lang.Throwable th6) {
            throw new java.lang.RuntimeException(th6);
        }
    }
