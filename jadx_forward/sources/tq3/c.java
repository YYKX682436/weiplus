...
public class c extends tq3.a {
    public static boolean c() {
        try {
            ...
            return nVar.f347062n.e(16777219L, 0L) < a17;
    ...
    public void run() {
        if (!c()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Priority.CalC2CChatPriorityTask", "no need to cal usage result");
            return;
        }
        fq3.n nVar = (fq3.n) i95.n0.c(fq3.n.class);
        nVar.m134976x2690a4ac();
        kq3.h hVar = nVar.f347062n;
        if (hVar.f("C2CChatUsage") == 0) {
            return;
        }
        jx3.f fVar = jx3.f.INSTANCE;
        fVar.mo68477x336bdfd8(1252L, 1L, 1L, false);
        long a17 = hq3.a.a();
        ...
        h18.close();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Priority.CalC2CChatPriorityTask", "calculateStayTime %.2f %.2f %.2f %.2f", java.lang.Double.valueOf(dArr[0]), java.lang.Double.valueOf(dArr[1]), java.lang.Double.valueOf(dArr2[0]), java.lang.Double.valueOf(dArr2[1]));
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Priority.CalC2CChatPriorityTask", "d: %.2f r: %.4f", java.lang.Double.valueOf(0.9d), java.lang.Double.valueOf(pow));
        ...
        nVar2.f347062n.i(16777219L, a17);
        fVar.mo68477x336bdfd8(1252L, 0L, 1L, false);
    }
}
