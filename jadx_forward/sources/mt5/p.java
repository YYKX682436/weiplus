...
public class p implements lt5.a {
    ...
    public int f412859a = -1;

    /* renamed from: b, reason: collision with root package name */
    public java.lang.String f412860b = "";
    ...
    public synchronized lt5.f a(android.content.Context context) {
        ...
        try {
            ...
            try {
                if (query.moveToNext()) {
                    try {
                        this.f412860b = query.getString(query.getColumnIndex("value"));
                ...
                java.lang.System.currentTimeMillis();
                return new lt5.f(this.f412860b, this.f412859a);
            } finally {
                try {
                    query.close();
            ...
            this.f412859a = org.p3343x72743996.net.InterfaceC29524x4f65168b.f73913x76158116;
            return lt5.f.a(org.p3343x72743996.net.InterfaceC29524x4f65168b.f73913x76158116);
        }
    }
