...
public final class z implements java.util.Collection, zz5.a {
    ...
    public final boolean contains(java.lang.Object obj) {
        ...
        long j17 = ((jz5.x) obj).f384385d;
        long[] jArr = this.f384388d;
    ...
    */
    ...
    public boolean equals(java.lang.Object obj) {
        if (obj instanceof jz5.z) {
            return p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.f384388d, ((jz5.z) obj).f384388d);
        }
        return false;
    }
    ...
    @Override // java.util.Collection
    public int hashCode() {
        return java.util.Arrays.hashCode(this.f384388d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return this.f384388d.length == 0;
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator iterator() {
        return new jz5.y(this.f384388d);
    }
    ...
    public java.lang.String m141657x9616526c() {
        return "ULongArray(storage=" + java.util.Arrays.toString(this.f384388d) + ')';
    }
