...
public final class d0 implements java.util.Collection, zz5.a {
    ...
    public final boolean contains(java.lang.Object obj) {
        ...
        short s17 = ((jz5.b0) obj).f384349d;
        short[] sArr = this.f384353d;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(sArr, "<this>");
    ...
    */
    public boolean containsAll(java.util.Collection r8) {
        ...
        L16:
            ...
            if (r2 == 0) goto L46
            jz5.b0 r0 = (jz5.b0) r0
            short r0 = r0.f384349d
            java.lang.String r2 = "<this>"
            short[] r4 = r7.f384353d
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(r4, r2)
            int r2 = r4.length
            r5 = r3
        L32:
            if (r5 >= r2) goto L3c
    ...
    public boolean equals(java.lang.Object obj) {
        if (obj instanceof jz5.d0) {
            return p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.f384353d, ((jz5.d0) obj).f384353d);
        }
        return false;
    }
    ...
    @Override // java.util.Collection
    public int hashCode() {
        return java.util.Arrays.hashCode(this.f384353d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return this.f384353d.length == 0;
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator iterator() {
        return new jz5.c0(this.f384353d);
    }
    ...
    public java.lang.String m141626x9616526c() {
        return "UShortArray(storage=" + java.util.Arrays.toString(this.f384353d) + ')';
    }
