...
public class i implements java.lang.Runnable, android.view.View.OnAttachStateChangeListener {
    ...
    public android.view.View f510115d;
    ...
    public void run() {
        android.view.View view = this.f510115d;
        if (view == null) {
            return;
        }
        try {
            ...
            if (this.f510115d.getParent() instanceof android.view.ViewGroup) {
                ((android.view.ViewGroup) this.f510115d.getParent()).removeView(this.f510115d);
            }
        } finally {
            this.f510115d = null;
        }
