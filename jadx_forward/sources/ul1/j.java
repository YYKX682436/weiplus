...
public final class j extends db5.d5 {
    ...
    public final boolean f510116b;

    /* renamed from: c, reason: collision with root package name */
    public final android.widget.TextView f510117c;

    /* renamed from: d, reason: collision with root package name */
    public final android.widget.ImageView f510118d;
    ...
    public final ul1.j a(java.lang.CharSequence charSequence) {
        boolean z17 = this.f510116b;
        android.widget.TextView textView = this.f510117c;
        if (!z17) {
        ...
        if (charSequence == null || charSequence.length() == 0) {
            ...
            getContentView().findViewById(com.p314xaae8f345.mm.R.id.mvs).setPadding(0, i65.a.b(getContentView().getContext(), 27), 0, 0);
            textView.setContentDescription(charSequence);
        }
        return this;
    }
    ...
    public final void b(long j17) {
        ...
        if (a17 != null) {
            ...
            this.f510117c.requestFocus();
            if (j17 != com.p314xaae8f345.p3121x37984a.p3125x2eaf9f.C26918x6e83759b.f58001x610e5697) {
                com.p314xaae8f345.mm.sdk.p2603x2137b148.u3.i(new ul1.k(this), j17);
            }
        }
    }
    ...
    public j(android.content.Context context, boolean z17) {
        ...
        if (z17) {
            ...
            android.view.View.inflate(context, com.p314xaae8f345.mm.R.C30864xbddafb2a.f569625h2, frameLayout);
            setContentView(frameLayout);
            android.view.View findViewById = getContentView().findViewById(com.p314xaae8f345.mm.R.id.lbi);
            ...
            android.widget.ImageView imageView = (android.widget.ImageView) getContentView().findViewById(com.p314xaae8f345.mm.R.id.hlr);
            this.f510118d = imageView;
            android.view.View findViewById2 = getContentView().findViewById(com.p314xaae8f345.mm.R.id.obc);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(findViewById2, "findViewById(...)");
            this.f510117c = (android.widget.TextView) findViewById2;
            android.graphics.drawable.Drawable m9707x4a96be14 = b3.l.m9707x4a96be14(context, com.p314xaae8f345.mm.R.C30861xcebc809e.bds);
            if (m9707x4a96be14 != null) {
                m9707x4a96be14.mutate().setColorFilter(new android.graphics.PorterDuffColorFilter(-1, android.graphics.PorterDuff.Mode.SRC_ATOP));
            ...
            imageView.setScaleType(android.widget.ImageView.ScaleType.FIT_CENTER);
            android.view.View findViewById3 = getContentView().findViewById(com.p314xaae8f345.mm.R.id.lbi);
            ...
            android.view.View.inflate(context, com.p314xaae8f345.mm.R.C30864xbddafb2a.f569624h1, frameLayout2);
            setContentView(frameLayout2);
            android.view.View findViewById4 = getContentView().findViewById(com.p314xaae8f345.mm.R.id.obc);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(findViewById4, "findViewById(...)");
            this.f510117c = (android.widget.TextView) findViewById4;
            this.f510118d = null;
        }
        setFocusable(true);
        getContentView().setFocusable(true);
        this.f510117c.setFocusable(true);
    }
}
