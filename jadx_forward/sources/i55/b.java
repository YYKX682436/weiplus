...
public abstract class b {
    ...
    public final int f370364d;

    /* renamed from: e, reason: collision with root package name */
    public boolean f370365e;

    /* renamed from: g, reason: collision with root package name */
    public long f370367g;

    /* renamed from: m, reason: collision with root package name */
    public p3325xe03a0797.p3326xc267989b.y0 f370370m;

    /* renamed from: f, reason: collision with root package name */
    public java.lang.String f370366f = "";

    /* renamed from: h, reason: collision with root package name */
    public final java.util.Map f370368h = new java.util.LinkedHashMap();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.Map f370369i = new java.util.LinkedHashMap();

    /* renamed from: n, reason: collision with root package name */
    public final android.view.View.OnLayoutChangeListener f370371n = new i55.a(this);
    ...
    public static void d(i55.b bVar, java.lang.String source, long j17, android.view.View view, boolean z17, int i17, java.lang.Object obj) {
        ...
        java.util.Map map2 = bVar2.f370368h;
        java.util.Map map3 = bVar2.f370369i;
        if (view2 != null) {
            ...
            if (str3 != null && (jVar2 = (g55.j) ((java.util.LinkedHashMap) map3).get(str3)) != null) {
                java.lang.String str4 = jVar2.f350537c;
                bVar.e(source, j17, bVar2.f370365e && bVar2.b(view2), jVar2, view2.hashCode());
                if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(jVar2.f350537c, str4)) {
                    map2.put(java.lang.Integer.valueOf(hashCode), jVar2.f350537c);
                    map3.put(jVar2.f350537c, jVar2);
                    map3.remove(str4);
                }
            }
        ...
        if (f0Var == null) {
            ...
            while (it6.hasNext()) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.g(viewInfo, "viewInfo");
                java.util.Map map4 = viewInfo.f350535a;
                java.util.Iterator it7 = ((java.util.LinkedHashMap) map4).entrySet().iterator();
                java.util.ArrayList arrayList5 = new java.util.ArrayList();
                java.lang.String str6 = viewInfo.f350537c;
                while (true) {
                    if (!it7.hasNext()) {
                        str = str6;
                        map = map4;
                    ...
                    if (view3 == null) {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BaseRedDotExposureMonitorLogic", ((java.lang.Number) entry2.getKey()).intValue() + " is null remove");
                    } else {
                        boolean z18 = bVar2.f370365e && bVar2.b(view3);
                        str = str6;
                        map = map4;
                        arrayList = arrayList5;
                ...
                if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(jVar.f350537c, str)) {
                    map2.put(java.lang.Integer.valueOf(i18), jVar.f350537c);
                }
                ...
                if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((g55.j) entry.getValue()).f350537c, str2)) {
                    arrayList2.add(str2);
                }
                if (((g55.j) entry.getValue()).f350535a.isEmpty()) {
            ...
            while (it9.hasNext()) {
                ...
                map3.remove(str7);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.FindFriendTabExposureLogic", str7 + " is clear");
            }
    ...
    public final void a(java.lang.String str) {
        if (this.f370370m == null) {
            p3325xe03a0797.p3326xc267989b.p0 p0Var = p3325xe03a0797.p3326xc267989b.q1.f392101a;
            this.f370370m = p3325xe03a0797.p3326xc267989b.z0.a(p3325xe03a0797.p3326xc267989b.p3329x21ffc6bd.b0.f392017a);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BaseRedDotExposureMonitorLogic", "mMainScope start " + str);
        }
    }
    ...
    */
    ...
    public void c(long j17) {
        ...
        this.f370365e = true;
        this.f370366f = "";
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BaseRedDotExposureMonitorLogic", "on resume");
