...
public final class e {
    ...
    public static final na3.e f417519a = new na3.e();
    ...
    public final byte[] a(java.lang.String keyId, byte[] encrypted, java.lang.String algorithm) {
        ...
        try {
            ...
            javax.crypto.Cipher cipher2 = p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, "RSA/ECB/OAEPWithSHA-256AndMGF1Padding") ? javax.crypto.Cipher.getInstance("RSA/ECB/OAEPWithSHA-256AndMGF1Padding") : javax.crypto.Cipher.getInstance("RSA/ECB/PKCS1Padding");
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, "RSA/ECB/OAEPWithSHA-256AndMGF1Padding")) {
            ...
            if (encrypted.length == 256) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(doFinal2, "doFinal(...)");
                return doFinal2;
            }
            throw new java.lang.IllegalArgumentException("Invalid encrypted data size: " + encrypted.length + " bytes. Expected: 256 bytes");
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppSecureUtil", "rsaDecrypt error: " + e17.getClass().getSimpleName() + ": " + e17.getMessage());
            throw e17;
        }
    }
    ...
    public final byte[] b(java.lang.String keyId, byte[] data, java.lang.String algorithm) {
        ...
        try {
            ...
            int i17 = p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, "RSA/ECB/OAEPWithSHA-256AndMGF1Padding") ? 190 : 245;
            if (data.length <= i17) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppSecureUtil", "rsaEncrypt error: ", e17);
            throw e17;
        }
    }
    ...
    public final void c(java.security.KeyStore keyStore, java.lang.String str) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppSecureUtil", "the KeyId is not exist: " + str);
    ...
    public final java.lang.String d(java.lang.String algorithm, int i17) {
        ...
        na3.a aVar = na3.b.f417513f;
        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(algorithm, "AES-GCM")) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(randomizedEncryptionRequired, "setRandomizedEncryptionRequired(...)");
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(digests, "setDigests(...)");
        na3.b a17 = na3.b.f417513f.a(algorithm);
        int i18 = a17 == null ? -1 : na3.d.f417518a[a17.ordinal()];
        if (i18 == -1) {
    ...
    public final java.lang.String e(java.lang.String str) {
        return "key_" + str + '_' + java.lang.System.currentTimeMillis() + '_' + r26.n0.R(java.lang.String.valueOf(e06.p.j(new e06.k(0, 999999), c06.e.f119249d)), 6, '0');
    }
    ...
    public final byte[] f(java.lang.String keyId, java.lang.String algorithm) {
        ...
        try {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(encoded, "getEncoded(...)");
            return encoded;
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppSecureUtil", "rsaGetPublicKey error, error=" + e17.getMessage());
            throw e17;
        }
    }
    ...
    public final java.lang.String g(byte[] publicKeyBytes, byte[] privateKeyBytes, byte[] certificateBytes, java.lang.String algorithm) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(publicKeyBytes, "publicKeyBytes");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(privateKeyBytes, "privateKeyBytes");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(certificateBytes, "certificateBytes");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(algorithm, "algorithm");
        try {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(generateCertificate, "null cannot be cast to non-null type java.security.cert.X509Certificate");
    ...
    public final byte[] h(java.lang.String keyId, byte[] data, java.lang.String algorithm) {
        ...
        try {
            ...
            c(keyStore, keyId);
            java.security.Key key = keyStore.getKey(keyId, null);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(key, "null cannot be cast to non-null type java.security.PrivateKey");
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(sign, "sign(...)");
            return sign;
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppSecureUtil", "rsaSign error: ", e17);
            throw e17;
        }
    }
    ...
    public final boolean i(java.lang.String keyId, byte[] data, byte[] signature, java.lang.String algorithm) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LiteAppSecureUtil", "rsaVerify error: ", e17);
            throw e17;
        }
    }
}
