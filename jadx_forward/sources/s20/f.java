...
public final class f extends android.text.style.MetricAffectingSpan {
    ...
    public final android.content.Context f483812d;

    /* renamed from: e, reason: collision with root package name */
    public final bw5.c9 f483813e;

    /* renamed from: f, reason: collision with root package name */
    public final int f483814f;

    public f(android.content.Context context, bw5.c9 item, int i17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(item, "item");
        this.f483812d = context;
        this.f483813e = item;
        this.f483814f = i17;
    }

    public final void a(android.text.TextPaint textPaint) {
        int i17 = this.f483814f;
        if (i17 <= 0) {
            return;
        }
        android.content.Context context = this.f483812d;
        float b17 = i65.a.b(context, i17);
        int i18 = this.f483813e.f107510g;
        if (i18 <= 0) {
            i18 = 14;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x0108, code lost:
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FinderLiveShoppingPriceView", "setTypeface() Exception:" + r1.getMessage());
     */
