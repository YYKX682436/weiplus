...
public final class b extends android.text.style.ReplacementSpan {
    ...
    public final java.util.List f483796d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.CharSequence f483797e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.List f483798f;

    /* renamed from: g, reason: collision with root package name */
    public final int f483799g;

    /* renamed from: h, reason: collision with root package name */
    public final int f483800h;

    /* renamed from: i, reason: collision with root package name */
    public final float f483801i;

    /* renamed from: m, reason: collision with root package name */
    public android.text.StaticLayout f483802m;

    /* renamed from: n, reason: collision with root package name */
    public int f483803n;

    /* renamed from: o, reason: collision with root package name */
    public float f483804o;
    ...
    public b(java.util.List beforeItems, java.lang.CharSequence middleItem, java.util.List afterItems, int i17, int i18, float f17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(beforeItems, "beforeItems");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(middleItem, "middleItem");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(afterItems, "afterItems");
        this.f483796d = beforeItems;
        this.f483797e = middleItem;
        this.f483798f = afterItems;
        this.f483799g = i17;
        this.f483800h = i18;
        this.f483801i = f17;
        this.f483804o = -1.0f;
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence charSequence, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        android.text.StaticLayout staticLayout = this.f483802m;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(staticLayout);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:84:0x022a, code lost:
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(r0, "concat(...)");
     */
    @Override // android.text.style.ReplacementSpan
    /*
