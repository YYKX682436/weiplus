...
public final class d extends g13.b {
    ...
    public void o(in5.s0 holder, i13.c cVar, int i17, int i18, boolean z17, java.util.List list) {
        ...
        ((android.widget.TextView) holder.f3639x46306858.findViewById(com.p314xaae8f345.mm.R.id.odf)).setText(item.f368818h);
        android.widget.TextView textView5 = (android.widget.TextView) holder.f3639x46306858.findViewById(com.p314xaae8f345.mm.R.id.gcj);
        java.lang.String str = item.f368819i;
        ...
        ((ke0.e) xVar).getClass();
        textView5.setText(com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.c0.j(context2, str, textSize));
    }
