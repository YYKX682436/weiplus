...
public class m implements com.p314xaae8f345.mm.p1006xc5476f33.p1930x6e0a2cd8.p1931x633fb29.a {

    /* renamed from: d, reason: collision with root package name */
    public final android.widget.TextView f559217d;

    /* renamed from: e, reason: collision with root package name */
    public final yy4.a f559218e;

    /* renamed from: f, reason: collision with root package name */
    public final android.view.View f559219f;

    public m(android.widget.ImageView imageView, android.widget.TextView textView, yy4.a aVar, android.view.View view) {
        this.f559217d = textView;
        this.f559218e = aVar;
        this.f559219f = view;
    }
    ...
    public boolean Y3(boolean z17) {
        android.widget.TextView textView = this.f559217d;
        if (z17) {
    ...
    public java.lang.String mo54844xfb83cc9b() {
        yy4.a aVar = this.f559218e;
        if (aVar == null) {
            return null;
        }
        return (java.lang.String) ((java.util.HashMap) com.p314xaae8f345.mm.p1006xc5476f33.p2443x6bc77ff.ui.ActivityC19512xacf356cc.f269632q).get(aVar.f66634x369ad11);
    }

    @Override // com.p314xaae8f345.mm.p1006xc5476f33.p1930x6e0a2cd8.p1931x633fb29.a
    public android.view.View h() {
        return this.f559219f;
    }
