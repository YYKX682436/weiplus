...
public final class y implements java.lang.Runnable {
    ...
    public final /* synthetic */ tn0.w0 f502319d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.graphics.SurfaceTexture f502320e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ int f502321f;

    public y(tn0.w0 w0Var, android.graphics.SurfaceTexture surfaceTexture, int i17) {
        this.f502319d = w0Var;
        this.f502320e = surfaceTexture;
        this.f502321f = i17;
    }
    ...
    public final void run() {
        ...
        kn0.f fVar4;
        kn0.f fVar5;
        tn0.w0 w0Var = this.f502319d;
        int r17 = tn0.w0.r(w0Var);
        ts0.r rVar2 = w0Var.f502308v;
        if (rVar2 != null) {
            kn0.i iVar = w0Var.C;
            rVar2.p(this.f502320e, (iVar == null || (fVar5 = iVar.f391093d) == null) ? false : fVar5.f391064c, r17);
        }
        if (!(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_finder_live_camera_ratio_4_3, 0) == 1) && (rVar = w0Var.f502308v) != null) {
            kn0.i iVar2 = w0Var.C;
            int i17 = 1080;
            ts0.b bVar = (ts0.b) rVar;
            android.util.Size C = bVar.C(new android.graphics.Point((iVar2 == null || (fVar4 = iVar2.f391093d) == null) ? 1080 : fVar4.f391065d, (int) ((((iVar2 == null || (fVar3 = iVar2.f391093d) == null) ? 1080 : fVar3.f391065d) * 16.0f) / 9.0f)));
            kn0.i iVar3 = w0Var.C;
            int i18 = (iVar3 == null || (fVar2 = iVar3.f391093d) == null) ? 1080 : fVar2.f391065d;
            if (iVar3 != null && (fVar = iVar3.f391093d) != null) {
                i17 = fVar.f391065d;
            }
            android.util.Size C2 = bVar.C(new android.graphics.Point(i18, (int) ((i17 * 4.0f) / 3.0f)));
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(C != null ? java.lang.Integer.valueOf(C.getWidth()) : null, C2 != null ? java.lang.Integer.valueOf(C2.getWidth()) : null)) {
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(C != null ? java.lang.Integer.valueOf(C.getHeight()) : null, C2 != null ? java.lang.Integer.valueOf(C2.getHeight()) : null)) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.LiveCore", sb7.toString());
        ...
        sb8.append(r17);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.LiveCore", sb8.toString());
        xn0.b b17 = vn0.b.f519707a.b();
        ts0.r rVar4 = w0Var.f502308v;
        b17.f536943a = rVar4 != null ? rVar4.e() : 0;
        ...
        if (rVar5 == null || (z17 = rVar5.z()) == null) {
            ...
            pm0.z.b(xy2.b.f539688b, "startPreviewButCameraConfigNull", false, null, null, false, false, null, 124, null);
            return;
        }
        java.lang.StringBuilder sb9 = new java.lang.StringBuilder("start preview systemRoate: ");
        int i19 = this.f502321f;
        sb9.append(i19);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.LiveCore", sb9.toString());
        ts0.c.f503078e = i19;
        f0Var.w(z17);
        ts0.r rVar6 = w0Var.f502308v;
        w0Var.B((rVar6 == null || rVar6.z() == null) ? null : java.lang.Boolean.valueOf(ts0.c.f503081h));
        ts0.r rVar7 = w0Var.f502308v;
        if ((rVar7 != null && rVar7.b() == 2) && i19 == 90 && (dVar = f0Var.f355297m) != null && (cVar = dVar.f347995c) != null) {
            cVar.r(0);
        }
        w0Var.f502310x = true;
        f0Var.mo8988x4ac79299(new tn0.x(w0Var));
    }
}
