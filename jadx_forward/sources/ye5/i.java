...
public final class i extends ye5.a implements qd5.h {

    /* renamed from: s, reason: collision with root package name */
    public yb5.d f542794s;
    ...
    public void S(yb5.d dVar, rd5.d dVar2) {
        if (dVar2 instanceof qd5.i) {
            ...
            if (g95.e0.j(iVar.f475787d.f526833b)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ChattingItemMediaGroupItem", "ChattingItemMediaGroupItemTo onMsgExposed, msg is expired, skip download");
            } else {
                te5.d.f500155a.a(iVar.f475787d.f526833b, new ye5.h(dVar, dVar2));
            }
        }
    }
