...
public class b implements android.os.Handler.Callback {
    ...
    public static final b56.b f99647f = new b56.b();

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Map f99649e = new java.util.HashMap();

    /* renamed from: d, reason: collision with root package name */
    public final android.os.Handler f99648d = new android.os.Handler(android.os.Looper.getMainLooper(), this);
    ...
    public boolean handleMessage(android.os.Message message) {
        ...
        java.util.Map map = this.f99649e;
        if (!isDestroyed) {
