...
public final class b0 extends i95.w implements n13.b0 {
    public final void Ai(android.content.Context context, android.content.Intent intent) {
        if (!(context instanceof android.app.Activity)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ForwardFeatureService", "startActivity with non-Activity context, add FLAG_ACTIVITY_NEW_TASK. context=".concat(context.getClass().getSimpleName()));
    ...
    public void Bi(android.content.Context context, co.a aVar, n13.r forwardActionInfo) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(forwardActionInfo, "forwardActionInfo");
        if (aVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ForwardFeatureService", "viewmodel is null, can not forward");
            return;
        }
        ...
        while (true) {
            if (!it.hasNext()) {
                ...
                bVar = (ek5.b) it.next();
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(aVar.getClass(), bVar.h())) {
                    break;
                }
            }
        }
        if (bVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ForwardFeatureService", "find no config, viewModel class: " + aVar.getClass() + ", please check newForward is open, or config is registered");
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ForwardFeatureService", "start forward, viewModel:" + aVar + " config:" + bVar);
    ...
    public final void wi(android.content.Context context, co.a aVar, java.lang.Class cls, n13.r rVar) {
        android.content.Intent Ui = ((qd0.q0) ((rd0.e1) i95.n0.c(rd0.e1.class))).Ui(context, rVar.f415659j, false, rVar.f415655f);
        if (!rVar.f415656g) {
        ...
        if (aVar != null) {
            ...
            Ui.putExtra("Retr_MsgTalker", aVar.m75945x2fec8307(i17 + 1));
            Ui.putExtra("Retr_Msg_Id", aVar.m75942xfb822ef2(i17 + 0));
            Ui.putExtra("Retr_Msg_Svr_Id", aVar.m75942xfb822ef2(i17 + 2));
            Ui.putExtra("msg_forward_sns_obj_id", aVar.m75945x2fec8307(i17 + 4));
            Ui.putExtra("msg_forward_exteral", aVar.m75933x41a8a7f2(i17 + 5));
            Ui.putExtra("Retr_Msg_view_model", aVar.m126747x696739c());
        }
        if (cls == null) {
        ...
        Ui.putExtra("ForwardParams_ForwardByUIC", rVar.f415650a);
        Ui.putExtra("Select_block_List", kz5.n0.g0(rVar.f415658i, ",", null, null, 0, null, null, 62, null));
        Ui.putExtra("ForwardParams_EnableContentClick", rVar.f415654e);
        Ui.putExtra("ForwardParams_ReportFromScene", rVar.f415653d.f415672a);
        Ui.putExtra("ForwardParams_ForwardMsgType", rVar.f415660k);
        Ui.putExtra("KEY_START_TIME", c01.id.c());
        java.util.List list = rVar.f415662m;
        if (list != null) {
            java.lang.String g07 = kz5.n0.g0(list, ",", null, null, 0, null, null, 62, null);
            if (g07.length() > 0) {
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(rVar.f415663n, java.lang.Boolean.FALSE)) {
        ...
        java.lang.Integer num = rVar.f415664o;
        if (num != null) {
            Ui.putExtra("max_limit_num", num.intValue());
            java.lang.String str = rVar.f415665p;
            if (str != null) {
                Ui.putExtra("too_many_member_tip_string", str);
            }
        }
        n13.c0 c0Var = rVar.f415661l;
        if (c0Var != null) {
            c0Var.a(Ui);
        }
        com.p314xaae8f345.mm.ui.da daVar = rVar.f415652c;
        int i18 = rVar.f415651b;
        if (i18 == -1) {
            Ai(context, Ui);
        } else if (!(context instanceof android.app.Activity)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ForwardFeatureService", "startActivityForResult, context is not an Activity");
        } else if (daVar == null) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            ...
            ((com.p314xaae8f345.mm.ui.ActivityC21401x6ce6f73f) context).m78743x70d84175(daVar, Ui, i18);
