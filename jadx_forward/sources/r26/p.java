...
public final class p extends kz5.b implements r26.l {
    ...
    public final /* synthetic */ r26.q f450441d;
    ...
    @Override // kz5.b
    public int d() {
        return this.f450441d.f450442a.groupCount() + 1;
    }

    public r26.k e(int i17) {
        r26.q qVar = this.f450441d;
        java.util.regex.Matcher matcher = qVar.f450442a;
        e06.k m17 = e06.p.m(matcher.start(i17), matcher.end(i17));
        if (m17.h().intValue() < 0) {
            return null;
        }
        java.lang.String group = qVar.f450442a.group(i17);
