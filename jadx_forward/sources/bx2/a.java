...
public final class a extends android.text.style.ClickableSpan {
    ...
    public final java.lang.Integer f117849d;
    ...
    public void updateDrawState(android.text.TextPaint textPaint) {
        ...
        java.lang.Integer num = this.f117849d;
        if (num != null) {
            textPaint.setColor(num.intValue());
        }
        try {
            textPaint.setTypeface(android.graphics.Typeface.createFromAsset(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getAssets(), "fonts/SF-Pro-Display-BoldItalic.otf"));
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("FinderLiveUtil", "setTypeface() Exception:" + e17.getMessage());
        }
        textPaint.setUnderlineText(false);
        textPaint.clearShadowLayer();
    }

    public /* synthetic */ a(java.lang.Integer num, int i17, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
