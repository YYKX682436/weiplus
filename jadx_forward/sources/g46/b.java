...
public class b extends h46.a {
    ...
    public g46.a f350387r;

    public b(java.io.InputStream inputStream) {
        super(inputStream, 65536);
        this.f350387r = g46.a.NO_BLOCK;
    }
    ...
    public int read(byte[] bArr, int i17, int i18) {
        ...
        if (ordinal == 0) {
            ...
            this.f360507m = j18;
            this.f350387r = g46.a.IN_LITERAL;
        } else if (ordinal != 1) {
            if (ordinal == 2) {
                try {
                    b17 = (int) r46.d.b(this.f360510p, 2);
                    int i29 = this.f350386q;
                    j17 = i29;
                    if (i29 == 15) {
                        long j27 = 0;
                        do {
                ...
                try {
                    j(b17, j17 + 4);
                    this.f350387r = g46.a.IN_BACK_REFERENCE;
                    z17 = true;
                    if (!z17) {
                        this.f350387r = g46.a.EOF;
                        return -1;
                    }
                ...
                throw new java.io.IOException("Unknown stream state " + this.f350387r);
            }
        ...
        if (!(this.f360507m > 0)) {
            this.f350387r = g46.a.LOOKING_FOR_BACK_REFERENCE;
        }
