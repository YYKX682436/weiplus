...
public final class n implements java.lang.Runnable {
    ...
    public final /* synthetic */ java.util.HashMap f540072d;

    public n(java.util.HashMap hashMap) {
        this.f540072d = hashMap;
    }

    @Override // java.lang.Runnable
    public final void run() {
        android.util.LruCache lruCache;
        for (java.util.Map.Entry entry : this.f540072d.entrySet()) {
            ...
            while (it.hasNext()) {
                ...
                if (!(str == null || str.length() == 0) && longValue > 0 && (lruCache = (android.util.LruCache) y00.h.f540060a.get(str)) != null) {
                }
            }
        }
    }
