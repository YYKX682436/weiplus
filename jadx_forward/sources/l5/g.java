...
public final class g extends l5.b {
    ...
    public final java.util.concurrent.atomic.AtomicReferenceFieldUpdater f398053a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicReferenceFieldUpdater f398054b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicReferenceFieldUpdater f398055c;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicReferenceFieldUpdater f398056d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicReferenceFieldUpdater f398057e;
    ...
    public g(java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2, java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater3, java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater4, java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater5) {
        super(null);
        this.f398053a = atomicReferenceFieldUpdater;
        this.f398054b = atomicReferenceFieldUpdater2;
        this.f398055c = atomicReferenceFieldUpdater3;
        this.f398056d = atomicReferenceFieldUpdater4;
        this.f398057e = atomicReferenceFieldUpdater5;
    }
    ...
    public boolean a(l5.k kVar, l5.f fVar, l5.f fVar2) {
        ...
        do {
            atomicReferenceFieldUpdater = this.f398056d;
    ...
    public boolean b(l5.k kVar, java.lang.Object obj, java.lang.Object obj2) {
        java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        do {
            atomicReferenceFieldUpdater = this.f398057e;
    ...
    public boolean c(l5.k kVar, l5.j jVar, l5.j jVar2) {
        java.util.concurrent.atomic.AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        do {
            atomicReferenceFieldUpdater = this.f398055c;
    ...
    public void d(l5.j jVar, l5.j jVar2) {
        this.f398054b.lazySet(jVar, jVar2);
    }

    @Override // l5.b
    public void e(l5.j jVar, java.lang.Thread thread) {
        this.f398053a.lazySet(jVar, thread);
    }
}
