...
public class z0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ c43.x f120055d;
    ...
    public void onClick(android.view.View view) {
        ...
        c43.x xVar = this.f120055d;
        if (xVar.D.getTag() instanceof s33.j) {
            s33.j jVar = (s33.j) xVar.D.getTag();
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GameChatRoom.GameChatItemVH", "retry send msg, cliMsgId:%s", jVar.f484041d);
