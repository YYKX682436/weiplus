...
public class h extends java.io.Reader {
    ...
    public se1.g f488301d;

    /* renamed from: e, reason: collision with root package name */
    public boolean f488302e;

    /* renamed from: f, reason: collision with root package name */
    public java.nio.charset.CharsetDecoder f488303f;

    /* renamed from: g, reason: collision with root package name */
    public final java.nio.ByteBuffer f488304g;

    public h(se1.g gVar, java.lang.String str) {
        super(gVar);
        this.f488302e = false;
        java.nio.ByteBuffer allocate = java.nio.ByteBuffer.allocate(8192);
        this.f488304g = allocate;
        str.getClass();
        this.f488301d = gVar;
        try {
            this.f488303f = java.nio.charset.Charset.forName(str).newDecoder().onMalformedInput(java.nio.charset.CodingErrorAction.REPLACE).onUnmappableCharacter(java.nio.charset.CodingErrorAction.REPLACE);
            allocate.limit(0);
    ...
    public void close() {
        synchronized (((java.io.Reader) this).lock) {
            java.nio.charset.CharsetDecoder charsetDecoder = this.f488303f;
            if (charsetDecoder != null) {
                charsetDecoder.reset();
            }
            this.f488303f = null;
            se1.g gVar = this.f488301d;
            if (gVar != null) {
