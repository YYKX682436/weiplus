...
public abstract class c {
    ...
    public final x.b f524364a;

    /* renamed from: b, reason: collision with root package name */
    public final x.b f524365b;

    /* renamed from: c, reason: collision with root package name */
    public final x.b f524366c;
    ...
    public final java.lang.Class b(java.lang.Class cls) {
        ...
        x.b bVar = this.f524366c;
        java.lang.Class cls2 = (java.lang.Class) bVar.m174751x4aabfc28(name, null);
        if (cls2 != null) {
            return cls2;
        }
    ...
    public final java.lang.reflect.Method c(java.lang.String str) {
        x.b bVar = this.f524364a;
        java.lang.reflect.Method method = (java.lang.reflect.Method) bVar.m174751x4aabfc28(str, null);
        if (method != null) {
            return method;
        }
    ...
    public final java.lang.reflect.Method d(java.lang.Class cls) {
        java.lang.String name = cls.getName();
        x.b bVar = this.f524365b;
        java.lang.reflect.Method method = (java.lang.reflect.Method) bVar.m174751x4aabfc28(name, null);
        if (method != null) {
            return method;
        }
    ...
    public int f(int i17, int i18) {
        return !e(i18) ? i17 : ((w4.d) this).f524368e.readInt();
    }
    ...
    public android.os.Parcelable g(android.os.Parcelable parcelable, int i17) {
        ...
        return ((w4.d) this).f524368e.readParcelable(w4.d.class.getClassLoader());
    }

    public w4.e h() {
        java.lang.String readString = ((w4.d) this).f524368e.readString();
        if (readString == null) {
            return null;
        }
        try {
    ...
    public void j(int i17, int i18) {
        i(i18);
        ((w4.d) this).f524368e.writeInt(i17);
    }

    public void k(android.os.Parcelable parcelable, int i17) {
        i(i17);
        ((w4.d) this).f524368e.writeParcelable(parcelable, 0);
    }

    public void l(w4.e eVar) {
        if (eVar == null) {
            ((w4.d) this).f524368e.writeString(null);
            return;
        }
        try {
            ((w4.d) this).f524368e.writeString(b(eVar.getClass()).getName());
            w4.c a17 = a();
            try {
                d(eVar.getClass()).invoke(null, eVar, a17);
                w4.d dVar = (w4.d) a17;
                int i17 = dVar.f524372i;
                if (i17 >= 0) {
                    int i18 = dVar.f524367d.get(i17);
                    android.os.Parcel parcel = dVar.f524368e;
