...
public final class g0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.p1878x49b0bd5a.C16559xedc507d9 f419114d;

    public g0(com.p314xaae8f345.mm.p1006xc5476f33.p1878x49b0bd5a.C16559xedc507d9 c16559xedc507d9) {
        this.f419114d = c16559xedc507d9;
    }

    @Override // java.lang.Runnable
    public final void run() {
        int max;
        com.p314xaae8f345.mm.p1006xc5476f33.p1878x49b0bd5a.C16559xedc507d9 c16559xedc507d9 = this.f419114d;
        ...
        if (i17 >= 0) {
            boolean z17 = c16559xedc507d9.f230995n <= i17;
            c16559xedc507d9.f230995n = i17;
            ...
            if (z17) {
                ...
                max = java.lang.Math.min(i18, c13920xa5f564aa2.size());
            } else {
            ...
            yj0.a.d(m66991x4905e9fa, arrayList.toArray(), "com/tencent/mm/plugin/monitor/FinderStreamMonitorView$observer$1$onEventHappen$2$1", "run", "()V", "Undefined", "smoothScrollToPosition", "(I)V");
            m66991x4905e9fa.c1(((java.lang.Integer) arrayList.get(0)).intValue());
            yj0.a.f(m66991x4905e9fa, "com/tencent/mm/plugin/monitor/FinderStreamMonitorView$observer$1$onEventHappen$2$1", "run", "()V", "Undefined", "smoothScrollToPosition", "(I)V");
        }
    }
}
