...
public class c2 extends wu5.b {
    ...
    public final /* synthetic */ ni3.f1 f419087e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ni3.d2 f419088f;
    ...
    public void run() {
        ni3.c1 c1Var = null;
        this.f419088f.f419096a.f419130v = null;
        int a17 = c01.w9.a();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SubCoreBaseMonitor", "summerdel checkUnfinishedDeleteMsgTask ret[%s]", java.lang.Integer.valueOf(a17));
        if (a17 > 0) {
            com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.g0.INSTANCE.mo68477x336bdfd8(418L, 8L, 1L, true);
        }
        ni3.g2 g2Var = this.f419088f.f419096a;
        ni3.f1 f1Var = this.f419087e;
        g2Var.getClass();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SubCoreBaseMonitor", "summerhv startScan");
        gm0.j1.i();
        if (gm0.j1.u().l()) {
            java.util.HashMap hashMap = new java.util.HashMap();
            com.p314xaae8f345.mm.vfs.r5 r5Var = (com.p314xaae8f345.mm.vfs.r5) com.p314xaae8f345.mm.vfs.a3.f294314a.a();
            if (r5Var.f294698f == null) {
                r5Var.f294698f = java.util.Collections.unmodifiableList(r5Var.f294694b);
            }
            for (com.p314xaae8f345.mm.vfs.l5 l5Var : r5Var.f294698f) {
                java.lang.String str = l5Var.f294600d;
                java.lang.String str2 = l5Var.f294601e;
            ...
            com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(D);
            if (r6Var.m() && r6Var.y()) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SubCoreBaseMonitor", "summerhv startScan root[%s] exist[%b], diretory[%b]", D, java.lang.Boolean.valueOf(r6Var.m()), java.lang.Boolean.valueOf(r6Var.y()));
                ...
                if (!g2Var.Ri(hashMap, hashMap2, "favorite/", 17)) {
                    hashMap2.put(com.p314xaae8f345.mm.p2621x8fb0427b.s3.a().substring(0, com.p314xaae8f345.mm.p2621x8fb0427b.s3.a().length() - 1), 17);
                }
                ...
                java.lang.String str28 = vz.e1.f523073a;
                ...
                ((ku5.t0) ku5.t0.f394148d).h(new ni3.e2(g2Var, hashMap2, c1Var, r6Var, f1Var), "summerhv_scanFile");
            } else {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SubCoreBaseMonitor", "summerhv startScan failed as path not exists[%s]", D);
                ((ni3.b2) f1Var).a(-1, null);
            }
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SubCoreBaseMonitor", "summerhv startScan failed as sdcard not available");
            ((ni3.b2) f1Var).a(-1, null);
        }
        g2Var.f419131w = c1Var;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SubCoreBaseMonitor", "summerhv auto scan started[%s]", this.f419088f.f419096a.f419131w);
    }
}
