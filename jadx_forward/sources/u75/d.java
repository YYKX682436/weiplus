...
public abstract class d {
    ...
    public static java.lang.Boolean f506715a;

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.Boolean f506716b;

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.Boolean f506717c;

    /* renamed from: d, reason: collision with root package name */
    public static java.lang.Boolean f506718d;
    ...
    */
    public static java.lang.String a(java.lang.String r8) {
        /*
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r2)     // Catch: java.lang.Throwable -> L4d java.lang.Exception -> L4f
            return r3
        L23:
        ...
        L51:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r5, r6)     // Catch: java.lang.Throwable -> L76
            if (r4 == 0) goto L75
    ...
    public static boolean b(int i17, java.lang.String str, java.lang.String str2, java.lang.String str3) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D0(str2, "")) {
            if (c()) {
                if (!(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str3) || java.lang.Long.valueOf(a("ro.miui.version.code_time")).longValue() < java.lang.Long.valueOf(str3).longValue())) {
                    return false;
                }
            }
    ...
    public static boolean c() {
        if (f506717c == null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Vendor.MIUI", "Build.MANUFACTURER = %s", str);
            if (android.text.TextUtils.isEmpty(str) || !str.equalsIgnoreCase("Xiaomi")) {
                f506717c = java.lang.Boolean.FALSE;
            } else {
                f506717c = java.lang.Boolean.TRUE;
            }
        }
        return f506717c.booleanValue();
    }

    public static boolean d() {
        if (f506718d == null) {
            java.lang.String str = android.os.Build.MANUFACTURER;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Vendor.MIUI", "Build.MANUFACTURER = %s, Build.MODEL ", str);
            if (android.text.TextUtils.isEmpty(str) || !str.equals("Xiaomi")) {
                f506718d = java.lang.Boolean.FALSE;
            } else {
                java.lang.String a17 = a("ro.miui.version.code_time");
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("Vendor.MIUI", "ifNotificationChannelSupportNativeActionJump() versionCode:%s", a17);
                if (java.lang.Long.valueOf(a17).longValue() > java.lang.Long.valueOf("1536681600").longValue()) {
                    f506718d = java.lang.Boolean.TRUE;
                } else {
                    f506718d = java.lang.Boolean.FALSE;
                }
            }
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Vendor.MIUI", "ifNotificationChannelSupportNativeActionJump() ifNotificationChannelSupportNativeActionJump:%s", java.lang.Boolean.valueOf(f506718d.booleanValue()));
        return f506718d.booleanValue();
    }
    ...
    */
    public static boolean e() {
        /*
            java.lang.Boolean r0 = u75.d.f506715a
            if (r0 != 0) goto L5e
            r0 = 0
            ...
            com.tencent.mm.vfs.b3 r2 = com.p314xaae8f345.mm.vfs.a3.f294314a     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            com.tencent.mm.vfs.z2 r2 = r2.m(r1, r0)     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            java.io.InputStream r0 = com.p314xaae8f345.mm.vfs.w6.D(r1, r2)     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            ...
            u75.d.f506715a = r1     // Catch: java.lang.Throwable -> L43 java.lang.Exception -> L45
            if (r0 == 0) goto L5e
        L3f:
        ...
        L45:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r2, r3, r1)     // Catch: java.lang.Throwable -> L43
            java.lang.Boolean r1 = java.lang.Boolean.FALSE     // Catch: java.lang.Throwable -> L43
            u75.d.f506715a = r1     // Catch: java.lang.Throwable -> L43
            if (r0 == 0) goto L5e
            goto L3f
        L58:
            if (r0 == 0) goto L5d
    ...
    public static boolean f() {
        if (f506716b == null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Vendor.MIUI", "Build.MANUFACTURER = %s", str);
            if (android.text.TextUtils.isEmpty(str) || !str.equalsIgnoreCase("Xiaomi")) {
                f506716b = java.lang.Boolean.FALSE;
            } else if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D0(wo.w1.a("ro.miui.ui.version.code"), "8")) {
                f506716b = java.lang.Boolean.TRUE;
            } else {
                f506716b = java.lang.Boolean.FALSE;
            }
        }
        return f506716b.booleanValue();
    }
    ...
    public static boolean h() {
        ...
        return !com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) && str.toLowerCase().contains("xiaomi");
    }
}
