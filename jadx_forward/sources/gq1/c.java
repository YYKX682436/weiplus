...
public class c {
    ...
    public final java.util.HashMap f356030a = new java.util.HashMap();

    /* renamed from: b, reason: collision with root package name */
    public final gq1.a f356031b;
    ...
    public void a(java.lang.String str, int i17, java.lang.String str2, gq1.d dVar) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.exdevie.IBeaconManager", "advertismentProcess, brand = %s, rssi = %d", str, java.lang.Integer.valueOf(i17));
        if (dVar == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.exdevie.IBeaconManager", "null == aProtocal");
            return;
        }
        gq1.b bVar = new gq1.b();
        bVar.f356027a = dVar;
        bVar.f356029c = str2;
        java.util.HashMap hashMap = this.f356030a;
        ...
        try {
            if (1 <= vector2.size()) {
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.exdevie.IBeaconManager", "calDistance failed!!!, %s", e17.getMessage());
                }
            }
        } finally {
            vector2.clear();
    ...
    public final void b(java.util.Vector vector, gq1.b bVar) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.exdevie.IBeaconManager", "calDistance");
        ...
        bVar.f356028b = new java.math.BigDecimal(a19).divide(new java.math.BigDecimal(1), 3, 4).doubleValue();
        double d18 = bVar.f356027a.f356033b.f356073f;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.exdevie.IBeaconManager", "txPower = %f , rssi = %f,distance = %f", java.lang.Double.valueOf(d18), java.lang.Double.valueOf(a19), java.lang.Double.valueOf(pow2));
        this.f356031b.d(pow2, bVar);
    }
}
