...
public interface b {
    default void b(android.graphics.Canvas canvas, java.lang.String firstLineText, java.lang.String secondLineText, android.graphics.RectF textRect, android.text.TextPaint firstLineTextPaint, android.text.TextPaint secondLineTextPaint, int i17, int i18, int i19, android.graphics.Paint paint, float f17, iy0.d textAlignType) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(firstLineText, "firstLineText");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(secondLineText, "secondLineText");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(textRect, "textRect");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(firstLineTextPaint, "firstLineTextPaint");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(secondLineTextPaint, "secondLineTextPaint");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(textAlignType, "textAlignType");
        float f19 = i18 * 2;
        ...
        if (iy0.a.f377241a[textAlignType.ordinal()] == 1) {
            f18 = textRect.top;
        } else {
    ...
    default void d(android.graphics.Canvas canvas, java.lang.String contentText, android.graphics.RectF textRect, android.text.TextPaint textPaint, int i17, int i18, android.graphics.Paint paint, float f17, iy0.d textAlignType, boolean z17) {
        float f18;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(canvas, "canvas");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(contentText, "contentText");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(textRect, "textRect");
