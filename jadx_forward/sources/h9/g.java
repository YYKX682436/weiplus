...
public final class g implements r9.h0 {
    ...
    public static final java.util.regex.Pattern f361158a = java.util.regex.Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.regex.Pattern f361159b = java.util.regex.Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.regex.Pattern f361160c = java.util.regex.Pattern.compile("CODECS=\"(.+?)\"");

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.regex.Pattern f361161d = java.util.regex.Pattern.compile("RESOLUTION=(\\d+x\\d+)");

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.regex.Pattern f361162e = java.util.regex.Pattern.compile("#EXT-X-TARGETDURATION:(\\d+)\\b");

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.regex.Pattern f361163f = java.util.regex.Pattern.compile("#EXT-X-VERSION:(\\d+)\\b");

    /* renamed from: g, reason: collision with root package name */
    public static final java.util.regex.Pattern f361164g = java.util.regex.Pattern.compile("#EXT-X-PLAYLIST-TYPE:(.+)\\b");

    /* renamed from: h, reason: collision with root package name */
    public static final java.util.regex.Pattern f361165h = java.util.regex.Pattern.compile("#EXT-X-MEDIA-SEQUENCE:(\\d+)\\b");

    /* renamed from: i, reason: collision with root package name */
    public static final java.util.regex.Pattern f361166i = java.util.regex.Pattern.compile("#EXTINF:([\\d\\.]+)\\b");

    /* renamed from: j, reason: collision with root package name */
    public static final java.util.regex.Pattern f361167j = java.util.regex.Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");

    /* renamed from: k, reason: collision with root package name */
    public static final java.util.regex.Pattern f361168k = java.util.regex.Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");

    /* renamed from: l, reason: collision with root package name */
    public static final java.util.regex.Pattern f361169l = java.util.regex.Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");

    /* renamed from: m, reason: collision with root package name */
    public static final java.util.regex.Pattern f361170m = java.util.regex.Pattern.compile("METHOD=(NONE|AES-128)");

    /* renamed from: n, reason: collision with root package name */
    public static final java.util.regex.Pattern f361171n = java.util.regex.Pattern.compile("URI=\"(.+?)\"");

    /* renamed from: o, reason: collision with root package name */
    public static final java.util.regex.Pattern f361172o = java.util.regex.Pattern.compile("IV=([^,.*]+)");

    /* renamed from: p, reason: collision with root package name */
    public static final java.util.regex.Pattern f361173p = java.util.regex.Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");

    /* renamed from: q, reason: collision with root package name */
    public static final java.util.regex.Pattern f361174q = java.util.regex.Pattern.compile("LANGUAGE=\"(.+?)\"");

    /* renamed from: r, reason: collision with root package name */
    public static final java.util.regex.Pattern f361175r = java.util.regex.Pattern.compile("NAME=\"(.+?)\"");

    /* renamed from: s, reason: collision with root package name */
    public static final java.util.regex.Pattern f361176s = java.util.regex.Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");

    /* renamed from: t, reason: collision with root package name */
    public static final java.util.regex.Pattern f361177t = a("AUTOSELECT");

    /* renamed from: u, reason: collision with root package name */
    public static final java.util.regex.Pattern f361178u = a(com.p176xb6135e39.p177xcca8366f.gms.p238x68ac49f.p240x4e139522.C2426x7e760204.f7429x859b4284);

    /* renamed from: v, reason: collision with root package name */
    public static final java.util.regex.Pattern f361179v = a("FORCED");
    ...
    public static h9.d e(h9.f fVar, java.lang.String str) {
        ...
        while (fVar.a()) {
            ...
            if (str2.startsWith("#EXT-X-PLAYLIST-TYPE")) {
                java.lang.String g17 = g(str2, f361164g);
                if ("VOD".equals(g17)) {
                    i37 = 1;
                ...
                j17 = (long) (java.lang.Double.parseDouble(g(str2, f361167j)) * 1000000.0d);
            } else {
                boolean startsWith = str2.startsWith("#EXT-X-MAP");
                java.util.regex.Pattern pattern = f361171n;
                if (startsWith) {
                    java.lang.String g18 = g(str2, pattern);
                    java.lang.String f17 = f(str2, f361169l);
                    if (f17 != null) {
                    ...
                    j18 = java.lang.Integer.parseInt(g(str2, f361162e)) * 1000000;
                } else if (str2.startsWith("#EXT-X-MEDIA-SEQUENCE")) {
                    i28 = java.lang.Integer.parseInt(g(str2, f361165h));
                    i27 = i28;
                } else if (str2.startsWith("#EXT-X-VERSION")) {
                    i29 = java.lang.Integer.parseInt(g(str2, f361163f));
                } else if (str2.startsWith("#EXTINF")) {
                    j37 = (long) (java.lang.Double.parseDouble(g(str2, f361166i)) * 1000000.0d);
                } else if (str2.startsWith("#EXT-X-KEY")) {
                    z27 = "AES-128".equals(g(str2, f361170m));
                    if (z27) {
                        str5 = g(str2, pattern);
                        str4 = f(str2, f361172o);
                    } else {
                        str3 = null;
                        str4 = null;
                        str5 = null;
                    ...
                    java.lang.String[] split2 = g(str2, f361168k).split("@");
                    ...
                    if (str2.startsWith("#EXT-X-PROGRAM-DATE-TIME")) {
                        if (j19 == 0) {
                            ...
                            java.util.regex.Matcher matcher = t9.d0.f498035e.matcher(substring);
                            if (!matcher.matches()) {
                            ...
                            if (i17 != 0) {
                                timeInMillis -= i17 * com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3061x5a71016.C26489x58a14bb2.f54062xde855ea8;
                            }
