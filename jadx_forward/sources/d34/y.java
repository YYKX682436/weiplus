...
public class y implements c01.yc {
    ...
    public void O0(com.p314xaae8f345.mm.p944x882e457a.p0 p0Var) {
        ...
        if (g17 == null || g17.length() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("ShakeCardRedDotMsgListener", "onReceiveMsg, ShakeCardRedDotMsg msgContent is null");
        } else {
            ((c34.h0) i95.n0.c(c34.h0.class)).f119731i.mo50293x3498a0(new d34.x(this, g17, p0Var));
        }
    }
