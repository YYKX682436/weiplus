...
public class d {
    ...
    public long f441753a = -1;

    /* renamed from: b, reason: collision with root package name */
    public final android.os.Handler f441754b;

    /* renamed from: c, reason: collision with root package name */
    public final q6.b f441755c;

    /* renamed from: d, reason: collision with root package name */
    public long f441756d;

    public d(android.os.Handler handler, java.lang.String str, p6.a aVar) {
        this.f441754b = handler;
        this.f441755c = new q6.b(str, aVar);
    }
    ...
    */
    public void b() {
        /*
            r11 = this;
            q6.b r0 = r11.f441755c
            long r1 = r0.b()     // Catch: java.lang.Exception -> Lc9
            r3 = -1
            int r5 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            r6 = 0
            android.os.Handler r7 = r11.f441754b
            if (r5 == 0) goto L25
            long r3 = r11.f441753a     // Catch: java.lang.Exception -> Lc9
            long r3 = r1 - r3
            r8 = 20
            long r3 = r3 - r8
            ...
            goto Lc9
        L25:
            long r1 = r11.f441756d     // Catch: java.lang.Exception -> Lc9
            long r8 = r0.b()     // Catch: java.lang.Exception -> Lc9
            int r3 = (r3 > r8 ? 1 : (r3 == r8 ? 0 : -1))
            o6.a r4 = r0.f441752f     // Catch: java.lang.Exception -> Lc9
            r5 = 1
            if (r3 != 0) goto L4a
            ...
            boolean r3 = p6.a.a(r4)     // Catch: java.lang.Exception -> Lc9
            if (r3 == 0) goto L45
            java.util.ArrayList r3 = r4.f424707b     // Catch: java.lang.Exception -> Lc9
        ...
        L4a:
            r3 = r6
        L4b:
            java.lang.String r8 = r0.f441750d     // Catch: java.lang.Exception -> Lc9
            ...
            if (r3 == 0) goto Lc2
            int r6 = r0.mo146856x51e8b0a()     // Catch: java.lang.Exception -> Lc9
            goto Lc2
        L62:
            r10 = 2
            if (r10 != r9) goto Lc2
        ...
        L7d:
            ...
            if (r0 == 0) goto Lc2
            java.util.ArrayList r0 = r4.f424707b     // Catch: java.lang.Exception -> Lc2
            ...
            java.util.ArrayList r0 = r0.f424709b     // Catch: java.lang.Exception -> Lc2
        ...
        L97:
            ...
            m6.b r5 = r4.f405882a     // Catch: java.lang.Exception -> Lc2
            java.lang.String r5 = r5.f405874a     // Catch: java.lang.Exception -> Lc2
            java.lang.String r8 = "continuous"
            boolean r5 = r5.equals(r8)     // Catch: java.lang.Exception -> Lc2
            if (r5 == 0) goto Lb7
            m6.b r4 = r4.f405882a     // Catch: java.lang.Exception -> Lc2
            int r5 = r4.f405875b     // Catch: java.lang.Exception -> Lc2
            int r4 = r4.f405876c     // Catch: java.lang.Exception -> Lc2
            int r5 = r5 + r4
            goto Lbd
        Lb7:
            m6.b r4 = r4.f405882a     // Catch: java.lang.Exception -> Lc2
            int r4 = r4.f405875b     // Catch: java.lang.Exception -> Lc2
            int r5 = r4 + 22
        Lbd:
            if (r5 <= r3) goto L97
            r3 = r5
    ...
    public void c(long j17, long j18) {
        android.os.Handler handler = this.f441754b;
        try {
            com.p144xabe4be82.p145xb7039297.p146x361a9b.C1425x3ce2cbe a17 = this.f441755c.a(j18);
            if (a17 == null || a17.f125450d.isEmpty()) {
                return;
            }
