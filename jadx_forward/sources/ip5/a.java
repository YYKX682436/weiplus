...
public abstract class a {
    public static final void a(com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.u1 u1Var) {
        boolean z17;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(u1Var, "<this>");
        tb0.j jVar = (tb0.j) i95.n0.c(tb0.j.class);
        if (jVar != null) {
            z17 = ((sb0.f) jVar).Ui(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a);
        } else {
            z17 = false;
        }
        if (!z17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MMFloatWinDialogCompat", "FloatWindowOp Not Allowed. Use Compat Mode");
            u1Var.q(false);
            return;
        }
        android.content.Context context = u1Var.f293530b;
        ...
        if (z18) {
            if (u1Var.f293531c == null) {
                u1Var.f293531c = i0Var.a();
            }
            android.view.Window window = u1Var.f293531c.getWindow();
            if (window != null) {
        ...
        android.content.Context context2 = u1Var.f293530b;
