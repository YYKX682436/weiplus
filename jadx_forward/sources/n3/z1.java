...
public final class z1 {
    ...
    public final java.lang.ref.WeakReference f415987a;

    public z1(android.view.View view) {
        this.f415987a = new java.lang.ref.WeakReference(view);
    }

    public n3.z1 a(float f17) {
        android.view.View view = (android.view.View) this.f415987a.get();
        if (view != null) {
    ...
    public n3.z1 e(final n3.e2 e2Var) {
        final android.view.View view = (android.view.View) this.f415987a.get();
        if (view != null) {
