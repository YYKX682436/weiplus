...
public class o2 extends n3.r2 {
    ...
    public static final android.view.animation.Interpolator f415912e = new android.view.animation.PathInterpolator(0.0f, 1.1f, 0.0f, 1.0f);

    /* renamed from: f, reason: collision with root package name */
    public static final android.view.animation.Interpolator f415913f = new y3.a();

    /* renamed from: g, reason: collision with root package name */
    public static final android.view.animation.Interpolator f415914g = new android.view.animation.DecelerateInterpolator();
    ...
    public static android.view.WindowInsets i(android.view.View view, android.view.WindowInsets windowInsets) {
        return view.getTag(com.p314xaae8f345.mm.R.id.f568747nx0) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
    }

    public static n3.j2 j(android.view.View view) {
        java.lang.Object tag = view.getTag(com.p314xaae8f345.mm.R.id.nxg);
        if (tag instanceof n3.n2) {
            return ((n3.n2) tag).f415909d;
        }
        return null;
    }
}
