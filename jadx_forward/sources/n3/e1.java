...
public abstract class e1 {
    public static void a(android.view.View view, final n3.j1 j1Var) {
        x.n nVar = (x.n) view.getTag(com.p314xaae8f345.mm.R.id.nxe);
        if (nVar == null) {
            nVar = new x.n();
            view.setTag(com.p314xaae8f345.mm.R.id.nxe, nVar);
        }
    ...
    public static void e(android.view.View view, n3.j1 j1Var) {
        ...
        x.n nVar = (x.n) view.getTag(com.p314xaae8f345.mm.R.id.nxe);
        if (nVar == null || (onUnhandledKeyEventListener = (android.view.View.OnUnhandledKeyEventListener) nVar.m174751x4aabfc28(j1Var, null)) == null) {
            return;
        }
