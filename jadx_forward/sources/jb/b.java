...
public class b implements java.io.Closeable {
    ...
    public static final char[] f380173v = ")]}'\n".toCharArray();

    /* renamed from: d, reason: collision with root package name */
    public final java.io.Reader f380174d;

    /* renamed from: o, reason: collision with root package name */
    public long f380182o;

    /* renamed from: p, reason: collision with root package name */
    public int f380183p;

    /* renamed from: q, reason: collision with root package name */
    public java.lang.String f380184q;

    /* renamed from: r, reason: collision with root package name */
    public int[] f380185r;

    /* renamed from: t, reason: collision with root package name */
    public java.lang.String[] f380187t;

    /* renamed from: u, reason: collision with root package name */
    public int[] f380188u;

    /* renamed from: e, reason: collision with root package name */
    public boolean f380175e = false;

    /* renamed from: f, reason: collision with root package name */
    public final char[] f380176f = new char[1024];

    /* renamed from: g, reason: collision with root package name */
    public int f380177g = 0;

    /* renamed from: h, reason: collision with root package name */
    public int f380178h = 0;

    /* renamed from: i, reason: collision with root package name */
    public int f380179i = 0;

    /* renamed from: m, reason: collision with root package name */
    public int f380180m = 0;

    /* renamed from: n, reason: collision with root package name */
    public int f380181n = 0;

    /* renamed from: s, reason: collision with root package name */
    public int f380186s = 0 + 1;

    static {
        com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.t.f126357a = new jb.a();
    }
    ...
    public b(java.io.Reader reader) {
        ...
        this.f380185r = iArr;
        iArr[0] = 6;
        this.f380187t = new java.lang.String[32];
        this.f380188u = new int[32];
        if (reader == null) {
            throw new java.lang.NullPointerException("in == null");
        }
        this.f380174d = reader;
    }

    public java.lang.String A() {
        java.lang.String F;
        int i17 = this.f380181n;
        if (i17 == 0) {
            i17 = f();
        }
        if (i17 == 14) {
        ...
        this.f380181n = 0;
        this.f380187t[this.f380186s - 1] = F;
        return F;
    }

    public final int C(boolean z17) {
        int i17 = this.f380177g;
        int i18 = this.f380178h;
        while (true) {
            boolean z18 = true;
            if (i17 == i18) {
                this.f380177g = i17;
            ...
            if (c17 == '\n') {
                ...
                if (c17 == '/') {
                    ...
                    c();
                    int i27 = this.f380177g;
                    char c18 = cArr[i27];
                    if (c18 == '*') {
                        this.f380177g = i27 + 1;
                        while (true) {
                            if (this.f380177g + 2 > this.f380178h && !k(2)) {
                                z18 = false;
                                break;
                            }
                            int i28 = this.f380177g;
                            if (cArr[i28] != '\n') {
                                for (int i29 = 0; i29 < 2; i29++) {
                                    if (cArr[this.f380177g + i29] != "*/".charAt(i29)) {
                                        break;
                                    }
                                }
                                break;
    ...
    public void D() {
        ...
        this.f380181n = 0;
        int[] iArr = this.f380188u;
        int i18 = this.f380186s - 1;
        iArr[i18] = iArr[i18] + 1;
    }
    ...
    */
    ...
    public java.lang.String I() {
        ...
        if (i17 == 10) {
            ...
            str = java.lang.Long.toString(this.f380182o);
        } else {
            if (i17 != 16) {
                throw new java.lang.IllegalStateException("Expected a string but was " + K() + q());
            }
            str = new java.lang.String(this.f380176f, this.f380177g, this.f380183p);
            this.f380177g += this.f380183p;
        }
        this.f380181n = 0;
        int[] iArr = this.f380188u;
        int i18 = this.f380186s - 1;
    ...
    */
    ...
    public final void M(int i17) {
        int i18 = this.f380186s;
        int[] iArr = this.f380185r;
        if (i18 == iArr.length) {
            int i19 = i18 * 2;
            this.f380185r = java.util.Arrays.copyOf(iArr, i19);
            this.f380188u = java.util.Arrays.copyOf(this.f380188u, i19);
            this.f380187t = (java.lang.String[]) java.util.Arrays.copyOf(this.f380187t, i19);
        }
        int[] iArr2 = this.f380185r;
        int i27 = this.f380186s;
        this.f380186s = i27 + 1;
        iArr2[i27] = i17;
    }
    ...
    public final char N() {
        int i17;
        int i18;
        if (this.f380177g == this.f380178h && !k(1)) {
            R("Unterminated escape sequence");
            throw null;
        }
        int i19 = this.f380177g;
        int i27 = i19 + 1;
        this.f380177g = i27;
        char[] cArr = this.f380176f;
        char c17 = cArr[i19];
            ...
            while (i28 < i29) {
                ...
                if (c19 < '0' || c19 > '9') {
                    if (c19 >= 'a' && c19 <= 'f') {
                        ...
                        if (c19 < 'A' || c19 > 'F') {
                            throw new java.lang.NumberFormatException("\\u".concat(new java.lang.String(cArr, this.f380177g, 4)));
                        }
                        i17 = c19 - 'A';
                    }
                    i18 = i17 + 10;
    ...
    public void Q() {
                ...
                if (i18 == 4) {
                    ...
                    if (i18 == 14 || i18 == 10) {
                        do {
                            int i19 = 0;
                            while (true) {
                                int i27 = this.f380177g + i19;
                                if (i27 < this.f380178h) {
                                    char c17 = this.f380176f[i27];
                                    if (c17 != '\t' && c17 != '\n' && c17 != '\f' && c17 != '\r' && c17 != ' ') {
                                        if (c17 != '#') {
                                            if (c17 != ',') {
                                                if (c17 != '/' && c17 != '=') {
        ...
        int[] iArr = this.f380188u;
        int i28 = this.f380186s;
        int i29 = i28 - 1;
        iArr[i29] = iArr[i29] + 1;
        this.f380187t[i28 - 1] = "null";
    }
    ...
    public void a() {
        ...
        if (i17 == 3) {
            M(1);
            this.f380188u[this.f380186s - 1] = 0;
            this.f380181n = 0;
        } else {
    ...
    */
    ...
    public final boolean k(int i17) {
        int i18;
        int i19;
        int i27 = this.f380180m;
        int i28 = this.f380177g;
        this.f380180m = i27 - i28;
        int i29 = this.f380178h;
        char[] cArr = this.f380176f;
        if (i29 != i28) {
            int i37 = i29 - i28;
            this.f380178h = i37;
        ...
        this.f380177g = 0;
        do {
            int i38 = this.f380178h;
            int read = this.f380174d.read(cArr, i38, cArr.length - i38);
            if (read == -1) {
                return false;
            }
            i18 = this.f380178h + read;
            this.f380178h = i18;
            if (this.f380179i == 0 && (i19 = this.f380180m) == 0 && i18 > 0 && cArr[0] == 65279) {
                this.f380177g++;
                this.f380180m = i19 + 1;
                i17++;
            }
    ...
    public java.lang.String q() {
        int i17 = this.f380179i + 1;
        int i18 = (this.f380177g - this.f380180m) + 1;
        ...
        int i19 = this.f380186s;
        for (int i27 = 0; i27 < i19; i27++) {
            int i28 = this.f380185r[i27];
            if (i28 == 1 || i28 == 2) {
                sb7.append('[');
                sb7.append(this.f380188u[i27]);
                sb7.append(']');
            } else if (i28 == 3 || i28 == 4 || i28 == 5) {
                sb7.append('.');
                java.lang.String str = this.f380187t[i27];
                if (str != null) {
                    sb7.append(str);
                }
            }
    ...
    public java.lang.String m140565x9616526c() {
    ...
    public boolean v() {
        ...
        this.f380181n = 0;
        int[] iArr2 = this.f380188u;
        int i19 = this.f380186s - 1;
    ...
    public double w() {
        ...
        if (i17 == 15) {
            ...
            int i18 = this.f380186s - 1;
            iArr[i18] = iArr[i18] + 1;
            return this.f380182o;
        }
        if (i17 == 16) {
            this.f380184q = new java.lang.String(this.f380176f, this.f380177g, this.f380183p);
            this.f380177g += this.f380183p;
        } else if (i17 == 8 || i17 == 9) {
            this.f380184q = F(i17 == 8 ? '\'' : '\"');
        } else if (i17 == 10) {
            this.f380184q = J();
        } else if (i17 != 11) {
        ...
        this.f380181n = 11;
        double parseDouble = java.lang.Double.parseDouble(this.f380184q);
        if (!this.f380175e && (java.lang.Double.isNaN(parseDouble) || java.lang.Double.isInfinite(parseDouble))) {
    ...
    public int x() {
        ...
        if (i17 == 15) {
            long j17 = this.f380182o;
            int i18 = (int) j17;
            if (j17 != i18) {
                throw new java.lang.NumberFormatException("Expected an int but was " + this.f380182o + q());
            }
            this.f380181n = 0;
            int[] iArr = this.f380188u;
            int i19 = this.f380186s - 1;
        ...
        if (i17 == 16) {
            ...
            try {
                int parseInt = java.lang.Integer.parseInt(this.f380184q);
                this.f380181n = 0;
                int[] iArr2 = this.f380188u;
                int i27 = this.f380186s - 1;
        ...
        if (i28 != parseDouble) {
            throw new java.lang.NumberFormatException("Expected an int but was " + this.f380184q + q());
        }
        this.f380184q = null;
        this.f380181n = 0;
        int[] iArr3 = this.f380188u;
        int i29 = this.f380186s - 1;
    ...
    public long z() {
        ...
        if (i17 == 16) {
            ...
            try {
                long parseLong = java.lang.Long.parseLong(this.f380184q);
                this.f380181n = 0;
                int[] iArr2 = this.f380188u;
                int i19 = this.f380186s - 1;
                iArr2[i19] = iArr2[i19] + 1;
        ...
        if (j17 != parseDouble) {
            throw new java.lang.NumberFormatException("Expected a long but was " + this.f380184q + q());
        }
        this.f380184q = null;
        this.f380181n = 0;
        int[] iArr3 = this.f380188u;
