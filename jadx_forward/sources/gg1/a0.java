...
public final class a0 extends gg1.y {
    ...
    public final /* synthetic */ gg1.c1 f353061a;
    ...
    public void b(aa1.e response) {
        ...
        if (map.containsKey("RelTime") && map.containsKey("TrackDuration")) {
            java.lang.String str3 = ((aa1.a) kz5.c1.h(map, "RelTime")).f84014a;
            java.lang.String str4 = ((aa1.a) kz5.c1.h(map, "TrackDuration")).f84014a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.VideoCast.VideoCastController", "getProgressTimeMs: relTime = " + str3 + ", duration =  " + str4);
            ...
            gVar.getClass();
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SameLayer.AppBrandVideoCastEventHandler", "onVideoTimeUpdate: currentPosition = " + b17 + " duration = " + b18);
            try {
                if (java.lang.Math.abs(b17 - gVar.f343398a) < 250) {
                    str = str4;
                    ...
                    try {
                        ...
                        e = e17;
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SameLayer.AppBrandVideoCastEventHandler", "OnXWebVideoTimeUpdate fail", e);
                        int i17 = (int) ((b17 / b18) * 100);
                        fg1.g gVar2 = (fg1.g) c1Var.f353069b;
                        gVar2.getClass();
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SameLayer.AppBrandVideoCastEventHandler", "onVideoProgress: " + i17);
            ...
            fg1.g gVar22 = (fg1.g) c1Var.f353069b;
            gVar22.getClass();
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SameLayer.AppBrandVideoCastEventHandler", "onVideoProgress: " + i172);
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SameLayer.AppBrandVideoCastEventHandler", "OnXWebVideoProgress fail", e19);
            }
            java.lang.StringBuilder sb62 = new java.lang.StringBuilder("get position success, relTime: ");
            fg1.j jVar22 = fg1.u.f343426l;
            sb62.append((int) jVar22.b(str3));
            sb62.append(" duration: ");
            sb62.append((int) jVar22.b(str));
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str2, sb62.toString());
        }
    }
}
