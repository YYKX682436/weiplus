...
public class m2 implements java.util.Iterator {
    ...
    public int f518266d = 0;

    public m2(vg3.n2 n2Var, vg3.l2 l2Var) {
    }

    @Override // java.util.Iterator
    public boolean hasNext() {
        return this.f518266d < 43;
    }

    @Override // java.util.Iterator
    public java.lang.Object next() {
        int i17 = this.f518266d;
        this.f518266d = i17 + 1;
        switch (i17) {
            case 0:
            ...
            case 3:
                return xw.l.INSTANCE;
            case 4:
                return nf0.r.INSTANCE;
            case 5:
            ...
            case 12:
                return n41.k.INSTANCE;
            case 13:
                return h14.s0.INSTANCE;
            case 14:
                return xw.d.INSTANCE;
            case 15:
                return hk.l.INSTANCE;
            case 16:
            ...
            case 38:
                return ue0.l.INSTANCE;
            case 39:
                return y50.o.INSTANCE;
            case 40:
                return h14.d.INSTANCE;
            case 41:
                return m90.g2.INSTANCE;
            case 42:
                return ar3.j.INSTANCE;
            default:
                throw new java.lang.IndexOutOfBoundsException("No more elements, total count: 43");
        }
    }
}
