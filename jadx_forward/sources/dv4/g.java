...
public final class g {
    ...
    public final java.lang.String f325542a;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f325543b;
    ...
    public g(org.json.JSONObject json) {
        ...
        try {
            str2 = java.net.URLDecoder.decode(optString2, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(str2);
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("FTSWebSearchPreGetData", "safeUrlDecode error: ".concat(optString2), e17);
            str2 = "";
        }
        if (str2.length() > 0) {
            ...
            while (true) {
                ...
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(((org.json.JSONObject) next).optString("key"), "parentSearchID")) {
                    obj = next;
                    break;
                }
            }
