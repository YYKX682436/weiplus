                ...
                if (objArr == null) {
                    ...
                    if (objArr.length != 2) {
                        ...
                        if (obj instanceof android.os.IBinder) {
                            i1Var2.f527333a = (android.os.IBinder) obj;
                            java.lang.Object obj2 = objArr[1];
                            if (obj2 instanceof java.lang.Integer) {
                                i1Var2.f527334b = ((java.lang.Integer) obj2).intValue();
                                i1Var = i1Var2;
                            } else {
                ...
                synchronized (wh.j1.class) {
                    while (true) {
                        ...
                        if (i17 < ((java.util.ArrayList) list).size()) {
                            ((rh.q3) ((wh.h1) ((java.util.ArrayList) list).get(i17))).b(i1Var.f527333a, i1Var.f527334b);
                            i17++;
                        }
                    }
                }
                ...
                if (obj9 == null || (obj9 instanceof java.lang.String)) {
                    ...
                    if (obj10 == null || (obj10 instanceof android.os.WorkSource)) {
                        ...
                        if (obj11 instanceof java.lang.Integer) {
                            ...
                            g1Var.f527317a = (android.os.IBinder) obj11;
                            java.lang.Object obj13 = objArr[1];
                            if (obj13 instanceof java.lang.Integer) {
                                g1Var.f527318b = ((java.lang.Integer) obj13).intValue();
                                g1Var2 = g1Var;
                            } else {
        ...
        synchronized (wh.j1.class) {
            while (true) {
                ...
                if (i17 < ((java.util.ArrayList) list2).size()) {
                    ((rh.q3) ((wh.h1) ((java.util.ArrayList) list2).get(i17))).a(g1Var2.f527317a, g1Var2.f527318b, g1Var2.f527319c, g1Var2.f527320d, g1Var2.f527321e, g1Var2.f527322f);
                    i17++;
                }
            }
        }
