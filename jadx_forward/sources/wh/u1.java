...
public abstract class u1 {
    ...
    public static final java.lang.ThreadLocal f527412a = new java.lang.ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    public static wh.r1 f527413b;

    /* renamed from: c, reason: collision with root package name */
    public static java.util.concurrent.atomic.AtomicReference f527414c;
    ...
    public static boolean b(int i17, int i18) {
        ...
        try {
            java.util.concurrent.atomic.AtomicReference atomicReference2 = f527414c;
        ...
        try {
            ...
            try {
                ...
                if (f527414c == null) {
                    f527414c = new java.util.concurrent.atomic.AtomicReference(method2);
                }
            }
        }
    }
    ...
    public static wh.t1 f(java.lang.String str) {
        wh.t1 t1Var;
        java.lang.ThreadLocal threadLocal = f527412a;
        try {
            try {
                ...
                wh.r1 r1Var = f527413b;
                if (r1Var != null) {
                    ((gi.g) r1Var).a(3, e17.f527404d);
                }
                try {
                    if (threadLocal.get() == null) {
                        threadLocal.set(new byte[128]);
                    ...
                    wh.r1 r1Var2 = f527413b;
                    if (r1Var2 != null) {
                        ((gi.g) r1Var2).a(1, e18.f527404d);
                    }
                    t1Var = null;
                }
            }
            if (t1Var == null || t1Var.f527406a == null) {
                oj.j.f("Matrix.battery.ProcStatUtil", "#parseJiffies read with buffer fail, fallback with spilts", new java.lang.Object[0]);
                try {
                    t1Var = h(wh.m.a(str));
                } catch (wh.s1 e19) {
                    wh.r1 r1Var3 = f527413b;
                    if (r1Var3 != null) {
                        ((gi.g) r1Var3).a(2, e19.f527404d);
                    }
                }
                if (t1Var != null) {
                    if (t1Var.f527406a == null) {
                    }
                }
    ...
    public static wh.t1 h(java.lang.String str) {
        ...
        if (!android.text.TextUtils.isEmpty(str)) {
            ...
            t1Var.f527406a = substring.substring(substring.indexOf("(") + 1, indexOf);
            ...
            t1Var.f527407b = split[1];
            t1Var.f527408c = oj.m.d(split[12], 0L);
            t1Var.f527409d = oj.m.d(split[13], 0L);
            t1Var.f527410e = oj.m.d(split[14], 0L);
            t1Var.f527411f = oj.m.d(split[15], 0L);
        }
        return t1Var;
    }
