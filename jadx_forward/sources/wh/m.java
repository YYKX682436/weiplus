...
public final class m {
    ...
    public static java.lang.Integer f527363a;

    /* renamed from: b, reason: collision with root package name */
    public static final jz5.g f527364b = jz5.h.a(jz5.i.f384362d, wh.l.f527357d);
    ...
    public static java.lang.String c(long j17, java.lang.String pattern, int i17, java.lang.Object obj) {
        if ((i17 & 2) != 0) {
            pattern = com.p314xaae8f345.tav.p2957xa228aba5.C25746x8808ec8f.f47897xee1ddd9f;
        }
        ...
        if (j17 > 0) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(format, "SimpleDateFormat(pattern….format(Date(timeStamps))");
            return format;
        }
        return j17 + "ms";
    }
    ...
    public static final int d(android.content.Context context, boolean z17) {
        ...
        wh.h hVar = kVar.f527351c;
        if (hVar == null || hVar.a()) {
            java.lang.Integer valueOf = java.lang.Integer.valueOf(e(context, false));
            kVar.f527351c = new wh.h(valueOf, 5000);
            return valueOf.intValue();
        }
        wh.h hVar2 = kVar.f527351c;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar2);
        return ((java.lang.Number) hVar2.f527326b).intValue();
    }
    ...
    public static final int e(android.content.Context context, boolean z17) {
        ...
        return com.p314xaae8f345.p552xbf8d97c1.p567xedfae76a.p568xc42a6420.C4670x2e7549c9.f19946x4fbc8495.m41037x57bab7e6() ? 4 : 2;
    }
    ...
    public static final int f(android.content.Context context) {
        ...
        wh.k kVar = (wh.k) t();
        kVar.getClass();
        wh.h hVar = kVar.f527354f;
        if (hVar == null || hVar.a()) {
            java.lang.Integer valueOf = java.lang.Integer.valueOf(g(context));
            kVar.f527354f = new wh.h(valueOf, com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3061x5a71016.C26489x58a14bb2.f54062xde855ea8);
            return valueOf.intValue();
        }
        wh.h hVar2 = kVar.f527354f;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar2);
        return ((java.lang.Number) hVar2.f527326b).intValue();
    }
    ...
    public static final int g(android.content.Context context) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        try {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(wh.n1.f527374f, com.p314xaae8f345.p2929xca247920.p2930x2eaf9f.p2931xaf3f29eb.C25497x5d2ac867.f46634x1dde913b) || p3321xbce91901.jvm.p3324x21ffc6bd.o.b(wh.n1.f527374f, "custom")) {
                wh.n1 j17 = wh.n1.j(context);
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(j17, "PowerProfile.init(context)");
        ...
        try {
            ...
            try {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(method, "profileClass.getMethod(\"…wer\", String::class.java)");
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(method2, "profileClass.getMethod(\"getBatteryCapacity\")");
    ...
    public static final int i(android.content.Context context) {
        ...
        wh.k kVar = (wh.k) t();
        kVar.getClass();
        wh.h hVar = kVar.f527353e;
        if (hVar == null || hVar.a()) {
            java.lang.Integer valueOf = java.lang.Integer.valueOf(j(context));
            kVar.f527353e = new wh.h(valueOf, com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3061x5a71016.C26489x58a14bb2.f54062xde855ea8);
            return valueOf.intValue();
        }
        wh.h hVar2 = kVar.f527353e;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar2);
        return ((java.lang.Number) hVar2.f527326b).intValue();
    }
    ...
    public static final int j(android.content.Context context) {
        ...
        android.content.Intent k17 = k(context);
        if (k17 != null) {
            int intExtra = k17.getIntExtra(ya.b.f77487x44fa364, -1);
    ...
    */
    ...
    public static final int l(android.content.Context context) {
        ...
        wh.k kVar = (wh.k) t();
        kVar.getClass();
        wh.h hVar = kVar.f527350b;
        if (hVar == null || hVar.a()) {
            java.lang.Integer valueOf = java.lang.Integer.valueOf(m(context));
            kVar.f527350b = new wh.h(valueOf, 5000);
            return valueOf.intValue();
        }
        wh.h hVar2 = kVar.f527350b;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar2);
        return ((java.lang.Number) hVar2.f527326b).intValue();
    }
    ...
    public static final int o() {
        ...
        wh.k kVar = (wh.k) t();
        wh.h hVar = kVar.f527355g;
        if (hVar != null && !hVar.a()) {
            wh.h hVar2 = kVar.f527355g;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar2);
            return ((java.lang.Number) hVar2.f527326b).intValue();
        }
        try {
            availableProcessors = new java.io.File("/sys/devices/system/cpu/").listFiles(wh.j.f527338a).length;
        } catch (java.lang.Exception unused) {
        ...
        kVar.f527355g = new wh.h(valueOf, 3600000);
        return valueOf.intValue();
    }
    ...
    public static final int r(android.content.Context context) {
        ...
        wh.k kVar = (wh.k) t();
        kVar.getClass();
        wh.h hVar = kVar.f527352d;
        if (hVar == null || hVar.a()) {
            java.lang.Integer valueOf = java.lang.Integer.valueOf(p3321xbce91901.jvm.p3324x21ffc6bd.o.b(android.os.Looper.myLooper(), android.os.Looper.getMainLooper()) ? y(context) : w(context) ? 1 : !A(context) ? 3 : wh.e1.c(context) ? 4 : 2);
            kVar.f527352d = new wh.h(valueOf, 5000);
            return valueOf.intValue();
        }
        wh.h hVar2 = kVar.f527352d;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar2);
        return ((java.lang.Number) hVar2.f527326b).intValue();
    }
    ...
    public static final java.lang.String s() {
        wh.k kVar = (wh.k) t();
        if (!android.text.TextUtils.isEmpty(kVar.f527349a)) {
            return kVar.f527349a;
        }
    ...
    public static final wh.i t() {
        return (wh.i) f527364b.mo141623x754a37bb();
    }
    ...
    public static final boolean v(android.content.Context context) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        try {
            systemService = context.getSystemService(com.p314xaae8f345.p3076xcbed6b1f.p3080xbe953013.p3081x4189335b.C26617x73f7249d.f55566xbe5e9100);
        } catch (java.lang.Throwable unused) {
        }
        if (systemService == null) {
        ...
        if (runningServices != null) {
            for (android.app.ActivityManager.RunningServiceInfo runningServiceInfo : runningServices) {
                if (!android.text.TextUtils.isEmpty(runningServiceInfo.process)) {
                    ...
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.f(str, "runningServiceInfo.process");
                    java.lang.String packageName = context.getPackageName();
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.f(packageName, "context.packageName");
    ...
    public static final boolean w(android.content.Context context) {
        int intExtra;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        java.lang.Integer num = f527363a;
