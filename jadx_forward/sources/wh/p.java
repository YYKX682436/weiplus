...
public class p implements java.lang.reflect.InvocationHandler {
    ...
    public final /* synthetic */ java.lang.Object f527379a;
    ...
    public java.lang.Object invoke(java.lang.Object obj, java.lang.reflect.Method method, java.lang.Object[] objArr) {
        if ("registerScanner".equals(method.getName())) {
            ...
            java.util.Iterator it6 = ((java.util.ArrayList) wh.r.f527391a).iterator();
            while (it6.hasNext()) {
                rh.x xVar = (rh.x) ((wh.q) it6.next());
                xVar.getClass();
                oj.j.c("Matrix.battery.BlueToothMonitorFeature", "#onStartScan, id = " + r2, new java.lang.Object[0]);
                rh.a0 a0Var2 = xVar.f477078a.f476840b;
                a0Var2.f476830c = a0Var2.f476830c + 1;
            }
            ...
            java.util.Iterator it7 = ((java.util.ArrayList) wh.r.f527391a).iterator();
            while (it7.hasNext()) {
                rh.x xVar2 = (rh.x) ((wh.q) it7.next());
                xVar2.getClass();
                oj.j.c("Matrix.battery.BlueToothMonitorFeature", "#onStartScanForIntent", new java.lang.Object[0]);
                xVar2.f477078a.f476840b.f476830c++;
            }
        }
        try {
            return wh.r.a(this.f527379a, method, objArr);
