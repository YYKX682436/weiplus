...
public abstract class x0 {
    ...
    /* renamed from: a */
    public static final java.util.ArrayList f361879a;

    /* renamed from: b */
    public static final jz5.g f361880b;

    static {
        java.util.List list;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.t70 t70Var = com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.t70.f209123a;
        java.lang.String d17 = ((com.p314xaae8f345.mm.p1006xc5476f33.p2468x38fea8.a) ((c25.e) gm0.j1.s(c25.e.class))).b().d("FinderTopicInputStopTokenList");
        ...
        if (str == null || p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, "")) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderConfig", "endchars: " + arrayList2);
            list = arrayList2;
        }
        ...
        f361879a = arrayList;
        f361880b = jz5.h.b(hc2.w0.f361876d);
    }
    ...
    public static final boolean b(java.lang.String str, int i17, int i18) {
        ...
        q26.l lVar = new q26.l((q26.m) r26.t.c(com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1433xac108269.j1.f183807a, subSequence, 0, 2, null));
        while (lVar.hasNext()) {
            ...
            if (((java.util.Set) ((jz5.n) f361880b).mo141623x754a37bb()).contains(str2)) {
                return true;
            }
        }
        return false;
    ...
    public static final java.lang.String d(java.lang.String str, int i17, boolean z17, java.lang.String reddotTitle) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(str, "<this>");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(reddotTitle, "reddotTitle");
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderSettingInfoUI", "formatUrlWithCreatorInfo, url: ".concat(a17));
        return a17;
    }
        ...
        while (i17 < str.length() && (K = r26.n0.K(str, '@', i17, false, 4, null)) != -1 && K < str.length() - 1) {
            ...
            if (!z17 || !b(str, K, i17)) {
                if (i17 - K > 1) {
                    ...
                    if (qVar != null) {
                        qVar.mo147xb9724478(java.lang.Integer.valueOf(K), java.lang.Integer.valueOf(i17), substring);
                    }
                    arrayList2.add(new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1433xac108269.m0(K, i17, substring, null, 8, null));
                }
            }
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderStringExt", "after split @ :%s", linkedList);
        if (linkedList.size() <= 0) {
            return new jz5.l(arrayList, arrayList2);
        }
        if (linkedList.size() <= 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("FinderStringExt", "list is null or size 0");
            return new jz5.l(arrayList, arrayList2);
        }
        int i19 = 0;
    ...
    */
    ...
    public static final jz5.l i(java.lang.String str, java.util.HashMap atContactMap, boolean z17, yz5.q qVar) {
        int i17;
        int K;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(atContactMap, "atContactMap");
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        if (str == null || str.length() == 0) {
            return new jz5.l(arrayList, arrayList2);
        ...
        while (i18 < str.length() && (K = r26.n0.K(str, '@', i18, false, 4, null)) != -1 && K < str.length() - 1) {
            ...
            if (!z17 || !b(str, K, i18)) {
                if (i18 - K > 1) {
                    ...
                    linkedList.add(substring);
                    if (qVar != null) {
                        qVar.mo147xb9724478(java.lang.Integer.valueOf(K), java.lang.Integer.valueOf(i18), substring);
                    }
                    arrayList2.add(new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1433xac108269.m0(K, i18, substring, null, 8, null));
                }
                com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.t70 t70Var = com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.t70.f209123a;
                jz5.g gVar = com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.t70.f209201e1;
                if (((java.lang.Number) ((lb2.j) ((jz5.n) gVar).mo141623x754a37bb()).r()).intValue() != 1000 && arrayList2.size() >= ((java.lang.Number) ((lb2.j) ((jz5.n) gVar).mo141623x754a37bb()).r()).intValue()) {
                    break;
                }
            }
        }
        ...
        for (java.lang.String str2 : linkedList) {
            if (atContactMap.containsKey(str2)) {
                ...
                if (gb4Var != null) {
                    ...
                    gb4Var2.set(0, gb4Var.m75945x2fec8307(0));
                    gb4Var2.set(1, gb4Var.m75945x2fec8307(1));
                    gb4Var2.set(2, gb4Var.m75945x2fec8307(2));
                    gb4Var2.set(3, (com.p314xaae8f345.mm.p2496xc50a8ce6.p2497xc50a8b8b.C19780xceb4c4dc) gb4Var.m75936x14adae67(3));
                    gb4Var2.set(4, java.lang.Long.valueOf(gb4Var.m75942xfb822ef2(4)));
                    gb4Var2.set(5, java.lang.Integer.valueOf(gb4Var.m75939xb282bd08(5)));
                    gb4Var2.set(7, java.lang.Integer.valueOf(gb4Var.m75939xb282bd08(7)));
                    i17 = i27 + 1;
    ...
    public static final java.lang.CharSequence j(java.lang.CharSequence charSequence, android.content.Context context, int i17, int i18, int i19, int i27, int i28, int i29, int i37, int i38) {
        ...
        if (i17 >= 0) {
            android.graphics.drawable.Drawable e17 = com.p314xaae8f345.mm.ui.uk.e(context, i18, color);
