...
public class e extends java.io.InputStream {
    ...
    public final java.io.InputStream f474036d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.zip.Checksum f474037e;
    ...
    public e(java.util.zip.Checksum checksum, java.io.InputStream inputStream) {
        ...
        this.f474037e = checksum;
        this.f474036d = inputStream;
    }

    @Override // java.io.InputStream
    public int read() {
        int read = this.f474036d.read();
        if (read >= 0) {
            this.f474037e.update(read);
        }
        return read;
    }
    ...
    public int read(byte[] bArr, int i17, int i18) {
        ...
        int read = this.f474036d.read(bArr, i17, i18);
        if (read >= 0) {
            this.f474037e.update(bArr, i17, read);
        }
        return read;
    }
}
