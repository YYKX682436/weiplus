...
public class j1 extends android.app.DatePickerDialog {
    ...
    public final void b(int i17, int i18, int i19) {
        if (this.f87467e > 1) {
            setTitle(getContext().getString(com.p314xaae8f345.mm.R.C30867xcad56011.fe6, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18 + 1)));
        }
    }
