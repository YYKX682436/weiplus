...
public final class g extends y10.a {
    ...
    public void b(pq.a context, bw5.x7 jumpInfo, t10.d callback) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("ECS_O.NativeHandler.GiftLottery", "launch mp lottery with params: " + jumpInfo.g().b().f273689a.length);
        ...
        if (context.f439086c != null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("ECS_O.NativeHandler.GiftLottery", "set open event callback, eventId:" + wi6);
