...
public class b extends p012xc85e97e9.p080xa1c8a596.p082xd1075a44.k {
    ...
    public int f534138b = -1;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ com.p176xb6135e39.p177xcca8366f.p244x11d36527.p246x5a0eb252.C2684x5190b082 f534139c;

    public b(com.p176xb6135e39.p177xcca8366f.p244x11d36527.p246x5a0eb252.C2684x5190b082 c2684x5190b082) {
        this.f534139c = c2684x5190b082;
    }
    ...
    public int a(android.view.View view, int i17, int i18) {
        ...
        int i19 = this.f534139c.f125890f;
        if (i19 == 0) {
            if (z17) {
                width = this.f534137a - view.getWidth();
                width2 = this.f534137a;
            } else {
                width = this.f534137a;
            ...
            width = this.f534137a - view.getWidth();
            width2 = view.getWidth() + this.f534137a;
        } else if (z17) {
            width = this.f534137a;
            width3 = view.getWidth();
            width2 = width3 + width;
    ...
    public void h(int i17) {
        this.f534139c.getClass();
    }

    @Override // p012xc85e97e9.p080xa1c8a596.p082xd1075a44.k
    public void i(android.view.View view, int i17, int i18, int i19, int i27) {
        float f17 = this.f534137a;
        float width = view.getWidth();
        com.p176xb6135e39.p177xcca8366f.p244x11d36527.p246x5a0eb252.C2684x5190b082 c2684x5190b082 = this.f534139c;
        float f18 = f17 + (width * c2684x5190b082.f125892h);
        float width2 = this.f534137a + (view.getWidth() * c2684x5190b082.f125893i);
        float f19 = i17;
        if (f19 <= f18) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x0053, code lost:
        ...
        if (java.lang.Math.abs(r9.getLeft() - r8.f534137a) >= java.lang.Math.round(r9.getWidth() * r3.f125891g)) goto L17;
     */
    @Override // p012xc85e97e9.p080xa1c8a596.p082xd1075a44.k
    /*
    ...
    */
    public void j(android.view.View r9, float r10, float r11) {
        /*
            ...
            r2 = 1
            com.google.android.material.behavior.SwipeDismissBehavior r3 = r8.f534139c
            r4 = 0
            if (r1 == 0) goto L3c
            java.util.WeakHashMap r5 = n3.l1.f415895a
            int r5 = n3.v0.d(r9)
            if (r5 != r2) goto L1a
            r5 = r2
            goto L1b
        ...
        L64:
            ...
            r2 = r4
        L67:
            androidx.customview.widget.l r10 = r3.f125888d
            int r11 = r9.getTop()
    ...
    public boolean k(android.view.View view, int i17) {
        return this.f534138b == -1 && this.f534139c.y(view);
    }
}
