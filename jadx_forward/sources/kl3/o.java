...
public abstract class o implements kl3.e {
    ...
    public kl3.g f390369a;

    /* renamed from: b, reason: collision with root package name */
    public b21.r f390370b;
    ...
    public void i(b21.r rVar) {
        b21.r rVar2 = this.f390370b;
        if (rVar2 == null || !rVar2.a(rVar)) {
            this.f390370b = rVar;
            return;
        }
        b21.r rVar3 = this.f390370b;
        rVar3.getClass();
        rVar3.f98881g = rVar.f98881g;
        rVar3.f98882h = rVar.f98882h;
        rVar3.f98883i = rVar.f98883i;
        rVar3.f98884m = rVar.f98884m;
        rVar3.f98888q = rVar.f98888q;
        rVar3.f98889r = rVar.f98889r;
        rVar3.f98890s = rVar.f98890s;
        rVar3.f98895x = rVar.f98895x;
        rVar3.f98891t = rVar.f98891t;
        rVar3.D = rVar.D;
        rVar3.F = rVar.F;
        rVar3.K = rVar.K;
        rVar3.L = rVar.L;
    ...
    public b21.r q(java.util.List list, int i17) {
        if (list == null || list.size() == 0 || i17 >= list.size()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Music.MusicBaseLogic", "music wrapper list error");
            return null;
        }
        this.f390370b = (b21.r) list.get(i17);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Music.MusicBaseLogic", "startPlayNewMusicList:%d", java.lang.Integer.valueOf(i17));
        return this.f390370b;
    }
    ...
    public boolean mo143622x4c4bb389() {
        ...
        int requestAudioFocus = audioManager.requestAudioFocus(k17.f536651b, 3, 2);
