...
public class od extends d95.b0 {
    ...
    public static dm.od f320587i;

    /* renamed from: j, reason: collision with root package name */
    public static final java.util.HashMap f320588j;
    ...
    public od() {
        ...
        if (!R("", gm0.j1.u().h() + "enFavorite.db", "", gm0.j1.b().h(), wo.w0.g(true), f320588j, true)) {
            throw new c01.c(1);
        }
        java.lang.String str = this.f309148g;
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.FavoriteDataBase", "dbinit failed :" + str);
