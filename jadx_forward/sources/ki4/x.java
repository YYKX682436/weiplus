...
public final class x extends i95.w implements bi4.w0 {
    public static com.p314xaae8f345.mm.p944x882e457a.m1 wi(ki4.x xVar, jz5.l params, bi4.v0 v0Var, p012xc85e97e9.p093xedfae76a.y yVar, boolean z17, int i17, java.lang.Object obj) {
        if ((i17 & 2) != 0) {
            v0Var = null;
        }
        if ((i17 & 4) != 0) {
    ...
    public final mj4.w Ai(java.lang.String str) {
        mj4.x n17 = ni4.x.f419309d.n();
        n17.getClass();
        if (str == null || r26.n0.N(str)) {
            return null;
        }
        p75.n0 TABLE = rj4.h.f477884u;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(TABLE, "TABLE");
        p75.d SESSIONID = rj4.h.f477885v;
        ...
        i17.f434190d = SESSIONID.j(str);
        return (mj4.w) i17.a().o(n17.f408618d, mj4.w.class);
    }

    public final void Bi(java.lang.String str, android.content.Context context) {
        ni4.x.f419309d.h().y0(str);
    ...
    public final void Di(java.lang.String str, java.lang.String str2, android.content.Context context) {
        ...
        java.lang.String str3 = xVar.m().y0(str).f76631xbed8694c;
        if (str3 == null) {
            str3 = "";
        }
        if (r26.n0.N(str3)) {
    ...
    public final void Ni(android.content.Context context, java.lang.String changeUserName) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(changeUserName, "changeUserName");
        android.content.Intent intent = new android.content.Intent();
