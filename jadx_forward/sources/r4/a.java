...
public final class a {
    ...
    public static volatile r4.a f451024d;

    /* renamed from: e, reason: collision with root package name */
    public static final java.lang.Object f451025e = new java.lang.Object();

    /* renamed from: c, reason: collision with root package name */
    public final android.content.Context f451028c;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Set f451027b = new java.util.HashSet();

    /* renamed from: a, reason: collision with root package name */
    public final java.util.Map f451026a = new java.util.HashMap();

    public a(android.content.Context context) {
        this.f451028c = context.getApplicationContext();
    }

    public void a(android.os.Bundle bundle) {
        java.util.Set set;
        java.lang.String string = this.f451028c.getString(com.p314xaae8f345.mm.R.C30867xcad56011.f571533i2);
        if (bundle != null) {
            try {
    ...
    public final java.lang.Object b(java.lang.Class cls, java.util.Set set) {
        ...
        java.util.Map map = this.f451026a;
        ...
        try {
            ...
            java.util.List<java.lang.Class> mo7908x1e06fd29 = bVar.mo7908x1e06fd29();
            if (!mo7908x1e06fd29.isEmpty()) {
                for (java.lang.Class cls2 : mo7908x1e06fd29) {
                    if (!((java.util.HashMap) map).containsKey(cls2)) {
                        b(cls2, set);
                    }
                }
            }
            java.lang.Object l07 = bVar.l0(this.f451028c);
            set.remove(cls);
