...
public final class u2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ bm2.v2 f103873d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.xn1 f103874e;

    public u2(bm2.v2 v2Var, r45.xn1 xn1Var) {
        this.f103873d = v2Var;
        this.f103874e = xn1Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        yz5.l lVar = this.f103873d.f103912h;
        if (lVar != null) {
            lVar.mo146xb9724478(this.f103874e);
        }
