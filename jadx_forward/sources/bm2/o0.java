...
public final class o0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.content.Context f103706d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.h32 f103707e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ bm2.b0 f103708f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ bm2.v0 f103709g;

    public o0(android.content.Context context, r45.h32 h32Var, bm2.b0 b0Var, bm2.v0 v0Var) {
        this.f103706d = context;
        this.f103707e = h32Var;
        this.f103708f = b0Var;
        this.f103709g = v0Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.content.Context context = this.f103706d;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(context, "$context");
        intent.putExtra("KEY_FINDER_LIVE_NOTICE_QR_CONTACT", xy2.c.e(context));
        intent.putExtra("KEY_FINDER_LIVE_NOTICE_QR_INFO", this.f103707e.mo14344x5f01b1f6());
        boolean z17 = false;
        intent.putExtra("KEY_FINDER_LIVE_NOTICE_QR_IS_VISITOR", false);
        c61.ub ubVar = (c61.ub) i95.n0.c(c61.ub.class);
        android.content.Context context2 = this.f103708f.f3639x46306858.getContext();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(context2, "getContext(...)");
        ((com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1433xac108269.i0) ubVar).Hj(context2, intent, 1013);
        dk2.ef efVar = dk2.ef.f314905a;
        gk2.e eVar = dk2.ef.I;
        if (eVar != null) {
            wt2.a aVar = this.f103709g.f103901n;
            if (aVar != null && (q57 = aVar.q5()) != null && ((mm2.c1) q57.a(mm2.c1.class)).S) {
                z17 = true;
            }
            bf2.c.b(bf2.c.f101131a, eVar, z17 ? 8 : 6, 1, null, 0, 24, null);
        }
