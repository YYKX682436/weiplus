...
public final class l3 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ bm2.i3 f103598d;
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        bm2.i3 i3Var = this.f103598d;
        if (action == 0) {
            i3Var.f103503e.setTextColor(android.graphics.Color.parseColor("#97AECC"));
        } else if (action == 1 || action == 3) {
            i3Var.f103503e.setTextColor(android.graphics.Color.parseColor("#BDD9FF"));
        }
