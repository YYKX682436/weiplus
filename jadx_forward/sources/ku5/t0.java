...
public class t0 implements ku5.u0, ku5.g {
    ...
    public static volatile ku5.u0 f394148d;

    /* renamed from: e, reason: collision with root package name */
    public static volatile ku5.g f394149e;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicBoolean f394150a = new java.util.concurrent.atomic.AtomicBoolean(false);

    /* renamed from: b, reason: collision with root package name */
    public volatile ku5.c f394151b;

    /* renamed from: c, reason: collision with root package name */
    public final vu5.l f394152c;

    public t0(ku5.c cVar) {
        this.f394151b = cVar;
        this.f394152c = new vu5.l(cVar);
    }

    public boolean A(java.lang.String str) {
        java.util.Objects.requireNonNull(str);
        xu5.b bVar = (xu5.b) xu5.b.f538833e.get(str);
        if (bVar == null) {
            return false;
        }
        bVar.f538836b.a();
    ...
    public java.util.Map f() {
        ((uu5.a) tu5.j.f503709a).getClass();
        java.util.HashMap hashMap = new java.util.HashMap();
        java.util.HashMap hashMap2 = uu5.a.f512842a;
        synchronized (hashMap2) {
            for (tu5.g gVar : hashMap2.values()) {
                int i17 = gVar.f503704c.get();
                if (i17 > 0) {
                    hashMap.put(gVar.f503703b, java.lang.Integer.valueOf(i17));
                }
            }
        }
        return hashMap;
