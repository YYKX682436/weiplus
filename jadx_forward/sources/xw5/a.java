...
public final class a extends android.graphics.drawable.Drawable {
    ...
    public final android.graphics.Paint f539270a;

    /* renamed from: b, reason: collision with root package name */
    public final android.graphics.Rect f539271b;
    ...
    public a(int i17) {
        ...
        this.f539270a = paint;
        this.f539271b = new android.graphics.Rect();
    }
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        android.graphics.Rect rect = this.f539271b;
        ...
        float f18 = f17 / 2.0f;
        android.graphics.Paint paint = this.f539270a;
