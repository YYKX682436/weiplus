...
public class z extends android.animation.AnimatorListenerAdapter {
    ...
    public final android.view.View f337226d;

    /* renamed from: e, reason: collision with root package name */
    public final android.animation.AnimatorListenerAdapter f337227e;

    public z(android.view.View view, android.animation.AnimatorListenerAdapter animatorListenerAdapter) {
        this.f337226d = view;
        this.f337227e = animatorListenerAdapter;
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public void onAnimationCancel(android.animation.Animator animator) {
        super.onAnimationCancel(animator);
        android.view.View view = this.f337226d;
        if (view != null) {
        ...
        android.animation.AnimatorListenerAdapter animatorListenerAdapter = this.f337227e;
