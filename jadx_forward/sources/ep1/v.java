...
public class v extends android.animation.AnimatorListenerAdapter {
    ...
    public final android.view.View f337214d;

    /* renamed from: e, reason: collision with root package name */
    public final android.animation.AnimatorListenerAdapter f337215e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ep1.x f337216f;

    public v(ep1.x xVar, android.view.View view, android.animation.AnimatorListenerAdapter animatorListenerAdapter) {
        this.f337216f = xVar;
        this.f337214d = view;
        this.f337215e = animatorListenerAdapter;
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public void onAnimationCancel(android.animation.Animator animator) {
        super.onAnimationCancel(animator);
        android.view.View view = this.f337214d;
        if (view != null) {
        ...
        android.animation.AnimatorListenerAdapter animatorListenerAdapter = this.f337215e;
