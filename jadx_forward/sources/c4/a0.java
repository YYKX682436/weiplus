...
public class a0 {
    ...
    public final android.service.media.MediaBrowserService.Result f119795a;

    public a0(android.service.media.MediaBrowserService.Result result) {
        this.f119795a = result;
    }

    public void a(java.lang.Object obj) {
        boolean z17 = obj instanceof java.util.List;
        java.util.ArrayList arrayList = null;
        android.service.media.MediaBrowserService.Result result = this.f119795a;
        if (!z17) {
