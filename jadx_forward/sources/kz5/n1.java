...
public final class n1 extends kz5.h implements java.util.RandomAccess {
    ...
    public final java.lang.Object[] f395522e;

    /* renamed from: f, reason: collision with root package name */
    public final int f395523f;
    ...
    public final void e(int i17) {
        ...
        if (i17 > 0) {
            int i18 = this.f395524g;
            int i19 = this.f395523f;
            int i27 = (i18 + i17) % i19;
            java.lang.Object[] objArr = this.f395522e;
            if (i18 > i27) {
    ...
    public java.lang.Object get(int i17) {
        int d17 = d();
        if (i17 >= 0 && i17 < d17) {
            return this.f395522e[(this.f395524g + i17) % this.f395523f];
        }
    ...
    public java.lang.Object[] toArray(java.lang.Object[] array) {
        ...
        int i17 = this.f395525h;
        if (length < i17) {
            array = java.util.Arrays.copyOf(array, i17);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(array, "copyOf(...)");
        }
        int i18 = this.f395525h;
        int i19 = this.f395524g;
        int i27 = 0;
        int i28 = 0;
        while (true) {
            objArr = this.f395522e;
            if (i28 >= i18 || i19 >= this.f395523f) {
                break;
            }
