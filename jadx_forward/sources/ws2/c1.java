...
public final class c1 implements ws2.m2 {
    ...
    public final /* synthetic */ ws2.k1 f530552a;
    ...
    public void a(boolean z17) {
        ws2.k1 k1Var = this.f530552a;
        ct2.j jVar = (ct2.j) k1Var.e(ct2.j.class);
        if (jVar != null) {
            if (jVar.f303805p == z17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MMFinder.LiveReplaySlice", "set isDocCast:" + jVar.f303805p + '!');
            }
            jVar.f303805p = z17;
        }
        java.util.Iterator it = k1Var.f530613l.iterator();
        while (it.hasNext()) {
    ...
    public void b(boolean z17) {
        java.util.Iterator it = this.f530552a.f530613l.iterator();
        while (it.hasNext()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0032, code lost:
        ...
        if ((r3.f324691a.m58783x8f7ec8ee() == 0) == true) goto L26;
     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0015, code lost:
    
        if ((r3.f324691a.m58783x8f7ec8ee() == 1) == true) goto L13;
     */
    @Override // ws2.m2
    /*
    ...
    */
    public void g(boolean r5, boolean r6) {
        /*
            ...
            r0 = 1
            r1 = 0
            ws2.k1 r2 = r4.f530552a
            if (r6 == 0) goto L23
            dt2.a0 r3 = r2.f530616o
            if (r3 == 0) goto L18
            com.tencent.mm.plugin.finder.replay.FinderLiveThumbPlayerProxy r3 = r3.f324691a
            int r3 = r3.m58783x8f7ec8ee()
            if (r3 != r0) goto L14
            r3 = r0
            goto L15
        L14:
        ...
        L3f:
            r2.f530614m = r5
            r2.f530615n = r6
            java.util.HashSet r0 = r2.f530613l
    ...
    public void mo174392x60d69242(qo0.b status, android.os.Bundle bundle) {
        ...
        java.util.Iterator it = this.f530552a.f530613l.iterator();
        while (it.hasNext()) {
            ((ws2.m2) it.next()).mo174392x60d69242(status, bundle);
        }
    }
}
