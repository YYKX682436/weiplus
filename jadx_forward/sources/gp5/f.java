...
public final class f implements java.lang.Runnable {
    ...
    public final /* synthetic */ gp5.g f356004d;
    ...
    public final void run() {
        wq4.k0 k0Var = this.f356004d.f356005a;
        k0Var.getClass();
        if (!ym1.f.Ni() && !ym1.f.Ri()) {
            android.media.AudioManager audioManager = k0Var.f530180a;
            if (audioManager.getRingerMode() == 0 || audioManager.getRingerMode() == 1) {
                return;
            }
        }
        java.lang.String e17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.e();
        android.content.Context context = k0Var.f530181b;
        if (context.getSharedPreferences(e17, 0).getBoolean("settings_shake", true)) {
            ...
            if (vibrator == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.RingPlayer", "shake:vibrator is null!");
                return;
            }
            vibrator.vibrate(10L);
        }
        java.lang.Boolean bool = java.lang.Boolean.TRUE;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.RingPlayer", "playSound, type: %s, changeStreamType: %s, shake: %s", 0, bool, bool);
        k0Var.f530186g = java.lang.System.currentTimeMillis();
        to.g gVar = new to.g();
        try {
            ...
            if (fp.h.b(28)) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.RingPlayer", "use audio attribute to play ring");
            } else {
            ...
            gVar.start();
            if (java.lang.System.currentTimeMillis() - k0Var.f530186g > 2000) {
                k0Var.getClass();
            }
