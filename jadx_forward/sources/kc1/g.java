...
public class g implements java.lang.Runnable {
    ...
    public final /* synthetic */ kc1.f f387829d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.e9 f387830e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ int f387831f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ org.json.JSONObject f387832g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ kc1.h f387833h;

    public g(kc1.h hVar, kc1.f fVar, com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.e9 e9Var, int i17, org.json.JSONObject jSONObject) {
        this.f387833h = hVar;
        this.f387829d = fVar;
        this.f387830e = e9Var;
        this.f387831f = i17;
        this.f387832g = jSONObject;
    }
    ...
    public void run() {
        ...
        kc1.f fVar = this.f387829d;
        com.p314xaae8f345.mm.p2825x7e128009.C22958xbc43cdfb c22958xbc43cdfb = fVar.f387826a;
        kc1.h hVar2 = this.f387833h;
        int i18 = this.f387831f;
        java.lang.String str5 = "errCode";
        com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.e9 e9Var2 = this.f387830e;
        if (c22958xbc43cdfb == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiFaceDetect", "hy: not prepared effect!");
        ...
        org.json.JSONObject jSONObject2 = this.f387832g;
        ...
        if (!has || !jSONObject2.has("width") || !jSONObject2.has("height")) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiFaceDetect", "hy: not given framebuffer");
        ...
        if (byteBuffer3 == null || optInt < 0 || optInt2 < 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiFaceDetect", "hy: invalid params when detect");
            hashMap3.put("errCode", java.lang.Integer.valueOf(fVar.a(cVar3)));
            e9Var2.a(i18, hVar2.p("fail: not valid params when detect frame buffer", hashMap3));
            return;
        }
        java.util.HashMap hashMap4 = new java.util.HashMap();
        kc1.f fVar2 = kc1.f.f387825d;
        kc1.c cVar4 = kc1.c.ResultOK;
        if (fVar2 == null || fVar2.f387826a == null) {
            cVar = cVar4;
            ...
            if (byteBuffer3.isDirect()) {
                ...
                byteBuffer2 = com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1212x6a710b1.v3.a(byteBuffer3).order(java.nio.ByteOrder.nativeOrder());
                byteBuffer2.position(0);
            }
            int b17 = kc1.f.f387825d.f387826a.b(byteBuffer2, optInt, optInt2);
            java.util.List f17 = kc1.f.f387825d.f387826a.f();
            if (b17 == 0) {
                java.util.ArrayList arrayList3 = (java.util.ArrayList) f17;
                if (arrayList3.size() > 0) {
                    hashMap4.put("errCode", java.lang.Integer.valueOf(fVar.a(cVar4)));
                    java.util.ArrayList arrayList4 = fVar.f387828c;
                    arrayList4.clear();
                    java.lang.String str6 = "enablePoint";
                    java.util.List c17 = jSONObject2.optBoolean("enablePoint") ? kc1.f.f387825d.f387826a.c() : null;
                    java.lang.String str7 = "enableConf";
                    if (jSONObject2.optBoolean("enableConf")) {
                        list = kc1.f.f387825d.f387826a.e();
                        str = "MicroMsg.JsApiFaceDetect";
                    } else {
                        str = "MicroMsg.JsApiFaceDetect";
                        list = null;
                    ...
                    if (jSONObject2.optBoolean("enableAngle")) {
                        cVar2 = cVar4;
                        list2 = kc1.f.f387825d.f387826a.d();
                    } else {
                        cVar2 = cVar4;
                        list2 = null;
                    }
                    ...
                    while (true) {
                        ...
                        if (!jSONObject2.optBoolean(str6) || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L0(c17) || c17.size() <= i19 || (pointFArr = (android.graphics.PointF[]) c17.get(i19)) == null) {
                            hashMap2 = hashMap4;
                            list3 = c17;
                            str4 = str6;
                            str3 = str5;
                        ...
                        kc1.b bVar = (!jSONObject2.optBoolean(str7) || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L0(list) || list.size() <= i19) ? null : new kc1.b(fVar, (float[]) list.get(i19));
                        kc1.a aVar = (!jSONObject2.optBoolean(str8) || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L0(list2) || list2.size() <= i19) ? null : new kc1.a(fVar, (tq5.a) list2.get(i19));
        ...
        if (byteBuffer.isDirect()) {
            com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1130x6aeeee6f.v vVar = (com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1130x6aeeee6f.v) e9Var.mo50357xcd94f799().h0(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1130x6aeeee6f.v.class);
            if (vVar == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.NativeBufferUtil", "hy: no buffer addon support");
            } else {
                vVar.mo51547x3b42e258(byteBuffer);
            }
        }
        if (java.util.Objects.equals(hashMap.get(str2), java.lang.Integer.valueOf(fVar.a(cVar)))) {
            e9Var.a(i17, hVar.p("ok", hashMap));
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(str, "hy: face detect failed");
