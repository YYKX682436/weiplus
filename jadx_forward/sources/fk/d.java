...
public final class d {
    ...
    public static final java.util.concurrent.ConcurrentHashMap f344791a = new java.util.concurrent.ConcurrentHashMap();
    ...
    public static final void a(wj.q0 actionType, java.lang.String posId, java.lang.String str, int i17, java.lang.String str2, java.lang.String str3) {
        ...
        float f17 = ik.f.f373354a.c(posId).f528057m;
        boolean z17 = true;
        if ((f17 == 0.0f) || f17 < c06.e.f119249d.b()) {
            return;
        }
        boolean b17 = str == null || str.length() == 0 ? false : p3321xbce91901.jvm.p3324x21ffc6bd.o.b(r26.n0.o0(str, '-', str), "123456");
        if (b17) {
        ...
        if (b17 && actionType == wj.q0.f528011e) {
            wj.o0 o0Var = wj.o0.f527989e;
            if (i17 == 0) {
                wj.o0 o0Var2 = wj.o0.f527989e;
                i17 = 7;
            }
        }
        ((ku5.t0) ku5.t0.f394148d).g(new fk.b(posId, str, actionType, i17, str4, str3));
    }
