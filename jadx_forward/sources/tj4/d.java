...
public final class d implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ int f501358d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ tj4.e f501359e;
    ...
    public final void onClick(android.view.View view) {
        ...
        tj4.e eVar = this.f501359e;
        int i17 = this.f501358d;
        if (i17 == 0) {
            yz5.p pVar = eVar.f501364h;
            if (pVar != null) {
                pVar.mo149xb9724478("-1", java.lang.Integer.valueOf(i17));
            }
        } else {
            yz5.p pVar2 = eVar.f501364h;
            if (pVar2 != null) {
                pVar2.mo149xb9724478(((tj4.a) eVar.f501360d.get(i17)).f501351f, java.lang.Integer.valueOf(i17));
            }
        }
