...
public final class z4 implements db5.x4 {
    ...
    public boolean e(float f17) {
        ...
        if (f17 < -4000.0f) {
            ...
            com.p314xaae8f345.mm.ui.p2642x2e06d1.C21507x556904c6 c21507x556904c6 = b5Var.f309827a;
            c21507x556904c6.f279039p = true;
            c21507x556904c6.f279033g.fling(0, b5Var.c(), 0, -((int) f17), 0, 0, 0, 1);
    ...
    public boolean f(float f17) {
        ...
        if (((db5.b5) y4Var).f309827a.f279042s) {
            if (c17 <= 0) {
        ...
        if (!((db5.b5) y4Var).f309827a.f279043t) {
            return false;
        }
        if (c17 >= 0) {
            ((db5.b5) y4Var).d(i17 / 2);
