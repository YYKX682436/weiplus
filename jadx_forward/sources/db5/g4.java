...
public class g4 implements android.view.ContextMenu {
    ...
    public final java.util.List f309877d = new java.util.ArrayList();

    /* renamed from: e, reason: collision with root package name */
    public java.lang.CharSequence f309878e;

    /* renamed from: f, reason: collision with root package name */
    public final android.content.Context f309879f;

    public g4(android.content.Context context) {
        this.f309879f = context;
    }

    public android.view.MenuItem a(int i17, int i18) {
        db5.h4 h4Var = new db5.h4(this.f309879f, i17, 0);
        h4Var.f309909t = i18;
        ((java.util.ArrayList) this.f309877d).add(h4Var);
        return h4Var;
    }

    @Override // android.view.Menu
    public android.view.MenuItem add(int i17, int i18, int i19, int i27) {
        db5.h4 h4Var = new db5.h4(this.f309879f, i18, i17);
        h4Var.f309909t = i27;
        ((java.util.ArrayList) this.f309877d).add(h4Var);
        return h4Var;
    }
    ...
    @Override // android.view.Menu
    public void clear() {
        java.util.List list = this.f309877d;
    ...
    public android.view.MenuItem d(int i17, int i18, java.lang.CharSequence charSequence) {
        ...
        h4Var.f309901i = spannableString;
        ((java.util.ArrayList) this.f309877d).add(h4Var);
        return h4Var;
    }
    ...
    public android.view.MenuItem e(int i17, int i18, java.lang.CharSequence charSequence, int i19, int i27, boolean z17) {
        ...
        h4Var.d(i19, i27);
        h4Var.f309908s = z17;
        ((java.util.ArrayList) this.f309877d).add(i18, h4Var);
        return h4Var;
    }
    ...
    public android.view.MenuItem findItem(int i17) {
        java.util.Iterator it = ((java.util.ArrayList) this.f309877d).iterator();
        while (it.hasNext()) {
    ...
    public android.view.MenuItem getItem(int i17) {
        return (android.view.MenuItem) ((java.util.ArrayList) this.f309877d).get(i17);
    }
    ...
    public android.view.ContextMenu setHeaderTitle(int i17) {
        ...
        if (i17 > 0 && (string = this.f309879f.getString(i17)) != null) {
            this.f309878e = string;
        }
        return this;
    }
    ...
    public android.view.MenuItem v(android.view.MenuItem menuItem) {
        ...
        ((java.util.ArrayList) this.f309877d).add(menuItem);
        return null;
    }
    ...
    public boolean z() {
        return ((java.util.ArrayList) this.f309877d).size() == 0;
    }
    ...
    public android.view.MenuItem add(int i17) {
        db5.h4 h4Var = new db5.h4(this.f309879f, 0, 0);
        h4Var.f309909t = i17;
        ((java.util.ArrayList) this.f309877d).add(h4Var);
        return h4Var;
    }
