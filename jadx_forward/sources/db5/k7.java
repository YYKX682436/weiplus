...
public class k7 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ db5.m7 f309955d;
    ...
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        ...
        db5.m7 m7Var = this.f309955d;
        intent.setData(android.net.Uri.fromParts("package", m7Var.f309973a.getPackageName(), null));
        intent.addFlags(268435456);
        android.content.Context context = m7Var.f309973a;
        ...
        jx3.f.INSTANCE.mo68477x336bdfd8(462L, 23L, 1L, true);
    }
}
