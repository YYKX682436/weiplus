...
public abstract class a1 {
    public static final java.lang.String a(o06.d callableMemberDescriptor) {
        ...
        if (l17 instanceof o06.o1) {
            l06.o.A(l17);
            o06.d b18 = v16.f.b(v16.f.l(l17), false, x06.m.f532808d, 1, null);
            if (b18 == null) {
                return null;
            }
            java.util.Map map = x06.k.f532799a;
            n16.g gVar = (n16.g) x06.k.f532799a.get(v16.f.g(b18));
            if (gVar != null) {
                return gVar.h();
            }
            return null;
        ...
        java.util.Map map2 = x06.g1.f532784j;
    ...
    public static final o06.d b(o06.d dVar) {
        ...
        if (!((java.util.ArrayList) x06.g1.f532785k).contains(dVar.mo132800xfb82e301())) {
            java.util.Map map = x06.k.f532799a;
            if (!x06.k.f532802d.contains(v16.f.l(dVar).mo132800xfb82e301())) {
                return null;
            }
        }
        if (dVar instanceof o06.o1 ? true : dVar instanceof o06.n1) {
            return v16.f.b(dVar, false, x06.x0.f532869d, 1, null);
        }
        if (dVar instanceof o06.v1) {
            return v16.f.b(dVar, false, x06.y0.f532870d, 1, null);
        }
        return null;
    }
    ...
    public static final o06.d c(o06.d dVar) {
        ...
        n16.g mo132800xfb82e301 = dVar.mo132800xfb82e301();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(mo132800xfb82e301, "getName(...)");
        if (jVar.b(mo132800xfb82e301)) {
            return v16.f.b(dVar, false, x06.z0.f532874d, 1, null);
        }
        return null;
    }
