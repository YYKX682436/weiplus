...
public abstract class b {
    ...
    public static final java.util.Map f532736c;

    /* renamed from: a, reason: collision with root package name */
    public final x06.k0 f532737a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.concurrent.ConcurrentHashMap f532738b;

    static {
        java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
        for (x06.c cVar : x06.c.m174844xcee59d22()) {
            java.lang.String str = cVar.f532750d;
            if (linkedHashMap.get(str) == null) {
                linkedHashMap.put(str, cVar);
            }
        }
        f532736c = linkedHashMap;
    }
    ...
    public b(x06.k0 javaTypeEnhancementState) {
        ...
        this.f532737a = javaTypeEnhancementState;
        this.f532738b = new java.util.concurrent.ConcurrentHashMap();
    }
    ...
    */
    ...
    public final f16.o c(java.lang.Object obj, yz5.l lVar) {
        f16.o h17;
        f16.o h18 = h(obj, ((java.lang.Boolean) lVar.mo146xb9724478(obj)).booleanValue());
        if (h18 != null) {
            return h18;
        }
        ...
        x06.w0 i17 = i(obj);
        if (i17 == null) {
            i17 = this.f532737a.f532804a.f532811a;
        }
        i17.getClass();
        if ((i17 == x06.w0.f532863e) || (h17 = h(j17, ((java.lang.Boolean) lVar.mo146xb9724478(j17)).booleanValue())) == null) {
            return null;
        }
        return f16.o.a(h17, null, i17 == x06.w0.f532864f, 1, null);
    }

    public final java.lang.Object d(java.lang.Object obj, n16.c cVar) {
        for (java.lang.Object obj2 : f(obj)) {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(e(obj2), cVar)) {
                return obj2;
            }
        }
        return null;
    ...
    public final boolean g(java.lang.Object obj, n16.c cVar) {
        ...
        while (it.hasNext()) {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(e(it.next()), cVar)) {
                return true;
            }
        }
        return false;
    ...
    */
    ...
    public final x06.w0 i(java.lang.Object obj) {
        ...
        x06.k0 k0Var = this.f532737a;
        x06.w0 w0Var = (x06.w0) k0Var.f532804a.f532813c.get(e(obj));
        if (w0Var != null) {
            return w0Var;
        }
        java.lang.Object d17 = d(obj, x06.d.f532754d);
        if (d17 == null || (str = (java.lang.String) kz5.n0.Y(a(d17, false))) == null) {
            return null;
        }
        x06.w0 w0Var2 = k0Var.f532804a.f532812b;
        if (w0Var2 != null) {
            return w0Var2;
        }
        ...
        if (hashCode == -1838656823) {
            if (str.equals("STRICT")) {
                return x06.w0.f532865g;
            }
            return null;
        }
        if (hashCode == 2656902 && str.equals("WARN")) {
            return x06.w0.f532864f;
        }
        return null;
    }
    ...
    public final java.lang.Object j(java.lang.Object annotation) {
        ...
        if (this.f532737a.f532804a.f532814d) {
            return null;
        }
        if (kz5.n0.O(x06.d.f532757g, e(annotation)) || g(annotation, x06.d.f532752b)) {
            return annotation;
        }
        if (!g(annotation, x06.d.f532751a)) {
            return null;
        }
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = this.f532738b;
