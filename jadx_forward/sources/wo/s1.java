...
public final class s1 {
    ...
    public final int a() {
        ...
        while (true) {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SoCFeatures", th6, "Failure on getCPUCoreCount.", new java.lang.Object[0]);
                return 1;
            }
        }
        if (i17 > 0) {
    ...
    public final java.util.Map c() {
        java.util.Map[] mapArr = wo.t1.f529334b;
        ...
        synchronized (mapArr) {
            ...
            java.util.Map d17 = wo.t1.f529333a.d();
            mapArr[0] = d17;
            return d17 == null ? kz5.q0.f395534d : d17;
        }
    }
    ...
    public final java.util.Map d() {
        try {
            ...
            java.io.Reader inputStreamReader = new java.io.InputStreamReader(new java.io.FileInputStream(new java.io.File("/proc/cpuinfo")), r26.c.f450398a);
            ...
            try {
                for (java.lang.String str : vz5.v.b(bufferedReader)) {
                    ...
                    java.util.regex.Pattern regex = (java.util.regex.Pattern) ((jz5.n) wo.t1.f529335c).mo141623x754a37bb();
                ...
                if (!mVar.containsKey("Hardware")) {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SoCFeatures", "result: " + a17 + ", socModel: " + a18);
                    if (a18 != null && r26.i0.p(a18, "kirin", true)) {
                        java.lang.String a19 = wo.w1.a("ro.hardware");
                        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(a19, "get(...)");
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SoCFeatures", "cpuhardware: " + a18 + ", cpuhardwareT: " + a19);
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SoCFeatures", th6, "Fail to parse /proc/cpuinfo", new java.lang.Object[0]);
            return null;
        }
    }
}
