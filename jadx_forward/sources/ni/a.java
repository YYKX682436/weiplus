...
public class a {
    ...
    public static final ni.a f418702a = new ni.a();

    public oi.e a(oi.d dVar, long j17, int i17) {
        ni.b bVar = ni.b.f418703d;
        bVar.getClass();
        int ordinal = dVar.ordinal();
        boolean z17 = true;
        if (ordinal != 0) {
            if (ordinal == 1) {
                return bVar.a(bVar.f418705b, j17, i17);
            }
            if (ordinal != 3) {
                return null;
            }
            return (oi.e) ((java.util.HashMap) bVar.f418706c).get(java.lang.Long.valueOf(j17));
        }
        ...
        return bVar.a(bVar.f418704a, j17, i17);
    }
    ...
    */
    public void b(oi.d r9, int r10, long r11, oi.e r13) {
        ...
        L84:
            ...
            goto Lae
        L90:
            java.util.Map r9 = r0.f418706c
            java.lang.Long r10 = java.lang.Long.valueOf(r11)
            java.util.HashMap r9 = (java.util.HashMap) r9
            r9.put(r10, r13)
            goto Lae
        L9c:
            java.util.Map r1 = r0.f418705b
            r2 = r10
            r3 = r11
            r5 = r13
            r6 = r7
