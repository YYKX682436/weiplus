...
public abstract class n {
    ...
    public static android.webkit.WebMessage b(y4.h hVar) {
        java.lang.String str = hVar.f540809b;
        y4.j[] jVarArr = hVar.f540808a;
        ...
        if (jVarArr != null) {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                ...
                if (a0Var.f551588a == null) {
                    z4.k0 k0Var = z4.f0.f551599a;
                    a0Var.f551588a = (android.webkit.WebMessagePort) k0Var.f551605a.m154457x439c65c7(java.lang.reflect.Proxy.getInvocationHandler(null));
                }
                webMessagePortArr2[i17] = a0Var.f551588a;
            }
