...
public class d extends av5.m0 {
    ...
    public final int f95891e;

    /* renamed from: f, reason: collision with root package name */
    public final int[][] f95892f;

    /* renamed from: g, reason: collision with root package name */
    public final int[][] f95893g;

    /* renamed from: h, reason: collision with root package name */
    public final int[][] f95894h;
    ...
    public int compareTo(av5.d dVar) {
        int i17 = dVar.f95891e;
        int i18 = this.f95891e;
        if (i18 != i17) {
            return cv5.c.f(i18, i17);
        }
        int[][] iArr = this.f95892f;
        int length = iArr.length;
        int[][] iArr2 = this.f95893g;
        int length2 = iArr2.length;
        int[][] iArr3 = this.f95894h;
        int length3 = iArr3.length;
        int[][] iArr4 = dVar.f95892f;
        int length4 = iArr4.length;
        int[][] iArr5 = dVar.f95893g;
        int length5 = iArr5.length;
        int[][] iArr6 = dVar.f95894h;
    ...
    public int mo9118x8cdac1b() {
        return cv5.e.a(java.lang.Integer.valueOf(this.f95891e), this.f95892f, this.f95893g, this.f95894h);
    }
}
