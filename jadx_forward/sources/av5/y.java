...
public final class y {
    ...
    public static final short[] f95994e = new short[0];

    /* renamed from: a, reason: collision with root package name */
    public final av5.o0 f95995a;

    /* renamed from: b, reason: collision with root package name */
    public final av5.v f95996b;

    /* renamed from: c, reason: collision with root package name */
    public java.nio.ByteBuffer f95997c;
    ...
    public y(int i17) {
        ...
        this.f95995a = o0Var;
        this.f95996b = new av5.v(this, null);
        new av5.w(this, null);
        new av5.x(this, null);
        new av5.t(this, null);
        new av5.q(this, null);
    ...
    public byte[] b(boolean z17) {
        ...
        try {
            ...
            java.nio.ByteBuffer duplicate = this.f95997c.duplicate();
    ...
    public av5.u c(int i17) {
        if (i17 < 0 || i17 >= this.f95997c.capacity()) {
            throw new java.lang.IllegalArgumentException("position=" + i17 + " length=" + this.f95997c.capacity());
        }
        java.nio.ByteBuffer duplicate = this.f95997c.duplicate();
        duplicate.order(java.nio.ByteOrder.LITTLE_ENDIAN);
        duplicate.position(i17);
        duplicate.limit(this.f95997c.capacity());
        return new av5.u(this, "temp-section", duplicate, null);
    }

    public av5.u d(av5.n0 n0Var) {
        int i17 = n0Var.f95954g;
        if (i17 < 0 || i17 >= this.f95997c.capacity()) {
            throw new java.lang.IllegalArgumentException("position=" + i17 + " length=" + this.f95997c.capacity());
        }
        java.nio.ByteBuffer duplicate = this.f95997c.duplicate();
        duplicate.order(java.nio.ByteOrder.LITTLE_ENDIAN);
        duplicate.position(i17);
        duplicate.limit(i17 + n0Var.f95955h);
