...
public final class u7 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ bg2.l8 f102089d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.lu5 f102090e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f102091f;

    public u7(bg2.l8 l8Var, r45.lu5 lu5Var, android.content.Context context) {
        this.f102089d = l8Var;
        this.f102090e = lu5Var;
        this.f102091f = context;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        r45.lu5 lu5Var = this.f102090e;
        zy2.zb.T8(zbVar, t1Var, kz5.c1.l(lVar, lVar2, lVar3, new jz5.l("survey_select", java.lang.String.valueOf(lu5Var.m75939xb282bd08(0)))), null, null, null, null, false, 124, null);
        int m75939xb282bd08 = lu5Var.m75939xb282bd08(0);
        ...
        if (s0Var == null || (context = s0Var.f374654e) == null) {
            ...
            java.lang.String string = context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.loi);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(string, "getString(...)");
            c14214xfa60143c.m56821x53bfe316(string);
            if (m75939xb282bd08 != 1) {
                java.lang.String string2 = context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.loh);
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(string2, "getString(...)");
                c14214xfa60143c.m56817x76492e13(string2);
                c14214xfa60143c.m56818xe8299f09(new bg2.v7(l8Var, c14214xfa60143c, m75939xb282bd08));
            }
        }
        ...
        if (c14214xfa60143c2 != null) {
            ...
            android.view.animation.TranslateAnimation translateAnimation = new android.view.animation.TranslateAnimation(0.0f, 0.0f, ((java.lang.Number) ((jz5.n) l8Var.f101813n).mo141623x754a37bb()).intValue(), 0.0f);
            ...
            bg2.r4 r4Var = new bg2.r4(c14214xfa60143c2, animationSet, animationSet2, l8Var.f101816q, new bg2.t7(l8Var, lu5Var, this.f102091f));
            bg2.a5 a5Var = (bg2.a5) l8Var.N6(bg2.a5.class);
            if (a5Var != null) {
                a5Var.e7(r4Var);
            }
            l8Var.f101821v = true;
            l8Var.f101822w = java.lang.Integer.valueOf(lu5Var.m75939xb282bd08(0));
            i95.m c18 = i95.n0.c(ml2.j0.class);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(c18, "getService(...)");
            zy2.zb.I8((zy2.zb) c18, ml2.u1.I2, kz5.c1.l(new jz5.l("liveId", bg2.l8.Z6(l8Var)), new jz5.l("feedId", bg2.l8.Y6(l8Var)), new jz5.l("panel_sence", "1"), new jz5.l("survey_select", java.lang.String.valueOf(lu5Var.m75939xb282bd08(0)))), null, null, null, null, false, 124, null);
        }
