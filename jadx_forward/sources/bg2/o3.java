...
public final class o3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.y23 f101881d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bg2.z3 f101882e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f101883f;

    public o3(r45.y23 y23Var, bg2.z3 z3Var, android.view.View view) {
        this.f101881d = y23Var;
        this.f101882e = z3Var;
        this.f101883f = view;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/finder/live/convert/convertcontroller/LiveConvertShoppingPromoteController$renderExp2Layout$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, array);
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("KEY_PARAMS_DO_ACTION", 9);
        intent.putExtra("KEY_PARAMS_AUTO_OPEN_PRODUCT_INFO", this.f101881d.mo14344x5f01b1f6());
        bg2.z3 z3Var = this.f101882e;
        ...
        if (abstractC14490x69736cb5 != null && (feedObject2 = abstractC14490x69736cb5.getFeedObject()) != null) {
            feedObject2.getFeedObject();
        }
        uc2.i iVar = (uc2.i) z3Var.O6(uc2.i.class);
        if (iVar != null) {
            ((sb2.o) iVar).Y6(this.f101883f, intent);
        }
        ...
        if (abstractC14490x69736cb53 != null) {
            ...
            v3Var.a(c76, abstractC14490x69736cb53, jSONObject2);
        }
        yj0.a.h(this, "com/tencent/mm/plugin/finder/live/convert/convertcontroller/LiveConvertShoppingPromoteController$renderExp2Layout$4", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
