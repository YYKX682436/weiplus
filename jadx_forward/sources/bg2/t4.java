...
public final class t4 implements android.view.animation.Animation.AnimationListener {
    ...
    public final bg2.r4 f102054a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ bg2.a5 f102055b;

    public t4(bg2.a5 a5Var, bg2.r4 config) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(config, "config");
        this.f102055b = a5Var;
        this.f102054a = config;
    }

    @Override // android.view.animation.Animation.AnimationListener
    public void onAnimationEnd(android.view.animation.Animation animation) {
        bg2.a5 a5Var = this.f102055b;
        a5Var.d7();
        p3325xe03a0797.p3326xc267989b.y0 y0Var = a5Var.f498674d.f498680g;
        p3325xe03a0797.p3326xc267989b.r2 r2Var = null;
        if (y0Var != null) {
            p3325xe03a0797.p3326xc267989b.p0 p0Var = p3325xe03a0797.p3326xc267989b.q1.f392101a;
            r2Var = p3325xe03a0797.p3326xc267989b.l.d(y0Var, p3325xe03a0797.p3326xc267989b.p3329x21ffc6bd.b0.f392017a, null, new bg2.s4(this, a5Var, null), 2, null);
        }
        a5Var.f101454h = r2Var;
    }
    ...
    public void onAnimationStart(android.view.animation.Animation animation) {
        in5.s0 s0Var;
        bg2.r4 r4Var = this.f102054a;
        bg2.a5 a5Var = this.f102055b;
        a5Var.f101453g = r4Var;
        uc2.g gVar = (uc2.g) a5Var.O6(uc2.g.class);
        android.view.View p17 = (gVar == null || (s0Var = ((sb2.l) gVar).f498674d.f498682i) == null) ? null : s0Var.p(com.p314xaae8f345.mm.R.id.f566017ee1);
        if (p17 != null) {
        ...
        in5.s0 s0Var2 = a5Var.f498674d.f498682i;
        android.view.View p18 = s0Var2 != null ? s0Var2.p(com.p314xaae8f345.mm.R.id.f565793dk3) : null;
        if (p18 == null) {
            return;
        }
