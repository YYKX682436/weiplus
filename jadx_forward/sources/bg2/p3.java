...
public final class p3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.y23 f101914d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bg2.z3 f101915e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f101916f;

    public p3(r45.y23 y23Var, bg2.z3 z3Var, android.view.View view) {
        this.f101914d = y23Var;
        this.f101915e = z3Var;
        this.f101916f = view;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        intent.putExtra("KEY_PARAMS_AUTO_OPEN_PRODUCT_INFO", this.f101914d.mo14344x5f01b1f6());
        bg2.z3 z3Var = this.f101915e;
        uc2.i iVar = (uc2.i) z3Var.O6(uc2.i.class);
        if (iVar != null) {
            ((sb2.o) iVar).Y6(this.f101916f, intent);
        }
