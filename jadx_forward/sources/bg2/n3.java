...
public final class n3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.y23 f101861d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bg2.z3 f101862e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f101863f;

    public n3(r45.y23 y23Var, bg2.z3 z3Var, android.view.View view) {
        this.f101861d = y23Var;
        this.f101862e = z3Var;
        this.f101863f = view;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/finder/live/convert/convertcontroller/LiveConvertShoppingPromoteController$renderExp2Layout$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, array);
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("KEY_PARAMS_DO_ACTION", 9);
        intent.putExtra("KEY_PARAMS_AUTO_OPEN_PRODUCT_INFO", this.f101861d.mo14344x5f01b1f6());
        bg2.z3 z3Var = this.f101862e;
        uc2.i iVar = (uc2.i) z3Var.O6(uc2.i.class);
        if (iVar != null) {
            ((sb2.o) iVar).Y6(this.f101863f, intent);
        }
        ...
        yj0.a.h(this, "com/tencent/mm/plugin/finder/live/convert/convertcontroller/LiveConvertShoppingPromoteController$renderExp2Layout$3", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
