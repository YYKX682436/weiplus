...
public final class l3 extends ym5.n0 {
    ...
    public final /* synthetic */ bg2.z3 f101799a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ r45.kr0 f101800b;

    public l3(bg2.z3 z3Var, r45.kr0 kr0Var) {
        this.f101799a = z3Var;
        this.f101800b = kr0Var;
    }
    ...
    public void mo976xcdf5f75c(android.view.View view, long j17, long j18, boolean z17) {
        ...
        if (z17) {
            ...
            if (z3Var.A) {
                ...
                if (y0Var != null) {
                    r45.kr0 kr0Var = this.f101800b;
                    if (kr0Var != null && (bh6Var = (r45.bh6) kr0Var.m75936x14adae67(2)) != null) {
                        i17 = bh6Var.m75939xb282bd08(1);
                    }
                    y0Var.Y6(2L, i17 * 1000, "{productid:" + z3Var.f102231s + '}');
                    return;
                }
                return;
            }
        ...
        long c17 = c01.id.c() - z3Var.f102227o;
        ml2.u1 u1Var = ml2.u1.f409637y2;
