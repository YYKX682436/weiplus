...
public final class g implements d0.e {
    ...
    public final float f306651a = 0;

    @Override // d0.d, d0.l
    public float a() {
        return this.f306651a;
    }
    ...
    public void b(p2.f fVar, int i17, int[] sizes, int[] outPositions) {
        ...
        d0.p.f306716a.e(i17, sizes, outPositions, false);
    }
    ...
    public void c(p2.f fVar, int i17, int[] sizes, p2.s layoutDirection, int[] outPositions) {
        ...
        if (layoutDirection == p2.s.Ltr) {
            ...
            d0.p.f306716a.e(i17, sizes, outPositions, true);
        }
    }

    /* renamed from: toString */
    public java.lang.String m123206x9616526c() {
