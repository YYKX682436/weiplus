...
/* renamed from: androidx.camera.extensions.internal.sessionprocessor.KeyValueMapCameraCaptureResult */
/* loaded from: classes14.dex */
class C1028xf0a1e1f4 implements p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.InterfaceC0663xe081a7be {
    private static final java.lang.String TAG = "KeyValueMapCameraCaptureResult";

    /* renamed from: mKeyValues */
    private final java.util.Map<android.hardware.camera2.CaptureResult.Key, java.lang.Object> f2568x844ee74;

    /* renamed from: mTagBundle */
    private p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0760xc2ac609c f2569xc5f18acf;

    /* renamed from: mTimestamp */
    private final long f2570x7e007329;

    public C1028xf0a1e1f4(long j17, p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0760xc2ac609c c0760xc2ac609c, java.util.Map<android.hardware.camera2.CaptureResult.Key, java.lang.Object> map) {
        this.f2568x844ee74 = map;
        this.f2569xc5f18acf = c0760xc2ac609c;
        this.f2570x7e007329 = j17;
    }
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode mo2927x10512add() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AE_MODE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeState mo2928xfa2afa97() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AE_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AfMode mo2929x105f425e() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AF_MODE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AfState mo2930xfbdfd336() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AF_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AwbMode mo2931x19a40e79() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_MODE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AwbState mo2932x1b348a7b() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.FlashState mo2934xa6611277() {
        java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.FLASH_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0760xc2ac609c mo2935x4aa7b206() {
        return this.f2569xc5f18acf;
    }

    @Override // p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.InterfaceC0663xe081a7be
    /* renamed from: getTimestamp */
    public long mo2936x2b69a60() {
        return this.f2570x7e007329;
    }
    ...
    public void mo2937xd74657e4(p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.p042x6a710b1.C0787x848778fa.Builder builder) {
        ...
        try {
            java.lang.Integer num = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.JPEG_ORIENTATION);
            if (num != null) {
        ...
        java.lang.Long l17 = (java.lang.Long) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.SENSOR_EXPOSURE_TIME);
        if (l17 != null) {
            builder.m5899xcddf3fe9(l17.longValue());
        }
        java.lang.Float f17 = (java.lang.Float) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.LENS_APERTURE);
        if (f17 != null) {
            builder.m5905x3f19aaf(f17.floatValue());
        }
        java.lang.Integer num2 = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.SENSOR_SENSITIVITY);
        if (num2 != null) {
            if (((java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_POST_RAW_SENSITIVITY_BOOST)) != null) {
                num2 = java.lang.Integer.valueOf(num2.intValue() * ((int) (r1.intValue() / 100.0f)));
            }
            builder.m5904xca0270c3(num2.intValue());
        }
        java.lang.Float f18 = (java.lang.Float) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.LENS_FOCAL_LENGTH);
        if (f18 != null) {
            builder.m5901x3a9013e9(f18.floatValue());
        }
        java.lang.Integer num3 = (java.lang.Integer) this.f2568x844ee74.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_MODE);
        if (num3 != null) {
