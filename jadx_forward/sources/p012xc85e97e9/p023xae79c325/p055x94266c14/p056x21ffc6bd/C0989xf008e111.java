...
/* renamed from: androidx.camera.extensions.internal.Camera2CameraCaptureResult */
/* loaded from: classes14.dex */
public class C0989xf008e111 implements p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.InterfaceC0663xe081a7be {
    private static final java.lang.String TAG = "C2CameraCaptureResult";

    /* renamed from: mCaptureResult */
    private final android.hardware.camera2.CaptureResult f2422xcd737796;

    /* renamed from: mTagBundle */
    private final p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0760xc2ac609c f2423xc5f18acf;

    public C0989xf008e111(p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0760xc2ac609c c0760xc2ac609c, android.hardware.camera2.CaptureResult captureResult) {
        this.f2423xc5f18acf = c0760xc2ac609c;
        this.f2422xcd737796 = captureResult;
    }
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode mo2927x10512add() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AE_MODE);
        if (num == null) {
            return p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.UNKNOWN;
        }
        int intValue = num.intValue();
        return intValue != 0 ? intValue != 1 ? intValue != 2 ? intValue != 3 ? intValue != 4 ? intValue != 5 ? p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.UNKNOWN : p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.ON_EXTERNAL_FLASH : p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.ON_AUTO_FLASH_REDEYE : p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.ON_ALWAYS_FLASH : p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.ON_AUTO_FLASH : p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.ON : p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeMode.OFF;
    }

    @Override // p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.InterfaceC0663xe081a7be
    /* renamed from: getAeState */
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AeState mo2928xfa2afa97() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AE_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AfMode mo2929x105f425e() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AF_MODE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AfState mo2930xfbdfd336() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AF_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AwbMode mo2931x19a40e79() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_MODE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.AwbState mo2932x1b348a7b() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0662xbfd96ab0.FlashState mo2934xa6611277() {
        java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.FLASH_STATE);
        if (num == null) {
    ...
    public p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.C0760xc2ac609c mo2935x4aa7b206() {
        return this.f2423xc5f18acf;
    }

    @Override // p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.InterfaceC0663xe081a7be
    /* renamed from: getTimestamp */
    public long mo2936x2b69a60() {
        java.lang.Long l17 = (java.lang.Long) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.SENSOR_TIMESTAMP);
        if (l17 == null) {
            return -1L;
        }
    ...
    public void mo2937xd74657e4(p012xc85e97e9.p023xae79c325.p034x2eaf9f.p037x316220.p042x6a710b1.C0787x848778fa.Builder builder) {
        ...
        try {
            java.lang.Integer num = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.JPEG_ORIENTATION);
            if (num != null) {
        ...
        java.lang.Long l17 = (java.lang.Long) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.SENSOR_EXPOSURE_TIME);
        if (l17 != null) {
            builder.m5899xcddf3fe9(l17.longValue());
        }
        java.lang.Float f17 = (java.lang.Float) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.LENS_APERTURE);
        if (f17 != null) {
            builder.m5905x3f19aaf(f17.floatValue());
        }
        java.lang.Integer num2 = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.SENSOR_SENSITIVITY);
        if (num2 != null) {
            if (((java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_POST_RAW_SENSITIVITY_BOOST)) != null) {
                num2 = java.lang.Integer.valueOf(num2.intValue() * ((int) (r1.intValue() / 100.0f)));
            }
            builder.m5904xca0270c3(num2.intValue());
        }
        java.lang.Float f18 = (java.lang.Float) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.LENS_FOCAL_LENGTH);
        if (f18 != null) {
            builder.m5901x3a9013e9(f18.floatValue());
        }
        java.lang.Integer num3 = (java.lang.Integer) this.f2422xcd737796.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_MODE);
        if (num3 != null) {
    ...
    public C0989xf008e111(android.hardware.camera2.CaptureResult captureResult) {
