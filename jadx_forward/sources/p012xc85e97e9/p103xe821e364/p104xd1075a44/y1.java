...
public class y1 extends p012xc85e97e9.p103xe821e364.p104xd1075a44.r3 {

    /* renamed from: d, reason: collision with root package name */
    public p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 f93820d;

    /* renamed from: e, reason: collision with root package name */
    public p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 f93821e;

    private android.view.View j(p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4.LayoutManager layoutManager, p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 w1Var) {
    ...
    private p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 l(p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4.LayoutManager layoutManager) {
        p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 w1Var = this.f93821e;
        if (w1Var == null || w1Var.f93792a != layoutManager) {
            this.f93821e = new p012xc85e97e9.p103xe821e364.p104xd1075a44.u1(layoutManager);
        }
        return this.f93821e;
    }

    private p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 m(p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4.LayoutManager layoutManager) {
        p012xc85e97e9.p103xe821e364.p104xd1075a44.w1 w1Var = this.f93820d;
        if (w1Var == null || w1Var.f93792a != layoutManager) {
            this.f93820d = new p012xc85e97e9.p103xe821e364.p104xd1075a44.v1(layoutManager);
        }
        return this.f93820d;
    }
    ...
    public p012xc85e97e9.p103xe821e364.p104xd1075a44.o1 e(p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4.LayoutManager layoutManager) {
        if (layoutManager instanceof p012xc85e97e9.p103xe821e364.p104xd1075a44.f3) {
            return new p012xc85e97e9.p103xe821e364.p104xd1075a44.x1(this, this.f93745a.getContext());
        }
        return null;
    }
    ...
    public int g(p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4.LayoutManager layoutManager, int i17, int i18) {
        ...
        android.view.View k17 = layoutManager.getF204840r() ? k(layoutManager, m(layoutManager)) : layoutManager.mo2416xc6ea780e() ? k(layoutManager, l(layoutManager)) : null;
        if (k17 == null || (m8032xa86cd69f = layoutManager.m8032xa86cd69f(k17)) == -1) {
            return -1;
        }
        boolean z17 = false;
        boolean z18 = !layoutManager.mo2416xc6ea780e() ? i18 <= 0 : i17 <= 0;
