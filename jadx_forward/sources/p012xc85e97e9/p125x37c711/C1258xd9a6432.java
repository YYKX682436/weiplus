...
/* renamed from: androidx.work.ArrayCreatingInputMerger */
/* loaded from: classes12.dex */
public final class C1258xd9a6432 extends a5.q {
    @Override // a5.q
    public a5.m a(java.util.List list) {
        ...
        while (it.hasNext()) {
            for (java.util.Map.Entry entry : java.util.Collections.unmodifiableMap(((a5.m) it.next()).f82944a).entrySet()) {
