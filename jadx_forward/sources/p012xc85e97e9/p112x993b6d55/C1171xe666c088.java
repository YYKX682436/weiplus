...
/* renamed from: androidx.transition.ArcMotion */
/* loaded from: classes13.dex */
public class C1171xe666c088 extends p012xc85e97e9.p112x993b6d55.AbstractC1180x9e297c5b {

    /* renamed from: d, reason: collision with root package name */
    public static final float f93907d = (float) java.lang.Math.tan(java.lang.Math.toRadians(35.0d));

    /* renamed from: a, reason: collision with root package name */
    public float f93908a;

    /* renamed from: b, reason: collision with root package name */
    public float f93909b;

    /* renamed from: c, reason: collision with root package name */
    public float f93910c;

    public C1171xe666c088(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f93908a = 0.0f;
        this.f93909b = 0.0f;
        this.f93910c = f93907d;
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, u4.u0.f506098i);
        org.xmlpull.v1.XmlPullParser xmlPullParser = (org.xmlpull.v1.XmlPullParser) attributeSet;
        this.f93909b = b(d3.r.d(obtainStyledAttributes, xmlPullParser, "minimumVerticalAngle", 1, 0.0f));
        this.f93908a = b(d3.r.d(obtainStyledAttributes, xmlPullParser, "minimumHorizontalAngle", 0, 0.0f));
        this.f93910c = b(d3.r.d(obtainStyledAttributes, xmlPullParser, "maximumAngle", 2, 70.0f));
