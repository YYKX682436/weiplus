...
/* renamed from: androidx.transition.ChangeTransform */
/* loaded from: classes13.dex */
public class C1177xf3af557c extends p012xc85e97e9.p112x993b6d55.AbstractC1183x100d4975 {
    ...
    public C1177xf3af557c(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        this.L = true;
        this.M = true;
        this.N = new android.graphics.Matrix();
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, u4.u0.f506095f);
    ...
    public final void T(u4.m1 m1Var) {
        ...
        if (this.M) {
            ...
            u4.w1.f506105a.b((android.view.ViewGroup) view.getParent(), matrix2);
            matrix2.preTranslate(-r2.getScrollX(), -r2.getScrollY());
            hashMap.put("android:changeTransform:parentMatrix", matrix2);
            hashMap.put("android:changeTransform:intermediateMatrix", view.getTag(com.p314xaae8f345.mm.R.id.oj9));
            hashMap.put("android:changeTransform:intermediateParentMatrix", view.getTag(com.p314xaae8f345.mm.R.id.f567795kp3));
        }
    }
    ...
    public void j(u4.m1 m1Var) {
        ...
        ((android.view.ViewGroup) m1Var.f506048b.getParent()).startViewTransition(m1Var.f506048b);
    }
    ...
    */
    public android.animation.Animator n(android.view.ViewGroup r26, u4.m1 r27, u4.m1 r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p012xc85e97e9.p112x993b6d55.C1177xf3af557c.n(android.view.ViewGroup, u4.m1, u4.m1):android.animation.Animator");
    }
