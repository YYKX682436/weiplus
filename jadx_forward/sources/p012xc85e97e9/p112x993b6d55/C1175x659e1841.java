...
/* renamed from: androidx.transition.ChangeImageTransform */
/* loaded from: classes13.dex */
public class C1175x659e1841 extends p012xc85e97e9.p112x993b6d55.AbstractC1183x100d4975 {
    ...
    public C1175x659e1841(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final void T(u4.m1 m1Var) {
        ...
        if ((view instanceof android.widget.ImageView) && view.getVisibility() == 0) {
            ...
            int i17 = u4.n.f506050a[imageView.getScaleType().ordinal()];
            if (i17 == 1) {
    ...
    public android.animation.Animator n(android.view.ViewGroup viewGroup, u4.m1 m1Var, u4.m1 m1Var2) {
        ...
        android.widget.ImageView imageView = (android.widget.ImageView) m1Var2.f506048b;
        android.graphics.drawable.Drawable drawable = imageView.getDrawable();
        ...
        if (matrix == null) {
            matrix = u4.h0.f506021a;
        }
        if (matrix2 == null) {
            matrix2 = u4.h0.f506021a;
        }
