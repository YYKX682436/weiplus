...
public class k2 extends r3.f implements android.view.View.OnClickListener {
    ...
    public final p012xc85e97e9.p016x746ad0e3.p019xd1075a44.C0100x4c79dc8d f91161r;

    /* renamed from: s, reason: collision with root package name */
    public final android.app.SearchableInfo f91162s;

    /* renamed from: t, reason: collision with root package name */
    public final android.content.Context f91163t;

    /* renamed from: u, reason: collision with root package name */
    public final java.util.WeakHashMap f91164u;

    /* renamed from: v, reason: collision with root package name */
    public final int f91165v;

    /* renamed from: w, reason: collision with root package name */
    public int f91166w;

    /* renamed from: x, reason: collision with root package name */
    public android.content.res.ColorStateList f91167x;
    ...
    public k2(android.content.Context context, p012xc85e97e9.p016x746ad0e3.p019xd1075a44.C0100x4c79dc8d c0100x4c79dc8d, android.app.SearchableInfo searchableInfo, java.util.WeakHashMap weakHashMap) {
        super(context, c0100x4c79dc8d.m2746x1b688cca(), null, true);
        this.f91166w = 1;
        this.f91168y = -1;
        this.f91169z = -1;
        this.A = -1;
        ...
        this.C = -1;
        this.D = -1;
        this.f91161r = c0100x4c79dc8d;
        this.f91162s = searchableInfo;
        this.f91165v = c0100x4c79dc8d.m2745x4608f811();
        this.f91163t = context;
        this.f91164u = weakHashMap;
    }
    ...
    */
    public void a(android.view.View r21, android.content.Context r22, android.database.Cursor r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p012xc85e97e9.p016x746ad0e3.p019xd1075a44.k2.a(android.view.View, android.content.Context, android.database.Cursor):void");
    }
    ...
    public void c(android.database.Cursor cursor) {
        try {
            super.c(cursor);
            if (cursor != null) {
                this.f91168y = cursor.getColumnIndex("suggest_text_1");
                this.f91169z = cursor.getColumnIndex("suggest_text_2");
    ...
    public java.lang.CharSequence d(android.database.Cursor cursor) {
        ...
        android.app.SearchableInfo searchableInfo = this.f91162s;
    ...
    public android.view.View f(android.content.Context context, android.database.Cursor cursor, android.view.ViewGroup viewGroup) {
        android.view.View inflate = this.f450469q.inflate(this.f450467o, viewGroup, false);
        inflate.setTag(new p012xc85e97e9.p016x746ad0e3.p019xd1075a44.j2(inflate));
        ((android.widget.ImageView) inflate.findViewById(com.p314xaae8f345.mm.R.id.d6o)).setImageResource(this.f91165v);
        return inflate;
    }
    ...
    public android.graphics.drawable.Drawable g(android.net.Uri uri) {
        ...
        try {
            android.content.res.Resources resourcesForApplication = this.f450461g.getPackageManager().getResourcesForApplication(authority);
    ...
    public android.view.View getDropDownView(int i17, android.view.View view, android.view.ViewGroup viewGroup) {
        try {
            ...
            android.view.View inflate = this.f450469q.inflate(this.f450468p, viewGroup, false);
            if (inflate != null) {
                ((p012xc85e97e9.p016x746ad0e3.p019xd1075a44.j2) inflate.getTag()).f91150a.setText(e17.toString());
            }
            return inflate;
        }
    }
    ...
    public android.view.View getView(int i17, android.view.View view, android.view.ViewGroup viewGroup) {
        try {
            ...
            android.view.View f17 = f(this.f450461g, this.f450460f, viewGroup);
            ((p012xc85e97e9.p016x746ad0e3.p019xd1075a44.j2) f17.getTag()).f91150a.setText(e17.toString());
            return f17;
        }
    }
    ...
    */
    public final android.graphics.drawable.Drawable h(java.lang.String r9) {
        /*
            r8 = this;
            java.util.WeakHashMap r0 = r8.f91164u
            android.content.Context r1 = r8.f91163t
        ...
        L43:
            ...
            return r5
        L46:
            android.graphics.drawable.Drawable r4 = b3.l.m9707x4a96be14(r1, r4)     // Catch: android.content.res.Resources.NotFoundException -> L54 java.lang.NumberFormatException -> L55
            if (r4 == 0) goto L53
        ...
        Ld4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p012xc85e97e9.p016x746ad0e3.p019xd1075a44.k2.h(java.lang.String):android.graphics.drawable.Drawable");
    }
    ...
    public android.database.Cursor j(android.app.SearchableInfo searchableInfo, java.lang.String str, int i17) {
        ...
        return this.f450461g.getContentResolver().query(fragment.build(), null, suggestSelection, strArr2, null);
    }

    @Override // android.widget.BaseAdapter
    public void notifyDataSetChanged() {
        super.notifyDataSetChanged();
        android.database.Cursor cursor = this.f450460f;
    ...
    public void onClick(android.view.View view) {
        ...
        if (tag instanceof java.lang.CharSequence) {
            this.f91161r.q((java.lang.CharSequence) tag);
        }
    }
}
