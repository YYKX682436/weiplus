...
public class n0 implements android.widget.ListAdapter, android.widget.SpinnerAdapter {
    ...
    public final android.widget.SpinnerAdapter f91189d;

    /* renamed from: e, reason: collision with root package name */
    public final android.widget.ListAdapter f91190e;

    public n0(android.widget.SpinnerAdapter spinnerAdapter, android.content.res.Resources.Theme theme) {
        this.f91189d = spinnerAdapter;
        if (spinnerAdapter instanceof android.widget.ListAdapter) {
            this.f91190e = (android.widget.ListAdapter) spinnerAdapter;
        }
    ...
    public boolean areAllItemsEnabled() {
        android.widget.ListAdapter listAdapter = this.f91190e;
        if (listAdapter != null) {
    ...
    public int getCount() {
        android.widget.SpinnerAdapter spinnerAdapter = this.f91189d;
