...
public class v implements d55.x {
    ...
    public final java.io.File f308150a;

    /* renamed from: b, reason: collision with root package name */
    public final android.os.Bundle f308151b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicBoolean f308152c;
    ...
    public v(android.content.Context context, java.lang.String str) {
        ...
        this.f308151b = new android.os.Bundle();
        this.f308152c = new java.util.concurrent.atomic.AtomicBoolean();
        this.f308150a = new java.io.File(file, "fast_persist_data");
    }

    @Override // d55.x
    public d55.x a() {
        try {
            d55.m0.a(this.f308150a);
        } catch (java.lang.Throwable th6) {
            d55.q0.a("MicroMsg.recovery.fastPersist", "create persist dir fail", th6);
        }
        this.f308152c.set(true);
        return this;
    }

    public final void b() {
        if (!this.f308152c.get()) {
    ...
    public final android.util.Pair f(java.lang.String str) {
        ...
        try {
            fileArr = this.f308150a.listFiles();
            if (fileArr == null) {
    ...
    public d55.v g() {
        b();
        android.os.Bundle bundle = this.f308151b;
        for (java.lang.String str : bundle.keySet()) {
            ...
            if (obj != null) {
                ...
                try {
                    d55.m0.b(new java.io.File(this.f308150a, ".FP__KEY__" + str + "__VALUE__" + obj));
                } catch (java.lang.Throwable th6) {
    ...
    public d55.x mo123528x1c849219(java.lang.String str, boolean z17) {
        this.f308151b.putBoolean(str, z17);
        return this;
    }
    ...
    public d55.x mo123529xc5c55e60(java.lang.String str, int i17) {
        this.f308151b.putLong(str, i17);
        return this;
    }

    @Override // d55.x
    /* renamed from: putLong */
    public d55.x mo123530xf2e7ce2b(java.lang.String str, long j17) {
        this.f308151b.putLong(str, j17);
        return this;
    }
    ...
    public d55.x mo123531xe4673800(java.lang.String str, java.lang.String str2) {
        this.f308151b.putString(str, str2);
        return this;
    }
}
