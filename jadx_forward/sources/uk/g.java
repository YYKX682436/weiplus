...
public abstract class g {
    ...
    public static final byte[] f510031a = {77, 105, 99, 114, 111, 77, 115, 103};

    /* renamed from: b, reason: collision with root package name */
    public static final byte[] f510032b = {66, 83, 68, 73, 70, 70, 52, 48};
    ...
    public static int a(java.io.RandomAccessFile randomAccessFile, int i17, byte[] bArr, int i18, java.io.File file, int i19) {
        ...
        if (java.util.Arrays.equals(f510031a, bArr2)) {
            z17 = false;
        } else {
            if (!java.util.Arrays.equals(f510032b, bArr2)) {
