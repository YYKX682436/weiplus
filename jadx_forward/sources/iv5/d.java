...
public class d extends iv5.j {
    ...
    public final av5.n0 f376678d;

    /* renamed from: e, reason: collision with root package name */
    public final av5.u f376679e;
    ...
    public d(jv5.a aVar, av5.y yVar, av5.y yVar2, kv5.i iVar) {
        ...
        this.f376679e = null;
        if (yVar2 != null) {
            av5.n0 n0Var = yVar2.f95995a.f95976t;
            this.f376678d = n0Var;
            this.f376679e = yVar2.d(n0Var);
        }
    }
    ...
    public java.lang.Comparable a(kv5.f fVar, java.lang.Comparable comparable) {
        ...
        fVar.getClass();
        int a17 = fVar.a(dVar.f95891e);
        int[][] iArr = dVar.f95892f;
        ...
        for (int i19 = 0; i19 < iArr6.length; i19++) {
            ...
            fv5.b bVar = iVar.f394303k;
            int d17 = bVar.d(i27);
            if (d17 >= 0) {
                i27 = bVar.f348555e[d17];
            } else if (i27 >= 0 && iVar.A.a(i27)) {
                i27 = -1;
            }
            iArr7[1] = i27;
        }
        return new av5.d(dVar.f95950d, a17, iArr2, iArr4, iArr6);
    }

    @Override // iv5.j
    public av5.n0 c(av5.y yVar) {
        return yVar.f95995a.f95976t;
    }
    ...
    public int i(java.lang.Comparable comparable) {
        av5.d dVar = (av5.d) comparable;
        this.f376678d.f95953f++;
        av5.u uVar = this.f376679e;
        uVar.A(uVar.f95990f.f95995a.f95976t, true);
        int position = uVar.f106295a.position();
        uVar.w(dVar.f95891e);
        int[][] iArr = dVar.f95892f;
        uVar.w(iArr.length);
        int[][] iArr2 = dVar.f95893g;
        uVar.w(iArr2.length);
        int[][] iArr3 = dVar.f95894h;
        uVar.w(iArr3.length);
        for (int[] iArr4 : iArr) {
            uVar.w(iArr4[0]);
            uVar.w(iArr4[1]);
