...
public abstract class e implements ry2.n {
    ...
    public final android.content.Context f482907d;

    /* renamed from: e, reason: collision with root package name */
    public android.os.Bundle f482908e;

    /* renamed from: f, reason: collision with root package name */
    public r45.zi2 f482909f;
    ...
    public final jz5.g f482912i;

    /* renamed from: m, reason: collision with root package name */
    public final java.util.ArrayList f482913m;

    /* renamed from: n, reason: collision with root package name */
    public boolean f482914n;

    /* renamed from: o, reason: collision with root package name */
    public boolean f482915o;

    public e(android.content.Context activity) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(activity, "activity");
        this.f482907d = activity;
        this.f482912i = jz5.h.b(new ry2.d(activity));
        this.f482913m = new java.util.ArrayList();
    }
    ...
    public final ry2.o h() {
        return (ry2.o) ((jz5.n) this.f482912i).mo141623x754a37bb();
    }
    ...
    public void j(r45.mb4 mediaObj) {
        ...
        java.lang.Object c1Var = mediaObj.m75939xb282bd08(2) == 4 ? com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(mediaObj.m75945x2fec8307(16)) ? new mn2.c1(mediaObj, com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.y90.f209889f, null, null, 12, null) : new mn2.r3(mediaObj, com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.y90.f209888e, null, 4, null) : new mn2.c1(mediaObj, com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.y90.f209889f, null, null, 12, null);
        mn2.g1 g1Var = mn2.g1.f411508a;
        wo0.c a17 = g1Var.e().a(c1Var);
        a17.g(g1Var.h(mn2.f1.f411486d));
        a17.f529406d = new ry2.b(this);
        a17.a();
    }

    public void k() {
        uv2.l lVar = uv2.l.f512933a;
        if (lVar.b() || lVar.a()) {
            java.util.ArrayList arrayList = this.f482913m;
            if (!arrayList.isEmpty()) {
                if (lVar.b() || lVar.a()) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("LogPost.FinderPostSpeedUpManager", "[cancelSpeedUp]");
                    uv2.e.f512909a.c(arrayList);
                    uv2.i.f512922a.e(arrayList, true);
                }
                arrayList.clear();
            }
        }
    ...
    */
    public final void l() {
        ...
        L14:
            if (r1 == 0) goto Le4
            java.util.ArrayList r5 = r11.f482913m
            ...
            android.content.Context r4 = r11.f482907d
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(r4, r1)
            pf5.z r1 = pf5.z.f435481a
            boolean r6 = r4 instanceof p012xc85e97e9.p016x746ad0e3.app.ActivityC0065xcd7aa112
            if (r6 == 0) goto Ld8
            ...
            sr2.w5 r1 = (sr2.w5) r1
            java.lang.String r1 = r1.f493317m
            uv2.i r4 = uv2.i.f512922a
            r45.zi2 r4 = r11.f482909f
            r10 = 0
            if (r4 == 0) goto L56
            r6 = 5
