...
public class z implements c01.yc {
    ...
    public void O0(com.p314xaae8f345.mm.p944x882e457a.p0 p0Var) {
        ...
        if (g17 == null || g17.length() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SubCoreCard.notifyShareCardListener", "onReceiveMsg, msgContent is null");
        } else {
            xt1.t0.fj().f538120y.mo50293x3498a0(new yt1.y(this, g17, p0Var));
        }
    }
