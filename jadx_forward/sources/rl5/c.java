...
public class c implements android.view.View.OnLongClickListener {
    ...
    public final /* synthetic */ android.view.View.OnCreateContextMenuListener f478841d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ rl5.r f478842e;

    public c(rl5.r rVar, android.view.View.OnCreateContextMenuListener onCreateContextMenuListener) {
        this.f478842e = rVar;
        this.f478841d = onCreateContextMenuListener;
    }
    ...
    public boolean onLongClick(android.view.View view) {
        ...
        rl5.r rVar = this.f478842e;
        rVar.f478889z.clear();
        rVar.f478871f = view;
        this.f478841d.onCreateContextMenu(rVar.f478889z, view, null);
