...
public final class b implements l45.m {
    ...
    public final /* synthetic */ qj3.g f445404a;
    ...
    public boolean a(xk0.p item) {
        ...
        this.f445404a.f445410e.w(ju3.c0.P, bundle);
        return true;
    }
    ...
    public void c(java.lang.Boolean bool) {
        ...
        qj3.g gVar = this.f445404a;
        if (booleanValue) {
            ju3.d0.k(gVar.f445410e, ju3.c0.V, null, 2, null);
        } else {
            ju3.d0.k(gVar.f445410e, ju3.c0.W, null, 2, null);
        }
    }
}
