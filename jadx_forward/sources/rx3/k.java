...
public final class k {
    ...
    public final rx3.s a(int i17, java.lang.Object obj) {
        ...
        if (obj == null) {
            return (rx3.s) ((java.util.LinkedHashMap) rx3.s.f482586c).get(java.lang.Integer.valueOf(i17));
        }
        java.util.Map map = rx3.s.f482587d;
        ...
        set.add(obj);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.RingtoneDataLoader", "obtain type:" + i17 + ", holder:" + obj + ", refCount:" + set.size());
        java.util.Map map2 = rx3.s.f482586c;
