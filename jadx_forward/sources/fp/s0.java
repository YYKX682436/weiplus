...
public abstract class s0 {
    ...
    public static final java.util.BitSet f346770a = new java.util.BitSet(256);

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.String f346771b;
    ...
    static {
        ...
        java.util.BitSet bitSet = f346770a;
        bitSet.set(45);
        bitSet.set(95);
        bitSet.set(46);
        bitSet.set(42);
        f346771b = (java.lang.String) java.security.AccessController.doPrivileged(new fp.u("file.encoding"));
    }

    public static java.lang.String a(java.lang.String str) {
        try {
            return b(str, f346771b);
