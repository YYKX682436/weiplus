...
public final class f extends ek3.b implements db5.d {
    ...
    public int f354029a = -1;

    /* renamed from: b, reason: collision with root package name */
    public int f354030b = -1;

    /* renamed from: c, reason: collision with root package name */
    public android.graphics.Rect f354031c;

    /* renamed from: d, reason: collision with root package name */
    public boolean f354032d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ gk3.m f354033e;
    ...
    public void c(android.view.View view, int i17) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MultiTaskSwipeBackAndEnterAnimWrapperSS", "onViewCaptured");
        this.f354033e.b(3, false);
        this.f354029a = -1;
        this.f354030b = -1;
        this.f354032d = false;
    }
    ...
    public void f(android.view.View view, float f17, float f18, float f19, float f27) {
        ...
        if (java.lang.Math.abs(f17) > 400 && i(0.0f)) {
            this.f354032d = true;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MultiTaskSwipeBackAndEnterAnimWrapperSS", "onViewReleased, auto add multitask!");
            return;
        }
        gk3.m mVar = this.f354033e;
        com.p314xaae8f345.mm.sdk.p2603x2137b148.u3.h(new gk3.d(mVar));
        mVar.f354064g = -1L;
        ...
        yj0.a.d(mo2159xc2a54588, arrayList.toArray(), "com/tencent/mm/plugin/multitask/animation/swipeback/singlescene/MultiTaskSwipeBackAnimWrapperSS$ViewDragCallback", "onViewReleased", "(Landroid/view/View;FFFF)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
        mo2159xc2a54588.setVisibility(((java.lang.Integer) arrayList.get(0)).intValue());
        yj0.a.f(mo2159xc2a54588, "com/tencent/mm/plugin/multitask/animation/swipeback/singlescene/MultiTaskSwipeBackAnimWrapperSS$ViewDragCallback", "onViewReleased", "(Landroid/view/View;FFFF)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
    }
    ...
    public void g(float f17, float f18, int i17, int i18, int i19, int i27) {
        ...
        if (eVar != null) {
            ...
            if (this.f354031c == null) {
                this.f354031c = al3.a.c(mVar.f354061d);
            }
            if (this.f354029a == -1 && this.f354030b == -1) {
                ek3.e eVar4 = mVar.f354061d;
                this.f354029a = eVar4 != null ? (int) eVar4.getTranslationX() : 0;
                ek3.e eVar5 = mVar.f354061d;
                this.f354030b = eVar5 != null ? (int) eVar5.getTranslationY() : 0;
            }
            float f19 = width;
            float f27 = (f17 / f19) / 3;
            ...
            float f47 = width3;
            android.graphics.Rect rect2 = this.f354031c;
            float width4 = f47 - ((rect2 != null ? rect2.left : 0) + ((rect2 != null ? rect2.width() : 0) / 2));
            float f48 = height2;
            android.graphics.Rect rect3 = this.f354031c;
            float height3 = f48 - ((rect3 != null ? rect3.top : 0) + ((rect3 != null ? rect3.height() : 0) / 2));
            float f49 = this.f354029a + (width4 * width2 * f39);
            float f57 = this.f354030b + (height3 * width2 * f39);
            if (f39 >= 0.16f && !this.f354032d) {
                this.f354032d = true;
                if (i(f39)) {
                    return;
                }
                com.p314xaae8f345.mm.sdk.p2603x2137b148.u3.h(new gk3.e(mVar));
                return;
            }
            float f58 = height;
    ...
    public boolean h(android.view.View view, int i17) {
        ek3.d dVar = this.f354033e.f354060c;
        if (dVar == null) {
            return false;
        }
    ...
    public final boolean i(float f17) {
        ...
        oa5.b.b(eVar).k(new gk3.a(f17, width, height, width2, rect3, eVar, rect3.left + (rect3.width() / 2), rect3.top + (rect3.height() / 2))).o(new gk3.c(mVar, m127794x8c4fcf52)).e(width2).f(width2).m((r9 - (rect2.left + (rect2.width() / 2))) * width2).n((r10 - (rect2.top + (rect2.height() / 2))) * width2).h(new android.view.animation.AccelerateInterpolator()).g(250L).l();
        return true;
    }
