...
public abstract class l4 {
    ...
    public static final boolean e(int[] iArr, int i17) {
        return (iArr[(i17 * 5) + 1] & com.p314xaae8f345.p3121x37984a.p3126x6aa9117b.C26948xabb259c7.f58223x264a8965) != 0;
    }
    ...
    public static final int n(java.util.ArrayList arrayList, int i17, int i18) {
        ...
        while (i19 <= size) {
            int i27 = (i19 + size) >>> 1;
            int i28 = ((n0.d) arrayList.get(i27)).f415010a;
            if (i28 < 0) {
                i28 += i18;
            }
            int i29 = p3321xbce91901.jvm.p3324x21ffc6bd.o.i(i28, i17);
            if (i29 < 0) {
                i19 = i27 + 1;
            } else {
                if (i29 <= 0) {
