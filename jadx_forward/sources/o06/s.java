...
public abstract class s {
    ...
    public static final o06.g b(o06.v0 v0Var, n16.c fqName, w06.a lookupLocation) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(lookupLocation, "lookupLocation");
        if (fqName.d()) {
            return null;
        }
        n16.c e17 = fqName.e();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(e17, "parent(...)");
        y16.s sVar = ((r06.o0) v0Var.Q(e17)).f450032m;
        n16.g f17 = fqName.f();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(f17, "shortName(...)");
        ...
        n16.c e19 = fqName.e();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(e19, "parent(...)");
        o06.g b17 = b(v0Var, e19, lookupLocation);
        if (b17 == null || (z17 = b17.z()) == null) {
            jVar = null;
        } else {
            n16.g f18 = fqName.f();
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(f18, "shortName(...)");
