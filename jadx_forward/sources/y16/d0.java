...
public final class d0 {
    ...
    public final y16.s a(java.lang.String message, java.util.Collection types) {
        ...
        int size = b17.size();
        y16.s cVar = size != 0 ? size != 1 ? new y16.c(message, (y16.s[]) b17.toArray(new y16.s[0]), null) : (y16.s) b17.get(0) : y16.r.f540506b;
        return b17.f424142d <= 1 ? cVar : new y16.h0(message, cVar, null);
    }
}
