...
public final class d extends android.text.SpannableStringBuilder {
    ...
    public final java.lang.Class f400119d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.List f400120e;

    public d(java.lang.Class cls, java.lang.CharSequence charSequence) {
        super(charSequence);
        this.f400120e = new java.util.ArrayList();
    ...
    public final void a() {
        int i17 = 0;
        while (true) {
            java.util.List list = this.f400120e;
            if (i17 >= ((java.util.ArrayList) list).size()) {
                return;
            }
            ((lg5.c) ((java.util.ArrayList) list).get(i17)).f400118e.incrementAndGet();
            i17++;
        }
    }
    ...
    public final boolean c(java.lang.Object obj) {
        if (obj != null) {
            return this.f400119d == obj.getClass();
        }
        return false;
    }
    ...
    public final void d() {
        ...
        while (true) {
            ...
            ((lg5.c) ((java.util.ArrayList) list).get(i17)).f400118e.decrementAndGet();
            i17++;
        }
    }
    ...
    public java.lang.Object[] getSpans(int i17, int i18, java.lang.Class cls) {
        ...
        for (int i19 = 0; i19 < cVarArr.length; i19++) {
            objArr[i19] = cVarArr[i19].f400117d;
        }
        return objArr;
    }
    ...
    public void removeSpan(java.lang.Object obj) {
        ...
        if (cVar != null) {
            ((java.util.ArrayList) this.f400120e).remove(cVar);
        }
    }
    ...
    public void setSpan(java.lang.Object obj, int i17, int i18, int i19) {
        if (c(obj)) {
            ...
            ((java.util.ArrayList) this.f400120e).add(cVar);
            obj = cVar;
        }
    ...
    public java.lang.CharSequence subSequence(int i17, int i18) {
        return new lg5.d(this.f400119d, this, i17, i18);
    }
