...
public final class s extends android.os.AsyncTask {
    ...
    public final /* synthetic */ p012xc85e97e9.p075x2eaf9f.app.AbstractServiceC1084x6c6d53dc f551052a;

    public s(p012xc85e97e9.p075x2eaf9f.app.AbstractServiceC1084x6c6d53dc abstractServiceC1084x6c6d53dc) {
        this.f551052a = abstractServiceC1084x6c6d53dc;
    }
    ...
    */
    public java.lang.Object doInBackground(java.lang.Object[] r5) {
        ...
        L2:
            androidx.core.app.JobIntentService r5 = r4.f551052a
            z2.t r0 = r5.f92557d
            r1 = 0
            if (r0 == 0) goto L31
            z2.y r0 = (z2.y) r0
            java.lang.Object r2 = r0.f551068b
            monitor-enter(r2)
            android.app.job.JobParameters r5 = r0.f551069c     // Catch: java.lang.Throwable -> L2e
            if (r5 != 0) goto L14
        ...
        L14:
            ...
            androidx.core.app.JobIntentService r3 = r0.f551067a
        ...
        L2e:
            ...
            throw r5
        L31:
            java.util.ArrayList r0 = r5.f92561h
            monitor-enter(r0)
            java.util.ArrayList r2 = r5.f92561h     // Catch: java.lang.Throwable -> L5a
            int r2 = r2.size()     // Catch: java.lang.Throwable -> L5a
            if (r2 <= 0) goto L48
            java.util.ArrayList r5 = r5.f92561h     // Catch: java.lang.Throwable -> L5a
            r2 = 0
        ...
        L4a:
            if (r2 == 0) goto L59
            androidx.core.app.JobIntentService r5 = r4.f551052a
            android.content.Intent r0 = r2.mo178325x1e885992()
            r5.b(r0)
            r2.mo178324xdc453139()
            goto L2
        L59:
            return r1
        L5a:
