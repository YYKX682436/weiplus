...
public class a2 extends u13.f {
    ...
    public final /* synthetic */ e23.c2 f328309b;
    ...
    public void b(android.content.Context context, u13.e eVar, u13.g gVar, java.lang.Object... objArr) {
        ...
        e23.c2 c2Var = this.f328309b;
        if (c2Var.f328332r) {
            b2Var.f328324a.setOnClickListener(new e23.y1(this, context));
        } else {
            b2Var.f328324a.setVisibility(8);
        }
        android.widget.LinearLayout linearLayout2 = new android.widget.LinearLayout(context);
        for (int i17 = 0; i17 < c2Var.f328331q.size(); i17++) {
            r45.vx5 vx5Var = (r45.vx5) c2Var.f328331q.get(i17);
            if (i17 % 2 != 0) {
                linearLayout = (android.widget.LinearLayout) linearLayout2.findViewById(com.p314xaae8f345.mm.R.id.q9h);
                ...
                ((android.widget.TextView) linearLayout2.findViewById(com.p314xaae8f345.mm.R.id.q9j)).setText(vx5Var.f470179d);
            } else {
                linearLayout2 = (android.widget.LinearLayout) android.view.LayoutInflater.from(context).inflate(com.p314xaae8f345.mm.R.C30864xbddafb2a.dfb, (android.view.ViewGroup) null);
                ...
                android.widget.LinearLayout linearLayout3 = (android.widget.LinearLayout) linearLayout2.findViewById(com.p314xaae8f345.mm.R.id.q9g);
                ...
                ((android.widget.TextView) linearLayout2.findViewById(com.p314xaae8f345.mm.R.id.q9i)).setText(vx5Var.f470179d);
                android.widget.LinearLayout.LayoutParams layoutParams = new android.widget.LinearLayout.LayoutParams(-1, -2);
                layoutParams.setMargins(0, i65.a.b(context, 8), 0, 0);
                linearLayout2.setLayoutParams(layoutParams);
                android.view.View findViewById = linearLayout2.findViewById(com.p314xaae8f345.mm.R.id.q9h);
                ...
                b2Var.f328325b.addView(linearLayout2);
                linearLayout = linearLayout3;
            }
            linearLayout.setOnClickListener(new e23.z1(this, linearLayout, context));
        }
        b2Var.f328325b.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-1, -2));
    }

    @Override // u13.f
    public android.view.View c(android.content.Context context, android.view.ViewGroup viewGroup, android.view.View view) {
        android.view.View inflate = android.view.LayoutInflater.from(context).inflate(com.p314xaae8f345.mm.R.C30864xbddafb2a.dfc, viewGroup, false);
        android.widget.LinearLayout linearLayout = (android.widget.LinearLayout) inflate.findViewById(com.p314xaae8f345.mm.R.id.q9e);
        android.widget.LinearLayout linearLayout2 = (android.widget.LinearLayout) inflate.findViewById(com.p314xaae8f345.mm.R.id.q9f);
        ...
        e23.b2 b2Var = this.f328309b.f328334t;
        b2Var.f328324a = (android.widget.LinearLayout) inflate.findViewById(com.p314xaae8f345.mm.R.id.q9e);
        b2Var.f328325b = (android.widget.LinearLayout) inflate.findViewById(com.p314xaae8f345.mm.R.id.q__);
