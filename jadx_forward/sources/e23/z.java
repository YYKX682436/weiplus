...
public class z extends u13.f {
    ...
    public final /* synthetic */ e23.a0 f328536b;
    ...
    public void b(android.content.Context context, u13.e eVar, u13.g gVar, java.lang.Object... objArr) {
        ...
        android.view.View view = yVar.f328527a;
        e23.a0 a0Var = this.f328536b;
        com.p314xaae8f345.mm.p1006xc5476f33.fts.ui.n3.i(view, a0Var.f505294d);
        yVar.f328528b.setText(((e23.a0) gVar).f328306s);
        yVar.f328529c.setImageResource(com.p314xaae8f345.mm.R.raw.f79418xd9fe6b16);
        if (a0Var.f505292b == 0 || !a0Var.f328304q) {
            android.view.View view2 = yVar.f328530d;
        ...
        android.view.View view3 = yVar.f328530d;
    ...
    public android.view.View c(android.content.Context context, android.view.ViewGroup viewGroup, android.view.View view) {
        android.view.View inflate = android.view.LayoutInflater.from(context).inflate(com.p314xaae8f345.mm.R.C30864xbddafb2a.f570649bc1, viewGroup, false);
        e23.y yVar = new e23.y(this.f328536b);
        yVar.f328528b = (android.widget.TextView) inflate.findViewById(com.p314xaae8f345.mm.R.id.o_q);
        yVar.f328529c = (android.widget.ImageView) inflate.findViewById(com.p314xaae8f345.mm.R.id.h6y);
        yVar.f328530d = inflate.findViewById(com.p314xaae8f345.mm.R.id.knz);
        yVar.f328527a = inflate.findViewById(com.p314xaae8f345.mm.R.id.mem);
        inflate.setTag(yVar);
        return inflate;
    }
    ...
    public boolean d(android.content.Context context, android.view.View view, u13.g gVar, java.lang.Object... objArr) {
        ...
        e23.a0 a0Var = this.f328536b;
        intent.putExtra("key_talker_query", a0Var.f505295e.f432665d[0]);
        intent.putExtra("key_query", a0Var.f505295e.f432665d[1]);
        intent.putExtra("Search_Scene", a0Var.f505298h);
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(a0Var.f328305r)) {
            o13.n.q(context, ".ui.FTSTalkerMessageUI", intent);
        } else {
            intent.putExtra("key_conv", a0Var.f328305r);
