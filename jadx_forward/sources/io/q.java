...
public final class q implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ jd5.a f374956d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f374957e;

    public q(jd5.a aVar, android.content.Context context) {
        this.f374956d = aVar;
        this.f374957e = context;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        jd5.a aVar = this.f374956d;
        long m75942xfb822ef2 = aVar.m75942xfb822ef2(aVar.f125235d + 0);
        android.content.Context context = this.f374957e;
        if (m75942xfb822ef2 > 0) {
            intent.setClassName(context, "com.tencent.mm.ui.chatting.gallery.ImageGalleryUI");
            intent.putExtra("img_gallery_msg_id", aVar.m75942xfb822ef2(aVar.f125235d + 0));
            intent.putExtra("img_gallery_talker", aVar.m75945x2fec8307(aVar.f125235d + 1));
            intent.putExtra("img_gallery_chatroom_name", aVar.m75945x2fec8307(aVar.f125235d + 1));
            intent.putExtra("img_preview_only", true);
            android.content.Context context2 = this.f374957e;
            ...
            android.content.Context context3 = this.f374957e;
