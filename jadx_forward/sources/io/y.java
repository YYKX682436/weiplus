...
public final class y implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ jd5.c f374974d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f374975e;

    public y(jd5.c cVar, android.content.Context context) {
        this.f374974d = cVar;
        this.f374975e = context;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        jd5.c cVar = this.f374974d;
        long m75942xfb822ef2 = cVar.m75942xfb822ef2(cVar.f125235d + 0);
        android.content.Context context = this.f374975e;
        if (m75942xfb822ef2 > 0) {
            intent.setClassName(context, "com.tencent.mm.ui.chatting.gallery.ImageGalleryUI");
            intent.putExtra("img_gallery_msg_id", cVar.m75942xfb822ef2(cVar.f125235d + 0));
            intent.putExtra("img_gallery_talker", cVar.m75945x2fec8307(cVar.f125235d + 1));
            intent.putExtra("img_gallery_chatroom_name", cVar.m75945x2fec8307(cVar.f125235d + 1));
            ...
            intent.putExtra("KEY_THUMB_PATH", cVar.m140766x4eae2065());
            intent.putExtra("KEY_VIDEO_DURATION", cVar.m140767x36bbd779());
        }
        android.content.Context context2 = this.f374975e;
