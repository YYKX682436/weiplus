...
public final class d implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.view.View f323165d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ dm1.m f323166e;
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator animator) {
        ...
        android.view.View view = this.f323165d;
        ...
        if (layoutParams2 != null) {
            ...
            android.view.ViewManager viewManager = this.f323166e.f323180b;
            if (viewManager != null) {
