...
public final class c extends android.graphics.drawable.Drawable {
    ...
    public final android.graphics.Paint f101146a;

    /* renamed from: b, reason: collision with root package name */
    public final android.graphics.Rect f101147b;
    ...
    public c(int i17) {
        ...
        this.f101146a = paint;
        this.f101147b = new android.graphics.Rect();
    }
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        android.graphics.Rect rect = this.f101147b;
        ...
        float f18 = f17 / 2.0f;
        android.graphics.Paint paint = this.f101146a;
