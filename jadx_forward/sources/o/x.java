...
public class x extends o.f implements android.view.MenuItem.OnActionExpandListener {
    ...
    public final /* synthetic */ o.z f423360e;
    ...
    public boolean onMenuItemActionCollapse(android.view.MenuItem menuItem) {
        return ((android.view.MenuItem.OnActionExpandListener) this.f423247d).onMenuItemActionCollapse(this.f423360e.c(menuItem));
    }

    @Override // android.view.MenuItem.OnActionExpandListener
    public boolean onMenuItemActionExpand(android.view.MenuItem menuItem) {
        return ((android.view.MenuItem.OnActionExpandListener) this.f423247d).onMenuItemActionExpand(this.f423360e.c(menuItem));
    }
}
