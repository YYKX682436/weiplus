...
public class j0 extends o.e implements android.view.Menu {
    ...
    public android.view.MenuItem add(java.lang.CharSequence charSequence) {
        return c(((o.r) ((g3.a) this.f423247d)).a(0, 0, 0, charSequence));
    }
    ...
    public int addIntentOptions(int i17, int i18, int i19, android.content.ComponentName componentName, android.content.Intent[] intentArr, android.content.Intent intent, int i27, android.view.MenuItem[] menuItemArr) {
        ...
        int addIntentOptions = ((o.r) ((g3.a) this.f423247d)).addIntentOptions(i17, i18, i19, componentName, intentArr, intent, i27, menuItemArr2);
    ...
    public android.view.SubMenu addSubMenu(java.lang.CharSequence charSequence) {
        return ((o.r) ((g3.a) this.f423247d)).addSubMenu(0, 0, 0, charSequence);
    }

    @Override // android.view.Menu
    public void clear() {
        java.lang.Object obj = this.f423234f;
        if (obj != null) {
            ((x.n) obj).clear();
        }
        ((o.r) ((g3.a) this.f423247d)).clear();
    }

    @Override // android.view.Menu
    public void close() {
        ((o.r) ((g3.a) this.f423247d)).c(true);
    }

    @Override // android.view.Menu
    public android.view.MenuItem findItem(int i17) {
        return c(((o.r) ((g3.a) this.f423247d)).findItem(i17));
    }

    @Override // android.view.Menu
    public android.view.MenuItem getItem(int i17) {
        return c(((o.r) ((g3.a) this.f423247d)).getItem(i17));
    }

    @Override // android.view.Menu
    public boolean hasVisibleItems() {
        return ((o.r) ((g3.a) this.f423247d)).hasVisibleItems();
    }

    @Override // android.view.Menu
    public boolean isShortcutKey(int i17, android.view.KeyEvent keyEvent) {
        return ((o.r) ((g3.a) this.f423247d)).isShortcutKey(i17, keyEvent);
    }

    @Override // android.view.Menu
    public boolean performIdentifierAction(int i17, int i18) {
        return ((o.r) ((g3.a) this.f423247d)).performIdentifierAction(i17, i18);
    }

    @Override // android.view.Menu
    public boolean performShortcut(int i17, android.view.KeyEvent keyEvent, int i18) {
        return ((o.r) ((g3.a) this.f423247d)).performShortcut(i17, keyEvent, i18);
    }

    @Override // android.view.Menu
    public void removeGroup(int i17) {
        java.util.Map map = this.f423234f;
        if (map != null) {
        ...
        ((o.r) ((g3.a) this.f423247d)).removeGroup(i17);
    }
