...
public final class f extends q0.c {
    ...
    public final java.lang.Object[] f440754e;

    /* renamed from: f, reason: collision with root package name */
    public final java.lang.Object[] f440755f;

    /* renamed from: g, reason: collision with root package name */
    public final int f440756g;

    /* renamed from: h, reason: collision with root package name */
    public final int f440757h;
    ...
    public p0.e add(int i17, java.lang.Object obj) {
        ...
        int n17 = n();
        if (i17 >= n17) {
            return g(this.f440754e, i17 - n17, obj);
        }
        q0.e eVar = new q0.e(null);
        return g(e(this.f440754e, this.f440757h, i17, obj, eVar), 0, eVar.f440753a);
    }

    @Override // kz5.b
    public int d() {
        return this.f440756g;
    }
    ...
    public final java.lang.Object[] e(java.lang.Object[] objArr, int i17, int i18, java.lang.Object obj, q0.e eVar) {
        ...
        while (true) {
            ...
            copyOf2[i19] = e((java.lang.Object[]) obj3, i27, 0, eVar.f440753a, eVar);
        }
        return copyOf2;
    }
    ...
    public final q0.f g(java.lang.Object[] objArr, int i17, java.lang.Object obj) {
        int n17 = n();
        int i18 = this.f440756g;
        int i19 = i18 - n17;
        java.lang.Object[] objArr2 = this.f440755f;
        java.lang.Object[] copyOf = java.util.Arrays.copyOf(objArr2, 32);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(copyOf, "copyOf(this, newSize)");
        if (i19 < 32) {
            kz5.v.k(objArr2, copyOf, i17 + 1, i17, i19);
            copyOf[i17] = obj;
            return new q0.f(objArr, copyOf, i18 + 1, this.f440757h);
        }
    ...
    public java.lang.Object get(int i17) {
        ...
        t0.c.a(i17, d());
        if (n() <= i17) {
            objArr = this.f440755f;
        } else {
            objArr = this.f440754e;
            for (int i18 = this.f440757h; i18 > 0; i18 -= 5) {
    ...
    public p0.e i(yz5.l predicate) {
        ...
        q0.h hVar = new q0.h(this, this.f440754e, this.f440755f, this.f440757h);
        hVar.L(predicate);
        return hVar.g();
    }

    public final q0.f j(java.lang.Object[] objArr, java.lang.Object[] objArr2, java.lang.Object[] objArr3) {
        int i17 = this.f440756g;
        int i18 = i17 >> 5;
        int i19 = this.f440757h;
        if (i18 <= (1 << i19)) {
    ...
    public final java.lang.Object[] k(java.lang.Object[] objArr, int i17, java.lang.Object[] objArr2) {
        ...
        if (objArr != null) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(objArr3, "copyOf(this, newSize)");
        } else {
    ...
    public java.util.ListIterator listIterator(int i17) {
        t0.c.b(i17, d());
        return new q0.i(this.f440754e, this.f440755f, i17, d(), (this.f440757h / 5) + 1);
    }
    ...
    public final p0.e m(java.lang.Object[] objArr, int i17, int i18, int i19) {
        ...
        if (i18 == 0) {
            if (objArr.length == 33) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(objArr, "copyOf(this, newSize)");
            }
    ...
    public p0.e set(int i17, java.lang.Object obj) {
        t0.c.a(i17, d());
        int n17 = n();
        java.lang.Object[] objArr = this.f440755f;
        java.lang.Object[] objArr2 = this.f440754e;
        int i18 = this.f440757h;
        if (n17 > i17) {
    ...
    public p0.e v(int i17) {
        t0.c.a(i17, d());
        int n17 = n();
        java.lang.Object[] objArr = this.f440754e;
        int i18 = this.f440757h;
        return i17 >= n17 ? m(objArr, n17, i18, i17 - n17) : m(l(objArr, i18, i17, new q0.e(this.f440755f[0])), n17, i18, 0);
    }

    @Override // p0.e
    public p0.d x() {
        return new q0.h(this, this.f440754e, this.f440755f, this.f440757h);
    }
    ...
    public p0.e add(java.lang.Object obj) {
        ...
        if (i18 < 32) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(copyOf, "copyOf(this, newSize)");
            copyOf[i18] = obj;
            return new q0.f(objArr2, copyOf, i17 + 1, this.f440757h);
        }
        java.lang.Object[] objArr3 = new java.lang.Object[32];
        objArr3[0] = obj;
