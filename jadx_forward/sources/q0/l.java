...
public final class l extends q0.c implements p0.b {
    ...
    public static final q0.l f440774f = new q0.l(new java.lang.Object[0]);

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.Object[] f440775e;

    public l(java.lang.Object[] buffer) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(buffer, "buffer");
        this.f440775e = buffer;
    }

    @Override // java.util.List, p0.e
    public p0.e add(int i17, java.lang.Object obj) {
        java.lang.Object[] objArr = this.f440775e;
        t0.c.b(i17, objArr.length);
        java.lang.Object[] objArr2 = this.f440775e;
    ...
    public p0.e addAll(java.util.Collection elements) {
        ...
        java.lang.Object[] copyOf = java.util.Arrays.copyOf(this.f440775e, d() + elements.size());
    ...
    @Override // kz5.b
    public int d() {
        return this.f440775e.length;
    }

    @Override // java.util.List
    public java.lang.Object get(int i17) {
        t0.c.a(i17, d());
        return this.f440775e[i17];
    }
    ...
    public p0.e i(yz5.l predicate) {
        ...
        for (int i17 = 0; i17 < d18; i17++) {
            ...
            if (((java.lang.Boolean) predicate.mo146xb9724478(obj)).booleanValue()) {
                if (!z17) {
                    ...
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.f(objArr2, "copyOf(this, size)");
                    z17 = true;
                    d17 = i17;
                }
            } else if (z17) {
        ...
        return d17 == d() ? this : d17 == 0 ? f440774f : new q0.l(kz5.v.s(objArr2, 0, d17));
    }

    @Override // kz5.h, java.util.List
    public int indexOf(java.lang.Object obj) {
        return kz5.z.X(this.f440775e, obj);
    }
    ...
    public int lastIndexOf(java.lang.Object obj) {
        ...
        if (obj == null) {
            ...
            while (true) {
                int i18 = length2 - 1;
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(obj, objArr[length2])) {
                    return length2;
                }
                if (i18 < 0) {
                    return -1;
    ...
    public java.util.ListIterator listIterator(int i17) {
        t0.c.b(i17, d());
        return new q0.d(this.f440775e, i17, d());
    }
    ...
    @Override // p0.e
    public p0.d x() {
        return new q0.h(this, null, this.f440775e, 0);
    }
