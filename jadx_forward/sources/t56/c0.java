...
public final class c0 extends java.util.concurrent.atomic.AtomicReference implements java.lang.Runnable, p56.s {
    ...
    public final u56.o f497395d;

    /* renamed from: e, reason: collision with root package name */
    public final r56.a f497396e;

    public c0(r56.a aVar) {
        this.f497396e = aVar;
        this.f497395d = new u56.o();
    }

    @Override // p56.s
    public boolean b() {
        return this.f497395d.f506372e;
    }

    @Override // p56.s
    public void c() {
        if (this.f497395d.f506372e) {
            return;
        }
        this.f497395d.c();
    }
    ...
    public c0(r56.a aVar, a66.c cVar) {
        this.f497396e = aVar;
        this.f497395d = new u56.o(new t56.b0(this, cVar));
    }

    public c0(r56.a aVar, u56.o oVar) {
        this.f497396e = aVar;
        this.f497395d = new u56.o(new t56.a0(this, oVar));
    }
}
