...
public final class e2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.RepairerLoginAndRegUI f522471d;

    public e2(com.tencent.mm.plugin.repairer.ui.RepairerLoginAndRegUI repairerLoginAndRegUI) {
        this.f522471d = repairerLoginAndRegUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.repairer.ui.RepairerLoginAndRegUI repairerLoginAndRegUI = this.f522471d;
        repairerLoginAndRegUI.getClass();
        android.content.Intent intent = new android.content.Intent();
        intent.setClassName(repairerLoginAndRegUI.mo55332x76847179(), "com.tencent.mm.plugin.account.ui.MobileLoginOrForceReg");
        intent.putExtra("ticket", "");
        intent.putExtra("moble", repairerLoginAndRegUI.U6().f522664b);
        ...
        intent.putExtra(dm.i4.f66875xa013b0d5, repairerLoginAndRegUI.U6().f522670h);
        intent.putExtra("password", "");
        intent.putExtra("nickname", repairerLoginAndRegUI.U6().f522670h);
        intent.putExtra("avatar_url", repairerLoginAndRegUI.U6().f522669g);
        intent.putExtra("mobile_check_type", 0);
        intent.putExtra("kintent_nickname", true);
        intent.putExtra("kintent_hasavatar", repairerLoginAndRegUI.U6().f522670h);
        intent.putExtra("kintent_password", "");
        intent.putExtra("key_reg_style", repairerLoginAndRegUI.U6().f522672j);
