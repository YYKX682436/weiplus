...
public final class j2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.RepairerLoginAndRegUI f522531d;

    public j2(com.tencent.mm.plugin.repairer.ui.RepairerLoginAndRegUI repairerLoginAndRegUI) {
        this.f522531d = repairerLoginAndRegUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.repairer.ui.RepairerLoginAndRegUI repairerLoginAndRegUI = this.f522531d;
        repairerLoginAndRegUI.getClass();
        android.content.Intent intent = new android.content.Intent();
        intent.setClassName(repairerLoginAndRegUI.mo55332x76847179(), "com.tencent.mm.plugin.account.ui.LoginByMobileSendSmsUI");
        repairerLoginAndRegUI.getIntent().putExtra("from_mobile", repairerLoginAndRegUI.U6().f522664b);
        repairerLoginAndRegUI.getIntent().putExtra("switch_login_wx_id", repairerLoginAndRegUI.U6().f522673k);
