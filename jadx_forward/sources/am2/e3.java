...
public final class e3 implements android.view.MenuItem.OnMenuItemClickListener {
    ...
    public final /* synthetic */ am2.g3 f90196d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.xn1 f90197e;

    public e3(am2.g3 g3Var, r45.xn1 xn1Var) {
        this.f90196d = g3Var;
        this.f90197e = xn1Var;
    }
    ...
    public final boolean onMenuItemClick(android.view.MenuItem it) {
        ...
        r45.xn1 xn1Var = this.f90197e;
        ch1Var.set(13, xn1Var);
        ch1Var.set(1, 20125);
        r45.ej1 ej1Var = new r45.ej1();
        ej1Var.set(0, 2);
        ej1Var.set(1, "预约了下一场直播");
        ej1Var.set(2, 1);
        ...
        ((mm2.x4) this.f90196d.f90208b.a(mm2.x4.class)).f411061f.add(new dk2.a8(ch1Var2));
        return true;
    }
}
