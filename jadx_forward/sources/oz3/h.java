...
public final class h implements oz3.a {
    ...
    public static final oz3.h f431803a = new oz3.h();

    /* renamed from: b, reason: collision with root package name */
    public static final jz5.g f431804b = jz5.h.b(oz3.g.f431802d);
    ...
    */
    public boolean a(oz3.e r7) {
        /*
            ...
            return r1
        L18:
            oz3.f r0 = r7.f431797h
            int r2 = r0.f431801d
            oz3.f r3 = oz3.f.f431798e
            r3 = 2
            r2 = r2 & r3
            if (r2 != 0) goto L3b
            ...
            return r1
        L3b:
            com.tencent.qbar.ScanIdentifyReportInfo r0 = r7.f431796g
            if (r0 != 0) goto L40
            return r1
        L40:
            r0 = 1
            java.lang.String r2 = r7.f431792c
            if (r2 == 0) goto L4e
            int r4 = r2.length()
            if (r4 != 0) goto L4c
            goto L4e
        ...
        L52:
            ...
            if (r3 != 0) goto Lba
        La2:
            java.lang.String r3 = e04.p.f327575J
    ...
    public void b(oz3.e request, fk0.a aVar) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ScanPayCodeOcrReportReporter", "reportOcrForPayCode");
        if (aVar == null) {
            return;
        }
        java.lang.String str = request.f431792c;
        java.lang.String obj = r26.n0.w0(str == null ? "" : str).toString();
        java.lang.String MERCHANT_PAY_PREFIX = e04.p.K;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(MERCHANT_PAY_PREFIX, "MERCHANT_PAY_PREFIX");
        int i17 = 2;
        if (r26.i0.A(obj, MERCHANT_PAY_PREFIX, false, 2, null) || r26.i0.y(obj, "https://payapp.wechatpay.cn/sjt/qr/", false)) {
            ...
            if (r26.i0.y(obj, "wxp://f2f", false)) {
                ...
                java.lang.String F2F_PAY_MATERIAL_PREFIX = e04.p.f327575J;
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(F2F_PAY_MATERIAL_PREFIX, "F2F_PAY_MATERIAL_PREFIX");
                i17 = (r26.i0.y(obj, F2F_PAY_MATERIAL_PREFIX, false) || r26.i0.y(obj, "https://payapp.wechatpay.cn/qr/", false)) ? 6 : -1;
            }
        }
        int i18 = i17;
        if (i18 < 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ScanPayCodeOcrReportReporter", "reportOcrForPayCode pay code type not support");
            return;
        }
        ...
        int i19 = aVar.f344793b;
        float f17 = aVar.f344796e;
        java.lang.String valueOf = java.lang.String.valueOf(f17);
        int i27 = aVar.f344795d;
        java.lang.String valueOf2 = java.lang.String.valueOf(f17);
        java.lang.String str2 = aVar.f344792a;
        ((nh0.i) iVar).getClass();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("WcPayReportFeatureService", "onScanPaymentCodeOcrReport, qrCodeType: %d, url: %s, color: %d, colorScore: %s, cls: %d, clsScore: %s", java.lang.Integer.valueOf(i18), str, java.lang.Integer.valueOf(i19), valueOf, java.lang.Integer.valueOf(i27), valueOf2);
