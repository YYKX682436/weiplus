...
public final class r0 extends dr4.r1 {
    ...
    public r0(int i17, int i18, int i19, int i27, int i28, int i29, boolean z17, int i37, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
    ...
    public android.util.Size A() {
        ...
        return (i17 == 0 || i17 == 180) ? new android.util.Size(this.f429525a, this.f429526b) : new android.util.Size(this.f429526b, this.f429525a);
    }
