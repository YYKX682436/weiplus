...
public class p implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ mx1.a f448838d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ qx1.q f448839e;
    ...
    public void onClick(android.view.View view) {
        ...
        px1.b bVar = px1.v.f440393a;
        qx1.q qVar = this.f448839e;
        java.lang.Boolean valueOf = java.lang.Boolean.valueOf(!qVar.f448853n);
        nx1.z zVar = qVar.f448840a;
        if (zVar != null) {
            zVar.d(bVar, valueOf);
        }
        boolean z17 = !qVar.f448853n;
        qVar.f448853n = z17;
        qx1.q.a(qVar, view, z17);
        qx1.q.b(qVar, this.f448838d);
