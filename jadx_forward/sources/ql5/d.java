...
public abstract class d extends android.widget.BaseExpandableListAdapter {
    ...
    public static final /* synthetic */ int f446128c = 0;

    /* renamed from: a, reason: collision with root package name */
    public final android.util.SparseArray f446129a = new android.util.SparseArray();

    /* renamed from: b, reason: collision with root package name */
    public com.p314xaae8f345.mm.ui.p2747xd1075a44.p2761x50446c43.C22700x2b5d269a f446130b;

    public final ql5.g a(int i17) {
        android.util.SparseArray sparseArray = this.f446129a;
    ...
    public final android.view.View getChildView(int i17, int i18, boolean z17, android.view.View view, android.view.ViewGroup viewGroup) {
        ...
        ((java.util.ArrayList) eVar.f446131d).clear();
        ...
        if (divider != null) {
            eVar.f446132e = divider;
            eVar.f446133f = measuredWidth;
            eVar.f446134g = dividerHeight;
        ...
        while (true) {
            ...
            java.util.List list = eVar.f446131d;
        ...
        boolean z18 = a17.f446140b;
        if (z18 && intValue != i19) {
            ql5.f fVar = new ql5.f(eVar, 0, i27, a17, null);
            m82041xf2fc90822 = this.f446130b.m82041xf2fc9082();
            fVar.setDuration(m82041xf2fc90822);
            ...
            ql5.f fVar2 = new ql5.f(eVar, a17.f446142d, 0, a17, null);
            m82041xf2fc9082 = this.f446130b.m82041xf2fc9082();
            fVar2.setDuration(m82041xf2fc9082);
    ...
    public final int getChildrenCount(int i17) {
        ql5.g a17 = a(i17);
        return a17.f446139a ? a17.f446141c + 1 : c(i17);
    }
}
