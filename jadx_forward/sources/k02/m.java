...
public abstract class m {
    public static void a(long j17, float f17, int i17) {
        ...
        android.content.SharedPreferences sharedPreferences = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSharedPreferences("download_pref", 0);
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(string)) {
            ...
            str = string + (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P(string.split("\\|")[r2.length - 1].split("_")[0], 0) + 1) + "_" + str2 + "|";
        }
