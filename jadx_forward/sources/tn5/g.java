...
public class g implements on5.h {
    ...
    public android.graphics.PointF f502406a;

    /* renamed from: b, reason: collision with root package name */
    public on5.h f502407b;

    /* renamed from: c, reason: collision with root package name */
    public boolean f502408c = true;

    @Override // on5.h
    public boolean a(android.view.View view) {
        on5.h hVar = this.f502407b;
        return hVar != null ? hVar.a(view) : c(view, this.f502406a, this.f502408c);
    }

    @Override // on5.h
    public boolean b(android.view.View view) {
        on5.h hVar = this.f502407b;
        return hVar != null ? hVar.b(view) : d(view, this.f502406a);
    }
            ...
            if (!(!(view instanceof on5.g) && ((view instanceof android.widget.AbsListView) || (view instanceof android.widget.ScrollView) || (view instanceof n3.o0) || (view instanceof android.webkit.WebView) || (view instanceof n3.e0)))) {
                ...
                for (int childCount = viewGroup.getChildCount(); childCount > 0; childCount--) {
                    ...
                    if (e(view, childAt, pointF.x, pointF.y, pointF2)) {
                        java.lang.Object tag = childAt.getTag(com.p314xaae8f345.mm.R.id.prl);
                        if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b("fixed", tag) || p3321xbce91901.jvm.p3324x21ffc6bd.o.b("fixed-top", tag)) {
                            return false;
                        }
    ...
    public final boolean d(android.view.View view, android.graphics.PointF pointF) {
        ...
        for (int childCount = viewGroup.getChildCount(); childCount > 0; childCount--) {
            ...
            if (e(view, childAt, pointF.x, pointF.y, pointF2)) {
                java.lang.Object tag = childAt.getTag(com.p314xaae8f345.mm.R.id.prl);
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b("fixed", tag) || p3321xbce91901.jvm.p3324x21ffc6bd.o.b("fixed-bottom", tag)) {
                    return false;
                }
                pointF.offset(pointF2.x, pointF2.y);
