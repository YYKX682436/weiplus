...
public abstract class n {
    ...
    public static final byte[] f498065a = {0, 0, 0, 1};

    /* renamed from: b, reason: collision with root package name */
    public static final float[] f498066b = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.Object f498067c = new java.lang.Object();

    /* renamed from: d, reason: collision with root package name */
    public static int[] f498068d = new int[10];
        ...
        synchronized (f498067c) {
            ...
            while (i19 < i17) {
                ...
                if (i19 < i17) {
                    int[] iArr = f498068d;
                    if (iArr.length <= i27) {
                        f498068d = java.util.Arrays.copyOf(iArr, iArr.length * 2);
                    }
                    f498068d[i27] = i19;
                    i19 += 3;
                    i27++;
