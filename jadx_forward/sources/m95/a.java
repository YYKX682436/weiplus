...
public class a {
    ...
    public static java.lang.String f406602c = "";

    /* renamed from: g, reason: collision with root package name */
    public static volatile java.lang.Float f406606g;

    /* renamed from: h, reason: collision with root package name */
    public static volatile java.lang.Float f406607h;

    /* renamed from: a, reason: collision with root package name */
    public android.util.TypedValue f406609a = new android.util.TypedValue();

    /* renamed from: b, reason: collision with root package name */
    public final byte[] f406610b = new byte[0];

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.Map f406603d = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.Map f406604e = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.Map f406605f = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: i, reason: collision with root package name */
    public static java.lang.Boolean f406608i = null;

    public static android.graphics.Bitmap a(android.content.res.Resources resources, int i17, float f17) {
        android.graphics.drawable.Drawable e17 = e(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e, i17, f17);
        if (e17 == null) {
            return null;
        }
        m95.b bVar = (m95.b) e17;
        int i18 = bVar.f406617g;
        int i19 = bVar.f406618h;
    ...
    public static android.graphics.Picture c(float f17, l95.c cVar, float f18) {
        ...
        android.graphics.Canvas beginRecording = picture.beginRecording((int) (l95.c.m145411x755bd410(cVar) * f18), (int) (l95.c.m145410x1c4fb41d(cVar) * f18));
        beginRecording.save();
        beginRecording.scale(f18, f18);
        l95.c.m145418xc84b4196(cVar, beginRecording, android.os.Looper.myLooper());
    ...
    public static l95.c d(android.content.res.Resources resources, int i17, java.lang.String str) {
        ...
        try {
            ...
            try {
                ...
                str4 = str5;
                e = e17;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SVGCompat", e, "", new java.lang.Object[0]);
    ...
    public static android.graphics.drawable.Drawable e(android.content.res.Resources resources, int i17, float f17) {
        ...
        if (!n95.b.b()) {
            java.lang.String str3 = f406602c + ".svg.code.drawable";
            float f18 = resources.getDisplayMetrics().density;
            float f19 = f17 > 0.0f ? f17 : 1.0f;
            if (f(resources, i17)) {
                if (f406607h == null) {
                    f406607h = java.lang.Float.valueOf(f18 / 1.0f);
                }
                floatValue = f406607h.floatValue();
            } else {
                if (f406606g == null) {
                    f406606g = java.lang.Float.valueOf(f18 / 3.0f);
                }
                floatValue = f406606g.floatValue();
            }
            float f27 = floatValue * f19;
            if (f17 <= 0.0f) {
                java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) f406604e;
            ...
            java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = (java.util.concurrent.ConcurrentHashMap) f406605f;
        ...
        try {
            try {
                ...
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SVGCompat", e17, "", new java.lang.Object[0]);
                    inputStream = e17;
                }
                long m78180x6581ab3 = com.p314xaae8f345.mm.svg.C21322xee5ed51e.m78180x6581ab3(org.apache.http.util.EncodingUtils.getString(bArr, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c).toString());
                ?? r17 = (m78180x6581ab3 > 0L ? 1 : (m78180x6581ab3 == 0L ? 0 : -1));
                if (r17 == 0) {
                    n95.d.a("MicroMsg.SVGCompat", "Parse SVG failed.", new java.lang.Object[0]);
                    str = r17;
                    openRawResource = inputStream;
                } else {
                    float[] m78178xc31faa3c = com.p314xaae8f345.mm.svg.C21322xee5ed51e.m78178xc31faa3c(m78180x6581ab3);
                    ?? r57 = resources.getDisplayMetrics().density;
                    float f28 = f(resources, i17) ? 1 : 3;
                    i18 = (f17 > 0.0f ? 1 : (f17 == 0.0f ? 0 : -1));
                    float f29 = (m78178xc31faa3c[0] / f28) * r57 * (i18 > 0 ? f17 : 1.0f);
                    float f37 = (m78178xc31faa3c[1] / f28) * r57;
                    if (i18 <= 0) {
                        f17 = 1.0f;
                    }
                    float f38 = f37 * f17;
                    ...
                    int m78183xd8b31c7c = com.p314xaae8f345.mm.svg.C21322xee5ed51e.m78183xd8b31c7c(m78180x6581ab3, beginRecording, i19, i27);
                    picture3.endRecording();
                    com.p314xaae8f345.mm.svg.C21322xee5ed51e.m78181x41012807(m78180x6581ab3);
                    m95.d dVar = new m95.d(picture3, i17);
                    if (m78183xd8b31c7c >= 0) {
                        return dVar;
                    }
                    n95.d.a("MicroMsg.SVGCompat", "Render SVG failed. Reason : %s", java.lang.Integer.valueOf(m78183xd8b31c7c));
                    str = beginRecording;
                    openRawResource = r57;
                }
            } catch (java.io.IOException e18) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SVGCompat", e18, "", new java.lang.Object[0]);
                ...
                if (openRawResource != null) {
                    try {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SVGCompat", e19, "", new java.lang.Object[0]);
                        str = str;
                        openRawResource = openRawResource;
                    }
                }
            ...
            if (openRawResource != null) {
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SVGCompat", e27, str, new java.lang.Object[i18]);
                }
            }
            throw th6;
        }
    ...
    public static boolean f(android.content.res.Resources resources, int i17) {
        java.lang.String resourceName = resources.getResourceName(i17);
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(resourceName)) {
            return false;
        }
    ...
    public static boolean i() {
        if (f406608i == null) {
            try {
                if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P(j62.e.g().a("clicfg_svg_hardware", "1", false, true), 1) > 0) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SVGCompat", "svg openHardWare!!");
                    f406608i = java.lang.Boolean.TRUE;
                } else {
                    f406608i = java.lang.Boolean.FALSE;
                }
            } catch (java.lang.Exception e17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.SVGCompat", e17, "svg openHardWare", new java.lang.Object[0]);
                f406608i = java.lang.Boolean.FALSE;
            }
        }
        return f406608i.booleanValue();
    }

    public boolean g(android.content.res.Resources resources, int i17) {
        java.lang.String charSequence;
        try {
            if (resources.getResourceTypeName(i17).equals(com.p314xaae8f345.p3076xcbed6b1f.p3080xbe953013.p3084xa1c33861.C26631x178a9850.f55633x65da3463)) {
                synchronized (this.f406610b) {
                    android.util.TypedValue typedValue = this.f406609a;
                    if (typedValue == null) {
                        typedValue = new android.util.TypedValue();
                        this.f406609a = typedValue;
                    }
