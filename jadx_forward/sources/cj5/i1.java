...
public final class i1 extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.l {
    ...
    public static final cj5.i1 f123675d = new cj5.i1();
    ...
    public java.lang.Object mo146xb9724478(java.lang.Object obj) {
        ...
        java.util.HashMap hashMap2 = state.f527863z;
        java.util.LinkedList linkedList = state.f527852o;
        if (dVar != null && (dVar instanceof wi5.t0)) {
            wi5.t0 t0Var = (wi5.t0) dVar;
            boolean contains = linkedList.contains(t0Var.f527874b.f477644f);
            ri5.j jVar = t0Var.f527874b;
            if (contains) {
                linkedList.remove(jVar.f477644f);
                j75.d dVar2 = state.f379599d;
                if (dVar2 != null) {
                    dVar2.a(new wi5.w0(wi5.v0.f527885e, wi5.u0.f527878d));
                }
                hashMap.remove(jVar.f477644f);
            } else if (state.f527849i <= 0 || linkedList.size() < state.f527849i) {
                linkedList.add(jVar.f477644f);
                java.lang.Long valueOf = java.lang.Long.valueOf(c01.id.a());
                java.lang.String str = jVar.f477644f;
                hashMap2.put(str, valueOf);
                j75.d dVar3 = state.f379599d;
                if (dVar3 != null) {
                    dVar3.a(new wi5.w0(wi5.v0.f527884d, wi5.u0.f527878d));
                }
                wi5.l0 l0Var = new wi5.l0();
                l0Var.f527838a = t0Var.f527876d;
                hashMap.put(str, l0Var);
            } else {
                j75.d dVar4 = state.f379599d;
                if (dVar4 != null) {
                    dVar4.a(new wi5.w0(wi5.v0.f527884d, wi5.u0.f527879e));
                }
            }
        }
        ...
        if (dVar5 != null && (dVar5 instanceof wi5.x0)) {
            ...
            if (linkedList.contains(x0Var.f527894b)) {
                java.lang.String str2 = x0Var.f527894b;
        ...
        if (dVar6 != null && (dVar6 instanceof wi5.y)) {
            ...
            java.util.List f07 = r26.n0.f0(yVar.f527896c, new java.lang.String[]{" "}, false, 0, 6, null);
            ...
            java.lang.String str3 = yVar.f527896c;
            if (!r26.n0.N(str3)) {
                java.lang.String str4 = yVar.f527895b;
                state.f527859v = str4;
                state.f527862y = arrayList;
                state.f527861x = str3;
                state.f527860w = null;
                if (arrayList.size() > 1) {
        ...
        if (dVar9 != null && (dVar9 instanceof wi5.w)) {
            state.f527858u = ((wi5.w) dVar9).f527887b;
            if (!(!r26.n0.N(r0.f527888c))) {
                state.f527859v = null;
                state.f527861x = null;
                state.f527862y = null;
                state.f527860w = null;
        ...
        j75.d dVar10 = state.f379599d;
        if (dVar10 != null && (dVar10 instanceof wi5.j0)) {
            wi5.j0 j0Var = (wi5.j0) dVar10;
            java.util.ArrayList arrayList2 = new java.util.ArrayList();
            for (java.lang.Object obj3 : j0Var.f527833b) {
                if (!linkedList.contains((java.lang.String) obj3)) {
                    arrayList2.add(obj3);
                }
            }
            if (state.f527849i <= 0 || linkedList.size() + arrayList2.size() <= state.f527849i) {
                java.util.ArrayList arrayList3 = new java.util.ArrayList();
                java.util.List list = j0Var.f527833b;
        ...
        if (dVar14 != null && (dVar14 instanceof wi5.m0)) {
            ...
            while (it8.hasNext()) {
                ...
                l0Var2.f527838a = m0Var.f527844c;
                hashMap.put(str5, l0Var2);
            }
            linkedList.clear();
            java.util.List list2 = m0Var.f527843b;
