...
public final class e {
    ...
    public android.graphics.Rect f106451h;

    /* renamed from: i, reason: collision with root package name */
    public int f106452i;

    /* renamed from: j, reason: collision with root package name */
    public float f106453j;

    /* renamed from: k, reason: collision with root package name */
    public float f106454k;
    ...
    public boolean f106462s;

    /* renamed from: w, reason: collision with root package name */
    public float f106466w;

    /* renamed from: x, reason: collision with root package name */
    public float f106467x;

    /* renamed from: y, reason: collision with root package name */
    public final android.os.Vibrator f106468y;

    /* renamed from: z, reason: collision with root package name */
    public boolean f106469z;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.ArrayList f106444a = new java.util.ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public final java.util.ArrayList f106445b = new java.util.ArrayList();

    /* renamed from: c, reason: collision with root package name */
    public final float[] f106446c = new float[2];

    /* renamed from: d, reason: collision with root package name */
    public final float[] f106447d = new float[4];

    /* renamed from: e, reason: collision with root package name */
    public final float[] f106448e = new float[2];

    /* renamed from: f, reason: collision with root package name */
    public bw3.d f106449f = bw3.d.f106440d;

    /* renamed from: g, reason: collision with root package name */
    public android.graphics.Matrix f106450g = new android.graphics.Matrix();

    /* renamed from: l, reason: collision with root package name */
    public float[] f106455l = new float[8];

    /* renamed from: m, reason: collision with root package name */
    public final float[] f106456m = new float[8];

    /* renamed from: n, reason: collision with root package name */
    public final float[] f106457n = new float[4];

    /* renamed from: q, reason: collision with root package name */
    public float f106460q = 10.0f;

    /* renamed from: r, reason: collision with root package name */
    public float f106461r = 0.1f;

    /* renamed from: t, reason: collision with root package name */
    public final bw3.c f106463t = bw3.c.f106437d;

    /* renamed from: u, reason: collision with root package name */
    public final boolean f106464u = true;

    /* renamed from: v, reason: collision with root package name */
    public final float f106465v = 15.0f;
    ...
    public e() {
        ...
        this.f106468y = (android.os.Vibrator) systemService;
        this.A = true;
        this.f106450g.setScale(1.0f, 1.0f);
    }
    ...
    */
    ...
    public final void b(android.view.MotionEvent motionEvent) {
        java.util.ArrayList arrayList = this.f106444a;
        java.util.Iterator it = kz5.c0.g(arrayList).iterator();
        while (it.hasNext()) {
            int b17 = ((kz5.x0) it).b();
            java.util.ArrayList arrayList2 = this.f106445b;
    ...
    public final float g(android.graphics.Matrix matrix) {
        ...
        float f17 = this.f106467x;
        return (f17 >= -90.0f || atan2 <= 0.0f) ? (f17 <= 90.0f || atan2 >= 0.0f) ? atan2 : atan2 + com.p314xaae8f345.p3206x37e841.C27807xedfc512a.f60968xdd9691f3 : atan2 - com.p314xaae8f345.p3206x37e841.C27807xedfc512a.f60968xdd9691f3;
    }

    public final void h(android.graphics.Matrix m17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(m17, "m");
        this.f106450g.set(m17);
        this.f106450g.mapPoints(this.f106456m, this.f106455l);
        float e17 = e();
        float[] fArr = this.f106457n;
        fArr[0] = e17;
        fArr[1] = f();
        fArr[2] = d();
        fArr[3] = c();
    ...
    public final void i(android.view.MotionEvent motionEvent) {
        ...
        if (arrayList.size() == 2) {
            this.f106449f = bw3.d.f106442f;
            if (this.f106463t == bw3.c.f106438e) {
                this.f106450g.mapPoints(this.f106448e, new float[]{this.f106459p / 2.0f, this.f106458o / 2.0f});
            }
            android.graphics.Matrix matrix = new android.graphics.Matrix();
            this.f106450g.invert(matrix);
            b(motionEvent);
            ...
            if (((java.lang.Number) obj3).intValue() < motionEvent.getPointerCount()) {
                ...
                if (((java.lang.Number) obj4).intValue() < motionEvent.getPointerCount()) {
                    ...
                    matrix.mapPoints(this.f106447d, new float[]{motionEvent.getX(((java.lang.Number) obj5).intValue()), motionEvent.getY(((java.lang.Number) obj6).intValue()), motionEvent.getX(((java.lang.Number) obj7).intValue()), motionEvent.getY(((java.lang.Number) obj8).intValue())});
                }
            }
        }
    }
