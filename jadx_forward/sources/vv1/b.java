...
public abstract class b {
    ...
    public static final java.util.concurrent.ThreadPoolExecutor f521936a = new java.util.concurrent.ThreadPoolExecutor(0, 1, 1, java.util.concurrent.TimeUnit.SECONDS, new java.util.concurrent.LinkedBlockingDeque());
    ...
    */
    public static void a(wv1.a r3, vv1.a r4, im5.b r5) {
        ...
        L54:
            boolean r4 = r3.d()
            if (r4 != 0) goto L5f
            java.util.concurrent.ThreadPoolExecutor r4 = vv1.b.f521936a
            r4.submit(r3)
        L5f:
            return
        */
