...
public abstract class d {
    ...
    public static oj.c f427216a;

    /* renamed from: b, reason: collision with root package name */
    public static long f427217b;

    /* renamed from: c, reason: collision with root package name */
    public static long f427218c;

    /* renamed from: d, reason: collision with root package name */
    public static int f427219d;

    /* renamed from: e, reason: collision with root package name */
    public static final java.io.FileFilter f427220e = new oj.b();
    ...
    */
    ...
    public static int c(java.lang.String str) {
        ...
        try {
            java.io.BufferedReader bufferedReader = new java.io.BufferedReader(new java.io.InputStreamReader(fileInputStream, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));
    ...
    public static org.json.JSONObject d(org.json.JSONObject jSONObject, android.app.Application application) {
        try {
            ...
            ((android.app.ActivityManager) application.getSystemService(com.p314xaae8f345.p3076xcbed6b1f.p3080xbe953013.p3081x4189335b.C26617x73f7249d.f55566xbe5e9100)).getMemoryInfo(memoryInfo);
    ...
    public static oj.c e(android.content.Context context) {
        ...
        if (i17 == 0) {
            java.io.File[] listFiles = new java.io.File("/sys/devices/system/cpu/").listFiles(f427220e);
        ...
        if (g17 >= 8589934592L) {
            ...
            if (g17 >= 4294967296L) {
                ...
                f427216a = oj.c.UN_KNOW;
            }
        }
        oj.j.c("Matrix.DeviceUtil", "getLevel, cost:" + (java.lang.System.currentTimeMillis() - currentTimeMillis) + ", level:" + f427216a, new java.lang.Object[0]);
        return f427216a;
    }
    ...
    public static java.lang.String f(java.lang.String str) {
        ...
        try {
            ...
            try {
                java.io.BufferedReader bufferedReader2 = new java.io.BufferedReader(new java.io.InputStreamReader(fileInputStream, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));
                while (true) {
                    try {
    ...
    public static long g(android.content.Context context) {
        ...
        f427217b = memoryInfo.totalMem;
        f427218c = memoryInfo.threshold;
        long maxMemory = java.lang.Runtime.getRuntime().maxMemory();
        if (maxMemory == com.p314xaae8f345.p3121x37984a.p3125x2eaf9f.C26918x6e83759b.f58001x610e5697) {
            f427219d = activityManager.getMemoryClass();
        } else {
            f427219d = (int) (maxMemory / 1048576);
        }
        oj.j.c("Matrix.DeviceUtil", "getTotalMemory cost:" + (java.lang.System.currentTimeMillis() - currentTimeMillis) + ", total_mem:" + f427217b + ", LowMemoryThresold:" + f427218c + ", Memory Class:" + f427219d, new java.lang.Object[0]);
        return f427217b;
    }
