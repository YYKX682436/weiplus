...
public final class u1 extends p16.p implements p16.i0 {
    ...
    public java.util.List f369314f = java.util.Collections.emptyList();

    /* renamed from: g, reason: collision with root package name */
    public int f369315g = -1;
    ...
    */
    public p16.g0 I3(p16.h r2, p16.l r3) {
        /*
            r1 = this;
            p16.j0 r0 = i16.v1.f369317n     // Catch: java.lang.Throwable -> Le p16.z -> L10
    ...
    public i16.v1 c() {
        ...
        int i17 = this.f369313e;
        if ((i17 & 1) == 1) {
            this.f369314f = java.util.Collections.unmodifiableList(this.f369314f);
            this.f369313e &= -2;
        }
        v1Var.f369320f = this.f369314f;
        int i18 = (i17 & 2) != 2 ? 0 : 1;
        v1Var.f369321g = this.f369315g;
        v1Var.f369319e = i18;
        return v1Var;
    }

    /* renamed from: clone */
    public java.lang.Object m134638x5a5dd5d() {
    ...
    public i16.u1 d(i16.v1 v1Var) {
        if (v1Var == i16.v1.f369316m) {
            return this;
        }
        if (!v1Var.f369320f.isEmpty()) {
            if (this.f369314f.isEmpty()) {
                this.f369314f = v1Var.f369320f;
                this.f369313e &= -2;
            } else {
                if ((this.f369313e & 1) != 1) {
                    this.f369314f = new java.util.ArrayList(this.f369314f);
                    this.f369313e |= 1;
                }
                this.f369314f.addAll(v1Var.f369320f);
            }
        }
        if ((v1Var.f369319e & 1) == 1) {
            int i17 = v1Var.f369321g;
            this.f369313e |= 2;
            this.f369315g = i17;
        }
        this.f432870d = this.f432870d.e(v1Var.f369318d);
        return this;
    }
}
