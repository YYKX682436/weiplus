...
public class d implements m62.c {
    ...
    public void a() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NotificationSpecialSingleton", "iniNotificationSpecialSceneSwitchEnable() enable:%s", java.lang.Integer.valueOf(Ni));
        if (!(Ni == 1)) {
            if (Ni == 0) {
                b(v17, false);
                return;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NotificationSpecialSingleton", "specialSceneDetail %s", Zi);
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(Zi) && (d17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.aa.d(Zi, "manufacturerlist", null)) != null) {
            int P = d17.containsKey(".manufacturerlist.size") ? com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P((java.lang.String) d17.get(".manufacturerlist.size"), 0) : 0;
    ...
    public final void b(android.content.SharedPreferences sharedPreferences, boolean z17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NotificationSpecialSingleton", "setSpecialSceneEnable() enable: %s", java.lang.Boolean.valueOf(z17));
    }
}
