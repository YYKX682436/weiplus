...
public class i implements vc1.s2 {
    ...
    public float f334051b;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f334054e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.l f334055f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ vc1.a3 f334056g;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicBoolean f334050a = new java.util.concurrent.atomic.AtomicBoolean(false);

    /* renamed from: c, reason: collision with root package name */
    public final org.json.JSONObject f334052c = new org.json.JSONObject();

    /* renamed from: d, reason: collision with root package name */
    public final uc1.h1 f334053d = new uc1.h1();

    public i(eg1.m mVar, int i17, com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.l lVar, vc1.a3 a3Var) {
        this.f334054e = i17;
        this.f334055f = lVar;
        this.f334056g = a3Var;
    }
    ...
    public void a(vc1.q1 q1Var, boolean z17) {
        vc1.a3 a3Var = this.f334056g;
        org.json.JSONObject jSONObject = this.f334052c;
        if (this.f334050a.compareAndSet(true, false)) {
            try {
                jSONObject.remove("mapId");
                jSONObject.put("mapId", this.f334054e);
                jSONObject.remove("type");
                jSONObject.put("type", "end");
                jSONObject.remove("causedBy");
                boolean z18 = q1Var.f516660a != this.f334051b;
                if (!z17) {
            ...
            uc1.h1 h1Var = this.f334053d;
            h1Var.f163907f = jSONObject2;
            this.f334055f.i(h1Var, null);
            jSONObject.toString();
        }
    }
    ...
    public void b(vc1.q1 q1Var, boolean z17) {
        org.json.JSONObject jSONObject = this.f334052c;
        if (this.f334050a.compareAndSet(false, true)) {
            try {
                jSONObject.remove("mapId");
                jSONObject.put("mapId", this.f334054e);
                jSONObject.remove("type");
