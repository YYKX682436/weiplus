...
public abstract class g2 {
    public static final void a(db5.g4 g4Var, yb5.d dVar, android.view.View view, int i17, com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var) {
        if (((qg5.z2) ((ct.j3) i95.n0.c(ct.j3.class))).nj(f9Var, true)) {
            ((db5.h4) g4Var.c(i17, 174, 0, dVar.s().getString(com.p314xaae8f345.mm.R.C30867xcad56011.nh7), com.p314xaae8f345.mm.R.raw.f78974xdba97b12)).f309902m = view.getContext().getString(com.p314xaae8f345.mm.R.C30867xcad56011.nh8);
            ((vh0.p3) ((vh0.o1) i95.n0.c(vh0.o1.class))).aj();
        }
    }

    public static final void b(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, java.lang.String str) {
        ...
        if (sc5.g.f488106b) {
            ...
            if (wi6 != null && (J0 = wi6.J0(f9Var.m124847x74d37ac6(), f9Var.Q0())) != null) {
                ...
                com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.app.e wi7 = com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.app.u5.wi();
                if (wi7 != null) {
                    wi7.mo9952xce0038c9(J0, new java.lang.String[0]);
                }
                c01.d9.e().g(new bt3.l0(f9Var.m124847x74d37ac6(), f9Var.Q0(), str, null));
                d35.h.f307877a.c(f9Var);
            }
        }
        com.p314xaae8f345.mm.ui.p2731xc84c5534.b.f291152a.d(f9Var, true);
    }

    public static final boolean c(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, yb5.d dVar) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ChattingItemAppMsgFileMvvm", "[onYuanBaoSummaryClick] AppMsgFile, msgId: " + f9Var.m124847x74d37ac6());
    ...
    public static final void d(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, ot0.q qVar) {
        ...
        if (sc5.g.f488106b) {
            ...
            com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.app.d J0 = com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.app.u5.wi().J0(m124847x74d37ac6, Q02);
            if (J0 == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppMsgLogic", "ERR:" + fp.k.c() + " getinfo failed: " + n17);
            } else {
                long j17 = J0.f68112x10a0fed7;
                com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.app.k0.m(false);
                if (j17 != 101) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppMsgLogic", "ERR:" + fp.k.c() + " get status failed: " + n17 + " status:" + J0.f68112x10a0fed7);
                } else {
                    ...
                    java.lang.String mediaId = bt3.l0.K(J0.f68096xac3be4e, Q02, m124847x74d37ac6);
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppMsgLogic", "pauseDownloadAttach %s %s %s %s", java.lang.Long.valueOf(m124847x74d37ac6), Q02, n17, mediaId);
                }
            }
            d35.h.f307877a.a(f9Var);
        }
        com.p314xaae8f345.mm.ui.p2731xc84c5534.b.f291152a.d(f9Var, false);
    }

    /* JADX WARN: Code restructure failed: missing block: B:105:0x0263, code lost:
    
        if ((r14 != null && r14.f68112x10a0fed7 == 102) != false) goto L125;
     */
    /* JADX WARN: Code restructure failed: missing block: B:150:0x035c, code lost:
    
        if (((rq3.k) ((cc0.l) i95.n0.c(cc0.l.class))).bj(r21.m124847x74d37ac6(), r21.Q0(), 4) == false) goto L183;
     */
    ...
    */
    public static final z01.m e(com.p314xaae8f345.mm.p2621x8fb0427b.f9 r21, yb5.d r22) {
        /*
