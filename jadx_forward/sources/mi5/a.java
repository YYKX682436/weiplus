...
public final class a implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ mi5.b f408322d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f408323e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ x05.c f408324f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ fc5.g f408325g;

    public a(mi5.b bVar, android.content.Context context, x05.c cVar, fc5.g gVar) {
        this.f408322d = bVar;
        this.f408323e = context;
        this.f408324f = cVar;
        this.f408325g = gVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.content.Context context = this.f408323e;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(context, "$context");
        this.f408322d.getClass();
        android.content.Intent intent = new android.content.Intent();
        fc5.g gVar = this.f408325g;
