...
public class a implements t75.c {
    ...
    public final android.os.IBinder f497850d;

    public a(android.os.IBinder iBinder) {
        this.f497850d = iBinder;
    }

    @Override // android.os.IInterface
    public android.os.IBinder asBinder() {
        return this.f497850d;
    }
    ...
    public java.lang.String d(java.util.Map map) {
        ...
        try {
            ...
            obtain.writeMap(map);
            this.f497850d.transact(9, obtain, obtain2, 0);
    ...
    public java.lang.String e(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.sdk.trafficcard.ITencentSmartcardOpenService");
            obtain.writeMap(map);
            this.f497850d.transact(7, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String g(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.sdk.trafficcard.ITencentSmartcardOpenService");
            obtain.writeMap(map);
            this.f497850d.transact(6, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String j(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.sdk.trafficcard.ITencentSmartcardOpenService");
            obtain.writeMap(map);
            this.f497850d.transact(3, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String k(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.sdk.trafficcard.ITencentSmartcardOpenService");
            obtain.writeMap(map);
            this.f497850d.transact(2, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String l(java.lang.String str, int i17) {
        ...
        try {
            ...
            obtain.writeInt(i17);
            this.f497850d.transact(5, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String p(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.sdk.trafficcard.ITencentSmartcardOpenService");
            obtain.writeMap(map);
            this.f497850d.transact(4, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String w(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.sdk.trafficcard.ITencentSmartcardOpenService");
            obtain.writeMap(map);
            this.f497850d.transact(8, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
