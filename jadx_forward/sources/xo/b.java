...
public final class b {
    ...
    public static final xo.b f537275a = new xo.b();

    public final java.util.Map a(java.lang.String cgroup) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(cgroup, "cgroup");
        if (cgroup.length() == 0) {
    ...
    public final java.lang.String b(int i17) {
        ...
        com.p314xaae8f345.mm.vfs.u6 u6Var = new com.p314xaae8f345.mm.vfs.u6(str);
        try {
            java.lang.String d17 = s46.d.d(u6Var, r26.c.f450398a);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(d17, "toString(...)");
            vz5.b.a(u6Var, null);
            return d17;
        } finally {
        }
