...
public class i extends kl.e {
    ...
    public i(java.lang.String str, int i17, int i18, int i19, int i27, int i28, int i29, int i37) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Mix.AudioVariableConvertProcess", "AudioVariableConvertProcess src:%s, srcSampleRate:%d, srcChannels:%d, srcBitDepth:%d, desSampleRate:%d, desChannels:%d, desBitDepth:%d", objArr);
        this.f390254l = rl.a.a(str);
        kl.d.a();
        if (i27 > 0) {
            this.f390248f = i27;
        }
