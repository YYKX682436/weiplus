...
public abstract class m {
    ...
    public static boolean f379499a;
    ...
    public static void b(android.content.res.Configuration configuration, android.content.res.Resources resources) {
        boolean E = com.p314xaae8f345.mm.ui.bk.E(resources);
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMUIModeManager", "updateNightMode, isDarkMode:%s, uiMode:%s, resourcesMode:%s oldUiMode:%s", objArr);
    }
    ...
    public static void c(android.content.res.Configuration configuration, boolean z17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMUIModeManager", "updateNightMode, isDarkMode:%s, uiMode:%s", java.lang.Boolean.valueOf(z17), java.lang.Integer.valueOf(configuration.uiMode));
    }
}
