...
public abstract class f {
    ...
    public static final java.lang.String[] f435918a = {"OMX.qcom.", "OMX.Exynos.", "OMX.hisi"};
        ...
        try {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                ...
                while (true) {
                    ...
                    if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str2) && str2.contains(str)) {
                        break;
                    }
                    i18++;
                }
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.MediaCodecUtil", e17, "isSupportHevc error", new java.lang.Object[0]);
            return false;
        }
    }
    ...
    public static java.lang.String b(android.media.MediaCodecInfo mediaCodecInfo) {
        for (java.lang.String str : mediaCodecInfo.getSupportedTypes()) {
            if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) && str.contains("hevc")) {
                return str;
            }
        }
        return "";
    ...
    public static java.lang.String c() {
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.MediaCodecUtil", e17, "report hevc info error %s", e17.toString());
            return "";
        } catch (java.lang.Throwable th6) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.MediaCodecUtil", th6, "report hevc info error %s", th6.toString());
            return "";
        }
    }
    ...
    public static java.lang.String d() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MediaCodecUtil", "high api 21 cost[%d] hevc info %s", java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - j19), sb9);
        return sb9;
    }
    ...
    public static java.lang.String e() {
        ...
        sb8.append(sb7.toString());
        java.lang.String sb9 = sb8.toString();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MediaCodecUtil", "below api 21 cost[%d] hevc info %s", java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime), sb9);
        return sb9;
    }
                ...
                if (!mediaCodecInfo.isEncoder()) {
                    ...
                    if (capabilitiesForType != null && !capabilitiesForType.isFeatureRequired("secure-playback") && !capabilitiesForType.isFeatureRequired("tunneled-playback")) {
                        ...
                        while (true) {
                            ...
                            if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str2) && str2.contains("dolby")) {
                                str = str2;
                                break;
                            }
                            i18++;
