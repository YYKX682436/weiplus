...
public final class d0 extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.a {
    ...
    public final /* synthetic */ rx4.e0 f482661d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ boolean f482662e;
    ...
    public java.lang.Object mo152xb9724478() {
        ...
        rx4.e0 e0Var = this.f482661d;
        android.view.ViewGroup viewGroup2 = (android.view.ViewGroup) e0Var.mo144222x4ff8c0f0(com.p314xaae8f345.mm.R.id.rr7);
        ...
        sb6.append((hVar == null || (list3 = hVar.f482694d) == null) ? -1 : ((java.util.ArrayList) list3).size());
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FTSNativeTeachHistoryBoxUIC", sb6.toString());
        if (viewGroup2 != null) {
            android.view.ViewGroup viewGroup3 = (android.view.ViewGroup) viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.cgz);
            if (viewGroup3 != null) {
                viewGroup3.removeAllViews();
            }
            java.util.List list4 = e0Var.f482676m;
            ((java.util.ArrayList) list4).clear();
            boolean z17 = this.f482662e;
            if (z17) {
                e0Var.f482671e = false;
                e0Var.f482672f = false;
                ((java.util.LinkedHashMap) e0Var.f482678o).clear();
                viewGroup3.setVisibility(0);
                android.view.View findViewById = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.rqv);
                ...
                android.view.View findViewById2 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.rji);
            ...
            android.widget.TextView textView = (android.widget.TextView) viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.odf);
            if (textView != null) {
                rx4.h hVar2 = e0Var.f482674h;
                textView.setText(hVar2 != null ? hVar2.f482693c : null);
            }
            android.widget.TextView textView2 = (android.widget.TextView) viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.f566757rr2);
            if (textView2 != null) {
                textView2.setText(e0Var.f482671e ? "收起" : "展开");
            }
            android.view.View findViewById3 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.f566755rr1);
            if (findViewById3 != null) {
                findViewById3.setRotation(e0Var.f482671e ? 180.0f : 0.0f);
            }
            if (!e0Var.f482672f) {
                android.view.View findViewById4 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.rqw);
                ...
                android.view.View findViewById5 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.rqx);
            ...
            if (z17) {
                ...
                rx4.h hVar3 = e0Var.f482674h;
                if (hVar3 != null) {
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.d(u17);
                    hVar3.f482694d = rx4.e0.f482669p.a(u17, 20);
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FTSNativeTeachHistoryBoxUIC", "FTSHistoryBlock fill, liveItems: " + ((java.util.ArrayList) hVar3.f482694d).size());
                }
                rx4.h hVar4 = e0Var.f482674h;
                if (hVar4 != null) {
                    hVar4.a(e0Var.f482677n);
                }
            }
            rx4.h hVar5 = e0Var.f482674h;
            java.lang.Class<rx4.h2> cls3 = rx4.h2.class;
            java.lang.String str4 = "getContext(...)";
            if (((hVar5 == null || (list2 = hVar5.f482694d) == null) ? 0 : ((java.util.ArrayList) list2).size()) > 0) {
                rx4.h hVar6 = e0Var.f482674h;
                p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar6);
                int size = ((java.util.ArrayList) hVar6.f482694d).size();
                android.view.View findViewById6 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.f566754rr0);
                if (findViewById6 != null) {
                    int i28 = (size <= 4 || e0Var.f482672f) ? 8 : 0;
                ...
                if (e0Var.f482671e || e0Var.f482672f) {
                    min = java.lang.Math.min(size, 20);
                } else {
                    rx4.h hVar7 = e0Var.f482674h;
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar7);
                    min = java.lang.Math.min(((java.util.ArrayList) hVar7.f482694d).size(), 4);
                }
                int i29 = 2;
                int i37 = (min - 1) / 2;
                if (i37 >= 0) {
                    int i38 = 0;
                    while (true) {
                        android.widget.LinearLayout linearLayout2 = new android.widget.LinearLayout(e0Var.m158354x19263085());
                        ...
                        while (it.hasNext()) {
                            ...
                            rx4.h hVar8 = e0Var.f482674h;
                            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(hVar8);
                            rx4.i iVar = (rx4.i) kz5.n0.a0(hVar8.f482694d, intValue);
                            if (iVar == null) {
                                ...
                                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(context, str4);
                                pf5.z zVar = pf5.z.f435481a;
                                if (!(context instanceof p012xc85e97e9.p016x746ad0e3.app.ActivityC0065xcd7aa112)) {
                                    throw new java.lang.IllegalStateException("Check failed.".toString());
                                }
                                p012xc85e97e9.p093xedfae76a.c1 a17 = zVar.a((p012xc85e97e9.p016x746ad0e3.app.ActivityC0065xcd7aa112) context).a(cls3);
                                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(a17, "get(...)");
                                rx4.h2 h2Var = (rx4.h2) a17;
                                if (h2Var.i7()) {
                                    android.view.View inflate = android.view.LayoutInflater.from(e0Var.m158354x19263085()).inflate(h2Var.E ? com.p314xaae8f345.mm.R.C30864xbddafb2a.eg7 : com.p314xaae8f345.mm.R.C30864xbddafb2a.eg8, (android.view.ViewGroup) null);
                                    ...
                                    if (iVar.f482724g) {
                                        android.widget.LinearLayout linearLayout3 = (android.widget.LinearLayout) viewGroup.findViewById(com.p314xaae8f345.mm.R.id.nwj);
                                        if (linearLayout3 != null) {
                                            linearLayout3.setVisibility(0);
                                        }
                                        ((android.widget.TextView) viewGroup.findViewById(com.p314xaae8f345.mm.R.id.vcd)).setText(iVar.f482725h);
                                    }
                                } else {
                                    android.view.View inflate2 = android.view.LayoutInflater.from(e0Var.m158354x19263085()).inflate(h2Var.E ? com.p314xaae8f345.mm.R.C30864xbddafb2a.duk : com.p314xaae8f345.mm.R.C30864xbddafb2a.ega, (android.view.ViewGroup) null);
                                ...
                                int i48 = intValue % 2;
                                boolean z18 = e0Var.f482672f;
                                float f17 = e0Var.f482675i;
                                if (z18) {
                                    i18 = i37;
                                    int i49 = (int) (4 * f17);
                                    layoutParams.setMargins(0, i49, 0, i49);
                                    viewGroup.setPadding(i49, i49, i49, i49);
                                    viewGroup.setBackgroundColor(b3.l.m9702x7444d5ad(e0Var.m158354x19263085(), com.p314xaae8f345.mm.R.C30859x5a72f63.f560025d));
                                    android.view.View findViewById7 = viewGroup.findViewById(com.p314xaae8f345.mm.R.id.f565569cs5);
                                ...
                                android.widget.TextView textView3 = (android.widget.TextView) viewGroup.findViewById(com.p314xaae8f345.mm.R.id.f565464ci2);
                ...
                cls = cls3;
                if (e0Var.f482672f) {
                    android.view.View findViewById8 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.rqv);
                    ...
                    android.view.View findViewById9 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.cgz);
                    ...
                    android.view.View findViewById10 = viewGroup2.findViewById(com.p314xaae8f345.mm.R.id.rji);
                    if (findViewById10 != null) {
                        ...
                        android.widget.TextView textView4 = (android.widget.TextView) findViewById10.findViewById(com.p314xaae8f345.mm.R.id.f565761dg2);
                        if (textView4 != null) {
            ...
            ((rx4.h2) zVar2.a((p012xc85e97e9.p016x746ad0e3.app.ActivityC0065xcd7aa112) context2).a(cls)).z7();
        }
