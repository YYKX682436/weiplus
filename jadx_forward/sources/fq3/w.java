    ...
    public void Ai(java.lang.String str, long j17, boolean z17, java.lang.String str2) {
        if (gm0.j1.a()) {
            if (!str.matches("\\d+")) {
                ...
                if (nVar.f347069u != null) {
                    fq3.n nVar2 = (fq3.n) i95.n0.c(fq3.n.class);
                    nVar2.m134976x2690a4ac();
                    nVar2.f347069u.a(new fq3.r(this, str, j17, z17, str2));
                    return;
                }
                return;
            }
            com.p314xaae8f345.mm.p2621x8fb0427b.f9 Li = pt0.f0.Li(str2, java.lang.Long.parseLong(str));
            if (Li.m124847x74d37ac6() == 0 || Li.A0() != 0) {
                return;
            }
            if (oq3.k.f428927a.c(4, Li.Q0()) == 0) {
                fq3.n nVar3 = (fq3.n) i95.n0.c(fq3.n.class);
                nVar3.m134976x2690a4ac();
                if (nVar3.f347069u != null) {
                    fq3.n nVar4 = (fq3.n) i95.n0.c(fq3.n.class);
                    nVar4.m134976x2690a4ac();
                    nVar4.f347069u.a(new fq3.r(this, str, j17, z17, str2));
                    return;
                }
                return;
            }
            ...
            nVar5.A.Z6(str3);
            kq3.i.e(Li);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.C2CPreDownloadPLC", "c2c pre download: file msg open, msgId:" + Li.m124847x74d37ac6());
        }
    }
    ...
    public void Bi(long j17, java.lang.String str, boolean z17, boolean z18) {
        if (gm0.j1.a()) {
            ...
            if (nVar.f347069u != null) {
                fq3.n nVar2 = (fq3.n) i95.n0.c(fq3.n.class);
                nVar2.m134976x2690a4ac();
                nVar2.f347069u.a(new fq3.t(this, j17, str, z17, z18));
            }
        }
    }
    ...
    public void Di(java.lang.String str, int i17) {
        if (gm0.j1.a()) {
            ...
            if (nVar.f347069u != null) {
                fq3.n nVar2 = (fq3.n) i95.n0.c(fq3.n.class);
                nVar2.m134976x2690a4ac();
                nVar2.f347069u.a(new fq3.v(this, str, i17));
            }
        }
    }
        ...
        if (gm0.j1.a()) {
            if (!str.matches("\\d+")) {
                ...
                if (nVar.f347069u != null) {
                    fq3.n nVar2 = (fq3.n) i95.n0.c(fq3.n.class);
                    nVar2.m134976x2690a4ac();
                    nVar2.f347069u.a(new fq3.q(this, z17, str, j17, z18, z19));
                    return;
                }
                return;
            }
            if (oq3.k.f428927a.c(4, pt0.f0.Li(str2, java.lang.Long.parseLong(str)).Q0()) != 0) {
                if (z17 || !z18) {
                    return;
                }
                ((fq3.n) i95.n0.c(fq3.n.class)).aj();
            ...
            if (nVar3.f347069u != null) {
                fq3.n nVar4 = (fq3.n) i95.n0.c(fq3.n.class);
                nVar4.m134976x2690a4ac();
                nVar4.f347069u.a(new fq3.q(this, z17, str, j17, z18, z19));
            }
        }
    }
}
