...
public final class b implements java.io.Closeable {
    ...
    public final boolean f302646d = ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.c0.clicfg_ilink_android_buffer_manager_v2, false);

    /* renamed from: e, reason: collision with root package name */
    public final cp5.d f302647e = new cp5.d();

    /* renamed from: f, reason: collision with root package name */
    public final cp5.c f302648f = new cp5.c("MicroMsg.MTR.BufferManager", false, 0);

    /* renamed from: g, reason: collision with root package name */
    public final android.util.SparseArray f302649g = new android.util.SparseArray();

    /* renamed from: h, reason: collision with root package name */
    public final android.util.SparseArray f302650h = new android.util.SparseArray();
    ...
    */
    public final cp5.a a(int r6, boolean r7) {
        /*
            r5 = this;
            boolean r0 = r5.f302646d
            if (r0 == 0) goto L68
            cp5.d r7 = r5.f302647e
            boolean r0 = r7.f302666c
            r1 = 1
            if (r0 != 0) goto L14
            r7.f302666c = r1
        ...
        L14:
            cp5.c r0 = r7.f302664a
            java.util.concurrent.atomic.AtomicLong r2 = r0.f302657f
            r2.incrementAndGet()
            java.util.concurrent.atomic.AtomicLong r2 = r0.f302661j
            long r3 = (long) r6
            r2.addAndGet(r3)
            int r2 = r6 + 16384
            int r2 = r2 + (-1)
            int r2 = r2 / 16384
            int r2 = r2 * 16384
            java.util.concurrent.ConcurrentHashMap r7 = r7.f302665b
        ...
        L42:
            ...
            if (r7 == 0) goto L58
            java.util.concurrent.atomic.AtomicLong r0 = r0.f302658g
            r0.incrementAndGet()
            r7.clear()
            r7.limit(r6)
            goto L62
        ...
        L62:
            ...
            return r6
        L68:
            cp5.c r0 = r5.f302648f
            java.util.concurrent.atomic.AtomicLong r1 = r0.f302657f
            r1.incrementAndGet()
            java.util.concurrent.atomic.AtomicLong r1 = r0.f302661j
            long r2 = (long) r6
            r1.addAndGet(r2)
            android.util.SparseArray r1 = r5.f302650h
        ...
        Laf:
            if (r3 == 0) goto Lbf
            r3.clear()
            java.util.concurrent.atomic.AtomicLong r6 = r0.f302658g
            r6.incrementAndGet()
            cp5.a r6 = new cp5.a
            r6.<init>(r5, r3, r7)
            return r6
    ...
    public final void b(java.nio.ByteBuffer buffer) {
        ...
        if (!this.f302646d) {
            android.util.SparseArray sparseArray = this.f302650h;
        ...
        cp5.d dVar = this.f302647e;
        dVar.getClass();
        if (buffer.isDirect()) {
            java.util.concurrent.ConcurrentHashMap concurrentHashMap = dVar.f302665b;
    ...
    public void close() {
        ...
        if (this.f302646d) {
            cp5.d dVar = this.f302647e;
            dVar.getClass();
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MTR.BufferManagerV2", "close");
            dVar.f302665b.clear();
            cp5.c cVar = dVar.f302664a;
            cVar.h(true);
            com.p314xaae8f345.mm.p1006xc5476f33.vqm.f fVar = cVar.f302655d;
            if (fVar != null) {
                cVar.i();
                com.p314xaae8f345.mm.p1006xc5476f33.vqm.a.f258826b.b(fVar);
            }
        } else {
            cp5.c cVar2 = this.f302648f;
            cVar2.h(true);
            com.p314xaae8f345.mm.p1006xc5476f33.vqm.f fVar2 = cVar2.f302655d;
            if (fVar2 != null) {
                cVar2.i();
                com.p314xaae8f345.mm.p1006xc5476f33.vqm.a.f258826b.b(fVar2);
            }
        }
        this.f302649g.clear();
    }
