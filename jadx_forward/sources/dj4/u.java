...
public final class u {
    ...
    public static final dj4.u f314582a = new dj4.u();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f314583b = new java.util.LinkedHashMap();
    ...
    public final java.lang.String a(android.widget.ImageView iv6, mj4.h info) {
        ...
        java.lang.Object tag = iv6.getTag(com.p314xaae8f345.mm.R.id.rrh);
        java.lang.String str = tag instanceof java.lang.String ? (java.lang.String) tag : null;
        java.lang.String f17 = f(info);
        if ((str == null || r26.n0.N(str)) || !p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, f17)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "setHeaderView: img old oldIvBindInfo=" + str + ", newIvBindInfo=" + f17 + ", iv = " + iv6.hashCode());
            iv6.setImageBitmap(null);
        }
        f314583b.put(java.lang.String.valueOf(iv6.hashCode()), f17);
        return f17;
    }
    ...
    public final void b(android.content.Context context, android.widget.ImageView iv6, java.lang.String username, mj4.h info, java.lang.String str, java.lang.String filePath, dj4.a aVar, int i17, boolean z17) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(kVar.p())) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "downloadImgAndSet: no imgUrl, had default back");
                g(iv6, info);
            } else if (com.p314xaae8f345.mm.vfs.w6.j(filePath)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "downloadImgAndSet: no imgUrl, exist file=".concat(filePath));
                dj4.w.a(new dj4.f(filePath, iv6, info, weakReference, f17));
            } else {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.TextStatus.StatusImgHandler", "downloadImgAndSet: hardcode default back, no imgUrl, no backgroundId, not exist file=".concat(filePath));
                iv6.setImageResource(bk4.e1.f102993a.b("text_state_default_image_11"));
            }
            if (aVar != null) {
                ((dj4.h) aVar).a();
                return;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "downloadImgAndSet: img==null fileExists:" + com.p314xaae8f345.mm.vfs.w6.j(filePath));
    ...
    public final void d(android.content.Context context, android.widget.ImageView iv6, java.lang.String username, mj4.h info, boolean z17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(username, "username");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(info, "info");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "handleImgOnlyByUrl called with: context = " + context + ", iv = " + iv6 + ", username = " + username + ", useThumb = " + z17);
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("handleImgOnlyByUrl info = ");
        sb6.append(info);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", sb6.toString());
        int hashCode = info.hashCode();
        iv6.setTag(com.p314xaae8f345.mm.R.id.f565654d41, java.lang.Integer.valueOf(hashCode));
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(i17)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "handleImgOnlyByUrl: no imgUrl, try default back");
            g(iv6, info);
        } else {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", sb7.toString());
            if (Bi == null) {
                java.lang.String b17 = bk4.n.f103046a.b(i17);
                if (com.p314xaae8f345.mm.vfs.w6.j(b17)) {
                    dj4.w.a(new dj4.i(b17, i17, iv6, info, context, a17));
                } else {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.TextStatus.StatusImgHandler", "handleImgOnlyByUrl: try default back, load imgUrl, no bitmap, no file " + b17 + ", ");
                    g(iv6, info);
        ...
        iv6.setTag(com.p314xaae8f345.mm.R.id.rrh, a17);
    }
    ...
    public final void e(android.content.Context context, android.widget.ImageView iv6, java.lang.String imgUrl, java.lang.String tag, boolean z17, float f17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "loadByUrl() called with: context = " + context + ", iv = " + iv6 + ", imgUrl = " + imgUrl + ", tag = " + tag + ", isBlur = " + z17 + ", blurRadius = " + f17);
        iv6.setTag(com.p314xaae8f345.mm.R.id.f565654d41, tag);
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(imgUrl)) {
            return;
        }
        ...
        java.lang.String b17 = bk4.n.f103046a.b(imgUrl);
        if (!com.p314xaae8f345.mm.vfs.w6.j(b17)) {
            ((j70.e) ((k70.g0) i95.n0.c(k70.g0.class))).Ui(imgUrl, new dj4.p(b17, imgUrl, iv6, tag, z17, context, f17));
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "loadByUrl: filePath:" + b17);
    ...
    public final void g(android.widget.ImageView imageView, mj4.h hVar) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", sb6.toString());
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(kVar.p())) {
            imageView.setImageResource(bk4.e1.f102993a.b(kVar.p()));
    ...
    public final void h(android.content.Context context, java.lang.String username, android.widget.ImageView iv6, mj4.h hVar, boolean z17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(username, "username");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(iv6, "iv");
        com.p314xaae8f345.mm.sdk.p2603x2137b148.Log.c("MicroMsg.TextStatus.StatusImgHandler", "setHeaderView() called with: context = " + context + ", username = " + username + ", iv = " + iv6 + ", onlyUseThumb = " + z17, new java.lang.Object[0]);
        ...
        if (z17) {
            ...
            java.lang.String j17 = kVar3.f408600b.f76525x91a52c19 == 2 ? "" : kVar3.j();
            java.lang.String g18 = nVar2.g("image", kVar3.l(), j17);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "downloadPicsAndSet>> called with: context = " + context + ", iv = " + iv6.hashCode() + ", statusId = " + kVar3.l() + ", username = " + username + ", infoHash = " + hashCode + ", picUrl = " + j17 + ", picFilePath = " + g18);
            if (!android.text.TextUtils.isEmpty(j17) && !android.text.TextUtils.isEmpty(g18)) {
                ...
                if (Bi != null) {
                    ...
                    boolean j18 = com.p314xaae8f345.mm.vfs.w6.j(g18);
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "downloadPicsAndSet>> imgFileExist exist=" + j18 + ", path=" + g18);
                    if (j18) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "begin download thumb:".concat(str3));
    ...
    public final void j(java.lang.String username, mj4.h info) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(username, "username");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(info, "info");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "triggerDownloadThumb() called with: username = " + username + ", info = " + info);
        ...
        if (Ni == 2) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "do not triggerDownloadThumb");
            return;
        }
        boolean z17 = (Ni == 0 && ((mj4.k) info).f408600b.f76525x91a52c19 == 1) ? false : true;
        if (z17) {
            j17 = ((mj4.k) info).i();
        } else {
            if (z17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "triggerDownloadThumb preloadStrategy=" + Ni + ", useThumb=" + z17);
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(j17) || ((j70.e) ((k70.v) i95.n0.c(k70.v.class))).Bi(j17) != null) {
            return;
        }
        mj4.k kVar = (mj4.k) info;
        java.lang.String g17 = bk4.n.f103046a.g(z17 ? "thumb" : "image", kVar.l(), j17);
        boolean j18 = com.p314xaae8f345.mm.vfs.w6.j(g17);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.StatusImgHandler", "triggerDownloadThumb: no memory cache, fileExists=" + j18 + ", filePath=" + g17 + ", statusId=" + kVar.l());
        if (j18 || g17 == null) {
            return;
        }
