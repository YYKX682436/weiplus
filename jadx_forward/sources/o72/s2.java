...
public abstract class s2 {
    ...
    public static final java.util.concurrent.ConcurrentHashMap f424994a = new java.util.concurrent.ConcurrentHashMap();

    public static void a(long j17, java.lang.String str) {
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = f424994a;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("[#FavPost#]", "bindSession localId=%d, curSessionId=%s, newSessionId=%s", java.lang.Long.valueOf(j17), str2, str);
    }
    ...
    public static void g(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.Object... objArr) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str, "[#FavPost#] " + d(str2, str3, objArr));
    }
    ...
    public static java.lang.String n(java.lang.String str) {
        return com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) ? "null" : str;
    }
    ...
    public static void o(final java.lang.String str) {
        ...
        f424994a.entrySet().removeIf(new java.util.function.Predicate() { // from class: o72.s2$$a
    ...
    public static void p(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.Object... objArr) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(str, "[#FavPost#] " + d(str2, str3, objArr));
    }
}
