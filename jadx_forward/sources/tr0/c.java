...
public final class c implements android.hardware.Camera.AutoFocusCallback {
    ...
    public final /* synthetic */ tr0.d f502821d;
    ...
    */
    public final void onAutoFocus(boolean r3, android.hardware.Camera r4) {
        /*
            r2 = this;
            tr0.d r3 = r2.f502821d
            r3.getClass()
            wo.h r4 = r3.f502822e     // Catch: java.lang.Exception -> L45
            if (r4 == 0) goto L13
            wo.d1 r4 = r4.f529246a     // Catch: java.lang.Exception -> L45
            if (r4 == 0) goto L13
            boolean r4 = r4.f529187c     // Catch: java.lang.Exception -> L45
            r0 = 1
            if (r4 != r0) goto L13
            goto L14
        L13:
        ...
        L2d:
            if (r1 == 0) goto L4c
            java.lang.String r1 = r3.f502823f     // Catch: java.lang.Exception -> L45
            if (r1 == 0) goto L4c
            r4.setFocusMode(r1)     // Catch: java.lang.Exception -> L45
            r3.f502823f = r0     // Catch: java.lang.Exception -> L45
            wo.h r3 = r3.f502822e     // Catch: java.lang.Exception -> L45
            if (r3 == 0) goto L3e
            wo.d1 r0 = r3.f529246a     // Catch: java.lang.Exception -> L45
        L3e:
            if (r0 != 0) goto L41
            goto L4c
        L41:
