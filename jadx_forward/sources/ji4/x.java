...
public final class x extends et1.c implements vg3.p4 {
    ...
    public java.lang.Object f(java.lang.String sessionId) {
        ...
        return ni4.x.f419309d.h().z0(sessionId);
    }
    ...
    public void k(java.lang.String sessionId) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.TextStatus.TextStatusConversationUpdater", "[onConversationMsgEmpty] " + z07.f72763xa3c65b86);
        if (z07.f72763xa3c65b86 > 0) {
            z07.f76569xf66fcca9 = "";
            xVar.h().m145258xce0038c9(z07.f72763xa3c65b86, z07, false);
            xVar.h().mo142179xf35bbb4(z07.f76582xbed8694c, 1, z07);
        }
    }
    ...
    public void l(java.lang.Object obj) {
        ...
        if (conversation.f72763xa3c65b86 <= 0) {
            ni4.x xVar = ni4.x.f419309d;
            xVar.h().mo51731x24249762(conversation, false);
            xVar.h().mo142179xf35bbb4(conversation.f76582xbed8694c, 2, conversation);
        } else {
            ni4.x xVar2 = ni4.x.f419309d;
            xVar2.h().m145258xce0038c9(conversation.f72763xa3c65b86, conversation, false);
            xVar2.h().mo142179xf35bbb4(conversation.f76582xbed8694c, 1, conversation);
        }
        mj4.w Ai = ((ki4.x) i95.n0.c(ki4.x.class)).Ai(conversation.f76582xbed8694c);
        if (Ai != null) {
            java.lang.String str = Ai.f76640x21f9b213;
            if (!(str == null || r26.n0.N(str))) {
                java.lang.String str2 = Ai.f76645x44fa3ce;
        ...
        ki4.x.wi((ki4.x) c17, new jz5.l(conversation.f76582xbed8694c, conversation.f76584x114ef53e), null, null, false, 14, null);
    }

    @Override // et1.c
    public boolean m(java.lang.String sessionId) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(sessionId, "sessionId");
        return com.p314xaae8f345.mm.p2621x8fb0427b.z3.H4(sessionId);
    }
    ...
    */
    public java.lang.Object n(java.lang.Object r18, java.lang.Object r19, com.p314xaae8f345.mm.p2621x8fb0427b.f9 r20, et1.b r21, int r22, xg3.l0 r23) {
        /*
