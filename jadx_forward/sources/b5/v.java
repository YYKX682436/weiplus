...
public class v extends l4.r {
    ...
    public final /* synthetic */ p012xc85e97e9.p125x37c711.p126x316220.C1266x839c9ed3 f99424b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v(p012xc85e97e9.p125x37c711.p126x316220.C1266x839c9ed3 c1266x839c9ed3, int i17) {
        super(i17);
        this.f99424b = c1266x839c9ed3;
    }
    ...
    public l4.s b(p4.b bVar) {
        ...
        hashSet.add(new n4.d("WorkSpec", "CASCADE", "CASCADE", java.util.Arrays.asList("work_spec_id"), java.util.Arrays.asList(dm.i4.f66865x76d1ec5a)));
        hashSet.add(new n4.d("WorkSpec", "CASCADE", "CASCADE", java.util.Arrays.asList("prerequisite_id"), java.util.Arrays.asList(dm.i4.f66865x76d1ec5a)));
        ...
        hashSet5.add(new n4.d("WorkSpec", "CASCADE", "CASCADE", java.util.Arrays.asList("work_spec_id"), java.util.Arrays.asList(dm.i4.f66865x76d1ec5a)));
        ...
        hashSet7.add(new n4.d("WorkSpec", "CASCADE", "CASCADE", java.util.Arrays.asList("work_spec_id"), java.util.Arrays.asList(dm.i4.f66865x76d1ec5a)));
        n4.g gVar4 = new n4.g("SystemIdInfo", hashMap4, hashSet7, new java.util.HashSet(0));
        n4.g a27 = n4.g.a(bVar, "SystemIdInfo");
        if (!gVar4.m149084xb2c87fbf(a27)) {
        ...
        hashMap5.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54571xe817953d, new n4.c(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54571xe817953d, "TEXT", true, 1, null, 1));
        hashMap5.put("work_spec_id", new n4.c("work_spec_id", "TEXT", true, 2, null, 1));
        java.util.HashSet hashSet8 = new java.util.HashSet(1);
        hashSet8.add(new n4.d("WorkSpec", "CASCADE", "CASCADE", java.util.Arrays.asList("work_spec_id"), java.util.Arrays.asList(dm.i4.f66865x76d1ec5a)));
        ...
        hashSet10.add(new n4.d("WorkSpec", "CASCADE", "CASCADE", java.util.Arrays.asList("work_spec_id"), java.util.Arrays.asList(dm.i4.f66865x76d1ec5a)));
        n4.g gVar6 = new n4.g("WorkProgress", hashMap6, hashSet10, new java.util.HashSet(0));
        n4.g a29 = n4.g.a(bVar, "WorkProgress");
        if (!gVar6.m149084xb2c87fbf(a29)) {
