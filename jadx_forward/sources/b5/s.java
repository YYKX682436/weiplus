...
public class s extends m4.a {
    ...
    public final android.content.Context f99414c;

    public s(android.content.Context context) {
        super(9, 10);
        this.f99414c = context;
    }
    ...
    public void a(p4.b bVar) {
        ...
        android.content.Context context = this.f99414c;
        ...
        android.database.sqlite.SQLiteDatabase sQLiteDatabase = cVar.f441540d;
