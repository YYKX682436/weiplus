...
public class q extends i95.w implements uy4.x {
    public boolean Ai() {
        az4.h.f97712c.getClass();
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.d().getBoolean("key_has_enter_welab", false)) {
            return false;
        }
    ...
    public void Bi(android.content.Context context, android.content.Intent intent) {
        intent.setClass(context, com.p314xaae8f345.mm.p1006xc5476f33.p2443x6bc77ff.ui.ActivityC19512xacf356cc.class);
