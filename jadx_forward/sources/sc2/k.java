...
public final class k implements android.view.ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final /* synthetic */ android.view.View f487537d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f487538e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ int f487539f;
    ...
    public void onGlobalLayout() {
        android.view.View view = this.f487537d;
        view.getViewTreeObserver().removeOnGlobalLayoutListener(this);
        int[] iArr = new int[2];
        int[] iArr2 = new int[2];
        view.getLocationOnScreen(iArr);
        android.view.View view2 = this.f487538e;
        view2.getLocationOnScreen(iArr2);
        int i17 = iArr[1];
        int n17 = i17 - (iArr2[1] + hc2.f1.n(view2));
        int i18 = this.f487539f;
        if (n17 < i18) {
