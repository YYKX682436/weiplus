...
public final class x0 implements j0.l3 {
    ...
    public final /* synthetic */ k0.y0 f384504a;
    ...
    public void b(long j17) {
        j0.d5 d5Var;
        k0.y0 y0Var = this.f384504a;
        if (y0Var.j().f349226a.f82214d.length() == 0) {
            return;
        }
        long f17 = d1.e.f(y0Var.f384520m, j17);
        y0Var.f384520m = f17;
        j0.c5 c5Var = y0Var.f384511d;
        if (c5Var != null && (d5Var = c5Var.f377772g) != null) {
            d1.e eVar = new d1.e(d1.e.f(y0Var.f384518k, f17));
            n0.v2 v2Var = y0Var.f384522o;
            ((n0.q4) v2Var).mo148714x53d8522f(eVar);
            java.lang.Integer num = y0Var.f384519l;
            int intValue = num != null ? num.intValue() : d5Var.b(y0Var.f384518k, false);
            d1.e eVar2 = (d1.e) ((n0.q4) v2Var).mo128745x754a37bb();
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(eVar2);
            k0.y0.c(y0Var, y0Var.j(), intValue, d5Var.b(eVar2.f307160a, false), false, k0.u.f384497c);
        }
    ...
    */
    public void c(long r10) {
        /*
            r9 = this;
            k0.y0 r6 = r9.f384504a
            n0.v2 r0 = r6.f384521n
            n0.q4 r0 = (n0.q4) r0
            java.lang.Object r0 = r0.mo128745x754a37bb()
            j0.u1 r0 = (j0.u1) r0
            if (r0 == 0) goto Lf
            return
        Lf:
            j0.u1 r0 = j0.u1.SelectionEnd
            n0.v2 r1 = r6.f384521n
            n0.q4 r1 = (n0.q4) r1
            r1.mo148714x53d8522f(r0)
            j0.c5 r0 = r6.f384511d
            r1 = 1
            r2 = 0
            if (r0 == 0) goto L53
            j0.d5 r0 = r0.f377772g
            if (r0 == 0) goto L53
            long r3 = r0.a(r10)
            long r3 = r0.c(r3)
            float r5 = d1.e.d(r3)
            a2.k1 r0 = r0.f377798a
            int r5 = r0.g(r5)
            float r7 = d1.e.c(r3)
            float r8 = r0.h(r5)
        ...
        L54:
            ...
            long r10 = r0.c(r10)
            float r10 = d1.e.d(r10)
            a2.k1 r11 = r0.f377798a
            int r10 = r11.g(r10)
            int r10 = r11.e(r10, r2)
            g2.t r1 = (g2.t) r1
            r1.getClass()
            k1.a r11 = r6.f384515h
            if (r11 == 0) goto L8f
            r0 = 9
            k1.b r11 = (k1.b) r11
            r11.a(r0)
        L8f:
            g2.e0 r11 = r6.j()
            a2.d r11 = r11.f349226a
            long r0 = a2.n1.a(r10, r10)
            g2.e0 r10 = r6.e(r11, r0)
            r6.h()
            yz5.l r11 = r6.f384510c
            r11.mo146xb9724478(r10)
            return
        La6:
            g2.e0 r0 = r6.j()
            a2.d r0 = r0.f349226a
            java.lang.String r0 = r0.f82214d
            int r0 = r0.length()
            if (r0 != 0) goto Lb5
            r2 = r1
        Lb5:
        ...
        Lda:
            ...
            d1.e r0 = new d1.e
            r0.<init>(r10)
            n0.v2 r10 = r6.f384522o
            n0.q4 r10 = (n0.q4) r10
            r10.mo148714x53d8522f(r0)
