...
public abstract class d {
    ...
    public static boolean f86640a;

    /* renamed from: b, reason: collision with root package name */
    public static int f86641b;

    /* renamed from: c, reason: collision with root package name */
    public static int f86642c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.concurrent.ConcurrentHashMap f86643d = new java.util.concurrent.ConcurrentHashMap();
    ...
    public static boolean c(android.content.Context context, android.graphics.Point point, boolean z17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSightUtil", "checkIfNeedUsePreviewLarge: previewSize: %s, displaySize: %s, displayRatio: %s, previewRatio: %s, diff: %s", point, f18, java.lang.Float.valueOf(f19), java.lang.Float.valueOf(f27), java.lang.Float.valueOf(abs));
        return abs > 0.01f;
    }
    ...
    public static android.graphics.Point d(android.graphics.Point point, android.graphics.Point point2, boolean z17, boolean z18) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSightUtil", "getCropPreviewSizeWithHeight, previewSize: %s, displaySize: %s, width: %s, newWidth: %s, makeMediaCodecHappy %s, , isRoate: %s", point2, point, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i19), java.lang.Boolean.valueOf(z18), java.lang.Boolean.valueOf(z17));
        if (i19 <= point2.x) {
            return new android.graphics.Point(i19, i18);
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSightUtil", "can not adapt to screen");
        return null;
    }
    ...
    public static android.graphics.Point e(android.graphics.Point point, android.graphics.Point point2, boolean z17, boolean z18) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSightUtil", "getCropPreviewSizeWithHeight, previewSize: %s, displaySize: %s, width: %s, newHeight: %s makeMediaCodecHappy %s, newWidth: %s, isRoate: %s", point2, point, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i27), java.lang.Boolean.valueOf(z18), java.lang.Integer.valueOf(i28), java.lang.Boolean.valueOf(z17));
    ...
    public static android.graphics.Point f(android.content.Context context) {
        ...
        if (!f86640a && com.p314xaae8f345.mm.ui.bk.k(context)) {
            h17.y -= com.p314xaae8f345.mm.ui.bk.j(context);
        }
        return h17;
    }
    ...
    public static java.lang.String g(java.lang.String str) {
        ...
        objArr[0] = yp5.a.f545942a.a() ? "wx_camera_" : "w_camera_";
    ...
    public static java.lang.String i(java.lang.String str) {
        try {
            return com.p314xaae8f345.mm.p1006xc5476f33.p2083x685d99d.p2084x2e06d1.e.e(str);
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMSightUtil", "getMediaInfo error: %s", e17.getMessage());
            return null;
        }
    }

    public static android.graphics.Point j() {
        return com.p314xaae8f345.mm.ui.bk.h(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a);
    }

    public static java.lang.String k(java.lang.String str) {
        int i17 = f86641b;
        f86641b = i17 + 1;
        com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(java.lang.String.format("%s/tempvideo%s.mp4", str, java.lang.Integer.valueOf(i17)));
        if (r6Var.m()) {
            r6Var.l();
        }
        ...
        com.p314xaae8f345.mm.vfs.r6 r6Var4 = new com.p314xaae8f345.mm.vfs.r6(r6Var.n() + ".soundmp4");
        if (r6Var4.m()) {
            r6Var4.l();
        }
        di3.u.f314296a.m77784x795fa299(new ai3.b(f86641b - 3, str));
        return r6Var.o();
    }

    public static java.lang.String l(java.lang.String str) {
        com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(java.lang.String.format("%s/%s.mp4", str, java.lang.Long.valueOf(java.lang.System.currentTimeMillis())));
        if (r6Var.m()) {
            r6Var.l();
        }
        return r6Var.o();
    ...
    public static long n(java.lang.String str) {
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = f86643d;
    ...
    */
    ...
    public static byte[] w(byte[] bArr, int i17, int i18, int i19) {
        ...
        byte[] m17 = ei3.x.f334720d.m(java.lang.Integer.valueOf(bArr.length));
        int i27 = i17 * i18;
    ...
    public static void x(java.lang.String str) {
        boolean z17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.f274522a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMSightUtil", "setTime key %s %s", str, com.p314xaae8f345.mm.sdk.p2603x2137b148.z3.b(true));
        f86643d.put(str, java.lang.Long.valueOf(java.lang.System.currentTimeMillis()));
    }
}
