...
public final class f0 implements t6.n {
    ...
    public final d7.d f308336a = new d7.d();
    ...
    public w6.z0 a(java.lang.Object obj, int i17, int i18, t6.l lVar) {
        ...
        java.util.concurrent.atomic.AtomicReference atomicReference2 = q7.c.f441823a;
        ...
        while (true) {
            ...
            if (read < 0) {
                ...
                return this.f308336a.a(android.graphics.ImageDecoder.createSource((java.nio.ByteBuffer) java.nio.ByteBuffer.allocateDirect(byteArray.length).put(byteArray).position(0)), i17, i18, lVar);
            }
