...
public final class p implements t6.f {
    ...
    public static final byte[] f308364a = "Exif\u0000\u0000".getBytes(java.nio.charset.Charset.forName(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));

    /* renamed from: b, reason: collision with root package name */
    public static final int[] f308365b = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};
    ...
    public int c(java.io.InputStream inputStream, x6.b bVar) {
        ...
        while (true) {
            java.io.InputStream inputStream2 = oVar.f308362a;
            if (((short) (inputStream2.read() & 255)) == 255) {
                ...
                if (read != 217) {
                    ...
                    long j17 = i17;
                    if (oVar.mo123612x35e57f(j17) != j17) {
                        android.util.Log.isLoggable("DfltImageHeaderParser", 3);
                        break;
                    }
                } else {
    ...
    public final com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498 d(d7.n nVar) {
        int a17 = nVar.a();
        if (a17 == 65496) {
            return com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.JPEG;
        }
        int a18 = ((a17 << 16) & (-65536)) | (nVar.a() & 65535);
        if (a18 == -1991225785) {
            nVar.mo123612x35e57f(21L);
            return nVar.b() >= 3 ? com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.PNG_A : com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.PNG;
        }
        if ((a18 >> 8) == 4671814) {
            return com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.GIF;
        }
        if (a18 != 1380533830) {
            return com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.UNKNOWN;
        }
        nVar.mo123612x35e57f(4L);
        ...
        if (i17 == 88) {
            nVar.mo123612x35e57f(4L);
            return (nVar.b() & 16) != 0 ? com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.WEBP_A : com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.WEBP;
        }
        if (i17 != 76) {
            return com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.WEBP;
        }
        nVar.mo123612x35e57f(4L);
        return (nVar.b() & 8) != 0 ? com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.WEBP_A : com.p147xb1cd08cc.p148x5de23a5.p149x32c4e6.EnumC1427x7be2d498.WEBP;
    }
    ...
    public final int e(d7.n nVar, byte[] bArr, int i17) {
        ...
        java.nio.ByteBuffer byteBuffer = mVar.f308357a;
