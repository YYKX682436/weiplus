...
public class l0 implements t6.n {
    ...
    public final d7.y f308355a;

    /* renamed from: b, reason: collision with root package name */
    public final x6.b f308356b;
    ...
    public w6.z0 a(java.lang.Object obj, int i17, int i18, t6.l lVar) {
        ...
        if (inputStream instanceof d7.i0) {
            ...
            z17 = true;
            i0Var = new d7.i0(inputStream, this.f308356b);
        }
        java.util.Queue queue = q7.f.f441827f;
        synchronized (queue) {
        ...
        fVar.f441828d = i0Var;
        try {
            w6.z0 a17 = this.f308355a.a(new q7.l(fVar), i17, i18, lVar, new d7.k0(i0Var, fVar));
            fVar.f441829e = null;
            fVar.f441828d = null;
            synchronized (queue) {
            ...
            if (z17) {
                i0Var.m123609x41012807();
            }
            return a17;
        } catch (java.lang.Throwable th6) {
            fVar.f441829e = null;
            fVar.f441828d = null;
            java.util.Queue queue2 = q7.f.f441827f;
            synchronized (queue2) {
