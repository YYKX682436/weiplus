...
public final class g extends android.text.style.ReplacementSpan {
    ...
    public final float f307295d;

    /* renamed from: e, reason: collision with root package name */
    public final int f307296e;

    /* renamed from: f, reason: collision with root package name */
    public final float f307297f;

    /* renamed from: g, reason: collision with root package name */
    public final int f307298g;

    /* renamed from: h, reason: collision with root package name */
    public final float f307299h;

    /* renamed from: i, reason: collision with root package name */
    public final int f307300i;

    /* renamed from: m, reason: collision with root package name */
    public android.graphics.Paint.FontMetricsInt f307301m;
    ...
    public final android.graphics.Paint.FontMetricsInt a() {
        android.graphics.Paint.FontMetricsInt fontMetricsInt = this.f307301m;
        if (fontMetricsInt != null) {
            return fontMetricsInt;
        }
        p3321xbce91901.jvm.p3324x21ffc6bd.o.o("fontMetrics");
        throw null;
    }

    public final int b() {
        if (this.f307304p) {
            return this.f307303o;
        }
    ...
    public int getSize(android.graphics.Paint paint, java.lang.CharSequence charSequence, int i17, int i18, android.graphics.Paint.FontMetricsInt fontMetricsInt) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(fontMetricsInt2, "paint.fontMetricsInt");
        this.f307301m = fontMetricsInt2;
        if (!(a().descent > a().ascent)) {
            throw new java.lang.IllegalArgumentException("Invalid fontMetrics: line height can not be negative.".toString());
        }
        float f18 = this.f307299h;
        float f19 = this.f307295d;
        int i19 = this.f307296e;
        if (i19 == 0) {
            f17 = f19 * f18;
        } else {
            if (i19 != 1) {
        ...
        this.f307302n = (int) java.lang.Math.ceil(f17);
        float f27 = this.f307297f;
        int i27 = this.f307298g;
        if (i27 == 0) {
        ...
        this.f307303o = (int) ceil;
        if (fontMetricsInt != null) {
            fontMetricsInt.ascent = a().ascent;
            fontMetricsInt.descent = a().descent;
            fontMetricsInt.leading = a().leading;
            switch (this.f307300i) {
                case 0:
