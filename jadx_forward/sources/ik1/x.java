...
public class x {
    ...
    public final java.util.Map f373378a = new x.b();

    public void a() {
        synchronized (this.f373378a) {
            java.util.Iterator it = ((x.b) this.f373378a).values().iterator();
            while (it.hasNext()) {
                ((java.util.Set) it.next()).clear();
            }
            ((x.n) this.f373378a).clear();
        }
    }
    ...
    public final java.util.Set c(java.lang.Object obj, boolean z17) {
        java.util.Set set;
        synchronized (this.f373378a) {
            set = (java.util.Set) ((x.n) this.f373378a).m174751x4aabfc28(obj, null);
            if (set == null && z17) {
                set = new java.util.HashSet();
                ((x.n) this.f373378a).put(obj, set);
            }
        }
        return set;
    }
    ...
    public java.util.Set g(java.lang.Object obj) {
        ...
        synchronized (this.f373378a) {
            set = (java.util.Set) ((x.n) this.f373378a).m174754xc84af884(obj);
        }
        return set;
    }
}
