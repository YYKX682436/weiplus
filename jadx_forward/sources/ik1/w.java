...
public abstract class w {
    ...
    public static java.lang.Float f373376b;

    /* renamed from: a, reason: collision with root package name */
    public static final android.util.DisplayMetrics f373375a = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getResources().getDisplayMetrics();

    /* renamed from: c, reason: collision with root package name */
    public static boolean f373377c = true;
    ...
    public static int b(org.json.JSONArray jSONArray) {
        ...
        return (!f373377c || (yVar = nf.x.f418149b) == null) ? rgb : yVar.b(rgb);
    }
    ...
    public static float f() {
        java.lang.Float f17 = f373376b;
        if (f17 != null) {
            return f17.floatValue();
        }
        android.util.DisplayMetrics displayMetrics = f373375a;
    ...
    public static int l(java.lang.String str) {
        ...
        java.util.Map map = ik1.u.f373374a;
        ...
        if (str.length() == 7) {
            ...
            if (str.length() != 9) {
                com.p314xaae8f345.mm.sdk.p2603x2137b148.Log.c("MicroMsg.JsValueUtil", "hy: Unknown color, given string is %s", str);
