...
public abstract class b1 {
    public static final zq5.v a(long j17, long j18, gr5.n contentScale, gr5.b alignment, boolean z17, int i17) {
        ...
        if (zq5.h.b(j17) || zq5.h.b(j18)) {
            ...
            return zq5.v.f556627f;
        }
        if (i17 % 90 == 0) {
            return (zq5.v) ((jz5.n) new hr5.l(j17, j18, contentScale, alignment, i17, !z17, null).f365936o).mo141623x754a37bb();
        }
    ...
    public static final zq5.n b(long j17, long j18, gr5.n contentScale, gr5.b alignment, boolean z17, int i17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(alignment, "alignment");
        if (zq5.h.b(j17) || zq5.h.b(j18)) {
            return zq5.n.f556614e;
        }
        if (i17 % 90 == 0) {
            return (zq5.n) ((jz5.n) new hr5.l(j17, j18, contentScale, alignment, i17, !z17, null).f365935n).mo141623x754a37bb();
        }
        throw new java.lang.IllegalArgumentException("rotation must be multiple of 90".toString());
    }
    ...
    public static final zq5.n d(long j17, long j18, gr5.n contentScale, gr5.b alignment, boolean z17, int i17, float f17, long j19) {
        ...
        float f19 = other.f556615a;
        if (!(b19 > f19 && other.f556617c > b18 && c18 > other.f556616b && other.f556618d > c17)) {
            return nVar;
        }
        float f27 = other.f556616b;
        return zq5.o.b(zq5.o.c(zq5.o.a(zq5.o.b(new zq5.n(b18 - f19, c17 - f27, b19 - f19, c18 - f27), zq5.u.a(other.f556617c - f19, other.f556618d - f27)), contentScale.a(zq5.h.g(d17), zq5.h.g(j17))), zq5.h.g(j18), i17), zq5.h.g(j18));
    }
    ...
    public static final zq5.n f(long j17, long j18, gr5.n contentScale, gr5.b alignment, boolean z17, int i17, float f17, boolean z18, gr5.f containerWhitespace) {
        ...
        float f18 = containerWhitespace.f356454a;
        float f19 = containerWhitespace.f356457d;
        float f27 = containerWhitespace.f356456c;
        float f28 = containerWhitespace.f356455b;
        ...
        float f37 = b17.f556615a * f17;
        float f38 = b17.f556616b * f17;
        float f39 = b17.f556617c * f17;
        float f47 = b17.f556618d * f17;
        float f48 = f39 - f37;
        float f49 = f47 - f38;
        if (a06.d.b(f48) >= i18) {
            float f57 = -1;
    ...
    public static final long g(long j17, long j18, gr5.n contentScale, gr5.b alignment, boolean z17, int i17, float f17, long j19, long j27) {
        ...
        if (zq5.h.b(j17) || zq5.h.b(j18)) {
            ...
            j28 = zq5.l.e(d18, zq5.m.a(b17.f556615a, b17.f556616b));
        }
        return zq5.h.b(j17) ? zq5.l.f556610b : zq5.l.e(zq5.l.f(j28, f17), j19);
    }
}
