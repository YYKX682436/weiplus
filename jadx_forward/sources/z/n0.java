...
public final class n0 implements z.l0 {
    ...
    public final float f550280a;

    /* renamed from: b, reason: collision with root package name */
    public final z.o1 f550281b;
    ...
    public float b(long j17, float f17, float f18, float f19) {
        z.o1 o1Var = this.f550281b;
        o1Var.f550301a = f18;
        return java.lang.Float.intBitsToFloat((int) (o1Var.a(f17, f19, j17 / 1000000) & io.p3284xd2ae381c.p3285xac0c4757.p3286xcca8366f.C28565x745483d5.f70718x647d53d2));
    }
    ...
    public long c(float f17, float f18, float f19) {
        ...
        double d29;
        z.o1 o1Var = this.f550281b;
        double d37 = o1Var.f550302b;
        float f27 = o1Var.f550307g;
        float f28 = this.f550280a;
        ...
        z.z a17 = z.a0.a(d58);
        a17.f550413a = (a17.f550413a + d57) / 2.0d;
        a17.f550414b /= 2.0d;
        z.z a18 = z.a0.a(d58);
        double d59 = -1;
        double d66 = a18.f550413a * d59;
        double d67 = a18.f550414b * d59;
        a18.f550413a = (d66 + d57) / 2.0d;
        a18.f550414b = d67 / 2.0d;
        if (d48 == 0.0d) {
            if (d47 == 0.0d) {
                j17 = 0;
                return j17 * 1000000;
        ...
        if (d39 > 1.0d) {
            double d69 = a17.f550413a;
            double d76 = a18.f550413a;
            double d77 = d69 - d76;
            ...
            if (java.lang.Math.abs(((java.lang.Number) m1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue()) >= 1.0E-4d) {
                int i18 = 0;
                while (d68 > 0.001d && i18 < 100) {
                    i18++;
                    double doubleValue = d19 - (((java.lang.Number) m1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue() / ((java.lang.Number) n1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue());
                    d68 = java.lang.Math.abs(d19 - doubleValue);
                    d19 = doubleValue;
                }
            }
        } else if (d39 < 1.0d) {
            double d87 = a17.f550413a;
            double d88 = (d47 - (d87 * abs)) / a17.f550414b;
            d19 = java.lang.Math.log(d49 / java.lang.Math.sqrt((abs * abs) + (d88 * d88))) / d87;
        } else {
            double d89 = a17.f550413a;
            double d96 = d89 * abs;
            double d97 = d47 - d96;
            ...
            if (!java.lang.Double.isNaN(d100) && d100 > 0.0d) {
                ...
                while (d68 > 0.001d && i17 < 100) {
                    i17++;
                    double doubleValue2 = d19 - (((java.lang.Number) k1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue() / ((java.lang.Number) l1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue());
            ...
            while (d68 > 0.001d) {
                i17++;
                double doubleValue22 = d19 - (((java.lang.Number) k1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue() / ((java.lang.Number) l1Var.mo146xb9724478(java.lang.Double.valueOf(d19))).doubleValue());
