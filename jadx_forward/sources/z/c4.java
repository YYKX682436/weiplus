...
public final class c4 implements z.x3 {
    ...
    public final java.util.Map f550154a;

    /* renamed from: b, reason: collision with root package name */
    public final int f550155b;

    /* renamed from: c, reason: collision with root package name */
    public final int f550156c;
    ...
    public c4(java.util.Map keyframes, int i17, int i18) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(keyframes, "keyframes");
        this.f550154a = keyframes;
        this.f550155b = i17;
        this.f550156c = i18;
    }
    ...
    public z.w c(long j17, z.w initialValue, z.w targetValue, z.w initialVelocity) {
        ...
        java.util.Map map = this.f550154a;
        if (map.containsKey(valueOf)) {
            return (z.w) ((jz5.l) kz5.c1.h(map, java.lang.Integer.valueOf(h17))).f384366d;
        }
        int i17 = this.f550155b;
        if (h17 >= i17) {
            return targetValue;
        }
        if (h17 <= 0) {
        ...
        for (java.util.Map.Entry entry : map.entrySet()) {
            ...
            if (h17 > intValue && intValue >= i18) {
                wVar = (z.w) lVar.f384366d;
                h0Var = (z.h0) lVar.f384367e;
                i18 = intValue;
            } else if (h17 < intValue && intValue <= i17) {
                targetValue = (z.w) lVar.f384366d;
                i17 = intValue;
            }
        }
        float a17 = h0Var.a((h17 - i18) / (i17 - i18));
        if (this.f550157d == null) {
            this.f550157d = initialValue.c();
            this.f550158e = initialValue.c();
        }
        int b17 = wVar.b();
        for (int i19 = 0; i19 < b17; i19++) {
            z.w wVar2 = this.f550157d;
            if (wVar2 == null) {
