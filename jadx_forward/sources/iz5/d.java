...
public class d extends iz5.b {
    ...
    public final java.lang.String f377703d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f377704e;
    ...
    public java.lang.String getMessage() {
        java.lang.String str = this.f377703d;
        java.lang.String str2 = this.f377704e;
        ...
        while (true) {
            int i17 = cVar.f377701b;
            if (i17 >= min || str.charAt(i17) != str2.charAt(cVar.f377701b)) {
                break;
            }
            cVar.f377701b++;
        }
        ...
        cVar.f377702c = str.length() - length;
