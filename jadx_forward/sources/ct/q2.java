...
public interface q2 extends i95.m {
    static void k5(ct.q2 q2Var, boolean z17, int i17, boolean z18, boolean z19, boolean z27, int i18, java.lang.Object obj) {
        ...
        if (arrayList.isEmpty()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ChatRecordsStagingFeatureService", "asyncPrepareChatRecordPlainTexts: no messages");
        } else {
            v65.i.b(l0Var.f444590s, null, new qg5.t(l0Var, arrayList, rVar, z28, z29, z37, z38, i19, null), 1, null);
        }
    }
}
