...
public abstract class b3 {
    ...
    public static final java.util.ArrayList f496239a = new java.util.ArrayList(3);
    ...
    public static java.lang.String a(java.lang.String str) {
        if (str == null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.VideoInfoStorage", "[getTable] fileName is null. %s", new com.p314xaae8f345.mm.sdk.p2603x2137b148.z3());
            return "videoinfo2";
        }
        java.util.Iterator it = f496239a.iterator();
        while (it.hasNext()) {
            t21.a3 a3Var = (t21.a3) it.next();
            if (!a3Var.f496235b.isEmpty() && str.toLowerCase().endsWith(a3Var.f496235b)) {
                return a3Var.f496234a;
            }
        }
        return "videoinfo2";
    }
    ...
    public static java.lang.String b(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var) {
        ...
        if (f9Var.A0() == 0) {
            ...
            try {
                ...
                if (split.length > 1) {
                    com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.V(split[1], 0L);
                }
                if (split.length > 2) {
                    split[2].equals("1");
                }
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.VideoContent", "VoiceContent parse failed.");
            }
        }
        if (Q0 != null) {
            return d(Q0);
        ...
        boolean z17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.f274522a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.VideoInfoStorage", "[getTable] human is null. %s", new com.p314xaae8f345.mm.sdk.p2603x2137b148.z3());
        return "videoinfo2";
    }
    ...
    public static java.lang.String c(java.lang.String str) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.VideoInfoStorage", "[getTableByTalker] talker is null. %s", new com.p314xaae8f345.mm.sdk.p2603x2137b148.z3());
        return "videoinfo2";
    }
    ...
    public static java.lang.String d(java.lang.String str) {
        ...
        return str != null && str.endsWith("@zhugemsg") ? "zhugemsgvideoinfo" : com.p314xaae8f345.mm.p2621x8fb0427b.z3.G3(str) ? "bizphotofansvideoinfo" : "videoinfo2";
    }

    public static void e(java.lang.String str, java.lang.String str2, java.lang.String[] strArr) {
        f496239a.add(new t21.a3(str.toLowerCase(), str2, strArr));
    }
}
