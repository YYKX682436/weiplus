...
public final class m {
    ...
    public static final a5.m f82943b;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.Map f82944a;
    ...
    public m(a5.m mVar) {
        this.f82944a = new java.util.HashMap(mVar.f82944a);
    }
    ...
    public static byte[] d(a5.m mVar) {
        ...
        try {
            objectOutputStream.writeInt(((java.util.HashMap) mVar.f82944a).size());
            for (java.util.Map.Entry entry : ((java.util.HashMap) mVar.f82944a).entrySet()) {
    ...
    public int b(java.lang.String str, int i17) {
        java.lang.Object obj = this.f82944a.get(str);
    ...
    /* renamed from: equals */
    public boolean m593xb2c87fbf(java.lang.Object obj) {
        if (this == obj) {
            return true;
        }
        ...
        a5.m mVar = (a5.m) obj;
        java.util.Map map = this.f82944a;
        java.util.Set<java.lang.String> keySet = map.keySet();
        if (!keySet.equals(mVar.f82944a.keySet())) {
            return false;
        }
        for (java.lang.String str : keySet) {
            java.lang.Object obj2 = map.get(str);
            java.lang.Object obj3 = mVar.f82944a.get(str);
    ...
    public int m594x8cdac1b() {
        return this.f82944a.hashCode() * 31;
    }

    /* renamed from: toString */
    public java.lang.String m595x9616526c() {
    ...
    public m(java.util.Map map) {
        this.f82944a = new java.util.HashMap(map);
    }
}
