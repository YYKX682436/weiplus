...
public abstract class g implements java.lang.Iterable {
    ...
    public static final p16.g f432816d = new p16.f0(new byte[0]);
    ...
    public p16.g e(p16.g gVar) {
        ...
        int mo157707x35e0012 = gVar.mo157707x35e001();
        if (mo157707x35e001 + mo157707x35e0012 >= 2147483647L) {
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder(53);
            sb6.append("ByteString would be too long: ");
            sb6.append(mo157707x35e001);
            sb6.append("+");
            sb6.append(mo157707x35e0012);
        ...
        if (gVar.mo157707x35e001() == 0) {
            return this;
        }
        if (mo157707x35e001() == 0) {
            return gVar;
        }
        int mo157707x35e0013 = mo157707x35e001() + gVar.mo157707x35e001();
        if (mo157707x35e0013 < 128) {
            int mo157707x35e0014 = mo157707x35e001();
            int mo157707x35e0015 = gVar.mo157707x35e001();
            byte[] bArr = new byte[mo157707x35e0014 + mo157707x35e0015];
            g(bArr, 0, 0, mo157707x35e0014);
            gVar.g(bArr, 0, mo157707x35e0014, mo157707x35e0015);
            return new p16.f0(bArr);
        }
        if (o0Var != null) {
            p16.g gVar3 = o0Var.f432866g;
            if (gVar3.mo157707x35e001() + gVar.mo157707x35e001() < 128) {
                int mo157707x35e0016 = gVar3.mo157707x35e001();
                int mo157707x35e0017 = gVar.mo157707x35e001();
                byte[] bArr2 = new byte[mo157707x35e0016 + mo157707x35e0017];
                gVar3.g(bArr2, 0, 0, mo157707x35e0016);
                gVar.g(bArr2, 0, mo157707x35e0016, mo157707x35e0017);
                return new p16.o0(o0Var.f432865f, new p16.f0(bArr2));
            }
        }
        if (o0Var != null) {
            p16.g gVar4 = o0Var.f432865f;
            int j17 = gVar4.j();
            p16.g gVar5 = o0Var.f432866g;
            if (j17 > gVar5.j()) {
                if (o0Var.f432868i > gVar.j()) {
                    return new p16.o0(gVar4, new p16.o0(gVar5, gVar));
                }
            }
        }
        if (mo157707x35e0013 >= p16.o0.f432863n[java.lang.Math.max(j(), gVar.j()) + 1]) {
            gVar2 = new p16.o0(this, gVar);
        } else {
            p16.l0 l0Var = new p16.l0(null);
            l0Var.a(this);
            l0Var.a(gVar);
            java.util.Stack stack = l0Var.f432853a;
    ...
    /* renamed from: size */
    public abstract int mo157707x35e001();

    /* renamed from: toString */
    public java.lang.String m157709x9616526c() {
        return java.lang.String.format("<ByteString@%s size=%d>", java.lang.Integer.toHexString(java.lang.System.identityHashCode(this)), java.lang.Integer.valueOf(mo157707x35e001()));
    }
}
