...
public class f0 extends p16.g {
    ...
    public final byte[] f432814e;

    /* renamed from: f, reason: collision with root package name */
    public int f432815f = 0;
    ...
    /* renamed from: equals */
    public boolean m157705xb2c87fbf(java.lang.Object obj) {
        if (obj == this) {
            return true;
        }
        if (!(obj instanceof p16.g) || mo157707x35e001() != ((p16.g) obj).mo157707x35e001()) {
            return false;
        }
        ...
        if (obj instanceof p16.f0) {
            return t((p16.f0) obj, 0, mo157707x35e001());
        }
    ...
    public void h(byte[] bArr, int i17, int i18, int i19) {
        java.lang.System.arraycopy(this.f432814e, i17, bArr, i18, i19);
    }

    /* renamed from: hashCode */
    public int m157706x8cdac1b() {
        int i17 = this.f432815f;
        if (i17 == 0) {
            int mo157707x35e001 = mo157707x35e001();
            i17 = n(mo157707x35e001, 0, mo157707x35e001);
            if (i17 == 0) {
                i17 = 1;
            }
            this.f432815f = i17;
    ...
    */
    ...
    @Override // p16.g
    public int p() {
        return this.f432815f;
    }

    @Override // p16.g
    public java.lang.String r(java.lang.String str) {
        return new java.lang.String(this.f432814e, u(), mo157707x35e001(), str);
    }

    @Override // p16.g
    public void s(java.io.OutputStream outputStream, int i17, int i18) {
        outputStream.write(this.f432814e, u() + i17, i18);
    }

    @Override // p16.g
    /* renamed from: size */
    public int mo157707x35e001() {
        return this.f432814e.length;
    }

    public boolean t(p16.f0 f0Var, int i17, int i18) {
        if (i18 > f0Var.mo157707x35e001()) {
            int mo157707x35e001 = mo157707x35e001();
        ...
        if (i17 + i18 <= f0Var.mo157707x35e001()) {
            int u17 = u() + i18;
            int u18 = u();
            int u19 = f0Var.u() + i17;
            while (u18 < u17) {
                if (this.f432814e[u18] != f0Var.f432814e[u19]) {
                    return false;
                }
                u18++;
                u19++;
        ...
        int mo157707x35e0012 = f0Var.mo157707x35e001();
