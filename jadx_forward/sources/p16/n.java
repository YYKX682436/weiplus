...
public final class n {
    ...
    public static final p16.n f432856d = new p16.n(true);

    /* renamed from: a, reason: collision with root package name */
    public final p16.w0 f432857a;

    /* renamed from: b, reason: collision with root package name */
    public boolean f432858b;

    /* renamed from: c, reason: collision with root package name */
    public boolean f432859c = false;

    public n() {
        int i17 = p16.w0.f432896i;
        this.f432857a = new p16.p0(16);
    }
    ...
    public static int c(p16.g1 g1Var, java.lang.Object obj) {
        switch (g1Var.ordinal()) {
            ...
            case 8:
                try {
                    byte[] bytes = ((java.lang.String) obj).getBytes(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
                    return p16.j.f(bytes.length) + bytes.length;
                } catch (java.io.UnsupportedEncodingException e17) {
                    throw new java.lang.RuntimeException("UTF-8 not supported.", e17);
                }
            case 9:
                return ((p16.h0) obj).mo134562x9d9c349b();
            case 10:
                return p16.j.e((p16.h0) obj);
            case 11:
                if (obj instanceof p16.g) {
                    p16.g gVar = (p16.g) obj;
                    return p16.j.f(gVar.mo157707x35e001()) + gVar.mo157707x35e001();
                }
                byte[] bArr = (byte[]) obj;
            ...
            case 13:
                return obj instanceof p16.w ? p16.j.c(((p16.w) obj).mo134573x276ffe3f()) : p16.j.c(((java.lang.Integer) obj).intValue());
            case 14:
                ((java.lang.Integer) obj).intValue();
                return 4;
            case 15:
    ...
    public static int d(p16.m mVar, java.lang.Object obj) {
        ...
        int i17 = tVar.f432879d;
        if (!tVar.f432881f) {
            int h17 = p16.j.h(i17);
            if (g1Var == p16.g1.f432819h) {
                h17 *= 2;
            }
    ...
    public static java.lang.Object i(p16.h hVar, p16.g1 g1Var, boolean z17) {
        ...
        switch (g1Var.ordinal()) {
            ...
            case 8:
                if (!z17) {
                    int k17 = hVar.k();
                    int i17 = hVar.f432826b;
                    int i18 = hVar.f432828d;
                    if (k17 > i17 - i18 || k17 <= 0) {
                        return k17 == 0 ? "" : new java.lang.String(hVar.h(k17), com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
                    }
                    java.lang.String str = new java.lang.String(hVar.f432825a, i18, k17, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
                    hVar.f432828d += k17;
                    return str;
                }
                int k18 = hVar.k();
                int i19 = hVar.f432828d;
                if (k18 <= hVar.f432826b - i19 && k18 > 0) {
                    hVar.f432828d = i19 + k18;
                    h17 = hVar.f432825a;
                } else {
                    if (k18 == 0) {
                        return "";
                ...
                if (p16.b1.b(h17, i19, i19 + k18) == 0) {
                    return new java.lang.String(h17, i19, k18, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
                }
    ...
    */
        ...
        switch (g1Var.ordinal()) {
            ...
            case 13:
                if (obj instanceof p16.w) {
                    jVar.n(((p16.w) obj).mo134573x276ffe3f());
                    return;
                } else {
                    jVar.n(((java.lang.Integer) obj).intValue());
                    return;
    ...
    public final boolean f(java.util.Map.Entry entry) {
        ...
        while (it.hasNext()) {
            if (!((p16.h0) it.next()).mo134563xf582434a()) {
                return false;
            }
        }
        return true;
    ...
    public void g() {
        ...
        p16.p0 p0Var = (p16.p0) this.f432857a;
        if (!p0Var.f432900g) {
            for (int i17 = 0; i17 < p0Var.f432898e.size(); i17++) {
                java.util.Map.Entry entry = (java.util.Map.Entry) p0Var.f432898e.get(i17);
                if (((p16.t) ((p16.m) entry.getKey())).f432881f) {
            ...
            for (java.util.Map.Entry entry2 : p0Var.c()) {
                if (((p16.t) ((p16.m) entry2.getKey())).f432881f) {
                    entry2.setValue(java.util.Collections.unmodifiableList((java.util.List) entry2.getValue()));
                }
            }
        }
        if (!p0Var.f432900g) {
            p0Var.f432899f = p0Var.f432899f.isEmpty() ? java.util.Collections.emptyMap() : java.util.Collections.unmodifiableMap(p0Var.f432899f);
            p0Var.f432900g = true;
        }
        this.f432858b = true;
    }
    ...
    public final void h(java.util.Map.Entry entry) {
        ...
        java.lang.Object value = entry.getValue();
        p16.t tVar = (p16.t) mVar;
        boolean z17 = tVar.f432881f;
        p16.w0 w0Var = this.f432857a;
        if (z17) {
            java.lang.Object e17 = e(mVar);
            if (e17 == null) {
        ...
        if (tVar.f432880e.f432823d != p16.h1.MESSAGE) {
        ...
        if (e18 != null) {
            w0Var.e(mVar, ((p16.p) ((p16.h0) e18).mo134565xaaa148a0()).b((p16.v) ((p16.h0) value)).mo134566x59bc66e());
            return;
        }
        if (value instanceof byte[]) {
    ...
    public void j(p16.m mVar, java.lang.Object obj) {
        if (!((p16.t) mVar).f432881f) {
            ...
            while (it.hasNext()) {
                k(((p16.t) mVar).f432880e, it.next());
            }
            obj = arrayList;
        }
        this.f432857a.e(mVar, obj);
    }

    public n(boolean z17) {
        int i17 = p16.w0.f432896i;
        this.f432857a = new p16.p0(0);
        g();
    }
}
