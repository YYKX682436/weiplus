...
public class b extends kn1.a {
    ...
    public static on1.b f428336b;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f428337c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.concurrent.ConcurrentHashMap f428338d;

    static {
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = new java.util.concurrent.ConcurrentHashMap();
        f428338d = concurrentHashMap;
    ...
    public on1.i c(int i17) {
        return (on1.i) f428338d.get(java.lang.Integer.valueOf(i17));
    }
}
