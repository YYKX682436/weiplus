...
public class a {
    ...
    public final c3.b f119617a;

    public a(android.content.Context context, android.content.pm.ShortcutInfo shortcutInfo) {
        java.lang.String string;
        c3.b bVar = new c3.b();
        this.f119617a = bVar;
        bVar.f119618a = shortcutInfo.getId();
        shortcutInfo.getPackage();
        android.content.Intent[] intents = shortcutInfo.getIntents();
        bVar.f119619b = (android.content.Intent[]) java.util.Arrays.copyOf(intents, intents.length);
        shortcutInfo.getActivity();
        bVar.f119620c = shortcutInfo.getShortLabel();
        bVar.f119621d = shortcutInfo.getLongLabel();
        ...
        c3.b bVar2 = this.f119617a;
        shortcutInfo.getUserHandle();
        bVar2.getClass();
        c3.b bVar3 = this.f119617a;
        shortcutInfo.getLastChangedTimestamp();
        bVar3.getClass();
        int i27 = android.os.Build.VERSION.SDK_INT;
        if (i27 >= 30) {
            c3.b bVar4 = this.f119617a;
            shortcutInfo.isCached();
            bVar4.getClass();
        }
        c3.b bVar5 = this.f119617a;
        shortcutInfo.isDynamic();
        bVar5.getClass();
        c3.b bVar6 = this.f119617a;
        shortcutInfo.isPinned();
        bVar6.getClass();
        c3.b bVar7 = this.f119617a;
        shortcutInfo.isDeclaredInManifest();
        bVar7.getClass();
        c3.b bVar8 = this.f119617a;
        shortcutInfo.isImmutable();
        bVar8.getClass();
        c3.b bVar9 = this.f119617a;
        shortcutInfo.isEnabled();
        bVar9.getClass();
        c3.b bVar10 = this.f119617a;
        shortcutInfo.hasKeyFieldsOnly();
        bVar10.getClass();
        c3.b bVar11 = this.f119617a;
        if (i27 < 29) {
        ...
        bVar11.getClass();
        c3.b bVar12 = this.f119617a;
        shortcutInfo.getRank();
        bVar12.getClass();
        c3.b bVar13 = this.f119617a;
