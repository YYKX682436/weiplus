...
public final class l2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ du3.s2 f325180d;
    ...
    public final void onClick(android.view.View view) {
        ...
        du3.s2 s2Var = this.f325180d;
        hk0.z0 S6 = s2Var.D().S6();
        hk0.z0 z0Var = hk0.z0.f363398g;
        if (S6 == z0Var) {
            s2Var.D().g7(s2Var.f325235n, true);
        } else {
            s2Var.f325235n = s2Var.D().S6();
            s2Var.D().g7(z0Var, true);
        }
        nu3.i.c(nu3.i.f421751a, "KEY_CLICK_MOSAIC_COUNT", 0, 2, null);
