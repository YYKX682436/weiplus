...
public final class k3 implements p012xc85e97e9.p093xedfae76a.k0 {
    ...
    public final /* synthetic */ du3.t3 f325175d;
    ...
    public void mo525x7bb163d5(java.lang.Object obj) {
        hk0.z0 z0Var = ((hk0.y0) obj).f363379a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ImproveEditPhotoPreviewPlugin", "observeMosaicState >> type: " + z0Var);
        int ordinal = z0Var.ordinal();
        qk.g6 g6Var = qk.g6.MOSAIC;
        du3.t3 t3Var = this.f325175d;
        if (ordinal == 1) {
        ...
        if (ordinal != 2) {
            if (ordinal != 3) {
                t3Var.G();
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ImproveEditPhotoPreviewPlugin", "unSelect all mosaic");
                return;
            } else {
