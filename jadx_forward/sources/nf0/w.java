...
public class w implements com.p314xaae8f345.mm.ui.cd, j45.k {
    ...
    public boolean b(android.content.Context context, java.lang.String str, android.content.Intent intent, int i17, com.p314xaae8f345.mm.ui.x7 x7Var) {
        if ((!str.endsWith(".TopStoryHomeUI") && !str.endsWith(".TopStoryHomeAffinityUI")) || !((uh4.c0) i95.n0.c(uh4.c0.class)).mo168058x74219ae7()) {
            return false;
        }
