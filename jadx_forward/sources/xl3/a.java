...
public class a implements android.media.AudioManager.OnAudioFocusChangeListener {
    ...
    public final /* synthetic */ xl3.b f536649d;
    ...
    public void onAudioFocusChange(int i17) {
        ...
        if (i17 == -1) {
            ...
            xl3.b bVar = this.f536649d;
            android.media.AudioManager audioManager = bVar.f536650a;
            if (audioManager != null) {
                audioManager.abandonAudioFocus(bVar.f536651b);
            }
        }
    }
}
