...
public final class l3 extends android.text.style.ClickableSpan {
    ...
    public final java.lang.ref.WeakReference f479328d;

    public l3(java.lang.ref.WeakReference rActivity) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(rActivity, "rActivity");
        this.f479328d = rActivity;
    }
    ...
    public void onClick(android.view.View widget) {
        ...
        android.app.Activity activity = (android.app.Activity) this.f479328d.get();
        if (activity == null) {
            int i17 = rl.b.f478676a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LotteryCreateLicenseSpanClick", "on click but activity is null!", null);
