...
public final class w {
    ...
    public final rn2.t2 f479435a;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f479436b;

    /* renamed from: c, reason: collision with root package name */
    public final com.p314xaae8f345.mm.sdk.p2597xc267989b.C20976x6ba6452a f479437c;

    public w(rn2.t2 viewCallback) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(viewCallback, "viewCallback");
        this.f479435a = viewCallback;
        this.f479436b = "FinderLiveLotteryCreateGiftHelper";
        this.f479437c = new com.p314xaae8f345.mm.sdk.p2597xc267989b.C20976x6ba6452a("FinderLiveLotteryCreateGiftHelper", viewCallback.f479386e, 0, 4, null);
    }
    ...
    public static final void a(rn2.w wVar, android.view.View view, android.widget.TextView textView, android.view.View view2, android.widget.TextView textView2, java.util.List list) {
        ...
        int i18 = ((rn2.y2) kz5.n0.X(list)).f479460b;
        if (i17 > 0 && i17 <= i18) {
            z17 = true;
        }
        view.setEnabled(z17);
        ...
        while (it6.hasNext()) {
            ...
            if (y2Var.f479459a) {
                f17 += y2Var.f479461c.m75939xb282bd08(1) * y2Var.f479462d.m75938x746dc8a6(9);
            }
        }
    ...
    public final void b(r45.gz1 gz1Var, java.util.List list) {
        ...
        int i17;
        java.lang.String str = this.f479436b;
        rn2.t2 t2Var = this.f479435a;
        if (gz1Var == null) {
            android.view.View view = t2Var.f479391l1;
            if (view != null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(str, "updateLotteryGiftList but prizeMethod is null");
        }
        ...
        if (gz1Var.m75939xb282bd08(0) == 2) {
            if (!(arrayList == null || arrayList.isEmpty())) {
                android.view.View view2 = t2Var.f479406x0;
                if (view2 != null) {
                ...
                p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4 c1163xf1deaba4 = t2Var.f479409y0;
                if (c1163xf1deaba4 != null) {
                    c1163xf1deaba4.mo7967x900dcbe1(new p012xc85e97e9.p103xe821e364.p104xd1075a44.C1162x665295de(t2Var.f479386e, 0, false));
                    rn2.k3 k3Var = new rn2.k3(false, false, 3, null);
                    k3Var.x().clear();
                    k3Var.x().addAll(arrayList);
                    k3Var.m8146xced61ae5();
                    c1163xf1deaba4.mo7960x6cab2c8d(k3Var);
                }
            }
        }
        android.widget.TextView textView = t2Var.f479397p1;
        if (textView != null) {
            if (arrayList == null || arrayList.isEmpty()) {
                i17 = 0;
            } else {
                ...
                float f17 = 0.0f;
                while (it.hasNext()) {
                    f17 += ((rn2.y2) it.next()).f479462d.m75938x746dc8a6(9) * r11.f479461c.m75939xb282bd08(1);
                }
                i17 = (int) f17;
            }
            textView.setText(java.lang.String.valueOf(i17));
        }
        android.widget.TextView textView2 = t2Var.f479410y1;
        if (textView2 != null) {
            rn2.l0 l0Var = rn2.l0.f479325a;
            r45.vd4 vd4Var = (r45.vd4) gz1Var.m75936x14adae67(2);
            java.lang.Integer valueOf = vd4Var != null ? java.lang.Integer.valueOf(vd4Var.m75939xb282bd08(0)) : null;
            rn2.f fVar = t2Var.f479387f;
            textView2.setText(java.lang.String.valueOf(l0Var.c(valueOf, fVar != null ? ((rn2.c1) fVar).f479204n : 0, arrayList)));
        }
        r45.vd4 vd4Var2 = (r45.vd4) gz1Var.m75936x14adae67(2);
        if (vd4Var2 != null && vd4Var2.m75939xb282bd08(0) == 0) {
            android.view.View view3 = t2Var.f479391l1;
            if (view3 == null) {
                return;
            }
        ...
        android.view.View view4 = t2Var.f479391l1;
        if (view4 == null) {
            return;
        }
