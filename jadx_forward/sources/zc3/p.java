...
public final class p implements zc3.c {
    ...
    public iq0.c f552962a;

    /* renamed from: b, reason: collision with root package name */
    public zq0.a f552963b;
    ...
    public void a() {
        ...
        ((nq0.p) tVar).Vi(new iq0.i("MagicWorkerDemo", s0Var, s26.c.e(3000, s26.d.f483904f), null, null, null, 0.0d, null, null, 504, null));
    }

    @Override // zc3.c
    public void b(zq0.a container) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(container, "container");
        if (this.f552962a == null) {
            gq0.t tVar = (gq0.t) i95.n0.c(gq0.t.class);
    ...
    public void mo178669x35dafd() {
        zq0.a aVar;
        iq0.c cVar = this.f552962a;
        if (cVar == null || (aVar = this.f552963b) == null) {
            return;
        }
        aVar.getWidth();
        aVar.getHeight();
