...
public class p extends p012xc85e97e9.p016x746ad0e3.app.i0 {

    /* renamed from: f, reason: collision with root package name */
    public final android.content.Context f504239f;

    public p(android.content.Context context) {
        super(context, com.p314xaae8f345.mm.R.C30868x68b1db1.f575754hg);
        C(1);
        this.f504239f = context;
    }

    public final android.view.View D(int i17, android.view.View view, android.view.ViewGroup.LayoutParams layoutParams) {
        android.view.Window window = getWindow();
        android.content.Context context = this.f504239f;
        ...
        android.view.ViewGroup viewGroup = (android.view.ViewGroup) android.view.LayoutInflater.from(context).inflate(com.p314xaae8f345.mm.R.C30864xbddafb2a.f570687bh3, (android.view.ViewGroup) null);
        ...
        android.widget.FrameLayout frameLayout = displayMetrics2.widthPixels > displayMetrics2.heightPixels ? (android.widget.FrameLayout) viewGroup.findViewById(com.p314xaae8f345.mm.R.id.jhe) : (android.widget.FrameLayout) viewGroup.findViewById(com.p314xaae8f345.mm.R.id.jhc);
