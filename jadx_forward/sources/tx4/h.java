...
public enum h {
    ...
    public static final java.util.EnumMap f504220f = new java.util.EnumMap(tx4.h.class);

    /* renamed from: d, reason: collision with root package name */
    public final int f504222d;

    static {
        java.util.Iterator it = java.util.EnumSet.allOf(tx4.h.class).iterator();
        while (it.hasNext()) {
            tx4.h hVar = (tx4.h) it.next();
            f504220f.put((java.util.EnumMap) hVar, (tx4.h) java.lang.Integer.valueOf(hVar.f504222d));
        }
    }
