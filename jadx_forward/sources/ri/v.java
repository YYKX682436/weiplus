...
public final class v extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.l {
    ...
    public final /* synthetic */ long f477542d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ long f477543e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.os.health.HealthStats f477544f;
    ...
    public java.lang.Object mo146xb9724478(java.lang.Object obj) {
        ...
        myDict.put("uid-load", java.lang.Long.valueOf(a06.d.c((((float) this.f477542d) * 100.0f) / ((float) this.f477543e))));
        android.os.health.HealthStats healthStats = this.f477544f;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(healthStats, "<this>");
        if (healthStats.hasStats(10014)) {
            map = healthStats.getStats(10014);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(map, "getStats(...)");
        } else {
            map = kz5.q0.f395534d;
        }
        ...
        if (j17 > 0) {
            ...
            for (java.lang.Object obj2 : kz5.c1.q(kz5.n0.F0(kz5.e1.v(map), new ri.u())).entrySet()) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(g17, "getProcSuffix(...)");
