...
public abstract class j {
    public static u3.u a(int i17, int i18, pa5.l lVar, pa5.k kVar, float f17, float f18, float f19, int i19, java.lang.Object obj) {
        ...
        pa5.b bVar = new pa5.b(new p3321xbce91901.jvm.p3324x21ffc6bd.e0(), i17, i18, lVar);
    ...
    public static void b(android.view.View view, e06.f range, boolean z17, final yz5.a aVar, int i17, java.lang.Object obj) {
        ...
        if (!z17) {
            view.animate().alpha((float) ((java.lang.Number) range.g()).doubleValue()).setInterpolator(ta5.h.f498412a.a()).withEndAction(aVar != null ? new java.lang.Runnable(aVar) { // from class: pa5.g

                /* renamed from: d, reason: collision with root package name */
                public final /* synthetic */ yz5.a f434639d;
        ...
        animate.setInterpolator(ta5.h.f498412a.a()).setUpdateListener(new pa5.e(view, doubleValue2)).withEndAction(new pa5.f(animate, aVar)).start();
    }
    ...
    public static void c(android.view.View view, pa5.m property, float f17, float f18, float f19, float f27, u3.p pVar, int i17, java.lang.Object obj) {
        ...
        vVar.a(f19);
        vVar.b(f27);
        int a17 = com.p314xaae8f345.mm.ui.zk.a(view.getContext(), (int) f17);
        u3.u uVar = new u3.u(view, new pa5.n());
        uVar.f505766i = 0.002f;
        uVar.f505769t = vVar;
        uVar.f505758a = a17;
        if (pVar != null) {
            uVar.a(pVar);
