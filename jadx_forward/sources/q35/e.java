...
public abstract class e {
    ...
    public static final java.lang.String f441509a = "/storage/emulated/" + (android.os.Process.myUid() / 100000) + "/";

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.Boolean f441510b = null;
    ...
    public static android.util.Pair a(android.content.ContentResolver contentResolver, android.net.Uri uri) {
        ...
        com.p314xaae8f345.mm.vfs.r6 h07 = lp0.b.h0("fav_share_file_temp");
        if (!h07.m()) {
            h07.J();
        }
        com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(h07, e17);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "copy to file:" + r6Var.o());
        if (r6Var.m()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "file exist, delete old");
            r6Var.l();
        }
        try {
            try {
            ...
            try {
                ...
                try {
                    ...
                    e = e18;
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ShareUtil", e, "copy google photo img fail", new java.lang.Object[0]);
                    pair = new android.util.Pair(null, null);
    ...
    public static android.util.Pair b(android.content.ContentResolver contentResolver, android.net.Uri uri) {
        ...
        com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(h07, (java.lang.String) r27);
        try {
            try {
                r27 = com.p314xaae8f345.mm.vfs.w6.H(r6Var);
            } catch (java.lang.Throwable th6) {
                th = th6;
                r07 = contentResolver;
            }
    ...
    public static final java.lang.String c(android.content.ContentResolver contentResolver, android.net.Uri uri, int i17) {
        ...
        sb6.append(com.p314xaae8f345.mm.sdk.p2603x2137b148.w2.a(java.lang.System.currentTimeMillis() + "_" + uri));
        sb6.append(i17);
        sb6.append(d(type));
        com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(cacheDir, sb6.toString());
        r6Var.l();
        try {
            outputStream = com.p314xaae8f345.mm.vfs.w6.H(r6Var);
    ...
    */
    public static java.lang.String e(android.content.ContentResolver r17, android.net.Uri r18) {
        /*
            ...
            com.tencent.mm.vfs.z7 r0 = com.p314xaae8f345.mm.vfs.z7.a(r0)     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
            java.lang.String r4 = r0.f294812f
            if (r4 == 0) goto L49
            java.lang.String r14 = com.p314xaae8f345.mm.vfs.e8.l(r4, r9, r9)     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
            ...
            java.lang.String r12 = r0.f294810d     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
            java.lang.String r13 = r0.f294811e     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
            java.lang.String r15 = r0.f294813g     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
            java.lang.String r0 = r0.f294814h     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
            r11 = r4
            r16 = r0
        ...
        L47:
            ...
            goto L67
        L49:
            java.lang.String r0 = r0.f294812f     // Catch: java.lang.Exception -> L47 java.lang.Throwable -> L5a
        ...
        L67:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r2, r0, r4, r5)     // Catch: java.lang.Throwable -> L5a
        ...
        L83:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r2, r0, r1, r4)     // Catch: java.lang.Throwable -> L5a
        L8b:
            if (r3 == 0) goto L8e
            goto L5f
        L8e:
    ...
    public static java.lang.String f(java.lang.String str) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ShareUtil", "[-] path is null.");
            return null;
        }
        if (android.os.Build.VERSION.SDK_INT >= 29) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ShareUtil", "[!] only do copy on system below api 29.");
            return str;
        }
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ShareUtil", th6, "[-] Fail to call readlink.", new java.lang.Object[0]);
                    try {
                        str2 = new java.io.File(str).getCanonicalPath();
                    } catch (java.lang.Throwable unused) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ShareUtil", th6, "[-] Fail to call getCanonicalPath.", new java.lang.Object[0]);
                        str2 = str;
                    }
                }
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "[+] getPathToSafePlace, oldPath: %s, resolvedPath: %s", str, str2);
                if (!str.equalsIgnoreCase(str2) && !i(str).equalsIgnoreCase(i(str2))) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ShareUtil", "[!] getPathToSafePlace, oldPath[%s] is not equal to resolvedPath[%s], return null.", str, str2);
                    com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.v1(fileInputStream2);
                    return null;
                }
                if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.S0(str2)) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ShareUtil", "[!] getPathToSafePlace, resolvedPath[%s](orig:%s) is not allowed to be a copy source, return null.", str2, str);
                    com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.v1(fileInputStream2);
                    return null;
                }
                com.p314xaae8f345.mm.vfs.r7 r7Var = com.p314xaae8f345.mm.vfs.q7.f294674a;
                com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(lp0.b.h0("cpsafe"), new java.io.File(str2).getName());
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (read == -1) {
                            ...
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "[+] getPathToSafePlace, copy done, oldPath: %s, returnPath: %s", str, i17);
                    ...
                    try {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ShareUtil", th, "[-] Failure when check and copy path '%s' to safe place.", str);
                        return null;
                    } finally {
                        com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.v1(outputStream);
    ...
    public static java.lang.String g(android.content.ContentResolver contentResolver, java.lang.String str, android.net.Uri uri, boolean z17) {
        java.io.Closeable closeable;
        if (z17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "getShareFilePath srcPath is exists and canRead, return srcPath:" + str);
            return str;
        }
        if (f441510b == null) {
            boolean z18 = true;
            ...
            f441510b = java.lang.Boolean.valueOf(z18);
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "getShareFilePath useCopyFilePath == " + f441510b);
        if (!f441510b.booleanValue()) {
            ...
            try {
                if (openInputStream != null) {
                    ...
                    if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(h17)) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ShareUtil", "getShareFilePath tmpPath == null , use srcPath:" + str);
                    ...
                    com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(h17);
                    if (r6Var.m()) {
                        r6Var.l();
                    }
                    outputStream = com.p314xaae8f345.mm.vfs.w6.K(h17, false);
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "getShareFilePath copy cost(ms):" + (java.lang.System.currentTimeMillis() - currentTimeMillis) + "  size(KB):" + (((float) j17) / 1024.0f));
                    if (r6Var.m() && r6Var.h()) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ShareUtil", "getShareFilePath tmpFile can use:" + h17);
                        com.p314xaae8f345.mm.p1006xc5476f33.p1277x2e06d1.p1279x3608ae.e0.r(13);
                        str = h17;
                    } else {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ShareUtil", "getShareFilePath tmpFile can not use, use srcPath:" + str);
                        com.p314xaae8f345.mm.p1006xc5476f33.p1277x2e06d1.p1279x3608ae.e0.r(14);
                    }
                } else {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ShareUtil", "getShareFilePath inputStream == null, copy fail, use srcPath:" + str);
                ...
                closeable = null;
                try {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ShareUtil", e, "", new java.lang.Object[0]);
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.ShareUtil", "getShareFilePath copy exception, use srcPath:" + str);
    ...
    public static java.lang.String h(java.lang.String str) {
        ...
        return zo3.p.Vi() + com.p314xaae8f345.mm.sdk.p2603x2137b148.w2.a(str + java.lang.System.currentTimeMillis());
    }
    ...
    public static java.lang.String i(java.lang.String str) {
        ...
        java.lang.String str2 = f441509a;
