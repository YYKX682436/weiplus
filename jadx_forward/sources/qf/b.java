...
public class b {
    ...
    public final java.util.LinkedList f443765a = new java.util.LinkedList();

    public void a(qf.c cVar) {
        java.lang.String b17 = cVar.b();
        this.f443765a.add(new android.util.Pair(cVar, android.text.TextUtils.isEmpty(b17) ? null : java.util.regex.Pattern.compile(b17)));
    }

    public android.webkit.WebResourceResponse b(java.lang.String str) {
        android.webkit.WebResourceResponse a17;
        java.util.Iterator it = this.f443765a.iterator();
        while (it.hasNext()) {
