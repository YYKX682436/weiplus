...
public final class r {
    ...
    public static final hx4.r f367224a = new hx4.r();

    /* renamed from: b, reason: collision with root package name */
    public static com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.y3 f367225b;
    ...
    public static final android.content.Intent a(android.content.Context context, android.content.Intent intent, java.lang.String str, boolean z17) {
        ...
        intent2.setClass(context, com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.ui.p2417x696c9db.p2419x8ff2b28.ActivityC19352x791af613.class);
    ...
    public static final android.graphics.drawable.Drawable d(android.content.Context context, android.content.pm.ResolveInfo resolveInfo) {
        ...
        try {
            ...
            if (str != null && resolveInfo.icon != 0) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(resourcesForApplication, "getResourcesForApplication(...)");
                try {
            ...
            if (iconResource != 0) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(resourcesForApplication2, "getResourcesForApplication(...)");
                try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.BrowserChooseDialogHelper", "Couldn't find resources for package", e17);
        }
    ...
    public static final void e(android.content.Context context, android.content.Intent intent, android.content.pm.ResolveInfo resolveInfo) {
        ...
        if (intent != null) {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.BrowserChooseDialogHelper", e17, "onBrowserItemClick exception", new java.lang.Object[0]);
                return;
            }
        } else {
            stringExtra = null;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BrowserChooseDialogHelper", "openInBrowser package: %s, uri: %s, url: %s", objArr);
        ((ht.a) ((jt.v) i95.n0.c(jt.v.class))).getClass();
        com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.y3 b17 = com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.z3.a().b(0, null);
        if (b17.h((resolveInfo == null || (activityInfo2 = resolveInfo.activityInfo) == null) ? null : activityInfo2.packageName)) {
            ((com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.t3) ((jt.y) b17)).s(context, stringExtra);
            return;
        }
        if (intent != null) {
        ...
        if (fp.h.c(29)) {
            ...
            if (activity != null) {
                activity.send(context, 1, null, hx4.q.f367223a, null);
                return;
            }
            return;
        }
    ...
    public final java.util.List b(java.util.List list) {
            ...
            while (it.hasNext()) {
                ...
                if (resolveInfo != null) {
                    ...
                    if ((((activityInfo == null || (applicationInfo = activityInfo.applicationInfo) == null) ? 0 : applicationInfo.flags) & 1) > 0) {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BrowserChooseDialogHelper", "filterBrowserList package: %s is system application", objArr);
                        arrayList3.add(resolveInfo);
                    } else {
                        java.util.HashSet hashSet = hx4.u.f367227a;
                        java.lang.String str4 = activityInfo != null ? activityInfo.packageName : null;
                        java.util.HashSet hashSet2 = hx4.u.f367227a;
                        if (str4 != null) {
                        ...
                        if (kz5.n0.O(hashSet2, str)) {
                            ...
                            if (f367225b == null) {
                                ((ht.a) ((jt.v) i95.n0.c(jt.v.class))).getClass();
                                f367225b = com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.z3.a().b(0, null);
                            }
                            com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.y3 y3Var = f367225b;
                            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(y3Var);
                            if (str5 != null) {
                            ...
                            if (hx4.u.f367228b) {
                                ...
                                java.util.HashSet hashSet3 = hx4.u.f367229c;
                                if (str6 != null) {
                                    str3 = str6.toLowerCase();
                                    p3321xbce91901.jvm.p3324x21ffc6bd.o.f(str3, "toLowerCase(...)");
                                } else {
                                    str3 = null;
                                }
                                if (kz5.n0.O(hashSet3, str3)) {
                                    ...
                                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BrowserChooseDialogHelper", "filterBrowserList package: %s is in block list", objArr2);
                                }
                            }
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BrowserChooseDialogHelper", "filterBrowserList resolveList: %s, finalList: %s, systemBrowserCount: %d, qqBrowserList: %s, filteredAllowList: %s", objArr3);
        return arrayList;
    }
