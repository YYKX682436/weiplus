...
public abstract class j implements wa.a {
    ...
    public static final boolean f496178g = java.lang.Boolean.parseBoolean(java.lang.System.getProperty("guava.concurrent.generate_cancellation_cause", "false"));

    /* renamed from: h, reason: collision with root package name */
    public static final java.util.logging.Logger f496179h = java.util.logging.Logger.getLogger(t2.j.class.getName());

    /* renamed from: i, reason: collision with root package name */
    public static final t2.b f496180i;

    /* renamed from: m, reason: collision with root package name */
    public static final java.lang.Object f496181m;

    /* renamed from: d, reason: collision with root package name */
    public volatile java.lang.Object f496182d;

    /* renamed from: e, reason: collision with root package name */
    public volatile t2.f f496183e;

    /* renamed from: f, reason: collision with root package name */
    public volatile t2.i f496184f;
    ...
    static {
        ...
        f496180i = hVar;
        if (th != null) {
            f496179h.log(java.util.logging.Level.SEVERE, "SafeAtomicHelper is broken!", th);
        }
        f496181m = new java.lang.Object();
    }
    ...
    public static void b(t2.j jVar) {
        ...
        do {
            iVar = jVar.f496184f;
        } while (!f496180i.c(jVar, iVar, t2.i.f496175c));
        while (true) {
            fVar = null;
            if (iVar == null) {
                break;
            }
            java.lang.Thread thread = iVar.f496176a;
            if (thread != null) {
                iVar.f496176a = null;
        ...
        do {
            fVar2 = jVar.f496183e;
        } while (!f496180i.a(jVar, fVar2, t2.f.f496166d));
        while (true) {
            fVar3 = fVar;
            fVar = fVar2;
            if (fVar == null) {
        ...
        while (fVar3 != null) {
            t2.f fVar4 = fVar3.f496169c;
            c(fVar3.f496167a, fVar3.f496168b);
            fVar3 = fVar4;
        }
    }
    ...
    public static void c(java.lang.Runnable runnable, java.util.concurrent.Executor executor) {
        try {
            ...
            f496179h.log(java.util.logging.Level.SEVERE, "RuntimeException while executing runnable " + runnable + " with executor " + executor, (java.lang.Throwable) e17);
        }
    }
    ...
    public final void mo606x162a7075(java.lang.Runnable runnable, java.util.concurrent.Executor executor) {
        runnable.getClass();
        executor.getClass();
        t2.f fVar = this.f496183e;
        t2.f fVar2 = t2.f.f496166d;
        if (fVar != fVar2) {
            t2.f fVar3 = new t2.f(runnable, executor);
            do {
                fVar3.f496169c = fVar;
                if (f496180i.a(this, fVar, fVar3)) {
                    return;
                } else {
                    fVar = this.f496183e;
                }
    ...
    public final boolean cancel(boolean z17) {
        java.lang.Object obj = this.f496182d;
        if ((obj == null) | false) {
            if (f496180i.b(this, obj, f496178g ? new t2.c(z17, new java.util.concurrent.CancellationException("Future.cancel() was called.")) : z17 ? t2.c.f496162b : t2.c.f496163c)) {
                b(this);
                return true;
            }
        }
    ...
    public final java.lang.Object d(java.lang.Object obj) {
        if (obj instanceof t2.c) {
            java.lang.Throwable th6 = ((t2.c) obj).f496164a;
        ...
        if (obj instanceof t2.e) {
            throw new java.util.concurrent.ExecutionException(((t2.e) obj).f496165a);
        }
        if (obj == f496181m) {
            return null;
        }
    ...
    public final void g(t2.i iVar) {
        iVar.f496176a = null;
        while (true) {
            t2.i iVar2 = this.f496184f;
            if (iVar2 == t2.i.f496175c) {
                return;
            }
            t2.i iVar3 = null;
            while (iVar2 != null) {
                t2.i iVar4 = iVar2.f496177b;
                if (iVar2.f496176a != null) {
                    iVar3 = iVar2;
                } else if (iVar3 != null) {
                    iVar3.f496177b = iVar4;
                    if (iVar3.f496176a == null) {
                        break;
                    }
                } else if (!f496180i.c(this, iVar2, iVar4)) {
                    break;
                }
                iVar2 = iVar4;
            }
    ...
    */
    ...
    public final boolean isCancelled() {
        return this.f496182d instanceof t2.c;
    }

    @Override // java.util.concurrent.Future
    public final boolean isDone() {
        return (this.f496182d != null) & true;
    }

    /* renamed from: toString */
    public java.lang.String m165648x9616526c() {
        java.lang.String str;
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        sb6.append(super.toString());
        sb6.append("[status=");
        if (this.f496182d instanceof t2.c) {
            sb6.append("CANCELLED");
        } else if (isDone()) {
            a(sb6);
        } else {
    ...
    public final java.lang.Object get() {
        ...
        if (!java.lang.Thread.interrupted()) {
            java.lang.Object obj2 = this.f496182d;
            if ((obj2 != null) & true) {
                return d(obj2);
            }
            t2.i iVar = this.f496184f;
            t2.i iVar2 = t2.i.f496175c;
            if (iVar != iVar2) {
                t2.i iVar3 = new t2.i();
                do {
                    t2.b bVar = f496180i;
