...
public class c {
    ...
    public android.os.CancellationSignal f325323a = null;
    ...
    public boolean a(boolean z17) {
        ...
        if (z17) {
            ...
            ju5.o a17 = ju5.o.a();
            a17.f383669b.postDelayed(new du5.b(this), 350L);
            return true;
        }
        zt5.h.c("Soter.SoterBiometricCanceller", "soter: cancellation signal 3", new java.lang.Object[0]);
        this.f325323a.cancel();
        ju5.n c17 = ju5.n.c();
        synchronized (c17.f383661a) {
            zt5.h.c("Soter.SoterTaskManager", "soter: cancelAuthCancellationTask", new java.lang.Object[0]);
            if (ju5.n.f383660c.size() != 0) {
                for (int i17 = 0; i17 < ju5.n.f383660c.size(); i17++) {
                    ju5.o.a().c(new ju5.m(c17, ju5.n.f383660c.keyAt(i17)));
                }
            }
        }
        return true;
    ...
    public void b() {
        ...
        this.f325323a = new android.os.CancellationSignal();
    }
}
