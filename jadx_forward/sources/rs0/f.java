    ...
    public static final java.util.List a(java.lang.String str, double[] result, int i17) {
        ...
        try {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("FPSComputer", "compute fps error: " + e18.getLocalizedMessage());
                com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.g0.INSTANCE.B(986L, 103L);
            }
            ...
            sb6.append(", avg fps = ");
            sb6.append(result[2]);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FPSComputer", sb6.toString());
            com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.g0.INSTANCE.C(986L, 102L, j17);
            return arrayList;
        } finally {
            cVar.g();
        }
