...
public final class e implements java.lang.Runnable {
    ...
    public final /* synthetic */ mh2.k f407850d;
    ...
    public final void run() {
        mh2.k kVar = this.f407850d;
        kVar.f407910f.setVisibility(0);
        kVar.f407910f.setAlpha(0.0f);
        android.view.View view = kVar.f407911g;
        if (view == null) {
            return;
        }
