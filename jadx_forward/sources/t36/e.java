...
public class e extends t36.k {
    ...
    public final t36.j f496976c;

    /* renamed from: d, reason: collision with root package name */
    public final t36.j f496977d;

    /* renamed from: e, reason: collision with root package name */
    public final t36.j f496978e;

    /* renamed from: f, reason: collision with root package name */
    public final t36.j f496979f;

    /* renamed from: g, reason: collision with root package name */
    public final t36.d f496980g;
    ...
    public e(java.lang.Class cls, t36.j jVar, t36.j jVar2, t36.j jVar3, t36.j jVar4) {
        ...
        this.f496980g = new t36.d(method, method3, method2);
        this.f496976c = jVar;
        this.f496977d = jVar2;
        this.f496978e = jVar3;
        this.f496979f = jVar4;
    ...
    public void f(javax.net.ssl.SSLSocket sSLSocket, java.lang.String str, java.util.List list) {
        if (str != null) {
            this.f496976c.c(sSLSocket, java.lang.Boolean.TRUE);
            this.f496977d.c(sSLSocket, str);
        }
        t36.j jVar = this.f496979f;
        if (jVar != null) {
            if (jVar.a(sSLSocket.getClass()) != null) {
                ...
                for (int i17 = 0; i17 < size; i17++) {
                    ...
                    if (r0Var != l36.r0.HTTP_1_0) {
                        kVar.F(r0Var.f397168d.length());
                        kVar.O(r0Var.f397168d);
                    }
                }
                objArr[0] = kVar.k(kVar.f533227e);
                try {
    ...
    public java.lang.String i(javax.net.ssl.SSLSocket sSLSocket) {
        ...
        try {
            ...
            if (bArr != null) {
                return new java.lang.String(bArr, m36.e.f404922d);
            }
            return null;
        } catch (java.lang.reflect.InvocationTargetException e17) {
            java.lang.Throwable targetException = e17.getTargetException();
    ...
    public java.lang.Object j(java.lang.String str) {
        t36.d dVar = this.f496980g;
        java.lang.reflect.Method method = dVar.f496973a;
        if (method == null) {
            return null;
        }
        try {
            java.lang.Object invoke = method.invoke(null, new java.lang.Object[0]);
            dVar.f496974b.invoke(invoke, str);
            return invoke;
        } catch (java.lang.Exception unused) {
            return null;
        }
    ...
    public void m(java.lang.String str, java.lang.Object obj) {
        ...
        if (obj != null) {
            try {
                dVar.f496975c.invoke(obj, new java.lang.Object[0]);
                z17 = true;
            } catch (java.lang.Exception unused) {
            }
        }
