...
public final class a implements ej3.c {
    ...
    public final java.lang.ThreadLocal f427329a = new java.lang.ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    public final boolean f427330b;

    /* renamed from: c, reason: collision with root package name */
    public final boolean f427331c;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.ThreadLocal f427332d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.ThreadLocal f427333e;

    /* renamed from: f, reason: collision with root package name */
    public final java.lang.ThreadLocal f427334f;

    public a() {
        boolean z17 = ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_multitalk_use_new_yuv_buffer, 0) == 1;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MultitalkUtils", "uploadUseYuvBuffer: " + z17);
        this.f427330b = z17;
        boolean z18 = ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_multitalk_upload_disable_finish_call, 0) == 1;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MultitalkUtils", "disableUploadFinishCall: " + z18);
        this.f427331c = z18 ^ true;
        this.f427332d = new java.lang.ThreadLocal();
        this.f427333e = new java.lang.ThreadLocal();
        this.f427334f = new java.lang.ThreadLocal();
    }
    ...
    */
    public java.lang.Object c(oj3.b r23, p3321xbce91901.p3322xc267989b.InterfaceC29045xdcb5ca57 r24) {
        /*
    ...
    */
    public final void e(java.nio.ByteBuffer r16, oj3.b r17) {
        /*
            ...
            r1 = r17
            r16.clear()
            mj3.g r10 = r1.f427336b
            nj3.e r11 = r1.f427337c
            java.util.concurrent.locks.ReentrantLock r12 = r11.f419434e
            r12.lock()
            boolean r1 = r11.f419433d     // Catch: java.lang.Throwable -> L95
            r13 = 0
            if (r1 == 0) goto L1e
            nj3.d r1 = r11.f419430a     // Catch: java.lang.Throwable -> L95
            boolean r2 = r1.f419428b     // Catch: java.lang.Throwable -> L95
            if (r2 == 0) goto L1e
            is0.c r1 = r1.f419427a     // Catch: java.lang.Throwable -> L95
            goto L1f
        L1e:
            r1 = r13
        L1f:
            if (r1 == 0) goto L31
            int r2 = r10.f408583a     // Catch: java.lang.Throwable -> L95
            int r3 = r10.f408584b     // Catch: java.lang.Throwable -> L95
        ...
        L31:
            int r1 = r10.f408583a     // Catch: java.lang.Throwable -> L95
            int r14 = r10.f408584b
            int r1 = r1 * r14
            r0.position(r1)     // Catch: java.lang.Throwable -> L95
            boolean r1 = r11.f419433d     // Catch: java.lang.Throwable -> L95
            if (r1 == 0) goto L46
            nj3.d r1 = r11.f419431b     // Catch: java.lang.Throwable -> L95
            boolean r2 = r1.f419428b     // Catch: java.lang.Throwable -> L95
            if (r2 == 0) goto L46
            is0.c r1 = r1.f419427a     // Catch: java.lang.Throwable -> L95
            goto L47
        ...
        L5b:
            ...
            boolean r1 = r11.f419433d     // Catch: java.lang.Throwable -> L95
            if (r1 == 0) goto L71
            nj3.d r1 = r11.f419432c     // Catch: java.lang.Throwable -> L95
            boolean r2 = r1.f419428b     // Catch: java.lang.Throwable -> L95
            if (r2 == 0) goto L71
            is0.c r1 = r1.f419427a     // Catch: java.lang.Throwable -> L95
            goto L72
        ...
        L84:
            ...
            r1 = r15
            boolean r0 = r1.f427331c     // Catch: java.lang.Throwable -> L93
            if (r0 == 0) goto L8f
