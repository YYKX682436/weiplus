...
public final class a3 extends android.text.style.ClickableSpan {
    ...
    public void onClick(android.view.View widget) {
        ...
        android.content.Context context = (android.content.Context) this.f428374d.get();
        if (context == null) {
            int i17 = rl.b.f478676a;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("LotteryLicenseSpanClick", "on click but rContext is null!", null);
