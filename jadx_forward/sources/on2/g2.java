...
public final class g2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ so2.c3 f428450d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ on2.j2 f428451e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ in5.s0 f428452f;
    ...
    public final void onClick(android.view.View view) {
        ...
        ((ml2.j0) i95.n0.c(ml2.j0.class)).Fj(ml2.j1.f409140w, "");
        so2.c3 c3Var = this.f428450d;
        int i17 = c3Var.f491833h;
        in5.s0 s0Var = this.f428452f;
        if (i17 == 1) {
            on2.j2.n(this.f428451e, s0Var, c3Var.f491832g);
        } else {
            android.content.Intent intent = new android.content.Intent();
            intent.putExtra("rawUrl", c3Var.f491831f);
            j45.l.j(s0Var.f374654e, "webview", ".ui.tools.WebViewUI", intent, null);
        }
