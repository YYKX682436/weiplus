...
public class a {
    ...
    public static final java.util.regex.Pattern f386007a = java.util.regex.Pattern.compile("oauth_token=([^&]+)");

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.regex.Pattern f386008b = java.util.regex.Pattern.compile("oauth_token_secret=([^&]*)");
