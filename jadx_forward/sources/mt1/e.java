...
public final class e extends android.content.BroadcastReceiver {
    ...
    public volatile com.p314xaae8f345.p3121x37984a.p3130x91727fcf.C26987xeef691ab f412742a;

    /* renamed from: b, reason: collision with root package name */
    public volatile wu5.c f412743b;

    /* renamed from: c, reason: collision with root package name */
    public boolean f412744c;

    /* renamed from: d, reason: collision with root package name */
    public boolean f412745d;
    ...
    public e() {
        ...
        this.f412745d = ((android.os.PowerManager) systemService).isInteractive();
    }

    public final void a() {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CalcWxNewService", "mCancellationSignal cancel");
        wu5.c cVar = this.f412743b;
        if (cVar != null) {
            cVar.cancel(false);
        }
        this.f412743b = null;
        com.p314xaae8f345.p3121x37984a.p3130x91727fcf.C26987xeef691ab c26987xeef691ab = this.f412742a;
        if (c26987xeef691ab != null) {
            c26987xeef691ab.m108007xae7a2e7a();
        }
        this.f412742a = null;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CalcWxNewService", "mCancellationSignal cancel done");
    }
    ...
    */
    ...
    public void onReceive(android.content.Context context, android.content.Intent intent) {
        ...
        if (!mt1.b0.f412734k || !this.f412744c || this.f412745d) {
            a();
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.CalcWxNewService", "it is charging and screen off, 5 min to calc");
        if (this.f412743b == null) {
            this.f412743b = ((ku5.t0) ku5.t0.f394148d).k(new mt1.d(this), 90000L);
        }
    }
}
