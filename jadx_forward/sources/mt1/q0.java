...
public final class q0 {
    ...
    public static final mt1.q0 f412791a = new mt1.q0();

    /* renamed from: b, reason: collision with root package name */
    public static final ot1.j f412792b;
    ...
    public final void a() {
        ...
        jVar.getClass();
        try {
            jVar.f430382d.H("WxFileIndexDownloadMigration", "DELETE FROM WxFileIndexDownloadMigration WHERE status = ?", new java.lang.String[]{java.lang.String.valueOf(200)});
    ...
    public final void b() {
        try {
            f412792b.f430382d.H("WxFileIndexLinkify", "DELETE FROM WxFileIndexLinkify WHERE status = ? OR status = ? OR status = ? OR status = ?", new java.lang.Object[]{0, 10, 5, 13});
        } catch (java.lang.Throwable th6) {
            throw new java.lang.RuntimeException("deleteOldLinkify failed : " + th6.getMessage());
        }
    }
    ...
    */
    public final boolean c(java.lang.String r5, java.lang.String r6, java.lang.String r7) {
        /*
            ...
            r2 = 1
            if (r5 == 0) goto L23
            boolean r5 = com.p314xaae8f345.mm.vfs.w6.h(r6)
        ...
        L24:
            ...
            if (r6 == 0) goto L43
            boolean r6 = com.p314xaae8f345.mm.vfs.w6.h(r7)
    ...
    public final java.lang.String d(java.lang.String str, java.lang.String str2) {
        ...
        java.lang.String b17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.w2.b(str4.getBytes());
        java.lang.String o17 = new com.p314xaae8f345.mm.vfs.r6(new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.vfs.z7.a(str)).r(), b17 + str2).o();
    ...
    */
    ...
    public final int g(long j17, long j18, java.lang.String filePath, java.lang.String newAttachmentName, java.lang.String indexFileName) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(newAttachmentName, "newAttachmentName");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(indexFileName, "indexFileName");
    ...
    public final void h() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.DuplicateFileLinkifyLogic", "rescueFileLinkFileFromError");
        int i17 = 0;
        jx3.f.INSTANCE.d(26980, -100, 0, 0, "", "", 0);
        ot1.j jVar2 = f412792b;
        jVar2.f430385g.a();
        android.database.Cursor f17 = jVar2.f430382d.f("SELECT id,originalPath,targetPath,status,indexRowId,msgId,username from WxFileIndexDownloadMigration WHERE status!=?", new java.lang.String[]{"200"}, 0);
        try {
            int count = f17.getCount();
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.DuplicateFileLinkifyLogic", "rescueDownloadMigrationError count = " + count);
            if (count == 0) {
                try {
            ...
            while (f17.moveToNext()) {
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.DuplicateFileLinkifyLogic", "rescueDownloadMigrationError, id = " + j17 + ", originalFilePath = " + string + ", targetFilePath = " + string2 + ", status = " + i18);
                    java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
                    sb6.append(string);
                    sb6.append(str2);
                    java.lang.String sb7 = sb6.toString();
                    if (!com.p314xaae8f345.mm.vfs.w6.j(sb7)) {
                        mt1.q0 q0Var = f412791a;
                    ...
                    if (i18 == 0 || i18 == 1) {
                        ...
                        jVar = jVar3;
                        if (com.p314xaae8f345.mm.vfs.w6.j(sb7)) {
                            boolean h17 = com.p314xaae8f345.mm.vfs.w6.h(sb7);
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.DuplicateFileLinkifyLogic", "LINKIFY_FILE_STATUS_START||DOWNLOAD_MIGRATION_STATUS_COPY_BACKUP_DONE, deleteBackupFileRet = " + h17);
                            if (!h17) {
                                jVar2 = jVar;
                                str2 = str;
                                f17 = cursor2;
                        ...
                        if (com.p314xaae8f345.mm.vfs.w6.j(string2)) {
                            boolean h18 = com.p314xaae8f345.mm.vfs.w6.h(string2);
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.DuplicateFileLinkifyLogic", "LINKIFY_FILE_STATUS_START||DOWNLOAD_MIGRATION_STATUS_COPY_BACKUP_DONE, deleteTargetFileRet = " + h18);
                            if (!h18) {
                                jVar2 = jVar;
                                str2 = str;
                                f17 = cursor2;
                        ...
                        try {
                            ...
                            try {
                                try {
                                    gm0.j1.u().f354686f.H("appattach", "UPDATE appattach SET fileFullPath=? WHERE msgInfoId=?", new java.lang.Object[]{string2, java.lang.Long.valueOf(j19)});
                                    jVar.t3(j17, 3);
                                    mt1.b0.f412724a.n().v3(j18, "wcf://attachment/" + (com.p314xaae8f345.mm.vfs.w6.q(string2) + '.' + com.p314xaae8f345.mm.vfs.w6.n(string2)));
                                    jVar.t3(j17, 4);
                        ...
                        cursor2 = f17;
                        jVar = jVar3;
                    } else if (com.p314xaae8f345.mm.vfs.w6.h(string)) {
                        jVar = jVar3;
                        jVar.t3(j17, 200);
                        str = str2;
                        cursor2 = f17;
                    ...
                    fVar.d(26980, java.lang.Integer.valueOf(org.p3343x72743996.net.InterfaceC29524x4f65168b.f74068x80b38894), 0, 0, string, string2, 0);
                    str2 = str;
                    f17 = cursor2;
                    ot1.j jVar4 = jVar;
                    i17 = 0;
