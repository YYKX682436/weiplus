...
public class c0 extends p012xc85e97e9.p112x993b6d55.AbstractC1183x100d4975 {
    ...
    public void g(u4.m1 m1Var) {
        ...
        if (view instanceof android.widget.TextView) {
            ((java.util.HashMap) m1Var.f506047a).put("android:textscale:scale", java.lang.Float.valueOf(((android.widget.TextView) view).getScaleX()));
        }
    }
    ...
    public android.animation.Animator n(android.view.ViewGroup viewGroup, u4.m1 m1Var, u4.m1 m1Var2) {
        if (m1Var == null || m1Var2 == null || !(m1Var.f506048b instanceof android.widget.TextView)) {
            return null;
        }
