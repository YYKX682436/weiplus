...
public abstract class e {
    ...
    public static final java.lang.reflect.Type[] f126343a = new java.lang.reflect.Type[0];

    public static java.lang.reflect.Type a(java.lang.reflect.Type type) {
        if (type instanceof java.lang.Class) {
            java.lang.Class cls = (java.lang.Class) type;
            return cls.isArray() ? new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.b(a(cls.getComponentType())) : cls;
        }
        if (type instanceof java.lang.reflect.ParameterizedType) {
            java.lang.reflect.ParameterizedType parameterizedType = (java.lang.reflect.ParameterizedType) type;
            return new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.c(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
        if (type instanceof java.lang.reflect.GenericArrayType) {
            return new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.b(((java.lang.reflect.GenericArrayType) type).getGenericComponentType());
        }
        if (!(type instanceof java.lang.reflect.WildcardType)) {
            return type;
        }
        java.lang.reflect.WildcardType wildcardType = (java.lang.reflect.WildcardType) type;
        return new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.d(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
    }

    public static void b(java.lang.reflect.Type type) {
        com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.a.a(((type instanceof java.lang.Class) && ((java.lang.Class) type).isPrimitive()) ? false : true);
    }
    ...
    public static java.lang.Class e(java.lang.reflect.Type type) {
        ...
        if (type instanceof java.lang.reflect.ParameterizedType) {
            ...
            com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.a.a(rawType instanceof java.lang.Class);
    ...
    public static java.lang.reflect.Type f(java.lang.reflect.Type type, java.lang.Class cls, java.lang.Class cls2) {
        ...
        com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.a.a(cls2.isAssignableFrom(cls));
            ...
            if (!(type2 instanceof java.lang.reflect.TypeVariable)) {
                if (type2 instanceof java.lang.Class) {
                    ...
                    if (cls2.isArray()) {
                        ...
                        return componentType == g17 ? cls2 : new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.b(g17);
                    }
                }
                if (type2 instanceof java.lang.reflect.GenericArrayType) {
                    ...
                    return genericComponentType == g18 ? genericArrayType : new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.b(g18);
                }
                if (type2 instanceof java.lang.reflect.ParameterizedType) {
                    ...
                    return z17 ? new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.c(g19, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
                }
                ...
                if (z18) {
                    ...
                    if (lowerBounds.length == 1) {
                        ...
                        if (g28 != lowerBounds[0]) {
                            return new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.d(new java.lang.reflect.Type[]{java.lang.Object.class}, g28 instanceof java.lang.reflect.WildcardType ? ((java.lang.reflect.WildcardType) g28).getLowerBounds() : new java.lang.reflect.Type[]{g28});
                        }
                    } else {
                        type3 = wildcardType;
                        if (upperBounds.length == 1) {
                            ...
                            if (g29 != upperBounds[0]) {
                                return new com.p176xb6135e39.p280x308fcb.p281x21ffc6bd.d(g29 instanceof java.lang.reflect.WildcardType ? ((java.lang.reflect.WildcardType) g29).getUpperBounds() : new java.lang.reflect.Type[]{g29}, f126343a);
                            }
                        }
                    }
                }
