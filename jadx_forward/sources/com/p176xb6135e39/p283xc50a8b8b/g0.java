...
public abstract class g0 extends com.p176xb6135e39.p283xc50a8b8b.k0 {

    /* renamed from: d, reason: collision with root package name */
    public final byte[] f126625d;
    ...
    public g0(int i17) {
        ...
        this.f126625d = bArr;
        this.f126626e = bArr.length;
    }

    public final void V(int i17) {
        int i18 = this.f126627f;
        int i19 = i18 + 1;
        byte[] bArr = this.f126625d;
    ...
    public final void Y(int i17) {
        boolean z17 = com.p176xb6135e39.p283xc50a8b8b.k0.f126780c;
        byte[] bArr = this.f126625d;
        if (z17) {
            while ((i17 & (-128)) != 0) {
                int i18 = this.f126627f;
                this.f126627f = i18 + 1;
                com.p176xb6135e39.p283xc50a8b8b.ib.r(bArr, i18, (byte) ((i17 & 127) | 128));
                i17 >>>= 7;
            }
        ...
        while ((i17 & (-128)) != 0) {
            int i27 = this.f126627f;
            this.f126627f = i27 + 1;
            bArr[i27] = (byte) ((i17 & 127) | 128);
            i17 >>>= 7;
        }
        int i28 = this.f126627f;
        this.f126627f = i28 + 1;
        bArr[i28] = (byte) i17;
    }
    ...
    public final void Z(long j17) {
        ...
        if (z17) {
            while ((j17 & (-128)) != 0) {
                int i17 = this.f126627f;
                this.f126627f = i17 + 1;
                com.p176xb6135e39.p283xc50a8b8b.ib.r(bArr, i17, (byte) ((((int) j17) & 127) | 128));
                j17 >>>= 7;
            }
            int i18 = this.f126627f;
            this.f126627f = i18 + 1;
            com.p176xb6135e39.p283xc50a8b8b.ib.r(bArr, i18, (byte) j17);
            return;
        }
        while ((j17 & (-128)) != 0) {
            int i19 = this.f126627f;
