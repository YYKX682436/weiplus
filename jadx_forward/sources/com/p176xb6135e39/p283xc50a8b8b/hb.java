...
public abstract class hb {
    ...
    public final sun.misc.Unsafe f126705a;

    public hb(sun.misc.Unsafe unsafe) {
        this.f126705a = unsafe;
    }

    public final int a(java.lang.Class cls) {
        return this.f126705a.arrayBaseOffset(cls);
    }

    public final int b(java.lang.Class cls) {
        return this.f126705a.arrayIndexScale(cls);
    }
