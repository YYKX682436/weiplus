...
public final class C1992x33b9c93 {
    private C1992x33b9c93() {
    }

    /* renamed from: isEmpty */
    public static boolean m18540x7aab3243(java.util.Collection<?> collection) {
        if (collection == null) {
            return true;
        }
    ...
    /* renamed from: listOf */
    public static <T> java.util.List<T> m18541xbe490b15() {
        return java.util.Collections.emptyList();
    }

    /* renamed from: mapOf */
    public static <K, V> java.util.Map<K, V> m18544x62dc853(K k17, V v17, K k18, V v18, K k19, V v19) {
    ...
    /* renamed from: mapOfKeyValueArrays */
    public static <K, V> java.util.Map<K, V> m18546x98e26d5f(K[] kArr, V[] vArr) {
    ...
    /* renamed from: mutableSetOfWithSize */
    public static <T> java.util.Set<T> m18547xb70ee95a(int i17) {
        return i17 == 0 ? new x.d(0) : zzb(i17, true);
    }

    @java.lang.Deprecated
    /* renamed from: setOf */
    public static <T> java.util.Set<T> m18548x68435d9(T t17, T t18, T t19) {
    ...
    @java.lang.Deprecated
    /* renamed from: listOf */
    public static <T> java.util.List<T> m18542xbe490b15(T t17) {
        return java.util.Collections.singletonList(t17);
    }

    @java.lang.Deprecated
    /* renamed from: listOf */
    public static <T> java.util.List<T> m18543xbe490b15(T... tArr) {
    ...
    /* renamed from: mapOf */
    public static <K, V> java.util.Map<K, V> m18545x62dc853(K k17, V v17, K k18, V v18, K k19, V v19, K k27, V v27, K k28, V v28, K k29, V v29) {
    ...
    @java.lang.Deprecated
    /* renamed from: setOf */
    public static <T> java.util.Set<T> m18549x68435d9(T... tArr) {
        int length = tArr.length;
        if (length == 0) {
        ...
        if (length == 3) {
            return m18548x68435d9(tArr[0], tArr[1], tArr[2]);
        }
        if (length != 4) {
