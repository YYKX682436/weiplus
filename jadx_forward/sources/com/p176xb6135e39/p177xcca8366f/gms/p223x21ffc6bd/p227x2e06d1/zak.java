...
public final class zak extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    ...
    private boolean zag;
    private boolean zah;
    private com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zaj zai;
    ...
    public zak(android.graphics.drawable.Drawable drawable, android.graphics.drawable.Drawable drawable2) {
        this(null);
        drawable = drawable == null ? com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zai.zaa : drawable;
        this.zaj = drawable;
        drawable.setCallback(this);
        com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zaj zajVar = this.zai;
        zajVar.zab = drawable.getChangingConfigurations() | zajVar.zab;
        drawable2 = drawable2 == null ? com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zai.zaa : drawable2;
        this.zak = drawable2;
        drawable2.setCallback(this);
        com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zaj zajVar2 = this.zai;
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        ...
        L82:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zak.draw(android.graphics.Canvas):void");
    }
    ...
    @Override // android.graphics.drawable.Drawable.Callback
    public final void scheduleDrawable(android.graphics.drawable.Drawable drawable, java.lang.Runnable runnable, long j17) {
        android.graphics.drawable.Drawable.Callback callback = getCallback();
        if (callback != null) {
    ...
    public zak(com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zaj zajVar) {
        this.zaa = 0;
        this.zad = 255;
        this.zaf = 0;
        this.zag = true;
        this.zai = new com.p176xb6135e39.p177xcca8366f.gms.p223x21ffc6bd.p227x2e06d1.zaj(zajVar);
    }
}
