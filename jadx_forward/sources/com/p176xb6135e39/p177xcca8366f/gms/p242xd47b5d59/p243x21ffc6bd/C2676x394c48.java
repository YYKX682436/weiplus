...
public class C2676x394c48 {
    ...
    private final android.content.pm.PackageInfo zzf(java.lang.String str) {
        try {
            return com.p176xb6135e39.p177xcca8366f.gms.p199xaf3f29eb.p220x84170e40.C2020x87f17260.m18642x2e2c3887(this.f7807x394c0e).m18639xffec0de(str, 64);
    ...
    public final boolean zze(java.lang.String str) {
        android.content.pm.PackageInfo zzf = zzf(str);
        if (zzf == null) {
            return false;
        }
        if (com.p176xb6135e39.p177xcca8366f.gms.p199xaf3f29eb.C1713x90a1c9c9.m17678x5882f166(this.f7807x394c0e)) {
            return zza(zzf, true);
        }
    ...
    private static boolean zza(android.content.pm.PackageInfo packageInfo, boolean z17) {
        android.content.pm.Signature[] signatureArr = packageInfo.signatures;
        if (signatureArr.length != 1) {
            return false;
        }
        signatureArr[0].toByteArray();
        return z17 ? zza(packageInfo, f7805x394c0f, f7806x394c10) : zza(packageInfo, f7805x394c0f);
    }

    private static boolean zza(android.content.pm.PackageInfo packageInfo, byte[]... bArr) {
        android.content.pm.Signature[] signatureArr = packageInfo.signatures;
        ...
        for (byte[] bArr2 : bArr) {
            if (java.util.Arrays.equals(bArr2, byteArray)) {
                return true;
            }
        }
        return false;
