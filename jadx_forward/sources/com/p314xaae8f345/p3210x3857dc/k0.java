        ...
        if ("GET_CONFIG_CMD".equals(str)) {
            ...
            if (obj4 instanceof java.lang.String[]) {
                ...
                if (strArr.length < 2) {
                    ...
                    obj2 = android.text.TextUtils.isEmpty(strArr[1]) ? com.p314xaae8f345.p3210x3857dc.b.m().f(strArr[0]) : com.p314xaae8f345.p3210x3857dc.b.m().g(strArr[0], strArr[1]);
                }
            } else {
            ...
            if (obj4 instanceof java.lang.String[]) {
                ...
                if (strArr2.length < 2) {
                    ...
                    valueOf = android.text.TextUtils.isEmpty(strArr2[1]) ? com.p314xaae8f345.p3210x3857dc.c.z().f(strArr2[0]) : com.p314xaae8f345.p3210x3857dc.c.z().g(strArr2[0], strArr2[1]);
                    obj2 = valueOf;
                }
            } else {
            ...
            if ("INVOKE_INSTANCE_METHOD".equals(str)) {
                ...
                if ("KEY_XPROFILE_RESULT_FORWARD_TO_SDK".equals(str) || "KEY_XPROFILE_TRACING_FRAME_COST_RESULT".equals(str)) {
                    com.p314xaae8f345.p3210x3857dc.t2 t2Var = com.p314xaae8f345.p3210x3857dc.s2.f302075a;
                    t2Var.getClass();
                    if (obj4 instanceof java.lang.Object[]) {
                        ...
                        if ((obj13 instanceof java.lang.String) && objArr5.length >= 2) {
                            p001xcca8366f.p003x91727fcf.v4.p009x62f6fe4.f.a(((java.util.concurrent.ConcurrentHashMap) t2Var.f302131b).get((java.lang.String) obj13));
                        }
                    }
                } else if ("KEY_CREATE_JAVA_CRASH_DUMP_FILE".equals(str)) {
                    if (obj4 instanceof java.lang.String) {
                        java.lang.String str6 = (java.lang.String) obj4;
                        if (!android.text.TextUtils.isEmpty(str6) && vx5.l0.f522913a != null) {
                            by5.c4.f("RuntimeToSdkChannel", "handleCreateJavaCrashDumpFile, serviceName:" + str6);
                            if (str6.contains("SandboxedProcessService")) {
                                ((com.p314xaae8f345.mm.p815xbe0af3c9.app.y0) vx5.l0.f522913a).getClass();
                                valueOf = com.p314xaae8f345.mm.app.t4.c(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a, bm5.f1.a(), "xweb_sandbox_crash");
                            } else if (str6.contains("PrivilegedProcessService")) {
                                ((com.p314xaae8f345.mm.p815xbe0af3c9.app.y0) vx5.l0.f522913a).getClass();
                                valueOf = com.p314xaae8f345.mm.app.t4.c(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a, bm5.f1.a(), "xweb_gpu_crash");
                            }
                        }
                    } else {
                    ...
                    if (obj4 instanceof java.lang.String) {
                        ...
                        if (!android.text.TextUtils.isEmpty(str7) && vx5.l0.f522913a != null) {
                            by5.c4.f("RuntimeToSdkChannel", "handleCreateNativeCrashDumpFile, serviceName:" + str7);
                            if (str7.contains("SandboxedProcessService")) {
                                ((com.p314xaae8f345.mm.p815xbe0af3c9.app.y0) vx5.l0.f522913a).getClass();
                                valueOf = com.p314xaae8f345.mm.app.t4.d(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a, bm5.f1.a(), "xweb_sandbox_crash");
                            } else if (str7.contains("PrivilegedProcessService")) {
                                ((com.p314xaae8f345.mm.p815xbe0af3c9.app.y0) vx5.l0.f522913a).getClass();
                                valueOf = com.p314xaae8f345.mm.app.t4.d(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a, bm5.f1.a(), "xweb_gpu_crash");
                            }
                        }
                    } else {
                    ...
                    if (obj4 instanceof android.os.Bundle) {
                        ...
                        com.p314xaae8f345.p3210x3857dc.v2 v2Var = com.p314xaae8f345.p3210x3857dc.x2.f302153a;
                        if (v2Var != null) {
                            com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.j5 j5Var = ((com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.i5) v2Var).f264478a;
                            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(bundle2);
                            j5Var.getClass();
                            ((ku5.t0) ku5.t0.f394148d).h(new com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.h5(bundle2, j5Var), "WebViewReportIp");
                        }
                    } else {
                        by5.c4.g("RuntimeToSdkChannel", "handleReportRequestIP, invalid args");
                    }
                } else if ("KEY_INCREASE_CHILD_PROCESS_CRASH_COUNT".equals(str)) {
                    com.p314xaae8f345.p3210x3857dc.t1.h();
                    ...
                    synchronized (com.p314xaae8f345.p3210x3857dc.t1.class) {
                        ...
                        if (c17 != null) {
                            int max = java.lang.Math.max(c17.getInt(com.p314xaae8f345.p3210x3857dc.t1.e(), 0) - 1, 0);
                            by5.c4.f("XWebChildProcessMonitor", "decreaseCrashCount, new crash count:" + max);
                            c17.edit().putInt(com.p314xaae8f345.p3210x3857dc.t1.e(), max).apply();
                        }
                    }
                } else if ("KEY_MULTI_PROCESS_DOWNGRADE_SYS".equals(str)) {
                    if (obj4 instanceof java.lang.String) {
                        com.p314xaae8f345.p3210x3857dc.t1.m(true, (java.lang.String) obj4);
                    } else {
                        com.p314xaae8f345.p3210x3857dc.t1.m(true, null);
                    }
                } else if ("KEY_MULTI_PROCESS_DOWNGRADE_CRASH".equals(str)) {
                    if (obj4 instanceof java.lang.String) {
                        com.p314xaae8f345.p3210x3857dc.t1.j((java.lang.String) obj4);
                    } else {
                        com.p314xaae8f345.p3210x3857dc.t1.j(null);
                    }
                } else if ("KEY_GET_LOCATION_START".equals(str)) {
                    if (obj4 instanceof java.lang.Boolean) {
                        ((java.lang.Boolean) obj4).booleanValue();
                        ux5.a aVar = ux5.b.a().f513416a;
                        if (aVar != null) {
                            com.p314xaae8f345.mm.p2829xfa87f9de.r0 r0Var = (com.p314xaae8f345.mm.p2829xfa87f9de.r0) aVar;
                            if (!r0Var.f296417a) {
                                i11.u.a(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a).e(r0Var.f296418b, com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a, 0, android.os.Looper.getMainLooper());
                                r0Var.f296417a = true;
                            }
                            z17 = true;
                        }
                    ...
                    ux5.a aVar2 = ux5.b.a().f513416a;
                    if (aVar2 != null) {
                        com.p314xaae8f345.mm.p2829xfa87f9de.r0 r0Var2 = (com.p314xaae8f345.mm.p2829xfa87f9de.r0) aVar2;
                        i11.u a17 = i11.u.a(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a);
                        i11.s sVar = r0Var2.f296418b;
                        a17.getClass();
                        a17.f368685a.mo50293x3498a0(new i11.x(a17, sVar));
                        r0Var2.f296417a = false;
                    }
                } else if ("KEY_START_REMOTE_DEBUG".equals(str)) {
                    by5.c4.f("RuntimeToSdkChannel", "handleStartRemoteDebug, process:" + org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.m156976xe5e58464());
                    if (obj4 instanceof java.lang.String) {
                        ...
                        if (by5.a1.c()) {
                            ...
                            u0Var.m(str8);
                            u0Var.l(true);
                            org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.f429503c.startService(new android.content.Intent(org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.f429503c, (java.lang.Class<?>) com.p314xaae8f345.p3210x3857dc.p3219x84f3d9cd.ServiceC27863x9718f944.class));
                            boolean z18 = wx5.e.f532122a;
                            android.content.Intent intent = new android.content.Intent();
                            intent.setAction("com.tencent.xweb.remotedebug");
                            intent.putExtra("extra_action", 1);
                            intent.putExtra(com.p314xaae8f345.p347x615374d.p349x208df1fe.p358xd1075a44.p360x696c9db.C3365xfbc5fb5e.f13301xac1d9648, str8);
                    ...
                    by5.c4.f("RuntimeToSdkChannel", "handleStopRemoteDebug, process:" + org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.m156976xe5e58464());
                    if (by5.a1.c()) {
                        com.p314xaae8f345.p3210x3857dc.u0 u0Var2 = com.p314xaae8f345.p3210x3857dc.t0.f302127a;
                        u0Var2.m(null);
                        u0Var2.l(false);
                        org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.f429503c.stopService(new android.content.Intent(org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.f429503c, (java.lang.Class<?>) com.p314xaae8f345.p3210x3857dc.p3219x84f3d9cd.ServiceC27863x9718f944.class));
                        boolean z19 = wx5.e.f532122a;
                        android.content.Intent intent2 = new android.content.Intent();
                        intent2.setAction("com.tencent.xweb.remotedebug");
                        intent2.putExtra("extra_action", 2);
                        intent2.putExtra("package_name", org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.l());
                        intent2.setPackage(org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.l());
                        by5.c4.f("XWebRemoteDebugBroadcastManager", "broadcastRemoteDebugStopped");
                        org.p3374x6d29641.p3375x2eaf9f.C29937xdd907d12.f429503c.sendBroadcast(intent2);
                    }
                }
                obj2 = obj5;
            }
