...
public enum f9 {
    ...
    DiscoveryLooks(ya.a.f77450x918d59a8, 1),
    DiscoverySearch(ya.a.f77450x918d59a8, 1),
    ...
    DiscoveryTing(ya.a.f77450x918d59a8, 1),
    MePayment("pay", 1),
    MeCouponCard("pay", 1),
    ...
    ContextSearch(ya.a.f77450x918d59a8, 1),
    ...
    public final int f274242d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f274243e;
    ...
    public static boolean i(int i17) {
        ...
        boolean z17 = i17 == 2;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WeChatBrands", "Business.Entry#isBanned = " + z17);
        return z17;
    }

    public static boolean m(com.p314xaae8f345.mm.sdk.p2603x2137b148.f9 f9Var) {
        ...
        if (f9Var.f274243e.equals("channels") || f9Var.f274243e.equals("live")) {
    ...
    public static boolean o(int i17) {
        ...
        boolean z17 = i17 != 0;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WeChatBrands", "Business.Entry#isRestricted = " + z17);
        return z17;
    }
    ...
    public static boolean p(int i17) {
        ...
        boolean z17 = i17 == 1;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WeChatBrands", "Business.Entry#signRequsted = " + z17);
        return z17;
    }

    public boolean h() {
        return !m(this) || i(this.f274242d);
    }
    ...
    public boolean k(android.content.Context context, m3.a aVar) {
        if (m(this)) {
            java.lang.String str = com.p314xaae8f345.mm.sdk.p2603x2137b148.a9.f273996a;
            if (yp5.a.f545942a.a() || !((java.lang.Boolean) com.p314xaae8f345.mm.sdk.p2603x2137b148.g9.f274251a.mo1850x58b836e(this)).booleanValue()) {
                return true;
            }
            if (!((java.lang.Boolean) com.p314xaae8f345.mm.sdk.p2603x2137b148.g9.f274252b.mo1850x58b836e(this)).booleanValue()) {
                return false;
            }
        }
        com.p314xaae8f345.mm.sdk.p2603x2137b148.e9 e9Var = new com.p314xaae8f345.mm.sdk.p2603x2137b148.e9(context, aVar);
        if (android.os.Looper.myLooper() == android.os.Looper.getMainLooper()) {
            e9Var.run();
        } else {
            ((ku5.t0) ku5.t0.f394148d).B(e9Var);
        }
        return false;
    }
    ...
    public boolean l(android.content.Context context, m3.a aVar) {
        ...
        if (!(context instanceof android.app.Activity) || !((java.lang.Boolean) com.p314xaae8f345.mm.sdk.p2603x2137b148.g9.f274252b.mo1850x58b836e(this)).booleanValue() || aVar == null) {
            return false;
        }
        aVar.mo3938xab27b508(com.p314xaae8f345.mm.sdk.p2603x2137b148.g9.f274253c);
        return false;
    }

    public boolean n() {
        return !m(this) || o(this.f274242d);
    }
