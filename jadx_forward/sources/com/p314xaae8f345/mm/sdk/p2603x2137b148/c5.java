...
public class c5 {
    public static java.lang.String a(java.lang.String str) {
        return com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) ? "" : str.startsWith("+") ? str : "+".concat(str);
    }
    ...
    public static java.lang.String c(java.lang.String str) {
        ...
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(null)) {
            com.p314xaae8f345.mm.sdk.p2603x2137b148.e5[] m77735xcee59d22 = com.p314xaae8f345.mm.sdk.p2603x2137b148.e5.m77735xcee59d22();
            int length2 = m77735xcee59d22.length;
            while (i18 < length2) {
                com.p314xaae8f345.mm.sdk.p2603x2137b148.e5 e5Var = m77735xcee59d22[i18];
                if (replace.startsWith(e5Var.f274185e) && (length = replace.length() - e5Var.f274185e.length()) >= e5Var.f274186f && length <= e5Var.f274187g) {
                    throw null;
                }
                i18++;
            }
        ...
        com.p314xaae8f345.mm.sdk.p2603x2137b148.e5[] m77735xcee59d222 = com.p314xaae8f345.mm.sdk.p2603x2137b148.e5.m77735xcee59d22();
        int length3 = m77735xcee59d222.length;
        while (i18 < length3) {
            com.p314xaae8f345.mm.sdk.p2603x2137b148.e5 e5Var2 = m77735xcee59d222[i18];
            if (replace.startsWith(e5Var2.f274185e)) {
                int length4 = replace.length();
                java.lang.String str2 = e5Var2.f274185e;
                int length5 = length4 - str2.length();
                if (length5 >= e5Var2.f274186f && length5 <= (i17 = e5Var2.f274187g)) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PhoneFormater", "[extractCountryCode] countrycode:%s country isocode: %s country.minlen:%d country.maxlen:%d", str2, e5Var2.f274184d, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i17));
                    return str2;
                }
            }
            i18++;
    ...
    public static java.lang.String e(java.lang.String str) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) || !com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.Q0(str).booleanValue()) {
            return str;
        }
    ...
    public static java.lang.String h(java.lang.String str) {
        return com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) ? "" : str.replaceAll("[\\.\\-\\ ]", "").trim();
    }
    ...
    public java.lang.String f(java.lang.String str, java.lang.String str2) {
        java.util.List<com.p314xaae8f345.mm.sdk.p2603x2137b148.f5> list;
        com.p314xaae8f345.mm.sdk.p2603x2137b148.e5[] e5VarArr;
        int i17;
        com.p314xaae8f345.mm.sdk.p2603x2137b148.e5 e5Var;
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) && !com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str2)) {
            com.p314xaae8f345.mm.sdk.p2603x2137b148.e5[] m77735xcee59d22 = com.p314xaae8f345.mm.sdk.p2603x2137b148.e5.m77735xcee59d22();
            int length = m77735xcee59d22.length;
            int i18 = 0;
            while (i18 < length) {
                com.p314xaae8f345.mm.sdk.p2603x2137b148.e5 e5Var2 = m77735xcee59d22[i18];
                if (e5Var2.f274185e != null && str.trim().toLowerCase().equals(e5Var2.f274185e.trim().toLowerCase()) && (list = e5Var2.f274188h) != null) {
                    java.lang.String h17 = h(str2);
                    if (h17 != null && h17.length() > e5Var2.f274186f) {
                        return h17;
                    }
                    for (com.p314xaae8f345.mm.sdk.p2603x2137b148.f5 f5Var : list) {
                        boolean K0 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(f5Var.f274203a);
                        int i19 = e5Var2.f274187g;
                        java.lang.String str3 = f5Var.f274204b;
                        java.lang.String str4 = f5Var.f274205c;
                        if (!K0) {
                            e5VarArr = m77735xcee59d22;
                            i17 = length;
                            e5Var = e5Var2;
                            if (java.util.regex.Pattern.compile(f5Var.f274203a).matcher(h17).lookingAt()) {
                        ...
                        m77735xcee59d22 = e5VarArr;
                        length = i17;
                        e5Var2 = e5Var;
                    }
                }
                i18++;
                m77735xcee59d22 = m77735xcee59d22;
                length = length;
            }
        }
        return str2;
