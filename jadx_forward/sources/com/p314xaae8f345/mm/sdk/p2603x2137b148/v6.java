...
public abstract class v6 {
    public static android.net.Uri a(android.content.Context context, java.lang.String str) {
        ...
        android.net.Uri uri;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ScopedStorageUtil", "#getContextUri: " + str);
        if (android.text.TextUtils.isEmpty(str)) {
            return null;
        }
        try {
            java.util.Iterator<android.app.ActivityManager.AppTask> it = ((android.app.ActivityManager) context.getSystemService(com.p314xaae8f345.p3076xcbed6b1f.p3080xbe953013.p3081x4189335b.C26617x73f7249d.f55566xbe5e9100)).getAppTasks().iterator();
            while (it.hasNext()) {
                ...
                if (taskInfo != null && (intent = taskInfo.baseIntent) != null) {
                    ...
                    if (data != null && str.equals(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.J(context, data))) {
                        return data;
                    }
                    if (taskInfo.baseIntent.getExtras() != null && (uri = (android.net.Uri) taskInfo.baseIntent.getExtras().getParcelable("android.intent.extra.STREAM")) != null && str.equals(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.J(context, uri))) {
                        return uri;
                    }
                }
            }
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ScopedStorageUtil", "getExternalUri fail: " + e17.getMessage());
            return null;
        }
    }

    public static android.net.Uri b(android.content.Context context, long j17, android.net.Uri uri) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ScopedStorageUtil", "#getExternalUri: " + j17);
        if (uri == null || !com.p314xaae8f345.mm.sdk.p2603x2137b148.d7.a(context) || j17 == 0) {
            return null;
        }
        try {
            return com.p314xaae8f345.mm.sdk.p2603x2137b148.b7.b(context, j17, uri);
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ScopedStorageUtil", "getExternalUri fail: " + e17.getMessage());
            return null;
        }
    ...
    public static android.net.Uri c(android.content.Context context, java.lang.String str, android.net.Uri uri) {
        if (uri == null || !com.p314xaae8f345.mm.sdk.p2603x2137b148.d7.a(context) || android.text.TextUtils.isEmpty(str)) {
            return null;
        }
        try {
            return com.p314xaae8f345.mm.sdk.p2603x2137b148.b7.a(context, str, uri);
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.ScopedStorageUtil", "getExternalUri fail: " + e17.getMessage());
            return null;
        }
    ...
    public static android.net.Uri e(android.content.Context context, java.lang.String str) {
        android.net.Uri c17;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ScopedStorageUtil", "#getMediaUri: " + str);
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.d7.a(context) || android.text.TextUtils.isEmpty(str)) {
            return null;
        }
