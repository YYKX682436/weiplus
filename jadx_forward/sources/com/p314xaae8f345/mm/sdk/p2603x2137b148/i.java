...
public abstract class i {
    ...
    public static android.app.Application f274263a;

    /* renamed from: b, reason: collision with root package name */
    public static android.app.Application f274264b;

    public static synchronized android.app.Application a() {
        synchronized (com.p314xaae8f345.mm.sdk.p2603x2137b148.i.class) {
            android.app.Application application = f274263a;
            if (application != null) {
                return application;
            }
            android.app.Application application2 = f274264b;
    ...
    public static android.app.Application b() {
        try {
            ...
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.sdk.ApplicationGlobal", "get activity thread fail, error = " + e17.getMessage() + " & " + e18.getMessage());
                return null;
            }
        }
    }
