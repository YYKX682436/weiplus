...
public class c0 implements java.util.Iterator {
    ...
    public int f152128d = 0;

    public c0(com.p314xaae8f345.mm.p944x882e457a.d0 d0Var, com.p314xaae8f345.mm.p944x882e457a.b0 b0Var) {
    }

    @Override // java.util.Iterator
    public boolean hasNext() {
        return this.f152128d < 24;
    }

    @Override // java.util.Iterator
    public java.lang.Object next() {
        int i17 = this.f152128d;
        this.f152128d = i17 + 1;
        switch (i17) {
            case 0:
