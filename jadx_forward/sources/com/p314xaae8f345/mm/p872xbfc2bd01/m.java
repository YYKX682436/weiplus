...
public class m extends com.p314xaae8f345.mm.p872xbfc2bd01.o {
        ...
        try {
            ...
            try {
                try {
                    ...
                    e = e17;
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.InBitmapFactory", e, "error decode bitmap %s", e.getMessage());
    ...
    public void d(android.graphics.Bitmap bitmap) {
        ...
        com.p314xaae8f345.mm.p872xbfc2bd01.c cVar = com.p314xaae8f345.mm.p872xbfc2bd01.c.f150489e;
        synchronized (cVar) {
            if (bitmap.isMutable() && !bitmap.isRecycled()) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BitmapPool", "release: %s", bitmap);
                cVar.k(bitmap);
                try {
                    if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P(j62.e.g().j("clicfg_bitmap_pool_release_recycle", "0", false, true), 0) == 1) {
                        bitmap.recycle();
                    }
    ...
    */
    public android.graphics.Bitmap e(java.lang.String r10, android.graphics.Rect r11, android.graphics.BitmapFactory.Options r12) {
        /*
            r9 = this;
            r0 = 0
            java.io.InputStream r10 = com.p314xaae8f345.mm.vfs.w6.E(r10)     // Catch: java.lang.Throwable -> L2c java.lang.Exception -> L2f
            com.tencent.mm.memory.k r7 = com.p314xaae8f345.mm.p872xbfc2bd01.k.f150497d     // Catch: java.lang.Throwable -> L27 java.lang.Exception -> L29
        ...
        L32:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r12, r1, r2)     // Catch: java.lang.Throwable -> L4c
            if (r8 == 0) goto L21
            com.tencent.mm.memory.k r11 = com.p314xaae8f345.mm.p872xbfc2bd01.k.f150497d
            r11.b(r8)
            goto L21
        L4b:
            return r0
        ...
        L4e:
            if (r0 == 0) goto L55
            com.tencent.mm.memory.k r12 = com.p314xaae8f345.mm.p872xbfc2bd01.k.f150497d
            r12.b(r0)
        L55:
            com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.v1(r10)
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p872xbfc2bd01.m.e(java.lang.String, android.graphics.Rect, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    */
    public android.graphics.Bitmap g(java.io.InputStream r10, android.graphics.BitmapFactory.Options r11) {
        /*
            r9 = this;
            r0 = 0
            com.tencent.mm.memory.k r1 = com.p314xaae8f345.mm.p872xbfc2bd01.k.f150497d     // Catch: java.lang.Throwable -> L1f java.lang.Exception -> L21
        ...
        L23:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r11, r1, r3)     // Catch: java.lang.Throwable -> L3c
            if (r2 == 0) goto L3b
            com.tencent.mm.memory.k r10 = com.p314xaae8f345.mm.p872xbfc2bd01.k.f150497d
            r10.b(r2)
        L3b:
            return r0
        L3c:
        ...
        L45:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p872xbfc2bd01.m.g(java.io.InputStream, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    */
    public final android.graphics.Bitmap h(java.io.InputStream r21, android.graphics.Rect r22, android.graphics.BitmapFactory.Options r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p872xbfc2bd01.m.h(java.io.InputStream, android.graphics.Rect, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }
    ...
    public final android.graphics.BitmapFactory.Options i(java.io.InputStream inputStream, android.graphics.BitmapFactory.Options options, java.nio.ByteBuffer byteBuffer, boolean z17, android.graphics.Rect rect) {
        ...
        if (rect == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.InBitmapFactory", "options.outWidth: %s, options.outHeight: %s, sampleSize: %s", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(options.inSampleSize));
        } else {
            i18 = rect.right - rect.left;
            i17 = rect.bottom - rect.top;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.InBitmapFactory", "region decode, width: %s, height: %s, rect: %s", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(i17), rect);
        }
        if (z17) {
            com.p314xaae8f345.mm.p872xbfc2bd01.c cVar = com.p314xaae8f345.mm.p872xbfc2bd01.c.f150489e;
            ...
            com.p314xaae8f345.mm.p872xbfc2bd01.c cVar2 = com.p314xaae8f345.mm.p872xbfc2bd01.c.f150489e;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.InBitmapFactory", "bitmapToReuse: %s, isRecycle: %s, isRegionDecode: %s, width: %s, height: %s", objArr);
        if (bitmap != null && bitmap.isMutable() && !bitmap.isRecycled()) {
            options.inBitmap = bitmap;
        }
        options.inMutable = true;
        boolean z18 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x.f274597a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.InBitmapFactory", "mimetype: %s", options.outMimeType);
        return options;
    }
}
