...
public class mo implements db5.t4 {
    ...
    public final /* synthetic */ com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2679xa2ca8c3b.lp f286128d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p2621x8fb0427b.f9 f286129e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ yb5.d f286130f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f286131g;

    public mo(com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2679xa2ca8c3b.lp lpVar, com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, yb5.d dVar, android.content.Context context) {
        this.f286128d = lpVar;
        this.f286129e = f9Var;
        this.f286130f = dVar;
        this.f286131g = context;
    }

    @Override // db5.t4
    /* renamed from: onMMMenuItemSelected */
    public void mo888x34063ac(android.view.MenuItem menuItem, int i17) {
        com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2679xa2ca8c3b.lp lpVar = this.f286128d;
        java.lang.String charSequence = lpVar.f286049n.toString();
        int itemId = menuItem.getItemId();
        com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var = this.f286129e;
        if (itemId == 0) {
        ...
        if (itemId == 1) {
            wl5.x xVar3 = lpVar.f286048m;
            if (xVar3 != null) {
                wl5.v vVar = xVar3.f528699k;
                if (vVar != null) {
                    vVar.d();
                }
                wl5.x xVar4 = lpVar.f286048m;
                xVar4.M = true;
                xVar4.i();
                lpVar.f286048m.l(0, lpVar.f286044i.m80028xc2a54588().a().length());
                lpVar.f286048m.o();
                wl5.x xVar5 = lpVar.f286048m;
                if (xVar5.f528701m) {
                    xVar5.f528701m = false;
                    xVar5.n(java.lang.Boolean.TRUE);
                }
                lpVar.f286048m.r();
                wl5.v vVar2 = lpVar.f286048m.f528699k;
                if (vVar2 != null) {
                    vVar2.e();
                    return;
                }
