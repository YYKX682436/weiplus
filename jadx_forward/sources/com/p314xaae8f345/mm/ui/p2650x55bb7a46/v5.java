...
public class v5 implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.view.View f284329d;
    ...
    public void run() {
        android.view.View view = this.f284329d;
        java.lang.Object tag = view.getTag(com.p314xaae8f345.mm.R.id.bpk);
        if (tag != null && !((java.lang.Boolean) tag).booleanValue()) {
            android.view.View view2 = this.f284329d;
        ...
        android.view.View view3 = this.f284329d;
