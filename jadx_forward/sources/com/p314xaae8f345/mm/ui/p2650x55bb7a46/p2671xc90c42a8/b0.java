...
public final class b0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2671xc90c42a8.h0 f283653d;

    public b0(com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2671xc90c42a8.h0 h0Var) {
        this.f283653d = h0Var;
    }
    ...
    public final void run() {
        ...
        int i17 = 0;
        android.database.Cursor k17 = ((com.p314xaae8f345.mm.p2621x8fb0427b.g9) c01.d9.b().u()).k1(this.f283653d.f283769e, 0, -1);
        long currentTimeMillis3 = java.lang.System.currentTimeMillis() - currentTimeMillis2;
        if (k17 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.EmojiHistoryListPresenter", "loadData cursor is null!! dbQueryCost:%dms", java.lang.Long.valueOf(currentTimeMillis3));
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EmojiHistoryListPresenter", "[firstLoad][perf] dbQuery cost:%dms", java.lang.Long.valueOf(currentTimeMillis3));
        com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2671xc90c42a8.h0 h0Var = this.f283653d;
        try {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            int i18 = 0;
            while (k17.moveToNext() && i18 < h0Var.f283772h * 50) {
                ...
                if (f07.size() > 3 && (Di = ((com.p314xaae8f345.mm.p689xc5a27af6.p741x5c28046.q0) ((com.p314xaae8f345.mm.p689xc5a27af6.p741x5c28046.api.z5) i95.n0.c(com.p314xaae8f345.mm.p689xc5a27af6.p741x5c28046.api.z5.class))).Di((java.lang.String) f07.get(3))) != null && (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(h0Var.f283773i, "") || h0Var.d(Di, h0Var.f283773i))) {
                    ...
                    java.lang.String c17 = com.p314xaae8f345.mm.ui.p2708x5ccaae3b.a.e().c(new java.util.Date(f9Var.mo78012x3fdd41df()), h0Var.f283768d);
            ...
            if (i18 != 0 && i18 < h0Var.f283772h * 50) {
                zb5.c cVar3 = new zb5.c();
                cVar3.f552843c = 2;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EmojiHistoryListPresenter", "[firstLoad] :: no more data found in DB");
                arrayList.add(cVar3);
            }
            ((ku5.t0) ku5.t0.f394148d).B(new com.p314xaae8f345.mm.ui.p2650x55bb7a46.p2671xc90c42a8.a0(h0Var, arrayList));
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EmojiHistoryListPresenter", "[firstLoad][perf][final] total cost:%dms, dbQuery:%dms, process+notifyUI:%dms, items:%d", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis), java.lang.Long.valueOf(j19), java.lang.Long.valueOf((java.lang.System.currentTimeMillis() - currentTimeMillis) - j19), java.lang.Integer.valueOf(i18));
            try {
