...
public final class C21530xd36355bc extends p012xc85e97e9.p075x2eaf9f.p079xd1075a44.C1095x65355f89 {
    ...
    public C21530xd36355bc(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent ev6) {
        ...
        if (action == 0) {
            ...
            com.p314xaae8f345.mm.ui.yk.c(str, "intercept down touchTop: " + this.touchTop + ", touchBottom: " + this.touchBotom + ", x: " + this.lastPosX + ", y: " + this.lastPosY, new java.lang.Object[0]);
            ...
            if (action == 2 || action == 3) {
                ...
                com.p314xaae8f345.mm.ui.yk.c(str, "intercept move x: " + x17 + ", y: " + y17 + ", dis: " + java.lang.Math.max(abs, abs2), new java.lang.Object[0]);
    ...
    public boolean onTouchEvent(android.view.MotionEvent ev6) {
        ...
        if (z17) {
            int y17 = (int) ev6.getY();
            com.p314xaae8f345.mm.ui.yk.c(this.K, "move top: " + this.touchTop + ", bottom: " + this.touchBotom + ", dy: " + (y17 - this.lastPosY), new java.lang.Object[0]);
    ...
    /* renamed from: setLastPosX */
    public final void m79283x1f9402bc(int i17) {
        this.lastPosX = i17;
    }

    /* renamed from: setLastPosY */
    public final void m79284x1f9402bd(int i17) {
        this.lastPosY = i17;
    }

    /* renamed from: setTouchBotom */
    public final void m79285xbb991be8(boolean z17) {
        this.touchBotom = z17;
    }

    /* renamed from: setTouchTop */
    public final void m79286x45b94c18(boolean z17) {
        this.touchTop = z17;
    }
}
