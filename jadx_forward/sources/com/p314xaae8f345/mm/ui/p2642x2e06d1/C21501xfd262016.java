...
public final class C21501xfd262016 extends android.widget.HorizontalScrollView {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public db5.w8 onScrollListener;

    public C21501xfd262016(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void onScrollChanged(int i17, int i18, int i19, int i27) {
        ...
        if (w8Var != null) {
            w8Var.mo26906x2d3d645c(this, i17, i18, i19, i27);
        }
    }

    /* renamed from: setOnScrollListener */
    public final void m79013x1a2696e2(db5.w8 w8Var) {
        this.onScrollListener = w8Var;
    }

    public C21501xfd262016(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
