...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_filled_close_thin */
/* loaded from: classes16.dex */
public class C8527x83506598 extends l95.c {

    /* renamed from: width */
    private final int f24253x6be2dc6 = 24;

    /* renamed from: height */
    private final int f24252xb7389127 = 24;
    ...
    public int mo43368x913c4840(int i17, java.lang.Object... objArr) {
        ...
        m145417xd4061a5a3.moveTo(11.9988f, 13.2726f);
        m145417xd4061a5a3.lineTo(5.77408f, 19.4961f);
        m145417xd4061a5a3.lineTo(4.50141f, 18.2232f);
        m145417xd4061a5a3.lineTo(10.7259f, 11.9999f);
        m145417xd4061a5a3.lineTo(4.50049f, 5.77567f);
        m145417xd4061a5a3.lineTo(5.77316f, 4.50277f);
        m145417xd4061a5a3.lineTo(11.9988f, 10.7273f);
        m145417xd4061a5a3.lineTo(18.227f, 4.50027f);
        m145417xd4061a5a3.lineTo(19.4997f, 5.77319f);
        m145417xd4061a5a3.lineTo(13.2717f, 11.9999f);
        m145417xd4061a5a3.lineTo(19.4997f, 18.2268f);
        m145417xd4061a5a3.lineTo(18.2271f, 19.4997f);
        m145417xd4061a5a3.lineTo(11.9988f, 13.2726f);
