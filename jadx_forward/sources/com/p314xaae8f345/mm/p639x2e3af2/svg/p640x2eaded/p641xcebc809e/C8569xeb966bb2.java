...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_filled_expand */
/* loaded from: classes16.dex */
public class C8569xeb966bb2 extends l95.c {

    /* renamed from: width */
    private final int f24337x6be2dc6 = 24;

    /* renamed from: height */
    private final int f24336xb7389127 = 24;
    ...
    public int mo43368x913c4840(int i17, java.lang.Object... objArr) {
        ...
        m145417xd4061a5a3.moveTo(18.5001f, 10.5f);
        m145417xd4061a5a3.lineTo(20.0001f, 10.5f);
        m145417xd4061a5a3.lineTo(20.0001f, 5.0f);
        m145417xd4061a5a3.cubicTo(20.0001f, 4.44772f, 19.5524f, 4.0f, 19.0001f, 4.0f);
        m145417xd4061a5a3.lineTo(13.4992f, 4.0f);
        m145417xd4061a5a3.lineTo(13.4992f, 5.5f);
        m145417xd4061a5a3.lineTo(17.4394f, 5.5f);
        m145417xd4061a5a3.lineTo(12.8839f, 10.0555f);
        m145417xd4061a5a3.lineTo(13.9446f, 11.1161f);
        m145417xd4061a5a3.lineTo(18.5001f, 6.56066f);
        m145417xd4061a5a3.lineTo(18.5001f, 10.5f);
        m145417xd4061a5a3.close();
        m145417xd4061a5a3.moveTo(11.1162f, 13.9445f);
        m145417xd4061a5a3.lineTo(10.0555f, 12.8839f);
        m145417xd4061a5a3.lineTo(5.5f, 17.4394f);
        m145417xd4061a5a3.lineTo(5.5f, 13.4994f);
        m145417xd4061a5a3.lineTo(4.0f, 13.4994f);
        m145417xd4061a5a3.lineTo(4.0f, 19.0003f);
        m145417xd4061a5a3.cubicTo(4.0f, 19.5526f, 4.44772f, 20.0003f, 5.0f, 20.0003f);
        m145417xd4061a5a3.lineTo(10.5f, 20.0003f);
        m145417xd4061a5a3.lineTo(10.5f, 18.5003f);
        m145417xd4061a5a3.lineTo(6.56041f, 18.5003f);
        m145417xd4061a5a3.lineTo(11.1162f, 13.9445f);
        m145417xd4061a5a3.close();
