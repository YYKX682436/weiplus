...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.appbrand_taskbar_load_progress */
/* loaded from: classes16.dex */
public class C7373x846fbddc extends l95.c {

    /* renamed from: width */
    private final int f21945x6be2dc6 = 16;

    /* renamed from: height */
    private final int f21944xb7389127 = 16;
    ...
    public int mo43368x913c4840(int i17, java.lang.Object... objArr) {
        ...
        m145417xd4061a5a2.lineTo(12.0f, 12.0f);
        ...
        m145417xd4061a5a3.moveTo(14.0f, 8.0f);
        m145417xd4061a5a3.cubicTo(14.0f, 11.3137f, 11.3137f, 14.0f, 8.0f, 14.0f);
        m145417xd4061a5a3.lineTo(8.0f, 12.95f);
        m145417xd4061a5a3.cubicTo(10.7338f, 12.95f, 12.95f, 10.7338f, 12.95f, 8.0f);
        m145417xd4061a5a3.cubicTo(12.95f, 5.26619f, 10.7338f, 3.05f, 8.0f, 3.05f);
        m145417xd4061a5a3.lineTo(8.0f, 2.0f);
        m145417xd4061a5a3.cubicTo(11.3137f, 2.0f, 14.0f, 4.68629f, 14.0f, 8.0f);
        ...
        com.p314xaae8f345.mm.svg.C21323x60230c65.m78193x7fec2a77(m145414xacbd08c9, 8.0f, 3.05f, 8.0f, 12.875f, new int[]{6316128, 1281384544}, new float[]{0.0f, 1.0f}, m145412xe5ca94b6, 0);
        ...
        m145417xd4061a5a4.moveTo(8.0f, 12.95f);
        m145417xd4061a5a4.lineTo(8.0f, 14.0f);
        m145417xd4061a5a4.cubicTo(4.68629f, 14.0f, 2.0f, 11.3137f, 2.0f, 8.0f);
        m145417xd4061a5a4.cubicTo(2.0f, 4.68629f, 4.68629f, 2.0f, 8.0f, 2.0f);
        m145417xd4061a5a4.cubicTo(8.28995f, 2.0f, 8.525f, 2.23505f, 8.525f, 2.525f);
        m145417xd4061a5a4.cubicTo(8.525f, 2.81495f, 8.28995f, 3.05f, 8.0f, 3.05f);
        m145417xd4061a5a4.cubicTo(5.26619f, 3.05f, 3.05f, 5.26619f, 3.05f, 8.0f);
        m145417xd4061a5a4.cubicTo(3.05f, 10.7338f, 5.26619f, 12.95f, 8.0f, 12.95f);
        ...
        com.p314xaae8f345.mm.svg.C21323x60230c65.m78193x7fec2a77(m145414xacbd08c92, 8.0f, 3.05f, 8.0f, 12.95f, new int[]{-10461088, 1281384544}, new float[]{0.0f, 1.0f}, m145412xe5ca94b6, 0);
