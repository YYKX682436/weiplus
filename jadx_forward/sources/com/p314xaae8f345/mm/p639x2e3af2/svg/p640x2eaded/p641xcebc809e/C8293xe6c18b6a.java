...
public class C8293xe6c18b6a extends l95.c {

    /* renamed from: width */
    private final int f23785x6be2dc6 = 24;

    /* renamed from: height */
    private final int f23784xb7389127 = 24;
    ...
    public int mo43368x913c4840(int i17, java.lang.Object... objArr) {
        ...
        canvas.save();
        float[] m145419x1d8aec80 = l95.c.m145419x1d8aec80(m145413xf00d6f43, 1.0f, 0.0f, -320.0f, 0.0f, 1.0f, -104.0f, 0.0f, 0.0f, 1.0f);
        ...
        canvas.concat(m145412xe5ca94b6);
        canvas.save();
        float[] m145419x1d8aec803 = l95.c.m145419x1d8aec80(m145419x1d8aec802, 1.0f, 0.0f, 16.0f, 0.0f, 1.0f, 24.0f, 0.0f, 0.0f, 1.0f);
        m145412xe5ca94b6.reset();
        m145412xe5ca94b6.setValues(m145419x1d8aec803);
        canvas.concat(m145412xe5ca94b6);
        canvas.save();
        float[] m145419x1d8aec804 = l95.c.m145419x1d8aec80(m145419x1d8aec803, 1.0f, 0.0f, 308.0f, 0.0f, 1.0f, 4.0f, 0.0f, 0.0f, 1.0f);
        m145412xe5ca94b6.reset();
