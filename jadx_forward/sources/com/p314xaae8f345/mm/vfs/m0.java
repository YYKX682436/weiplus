...
public abstract class m0 extends com.p314xaae8f345.mm.vfs.a implements com.p314xaae8f345.mm.vfs.p2 {
    @Override // com.p314xaae8f345.mm.vfs.q2
    public java.lang.Iterable C(java.lang.String str) {
        java.util.List k17 = com.p314xaae8f345.mm.vfs.e8.k(M(str, 4));
        int size = k17.size();
        if (size == 1) {
            return ((com.p314xaae8f345.mm.vfs.q2) k17.get(0)).C(str);
        }
        if (size == 0) {
            return null;
        }
        com.p314xaae8f345.mm.vfs.l0 l0Var = new com.p314xaae8f345.mm.vfs.l0(str);
        return new pm5.e(new pm5.b(k17, l0Var), l0Var);
    }

    @Override // com.p314xaae8f345.mm.vfs.q2
    public java.lang.String D(java.lang.String str, boolean z17) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, z17 ? 2 : 1);
        if (L == null) {
            return null;
        }
        return L.D(str, z17);
    ...
    public boolean F(java.lang.String str) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, 1);
        return L != null && L.F(str);
    }

    @Override // com.p314xaae8f345.mm.vfs.a
    public final long G(java.lang.String str, com.p314xaae8f345.mm.vfs.q2 q2Var, java.lang.String str2, boolean z17) {
        throw new java.lang.AssertionError();
    }

    @Override // com.p314xaae8f345.mm.vfs.a
    public final boolean H(java.lang.String str, com.p314xaae8f345.mm.vfs.q2 q2Var, java.lang.String str2) {
        throw new java.lang.AssertionError();
    }
    ...
    public abstract com.p314xaae8f345.mm.vfs.q2 L(java.lang.String str, int i17);
    ...
    public final boolean N(java.lang.String str, boolean z17) {
        ...
        java.lang.String i17 = com.p314xaae8f345.mm.vfs.e8.i(str);
        if (i17 == null) {
            return false;
        }
        com.p314xaae8f345.mm.vfs.q2 L = L(i17, 2);
        while (z17 && (L instanceof com.p314xaae8f345.mm.vfs.m0)) {
            L = ((com.p314xaae8f345.mm.vfs.m0) L).L(i17, 2);
        }
        com.p314xaae8f345.mm.vfs.q2 L2 = L(i17, 1);
        while (z17 && (L2 instanceof com.p314xaae8f345.mm.vfs.m0)) {
            L2 = ((com.p314xaae8f345.mm.vfs.m0) L2).L(i17, 1);
        }
        if (L == L2 || L.F(i17) || (m17 = L2.m(i17)) == null || !m17.f294769f) {
            return false;
        }
        return L.r(i17);
    }
    ...
    public java.io.OutputStream c(java.lang.String str, boolean z17) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, z17 ? 3 : 2);
        if (L == null) {
            throw new java.io.FileNotFoundException("Path not found on any filesystems: " + str);
        }
        if (z17 || K().size() <= 1) {
    ...
    public boolean d(java.lang.String str) {
        ...
        boolean z17 = false;
        while (it.hasNext()) {
            z17 |= ((com.p314xaae8f345.mm.vfs.q2) it.next()).d(str);
        }
        return z17;
    }
    ...
    public boolean e(java.lang.String str, boolean z17) {
        ...
        boolean z18 = false;
        while (it.hasNext()) {
            z18 |= ((com.p314xaae8f345.mm.vfs.q2) it.next()).e(str, z17);
        }
        return z18;
    }
    ...
    public com.p314xaae8f345.mm.vfs.o2 g(java.lang.String str) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, 0);
        if (L != null) {
            return L.g(str);
        }
    ...
    public java.lang.Iterable mo82286x32b09e(java.lang.String str) {
        ...
        int size = k17.size();
        if (size == 1) {
            return ((com.p314xaae8f345.mm.vfs.q2) k17.get(0)).mo82286x32b09e(str);
        }
        if (size == 0) {
            return null;
        }
        com.p314xaae8f345.mm.vfs.k0 k0Var = new com.p314xaae8f345.mm.vfs.k0(str);
    ...
    public boolean n(java.lang.String str, long j17) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, 3);
    ...
    public void q(android.os.CancellationSignal cancellationSignal) {
        for (com.p314xaae8f345.mm.vfs.q2 q2Var : K()) {
    ...
    public boolean r(java.lang.String str) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, 2);
    ...
    public android.os.ParcelFileDescriptor x(java.lang.String str, java.lang.String str2) {
        com.p314xaae8f345.mm.vfs.q2 L = L(str, str2.contains("rw") ? 3 : str2.contains("w") ? 2 : 1);
        if (L != null) {
            return L.x(str, str2);
        }
        throw new java.io.FileNotFoundException("Path not found on any filesystems: " + str);
