...
public class h4 extends com.p314xaae8f345.mm.vfs.a {

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f294508e;

    /* renamed from: f, reason: collision with root package name */
    public boolean f294509f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.vfs.C22758x1f6ac662 f294510g;

    public h4(com.p314xaae8f345.mm.vfs.C22758x1f6ac662 c22758x1f6ac662, java.lang.String str) {
        this.f294510g = c22758x1f6ac662;
        java.lang.String a17 = str.isEmpty() ? "" : com.p314xaae8f345.mm.vfs.e8.a(str);
        ...
        if (file.exists()) {
            com.p314xaae8f345.p2943x68b0d85.p2944xbe97f590.Log.e("VFS.NativeFileSystem", "Base directory exists but is not a directory, delete and proceed.Base path: " + file.getPath());
            file.delete();
        }
        this.f294509f = false;
    }
    ...
    public java.lang.Iterable C(java.lang.String str) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            java.nio.file.Path a17 = com.p314xaae8f345.mm.vfs.c4.a(D);
            if (a17 == null) {
                return null;
            }
            return new com.p314xaae8f345.mm.vfs.b4(a17, this);
        }
    ...
    public java.lang.String D(java.lang.String str, boolean z17) {
        java.lang.String str2 = this.f294508e;
        if (str2 == null) {
            throw new java.lang.IllegalStateException("Base path cannot be resolved: " + this.f294510g.f294270e);
        }
        if (z17 && !this.f294509f) {
    ...
    public boolean H(java.lang.String str, com.p314xaae8f345.mm.vfs.q2 q2Var, java.lang.String str2) {
        if ((q2Var.o() & 2) != 0) {
            ...
            if (D != null && D2 != null) {
                return com.p314xaae8f345.mm.vfs.z3.a(D, D2);
            }
        }
        return false;
    }

    public final com.p314xaae8f345.mm.vfs.x1 K(java.io.File file) {
        long j17;
        java.lang.String path = file.getPath();
        java.lang.String str = this.f294508e;
        ...
        try {
            ...
            return new com.p314xaae8f345.mm.vfs.x1(this, substring, name, stat.st_size, 512 * lstat.st_blocks, j17, android.system.OsConstants.S_ISDIR(stat.st_mode));
    ...
    public java.io.InputStream a(java.lang.String str) {
        ...
        try {
            return new com.p314xaae8f345.mm.vfs.f4(D);
        } catch (java.lang.Exception e17) {
            throw com.p314xaae8f345.mm.vfs.C22758x1f6ac662.c(e17);
        }
    }
    ...
    public boolean e(java.lang.String str, boolean z17) {
        ...
        boolean f17 = z17 ? com.p314xaae8f345.mm.vfs.C22758x1f6ac662.f(file) : file.delete();
        if (z18 && f17) {
            this.f294509f = false;
        }
        return f17;
    ...
    /* renamed from: equals */
    public boolean m82404xb2c87fbf(java.lang.Object obj) {
        if (obj instanceof com.p314xaae8f345.mm.vfs.h4) {
            if (this.f294508e.equals(((com.p314xaae8f345.mm.vfs.h4) obj).f294508e)) {
                return true;
            }
        }
        return false;
    ...
    public com.p314xaae8f345.mm.vfs.o2 g(java.lang.String str) {
        try {
            ...
            com.p314xaae8f345.mm.vfs.o2 o2Var = new com.p314xaae8f345.mm.vfs.o2();
            o2Var.f294635a = statFs.getBlockSizeLong();
            o2Var.f294636b = statFs.getAvailableBlocksLong();
            long blockCountLong = statFs.getBlockCountLong();
            long j17 = o2Var.f294636b;
            long j18 = o2Var.f294635a;
            o2Var.f294637c = j17 * j18;
            o2Var.f294638d = blockCountLong * j18;
            return o2Var;
    ...
    public int m82405x8cdac1b() {
        return com.p314xaae8f345.mm.vfs.h4.class.hashCode() ^ this.f294508e.hashCode();
    }
    ...
    public java.lang.Iterable mo82286x32b09e(java.lang.String str) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            ...
            return new com.p314xaae8f345.mm.vfs.a4(a17, this);
        }
        java.io.File file = new java.io.File(D);
        ...
        return new pm5.l(java.util.Arrays.asList(list), new com.p314xaae8f345.mm.vfs.g4(this, file), null, false);
    }
    ...
    public boolean r(java.lang.String str) {
        ...
        try {
            ...
            com.p314xaae8f345.p2943x68b0d85.p2944xbe97f590.Log.e("VFS.NativeFileSystem", e17, "Cannot create directory.");
        }
    ...
    public android.os.ParcelFileDescriptor x(java.lang.String str, java.lang.String str2) {
        ...
        try {
            return android.os.ParcelFileDescriptor.open(new java.io.File(D), com.p314xaae8f345.mm.vfs.C22758x1f6ac662.d(str2));
        } catch (java.lang.Exception e17) {
            throw com.p314xaae8f345.mm.vfs.C22758x1f6ac662.c(e17);
        }
    }
