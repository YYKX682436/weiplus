...
public final class d {
    ...
    private static int a(android.content.ContentResolver contentResolver, android.net.Uri uri) {
        com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.i("MicroMsg.SDK.Util", "getFileSize with content url");
        if (contentResolver == null || uri == null) {
            com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.w("MicroMsg.SDK.Util", "getFileSize fail, resolver or uri is null");
            return 0;
        }
        ...
        try {
            try {
                ...
                if (openInputStream == null) {
                    if (openInputStream != null) {
                        try {
                            ...
                            com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.e("MicroMsg.SDK.Util", "getFileSize exception: " + e17.getMessage());
                        }
                    }
                    return 0;
                }
                ...
                try {
                    ...
                    com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.e("MicroMsg.SDK.Util", "getFileSize exception: " + e18.getMessage());
                }
                return available;
            } catch (java.lang.Exception e19) {
                com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.w("MicroMsg.SDK.Util", "getFileSize fail, " + e19.getMessage());
                if (0 != 0) {
                    try {
                        inputStream.close();
                    } catch (java.io.IOException e27) {
                        com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.e("MicroMsg.SDK.Util", "getFileSize exception: " + e27.getMessage());
                    }
                }
                return 0;
            }
            ...
            if (0 != 0) {
                try {
                    ...
                    com.p314xaae8f345.mm.p987xb4b579b0.p996x6a710b1.Log.e("MicroMsg.SDK.Util", "getFileSize exception: " + e28.getMessage());
                }
            }
            throw th6;
        }
    ...
    public static int m48581x50026913(java.lang.String str) {
