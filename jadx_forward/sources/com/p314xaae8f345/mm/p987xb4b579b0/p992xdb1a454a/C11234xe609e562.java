...
public class C11234xe609e562 {
    ...
    public static class Req extends com.p314xaae8f345.mm.p987xb4b579b0.p991x882e457a.AbstractC11229x4f6513ed {
        ...
        private static final int f32898xfd221449 = 10240;

        /* renamed from: scanResult */
        public java.lang.String f32899xbc66e8fa;

        @Override // com.p314xaae8f345.mm.p987xb4b579b0.p991x882e457a.AbstractC11229x4f6513ed
        /* renamed from: checkArgs */
        public boolean mo48424x17b96605() {
            java.lang.String str = this.f32899xbc66e8fa;
            return str != null && str.length() >= 0 && this.f32899xbc66e8fa.length() <= 10240;
        }
        ...
        public void mo48427x792022dd(android.os.Bundle bundle) {
            ...
            bundle.putString("_wxapi_scan_qrcode_result", java.net.URLEncoder.encode(this.f32899xbc66e8fa));
        }
    }
