...
/* renamed from: com.tencent.mm.wepicker.view.PickerView */
/* loaded from: classes9.dex */
public class C22938x221c9c73 extends p012xc85e97e9.p103xe821e364.p104xd1075a44.C1163xf1deaba4 {
    ...
    public float f295878f2;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public C22938x221c9c73(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        while (t1Var.hasNext()) {
            ...
            if (this.f295878f2 < 0.0f) {
                this.f295878f2 = view.getX();
            }
            ...
            view.setX(this.f295878f2 + ((f19 - f28) * this.offset));
    ...
    /* renamed from: setEnableAlpha */
    public final void m83500x19674fd9(boolean z17) {
        this.enableAlpha = z17;
    }

    /* renamed from: setMinAlpha */
    public final void m83501x235cdcae(float f17) {
        this.minAlpha = f17;
    }

    /* renamed from: setMinScaleRate */
    public final void m83502xeebd189a(float f17) {
        this.minScaleRate = f17;
    }

    /* renamed from: setOffset */
    public final void m83503x1b83bb95(float f17) {
        this.offset = f17;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C22938x221c9c73(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        mo7967x900dcbe1(new com.p314xaae8f345.mm.p2816xed9644dc.p2817x373aa5.C22939x715c4d57(context));
        setOverScrollMode(1);
        new p012xc85e97e9.p103xe821e364.p104xd1075a44.p1().b(this);
