...
public class a1 implements com.p314xaae8f345.mm.p971x6de15a2e.c1 {

    /* renamed from: d, reason: collision with root package name */
    public final android.os.IBinder f153492d;

    public a1(android.os.IBinder iBinder) {
        this.f153492d = iBinder;
    }
    ...
    public void Za(boolean z17, float f17, float f18, boolean z18, int i17, int i18, int i19, boolean z19, int i27, int i28, int i29) {
        ...
        try {
            ...
            obtain.writeInt(i28);
            obtain.writeInt(i29);
            this.f153492d.transact(2, obtain, obtain2, 0);
    ...
    public void le(boolean z17, float f17, float f18, boolean z18, int i17, int i18, int i19) {
        ...
        try {
            ...
            obtain.writeInt(i18);
            obtain.writeInt(i19);
            this.f153492d.transact(1, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
