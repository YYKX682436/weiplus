...
public final /* data */ class C22940x18bf1e7e {
    ...
    public C22940x18bf1e7e(int i17, java.lang.String cachePath, boolean z17, boolean z18, boolean z19, int i18, java.util.Map<java.lang.String, int[]> typicalShape, java.util.Map<java.lang.String, java.lang.String> typicalDataFile, boolean z27, java.lang.String npuLibsPath) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(cachePath, "cachePath");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(typicalShape, "typicalShape");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(typicalDataFile, "typicalDataFile");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(npuLibsPath, "npuLibsPath");
        this.numThreads = i17;
    ...
    public final java.util.Map<java.lang.String, int[]> m83512xe55482da() {
        return this.typicalShape;
    }

    /* renamed from: component8 */
    public final java.util.Map<java.lang.String, java.lang.String> m83513xe55482db() {
    ...
    /* renamed from: copy */
    public final com.p314xaae8f345.mm.p2818xd0d82df3.C22940x18bf1e7e m83515x2eaf75(int numThreads, java.lang.String cachePath, boolean allowQuantize, boolean allowGPU, boolean allowNPU, int precisionLevel, java.util.Map<java.lang.String, int[]> typicalShape, java.util.Map<java.lang.String, java.lang.String> typicalDataFile, boolean useNpuOnly, java.lang.String npuLibsPath) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(cachePath, "cachePath");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(typicalShape, "typicalShape");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(typicalDataFile, "typicalDataFile");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(npuLibsPath, "npuLibsPath");
        return new com.p314xaae8f345.mm.p2818xd0d82df3.C22940x18bf1e7e(numThreads, cachePath, allowQuantize, allowGPU, allowNPU, precisionLevel, typicalShape, typicalDataFile, useNpuOnly, npuLibsPath);
    }

    /* renamed from: equals */
    public boolean m83516xb2c87fbf(java.lang.Object other) {
        if (this == other) {
            return true;
        }
        if (!(other instanceof com.p314xaae8f345.mm.p2818xd0d82df3.C22940x18bf1e7e)) {
            return false;
        }
        com.p314xaae8f345.mm.p2818xd0d82df3.C22940x18bf1e7e c22940x18bf1e7e = (com.p314xaae8f345.mm.p2818xd0d82df3.C22940x18bf1e7e) other;
        return this.numThreads == c22940x18bf1e7e.numThreads && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.cachePath, c22940x18bf1e7e.cachePath) && this.allowQuantize == c22940x18bf1e7e.allowQuantize && this.allowGPU == c22940x18bf1e7e.allowGPU && this.allowNPU == c22940x18bf1e7e.allowNPU && this.precisionLevel == c22940x18bf1e7e.precisionLevel && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.typicalShape, c22940x18bf1e7e.typicalShape) && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.typicalDataFile, c22940x18bf1e7e.typicalDataFile) && this.useNpuOnly == c22940x18bf1e7e.useNpuOnly && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.npuLibsPath, c22940x18bf1e7e.npuLibsPath);
    }

    /* renamed from: hashCode */
    public int m83517x8cdac1b() {
    ...
    public java.lang.String m83518x9616526c() {
    ...
    public /* synthetic */ C22940x18bf1e7e(int i17, java.lang.String str, boolean z17, boolean z18, boolean z19, int i18, java.util.Map map, java.util.Map map2, boolean z27, java.lang.String str2, int i19, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
