...
public abstract class AbstractC22812x564522ea<T extends q31.p> extends com.p314xaae8f345.mm.p970x335620.AbstractC11172x705e5905<T> {
    ...
    public AbstractC22812x564522ea(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final java.util.List<java.lang.Integer> m82769x8eb95c8a() {
    ...
    public final void m82770xec18708e(ym5.e6 e6Var) {
        ym5.e6 e6Var2 = this.layoutConfig;
        this.layoutConfig = e6Var;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.b(e6Var2, e6Var);
    }

    /* renamed from: setMForceStretch */
    public final void m82771x95cc2165(jz5.l lVar) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(lVar, "<set-?>");
        this.mForceStretch = lVar;
    }

    /* renamed from: setMStretchIds */
    public final void m82772x251ecffe(java.util.List<java.lang.Integer> list) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(list, "<set-?>");
        this.mStretchIds = list;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractC22812x564522ea(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
