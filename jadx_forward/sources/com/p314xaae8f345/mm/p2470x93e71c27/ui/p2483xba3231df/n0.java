...
public final class n0 {
    ...
    public static /* synthetic */ void d(com.p314xaae8f345.mm.p2470x93e71c27.ui.p2483xba3231df.n0 n0Var, java.lang.String str, android.widget.ImageView imageView, float f17, boolean z17, int i17, java.lang.Object obj) {
        if ((i17 & 4) != 0) {
            f17 = 0.5f;
        }
        if ((i17 & 8) != 0) {
    ...
    public final android.graphics.drawable.Drawable b(android.content.Context context, android.content.pm.ResolveInfo ri6) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(ri6, "ri");
        try {
            ...
            if (iconResource != 0) {
                ...
                if (drawable2 != null) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SimpleAppInfoItemConvert", "loadIconForResolveInfo iconRes %d done", java.lang.Integer.valueOf(iconResource));
                    return drawable2;
                }
            }
        } catch (android.content.pm.PackageManager.NameNotFoundException e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SimpleAppInfoItemConvert", "Couldn't find resources for package", e17);
        }
