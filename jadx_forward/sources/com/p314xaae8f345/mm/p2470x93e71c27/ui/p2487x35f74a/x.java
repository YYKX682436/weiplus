...
public final class x implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ android.text.Spannable f272829d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.widget.TextView f272830e;

    public x(android.text.Spannable spannable, android.widget.TextView textView) {
        this.f272829d = spannable;
        this.f272830e = textView;
    }
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        android.widget.TextView textView2 = this.f272830e;
        boolean z17 = false;
        android.text.Spannable spannable = this.f272829d;
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMSg.MMLinkSpanTextView", "touch " + motionEvent.getX() + ", " + motionEvent.getY() + ", ret:" + z17);
