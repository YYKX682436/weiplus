...
public abstract class f {
    ...
    public static android.content.Intent f273146b;

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.ref.WeakReference f273147c;

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.HashMap f273149e;

    /* renamed from: a, reason: collision with root package name */
    public static final java.util.List f273145a = new java.util.ArrayList();

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.HashMap f273148d = new java.util.HashMap();

    static {
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        try {
            java.lang.String[] split = com.p314xaae8f345.mm.vfs.w6.M("assets:///mimetype.txt").split("\n");
            for (java.lang.String str : split) {
                java.lang.String[] split2 = str.split(",");
                if (split2 == null || split2.length <= 1 || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(split2[0]) || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(split2[1])) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "mimeType %s", str);
                } else {
                    f273148d.put(split2[0].trim(), split2[1].trim());
                }
            }
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "read from mimetype text %d %d %d", java.lang.Integer.valueOf(split.length), java.lang.Integer.valueOf(f273148d.size()), java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis));
        } catch (java.io.IOException e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.AppChooserIntentUtil", e17, "read mimeType from asset", new java.lang.Object[0]);
        }
    ...
    public static android.content.Intent b(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3) {
        ...
        com.p314xaae8f345.mm.sdk.p2603x2137b148.i1.e(context, intent, new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.vfs.z7.a(str2 == null ? "" : str2)), str3, str, false);
        try {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "createNormalIntent %s %s %s", str, str2, intent.toString());
    ...
    public static android.content.Intent c(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3, int i17) {
        ...
        if (str3 != null) {
            ...
            intent.putExtra("key_reader_sdk_format", com.p314xaae8f345.mm.vfs.w6.n(str3));
        }
        com.p314xaae8f345.mm.sdk.p2603x2137b148.i1.f(context, intent, new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.vfs.z7.a(str2 == null ? "" : str2)), str, false);
        try {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "createQQBrowserIntent %s %s %s", str, str2, intent.toString());
        } catch (java.lang.Exception unused) {
        }
        return intent;
    }
    ...
    public static java.lang.String e(java.lang.String str) {
        ...
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            ...
            if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(mimeTypeFromExtension)) {
                mimeTypeFromExtension = (java.lang.String) f273148d.get(str);
            }
            if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(mimeTypeFromExtension)) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "getMimeTypeByExt fileExt: %s mimeType: %s", str, str2);
        return str2;
    }
    ...
    public static void f(android.app.Activity activity, int i17, int i18, android.content.Intent intent, boolean z17, int i19, int i27, int i28) {
        if (i17 == 2) {
            if (-1 != i18 || intent == null) {
                if (4098 == i18) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppChooserIntentUtil", "Not Found App Support media type");
                    if (z17) {
                ...
                if (4097 != i18) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "AppChooserUI result code is not ok or data is null");
                    return;
                }
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "AppChooserUI result code is no choice");
                if (z17) {
                    db5.e1.i(activity, i19, i27);
                    return;
                }
            ...
            if (intent2 == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppChooserIntentUtil", "AppChooserUI target intent is null in handlerResultOfAppChooserUI");
                if (z17) {
                    db5.e1.i(activity, i19, i27);
                    return;
                }
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "AppChooserUI select package name %s and target intent is not null", stringExtra);
            android.content.Intent intent3 = new android.content.Intent(intent2);
            intent3.setPackage(stringExtra);
            com.p314xaae8f345.mm.p2470x93e71c27.ui.p2483xba3231df.i0.f272496a.a(stringExtra, intent2.getType());
            if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.I0(activity, intent3, true, false)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppChooserIntentUtil", "Always Intent is not support mimetype");
                if (z17) {
                    db5.e1.i(activity, i19, i27);
                    return;
                }
            ...
            try {
                if ("com.tencent.mtt".equals(stringExtra)) {
                    com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.g0.INSTANCE.d(11168, 5, java.lang.Integer.valueOf(i28));
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppChooserIntentUtil", "ActivityNotFoundException:" + e17);
                if (z17) {
                    db5.e1.i(activity, i19, i27);
                }
            }
    ...
    public static void g(android.content.Context context, long j17, java.lang.String str, boolean z17, java.lang.String str2, java.lang.String str3, java.lang.String str4, java.lang.String str5, int i17, java.lang.String str6, r45.w60 w60Var) {
        if (!com.p314xaae8f345.mm.p2470x93e71c27.p2474x633fb29.t3.k(str3, str6)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "openByMiniQB: file Can't OpenByMiniQB ");
            return;
        }
        ...
        boolean z18 = c6Var.f87869a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppChooserIntentUtil", "openByMiniQB msgId: " + j17 + ", filePath:" + str2 + ", fileExt:" + str3 + ", sence:" + i17);
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("msg_id", j17);
        intent.putExtra("msg_talker", str);
        intent.putExtra("msg_share_forbidden", z17);
        intent.putExtra("open_in_device", c6Var.f87869a);
        ...
        if (w60Var != null) {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppChooserIntentUtil", "invoke openByMiniQB Exception! Error:%s", e17.getMessage());
            }
        }
        intent.addFlags(268435456);
        ...
        android.net.Uri b17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.i1.b(context, new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.vfs.z7.a(str2)));
        if (b17 != null) {
            ((java.util.HashSet) com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.f274527f).add(b17.toString());
        }
    }
    ...
    */
    public static void i(android.app.Activity r33, long r34, java.lang.String r36, java.lang.String r37, java.lang.String r38, java.lang.String r39, int r40) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p2470x93e71c27.ui.p2488x696c9db.f.i(android.app.Activity, long, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int):void");
    }
    ...
    */
    public static boolean j(long r34, java.lang.String r36, java.lang.String r37, java.lang.String r38, java.lang.String r39, int r40, r45.w60 r41) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p2470x93e71c27.ui.p2488x696c9db.f.j(long, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, r45.w60):boolean");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:152:0x03f1, code lost:
        ...
        if (r58.m75933x41a8a7f2(2) == false) goto L123;
     */
    ...
    */
    public static boolean k(java.lang.String r52, java.lang.String r53, java.lang.String r54, java.lang.String r55, int r56, boolean r57, r45.w60 r58) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p2470x93e71c27.ui.p2488x696c9db.f.k(java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, boolean, r45.w60):boolean");
    }
    ...
    public static boolean l(android.app.Activity activity, java.lang.String str, java.lang.String str2, java.lang.String str3, int i17, int i18) {
        ...
        android.net.Uri b17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.i1.b(activity, new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.vfs.z7.a(str == null ? "" : str)));
        ...
        android.content.Intent intent = new android.content.Intent(activity, (java.lang.Class<?>) com.p314xaae8f345.mm.p2470x93e71c27.ui.p2488x696c9db.ActivityC19725xad6fc40e.class);
        intent.putExtra("type", 0);
        intent.putExtra(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37660xb6ae3b28, activity.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.f572432b74));
    ...
    public static void m(com.p314xaae8f345.mm.ui.AbstractActivityC21394xb3d2c0cf abstractActivityC21394xb3d2c0cf, java.lang.String str, java.lang.String str2, java.lang.String str3, int i17) {
        java.lang.String e17 = e(str3);
        a(e17, 0);
        android.net.Uri b17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.i1.b(abstractActivityC21394xb3d2c0cf, new com.p314xaae8f345.mm.vfs.r6(com.p314xaae8f345.mm.vfs.z7.a(str == null ? "" : str)));
        android.os.Bundle bundle = new android.os.Bundle();
        android.content.Intent b18 = b(abstractActivityC21394xb3d2c0cf, e17, str, str2);
        ...
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("type", 0);
        intent.putExtra(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37660xb6ae3b28, abstractActivityC21394xb3d2c0cf.getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.f572432b74));
        intent.putExtra("mimetype", e17);
        intent.putExtra("targetintent", b18);
        intent.putExtra("transferback", bundle);
        intent.putExtra(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54548xbbf10811, i17);
        intent.putExtra("openWay", true);
        j45.l.w(abstractActivityC21394xb3d2c0cf, ".pluginsdk.ui.tools.AppChooserUI", intent, 2, new com.p314xaae8f345.mm.p2470x93e71c27.ui.p2488x696c9db.e(abstractActivityC21394xb3d2c0cf, i17));
    }
}
