...
public abstract class j0 {
    public static boolean a(int i17, int i18) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.C2CTransferConfig", "transferType:%s model:%s select %s mode", objArr);
        if (Ni == 1) {
            return true;
        }
        int Ni2 = ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_mediacodec_side_limit, 3000);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.C2CTransferConfig", "rawWidth %d rawHeight:%d limit:%d", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(Ni2));
