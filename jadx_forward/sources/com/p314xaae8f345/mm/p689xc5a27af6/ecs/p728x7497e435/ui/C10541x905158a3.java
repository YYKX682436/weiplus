...
/* renamed from: com.tencent.mm.feature.ecs.nirvana.ui.MagicDebugPanelView */
/* loaded from: classes8.dex */
public final class C10541x905158a3 extends android.widget.FrameLayout {
    ...
    public final android.os.Handler f147347d;

    /* renamed from: e, reason: collision with root package name */
    public boolean f147348e;

    /* renamed from: f, reason: collision with root package name */
    public java.lang.String f147349f;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.Runnable f147350g;

    /* renamed from: h, reason: collision with root package name */
    public iq0.c f147351h;

    /* renamed from: i, reason: collision with root package name */
    public java.lang.String f147352i;

    /* renamed from: m, reason: collision with root package name */
    public android.widget.TextView f147353m;

    /* renamed from: n, reason: collision with root package name */
    public android.widget.TextView f147354n;

    /* renamed from: o, reason: collision with root package name */
    public android.widget.TextView f147355o;

    /* renamed from: p, reason: collision with root package name */
    public android.widget.TextView f147356p;

    /* renamed from: q, reason: collision with root package name */
    public android.widget.SeekBar f147357q;

    /* renamed from: r, reason: collision with root package name */
    public android.widget.Switch f147358r;

    /* renamed from: s, reason: collision with root package name */
    public f00.d f147359s;

    /* renamed from: t, reason: collision with root package name */
    public android.view.View f147360t;

    /* renamed from: u, reason: collision with root package name */
    public int f147361u;

    /* renamed from: v, reason: collision with root package name */
    public boolean f147362v;

    /* renamed from: w, reason: collision with root package name */
    public boolean f147363w;

    /* renamed from: x, reason: collision with root package name */
    public android.widget.TextView f147364x;

    /* renamed from: y, reason: collision with root package name */
    public android.widget.LinearLayout f147365y;

    /* renamed from: z, reason: collision with root package name */
    public android.widget.LinearLayout f147366z;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public C10541x905158a3(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
    }

    /* renamed from: getTouchSlop */
    private final int m44288x151bf723() {
        return ((java.lang.Number) ((jz5.n) this.touchSlop).mo141623x754a37bb()).intValue();
    }
    ...
    public final void c(int i17, float f17, float f18) {
        int i18;
        try {
            android.view.View view = this.f147360t;
            if (view == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicDebugPanelView", "postCanvasTouchEvent failed: parentView is null");
                return;
            }
            if (i17 != 0) {
                i18 = 1;
                if (i17 != 1) {
                    i18 = 2;
                    if (i17 != 2) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicDebugPanelView", "postCanvasTouchEvent failed: unknown action " + i17);
                        return;
                    }
                }
            } else {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicDebugPanelView", "postCanvasTouchEvent failed: " + e17.getMessage(), e17);
        }
    }

    public final void d() {
        this.f147348e = !this.f147348e;
        e();
        if (this.f147348e) {
            iq0.c cVar = this.f147351h;
            if (cVar == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicDebugPanelView", "startProfile failed: bizHandle is null");
                b();
                return;
            }
            q10.k kVar = q10.k.f441053a;
            p10.t tVar = new p10.t(this);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MBProfileUtil", "startProfile: bizName=" + cVar.f375177a + ", instanceKey=" + cVar.f375178b);
        ...
        iq0.c cVar2 = this.f147351h;
        if (cVar2 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicDebugPanelView", "finishProfile failed: bizHandle is null");
            b();
            return;
        }
        if (this.f147359s == null) {
            f00.a aVar = f00.d.f339825d;
            android.content.Context context = getContext();
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(context, "getContext(...)");
            this.f147359s = f00.a.a(aVar, context, getContext().getString(com.p314xaae8f345.mm.R.C30867xcad56011.f572137zq), 500L, null, 8, null);
        }
        f00.d dVar = this.f147359s;
        if (dVar != null) {
            dVar.a();
        }
        java.lang.String token = this.f147349f;
        ...
        q10.k kVar2 = q10.k.f441053a;
        java.lang.String bizName = this.f147352i;
        java.lang.String profileToken = this.f147349f;
        boolean z17 = this.f147362v;
        p10.p pVar = new p10.p(this);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(bizName, "bizName");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(profileToken, "profileToken");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MBProfileUtil", "finishProfile: bizName=" + bizName + ", token=" + profileToken + ", shouldUpload=" + z17);
        ((nq0.p) ((gq0.t) i95.n0.c(gq0.t.class))).bj(cVar2, format, new q10.d(z17, pVar));
    }

    public final void e() {
        android.widget.TextView textView = this.f147353m;
        if (textView != null) {
            textView.setText(this.f147348e ? "Stop Profile" : "Start Profile");
        } else {
            p3321xbce91901.jvm.p3324x21ffc6bd.o.o("profileButton");
            throw null;
        }
    }
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent ev6) {
        ...
        if (action == 0) {
            ...
            if (abs > m44288x151bf723() || abs2 > m44288x151bf723()) {
                this.E = true;
                return true;
            }
        }
    ...
    /* renamed from: setParentView */
    public final void m44289xdd05871(android.view.View view) {
        this.f147360t = view;
    }

    public /* synthetic */ C10541x905158a3(android.content.Context context, android.util.AttributeSet attributeSet, int i17, int i18, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
        this(context, (i18 & 2) != 0 ? null : attributeSet, (i18 & 4) != 0 ? 0 : i17);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C10541x905158a3(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        this.f147347d = new android.os.Handler(android.os.Looper.getMainLooper());
        this.f147349f = "";
        this.f147352i = "";
        this.f147361u = 1000;
        this.f147362v = true;
        ...
        this.f147364x = textView;
        android.widget.LinearLayout linearLayout2 = this.f147365y;
        if (linearLayout2 != null) {
            ...
            android.widget.Switch r142 = this.f147358r;
            if (r142 != null) {
                r142.setLayoutParams(layoutParams3);
                android.widget.Switch r97 = this.f147358r;
                if (r97 != null) {
                    linearLayout4.addView(r97);
                    android.widget.LinearLayout linearLayout5 = this.f147366z;
                    if (linearLayout5 != null) {
                        ...
                        android.widget.TextView textView4 = this.f147353m;
                        if (textView4 != null) {
                            textView4.setLayoutParams(layoutParams4);
                            android.widget.LinearLayout linearLayout6 = this.f147366z;
                            if (linearLayout6 == null) {
                                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("expandedContentLayout");
                                throw null;
                            }
                            android.widget.TextView textView5 = this.f147353m;
                            if (textView5 != null) {
                                ...
                                android.widget.TextView textView7 = this.f147354n;
                                if (textView7 != null) {
                                    textView7.setLayoutParams(layoutParams5);
                                    android.widget.LinearLayout linearLayout7 = this.f147366z;
                                    if (linearLayout7 == null) {
                                        p3321xbce91901.jvm.p3324x21ffc6bd.o.o("expandedContentLayout");
                                        throw null;
                                    }
                                    android.widget.TextView textView8 = this.f147354n;
                                    if (textView8 != null) {
                                        ...
                                        android.widget.TextView textView10 = this.f147356p;
                                        if (textView10 != null) {
                                            textView10.setLayoutParams(layoutParams6);
                                            android.widget.LinearLayout linearLayout8 = this.f147366z;
                                            if (linearLayout8 == null) {
                                                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("expandedContentLayout");
                                                throw null;
                                            }
                                            android.widget.TextView textView11 = this.f147356p;
                                            if (textView11 != null) {
                                                ...
                                                android.widget.SeekBar seekBar2 = this.f147357q;
                                                if (seekBar2 != null) {
                                                    seekBar2.setLayoutParams(layoutParams7);
                                                    android.widget.LinearLayout linearLayout9 = this.f147366z;
                                                    if (linearLayout9 == null) {
                                                        p3321xbce91901.jvm.p3324x21ffc6bd.o.o("expandedContentLayout");
                                                        throw null;
                                                    }
                                                    android.widget.SeekBar seekBar3 = this.f147357q;
                                                    if (seekBar3 != null) {
                                                        ...
                                                        this.f147355o = textView12;
                                                        android.widget.LinearLayout.LayoutParams layoutParams8 = new android.widget.LinearLayout.LayoutParams(a(120.0f), a(36.0f));
                                                        android.widget.TextView textView13 = this.f147355o;
                                                        if (textView13 != null) {
                                                            textView13.setLayoutParams(layoutParams8);
                                                            android.widget.LinearLayout linearLayout10 = this.f147366z;
                                                            if (linearLayout10 == null) {
                                                                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("expandedContentLayout");
                                                                throw null;
                                                            }
                                                            android.widget.TextView textView14 = this.f147355o;
                                                            if (textView14 != null) {
                                                                linearLayout10.addView(textView14);
                                                                android.widget.LinearLayout linearLayout11 = this.f147365y;
                                                                if (linearLayout11 == null) {
                                                                    p3321xbce91901.jvm.p3324x21ffc6bd.o.o("rootLayout");
                                                                    throw null;
                                                                }
                                                                android.widget.LinearLayout linearLayout12 = this.f147366z;
                                                                if (linearLayout12 != null) {
                                                                    linearLayout11.addView(linearLayout12);
                                                                    android.view.View view = this.f147365y;
                                                                    if (view != null) {
                                                                        addView(view);
                                                                        setClickable(true);
                                                                        return;
                                                            ...
                                                            p3321xbce91901.jvm.p3324x21ffc6bd.o.o("swipeButton");
                                                            throw null;
                                                        }
                                                        p3321xbce91901.jvm.p3324x21ffc6bd.o.o("swipeButton");
                                                        throw null;
                                                    }
                                                    p3321xbce91901.jvm.p3324x21ffc6bd.o.o("swipeSpeedSeekBar");
                                                    throw null;
                                                }
                                                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("swipeSpeedSeekBar");
                                                throw null;
                                    ...
                                    p3321xbce91901.jvm.p3324x21ffc6bd.o.o("heapSnapshotButton");
                                    throw null;
                                }
                                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("heapSnapshotButton");
                                throw null;
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("uploadSwitch");
                throw null;
            }
            p3321xbce91901.jvm.p3324x21ffc6bd.o.o("uploadSwitch");
            throw null;
