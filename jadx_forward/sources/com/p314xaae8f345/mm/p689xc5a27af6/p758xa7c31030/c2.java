...
@j95.b(m140513x1e06fd29 = {lh.k.class, ob0.o2.class, com.p314xaae8f345.mm.p689xc5a27af6.p758xa7c31030.api.a.class, ob0.f.class})
/* loaded from: classes12.dex */
public class c2 extends i95.w implements ob0.h3 {

    /* renamed from: g, reason: collision with root package name */
    public static volatile sp3.b f149067g;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.Runnable f149068d = new com.p314xaae8f345.mm.p689xc5a27af6.p758xa7c31030.j2(this);

    /* renamed from: e, reason: collision with root package name */
    public volatile boolean f149069e;

    /* renamed from: f, reason: collision with root package name */
    public volatile long f149070f;

    public c2() {
        this.f149069e = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.n() || com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.j() || com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.s();
        this.f149070f = 0L;
    }

    public ob0.s2 Ai(java.lang.String str, long j17) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PluginPerformance", "getBizMemoryStat %s", str);
        return new com.p314xaae8f345.mm.p1006xc5476f33.p1944xa7c31030.p1947xef4ce806.i(str, j17);
    }

    public final void Bi() {
        ((ku5.t0) ku5.t0.f394148d).k(this.f149068d, 300000L);
    }
    ...
    public final void Di() {
        ...
        if (!f17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PluginPerformance", "setupMallOpt: disabled");
            return;
        }
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.z.f274648k && !f18) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PluginPerformance", "setupMallOpt: disabled for 32bit");
            return;
        }
        com.p314xaae8f345.mm.p689xc5a27af6.p758xa7c31030.f2 f2Var = new com.p314xaae8f345.mm.p689xc5a27af6.p758xa7c31030.f2(this);
        ki.i iVar = ki.i.f389634c;
        iVar.c(f2Var);
        e42.d0 d0Var = e42.d0.clicfg_matrix_memory_mallopt_purge_app_bg;
        if (!z65.c.a() && !o45.wf.f424566k) {
            z17 = false;
        }
        if (ih.a.f(d0Var, z17)) {
            iVar.b(f2Var);
    ...
    public void mo204xfac946a6(android.content.Context context) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.n()) {
            java.util.List<android.hardware.Sensor> sensorList = ((android.hardware.SensorManager) com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSystemService("sensor")).getSensorList(-1);
            if (mm.l.c() || mm.l.b()) {
                ...
                for (android.hardware.Sensor sensor : sensorList) {
                    ...
                    try {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("HealthStatsHelper", "getSensorHandle err: " + th6.getMessage());
                        i17 = 0;
                    }
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("HealthStatsHelper", "Sensors = " + ((java.lang.Object) sb6));
            }
            ...
            if (mm.o.b() || mm.o.c()) {
                ...
                try {
                    ...
                    for (java.util.Map.Entry entry : wh.n1.f527371c.entrySet()) {
                        linkedHashMap.put("powerItem-" + ((java.lang.String) entry.getKey()), entry.getValue());
                    }
                    for (java.util.Map.Entry entry2 : wh.n1.f527372d.entrySet()) {
                    ...
                    int o17 = wh.m.o();
                    int g17 = j17.g();
                    int length = j17.f527375a.length;
                    java.lang.StringBuilder sb8 = new java.lang.StringBuilder();
                    for (int i19 = 0; i19 < j17.f527375a.length; i19++) {
                        int i27 = j17.i(i19);
                ...
                ((ku5.t0) ku5.t0.f394148d).k(new java.lang.Runnable() { // from class: gi.u0$$a
                    ...
                    public final void run() {
                        ...
                        for (java.lang.String str : android.system.Os.getenv("CUST_POLICY_DIRS").split(":")) {
                            ...
                            if (file.exists() && file.canRead()) {
                                ...
                                try {
                                    gi.p1.f353615b.clear();
                                    gi.p1.f353616c.clear();
                                    p1Var.f(context3, "power_profile");
                                    p1Var.d();
                                    linkedHashMap2.put(com.p314xaae8f345.p2929xca247920.p2930x2eaf9f.p2931xaf3f29eb.C25497x5d2ac867.f46634x1dde913b, gi.u0.a(com.p314xaae8f345.p2929xca247920.p2930x2eaf9f.p2931xaf3f29eb.C25497x5d2ac867.f46634x1dde913b, p1Var));
            ...
            gm0.j1.e().k(new com.p314xaae8f345.mm.p689xc5a27af6.p758xa7c31030.k2(this), 2000L);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:343:0x05ea, code lost:
        ...
        r12 = 0;
        com.p314xaae8f345.mm.app.p5.d("MicroMsg.GCSemiSpaceTrimWrapper", r0, "[-] Fail to mark enabled.", new java.lang.Object[0]);
     */
    ...
    */
    public void mo8845x3e5a77bb(final android.content.Context r27) {
        /*
            Method dump skipped, instructions count: 2738
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p689xc5a27af6.p758xa7c31030.c2.mo8845x3e5a77bb(android.content.Context):void");
    }

    public ob0.b3 wi() {
        return com.p314xaae8f345.mm.p1006xc5476f33.p1944xa7c31030.p1947xef4ce806.b0.B;
    }
}
