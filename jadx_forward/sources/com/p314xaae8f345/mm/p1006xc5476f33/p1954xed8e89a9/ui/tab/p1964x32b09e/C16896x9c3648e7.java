...
/* renamed from: com.tencent.mm.plugin.profile.ui.tab.list.BizProfileTabArticleFragment */
/* loaded from: classes11.dex */
public final class C16896x9c3648e7 extends com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1964x32b09e.AbstractC16899xcafbd5ba<wr3.m> {

    /* renamed from: w, reason: collision with root package name */
    public final java.lang.String f235954w;

    /* renamed from: x, reason: collision with root package name */
    public com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1967x373aa5.C16920x131f5742 f235955x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C16896x9c3648e7(boolean z17, int i17, sr3.g config) {
        super(z17, i17, config);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(config, "config");
        this.f235954w = "BizProfileTabArticleFragment";
    }
    ...
    public boolean G0(vr3.h outBoxData) {
        ...
        return (s5Var != null && (p5Var = s5Var.f467047i) != null && (linkedList = p5Var.f464287e) != null && (linkedList.isEmpty() ^ true)) && ((r45.o5) s5Var.f467047i.f464287e.get(0)).f463456p == 0;
    }

    public com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1967x373aa5.C16920x131f5742 J0() {
        com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1967x373aa5.C16920x131f5742 c16920x131f5742 = this.f235955x;
    ...
    public void P() {
        try {
            if (this.f235955x != null) {
                com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1967x373aa5.C16920x131f5742 J0 = J0();
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(this.f235954w, "onAppBarLayoutExpand: recyclerView error: " + e17);
        }
    }
    ...
    public android.view.View mo7503x18bad100(android.view.LayoutInflater inflater, android.view.ViewGroup viewGroup, android.os.Bundle bundle) {
        ...
        this.f235955x = (com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1967x373aa5.C16920x131f5742) findViewById;
        com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1967x373aa5.C16920x131f5742 J0 = J0();
        android.content.Context mo7438x76847179 = mo7438x76847179();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(mo7438x76847179);
        J0.N(new wr3.u0(mo7438x76847179));
        ...
        this.f235965v = new wr3.m(context, j0(), this.f235959p, this.f235960q, this.f235963t, this.f235964u, this.f235961r, n17);
        J0().mo7960x6cab2c8d(r0());
        J0().m67699xa386e40(new wr3.n(this));
        return inflate;
    }
    ...
    public void mo7518x594b1124(android.view.View view, android.os.Bundle bundle) {
        ...
        p0(this.f235954w, new wr3.o(this), new wr3.p(this), new wr3.q(this), new wr3.r(this));
    }
        ...
        synchronized (this) {
            ...
            if (wlVar != null) {
                ...
                if ((tj6Var != null ? tj6Var.f468043f : null) != null && !tj6Var.f468043f.f469886e.isEmpty()) {
                    J0().m67723x7e5a7937(true);
                    return new java.util.ArrayList(wlVar.C.f468043f.f469886e);
                }
            }
            return arrayList;
        }
    ...
    public java.lang.String getF235954w() {
        return this.f235954w;
    }
    ...
    public void x0(com.p314xaae8f345.mm.p2495xc50a8b8b.g gVar) {
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1963x2eefaa.C16893x570516c7.g(n07, n07.A, new vr3.l(n07), 4, gVar, n07.f235818p, null, 32, null);
    }
    ...
    public void y0(com.p314xaae8f345.mm.p1006xc5476f33.p1954xed8e89a9.ui.tab.p1963x2eefaa.C16893x570516c7 dataFetcher, p012xc85e97e9.p093xedfae76a.k0 observer) {
        ...
        dataFetcher.f235818p.mo7806x9d92d11c(this, observer);
    }
}
