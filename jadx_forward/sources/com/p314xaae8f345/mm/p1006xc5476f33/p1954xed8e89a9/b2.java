...
public final class b2 implements i21.g {
    ...
    public final /* synthetic */ java.lang.String f234926a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ java.util.concurrent.atomic.AtomicInteger f234927b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f234928c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ r45.c5 f234929d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.util.concurrent.CopyOnWriteArrayList f234930e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ yz5.l f234931f;
    ...
    public b2(java.lang.String str, java.util.concurrent.atomic.AtomicInteger atomicInteger, java.lang.String str2, r45.c5 c5Var, java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList, yz5.l lVar) {
        this.f234926a = str;
        this.f234927b = atomicInteger;
        this.f234928c = str2;
        this.f234929d = c5Var;
        this.f234930e = copyOnWriteArrayList;
        this.f234931f = lVar;
    }
    ...
    public void a(boolean z17, int i17) {
        ...
        sb6.append(i17);
        sb6.append(" at ");
        sb6.append(this.f234926a);
        sb6.append(", succeed: ");
        sb6.append(z17);
        sb6.append(", downloading: ");
        java.util.concurrent.atomic.AtomicInteger atomicInteger = this.f234927b;
        sb6.append(atomicInteger.get());
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ProfileUtilsKt", sb6.toString());
        java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList = this.f234930e;
        if (z17) {
            java.lang.String str = this.f234928c;
            mr3.l lVar = null;
            if (str != null && (c5Var = this.f234929d) != null) {
                i21.q h17 = i21.q.h();
        ...
        if (atomicInteger.decrementAndGet() <= 0) {
            ...
            this.f234931f.mo146xb9724478(copyOnWriteArrayList);
        }
    }
}
