...
/* renamed from: com.tencent.mm.plugin.media.view.gesture.PreviewGestureContainer */
/* loaded from: classes10.dex */
public final class C16501x5a606100 extends com.p314xaae8f345.mm.ui.p2747xd1075a44.p2756x7e662d35.C22678xac4e51fa implements mg3.b {
    ...
    public C16501x5a606100(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void L(float f17, float f18, float f19) {
        mg3.f fVar;
        sy3.b bVar;
        float mo66618xfd74f284 = mo66618xfd74f284();
        super.L(f17, f18, f19);
        float mo66618xfd74f2842 = mo66618xfd74f284();
        if ((mo66618xfd74f2842 == mo66618xfd74f284) || (fVar = this.onScaleChangedListener) == null || (bVar = ((vh5.h) fVar).f518750a) == null) {
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ImageOCRZoomHelper", "alvinluo gesture ScaleChanged, oldScale " + mo66618xfd74f284 + ", newScale: " + mo66618xfd74f2842);
        double d17 = (double) mo66618xfd74f2842;
        kz3.w wVar = ((kz3.t) bVar).f395461a;
        if (d17 >= 1.1d) {
            wVar.b(2);
        } else {
            wVar.b(1);
    ...
    public final void O(android.view.View container, float f17, float f18, boolean z17) {
        ...
        if (!z17 && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(container, getContentView())) {
        ...
        m81927xfd4def63(f18);
        F();
        m81921x1f57be89(1.0f);
        mg3.l lVar = this.scaleConfig;
        if (lVar != null) {
            m81922xe91e3cf7(lVar.f407777b);
            m81920x7c800d89(lVar.f407778c);
        }
        this.B1 = 0.0f;
    ...
    public final boolean Q(android.view.MotionEvent motionEvent, android.view.MotionEvent motionEvent2, float f17, float f18) {
        ...
        float f19 = m81888xc7b108a2()[0] / 1;
        android.graphics.Matrix matrix = new android.graphics.Matrix(getMainMatrix());
        android.graphics.Matrix matrix2 = new android.graphics.Matrix(getMainMatrix());
        float f27 = mo66594x1a3a7a7d.x * f19;
        float f28 = mo66594x1a3a7a7d.y * f19;
    ...
    @Override // mg3.b
    /* renamed from: getCurrentScaleRatio */
    public float mo66618xfd74f284() {
        return m81888xc7b108a2()[0];
    }
    ...
    /* renamed from: getMaxScaleRatio */
    public float m66620xe97165af() {
        return getMaxScaleValue();
    }

    @Override // mg3.b
    /* renamed from: getMinScaleRatio */
    public float mo66621x560f951d() {
    ...
    public boolean onDoubleTap(android.view.MotionEvent e17) {
        ...
        mg3.l lVar = this.scaleConfig;
        m81920x7c800d89(lVar != null ? lVar.f407778c : 5.0f);
        float f17 = m81888xc7b108a2()[0];
        mg3.l lVar2 = this.scaleConfig;
        float f18 = lVar2 != null ? lVar2.f407779d : 2.0f;
        if (f17 > 1.0f) {
            com.p314xaae8f345.mm.ui.p2747xd1075a44.p2756x7e662d35.C22678xac4e51fa.K(this, null, null, 3, null);
            android.view.KeyEvent.Callback contentView = getContentView();
            rf3.g gVar = contentView instanceof rf3.g ? (rf3.g) contentView : null;
            if (gVar == null) {
                return true;
            }
            gVar.c(mo66618xfd74f284());
            return true;
        }
        ...
        if (getViewScale() >= 1.0d) {
            ...
            if (!rectF.isEmpty() && !rectF.contains(b17, c17)) {
                ...
                if (c17 < f19 || c17 > rectF.bottom) {
                    e0Var2.f391648d = (f19 + rectF.bottom) / 2;
                } else {
                    float f27 = rectF.left;
                    if (b17 < f27 || b17 > rectF.right) {
                        e0Var.f391648d = (f27 + rectF.right) / 2;
                    }
                }
            }
        }
        ...
        if (!getContentRectF().isEmpty()) {
            D(f18, m81888xc7b108a2()[0], e0Var.f391648d, e0Var2.f391648d, null);
            return true;
        }
        requestLayout();
            ...
            if (!getHasMorePoint() && (java.lang.Math.abs(f19) >= 1000.0f || java.lang.Math.abs(f27) >= 1000.0f)) {
                ...
                if ((!t17 || !u17) && (P = P()) != null) {
                    if ((P.left >= getVisibilityRect().left && f19 > 0.0f) || (P.right <= getVisibilityRect().right && f19 < 0.0f)) {
                        if (getScaleType() != ml5.k.f409963d && getScaleType() != ml5.k.f409965f) {
                            f19 = 0.0f;
                        }
                    }
                    ...
                    m81915x1cb5a321(ofPropertyValuesHolder);
                    return true;
                }
            }
        }
    ...
    */
    public boolean onScroll(android.view.MotionEvent r17, android.view.MotionEvent r18, float r19, float r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1855x62f6fe4.p1858x373aa5.p1860xfb865d49.C16501x5a606100.onScroll(android.view.MotionEvent, android.view.MotionEvent, float, float):boolean");
    }

    /* renamed from: setGestureListener */
    public void m66625xa8ac985b(mg3.d dVar) {
        this.gestureListener = dVar;
    }

    /* renamed from: setLongVertical */
    public final void m66626x9204e394(boolean z17) {
        this.C1 = z17;
    }

    /* renamed from: setOnScaleChangedListener */
    public final void m66627xf9f1f85f(mg3.f fVar) {
        this.onScaleChangedListener = fVar;
    }

    /* renamed from: setScaleConfig */
    public final void m66628x23c5936a(mg3.l lVar) {
        this.scaleConfig = lVar;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C16501x5a606100(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
