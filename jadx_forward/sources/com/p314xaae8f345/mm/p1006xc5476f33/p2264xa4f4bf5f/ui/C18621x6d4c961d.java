...
/* renamed from: com.tencent.mm.plugin.textstatus.ui.StatusIndicator */
/* loaded from: classes11.dex */
public final class C18621x6d4c961d extends android.widget.LinearLayout {

    /* renamed from: i, reason: collision with root package name */
    public static final /* synthetic */ int f255004i = 0;

    /* renamed from: d, reason: collision with root package name */
    public final int f255005d;

    /* renamed from: e, reason: collision with root package name */
    public final int f255006e;

    /* renamed from: f, reason: collision with root package name */
    public android.view.View f255007f;

    /* renamed from: g, reason: collision with root package name */
    public int f255008g;

    /* renamed from: h, reason: collision with root package name */
    public float f255009h;

    public C18621x6d4c961d(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f255005d = i65.a.b(getContext(), 94);
        this.f255006e = com.p314xaae8f345.mm.R.C30864xbddafb2a.dx9;
        this.f255009h = -1.0f;
    }

    /* renamed from: getCacheView */
    private final android.view.View m71788xde6f3e91() {
        if (this.f255007f == null) {
            this.f255007f = android.view.View.inflate(getContext(), this.f255006e, null);
        }
        android.view.View view = this.f255007f;
        if (view != null) {
            view.clearAnimation();
            view.setScaleY(1.0f);
            view.setScaleX(1.0f);
        }
        android.view.View view2 = this.f255007f;
        if (view2 != null) {
        ...
        android.view.View view3 = this.f255007f;
    ...
    public final void a(boolean z17, int i17) {
        this.f255009h = 0.0f;
        android.view.View m71788xde6f3e91 = m71788xde6f3e91();
        if (m71788xde6f3e91.getParent() != null) {
            m71788xde6f3e91.clearAnimation();
            android.view.ViewParent parent = m71788xde6f3e91.getParent();
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(parent, "null cannot be cast to non-null type android.view.ViewGroup");
            ((android.view.ViewGroup) parent).removeView(m71788xde6f3e91);
        }
        if (z17) {
            ...
            m71788xde6f3e91.setTag(java.lang.Integer.valueOf(((java.lang.Integer) tag).intValue() + 1));
            addView(m71788xde6f3e91);
            this.f255007f = getChildAt(0);
            ...
            m71788xde6f3e91.setTag(java.lang.Integer.valueOf(((java.lang.Integer) tag2).intValue() - 1));
            addView(m71788xde6f3e91, 0);
            this.f255007f = getChildAt(getChildCount() - 1);
            android.view.View childAt2 = getChildAt(getChildCount() - 2);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(childAt2);
            b(childAt2, true);
        }
        java.lang.Object tag3 = m71788xde6f3e91.getTag();
        ...
        if ((intValue == this.f255008g - 1 || intValue == 0) ? false : true) {
            b(m71788xde6f3e91, false);
        }
        android.view.View view = this.f255007f;
        if (view != null) {
            sa5.d.b(view, new com.p314xaae8f345.mm.p1006xc5476f33.p2264xa4f4bf5f.ui.f4(new com.p314xaae8f345.mm.p1006xc5476f33.p2264xa4f4bf5f.ui.r3(this)), 300L, new com.p314xaae8f345.mm.p1006xc5476f33.p2264xa4f4bf5f.ui.s3(this));
        }
    }

    public final void b(android.view.View view, boolean z17) {
        if (view.getWidth() <= 0) {
            n3.m0.a(view, new com.p314xaae8f345.mm.p1006xc5476f33.p2264xa4f4bf5f.ui.t3(view, z17, this, view));
        } else if (z17) {
            d(view);
        } else {
            c(view);
    ...
    public final void d(android.view.View view) {
        ...
        scaleAnimation.setAnimationListener(new com.p314xaae8f345.mm.p1006xc5476f33.p2264xa4f4bf5f.ui.u3(view));
        view.startAnimation(scaleAnimation);
    }

    @Override // android.widget.LinearLayout, android.view.ViewGroup, android.view.View
    public void onLayout(boolean z17, int i17, int i18, int i19, int i27) {
        int indexOfChild = indexOfChild(this.f255007f);
        if (indexOfChild < 0 || this.f255009h < 0.0f) {
        ...
        if (indexOfChild == 0) {
            float measuredWidth2 = ((getMeasuredWidth() - (measuredWidth * 5)) / 2) - (measuredWidth * this.f255009h);
        ...
        float width = ((getWidth() - (measuredWidth * 5)) / 2) - (measuredWidth * (1 - this.f255009h));
    ...
    public void onMeasure(int i17, int i18) {
        super.onMeasure(android.view.View.MeasureSpec.makeMeasureSpec(this.f255005d, Integer.MIN_VALUE), i18);
    }

    /* renamed from: setSelect */
    public final void m71789x224b8bfe(int i17) {
        ...
        if (intValue <= i17 && i17 <= intValue2) {
            ...
            if (i17 == intValue2 && i17 != this.f255008g - 1) {
                a(true, i17);
                return;
            } else {
        ...
        if (i17 == 0) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(childAt3, "getChildAt(...)");
            b(childAt3, false);
            return;
        }
        if (i17 == this.f255008g - 1) {
            for (int childCount4 = getChildCount() - 1; -1 < childCount4; childCount4--) {
                android.view.View childAt4 = getChildAt(childCount4);
                p3321xbce91901.jvm.p3324x21ffc6bd.o.d(childAt4);
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(childAt5, "getChildAt(...)");
            b(childAt5, false);
        }
    }

    public C18621x6d4c961d(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
