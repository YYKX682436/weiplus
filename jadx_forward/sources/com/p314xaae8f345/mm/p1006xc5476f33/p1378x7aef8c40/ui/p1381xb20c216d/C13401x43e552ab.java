...
public final class C13401x43e552ab extends com.p314xaae8f345.mm.p679x5c28046.p684x373aa5.C10450x95592a7d implements r22.f {

    /* renamed from: r, reason: collision with root package name */
    public final r22.e f180273r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13401x43e552ab(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        this.f180273r = new w22.i(this);
    }

    @Override // b32.c0
    public void b(android.graphics.RectF bounds, float f17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(bounds, "bounds");
        w22.i iVar = (w22.i) this.f180273r;
        iVar.getClass();
        iVar.f524079c.set(bounds);
        iVar.f524080d.addRoundRect(new android.graphics.RectF(bounds.left, bounds.top, bounds.right, bounds.bottom), f17, f17, android.graphics.Path.Direction.CW);
        iVar.a();
    }
    ...
    public com.p314xaae8f345.mm.p1006xc5476f33.p1378x7aef8c40.ui.p1381xb20c216d.C13399xaee30621 mo54953x2e0f72f8() {
        if (!(getParent().getParent() instanceof com.p314xaae8f345.mm.p1006xc5476f33.p1378x7aef8c40.ui.p1381xb20c216d.C13399xaee30621)) {
            return null;
        }
        android.view.ViewParent parent = getParent().getParent();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.e(parent, "null cannot be cast to non-null type com.tencent.mm.plugin.emojicapture.ui.editor.EditorItemContainer");
        return (com.p314xaae8f345.mm.p1006xc5476f33.p1378x7aef8c40.ui.p1381xb20c216d.C13399xaee30621) parent;
    }

    /* renamed from: getTouchMatrix */
    public final android.graphics.Matrix m54954x3324feaa() {
        return ((w22.i) this.f180273r).f524078b.f106450g;
    }
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        ...
        canvas.save();
        r22.e eVar = this.f180273r;
        w22.i iVar = (w22.i) eVar;
        iVar.getClass();
        if (iVar.f524084h) {
            canvas.clipPath(iVar.f524080d);
        }
        canvas.setMatrix(iVar.f524078b.f106450g);
        if (iVar.f524083g) {
            float f17 = iVar.f524081e.left;
            float f18 = iVar.f524085i;
            float f19 = iVar.f524089m / f18;
            float f27 = f17 - f19;
            float f28 = r1.top - f19;
            float f29 = r1.right + f19;
            float f37 = r1.bottom + f19;
            float f38 = (iVar.f524090n / 2) / f18;
            android.graphics.Paint paint = iVar.f524082f;
            paint.setStrokeWidth(iVar.f524088l / f18);
            float f39 = f27 - f38;
            float f47 = f28 - f38;
            float f48 = f27 + f38;
            float f49 = f28 + f38;
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        /*
            ...
            r22.e r0 = r13.f180273r
            w22.i r0 = (w22.i) r0
            r0.getClass()
            r22.f r1 = r0.f524077a
            com.tencent.mm.plugin.emojicapture.ui.editor.EditorItemContainer r2 = r1.mo54953x2e0f72f8()
            bw3.e r3 = r0.f524078b
            boolean r4 = r3.a(r14)
            r5 = 0
            if (r4 == 0) goto Lc3
            if (r2 == 0) goto L20
        ...
        L39:
            ...
            bw3.b r14 = new bw3.b
            r14.<init>()
            float r8 = r0.f524087k
            r14.f106435c = r8
            float r8 = r0.f524086j
            r14.f106436d = r8
            float[] r8 = new float[r7]
            android.graphics.Rect r9 = r0.f524081e
            int r10 = r9.width()
            float r10 = (float) r10
            float r10 = r10 / r4
            r8[r5] = r10
            ...
            android.graphics.RectF r9 = r0.f524079c
            float r10 = r9.left
            float r11 = r9.top
            float r12 = r9.right
            float r9 = r9.bottom
            ...
            float r8 = r8 / r4
            r7[r6] = r8
            android.graphics.Matrix r4 = r3.f106450g
            r4.mapPoints(r7)
            android.graphics.RectF r4 = r14.f106433a
            r8 = r7[r5]
            r7 = r7[r6]
            ...
            r14.f106433a = r4
        L99:
            android.graphics.Matrix r2 = r3.f106450g
            w22.h r3 = new w22.h
            r3.<init>(r0)
            r14.a(r2, r3)
            goto Lbd
        La4:
            ...
            float r14 = r14 / r4
            r2[r6] = r14
            android.graphics.Matrix r14 = r3.f106450g
            r14.mapPoints(r2)
        Lbd:
        ...
        Lc3:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1378x7aef8c40.ui.p1381xb20c216d.C13401x43e552ab.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public av3.a p(android.graphics.Matrix matrix) {
        ...
        if (z17) {
            ...
            matrix2.set(((w22.i) eVar).f524078b.f106450g);
            if (matrix != null) {
        ...
        matrix3.postConcat(((w22.i) eVar).f524078b.f106450g);
        if (matrix != null) {
    ...
    public void mo9753x40b67ed6(boolean z17) {
        w22.i iVar = (w22.i) this.f180273r;
        iVar.f524083g = z17;
        java.lang.Object obj = iVar.f524077a;
    ...
    public void setImageDrawable(android.graphics.drawable.Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            w22.i iVar = (w22.i) eVar;
            bw3.e eVar2 = iVar.f524078b;
            eVar2.f106459p = intrinsicWidth;
            eVar2.f106458o = intrinsicHeight;
            android.graphics.Rect rect = iVar.f524081e;
    ...
    public C13401x43e552ab(android.content.Context context) {
        this(context, null);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public C13401x43e552ab(android.content.Context context, android.util.AttributeSet attributeSet) {
