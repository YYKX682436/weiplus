...
public final class r2 extends al5.w {

    /* renamed from: f, reason: collision with root package name */
    public java.lang.ref.WeakReference f185970f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r2(android.graphics.drawable.Drawable drawable) {
        super(drawable, 0);
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence text, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        java.lang.ref.WeakReference weakReference = this.f185970f;
        ...
        if (drawable == null) {
            ...
            this.f185970f = new java.lang.ref.WeakReference(drawable);
        }
        if (drawable != null) {
            canvas.save();
