package com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1434xadde6502;
...
public final class C13684x82c14eb0 extends android.view.TextureView implements bb2.a1 {
    ...
    public java.util.LinkedList f184346f;
    ...
    public C13684x82c14eb0(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void a(boolean z17) {
        if (getBulletManager().f100575g || this.feed == null) {
            return;
        }
        getBulletManager().h(m55608xfb7f4e14(), z17, this.f184346f);
    }
    ...
    public void d(so2.u1 feed, java.util.LinkedList linkedList) {
        ...
        m55610x764a1520(feed);
        this.f184346f = linkedList;
    }
    ...
    public final so2.u1 m55608xfb7f4e14() {
    ...
    public android.view.View mo10138xfb86a31b() {
        return this;
    }

    @Override // bb2.a1
    /* renamed from: onDetach */
    public void mo10139x3f5eee52() {
        getBulletManager().i();
    }
    ...
    public final void m55610x764a1520(so2.u1 u1Var) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(u1Var, "<set-?>");
        this.feed = u1Var;
    }

    @Override // bb2.a1
    /* renamed from: setOnAfterPlaySeekListener */
    public void mo10140xa87d033b(yz5.a aVar) {
        this.onAfterPlaySeekListener = aVar;
    }

    @Override // bb2.a1
    /* renamed from: setReuse */
    public void mo10141x53a1e732(boolean z17) {
        this.isReuse = z17;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13684x82c14eb0(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
