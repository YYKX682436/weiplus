...
public final class tc {
    public tc(p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
    }
    ...
    public final android.graphics.Bitmap a(android.graphics.Bitmap coverBitmap, int i17, int i18) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(coverBitmap, "coverBitmap");
        ...
        android.graphics.Bitmap S = com.p314xaae8f345.mm.sdk.p2603x2137b148.x.S(coverBitmap, i18 / 20, i17 / 20, true, false);
        if (S == null) {
        ...
        try {
            kVar = new ib5.k(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a);
            try {
                kVar.b(S, 20.0f);
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("Finder.FinderPreviewCoverUI", sb6.toString());
                ...
                th = th6;
                try {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("Finder.FinderPreviewCoverUI", "setBlurBitmap error:" + th.getMessage());
                    S = com.p314xaae8f345.mm.sdk.p2603x2137b148.x.X(S, 20);
                    if (kVar != null) {
                        try {
                            kVar.mo135041x5cd39ffa();
    ...
    public final int b(r45.mb4 mb4Var) {
        return (mb4Var == null || mb4Var.m75938x746dc8a6(4) <= 0.0f || mb4Var.m75938x746dc8a6(5) <= 0.0f || mb4Var.m75938x746dc8a6(4) < mb4Var.m75938x746dc8a6(5)) ? 0 : 1;
    }
    ...
    public final void c(android.app.Activity context, java.lang.String personalImagePath, java.lang.String str, float f17, int i17, int i18) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(personalImagePath, "personalImagePath");
        ...
        bundle.putString(com.p314xaae8f345.p347x615374d.p349x208df1fe.p358xd1075a44.p360x696c9db.C3365xfbc5fb5e.f13305x20d82714, "pages/coverPreview/entry");
        bundle.putString("query", g07);
        ((com.p314xaae8f345.mm.p689xc5a27af6.p753x32b0ae.i) ((q80.g0) i95.n0.c(q80.g0.class))).kk(context, bundle, true, false, new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.ui.sc());
    }
}
