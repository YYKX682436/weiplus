...
public final class b7 implements java.lang.Runnable {
    ...
    public final /* synthetic */ cp0.n f210472d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.graphics.Bitmap f210473e;

    public b7(cp0.n nVar, android.graphics.Bitmap bitmap) {
        this.f210472d = nVar;
        this.f210473e = bitmap;
    }

    @Override // java.lang.Runnable
    public final void run() {
        android.view.View b17 = this.f210472d.b();
        if (b17 != null) {
            ...
            android.graphics.Bitmap bitmap = this.f210473e;
