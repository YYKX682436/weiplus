...
public class C15108xb0956cb5 extends android.widget.RelativeLayout implements on5.c {

    /* renamed from: d, reason: collision with root package name */
    public boolean f210671d;
    ...
    public C15108xb0956cb5(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public boolean b(boolean z17) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L0(this.dataList)) {
            if (findViewById == null) {
                return true;
            }
        ...
        android.widget.TextView textView = findViewById != null ? (android.widget.TextView) findViewById.findViewById(com.p314xaae8f345.mm.R.id.bdz) : null;
        if (textView == null) {
            return true;
        }
    ...
    public void g(on5.f refreshLayout, sn5.b oldState, sn5.b newState) {
        ...
        if ((newState == sn5.b.f491689o || newState == sn5.b.f491688n) && (findViewById = findViewById(com.p314xaae8f345.mm.R.id.ilh)) != null) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            java.lang.ThreadLocal threadLocal = zj0.c.f554818a;
            arrayList.add(0);
            java.util.Collections.reverse(arrayList);
    ...
    /* renamed from: getAvailiableList */
    public final java.util.List<java.lang.Integer> m60920xa9a3e968() {
        return this.availiableList;
    }

    /* renamed from: getDataList */
    public final java.util.List<so2.j5> m60921xe6796cde() {
    ...
    public java.lang.String j(int i17) {
        java.lang.String string = getContext().getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.d0f, java.lang.Integer.valueOf(i17));
    ...
    public final void m60922xe131cdea(java.util.List<? extends so2.j5> list) {
        this.dataList = list;
    }

    public C15108xb0956cb5(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        this.availiableList = kz5.c0.i(3002, 4, 9, 3001, 2, -3, -5, -7, 10002);
        android.content.res.TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, li0.a.f400283d);
