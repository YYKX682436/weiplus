...
public final class C14447x781b0cb extends android.widget.LinearLayout implements com.p314xaae8f345.mm.ui.p2740x696c9db.c5 {

    /* renamed from: d, reason: collision with root package name */
    public final boolean f202592d;
    ...
    public C14447x781b0cb(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f202592d = com.p314xaae8f345.mm.ui.bl.f(getContext());
    ...
    public final void a() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MegaVideoInputLayout", "restoreViews: return to original");
    ...
    /* renamed from: setListenKeyBoardChange */
    public final void m58263x7a6cef80(boolean z17) {
        this.listenKeyBoardChange = z17;
    }

    /* renamed from: setNestedAnimButton */
    public final void m58264xbd36f57c(android.view.View view) {
        this.nestedAnimButton = view;
    }

    /* renamed from: setNestedAnimVideoView */
    public final void m58265x6d662336(android.view.View view) {
        this.nestedAnimVideoView = view;
    }

    /* renamed from: setOnKeyboardChange */
    public final void m58266x1cc24eb8(yz5.p pVar) {
        this.onKeyboardChange = pVar;
    }

    /* renamed from: setShowKeyboard */
    public final void m58267x8279f386(boolean z17) {
    }
    ...
    public void w2(int i17, boolean z17) {
        ...
        if (!this.listenKeyBoardChange) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MegaVideoInputLayout", "onKeyboardHeightChanged: listenKeyBoardChange = " + this.listenKeyBoardChange);
            return;
        }
        boolean z18 = i17 > 0;
        if (z18) {
            int c17 = this.f202592d ? com.p314xaae8f345.mm.ui.bl.c(getContext()) + i17 : i17;
            boolean z19 = getContext().getResources().getConfiguration().orientation == 2;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MegaVideoInputLayout", "animViews: footer isLand = " + z19 + ", translateY = " + c17);
            if (!z19 && (view = this.nestedAnimVideoView) != null) {
                android.graphics.Point h17 = com.p314xaae8f345.mm.ui.bk.h(getContext());
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MegaVideoInputLayout", "animViews: video view translateY = " + i19 + ", scale = " + f17);
            }
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MegaVideoInputLayout", "onKeyboardHeightChanged: isShow = " + z18 + ", height = " + i17);
        yz5.p pVar = this.onKeyboardChange;
        if (pVar != null) {
            pVar.mo149xb9724478(java.lang.Boolean.valueOf(z18), java.lang.Integer.valueOf(i17));
        }
    }

    public C14447x781b0cb(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
