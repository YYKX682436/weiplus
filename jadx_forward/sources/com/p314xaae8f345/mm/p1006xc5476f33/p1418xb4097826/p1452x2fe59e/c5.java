...
public final class c5 implements gm5.a {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.a7 f187988a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ pq5.g f187989b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ fp0.r f187990c;

    public c5(com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.a7 a7Var, pq5.g gVar, fp0.r rVar) {
        this.f187988a = a7Var;
        this.f187989b = gVar;
        this.f187990c = rVar;
    }
    ...
    public java.lang.Object mo1059x2e7a5e(java.lang.Object obj) {
        ...
        if (((java.lang.Boolean) ((lb2.j) ((jz5.n) com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.t70.f209504ud).mo141623x754a37bb()).r()).booleanValue() && valueOf != null) {
            com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1636x8fb0427b.C14994x9b99c079 c14994x9b99c079 = this.f187988a.f187745i;
            if (c14994x9b99c079 == null) {
                p3321xbce91901.jvm.p3324x21ffc6bd.o.o("feedObj");
                throw null;
            }
            if (valueOf.longValue() != c14994x9b99c079.m59251x5db1b11()) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("Finder.DrawerPresenter", "preload prev skip feedId not match");
                this.f187989b.j(true);
                this.f187990c.b(fp0.u.f346823f);
                return new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.m2(false, null);
            }
        }
        if (this.f187988a.G() && vg7Var != this.f187988a.j0()) {
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder("preload prev skip sortType not match, reqSortType = ");
            sb6.append(vg7Var != null ? java.lang.Integer.valueOf(vg7Var.f469761d) : null);
            sb6.append(", sortType = ");
            sb6.append(this.f187988a.j0().f469761d);
        ...
        this.f187988a.F0(((r45.j51) fVar).m75939xb282bd08(4) == 1);
        this.f187988a.f187755s = ((r45.j51) fVar2.f152151d).m75934xbce7f2f(3);
        java.lang.StringBuilder sb7 = new java.lang.StringBuilder("preloadPrevPage after lastBuffer ");
        if (this.f187988a.f187755s == null) {
            b17 = "null";
        } else {
            com.p314xaae8f345.mm.p2495xc50a8b8b.g gVar = this.f187988a.f187755s;
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.a7 a7Var = this.f187988a;
        ...
        return new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.m2(false, this.f187988a.Q(arrayList, true));
    }
}
