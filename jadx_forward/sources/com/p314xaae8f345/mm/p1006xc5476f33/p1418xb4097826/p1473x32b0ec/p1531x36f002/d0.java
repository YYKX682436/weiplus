...
public final class d0 {
    ...
    public static final com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.d0 f197006a = new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.d0();
    ...
    public final int a(dk2.zf zfVar) {
        ...
        if (fgVar != null && (q17 = fgVar.q()) != null) {
            str = (java.lang.String) q17.f384366d;
        }
        if (mo124533xfb85f7b0 == 1000066) {
            return 1;
        }
    ...
    public final void b(gk2.e eVar, int i17, java.lang.String str, java.util.HashMap extraKv) {
        ...
        r45.qm1 qm1Var;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(extraKv, "extraKv");
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderLivePostMsgReportUtil", "reportPostFinderLiveBoxMsg type:" + i17 + ", content:" + str + ", extraKvSize:" + extraKv.size());
        extraKv.put("comment_type", java.lang.String.valueOf(i17 == 1000066 ? 1 : i17 == 20035 ? 2 : 0));
        ml2.r0 r0Var = (ml2.r0) i95.n0.c(ml2.r0.class);
        java.lang.Integer valueOf = java.lang.Integer.valueOf(i17);
        if (eVar == null || (j0Var = ((mm2.e0) eVar.a(mm2.e0.class)).f410503m) == null || (qm1Var = (r45.qm1) j0Var.mo3195x754a37bb()) == null || (str2 = qm1Var.m75945x2fec8307(1)) == null) {
            str2 = "";
        }
        r0Var.getClass();
    ...
    */
    public final void c(gk2.e r14, dk2.zf r15, java.util.HashMap r16) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.d0.c(gk2.e, dk2.zf, java.util.HashMap):void");
    }
    ...
    public final void d(gk2.e eVar, java.lang.String content, dk2.zf zfVar, java.util.HashMap extraKv) {
        ...
        sb6.append(", extraKv:");
        sb6.append(extraKv);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderLivePostMsgReportUtil", sb6.toString());
        ...
        if (zfVar != null) {
            ...
            dk2.fg fgVar = zfVar instanceof dk2.fg ? (dk2.fg) zfVar : null;
            if (fgVar != null && (q17 = fgVar.q()) != null) {
                extraKv.put("reply_emoji_md5", q17.f384366d);
            }
        } else {
        ...
        if (zl2.r4.f555483a.w1()) {
            ...
            zy2.zb.y6(j0Var, ml2.z4.f409890i2, jSONObject.toString(), null, 4, null);
            return;
        }
        ...
        ml2.r0.hj(r0Var, ml2.b4.f408807x, jSONObject2.toString(), 0L, null, null, null, null, null, 252, null);
        r0Var.f409397J++;
    }
}
