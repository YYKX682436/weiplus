...
public final class bp implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.view.ViewGroup f193597d;

    public bp(android.view.ViewGroup viewGroup) {
        this.f193597d = viewGroup;
    }

    @Override // java.lang.Runnable
    public final void run() {
        android.view.ViewGroup viewGroup = this.f193597d;
