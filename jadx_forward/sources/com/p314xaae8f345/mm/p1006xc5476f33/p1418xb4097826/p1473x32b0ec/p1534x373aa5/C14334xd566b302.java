...
/* renamed from: com.tencent.mm.plugin.finder.live.view.FinderLiveMarqueeTextView */
/* loaded from: classes5.dex */
public final class C14334xd566b302 extends android.widget.TextView {

    /* renamed from: q, reason: collision with root package name */
    public static final /* synthetic */ int f197555q = 0;

    /* renamed from: d, reason: collision with root package name */
    public android.widget.Scroller f197556d;
    ...
    public boolean f197559g;

    /* renamed from: h, reason: collision with root package name */
    public boolean f197560h;
    ...
    public final java.lang.String f197563n;
    ...
    public C14334xd566b302(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
    }

    /* renamed from: getTextEdge */
    private final int m57399x40010600() {
        return ((java.lang.Number) ((jz5.n) this.textEdge).mo141623x754a37bb()).intValue();
    }
    ...
    public final void b() {
        android.widget.Scroller scroller = this.f197556d;
        if (scroller == null || this.f197559g) {
            return;
        }
        this.f197559g = true;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(scroller);
        this.f197558f = scroller.getCurrX();
        android.widget.Scroller scroller2 = this.f197556d;
    ...
    public final void c() {
        ...
        if (this.f197559g) {
            ...
            if (this.f197560h) {
                new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1534x373aa5.f6(this, i18, i19, i27), this.scrollFirstDelay);
                return;
            }
            android.widget.Scroller scroller2 = this.f197556d;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(scroller2);
    ...
    public void computeScroll() {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(scroller);
        if (!scroller.isFinished() || this.f197559g) {
            return;
        }
    ...
    public final void m57403x2d7bfd9a(int i17) {
        this.rndDuration = i17;
    }

    /* renamed from: setScrollFirstDelay */
    public final void m57404xdaef87e2(int i17) {
        this.scrollFirstDelay = i17;
    }

    /* renamed from: setScrollMode */
    public final void m57405x20556c12(int i17) {
        this.scrollMode = i17;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14334xd566b302(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        this.f197559g = true;
        this.f197560h = true;
        this.f197563n = "  ";
        this.textEdge = jz5.h.b(new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1534x373aa5.g6(this));
