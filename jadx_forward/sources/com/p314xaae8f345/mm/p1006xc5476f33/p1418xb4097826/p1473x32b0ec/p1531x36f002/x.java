...
public final class x {
    ...
    public static final com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.x f197275a = new com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.x();
    ...
    */
    public final void a(java.util.List r11, java.util.Map r12) {
        /*
            ...
            r2 = 0
            if (r0 == 0) goto L42
            ae2.b2 r0 = ae2.b2.f84994a
            jz5.g r0 = ae2.b2.f85019t
            jz5.n r0 = (jz5.n) r0
        ...
        L43:
            ...
            mm2.e0 r0 = (mm2.e0) r0
            androidx.lifecycle.j0 r3 = r0.f410503m
            java.lang.Object r3 = r3.mo3195x754a37bb()
            r45.qm1 r3 = (r45.qm1) r3
            if (r3 == 0) goto L61
            java.lang.String r3 = r3.m75945x2fec8307(r1)
            if (r3 != 0) goto L63
        L61:
            java.lang.String r3 = ""
        L63:
        ...
        Ld0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.x.a(java.util.List, java.util.Map):void");
    }
    ...
    */
    public final r45.ch1 b(r45.ch1 r10, int r11, int r12) {
        /*
            ...
            r0 = 8
            com.tencent.mm.protobuf.f r0 = r10.m75936x14adae67(r0)
            r8 = r0
            r45.qm1 r8 = (r45.qm1) r8
            r0 = 0
            if (r8 == 0) goto L58
            r1 = 1
            java.lang.String r2 = r8.m75945x2fec8307(r1)
            r3 = 0
            if (r2 == 0) goto L22
            int r2 = r2.length()
            if (r2 != 0) goto L20
        ...
        L26:
            r2 = 12
            long r4 = r10.m75942xfb822ef2(r2)
            r2 = 14
            java.lang.String r2 = r10.m75945x2fec8307(r2)
            if (r2 == 0) goto L40
            int r6 = r2.length()
            if (r6 <= 0) goto L3b
            r3 = r1
        ...
        L58:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.x.b(r45.ch1, int, int):r45.ch1");
    }
    ...
    public final r45.ch1 c(long j17, java.lang.String str, java.lang.Integer num, int i17, int i18, r45.qm1 qm1Var) {
        ...
        zi1Var.f473616d = j17;
        zi1Var.f473617e = qm1Var;
        zi1Var.f473618f = i18;
        zi1Var.f473619g = i17;
        zi1Var.f473622m = str;
        zi1Var.f473623n = i19;
        int i27 = qs5.u.f448004a;
        if (i18 == 1) {
            zi1Var.f473619g = i17 + 1;
        } else if (i18 == 2) {
            zi1Var.f473619g = i17 - 1;
        }
        zi1Var.f473619g = java.lang.Math.max(0, zi1Var.f473619g);
        ch1Var.set(4, com.p314xaae8f345.mm.p2495xc50a8b8b.g.b(zi1Var.mo14344x5f01b1f6()));
        ch1Var.set(13, f197275a.f(qm1Var != null ? qm1Var.m75945x2fec8307(1) : null));
        ch1Var.set(8, qm1Var);
    ...
    public final r45.ch1 d(r45.qm1 boxId, java.lang.String content) {
        ...
        th1Var.f467957d = content;
        ch1Var.set(4, com.p314xaae8f345.mm.p2495xc50a8b8b.g.b(th1Var.mo14344x5f01b1f6()));
        ch1Var.set(13, f197275a.f(boxId.m75945x2fec8307(1)));
        ch1Var.set(8, boxId);
        ch1Var.set(2, zl2.q4.f555466a.m());
        return ch1Var;
    }
    ...
    */
    public final java.lang.String e(java.lang.String r20, java.lang.String r21, java.lang.String r22, boolean r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.x.e(java.lang.String, java.lang.String, java.lang.String, boolean):java.lang.String");
    }
    ...
    public final boolean g(java.lang.String str) {
        ...
        boolean z17 = false;
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) && com.p314xaae8f345.mm.p2621x8fb0427b.z3.R4(str) && ((qv1.a) ((rv1.f) gm0.j1.s(rv1.f.class))).c(str)) {
            z17 = true;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Finder.FinderLiveBoxUtil", "isChatRoomDismiss " + str + ", " + z17);
        return z17;
    }
    ...
    public final boolean h(java.lang.String str) {
        ((py.a) ((qy.i) i95.n0.c(qy.i.class))).getClass();
        boolean z17 = false;
        if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) && com.p314xaae8f345.mm.p2621x8fb0427b.z3.R4(str) && !c01.v1.x(str, false)) {
            z17 = true;
        }
    ...
    */
    public final void i(dk2.zf r12, boolean r13, gk2.e r14, android.content.Context r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1473x32b0ec.p1531x36f002.x.i(dk2.zf, boolean, gk2.e, android.content.Context):void");
    }
    ...
    public final void j(boolean z17, dk2.cg cgVar) {
        ...
        if (zl2.q4.f555466a.E()) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Finder.FinderLiveBoxUtil", "updateLikeMsg msg:" + cgVar.hashCode() + ",likeCount:" + cgVar.s() + ",selfLike:" + cgVar.o() + '!');
        }
    }
}
