...
public final class C15430xb1d1f629 extends android.widget.RelativeLayout implements on5.c {

    /* renamed from: d, reason: collision with root package name */
    public boolean f214482d;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    public yz5.a onMoving;

    public C15430xb1d1f629(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void g(on5.f refreshLayout, sn5.b oldState, sn5.b newState) {
        ...
        sn5.b bVar = sn5.b.f491689o;
        if ((newState == bVar || newState == sn5.b.f491688n) && (textView = (android.widget.TextView) findViewById(com.p314xaae8f345.mm.R.id.ili)) != null) {
            textView.setVisibility(0);
        }
        if (newState != bVar || (findViewById = findViewById(com.p314xaae8f345.mm.R.id.ilh)) == null) {
            return;
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f554818a;
    ...
    public final void m62883xc5db1d8f(yz5.a aVar) {
        this.onMoving = aVar;
    }

    public C15430xb1d1f629(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
