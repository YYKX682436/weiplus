...
public abstract class k0 {
        ...
        if (str != null) {
            ...
            if (d18 != null) {
                ...
                while (i18 < 1000) {
                    ...
                    k3Var.f327538a = str21;
                    n3Var.f327566b.f327558a.add(k3Var);
                    i18++;
                }
                n3Var.f327566b.f327559b = new java.util.LinkedList();
                ...
                while (i19 < 1000) {
                    ...
                    if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str23) && com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str24)) {
                        break;
                    }
                    e04.l3 l3Var = new e04.l3();
                    l3Var.f327553a = str23;
                    l3Var.f327554b = str24;
                    n3Var.f327566b.f327559b.add(l3Var);
                    i19++;
                }
                java.lang.String str25 = (java.lang.String) d18.get(str2.concat(".functionType"));
                if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str25)) {
                    n3Var.f69632xff957a57 = i17;
                } else {
                    n3Var.f69632xff957a57 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P(str25, 0);
                }
                if (z17) {
                    n3Var.f69646x4b6e9352 = str;
                } else {
                    java.lang.StringBuilder sb9 = new java.lang.StringBuilder(256);
                    sb9.append("<productInfo>");
                    sb9.append(str);
                    sb9.append("<functionType>" + n3Var.f69632xff957a57 + "</functionType>");
                    sb9.append("</productInfo>");
                    n3Var.f69646x4b6e9352 = sb9.toString();
                }
            }
        }
        return n3Var;
    ...
    public static java.lang.String c(android.content.Context context, e04.n3 n3Var) {
        ...
        qVar.f430179d = a(n3Var.f69632xff957a57);
        qVar.f430187f = n3Var.f69644x29dd02d3;
        qVar.f430191g = n3Var.f69641x10639700;
        qVar.f430199i = 10;
        qVar.f430207k = n3Var.f69640xf16e7ed5;
        qVar.f430195h = "";
        qVar.H = e04.q3.b(context, n3Var.f69645x2262335f);
        qVar.f430267z = n3Var.f69643x7b28c57e;
        qVar.f430176c0 = n3Var.f69645x2262335f;
        qVar.f430180d0 = e04.q3.a(n3Var);
