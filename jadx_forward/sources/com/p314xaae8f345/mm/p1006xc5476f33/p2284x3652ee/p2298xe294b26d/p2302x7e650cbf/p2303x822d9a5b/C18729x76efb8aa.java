package com.p314xaae8f345.mm.p1006xc5476f33.p2284x3652ee.p2298xe294b26d.p2302x7e650cbf.p2303x822d9a5b;

@p3321xbce91901.InterfaceC29042xe907df4f(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u00002\u00020\u00012\u00020\u0002B\u001b\b\u0016\u0012\u0006\u0010\u000e\u001a\u00020\r\u0012\b\u0010\u0010\u001a\u0004\u0018\u00010\u000f¢\u0006\u0004\b\u0011\u0010\u0012B#\b\u0016\u0012\u0006\u0010\u000e\u001a\u00020\r\u0012\b\u0010\u0010\u001a\u0004\u0018\u00010\u000f\u0012\u0006\u0010\u0013\u001a\u00020\u0007¢\u0006\u0004\b\u0011\u0010\u0014J\u0012\u0010\u0006\u001a\u00020\u00052\b\u0010\u0004\u001a\u0004\u0018\u00010\u0003H\u0016R\u001b\u0010\f\u001a\u00020\u00078BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\n\u0010\u000b¨\u0006\u0015"}, d2 = {"Lcom/tencent/mm/plugin/ting/playapp/radio_channel/floatball/TingRadioChannelFloatBallView;", "Landroid/widget/FrameLayout;", "Lbl4/a;", "Landroid/view/View$OnClickListener;", "clickListener", "Ljz5/f0;", "setOnCoverClickListener", "", "h", "Ljz5/g;", "getWaveSize", "()I", "waveSize", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attributeSet", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "defAttr", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "plugin-ting_release"}, k = 1, mv = {1, 9, 0})
/* renamed from: com.tencent.mm.plugin.ting.playapp.radio_channel.floatball.TingRadioChannelFloatBallView */
/* loaded from: classes14.dex */
public final class C18729x76efb8aa extends android.widget.FrameLayout implements bl4.a {

    /* renamed from: i, reason: collision with root package name */
    public static final /* synthetic */ int f256263i = 0;

    /* renamed from: d, reason: collision with root package name */
    public com.p314xaae8f345.mm.ui.p2747xd1075a44.C22628xfde5d61d f256264d;

    /* renamed from: e, reason: collision with root package name */
    public android.view.View.OnClickListener f256265e;

    /* renamed from: f, reason: collision with root package name */
    public bl4.b f256266f;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.String f256267g;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    public final jz5.g waveSize;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public C18729x76efb8aa(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
    }

    /* renamed from: getWaveSize */
    private final int m72209x9fd50010() {
    ...
    public void a(bl4.b bVar) {
        ...
        bl4.b bVar2 = this.f256266f;
        boolean a17 = bVar2 != null ? bVar2.a(bVar) : false;
        this.f256266f = bVar;
        java.lang.String str2 = bVar != null ? bVar.f103268d : null;
        boolean z17 = true;
        if (str2 == null || str2.length() == 0) {
            com.p314xaae8f345.mm.ui.p2747xd1075a44.C22628xfde5d61d c22628xfde5d61d = this.f256264d;
            ...
            com.p314xaae8f345.mm.ui.p2747xd1075a44.C22628xfde5d61d c22628xfde5d61d2 = this.f256264d;
        ...
        if (bVar3 != null) {
            ...
            if (z17) {
                ...
                pm0.v.X(new zl4.g(this));
            } else {
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str3, this.f256267g)) {
                ...
                this.f256267g = str3;
                ((dl4.m0) ((ff0.t) i95.n0.c(ff0.t.class))).aj(str3, this.f256264d, z18 ? ((dl4.m0) ((ff0.t) i95.n0.c(ff0.t.class))).Ui() : 0, new zl4.h(this));
            }
        }
    }
    ...
    public void mo10729xe6095fa6(android.view.View.OnClickListener onClickListener) {
        this.f256265e = onClickListener;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C18729x76efb8aa(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        this.f256267g = "";
        this.waveSize = jz5.h.b(new zl4.i(this));
        ...
        this.f256264d = c22628xfde5d61d;
        if (c22628xfde5d61d != null) {
            c22628xfde5d61d.setVisibility(0);
        }
        com.p314xaae8f345.mm.ui.p2747xd1075a44.C22628xfde5d61d c22628xfde5d61d2 = this.f256264d;
        if (c22628xfde5d61d2 != null) {
            c22628xfde5d61d2.setOnClickListener(new zl4.f(this));
        }
        ...
        com.p314xaae8f345.mm.ui.p2747xd1075a44.C22628xfde5d61d c22628xfde5d61d3 = this.f256264d;
