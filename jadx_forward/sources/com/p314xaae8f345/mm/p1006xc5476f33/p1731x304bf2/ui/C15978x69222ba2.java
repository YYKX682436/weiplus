...
public class C15978x69222ba2 extends android.widget.LinearLayout implements xn5.a0 {
    public C15978x69222ba2(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void m64769x76491f2c(java.util.LinkedList<java.lang.String> linkedList) {
        ...
        if (getChildCount() < linkedList.size() / 2) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                android.view.View.inflate(getContext(), com.p314xaae8f345.mm.R.C30864xbddafb2a.bgu, this);
            }
        }
        ...
        for (int i19 = 0; i19 < linkedList.size() / 2; i19++) {
            ...
            android.widget.TextView textView = (android.widget.TextView) childAt3.findViewById(com.p314xaae8f345.mm.R.id.gox);
            android.widget.TextView textView2 = (android.widget.TextView) childAt3.findViewById(com.p314xaae8f345.mm.R.id.goy);
