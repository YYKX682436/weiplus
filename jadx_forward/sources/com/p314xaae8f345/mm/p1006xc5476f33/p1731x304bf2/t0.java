...
public class t0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ m33.c1 f222173d;

    public t0(com.p314xaae8f345.mm.p1006xc5476f33.p1731x304bf2.p0 p0Var, m33.c1 c1Var) {
        this.f222173d = c1Var;
    }
    ...
    */
    public void run() {
        /*
            r10 = this;
            m53.l1 r0 = com.p314xaae8f345.mm.p1006xc5476f33.p1731x304bf2.p1738x38a607f9.i.i()
            m33.c1 r1 = r10.f222173d
            if (r0 == 0) goto Lae
            m53.h3 r0 = r0.f405393e
            if (r0 == 0) goto Lae
            java.lang.String r0 = r0.f405283d
        ...
        L16:
            ...
            android.database.Cursor r6 = r0.m145256x1d3f4980(r6, r8)     // Catch: java.lang.Exception -> L98
            r8 = 1
            if (r6 == 0) goto L69
            ...
            if (r9 <= 0) goto L4e
            r3.f404813a = r8     // Catch: java.lang.Exception -> L98
            r3.f404814b = r9     // Catch: java.lang.Exception -> L98
        L4e:
            r6.close()     // Catch: java.lang.Exception -> L98
            boolean r6 = r3.f404813a     // Catch: java.lang.Exception -> L98
            if (r6 == 0) goto L69
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r2, r0, r6)     // Catch: java.lang.Exception -> L98
            goto La6
        L69:
            ...
            android.database.Cursor r0 = r0.m145256x1d3f4980(r6, r9)     // Catch: java.lang.Exception -> L98
            if (r0 != 0) goto L74
            goto La6
        L74:
        ...
        Lb6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1731x304bf2.t0.run():void");
    }
}
