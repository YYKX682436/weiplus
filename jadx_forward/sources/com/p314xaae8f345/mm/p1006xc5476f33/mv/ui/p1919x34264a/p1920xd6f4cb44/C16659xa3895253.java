...
public final class C16659xa3895253 extends android.widget.RelativeLayout {

    /* renamed from: d, reason: collision with root package name */
    public final r45.hf2 f232429d;
    ...
    public C16659xa3895253(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        new fm3.u();
        this.f232429d = new r45.hf2();
        this.videoContainer = jz5.h.b(new om3.e(this));
        this.lyricManager = jz5.h.b(new om3.d(context, this));
        android.view.View.inflate(context, com.p314xaae8f345.mm.R.C30864xbddafb2a.czv, this);
    }

    /* renamed from: getLyricManager */
    private final om3.c m67272x59d8bcc4() {
        return (om3.c) ((jz5.n) this.lyricManager).mo141623x754a37bb();
    }

    /* renamed from: getSongIdWithCheckPermission */
    private final void m67273x2e4a1d6b() {
        gm0.j1.d().g(new hm3.g(this.f232429d, hashCode()));
    }

    /* renamed from: getVideoContainer */
    private final android.widget.FrameLayout m67274xe8faff3c() {
        return (android.widget.FrameLayout) ((jz5.n) this.videoContainer).mo141623x754a37bb();
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public C16659xa3895253(android.content.Context context, android.util.AttributeSet attrs) {
