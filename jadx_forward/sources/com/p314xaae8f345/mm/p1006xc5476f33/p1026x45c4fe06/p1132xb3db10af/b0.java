...
public abstract class b0 {
    ...
    public static final java.util.Map f165662a = new java.util.HashMap();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f165663b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.Map f165664c = new java.util.HashMap();

    public static java.util.List a(java.lang.Class cls, java.lang.String str) {
        java.lang.String str2 = cls.getName() + "_" + str;
        java.util.Map map = f165663b;
        if (((java.util.HashMap) map).containsKey(str2)) {
            return (java.util.List) ((java.util.HashMap) map).get(str2);
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        kg1.m.e(c(cls, str), new com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1132xb3db10af.a0(arrayList));
