package com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1219xd1075a44.p1221x2e06d1;

/* renamed from: com.tencent.mm.plugin.appbrand.widget.base.AppBrandViewMotionCompat */
/* loaded from: classes7.dex */
public final class C12764xd5406843 {

    /* renamed from: a, reason: collision with root package name */
    public static android.view.MotionEvent.PointerCoords[] f172589a;

    /* renamed from: b, reason: collision with root package name */
    public static android.view.MotionEvent.PointerProperties[] f172590b;

    /* renamed from: c, reason: collision with root package name */
    public static int[] f172591c;
    ...
    public static android.view.MotionEvent c(android.view.MotionEvent motionEvent, int i17) {
        ...
        android.view.MotionEvent.PointerCoords[] pointerCoordsArr2 = f172589a;
        if (pointerCoordsArr2 == null || pointerCoordsArr2.length < pointerCount) {
            ...
            f172590b = pointerPropertiesArr;
            f172591c = new int[length];
        }
        android.view.MotionEvent.PointerProperties[] pointerPropertiesArr2 = f172590b;
        android.view.MotionEvent.PointerCoords[] pointerCoordsArr4 = f172589a;
        int[] iArr = f172591c;
    ...
    /* renamed from: dispatchTransformedTouchEvent */
    public static boolean m53349x403165ac(android.view.ViewGroup viewGroup, android.view.MotionEvent motionEvent, boolean z17, android.view.View view, int i17) {
        ...
        if (i27 != i18) {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.AppBrandViewMotionCompat", "dispatchTransformedTouchEvent e=%s", e17.getMessage());
                return false;
            }
        } else {
