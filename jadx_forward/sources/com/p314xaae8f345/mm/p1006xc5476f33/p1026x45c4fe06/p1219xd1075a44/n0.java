...
public class n0 extends android.graphics.drawable.Drawable {
    ...
    public static final /* synthetic */ int f173301e = 0;

    /* renamed from: a, reason: collision with root package name */
    public final android.graphics.Rect f173302a = new android.graphics.Rect();

    /* renamed from: b, reason: collision with root package name */
    public final android.graphics.Rect f173303b = new android.graphics.Rect();

    /* renamed from: c, reason: collision with root package name */
    public final android.graphics.Paint f173304c = new android.graphics.Paint();

    /* renamed from: d, reason: collision with root package name */
    public int f173305d = 0;
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        int i17 = bounds.top;
        android.graphics.Rect rect = this.f173302a;
        ...
        android.graphics.Paint paint = this.f173304c;
        if (this.f173305d != 0) {
            int i18 = rect.left;
            android.graphics.Rect rect2 = this.f173303b;
            if (i18 > 0) {
                rect2.set(bounds.left, min, min2, max2);
                paint.setColor(this.f173305d);
