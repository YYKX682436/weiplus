...
public class t extends com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1219xd1075a44.y implements android.graphics.drawable.Animatable2 {

    /* renamed from: p, reason: collision with root package name */
    public java.util.ArrayList f173646p;
    ...
    public void clearAnimationCallbacks() {
        java.util.ArrayList arrayList = this.f173646p;
        if (arrayList != null) {
            arrayList.clear();
            this.f173646p = null;
        }
    ...
    @Override // com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1219xd1075a44.y, android.graphics.drawable.Animatable
    public void start() {
        super.start();
        java.util.ArrayList arrayList = this.f173646p;
        ...
        java.util.Iterator it = new java.util.ArrayList(this.f173646p).iterator();
        while (it.hasNext()) {
    ...
    public boolean unregisterAnimationCallback(android.graphics.drawable.Animatable2.AnimationCallback animationCallback) {
        ...
        int indexOf;
        if (animationCallback == null || (arrayList = this.f173646p) == null || (indexOf = arrayList.indexOf(animationCallback)) < 0) {
            return false;
        }
        this.f173646p.remove(indexOf);
        return true;
    }
}
