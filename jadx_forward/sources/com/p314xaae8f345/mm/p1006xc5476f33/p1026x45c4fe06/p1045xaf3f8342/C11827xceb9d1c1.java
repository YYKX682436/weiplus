...
public class C11827xceb9d1c1 implements android.os.Parcelable {

    /* renamed from: CREATOR */
    public static final android.os.Parcelable.Creator<com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1045xaf3f8342.C11827xceb9d1c1> f33604x681a0c0c = new k91.q5();

    /* renamed from: d, reason: collision with root package name */
    public java.lang.String f158966d;

    /* renamed from: e, reason: collision with root package name */
    public int f158967e;

    /* renamed from: f, reason: collision with root package name */
    public java.lang.String f158968f;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.String f158969g;

    /* renamed from: h, reason: collision with root package name */
    public boolean f158970h;

    /* renamed from: i, reason: collision with root package name */
    public final java.util.List f158971i = new java.util.LinkedList();

    /* renamed from: m, reason: collision with root package name */
    public long f158972m;

    /* renamed from: n, reason: collision with root package name */
    public java.lang.String f158973n;

    /* renamed from: o, reason: collision with root package name */
    public java.lang.String f158974o;

    public C11827xceb9d1c1() {
    }
    ...
    */
    public static java.util.List a(java.lang.Object r14) {
        ...
        L1e:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r1, r3, r6)     // Catch: org.json.JSONException -> Ld9
            r3 = r2
        L30:
            if (r3 == 0) goto Ld8
        ...
        L4e:
            ...
            java.util.List r9 = r8.f158971i     // Catch: org.json.JSONException -> Ld9
            java.lang.String r10 = "plugin_id"
            java.lang.String r10 = r7.optString(r10)     // Catch: org.json.JSONException -> Ld9
            r8.f158966d = r10     // Catch: org.json.JSONException -> Ld9
            java.lang.String r10 = "inner_version"
            int r10 = r7.optInt(r10)     // Catch: org.json.JSONException -> Ld9
            r8.f158967e = r10     // Catch: org.json.JSONException -> Ld9
            java.lang.String r10 = "md5"
            java.lang.String r10 = r7.optString(r10)     // Catch: org.json.JSONException -> Ld9
            r8.f158968f = r10     // Catch: org.json.JSONException -> Ld9
            java.lang.String r10 = "prefix_path"
            java.lang.String r10 = r7.optString(r10)     // Catch: org.json.JSONException -> Ld9
            r8.f158969g = r10     // Catch: org.json.JSONException -> Ld9
        ...
        L84:
            r10 = r4
        L85:
            r8.f158970h = r10     // Catch: org.json.JSONException -> Ld9
        ...
        Ld9:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r1, r0, r14)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1045xaf3f8342.C11827xceb9d1c1.a(java.lang.Object):java.util.List");
    }
    ...
    public static java.util.List b(java.util.List list, java.lang.Object obj, int i17) {
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                ...
                if (c11831x52cc1bc5.f159007d == i17) {
                    list2 = c11831x52cc1bc5.f159010g;
                }
            }
        }
    ...
    public void writeToParcel(android.os.Parcel parcel, int i17) {
        parcel.writeString(this.f158966d);
        parcel.writeInt(this.f158967e);
        parcel.writeString(this.f158968f);
        parcel.writeString(this.f158969g);
        parcel.writeByte(this.f158970h ? (byte) 1 : (byte) 0);
        parcel.writeList(this.f158971i);
        parcel.writeLong(this.f158972m);
        parcel.writeString(this.f158973n);
        parcel.writeString(this.f158974o);
    }

    public C11827xceb9d1c1(android.os.Parcel parcel) {
        this.f158966d = parcel.readString();
        this.f158967e = parcel.readInt();
        this.f158968f = parcel.readString();
        this.f158969g = parcel.readString();
        this.f158970h = parcel.readByte() == 1;
        parcel.readList(this.f158971i, java.lang.Integer.class.getClassLoader());
        this.f158972m = parcel.readLong();
        this.f158973n = parcel.readString();
        this.f158974o = parcel.readString();
    }
}
