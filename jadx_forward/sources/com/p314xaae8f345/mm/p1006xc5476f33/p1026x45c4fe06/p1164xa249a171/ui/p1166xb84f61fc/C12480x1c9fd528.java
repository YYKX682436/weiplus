...
public class C12480x1c9fd528 extends com.p314xaae8f345.mm.ui.p2747xd1075a44.C22633x83752a59 {
    public android.content.Context G;

    public C12480x1c9fd528(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final void I0() {
        com.p314xaae8f345.mm.sdk.p2603x2137b148.Log.c("MicroMsg.AppBrand.OpenMaterialWebView", "init OpenMaterialWebView", new java.lang.Object[0]);
        if (fp.h.c(19)) {
            return;
        }
        try {
            ...
            if (a17 instanceof java.lang.Thread) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrand.OpenMaterialWebView", "tryInterruptAwaitingWebCoreThread, webCoreThread.getState = %s", thread.getState());
                if (thread.getState() == java.lang.Thread.State.WAITING) {
                    thread.interrupt();
                }
            }
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrand.OpenMaterialWebView", "tryInterruptAwaitingWebCoreThread, exception = %s", e17);
        }
    }
    ...
    public void J0(com.p314xaae8f345.p3210x3857dc.s0 s0Var, com.p314xaae8f345.p3210x3857dc.h1 h1Var) {
        ...
        com.p314xaae8f345.p3210x3857dc.z0 mo120153xd15cf999 = mo120153xd15cf999();
        zg0.q3 q3Var = (zg0.q3) i95.n0.c(zg0.q3.class);
        android.content.Context context = getContext();
        java.lang.String g17 = mo120153xd15cf999().g();
        ((yg0.s4) q3Var).getClass();
        mo120153xd15cf999.Q(com.p314xaae8f345.mm.p2470x93e71c27.ui.p2488x696c9db.e9.b(context, g17));
        ...
        m52096xeed5daa9((android.view.WindowManager) com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSystemService("window"));
    ...
    public void m52096xeed5daa9(android.view.WindowManager windowManager) {
        try {
    ...
    public C12480x1c9fd528(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        this.G = context;
        I0();
    }

    public C12480x1c9fd528(android.content.Context context) {
        super(context, null);
        this.G = context;
        I0();
    }
