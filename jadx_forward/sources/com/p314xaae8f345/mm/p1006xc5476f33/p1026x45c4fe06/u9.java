...
public abstract class u9 {
    public static boolean a(android.content.Context context, com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.t9 t9Var, int i17, boolean z17) {
        java.lang.String str;
        if (context == null || t9Var == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrandShortcutManager", "add fail, invalid argument");
            return false;
        }
        java.lang.String[] strArr = t9Var.f170506b;
        if (strArr == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrandShortcutManager", "no such user");
            return false;
        }
        android.graphics.Bitmap d17 = d(strArr);
        if (d17 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "bitmap do not exist, delay get.");
            return true;
        }
        android.content.Intent c17 = c(context, t9Var, i17, e(context, d17, i17), true);
        if (c17 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrandShortcutManager", "add fail, intent is null");
            return false;
        }
        ...
        if (((android.content.Intent) c17.getParcelableExtra("android.intent.extra.shortcut.INTENT")) != null) {
            ...
            java.lang.String str3 = t9Var.f170508d;
            sb6.append(str3);
            sb6.append(i17);
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "appId: %s, shortcutId: %s", str3, str);
        } else {
            str = null;
        }
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "add shortcut %s", t9Var.f170509e);
            return true;
        } catch (java.lang.IllegalStateException e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.AppBrandShortcutManager", e17.toString());
            return false;
        }
    }
    ...
    public static void b(android.content.Context context, android.graphics.Bitmap bitmap, java.lang.String str) {
        ...
        if (context == null || bitmap == null || bitmap.isRecycled() || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            return;
        }
    ...
    public static android.content.Intent c(android.content.Context context, com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.t9 t9Var, int i17, android.graphics.Bitmap bitmap, boolean z17) {
        java.lang.String str;
        if (t9Var == null || context == null || (str = t9Var.f170509e) == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrandShortcutManager", "buildIntent, wrong parameters");
            return null;
        }
        if (bitmap == null && z17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrandShortcutManager", "no bmp");
            return null;
        }
        java.lang.String str2 = t9Var.f170507c;
        if (!android.text.TextUtils.isEmpty(str2)) {
            str = str2;
        }
        android.content.Intent wi6 = com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p9.f167864a.wi(context.getPackageName(), i17, t9Var.f170509e, t9Var.f170507c, t9Var.f170506b, t9Var.f170508d, t9Var.f170505a, 1);
    ...
    public static android.graphics.Bitmap d(java.lang.String[] strArr) {
        ...
        while (true) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "getAvatarBitmap :url:%s", str);
            if (!com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) && (bitmap = l01.d0.f396294a.f(str, null)) != null && !bitmap.isRecycled()) {
                break;
            }
            i17++;
        }
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "use default Icon");
        ...
        if (m10969xb866ec1c.isRecycled()) {
            return null;
        }
        return m10969xb866ec1c;
    }
    ...
    public static android.graphics.Bitmap e(android.content.Context context, android.graphics.Bitmap bitmap, int i17) {
        ...
        if (context != null && bitmap != null && !bitmap.isRecycled()) {
            ...
            if (createScaledBitmap != null) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "bitmap recycle %s", createScaledBitmap);
                createScaledBitmap.recycle();
            }
            if (i17 == 2) {
                b(context, bitmap2, i65.a.r(context, com.p314xaae8f345.mm.R.C30867xcad56011.f571827qz));
            } else if (i17 == 1) {
                b(context, bitmap2, i65.a.r(context, com.p314xaae8f345.mm.R.C30867xcad56011.f571828r0));
            }
        }
        return bitmap2;
    }

    public static boolean f(android.content.Context context, com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.t9 t9Var, int i17) {
        if (context == null || t9Var == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.AppBrandShortcutManager", "remove fail, context or config is null.");
            return false;
        }
        java.lang.String[] strArr = t9Var.f170506b;
        if (strArr == null) {
        ...
        ((zd0.e) ((ae0.h) i95.n0.c(ae0.h.class))).getClass();
        xp1.c.i(context, c17);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.AppBrandShortcutManager", "remove shortcut %s", t9Var.f170509e);
        return true;
    }
}
