...
public class ka extends com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.f {

    /* renamed from: CTRL_INDEX */
    public static final int f34378x366c91de = 619;

    /* renamed from: NAME */
    public static final java.lang.String f34379x24728b = "openWCPayLQTDepositPlanAdd";

    /* renamed from: g, reason: collision with root package name */
    public final int f162885g = cf.b.a(this);
    ...
    public void A(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.l lVar, org.json.JSONObject jSONObject, int i17) {
        ...
        if (r07 == null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "mmActivity is null, invoke fail!");
            return;
        }
        nf.g.a(r07).f(new com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.ja(this, r07, d0Var, i17));
        ...
        if (e17 == null) {
            d0Var.a(i17, o("fail"));
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "sysConfig is null, invoke fail!");
            return;
        }
        ...
        if (b17 == null) {
            d0Var.a(i17, o("fail"));
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "runtime is null, invoke fail!");
            return;
        }
        ...
        bundle.putString("command_word", f34379x24728b);
        bundle.putString("wxapp_path", m52170xad58292c);
        bundle.putInt("source_type", 2);
        if (android.text.TextUtils.isEmpty(optString)) {
            j45.l.n(r07, "wallet", ".ui.WalletJsApiAdapterUI", new android.content.Intent().putExtras(bundle), this.f162885g);
        } else if ("LQTFixedDepositAddPlan".equals(optString)) {
            ((h45.q) i95.n0.c(h45.q.class)).mo24817xf6e2c929(r07, bundle);
            d0Var.a(i17, o("ok"));
        } else {
            d0Var.a(i17, o("fail:auth denied"));
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "routURL auth failed!");
        }
    }
}
