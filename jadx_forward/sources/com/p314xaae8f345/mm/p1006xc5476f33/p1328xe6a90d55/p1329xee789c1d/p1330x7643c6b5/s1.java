...
public class s1 implements com.p314xaae8f345.mm.p1006xc5476f33.p1328xe6a90d55.p1329xee789c1d.p1330x7643c6b5.j {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.p1328xe6a90d55.p1329xee789c1d.p1330x7643c6b5.p0 f177619a;

    public s1(com.p314xaae8f345.mm.p1006xc5476f33.p1328xe6a90d55.p1329xee789c1d.p1330x7643c6b5.p0 p0Var) {
        this.f177619a = p0Var;
    }
    ...
    public void a(int i17, java.nio.ByteBuffer byteBuffer, int i18, int i19, int i27) {
        com.p314xaae8f345.mm.p1006xc5476f33.p1328xe6a90d55.p1329xee789c1d.p1330x7643c6b5.p0 p0Var = this.f177619a;
        p0Var.f177569x0.d(i17, "screenCaptureCallback");
        java.lang.String str = (java.lang.String) p0Var.L1.get(java.lang.Integer.valueOf(i17));
        if ((i27 & 1) == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.OpenVoice.OpenVoiceService", "Unsupported format %d", java.lang.Integer.valueOf(i27));
        ...
        if (decodeByteArray != null && !decodeByteArray.isRecycled()) {
            try {
                com.p314xaae8f345.mm.sdk.p2603x2137b148.x.D0(decodeByteArray, 90, android.graphics.Bitmap.CompressFormat.JPEG, str, true);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.OpenVoice.OpenVoiceService", "bitmap filelen %s", java.lang.Long.valueOf(com.p314xaae8f345.mm.vfs.w6.k(str)));
                z17 = true;
            } catch (java.lang.Exception e17) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.OpenVoice.OpenVoiceService", "error for saveBitmapToImage %s", e17.getMessage());
            }
        }
        if (!z17) {
            ((md1.t) p0Var.O1).a(1, null, "save fail", -1, -1);
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.OpenVoice.OpenVoiceService", "saved at %s", str);
