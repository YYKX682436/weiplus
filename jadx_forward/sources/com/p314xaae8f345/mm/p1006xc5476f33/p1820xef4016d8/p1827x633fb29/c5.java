...
public class c5 implements android.view.animation.Animation.AnimationListener {
    ...
    public final /* synthetic */ android.view.View f226745a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ int f226746b;
    ...
    public void onAnimationEnd(android.view.animation.Animation animation) {
        android.view.View view = this.f226745a;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f554818a;
        arrayList.add(java.lang.Integer.valueOf(this.f226746b));
