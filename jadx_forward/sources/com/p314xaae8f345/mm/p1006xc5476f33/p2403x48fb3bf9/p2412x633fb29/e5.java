...
public final class e5 extends com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2404x2eaf9f.i3 {

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.ArrayList f264395c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.ArrayList f264396d;

    /* renamed from: b, reason: collision with root package name */
    public boolean f264397b;

    static {
        com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.d5 d5Var = new com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.d5(null);
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.d5.a(d5Var, Zi);
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.d5.a(d5Var, Zi2);
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.d5.b(d5Var, Zi3);
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.d5.b(d5Var, Zi4);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WebViewTeenModeInterceptor", "initWebViewTeenModeInterceptor blockList size: %d, %s, allowList size: %d, %s", java.lang.Integer.valueOf(d18.size()), d18, java.lang.Integer.valueOf(d17.size()), d17);
    }
    ...
    public boolean i() {
        ...
        boolean z17 = false;
        if (!(s6Var != null ? s6Var.mo13794x74219ae7() : false)) {
            return true;
        }
        java.lang.String str = c().f263475n;
        ...
        int i17 = z17 ? 2 : 3;
        java.lang.String c17 = hy4.c.f367622a.c(str);
        boolean v17 = v(i17, c17);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WebViewTeenModeInterceptor", "onTeenModeStatusChange bizType=" + i17 + ", bizKey = " + c17 + " hasAuthorized=" + this.f264397b + ", newHasAuthorized=" + v17 + ", url=" + str);
        if (v17 && !this.f264397b) {
            this.f264397b = v17;
            c().f263449a.mo32265x141096a9("about:blank");
            c().f263454c0 = true;
            c().V0(str, true, 8);
        }
        return true;
    ...
    */
    public boolean p(java.lang.String r11, android.content.Intent r12) {
        ...
        L14:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r1, r12, r4, r5)
            r10.y(r2, r0)
        L1f:
            r12 = r3
        L20:
        ...
        L2b:
            ...
            qk.s6 r4 = (qk.s6) r4
            boolean r4 = r4.mo13794x74219ae7()
        ...
        La2:
            ...
            r8 = 4
            r9 = 0
            com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2404x2eaf9f.r0.W0(r4, r5, r6, r7, r8, r9)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.e5.p(java.lang.String, android.content.Intent):boolean");
    }
    ...
    */
    public boolean s(int r1, boolean r2, java.lang.String r3, java.lang.String r4) {
        /*
            ...
            r2 = 0
            if (r1 == 0) goto L1b
            boolean r1 = r1.mo13794x74219ae7()
            goto L1c
        L1b:
            r1 = r2
        L1c:
        ...
        L6b:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2412x633fb29.e5.s(int, boolean, java.lang.String, java.lang.String):boolean");
    }
    ...
    public final boolean v(int i17, java.lang.String bizKey) {
        ...
        try {
            com.p314xaae8f345.mm.p1006xc5476f33.p2403x48fb3bf9.p2416x3608ae.v0 e07 = c().e0();
            android.os.Bundle bundle = new android.os.Bundle();
            bundle.putInt("bizType", i17);
            bundle.putString("bizKey", bizKey);
            android.os.Bundle i18 = e07.i(257, bundle);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(i18, "null cannot be cast to non-null type android.os.Bundle");
            boolean z17 = i18.getBoolean("authorized", false);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WebViewTeenModeInterceptor", "hasAuthorization:bizType=" + i17 + ", bizKey = " + bizKey + ", authorized = " + z17);
            return z17;
        } catch (java.lang.Throwable th6) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.WebViewTeenModeInterceptor", "get hasAuthorization error " + th6.getMessage());
            return false;
        }
    }

    public final boolean w(java.lang.String str) {
        for (java.lang.String str2 : f264395c) {
    ...
    public final boolean x(java.lang.String str) {
        for (java.lang.String str2 : f264396d) {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(str, str2)) {
                return true;
            }
            if (r26.i0.n(str, "." + str2, false)) {
