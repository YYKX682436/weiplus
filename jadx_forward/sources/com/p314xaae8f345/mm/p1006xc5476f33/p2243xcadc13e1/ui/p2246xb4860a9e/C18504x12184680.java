...
/* renamed from: com.tencent.mm.plugin.subapp.ui.friend.AddFriendVerifyRecordConvertFactory */
/* loaded from: classes4.dex */
public final class C18504x12184680 implements in5.s {

    /* renamed from: $stable */
    public static final int f38471x3b2de05f = 8;

    /* renamed from: Companion */
    public static final eg4.a f38472x233c02ec = new eg4.a(null);
    ...
    public C18504x12184680() {
        this(null, 1, 0 == true ? 1 : 0);
    }

    /* renamed from: getFMessageItemConvert */
    private final eg4.t m71552x35e869() {
        return (eg4.t) this.fMessageItemConvert.mo141623x754a37bb();
    }

    /* renamed from: getHeaderConvert */
    private final eg4.y m71553xe03f06b0() {
        return (eg4.y) this.headerConvert.mo141623x754a37bb();
    }

    /* renamed from: getLoadingItemConvert */
    private final eg4.z m71554x41967a3a() {
        return (eg4.z) this.loadingItemConvert.mo141623x754a37bb();
    }

    /* renamed from: getNewItemConvert */
    private final eg4.i0 m71555x2578b656() {
        return (eg4.i0) this.newItemConvert.mo141623x754a37bb();
    }
    ...
    public in5.r mo43555xf2bb75ea(int type) {
        eg4.f2 f2Var;
        eg4.f2.f334236e.getClass();
        eg4.f2[] m127702xcee59d22 = eg4.f2.m127702xcee59d22();
        int length = m127702xcee59d22.length;
        int i17 = 0;
        while (true) {
            if (i17 >= length) {
                f2Var = null;
            ...
            f2Var = m127702xcee59d22[i17];
            if (f2Var.f334239d == type) {
                break;
            }
            i17++;
        }
        if (f2Var == null) {
            f2Var = eg4.f2.f334237f;
        }
        int ordinal = f2Var.ordinal();
        if (ordinal == 0) {
            return m71553xe03f06b0();
        }
        if (ordinal == 1) {
            return m71555x2578b656();
        }
        if (ordinal == 2) {
            return m71552x35e869();
        }
        if (ordinal == 3) {
            return m71554x41967a3a();
        }
        throw new jz5.j();
    }

    public C18504x12184680(yz5.p pVar) {
        this.onItemLongClickListener = pVar;
        this.headerConvert = jz5.h.b(eg4.c.f334213d);
        this.newItemConvert = jz5.h.b(new eg4.e(this));
        this.fMessageItemConvert = jz5.h.b(new eg4.b(this));
        this.loadingItemConvert = jz5.h.b(eg4.d.f334219d);
    }

    public /* synthetic */ C18504x12184680(yz5.p pVar, int i17, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
