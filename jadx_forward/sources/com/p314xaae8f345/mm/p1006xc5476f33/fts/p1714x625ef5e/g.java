...
public final class g extends p13.t {
    ...
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.k f219076q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.k kVar, p13.u ftsRequest) {
        super(ftsRequest);
    ...
    public void p(p13.v vVar) {
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.k kVar = this.f219076q;
        if (vVar == null || uVar == null) {
            return;
        }
        p13.r d17 = p13.r.d(uVar.f432688q);
        int size = ((java.util.ArrayList) uVar.f432688q).size() + 1;
        vVar.f432692d = d17;
