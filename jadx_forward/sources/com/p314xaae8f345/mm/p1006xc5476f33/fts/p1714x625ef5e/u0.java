...
public class u0 extends p13.t {
    ...
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.l f219218q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public u0(com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.l lVar, p13.u uVar) {
        super(uVar);
        this.f219218q = lVar;
    }
    ...
    public void p(p13.v vVar) {
        ...
        vVar.f432692d = b17;
        android.database.Cursor R = this.f219218q.f219121g.R(b17, uVar.f432678g);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.HashSet hashSet = new java.util.HashSet(uVar.f432681j);
        int i17 = 0;
        while (R.moveToNext()) {
