...
public final class k1 extends p13.t {

    /* renamed from: q, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.s1 f219115q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k1(com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.s1 s1Var, p13.u ftsRequest) {
        super(ftsRequest);
    ...
    public void p(p13.v vVar) {
        ...
        p75.d dVar = dm.i2.L;
        i17.f434190d = dVar.p("'%@kefu.openim'").d(dVar.p("'%@app'"));
        ...
        com.p314xaae8f345.mm.p1006xc5476f33.fts.p1714x625ef5e.s1 s1Var = this.f219115q;
        ...
        if (gVar != null) {
            if (b17.a()) {
                ...
                java.lang.String format = java.lang.String.format("SELECT %s.docid, type, subtype, entity_id, aux_index, timestamp, content, MMHighlight(%s, %s, type, subtype) FROM %s NOT INDEXED JOIN %s ON (%s.docid = %s.rowid) WHERE %s MATCH '%s' AND status >= 0 ORDER BY subtype;", java.util.Arrays.copyOf(new java.lang.Object[]{gVar.r(), gVar.o(), java.lang.Long.valueOf(((java.util.ArrayList) b17.f432666e).size()), gVar.r(), gVar.o(), gVar.r(), gVar.o(), gVar.o(), b17.f()}, 9));
