...
public final class u1 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ android.view.View f219724d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.fts.ui.ActivityC15600x40dfa53 f219725e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ a23.e f219726f;

    public u1(android.view.View view, com.p314xaae8f345.mm.p1006xc5476f33.fts.ui.ActivityC15600x40dfa53 activityC15600x40dfa53, a23.e eVar) {
        this.f219724d = view;
        this.f219725e = activityC15600x40dfa53;
        this.f219726f = eVar;
    }
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0 || motionEvent.getAction() == 2) {
            android.view.View view2 = this.f219724d;
            ...
            if (motionEvent.getAction() == 1) {
                com.p314xaae8f345.mm.p1006xc5476f33.fts.ui.ActivityC15600x40dfa53 activityC15600x40dfa53 = this.f219725e;
                a23.g gVar = activityC15600x40dfa53.f219483t;
                if (gVar != null) {
                    gVar.d(this.f219726f.f82382a);
                }
                a23.g gVar2 = activityC15600x40dfa53.f219483t;
                if (gVar2 != null && (gVar2.b().isEmpty() ^ true)) {
                    android.widget.LinearLayout linearLayout = activityC15600x40dfa53.f219482s;
                    if (linearLayout != null) {
                        linearLayout.removeView(this.f219724d);
                    }
                } else {
                    android.widget.LinearLayout linearLayout2 = activityC15600x40dfa53.f219482s;
                    if (linearLayout2 != null) {
                        linearLayout2.removeAllViews();
                    }
                }
                android.view.View view3 = this.f219724d;
                ...
                android.view.View view4 = this.f219724d;
