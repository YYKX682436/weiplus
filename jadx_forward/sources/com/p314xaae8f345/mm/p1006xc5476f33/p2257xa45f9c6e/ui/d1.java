...
public class d1 extends p012xc85e97e9.p103xe821e364.p104xd1075a44.o3 {

    /* renamed from: s, reason: collision with root package name */
    public static android.animation.TimeInterpolator f254121s;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.ArrayList f254122h = new java.util.ArrayList();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.ArrayList f254123i = new java.util.ArrayList();

    /* renamed from: j, reason: collision with root package name */
    public final java.util.ArrayList f254124j = new java.util.ArrayList();

    /* renamed from: k, reason: collision with root package name */
    public final java.util.ArrayList f254125k = new java.util.ArrayList();

    /* renamed from: l, reason: collision with root package name */
    public final java.util.ArrayList f254126l = new java.util.ArrayList();

    /* renamed from: m, reason: collision with root package name */
    public final java.util.ArrayList f254127m = new java.util.ArrayList();

    /* renamed from: n, reason: collision with root package name */
    public final java.util.ArrayList f254128n = new java.util.ArrayList();

    /* renamed from: o, reason: collision with root package name */
    public final java.util.ArrayList f254129o = new java.util.ArrayList();

    /* renamed from: p, reason: collision with root package name */
    public final java.util.ArrayList f254130p = new java.util.ArrayList();

    /* renamed from: q, reason: collision with root package name */
    public final java.util.ArrayList f254131q = new java.util.ArrayList();

    /* renamed from: r, reason: collision with root package name */
    public final java.util.ArrayList f254132r = new java.util.ArrayList();
    ...
    public final void F(java.util.List list, p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var) {
        for (int size = list.size() - 1; size >= 0; size--) {
            com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1 b1Var = (com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1) list.get(size);
            if (G(b1Var, k3Var) && b1Var.f254096a == null && b1Var.f254097b == null) {
                list.remove(b1Var);
            }
        }
    }

    public final boolean G(com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1 b1Var, p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var) {
        if (b1Var.f254097b == k3Var) {
            b1Var.f254097b = null;
        } else {
            if (b1Var.f254096a != k3Var) {
                return false;
            }
            b1Var.f254096a = null;
        }
    ...
    public void H(p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var) {
        if (f254121s == null) {
            f254121s = new android.animation.ValueAnimator().getInterpolator();
        }
        k3Var.f3639x46306858.animate().setInterpolator(f254121s);
        j(k3Var);
    }
    ...
    public void j(p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var) {
        android.view.View view = k3Var.f3639x46306858;
        view.animate().cancel();
        java.util.ArrayList arrayList = this.f254124j;
        ...
        while (true) {
            ...
            if (((com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1) arrayList.get(size)).f254112a == k3Var) {
        ...
        F(this.f254125k, k3Var);
        float f17 = 1.0f;
        if (this.f254122h.remove(k3Var)) {
        ...
        java.util.ArrayList arrayList4 = this.f254128n;
        ...
        java.util.ArrayList arrayList6 = this.f254127m;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (((com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1) arrayList7.get(size4)).f254112a == k3Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    x(k3Var);
        ...
        java.util.ArrayList arrayList8 = this.f254126l;
        ...
        this.f254131q.remove(k3Var);
        this.f254129o.remove(k3Var);
        this.f254132r.remove(k3Var);
        this.f254130p.remove(k3Var);
        E();
    }
    ...
    public void k() {
        ...
        while (true) {
            ...
            com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1 c1Var = (com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1) arrayList.get(size);
            android.view.View view = c1Var.f254112a.f3639x46306858;
            view.setTranslationY(0.0f);
            view.setTranslationX(0.0f);
            x(c1Var.f254112a);
            arrayList.remove(size);
        }
        java.util.ArrayList arrayList2 = this.f254122h;
        ...
        java.util.ArrayList arrayList3 = this.f254123i;
        ...
        java.util.ArrayList arrayList5 = this.f254125k;
        ...
        while (true) {
            ...
            com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1 b1Var = (com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1) arrayList5.get(size4);
            p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var2 = b1Var.f254096a;
            if (k3Var2 != null) {
                G(b1Var, k3Var2);
            }
            p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var3 = b1Var.f254097b;
            if (k3Var3 != null) {
                G(b1Var, k3Var3);
            }
        }
        ...
        while (true) {
            ...
            while (true) {
                size6--;
                if (size6 >= 0) {
                    com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1 c1Var2 = (com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1) arrayList7.get(size6);
                    android.view.View view3 = c1Var2.f254112a.f3639x46306858;
        ...
        java.util.ArrayList arrayList11 = this.f254128n;
        ...
        while (true) {
            ...
            while (true) {
                size10--;
                if (size10 >= 0) {
                    com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1 b1Var2 = (com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1) arrayList12.get(size10);
                    p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var5 = b1Var2.f254096a;
                    if (k3Var5 != null) {
                        G(b1Var2, k3Var5);
                    }
                    p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var6 = b1Var2.f254097b;
                    if (k3Var6 != null) {
                        G(b1Var2, k3Var6);
                    }
    ...
    @Override // p012xc85e97e9.p103xe821e364.p104xd1075a44.n2
    public boolean o() {
        return (this.f254123i.isEmpty() && this.f254125k.isEmpty() && this.f254124j.isEmpty() && this.f254122h.isEmpty() && this.f254130p.isEmpty() && this.f254131q.isEmpty() && this.f254129o.isEmpty() && this.f254132r.isEmpty() && this.f254127m.isEmpty() && this.f254126l.isEmpty() && this.f254128n.isEmpty()) ? false : true;
    }

    @Override // p012xc85e97e9.p103xe821e364.p104xd1075a44.n2
    public void s() {
        java.util.ArrayList arrayList = this.f254122h;
        boolean z17 = !arrayList.isEmpty();
        java.util.ArrayList arrayList2 = this.f254124j;
        boolean z18 = !arrayList2.isEmpty();
        java.util.ArrayList arrayList3 = this.f254125k;
        boolean z19 = !arrayList3.isEmpty();
        java.util.ArrayList arrayList4 = this.f254123i;
        ...
        if (z17 || z18 || z27 || z19) {
            ...
            while (it.hasNext()) {
                ...
                this.f254131q.add(k3Var);
                animate.setDuration(this.f93702d).alpha(0.0f).setListener(new com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.w0(this, k3Var, animate, view)).start();
            }
            arrayList.clear();
            if (z18) {
                java.util.ArrayList arrayList5 = new java.util.ArrayList();
                arrayList5.addAll(arrayList2);
                this.f254127m.add(arrayList5);
                arrayList2.clear();
                com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.t0 t0Var = new com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.t0(this, arrayList5);
                android.view.View view2 = ((com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1) arrayList5.get(0)).f254112a.f3639x46306858;
            ...
            if (z19) {
                ...
                this.f254128n.add(arrayList6);
                arrayList3.clear();
                com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.u0 u0Var = new com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.u0(this, arrayList6);
                if (z17) {
                    android.view.View view3 = ((com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1) arrayList6.get(0)).f254096a.f3639x46306858;
            ...
            if (z27) {
                ...
                this.f254126l.add(arrayList7);
                arrayList4.clear();
                com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.v0 v0Var = new com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.v0(this, arrayList7);
                if (!z17 && !z18 && !z19) {
                    v0Var.run();
                    return;
                }
                android.view.View view4 = ((p012xc85e97e9.p103xe821e364.p104xd1075a44.k3) arrayList7.get(0)).f3639x46306858;
                long j19 = this.f93702d;
    ...
    public boolean u(p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var, p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var2, int i17, int i18, int i19, int i27) {
        ...
        this.f254125k.add(new com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.b1(k3Var, k3Var2, i17, i18, i19, i27));
        return true;
    }
    ...
    public boolean v(p012xc85e97e9.p103xe821e364.p104xd1075a44.k3 k3Var, int i17, int i18, int i19, int i27) {
        ...
        this.f254124j.add(new com.p314xaae8f345.mm.p1006xc5476f33.p2257xa45f9c6e.ui.c1(k3Var, translationX, translationY, i19, i27));
        return true;
    }
