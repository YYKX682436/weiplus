package com.p314xaae8f345.mm.p1006xc5476f33.p1983x4fc5b2ca.p1990xc5476f33.p1992xb0f4c919;
...
public class C17001x433744de extends android.widget.RelativeLayout implements yt3.r2 {
    ...
    public C17001x433744de(android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        this.imageSizeDP = 34;
        this.paddingDp = 6;
        android.view.LayoutInflater.from(getContext()).inflate(m67913x22f21e20(), (android.view.ViewGroup) this, true);
        android.widget.ImageView imageView = (android.widget.ImageView) findViewById(com.p314xaae8f345.mm.R.id.llb);
        this.unDoImageView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(com.p314xaae8f345.mm.ui.uk.e(getContext(), com.p314xaae8f345.mm.R.raw.f79868x8752620f, -1));
        }
        android.widget.ImageView imageView2 = this.unDoImageView;
        if (imageView2 != null) {
            imageView2.setOnClickListener(new bu3.i(this));
        }
        this.colorList = (android.widget.GridView) findViewById(com.p314xaae8f345.mm.R.id.f565365c61);
        android.content.res.Resources resources = getContext().getResources();
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f554818a;
        arrayList2.add(java.lang.Integer.valueOf(com.p314xaae8f345.mm.R.C30861xcebc809e.c6w));
        ...
        arrayList3.add(java.lang.Integer.valueOf(com.p314xaae8f345.mm.R.C30861xcebc809e.c6z));
    ...
    public final void a(android.graphics.Bitmap bitmap, android.graphics.Bitmap bitmap2) {
        ...
        if (bitmap != null) {
            ...
            gVar.f106134a = bitmap;
            gVar.f106136c = 99;
            arrayList.add(gVar);
        }
        if (bitmap2 != null) {
            bu3.g gVar2 = new bu3.g();
            gVar2.f106134a = bitmap2;
            gVar2.f106136c = 100;
            arrayList.add(gVar2);
        }
        ...
        gVar4.f106135b = -16777216;
        gVar4.f106136c = 1;
        arrayList.add(gVar4);
        bu3.g gVar5 = new bu3.g();
        gVar5.f106135b = -707825;
        gVar5.f106136c = 2;
        arrayList.add(gVar5);
        bu3.g gVar6 = new bu3.g();
        gVar6.f106135b = -17592;
        gVar6.f106136c = 3;
        arrayList.add(gVar6);
        bu3.g gVar7 = new bu3.g();
        gVar7.f106135b = -16535286;
        gVar7.f106136c = 4;
        arrayList.add(gVar7);
        bu3.g gVar8 = new bu3.g();
        gVar8.f106135b = -15172610;
        gVar8.f106136c = 5;
        arrayList.add(gVar8);
        bu3.g gVar9 = new bu3.g();
        gVar9.f106135b = -7054596;
        gVar9.f106136c = 6;
        arrayList.add(gVar9);
    }
    ...
    public final int m67913x22f21e20() {
        return com.p314xaae8f345.mm.R.C30864xbddafb2a.c9m;
    }
    ...
    /* renamed from: getResourceArray */
    public final java.util.ArrayList<bu3.g> m67916xf61bd335() {
    ...
    /* renamed from: setColorList */
    public final void m67919xd1d01c5f(android.widget.GridView gridView) {
        this.colorList = gridView;
    }

    /* renamed from: setMStatus */
    public final void m67920xcb787ffd(ju3.d0 d0Var) {
        this.mStatus = d0Var;
    }

    /* renamed from: setSelectType */
    public final void m67921xb9b16058(int i17) {
        this.selectType = i17;
    }

    /* renamed from: setStatus */
    public final void m67922x231a26f4(ju3.d0 status) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(status, "status");
        this.mStatus = status;
    }

    /* renamed from: setUnDoImageView */
    public final void m67923x5c2004ba(android.widget.ImageView imageView) {
        this.unDoImageView = imageView;
    }
        ...
        if (i17 == 0) {
            ...
            for (java.lang.Object obj : this.resourceArray) {
                ...
                if ((gridView != null ? gridView.getChildAt(i18) : null) != null) {
                    ...
                    if (((bu3.a) childAt2).m11315xfb85f7b0() != this.selectType) {
