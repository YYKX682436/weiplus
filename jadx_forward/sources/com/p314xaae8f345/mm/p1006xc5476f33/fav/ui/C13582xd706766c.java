...
/* renamed from: com.tencent.mm.plugin.fav.ui.MaxHeightFrameLayout */
/* loaded from: classes2.dex */
public final class C13582xd706766c extends android.widget.FrameLayout {

    /* renamed from: d, reason: collision with root package name */
    public int f181979d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13582xd706766c(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onMeasure(int i17, int i18) {
        if (this.f181979d > 0) {
            ...
            if (mode == Integer.MIN_VALUE) {
                int i19 = this.f181979d;
                if (size > i19) {
                    size = i19;
                }
                i18 = android.view.View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE);
            } else if (mode == 0) {
                i18 = android.view.View.MeasureSpec.makeMeasureSpec(this.f181979d, Integer.MIN_VALUE);
            } else if (mode == 1073741824) {
                int i27 = this.f181979d;
                if (size > i27) {
                    size = i27;
                }
    ...
    public final void m55321x25bfb969(int i17) {
        this.f181979d = i17;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13582xd706766c(android.content.Context context, android.util.AttributeSet attrs, int i17) {
