...
/* renamed from: com.tencent.mm.plugin.fav.ui.widget.NestedScrollingListView */
/* loaded from: classes14.dex */
public final class C13626x71a88521 extends android.widget.ListView implements n3.d0 {

    /* renamed from: d, reason: collision with root package name */
    public final n3.f0 f183119d;

    public C13626x71a88521(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f183119d = new n3.f0(this);
        setNestedScrollingEnabled(true);
    }

    @Override // android.view.View
    public boolean dispatchNestedFling(float f17, float f18, boolean z17) {
        return this.f183119d.a(f17, f18, z17);
    }

    @Override // android.view.View
    public boolean dispatchNestedPreFling(float f17, float f18) {
        return this.f183119d.b(f17, f18);
    }

    @Override // android.view.View
    public boolean isNestedScrollingEnabled() {
        return this.f183119d.f415867d;
    }
    ...
    public C13626x71a88521(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
