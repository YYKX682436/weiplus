...
public class b0 implements android.app.PendingIntent.OnFinished {
    ...
    public final /* synthetic */ long f175254a;
    ...
    public void onSendFinished(android.app.PendingIntent pendingIntent, android.content.Intent intent, int i17, java.lang.String str, android.os.Bundle bundle) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WXBizLogic", "safeStartWXBizEntry use PendingIntent.getActivity for enterId:%d onSendFinished resultCode: %d, resultData: %s", java.lang.Long.valueOf(this.f175254a), java.lang.Integer.valueOf(i17), str);
    }
}
