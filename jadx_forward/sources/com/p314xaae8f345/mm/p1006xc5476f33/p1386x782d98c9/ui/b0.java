...
public final class b0 extends android.widget.BaseAdapter {
    ...
    public final java.util.ArrayList f180938d;

    public b0(java.util.ArrayList arrayList) {
        this.f180938d = arrayList;
    }

    @Override // android.widget.Adapter
    public int getCount() {
        java.util.ArrayList arrayList = this.f180938d;
        if (arrayList != null) {
    ...
    public android.view.View getView(int i17, android.view.View view, android.view.ViewGroup viewGroup) {
        com.p314xaae8f345.mm.p1006xc5476f33.p1386x782d98c9.ui.a0 a0Var;
        android.view.View view2 = null;
        java.util.ArrayList arrayList = this.f180938d;
        if (arrayList != null && arrayList.size() > 0) {
            java.lang.String str = (arrayList == null || arrayList.size() <= 0) ? null : (java.lang.String) arrayList.get(i17);
            if (view == null) {
                a0Var = new com.p314xaae8f345.mm.p1006xc5476f33.p1386x782d98c9.ui.a0(null);
                view2 = android.view.View.inflate(viewGroup.getContext(), com.p314xaae8f345.mm.R.C30864xbddafb2a.a9h, null);
                a0Var.f180927b = (android.widget.TextView) view2.findViewById(com.p314xaae8f345.mm.R.id.cgo);
                a0Var.f180926a = (android.widget.TextView) view2.findViewById(com.p314xaae8f345.mm.R.id.ni9);
                a0Var.f180928c = view2.findViewById(com.p314xaae8f345.mm.R.id.of8);
                a0Var.f180929d = view2.findViewById(com.p314xaae8f345.mm.R.id.atf);
                view2.setTag(a0Var);
            } else {
                a0Var = (com.p314xaae8f345.mm.p1006xc5476f33.p1386x782d98c9.ui.a0) view.getTag();
                view2 = view;
            }
            a0Var.f180926a.setText(java.lang.Integer.toString(i17 + 1));
            a0Var.f180927b.setText(str);
            if (i17 == 0 && arrayList.size() == 1) {
                android.view.View view3 = a0Var.f180928c;
                ...
                android.view.View view4 = a0Var.f180929d;
                ...
                android.view.View view5 = a0Var.f180928c;
                ...
                android.view.View view6 = a0Var.f180929d;
                ...
                android.view.View view7 = a0Var.f180929d;
                ...
                android.view.View view8 = a0Var.f180928c;
