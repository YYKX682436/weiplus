...
/* renamed from: com.tencent.mm.plugin.emoji.editor.widgets.EmojiEditorPreviewLayout */
/* loaded from: classes10.dex */
public final class C13258x5720669f extends android.view.ViewGroup {

    /* renamed from: d, reason: collision with root package name */
    public float f179012d;

    /* renamed from: e, reason: collision with root package name */
    public float f179013e;

    /* renamed from: f, reason: collision with root package name */
    public android.graphics.Rect f179014f;
    ...
    public C13258x5720669f(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
    }

    public final void a(int i17, int i18) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EmojiEditorPreviewLayout", "setMediaSize: width=" + i17 + ", height=" + i18 + ", old baseWidth=" + this.f179021p + ", baseHeight=" + this.f179022q);
        this.f179012d = (float) i17;
        this.f179013e = (float) i18;
        this.f179021p = 0;
        this.f179022q = 0;
        requestLayout();
    }
    ...
    /* renamed from: getInvisibleBounds */
    public final android.graphics.Rect m54744xe4c43e8c() {
        if (getChildCount() <= 0) {
    ...
    public void onLayout(boolean z17, int i17, int i18, int i19, int i27) {
        ...
        for (android.view.View view : arrayList) {
            ...
            android.graphics.Rect rect = this.f179014f;
            android.graphics.Rect rect2 = this.visibleBounds;
            if (rect != null) {
                p3321xbce91901.jvm.p3324x21ffc6bd.o.d(rect);
                rect2.set(rect);
                float width = this.f179021p == 0 ? 1.0f : rect.width() / this.f179021p;
                float height = this.f179022q != 0 ? rect.height() / this.f179022q : 1.0f;
                view.setScaleX(width);
                view.setScaleY(height);
                int centerX = rect.centerX();
                int centerY = rect.centerY();
                int i28 = this.f179021p;
                int i29 = this.f179022q;
                ...
                boolean z18 = !p3321xbce91901.jvm.p3324x21ffc6bd.o.b(this.fitBoundsRect, rect);
                ...
                } else if (this.f179012d > 0.0f && rect4 != null) {
                    float measuredWidth = view.getMeasuredWidth() / this.f179012d;
    ...
    public void onMeasure(int i17, int i18) {
        ...
        float f17 = this.f179012d;
        if (f17 > 0.0f) {
            float f18 = this.f179013e;
            if (f18 <= 0.0f || measuredWidth <= 0) {
                return;
            }
            if (this.f179021p == 0 || this.f179022q == 0) {
                if (f17 < f18) {
                    this.f179022q = measuredWidth;
                    this.f179021p = (int) (f17 / (f18 / measuredWidth));
                } else {
                    this.f179021p = measuredWidth;
                    this.f179022q = (int) (f18 / (f17 / measuredWidth));
                }
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EmojiEditorPreviewLayout", "onMeasure calculate baseSize: baseWidth=" + this.f179021p + ", baseHeight=" + this.f179022q + ", mediaWidth=" + this.f179012d + ", mediaHeight=" + this.f179013e + ", maxSize=" + measuredWidth);
            }
            ...
            if (rect != null) {
                ...
                i19 = (int) (this.f179012d * width);
                i27 = (int) (this.f179013e * width);
            } else {
                i19 = this.f179021p;
                i27 = this.f179022q;
            }
    ...
    /* renamed from: setFitBounds */
    public final void m54748x79a68fe4(android.graphics.Rect rect) {
        this.f179014f = rect;
        requestLayout();
    }

    /* renamed from: setOnFitBoundsUpdated */
    public final void m54749x322b9bb6(yz5.a aVar) {
        this.onFitBoundsUpdated = aVar;
    }

    /* renamed from: setVideoClipBounds */
    public final void m54750xa0e1083e(android.graphics.Rect rect) {
        this.videoClipBounds = rect;
        requestLayout();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13258x5720669f(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
