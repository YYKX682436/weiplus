...
public class c implements android.view.View.OnTouchListener {
    ...
    public com.p314xaae8f345.mm.p1006xc5476f33.p2018x185239e.ui.b f239186d;
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if (this.f239186d == null) {
            this.f239186d = new com.p314xaae8f345.mm.p1006xc5476f33.p2018x185239e.ui.b(view);
        }
        ...
        if (action == 0 || action == 1) {
            ...
            if (clickableSpanArr.length != 0) {
                if (action == 0) {
                    view.postDelayed(this.f239186d, android.view.ViewConfiguration.getLongPressTimeout());
                } else {
                    view.removeCallbacks(this.f239186d);
