...
public class j implements o25.a2 {
    ...
    public final boolean b(android.content.Context context, java.lang.String str, boolean z17, o25.o2 o2Var, android.os.Bundle bundle) {
        if (context == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMURIJumpHandler", "jumpToUIInternal, context is null!");
            return false;
        }
        if (str == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMURIJumpHandler", "jumpToUIInternal url is null");
            return false;
        }
        if (str.startsWith("weixin://openSpecificView/")) {
            return d(context, str, new java.lang.Object[0]);
        }
        com.p314xaae8f345.mm.app.p622xc5476f33.s f17 = com.p314xaae8f345.mm.app.p622xc5476f33.s.f();
        java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList = f17.f135215h;
        copyOnWriteArrayList.size();
        java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList2 = f17.f135216i;
        copyOnWriteArrayList2.size();
        java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList3 = f17.f135217m;
        copyOnWriteArrayList3.size();
        f17.f135214g = context;
        com.p314xaae8f345.mm.app.p622xc5476f33.C5082xed6d00e c5082xed6d00e = f17.f135213f;
            ...
            if (!it.hasNext()) {
                ...
                while (true) {
                    if (!it6.hasNext()) {
                        ...
                        while (it7.hasNext()) {
                            if (((com.p314xaae8f345.mm.app.p622xc5476f33.C5082xed6d00e.BaseUriSpanHandler) it7.next()).f(str, z17, o2Var, bundle)) {
                                f17.f135214g = null;
                                c5082xed6d00e.f135123a = null;
                            }
                        }
                    ...
                    if (((com.p314xaae8f345.mm.app.p622xc5476f33.C5082xed6d00e.BaseUriSpanHandler) it6.next()).f(str, z17, o2Var, bundle)) {
                        f17.f135214g = null;
                        c5082xed6d00e.f135123a = null;
                        break;
                    }
                }
            } else if (((com.p314xaae8f345.mm.app.p622xc5476f33.C5082xed6d00e.BaseUriSpanHandler) it.next()).f(str, z17, o2Var, bundle)) {
                f17.f135214g = null;
                c5082xed6d00e.f135123a = null;
                break;
            }
    ...
    public boolean c(android.content.Context context, java.lang.String str, boolean z17, o25.o2 o2Var) {
        if (context == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMURIJumpHandler", "jumpToURLWithCallback, context is null!");
            return false;
        }
        if (!str.startsWith("http")) {
            if (!b(context, str, z17, o2Var, null)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.MMURIJumpHandler", "jumpToUI failed, uri:%s", str);
            }
            return false;
        }
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMURIJumpHandler", "openLinkInBrowser fail:%s", e17.getMessage());
            return true;
        }
    }
    ...
    public boolean d(android.content.Context context, java.lang.String str, java.lang.Object... objArr) {
        ...
        if (context == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMURIJumpHandler", "openSpecificUI, context is null");
            return false;
        }
        android.content.Intent intent = new android.content.Intent();
        intent.addFlags(268435456);
        ...
        if (replace.equalsIgnoreCase("contacts")) {
            ...
            android.content.Intent intent2 = intent.setClass(context, com.p314xaae8f345.mm.ui.ActivityC21387x976b8e54.class);
            java.util.ArrayList arrayList = new java.util.ArrayList();
            ...
            if (!replace.equalsIgnoreCase("newfriend")) {
                if (replace.equalsIgnoreCase("addfriend") || replace.equalsIgnoreCase("contact/addFriend")) {
                    ...
                    android.content.Intent intent4 = intent.setClass(context, com.p314xaae8f345.mm.ui.ActivityC21387x976b8e54.class);
                    ...
                    com.p314xaae8f345.mm.ui.AbstractActivityC21409xdfe27f5a.X6(context, intent.setClass(context, com.p314xaae8f345.mm.p1006xc5476f33.p1008xb9d38a2d.p1009x2e243d.ui.ActivityC11360x90d2d970.class));
                } else if (replace.equalsIgnoreCase(com.p314xaae8f345.p2981xfaaf2ff7.p2985xbf8bc95e.p2986x330697.C25964xb9d36a6b.f49240x524f1eb5)) {
                    ...
                    com.p314xaae8f345.mm.ui.p2690x38b72420.ActivityC22339x138c4ba8.y7(context);
                    ...
                    intent.putExtra("rawUrl", java.lang.String.format(com.p314xaae8f345.mm.ui.n2.f290931a, 34));
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMURIJumpHandler", "enter to cardhome");
                    ...
                    c5631x90d66b9.f135958g.f87687a = context;
                    c5631x90d66b9.e();
                    ...
                    if (bundle != null) {
                        try {
                            P = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P(bundle.getString("extinfo"), 0);
                        } catch (java.lang.Exception unused) {
                        }
                        java.lang.Object[] objArr2 = new java.lang.Object[2];
                        objArr2[0] = java.lang.Boolean.valueOf((gm0.j1.a() || gm0.m.r()) ? false : true);
                        objArr2[1] = java.lang.Integer.valueOf(P);
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMURIJumpHandler", "upload log from jsapi, before upload, is-login:%b, time:%d", objArr2);
                        android.content.Intent intent5 = new android.content.Intent(context, (java.lang.Class<?>) com.p314xaae8f345.mm.ui.ActivityC21385x68412954.class);
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMURIJumpHandler", "upload log from jsapi, before upload, is-login:%b, time:%d", objArr22);
                    android.content.Intent intent52 = new android.content.Intent(context, (java.lang.Class<?>) com.p314xaae8f345.mm.ui.ActivityC21385x68412954.class);
                    ...
                    intent.setClass(context, com.p314xaae8f345.mm.ui.ActivityC21339x2c5c4123.class);
                    intent.putExtra("sns_userName", str2);
                    intent.putExtra(dm.i4.f66875xa013b0d5, str2);
                    ...
                    if (!replace.equalsIgnoreCase("BrandServiceIndexUI")) {
                        if (replace.equalsIgnoreCase("miniProgram")) {
                            z17 = true;
                            ((com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.app.t2) ((com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1187x7643c6b5.k6) i95.n0.c(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1187x7643c6b5.k6.class))).wi(context, 1, false);
                            ...
                            if (com.p314xaae8f345.mm.p1006xc5476f33.p2233x6892774.p2234x633fb29.c0.e()) {
                                ...
                                if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(r18)) {
                                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MMURIJumpHandler", "Get username from UserInfo return null or nil.");
                                    return false;
                                }
                                intent.putExtra(dm.i4.f66875xa013b0d5, r18);
                            ...
                            ((yn1.h4) ((mv.w) i95.n0.c(mv.w.class))).cj(context, mv.a.f413005h);
                        } else if (replace.equalsIgnoreCase("contactblacklist")) {
                            intent.putExtra("filter_type", c01.t7.a(context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.fsb)).a());
                            ...
                            if (((com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Bi().n("gh_43f2581f6fd6", true).r2()) {
                            ...
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMURIJumpHandler", "safe center url %s", d17);
                        ...
                        } else if (replace.equalsIgnoreCase(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37655xccbf8c68)) {
                            ...
                            com.p314xaae8f345.mm.p632xd97a1f41.p633xb307e119.C5651x28bf928 c5651x28bf928 = new com.p314xaae8f345.mm.p632xd97a1f41.p633xb307e119.C5651x28bf928();
                            am.sh shVar = c5651x28bf928.f135976g;
                            shVar.f89432b = replace;
                            shVar.f89431a = context;
                            c5651x28bf928.e();
                            am.th thVar = c5651x28bf928.f135977h;
                            android.content.Intent intent6 = thVar.f89543a;
                            if (intent6 != null) {
                                ...
                                yj0.a.f(context, "com/tencent/mm/app/plugin/MMURIJumpHandler", "openSpecificUI", "(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/Object;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
                            } else if (thVar.f89544b) {
                                db5.t7.m123882x26a183b(context, com.p314xaae8f345.mm.R.C30867xcad56011.f574206hf4, 0).show();
                            }
                            if (intent6 == null && !thVar.f89545c) {
                                return false;
                            }
                        }
                        return z17;
            ...
            if (bm5.o1.f104252a.h(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2535xb5e903a3.C20239x152d18ed()) == 1) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMURIJumpHandler", "openSpecificUI newfriend, [AddFriendVerifyRecordToCloud] goto AddFriendVerifyRecordUI (new)");
                j45.l.j(context, "subapp", ".ui.friend.AddFriendVerifyRecordUI", intent7, null);
            } else {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMURIJumpHandler", "openSpecificUI newfriend, [AddFriendVerifyRecordToCloud] goto FMessageConversationUI (old)");
