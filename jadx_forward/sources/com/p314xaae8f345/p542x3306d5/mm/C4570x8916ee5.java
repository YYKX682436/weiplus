...
public class C4570x8916ee5 implements com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.CallBack {
    ...
    private int m40282xfd828c6e(java.lang.String str) {
    ...
    private void m40283x2d1bc438() {
        int m40282xfd828c6e = m40282xfd828c6e(com.p314xaae8f345.mm.sdk.p2603x2137b148.w9.f274586a);
        java.lang.String str = TAG;
        java.lang.Integer valueOf = java.lang.Integer.valueOf(m40282xfd828c6e);
        ...
        m40284x1e599531(m40282xfd828c6e);
    }

    /* renamed from: killProcess */
    private void m40284x1e599531(int i17) {
        try {
            ...
            yj0.a.d(obj, arrayList.toArray(), "com/tencent/mars/mm/MMStnManagerCallback", "killProcess", "(I)V", "android/os/Process_EXEC_", "killProcess", "(I)V");
            android.os.Process.killProcess(((java.lang.Integer) arrayList.get(0)).intValue());
            yj0.a.f(obj, "com/tencent/mars/mm/MMStnManagerCallback", "killProcess", "(I)V", "android/os/Process_EXEC_", "killProcess", "(I)V");
        } catch (java.lang.Exception e17) {
    ...
    public int mo659x8a9f58be(java.lang.String str, long j17, final byte[] bArr, byte[] bArr2, final byte[] bArr3, final long j18) {
        ...
        if (this.f19475xa9640dde.k(str) && j17 != 5) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(TAG, "[OnActionNotify] uuid = " + str + ", is Repeated");
            return f19472x92a76f9b;
        }
        this.f19475xa9640dde.put(str, str);
        if (j17 == 2) {
            if (bArr != null) {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.5
        ...
        if (j17 == 4) {
            if (bArr != null) {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.6
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        if (j17 == 7) {
            if (bArr != null) {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.7
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        if (j17 == 5) {
            if (bArr == null) {
                return f19470xfc19f67c;
            }
            com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.8
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(com.p314xaae8f345.p542x3306d5.mm.C4570x8916ee5.TAG, e18, null, new java.lang.Object[0]);
                    }
                }
            });
            return f19469x49f4583d;
        }
        if (j17 == 8) {
            if (bArr != null) {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback$$a
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.p314xaae8f345.p542x3306d5.mm.C4570x8916ee5.m40285xd8913107(bArr);
                    }
                });
            }
            return f19472x92a76f9b;
        ...
        if (j17 == 9) {
            if (bArr != null) {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback$$b
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.p314xaae8f345.p542x3306d5.mm.C4570x8916ee5.m40286xd8913108(bArr);
                    }
                });
            }
            return f19472x92a76f9b;
        ...
        if (j17 == 11) {
            if (bArr != null) {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback$$c
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.p314xaae8f345.p542x3306d5.mm.C4570x8916ee5.m40287xd8913109(bArr);
                    }
                });
            }
            return f19472x92a76f9b;
        }
        return f19473x38df5736;
    }
    ...
    public void mo661x7433764c(android.os.IInterface iInterface) {
        if (iInterface == null) {
            ...
            this.f134067l.lock();
            this.f19478xf710dfb1.add((com.p314xaae8f345.mm.p971x6de15a2e.b0) iInterface);
            this.f134067l.unlock();
        }
    }
    ...
    public int mo662xa261f88f(int i17, java.lang.Object obj, java.lang.String str, byte[] bArr, int[] iArr, int[] iArr2, int i18, int[] iArr3) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(TAG, m40281x6cf4e7b4(e17));
            return -1;
        }
    }
    ...
    public int mo664x17921322(java.lang.String str, int i17, int i18, int i19, int i27, byte[] bArr, byte[] bArr2, android.os.IInterface iInterface) {
        if (iInterface instanceof com.p314xaae8f345.mm.p971x6de15a2e.c1) {
            return com.p314xaae8f345.p542x3306d5.mm.C4568xc7b44267.m40184x9cf0d20b().m40185x17921322(str, i17, i18, i19, i27, bArr, bArr2, (com.p314xaae8f345.mm.p971x6de15a2e.c1) iInterface);
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(TAG, "Callback type mismatch!");
        return 0;
    }
    ...
    public void mo665xed157802() {
        com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.10
            @Override // java.lang.Runnable
            public void run() {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.f().a(6238, null);
            }
        });
    }
    ...
    public int mo667x8faab340(java.lang.String str, java.util.List<java.lang.String> list) {
        ...
        ((com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80) com.p314xaae8f345.p542x3306d5.C4435xa52e04fa.m37502x6f964b77(com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.class)).m40240x7f49a52e(str, c4566xebd53123);
    ...
    public int mo670x47ecc391(long j17, java.lang.String str) {
        if (j17 == 11108) {
            try {
                if (f19474xd1092156.contains(java.lang.Integer.valueOf(java.lang.Integer.parseInt(str)))) {
                    return 1;
                }
            } catch (java.lang.Exception unused) {
            }
    ...
    public int mo671x65185ded(java.util.List<java.lang.String> list, boolean z17) {
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        com.p314xaae8f345.p542x3306d5.mm.C4566xebd53123 c4566xebd53123 = new com.p314xaae8f345.p542x3306d5.mm.C4566xebd53123();
        ((com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80) com.p314xaae8f345.p542x3306d5.C4435xa52e04fa.m37502x6f964b77(com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.class)).m40249x2f97f28a(z17, c4566xebd53123);
        for (int i17 = 0; i17 < c4566xebd53123.f19386xbe0e3ae6; i17++) {
            list.add(c4566xebd53123.f19385xac04aca4[i17]);
        }
        long currentTimeMillis2 = java.lang.System.currentTimeMillis();
    ...
    public int mo672x77eff5c6(java.util.List<java.lang.String> list, java.lang.String str, boolean z17) {
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        com.p314xaae8f345.p542x3306d5.mm.C4566xebd53123 c4566xebd53123 = new com.p314xaae8f345.p542x3306d5.mm.C4566xebd53123();
        ((com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80) com.p314xaae8f345.p542x3306d5.C4435xa52e04fa.m37502x6f964b77(com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.class)).m40252x820c86e3(str, z17, c4566xebd53123);
        for (int i17 = 0; i17 < c4566xebd53123.f19386xbe0e3ae6; i17++) {
            list.add(c4566xebd53123.f19385xac04aca4[i17]);
        }
        long currentTimeMillis2 = java.lang.System.currentTimeMillis();
    ...
    public void mo678xc058cd76(byte[] bArr, int i17, int i18, int i19, int i27, java.lang.String str, int i28, java.lang.String str2, int i29, int i37) {
        ...
        try {
            ...
            com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.4
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void mo679x5825913a(int i17, java.lang.String str) {
        ...
        m40289x615d1b04("⚠️支付cgi错打newdns业务标记", java.lang.String.format("支付cgi:[id: %d, url: %s] 错打了newdns业务标记，请确认去掉标记后再行测试，点击确定将退出微信", java.lang.Integer.valueOf(i17), str));
    }
    ...
    public void mo680x47b0a247(int i17, java.lang.String str) {
        ...
        m40289x615d1b04("⚠️支付cgi漏打newdns业务标记", java.lang.String.format("支付cgi:[id: %d, url: %s] 漏打了newdns业务标记，请确认补充标记后再行测试，点击确定将退出微信", java.lang.Integer.valueOf(i17), str));
    }

    @Override // com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.CallBack
    /* renamed from: notifyStnWeaknet */
    public void mo681x31a1e061(final boolean z17) {
        com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.9
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void mo683xce1830b3(com.p314xaae8f345.p542x3306d5.mm.C4567xf5d28c4a c4567xf5d28c4a, boolean z17) {
        com.p314xaae8f345.p542x3306d5.mm.C4568xc7b44267.m40184x9cf0d20b().m40186xce1830b3(c4567xf5d28c4a, z17);
    }

    @Override // com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.CallBack
    /* renamed from: onOOBNotify */
    public void mo684x851b014c(final java.lang.String str) {
        ...
        try {
            com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.3
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void mo685x7797f08b(boolean z17, int i17) {
        ...
        try {
            try {
                for (com.p314xaae8f345.mm.p971x6de15a2e.b0 b0Var : this.f19478xf710dfb1) {
                    if (b0Var != null) {
                        b0Var.Xe(z17, i17);
                    }
                }
    ...
    public void mo686x7b24ad89(android.os.IInterface iInterface) {
        if (iInterface == null) {
            ...
            this.f134067l.lock();
            this.f19478xf710dfb1.remove((com.p314xaae8f345.mm.p971x6de15a2e.b0) iInterface);
            this.f134067l.unlock();
        }
    }
    ...
    public void mo687x73181082(int i17, int i18, int i19, int i27) {
        int i28 = this.f19481xb1aaa5ff + i17;
        this.f19481xb1aaa5ff = i28;
        int i29 = this.f19482xb1ab1ba1 + i18;
        this.f19482xb1ab1ba1 = i29;
        int i37 = this.f19479x6d26b00c + i19;
        this.f19479x6d26b00c = i37;
        int i38 = this.f19480x6d2725ae + i27;
        this.f19480x6d2725ae = i38;
        int i39 = i37 + i38 + i28 + i29;
        final u31.c cVar = com.p314xaae8f345.mm.p971x6de15a2e.x2.g().f153717a;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("C2Java", "reportNetFlow time[%d,%d] sum:%d wr[%d,%d] ws[%d,%d] mr[%d,%d] ms[%d,%d] fgbg:%b Moniter:%s", java.lang.Long.valueOf(this.f19477x7f950d57), java.lang.Long.valueOf(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.H1(this.f19477x7f950d57)), java.lang.Integer.valueOf(i39), java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(this.f19481xb1aaa5ff), java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(this.f19482xb1ab1ba1), java.lang.Integer.valueOf(i19), java.lang.Integer.valueOf(this.f19479x6d26b00c), java.lang.Integer.valueOf(i27), java.lang.Integer.valueOf(this.f19480x6d2725ae), java.lang.Boolean.valueOf(z65.c.f551988a), cVar);
        if (cVar == null) {
            return;
        }
        if (i39 >= 102400 || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.H1(this.f19477x7f950d57) >= 30) {
            this.f19477x7f950d57 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.i1();
            final int i47 = this.f19481xb1aaa5ff;
            this.f19481xb1aaa5ff = 0;
            final int i48 = this.f19482xb1ab1ba1;
            this.f19482xb1ab1ba1 = 0;
            final int i49 = this.f19479x6d26b00c;
            this.f19479x6d26b00c = 0;
            final int i57 = this.f19480x6d2725ae;
            this.f19480x6d2725ae = 0;
            try {
                com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.2
                    @Override // java.lang.Runnable
                    public void run() {
                        try {
    ...
    public void mo691x731e15a8(final com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.ReportInfo reportInfo) {
        try {
            com.p314xaae8f345.mm.p971x6de15a2e.x2.e().mo50293x3498a0(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.1
                @Override // java.lang.Runnable
                public void run() {
                    int mo669x641430a9 = com.p314xaae8f345.p542x3306d5.mm.C4570x8916ee5.this.mo669x641430a9(reportInfo.f19432x9d48d1f1);
                    if (mo669x641430a9 == 0) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("C2Java", "ActionId Can not convert");
                    } else {
                        reportInfo.f19432x9d48d1f1 = mo669x641430a9;
                    }
                }
            });
        } catch (java.lang.Exception unused) {
    ...
    public void mo693x19d1d47(java.lang.String str) {
        ...
        if (str.contains("testReportFlush")) {
            ((com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80) com.p314xaae8f345.p542x3306d5.C4435xa52e04fa.m37502x6f964b77(com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.class)).m40277xc89b4a3e();
            return;
        }
        ...
        if (str.contains("oversea")) {
            ...
            ((com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80) com.p314xaae8f345.p542x3306d5.C4435xa52e04fa.m37502x6f964b77(com.p314xaae8f345.p542x3306d5.mm.C4569xb3cd6a80.class)).m40245xbb09de0b();
        }
    }
}
