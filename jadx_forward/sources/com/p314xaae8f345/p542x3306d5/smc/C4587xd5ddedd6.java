...
/* renamed from: com.tencent.mars.smc.SmcProtoBufUtil */
/* loaded from: classes15.dex */
public class C4587xd5ddedd6 {
    /* renamed from: fillStrategyTable */
    private static p45.o m40407xd00c5f58(java.util.LinkedList<r45.nf6> linkedList) {
    ...
    public static r45.ed3 m40408x2b1c8130() {
        r45.ed3 ed3Var = new r45.ed3();
        java.util.ArrayList<java.lang.Integer> m40377xce5bcaa4 = ((com.p314xaae8f345.p542x3306d5.smc.C4585x1608f244) com.p314xaae8f345.p542x3306d5.C4435xa52e04fa.m37502x6f964b77(com.p314xaae8f345.p542x3306d5.smc.C4585x1608f244.class)).m40377xce5bcaa4();
        if (m40377xce5bcaa4.size() != 6) {
            return null;
        }
        ed3Var.f454836d = m40377xce5bcaa4.get(0).intValue();
        ed3Var.f454837e = m40377xce5bcaa4.get(1).intValue();
        ed3Var.f454838f = m40377xce5bcaa4.get(2).intValue();
        ed3Var.f454840h = m40377xce5bcaa4.get(3).intValue();
        ed3Var.f454841i = m40377xce5bcaa4.get(4).intValue();
        ed3Var.f454842m = m40377xce5bcaa4.get(5).intValue();
        return ed3Var;
    }

    /* renamed from: toMMReportIdkeyReq */
    public static r45.u30 m40409x48781a29(p45.g gVar) {
    ...
    public static r45.u30 m40410x80c7e04(p45.i iVar) {
        r45.u30 u30Var = new r45.u30();
    ...
    public static r45.zx3 m40411xf90de413(p45.k kVar) {
    ...
    public static p45.c m40412x33356c39(r45.fd3 fd3Var) {
        ...
        cVar.f433419g = m40407xd00c5f58(fd3Var.f455759h);
        cVar.f433420h = m40407xd00c5f58(fd3Var.f455760i);
        return cVar;
    }

    /* renamed from: toSmcKVStrategyResp */
    public static p45.f m40413x3ec8f73c(r45.fd3 fd3Var) {
        ...
        fVar.f433442h = m40407xd00c5f58(fd3Var.f455768t);
        fVar.f433443i = m40407xd00c5f58(fd3Var.f455769u);
        fVar.f433444m = m40407xd00c5f58(fd3Var.f455770v);
        return fVar;
    }

    /* renamed from: toSmcReportIdkeyResp */
    public static p45.h m40414xaf5c7bd2(r45.v30 v30Var) {
        ...
        hVar.f433454g = m40407xd00c5f58(v30Var.f469373h);
        hVar.f433455h = m40407xd00c5f58(v30Var.f469374i);
        return hVar;
    }

    /* renamed from: toSmcReportKvResp */
    public static p45.j m40415x59eaa1d(r45.v30 v30Var) {
        ...
        jVar.f433468h = m40407xd00c5f58(v30Var.f469373h);
        jVar.f433469i = m40407xd00c5f58(v30Var.f469374i);
        jVar.f433470m = m40407xd00c5f58(v30Var.f469375m);
        return jVar;
    }
}
