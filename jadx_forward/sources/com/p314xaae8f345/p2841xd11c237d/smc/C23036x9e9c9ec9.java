...
/* renamed from: com.tencent.paymars.smc.SmcManagerCallbackWithPush */
/* loaded from: classes12.dex */
public class C23036x9e9c9ec9 implements com.p314xaae8f345.p2841xd11c237d.smc.C23035x1608f244.CallBack {
    private static final java.lang.String TAG = "MicroMsg.SmcManagerCallbackWithPush";

    /* renamed from: context */
    private android.content.Context f40249x38b735af;

    /* renamed from: kvReportNotify */
    private com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.InterfaceC17195x10840331 f40250x7d0cbaa8 = null;

    public C23036x9e9c9ec9(android.content.Context context) {
        this.f40249x38b735af = context;
    }

    /* renamed from: getAppFilePath */
    private java.lang.String m84540xda9123cc() {
        if (this.f40249x38b735af == null) {
            return null;
        }
        try {
            com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(this.f40249x38b735af.getFilesDir().getPath() + "/pay");
            if (!r6Var.m()) {
                r6Var.J();
            }
    ...
    public java.lang.String mo68455xb7d8cfb2() {
        java.lang.String str = m84540xda9123cc() + "/kvcomm-push/";
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(TAG, "[TEST-PATH (Smc)]path:" + m84540xda9123cc());
        return str;
    }
    ...
    public void mo68458xdaa0e966(byte[] bArr, byte[] bArr2, int i17, java.lang.String str) {
        try {
            com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.InterfaceC17195x10840331 interfaceC17195x10840331 = this.f40250x7d0cbaa8;
    ...
    public boolean mo68460x4bfb482f(byte[] bArr) {
        ...
        try {
            ...
            if (com.p314xaae8f345.p2841xd11c237d.smc.C23037xd5ddedd6.m84546xf90de413(kVar).f473986d <= 0) {
    ...
    public void m84541x339aefaa(com.p314xaae8f345.mm.p1006xc5476f33.p2029xc84c5534.p2031x7643c6b5.InterfaceC17195x10840331 interfaceC17195x10840331) {
        this.f40250x7d0cbaa8 = interfaceC17195x10840331;
    }
}
