...
public class j extends ce1.c {
    ...
    public static final int f4372x366c91de = 899;

    /* renamed from: NAME */
    public static final java.lang.String f4373x24728b = "setDefaultTrafficCard";
    ...
    public void C(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.d0 d0Var, int i17, android.os.IInterface iInterface, org.json.JSONObject jSONObject) {
        if (jSONObject == null) {
            ...
            D(6, dVar.f122304a, "deviceData is null");
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiSetDefaultTrafficCard", "deviceData is null, invoke fail: [%s] ! with appId[%s] callbackId[%s]", dVar.f122305b, d0Var.mo48798x74292566(), java.lang.Integer.valueOf(i17));
            return;
        }
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.JsApiSetDefaultTrafficCard", "setDefaultCardString: [%s]! params: [%s]", w17, new org.json.JSONObject(hashMap2).toString());
            if (!android.text.TextUtils.isEmpty(w17)) {
                jSONObject2 = new org.json.JSONObject(w17);
            }
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiSetDefaultTrafficCard", "call remote interface fail: [%s] ! ", e17.getMessage());
        }
        ...
        if (jSONObject2 == null) {
            ...
            D(6, dVar2.f122304a, "call remote interface exception");
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiSetDefaultTrafficCard", "call remote interface exception.");
            return;
        }
        ...
        D(6, a17.f122304a, str);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiSetDefaultTrafficCard", "Return code from remote interface! with RetCode rechargeCard[%s] ", java.lang.Integer.valueOf(optInt));
    }
}
