...
public class g extends ce1.c {
    ...
    public static final int f4366x366c91de = 897;

    /* renamed from: NAME */
    public static final java.lang.String f4367x24728b = "issueTrafficCard";
    ...
    public void C(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.d0 d0Var, int i17, android.os.IInterface iInterface, org.json.JSONObject jSONObject) {
        ...
        if (jSONObject == null) {
            ...
            D(3, dVar.f122304a, "deviceData is null");
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiIssueTrafficCard", "deviceData is null, invoke fail: [%s] ! with appId[%s] callbackId[%s]", dVar.f122305b, d0Var.mo48798x74292566(), java.lang.Integer.valueOf(i17));
            return;
        }
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiIssueTrafficCard", "call remote interface fail: [%s] ! ", e17.getMessage());
        }
        ...
        if (jSONObject2 == null) {
            ...
            D(3, dVar2.f122304a, "call remote interface exception");
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiIssueTrafficCard", "call remote interface exception.");
            return;
        }
        ...
        java.lang.String str2 = a17.f122305b;
        sb6.append(str2);
        d0Var.a(i17, p(sb6.toString(), hashMap3));
        D(3, a17.f122304a, str2);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.JsApiIssueTrafficCard", "Return code from remote interface! with RetCode issueCard[%s] ", java.lang.Integer.valueOf(optInt));
    }
}
