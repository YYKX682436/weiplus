...
public final class d1 extends gm2.e {
    ...
    public int j(int i17) {
        if (this.f354888a == gm2.c2.f354883i && !com.p314xaae8f345.mm.ui.bk.C()) {
            if (1 <= i17 && i17 < 7) {
                return com.p314xaae8f345.mm.R.C30861xcebc809e.cou;
            }
            if (7 <= i17 && i17 < 13) {
                return com.p314xaae8f345.mm.R.C30861xcebc809e.cow;
            }
            if (!(13 <= i17 && i17 < 18)) {
            ...
            return com.p314xaae8f345.mm.R.C30861xcebc809e.cos;
        }
        return m(i17);
    }
    ...
    public int k(int i17) {
        if (1 <= i17 && i17 < 7) {
            return com.p314xaae8f345.mm.R.C30861xcebc809e.cpt;
        }
        if (7 <= i17 && i17 < 13) {
            return com.p314xaae8f345.mm.R.C30861xcebc809e.cpu;
        }
        if (!(13 <= i17 && i17 < 18)) {
            if (!(18 <= i17 && i17 <= Integer.MAX_VALUE)) {
                return 0;
        ...
        return com.p314xaae8f345.mm.R.C30861xcebc809e.cpq;
    }

    @Override // gm2.e
    public int[] l(int i17) {
        int[] l17 = super.l(i17);
        android.graphics.drawable.Drawable drawable = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getDrawable(k(i17));
    ...
    public final int m(int i17) {
        if (1 <= i17 && i17 < 7) {
            return com.p314xaae8f345.mm.R.C30861xcebc809e.cot;
        }
        if (7 <= i17 && i17 < 13) {
            return com.p314xaae8f345.mm.R.C30861xcebc809e.cov;
        }
        if (!(13 <= i17 && i17 < 18)) {
            if (!(18 <= i17 && i17 <= Integer.MAX_VALUE)) {
                return 0;
        ...
        return com.p314xaae8f345.mm.R.C30861xcebc809e.cor;
    }
}
