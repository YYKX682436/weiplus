...
public final class a implements android.opengl.GLSurfaceView.EGLConfigChooser {
    ...
    public final int[] f420881a = {12324, 4, 12323, 4, 12322, 4, 12352, 4, 12344};

    /* renamed from: b, reason: collision with root package name */
    public final int[] f420882b = new int[1];
    ...
    public javax.microedition.khronos.egl.EGLConfig chooseConfig(javax.microedition.khronos.egl.EGL10 egl, javax.microedition.khronos.egl.EGLDisplay display) {
        ...
        int[] iArr = new int[1];
        egl.eglChooseConfig(display, this.f420881a, null, 0, iArr);
        int i17 = iArr[0];
        if (i17 <= 0) {
        ...
        egl.eglChooseConfig(display, this.f420881a, eGLConfigArr, i17, iArr);
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.RenderConfigChooser", format);
        for (int i18 = 0; i18 < i17; i18++) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.RenderConfigChooser", format2);
        ...
        for (int i29 = 0; i29 < i17; i29++) {
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.d(eGLConfig2);
