...
public class x0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ java.lang.String f426848d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Intent f426849e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ oh1.z0 f426850f;

    public x0(oh1.z0 z0Var, java.lang.String str, android.content.Intent intent) {
        this.f426850f = z0Var;
        this.f426848d = str;
        this.f426849e = intent;
    }
    ...
    public void run() {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PCWxaLaunchAppNotifyHandler", "now isForeground:%b", java.lang.Boolean.valueOf(mo40975xf7b3660d));
        if (mo40975xf7b3660d) {
            return;
        }
        oh1.z0 z0Var = this.f426850f;
        z0Var.getClass();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PCWxaLaunchAppNotifyHandler", "showWxaLaunchContentNotification");
        android.content.Intent intent = new android.content.Intent(this.f426849e);
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.PCWxaLaunchAppNotifyHandler", "canVibrate:%b", java.lang.Boolean.valueOf(i17));
        ((com.p314xaae8f345.mm.p642xad8b531f.p643x237a88eb.z) ((oo3.i) i95.n0.c(oo3.i.class))).Ai(53, b17);
        ((com.p314xaae8f345.mm.p642xad8b531f.p643x237a88eb.z) ((oo3.i) i95.n0.c(oo3.i.class))).Bi();
        if (z0Var.f426859d) {
            return;
        }
        z0Var.f426859d = true;
        c4683x847dbe1b.mo40973x40b15f2e(new oh1.y0(z0Var));
    }
}
