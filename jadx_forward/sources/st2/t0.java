...
public final class t0 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ st2.h1 f493991d;
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Finder.LiveShoppingListPlugin", "blank area down");
            view.getParent().requestDisallowInterceptTouchEvent(true);
        } else if (motionEvent.getAction() == 1) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("Finder.LiveShoppingListPlugin", "blank area up");
