...
public final class n implements android.graphics.SurfaceTexture.OnFrameAvailableListener {
    ...
    public final /* synthetic */ rw2.t f482151d;
    ...
    public final void onFrameAvailable(android.graphics.SurfaceTexture surfaceTexture) {
        ...
        rw2.t tVar = this.f482151d;
        android.os.HandlerThread handlerThread = tVar.f482161e;
        if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(myLooper, handlerThread != null ? handlerThread.getLooper() : null)) {
