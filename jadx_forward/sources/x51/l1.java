...
public abstract class l1 {
    ...
    public static boolean b(byte[] bArr, java.lang.String str, java.lang.String str2, int i17) {
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.M0(bArr)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StackReportUploader", "read file failed:%s", str);
            return false;
        }
        if (bArr.length > 128000) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StackReportUploader", "file :%s data len error:%d", str, java.lang.Integer.valueOf(bArr.length));
            return false;
        }
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.M0(a17)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StackReportUploader", "zip data failed file:%s", str);
            return false;
        }
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.M0(bArr2)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StackReportUploader", "encrypt data failed file:%s", str);
        }
        java.lang.String str3 = "https://" + com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSharedPreferences("system_config_prefs", 0).getString("support.weixin.qq.com", "support.weixin.qq.com");
        ...
        try {
            ...
            if (execute == null || execute.getStatusLine() == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StackReportUploader", "execute http failed resp null");
                return false;
            }
            if (execute.getStatusLine().getStatusCode() == 200) {
                return true;
            }
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.StackReportUploader", "error response code:%d ", java.lang.Integer.valueOf(execute.getStatusLine().getStatusCode()));
            return false;
