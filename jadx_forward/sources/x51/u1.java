    ...
    */
    public static int a(android.content.Context r7, java.lang.String r8) {
        ...
        L37:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r1, r7, r0, r8)     // Catch: java.io.IOException -> L77 java.lang.Throwable -> L9e
            r7 = r2
        L3e:
            r8 = 1
            if (r7 == r8) goto La7
        ...
        L79:
            ...
            return r2
        L83:
            int r7 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.P(r7, r2)     // Catch: java.io.IOException -> L77 java.lang.Throwable -> L9e
            r3.close()
            return r7
        L8b:
        ...
        L90:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r1, r8, r0, r4)     // Catch: java.io.IOException -> L77 java.lang.Throwable -> L9e
            goto L3e
        L97:
            r8 = move-exception
            java.lang.Object[] r4 = new java.lang.Object[r2]     // Catch: java.io.IOException -> L77 java.lang.Throwable -> L9e
        ...
        La0:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r1, r7, r0, r8)     // Catch: java.lang.Throwable -> L9e
            if (r3 == 0) goto Laa
        La7:
            r3.close()
        Laa:
    ...
    public static android.content.res.XmlResourceParser b(android.content.Context context, android.content.res.AssetManager assetManager) {
        try {
            ...
            if (str == null && context.getPackageName().equals(com.p159x477cd522.p160x333422.C1461x7397cc93.f4735xf773c24f)) {
            ...
            for (int i17 = 1; i17 < 20; i17++) {
                if (str != null && str.equals(method.invoke(assetManager, java.lang.Integer.valueOf(i17)))) {
                    return assetManager.openXmlResourceParser(i17, com.p314xaae8f345.p3076xcbed6b1f.p3080xbe953013.p3084xa1c33861.C26631x178a9850.f55716x82f230e);
                }
            }
        } catch (java.lang.Exception unused) {
        }
        return assetManager.openXmlResourceParser(com.p314xaae8f345.p3076xcbed6b1f.p3080xbe953013.p3084xa1c33861.C26631x178a9850.f55716x82f230e);
    }
}
