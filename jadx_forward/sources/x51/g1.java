...
public class g1 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ java.lang.String f533543d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f533544e;

    public g1(java.lang.String str, android.content.Context context) {
        this.f533543d = str;
        this.f533544e = context;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("rawUrl", this.f533543d);
        ...
        ((bt.d) ((ct.u2) i95.n0.c(ct.u2.class))).f105601d.D(intent, this.f533544e);
    }
}
