...
public abstract class l0 {
    ...
    public static final java.util.concurrent.ConcurrentHashMap f533562a = new java.util.concurrent.ConcurrentHashMap();

    public static final x51.k0 a(int i17, java.lang.String str, java.util.HashMap hashMap, boolean z17, boolean z18) {
        iz5.a.g(null, (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) || hashMap == null) ? false : true);
        int hashCode = str.hashCode();
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = f533562a;
        ...
        if (k0Var == null) {
            ...
            iz5.a.g(null, z17 == k0Var.f533555i);
            long b17 = k0Var.b();
