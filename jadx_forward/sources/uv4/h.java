...
public class h extends uv4.b {
    ...
    public long f512966i;

    /* renamed from: j, reason: collision with root package name */
    public final java.util.HashMap f512967j;

    public h(int i17, java.lang.String str, java.lang.String str2, java.lang.String str3, long j17) {
        super(i17, str, str2, str3, j17);
        this.f512965h = 1;
        this.f512967j = new java.util.HashMap();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WebSearch.WebSearchTemplate", "Init WebSearchTemplate templatePath:%s zipFileName:%s assetDir:%s", this.f512951b, this.f512952c, this.f512953d);
    }

    @Override // uv4.g
    public int b() {
        if (this.f512965h <= 1 || p().B() > this.f512966i) {
            k();
        }
        return this.f512965h;
    }
    ...
    public java.util.HashMap f() {
        int b17 = b();
        java.util.HashMap hashMap = this.f512967j;
                ...
                while (keys.hasNext()) {
                    ...
                    if (next != null && next.endsWith(".js")) {
                        ...
                        if (com.p314xaae8f345.mm.vfs.w6.j(str)) {
                            ...
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WebSearch.WebSearchTemplate", "getJsFileMap %s %s %s", java.lang.Integer.valueOf(b17), str, optString);
                        }
                    }
                }
                hashMap.put(java.lang.Integer.valueOf(b17), hashMap2);
            } catch (java.lang.Exception e18) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.WebSearch.WebSearchTemplate", e18, "", new java.lang.Object[0]);
            }
        }
        return hashMap2;
    }
    ...
    public java.lang.String h() {
        return new com.p314xaae8f345.mm.vfs.r6(l(), this.f512952c).o();
    }
    ...
    public void k() {
        ...
        try {
            this.f512965h = java.lang.Integer.parseInt(properties.getProperty("version", java.lang.String.valueOf(1)));
        } catch (java.lang.Exception unused) {
            this.f512965h = 1;
        }
        this.f512966i = java.lang.System.currentTimeMillis();
    }
