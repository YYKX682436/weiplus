...
public final class h2 {
    ...
    public static final bk4.h2 f103015a = new bk4.h2();

    public final void a(android.view.View view, int i17, java.util.Map oriMap) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(oriMap, "oriMap");
        if (view == null) {
            return;
        }
        ...
        if (view instanceof android.widget.TextView) {
            ...
            if (i17 != textView.getTextColors().getDefaultColor()) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(textColors, "getTextColors(...)");
