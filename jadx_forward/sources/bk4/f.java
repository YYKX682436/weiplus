...
public abstract class f {
    ...
    public final java.lang.CharSequence O(android.view.View view, java.lang.String str, java.lang.CharSequence charSequence, int i17, bi4.d iconType, bi4.c iconScene) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(u0VarArr);
    ...
    public final android.graphics.drawable.Drawable i(android.graphics.Bitmap bitmap, boolean z17, bi4.d iconType, bi4.b iconColor) {
        ...
        if (bk4.e.f102990a[iconType.ordinal()] == 1) {
            switch (iconColor.ordinal()) {
                case 1:
                    color = -1;
                    break;
                case 2:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f560058a6);
                    break;
                case 3:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f560035m);
                    break;
                case 4:
                default:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f560080ah);
                    break;
                case 5:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77636xad7ef29);
                    break;
                case 6:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77762x20e833);
                    break;
                case 7:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77758x20e832);
                    break;
                case 8:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77764x20e834);
                    break;
                case 9:
                    color = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77766x20e835);
                    break;
            }
            com.p314xaae8f345.mm.ui.uk.f(bitmapDrawable, color);
        } else {
            int ordinal = iconColor.ordinal();
            com.p314xaae8f345.mm.ui.uk.f(bitmapDrawable, ordinal != 6 ? ordinal != 10 ? com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f560086an) : com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.a0c) : com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f77762x20e833));
        }
        return bitmapDrawable;
    }
    ...
    public final android.text.style.ImageSpan q(android.widget.TextView textView, java.lang.String str, bi4.c cVar, int i17) {
        ...
        int i18 = cVar == null ? -1 : bk4.e.f102991b[cVar.ordinal()];
