...
public final class a implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ hk1.e f363400d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.animation.Animation f363401e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.animation.ValueAnimator f363402f;

    public a(hk1.e eVar, android.view.animation.Animation animation, android.animation.ValueAnimator valueAnimator) {
        this.f363400d = eVar;
        this.f363401e = animation;
        this.f363402f = valueAnimator;
    }

    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    public final void onAnimationUpdate(android.animation.ValueAnimator it) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(it, "it");
        hk1.e eVar = this.f363400d;
        android.view.ViewGroup viewGroup = eVar.f363409f;
        android.animation.ValueAnimator valueAnimator = this.f363402f;
        if (viewGroup == null) {
            valueAnimator.cancel();
            return;
        }
        android.view.animation.Transformation transformation = new android.view.animation.Transformation();
        if (!this.f363401e.getTransformation(android.os.SystemClock.uptimeMillis(), transformation)) {
            valueAnimator.cancel();
            return;
        }
