...
public final class u {
    ...
    public static final ub5.u f507787a = new ub5.u();

    static {
        kz5.p1.f(3, 6, 22, 23, 30, 41, 26, 40, 27, 42, 28, 5);
        kz5.p1.f(2000, java.lang.Integer.valueOf(com.p314xaae8f345.p2926x359365.C25483x77a9a59f.f46349x3142bb26));
    }
    ...
    */
    ...
    public final boolean b() {
        ...
        int c17 = j62.e.g().c(new com.p314xaae8f345.mm.p2502xe5c27cfa.p2506xaf3f8342.p2585xce036727.C20838x6140fd22());
        boolean z17 = false;
        boolean z18 = c17 == 1 || c17 == 3;
        xj.m Ui = ((wj.j0) ((xj.i) ((jz5.n) u3Var.f444745h).mo141623x754a37bb())).Ui(wj.t0.f528046v);
        if (z18 && bj6 && Ui != null) {
            z17 = true;
        }
        if (!z17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.YuanBaoCopyChatRecordsFSC", "isShowButton: " + z17 + ", multiSelectCopyConfigEnabled: " + z18 + ", isMainlandHkMoUser: " + bj6 + ", adInfo: " + Ui);
        }
        return z17;
    }
}
