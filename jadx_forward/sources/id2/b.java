...
public final class b implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ p3321xbce91901.jvm.p3324x21ffc6bd.c0 f372017d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ id2.l f372018e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.content.Intent f372019f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.z2 f372020g;

    public b(p3321xbce91901.jvm.p3324x21ffc6bd.c0 c0Var, id2.l lVar, android.content.Intent intent, com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.z2 z2Var) {
        this.f372017d = c0Var;
        this.f372018e = lVar;
        this.f372019f = intent;
        this.f372020g = z2Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        int i17 = 1;
        this.f372017d.f391645d = true;
        id2.m.f372195a.b("room_live_start", "153");
        ml2.j0 j0Var = (ml2.j0) i95.n0.c(ml2.j0.class);
        ml2.y3 y3Var = ml2.y3.f409807i;
        j0Var.ck(y3Var);
        id2.l lVar = this.f372018e;
        java.lang.String str = lVar.f372183d;
        ...
        android.content.Intent intent = this.f372019f;
        intent.putExtra("KEY_PARAMS_SOURCE_TYPE", y3Var);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(pf5.o.TAG, "goLive fromChatRoomId:" + lVar.f372183d);
        intent.putExtra("KEY_PARAMS_FROM_CHATROOM_ID", lVar.f372183d);
        this.f372020g.B();
