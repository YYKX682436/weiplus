...
public class u implements vg3.q4 {
    ...
    public static c01.s f119031f;

    /* renamed from: d, reason: collision with root package name */
    public long f119032d = -1;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.LinkedHashMap f119033e;

    public u() {
        java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
        this.f119033e = linkedHashMap;
    ...
    */
    public static java.lang.String b(java.lang.String r9, long r10, long r12) {
        /*
            ...
            if (r3 == 0) goto L27
            android.content.Context r3 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a     // Catch: java.lang.Throwable -> L71 java.lang.Exception -> L74
            ...
            goto L2c
        L27:
            java.io.InputStream r9 = com.p314xaae8f345.mm.vfs.w6.E(r9)     // Catch: java.lang.Throwable -> L71 java.lang.Exception -> L74
            r4 = r2
        L2c:
            r2 = r9
        L2d:
        ...
        L5c:
            ...
            java.lang.String r9 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.l(r9)     // Catch: java.lang.Exception -> L6f java.lang.Throwable -> L88
            if (r2 == 0) goto L69
        ...
        L76:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r10, r9, r0, r11)     // Catch: java.lang.Throwable -> L88
            if (r2 == 0) goto L82
    ...
    public static long c(java.lang.String str) {
        ...
        try {
            try {
                zipFile = new java.util.zip.ZipFile(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getApplicationInfo().sourceDir);
        ...
        try {
            ...
            e = e18;
            zipFile2 = zipFile;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.BigBallSysCmdMsgConsumer", e, "", new java.lang.Object[0]);
            if (zipFile2 != null) {
                try {
                    zipFile2.close();
            ...
            for (java.lang.Object obj : objArr) {
                if (obj instanceof java.lang.String) {
                    ...
                    if (!(obj instanceof java.lang.Boolean)) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.BigBallSysCmdMsgConsumer", "Invalid object class: %s", obj);
                        return "";
                    }
                    byteArrayOutputStream.write(((java.lang.Boolean) obj).booleanValue() ? 1 : 0);
                }
            }
            return com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.l(java.security.MessageDigest.getInstance("MD5").digest(byteArrayOutputStream.toByteArray()));
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.BigBallSysCmdMsgConsumer", e17, "", new java.lang.Object[0]);
            return "";
        }
    }

    public void f(java.lang.String str, long j17, com.p314xaae8f345.mm.p944x882e457a.p0 p0Var, java.lang.String str2, java.lang.String str3, java.lang.String str4) {
        com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var;
        com.p314xaae8f345.mm.p2621x8fb0427b.l4 l4Var;
        a95.a z07;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BigBallSysCmdMsgConsumer", "doRevokeMsg xmlSrvMsgId=%d talker=%s isGet=%s", java.lang.Long.valueOf(j17), str, java.lang.Boolean.valueOf(p0Var.f152260b));
        ...
        com.p314xaae8f345.mm.p2621x8fb0427b.f9 M1 = com.p314xaae8f345.mm.p2621x8fb0427b.f9.M1(o27);
        ...
        if (p0Var.f152260b) {
            ...
            y7Var.f69372xd234289f = j17;
            if (o27.m124847x74d37ac6() == 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str4, "summerbadcr get a revoke but msg id is 0 originSvrId[%d]", java.lang.Long.valueOf(j17));
                y7Var.f69365xad49e234 = g17;
                y7Var.f69366xac3be4e = j4Var.f459098o;
                y7Var.f69367x225ba391 = c01.w9.q(p0Var);
                y7Var.f69368x6bbbdde5 = x51.j1.g(j4Var.f459091e);
                y7Var.f69377xa80ff8f6 = x51.j1.g(j4Var.f459092f);
                y7Var.f69371x6edd4861 = j4Var.f459101r;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str4, "summerbadcr insert ret[%b], systemRowid[%d]", java.lang.Boolean.valueOf(((w11.w1) i95.n0.c(w11.w1.class)).Ai().mo880xb970c2b9(y7Var)), java.lang.Long.valueOf(y7Var.f72763xa3c65b86));
                return;
            }
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str4, "summerbadcr get a revoke and has done delete info, originSvrId[%d]", java.lang.Long.valueOf(j17));
            ((w11.w1) i95.n0.c(w11.w1.class)).Ai().mo49766xb06685ab(y7Var, true, new java.lang.String[0]);
            if (p17 != null && p17.R0() == j4Var.f459102s) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str4, "summerbadcr get a revoke and fix fault lastseq[%s], firstUnDeliverSeq[%s]", java.lang.Long.valueOf(p17.R0()), java.lang.Long.valueOf(p17.F0()));
                com.p314xaae8f345.mm.p2621x8fb0427b.f9 W5 = ((com.p314xaae8f345.mm.p2621x8fb0427b.g9) c01.d9.b().u()).W5(p17.h1());
                if (W5 != null) {
                    p17.P1(W5.F0());
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str4, "summerbadcr get a revoke and fix fault by [%s, %s] lastseq[%s], firstUnDeliverSeq[%s], update[%s]", java.lang.Long.valueOf(W5.I0()), java.lang.Long.valueOf(W5.F0()), java.lang.Long.valueOf(p17.R0()), java.lang.Long.valueOf(p17.F0()), java.lang.Integer.valueOf(((com.p314xaae8f345.mm.p2621x8fb0427b.m4) c01.d9.b().r()).Y(p17, p17.h1(), true, true)));
                }
            }
        }
        if (o27.m124847x74d37ac6() != 0 || (z07 = ((com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.C16508x1e702dd3) i95.n0.c(com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.C16508x1e702dd3.class)).wi().z0(j17)) == null) {
            f9Var = M1;
            l4Var = p17;
        } else {
            f9Var = M1;
            l4Var = p17;
            if (z07.f68549xd09be28e != 0) {
                o27 = ((com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).cj().o2(str, z07.f68549xd09be28e);
            }
        }
        if (o27.m124847x74d37ac6() == 0) {
            if (((lp3.r) i95.n0.c(lp3.r.class)).Bi(j17) != null) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str4, "summerbadcr get a revoke newxml, but original msg has not been found, originSvrId[%d]", java.lang.Long.valueOf(j17));
                ((com.p314xaae8f345.mm.p2621x8fb0427b.g9) c01.d9.b().u()).f275523s.a(0, j17, 0L, false);
                return;
            }
        }
        if (o27.mo78013xfb85f7b0() == 922746929) {
            ((lp3.l) ((mp3.j) i95.n0.c(mp3.j.class))).Bi(str, j17);
            return;
        }
        int i17 = o27.F & 4;
        if (i17 != 4) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BigBallSysCmdMsgConsumer", "doRevokeMsg revokeFlag=%d msgId=%s talker=%s type=%d revokeMsgSvrId=%d", java.lang.Integer.valueOf(i17), java.lang.Long.valueOf(o27.m124847x74d37ac6()), str, java.lang.Integer.valueOf(o27.mo78013xfb85f7b0()), java.lang.Long.valueOf(j17));
            tg3.p1.f500739a.d(o27);
            if (((kc5.x) ((wg3.j) i95.n0.c(wg3.j.class))).Ni() && (o27.J2() || o27.m78014x7b98c171())) {
                r15.d I = com.p314xaae8f345.mm.p957x53236a1b.d1.I(o27);
                o27.d1(str2);
                o27.m124850x7650bebc(285222674);
                ...
                o27.x3(hVar.m126747x696739c());
            } else {
                o27.d1(str2);
                o27.x3(str2);
                o27.m124850x7650bebc(268445456);
            }
            o27.p1("");
            c01.w9.n(o27, p0Var);
            ((com.p314xaae8f345.mm.p2621x8fb0427b.g9) c01.d9.b().u()).lb(o27.m124847x74d37ac6(), o27, true);
        }
        com.p314xaae8f345.mm.p632xd97a1f41.p633xb307e119.C5945xdd67bc5f c5945xdd67bc5f = new com.p314xaae8f345.mm.p632xd97a1f41.p633xb307e119.C5945xdd67bc5f();
        long m124847x74d37ac6 = o27.m124847x74d37ac6();
        am.cs csVar = c5945xdd67bc5f.f136246g;
        csVar.f87927a = m124847x74d37ac6;
        csVar.f87928b = str2;
        csVar.f87929c = o27;
        com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var2 = f9Var;
        csVar.f87930d = f9Var2;
        csVar.f87931e = j17;
        csVar.f87932f = str3;
        c5945xdd67bc5f.e();
        if (f9Var2 != null) {
        ...
        if (D0 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.msgquote.PluginMsgQuote", "handleRevokeMsgBySvrId msgSvrId:%s, msgQuote is null", java.lang.Long.valueOf(j17));
        } else if (D0.f66421x10a0fed7 == 1) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.msgquote.PluginMsgQuote", "handleRevokeMsgBySvrId msgSvrId:%s revoked!!", java.lang.Long.valueOf(j17));
        } else {
            D0.f66421x10a0fed7 = 1;
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.msgquote.PluginMsgQuote", "handleRevokeMsgBySelf() msgSvrId:%s result:%s", java.lang.Long.valueOf(j17), java.lang.Boolean.valueOf(eVar2.Di().P0(D0)));
        }
        if (l4Var != null && l4Var.d1() > 0) {
            if (l4Var.d1() >= ((com.p314xaae8f345.mm.p2621x8fb0427b.g9) c01.d9.b().u()).w8(o27)) {
                ...
                if (l4Var2.t0() > 0) {
                    if (o27.s2(c01.z1.r())) {
                        ...
                        l4Var2.i1(l4Var2.t0() - com.p314xaae8f345.p3006xb8ff1437.p3028x2eaf9f.p3029xaf3f29eb.C26306x4f373ca9.f52070xe96767bb);
                    }
                }
                ((com.p314xaae8f345.mm.p2621x8fb0427b.m4) c01.d9.b().r()).W(l4Var2, l4Var2.h1());
            }
        }
        if (kn.l0.a(f9Var2)) {
            ...
            c5761xb35fab50.f136080g.f89436a = f9Var2;
            c5761xb35fab50.e();
        }
    }
