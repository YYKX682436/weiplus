...
public abstract class h9 {
    public static android.content.SharedPreferences a() {
        ...
        if (!sharedPreferences.getBoolean("key_auth_info_prefs_created", false)) {
            ...
            fVar.mo68477x336bdfd8(148L, 12L, 1L, true);
            com.p314xaae8f345.mm.p2621x8fb0427b.j3 j3Var = new com.p314xaae8f345.mm.p2621x8fb0427b.j3(com.p314xaae8f345.mm.p2621x8fb0427b.v3.f277806a + "autoauth.cfg");
            if (!j3Var.f276576c && j3Var.a(3) != null) {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMReqRespAuthComm", "summerauth auth_info_key_prefs not exit! use autoauthcfg now commit[%b] create[%b], ver[%d], uin[%d], aak[%s], sid[%s]", java.lang.Boolean.valueOf(edit.commit()), java.lang.Boolean.valueOf(sharedPreferences.getBoolean("key_auth_info_prefs_created", false)), java.lang.Integer.valueOf(sharedPreferences.getInt("key_auth_update_version", 0)), java.lang.Integer.valueOf(sharedPreferences.getInt("_auth_uin", 0)), sharedPreferences.getString("_auth_key", ""), sharedPreferences.getString("server_id", ""));
                fVar.mo68477x336bdfd8(148L, 51L, 1L, true);
                return sharedPreferences;
            }
            android.content.SharedPreferences sharedPreferences2 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSharedPreferences("auto_auth_key_prefs", 4);
            android.content.SharedPreferences.Editor edit2 = sharedPreferences.edit();
            if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(sharedPreferences2.getString("_auth_key", ""))) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMReqRespAuthComm", "summerauth auth_info_key_prefs not exit! neither autoauthcfg nor oldAAKsp existed just install! stack[%s]", new com.p314xaae8f345.mm.sdk.p2603x2137b148.z3());
            } else {
                ...
                edit2.putString("server_id", com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getSharedPreferences("server_id_prefs", 4).getString("server_id", ""));
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MMReqRespAuthComm", "summerauth auth_info_key_prefs not exit! use oldAAKsp now commit[%b] create[%b], ver[%d], uin[%d], aak[%s], sid[%s]", java.lang.Boolean.valueOf(edit2.commit()), java.lang.Boolean.valueOf(sharedPreferences.getBoolean("key_auth_info_prefs_created", false)), java.lang.Integer.valueOf(sharedPreferences.getInt("key_auth_update_version", 0)), java.lang.Integer.valueOf(sharedPreferences.getInt("_auth_uin", 0)), sharedPreferences.getString("_auth_key", ""), sharedPreferences.getString("server_id", ""));
            }
        }
        return sharedPreferences;
    }
