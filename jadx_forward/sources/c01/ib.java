...
public class ib {
    ...
    public final l75.k0 f118793a;

    public ib(l75.k0 k0Var, com.p314xaae8f345.mm.p2621x8fb0427b.l8 l8Var) {
        this.f118793a = k0Var;
    }
    ...
    public android.database.Cursor a(java.lang.String str, java.util.List list, java.lang.String str2) {
        ...
        if (str2 != null && str2.length() > 0) {
            ...
            while (f17.moveToNext()) {
                java.lang.String string = f17.getString(f17.getColumnIndex(dm.i4.f66875xa013b0d5));
