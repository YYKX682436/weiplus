...
public final class p extends ot1.g {
    ...
    public java.lang.Object j(android.database.Cursor cursor) {
        ...
        if ((1 & j17) != 0) {
            this.f96162e.add(new jz5.l(b17 == null ? "talker-ignore" : b17, java.lang.Long.valueOf(j18)));
        }
        if (i17 != 3 && i17 != 23) {
            return null;
        }
        ...
        hVar.f68219x9f7e1864 = cursor.getLong(1);
        hVar.f68223x297eb4f7 = j18;
        hVar.f68230xdec927b = b17;
        hVar.f68220x2918cf02 = j17;
        return hVar;
    }
}
