...
public abstract class o0 {
    ...
    public static r45.jw4 f426101a;
    ...
    public static r45.kw4 a(int i17) {
        r45.jw4 jw4Var = f426101a;
        if (jw4Var == null) {
            return null;
        }
        java.util.Iterator it = jw4Var.f459701d.iterator();
        while (it.hasNext()) {
            r45.kw4 kw4Var = (r45.kw4) it.next();
            if (kw4Var.f460534d == i17) {
                return kw4Var;
            }
        }
        return null;
    ...
    public static java.lang.String b() {
        ...
        return com.p314xaae8f345.mm.p2621x8fb0427b.v3.f277806a + gm0.b0.e(i17) + '/';
    }

    public static synchronized boolean c(int i17, long j17, int i18) {
        synchronized (od0.o0.class) {
            if (j17 <= 0 || i18 <= 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.SecInfoReporterImpl", "bad interval: %s, %s", java.lang.Long.valueOf(j17), java.lang.Integer.valueOf(i18));
                return false;
            }
            if (f426101a == null) {
                d();
    ...
    public static synchronized void d() {
        synchronized (od0.o0.class) {
            ...
            try {
                ...
                f426101a = new r45.jw4();
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SecInfoReporterImpl", "normsg stat load failed, use default. %s", e17);
            }
        }
    }
    ...
    */
    public static synchronized r45.jw4 e() {
        ...
        L10:
            ...
            com.tencent.mm.vfs.z7 r2 = com.p314xaae8f345.mm.vfs.z7.a(r2)     // Catch: java.lang.Throwable -> Lc7
            r4 = 0
            boolean r5 = r3.isEmpty()     // Catch: java.lang.Throwable -> Lc7
            java.lang.String r6 = r2.f294812f     // Catch: java.lang.Throwable -> Lc7
            if (r5 != 0) goto L3d
            ...
            java.lang.String r6 = com.p314xaae8f345.mm.vfs.e8.l(r3, r4, r4)     // Catch: java.lang.Throwable -> Lc7
        L3d:
            r8 = r6
            com.tencent.mm.vfs.z7 r3 = new com.tencent.mm.vfs.z7     // Catch: java.lang.Throwable -> Lc7
            java.lang.String r6 = r2.f294810d     // Catch: java.lang.Throwable -> Lc7
            java.lang.String r7 = r2.f294811e     // Catch: java.lang.Throwable -> Lc7
            java.lang.String r9 = r2.f294813g     // Catch: java.lang.Throwable -> Lc7
            java.lang.String r10 = r2.f294814h     // Catch: java.lang.Throwable -> Lc7
            r5 = r3
            ...
            com.tencent.mm.vfs.b3 r6 = com.p314xaae8f345.mm.vfs.a3.f294314a     // Catch: java.lang.Throwable -> La9 java.lang.Exception -> Lab
            com.tencent.mm.vfs.z2 r6 = r6.m(r3, r2)     // Catch: java.lang.Throwable -> La9 java.lang.Exception -> Lab
            java.io.InputStream r3 = com.p314xaae8f345.mm.vfs.w6.D(r3, r6)     // Catch: java.lang.Throwable -> La9 java.lang.Exception -> Lab
        ...
        L6d:
            ...
            r8.f460534d = r3     // Catch: java.lang.Exception -> La7 java.lang.Throwable -> Lbf
            r8.f460535e = r6     // Catch: java.lang.Exception -> La7 java.lang.Throwable -> Lbf
            r3 = 1
            r8.f460536f = r3     // Catch: java.lang.Exception -> La7 java.lang.Throwable -> Lbf
            java.util.LinkedList r3 = r1.f459701d     // Catch: java.lang.Exception -> La7 java.lang.Throwable -> Lbf
        ...
        L8b:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r2, r3)     // Catch: java.lang.Exception -> La7 java.lang.Throwable -> Lbf
        L93:
        ...
        Lae:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r3, r4, r2)     // Catch: java.lang.Throwable -> Lbf
            if (r5 == 0) goto Lbd
            goto L93
        Lbd:
            monitor-exit(r0)
    ...
    public static synchronized r45.jw4 f() {
        ...
        synchronized (od0.o0.class) {
            ...
            if (!isEmpty) {
                str = com.p314xaae8f345.mm.vfs.e8.l(str + '/' + V6, false, false);
            }
            com.p314xaae8f345.mm.vfs.z7 z7Var = new com.p314xaae8f345.mm.vfs.z7(a17.f294810d, a17.f294811e, str, a17.f294813g, a17.f294814h);
            ...
            try {
                try {
                    dataInputStream = new java.io.DataInputStream(com.p314xaae8f345.mm.vfs.w6.D(z7Var, com.p314xaae8f345.mm.vfs.a3.f294314a.m(z7Var, m18)));
                } catch (java.lang.Exception e17) {
                    e = e17;
                }
            ...
            try {
                ...
                try {
                    jw4Var.mo11468x92b714fd(bArr);
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SecInfoReporterImpl", "normsg stat load done.");
                    return jw4Var;
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SecInfoReporterImpl", "normsg stat load failed, use default. %s", e);
    ...
    public static synchronized void g() {
        ...
        synchronized (od0.o0.class) {
            java.lang.String b17 = b();
            if (b17 == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SecInfoReporterImpl", "normsg cache path is null.");
                return;
            }
            com.p314xaae8f345.mm.vfs.r6 r6Var = new com.p314xaae8f345.mm.vfs.r6(b17, fo3.s.INSTANCE.V6("!#?'8/f((6(1$\u001f2*>(s826"));
            if (!r6Var.m()) {
                r6Var.s().J();
            }
            ...
            try {
                try {
                    try {
                        dataOutputStream = new java.io.DataOutputStream(com.p314xaae8f345.mm.vfs.w6.H(r6Var));
                    } catch (java.lang.Throwable th7) {
            ...
            try {
                r45.jw4 jw4Var = f426101a;
                if (jw4Var != null) {
                    dataOutputStream.write(jw4Var.mo14344x5f01b1f6());
                }
                ?? r17 = "MicroMsg.SecInfoReporterImpl";
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SecInfoReporterImpl", "normsg stat save done.");
                dataOutputStream.close();
                dataOutputStream2 = r17;
            } catch (java.lang.Exception unused3) {
                dataOutputStream3 = dataOutputStream;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SecInfoReporterImpl", "normsg stat save failed.");
