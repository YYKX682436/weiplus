...
public enum c0 {
    ...
    public final java.util.concurrent.ConcurrentMap f391213d = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: e, reason: collision with root package name */
    public final java.util.concurrent.ConcurrentMap f391214e = new java.util.concurrent.ConcurrentHashMap();
    ...
    public void b(java.lang.String str, long j17, long j18, long j19, long j27) {
        if (kn4.d0.f391215d) {
            java.util.concurrent.ConcurrentMap concurrentMap = this.f391213d;
            ...
            java.util.concurrent.ConcurrentMap concurrentMap2 = this.f391214e;
