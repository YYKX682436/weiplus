...
public class r implements qk.v7 {
    ...
    public int a() {
        um.e eVar = (um.e) com.p314xaae8f345.mm.p647x5a0af82.C10322x22f91ed2.a().c(dl.a.DOODLE);
        if (eVar == null) {
            return 0;
        }
        return eVar.A3(true);
    ...
    public int c() {
        um.s sVar = (um.s) com.p314xaae8f345.mm.p647x5a0af82.C10322x22f91ed2.a().c(dl.a.MOSAIC);
        if (sVar == null) {
            return 0;
        }
        return sVar.A3(true);
    ...
    public int d() {
        ...
        int[] iArr = dn5.c.D;
        int[] iArr2 = new int[8];
        java.util.Stack stack = eVar.f510208d;
        if (stack != null) {
    ...
    public int f() {
        um.e eVar = (um.e) com.p314xaae8f345.mm.p647x5a0af82.C10322x22f91ed2.a().c(dl.a.DOODLE);
        int i17 = eVar != null ? 0 + eVar.f510210f : 0;
        um.s sVar = (um.s) com.p314xaae8f345.mm.p647x5a0af82.C10322x22f91ed2.a().c(dl.a.MOSAIC);
        return sVar != null ? i17 + sVar.f510229g : i17;
    }
    ...
    public boolean h() {
        dl.b d17 = ((l45.n) this.f341494a).d(qk.g6.CROP_PHOTO);
