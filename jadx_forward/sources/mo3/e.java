...
public abstract class e {
    public static void a(android.content.Context context, android.app.NotificationManager notificationManager, java.lang.String str, boolean z17, boolean z18, boolean z19, boolean z27, android.content.SharedPreferences sharedPreferences) {
        android.app.NotificationChannel notificationChannel = new android.app.NotificationChannel(str, context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.f574178hb5), 4);
        notificationChannel.setDescription(context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.f574177hb4));
    ...
    public static void b(android.content.Context context, android.app.NotificationManager notificationManager, java.lang.String str, boolean z17, boolean z18, android.content.SharedPreferences sharedPreferences) {
        ...
        if (z18) {
            java.lang.String string = sharedPreferences.getString("settings.ringtone", null);
            if (d(string)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.NotificationManufacturerCompatibility", "sound = %s", android.net.Uri.parse(string));
                notificationChannel.setSound(android.net.Uri.parse(string), android.app.Notification.AUDIO_ATTRIBUTES_DEFAULT);
            }
        }
        sharedPreferences.edit().putString("message_channel_id", str).commit();
            ...
            if (z19) {
                try {
                    if (e17.getSound() != null) {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveSoundTone: %s", uri);
                    }
                    ...
                    n25.a.f415850a = "message_channel_compatibility_id";
                    ip.b.f375079b = "message_channel_compatibility_id";
                } catch (java.lang.Exception e18) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.NotificationManufacturerCompatibility", "huaweiNotificationCompatibility exception:%s", e18.getMessage());
                }
            } else {
                a(context, notificationManager, a17, startsWith, startsWith2, z17, z18, sharedPreferences);
            }
    ...
    */
    public static boolean d(java.lang.String r7) {
        /*
            ...
            android.content.Context r4 = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a     // Catch: java.lang.Throwable -> L35 java.io.IOException -> L37 java.lang.SecurityException -> L39 java.lang.NullPointerException -> L3b
        ...
        L5d:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r2, r7, r4)
            return r0
        */
    ...
    public static android.app.NotificationChannel e(android.app.NotificationManager notificationManager, java.lang.String str) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.NotificationManufacturerCompatibility", "deleteNoNumberNotification exception:%s", e17.getMessage());
        }
        ...
        for (android.app.NotificationChannel notificationChannel : notificationChannels) {
            if (notificationChannel != null && notificationChannel.getId() != null && com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D0(notificationChannel.getId(), str)) {
    ...
    public static boolean f(android.content.Context context, android.app.NotificationManager notificationManager, boolean z17, boolean z18, android.content.SharedPreferences sharedPreferences) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NotificationManufacturerCompatibility", "xiaomiNotificationCompatibility() lastVersion:%s curVersion:%s", a18, java.lang.Integer.valueOf(o45.wf.f424562g));
        if (split == null || split.length != 2) {
            return true;
        }
        int parseInt = java.lang.Integer.parseInt(split[0], 16);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NotificationManufacturerCompatibility", "xiaomiNotificationCompatibility() lastVersion:%s", java.lang.Integer.valueOf(parseInt));
        if (654311424 > parseInt || parseInt > 654312247 || com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D0(e17.getId(), "message_channel_compatibility_id")) {
            return true;
        }
        if (e17.getSound() != null) {
            b(context, notificationManager, a17, z17, z18, sharedPreferences);
