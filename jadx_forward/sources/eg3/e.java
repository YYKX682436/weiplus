...
public final class e implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.widget.ImageView f334190d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f334191e;

    public e(android.widget.ImageView imageView, int i17) {
        this.f334190d = imageView;
        this.f334191e = i17;
    }
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator valueAnimator) {
        ...
        android.widget.ImageView imageView = this.f334190d;
        if (floatValue <= 0.1f) {
            imageView.setAlpha(10 * floatValue);
        } else if (floatValue >= 0.9f) {
            imageView.setAlpha((1.0f - floatValue) * 10);
        }
        imageView.setTranslationY(floatValue * (this.f334191e - imageView.getHeight()));
    }
}
