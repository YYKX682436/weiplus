...
public final class i1 implements s1.t0 {
    ...
    public final yz5.l f395781a;

    /* renamed from: b, reason: collision with root package name */
    public final boolean f395782b;

    /* renamed from: c, reason: collision with root package name */
    public final float f395783c;

    /* renamed from: d, reason: collision with root package name */
    public final d0.d2 f395784d;

    public i1(yz5.l onLabelMeasured, boolean z17, float f17, d0.d2 paddingValues) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(onLabelMeasured, "onLabelMeasured");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(paddingValues, "paddingValues");
        this.f395781a = onLabelMeasured;
        this.f395782b = z17;
        this.f395783c = f17;
        this.f395784d = paddingValues;
    }
    ...
    public int a(s1.u uVar, java.util.List measurables, int i17) {
        ...
        return g(measurables, i17, l0.h1.f395750d);
    }
    ...
    public int b(s1.u uVar, java.util.List measurables, int i17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(uVar, "<this>");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(measurables, "measurables");
        return f(uVar, measurables, i17, l0.d1.f395655d);
    }
    ...
    public int c(s1.u uVar, java.util.List measurables, int i17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(uVar, "<this>");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(measurables, "measurables");
        return f(uVar, measurables, i17, l0.g1.f395742d);
    }
    ...
    public s1.u0 d(s1.x0 measure, java.util.List measurables, long j17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(measurables, "measurables");
        int G = measure.G(((d0.e2) this.f395784d).f306644d);
        ...
        if (m19 != null) {
            this.f395781a.mo146xb9724478(new d1.k(d1.l.a(m19.f483583d, m19.f483584e)));
        }
        ...
        while (it8.hasNext()) {
            ...
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(s1.c0.a(r0Var4), "TextField")) {
                ...
                int max = java.lang.Math.max(l0.h4.e(m17) + java.lang.Math.max(m27.f483583d, java.lang.Math.max(l0.h4.e(m19), l0.h4.e(m28))) + l0.h4.e(m18), p2.c.j(j17));
                int c17 = l0.c1.c(l0.h4.d(m17), l0.h4.d(m18), m27.f483584e, l0.h4.d(m19), l0.h4.d(m28), j17, measure.mo7005x9a59d0b2(), this.f395784d);
                java.util.Iterator it10 = measurables.iterator();
                while (it10.hasNext()) {
                    s1.r0 r0Var6 = (s1.r0) it10.next();
                    if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(s1.c0.a(r0Var6), "border")) {
    ...
    public int e(s1.u uVar, java.util.List measurables, int i17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(uVar, "<this>");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(measurables, "measurables");
        return g(measurables, i17, l0.e1.f395687d);
    }
    ...
    public final int f(s1.u uVar, java.util.List list, int i17, yz5.p pVar) {
        ...
        for (java.lang.Object obj5 : list) {
            if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(l0.h4.c((s1.t) obj5), "TextField")) {
                ...
                s1.t tVar4 = (s1.t) obj;
                return l0.c1.c(intValue4, intValue3, intValue, intValue2, tVar4 != null ? ((java.lang.Number) pVar.mo149xb9724478(tVar4, java.lang.Integer.valueOf(i17))).intValue() : 0, l0.h4.f395757a, uVar.mo7005x9a59d0b2(), this.f395784d);
            }
        }
        throw new java.util.NoSuchElementException("Collection contains no element matching the predicate.");
    }
