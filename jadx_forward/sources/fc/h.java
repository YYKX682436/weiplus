...
public abstract class h implements java.util.Set {
    ...
    public final /* synthetic */ fc.k f342446d;
    ...
    public boolean isEmpty() {
        return this.f342446d.m129316x7aab3243();
    }
    ...
    @Override // java.util.Set, java.util.Collection
    public int size() {
        return this.f342446d.f342433d;
    }

    @Override // java.util.Set, java.util.Collection
    public java.lang.Object[] toArray() {
        java.lang.Object[] objArr = new java.lang.Object[this.f342446d.f342433d];
        java.util.Iterator it = iterator();
        int i17 = 0;
        while (it.hasNext()) {
            objArr[i17] = it.next();
    ...
    public java.lang.Object[] toArray(java.lang.Object[] objArr) {
        int i17 = this.f342446d.f342433d;
