...
public final class b implements so2.j5, wp2.a {
    ...
    public final r45.fa2 f364740d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.ArrayList f364741e;

    public b(r45.fa2 container) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(container, "container");
        this.f364740d = container;
        this.f364741e = new java.util.ArrayList();
    }

    @Override // wp2.a
    public com.p314xaae8f345.mm.p2495xc50a8b8b.g a() {
        return this.f364740d.f455665n;
    }

    @Override // wp2.a
    public void b(int i17) {
        this.f364740d.f455663i = i17;
    }

    @Override // wp2.a
    public int c() {
        return this.f364741e.size();
    }

    @Override // com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.p1459x633fb29.p1460x21ffc6bd.r0
    public int d(com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.p1459x633fb29.p1460x21ffc6bd.r0 obj) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(obj, "obj");
        return ((obj instanceof hq2.b) && ((hq2.b) obj).f364740d.f455658d == this.f364740d.f455658d) ? 0 : -1;
    }

    @Override // wp2.a
    public void f(com.p314xaae8f345.mm.p2495xc50a8b8b.g gVar) {
        this.f364740d.f455665n = gVar;
    }

    @Override // wp2.a
    public java.util.List g() {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.LinkedList card_list = this.f364740d.f455662h;
