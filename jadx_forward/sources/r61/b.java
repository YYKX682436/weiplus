...
public class b extends l75.a1 {
    ...
    @Override // l75.a1
    public boolean f() {
        l75.k0 k0Var = this.f474352d;
        if (k0Var != null && !k0Var.J()) {
            return true;
        }
        java.lang.Object[] objArr = new java.lang.Object[1];
        objArr[0] = k0Var == null ? "null" : java.lang.Boolean.valueOf(k0Var.J());
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.AddrUploadStorage", "shouldProcessEvent db is close :%s", objArr);
        return false;
    }
    ...
    public boolean g(java.util.List list) {
        ...
        if (list != null && list.size() > 0) {
            com.p314xaae8f345.mm.sdk.p2603x2137b148.i8 i8Var = new com.p314xaae8f345.mm.sdk.p2603x2137b148.i8("MicroMsg.AddrUploadStorage", "delete transaction");
            i8Var.a("begin");
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (str != null && str.length() > 0) {
                        if (k0Var.mo70514xb06685ab("addr_upload2", "id =?", new java.lang.String[]{"" + r61.a.d(str)}) > 0) {
                            b(5, this, str);
                        }
                    }
                }
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.AddrUploadStorage", e17, "", new java.lang.Object[0]);
            }
    ...
    public r61.a h(java.lang.String str) {
        ...
        sb6.append(str);
        sb6.append("\"");
        android.database.Cursor f17 = this.f474352d.f(sb6.toString(), null, 2);
        if (f17.moveToFirst()) {
            aVar.b(f17);
        }
        f17.close();
    ...
    public r61.a i(java.lang.String str) {
        r61.a aVar = null;
        if (str != null && str.length() > 0) {
            android.database.Cursor f17 = this.f474352d.f("select addr_upload2.id,addr_upload2.md5,addr_upload2.peopleid,addr_upload2.uploadtime,addr_upload2.realname,addr_upload2.realnamepyinitial,addr_upload2.realnamequanpin,addr_upload2.username,addr_upload2.nickname,addr_upload2.nicknamepyinitial,addr_upload2.nicknamequanpin,addr_upload2.type,addr_upload2.moblie,addr_upload2.email,addr_upload2.status,addr_upload2.reserved1,addr_upload2.reserved2,addr_upload2.reserved3,addr_upload2.reserved4,addr_upload2.lvbuf,addr_upload2.showhead from addr_upload2 where addr_upload2.id=" + r61.a.d(str) + "", null, 2);
            if (f17.moveToFirst()) {
                aVar = new r61.a();
                aVar.b(f17);
            }
    ...
    public int j(java.lang.String str, r61.a aVar) {
        ...
        if (c17.size() > 0) {
            i17 = this.f474352d.p("addr_upload2", c17, "id=?", new java.lang.String[]{"" + r61.a.d(str)});
        } else {
            i17 = 0;
        }
        if (i17 > 0) {
