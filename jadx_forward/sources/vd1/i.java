...
public final class i extends com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.f {
    ...
    public static final int f77286x366c91de = -2;

    /* renamed from: NAME */
    public static final java.lang.String f77287x24728b = "mbAdFullLinkReport";

    @Override // com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.f
    public void A(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.l lVar, org.json.JSONObject jSONObject, int i17) {
        java.lang.String str;
        if (jSONObject == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MBADFullLinkReporter", "[MBAd] data is null");
            if (lVar != null) {
        ...
        try {
            ...
            try {
                ...
                if (optString == null || r26.n0.N(optString)) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MBADFullLinkReporter", "[MBAd] mbAdFullLinkReport: action is empty, skip");
                    if (lVar != null) {
                ...
                if (c0Var != null) {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MBADFullLinkReporter", "[MBAd] mbAdFullLinkReport ok, action=" + optString + ", bizName=" + optString2 + ", bizScene=" + optString3 + ", traceId=" + optString4 + ", frameSetName=" + optString5 + ", implType=" + optString6 + ", reportSource=" + optString7);
                } else {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MBADFullLinkReporter", "[MBAd] IMBADFullLinkReporter service not found");
                }
                if (lVar != null) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MBADFullLinkReporter", "[MBAd] mbAdFullLinkReport failed: " + e, e);
        if (lVar != null) {
