...
public abstract class x1 extends u4.a2 {
    ...
    public static java.lang.reflect.Method f506112a;

    /* renamed from: b, reason: collision with root package name */
    public static boolean f506113b;

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.reflect.Method f506114c;

    /* renamed from: d, reason: collision with root package name */
    public static boolean f506115d;
    ...
    public float a(android.view.View view) {
        if (!f506115d) {
            try {
                ...
                f506114c = declaredMethod;
                declaredMethod.setAccessible(true);
            } catch (java.lang.NoSuchMethodException unused) {
            }
            f506115d = true;
        }
        java.lang.reflect.Method method = f506114c;
        if (method != null) {
            try {
