...
public final class p implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.widget.CheckBox f421139d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ ns4.s f421140e;

    public p(android.widget.CheckBox checkBox, ns4.s sVar) {
        this.f421139d = checkBox;
        this.f421140e = sVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.widget.CheckBox checkBox = this.f421139d;
        boolean isChecked = checkBox.isChecked();
        ns4.s sVar = this.f421140e;
        if (isChecked) {
