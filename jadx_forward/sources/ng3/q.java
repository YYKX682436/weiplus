...
public final class q extends android.view.GestureDetector.SimpleOnGestureListener {
    ...
    public final /* synthetic */ ng3.r f418559d;
    ...
    public boolean onDoubleTap(android.view.MotionEvent e17) {
        ...
        this.f418559d.a(new ng3.a(ng3.t.f418581s, e17));
    ...
    public void onLongPress(android.view.MotionEvent e17) {
        ...
        java.lang.Object[] array = arrayList.toArray();
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/media/view/gesture/controller/TapController$gestureDetector$1", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.f69928x24728b, "(Landroid/view/MotionEvent;)V", this, array);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(e17, "e");
        this.f418559d.d(new ng3.i(ng3.t.f418579q, e17));
        super.onLongPress(e17);
        yj0.a.h(this, "com/tencent/mm/plugin/media/view/gesture/controller/TapController$gestureDetector$1", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.f69928x24728b, "(Landroid/view/MotionEvent;)V");
    }

    @Override // android.view.GestureDetector.SimpleOnGestureListener, android.view.GestureDetector.OnDoubleTapListener
    public boolean onSingleTapConfirmed(android.view.MotionEvent e17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(e17, "e");
        this.f418559d.d(new ng3.p(ng3.t.f418580r, e17));
