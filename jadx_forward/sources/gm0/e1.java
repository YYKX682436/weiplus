...
public class e1 extends android.os.FileObserver {
    ...
    public void onEvent(int i17, java.lang.String str) {
        ...
        objArr[1] = str;
        java.io.File file = gm0.d1.f354710a;
        synchronized (gm0.d1.class) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.FileDisappearedObserver", str2);
            gm0.d1.f354710a.mkdirs();
            try {
                java.io.File file2 = gm0.d1.f354711b;
                if (!file2.exists()) {
                    file2.createNewFile();
                }
            ...
            com.p314xaae8f345.mm.vfs.w6.R(gm0.d1.f354711b.getAbsolutePath(), str2.getBytes(java.nio.charset.StandardCharsets.UTF_8));
        }
        gm0.i1 i1Var = this.f354715a;
        if (i1Var != null) {
