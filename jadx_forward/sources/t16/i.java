...
public final class i {
    ...
    public static final t16.i f496148a = new t16.i();
    ...
    public final t16.b a(java.util.List list, o06.v0 v0Var, l06.r rVar) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(r17, "getPrimitiveArrayKotlinType(...)");
    ...
    public final t16.g b(java.lang.Object obj, o06.v0 v0Var) {
        ...
        if (obj instanceof byte[]) {
            return a(kz5.z.v0((byte[]) obj), v0Var, l06.r.f396431n);
        }
        ...
        if (z17) {
            ...
            return a(r27, v0Var, l06.r.f396432o);
        }
        if (obj instanceof int[]) {
            return a(kz5.z.x0((int[]) obj), v0Var, l06.r.f396433p);
        }
        if (obj instanceof long[]) {
            return a(kz5.z.y0((long[]) obj), v0Var, l06.r.f396435r);
        }
        if (obj instanceof char[]) {
            ...
            return a(r27, v0Var, l06.r.f396430m);
        }
        if (obj instanceof float[]) {
            return a(kz5.z.w0((float[]) obj), v0Var, l06.r.f396434q);
        }
        if (obj instanceof double[]) {
            ...
            return a(r27, v0Var, l06.r.f396436s);
        }
        ...
        return a(r27, v0Var, l06.r.f396429i);
    }
}
