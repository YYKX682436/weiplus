...
public final class g extends h.b {
    ...
    public final int f423949a;

    /* renamed from: b, reason: collision with root package name */
    public final int f423950b;
    ...
    */
    ...
    public final java.util.List d(java.util.ArrayList arrayList) {
        if (arrayList == null || arrayList.size() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.GalleryFeatureService", "no image selected");
            return kz5.p0.f395529d;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.GalleryFeatureService", "handleImages size=" + arrayList.size());
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        java.util.Iterator it = arrayList.iterator();
        while (it.hasNext()) {
            arrayList2.add(new qc0.l1(qc0.n1.f442951e, (java.lang.String) it.next(), null, 0L, null, null, 0L, false, 0, 0L, null, null, 4092, null));
        }
        return arrayList2;
    }
}
