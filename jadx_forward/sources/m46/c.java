...
public abstract class c {
    ...
    public static final byte[] f405000a = {-3, 55, 122, 88, 90, 0};

    /* renamed from: b, reason: collision with root package name */
    public static volatile m46.b f405001b;
    ...
    static {
        ...
        if (!(!r46.i.f474040a)) {
            f405001b = bVar;
        } else if (f405001b == bVar) {
            try {
                m46.a.b(null, 0);
            } catch (java.lang.NoClassDefFoundError unused) {
                z17 = false;
            }
            f405001b = z17 ? m46.b.CACHED_AVAILABLE : m46.b.CACHED_UNAVAILABLE;
        }
    }
}
