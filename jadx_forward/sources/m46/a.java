...
public class a extends a46.b {
    ...
    public final java.io.InputStream f404995e;

    public a(java.io.InputStream inputStream, boolean z17, int i17) {
        r46.g gVar = new r46.g(inputStream);
        if (z17) {
            this.f404995e = new org.tukaani.xz.XZInputStream(gVar, i17);
        } else {
            this.f404995e = new org.tukaani.xz.SingleXZInputStream(gVar, i17);
        }
    }
    ...
    public int available() {
        return this.f404995e.available();
    }
    ...
    public long skip(long j17) {
        try {
            return r46.h.b(this.f404995e, j17);
        } catch (org.tukaani.xz.MemoryLimitException e17) {
            throw new z36.a(e17.getMemoryNeeded(), e17.getMemoryLimit(), e17);
        }
    }
    ...
    public int read(byte[] bArr, int i17, int i18) {
        ...
        try {
            int read = this.f404995e.read(bArr, i17, i18);
            a(read);
            return read;
        } catch (org.tukaani.xz.MemoryLimitException e17) {
            throw new z36.a(e17.getMemoryNeeded(), e17.getMemoryLimit(), e17);
