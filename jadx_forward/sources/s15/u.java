...
public class u extends e14.k {
    ...
    public u() {
        ...
        this.f483713d = mo75927x8ded05a8;
        super.m126741x8589bfe1("RecordFinderTopicLocationItem");
    ...
    public void j(float f17) {
        super.set(this.f483713d + 2, java.lang.Float.valueOf(f17));
    }

    public void k(float f17) {
        super.set(this.f483713d + 1, java.lang.Float.valueOf(f17));
    }

    public void l(java.lang.String str) {
        super.set(this.f483713d + 0, str);
    }
}
