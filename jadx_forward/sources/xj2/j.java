...
public final class j extends wj2.w implements android.view.View.OnClickListener {
    ...
    @Override // wj2.w
    public void R() {
        this.K.f343563a.setBackground(o() ? getContext().getResources().getDrawable(com.p314xaae8f345.mm.R.C30861xcebc809e.cq6) : getContext().getResources().getDrawable(com.p314xaae8f345.mm.R.C30861xcebc809e.f563335cq5));
    }
    ...
    public void l(pm2.a widgetMode, xh2.a data) {
        ...
        this.f536375J = data.f536054b.f536086e;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        if (valueOf != null && valueOf.intValue() == id6) {
            if (zl2.r4.f555483a.w1()) {
                if (o() && m174009x3a33aac1().a0().o() && (m145850xf6df7a5e = m145850xf6df7a5e()) != null && (m174010xb411027f = m174010xb411027f()) != null) {
                    m174010xb411027f.e(m145850xf6df7a5e);
                }
            } else if (o()) {
                lj2.x0 m174010xb411027f2 = m174010xb411027f();
                if (m174010xb411027f2 != null) {
                    m174010xb411027f2.S(this.f536375J);
                }
            } else {
                km2.q qVar = (km2.q) kz5.n0.Z(m174009x3a33aac1().a0().g());
                if (qVar != null) {
                    db5.t7.m123883x26a183b(getContext(), getContext().getResources().getString(com.p314xaae8f345.mm.R.C30867xcad56011.m8q, qVar.f390706d), 1).show();
                }
            }
        }
