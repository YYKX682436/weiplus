...
public abstract class b0 {
    public static final java.util.Collection a(java.util.Collection collection, yz5.l descriptorByHandle) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(descriptorByHandle, "descriptorByHandle");
        ...
        while (!linkedList.isEmpty()) {
            ...
            if (((java.util.ArrayList) g17).size() == 1 && a18.isEmpty()) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(y07, "single(...)");
                a17.add(y07);
            } else {
                java.lang.Object s17 = r16.x.s(g17, descriptorByHandle);
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(s17, "selectMostSpecificMember(...)");
                o06.b bVar = (o06.b) descriptorByHandle.mo146xb9724478(s17);
                for (java.lang.Object obj : g17) {
                    p3321xbce91901.jvm.p3324x21ffc6bd.o.d(obj);
                    if (!r16.x.k(bVar, (o06.b) descriptorByHandle.mo146xb9724478(obj))) {
                        a18.add(obj);
                    }
                }
                if (!a18.isEmpty()) {
