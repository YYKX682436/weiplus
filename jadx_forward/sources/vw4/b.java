...
public final class b {
    ...
    public static final vw4.b f522745a = new vw4.b();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Set f522746b;
    ...
    public final void a(java.lang.String str) {
        ...
        java.util.Set set = f522746b;
        synchronized (set) {
            ((java.util.HashSet) set).add(str);
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("AdH5URLManager", "addDisableUrl, url=" + str);
    }
    ...
    public final boolean c() {
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.WebViewHighRiskAdH5Interceptor", "isInterceptEnabled, expt=" + Ni);
            return Ni > 0;
        } catch (java.lang.Throwable th6) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.WebViewHighRiskAdH5Interceptor", "isInterceptEnabled, exp=" + th6);
            return false;
        }
    }
