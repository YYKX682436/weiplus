...
public final class r2 extends android.text.style.ClickableSpan {
    ...
    public final /* synthetic */ dk2.zf f344999d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ fk2.s2 f345000e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f345001f;

    public r2(dk2.zf zfVar, fk2.s2 s2Var, android.content.Context context) {
        this.f344999d = zfVar;
        this.f345000e = s2Var;
        this.f345001f = context;
    }
    ...
    public void onClick(android.view.View widget) {
        ...
        if (zfVar instanceof dk2.la) {
            ...
            java.lang.String m75945x2fec8307 = ((r45.ak1) D).m75945x2fec8307(0);
            if (m75945x2fec8307 != null) {
                this.f345000e.q(this.f345001f, m75945x2fec8307);
            }
        }
    ...
    public void updateDrawState(android.text.TextPaint ds6) {
        ...
        ds6.setColor(this.f345001f.getResources().getColor(com.p314xaae8f345.mm.R.C30859x5a72f63.f560583od));
