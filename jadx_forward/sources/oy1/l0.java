...
public final class l0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.net.ConnectivityManager f431417d;

    public l0(android.net.ConnectivityManager connectivityManager) {
        this.f431417d = connectivityManager;
    }
    ...
    */
    public final void run() {
        /*
            r3 = this;
            android.net.ConnectivityManager r0 = r3.f431417d
        ...
        L1d:
            ...
            java.util.concurrent.atomic.AtomicBoolean r0 = qy1.g.f449259b
            r0.set(r2)
