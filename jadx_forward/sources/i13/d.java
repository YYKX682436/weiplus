...
public final class d extends com.p314xaae8f345.mm.p944x882e457a.i {
    ...
    public void x(int i17, int i18, java.lang.String str, com.p314xaae8f345.mm.p2495xc50a8b8b.f fVar, com.p314xaae8f345.mm.p944x882e457a.m1 m1Var) {
        ...
        java.lang.String str2 = this.f368811m;
        if (!a17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(str2, "account nor ready");
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(str2, "CgiAcceptForceNotify errType:%d, errCode:%d, errMsg:%s", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18), str);
        if (i17 == 0 && i18 == 0) {
            return;
        }
