...
public abstract class e {
    ...
    public static final byte[] f404919a;

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.String[] f404920b = new java.lang.String[0];

    /* renamed from: c, reason: collision with root package name */
    public static final l36.c1 f404921c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.nio.charset.Charset f404922d;

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.TimeZone f404923e;

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.Comparator f404924f;

    /* renamed from: g, reason: collision with root package name */
    public static final java.lang.reflect.Method f404925g;

    /* renamed from: h, reason: collision with root package name */
    public static final java.util.regex.Pattern f404926h;
    ...
    static {
        ...
        f404921c = new l36.b1(null, j17, kVar);
        ...
        x36.o.j("0000ffff");
        x36.o.j("ffff0000");
        f404922d = java.nio.charset.Charset.forName(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c);
        java.nio.charset.Charset.forName(com.p314xaae8f345.p347x615374d.p349x208df1fe.app.C3125x9fd75533.f11976x3730806a);
        ...
        f404923e = java.util.TimeZone.getTimeZone("GMT");
        f404924f = new m36.c();
        try {
        ...
        f404925g = method;
        f404926h = java.util.regex.Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");
    }
    ...
    */
    ...
    public static java.lang.String k(l36.k0 k0Var, boolean z17) {
        boolean contains = k0Var.f397067d.contains(":");
        java.lang.String str = k0Var.f397067d;
        if (contains) {
            str = "[" + str + "]";
        }
        int i17 = k0Var.f397068e;
        if (!z17 && i17 == l36.k0.c(k0Var.f397064a)) {
            return str;
        }
        return str + ":" + i17;
    }
    ...
    public static boolean q(x36.h0 h0Var, int i17, java.util.concurrent.TimeUnit timeUnit) {
        ...
        try {
            ...
            if (c17 == com.p314xaae8f345.p3121x37984a.p3125x2eaf9f.C26918x6e83759b.f58001x610e5697) {
                h0Var.h().a();
                return true;
            }
    ...
    public static l36.i0 t(java.util.List list) {
        ...
        while (it.hasNext()) {
            ...
            java.lang.String u17 = cVar.f450887a.u();
            java.lang.String u18 = cVar.f450888b.u();
