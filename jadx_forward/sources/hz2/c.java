...
public final class c implements com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.w1 {
    ...
    public final /* synthetic */ java.lang.String f367844a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f367845b;

    public c(java.lang.String str, android.content.Context context) {
        this.f367844a = str;
        this.f367845b = context;
    }

    @Override // com.p314xaae8f345.mm.ui.p2747xd1075a44.p2757xb099fd48.w1
    public final void a(boolean z17, java.lang.String str) {
        if (z17) {
            java.lang.String linkUrl = this.f367844a;
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(linkUrl, "$linkUrl");
            if (linkUrl.length() > 0) {
                android.content.Intent intent = new android.content.Intent();
                intent.putExtra("rawUrl", linkUrl);
                j45.l.j(this.f367845b, "webview", ".ui.tools.WebViewUI", intent, null);
            }
        }
    }
}
