...
public final class t8 {
    ...
    /* renamed from: a */
    public static final te2.t8 f499973a = new te2.t8();

    /* renamed from: b */
    public static int f499974b;
    ...
    public final void a(int i17, int i18, int i19, boolean z17) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("FinderLivePauseReportHelper", "report curType:" + f499974b + " type:" + i17 + ",time:" + i18 + ", uiState:" + i19 + ", miniWindow:" + z17 + ", isAnchor:" + w17);
        if (w17 || i17 == f499974b) {
            return;
        }
