...
public class d {
    ...
    public final java.lang.String f544465a;

    /* renamed from: b, reason: collision with root package name */
    public final java.io.OutputStream f544466b;
    ...
    public d(java.lang.String str, int i17, int i18, int i19) {
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.PcmWriter", "create file failed: " + e17.getMessage());
        }
    }
    ...
    public void a() {
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.PcmWriter", "close file failed: " + e17.getMessage());
        }
        int i17 = 0;
        i17 = 0;
        i17 = 0;
        ...
        try {
            try {
                randomAccessFile = com.p314xaae8f345.mm.vfs.w6.B(this.f544465a, true);
                randomAccessFile.seek(4L);
                java.nio.ByteBuffer allocate = java.nio.ByteBuffer.allocate(4);
                allocate.order(java.nio.ByteOrder.LITTLE_ENDIAN);
                allocate.putInt(this.f544467c - 8);
                randomAccessFile.write(allocate.array());
                allocate.rewind();
                allocate.putInt(this.f544467c - 42);
                ...
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.PcmWriter", e18, "", r27);
                    i17 = r27;
                ...
                if (randomAccessFile != null) {
                    try {
                        ...
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.PcmWriter", e19, "", new java.lang.Object[i17]);
                    }
                }
                throw th6;
            }
        } catch (java.io.FileNotFoundException e27) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.PcmWriter", e27, "", new java.lang.Object[0]);
            randomAccessFile = randomAccessFile;
            if (randomAccessFile != null) {
                try {
                    randomAccessFile.close();
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.PcmWriter", e28, "", r28);
                    i17 = r28;
                    randomAccessFile = e28;
                }
            }
        } catch (java.io.IOException e29) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.PcmWriter", e29, "", new java.lang.Object[0]);
            randomAccessFile = randomAccessFile;
            if (randomAccessFile != null) {
                try {
                    randomAccessFile.close();
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.PcmWriter", e37, "", r29);
                    i17 = r29;
    ...
    public boolean b(byte[] bArr, int i17) {
        java.io.OutputStream outputStream = this.f544466b;
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.PcmWriter", "write to file failed: " + e17.getMessage());
            return false;
        }
    }
}
