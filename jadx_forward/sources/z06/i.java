...
public class i extends r06.f1 implements z06.a {
    ...
    public java.lang.Object B(o06.a aVar) {
        jz5.l lVar = this.I;
        if (lVar == null || !((o06.a) lVar.f384366d).equals(aVar)) {
            return null;
        }
        return lVar.f384367e;
    }

    @Override // r06.f1, o06.m2
    public boolean C() {
        f26.o0 type = mo132802xfb85f7b0();
        if (!this.H) {
            return false;
        }
        ...
        p06.k kVar = f16.g1.f340261a;
        g26.w wVar = g26.w.f349551a;
        n16.c ENHANCED_NULLABILITY_ANNOTATION = x06.p0.f532832p;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(ENHANCED_NULLABILITY_ANNOTATION, "ENHANCED_NULLABILITY_ANNOTATION");
    ...
    public z06.a L(f26.o0 o0Var, java.util.List list, f26.o0 o0Var2, jz5.l lVar) {
        ...
        z06.i iVar = new z06.i(e(), mo9601xa083c1ee(), f(), mo9617x61f71b08(), this.f450073i, mo132800xfb82e301(), mo9602x2fa78b11(), a17, j(), this.H, lVar);
        r06.g1 g1Var2 = this.D;
        if (g1Var2 != null) {
            g1Var = r14;
            r06.g1 g1Var3 = new r06.g1(iVar, g1Var2.mo9601xa083c1ee(), g1Var2.f(), g1Var2.mo9617x61f71b08(), g1Var2.f449915h, g1Var2.f449916i, g1Var2.f449919o, j(), a17 == null ? null : a17.c(), g1Var2.mo9602x2fa78b11());
            g1Var.f449922r = g1Var2.f449922r;
            g1Var.w0(o0Var2);
        } else {
            g1Var = null;
        }
        ...
        if (aVar != null) {
            ...
            r06.h1 h1Var2 = new r06.h1(iVar, ((p06.b) aVar).mo9601xa083c1ee(), d1Var.f(), d1Var.mo9617x61f71b08(), d1Var.f449915h, d1Var.f449916i, d1Var.f449919o, j(), a17 == null ? null : a17.b(), ((r06.w) aVar).mo9602x2fa78b11());
            h1Var2.f449922r = h1Var2.f449922r;
            o06.l2 l2Var = (o06.l2) ((r06.h1) aVar).W().get(0);
            if (l2Var == null) {
                r06.h1.G(6);
                throw null;
            }
            h1Var2.f449960s = l2Var;
            h1Var = h1Var2;
        } else {
            h1Var = null;
        }
        iVar.y0(g1Var, h1Var, this.F, this.G);
        yz5.a aVar2 = this.f450075n;
        if (aVar2 != null) {
            iVar.s0(this.f450074m, aVar2);
        }
        iVar.M(i());
        iVar.A0(o0Var2, mo132803xb121b9ba(), this.A, o0Var == null ? null : r16.h.h(this, o0Var, p06.i.f432298a), kz5.p0.f395529d);
        return iVar;
    }
    ...
    public r06.f1 w0(o06.m mVar, o06.t0 t0Var, o06.g0 g0Var, o06.o1 o1Var, o06.c cVar, n16.g gVar, o06.x1 x1Var) {
        ...
        if (x1Var != null) {
            return new z06.i(mVar, mo9601xa083c1ee(), t0Var, g0Var, this.f450073i, gVar, x1Var, o1Var, cVar, this.H, this.I);
        }
        G(18);
        throw null;
    }
