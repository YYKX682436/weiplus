...
public class m0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ ju5.n0 f383658d;
    ...
    public void run() {
        ju5.n0 n0Var = this.f383658d;
        n0Var.h(n0Var.f383664d, n0Var.f383666f);
        n0Var.getClass();
        try {
            android.content.SharedPreferences c17 = fu5.d.b().c();
            int i17 = c17.getInt(zt5.j.a().f557137a, -1);
            zt5.h.a("Soter.TaskInit", "soter: ask status: %d", java.lang.Integer.valueOf(i17));
            boolean z17 = i17 != 0;
            int[] iArr = n0Var.f383666f;
            if (z17 && wt5.a.h()) {
