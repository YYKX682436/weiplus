...
public class a {
    ...
    public final android.net.ConnectivityManager f523048a;

    public a(android.net.ConnectivityManager connectivityManager) {
        this.f523048a = connectivityManager;
    }
    ...
    public java.util.List b() {
        android.net.ConnectivityManager connectivityManager = this.f523048a;
