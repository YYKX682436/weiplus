...
public class e extends com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.f {
    ...
    public static final int f77260x366c91de = 372;

    /* renamed from: NAME */
    public static final java.lang.String f77261x24728b = "canvasGetImageData";
    ...
    public static java.util.Map C(int[] iArr, int i17, int i18) {
        ...
        hashMap.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26532xcd500876.f54772x9d04c306, wrap);
    ...
    public void A(com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.l lVar, org.json.JSONObject jSONObject, int i17) {
        ...
        try {
            ...
            if (Q == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.JsApiCanvasGetImageData", "invoke JsApi canvasGetImageData failed, component view is null.");
                lVar.a(i29, o("fail:page is null"));
                return;
            }
            android.view.View o17 = ((com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1170x34628f.ia) Q.M(jSONObject.optBoolean("independent", false))).o(i37);
            if (o17 == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.JsApiCanvasGetImageData", "view(%s) is null.", java.lang.Integer.valueOf(i37));
            ...
            if (!(o17 instanceof com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.p1083x760fdadc.C12072x6098f505)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.JsApiCanvasGetImageData", "the viewId is not a canvas(%s).", java.lang.Integer.valueOf(i37));
                lVar.a(i29, o("fail:illegal view type"));
                return;
            }
            android.view.View view2 = (android.view.View) ((com.p314xaae8f345.mm.p1006xc5476f33.p1026x45c4fe06.p1059x60b7c31.p1083x760fdadc.C12072x6098f505) o17).d(android.view.View.class);
            if (!(view2 instanceof h91.b)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.JsApiCanvasGetImageData", "the view is not a instance of CanvasView.(%s)", java.lang.Integer.valueOf(i37));
                lVar.a(i29, o("fail:illegal view type"));
                return;
            }
            float f17 = ik1.w.f();
            ...
            if (optInt3 == 0 || optInt4 == 0) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.JsApiCanvasGetImageData", "width(%s) or height(%s) is 0.(%s)", java.lang.Integer.valueOf(optInt3), java.lang.Integer.valueOf(optInt4), java.lang.Integer.valueOf(i37));
            ...
            try {
                ...
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.JsApiCanvasGetImageData", "getPixels failed, viewId(%s). Exception: %s", java.lang.Integer.valueOf(i37), e18);
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.JsApiCanvasGetImageData", "getPixels failed. finalXDp:%d finalYDp:%d finalWidthDp:%d finalHeightDp:%d wDp:%d data:%s", java.lang.Integer.valueOf(round5), java.lang.Integer.valueOf(round6), java.lang.Integer.valueOf(round7), java.lang.Integer.valueOf(round8), java.lang.Integer.valueOf(optInt3), jSONObject);
                    lVar.a(i17, o("fail: getPixels failed"));
                }
            } catch (java.lang.Exception e19) {
                e = e19;
                i29 = i17;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.JsApiCanvasGetImageData", "create bitmap failed, viewId(%s). Exception : %s", java.lang.Integer.valueOf(i37), e);
                lVar.a(i29, o("fail:create bitmap failed"));
            }
        } catch (org.json.JSONException e27) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.JsApiCanvasGetImageData", "get canvas id failed, %s", android.util.Log.getStackTraceString(e27));
