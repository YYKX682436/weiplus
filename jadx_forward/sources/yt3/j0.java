...
public final class j0 implements l45.m {
    ...
    public final /* synthetic */ yt3.p0 f547037a;
    ...
    public boolean a(xk0.p item) {
        ...
        this.f547037a.f547113e.w(ju3.c0.P, bundle);
        return true;
    }
    ...
    public void c(java.lang.Boolean bool) {
        ...
        yt3.p0 p0Var = this.f547037a;
        if (booleanValue) {
            ju3.d0.k(p0Var.f547113e, ju3.c0.V, null, 2, null);
        } else {
            ju3.d0.k(p0Var.f547113e, ju3.c0.W, null, 2, null);
        }
    }
}
