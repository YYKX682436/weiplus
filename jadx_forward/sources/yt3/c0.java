...
public final class c0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ yt3.d0 f546909d;
    ...
    public final void onClick(android.view.View view) {
        ...
        android.content.Context context = d0Var.f546930d.getContext();
        ...
        ct0.b bVar = d0Var.f546932f;
        if (bVar == null || (str = bVar.f303737a) == null) {
            str = bVar != null ? bVar.f303742f : null;
        }
        intent.putExtra("key_finder_post_sns_video_path", str);
        ct0.b bVar2 = d0Var.f546932f;
        intent.putExtra("key_finder_post_sns_video_duration_ms", bVar2 != null ? bVar2.f303741e : 0);
