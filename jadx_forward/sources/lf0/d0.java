...
public final class d0 extends i95.w implements pm4.t {
    ...
    public static final java.util.concurrent.ConcurrentHashMap f399734e = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.concurrent.ConcurrentHashMap f399735f = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: d, reason: collision with root package name */
    public java.lang.String f399736d = "";

    public static final void wi(lf0.d0 d0Var, java.lang.String str, org.json.JSONObject jSONObject) {
        d0Var.getClass();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("TopStoryLiteAppJsApiFeatureService", "[TopStoryLiteApp]did dispatch preloadK1KData: " + jSONObject);
        q80.g0 g0Var = (q80.g0) i95.n0.c(q80.g0.class);
        if (g0Var != null) {
            ((com.p314xaae8f345.mm.p689xc5a27af6.p753x32b0ae.i) g0Var).rj(str, "preloadK1KData", jSONObject);
        }
    }
    ...
    public void Ai(android.content.Context context, java.lang.String liteAppId, int i17, java.lang.String tabInfo, java.lang.String sessionId) {
        ...
        Bi.put(com.p314xaae8f345.p362xadfe2b3.p372x8fb0427b.C3712x3ed8a441.f14354xe2e3e984, sessionId);
        if (!((com.p314xaae8f345.mm.p689xc5a27af6.p753x32b0ae.i) ((q80.g0) i95.n0.c(q80.g0.class))).tk(liteAppId)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("TopStoryLiteAppJsApiFeatureService", "[TopStoryLiteApp] does not dispatch enterTopStory because store is not alive");
            return;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("TopStoryLiteAppJsApiFeatureService", "[TopStoryLiteApp]did dispatch enterTopStory: " + Bi);
        q80.g0 g0Var = (q80.g0) i95.n0.c(q80.g0.class);
        if (g0Var != null) {
            ((com.p314xaae8f345.mm.p689xc5a27af6.p753x32b0ae.i) g0Var).rj(liteAppId, "enterTopStory", Bi);
        }
    }
    ...
    public final org.json.JSONObject Bi(android.content.Context context) {
        ...
        jSONObject.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54548xbbf10811, 21);
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(f17, "genSessionId(...)");
        this.f399736d = f17;
        jSONObject.put(com.p314xaae8f345.p362xadfe2b3.p372x8fb0427b.C3712x3ed8a441.f14354xe2e3e984, f17);
        return jSONObject;
    }
    ...
    */
    public void Di(android.content.Context r16, java.lang.String r17, java.lang.String r18, boolean r19) {
        ...
        L53:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r2, r4, r0)
        L63:
            java.util.concurrent.ConcurrentHashMap r0 = lf0.d0.f399735f
        ...
        L77:
            ...
            q80.g0 r6 = (q80.g0) r6
            com.tencent.mm.feature.lite.i r6 = (com.p314xaae8f345.mm.p689xc5a27af6.p753x32b0ae.i) r6
            boolean r6 = r6.tk(r8)
            if (r6 == 0) goto La2
        ...
        La2:
            ...
            r1 = r0
            com.tencent.mm.feature.lite.i r1 = (com.p314xaae8f345.mm.p689xc5a27af6.p753x32b0ae.i) r1
            r3 = r10
            r4 = r11
            r5 = r12
            r7 = r14
