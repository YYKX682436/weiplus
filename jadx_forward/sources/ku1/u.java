...
public class u implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.view.View f393679d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f393680e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.widget.ImageView f393681f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ android.widget.Button f393682g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ android.view.ViewGroup f393683h;

    /* renamed from: i, reason: collision with root package name */
    public final /* synthetic */ tt1.j f393684i;

    /* renamed from: m, reason: collision with root package name */
    public final /* synthetic */ ku1.v f393685m;
    ...
    public u(ku1.v vVar, android.view.View view, android.view.View view2, android.widget.ImageView imageView, android.widget.Button button, android.view.ViewGroup viewGroup, tt1.j jVar) {
        ...
        this.f393679d = view;
        this.f393680e = view2;
        this.f393681f = imageView;
        this.f393682g = button;
        this.f393683h = viewGroup;
        this.f393684i = jVar;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        android.view.View view2 = this.f393679d;
        ...
        android.view.View view3 = this.f393680e;
        ...
        this.f393681f.setVisibility(0);
        this.f393682g.setVisibility(8);
        ku1.v vVar = this.f393685m;
        vVar.f393663a.l(lu1.e.CARDCODEREFRESHACTION_SNAPSHOT);
        vVar.i(this.f393683h, this.f393684i);
