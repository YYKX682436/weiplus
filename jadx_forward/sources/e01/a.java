...
public abstract class a {
    ...
    public final java.util.List f327371a = new java.util.ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f327372b = e();

    /* renamed from: c, reason: collision with root package name */
    public final java.lang.String[] f327373c = d();

    public void a(e01.g gVar) {
        java.util.List list = this.f327371a;
    ...
    public void b(java.lang.String str) {
        ...
        java.lang.String str2 = this.f327372b;
        sb6.append(str2);
        sb6.append(str);
        edit.remove(sb6.toString()).commit();
        java.lang.String[] strArr = this.f327373c;
        if (strArr != null) {
        ...
        java.util.Iterator it = ((java.util.ArrayList) this.f327371a).iterator();
        while (it.hasNext()) {
            ((e01.g) it.next()).b();
        }
    }
    ...
    public java.lang.String c(java.lang.String str, java.lang.String str2) {
        ...
        return D.getString(this.f327372b + str2 + str, null);
    }
    ...
    public void g(java.lang.String str, boolean z17, java.lang.String[] strArr) {
        ...
        java.lang.String[] strArr2 = this.f327373c;
