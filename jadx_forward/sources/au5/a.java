...
public class a extends au5.c {
    ...
    public zt5.k b() {
        ...
        if (m()) {
            try {
                java.security.KeyPairGenerator keyPairGenerator = java.security.KeyPairGenerator.getInstance("RSA", this.f95681b);
                keyPairGenerator.initialize(yt5.c.b(zt5.j.a().f557137a + ".addcounter.auto_signed_when_get_pubkey_attk", 16).c("SHA-256").d("PSS").a());
    ...
    public zt5.r d() {
        ...
        if (m()) {
            try {
                ...
                keyStore.load(null);
                try {
                    java.security.cert.Certificate[] certificateChain = keyStore.getCertificateChain(zt5.j.a().f557137a);
