...
public class a {
    ...
    public final java.util.Map f433292a = new java.util.HashMap();

    public final x51.k0 a(java.lang.String str) {
        if (u46.l.e(str)) {
            return null;
        }
        java.util.Map map = this.f433292a;
        ...
        if (k0Var == null) {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("EdgeComputingDBService", "[EdgeComputingDBService] getOrCreateDataDB getOrCreateDataDB throw Exception : " + e17.getMessage());
            }
            if (k0Var != null) {
    ...
    */
    public java.util.List b(java.lang.String r7, java.lang.String r8) {
        ...
        L8c:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(r2, r7)     // Catch: java.lang.Throwable -> L8a
            boolean r7 = r8.isClosed()
            if (r7 != 0) goto Lac
            goto L86
        Lac:
