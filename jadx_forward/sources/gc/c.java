...
public final class c {
    ...
    public static final gc.c f351616a = new gc.c();
    ...
    public final java.util.List a(java.util.List list, int i17, int i18, int i19, boolean z17) {
        ...
        for (java.util.List<gc.a> list2 : kz5.n0.N(list, i18)) {
            ...
            for (gc.a aVar : list2) {
                ...
                if (!(!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(rect, aVar.f351615c))) {
                    rect = null;
                }
                if (rect != null) {
                    aVar.f351615c = rect;
    ...
    public final java.util.List b(java.util.List layoutList, int i17, int i18, int i19) {
        int i27;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(layoutList, "layoutList");
        layoutList.size();
        ...
        if (F0.size() <= 4) {
            ...
            if (aVar != null) {
                ...
                gc.a aVar2 = p3321xbce91901.jvm.p3324x21ffc6bd.o.b(aVar.f351615c, rect) ^ true ? aVar : null;
                if (aVar2 != null) {
                    aVar2.f351615c = rect;
                    arrayList.add(aVar2);
                }
        ...
        for (java.lang.Object obj2 : subList) {
            ...
            if (i28 == i48) {
                ...
                if (!(p3321xbce91901.jvm.p3324x21ffc6bd.o.b(aVar3.f351615c, rect2) ^ z17)) {
                    aVar3 = null;
                }
                if (aVar3 != null) {
                    aVar3.f351615c = rect2;
                ...
                z17 = true;
                if (!(!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(aVar3.f351615c, rect3))) {
                    aVar3 = null;
                }
                if (aVar3 != null) {
                    aVar3.f351615c = rect3;
                    arrayList4.add(aVar3);
                }
                i58 += i37;
            }
