...
public final class e implements a2.o {
    ...
    public final a2.o1 f369387a;

    /* renamed from: b, reason: collision with root package name */
    public final f2.g f369388b;

    /* renamed from: c, reason: collision with root package name */
    public final i2.f f369389c;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.CharSequence f369390d;

    /* renamed from: e, reason: collision with root package name */
    public final b2.g f369391e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.List f369392f;

    /* renamed from: g, reason: collision with root package name */
    public final int f369393g;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:91:0x023c, code lost:
        ...
        if (p2.u.c(r6.f82328c) == false) goto L109;
     */
    ...
    */
    ...
    @Override // a2.o
    public boolean a() {
        java.util.ArrayList arrayList = (java.util.ArrayList) this.f369392f;
        int size = arrayList.size();
        for (int i17 = 0; i17 < size; i17++) {
            i2.i iVar = (i2.i) arrayList.get(i17);
            if (iVar.f369399a.mo128745x754a37bb() != iVar.f369400b) {
                return true;
            }
        }
        return false;
    ...
    @Override // a2.o
    public float b() {
        return ((java.lang.Number) this.f369391e.f98821b.mo141623x754a37bb()).floatValue();
    }

    @Override // a2.o
    public float c() {
        return ((java.lang.Number) this.f369391e.f98822c.mo141623x754a37bb()).floatValue();
    }
}
