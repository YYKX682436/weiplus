...
public abstract class c extends java.lang.Thread {
    ...
    public final sb.b f486922d;

    /* renamed from: e, reason: collision with root package name */
    public sb.i f486923e;

    /* renamed from: f, reason: collision with root package name */
    public java.net.HttpURLConnection f486924f;

    /* renamed from: g, reason: collision with root package name */
    public byte[] f486925g;

    public c() {
        sb.b bVar = new sb.b();
        this.f486922d = bVar;
        bVar.f486918g = new java.util.HashMap();
        bVar.f486915d = ub.b.b();
    }
    ...
    */
    ...
    public final void c(int i17, int i18, java.lang.Exception exc, java.lang.String str) {
        ...
        bVar.f486916e.endsWith("log_data");
        com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.i("APBaseHttpReq", getClass().getName() + " tryAgain reqTimes = " + bVar.f486920i + " tryTimes = " + bVar.f486921j);
        try {
            if (bVar.f486920i < bVar.f486921j) {
                bVar.a();
                b();
                return;
            }
            if (bVar.f486912a.equals("https://")) {
                for (java.lang.Throwable th6 = exc; th6 != null; th6 = th6.getCause()) {
                    ...
                    com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.e("APBaseHttpReq", "您的设备系统时间不正确，请更改");
                    sb.a aVar = (sb.a) this.f486923e;
                    aVar.f486911c.remove(aVar.f486909a);
                    aVar.a(this);
                    android.os.Message message = new android.os.Message();
                    message.what = 4;
                    message.obj = aVar;
                    aVar.f486910b.sendMessage(message);
                    return;
                }
            }
            sb.a aVar2 = (sb.a) this.f486923e;
            aVar2.f486911c.remove(aVar2.f486909a);
            aVar2.a(this);
            android.os.Message message2 = new android.os.Message();
            message2.what = 4;
            message2.obj = aVar2;
            aVar2.f486910b.sendMessage(message2);
            com.p314xaae8f345.p592x631407a.p595x2eaf0c.C4755x3b98095.i("APBaseHttpReq", str);
            exc.getClass();
        } catch (java.lang.Exception unused) {
        }
    }
