...
public final class p extends f4.o {
    ...
    public f4.e c(long j17, long j18, android.view.FrameMetrics frameMetrics) {
        ...
        return new f4.f(j17, metric, frameMetrics.getMetric(6) + metric + frameMetrics.getMetric(7), frameMetrics.getMetric(8) - frameMetrics.getMetric(13), metric > j18, uVar != null ? uVar.c(j17, j19) : kz5.p0.f395529d);
    }
}
