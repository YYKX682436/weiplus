...
public abstract class a {
    public static final boolean a(java.util.List list) {
        ...
        if (list2.size() == 1) {
            j17 = ((d1.e) kz5.n0.X(list2)).f307160a;
        } else {
            if (list2.isEmpty()) {
            ...
            if (1 <= h18) {
                int i18 = 1;
                while (true) {
                    X = new d1.e(d1.e.f(((d1.e) X).f307160a, ((d1.e) list2.get(i18)).f307160a));
                    if (i18 == h18) {
                        break;
                    }
                    i18++;
    ...
    public static final boolean b(y1.y yVar) {
        ...
        return (y1.m.a(f17, y1.i0.f540257f) == null && y1.m.a(yVar.f(), y1.i0.f540256e) == null) ? false : true;
    }

    public static final void c(y1.y node, o3.l info) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(node, "node");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(info, "info");
        p001xcca8366f.p003x91727fcf.v4.p009x62f6fe4.f.a(y1.m.a(node.f(), y1.i0.f540258g));
        y1.y g17 = node.g();
        if (g17 == null || y1.m.a(g17.f(), y1.i0.f540256e) == null) {
            return;
        }
        y1.b bVar = (y1.b) y1.m.a(g17.f(), y1.i0.f540257f);
        if (bVar != null) {
            if (bVar.f540228a < 0 || bVar.f540229b < 0) {
                return;
            }
        }
        if (node.f().d(y1.i0.f540273v)) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            java.util.List h17 = g17.h();
            int size = h17.size();
            for (int i17 = 0; i17 < size; i17++) {
                y1.y yVar = (y1.y) h17.get(i17);
                if (yVar.f().d(y1.i0.f540273v)) {
                    arrayList.add(yVar);
                }
            }
            if (!arrayList.isEmpty()) {
                ...
                for (int i18 = 0; i18 < size2; i18++) {
                    ...
                    if (yVar2.f540333f == node.f540333f) {
                        int i19 = a17 ? 0 : i18;
                        int i27 = a17 ? i18 : 0;
                        y1.l f17 = yVar2.f();
                        y1.o0 key = y1.i0.f540273v;
                        f17.getClass();
                        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(key, "key");
                        java.lang.Object obj = ((java.util.LinkedHashMap) f17.f540299d).get(key);
                        if (obj == null) {
