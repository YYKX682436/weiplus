...
public abstract class c {
    ...
    public static final com.p314xaae8f345.mm.sdk.p2603x2137b148.c5 f497944a = new com.p314xaae8f345.mm.sdk.p2603x2137b148.c5();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.HashMap f497945b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.HashMap f497946c = new java.util.HashMap();

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.HashMap f497947d = new java.util.HashMap();

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.HashMap f497948e = new java.util.HashMap();

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.HashMap f497949f = new java.util.HashMap();

    public static java.lang.String a(java.lang.String str) {
        java.util.HashMap hashMap = f497946c;
        if (hashMap.size() == 0) {
            k();
        }
        if (m(str)) {
    ...
    public static java.lang.String c(java.lang.String str) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(a17)) {
            e17 = com.p314xaae8f345.mm.sdk.p2603x2137b148.c5.e(i17);
        } else {
            java.lang.String substring = o(i18).substring(a17.length());
            java.lang.String f17 = f497944a.f(a17, substring);
    ...
    */
    ...
    public static java.lang.String g(java.lang.String str) {
        java.util.HashMap hashMap = f497948e;
        if (hashMap.size() == 0) {
            k();
        }
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
    ...
    */
    public static java.lang.String h() {
        ...
        L49:
            c01.fb r0 = c01.fb.a()
            java.lang.String r0 = r0.f118726g
        ...
        L72:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r5, r1, r2)
            java.lang.String r1 = "+"
    ...
    public static int i(java.lang.String str, java.lang.String str2) {
        ...
        if (!j35.u.d(context, "android.permission.READ_CONTACTS", true)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "no contact permission");
            return -1;
        }
        ...
        try {
            try {
                ...
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "getPhoneTypeByContactIdAndPhoneNumber error: %s", e17.getMessage());
            }
            return -1;
        } finally {
            query.close();
    ...
    public static void k() {
        ...
        try {
            try {
                inputStream = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a.getAssets().open("ipcall_country_code.txt");
                ...
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "exception:%s", com.p314xaae8f345.mm.sdk.p2603x2137b148.z3.c(e17));
                }
            } catch (java.io.IOException e18) {
                boolean z18 = com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.f274522a;
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "exception:%s", com.p314xaae8f345.mm.sdk.p2603x2137b148.z3.c(e18));
                if (inputStream != null) {
                    try {
                        inputStream.close();
                    } catch (java.io.IOException e19) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "exception:%s", com.p314xaae8f345.mm.sdk.p2603x2137b148.z3.c(e19));
                    }
                }
                str = "";
            }
            ...
            for (int i17 = 0; i17 < split.length; i17++) {
                ...
                if (split2.length < 2) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "this country item has problem %s", split[i17]);
                } else {
                    t83.d dVar = new t83.d();
                    dVar.f497950a = split2[0];
                    dVar.f497951b = split2[1];
                    java.lang.String l17 = com.p314xaae8f345.mm.p2621x8fb0427b.ha.k().l(split2[0]);
                    if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(l17)) {
                        l17 = new java.util.Locale("", split2[0]).getDisplayCountry(com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274608e.getConfiguration().locale);
                    }
                    dVar.f497952c = l17;
                    f497948e.put(dVar.f497951b, dVar.f497950a);
                    f497949f.put(dVar.f497950a, dVar.f497951b);
                    f497946c.put(dVar.f497951b, dVar.f497952c);
                    f497947d.put(dVar.f497952c, dVar.f497951b);
                    f497945b.put(dVar.f497950a, dVar);
                }
            }
            ...
            if (inputStream != null) {
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.IPCallAddressUtil", "exception:%s", com.p314xaae8f345.mm.sdk.p2603x2137b148.z3.c(e27));
                }
            }
            throw th6;
        }
    ...
    public static java.lang.String n(int i17) {
        android.content.Context context = com.p314xaae8f345.mm.sdk.p2603x2137b148.x2.f274604a;
        return i17 != 1 ? i17 != 2 ? i17 != 4 ? i17 != 5 ? i17 != 10 ? context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.f574234hi2) : context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.hhx) : context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.f574232hi0) : context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.hhy) : context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.f574233hi1) : context.getString(com.p314xaae8f345.mm.R.C30867xcad56011.hhz);
    }

    public static java.lang.String o(java.lang.String str) {
        return !com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str) ? str.startsWith("+") ? str.substring(1) : str.startsWith("00") ? str.substring(2) : str : str;
    }
}
