...
public abstract class f extends g75.t {
    ...
    public static final java.util.concurrent.ConcurrentHashMap f350895c = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    public final jz5.g f350896b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(g75.r pipeline) {
        super(pipeline);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(pipeline, "pipeline");
        this.f350896b = jz5.h.b(g75.a.f350879d);
    }
    ...
    public void d() {
        ...
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = f350895c;
    ...
    public final void j(j75.b bVar, boolean z17) {
        ...
        if (z18) {
            ...
            g75.z data = ((g75.a0) bVar).f350880b;
        ...
        g75.z data2 = ((g75.v) bVar).f350935b;
