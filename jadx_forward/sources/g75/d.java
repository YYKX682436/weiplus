...
public final class d extends p3321xbce91901.jvm.p3324x21ffc6bd.q implements yz5.l {
    ...
    public final /* synthetic */ g75.f f350891d;
            ...
            while (true) {
                ...
                if (i17 < length) {
                    ...
                    if (method.isAnnotationPresent(h75.a.class) && method.getParameterTypes().length == 2) {
                        ...
                        if (!g75.z.class.isAssignableFrom(cls) || p3321xbce91901.jvm.p3324x21ffc6bd.o.b(j75.b.class, cls2) || !j75.b.class.isAssignableFrom(cls2) || !j75.b.class.isAssignableFrom(returnType)) {
                            break;
                        }
                        ((java.util.HashMap) ((jz5.n) gVar).mo141623x754a37bb()).put(cls2.getName(), method);
                    }
                    i17++;
                } else {
                    java.lang.System.currentTimeMillis();
