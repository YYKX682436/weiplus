...
public final class w {
    ...
    public final p75.m a(p75.m condition) {
        ...
        java.lang.String[] FILTER_ARRAY_MAIN = c01.e2.f118653d;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(FILTER_ARRAY_MAIN, "FILTER_ARRAY_MAIN");
    ...
    public final java.util.List b() {
        ...
        g17.f434190d = dm.i2.W.j("message_fold");
        p75.l0 a17 = g17.a();
        java.util.ArrayList arrayList = new java.util.ArrayList();
        l75.k0 k0Var = gm0.j1.u().f354686f;
        if (k0Var != null && (B = k0Var.B(a17.f434169a, a17.f434170b)) != null) {
            while (B.moveToNext()) {
                try {
    ...
    public final int c() {
        ...
        p75.i0 g17 = n0Var.g(kz5.b0.c(new p75.j(dm.i4.f66875xa013b0d5, "string", n0Var.f434209a, "", "count")));
        g17.f434190d = dm.i2.W.j("message_fold");
        p75.l0 a17 = g17.a();
        l75.k0 k0Var = gm0.j1.u().f354686f;
        if (k0Var != null && (B = k0Var.B(a17.f434169a, a17.f434170b)) != null) {
    ...
    public final java.util.List d(java.util.List columns, java.util.List usernameList) {
        ...
        g17.f434190d = dm.i2.L.l(usernameList);
        p75.l0 a17 = g17.a();
        java.util.HashMap hashMap = new java.util.HashMap();
        java.util.ArrayList arrayList = new java.util.ArrayList();
        for (com.p314xaae8f345.mm.p2621x8fb0427b.l4 l4Var : a17.k(gm0.j1.u().f354686f, com.p314xaae8f345.mm.p2621x8fb0427b.l4.class)) {
        ...
        while (it.hasNext()) {
            com.p314xaae8f345.mm.p2621x8fb0427b.l4 l4Var2 = (com.p314xaae8f345.mm.p2621x8fb0427b.l4) hashMap.get((java.lang.String) it.next());
            if (l4Var2 != null) {
    ...
    public final int e(java.lang.String username, java.lang.String str, int i17) {
        ...
        contentValues.put(dm.i2.W.f434158a, str);
        contentValues.put(dm.i2.X.f434158a, java.lang.Integer.valueOf(i17));
        p75.h1 j17 = n0Var.j(contentValues);
        j17.f434184c = dm.i2.L.j(username);
        int f17 = j17.a().f(gm0.j1.u().f354686f);
    ...
    public final int f(java.util.List userNames, java.lang.String parentRef) {
        ...
        p75.n0 n0Var = dm.i2.K;
        android.content.ContentValues contentValues = new android.content.ContentValues();
        contentValues.put(dm.i2.W.f434158a, parentRef);
        p75.h1 j17 = n0Var.j(contentValues);
        j17.f434184c = dm.i2.L.l(userNames);
        int f17 = j17.a().f(gm0.j1.u().f354686f);
        com.p314xaae8f345.mm.p2621x8fb0427b.m4 Di = ((com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Di();
        if ((Di instanceof l75.a1) && f17 > 0) {
