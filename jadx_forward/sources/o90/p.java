...
public final class p implements hm0.w {
    ...
    */
    public void mo1990xde9f63df(int r10) {
        /*
            r9 = this;
        ...
        L25:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r6, r7)     // Catch: java.lang.Exception -> L79
            r6 = 2
            if (r3 != 0) goto L49
            java.lang.String r3 = lh3.n.f400220p     // Catch: java.lang.Exception -> L79
            ...
            java.lang.String r8 = lh3.n.f400220p     // Catch: java.lang.Exception -> L79
            r7[r2] = r8     // Catch: java.lang.Exception -> L79
            r7[r4] = r5     // Catch: java.lang.Exception -> L79
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r3, r7)     // Catch: java.lang.Exception -> L79
            lh3.n.f400220p = r5     // Catch: java.lang.Exception -> L79
            goto L64
        L49:
            java.lang.String r3 = r10.Ri()     // Catch: java.lang.Exception -> L79
            java.lang.String r5 = lh3.n.f400221q     // Catch: java.lang.Exception -> L79
            boolean r5 = r3.equals(r5)     // Catch: java.lang.Exception -> L79
            if (r5 != 0) goto L66
            java.lang.String r5 = "clientIp change old[%s] new[%s]"
            java.lang.Object[] r7 = new java.lang.Object[r6]     // Catch: java.lang.Exception -> L79
            java.lang.String r8 = lh3.n.f400221q     // Catch: java.lang.Exception -> L79
            r7[r2] = r8     // Catch: java.lang.Exception -> L79
            r7[r4] = r3     // Catch: java.lang.Exception -> L79
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r1, r5, r7)     // Catch: java.lang.Exception -> L79
            lh3.n.f400221q = r3     // Catch: java.lang.Exception -> L79
        L64:
            r3 = r4
            goto L67
        L66:
        ...
        L67:
            if (r3 == 0) goto L73
            r10.f400222d = r2     // Catch: java.lang.Exception -> L79
            r3 = 0
            r10.f400226h = r3     // Catch: java.lang.Exception -> L79
            r10.wi(r6)     // Catch: java.lang.Exception -> L79
            goto L7f
        L73:
            int r3 = r10.f400223e     // Catch: java.lang.Exception -> L79
            r10.Di(r3, r4)     // Catch: java.lang.Exception -> L79
            goto L7f
        L79:
            r10 = move-exception
            java.lang.Object[] r2 = new java.lang.Object[r2]
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35(r1, r10, r0, r2)
        L7f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: o90.p.mo1990xde9f63df(int):void");
    }
}
