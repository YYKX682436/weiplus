...
public final class j {
    ...
    public static final u24.j f505658a = new u24.j();
    ...
    public final a24.t a(java.util.List items) {
        ...
        while (it6.hasNext()) {
            ...
            if (tVar2 != null) {
                ...
                if (p3321xbce91901.jvm.p3324x21ffc6bd.o.b(tVar2.f82439b.getClass(), com.p314xaae8f345.mm.p1006xc5476f33.p2051x765f0e50.ui.p2060xf8bc3f31.p2062x5582bc23.C17523x8c728888.class)) {
                    tVar2.f82438a = null;
                    obj = jz5.f0.f384359a;
                } else {
                    a24.t tVar3 = (a24.t) linkedHashMap.get(a76);
                    tVar2.f82438a = tVar3;
                    if (tVar3 == null || (list = tVar3.f82440c) == null) {
                        tVar2 = tVar;
                        obj = null;
                    } else {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MircoMsg.NodeUtil", "nodeMap[item.key] is null");
        }
        if (tVar == null) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MircoMsg.NodeUtil", "checkTree: node is null");
        }
        return tVar;
    }
}
