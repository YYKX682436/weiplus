...
public abstract class j0 {
    public static float[] a(float[] values, int i17, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
        if ((i17 & 1) != 0) {
    ...
    public static final void c(float[] fArr, d1.d rect) {
        ...
        long b17 = b(fArr, d1.f.a(rect.f307152a, rect.f307153b));
        long b18 = b(fArr, d1.f.a(rect.f307152a, rect.f307155d));
        long b19 = b(fArr, d1.f.a(rect.f307154c, rect.f307153b));
        long b27 = b(fArr, d1.f.a(rect.f307154c, rect.f307155d));
        rect.f307152a = java.lang.Math.min(java.lang.Math.min(d1.e.c(b17), d1.e.c(b18)), java.lang.Math.min(d1.e.c(b19), d1.e.c(b27)));
        rect.f307153b = java.lang.Math.min(java.lang.Math.min(d1.e.d(b17), d1.e.d(b18)), java.lang.Math.min(d1.e.d(b19), d1.e.d(b27)));
        rect.f307154c = java.lang.Math.max(java.lang.Math.max(d1.e.c(b17), d1.e.c(b18)), java.lang.Math.max(d1.e.c(b19), d1.e.c(b27)));
        rect.f307155d = java.lang.Math.max(java.lang.Math.max(d1.e.d(b17), d1.e.d(b18)), java.lang.Math.max(d1.e.d(b19), d1.e.d(b27)));
    }
