    ...
    */
    public void Ai(java.lang.String r3) {
        /*
            r2 = this;
            if (r3 == 0) goto L11
            boolean r0 = com.p314xaae8f345.mm.p2621x8fb0427b.z3.a4(r3)
            if (r0 == 0) goto La
            r0 = 1
            goto L12
        La:
    ...
    public boolean Bi(java.lang.String str) {
        ...
        z53.i z07 = Ui.z0(str);
        boolean mo60485xc9e4dcd4 = Ui.mo60485xc9e4dcd4(z07.f72763xa3c65b86, false);
        Ui.mo142179xf35bbb4("single", 3, z07);
        return mo60485xc9e4dcd4;
    }
    ...
    public z53.j Ni() {
        ...
        long j17 = D0 != null ? D0.f67667x11a0aa61 : 0L;
        if (D0 != null) {
            java.lang.String str2 = D0.f67670x114ef53e;
            str = str2 == null || str2.length() == 0 ? "@gamelifehistory" : D0.f67670x114ef53e;
        } else {
            str = null;
        }
        z53.j jVar = new z53.j(str, j17, gm0.j1.u().c().v(com.p314xaae8f345.mm.p2621x8fb0427b.u3.USERINFO_GAME_LIFE_LAST_SAVED_EXTERN_INFO_STRING, ""), gm0.j1.u().c().r(com.p314xaae8f345.mm.p2621x8fb0427b.u3.USERINFO_GAME_LIFE_LAST_SAVED_MSG_TYPE_INT, 0), D0 != null ? D0.f67672xa783a79b : 0L);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GameLife.ConversationService", "getLatestConversationInfo: " + jVar);
        return jVar;
    }

    public int Ri() {
        android.database.Cursor B = ((t53.m0) i95.n0.c(t53.m0.class)).Ui().f551801d.B("SELECT SUM(unReadCount) FROM GameLifeConversation WHERE sessionId<>'@gamelifehistory'", null);
        try {
            int i17 = 0;
            ...
            vz5.b.a(B, null);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GameLife.ConversationStorage", "[getTotalUnreadCount] " + i17);
            return i17;
        } finally {
        }
    }
    ...
    */
    public int Ui(java.lang.String r7) {
        /*
            ...
            r3 = 0
            if (r7 == 0) goto L13
            boolean r4 = com.p314xaae8f345.mm.p2621x8fb0427b.z3.a4(r7)
            if (r4 == 0) goto L10
            r4 = r0
            goto L14
        L10:
        ...
        L17:
            ...
            boolean r5 = com.p314xaae8f345.mm.p2621x8fb0427b.z3.a4(r7)
            if (r5 == 0) goto L2d
            goto L31
        L2d:
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r2, r1)
    ...
    public void Vi(l75.q0 storageChange) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(storageChange, "storageChange");
        ((t53.m0) i95.n0.c(t53.m0.class)).Ui().mo49775xc84af884(storageChange);
    }
