...
public final class c1 extends al5.w {

    /* renamed from: f, reason: collision with root package name */
    public java.lang.ref.WeakReference f544762f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c1(android.graphics.drawable.Drawable drawable) {
        super(drawable, 0);
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence text, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        java.lang.ref.WeakReference weakReference = this.f544762f;
        ...
        if (drawable == null) {
            ...
            this.f544762f = new java.lang.ref.WeakReference(drawable);
        }
        if (drawable != null) {
            canvas.save();
