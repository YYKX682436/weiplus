...
public final class s0 extends qw4.a {
    ...
    public static final av4.s0 f95865d = new av4.s0();
    ...
    public boolean a(nw4.k env, nw4.y2 msg) {
        ...
        if (e17 == 1) {
            ...
            if (e17 != 11) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SystemCapabilityAuthorizationStatusJsApi", "capability error: " + e17);
                return true;
            }
            g0Var = d85.g0.CAMERA;
        }
        if (e18 == 10) {
            ...
            if (e18 != 11) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SystemCapabilityAuthorizationStatusJsApi", "authScene error: " + e18);
                return true;
            }
        ...
        if (activity != null) {
            ...
            while (it6.hasNext()) {
                ...
                if (ij6 == d85.h0.SYSTEM_REFUSE) {
                    ...
                    if (ij6 == d85.h0.ERROR) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SystemCapabilityAuthorizationStatusJsApi", "IPluginSensitive.PERMISSION_RESULT.ERROR = " + ij6.f308734d);
                    }
                }
            }
        }
        ...
        env.f422396d.e(msg.f422546c, msg.f422552i + ":ok", k17);
        return true;
    }
