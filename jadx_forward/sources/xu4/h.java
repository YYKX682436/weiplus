...
public final class h extends aw4.y {
    ...
    public void h(java.lang.String paramStr) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(paramStr, "paramStr");
    ...
    public java.util.List i() {
        ...
        x50Var.f471321d = "emojiRecPersonalization";
        x50Var.f471322e = ((com.p314xaae8f345.mm.p2621x8fb0427b.h5) ((com.p314xaae8f345.mm.p689xc5a27af6.p741x5c28046.api.c6) i95.n0.c(com.p314xaae8f345.mm.p689xc5a27af6.p741x5c28046.api.c6.class))).Ai() ? 1L : 0L;
    ...
    public final yu4.p k() {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.e(qVar, "null cannot be cast to non-null type com.tencent.mm.plugin.websearch.emojisearch.ui.IEmojiSearchUIComponent");
        return (yu4.p) qVar;
    }
    ...
    public void mo815x76e0bfae(int i17, int i18, java.lang.String str, com.p314xaae8f345.mm.p944x882e457a.m1 m1Var) {
        ...
        if (!(m1Var instanceof su4.k1)) {
            if (m1Var instanceof su4.m1) {
                ...
                if (m1Var2.f494543h == a() && p3321xbce91901.jvm.p3324x21ffc6bd.o.b(m1Var, this.f538821i)) {
                    if (i17 == 0 && i18 == 0 && (sn3Var = m1Var2.f494542g) != null) {
                        k().O2(sn3Var, m1Var2.f494541f.f466560i);
                    }
                    this.f538821i = null;
                    return;
                }
        ...
        if (k1Var.f494510g.f494610q == a()) {
            if (i17 != 0 || i18 != 0) {
                xu4.d b17 = k().b();
                if (b17 != null) {
                    su4.r1 r1Var = k1Var.f494510g;
            ...
            r45.aa7 aa7Var = k1Var.f494509f;
            if (aa7Var != null) {
                xu4.d b18 = k().b();
                if (b18 != null) {
                    su4.r1 r1Var2 = k1Var.f494510g;
