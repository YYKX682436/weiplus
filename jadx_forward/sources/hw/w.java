...
public final class w implements jc3.m {
    ...
    public final /* synthetic */ hw.c0 f366975a;
    ...
    public void b(java.lang.Object obj, jc3.k callback) {
        ...
        if (f(view)) {
            ...
            this.f366975a.f366895x.n((java.lang.String) h0Var.f391656d, mo20599xaaa148a0.mo20556x59bc66e().mo20648x5f01b1f6(), new hw.t(callback, this, h0Var));
        }
    }
    ...
    public void c(java.lang.Object obj, java.lang.Object obj2, jc3.k callback) {
        ...
        if (f(view)) {
            ...
            if (obj3 instanceof com.p314xaae8f345.mm.p775xd2ae381c.p777xc5476f33.p778x65fc9e8.l) {
                ...
                i18.h(mz5.b.c(viewAttribute.f366957a, new int[0]));
                i18.i(mz5.b.c(viewAttribute.f366958b, new int[0]));
                i18.j(mz5.b.c(viewAttribute.f366959c, new int[0]));
                i18.g(mz5.b.c(viewAttribute.f366960d, new int[0]));
                ...
                boolean z17 = viewAttribute.f366961e > 0;
                mo20599xaaa148a0.f149517d = i19 | 2;
                mo20599xaaa148a0.f149519f = z17;
                mo20599xaaa148a0.m20881x7bb163d5();
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MagicEcsTLBaseBiz", ((java.lang.String) h0Var.f391656d) + " viewId:" + mo20599xaaa148a0.f149518e + ",left:" + i18.f149548e + "top:" + i18.f149549f + "height:" + i18.f149551h + "width:" + i18.f149550g);
                h0Var.f391656d = "updateFrameSet";
            } else {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicEcsTLBaseBiz", "view.message is not a MagicSclBizApi.MBApiInsertFrameSet.Builder");
            }
            this.f366975a.f366895x.n((java.lang.String) h0Var.f391656d, mo20599xaaa148a0.mo20556x59bc66e().mo20648x5f01b1f6(), new hw.u(callback, this, h0Var));
        }
    }
    ...
    public void e(java.lang.Object obj, java.lang.Object obj2, jc3.k callback) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(callback, "callback");
        if (f(view)) {
            hw.c0 c0Var = this.f366975a;
            view.f492478b = new java.lang.ref.WeakReference(c0Var.f366895x);
            p3321xbce91901.jvm.p3324x21ffc6bd.h0 h0Var = new p3321xbce91901.jvm.p3324x21ffc6bd.h0();
            h0Var.f391656d = "";
            java.lang.Object obj3 = view.f492477a;
            if (!(obj3 instanceof com.p314xaae8f345.mm.p775xd2ae381c.p777xc5476f33.p778x65fc9e8.l)) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.MagicEcsTLBaseBiz", "apiName invalid");
                return;
            }
            ...
            i17.h(viewAttribute.f366957a);
            i17.i(viewAttribute.f366958b);
            i17.j(viewAttribute.f366959c);
            i17.g(viewAttribute.f366960d);
            p3321xbce91901.jvm.p3324x21ffc6bd.o.e(obj3, "null cannot be cast to non-null type com.tencent.mm.flutter.plugin.proto.MagicSclBizApi.MBApiInsertFrameSet.Builder");
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MagicEcsTLBaseBiz", ((java.lang.String) h0Var.f391656d) + " viewId:" + lVar.f149530e + ",left:" + lVar.e().f149555e + "top:" + lVar.e().f149556f + "height:" + lVar.e().f149558h + "width:" + lVar.e().f149557g);
            c0Var.f366895x.n((java.lang.String) h0Var.f391656d, mo20556x59bc66e2.mo20648x5f01b1f6(), new hw.s(callback, this, h0Var));
        }
    }
    ...
    public final boolean f(sp0.d view) {
        ...
        if (!(obj instanceof com.p314xaae8f345.mm.p775xd2ae381c.p777xc5476f33.p778x65fc9e8.l)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.MagicEcsTLBaseBiz", "is not MBApiInsertFrameSet,no need to transfer flutter");
            return false;
        }
