...
public class i extends jn1.c {
    ...
    public j75.b mo131691xef4b835f(g75.z state, gk0.e action) {
        ...
        sVar.rj(str, bitmap);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Avatar.AvatarLoadBitmapFlowPPC", "put small bitmap to cache " + str);
    ...
    public j75.b l(g75.z state) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.Avatar.AvatarLoadBitmapFlowPPC", "hit small bitmap cache " + k17);
        g75.z zVar = new g75.z();
