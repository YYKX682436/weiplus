...
public abstract class q0 {
    public static final u1.w a(u1.w wVar, yz5.l predicate) {
        ...
        if (((java.lang.Boolean) predicate.mo146xb9724478(wVar)).booleanValue()) {
            return wVar;
        }
    ...
    public static final java.util.List b(u1.w wVar, java.util.List list) {
        ...
        try {
            y1.g.f540240h = y1.d.Stripe;
            V0 = kz5.n0.V0(arrayList);
            kz5.g0.s(V0);
        } catch (java.lang.IllegalArgumentException unused) {
            y1.g.f540240h = y1.d.Location;
            V0 = kz5.n0.V0(arrayList);
            kz5.g0.s(V0);
        }
        ...
        for (int i18 = 0; i18 < size2; i18++) {
            arrayList2.add(((y1.g) V0.get(i18)).f540242e);
        }
    ...
    public static final u1.c1 c(u1.w wVar) {
        ...
        return (c17 == null || (c1Var = c17.f505187d) == null) ? wVar.I : c1Var;
    }
}
