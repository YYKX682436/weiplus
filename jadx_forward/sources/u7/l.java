...
public class l implements u7.t {
    ...
    public final x7.b f506595a;

    /* renamed from: b, reason: collision with root package name */
    public final w7.b f506596b;

    /* renamed from: c, reason: collision with root package name */
    public u7.u f506597c;

    /* renamed from: d, reason: collision with root package name */
    public java.net.HttpURLConnection f506598d;

    /* renamed from: e, reason: collision with root package name */
    public java.io.InputStream f506599e;
    ...
    public void a() {
        java.net.HttpURLConnection httpURLConnection = this.f506598d;
    ...
    */
    public final void b() {
        /*
            r8 = this;
            u7.u r0 = r8.f506597c
            java.lang.String r0 = r0.f506613a
            r0 = 0
        ...
        L1c:
            ...
            u7.u r6 = r8.f506597c     // Catch: java.lang.Throwable -> L41 java.io.IOException -> L4a
            java.lang.String r6 = r6.f506613a     // Catch: java.lang.Throwable -> L41 java.io.IOException -> L4a
            r5.<init>(r6, r1, r4)     // Catch: java.lang.Throwable -> L41 java.io.IOException -> L4a
            r8.f506597c = r5     // Catch: java.lang.Throwable -> L41 java.io.IOException -> L4a
            x7.b r1 = r8.f506595a     // Catch: java.lang.Throwable -> L41 java.io.IOException -> L4a
            ...
            u7.u r1 = r8.f506597c     // Catch: java.lang.Throwable -> L41 java.io.IOException -> L4a
        ...
        L49:
            r0 = r3
        L4a:
            u7.u r1 = r8.f506597c     // Catch: java.lang.Throwable -> L41
            java.lang.String r1 = r1.f506613a     // Catch: java.lang.Throwable -> L41
            if (r3 == 0) goto L53
    ...
    public synchronized long c() {
        if (this.f506597c.f506614b == -2147483648L) {
            b();
        }
        return this.f506597c.f506614b;
    }
    ...
    public void d(long j17) {
        try {
            ...
            this.f506599e = new java.io.BufferedInputStream(this.f506598d.getInputStream(), 8192);
            java.net.HttpURLConnection httpURLConnection = this.f506598d;
            ...
            if (responseCode != 200) {
                parseLong = responseCode == 206 ? parseLong + j17 : this.f506597c.f506614b;
            }
            java.lang.String str = this.f506597c.f506613a;
            u7.u uVar = new u7.u(str, parseLong, contentType);
            this.f506597c = uVar;
            ((x7.a) this.f506595a).b(str, uVar);
        } catch (java.io.IOException e18) {
            throw new u7.r("Error opening connection for " + this.f506597c.f506613a + " with offset " + j17, e18);
        }
    }
    ...
    public int f(byte[] bArr) {
        java.io.InputStream inputStream = this.f506599e;
        if (inputStream == null) {
            throw new u7.r("Error reading data from " + this.f506597c.f506613a + ": connection is absent!");
        }
        try {
            return inputStream.read(bArr, 0, bArr.length);
        } catch (java.io.InterruptedIOException e17) {
            throw new u7.n("Reading source " + this.f506597c.f506613a + " is interrupted", e17);
        } catch (java.io.IOException e18) {
            throw new u7.r("Error reading data from " + this.f506597c.f506613a, e18);
        }
    }

    /* renamed from: toString */
    public java.lang.String m167651x9616526c() {
        return "HttpUrlSource{sourceInfo='" + this.f506597c + "}";
    }

    public l(u7.l lVar) {
        this.f506597c = lVar.f506597c;
        this.f506595a = lVar.f506595a;
        this.f506596b = lVar.f506596b;
    }
}
