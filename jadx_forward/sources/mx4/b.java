...
public final class b extends qw4.a {
    ...
    public static final mx4.b f414167d = new mx4.b();
    ...
    */
    ...
    public final void e(nw4.k kVar, nw4.y2 y2Var, java.util.HashMap hashMap) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MagicLiveCardDevTools.JsApiHandleDynamicCardDebugAction", "endWithResult:" + hashMap);
        kVar.f422396d.e(y2Var.f422546c, "handleDynamicCardDebugAction:ok", hashMap);
    }
    ...
    public final void f() {
        ...
        synchronized (mVar) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SurfaceApp.MagicLiveCardMgr", "forceCleanUp");
            if (xg4.m.f535980b != null && mVar.c()) {
                ((ku5.t0) ku5.t0.f394148d).B(xg4.h.f535975d);
            }
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SurfaceApp.MagicLiveCardMgr", "forceCleanUp not registered or not open");
        }
        ((com.p314xaae8f345.mm.p689xc5a27af6.p743xb4097826.p744x32b0ec.v4) ((s40.w0) i95.n0.c(s40.w0.class))).Ek();
    }
}
