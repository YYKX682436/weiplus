    ...
    */
    public final void a(java.nio.ByteBuffer r16, cp5.e r17, zo5.e r18) {
        /*
            ...
            r11 = r18
            r16.clear()
            java.util.concurrent.locks.ReentrantLock r12 = r10.f302671e
            r12.lock()
            boolean r1 = r10.f302670d     // Catch: java.lang.Throwable -> L8c
            r13 = 0
            if (r1 == 0) goto L1c
            cp5.f r1 = r10.f302667a     // Catch: java.lang.Throwable -> L8c
            boolean r2 = r1.f302673b     // Catch: java.lang.Throwable -> L8c
            if (r2 == 0) goto L1c
            dp5.f r1 = r1.f302672a     // Catch: java.lang.Throwable -> L8c
            goto L1d
        L1c:
            r1 = r13
        L1d:
            if (r1 == 0) goto L2f
            int r2 = r11.f556413a     // Catch: java.lang.Throwable -> L8c
            int r3 = r11.f556414b     // Catch: java.lang.Throwable -> L8c
        ...
        L2f:
            int r1 = r11.f556413a     // Catch: java.lang.Throwable -> L8c
            int r14 = r11.f556414b
            int r1 = r1 * r14
            r0.position(r1)     // Catch: java.lang.Throwable -> L8c
            boolean r1 = r10.f302670d     // Catch: java.lang.Throwable -> L8c
            if (r1 == 0) goto L44
            cp5.f r1 = r10.f302668b     // Catch: java.lang.Throwable -> L8c
            boolean r2 = r1.f302673b     // Catch: java.lang.Throwable -> L8c
            if (r2 == 0) goto L44
            dp5.f r1 = r1.f302672a     // Catch: java.lang.Throwable -> L8c
            goto L45
        ...
        L59:
            ...
            boolean r1 = r10.f302670d     // Catch: java.lang.Throwable -> L8c
            if (r1 == 0) goto L6f
            cp5.f r1 = r10.f302669c     // Catch: java.lang.Throwable -> L8c
            boolean r2 = r1.f302673b     // Catch: java.lang.Throwable -> L8c
            if (r2 == 0) goto L6f
            dp5.f r1 = r1.f302672a     // Catch: java.lang.Throwable -> L8c
            goto L70
