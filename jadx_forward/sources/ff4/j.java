...
public final class j implements java.lang.Runnable {
    ...
    public final /* synthetic */ ff4.m f343229d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.b50 f343230e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ff4.k f343231f;

    public j(ff4.m mVar, r45.b50 b50Var, ff4.k kVar) {
        this.f343229d = mVar;
        this.f343230e = b50Var;
        this.f343231f = kVar;
    }
    ...
    public final void run() {
        ...
        r45.b50 item = this.f343230e;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(item, "$item");
        this.f343229d.getClass();
        ff4.k h17 = this.f343231f;
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.StoryCgi.NetSceneStorySync", "processStoryCommentDel username:" + if6Var.f458529e + " createTime:" + if6Var.f458535n + " id:" + hf6Var2.f457653d);
            gf4.l.f352887d.d(hf6Var2);
