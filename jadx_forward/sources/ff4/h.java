...
public final class h implements java.lang.Runnable {
    ...
    public final /* synthetic */ ff4.m f343223d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.b50 f343224e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ff4.k f343225f;

    public h(ff4.m mVar, r45.b50 b50Var, ff4.k kVar) {
        this.f343223d = mVar;
        this.f343224e = b50Var;
        this.f343225f = kVar;
    }
    ...
    public final void run() {
        ...
        r45.b50 item = this.f343224e;
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(item, "$item");
        this.f343223d.getClass();
        ff4.k h17 = this.f343225f;
        ...
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.StoryCgi.NetSceneStorySync", "processStoryComment username:" + str + " createTime:" + i17 + " id:" + j17 + " ulonglong " + pm0.v.u(j17));
            gf4.l.f352887d.b(hf6Var2);
