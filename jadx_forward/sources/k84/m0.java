...
public final class m0 implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ float f386646d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ k84.q1 f386647e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ int f386648f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ int f386649g;
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator it) {
        com.p314xaae8f345.mm.p1006xc5476f33.sns.ui.p2214x49b0bd5a.C18371x36a2d70d.m71153x3a548b48("onAnimationUpdate", "com.tencent.mm.plugin.sns.ad.widget.adsocial.AdContinuousLikeComponent$startAnim$1$1");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(it, "it");
        java.lang.Object animatedValue = it.getAnimatedValue();
        java.lang.Float f17 = animatedValue instanceof java.lang.Float ? (java.lang.Float) animatedValue : null;
        float floatValue = f17 != null ? f17.floatValue() : 0.0f;
        float f18 = 1;
        float f19 = this.f386646d;
        float f27 = f19 + ((f18 - floatValue) * (f18 - f19));
        k84.q1 q1Var = this.f386647e;
        ...
        if (F3 != null) {
            F3.setBackground(new android.graphics.drawable.ColorDrawable(e3.b.c(this.f386648f, this.f386649g, floatValue)));
        }
        float interpolation = floatValue < 0.2f ? s74.q4.f486046a.d().getInterpolation(floatValue / 0.2f) : 1.0f;
        ...
        float interpolation2 = floatValue >= 0.2f ? s74.q4.f486046a.d().getInterpolation((floatValue - 0.2f) / 0.8f) : floatValue < 0.2f ? 0.0f : 1.0f;
        android.view.ViewGroup J2 = q1Var.J();
        if (J2 != null) {
            J2.setAlpha(interpolation2);
        }
        q1Var.j();
        com.p314xaae8f345.mm.p1006xc5476f33.sns.ui.p2214x49b0bd5a.C18371x36a2d70d.m71152xb91771c1("onAnimationUpdate", "com.tencent.mm.plugin.sns.ad.widget.adsocial.AdContinuousLikeComponent$startAnim$1$1");
    }
}
