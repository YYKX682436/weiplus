...
public class d extends fn4.d {
    ...
    public void b(fn4.b bVar) {
        ...
        if (a17 instanceof gn4.d0) {
            ...
            int m8183xf806b362 = d0Var != null ? d0Var.m8183xf806b362() : -1;
            if (m8183xf806b362 != bVar.Y2() && bVar.I2().f346109e) {
                bVar.I2().m();
                if (d0Var != null) {
                    bVar.o4().e(d0Var.f346117e);
                }
            }
            bVar.t();
            for (int i17 = 0; i17 < mo72292x4905e9fa.getChildCount(); i17++) {
                ...
                if (childAt.getTag() != null) {
                    gn4.d0 d0Var2 = (gn4.d0) bVar.mo72292x4905e9fa().w0(childAt);
                    if (d0Var2.m8183xf806b362() == m8183xf806b362) {
                        d0Var2.m();
                        if (!bVar.I2().f346109e) {
                            d0Var2.f355138h.s();
                        }
