...
public final class v implements so2.j5, wp2.a, yp2.a {
    ...
    public final r45.fa2 f520490d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.ArrayList f520491e;

    public v(r45.fa2 container) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(container, "container");
        this.f520490d = container;
        this.f520491e = new java.util.ArrayList();
    }

    @Override // wp2.a
    public com.p314xaae8f345.mm.p2495xc50a8b8b.g a() {
        return this.f520490d.f455665n;
    }

    @Override // wp2.a
    public void b(int i17) {
        this.f520490d.f455663i = i17;
    }

    @Override // wp2.a
    public int c() {
        return this.f520491e.size();
    }

    @Override // com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.p1459x633fb29.p1460x21ffc6bd.r0
    public int d(com.p314xaae8f345.mm.p1006xc5476f33.p1418xb4097826.p1452x2fe59e.p1459x633fb29.p1460x21ffc6bd.r0 obj) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(obj, "obj");
        return ((obj instanceof vp2.v) && ((vp2.v) obj).f520490d.f455658d == this.f520490d.f455658d) ? 0 : -1;
    }

    @Override // yp2.a
    public r45.fa2 e() {
        return this.f520490d;
    }

    @Override // wp2.a
    public void f(com.p314xaae8f345.mm.p2495xc50a8b8b.g gVar) {
        this.f520490d.f455665n = gVar;
    }

    @Override // wp2.a
    public java.util.List g() {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.LinkedList card_list = this.f520490d.f455662h;
