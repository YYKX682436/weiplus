...
public enum f0 {
    ...
    public void a(java.lang.String str, java.lang.String str2, int i17, int i18) {
        ...
        if (str.equals("requireSoterBiometricAuthentication")) {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.SoterReportManager", "unknown soter jsapi function name");
            i19 = -1;
        }
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.SoterReportManager", "functionNameCode: %d", java.lang.Integer.valueOf(i19));
        if (i19 != -1) {
