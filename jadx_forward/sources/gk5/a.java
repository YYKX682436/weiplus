...
public final class a extends m50.x {
    ...
    */
        ...
        if (Z6 != null) {
            ...
            if (e76 != null && e76.z0() != null && !p3321xbce91901.jvm.p3324x21ffc6bd.o.b(e76.z0(), "")) {
                ...
                try {
                    ...
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("MicroMsg.ForwardAppBrandNativeUIC", e17, "processAppMessageTransfer send to user: %s, exception", up5.f.f511478o);
                }
            }
    ...
    public final boolean q7(byte[] bArr) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.ForwardAppBrandNativeUIC", "isImage called, data[0-4]:[%d,%d,%d,%d,%d]", java.lang.Byte.valueOf(bArr[0]), java.lang.Byte.valueOf(bArr[1]), java.lang.Byte.valueOf(bArr[2]), java.lang.Byte.valueOf(bArr[3]), java.lang.Byte.valueOf(bArr[4]));
