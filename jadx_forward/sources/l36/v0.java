...
public class v0 {
    ...
    public l36.k0 f397197a;

    /* renamed from: b, reason: collision with root package name */
    public java.lang.String f397198b;

    /* renamed from: c, reason: collision with root package name */
    public l36.h0 f397199c;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Map f397200d;

    public v0() {
        this.f397200d = java.util.Collections.emptyMap();
        this.f397198b = "GET";
        this.f397199c = new l36.h0();
    }

    public l36.w0 a() {
        if (this.f397197a != null) {
    ...
    public l36.v0 b(l36.l lVar) {
        java.lang.String m145032x9616526c = lVar.m145032x9616526c();
        if (m145032x9616526c.isEmpty()) {
            this.f397199c.d("Cache-Control");
            return this;
        }
        this.f397199c.e("Cache-Control", m145032x9616526c);
        return this;
    }
    ...
    public v0(l36.w0 w0Var) {
        ...
        this.f397200d = java.util.Collections.emptyMap();
        this.f397197a = w0Var.f397214a;
        this.f397198b = w0Var.f397215b;
        w0Var.getClass();
        java.util.Map map = w0Var.f397217d;
        if (map.isEmpty()) {
            linkedHashMap = java.util.Collections.emptyMap();
        } else {
            linkedHashMap = new java.util.LinkedHashMap(map);
        }
        this.f397200d = linkedHashMap;
        this.f397199c = w0Var.f397216c.e();
    }
}
