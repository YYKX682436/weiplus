...
public final class i0 {
    ...
    public final java.lang.String[] f397048a;

    public i0(l36.h0 h0Var) {
        java.util.List list = h0Var.f397035a;
        this.f397048a = (java.lang.String[]) ((java.util.ArrayList) list).toArray(new java.lang.String[((java.util.ArrayList) list).size()]);
    }
    ...
    public java.lang.String c(java.lang.String str) {
        java.lang.String[] strArr = this.f397048a;
    ...
    public java.lang.String d(int i17) {
        return this.f397048a[i17 * 2];
    }

    public l36.h0 e() {
        l36.h0 h0Var = new l36.h0();
        java.util.Collections.addAll(h0Var.f397035a, this.f397048a);
        return h0Var;
    }

    /* renamed from: equals */
    public boolean m145023xb2c87fbf(java.lang.Object obj) {
        return (obj instanceof l36.i0) && java.util.Arrays.equals(((l36.i0) obj).f397048a, this.f397048a);
    }

    public java.lang.String f(int i17) {
        return this.f397048a[(i17 * 2) + 1];
    }

    public java.util.List g(java.lang.String str) {
        int length = this.f397048a.length / 2;
    ...
    public int m145024x8cdac1b() {
        return java.util.Arrays.hashCode(this.f397048a);
    }

    /* renamed from: toString */
    public java.lang.String m145025x9616526c() {
