...
public final class u0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.view.View.OnClickListener f388374d;

    public u0(android.view.View.OnClickListener onClickListener) {
        this.f388374d = onClickListener;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        if (q0Var != null && q0Var.f388339g != null) {
            o0Var.a().Q0(1);
        }
        this.f388374d.onClick(view);
