...
public class b implements java.lang.Runnable {
    ...
    public void run() {
        nl0.d dVar = nl0.c.f419692a;
        dVar.getClass();
        dVar.f419696d.A("KeyNodeInfo", "DELETE FROM KeyNodeInfo where happen_time<=" + (java.lang.System.currentTimeMillis() - (nl0.e.c() * 86400000)));
        nl0.a aVar = nl0.c.f419693b;
        aVar.getClass();
        java.lang.String str = "DELETE FROM FewShotLearning where time<=" + (java.lang.System.currentTimeMillis() - 15552000000L);
        l75.k0 k0Var = aVar.f419691d;
