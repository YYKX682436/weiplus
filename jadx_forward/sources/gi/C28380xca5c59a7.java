...
/* renamed from: gi.u0$$d0 */
/* loaded from: classes12.dex */
public final /* synthetic */ class C28380xca5c59a7 implements r.a {
    @Override // r.a
    /* renamed from: apply */
    public final java.lang.Object mo1850x58b836e(java.lang.Object obj) {
        ...
        android.os.health.HealthStats healthStats = (android.os.health.HealthStats) dVar.f404626b;
        ...
        if (sb6.length() > 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("HealthStatsHelper", healthStats.getDataType() + " " + str5 + " measure: " + ((java.lang.Object) sb6));
        }
        ...
        if (sb7.length() > 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("HealthStatsHelper", healthStats.getDataType() + " " + str5 + " measureList: " + ((java.lang.Object) sb7));
        }
        ...
        if (sb9.length() > 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("HealthStatsHelper", healthStats.getDataType() + " " + str5 + " timer: " + ((java.lang.Object) sb9));
        }
        ...
        if (sb10.length() > 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("HealthStatsHelper", healthStats.getDataType() + " " + str5 + " timerList: " + ((java.lang.Object) sb10));
        }
