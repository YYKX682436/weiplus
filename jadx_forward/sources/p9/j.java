...
public final class j {
    ...
    public static final java.util.regex.Pattern f434378b = java.util.regex.Pattern.compile("^(\\S+)\\s+-->\\s+(\\S+)(.*)?$");

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.regex.Pattern f434379c = java.util.regex.Pattern.compile("(\\S+?):(\\S+)");

    /* renamed from: a, reason: collision with root package name */
    public final java.lang.StringBuilder f434380a = new java.lang.StringBuilder();
    ...
    public static void a(java.lang.String str, p9.h hVar, android.text.SpannableStringBuilder spannableStringBuilder, java.util.List list, java.util.List list2) {
        ...
        int i18;
        ?? size;
        int i19 = hVar.f434373b;
        int length = spannableStringBuilder.length();
        java.lang.String str2 = hVar.f434372a;
        str2.getClass();
        ...
        if (hashCode == 0) {
            ...
            if (hashCode == 118 && str2.equals(org.p3343x72743996.p3344x2e06d1.C29284xa13724f3.V)) {
                c17 = 5;
            }
            c17 = 65535;
        } else {
        ...
        while (i28 < size2) {
            ...
            if (dVar.f434344a.isEmpty() && dVar.f434345b.isEmpty() && dVar.f434346c.isEmpty() && dVar.f434347d.isEmpty()) {
                size = str2.isEmpty();
            } else {
                int a17 = p9.d.a(p9.d.a(p9.d.a(i27, dVar.f434344a, str, 1073741824), dVar.f434345b, str2, 2), dVar.f434347d, hVar.f434374c, 4);
                size = (a17 == -1 || !java.util.Arrays.asList(hVar.f434375d).containsAll(dVar.f434346c)) ? 0 : (dVar.f434346c.size() * 4) + a17;
            }
            if (size > 0) {
        ...
        for (int i29 = 0; i29 < size3; i29++) {
            p9.d dVar2 = ((p9.i) list2.get(i29)).f434377e;
            if (dVar2 != null) {
                int i37 = dVar2.f434355l;
                if (((i37 == -1 && dVar2.f434356m == -1) ? -1 : (i37 == 1 ? (char) 1 : (char) 0) | (dVar2.f434356m == 1 ? (char) 2 : (char) 0)) != -1) {
                    int i38 = dVar2.f434355l;
                    int i39 = (i38 == -1 && dVar2.f434356m == -1) ? -1 : (i38 == 1 ? 1 : 0) | (dVar2.f434356m == 1 ? 2 : 0);
                    i17 = 33;
                ...
                if (dVar2.f434350g) {
                    ...
                    spannableStringBuilder.setSpan(new android.text.style.ForegroundColorSpan(dVar2.f434349f), i19, length, i17);
                }
                if (dVar2.f434352i) {
                    if (!dVar2.f434352i) {
                        throw new java.lang.IllegalStateException("Background color not defined.");
                    }
                    spannableStringBuilder.setSpan(new android.text.style.BackgroundColorSpan(dVar2.f434351h), i19, length, 33);
                }
                if (dVar2.f434348e != null) {
                    i18 = 33;
                    spannableStringBuilder.setSpan(new android.text.style.TypefaceSpan(dVar2.f434348e), i19, length, 33);
                } else {
                    i18 = 33;
                }
                int i47 = dVar2.f434357n;
                if (i47 == 1) {
    ...
    public static boolean b(java.lang.String str, java.util.regex.Matcher matcher, t9.p pVar, p9.f fVar, java.lang.StringBuilder sb6, java.util.List list) {
        try {
            fVar.f434359a = p9.l.b(matcher.group(1));
            fVar.f434360b = p9.l.b(matcher.group(2));
