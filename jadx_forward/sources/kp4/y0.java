...
public final class y0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.p314xaae8f345.mm.p1006xc5476f33.p2324x37470e.ui.p2333x693b1d6.C18814xdf4aba0 f392692d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.util.LinkedList f392693e;

    public y0(com.p314xaae8f345.mm.p1006xc5476f33.p2324x37470e.ui.p2333x693b1d6.C18814xdf4aba0 c18814xdf4aba0, java.util.LinkedList linkedList, long j17) {
        this.f392692d = c18814xdf4aba0;
        this.f392693e = linkedList;
    }

    @Override // java.lang.Runnable
    public final void run() {
        com.p314xaae8f345.mm.p1006xc5476f33.p2324x37470e.ui.p2333x693b1d6.C18814xdf4aba0 c18814xdf4aba0 = this.f392692d;
        ...
        java.util.LinkedList<kp4.c1> linkedList = this.f392693e;
        ...
        yj0.a.d(c1162x665295de, arrayList.toArray(), "com/tencent/mm/plugin/vlog/ui/thumb/TrackCropView$setTrack$2", "run", "()V", "Undefined", "scrollToPositionWithOffset", "(II)V");
        c1162x665295de.P(((java.lang.Integer) arrayList.get(0)).intValue(), ((java.lang.Integer) arrayList.get(1)).intValue());
        yj0.a.f(c1162x665295de, "com/tencent/mm/plugin/vlog/ui/thumb/TrackCropView$setTrack$2", "run", "()V", "Undefined", "scrollToPositionWithOffset", "(II)V");
        ...
        if (seekSlider != null) {
            ...
            seekSlider.post(new com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.i1(seekSlider, width2 - (i19 * 2), i19, (int) (((float) 1000) * c18814xdf4aba0.f257598r)));
        }
        ...
        if (seekSlider3 != null) {
            seekSlider3.post(new kp4.x0(c18814xdf4aba0, max));
        }
    }
}
