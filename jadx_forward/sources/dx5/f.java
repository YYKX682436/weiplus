...
public final class f implements java.lang.Runnable {
    ...
    public final dx5.d f326047d;

    /* renamed from: e, reason: collision with root package name */
    public final long f326048e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicBoolean f326049f;

    /* renamed from: g, reason: collision with root package name */
    public java.net.HttpURLConnection f326050g;

    public f(dx5.d downloadParams) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(downloadParams, "downloadParams");
        this.f326047d = downloadParams;
        this.f326048e = downloadParams.f326043a;
        this.f326049f = new java.util.concurrent.atomic.AtomicBoolean(false);
    }
    ...
    public final void b(dx5.c cVar) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(format);
        dx5.g gVar = dx5.g.f326051a;
        dx5.g.f326052b.mo119839x9dc2a798(j17, cVar);
    }

    public final void c(jz5.l lVar) {
        if (this.f326049f.get()) {
            b(dx5.c.f326041e);
            return;
        }
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(format);
        dx5.g gVar = dx5.g.f326051a;
        dx5.g.f326052b.mo119840x428b6afc(j17, lVar);
    }
    ...
    public final void d(long j17) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(format);
        dx5.g gVar = dx5.g.f326051a;
        dx5.g.f326052b.mo119843x3688ff42(j18, j17);
    }
    ...
    public final void e(long j17, int i17, java.util.Map map) {
        ...
        p3321xbce91901.jvm.p3324x21ffc6bd.o.d(format);
        dx5.g gVar = dx5.g.f326051a;
        dx5.g.f326052b.mo119841x5d21f921(j17, i17, map);
    }
    ...
    */
    public final long f(java.io.InputStream r15) {
        ...
        L3d:
            ...
            r8 = -1
            if (r6 == r8) goto L68
            java.util.concurrent.atomic.AtomicBoolean r8 = r14.f326049f     // Catch: java.lang.Throwable -> Lac
            ...
            dx5.g r12 = dx5.g.f326051a     // Catch: java.lang.Throwable -> Lac
            dx5.b r12 = dx5.g.f326052b     // Catch: java.lang.Throwable -> Lac
            r12.mo119842x6e8d0d64(r3, r8, r6)     // Catch: java.lang.Throwable -> Lac
            goto L3d
        L60:
        ...
        L68:
            ...
            p3321xbce91901.jvm.p3324x21ffc6bd.o.g(r15, r7)
            int r1 = r0.length
