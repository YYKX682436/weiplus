...
public abstract class f {
    ...
    public static final int b(int i17, com.p314xaae8f345.mm.p2495xc50a8b8b.g gVar) {
        if (gVar == null) {
            return 0;
        }
        return f36.a.c(i17) + f36.a.a(gVar.f273689a.length) + gVar.f273689a.length;
    }
        ...
        if (linkedList != null) {
            switch (i18) {
                ...
                case 6:
                    ...
                    while (it10.hasNext()) {
                        i19 += b(i17, (com.p314xaae8f345.mm.p2495xc50a8b8b.g) it10.next());
                    }
                    break;
                case 7:
                ...
                case 8:
                    ...
                    while (it12.hasNext()) {
                        ...
                        i19 += i(i17, ((com.p314xaae8f345.mm.p2495xc50a8b8b.f) next6).mo75928xcd1e8d8());
                    }
                    break;
                default:
    ...
    public static final int l(int i17, java.util.LinkedList linkedList) {
        ...
        if (linkedList != null && (!linkedList.isEmpty())) {
            ...
            java.util.Iterator it = linkedList.iterator();
            while (it.hasNext()) {
                i18 += ((java.lang.Number) lVar.mo146xb9724478(it.next())).intValue();
            }
        }
        return i18;
    }
