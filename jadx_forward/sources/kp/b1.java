...
public final class b1 implements android.net.wifi.p2p.WifiP2pManager.ConnectionInfoListener {
    ...
    public final /* synthetic */ kp.i1 f392251a;
    ...
    public final void onConnectionInfoAvailable(android.net.wifi.p2p.WifiP2pInfo wifiP2pInfo) {
        kp.i1 i1Var = this.f392251a;
        ((p3325xe03a0797.p3326xc267989b.p3328x30012e.h3) i1Var.f392300h).k(wifiP2pInfo);
        ...
        if (!wifiP2pInfo.groupFormed) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("WiFiDirectService", "group not formed");
        ...
        if (wifiP2pInfo.isGroupOwner) {
            ...
            if (wifiP2pManager == null) {
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("WiFiDirectService", "WiFiP2pManager is null, cannot request group info");
                return;
            } else {
                wifiP2pManager.requestGroupInfo(i1Var.f392298f, new kp.c1(i1Var));
                return;
            }
        }
        ...
        if (hostAddress != null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("WiFiDirectService", "connect success, it's client，GO IP: ".concat(hostAddress));
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("WiFiDirectService", "Group Owner IP is null");
        }
        i1Var.f392297e.requestGroupInfo(i1Var.f392298f, new kp.a1(i1Var));
    }
}
