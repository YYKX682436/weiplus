...
public abstract class g {
    ...
    public static java.lang.String a(java.lang.Object obj) {
        ...
        boolean z18 = true;
        if (!(z17 && ((dc.a) b17).f310132h == dc.q.CHAR)) {
            if (!(z17 && ((dc.a) b17).f310132h == dc.q.BYTE)) {
            ...
            try {
                ...
                return new java.lang.String((byte[]) declaredMethod.invoke(aVar, 0, num), java.nio.charset.Charset.forName(com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));
        ...
        while (true) {
            ...
            if (((dc.b) it.next()).f310135a.f310148b.equals("offset")) {
                break;
            }
        }
        if (z18) {
        ...
        java.nio.CharBuffer asCharBuffer = java.nio.ByteBuffer.wrap(aVar2.m(intValue, intValue2)).order(ec.a.f332458a).asCharBuffer();
    ...
    public static java.lang.Object b(java.util.List list, java.lang.String str) {
        ...
        while (it.hasNext()) {
            ...
            if (bVar.f310135a.f310148b.equals(str)) {
                return bVar.f310136b;
            }
        }
