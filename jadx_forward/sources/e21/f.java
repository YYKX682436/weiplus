...
public class f implements xg3.f0 {
    ...
    public final android.util.SparseArray f328047d = new android.util.SparseArray();

    /* renamed from: e, reason: collision with root package name */
    public final android.util.SparseArray f328048e = new android.util.SparseArray();

    public void a(int i17, xg3.d0 d0Var, boolean z17) {
        android.util.SparseArray sparseArray = this.f328047d;
    ...
    public void c(java.util.ArrayList arrayList) {
        ...
        gm0.j1.i();
        jVar.mo807x6c193ac1(gm0.j1.n().f354821b.f152297d, new e21.e(this, arrayList));
    }
}
