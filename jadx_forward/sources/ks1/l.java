...
public final class l extends ks1.g {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(js1.c tokenManager) {
        super(tokenManager);
    ...
    public com.p314xaae8f345.mm.p944x882e457a.o c(com.p314xaae8f345.mm.p1006xc5476f33.p1289x8f4dc54e.api.C12965xc9712d2 transferRequestInfo) {
        ...
        if (!(str == null || str.length() == 0)) {
            ru3Var.f466752p = transferRequestInfo.f175458s;
        }
        com.p314xaae8f345.mm.p944x882e457a.l lVar = new com.p314xaae8f345.mm.p944x882e457a.l();
        lVar.f152197a = ru3Var;
        lVar.f152198b = new r45.su3();
        lVar.f152199c = "/cgi-bin/micromsg-bin/h5webtransfer";
        lVar.f152200d = 6601;
        lVar.f152201e = 6601;
        lVar.f152202f = 0;
        return lVar.a();
