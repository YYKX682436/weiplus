...
public abstract class c {
    ...
    public static final java.util.Comparator f405060a = new m51.b();

    public static java.util.List a(h51.h hVar) {
        int min = (int) java.lang.Math.min(32768, hVar.f360565h);
        byte[] bArr = new byte[min];
        long j17 = min;
        long j18 = hVar.f360565h - j17;
        hVar.a(j18, j17);
        int i17 = 0;
        ...
        long j28 = b18;
        java.util.Collections.sort(arrayList, f405060a);
        while (i17 < arrayList.size()) {
            i51.a aVar = (i51.a) arrayList.get(i17);
            long j29 = i17 < arrayList.size() - 1 ? ((i51.a) arrayList.get(i17 + 1)).f369999g : j28;
            long j37 = aVar.f369999g;
            hVar.a(j37, j29 - j37);
            if (((int) m51.d.b(hVar)) != 67324752) {
                throw new java.util.zip.ZipException("Bad local entry header");
            }
            m51.d.e(hVar, 22);
            aVar.f370000h = aVar.f369999g + m51.d.a(hVar) + 30 + m51.d.a(hVar);
            i17++;
        }
        return arrayList;
    }
