...
public final class b extends l75.n0 {
    ...
    public static final java.lang.String[] f337539e;

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f337540d;

    static {
        l75.e0 e0Var = er1.a.f337538y;
        f337539e = new java.lang.String[]{l75.n0.m145250x3fdc6f77(er1.a.f337538y, "BizContactConversationMassSend")};
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(l75.k0 db6) {
        super(db6, er1.a.f337538y, "BizContactConversationMassSend", dm.b1.f317326o);
    ...
    public final long J0(java.lang.String talker, long j17, int i17) {
        ...
        if (i17 <= 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.BizContactConversationMassSendStorage", "error target inc count");
            return j17;
        }
        ...
        android.database.Cursor B = this.f337540d.B("SELECT createTime FROM BizContactConversationMassSend WHERE " + concat + " ORDER BY createTime ASC LIMIT " + i17, new java.lang.String[]{talker, java.lang.String.valueOf(j17)});
        if (B != null) {
            try {
                if (B.moveToLast()) {
                    j17 = B.getLong(0);
                } else {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.BizContactConversationMassSendStorage", "get result fail, no data found");
                }
                vz5.b.a(B, null);
            } finally {
            }
        } else {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.BizContactConversationMassSendStorage", "get inc msg create time error, cursor is null");
        }
        return j17;
    }
    ...
    */
    public final int L0(java.lang.String r8, long r9, long r11) {
        ...
        L46:
            ...
            r3.append(r2)
            java.lang.String r2 = r3.toString()
            com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.n(r8)
            ...
            l75.k0 r10 = r7.f337540d     // Catch: java.lang.Exception -> La0
        ...
        L87:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(r0, r9)     // Catch: java.lang.Throwable -> L93
            r9 = r1
        L8d:
            r10 = 0
        ...
        L9a:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w(r0, r8)     // Catch: java.lang.Exception -> La0
            goto Lb6
        La0:
            r8 = move-exception
            java.lang.StringBuilder r9 = new java.lang.StringBuilder
    ...
    public final java.util.List P0(java.lang.String talker, int i17, long j17, long j18) {
        ...
        android.database.Cursor B = this.f337540d.B("SELECT msgId FROM BizContactConversationMassSend WHERE " + concat + " ORDER BY createTime ASC LIMIT " + i17, (java.lang.String[]) arrayList.toArray(new java.lang.String[0]));
        if (B == null) {
    ...
    public final long W0(java.lang.String talker, long j17) {
        ...
        android.database.Cursor f17 = this.f337540d.f("SELECT createTime FROM BizContactConversationMassSend WHERE " + sb7 + " ORDER BY createTime ASC LIMIT 1", (java.lang.String[]) arrayList.toArray(new java.lang.String[0]), 2);
        if (f17 != null) {
            try {
    ...
    public final int b1(java.lang.String talker, long j17) {
        ...
        try {
            android.database.Cursor B = this.f337540d.B("SELECT COUNT(*) FROM BizContactConversationMassSend WHERE " + str, (java.lang.String[]) arrayList.toArray(new java.lang.String[0]));
            if (B == null) {
                return 0;
            }
            try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.BizContactConversationMassSendStorage", "getTotalMessageCount error: " + e17.getMessage());
            return 0;
        }
    }
    ...
    public final int z0() {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizContactConversationMassSendStorage", "clearAll");
        try {
            int mo70514xb06685ab = this.f337540d.mo70514xb06685ab("BizContactConversationMassSend", null, null);
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizContactConversationMassSendStorage", "clearAll: successfully cleared " + mo70514xb06685ab + " messages from new table");
            return mo70514xb06685ab;
        } catch (java.lang.Exception e17) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.BizContactConversationMassSendStorage", "clearAll: failed to clear new table", e17);
            return 0;
        }
    }
}
