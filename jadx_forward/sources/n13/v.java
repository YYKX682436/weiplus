...
public final class v {
    ...
    public static final n13.v f415673a = new n13.v();
    ...
    public final l15.c b(java.lang.String str, java.lang.String str2, long j17) {
        ...
        aVar.N(str2);
        aVar.set(aVar.f449897d + 0, java.lang.Long.valueOf(j17));
        bVar.set(bVar.f513848e + 8, aVar);
    ...
    public final l15.c d(java.util.HashMap params) {
        ...
        dVar.set(dVar.f449898d + 0, str);
        java.lang.String str2 = (java.lang.String) params.get(com.p314xaae8f345.p347x615374d.p349x208df1fe.p358xd1075a44.p360x696c9db.C3365xfbc5fb5e.f13305x20d82714);
        if (str2 == null) {
            str2 = "";
        }
        dVar.x(str2);
        ...
        dVar.A(str5);
        java.lang.String str6 = (java.lang.String) params.get(ya.b.f77502x92235c1b);
        if (str6 == null) {
            str6 = "";
        }
        dVar.z(str6);
        dVar.B(p3321xbce91901.jvm.p3324x21ffc6bd.o.b(params.get("isTransparent"), "1"));
        dVar.u(p3321xbce91901.jvm.p3324x21ffc6bd.o.b(params.get("hideIcon"), "1"));
        java.lang.String str7 = (java.lang.String) params.get("isGameShareCard");
        if (str7 == null) {
            str7 = "";
        }
        dVar.t(str7);
        dVar.s(p3321xbce91901.jvm.p3324x21ffc6bd.o.b(params.get("forbidForward"), "1"));
        cVar.u(dVar);
        z05.b bVar = new z05.b();
        bVar.q((java.lang.String) params.get("bizData"));
        bVar.u((java.lang.String) params.get(com.p314xaae8f345.p3085x8ea91595.p3090x2a97d52d.C26667x4be17176.f56088xe92e69a4));
        ...
        java.lang.String str9 = (java.lang.String) params.get(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37660xb6ae3b28);
        if (str9 == null) {
            str9 = "";
        }
    ...
    public final l15.c e(java.util.HashMap params) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(params, "params");
        v05.b bVar = new v05.b();
        java.lang.String str = (java.lang.String) params.get(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37660xb6ae3b28);
        if (str == null) {
            str = "";
        }
        int i17 = bVar.f449898d;
        ...
        gVar.z(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D1((java.lang.String) params.get("item_show_type"), -1));
        gVar.A(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D1((java.lang.String) params.get("picCount"), 0));
        gVar.w(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.B1((java.lang.String) params.get("coverPicWidth")));
        gVar.t(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.B1((java.lang.String) params.get("coverPicHeight")));
        ...
        gVar.y(str9);
        gVar.x(com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.D1((java.lang.String) params.get("duration"), -1));
