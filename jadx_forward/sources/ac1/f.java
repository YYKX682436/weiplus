...
public class f implements android.view.animation.Interpolator {
    ...
    public final android.graphics.PointF f84531a;

    /* renamed from: b, reason: collision with root package name */
    public final android.graphics.PointF f84532b;

    /* renamed from: c, reason: collision with root package name */
    public final android.graphics.PointF f84533c;

    /* renamed from: d, reason: collision with root package name */
    public final android.graphics.PointF f84534d;

    /* renamed from: e, reason: collision with root package name */
    public final android.graphics.PointF f84535e;
    ...
    public f(ac1.g gVar, float f17, float f18, float f19, float f27) {
        ...
        new android.graphics.PointF();
        this.f84533c = new android.graphics.PointF();
        this.f84534d = new android.graphics.PointF();
        this.f84535e = new android.graphics.PointF();
        float f28 = pointF.x;
    ...
    public float getInterpolation(float f17) {
        ...
        while (true) {
            pointF = this.f84533c;
            pointF2 = this.f84532b;
            pointF3 = this.f84534d;
            pointF4 = this.f84531a;
            pointF5 = this.f84535e;
            if (i17 >= 14) {
                break;
            }
