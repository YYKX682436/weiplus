...
public final class j1 extends df5.n {
    ...
    public final v11.e0 f313668s;

    /* renamed from: t, reason: collision with root package name */
    public final df5.d1 f313669t;

    /* renamed from: u, reason: collision with root package name */
    public java.lang.String f313670u;

    /* renamed from: v, reason: collision with root package name */
    public yz5.a f313671v;

    /* renamed from: w, reason: collision with root package name */
    public final android.widget.LinearLayout f313672w;

    /* renamed from: x, reason: collision with root package name */
    public boolean f313673x;
    ...
    public j1(android.content.Context context, v11.e0 renderConfig) {
        ...
        this.f313668s = renderConfig;
        this.f313669t = new df5.d1(context, renderConfig);
        this.f313670u = "";
        android.widget.LinearLayout linearLayout = new android.widget.LinearLayout(context);
        linearLayout.setOrientation(1);
        this.f313672w = linearLayout;
    ...
    public static final java.util.List b(df5.j1 j1Var, java.util.List list, int i17, int i18) {
        ...
        v11.e0 e0Var = j1Var.f313668s;
        boolean z17 = e0Var.f513905k.f513924o;
        int i27 = (i18 + i17) * 2;
        android.widget.LinearLayout linearLayout = j1Var.f313672w;
        ...
        if (linearLayout2 == null) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.NativeMarkdownTableView", "[TABLE_DIFF] buildCellFeedItems: rowViewIndex=%d NOT FOUND (childCount=%d), rowIdx=%d, headerOffset=%d, cells lost", java.lang.Integer.valueOf(i27), java.lang.Integer.valueOf(linearLayout.getChildCount()), java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(i17));
        ...
        while (i29 < size) {
            ...
            if (k0Var != null) {
                android.text.SpannableStringBuilder spannableStringBuilder = (android.text.SpannableStringBuilder) j1Var.f313669t.g(k0Var.f513965e, e0Var.f513905k.f513925p);
                if ((spannableStringBuilder.length() == 0 ? 1 : i28) == 0) {
                    ...
                    if (frameLayout != null) {
                        ...
                        if (textView != null) {
                            ...
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NativeMarkdownTableView", "[TABLE_DIFF] buildCellFeedItems: row=%d, col=%d, tvHash=%d, text=[%s]", valueOf, valueOf2, valueOf3, r26.p0.E0(spannableStringBuilder2, 40));
                            i19 = 0;
    ...
    public final void c(java.util.List list, int[] iArr, java.util.List list2, boolean z17, boolean z18) {
        ...
        linearLayout.setLayoutParams(new android.widget.LinearLayout.LayoutParams(this.f313673x ? -1 : -2, -2));
        java.util.Iterator it = list.iterator();
        int i17 = 0;
        while (true) {
            boolean hasNext = it.hasNext();
            v11.e0 e0Var = this.f313668s;
            if (!hasNext) {
                android.widget.LinearLayout linearLayout2 = this.f313672w;
                linearLayout2.addView(linearLayout);
                android.view.View view = new android.view.View(getContext());
                view.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-1, e0Var.f513905k.f513922m));
                v11.g0 g0Var = e0Var.f513905k;
                if (z18) {
                    com.p314xaae8f345.mm.ui.kk.d(view, g0Var.f513919j);
                }
                view.setBackgroundColor(g0Var.f513923n);
            ...
            if (l0Var == null) {
                v11.l0 l0Var2 = k0Var != null ? k0Var.f513964d : null;
                if (l0Var2 == null) {
                    l0Var2 = v11.l0.f513970d;
                }
                l0Var = l0Var2;
            }
            ...
            boolean z29 = this.f313673x;
            if (z29 && z27 && z28) {
                i19 = 0;
            }
            frameLayout.setLayoutParams(new android.widget.LinearLayout.LayoutParams(i19, -2, (z29 && z27 && z28) ? 1.0f : 0.0f));
            frameLayout.addView(e(k0Var != null ? this.f313669t.g(k0Var.f513965e, e0Var.f513905k.f513925p) : "", z17 ? e0Var.f513905k.f513911b : e0Var.f513905k.f513910a, l0Var, z17, z28), new android.widget.FrameLayout.LayoutParams(-1, -2));
            linearLayout.addView(frameLayout);
            if (e0Var.f513905k.f513924o && i17 < kz5.c0.h(list)) {
                android.view.View view2 = new android.view.View(getContext());
                view2.setLayoutParams(new android.widget.LinearLayout.LayoutParams(e0Var.f513905k.f513922m, -1));
                view2.setBackgroundColor(e0Var.f513905k.f513923n);
    ...
    public final int[] d(java.util.List list, java.util.List list2, java.util.List list3) {
        ...
        for (int i17 = 0; i17 < size; i17++) {
            iArr[i17] = this.f313668s.f513905k.f513920k;
        }
        if (list != null) {
            int i18 = 0;
    ...
    public final android.widget.TextView e(java.lang.CharSequence charSequence, v11.j0 j0Var, v11.l0 l0Var, boolean z17, boolean z18) {
        int i17;
        v11.e0 e0Var = this.f313668s;
        v11.b0 b0Var = e0Var.f513905k.f513925p;
        if (b0Var == null) {
            b0Var = e0Var.f513901g;
        }
        android.content.Context context = getContext();
        p3321xbce91901.jvm.p3324x21ffc6bd.o.f(context, "getContext(...)");
        df5.k1 k1Var = new df5.k1(context, b0Var);
        k1Var.setTextColor(j0Var.f513950b);
        k1Var.setTextSize(1, j0Var.f513949a);
        if (j0Var.f513951c) {
            android.text.TextPaint paint = k1Var.getPaint();
            e0Var.f513898d.getClass();
        ...
        if (j0Var.f513956h) {
            com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.y0 y0Var = new com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.y0(k1Var.getContext());
        ...
        v11.g0 g0Var = e0Var.f513905k;
        int i19 = g0Var.f513914e;
        int i27 = j0Var.f513954f;
        int i28 = i19 + i27;
        int i29 = j0Var.f513955g;
        k1Var.setPaddingRelative(i28, z17 ? g0Var.f513918i : g0Var.f513917h + i29, z18 ? g0Var.f513916g : g0Var.f513915f + i27, g0Var.f513917h + i29);
        k1Var.setText(charSequence, android.widget.TextView.BufferType.SPANNABLE);
        jf5.k0.c(k1Var, df5.f1.f313627d);
        return k1Var;
    }
    ...
    public final void f(java.util.List list, java.util.List list2, int i17, java.util.Map map, java.util.List list3) {
        ...
        android.view.View childAt = j1Var.f313672w.getChildAt(i17);
        android.widget.LinearLayout linearLayout2 = childAt instanceof android.widget.LinearLayout ? (android.widget.LinearLayout) childAt : null;
        if (linearLayout2 == null) {
            return;
        }
        ...
        while (i19 < size) {
            ...
            if (!p3321xbce91901.jvm.p3324x21ffc6bd.o.b(k0Var != null ? k0Var.f513965e : null, k0Var2 != null ? k0Var2.f513965e : null)) {
                int i27 = z17 ? i19 * 2 : i19;
                android.view.View childAt2 = linearLayout2.getChildAt(i27);
                android.widget.FrameLayout frameLayout = childAt2 instanceof android.widget.FrameLayout ? (android.widget.FrameLayout) childAt2 : null;
                if (frameLayout == null) {
                    com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.NativeMarkdownTableView", "[TABLE_DIFF] diffRowToItems: cellFrame null at rowViewIndex=%d, colIdx=%d, cellViewIndex=%d, rowChildCount=%d", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i19), java.lang.Integer.valueOf(i27), java.lang.Integer.valueOf(linearLayout2.getChildCount()));
                } else {
                    android.view.View childAt3 = frameLayout.getChildAt(i18);
                    android.widget.TextView textView = childAt3 instanceof android.widget.TextView ? (android.widget.TextView) childAt3 : null;
                    if (textView == null) {
                        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.NativeMarkdownTableView", "[TABLE_DIFF] diffRowToItems: tv null at rowViewIndex=%d, colIdx=%d", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i19));
                    } else {
                        java.lang.String str = "";
                        java.lang.String g17 = k0Var2 != null ? j1Var.f313669t.g(k0Var2.f513965e, e0Var.f513905k.f513925p) : "";
                        ...
                        if (length < spannableStringBuilder.length()) {
                            ...
                            java.lang.String spannableStringBuilder2 = spannableStringBuilder.toString();
                            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(spannableStringBuilder2, "toString(...)");
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NativeMarkdownTableView", "[TABLE_DIFF] diffRowToItems: Feed row=%d, col=%d, tvHash=%d, oldLen=%d, newLen=%d, tvText=[%s], newText=[%s]", valueOf, valueOf2, valueOf3, valueOf4, valueOf5, E0, r26.p0.E0(spannableStringBuilder2, 40));
                            ...
                            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(spannableStringBuilder3, "toString(...)");
                            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.NativeMarkdownTableView", "[TABLE_DIFF] diffRowToItems: setText row=%d, col=%d, tvHash=%d, oldLen=%d, newLen=%d, newText=[%s]", valueOf6, valueOf7, valueOf8, valueOf9, valueOf10, r26.p0.E0(spannableStringBuilder3, 40));
    ...
    public final int g(v11.k0 k0Var, boolean z17, boolean z18, v11.l0 l0Var) {
        v11.e0 e0Var = this.f313668s;
        if (k0Var == null) {
            return e0Var.f513905k.f513920k;
        }
        java.lang.CharSequence g17 = this.f313669t.g(k0Var.f513965e, e0Var.f513905k.f513925p);
        v11.j0 j0Var = z17 ? e0Var.f513905k.f513911b : e0Var.f513905k.f513910a;
        if (l0Var == null) {
            l0Var = k0Var.f513964d;
        }
        android.widget.TextView e17 = e(g17, j0Var, l0Var, z17, z18);
        int i17 = e0Var.f513905k.f513921l;
        if (i17 <= 0) {
        ...
        v11.g0 g0Var = e0Var.f513905k;
        int i18 = g0Var.f513921l;
        return i18 > 0 ? e06.p.f(measuredWidth, g0Var.f513920k, i18) : java.lang.Math.max(measuredWidth, g0Var.f513920k);
    }

    /* renamed from: getOnInteractionConsumed */
    public final yz5.a m124334x984bae05() {
        return this.f313671v;
    }
    ...
    public final int i(v11.q qVar) {
        ...
        java.util.Iterator it = qVar.f513987a.iterator();
        java.lang.Integer num = null;
        if (it.hasNext()) {
            valueOf = java.lang.Integer.valueOf(((v11.k0) it.next()).f513962b + 1);
            while (it.hasNext()) {
                java.lang.Integer valueOf4 = java.lang.Integer.valueOf(((v11.k0) it.next()).f513962b + 1);
        ...
        java.util.Iterator it6 = qVar.f513988b.iterator();
        if (it6.hasNext()) {
            java.util.Iterator it7 = ((java.util.List) it6.next()).iterator();
            if (it7.hasNext()) {
                valueOf2 = java.lang.Integer.valueOf(((v11.k0) it7.next()).f513962b + 1);
                while (it7.hasNext()) {
                    java.lang.Integer valueOf5 = java.lang.Integer.valueOf(((v11.k0) it7.next()).f513962b + 1);
            ...
            while (it6.hasNext()) {
                ...
                if (it8.hasNext()) {
                    valueOf3 = java.lang.Integer.valueOf(((v11.k0) it8.next()).f513962b + 1);
                    while (it8.hasNext()) {
                        java.lang.Integer valueOf7 = java.lang.Integer.valueOf(((v11.k0) it8.next()).f513962b + 1);
        ...
        return java.lang.Math.max(intValue, java.lang.Math.max(num5 != null ? num5.intValue() : 0, qVar.f513989c.size()));
    }
    ...
    public final void j(v11.q block, java.lang.String rawMarkdown, long j17) {
        ...
        this.f313670u = rawMarkdown;
        android.widget.LinearLayout linearLayout = this.f313672w;
        linearLayout.removeAllViews();
        int i17 = i(block);
        if (i17 == 0) {
            return;
        }
        v11.g0 g0Var = this.f313668s.f513905k;
        int i18 = g0Var.f513912c;
        int i19 = g0Var.f513913d;
        linearLayout.setPadding(i18, i19, i18, i19);
        java.util.List list = block.f513987a;
        if (!(!list.isEmpty())) {
            list = null;
        }
        java.util.List h17 = list != null ? h(list, i17) : null;
        java.util.List list2 = block.f513988b;
        java.util.ArrayList arrayList = new java.util.ArrayList(kz5.d0.q(list2, 10));
        java.util.Iterator it = list2.iterator();
        while (it.hasNext()) {
            arrayList.add(h((java.util.List) it.next(), i17));
        }
        this.f313673x = arrayList.size() + (h17 != null ? 1 : 0) <= 1;
        ...
        layoutParams2.width = this.f313673x ? -1 : -2;
        linearLayout.setLayoutParams(layoutParams2);
        int[] d17 = d(h17, arrayList, block.f513989c);
        if (h17 != null) {
            c(h17, d17, block.f513989c, true, arrayList.isEmpty());
        }
        ...
        while (it6.hasNext()) {
            ...
            c((java.util.List) next, d17, block.f513989c, false, i27 == kz5.c0.h(arrayList));
            i27 = i28;
        }
        ...
        if (c20976x6ba6452a != null) {
            v65.i.b(c20976x6ba6452a, null, new cf5.q(j17, currentTimeMillis2, null), 1, null);
        }
    }

    public final void k(int i17, int[] iArr) {
        int i18;
        android.view.View childAt = this.f313672w.getChildAt(i17);
        ...
        boolean z17 = this.f313668s.f513905k.f513924o;
        int length = iArr.length;
    ...
    public final void m124335x685e6079(yz5.a aVar) {
        this.f313671v = aVar;
        this.f313669t.f313607c = aVar;
    }
}
