...
public final class k1 extends android.widget.TextView {
    ...
    public final android.graphics.Paint f313678d;

    /* renamed from: e, reason: collision with root package name */
    public final android.graphics.Path f313679e;

    /* renamed from: f, reason: collision with root package name */
    public final android.graphics.RectF f313680f;

    /* renamed from: g, reason: collision with root package name */
    public final float f313681g;

    /* renamed from: h, reason: collision with root package name */
    public final int f313682h;

    /* renamed from: i, reason: collision with root package name */
    public final int f313683i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k1(android.content.Context context, v11.b0 inlineStyleConfig) {
        super(context);
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(context, "context");
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(inlineStyleConfig, "inlineStyleConfig");
        android.graphics.Paint paint = new android.graphics.Paint(1);
        paint.setStyle(android.graphics.Paint.Style.FILL);
        paint.setColor(inlineStyleConfig.f513873h);
        this.f313678d = paint;
        this.f313679e = new android.graphics.Path();
        this.f313680f = new android.graphics.RectF();
        this.f313681g = inlineStyleConfig.f513874i;
        this.f313682h = inlineStyleConfig.f513875j;
        this.f313683i = inlineStyleConfig.f513877l;
    }
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        ...
        if (layout != null) {
            ...
            if (spanned2 != null) {
                ...
                p3321xbce91901.jvm.p3324x21ffc6bd.o.d(v0VarArr2);
                        ...
                        if (spanStart >= spanEnd || (i18 = spanStart + 2) >= spanEnd - 2 || (lineForOffset = layout.getLineForOffset(i18)) > (lineForOffset2 = layout.getLineForOffset(i19))) {
                            ...
                            while (true) {
                                ...
                                if (max < min) {
                                    ...
                                    android.graphics.RectF rectF = this.f313680f;
                                    rectF.set(f17, max2, min2, min3);
                                    android.graphics.Path path = this.f313679e;
                                    path.reset();
                                    boolean z27 = i28 == lineForOffset;
                                    boolean z28 = i28 == lineForOffset2;
                                    float f19 = this.f313681g;
                                    if (z27 && z28) {
                                    ...
                                    canvas.drawPath(path, this.f313678d);
                                } else {
                                    v0VarArr = v0VarArr2;
                                    i17 = length;
                                    z17 = false;
