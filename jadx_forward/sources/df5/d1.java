...
public final class d1 {
    ...
    public final android.content.Context f313605a;

    /* renamed from: b, reason: collision with root package name */
    public final v11.e0 f313606b;

    /* renamed from: c, reason: collision with root package name */
    public yz5.a f313607c;

    /* renamed from: d, reason: collision with root package name */
    public final jz5.g f313608d;

    /* renamed from: e, reason: collision with root package name */
    public final jz5.g f313609e;

    /* renamed from: f, reason: collision with root package name */
    public final jz5.g f313610f;
    ...
    public d1(android.content.Context context, v11.e0 renderConfig) {
        ...
        this.f313605a = context;
        this.f313606b = renderConfig;
        this.f313608d = jz5.h.b(new df5.b1(this));
        this.f313609e = jz5.h.b(new df5.a1(this));
        this.f313610f = jz5.h.b(new df5.c1(this));
    }
    ...
    public static void d(df5.d1 d1Var, android.text.SpannableStringBuilder spannableStringBuilder, int i17, boolean z17, int i18, java.lang.Object obj) {
        ...
        spannableStringBuilder.setSpan(new df5.x0(i17, d1Var.f313606b.f513897c.f513927a.f513953e, z17 ? ((java.lang.Number) ((jz5.n) d1Var.f313610f).mo141623x754a37bb()).intValue() : 0), length, length2, 33);
    }
    ...
    public final void a(android.text.SpannableStringBuilder spannableStringBuilder, v11.r rVar) {
        ...
        if (rVar instanceof v11.p) {
            spannableStringBuilder.append(g(((v11.p) rVar).f513986a, null));
            return;
        }
        ...
        java.util.List list = ((v11.n) rVar).f513977a;
        v11.e0 e0Var3 = this.f313606b;
        int i19 = e0Var3.f513900f.f513880b;
        jz5.g gVar = this.f313608d;
        int measureText = (int) ((android.text.TextPaint) ((jz5.n) gVar).mo141623x754a37bb()).measureText("0.");
        java.util.ArrayList arrayList3 = new java.util.ArrayList();
        java.util.LinkedHashMap linkedHashMap4 = new java.util.LinkedHashMap();
        java.util.Iterator it = list.iterator();
        int i27 = -1;
        while (it.hasNext()) {
            int i28 = ((v11.i) it.next()).f513934c;
            if (i28 != i27) {
        ...
        for (int i29 = 0; i29 < size; i29++) {
            ...
            int measureText2 = iVar.f513933b ? (int) ((android.text.TextPaint) ((jz5.n) gVar).mo141623x754a37bb()).measureText(iVar.f513932a) : 0;
        ...
        for (java.lang.Object obj3 : list) {
            ...
            linkedHashMap6.put(java.lang.Integer.valueOf(iVar2.f513934c), java.lang.Integer.valueOf(intValue2));
            int i39 = 0;
            for (int i47 = 0; i47 < iVar2.f513934c; i47++) {
            ...
            int length = spannableStringBuilder.length();
            java.util.Iterator it7 = iVar2.f513935d.iterator();
            while (it7.hasNext()) {
                c(spannableStringBuilder, (v11.a) it7.next(), e0Var3.f513901g);
            }
            int length2 = spannableStringBuilder.length();
            if (length < length2) {
                java.lang.String str = iVar2.f513932a;
                linkedHashMap = linkedHashMap6;
                v11.c0 c0Var = e0Var3.f513900f;
                arrayList = arrayList3;
                linkedHashMap2 = linkedHashMap5;
                i17 = i19;
                e0Var = e0Var3;
                spannableStringBuilder.setSpan(new df5.w0(str, c0Var.f513879a, i39, i48, c0Var.f513880b, iVar2.f513933b, measureText), length, length2, 33);
                e(spannableStringBuilder, length, length2, iVar2.f513936e);
            } else {
                linkedHashMap = linkedHashMap6;
                arrayList = arrayList3;
                linkedHashMap2 = linkedHashMap5;
            ...
            if (i37 < kz5.c0.h(list)) {
                ...
                i18 = measureText;
                d(this, spannableStringBuilder, e0Var2.f513897c.f513930d, false, 4, null);
            } else {
                linkedHashMap3 = linkedHashMap;
                i18 = measureText;
                arrayList2 = arrayList;
    ...
    public final void b(android.text.SpannableStringBuilder spannableStringBuilder, v11.j jVar, int i17) {
        if (jVar.f513947a.isEmpty()) {
            return;
        }
        int length = spannableStringBuilder.length();
        java.util.List list = jVar.f513947a;
        java.util.Iterator it = list.iterator();
        int i18 = 0;
        while (true) {
            boolean hasNext = it.hasNext();
            v11.e0 e0Var = this.f313606b;
            if (!hasNext) {
                int length2 = spannableStringBuilder.length();
                if (length < length2) {
                    v11.u uVar = e0Var.f513904j;
                    if (i17 <= uVar.f514005d) {
                        spannableStringBuilder.setSpan(new df5.t0(uVar.f514002a, uVar.f514003b, uVar.f514004c, 1), length, length2, 33);
                        e(spannableStringBuilder, length, length2, jVar.f513948b);
                        return;
                    }
                    return;
                }
            ...
            if (i18 < kz5.c0.h(list)) {
                d(this, spannableStringBuilder, e0Var.f513897c.f513930d, false, 4, null);
            }
            i18 = i19;
        }
    }
    ...
    public final void c(android.text.SpannableStringBuilder spannableStringBuilder, v11.a aVar, v11.b0 b0Var) {
        ...
        boolean z17 = aVar.f513856f;
        v11.s sVar = aVar.f513858h;
        java.lang.String str = aVar.f513851a;
        if (z17) {
            int i17 = b0Var.f513876k;
            boolean z18 = spannableStringBuilder.length() == 0;
            int i18 = b0Var.f513875j;
            ...
            java.lang.Object mo141623x754a37bb = ((jz5.n) this.f313609e).mo141623x754a37bb();
            p3321xbce91901.jvm.p3324x21ffc6bd.o.f(mo141623x754a37bb, "getValue(...)");
            spannableStringBuilder.setSpan(new df5.v0(b0Var.f513870e, b0Var.f513872g, b0Var.f513878m, (android.graphics.Paint.FontMetricsInt) mo141623x754a37bb), length, length5, 33);
            e(spannableStringBuilder, length2, length3, sVar);
            return;
        }
        int length6 = spannableStringBuilder.length();
        ((ke0.e) ((le0.x) i95.n0.c(le0.x.class))).getClass();
        spannableStringBuilder.append(com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.c0.i(this.f313605a, str));
        int length7 = spannableStringBuilder.length();
        if (length6 == length7) {
            return;
        }
        boolean z19 = aVar.f513852b;
        java.lang.String str2 = aVar.f513855e;
        boolean z27 = z19 || (str2 != null && b0Var.f513868c);
        v11.e0 e0Var = this.f313606b;
        if (z27) {
        ...
        if (aVar.f513857g && b0Var.f513871f) {
        ...
        if (str2 != null) {
            ...
            m3Var.f450735k = b0Var.f513866a;
            m3Var.f450736l = b0Var.f513867b;
            com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.z0 z0Var = new com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.z0(1, m3Var);
            z0Var.m75738x5bfbb681(new df5.y0(this));
            spannableStringBuilder.setSpan(z0Var, length6, length7, 33);
        } else {
            if (str.length() > 500) {
                java.util.regex.Pattern pattern = com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.b0.f272711m;
                java.lang.String lowerCase = str.toLowerCase(java.util.Locale.ROOT);
                p3321xbce91901.jvm.p3324x21ffc6bd.o.f(lowerCase, "toLowerCase(...)");
                matcher = pattern.matcher(lowerCase);
            } else {
                java.util.regex.Pattern pattern2 = com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.b0.f272710l;
            ...
            while (matcher.find()) {
                ...
                m3Var2.f450735k = b0Var.f513866a;
                m3Var2.f450736l = b0Var.f513867b;
                if (b0Var.f513868c) {
                    e0Var.f513898d.getClass();
                    spannableStringBuilder.setSpan(new df5.u0(0.8f), start, i37, 33);
                }
                com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.z0 z0Var2 = new com.p314xaae8f345.mm.p2470x93e71c27.ui.p2487x35f74a.z0(1, m3Var2);
                z0Var2.m75738x5bfbb681(new df5.z0(this));
    ...
    public final java.lang.CharSequence f(java.util.List runs, int i17, v11.s sVar) {
        ...
        while (true) {
            ...
            c(spannableStringBuilder, (v11.a) it.next(), e0Var.f513901g);
        }
        int length2 = spannableStringBuilder.length();
        if (length < length2) {
            v11.z zVar = e0Var.f513899e;
            if (zVar.f514030g) {
                java.lang.Float f18 = i17 != 1 ? i17 != 2 ? i17 != 3 ? i17 != 4 ? i17 != 5 ? zVar.f514029f.f513861c : zVar.f514028e.f513861c : zVar.f514027d.f513861c : zVar.f514026c.f513861c : zVar.f514025b.f513861c : zVar.f514024a.f513861c;
                if (f18 != null) {
                    f17 = f18.floatValue();
                } else {
                    e0Var.f513898d.getClass();
            ...
            v11.z zVar2 = e0Var.f513899e;
            spannableStringBuilder.setSpan(new android.text.style.AbsoluteSizeSpan(a06.d.b(i17 != 1 ? i17 != 2 ? i17 != 3 ? i17 != 4 ? i17 != 5 ? zVar2.f514029f.f513859a : zVar2.f514028e.f513859a : zVar2.f514027d.f513859a : zVar2.f514026c.f513859a : zVar2.f514025b.f513859a : zVar2.f514024a.f513859a), true), length, length2, 33);
    ...
    public final java.lang.CharSequence h(java.util.List blocks) {
        ...
        for (java.lang.Object obj : blocks) {
            ...
            if (i17 < kz5.c0.h(blocks)) {
                d(this, spannableStringBuilder, this.f313606b.f513897c.f513931e, false, 4, null);
            }
            i17 = i18;
        }
        return spannableStringBuilder;
