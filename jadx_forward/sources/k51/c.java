...
public class c {
    ...
    public m51.e c(java.io.DataInputStream dataInputStream) {
        ...
        com.p314xaae8f345.p2943x68b0d85.p2944xbe97f590.Log.i("HdiffApk-MMPatchReader", "checkNonNegative, newFileSize = " + readLong2 + ", newFileMD5Length = " + readInt + ", newFileMD5 = " + str);
        ...
        return new m51.e(java.util.Collections.unmodifiableList(arrayList), java.util.Collections.unmodifiableList(arrayList2), j27, java.util.Collections.unmodifiableList(arrayList5), str, j28, ((m51.a) arrayList5.get(0)).f405057a.f360568e, ((m51.a) arrayList5.get(0)).f405058b.f360568e, arrayList3, arrayList4);
    }
}
