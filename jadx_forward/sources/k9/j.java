...
public final class j {
    ...
    public static final byte[] f387024h = {0, 7, 8, 15};

    /* renamed from: i, reason: collision with root package name */
    public static final byte[] f387025i = {0, 119, -120, -1};

    /* renamed from: j, reason: collision with root package name */
    public static final byte[] f387026j = {0, 17, 34, 51, 68, 85, 102, 119, -120, -103, -86, -69, -52, -35, -18, -1};

    /* renamed from: a, reason: collision with root package name */
    public final android.graphics.Paint f387027a;

    /* renamed from: b, reason: collision with root package name */
    public final android.graphics.Paint f387028b;

    /* renamed from: c, reason: collision with root package name */
    public final android.graphics.Canvas f387029c;

    /* renamed from: d, reason: collision with root package name */
    public final k9.c f387030d;

    /* renamed from: e, reason: collision with root package name */
    public final k9.b f387031e;

    /* renamed from: f, reason: collision with root package name */
    public final k9.i f387032f;

    /* renamed from: g, reason: collision with root package name */
    public android.graphics.Bitmap f387033g;
    ...
    public j(int i17, int i18) {
        ...
        this.f387028b = paint2;
        paint2.setStyle(android.graphics.Paint.Style.FILL);
        paint2.setXfermode(new android.graphics.PorterDuffXfermode(android.graphics.PorterDuff.Mode.DST_OVER));
        paint2.setPathEffect(null);
        this.f387029c = new android.graphics.Canvas();
        this.f387030d = new k9.c(719, 575, 0, 719, 0, 575);
        this.f387031e = new k9.b(0, new int[]{0, -1, -16777216, -8421505}, a(), b());
        this.f387032f = new k9.i(i17, i18);
    }
    ...
    */
    ...
    public static k9.d f(t9.o oVar) {
        ...
        if (d18 == 1) {
            ...
            if (d19 > 0) {
                bArr2 = new byte[d19];
                t9.a.d(oVar.f498071c == 0);
                java.lang.System.arraycopy(oVar.f498069a, oVar.f498070b, bArr2, 0, d19);
                oVar.f498070b += d19;
                oVar.a();
            }
            if (d27 > 0) {
                bArr = new byte[d27];
                t9.a.d(oVar.f498071c == 0);
                java.lang.System.arraycopy(oVar.f498069a, oVar.f498070b, bArr, 0, d27);
                oVar.f498070b += d27;
                oVar.a();
