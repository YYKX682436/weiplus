...
public class h extends rh.a {
    ...
    public uh.g k() {
        ...
        uh.g gVar = new uh.g();
        android.os.health.HealthStats m17 = uh.i.m(this.f476827a.d());
        if (m17 != null) {
            gVar.f509212e = m17;
            rh.k1 k1Var = (rh.k1) this.f476827a.i(rh.k1.class);
            long j18 = 0;
            if (k1Var != null && (n1Var = k1Var.f476968k) != null && n1Var.l()) {
                ...
                gVar.f509216g = rh.x2.b(java.lang.Double.valueOf(f17));
                ...
                gVar.f509218h = rh.x2.b(java.lang.Double.valueOf(d17));
                ...
                gVar.f509220i = rh.x2.b(java.lang.Double.valueOf(c17));
                ...
                gVar.f509222j = rh.x2.b(java.lang.Double.valueOf(d27));
                ...
                gVar.f509224k = rh.x2.b(java.lang.Double.valueOf(e17));
                ...
                gVar.f509226l = rh.x2.b(java.lang.Double.valueOf(d29));
                android.content.Context d37 = this.f476827a.d();
                ...
                gVar.f509228m = rh.x2.b(java.lang.Double.valueOf(d19));
                double e18 = (n1Var.e("camera.avg") / 3600000.0d) * uh.i.o(m17, 10035);
                if (e18 <= 0.0d) {
                    e18 = 0.0d;
                }
                gVar.f509230n = rh.x2.b(java.lang.Double.valueOf(e18));
                double e19 = (n1Var.e("camera.flashlight") / 3600000.0d) * uh.i.o(m17, 10034);
                if (e19 <= 0.0d) {
                    e19 = 0.0d;
                }
                gVar.f509232o = rh.x2.b(java.lang.Double.valueOf(e19));
                ...
                gVar.f509234p = rh.x2.b(java.lang.Double.valueOf(d38));
                ...
                gVar.f509236q = rh.x2.b(java.lang.Double.valueOf(d39));
                double e29 = (n1Var.e("screen.on") / 3600000.0d) * java.lang.Math.min(uh.i.o(m17, 10038), uh.i.o(m17, 10036));
                if (e29 <= 0.0d) {
                    e29 = 0.0d;
                }
                gVar.f509238r = rh.x2.b(java.lang.Double.valueOf(e29));
                ...
                gVar.f509240s = rh.x2.b(java.lang.Double.valueOf(f18));
                double e37 = ((n1Var.e("cpu.suspend") / 3600000.0d) * uh.i.n(m17, 10001)) + ((n1Var.e("cpu.idle") / 3600000.0d) * uh.i.n(m17, 10002));
                gVar.f509242t = rh.x2.b(java.lang.Double.valueOf(e37 > 0.0d ? e37 : 0.0d));
            }
            gVar.f509244u = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, 10064)));
            gVar.f509246v = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, 10062)));
            gVar.f509248w = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, 10063)));
            gVar.f509250x = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, 10001)));
            gVar.f509252y = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, 10002)));
            gVar.f509254z = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3061x5a71016.C26489x58a14bb2.f54056xf1449bd6)));
            gVar.A = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, com.p314xaae8f345.p3006xb8ff1437.p3059xeb76ee26.p3061x5a71016.C26489x58a14bb2.f54055x82c2d261)));
            ...
            gVar.f509206J = rh.x2.b(java.lang.Long.valueOf(uh.i.n(m17, 10055)));
            ...
            if (m17.hasTimers(10006)) {
                ...
                for (java.util.Map.Entry<java.lang.String, android.os.health.TimerStat> entry : m17.getTimers(10006).entrySet()) {
                    ...
                    if (gVar.f509253y0.isEmpty()) {
                        gVar.f509253y0 = new java.util.HashMap();
                    }
                    gVar.f509253y0.put(key2, rh.x2.b(java.lang.Long.valueOf(time)));
                    j27 += time;
                }
                gVar.f509207a0 = rh.x2.b(java.lang.Long.valueOf(j27));
            }
            if (m17.hasTimers(10005)) {
                ...
                for (java.util.Map.Entry<java.lang.String, android.os.health.TimerStat> entry2 : m17.getTimers(10005).entrySet()) {
                    ...
                    if (gVar.f509255z0.isEmpty()) {
                        gVar.f509255z0 = new java.util.HashMap();
                    }
                    gVar.f509255z0.put(key3, rh.x2.b(java.lang.Long.valueOf(time2)));
                    j28 += time2;
                }
                gVar.f509208b0 = rh.x2.b(java.lang.Long.valueOf(j28));
            }
            if (m17.hasTimers(10007)) {
                ...
                gVar.f509209c0 = rh.x2.b(java.lang.Long.valueOf(j29));
            }
            if (m17.hasTimers(10008)) {
                ...
                gVar.f509211d0 = rh.x2.b(java.lang.Long.valueOf(j37));
            }
            if (m17.hasStats(10013)) {
                ...
                gVar.f509213e0 = rh.x2.b(java.lang.Long.valueOf(j38));
            }
            gVar.f509215f0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10011)));
            if (m17.hasTimers(10012)) {
                java.util.List<android.hardware.Sensor> sensorList2 = ((android.hardware.SensorManager) this.f476827a.d().getSystemService("sensor")).getSensorList(-1);
                ...
                gVar.f509217g0 = rh.x2.b(java.lang.Long.valueOf(j39));
            }
            gVar.f509219h0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10035)));
            gVar.f509221i0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10034)));
            gVar.f509223j0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10032)));
            gVar.f509225k0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10033)));
            if (m17.hasTimers(10010)) {
                ...
                gVar.f509227l0 = rh.x2.b(java.lang.Long.valueOf(j47));
            }
            if (m17.hasTimers(10009)) {
                ...
                gVar.f509229m0 = rh.x2.b(java.lang.Long.valueOf(j18));
            }
            gVar.f509231n0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10036)));
            gVar.f509233o0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10038)));
            gVar.f509235p0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10040)));
            gVar.f509237q0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10041)));
            gVar.f509239r0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10039)));
            gVar.f509241s0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10042)));
            gVar.f509243t0 = rh.x2.b(java.lang.Long.valueOf(uh.i.o(m17, 10043)));
            if (m17.hasStats(10014)) {
                for (java.util.Map.Entry<java.lang.String, android.os.health.HealthStats> entry4 : m17.getStats(10014).entrySet()) {
                    ...
                    if (value != null) {
                        if (gVar.f509245u0.isEmpty()) {
                            gVar.f509245u0 = new java.util.HashMap();
                        }
                        gVar.f509245u0.put(key5, rh.x2.b(java.lang.Long.valueOf(uh.i.n(value, 30001))));
                        if (gVar.f509247v0.isEmpty()) {
                            gVar.f509247v0 = new java.util.HashMap();
                        }
                        gVar.f509247v0.put(key5, rh.x2.b(java.lang.Long.valueOf(uh.i.n(value, 30002))));
                        if (gVar.f509249w0.isEmpty()) {
                            gVar.f509249w0 = new java.util.HashMap();
                        }
                        gVar.f509249w0.put(key5, rh.x2.b(java.lang.Long.valueOf(uh.i.n(value, com.p314xaae8f345.p542x3306d5.cdn.p545x65fc9e8.EnumC4491xd8033ef6.f18801x2c319e6f))));
                        if (gVar.f509251x0.isEmpty()) {
                            gVar.f509251x0 = new java.util.HashMap();
                        }
                        gVar.f509251x0.put(key5, rh.x2.b(java.lang.Long.valueOf(uh.i.n(value, 30003))));
                    }
                }
            }
        }
