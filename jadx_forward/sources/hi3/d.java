...
public class d implements android.opengl.GLSurfaceView.EGLConfigChooser {

    /* renamed from: a, reason: collision with root package name */
    public final int[] f363070a = {12324, 4, 12323, 4, 12322, 4, 12352, 4, 12344};

    /* renamed from: b, reason: collision with root package name */
    public final int[] f363071b = new int[1];

    public d(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.ui.p1876xea0e606f.C16557x646260ab c16557x646260ab, int i17, int i18, int i19, int i27, int i28, int i29) {
    }
    ...
    public javax.microedition.khronos.egl.EGLConfig chooseConfig(javax.microedition.khronos.egl.EGL10 egl10, javax.microedition.khronos.egl.EGLDisplay eGLDisplay) {
        int[] iArr = new int[1];
        egl10.eglChooseConfig(eGLDisplay, this.f363070a, null, 0, iArr);
        int i17 = iArr[0];
        if (i17 <= 0) {
        ...
        egl10.eglChooseConfig(eGLDisplay, this.f363070a, eGLConfigArr, i17, iArr);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GLConfigChooser", java.lang.String.format("%d configurations", java.lang.Integer.valueOf(i17)));
        for (int i18 = 0; i18 < i17; i18++) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("GLConfigChooser", java.lang.String.format("Configuration %d:\n", java.lang.Integer.valueOf(i18)));
