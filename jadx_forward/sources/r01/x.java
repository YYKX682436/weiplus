...
public class x extends l75.n0 {
    ...
    public static final java.lang.String[] f449802f = {l75.n0.m145250x3fdc6f77(qk.o.f445831y1, "bizinfo")};

    /* renamed from: g, reason: collision with root package name */
    public static final java.util.Map f449803g = new java.util.HashMap();

    /* renamed from: h, reason: collision with root package name */
    public static final java.lang.String[] f449804h = {"CREATE  INDEX IF NOT EXISTS type_username_index ON bizinfo ( type,username ) ", "CREATE  INDEX IF NOT EXISTS  username_acceptType_index ON bizinfo ( username,acceptType ) "};

    /* renamed from: d, reason: collision with root package name */
    public final l75.v0 f449805d;

    /* renamed from: e, reason: collision with root package name */
    public final r01.s f449806e;

    public x(l75.k0 k0Var) {
        super(k0Var, qk.o.f445831y1, "bizinfo", f449804h);
        this.f449805d = new r01.r(this);
        this.f449806e = new r01.s(this, null);
    }

    @Override // l75.n0
    /* renamed from: C1, reason: merged with bridge method [inline-methods] */
    public boolean mo11260x413cb2b4(qk.o oVar) {
        qk.f e17;
        oVar.f66747xa783a79b = java.lang.System.currentTimeMillis();
        oVar.t0();
        qk.n D0 = oVar.D0(false);
        if (D0 != null && (e17 = D0.e()) != null) {
            oVar.f66744x37bf97ce = e17.f445634c;
        }
        boolean mo11260x413cb2b4 = super.mo11260x413cb2b4(oVar);
        if (mo11260x413cb2b4 && !com.p314xaae8f345.mm.p2621x8fb0427b.z3.R4(oVar.f66748xdec927b)) {
            r01.u uVar = new r01.u();
            uVar.f449786b = oVar.f66748xdec927b;
            oVar.P0();
            uVar.f449785a = r01.t.UPDATE;
            uVar.f449787c = oVar;
            l75.v0 v0Var = this.f449805d;
            v0Var.d(uVar);
            v0Var.c();
        }
    ...
    public void P0(qk.o oVar) {
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "delete biz ret = %b, username = %s", java.lang.Boolean.valueOf(super.mo9951xb06685ab(oVar, dm.i4.f66875xa013b0d5)), oVar.f66748xdec927b);
        r01.u uVar = new r01.u();
        uVar.f449786b = oVar.f66748xdec927b;
        uVar.f449785a = r01.t.DELETE;
        uVar.f449787c = oVar;
        l75.v0 v0Var = this.f449805d;
        v0Var.d(uVar);
        v0Var.c();
    ...
    public qk.o b1(java.lang.String str) {
        r01.s sVar = this.f449806e;
        qk.o oVar = null;
        if (sVar.f449765b && str != null) {
            oVar = (qk.o) sVar.f449764a.a(str);
        }
        if (oVar != null) {
            return oVar;
        }
        qk.o oVar2 = new qk.o();
        oVar2.f66748xdec927b = str;
        super.get(oVar2, new java.lang.String[0]);
        if (sVar.f449765b) {
            sVar.f449764a.b(str, oVar2);
        }
        return oVar2;
    }
    ...
    public void d(java.lang.String str) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "delete biz ret = %b, username = %s", java.lang.Boolean.valueOf(super.mo9951xb06685ab(oVar, dm.i4.f66875xa013b0d5)), str);
        r01.u uVar = new r01.u();
        uVar.f449786b = str;
        uVar.f449785a = r01.t.DELETE;
        uVar.f449787c = oVar;
    ...
    public java.lang.String d1(java.lang.String str) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.BizInfoStorage", "getBizChatBrandUserName userName is null");
            return null;
        }
        java.util.Map map = f449803g;
        if (map != null && ((java.util.HashMap) map).containsKey(str)) {
            java.lang.String str3 = (java.lang.String) ((java.util.HashMap) map).get(str);
            if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.K0(str3) || !c01.e2.J(str3)) {
                return null;
            }
            return str3;
        }
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getEnterpriseBizChatChild sql %s", sb7);
    ...
    public android.database.Cursor f1(java.lang.String str) {
        ...
        java.lang.String sb7 = sb6.toString();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getEnterpriseChatConnector sql %s", sb7);
        return gm0.j1.u().f354686f.B(sb7, null);
    }
    ...
    public java.util.List i1(java.lang.String str) {
        ...
        L0(sb6, str);
        java.lang.String sb7 = sb6.toString();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getEnterpriseChildNameList sql %s", sb7);
        android.database.Cursor f17 = gm0.j1.u().f354686f.f(sb7, null, 2);
        if (f17 == null) {
            return null;
        }
    ...
    public android.database.Cursor k1(java.lang.String str, int i17) {
        ...
        java.lang.String sb7 = sb6.toString();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getEnterpriseChildOfAcceptType sql %s", sb7);
        return gm0.j1.u().f354686f.B(sb7, null);
    }
    ...
    public java.util.List n1() {
        ...
        sb6.append(") == 0) ");
        java.lang.String sb7 = sb6.toString();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getEnterpriseConnectorList sql %s", sb7);
        android.database.Cursor f17 = gm0.j1.u().f354686f.f(sb7, null, 2);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        if (f17 == null) {
            return arrayList;
        ...
        f17.close();
        return ((com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Bi().H(arrayList);
    }
    ...
    public android.database.Cursor o1(java.lang.String str, boolean z17) {
        ...
        sb6.append("rcontact.type & 2048 desc, rcontact.showHead asc,  case when length(rcontact.conRemarkPYFull) > 0 then upper(rcontact.conRemarkPYFull)  else upper(rcontact.quanPin) end asc,  case when length(rcontact.conRemark) > 0 then upper(rcontact.conRemark)  else upper(rcontact.quanPin) end asc,  upper(rcontact.quanPin) asc,  upper(rcontact.nickname) asc,  upper(rcontact.username) asc ");
        java.lang.String sb7 = sb6.toString();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getEnterpriseEnableChild sql %s", sb7);
        return gm0.j1.u().f354686f.B(sb7, null);
    }

    /* JADX WARN: Code restructure failed: missing block: B:10:0x0074, code lost:
    
        return ((com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Bi().H(r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0049, code lost:
        ...
        r0.close();
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.BizInfoStorage", "getMyAcceptList: type[%d], use time[%d ms]", java.lang.Integer.valueOf(r9), java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - r1));
     */
    /*
    ...
    */
    public java.util.List p1(int r9) {
        /*
            ...
            android.database.Cursor r0 = r8.m145256x1d3f4980(r0, r5)
        ...
        L49:
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(r3, r0, r9)
            java.lang.Class<vg3.x3> r9 = vg3.x3.class
            lm0.a r9 = gm0.j1.s(r9)
            vg3.x3 r9 = (vg3.x3) r9
            com.tencent.mm.plugin.messenger.foundation.h2 r9 = (com.p314xaae8f345.mm.p1006xc5476f33.p1863xaa66bb13.p1864x83f804b3.h2) r9
    ...
    public int u1(int i17) {
        ...
        if (com.p314xaae8f345.mm.sdk.p2603x2137b148.t8.L0(p17)) {
            return 0;
        }
    ...
    public boolean mo880xb970c2b9(qk.o oVar) {
        qk.f e17;
        oVar.f66747xa783a79b = java.lang.System.currentTimeMillis();
        oVar.t0();
        qk.n D0 = oVar.D0(false);
        ...
        boolean mo880xb970c2b9 = super.mo880xb970c2b9(oVar);
        if (mo880xb970c2b9 && !com.p314xaae8f345.mm.p2621x8fb0427b.z3.R4(oVar.f66748xdec927b)) {
            r01.u uVar = new r01.u();
            uVar.f449786b = oVar.f66748xdec927b;
            oVar.P0();
            uVar.f449785a = r01.t.INSTERT;
            uVar.f449787c = oVar;
            l75.v0 v0Var = this.f449805d;
            v0Var.d(uVar);
            v0Var.c();
