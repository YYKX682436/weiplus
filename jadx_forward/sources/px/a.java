...
public final class a extends i95.w implements qx.d0 {
    public java.lang.String Ai(java.lang.String str, java.lang.String str2, long j17) {
        if (!com.p314xaae8f345.mm.p2621x8fb0427b.z3.L4(str) || str2 == null || j17 <= 0) {
            return null;
        }
        java.lang.String wi6 = wi(pt0.f0.f439742b1.k(str2, j17));
        if (r26.n0.N(wi6)) {
            return null;
        }
        return wi6;
    ...
    public final void Bi(java.lang.String str, java.lang.String text, java.lang.String str2, long j17) {
        ...
        java.lang.String str3 = nVar.f445283c;
        if (str3 == null) {
            str3 = nVar.f445282b;
        }
        ...
        gVar.set(i17 + 4, java.lang.Integer.valueOf(c01.e2.C(nVar.f445282b)));
        gVar.set(i17 + 7, 1);
        gVar.set(i17 + 9, 1);
        gVar.set(i17 + 13, text);
        gVar.set(i17 + 12, "");
        long r18 = pt0.f0.f439742b1.r(gVar);
        com.p314xaae8f345.mm.sdk.p2603x2137b148.w2.a(c01.z1.r());
        long m75942xfb822ef2 = gVar.m75942xfb822ef2(i18) / 1000;
        p3325xe03a0797.p3326xc267989b.l.d(v65.m.f515113a, p3325xe03a0797.p3326xc267989b.q1.f392101a, null, new qi3.k(nVar, java.lang.Long.valueOf(r18).longValue(), valueOf, text, null), 2, null);
    }
    ...
    */
    ...
    public final java.lang.String wi(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var) {
        if (f9Var == null) {
            return "";
        }
        try {
            ...
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.m40542x58ef3d35("BypMsgInfoService", e17, "generateClawTextSummary(MsgInfo) failed", new java.lang.Object[0]);
            return "";
        }
    }
}
