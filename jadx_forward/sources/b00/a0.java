...
public final class a0 extends i95.w implements c00.u3 {
    ...
    public java.lang.String f98169d;

    /* renamed from: e, reason: collision with root package name */
    public long f98170e;

    /* renamed from: f, reason: collision with root package name */
    public final jz5.g f98171f = jz5.h.b(b00.x.f98320d);
    ...
    public final java.util.Map Ni(java.lang.String str) {
        ...
        linkedHashMap.put("kf_session_id", b00.k0.f98235a);
        return linkedHashMap;
    }
    ...
    public final java.util.Map Ri(java.lang.String str, java.util.Map map) {
        ...
        java.lang.String str2 = this.f98169d;
    ...
    public final java.util.Map Ui(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4, int i17) {
        java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
        linkedHashMap.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54548xbbf10811, java.lang.String.valueOf(i17));
        linkedHashMap.put("type", str);
        if (str2 == null) {
            str2 = "";
        }
        linkedHashMap.put(com.p314xaae8f345.mm.p1006xc5476f33.p1873x468d4ffd.p1875x75a49f33.C16532xe69b9d82.f37660xb6ae3b28, str2);
        if (str3 == null) {
            str3 = "";
        }
    ...
    public final java.util.Map Vi(java.lang.String str, java.lang.String str2, int i17, java.lang.String str3, int i18) {
        ...
        linkedHashMap.put(com.p314xaae8f345.p3006xb8ff1437.p3069xbd917455.p3070xe3a677a0.p3071xc84c5534.C26529xf7ae38e4.PlayerStep.f54548xbbf10811, java.lang.Integer.valueOf(i18));
        linkedHashMap.put("kf_session_id", b00.k0.f98235a);
        return linkedHashMap;
    }

    public final dy1.r Zi() {
        return (dy1.r) ((jz5.n) this.f98171f).mo141623x754a37bb();
    }

    public void a(android.view.View view, com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, java.lang.String str, int i17) {
        ...
        if (view != null && f9Var != null) {
            if (!(str == null || str.length() == 0)) {
                ...
                wi(view, str, 160, str + '_' + f9Var.m124847x74d37ac6() + str2, b17, b00.w.f98317d);
                java.lang.StringBuilder sb6 = new java.lang.StringBuilder("bindReportForView success, viewId:");
                sb6.append(str);
                sb6.append(", viewIndex:");
                sb6.append(i17);
                com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EcsKfReportService", sb6.toString());
                return;
            }
        }
        ...
        sb7.append(", viewId:");
        sb7.append(str);
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.EcsKfReportService", sb7.toString());
    }

    public void aj(java.lang.String event, com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, java.lang.String str) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(event, "event");
        c(event, f9Var, str, -1);
    }

    public final java.util.Map b(com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, int i17) {
        ...
        if (T0 == null || T0.length() == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EcsKfReportService", "not ecs kf session, skip report");
            return null;
        }
        int c17 = k41.h1.c(T0);
        if (c17 == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.w("MicroMsg.EcsKfReportService", "ecs kf session, but type == 0");
            return null;
        }
    ...
    public final void bj(java.lang.String str, java.lang.String str2, java.util.Map map) {
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EcsKfReportService", "reportEvent viewId:" + str + ", eventId:" + str2 + ", params:" + map);
    }

    public void c(java.lang.String event, com.p314xaae8f345.mm.p2621x8fb0427b.f9 f9Var, java.lang.String str, int i17) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(event, "event");
        if (f9Var != null) {
            if (!(str == null || str.length() == 0)) {
                java.util.Map b17 = b(f9Var, i17);
                if (b17 != null) {
                    ...
                    t17.put("kf_session_id", b00.k0.f98235a);
                    bj(str, event, t17);
                    return;
                }
                return;
    ...
    public void hj(int i17, java.lang.String str) {
        if (!k41.h1.d(str)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EcsKfReportService", "reportEnterKfRoom skip, not ecs kf, scene:" + i17 + ", kfUserName:" + str);
            return;
        }
        int c17 = k41.h1.c(str);
        java.lang.String str2 = b00.k0.f98235a;
        java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
        ...
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i("MicroMsg.EcsKfReportService", "reportEnterKfRoom success, scene:" + i17 + ", sessionId:" + str2 + ", kfUserName:" + str + ", kefuType:" + c17 + ", params:" + linkedHashMap);
    }
    ...
    public final void wi(android.view.View view, java.lang.String str, int i17, java.lang.String str2, java.util.Map map, final yz5.l lVar) {
        ...
        if (lVar != null) {
            ((cy1.a) Zi()).Ai(view, new ly1.a(lVar) { // from class: b00.z
                ...
                public final /* synthetic */ yz5.l f98331a;
                ...
                public final /* synthetic */ java.util.Map b(java.lang.String str3) {
                    return (java.util.Map) this.f98331a.mo146xb9724478(str3);
                }
            });
        }
