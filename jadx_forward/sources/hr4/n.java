...
public final class n implements hr4.q {
    ...
    public void a(boolean z17, kr4.e eVar) {
        java.lang.String str = eVar != null ? eVar.f68903xdec927b : null;
        ...
        if (c17.containsKey(eVar.f68903xdec927b)) {
            hr4.q qVar = (hr4.q) pVar.c().get(eVar.f68903xdec927b);
            if (qVar != null) {
                qVar.a(z17, eVar);
            }
            pVar.c().remove(eVar.f68903xdec927b);
        }
        if (z17) {
            pVar.d(eVar);
        }
    ...
    @Override // hr4.q
    public void b() {
        java.util.Iterator it = hr4.p.f365796a.c().entrySet().iterator();
        while (it.hasNext()) {
            hr4.q.c((hr4.q) ((java.util.Map.Entry) it.next()).getValue(), false, null, 2, null);
        }
        hr4.p.f365796a.c().clear();
    }
}
