...
public class r {
    ...
    public java.lang.String f118458a = "WriterAndReader";

    /* renamed from: b, reason: collision with root package name */
    public java.io.File f118459b;

    public r(java.lang.String str) {
        this.f118459b = null;
        this.f118459b = new java.io.File(str);
    }
    ...
    public boolean a(byte[] bArr, boolean z17) {
        ...
        try {
            if (!this.f118459b.exists()) {
                java.io.File file = new java.io.File(this.f118459b.getParent());
                if (!file.exists()) {
                    file.mkdirs();
                    this.f118459b.createNewFile();
                }
            }
            fileOutputStream = new java.io.FileOutputStream(this.f118459b, z17);
    ...
    public java.lang.String a(java.lang.String str) {
        ...
        try {
            try {
                if (this.f118459b.exists()) {
                    java.io.FileInputStream fileInputStream2 = new java.io.FileInputStream(this.f118459b.getAbsolutePath());
                    try {
