...
public class q {
    ...
    public static java.lang.String f118449b = "TencentLocation_sapp/comp";

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.String f118450c = "TencentLocation_sapp/odex";

    /* renamed from: d, reason: collision with root package name */
    public static java.lang.String f118451d = "complist_loading_sapp";

    /* renamed from: e, reason: collision with root package name */
    public static long f118452e = 0;

    /* renamed from: f, reason: collision with root package name */
    public static java.lang.String f118453f = "01234567890ABCDEF";

    /* renamed from: g, reason: collision with root package name */
    public static java.lang.String f118454g = "key-locselfid";

    /* renamed from: h, reason: collision with root package name */
    public static java.lang.String f118455h = "key-locoutid";

    /* renamed from: i, reason: collision with root package name */
    public static java.lang.String f118456i = "01234567890ABCDEF";

    /* renamed from: a, reason: collision with root package name */
    public static final java.lang.Object f118448a = new java.lang.Object();

    /* renamed from: j, reason: collision with root package name */
    public static java.util.HashMap<java.lang.String, c.t.m.p134x35c0ce.c.r> f118457j = new java.util.HashMap<>();
    ...
    public static java.lang.String h(android.content.Context context) {
        return context.getFilesDir().getAbsolutePath() + java.io.File.separator + f118450c;
    }
    ...
    public static c.t.m.p134x35c0ce.c.r a(android.content.Context context, java.lang.String str) {
        if (f118457j.containsKey(str)) {
            return f118457j.get(str);
        }
        c.t.m.p134x35c0ce.c.r rVar = new c.t.m.p134x35c0ce.c.r(context.getFilesDir().getAbsolutePath() + "/TencentLocation_sapp/conf/" + str);
        f118457j.put(str, rVar);
        return rVar;
    }
    ...
    public static java.lang.String e(android.content.Context context) {
        try {
            ...
            java.lang.String str = c.t.m.p134x35c0ce.c.i.f118433a;
            return null;
        }
    }
    ...
    */
    public static int f(android.content.Context r9) {
        ...
        L7e:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: c.t.m.p134x35c0ce.c.q.f(android.content.Context):int");
    }

    public static java.lang.String g(android.content.Context context) {
        try {
            java.lang.String str = f118453f;
            if (str != null && str.length() != 0 && !"01234567890ABCDEF".equals(f118453f)) {
                return f118453f;
            }
            java.lang.String a17 = c.t.m.p134x35c0ce.c.l.a(b(context, "LocationSDK", "_col_ooo_"));
            if (!"01234567890ABCDEF".equals(a17) && !"".equals(a17)) {
                f118453f = a17;
                return a17;
            }
            java.lang.String b17 = b(context, "TLocationSDK", f118455h);
            if (!"01234567890ABCDEF".equals(b17)) {
                f118453f = b17;
                return b17;
            }
            java.lang.String b18 = b(context, "TLocationSDK", f118454g);
            ...
            f118453f = "01234567890ABCDEF";
            return "01234567890ABCDEF";
        }
    }

    public static java.lang.String c(android.content.Context context) {
        return context.getFilesDir().getAbsolutePath() + java.io.File.separator + f118449b;
    }
    ...
    public static java.lang.String c(java.lang.String str) {
        try {
            ...
            c.t.m.p134x35c0ce.c.e.b().a("DRG", "statucode:" + string);
            if (string.equals("-3")) {
                return null;
            }
            if (string.equals("0")) {
            ...
            c.t.m.p134x35c0ce.c.e.b().a("DRG", "statucode:" + e17.toString());
            return null;
        }
    }

    public static java.util.List<c.t.m.p134x35c0ce.c.a> d(java.lang.String str) {
        ...
        try {
            for (java.lang.String str2 : str.split(";")) {
                ...
                if (split.length >= 5) {
                    try {
                        c.t.m.p134x35c0ce.c.a aVar = new c.t.m.p134x35c0ce.c.a();
                        aVar.f118388a = java.lang.Integer.valueOf(split[0]).intValue();
                        aVar.f118389b = split[1];
                        aVar.f118390c = split[2];
                        aVar.f118391d = java.lang.Integer.valueOf(split[3]).intValue();
                        aVar.f118392e = split[4];
                        if (split.length > 5) {
                            aVar.f118393f = split[5];
                        }
                        arrayList.add(aVar);
                    } catch (java.lang.Exception unused) {
                    }
    ...
    public static void a() {
        ...
        f118449b = "TencentLocation_sapp/comp";
        f118450c = "TencentLocation_sapp/odex";
        f118449b += "_atuo_" + currentTimeMillis;
        f118450c += "_atuo_" + currentTimeMillis;
    }
    ...
    public static java.lang.String b(android.content.Context context, java.lang.String str, java.lang.String str2) {
        try {
            if (c.t.m.p134x35c0ce.c.p.f118447b == null) {
                c.t.m.p134x35c0ce.c.p.f118447b = context;
            }
            return (java.lang.String) c.t.m.p134x35c0ce.c.p.a(str, str2, "01234567890ABCDEF");
        } catch (java.lang.Throwable unused) {
            return "01234567890ABCDEF";
        }
    }
    ...
    */
    public static byte[] b(byte[] r7) {
        ...
        L7f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: c.t.m.p134x35c0ce.c.q.b(byte[]):byte[]");
    }
    ...
    public static void a(android.content.Context context) {
        ...
        try {
            ...
            for (java.io.File file : listFiles) {
                ...
                if (file.isDirectory() && name.contains("_atuo_") && !f118449b.contains(name)) {
                    if (name.startsWith("odex_")) {
                        if (f118449b.contains(name.replaceAll("odex_", "comp_"))) {
                        }
                    }
    ...
    public static java.util.List<java.lang.String> a(android.content.Context context, java.io.File file) {
        ...
        c.t.m.p134x35c0ce.c.i.a("before check ,private dir files:" + str);
        return arrayList;
    }
    ...
    public static void a(android.content.Context context, android.util.Pair<java.lang.String, java.lang.String> pair) {
        ...
        try {
            if (!com.p314xaae8f345.map.p490x3f94e06.p491x35c0ce.C4220x87c4c053.f16242xc6cd8c52.equals(pair.first) || (obj = pair.second) == null || ((java.lang.String) obj).length() <= 0) {
                return;
            }
            java.lang.Object obj2 = pair.second;
            f118456i = (java.lang.String) obj2;
            a(context, f118455h, (java.lang.String) obj2);
        } catch (java.lang.Throwable unused) {
        }
    }
    ...
    public static void a(android.content.Context context, java.lang.String str, java.lang.String str2) {
        try {
            ...
            c.t.m.p134x35c0ce.c.p.b("TLocationSDK", str, str2);
        } catch (java.lang.Throwable unused) {
        }
    }
    ...
    public static java.lang.String b(android.content.Context context, java.lang.String str) {
        ...
        try {
            ...
            java.io.BufferedReader bufferedReader = new java.io.BufferedReader(new java.io.InputStreamReader(open, com.p314xaae8f345.p519xbf8bc95e.p532x21ffc6bd.rv.f132803c));
            while (true) {
    ...
    public static java.lang.String a(java.util.List<c.t.m.p134x35c0ce.c.a> list) {
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        for (c.t.m.p134x35c0ce.c.a aVar : list) {
            sb6.append(aVar.f118388a);
            sb6.append(",");
            sb6.append(aVar.f118389b);
            sb6.append(",");
            ...
            sb6.append(aVar.f118390c);
            sb6.append(",");
            sb6.append(aVar.f118391d);
            sb6.append(",");
            sb6.append(aVar.f118392e);
            sb6.append(",");
            sb6.append(aVar.f118393f);
            sb6.append(";");
        }
        return sb6.toString();
    }

    public static boolean a(android.content.Context context, java.util.List<c.t.m.p134x35c0ce.c.a> list) {
        java.util.List<c.t.m.p134x35c0ce.c.a> d17 = d(c(context, "__SP_UPDATE_TencentLoc_COMP_INFO__sapp_", ""));
        if (list.size() == 0) {
            return false;
        }
        if (d17.size() == 0) {
        ...
        for (int i17 = 0; i17 < d17.size(); i17++) {
            c.t.m.p134x35c0ce.c.a aVar = d17.get(i17);
            int i18 = 0;
            while (true) {
                if (i18 < list.size()) {
                    c.t.m.p134x35c0ce.c.a aVar2 = list.get(i18);
                    if (aVar2.f118388a == aVar.f118388a) {
                        aVar.f118390c = aVar2.f118390c;
                        aVar.f118389b = aVar2.f118389b;
                        aVar.f118391d = aVar2.f118391d;
                        aVar.f118392e = aVar2.f118392e;
                        break;
                    }
                    i18++;
                }
    ...
    public static boolean a(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3, long j17, byte[] bArr) {
        ...
        try {
            ...
            byte[] b17 = b(c.t.m.p134x35c0ce.c.l.a(byteArrayOutputStream.toByteArray(), "sE0zy%DVqLnXA$hmNZ8NBwcg7FDrvi!q"));
            if (b17 != null) {
            ...
            c.t.m.p134x35c0ce.c.i.a("copy base to private dir", e17);
        }
        return z17;
    }
