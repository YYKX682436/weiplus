...
public abstract class a {
    public static int a(v2.k kVar, int i17) {
        ...
        for (int i27 = 0; i27 < size; i27++) {
            ...
            v2.g[] gVarArr = iVar.A;
            v2.g gVar = gVarArr[i18 + 1].f514170d;
            i19 = java.lang.Math.max(i19, b(iVar, i17, gVar == null || !(gVarArr[i18].f514170d == null || gVar == null), 0));
        }
        kVar.f514235c[i17] = i19;
        return i19;
    }
    ...
    public static int b(v2.i iVar, int i17, boolean z17, int i18) {
        ...
        v2.g gVar2 = iVar.f514212w;
        boolean z19 = gVar2.f514170d != null && i17 == 1;
        if (z17) {
            i27 = iVar.Q;
            i19 = iVar.h() - iVar.Q;
            i29 = i17 * 2;
        ...
        v2.g[] gVarArr = iVar.A;
        if (gVarArr[i28].f514170d == null || gVarArr[i29].f514170d != null) {
            i37 = 1;
        } else {
            i37 = -1;
            int i49 = i28;
        ...
        java.util.Iterator it = gVarArr[i29].f514167a.f514261a.iterator();
        int i59 = 0;
        while (it.hasNext()) {
            i59 = java.lang.Math.max(i59, b(((v2.o) ((v2.q) it.next())).f514250c.f514168b, i17, z17, i58));
        }
        java.util.Iterator it6 = gVarArr[i28].f514167a.f514261a.iterator();
        int i66 = 0;
        while (it6.hasNext()) {
            i66 = java.lang.Math.max(i66, b(((v2.o) ((v2.q) it6.next())).f514250c.f514168b, i17, z17, l18 + i58));
            it6 = it6;
            i28 = i28;
        }
        int i67 = i28;
        ...
        int i68 = 1;
        if (i17 == 1) {
            v2.o oVar = gVar2.f514167a;
            java.util.Iterator it7 = oVar.f514261a.iterator();
            int i69 = 0;
            while (it7.hasNext()) {
                java.util.Iterator it8 = it7;
                v2.o oVar2 = (v2.o) ((v2.q) it7.next());
                if (i37 == i68) {
                    i69 = java.lang.Math.max(i69, b(oVar2.f514250c.f514168b, i17, z17, i27 + i58));
                    i48 = i29;
                } else {
                    i48 = i29;
                    i69 = java.lang.Math.max(i69, b(oVar2.f514250c.f514168b, i17, z17, (i19 * i37) + i58));
                }
                it7 = it8;
                i29 = i48;
                i68 = 1;
        ...
        v2.g gVar3 = gVarArr[i38].f514170d;
        if (gVar3 != null && (gVar = gVarArr[i67].f514170d) != null && gVar3.f514168b == (iVar2 = iVar.D) && gVar.f514168b == iVar2) {
            iVar.f514205p.a(iVar, i17);
        }
        return max;
    }
    ...
    public static int c(v2.i iVar, int i17) {
        ...
        v2.g gVar4 = gVar2.f514170d;
        if (gVar4 == null) {
            return 0;
        }
        v2.i iVar2 = gVar4.f514168b;
        v2.i iVar3 = iVar.D;
        if (iVar2 != iVar3 || (gVar = gVar3.f514170d) == null || gVar.f514168b != iVar3) {
            return 0;
        }
    ...
    public static void e(java.util.List list, int i17, int i18) {
        ...
        for (int i19 = 0; i19 < size; i19++) {
            ...
            if (i17 == 0) {
                hashSet = kVar.f514238f;
            } else if (i17 == 1) {
                hashSet = kVar.f514239g;
            } else {
                kVar.getClass();
                hashSet = null;
            }
            for (v2.i iVar : hashSet) {
                if (iVar.f514183a0) {
                    ...
                    if ((gVar.f514170d == null || gVar2.f514170d == null) ? false : true) {
                        ...
                        if (iVar.G != 0.0f) {
                            ...
                            if ((i17 == 0 ? hVarArr[0] : i17 == 1 ? hVarArr[1] : null) == v2.h.MATCH_CONSTRAINT) {
                                int d17 = d(iVar);
                                int i28 = (int) gVarArr[i27].f514167a.f514254g;
                                int i29 = i28 + d17;
                                v2.o oVar = gVar2.f514167a;
                                oVar.f514253f = gVar.f514167a;
                                oVar.f514254g = d17;
                                oVar.f514262b = 1;
                                if (i17 == 0) {
                                    iVar.I = i28;
