...
public final class a extends android.text.style.ImageSpan {
    ...
    public final /* synthetic */ android.graphics.drawable.Drawable f123202d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f123203e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ boolean f123204f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(android.graphics.drawable.Drawable drawable, int i17, boolean z17) {
        super(drawable, 1);
        this.f123202d = drawable;
        this.f123203e = i17;
        this.f123204f = z17;
    }
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence charSequence, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        android.graphics.drawable.Drawable drawable = this.f123202d;
        ...
        if (this.f123204f) {
            ...
            canvas.translate(f17 + this.f123203e, i38);
        }
    ...
    public int getSize(android.graphics.Paint paint, java.lang.CharSequence charSequence, int i17, int i18, android.graphics.Paint.FontMetricsInt fontMetricsInt) {
        p3321xbce91901.jvm.p3324x21ffc6bd.o.g(paint, "paint");
        android.graphics.Rect bounds = this.f123202d.getBounds();
        ...
        return bounds.width() + this.f123203e;
    }
}
