...
public abstract class a {
    ...
    public final android.database.DataSetObservable f341069a = new android.database.DataSetObservable();
    ...
    public android.view.View a(int i17, android.view.View view, android.view.ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            if (hVar.f341075b == null) {
                hVar.f341075b = android.view.LayoutInflater.from(viewGroup.getContext());
            }
            int i18 = hVar.f341076c.get(0, org.p3343x72743996.net.InterfaceC29524x4f65168b.f73905xd13abb6c);
            f43.b bVar3 = null;
            android.view.View inflate = i18 != -404 ? hVar.f341075b.inflate(i18, viewGroup, false) : null;
        ...
        bVar.f341071b = 0;
        p33.i0 i0Var = (p33.i0) ((f43.h) this).f341077d.get(i17);
        if (i0Var != null) {
            ((android.widget.TextView) bVar.f341070a.findViewById(com.p314xaae8f345.mm.R.id.oqu)).setText(i0Var.f433126e);
        }
        return view2;
    }
}
