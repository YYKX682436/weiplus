...
public final class i implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.view.View f522383d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f522384e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.widget.TextView f522385f;

    public i(android.view.View view, int i17, android.widget.TextView textView) {
        this.f522383d = view;
        this.f522384e = i17;
        this.f522385f = textView;
    }
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator it) {
        ...
        android.view.View view = this.f522383d;
        ...
        int i17 = this.f522384e;
        this.f522383d.setTranslationY((-i17) * floatValue);
        android.widget.TextView textView = this.f522385f;
