...
public class f extends os0.a {
    ...
    public f(int i17, int i18, int i19, int i27, int i28, int i29) {
        ...
        this.E = t17;
        if (t17 == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.GLTextureRenderProcYuvToRgb", "checkInit, load program failed!");
        }
        ...
        this.f429553J = android.opengl.GLES20.glGetUniformLocation(t17, "uMatrix");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x003f, code lost:
        ...
        if (r1.capacity() != ((r13.f429525a * r13.f429526b) / 2)) goto L22;
     */
    @Override // os0.a
    /*
