...
public class d extends os0.a {
    ...
    public d(int i17, int i18, int i19, int i27, int i28, int i29, int i37, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
        ...
        this.F = t17;
        if (t17 == 0) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e("MicroMsg.GLTextureRenderProcI420ToRgb", "checkInit, load program failed!");
        }
        ...
        this.f429552J = android.opengl.GLES20.glGetUniformLocation(t17, "u_texture");
