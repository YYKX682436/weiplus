...
public class c extends os0.a {
    ...
    public /* synthetic */ c(int i17, int i18, int i19, int i27, int i28, int i29, int i37, p3321xbce91901.jvm.p3324x21ffc6bd.i iVar) {
    ...
    public void p() {
        ...
        if (i17 == -1 || !android.opengl.GLES20.glIsTexture(i17)) {
            com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.e(this.I, "draw with invalid texture");
            return;
        }
