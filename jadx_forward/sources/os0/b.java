...
public class b extends os0.a {
    ...
    public void p() {
        ...
        android.opengl.GLES20.glUseProgram(this.f429551J);
        android.opengl.GLES20.glActiveTexture(33984);
        android.opengl.GLES20.glBindTexture(this.Z, this.D);
        android.opengl.GLES20.glTexParameterf(this.Z, 10241, 9729.0f);
        android.opengl.GLES20.glTexParameterf(this.Z, com.p176xb6135e39.p177xcca8366f.gms.gcm.C2046x27a9a5.f6064x20a7e2cb, 9729.0f);
        ...
        android.opengl.GLES20.glVertexAttribPointer(this.K, 2, 5126, false, 0, (java.nio.Buffer) this.f429532h);
        int i39 = this.K;
        ...
        android.opengl.GLES20.glVertexAttribPointer(this.L, 2, 5126, false, 0, (java.nio.Buffer) this.f429531g);
        int i48 = this.L;
        android.opengl.GLES20.glEnableVertexAttribArray(i48);
        android.opengl.GLES20.glUniformMatrix4fv(this.S, 1, false, this.f429536l, 0);
        ...
        this.E = null;
        this.G = null;
        com.p314xaae8f345.p542x3306d5.p550x382fcc.Log.i(this.C, "draw frame used " + (android.os.SystemClock.elapsedRealtime() - elapsedRealtime) + "ms");
    }
