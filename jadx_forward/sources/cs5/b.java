...
public abstract class b {
    ...
    public static final java.util.regex.Pattern f303664a = java.util.regex.Pattern.compile("(.*),(.*)\\|(.*)");

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.regex.Pattern f303665b = java.util.regex.Pattern.compile("(.*)\\.:(.*),(.*)\\|(.*)");

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.regex.Pattern f303666c = java.util.regex.Pattern.compile("(.*),(.*)-(.*),(.*)\\|(.*)");

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.regex.Pattern f303667d = java.util.regex.Pattern.compile("(.*)\\.:(.*),(.*)-(.*),(.*)\\|(.*)");
    ...
    public static cs5.a b(int i17, java.lang.String str) {
        ...
        if (i17 != 3) {
            ...
            if (split.length <= 1) {
                java.util.regex.Matcher matcher = f303664a.matcher(str);
            ...
            for (java.lang.String str4 : split) {
                java.util.regex.Matcher matcher2 = f303665b.matcher(str4);
            ...
            return arrayList.size() == 0 ? cs5.a.f303659d : new cs5.a(i17, str3, (java.lang.String[]) arrayList.toArray(new java.lang.String[arrayList.size()]), hashMap);
        }
        java.util.HashMap hashMap2 = new java.util.HashMap();
        if (split.length <= 1) {
            try {
                java.util.regex.Matcher matcher3 = f303666c.matcher(split[0]);
        ...
        int i28 = 0;
        while (i28 < length) {
            java.util.regex.Matcher matcher4 = f303667d.matcher(split[i28]);
        ...
        return (arrayList2.size() == 0 && arrayList3.size() == 0) ? cs5.a.f303659d : new cs5.a(str2, (java.lang.String[]) arrayList2.toArray(new java.lang.String[arrayList2.size()]), (java.lang.String[]) arrayList3.toArray(new java.lang.String[arrayList3.size()]), hashMap2);
    }
