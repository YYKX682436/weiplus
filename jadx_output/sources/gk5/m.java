...
public final class m extends m50.x {
    ...
    public boolean k7(xi5.e action) {
        ...
        kotlin.jvm.internal.o.g(activity, "activity");
        gk5.m1 m1Var = (gk5.m1) pf5.z.f353948a.a(activity).a(gk5.m1.class);
        com.tencent.wework.api.IWWAPI.WWAppType d17 = com.tencent.mm.ui.chatting.hd.d(action.f454741b);
        m1Var.getClass();
        com.tencent.mm.ui.chatting.hd.r(m1Var.getActivity(), m1Var.getString(com.tencent.mm.R.string.ifb), d17);
        return true;
    }
    ...
    public void o7(java.lang.String toUser) {
        ...
        java.lang.Object obj = com.tencent.mm.pluginsdk.model.app.k0.K(v17, "", "", toUser, "", null, null, "", "", new com.tencent.mm.plugin.msg.MsgIdTalker(j17, aVar2.getString(aVar2.f43702d + 1))).second;
        if (obj != null) {
