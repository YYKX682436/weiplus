...
public final class c0 extends m50.x {
    ...
    public void o7(java.lang.String toUser) {
        ...
        byte[] N = com.tencent.mm.vfs.w6.N(Di.D2(e76, z07, true), 0, -1);
        ot0.q Z6 = Z6();
        if (Z6 != null) {
            ...
            if (h17 != null && (str = h17.field_fileFullPath) != null && !kotlin.jvm.internal.o.b(str, "")) {
                ...
                com.tencent.mars.xlog.Log.i("MicroMsg.ForwardMusicTingUIC", "summerbig send old path[%s], title[%s] attachPath[%s]， finish[%b]", h17.field_fileFullPath, Z6.f348654f, str2, java.lang.Boolean.valueOf(h17.t0()));
            }
            ...
            java.lang.Object obj = com.tencent.mm.pluginsdk.model.app.k0.K(i17, str4, str5, toUser, str3, N, "", "", v17, new com.tencent.mm.plugin.msg.MsgIdTalker(j17, cVar2.getString(cVar2.f43702d + 1))).second;
            if (obj != null) {
