...
public final class d1 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ gk5.k1 f272643d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ wi5.n0 f272644e;
    ...
    public final void onClick(android.view.View view) {
        ...
        gk5.k1 k1Var = this.f272643d;
        k1Var.getClass();
        android.content.Intent intent = new android.content.Intent();
        intent.setClassName(k1Var.getActivity(), "com.tencent.mm.ui.contact.GroupCardSelectUI");
        intent.putExtra("group_select_type", true);
        intent.putExtra("group_select_need_result", true);
        wi5.n0 n0Var = this.f272644e;
        if (n0Var.f446315h == 14) {
            ...
            k1Var.getActivity().startActivityForResult(intent, 4);
        } else {
            k1Var.getActivity().startActivityForResult(intent, 0);
        }
