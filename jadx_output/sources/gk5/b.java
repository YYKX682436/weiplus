...
public final class b extends m50.x {
    ...
    */
        ...
        if (Z6 != null) {
            ...
            if (e76 != null && e76.z0() != null && !kotlin.jvm.internal.o.b(e76.z0(), "")) {
                ...
                try {
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ForwardAppBrandUIC", e17, "processAppMessageTransfer send to user: %s, exception", up5.f.f429945o);
                }
            }
    ...
    public final boolean q7(byte[] bArr) {
        com.tencent.mars.xlog.Log.i("MicroMsg.ForwardAppBrandUIC", "isImage called, data[0-4]:[%d,%d,%d,%d,%d]", java.lang.Byte.valueOf(bArr[0]), java.lang.Byte.valueOf(bArr[1]), java.lang.Byte.valueOf(bArr[2]), java.lang.Byte.valueOf(bArr[3]), java.lang.Byte.valueOf(bArr[4]));
