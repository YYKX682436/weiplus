...
public class d implements lb1.l {
    ...
    public volatile java.util.Queue f317700a;

    /* renamed from: b, reason: collision with root package name */
    public volatile ob1.c f317701b;

    /* renamed from: c, reason: collision with root package name */
    public volatile java.util.List f317702c;

    /* renamed from: d, reason: collision with root package name */
    public final android.os.Handler f317703d = new android.os.Handler(android.os.Looper.getMainLooper());

    @Override // lb1.l
    public void a(android.bluetooth.BluetoothGatt bluetoothGatt, int i17, int i18) {
        ob1.c cVar = this.f317701b;
        if (cVar != null) {
            cVar.a(bluetoothGatt, i17, i18);
        }
        java.util.List list = this.f317702c;
        if (list != null) {
    ...
    public void b(android.bluetooth.BluetoothGatt bluetoothGatt, android.bluetooth.BluetoothGattDescriptor bluetoothGattDescriptor, int i17) {
        ...
        if (list != null) {
            java.util.Iterator it = ((java.util.ArrayList) list).iterator();
            while (it.hasNext()) {
                boolean z17 = ((ob1.c) it.next()).f343997l;
            }
        }
    }
    ...
    public final synchronized void k() {
        ob1.c cVar = this.f317701b;
        if (cVar == null || cVar.f343997l) {
            java.util.Queue queue = this.f317700a;
            if (queue != null) {
                ...
                if (concurrentLinkedQueue.size() > 0) {
                    ...
                    if (cVar2 == null) {
                        com.tencent.mars.xlog.Log.w("MicroMsg.Ble.BleConnectDispatcher", "curSerialAction is null, err", new java.lang.Object[0]);
                        return;
                    }
                    this.f317701b = cVar2;
                    if (cVar2.f343992g) {
                        this.f317703d.postDelayed(new lb1.c(this, cVar2), cVar2.f343995j);
                    } else {
                        cVar2.k();
                    }
                }
