...
public final class l1 extends kotlin.jvm.internal.q implements yz5.l {
    ...
    public final /* synthetic */ android.content.Context f265018d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f265019e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ er4.r f265020f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l1(android.content.Context context, java.lang.String str, er4.r rVar) {
        super(1);
        this.f265018d = context;
        this.f265019e = str;
        this.f265020f = rVar;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj) {
        ...
        if (intent != null) {
            android.content.Context context = this.f265018d;
            java.lang.String otherUserName = this.f265019e;
            er4.r rVar = this.f265020f;
            qo5.b bVar = qo5.b.f365663a;
            boolean z17 = rVar == er4.r.MP_ROOM_TYPE_VIDEO;
            kotlin.jvm.internal.o.g(context, "context");
            kotlin.jvm.internal.o.g(otherUserName, "otherUserName");
            ...
            boolean b19 = nq4.f.f339014a.b();
            if (b19) {
                com.tencent.mars.xlog.Log.i("MicroMsg.VoIPMPVoIPNotificationHelper", "Enable Bluetooth QuickAccept, use silent channel");
                ...
                com.tencent.mars.xlog.Log.i("MicroMsg.VoIPMPVoIPNotificationHelper", "Use origin channel");
            }
            android.app.PendingIntent activity = r26.i0.p(android.os.Build.MANUFACTURER, "vivo", true) ? android.app.PendingIntent.getActivity(com.tencent.mm.sdk.platformtools.x2.f193071a, 0, intent, fp.g0.a(134217728) | 67108864) : android.app.PendingIntent.getActivity(com.tencent.mm.sdk.platformtools.x2.f193071a, 0, intent, fp.g0.a(134217728));
            ...
            com.tencent.mm.storage.z3 n17 = ((com.tencent.mm.plugin.messenger.foundation.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Bi().n(otherUserName, true);
            ...
            kotlin.jvm.internal.o.f(b27, "build(...)");
            b27.flags |= 4;
            com.tencent.mars.xlog.Log.i("MicroMsg.VoIPMPVoIPNotificationHelper", "voip notify it ");
            ((com.tencent.mm.booter.notification.x) mo3.f.f330406a).n(41, b27, true);
            qo5.b.f365666d = java.lang.System.currentTimeMillis();
            if (mx3.f0.j() && fp.e0.g()) {
                com.tencent.mm.sdk.platformtools.x2.f193071a.grantUriPermission("com.android.systemui", com.tencent.mm.sdk.platformtools.i1.b(com.tencent.mm.sdk.platformtools.x2.f193071a, com.tencent.mm.vfs.r6.j(new java.io.File(mx3.i0.j(otherUserName).h()))), 1);
            }
            qo5.b.f365667e.alive();
            com.tencent.mm.plugin.voipmp.platform.k kVar = com.tencent.mm.plugin.voipmp.platform.k.f177277b;
            er4.k kVar2 = er4.k.VoIPMPIlinkSDKStatTypeNotifyAction;
            er4.j jVar = new er4.j();
            jVar.f256104d = er4.z.ACTION_TYPE_INCOMING_SHOW_NOTIFICATION;
            jVar.f256110m[1] = true;
            kVar.a(kVar2, jVar);
        }
