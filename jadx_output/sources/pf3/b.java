...
public class b {
    ...
    public final pf3.d f353812a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Set f353813b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.Set f353814c;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Set f353815d;

    public b(pf3.d opLayer) {
        kotlin.jvm.internal.o.g(opLayer, "opLayer");
        this.f353812a = opLayer;
        this.f353813b = new java.util.LinkedHashSet();
        this.f353814c = new java.util.LinkedHashSet();
        this.f353815d = new java.util.LinkedHashSet();
    }
    ...
    public final void a(pf3.d layer) {
        ...
        java.util.Map map2 = layer.f353821p;
        ...
        java.util.Iterator it8 = this.f353813b.iterator();
        while (it8.hasNext()) {
        ...
        for (android.view.View view3 : this.f353815d) {
        ...
        for (android.view.View view4 : this.f353814c) {
    ...
    public final void b(android.view.View view) {
        ...
        this.f353814c.add(view);
    }

    public final void c(android.view.View view) {
        kotlin.jvm.internal.o.g(view, "view");
        this.f353813b.add(view);
    }
}
