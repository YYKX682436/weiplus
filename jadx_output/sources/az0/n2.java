...
public final class n2 {
    ...
    public n2() {
        this.f15734e = -1;
        this.f15734e = rs0.i.f399296a.t("uniform mat4 uMVPMatrix;\n            uniform float flipY;\n            uniform mat4 uSTMatrix;\n            attribute vec4 aPosition;\n            attribute vec4 aTextureCoord;\n            varying vec2 vTextureCoord;\n            void main() {\n                gl_Position = uMVPMatrix * aPosition * vec4(1.0, flipY, 1.0, 1.0);\n                vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n            }\n            ", "#extension GL_OES_EGL_image_external : require\n            precision highp float;\n            varying vec2 vTextureCoord;\n            uniform samplerExternalOES sTexture;\n            void main() {\n                gl_FragColor = texture2D(sTexture, vTextureCoord);\n            }\n            ");
    }

    public final void a(java.lang.String str) {
        int glGetError = android.opengl.GLES20.glGetError();
        if (glGetError != 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.MaasMJCaptureSessionPreload", str + ": glError 0x" + java.lang.Integer.toHexString(glGetError));
        }
    }

    public final void b(int i17, float[] fArr, int i18, int i19, int i27, int i28, boolean z17) {
        if (this.f15734e == -1) {
            com.tencent.mars.xlog.Log.e("MicroMsg.MaasMJCaptureSessionPreload", "program is not ready");
            return;
        }
        a("draw start");
        int i29 = this.f15734e;
        ...
        android.opengl.GLES20.glUniform1i(android.opengl.GLES20.glGetUniformLocation(i29, androidx.camera.core.processing.util.GLUtils.VAR_TEXTURE), 0);
        a("glViewport");
