...
public abstract class a {
    ...
    public static final java.util.Map f395832a = new ri.b();

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.Runnable f395833b = new ri.c();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.Map f395834c = new java.util.HashMap();

    /* renamed from: d, reason: collision with root package name */
    public static final yj0.b f395835d = new ri.d();

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.Map f395836e = new java.util.HashMap();

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.Map f395837f = new java.util.HashMap();

    /* renamed from: g, reason: collision with root package name */
    public static final yj0.b f395838g = new ri.e();

    /* renamed from: h, reason: collision with root package name */
    public static final java.util.Map f395839h = new java.util.HashMap();

    /* renamed from: i, reason: collision with root package name */
    public static final yj0.b f395840i = new ri.f();

    /* renamed from: j, reason: collision with root package name */
    public static final java.util.Map f395841j = new java.util.HashMap();

    /* renamed from: k, reason: collision with root package name */
    public static final yj0.b f395842k = new ri.g();

    /* renamed from: l, reason: collision with root package name */
    public static final java.util.Map f395843l = new java.util.HashMap();

    /* renamed from: m, reason: collision with root package name */
    public static final yj0.b f395844m = new ri.h();
    ...
    public static void a(java.lang.Class cls, wh.t0 t0Var) {
        ...
        qh.f0 f0Var = uVar.f354296h;
        if (f0Var.f363335d.f363298q || (i17 = f0Var.i(cls)) == null) {
            return;
        }
        t0Var.accept(i17);
    }
    ...
    public static void c(java.lang.String str, final java.lang.String str2, final java.lang.String str3, final java.lang.String str4, final java.lang.String str5, java.lang.String str6, final java.lang.Object obj, final java.lang.Object[] objArr) {
        ...
        switch (c17) {
                ...
                a(rh.e4.class, new wh.t0() { // from class: ri.a$$a
                    ...
                    public final void accept(java.lang.Object obj2) {
                        ...
                        if (str12.equals("startScan")) {
                            e4Var.f395372b.f395366a++;
                        } else if (str12.equals("getScanResults")) {
                            e4Var.f395372b.f395367b++;
                        }
                    }
                });
                break;
            case 1:
                a(rh.m.class, new wh.t0() { // from class: ri.a$$d
                    ...
                    public final void accept(java.lang.Object obj2) {
                        ...
                        switch (c19) {
                            case 0:
                                synchronized (mVar.f395451c.f395438a) {
                                    r5.f395440c--;
                                }
                                return;
                            case 1:
            ...
            case 2:
                if (ih.d.c() && (uVar = (ph.u) ih.d.d().a(ph.u.class)) != null) {
                    qh.f0 f0Var = uVar.f354296h;
                    if (!f0Var.f363335d.f363298q && (i17 = f0Var.i(rh.m.class)) != null) {
                        str5.getClass();
                        break;
                    }
                }
                    ...
                    public final void accept(java.lang.Object obj2) {
                        ...
                        switch (c19) {
                            case 0:
                                ...
                                return;
                            case 1:
                                synchronized (z3Var.f395576d.f395561a) {
                                    r12.f395565e--;
                                }
            ...
            case 4:
                if (objArr != null) {
                    ...
                    while (i28 < length) {
                        ...
                        if ((obj2 instanceof android.content.Intent) && (component = ((android.content.Intent) obj2).getComponent()) != null && (packageManager = com.tencent.mm.sdk.platformtools.x2.f193071a.getPackageManager()) != null) {
                            try {
                                ...
                                com.tencent.mars.xlog.Log.w("Matrix.battery.AmsInvokeListener", "get service info err: " + e17.getMessage());
                            }
                        }
                    ...
                    if (c18 == 1 || c18 == 2 || c18 == 3) {
                        if (!android.text.TextUtils.isEmpty(str8)) {
                            try {
                                ...
                                ((com.tencent.mm.feature.performance.q) ((ob0.i3) i95.n0.c(ob0.i3.class))).getClass();
                                ((com.tencent.mm.ipcinvoker.wx_extension.p0) ((com.tencent.mm.ipcinvoker.wx_extension.i0) i95.n0.c(com.tencent.mm.ipcinvoker.wx_extension.i0.class))).getClass();
                            } catch (java.lang.ClassNotFoundException unused) {
                                str10 = str9;
                            }
                            if (com.tencent.mm.ipcinvoker.BaseIPCService.class.isAssignableFrom(cls)) {
                                ((com.tencent.mm.feature.performance.q) ((ob0.i3) i95.n0.c(ob0.i3.class))).getClass();
                                ((com.tencent.mm.ipcinvoker.wx_extension.p0) ((com.tencent.mm.ipcinvoker.wx_extension.i0) i95.n0.c(com.tencent.mm.ipcinvoker.wx_extension.i0.class))).getClass();
                                java.lang.ThreadLocal threadLocal = com.tencent.mm.ipcinvoker.q.f68387i;
                                java.lang.Class cls2 = threadLocal != null ? (java.lang.Class) threadLocal.get() : null;
                                if (cls2 != null) {
                                    str11 = "ipc:" + cls2.getName();
                                    str10 = str11;
                                    if ((i18 & 1) != 1 || (i18 & 32) != 32) {
                                        ((com.tencent.mm.feature.performance.q) ((ob0.i3) i95.n0.c(ob0.i3.class))).Ni("type_bind_service", java.lang.System.currentTimeMillis(), bm5.f1.a(), str8, str10);
                                    }
                                }
                            }
                            str11 = str9;
                        ...
                        if (!(serviceConnection instanceof l85.s0)) {
                            if (com.tencent.mm.sdk.platformtools.s9.f192975c && (i18 & 1) == 1) {
                            ...
                            if (serviceConnection != null && !android.text.TextUtils.isEmpty(str8)) {
                                ...
                                synchronized (map) {
                                    ...
                                    synchronized (list2) {
                                        com.tencent.mars.xlog.Log.i("Matrix.battery.AmsInvokeListener", "hold service conn: " + str9 + "@" + serviceConnection.hashCode() + ", proc=" + str8);
                                ...
                                try {
                                    ...
                                    while (it.hasNext()) {
                                        ...
                                        if (((java.lang.ref.WeakReference) pair.second).get() == serviceConnection) {
                                            com.tencent.mars.xlog.Log.i("Matrix.battery.AmsInvokeListener", "release service conn: " + ((java.lang.String) pair.first) + "@" + serviceConnection.hashCode());
                                            it.remove();
                                        }
                                    }
                                } catch (java.lang.Exception e18) {
                                    com.tencent.mars.xlog.Log.w("Matrix.battery.AmsInvokeListener", "modify err: " + e18.getMessage());
                                }
                            }
                        }
                    }
            ...
            case 5:
                if (ih.d.c() && (uVar2 = (ph.u) ih.d.d().a(ph.u.class)) != null) {
                    qh.f0 f0Var2 = uVar2.f354296h;
                    if (!f0Var2.f363335d.f363298q && (i19 = f0Var2.i(rh.m2.class)) != null) {
                        rh.m2 m2Var = (rh.m2) i19;
                        str5.getClass();
                        if (str5.equals("requestLocationUpdates")) {
                            m2Var.f395460b.f395444a++;
                            break;
                        }
                    }
                }
                ...
                a(rh.b0.class, new wh.t0() { // from class: ri.a$$b
                    ...
                    public final void accept(java.lang.Object obj3) {
                        ...
                        switch (c19) {
                            case 0:
                            case 1:
                                b0Var.f395307b.f395297c++;
                                return;
                            case 2:
                                b0Var.f395307b.f395296b++;
                                return;
                            default:
                                return;
                        }
        ...
        com.tencent.mars.xlog.Log.i("Matrix.battery.AmsInvokeListener", sb6.toString());
    }
}
