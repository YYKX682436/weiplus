...
public abstract class i {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:99:0x0157, code lost:
        ...
        if (r15.contains(com.tencent.matrix.battery.accumulate.persist.FlattProperty.PROC_MM) == false) goto L80;
     */
    ...
    */
    ...
    public static java.lang.String c(rh.c1 c1Var) {
        char c17;
        java.lang.String str = c1Var.f395337s;
        switch (str.hashCode()) {
            case -1462962565:
    ...
    public static int d() {
        int d17 = wh.m.d(com.tencent.mm.sdk.platformtools.x2.f193071a, com.tencent.mm.app.w.INSTANCE.f53889n);
        if (d17 == 2 && com.tencent.mm.app.q5.b().d()) {
            return 4;
        }
        return d17;
    }
    ...
    public static int e() {
        return wh.m.r(com.tencent.mm.sdk.platformtools.x2.f193071a);
    }
    ...
    public static java.lang.String g(java.lang.String str) {
        return !str.contains(com.tencent.mm.sdk.platformtools.x2.f193072b) ? str : str.contains(":") ? str.substring(str.lastIndexOf(":") + 1) : com.tencent.matrix.battery.accumulate.persist.FlattProperty.PROC_MM;
    }

    public static m3.d h(qh.b bVar) {
        java.lang.String str = bVar.f363316i;
        int i17 = bVar.f363317j;
        if ("background".equals(str)) {
            if (android.text.TextUtils.isEmpty(bVar.f363318k)) {
                java.lang.String str2 = gi.p.f272076b;
                if (!com.eclipsesource.mmv8.Platform.UNKNOWN.equals(str2)) {
                    i17 = -1;
                    str = str2;
                }
            } else {
