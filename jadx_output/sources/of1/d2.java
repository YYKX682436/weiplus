...
public class d2 implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.os.Bundle f344904d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ of1.m2 f344905e;

    public d2(of1.m2 m2Var, android.os.Bundle bundle) {
        this.f344905e = m2Var;
        this.f344904d = bundle;
    }

    @Override // java.lang.Runnable
    public void run() {
        com.tencent.mm.plugin.webview.permission.w wVar;
        of1.m2 m2Var = this.f344905e;
        if (m2Var.f344975e == null || (wVar = m2Var.f344976f) == null || !wVar.c().f(42)) {
            return;
        }
        m2Var.f344975e.D(this.f344904d, "download_succ");
    }
}
