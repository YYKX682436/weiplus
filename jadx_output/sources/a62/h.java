...
public abstract class h {
    public static void a(r45.lw3 lw3Var, r45.jw3 jw3Var) {
        ...
        r45.w35 w35Var2;
        r45.c45 c45Var2;
        com.tencent.mars.xlog.Log.i("HABBYGE-MALI.HellSessionReportUtil", "adjustSession");
        java.util.Iterator it = lw3Var.f379878f.iterator();
        ...
        loop0: while (true) {
            ...
            while (it.hasNext()) {
                ...
                if (c45Var2 != null) {
                    ...
                    if (c45Var2.f371275i < c45Var3.f371275i) {
                        c45Var3 = c45Var2;
                    }
                    if (c45Var2.f371276m > c45Var.f371276m) {
                        c45Var = c45Var2;
                    }
                }
            }
        ...
        java.util.Iterator it6 = lw3Var.f379880h.iterator();
        loop2: while (true) {
            w35Var = w35Var3;
            while (it6.hasNext()) {
                ...
                if (w35Var2 != null) {
                    ...
                    if (w35Var2.f388845g < w35Var3.f388845g) {
                        w35Var3 = w35Var2;
                    }
                    if (w35Var2.f388846h > w35Var.f388846h) {
                        w35Var = w35Var2;
                    }
                }
            }
        ...
        if (c45Var3 == null) {
            ...
            z17 = w35Var3.f388848m.equals(jw3Var.f378159d) && w35Var3.f388845g == jw3Var.f378160e;
            w35Var3.f388845g = lw3Var.f379876d;
            if (z17) {
                com.tencent.mars.xlog.Log.i("HABBYGE-MALI.HellSessionReportUtil", " adjustSession same page TRUE !!!");
                jw3Var.f378160e = w35Var3.f388845g;
            } else {
                com.tencent.mars.xlog.Log.e("HABBYGE-MALI.HellSessionReportUtil", " adjustSession same page FALSE !!!");
            }
        } else if (w35Var3 == null) {
            c45Var3.f371275i = lw3Var.f379876d;
        } else if (w35Var3.f388845g < c45Var3.f371275i) {
            z17 = w35Var3.f388848m.equals(jw3Var.f378159d) && w35Var3.f388845g == jw3Var.f378160e;
            w35Var3.f388845g = lw3Var.f379876d;
            if (z17) {
                com.tencent.mars.xlog.Log.i("HABBYGE-MALI.HellSessionReportUtil", " adjustSession same page TRUE !!!");
        ...
        if (c45Var == null) {
            if (w35Var != null) {
                w35Var.f388846h = lw3Var.f379877e;
            }
        } else if (w35Var == null) {
            c45Var.f371276m = lw3Var.f379877e;
        } else if (w35Var.f388846h > c45Var.f371276m) {
            w35Var.f388846h = lw3Var.f379877e;
        } else {
            c45Var.f371276m = lw3Var.f379877e;
        }
    ...
    public static void b(org.json.JSONObject jSONObject, r45.jw3 jw3Var, boolean z17, long j17) {
        ...
        java.util.LinkedList<r45.kw3> linkedList = z17 ? jw3Var.f378165m : jw3Var.f378163h;
        org.json.JSONArray jSONArray = new org.json.JSONArray();
        if (linkedList.isEmpty()) {
            jSONObject.put("businessParam", jSONArray);
            e(jw3Var.f378159d, z17, j17);
            return;
        }
        ...
        for (r45.kw3 kw3Var2 : linkedList) {
            if (kw3Var2 != null) {
                ...
                java.lang.String str3 = kw3Var2.f378998d;
                ...
                do {
                    i17++;
                    str = com.tencent.mm.plugin.expt.hellhound.ext.session.config.c.d(jw3Var.f378160e, i17);
    ...
    public static void c(org.json.JSONObject jSONObject, r45.jw3 jw3Var, long j17) {
        ...
        java.lang.String str;
        if (jw3Var.f378166n.isEmpty()) {
            g(jw3Var.f378159d, j17);
            return;
        }
        ?? jSONArray = new org.json.JSONArray();
        java.util.Iterator it6 = jw3Var.f378166n.iterator();
        while (it6.hasNext()) {
            r45.a07 a07Var = (r45.a07) it6.next();
            if (a07Var != null && !a07Var.f369614t) {
                ...
                if (linkedList.isEmpty()) {
                    obj = jSONArray;
                    it = it6;
                    f(a07Var.f369602e, jw3Var.f378159d, j17);
                } else {
                    org.json.JSONArray jSONArray2 = new org.json.JSONArray();
                    java.util.Iterator it7 = linkedList.iterator();
                    while (it7.hasNext()) {
                        r45.ql qlVar = (r45.ql) it7.next();
                        if (qlVar != null && qlVar.f384080d == j17) {
                            java.util.Iterator it8 = qlVar.f384081e.iterator();
                            while (it8.hasNext()) {
                                r45.kw3 kw3Var = (r45.kw3) it8.next();
                                if (kw3Var != null && (str = kw3Var.f378999e) != null) {
                                    java.util.Iterator it9 = a07Var.f369613s.iterator();
                                    boolean z17 = false;
                                    ...
                                    while (it9.hasNext()) {
                                        ...
                                        if (k44Var != null && k44Var.f378363d == j17) {
                                            java.util.Iterator it11 = k44Var.f378364e.iterator();
                                            while (true) {
                                                if (it11.hasNext()) {
    ...
    */
    ...
    public static void e(java.lang.String str, boolean z17, long j17) {
        r45.g16 b17;
        if (z17 || (b17 = com.tencent.mm.plugin.expt.hellhound.ext.session.config.e.a().b(j17)) == null) {
            return;
        }
        java.util.Iterator it = b17.f374824f.iterator();
        while (it.hasNext()) {
            r45.c16 c16Var = (r45.c16) it.next();
            if (c16Var != null && str.equals(b52.b.g(c16Var.f371220d)) && !(!c16Var.f371221e.isEmpty())) {
                return;
            }
        }
    }
    ...
    public static void f(java.lang.String str, java.lang.String str2, long j17) {
        boolean z17;
        r45.g16 b17 = com.tencent.mm.plugin.expt.hellhound.ext.session.config.e.a().b(j17);
        if (b17 != null) {
            java.util.Iterator it = b17.f374824f.iterator();
            while (it.hasNext()) {
                r45.c16 c16Var = (r45.c16) it.next();
                if (c16Var != null && str2.equals(b52.b.g(c16Var.f371220d))) {
                    ...
                    while (true) {
                        ...
                        if (b07Var != null && str.equals(b07Var.f370422i)) {
                            b07Var.f370421h.isEmpty();
                            z17 = true;
                            break;
                        }
                    }
    ...
    public static void g(java.lang.String str, long j17) {
        ...
        if (b17 != null) {
            ...
            while (it.hasNext()) {
                r45.c16 c16Var = (r45.c16) it.next();
                if (c16Var != null && str.equals(b52.b.g(c16Var.f371220d)) && !(!c16Var.f371222f.isEmpty())) {
                    return;
                }
            }
        }
    ...
    */
    ...
    public static void i(r45.iw3 iw3Var, r45.lw3 lw3Var, boolean z17) {
        ...
        r45.jw3 jw3Var;
        r45.jw3 jw3Var2;
        java.util.Collections.sort(iw3Var.f377354d, new a62.g());
        ...
        while (true) {
            ...
            java.util.List list = (java.util.List) ((java.util.HashMap) j17).get(c45Var.f371270d);
            if (list != null && !list.isEmpty()) {
                ((r45.jw3) list.get(0)).f378160e = c45Var.f371275i;
            }
        }
        java.util.Iterator it6 = lw3Var.f379880h.iterator();
        while (it6.hasNext()) {
            r45.w35 w35Var = (r45.w35) it6.next();
            java.util.List list2 = (java.util.List) ((java.util.HashMap) j17).get(w35Var.f388848m + "_" + w35Var.f388845g);
            if (list2 != null && !list2.isEmpty()) {
                ((r45.jw3) list2.get(0)).f378160e = w35Var.f388845g;
            }
        }
        java.util.LinkedList linkedList = iw3Var.f377354d;
        int size = linkedList.size();
        if (size > 0 && (jw3Var2 = (r45.jw3) linkedList.getFirst()) != null) {
            jw3Var2.f378160e = lw3Var.f379876d;
        }
        int i18 = 0;
        while (true) {
            if (i18 >= size) {
            ...
            if (jw3Var3 != null) {
                ...
                if (jw3Var4 != null && jw3Var3.f378161f == 0) {
                    long j18 = jw3Var4.f378160e - jw3Var3.f378160e;
                    jw3Var3.f378161f = j18 > 0 ? j18 : 0L;
                }
            }
            i18++;
        }
        if (!z17) {
            ...
            long j19 = lw3Var.f379877e - jw3Var.f378160e;
            jw3Var.f378161f = j19 > 0 ? j19 : 0L;
            return;
        }
        long j27 = 0;
        for (i17 = 0; i17 < size; i17++) {
            ...
            if (jw3Var5 != null) {
                long j28 = jw3Var5.f378161f;
                if (j28 > 0) {
                    j27 += j28;
                }
            }
        }
        lw3Var.f379877e = lw3Var.f379876d + j27;
    }

    public static java.util.Map j(r45.iw3 iw3Var) {
        java.util.List arrayList;
        java.util.HashMap hashMap = new java.util.HashMap();
        java.util.Iterator it = iw3Var.f377354d.iterator();
        while (it.hasNext()) {
            r45.jw3 jw3Var = (r45.jw3) it.next();
            if (jw3Var != null) {
                java.lang.String str = jw3Var.f378162g;
                if (str == null || str.isEmpty()) {
                    java.util.ArrayList arrayList2 = new java.util.ArrayList();
                    arrayList2.add(jw3Var);
                    hashMap.put(jw3Var.f378159d + "_" + jw3Var.f378160e, arrayList2);
                } else {
                    if (hashMap.containsKey(jw3Var.f378162g)) {
                        arrayList = (java.util.List) hashMap.get(jw3Var.f378162g);
                        if (arrayList == null) {
                    ...
                    hashMap.put(jw3Var.f378162g, arrayList);
                }
            }
        }
        return hashMap;
        ...
        while (it.hasNext()) {
            ...
            if (jw3Var != null) {
                ...
                if (str != null && !str.isEmpty()) {
                    ...
                    arrayList.add(jw3Var);
                    hashMap.put(jw3Var.f378162g, arrayList);
                } else if (!hashMap.containsKey(jw3Var.f378159d)) {
                    java.util.ArrayList arrayList2 = new java.util.ArrayList();
                    arrayList2.add(jw3Var);
                    hashMap.put(jw3Var.f378159d, arrayList2);
                }
            }
        }
        return hashMap;
