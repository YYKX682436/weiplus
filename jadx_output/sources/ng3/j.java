...
public final class j extends android.view.GestureDetector.SimpleOnGestureListener {
    ...
    public final /* synthetic */ ng3.k f337008d;
    ...
    public boolean onDown(android.view.MotionEvent e17) {
        ...
        ng3.l lVar = new ng3.l(ng3.t.f337040h, null, e17, 0.0f, 0.0f, 26, null);
        ng3.k kVar = this.f337008d;
        kVar.a(lVar);
        kVar.getClass();
    ...
    public boolean onFling(android.view.MotionEvent motionEvent, android.view.MotionEvent e27, float f17, float f18) {
        ...
        ng3.d dVar = new ng3.d(ng3.t.f337043n, motionEvent, e27, f17, f18);
        ng3.k kVar = this.f337008d;
        kVar.d(dVar);
        kVar.getClass();
    ...
    public void onLongPress(android.view.MotionEvent motionEvent) {
        ...
        java.lang.Object[] array = arrayList.toArray();
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/media/view/gesture/controller/MoveController$gestureDetector$1", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V", this, array);
        super.onLongPress(motionEvent);
        yj0.a.h(this, "com/tencent/mm/plugin/media/view/gesture/controller/MoveController$gestureDetector$1", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V");
    }
    ...
    public boolean onScroll(android.view.MotionEvent motionEvent, android.view.MotionEvent e27, float f17, float f18) {
        kotlin.jvm.internal.o.g(e27, "e2");
        ng3.k kVar = this.f337008d;
        android.view.VelocityTracker velocityTracker = kVar.f337009c;
        int xVelocity = velocityTracker != null ? (int) velocityTracker.getXVelocity() : 0;
        android.view.VelocityTracker velocityTracker2 = kVar.f337009c;
        ...
        kVar.a(new ng3.l(ng3.t.f337041i, motionEvent, e27, f17, f18));
        ...
        if (java.lang.Math.abs(d17) <= 250.0d && java.lang.Math.abs(f18) > java.lang.Math.abs(d17) && java.lang.Math.abs(yVelocity) > java.lang.Math.abs(xVelocity)) {
            kVar.a(new ng3.l(ng3.t.f337042m, motionEvent, e27, f17, f18));
        }
