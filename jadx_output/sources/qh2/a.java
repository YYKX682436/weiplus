...
public final class a implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ qh2.d f363434d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ lj2.x0 f363435e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ lj2.v0 f363436f;
    ...
    public final void onClick(android.view.View view) {
        ...
        qh2.d dVar = this.f363434d;
        boolean G = dVar.G();
        lj2.x0 x0Var = this.f363435e;
        if (G || x0Var.V()) {
            zh2.b m17 = x0Var.m();
            if (m17 != null) {
                ((ch2.o2) m17).z7(4);
            }
            lf2.a aVar = (lf2.a) this.f363436f.o(lf2.a.class);
            if (aVar != null) {
                aVar.Z6(2, 4);
            }
        } else {
