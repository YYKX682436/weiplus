...
public final class b implements android.animation.Animator.AnimatorListener {
    ...
    public final /* synthetic */ nq.c f338862d;
    ...
    public void onAnimationCancel(android.animation.Animator animator) {
        this.f338862d.f338863d.f338873g = false;
    }

    @Override // android.animation.Animator.AnimatorListener
    public void onAnimationEnd(android.animation.Animator animator) {
        nq.c cVar = this.f338862d;
        android.view.View view = cVar.f338863d.f338871e;
        if (view != null) {
