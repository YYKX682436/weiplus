...
public class e implements java.util.Enumeration {
    ...
    public final java.util.Enumeration f295629a;

    public e(java.util.Enumeration enumeration, ix5.d dVar) {
        this.f295629a = enumeration;
    }

    @Override // java.util.Enumeration
    public boolean hasMoreElements() {
        return this.f295629a.hasMoreElements();
    }

    @Override // java.util.Enumeration
    public java.lang.Object nextElement() {
        java.lang.String name;
        java.util.zip.ZipEntry zipEntry = (java.util.zip.ZipEntry) this.f295629a.nextElement();
