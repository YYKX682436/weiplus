...
public class w5 {
    ...
    public static final android.net.Uri f305812a = android.net.Uri.parse("content://" + rf.a.f394606a + "/WxaAttributesTable");

    /* renamed from: b, reason: collision with root package name */
    public static final k91.w5 f305813b = new k91.w5();
    ...
    */
    public java.util.List a(java.util.List r11, java.lang.String... r12) {
        ...
        L2d:
            ...
            r2 = 0
            android.content.Context r3 = com.tencent.mm.sdk.platformtools.x2.f193071a     // Catch: java.lang.Throwable -> L8a
            android.content.ContentResolver r4 = r3.getContentResolver()     // Catch: java.lang.Throwable -> L8a
            android.net.Uri r5 = k91.w5.f305812a     // Catch: java.lang.Throwable -> L8a
        ...
        L67:
            ...
            r1.convertFrom(r12)     // Catch: java.lang.Throwable -> L7e
        ...
        L8a:
            ...
            com.tencent.mars.xlog.Log.e(r12, r0, r11)
            return r2
        L9f:
    ...
    public k91.v5 b(java.lang.String str, java.lang.String... strArr) {
        ...
        com.tencent.mars.xlog.Log.i("Luggage.WxaAttrsContentResolver", "queryWithAppId appId:%s, cost:%dms, columns:%s", str, java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime), java.util.Arrays.toString(strArr));
        return c17;
    }

    public final k91.v5 c(java.lang.String[] strArr, java.lang.String str, java.lang.String[] strArr2) {
        android.database.Cursor query = com.tencent.mm.sdk.platformtools.x2.f193071a.getContentResolver().query(f305812a, strArr, str, strArr2, null);
        k91.v5 v5Var = null;
        if (query == null) {
            return null;
        }
