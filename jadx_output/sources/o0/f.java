...
public final class f implements java.util.List, zz5.d {
    ...
    public boolean addAll(int i17, java.util.Collection elements) {
        ...
        return this.f341844d.c(i17, elements);
    }
    ...
    public boolean contains(java.lang.Object obj) {
        return this.f341844d.f(obj);
    }

    @Override // java.util.List, java.util.Collection
    public boolean containsAll(java.util.Collection elements) {
        kotlin.jvm.internal.o.g(elements, "elements");
        o0.i iVar = this.f341844d;
        iVar.getClass();
    ...
    public java.lang.Object get(int i17) {
        o0.j.a(this, i17);
        return this.f341844d.f341850d[i17];
    }

    @Override // java.util.List
    public int indexOf(java.lang.Object obj) {
        return this.f341844d.h(obj);
    }

    @Override // java.util.List, java.util.Collection
    public boolean isEmpty() {
        return this.f341844d.i();
    }
    ...
    public boolean retainAll(java.util.Collection elements) {
        ...
        for (int i18 = i17 - 1; -1 < i18; i18--) {
            if (!elements.contains(iVar.f341850d[i18])) {
                iVar.m(i18);
            }
        }
        return i17 != iVar.f341852f;
    ...
    public java.lang.Object set(int i17, java.lang.Object obj) {
        o0.j.a(this, i17);
        java.lang.Object[] objArr = this.f341844d.f341850d;
    ...
    public boolean addAll(java.util.Collection elements) {
        ...
        o0.i iVar = this.f341844d;
        iVar.getClass();
        return iVar.c(iVar.f341852f, elements);
    }
