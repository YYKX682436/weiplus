...
public final class y extends com.tencent.mm.plugin.sns.ui.listener.h1 {

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ uc4.z f426464d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f426465e;

    public y(uc4.z zVar, android.content.Context context) {
        this.f426464d = zVar;
        this.f426465e = context;
    }
    ...
    public void a(android.view.ContextMenu menu, android.view.View v17, android.view.ContextMenu.ContextMenuInfo contextMenuInfo) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onMMCreateContextMenu", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveContentTranslateClick$descMenuListener$1");
        kotlin.jvm.internal.o.g(menu, "menu");
        kotlin.jvm.internal.o.g(v17, "v");
        uc4.z zVar = this.f426464d;
        xc4.p c17 = zVar.c();
        if (c17 == null) {
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onMMCreateContextMenu", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveContentTranslateClick$descMenuListener$1");
            return;
        }
        ...
        android.content.Context context = this.f426465e;
        if (!booleanValue) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.SnsMenuActionReporter", "setIsTranslateView >> true");
        ta4.y0.f416865c = true;
        ...
        if (!c17.isAd()) {
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("isTranslatedPost", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveContentTranslateClick");
            xc4.p c18 = zVar.c();
            ...
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("isTranslatedPost", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveContentTranslateClick");
            if (z17) {
        ...
        com.tencent.mm.plugin.sns.model.s6.b(menu, true);
    ...
    public boolean b(android.view.View view) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onbindOnSelectedView", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveContentTranslateClick$descMenuListener$1");
        kotlin.jvm.internal.o.g(view, "view");
        uc4.z zVar = this.f426464d;
        xc4.p c17 = zVar.c();
        if (c17 == null) {
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onbindOnSelectedView", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveContentTranslateClick$descMenuListener$1");
            return false;
        }
