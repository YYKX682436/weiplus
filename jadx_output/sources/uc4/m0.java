...
public abstract class m0 extends uc4.g {
    ...
    public final jz5.g f426434f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m0(android.content.Context context) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
        this.f426434f = jz5.h.b(new uc4.l0(this));
    }

    @Override // uc4.g
    public boolean i(android.view.MenuItem menuItem, int i17) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("handleMenuClick", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveLinkClick");
        ...
        if (menuItem.getItemId() == 4 || menuItem.getItemId() == 28 || menuItem.getItemId() == 30 || menuItem.getItemId() == 5 || menuItem.getItemId() == 3 || menuItem.getItemId() == 32 || menuItem.getItemId() == 10 || menuItem.getItemId() == 22 || menuItem.getItemId() == 2 || menuItem.getItemId() == 23 || menuItem.getItemId() == 24) {
            ...
            if (c17 == null) {
                ...
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("handleMenuClick", "com.tencent.mm.plugin.sns.ui.improve.item.click.ImproveLinkClick");
                return false;
            }
