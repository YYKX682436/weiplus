...
public final class d implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.emojicapture.ui.editor.CaptureEditorContainer f17631d;

    public d(com.tencent.mm.plugin.emojicapture.ui.editor.CaptureEditorContainer captureEditorContainer) {
        this.f17631d = captureEditorContainer;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        r22.c presenter = this.f17631d.getPresenter();
        if (presenter != null) {
            ((w22.v) presenter).f();
        }
