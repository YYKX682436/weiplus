...
public final class k0 extends wt3.n0 {
    ...
    public final java.util.ArrayList f449433i;
    ...
    public k0(java.util.ArrayList imageList, int i17, wt3.q classifier) {
        ...
        this.f449433i = imageList;
    }

    @Override // wt3.n0
    public android.graphics.Bitmap d(int i17) {
        java.util.ArrayList arrayList = this.f449433i;
        ...
        options.inSampleSize = com.tencent.mm.sdk.platformtools.x.f(options.outWidth, options.outHeight, this.f449452b, this.f449453c);
        options.inJustDecodeBounds = false;
        android.graphics.Bitmap d17 = com.tencent.mm.graphics.e.d((java.lang.String) arrayList.get(i27), options);
        if (d17 != null) {
            return d17;
        }
        int i28 = this.f449452b;
        int i29 = this.f449453c;
    ...
    public void f() {
        ...
        this.f449454d = new int[]{0, 0, 0};
        java.util.ArrayList arrayList = this.f449433i;
        if (arrayList.size() >= 3) {
            this.f449454d[1] = arrayList.size() / 2;
            this.f449454d[2] = arrayList.size() - 1;
