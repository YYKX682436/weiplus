...
public abstract class a {
    public static void a(java.lang.ClassLoader classLoader, java.io.File file) {
        ...
        com.tencent.tinker.loader.shareutil.ShareReflectUtil.findField(obj, "nativeLibraryPathElements").set(obj, (java.lang.Object[]) com.tencent.tinker.loader.shareutil.ShareReflectUtil.findMethod(obj, "makePathElements", (java.lang.Class<?>[]) new java.lang.Class[]{java.util.List.class, java.io.File.class, java.util.List.class}).invoke(obj, arrayList, null, new java.util.ArrayList()));
    }
}
