...
public class c {
    ...
    public final int f452844a;

    /* renamed from: b, reason: collision with root package name */
    public final char[] f452845b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.Map f452846c;
    ...
    public c(java.lang.String str) {
        ...
        this.f452844a = length;
        this.f452846c = new java.util.HashMap(length);
        for (int i18 = 0; i18 < length; i18++) {
            this.f452846c.put(java.lang.Character.valueOf(charArray[i18]), java.lang.Integer.valueOf(i18));
        }
        char[] cArr = new char[(length * 2) + 1];
        this.f452845b = cArr;
        cArr[0] = 0;
        while (i17 < length) {
            char[] cArr2 = this.f452845b;
            int i19 = i17 + 1;
    ...
    public final int a(char c17) {
        ...
        java.util.Map map = this.f452846c;
