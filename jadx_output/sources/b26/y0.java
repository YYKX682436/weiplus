...
public abstract /* synthetic */ class y0 {
    ...
    static {
        int[] iArr = new int[i16.l0.values().length];
        try {
            iArr[0] = 1;
        ...
        f17546a = iArr;
        int[] iArr2 = new int[o06.t0.values().length];
        try {
            iArr2[0] = 1;
        } catch (java.lang.NoSuchFieldError unused5) {
        }
        try {
            o06.s0 s0Var = o06.t0.f341984d;
            iArr2[2] = 2;
        } catch (java.lang.NoSuchFieldError unused6) {
        }
        try {
            o06.s0 s0Var2 = o06.t0.f341984d;
            iArr2[3] = 3;
        } catch (java.lang.NoSuchFieldError unused7) {
        }
        try {
            o06.s0 s0Var3 = o06.t0.f341984d;
            iArr2[1] = 4;
        } catch (java.lang.NoSuchFieldError unused8) {
        }
        int[] iArr3 = new int[i16.h2.values().length];
        try {
            iArr3[0] = 1;
        ...
        int[] iArr4 = new int[i16.n.values().length];
        try {
            iArr4[0] = 1;
        ...
        f17547b = iArr4;
        int[] iArr5 = new int[o06.h.values().length];
        try {
            iArr5[0] = 1;
        ...
        try {
            o06.h hVar2 = o06.h.f341960d;
            iArr5[2] = 3;
        } catch (java.lang.NoSuchFieldError unused24) {
        }
        try {
            o06.h hVar3 = o06.h.f341960d;
            iArr5[3] = 4;
        } catch (java.lang.NoSuchFieldError unused25) {
        }
        try {
            o06.h hVar4 = o06.h.f341960d;
            iArr5[4] = 5;
        } catch (java.lang.NoSuchFieldError unused26) {
        }
        try {
            o06.h hVar5 = o06.h.f341960d;
            iArr5[5] = 6;
        } catch (java.lang.NoSuchFieldError unused27) {
        }
        int[] iArr6 = new int[i16.r1.values().length];
        try {
            iArr6[0] = 1;
        ...
        int[] iArr7 = new int[i16.i1.values().length];
        try {
            iArr7[0] = 1;
        ...
        int[] iArr8 = new int[f26.d3.values().length];
        try {
            iArr8[1] = 1;
