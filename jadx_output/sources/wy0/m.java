...
public abstract class m {
    public static final void a(java.util.List imagePathList, z0.t tVar, int i17, n0.o oVar, int i18, int i19) {
        ...
        long j17 = ((p2.q) v2Var2.getValue()).f351396a;
        float floatValue = ((java.lang.Number) v2Var.getValue()).floatValue();
        y0Var.U(-1687182554);
        boolean d17 = y0Var.d(j17) | y0Var.b(floatValue);
        java.lang.Object y19 = y0Var.y();
        if (d17 || y19 == obj2) {
            float floatValue2 = ((java.lang.Number) v2Var.getValue()).floatValue() * ((int) (((p2.q) v2Var2.getValue()).f351396a >> 32));
            y19 = java.lang.Integer.valueOf((((float) p2.q.b(((p2.q) v2Var2.getValue()).f351396a)) > floatValue2 ? java.lang.Float.valueOf(((p2.q.b(((p2.q) v2Var2.getValue()).f351396a) - floatValue2) / 2) + floatValue2) : java.lang.Integer.valueOf(p2.q.b(((p2.q) v2Var2.getValue()).f351396a))).intValue());
            y0Var.g0(y19);
        }
        ...
        y0Var.U(733328855);
        int i38 = i37 >> 3;
        s1.t0 c17 = d0.y.c(z0.a.f468889a, false, y0Var, (i38 & 112) | (i38 & 14));
        y0Var.U(-1323940314);
        ...
        y0Var.n();
        ((u0.i) a18).invoke(new n0.i4(y0Var), y0Var, java.lang.Integer.valueOf((i39 >> 3) & 112));
        y0Var.U(2058660585);
        y0Var.U(-2137368960);
        if (((i39 >> 9) & 14 & 11) == 2 && y0Var.v()) {
            ...
            if (intValue <= 0 || i27 <= 0) {
                ...
                float a19 = i65.a.a(com.tencent.mm.sdk.platformtools.x2.f193071a, i65.a.c(com.tencent.mm.sdk.platformtools.x2.f193071a, i65.a.f(com.tencent.mm.sdk.platformtools.x2.f193071a, com.tencent.mm.R.dimen.f479738dv)));
                y0Var.U(1648959803);
                ...
                z17 = false;
                y0Var.o(false);
                float density = ((int) floatValue3) / ((p2.f) y0Var.i(h3Var)).getDensity();
                z18 = true;
                b(a17, d0.v1.b(pVar, 0.0f, density, 1, null), y0Var, 0, 0);
            }
            y0Var.o(z17);
        }
        y0Var.o(z17);
        ...
        n0.f4 q17 = y0Var.q();
        if (q17 != null) {
            ((n0.l3) q17).f333608d = new wy0.k(imagePathList, tVar2, i27, i18, i19);
        }
    }
    ...
    */
    ...
    public static final float c(java.lang.String str) {
        ...
        if (com.tencent.mm.sdk.platformtools.l.a(str) % 180 != 0) {
            int i17 = point.y;
            point.y = point.x;
            point.x = i17;
        }
