...
public abstract class h4 {
    ...
    public static final long f314224a = p2.d.a(0, 0, 0, 0);

    /* renamed from: b, reason: collision with root package name */
    public static final float f314225b = 16;

    /* renamed from: c, reason: collision with root package name */
    public static final float f314226c = 12;

    /* renamed from: d, reason: collision with root package name */
    public static final z0.t f314227d;

    static {
        int i17 = z0.t.f468922q1;
        float f17 = 48;
        f314227d = d0.a3.d(z0.p.f468921d, f17, f17);
    }
    ...
    public static final void a(l0.x4 type, java.lang.String value, yz5.p innerTextField, g2.t0 visualTransformation, yz5.p pVar, yz5.p pVar2, yz5.p pVar3, yz5.p pVar4, boolean z17, boolean z18, boolean z19, c0.n interactionSource, d0.d2 contentPadding, l0.m3 colors, yz5.p pVar5, n0.o oVar, int i17, int i18, int i19) {
        ...
        if (i39 != 0) {
            ...
            i27 |= y0Var2.f(z17) ? 67108864 : com.tencent.thumbplayer.core.common.TPMediaCodecProfileLevel.HEVCHighTierLevel62;
        }
        int i47 = i19 & 512;
        if (i47 != 0) {
            i27 |= 805306368;
        } else if ((i17 & 1879048192) == 0) {
            i27 |= y0Var2.f(z18) ? com.tencent.wcdb.database.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING : 268435456;
        }
        int i48 = i27;
        int i49 = i19 & 1024;
        if (i49 != 0) {
        ...
        if ((i48 & 1533916891) == 306783378 && (46811 & i57) == 9362 && y0Var2.v()) {
            ...
            if (e17 || y17 == n0.n.f333620a) {
                y17 = new g2.r0(new a2.d(value, null, null, 6, null), g2.u.f267748a);
                y0Var2.g0(y17);
            }
            y0Var2.o(false);
            java.lang.String str = ((g2.r0) y17).f267744a.f681d;
            if (((java.lang.Boolean) c0.h.a(interactionSource, y0Var2, (i57 >> 3) & 14).getValue()).booleanValue()) {
                l0Var = l0.l0.Focused;
            } else {
            ...
            a2.o1 o1Var = j5Var.f314307g;
            long b17 = o1Var.b();
            long j17 = e1.y.f246320k;
            boolean c17 = e1.y.c(b17, j17);
            a2.o1 o1Var2 = j5Var.f314312l;
            boolean z39 = (c17 && !e1.y.c(o1Var2.b(), j17)) || (!e1.y.c(o1Var.b(), j17) && e1.y.c(o1Var2.b(), j17));
            l0.w4 w4Var = l0.w4.f314586a;
            y0Var2.U(2129141006);
            long b18 = ((l0.j5) y0Var2.i(h3Var)).f314312l.b();
            if (z39) {
                if (!(b18 != j17)) {
                    b18 = ((e1.y) d4Var.invoke(l0Var2, y0Var2, 0)).f246322a;
                }
            }
            long j18 = b18;
            y0Var2.o(false);
            long b19 = ((l0.j5) y0Var2.i(h3Var)).f314307g.b();
            if (z39) {
                if (!(b19 != j17)) {
                    b19 = ((e1.y) d4Var.invoke(l0Var2, y0Var2, 0)).f246322a;
                }
            }
            y0Var = y0Var2;
        ...
        ((n0.l3) q17).f333608d = new l0.c4(type, value, innerTextField, visualTransformation, pVar, pVar6, pVar7, pVar8, z28, z29, z27, interactionSource, contentPadding, colors, pVar9, i17, i18, i19);
    }
