...
public final class s4 implements s1.t0 {
    ...
    public int a(s1.u uVar, java.util.List measurables, int i17) {
        ...
        return g(measurables, i17, l0.r4.f314502d);
    }
    ...
    public int b(s1.u uVar, java.util.List measurables, int i17) {
        kotlin.jvm.internal.o.g(uVar, "<this>");
        kotlin.jvm.internal.o.g(measurables, "measurables");
        return f(uVar, measurables, i17, l0.n4.f314398d);
    }
    ...
    public int c(s1.u uVar, java.util.List measurables, int i17) {
        kotlin.jvm.internal.o.g(uVar, "<this>");
        kotlin.jvm.internal.o.g(measurables, "measurables");
        return f(uVar, measurables, i17, l0.q4.f314492d);
    }
    ...
    public s1.u0 d(s1.x0 measure, java.util.List measurables, long j17) {
        ...
        kotlin.jvm.internal.o.g(measurables, "measurables");
        d0.e2 e2Var = (d0.e2) this.f314517c;
        int G = measure.G(e2Var.f225109b);
        int G2 = measure.G(e2Var.f225111d);
        int G3 = measure.G(l0.m4.f314382c);
        ...
        while (it8.hasNext()) {
            ...
            if (kotlin.jvm.internal.o.b(s1.c0.a(r0Var4), "TextField")) {
                ...
                int max2 = java.lang.Math.max(l0.h4.e(o1Var) + java.lang.Math.max(m19.f402050d, java.lang.Math.max(l0.h4.e(m18), l0.h4.e(m27))) + l0.h4.e(o1Var2), p2.c.j(j17));
                int c17 = l0.m4.c(m19.f402051e, m18 != null, max, l0.h4.d(o1Var), l0.h4.d(o1Var2), l0.h4.d(m27), j17, measure.getDensity(), this.f314517c);
    ...
    public int e(s1.u uVar, java.util.List measurables, int i17) {
        kotlin.jvm.internal.o.g(uVar, "<this>");
        kotlin.jvm.internal.o.g(measurables, "measurables");
        return g(measurables, i17, l0.o4.f314415d);
    }
    ...
    public final int f(s1.u uVar, java.util.List list, int i17, yz5.p pVar) {
        ...
        for (java.lang.Object obj5 : list) {
            if (kotlin.jvm.internal.o.b(l0.h4.c((s1.t) obj5), "TextField")) {
                ...
                s1.t tVar4 = (s1.t) obj;
                return l0.m4.c(intValue, intValue2 > 0, intValue2, intValue4, intValue3, tVar4 != null ? ((java.lang.Number) pVar.invoke(tVar4, java.lang.Integer.valueOf(i17))).intValue() : 0, l0.h4.f314224a, uVar.getDensity(), this.f314517c);
            }
        }
        throw new java.util.NoSuchElementException("Collection contains no element matching the predicate.");
    }
