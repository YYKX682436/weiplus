...
public final class h0 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ yz5.l f336151d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ boolean f336152e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.app.Activity f336153f;

    public h0(yz5.l lVar, boolean z17, android.app.Activity activity) {
        this.f336151d = lVar;
        this.f336152e = z17;
        this.f336153f = activity;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public final void onClick(android.content.DialogInterface dialogInterface, int i17) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onClick", "com.tencent.mm.plugin.sns.ui.improve.component.toolbar.SecondCutEntrance$handleSelect$2");
        this.f336151d.invoke(java.lang.Boolean.TRUE);
        boolean z17 = this.f336152e;
        android.app.Activity context = this.f336153f;
        if (z17) {
        ...
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onClick", "com.tencent.mm.plugin.sns.ui.improve.component.toolbar.SecondCutEntrance$handleSelect$2");
    }
}
