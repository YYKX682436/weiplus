...
public class q1 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.label.ui.ContactLabelManagerUI f260437d;

    public q1(com.tencent.mm.plugin.label.ui.ContactLabelManagerUI contactLabelManagerUI) {
        this.f260437d = contactLabelManagerUI;
    }
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            com.tencent.mm.plugin.label.ui.ContactLabelManagerUI contactLabelManagerUI = this.f260437d;
            contactLabelManagerUI.L = rawX;
            contactLabelManagerUI.M = (int) motionEvent.getRawY();
        }
