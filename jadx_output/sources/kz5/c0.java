...
public abstract class c0 extends kz5.b0 {
    ...
    public static final int e(java.util.List list, int i17, int i18, yz5.l comparison) {
        ...
        while (i17 <= i19) {
            int i27 = (i17 + i19) >>> 1;
            int intValue = ((java.lang.Number) comparison.invoke(list.get(i27))).intValue();
            if (intValue < 0) {
                i17 = i27 + 1;
            } else {
                if (intValue <= 0) {
    ...
    public static final java.util.List i(java.lang.Object... elements) {
        kotlin.jvm.internal.o.g(elements, "elements");
        return elements.length > 0 ? kz5.v.f(elements) : kz5.p0.f313996d;
    }

    public static final java.util.List j(java.lang.Object obj) {
        return obj != null ? kz5.b0.c(obj) : kz5.p0.f313996d;
    }
    ...
    public static final java.util.List l(java.util.List list) {
        kotlin.jvm.internal.o.g(list, "<this>");
        int size = list.size();
        return size != 0 ? size != 1 ? list : kz5.b0.c(list.get(0)) : kz5.p0.f313996d;
    }
