...
public final class j1 extends kz5.l {
    ...
    public final java.util.List f313979d;

    public j1(java.util.List delegate) {
        kotlin.jvm.internal.o.g(delegate, "delegate");
        this.f313979d = delegate;
    }

    @Override // java.util.AbstractList, java.util.List
    public void add(int i17, java.lang.Object obj) {
        this.f313979d.add(kz5.i0.G(this, i17), obj);
    }
    ...
    @Override // kz5.l
    public int d() {
        return this.f313979d.size();
    }

    @Override // kz5.l
    public java.lang.Object e(int i17) {
        return this.f313979d.remove(kz5.i0.F(this, i17));
    }

    @Override // java.util.AbstractList, java.util.List
    public java.lang.Object get(int i17) {
        return this.f313979d.get(kz5.i0.F(this, i17));
    }
    ...
    public java.lang.Object set(int i17, java.lang.Object obj) {
        return this.f313979d.set(kz5.i0.F(this, i17), obj);
    }
