...
public final class i extends of3.b {
    ...
    public void W6() {
        super.W6();
        com.tencent.mars.xlog.Log.i("LegoBaseUI", "Importing implementation: " + th5.g0.class.getSimpleName() + " for interface: " + sf3.f.class.getSimpleName());
        ...
        com.tencent.mars.xlog.Log.i("LegoBaseUI", "Importing implementation: " + zh5.a0.class.getSimpleName() + " for interface: " + sf3.e.class.getSimpleName());
        ...
        com.tencent.mars.xlog.Log.i("LegoBaseUI", "Importing implementation: " + th5.p0.class.getSimpleName() + " for interface: " + vf3.a.class.getSimpleName());
        ...
        com.tencent.mars.xlog.Log.i("LegoBaseUI", "Importing implementation: " + th5.z0.class.getSimpleName() + " for interface: " + bg3.f.class.getSimpleName());
        ...
        com.tencent.mars.xlog.Log.i("LegoBaseUI", "Importing implementation: " + th5.r0.class.getSimpleName() + " for interface: " + dg3.m.class.getSimpleName());
        ...
        com.tencent.mars.xlog.Log.i("LegoBaseUI", "Importing implementation: " + th5.k.class.getSimpleName() + " for interface: " + zf3.a.class.getSimpleName());
    ...
    @Override // of3.b
    public of3.a Z6() {
        return new of3.a(kotlin.jvm.internal.i0.a(th5.q0.class));
    }

    @Override // of3.b
    public of3.a b7() {
        return new of3.a(kotlin.jvm.internal.i0.a(th5.f.class));
    }

    @Override // of3.b
    public of3.e c7() {
        return new of3.e(com.tencent.mm.R.id.l3x, kotlin.jvm.internal.i0.a(th5.u0.class));
    }
}
