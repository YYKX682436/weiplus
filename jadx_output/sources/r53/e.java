...
public abstract class e {
    ...
    public static final java.util.HashMap f392651a;

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.HashMap f392652b;

    static {
        new java.util.HashMap();
        new java.util.HashMap();
        f392651a = new java.util.HashMap();
        f392652b = new java.util.HashMap();
    }
    ...
    public static java.lang.String a(android.content.Context context, long j17) {
        ...
        java.util.HashMap hashMap = f392651a;
        boolean containsKey = hashMap.containsKey(java.lang.Long.valueOf(j17));
        java.util.HashMap hashMap2 = f392652b;
        if (containsKey) {
        ...
        if (j18 < 60000) {
            return context.getString(com.tencent.mm.R.string.fmp);
        }
        ...
        if (timeInMillis2 > 0 && timeInMillis2 <= 86400000) {
            int i19 = (int) j19;
            i17 = i19 >= 1 ? i19 : 1;
            java.lang.String quantityString2 = context.getResources().getQuantityString(com.tencent.mm.R.plurals.f489673j, i17, java.lang.Integer.valueOf(i17));
        ...
        java.lang.String quantityString3 = context.getResources().getQuantityString(com.tencent.mm.R.plurals.f489675l, i17, java.lang.Integer.valueOf(i17));
