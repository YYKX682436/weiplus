...
public abstract class x {
    /* JADX WARN: Code restructure failed: missing block: B:105:0x03e3, code lost:
        ...
        if (r11 == r8) goto L272;
     */
    /* JADX WARN: Code restructure failed: missing block: B:110:0x0492, code lost:
    ...
    */
    public static final void a(a2.d r35, boolean r36, long r37, z0.t r39, boolean r40, long r41, long r43, f2.p r45, f2.r r46, f2.h r47, long r48, l2.g r50, int r51, long r52, int r54, boolean r55, yz5.l r56, a2.o1 r57, n0.o r58, int r59, int r60, int r61) {
        /*
            Method dump skipped, instructions count: 1275
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ty0.x.a(a2.d, boolean, long, z0.t, boolean, long, long, f2.p, f2.r, f2.h, long, l2.g, int, long, int, boolean, yz5.l, a2.o1, n0.o, int, int, int):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:98:0x03c1 A[ADDED_TO_REGION] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void b(java.lang.String r35, boolean r36, long r37, z0.t r39, boolean r40, long r41, long r43, f2.p r45, f2.r r46, f2.h r47, long r48, l2.g r50, int r51, long r52, int r54, boolean r55, yz5.l r56, a2.o1 r57, n0.o r58, int r59, int r60, int r61) {
        /*
            Method dump skipped, instructions count: 1263
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ty0.x.b(java.lang.String, boolean, long, z0.t, boolean, long, long, f2.p, f2.r, f2.h, long, l2.g, int, long, int, boolean, yz5.l, a2.o1, n0.o, int, int, int):void");
    }

    public static final void c(long j17, long j18, n0.o oVar, int i17) {
        n0.y0 y0Var = (n0.y0) oVar;
        y0Var.V(1364391032);
        int i18 = (i17 & 14) == 0 ? i17 | (y0Var.d(j17) ? 4 : 2) : i17;
        if ((i17 & 112) == 0) {
            i18 |= y0Var.d(j18) ? 32 : 16;
        }
        if ((i18 & 91) == 18 && y0Var.v()) {
            y0Var.O();
        } else {
            java.lang.Object obj = n0.e1.f333492a;
            z0.t j19 = d0.a3.j(z0.p.f468921d, ((float) 3.5d) * 8);
            kotlin.jvm.internal.o.g(j19, "<this>");
            z0.t k17 = j19.k(d0.a3.f225066b);
            jz5.l[] colorStops = (jz5.l[]) java.util.Arrays.copyOf(new jz5.l[]{new jz5.l(java.lang.Float.valueOf(0.0f), new e1.y(j17)), new jz5.l(java.lang.Float.valueOf(1.0f), new e1.y(j18))}, 2);
            long a17 = d1.f.a(0.0f, 0.0f);
            long a18 = d1.f.a(Float.POSITIVE_INFINITY, 0.0f);
            kotlin.jvm.internal.o.g(colorStops, "colorStops");
            int length = colorStops.length;
            java.util.ArrayList arrayList = new java.util.ArrayList(length);
            int i19 = 0;
            while (i19 < length) {
                arrayList.add(new e1.y(((e1.y) colorStops[i19].f302834e).f246322a));
                i19++;
                k17 = k17;
            }
            z0.t tVar = k17;
            java.util.ArrayList arrayList2 = new java.util.ArrayList(colorStops.length);
            for (jz5.l lVar : colorStops) {
                arrayList2.add(java.lang.Float.valueOf(((java.lang.Number) lVar.f302833d).floatValue()));
            }
            d0.y.a(a0.b.a(tVar, new e1.i0(arrayList, arrayList2, a17, a18, 0, null), null, 0.0f, 6, null), y0Var, 0);
            java.lang.Object obj2 = n0.e1.f333492a;
        }
        n0.f4 q17 = y0Var.q();
        if (q17 != null) {
            ((n0.l3) q17).f333608d = new ty0.e(j17, j18, i17);
        }
    }
}
