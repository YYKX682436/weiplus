...
public final class j {
    ...
    public static final i45.j f288415a = new i45.j();

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.String f288416b = "";

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.String f288417c;

    /* renamed from: d, reason: collision with root package name */
    public static java.lang.String f288418d;

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.HashSet f288419e;
    ...
    public final boolean a(i45.c cVar) {
        ...
        return c01.id.a() - com.tencent.mm.sdk.platformtools.o4.M("mmkv_wetype").getLong("mmkv_key_voice_to_text_after_config_insert_last_time", 0L) > ((long) cVar.f288398c) * 3600000 && com.tencent.mm.sdk.platformtools.o4.M("mmkv_wetype").getLong("mmkv_key_voice_to_text_after_config_insert_time", 0L) < ((long) cVar.f288399d);
    }

    public final boolean b(i45.b bVar) {
        if (bVar == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.WxImeHelper", "checkIfNeedShowFullTextGuide: textGuide == null ");
            return false;
        }
        boolean z17 = com.tencent.mm.sdk.platformtools.o4.M("mmkv_wetype").getBoolean("mmkv_key_full_text_config_has_click", false);
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("checkIfNeedShowFullTextGuide: hasClick(");
        sb6.append(z17);
        sb6.append(',');
        int i17 = bVar.f288395e;
        sb6.append((i17 & 1) == 1);
        sb6.append(')');
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", sb6.toString());
        if (z17) {
            if ((i17 & 1) == 1) {
                return false;
            }
        }
        long a17 = c01.id.a() - com.tencent.mm.sdk.platformtools.o4.M("mmkv_wetype").getLong("mmkv_key_full_text_config_insert_last_time", 0L);
        java.lang.StringBuilder sb7 = new java.lang.StringBuilder("checkIfNeedShowFullTextGuide: interval(");
        sb7.append(a17);
        sb7.append(',');
        int i18 = bVar.f288392b;
        sb7.append(i18);
        sb7.append(')');
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", sb7.toString());
        if (a17 < i18 * 3600000) {
            return false;
        }
        long j17 = com.tencent.mm.sdk.platformtools.o4.M("mmkv_wetype").getLong("mmkv_key_full_text_config_insert_count", 0L);
        java.lang.StringBuilder sb8 = new java.lang.StringBuilder("checkIfNeedShowFullTextGuide: maxCount(");
        sb8.append(j17);
        sb8.append(", ");
        int i19 = bVar.f288393c;
        sb8.append(i19);
        sb8.append(')');
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", sb8.toString());
        if (j17 >= i19) {
            return false;
        }
        long j18 = com.tencent.mm.sdk.platformtools.o4.M("mmkv_wetype").getLong("mmkv_key_scene_full_text_config_start_timestamp", 0L);
        ...
        sb9.append(a18);
        sb9.append(", ");
        int i27 = bVar.f288394d;
        sb9.append(i27);
        sb9.append(')');
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", sb9.toString());
    ...
    public final boolean c(android.os.Bundle bundle, java.lang.String str, java.lang.String str2) {
        if (bundle.getBoolean("f_t_f_pfd", false)) {
            ...
            if (parcelFileDescriptor == null) {
                com.tencent.mars.xlog.Log.w("MicroMsg.WxImeHelper", "fileReplacePfdToPath: pfd null");
                return false;
            }
            java.lang.String e17 = f288415a.e();
            java.io.FileInputStream fileInputStream = new java.io.FileInputStream(parcelFileDescriptor.getFileDescriptor());
            com.tencent.mm.vfs.y6 y6Var = new com.tencent.mm.vfs.y6(new com.tencent.mm.vfs.r6(e17));
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.WxImeHelper", "fileReplace exception:" + e18.getMessage());
                return false;
            } finally {
    ...
    public final java.lang.String d() {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", "getCurIme: " + str);
    ...
    public final java.lang.String f(boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", "getTempWxId result:" + str);
    ...
    */
    public final i45.c g() {
        ...
        L2e:
            ...
            if (r1 != 0) goto Lcc
            boolean r1 = com.tencent.mm.sdk.platformtools.t8.D0(r4, r0)
            if (r1 == 0) goto L4f
            goto Lcc
        L4f:
            ...
            boolean r2 = com.tencent.mm.sdk.platformtools.m2.m()     // Catch: java.lang.Exception -> Lb4
            if (r2 == 0) goto L62
            goto L75
        L62:
            boolean r2 = com.tencent.mm.sdk.platformtools.m2.n()     // Catch: java.lang.Exception -> Lb4
            if (r2 == 0) goto L6c
            java.lang.String r2 = "traditional_chinese"
            goto L78
        L6c:
            boolean r2 = com.tencent.mm.sdk.platformtools.m2.j()     // Catch: java.lang.Exception -> Lb4
            if (r2 != 0) goto L75
        ...
        L78:
            ...
            boolean r5 = com.tencent.mm.sdk.platformtools.t8.K0(r2)     // Catch: java.lang.Exception -> Lb4
            if (r5 != 0) goto Lb3
            boolean r5 = com.tencent.mm.sdk.platformtools.t8.K0(r0)     // Catch: java.lang.Exception -> Lb4
            if (r5 == 0) goto La1
            goto Lb3
        La1:
            i45.c r5 = new i45.c     // Catch: java.lang.Exception -> Lb4
            kotlin.jvm.internal.o.d(r2)     // Catch: java.lang.Exception -> Lb4
            kotlin.jvm.internal.o.d(r0)     // Catch: java.lang.Exception -> Lb4
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean h(android.view.View r63, java.lang.String r64, java.lang.String r65, android.os.Bundle r66, com.tencent.mm.pluginsdk.ui.chat.k5 r67) {
        /*
    ...
    public final void i(android.content.Context context, android.os.Bundle bundle) {
        ...
        if (com.tencent.mm.storage.z3.R4(en1.a.a())) {
        ...
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).Bj(com.tencent.mm.storage.z3.R4(en1.a.a()) ? 3 : 2, 3, 32, intent);
        intent.putExtra("key_enter_profile_type", 4);
        intent.putExtra("key_entrance_type", 32);
        intent.putExtra("from_user", en1.a.a());
        intent.putExtra("finder_username", bundle.getString(dm.i4.COL_USERNAME, ""));
        ...
        i45.k.a(i45.k.f288420a, 2L, 100000, null, null, null, null, null, null, bundle.getString(dm.i4.COL_USERNAME, ""), null, 764, null);
    }
    ...
    public final void j(android.content.Context context, android.os.Bundle bundle, i45.d dVar) {
        ...
        if (string == null || string.length() == 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WxImeHelper", "openUrlOnPc Fail(empty url) url:" + string + ", title:" + string2);
            i45.d.b(dVar, -1L, null, null, 6, null);
            return;
        }
        if (!((d73.i) i95.n0.c(d73.i.class)).Qg()) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WxImeHelper", "openUrlOnPc Fail(pc not ready) url:" + string + ", title:" + string2);
        ...
        com.tencent.mm.plugin.handoff.model.HandOffURL handOffURL = new com.tencent.mm.plugin.handoff.model.HandOffURL(string2, string, string3, 0, null, null, null, null, 248, null);
        kotlin.jvm.internal.o.d(string4);
        handOffURL.setNickname(string4);
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", "openUrlOnPc Success(send success) url:" + string + ", title:" + string2);
    ...
    public final void k(android.content.Context context, android.os.Bundle bundle, java.lang.String str, i45.d dVar) {
        ...
        if (!c(bundle, "imgPfd", "imgPath")) {
            ...
            com.tencent.mars.xlog.Log.w("MicroMsg.WxImeHelper", "shareImg: fileReplacePfdToPath false.");
            return;
        }
        java.lang.String string2 = bundle.getString("imgPath", "");
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", "shareImg() called with: context = " + context + ", imgPath = " + string2 + ", toUser = " + str + " imgUid:" + string);
        if (!com.tencent.mm.sdk.platformtools.t8.W0(android.net.Uri.parse(string2))) {
            i45.d.b(dVar, 3L, null, null, 6, null);
            com.tencent.mars.xlog.Log.w("MicroMsg.WxImeHelper", "shareImg: isUriSafeToBeCopySrc false: no safe");
            return;
        }
        ((kt.c) ((lt.i0) i95.n0.c(lt.i0.class))).getClass();
        if (com.tencent.mm.pluginsdk.model.app.w.e(string2)) {
            ((dk5.s5) tg3.t1.a()).Vi(context, str, string2, 1, "", "", null);
            i45.k.a(i45.k.f288420a, 2L, 2, null, null, null, null, null, null, null, string, 508, null);
        } else {
            i45.d.b(dVar, 3L, null, null, 6, null);
            com.tencent.mars.xlog.Log.w("MicroMsg.WxImeHelper", "shareImg: checkFileValid is false ");
        }
    }
    ...
    public final jz5.l l(java.lang.String str) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", "verifyIdentityTokenValid curToken:" + string + ", identityToken:" + str);
        ...
        long b17 = c01.id.b();
        com.tencent.mars.xlog.Log.i("MicroMsg.WxImeHelper", "verifyIdentityTokenValid validTimestamp:" + j17 + ", current:" + b17);
