...
public abstract class l0 extends android.os.Binder implements l85.n0 {
    ...
    public boolean onTransact(int i17, android.os.Parcel parcel, android.os.Parcel parcel2, int i18) {
        ...
        if (i17 == 1) {
            ...
            ((l85.a) this).startService((android.content.Intent) l85.m0.a(parcel, android.content.Intent.CREATOR));
            parcel2.writeNoException();
        } else {
            if (i17 != 4) {
                return super.onTransact(i17, parcel, parcel2, i18);
            }
            ((l85.a) this).stopService((android.content.Intent) l85.m0.a(parcel, android.content.Intent.CREATOR));
            parcel2.writeNoException();
        }
        return true;
    }
