...
public final class w1 extends u1.d0 {
    ...
    public static final s1.w1 f402090b = new s1.w1();
    ...
    public s1.u0 d(s1.x0 measure, java.util.List measurables, long j17) {
        ...
        if (measurables.isEmpty()) {
            return s1.v0.b(measure, p2.c.j(j17), p2.c.i(j17), null, s1.t1.f402075d, 4, null);
        }
        if (measurables.size() == 1) {
            s1.o1 m17 = ((s1.r0) measurables.get(0)).m(j17);
            return s1.v0.b(measure, p2.d.e(j17, m17.f402050d), p2.d.d(j17, m17.f402051e), null, new s1.u1(m17), 4, null);
        }
        ...
        for (int i27 = 0; i27 < size2; i27++) {
            ...
            i18 = java.lang.Math.max(o1Var.f402050d, i18);
            i19 = java.lang.Math.max(o1Var.f402051e, i19);
        }
