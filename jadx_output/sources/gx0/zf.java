...
public final class zf implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ gx0.gg f277289d;
    ...
    public final void onClick(android.view.View view) {
        ...
        gx0.gg ggVar = this.f277289d;
        yy0.m7 m7Var = (yy0.m7) ggVar.R6().O6();
        kotlinx.coroutines.l.d(m7Var.Di(), null, null, new yy0.c5(m7Var, null), 3, null);
        ggVar.a7();
        gx0.w8 d76 = ggVar.d7();
        gx0.u2 u2Var = (gx0.u2) ((jz5.n) ggVar.f276478n).getValue();
        sw0.f fVar = sw0.f.f413432g;
        java.util.HashMap hashMap = new java.util.HashMap();
        hashMap.put("KEY_PANEL_ARGS", new ow0.a(fVar, true));
        yt0.c.Q5(d76, u2Var, hashMap, false, zw0.b.f476551e, 4, null);
