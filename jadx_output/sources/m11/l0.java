...
public class l0 extends l75.s0 implements k70.a0 {
    ...
    public l0(l75.k0 k0Var) {
        ...
        this.f322746p = null;
        java.util.Iterator it = m11.k0.f322726a.iterator();
        while (it.hasNext()) {
            java.lang.String str = ((m11.j0) it.next()).f322719a;
            ...
            if (i19 != 0 && i27 != 0 && !"ImgInfo2".equals(str) && i28 == 22 && i29 == 23) {
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "error index for msg_talker, table: " + str);
                this.f322737d = true;
                ...
                msgRefactorReportStruct.p("imginfo2_biz_drop_error_msgtalker_column");
    ...
    public static synchronized java.lang.String b1(java.lang.String str) {
        ...
        synchronized (m11.l0.class) {
            ...
            f322736w = currentTimeMillis;
            g17 = kk.k.g((str + currentTimeMillis).getBytes());
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "generateMd5: %s, %s", g17, java.lang.Long.valueOf(currentTimeMillis));
        }
        return g17;
    }
    ...
    */
    public boolean A4(com.tencent.mm.storage.f9 r24, android.widget.ImageView r25, java.lang.String r26, boolean r27, float r28, int r29, int r30, boolean r31, int r32, android.widget.ImageView r33, int r34, int r35, boolean r36, android.view.View r37) {
        /*
    ...
    public m11.b0 C1(java.lang.Long l17) {
        ...
        android.database.Cursor E = this.f322746p.E(a17, null, "id=?", new java.lang.String[]{"" + l17}, null, null, null);
    ...
    public boolean D0(com.tencent.mm.storage.f9 f9Var, java.lang.String str, java.lang.String str2, int i17, int i18, int i19, int i27, int i28, boolean z17) {
        ...
        boolean z27 = 0;
        if (com.tencent.mm.sdk.platformtools.t8.K0(F2)) {
            return false;
        }
        if (F2.endsWith("hd")) {
            str3 = F2;
        ...
        if (com.tencent.mm.vfs.w6.k(str3) > 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "hdThumbPath exists, return true");
            synchronized (this.f322745o) {
                java.lang.String j17 = (!android.text.TextUtils.isEmpty(str2) || f9Var == null) ? str2 : bm5.z.j(bm5.y.a(f9Var, bm5.f0.f22564i));
                if (((java.util.HashMap) this.f322745o).containsKey(j17) && !((java.lang.String) ((java.util.HashMap) this.f322745o).get(j17)).endsWith("hd")) {
                    ((java.util.HashMap) this.f322745o).put(j17, str3);
                }
            }
            return true;
        }
        float g17 = i65.a.g(com.tencent.mm.sdk.platformtools.x2.f193071a);
        android.graphics.BitmapFactory.Options n08 = com.tencent.mm.sdk.platformtools.x.n0(substring);
        if (n08 == null || n08.outWidth <= 0 || n08.outHeight <= 0) {
            com.tencent.mm.plugin.report.service.g0 g0Var = com.tencent.mm.plugin.report.service.g0.INSTANCE;
            g0Var.idkeyStat(111L, 185L, 1L, false);
            if (com.tencent.mm.vfs.w6.k(substring) > 0) {
                return false;
            }
            android.graphics.BitmapFactory.Options options = new android.graphics.BitmapFactory.Options();
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "createHDThumbNail old op is invaild but len is 0 need recreate[%s, %d, %d]", options, java.lang.Integer.valueOf(options.outWidth), java.lang.Integer.valueOf(options.outHeight));
        ...
        if (!((n08.outWidth == 0 || n08.outHeight == 0) ? false : true)) {
            ...
            if (H != null) {
                ...
                if (!z18) {
                    ...
                    if (!(n08.outWidth == 0 && n08.outHeight != 0) && (n07 = com.tencent.mm.sdk.platformtools.x.n0(str)) != null) {
                        o70.f aj6 = ((v70.b0) ((xs.f1) i95.n0.c(xs.f1.class))).aj(n07.outWidth, n07.outHeight);
                        n08.outWidth = aj6.f343231a;
                        n08.outHeight = aj6.f343232b;
                    }
                }
            }
            ...
            if (!(n08.outWidth == 0 && n08.outHeight != 0)) {
                ...
                n08.outWidth = aj62.f343231a;
                n08.outHeight = aj62.f343232b;
            }
        }
        ...
        try {
            boolean y17 = i18 == 0 ? com.tencent.mm.sdk.platformtools.x.y(str, i29, i37, android.graphics.Bitmap.CompressFormat.JPEG, 80, str3, true, new com.tencent.mm.pointers.PInt(), new com.tencent.mm.pointers.PInt(), true, i28) : com.tencent.mm.sdk.platformtools.x.z(str, i29, i37, android.graphics.Bitmap.CompressFormat.JPEG, 80, str3, true, new com.tencent.mm.pointers.PInt(), new com.tencent.mm.pointers.PInt(), true, true, i28);
            java.lang.System.currentTimeMillis();
            z27 = substring;
            java.lang.String str4 = str3;
            u0(f9Var, z27, true, i65.a.g(com.tencent.mm.sdk.platformtools.x2.f193071a), true, false, true, i17, false);
            if (y17) {
                synchronized (this.f322745o) {
                    java.lang.String j19 = (!android.text.TextUtils.isEmpty(str2) || f9Var == null) ? str2 : bm5.z.j(bm5.y.a(f9Var, bm5.f0.f22564i));
                    if (((java.util.HashMap) this.f322745o).containsKey(j19) && !((java.lang.String) ((java.util.HashMap) this.f322745o).get(j19)).endsWith("hd")) {
                        ((java.util.HashMap) this.f322745o).put(j19, str4);
                    }
                }
                zz.b bj6 = ((t02.e) ((a00.i) i95.n0.c(a00.i.class))).bj(str4, 3, null, null);
                com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "check dup, ret:%s, hit:%s, copyRes:%s, replaceRes:%s", java.lang.Integer.valueOf(bj6.f477691a), java.lang.Boolean.valueOf(bj6.f477692b), java.lang.Boolean.valueOf(bj6.f477694d), java.lang.Long.valueOf(bj6.f477695e));
            } else {
            ...
            com.tencent.mm.plugin.report.service.g0.INSTANCE.idkeyStat(111L, 184L, 1L, false);
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "create hd thumbnail failed. %s", e17.toString());
            return z27;
        }
    }

    public java.lang.String D2(com.tencent.mm.storage.f9 f9Var, java.lang.String str, boolean z17) {
    ...
    public final android.database.Cursor D3(java.lang.String str, java.lang.String[] strArr, java.lang.String str2, java.lang.String[] strArr2, java.lang.String str3, java.lang.String str4, java.lang.String str5) {
        return this.f322746p.E(str, strArr, str2, strArr2, str3, str4, str5);
    }

    public java.lang.String F2(com.tencent.mm.storage.f9 f9Var, java.lang.String str, boolean z17, boolean z18, boolean z19) {
        java.lang.String mj6;
        java.lang.String j17 = (!android.text.TextUtils.isEmpty(str) || f9Var == null) ? str : bm5.z.j(bm5.y.a(f9Var, bm5.f0.f22564i));
        java.util.Map map = this.f322745o;
        if (j17 == null || !((java.util.HashMap) map).containsKey(j17)) {
            mj6 = z17 ? j17 : ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).mj(f9Var, str, z18);
            if (!com.tencent.mm.sdk.platformtools.t8.K0(mj6)) {
        ...
        if (f9Var != null) {
            new com.tencent.mm.plugin.msg.MsgIdTalker(f9Var.getMsgId(), f9Var.Q0()).toString();
        }
        return mj6;
    }
    ...
    public int F4(java.lang.Long l17, m11.b0 b0Var) {
        ...
        if (android.text.TextUtils.isEmpty(b0Var.f322645m)) {
            b0Var.y("");
        }
        ...
        if (c17.size() == 0) {
            ...
            p17 = this.f322746p.p(m11.k0.a(l17.longValue()), c17, "id=?", new java.lang.String[]{"" + l17});
        }
        pt0.e0 e0Var = pt0.f0.f358209b1;
        if (e0Var.d() && c17.containsKey("msglocalid") && c17.containsKey("msgSvrId") && b0Var.f322647o <= 0 && b0Var.f322634b != 0) {
            java.lang.String p18 = e0Var.p(new java.lang.Throwable());
            com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct msgRefactorReportStruct = new com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct();
            msgRefactorReportStruct.p("imgInfo_check_id");
            msgRefactorReportStruct.u(p18);
            msgRefactorReportStruct.q(com.tencent.mm.sdk.platformtools.z.f193109e);
            msgRefactorReportStruct.f59281j = b0Var.f322634b;
            msgRefactorReportStruct.f59280i = b0Var.f322647o;
            msgRefactorReportStruct.k();
        }
        pt0.p.G6(b0Var.f322647o, b0Var.f322645m);
        com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "update last :%d values : %s %s", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - valueOf.longValue()), c17.toString(), java.lang.Integer.valueOf(p17));
        if (p17 != -1) {
            b0Var.a();
            doNotify();
        }
    ...
    public java.lang.String G2(java.lang.String str, m11.b0 b0Var) {
        ...
        if (b0Var.j()) {
            android.database.Cursor D3 = D3(m11.k0.b(str), new java.lang.String[]{"bigImgPath"}, "id=? and totalLen = offset", new java.lang.String[]{"" + b0Var.f322649q}, null, null, null);
    ...
    public java.lang.String J0(com.tencent.mm.storage.f9 f9Var, byte[] bArr) {
        if (com.tencent.mm.sdk.platformtools.t8.M0(bArr)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "save dir thumb error, thumbBuf is null");
            return null;
        }
        android.graphics.BitmapFactory.Options options = new android.graphics.BitmapFactory.Options();
        ...
        if (options.outWidth < 0 || options.outHeight < 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "Bad thumbBuf, perhaps it's not complete or damaged ??");
            return null;
        }
        java.lang.String W0 = W0();
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, bm5.f0.f22564i, W0, "th_", "", true, true);
        com.tencent.mm.vfs.w6.h(bj6);
        com.tencent.mm.vfs.w6.S(bj6, bArr, 0, bArr.length);
        return "THUMBNAIL_DIRPATH://th_" + W0;
    }

    public android.graphics.Bitmap J3(com.tencent.mm.storage.f9 f9Var, java.lang.String str) {
        return com.tencent.mm.sdk.platformtools.x.j0(D2(f9Var, str, true), 0, 0, i65.a.g(com.tencent.mm.sdk.platformtools.x2.f193071a));
    }
    ...
    public java.lang.String K3(com.tencent.mm.storage.f9 f9Var, java.lang.String str, byte[] bArr, int i17, android.graphics.Bitmap.CompressFormat compressFormat) {
        if (com.tencent.mm.sdk.platformtools.t8.M0(bArr)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "save dir thumb error, thumbBuf is null");
            return null;
        }
        java.lang.String W0 = com.tencent.mm.sdk.platformtools.t8.K0(str) ? W0() : str;
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, bm5.f0.f22564i, W0, "th_", "", true, true);
        try {
            ...
            com.tencent.mm.sdk.platformtools.x.D0(decodeByteArray, i17, compressFormat, bj6, true);
            return "THUMBNAIL_DIRPATH://th_" + W0;
        } catch (java.io.IOException e17) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "save bitmap to image error, %s", e17);
            return O3(f9Var, bArr, true, compressFormat);
        } catch (java.lang.Exception e18) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "save bitmap to image error, %s", e18);
            return O3(f9Var, bArr, true, compressFormat);
        }
    }

    public java.lang.String L0(com.tencent.mm.storage.f9 f9Var, bm5.f0 f0Var, byte[] bArr, java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.M0(bArr)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "directSaveThumbBufForAppMsg save dir thumb error, thumbBuf is null");
            return null;
        }
        android.graphics.BitmapFactory.Options options = new android.graphics.BitmapFactory.Options();
        options.inJustDecodeBounds = true;
        com.tencent.mm.graphics.e.b(bArr, 0, bArr.length, options);
        if (options.outWidth < 0 || options.outHeight < 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "directSaveThumbBufForAppMsg Bad thumbBuf, perhaps it's not complete or damaged ??");
            return null;
        }
    ...
    public void M4() {
        ...
        com.tencent.mm.sdk.platformtools.o4 o4Var2 = m11.k0.f322727b;
        java.util.Iterator it = m11.k0.f322726a.iterator();
        while (it.hasNext()) {
            m11.j0 j0Var = (m11.j0) it.next();
            java.util.concurrent.atomic.AtomicLong atomicLong = j0Var.f322723e;
            android.database.Cursor f17 = this.f322746p.f("SELECT max(id) FROM " + j0Var.f322719a, null, 2);
            long j17 = f17.moveToFirst() ? f17.getLong(0) : 0L;
            f17.close();
            long j18 = o4Var2.getLong("img." + j0Var.f322719a, -1L);
            if (!j0Var.f322719a.equals("ImgInfo2") || (j18 <= j17 + 100000000 && j17 <= 100000000 + j18 && j18 <= 2147483647L)) {
                o4Var = o4Var2;
            } else {
                o4Var = o4Var2;
                ((ku5.t0) ku5.t0.f312615d).h(new m11.g0(this, j17, j18), "report_error_img_id");
            }
            ...
            qt0.b bVar = qt0.b.f366491a;
            l75.k0 k0Var = this.f322746p;
            java.lang.String str = j0Var.f322719a;
            bVar.b(new qt0.e(k0Var, new java.lang.String[]{"CREATE INDEX IF NOT EXISTS " + str + "msgLocalIdTalkerIndex ON " + str + " ( msglocalid,msgTalker ) "}, j0Var.f322719a, "imginfo", 0));
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "[updateLatestImgID] table=%s, loading new img id=%s", j0Var.f322719a, java.lang.Long.valueOf(atomicLong.get()));
            o4Var2 = o4Var;
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String N3(com.tencent.mm.storage.f9 r29, byte[] r30, int r31, android.graphics.Bitmap.CompressFormat r32, int r33, int r34, int r35, java.lang.String r36, boolean r37) {
        /*
    ...
    public android.graphics.Bitmap O2(long j17, java.lang.String str, int i17, int i18, int i19, boolean z17) {
        ...
        if (bitmap == null || bitmap.isRecycled()) {
            ...
            if (str == null || str.equals("") || i17 < 0 || i18 < 0 || i19 < 0) {
                com.tencent.mars.xlog.Log.w("MicroMsg.BitmapUtil", "createLocation fail. srcResId or maskResId is null,or width/height <0");
            } else {
                android.graphics.Bitmap G = com.tencent.mm.sdk.platformtools.x.G(com.tencent.mm.vfs.w6.N(str, 0, -1));
                java.util.WeakHashMap weakHashMap = com.tencent.mm.sdk.platformtools.t.f192977a;
                if (G != null && !G.isRecycled()) {
                    java.lang.System.currentTimeMillis();
                    android.graphics.Bitmap m17 = com.tencent.mm.sdk.platformtools.x.m(i18, i19, android.graphics.Bitmap.Config.ARGB_8888, false);
                    ...
                    java.lang.System.currentTimeMillis();
                    bitmap = i17 == 0 ? m17 : com.tencent.mm.sdk.platformtools.x.p(m17, i17);
                }
            }
    ...
    public java.lang.String O3(com.tencent.mm.storage.f9 f9Var, byte[] bArr, boolean z17, android.graphics.Bitmap.CompressFormat compressFormat) {
    ...
    public m11.b0 P1(java.lang.Long l17) {
        m11.b0 C1 = C1(l17);
        if (C1.f322633a != l17.longValue()) {
            return null;
        }
        return C1;
    }

    public m11.b0 S1(com.tencent.mm.storage.f9 f9Var) {
        m11.b0 T1 = T1(f9Var.Q0(), f9Var.getMsgId());
        if (T1 == null || T1.f322633a == 0) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String S3(com.tencent.mm.storage.f9 r29, byte[] r30, int r31, android.graphics.Bitmap.CompressFormat r32, int r33, float r34, int r35, java.lang.String r36, boolean r37) {
        /*
    ...
    public java.util.List V2(int i17, com.tencent.wcdb.support.CancellationSignal cancellationSignal) {
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.Iterator it = m11.k0.f322726a.iterator();
        while (it.hasNext()) {
            android.database.Cursor d17 = this.f322746p.d(false, ((m11.j0) it.next()).f322719a, new java.lang.String[]{dm.i4.COL_ID, "msgSvrId", "msglocalid"}, "msgTalker IS NULL", new java.lang.String[0], null, null, null, i17 + "", cancellationSignal);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "getNonTalkers, duration = " + (java.lang.System.currentTimeMillis() - currentTimeMillis) + ", size = " + arrayList.size());
        return arrayList;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String V3(com.tencent.mm.storage.f9 r20, byte[] r21, boolean r22, android.graphics.Bitmap.CompressFormat r23, boolean r24, java.lang.String r25) {
        /*
    ...
    public final java.lang.String Y2(java.lang.String str, java.lang.String str2, int i17) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(h27.f322639g)) {
            return null;
        }
        com.tencent.mm.storage.f9 Li = pt0.f0.Li(str, h27.f322647o);
        java.lang.String mj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).mj(Li, h27.f322639g, true);
    ...
    public android.graphics.Bitmap b3(java.lang.String str, float f17, android.content.Context context, int i17) {
        ...
        android.graphics.Bitmap a17 = com.tencent.mm.sdk.platformtools.j.a(trim, f17);
        if (a17 == null) {
            return a17;
        }
        ...
        if (i19 <= 0 || i18 <= 0 || i19 > 2048 || i18 > 2048) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "getVideoThumb, error Scale Size %d*%d", java.lang.Integer.valueOf(i19), java.lang.Integer.valueOf(i18));
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "getVideoThumb, Bitmap.createScaledBitmap Exception:%s", e17.getMessage());
                com.tencent.mm.plugin.report.service.g0.INSTANCE.idkeyStat(111L, 188L, 1L, false);
            }
        }
        android.graphics.Bitmap p17 = i17 != -1 ? com.tencent.mm.sdk.platformtools.x.p(bitmap, i17) : bitmap;
        if (a17 != p17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "[getVideoThumb] bitmap:%s", a17.toString());
            a17.recycle();
        }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:320:0x02ba, code lost:
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "get useopt :%s", com.tencent.mm.sdk.platformtools.z3.c(r0));
        r5 = false;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String f1(k70.h0 r58, java.lang.String r59, boolean r60, com.tencent.mm.pointers.PString r61, com.tencent.mm.pointers.PString r62, com.tencent.mm.pointers.PString r63, com.tencent.mm.pointers.PString r64, java.lang.String r65, kk.c r66) {
        /*
    ...
    public long f3(com.tencent.mm.storage.f9 f9Var, java.lang.String str, byte[] bArr, int i17, long j17, boolean z17, java.lang.String str2, com.tencent.mm.pointers.PString pString, com.tencent.mm.pointers.PInt pInt, com.tencent.mm.pointers.PInt pInt2) {
        java.lang.String str3 = "SERVERID://" + j17;
        java.lang.String g17 = kk.k.g(str3.getBytes());
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, bm5.f0.f22564i, g17, "th_", "", true, false);
        if (bArr != null && bArr.length >= 0) {
            android.graphics.Bitmap G = com.tencent.mm.sdk.platformtools.x.G(bArr);
            if (G == null) {
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "create decodeByteArray failed: ".concat(new java.lang.String(bArr)));
            }
            if (!z17 && G != null) {
                try {
                    android.graphics.Bitmap V = com.tencent.mm.sdk.platformtools.x.V(G, 120, 120, false);
                    pInt.value = V.getWidth();
                    pInt2.value = V.getHeight();
                    com.tencent.mm.sdk.platformtools.x.D0(V, 90, android.graphics.Bitmap.CompressFormat.JPEG, bj6, true);
                } catch (java.io.IOException unused) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "create thumbnail from byte failed: " + g17 + " " + new java.lang.String(bArr));
                }
            }
        }
        m11.b0 b0Var = new m11.b0();
        ...
        b0Var.n(str2);
        b0Var.p((int) com.tencent.mm.sdk.platformtools.t8.i1());
        b0Var.y(str);
        long t37 = t3(str, dm.i4.COL_ID, b0Var);
        if (t37 != -1) {
            doNotify();
        }
        return t37;
    ...
    public m11.b0 h2(java.lang.String str, java.lang.String str2, int i17) {
        m11.b0 b0Var = new m11.b0();
        java.lang.String b17 = m11.k0.b(str);
        android.database.Cursor E = this.f322746p.E(b17, null, "origImgMD5=? AND compressType=?", new java.lang.String[]{"" + str2, i17 + ""}, null, null, null);
        if (E.moveToFirst()) {
            b0Var.b(E, y0(b17));
        }
        E.close();
    ...
    public boolean i1(com.tencent.mm.storage.f9 f9Var, long j17, byte[] bArr, com.tencent.mm.pointers.PString pString, com.tencent.mm.pointers.PInt pInt, com.tencent.mm.pointers.PInt pInt2) {
        java.lang.String g17 = kk.k.g(("SERVERID://" + j17).getBytes());
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, bm5.f0.f22564i, g17, "th_", "", true, true);
        if (bArr != null) {
            android.graphics.Bitmap G = com.tencent.mm.sdk.platformtools.x.G(bArr);
            if (G == null) {
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "create decodeByteArray failed: ".concat(new java.lang.String(bArr)));
            ...
            try {
                ...
                pInt.value = V.getWidth();
                pInt2.value = V.getHeight();
                pString.value = "THUMBNAIL_DIRPATH://th_" + g17;
                com.tencent.mm.sdk.platformtools.x.D0(V, 90, android.graphics.Bitmap.CompressFormat.JPEG, bj6, true);
            } catch (java.io.IOException unused) {
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "create thumbnail from byte failed: " + g17 + " " + new java.lang.String(bArr));
                return false;
    ...
    public java.lang.String j4(com.tencent.mm.storage.f9 f9Var, byte[] bArr, android.graphics.Bitmap.CompressFormat compressFormat, int i17, int i18, int i19, int i27, java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.M0(bArr)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "[saveDirThumbWithCrop] save dir thumb error, thumbBuf is null");
            return null;
        }
        java.lang.String W0 = (str == null || android.text.TextUtils.isEmpty(str)) ? W0() : str;
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, bm5.f0.f22564i, W0, "msgth_", "", true, true);
        try {
            android.graphics.Bitmap R = com.tencent.mm.sdk.platformtools.x.R(com.tencent.mm.sdk.platformtools.x.G(bArr), i17, i18, i27);
            if (R != null) {
                com.tencent.mm.sdk.platformtools.x.D0(R, 90, compressFormat, bj6, true);
            }
            return o1(W0);
        } catch (java.lang.Exception e17) {
            com.tencent.mm.plugin.report.service.g0.INSTANCE.idkeyStat(111L, 189L, 1L, false);
            com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "[saveDirThumbWithCrop] create thumbnail from byte failed: msgth_" + str + ", ex = " + e17.getMessage());
            return null;
        }
    }
    ...
    public m11.b0 k2(oi3.g gVar) {
        ...
        m11.b0 T1 = T1(string, gVar.getLong(i17 + 0));
        if (T1 == null || T1.f322633a == 0) {
            T1 = b2(gVar.getString(i17 + 3), gVar.getLong(i17 + 1));
            if (T1.f322633a == 0) {
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "deleteByMsg can't find correspond imgInfo");
                return null;
            }
    ...
    public android.graphics.Bitmap m0(com.tencent.mm.storage.f9 f9Var, java.lang.String str, float f17, boolean z17) {
        return s0(f9Var, str, false, f17, z17, false, false, -1);
    }

    public android.graphics.Bitmap n0(com.tencent.mm.storage.f9 f9Var, java.lang.String str, boolean z17, float f17, boolean z18, boolean z19) {
        return s0(f9Var, str, z17, f17, z18, z19, false, 0);
    }

    public long n1(java.lang.String str) {
        m11.j0 c17 = m11.k0.c(str);
        long incrementAndGet = c17.f322723e.incrementAndGet();
        m11.k0.f322727b.putLong("img." + c17.f322719a, incrementAndGet);
    ...
    public final java.lang.String o2(com.tencent.mm.storage.f9 f9Var, bm5.f0 f0Var, java.lang.String str) {
        ...
        if (trim.startsWith("THUMBNAIL://")) {
            try {
                trim = C1(java.lang.Long.valueOf(trim.substring(12))).f322639g;
            } catch (java.lang.NumberFormatException e17) {
                com.tencent.mars.xlog.Log.e("MicroMsg.ImgInfoStorage", "read img buf failed: " + e17.getMessage());
                return null;
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x00ce, code lost:
        ...
        if (com.tencent.mm.vfs.w6.j(r14) != false) goto L44;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String p1(com.tencent.mm.storage.f9 r14) {
        /*
    ...
    public final android.graphics.Bitmap s0(com.tencent.mm.storage.f9 f9Var, java.lang.String str, boolean z17, float f17, boolean z18, boolean z19, boolean z27, int i17) {
    ...
    public long t3(java.lang.String str, java.lang.String str2, m11.b0 b0Var) {
        ...
        if (e0Var.d() && c17.containsKey("msglocalid") && c17.containsKey("msgSvrId") && b0Var.f322647o <= 0 && b0Var.f322634b != 0) {
            ...
            com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct msgRefactorReportStruct = new com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct();
            msgRefactorReportStruct.p("imgInfo_check_id");
            msgRefactorReportStruct.u(p17);
            msgRefactorReportStruct.q(com.tencent.mm.sdk.platformtools.z.f193109e);
            msgRefactorReportStruct.f59281j = b0Var.f322634b;
            msgRefactorReportStruct.f59280i = b0Var.f322647o;
            msgRefactorReportStruct.k();
        }
        long l17 = this.f322746p.l(b17, str2, c17);
        if (l17 != -1) {
            b0Var.a();
        }
        if (!z65.c.f470458d) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "insert img,table:%s result:%d, localId:%d, msgLocalId:%d, msgSvrId:%d, hdID:%d", b17, java.lang.Long.valueOf(l17), java.lang.Long.valueOf(b0Var.f322633a), java.lang.Long.valueOf(b0Var.f322647o), java.lang.Long.valueOf(b0Var.f322634b), java.lang.Long.valueOf(b0Var.f322649q));
        }
        pt0.p.G6(b0Var.f322647o, str);
        return l17;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public android.graphics.Bitmap u0(com.tencent.mm.storage.f9 r15, java.lang.String r16, boolean r17, float r18, boolean r19, boolean r20, boolean r21, int r22, boolean r23) {
        /*
    ...
    public final long v3(java.lang.String str, java.lang.String str2, m11.b0 b0Var) {
        ...
        long v17 = this.f322746p.v(b17, dm.i4.COL_ID, c17);
        if (v17 != -1) {
            b0Var.a();
        }
        if (!z65.c.f470458d) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String v4(com.tencent.mm.storage.f9 r22, byte[] r23, android.graphics.Bitmap.CompressFormat r24, boolean r25, int r26, int r27) {
        /*
            r21 = this;
            java.lang.String r1 = "create thumbnail from byte failed: th_"
            boolean r0 = com.tencent.mm.sdk.platformtools.t8.M0(r23)
        ...
        L12:
            ...
            r5 = 0
            java.io.OutputStream r6 = com.tencent.mm.vfs.w6.K(r4, r5)     // Catch: java.lang.Throwable -> L88 java.lang.Exception -> L8a
            r7 = r23
            ...
            if (r25 == 0) goto L56
            android.graphics.Bitmap r5 = com.tencent.mm.sdk.platformtools.x.J(r4, r3)     // Catch: java.lang.Throwable -> L83 java.lang.Exception -> L86
            goto L5e
        L56:
            r7 = r26
            r8 = r27
            android.graphics.Bitmap r5 = com.tencent.mm.sdk.platformtools.x.T(r4, r8, r7, r5)     // Catch: java.lang.Throwable -> L83 java.lang.Exception -> L86
        L5e:
            if (r5 == 0) goto L68
            r7 = 90
            r8 = 1
            r9 = r24
            com.tencent.mm.sdk.platformtools.x.D0(r5, r7, r9, r0, r8)     // Catch: java.lang.Throwable -> L83 java.lang.Exception -> L86
        L68:
        ...
        L8a:
            ...
            r6 = r3
        L8c:
            com.tencent.mm.plugin.report.service.g0 r13 = com.tencent.mm.plugin.report.service.g0.INSTANCE     // Catch: java.lang.Throwable -> L83
            r14 = 111(0x6f, double:5.5E-322)
            r16 = 189(0xbd, double:9.34E-322)
            r18 = 1
            r20 = 0
            r13.idkeyStat(r14, r16, r18, r20)     // Catch: java.lang.Throwable -> L83
            ...
            com.tencent.mars.xlog.Log.e(r2, r0)     // Catch: java.lang.Throwable -> L83
            boolean r0 = com.tencent.mm.vfs.w6.j(r4)
            if (r0 == 0) goto Lbd
            com.tencent.mm.vfs.w6.h(r4)
        Lbd:
        ...
        Lc2:
            return r3
        Lc3:
            boolean r1 = com.tencent.mm.vfs.w6.j(r4)
            if (r1 == 0) goto Lcc
            com.tencent.mm.vfs.w6.h(r4)
        Lcc:
            if (r3 == 0) goto Ld1
    ...
    public long w3(java.lang.String str, java.lang.String str2, long j17, int i17, boolean z17, java.lang.String str3, int i18) {
        ...
        return t3(str, dm.i4.COL_ID, b0Var);
    }
    ...
    public final boolean y0(java.lang.String str) {
        ...
        return this.f322737d;
    }

    public java.lang.String y2(com.tencent.mm.storage.f9 f9Var, bm5.f0 f0Var, java.lang.String str, java.lang.String str2, java.lang.String str3) {
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, f0Var, str, str2, str3, true, false);
        if (com.tencent.mm.sdk.platformtools.t8.K0(bj6)) {
            return null;
        }
        return com.tencent.mm.sdk.platformtools.y1.g(bj6) ? P0(bj6) : bj6;
    }

    public boolean y4(com.tencent.mm.storage.f9 f9Var, android.widget.ImageView imageView, java.lang.String str, float f17, int i17, int i18, boolean z17, int i19, android.widget.ImageView imageView2, int i27, int i28, boolean z18, android.view.View view) {
        return A4(f9Var, imageView, str, false, f17, i17, i18, z17, i19, imageView2, i27, i28, z18, view);
    }

    public boolean z0(com.tencent.mm.storage.f9 f9Var, int i17, int i18, int i19) {
        java.lang.String p17 = p1(f9Var);
        if (f9Var != null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "createHDThumbNail %s %s %s", java.lang.Long.valueOf(f9Var.getMsgId()), f9Var.z0(), p17);
        }
    ...
    */
    public m11.b0 z1(long r14) {
        ...
        L52:
            ...
            com.tencent.mars.xlog.Log.w(r3, r4, r1)     // Catch: java.lang.Throwable -> L68
            if (r14 == 0) goto L66
            r14.close()
        L66:
            r2 = r15
    ...
    public final void z3(com.tencent.mm.storage.f9 f9Var, android.widget.ImageView imageView, android.widget.ImageView imageView2, android.view.View view, java.lang.String str, java.lang.String str2, float f17, boolean z17, int i17) {
        java.util.Set set;
        int i18;
        m11.i0 i0Var;
        int i19;
        ...
        java.util.ArrayList arrayList = (java.util.ArrayList) this.f322739f;
        java.util.Iterator it = arrayList.iterator();
        do {
            boolean hasNext = it.hasNext();
            set = this.f322743m;
            if (!hasNext) {
                ((java.util.HashMap) this.f322740g).put(java.lang.Integer.valueOf(hashCode2), new java.lang.ref.WeakReference(imageView));
                int i27 = 0;
                if (imageView2 != null) {
                    i18 = imageView2.hashCode();
                    ((java.util.HashMap) this.f322741h).put(java.lang.Integer.valueOf(i18), new java.lang.ref.WeakReference(imageView2));
                } else {
                    i18 = 0;
                }
                if (view != null) {
                    i27 = view.hashCode();
                    ((java.util.HashMap) this.f322742i).put(java.lang.Integer.valueOf(i27), new java.lang.ref.WeakReference(view));
                }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ImgInfoStorage", "setbitmapFromUri  [%d, %s] ", java.lang.Integer.valueOf(i19), i0Var.f322711b);
        i0Var.f322711b = str;
