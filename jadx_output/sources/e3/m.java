    ...
    public android.graphics.Typeface a(android.content.Context context, d3.g gVar, android.content.res.Resources resources, int i17) {
        try {
            ...
            for (d3.h hVar : gVar.f226086a) {
                try {
                    android.graphics.fonts.Font build = new android.graphics.fonts.Font.Builder(resources, hVar.f226092f).setWeight(hVar.f226088b).setSlant(hVar.f226089c ? 1 : 0).setTtcIndex(hVar.f226091e).setFontVariationSettings(hVar.f226090d).build();
                    if (builder == null) {
    ...
    public android.graphics.Typeface b(android.content.Context context, android.os.CancellationSignal cancellationSignal, k3.n[] nVarArr, int i17) {
        ...
        try {
            ...
            for (k3.n nVar : nVarArr) {
                try {
                    openFileDescriptor = contentResolver.openFileDescriptor(nVar.f303803a, "r", cancellationSignal);
                } catch (java.io.IOException unused) {
                }
                if (openFileDescriptor != null) {
                    try {
                        android.graphics.fonts.Font build = new android.graphics.fonts.Font.Builder(openFileDescriptor).setWeight(nVar.f303805c).setSlant(nVar.f303806d ? 1 : 0).setTtcIndex(nVar.f303804b).build();
                        if (builder == null) {
                            builder = new android.graphics.fonts.FontFamily.Builder(build);
                        } else {
                            builder.addFont(build);
