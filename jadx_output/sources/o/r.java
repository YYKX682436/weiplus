...
public class r implements g3.a {
    ...
    public final android.content.Context f341780d;

    /* renamed from: e, reason: collision with root package name */
    public final android.content.res.Resources f341781e;

    /* renamed from: f, reason: collision with root package name */
    public boolean f341782f;

    /* renamed from: g, reason: collision with root package name */
    public boolean f341783g;

    /* renamed from: h, reason: collision with root package name */
    public o.p f341784h;

    /* renamed from: i, reason: collision with root package name */
    public final java.util.ArrayList f341785i;

    /* renamed from: m, reason: collision with root package name */
    public final java.util.ArrayList f341786m;

    /* renamed from: n, reason: collision with root package name */
    public boolean f341787n;

    /* renamed from: o, reason: collision with root package name */
    public final java.util.ArrayList f341788o;

    /* renamed from: p, reason: collision with root package name */
    public final java.util.ArrayList f341789p;

    /* renamed from: q, reason: collision with root package name */
    public boolean f341790q;

    /* renamed from: s, reason: collision with root package name */
    public java.lang.CharSequence f341792s;

    /* renamed from: t, reason: collision with root package name */
    public android.graphics.drawable.Drawable f341793t;

    /* renamed from: u, reason: collision with root package name */
    public android.view.View f341794u;

    /* renamed from: r, reason: collision with root package name */
    public int f341791r = 0;

    /* renamed from: v, reason: collision with root package name */
    public boolean f341795v = false;

    /* renamed from: w, reason: collision with root package name */
    public boolean f341796w = false;

    /* renamed from: x, reason: collision with root package name */
    public boolean f341797x = false;

    /* renamed from: y, reason: collision with root package name */
    public boolean f341798y = false;

    /* renamed from: z, reason: collision with root package name */
    public final java.util.ArrayList f341799z = new java.util.ArrayList();
    ...
    public r(android.content.Context context) {
        boolean z17;
        boolean z18 = false;
        this.f341780d = context;
        android.content.res.Resources resources = context.getResources();
        this.f341781e = resources;
        this.f341785i = new java.util.ArrayList();
        this.f341786m = new java.util.ArrayList();
        this.f341787n = true;
        this.f341788o = new java.util.ArrayList();
        this.f341789p = new java.util.ArrayList();
        this.f341790q = true;
        if (resources.getConfiguration().keyboard != 1) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 28) {
                ...
                int identifier = resources2.getIdentifier("config_showMenuShortcutsWhenKeyboardPresent", "bool", com.eclipsesource.mmv8.Platform.ANDROID);
    ...
    public android.view.MenuItem a(int i17, int i18, int i19, java.lang.CharSequence charSequence) {
        ...
        o.u uVar = new o.u(this, i17, i18, i19, i29, charSequence, this.f341791r);
        java.util.ArrayList arrayList = this.f341785i;
        ...
        while (true) {
            ...
            if (((o.u) arrayList.get(size)).f341807g <= i29) {
                i27 = size + 1;
                break;
            }
        }
    ...
    public int addIntentOptions(int i17, int i18, int i19, android.content.ComponentName componentName, android.content.Intent[] intentArr, android.content.Intent intent, int i27, android.view.MenuItem[] menuItemArr) {
        int i28;
        android.content.pm.PackageManager packageManager = this.f341780d.getPackageManager();
    ...
    public android.view.MenuItem findItem(int i17) {
        ...
        for (int i18 = 0; i18 < size; i18++) {
            o.u uVar = (o.u) this.f341785i.get(i18);
            if (uVar.f341804d == i17) {
                return uVar;
            }
            if (uVar.hasSubMenu() && (findItem = uVar.f341818u.findItem(i17)) != null) {
                return findItem;
            }
        }
        return null;
    ...
    public o.u g(int i17, android.view.KeyEvent keyEvent) {
        java.util.ArrayList arrayList = this.f341799z;
        arrayList.clear();
        ...
        for (int i18 = 0; i18 < size; i18++) {
            ...
            char c17 = n17 ? uVar.f341813p : uVar.f341811n;
    ...
    public android.view.MenuItem getItem(int i17) {
        return (android.view.MenuItem) this.f341785i.get(i17);
    }
    ...
    public void h(java.util.List list, int i17, android.view.KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i17 == 67) {
            ...
            for (0; i18 < size; i18 + 1) {
                o.u uVar = (o.u) arrayList.get(i18);
                if (uVar.hasSubMenu()) {
                    uVar.f341818u.h(list, i17, keyEvent);
                }
                char c17 = n17 ? uVar.f341813p : uVar.f341811n;
                if (((modifiers & 69647) == ((n17 ? uVar.f341814q : uVar.f341812o) & 69647)) && c17 != 0) {
                    char[] cArr = keyData.meta;
    ...
    public boolean hasVisibleItems() {
        ...
        for (int i17 = 0; i17 < size; i17++) {
            if (((o.u) this.f341785i.get(i17)).isVisible()) {
                return true;
            }
        }
        return false;
    ...
    public void i() {
        ...
        if (this.f341790q) {
            ...
            java.util.ArrayList arrayList = this.f341788o;
            java.util.ArrayList arrayList2 = this.f341789p;
            if (z17) {
                arrayList.clear();
                arrayList2.clear();
                int size = l17.size();
    ...
    public java.util.ArrayList l() {
        boolean z17 = this.f341787n;
        java.util.ArrayList arrayList = this.f341786m;
        if (!z17) {
            return arrayList;
        }
        arrayList.clear();
        java.util.ArrayList arrayList2 = this.f341785i;
    ...
    public boolean n() {
        return this.f341782f;
    }

    public boolean o() {
        return this.f341783g;
    }
    ...
    */
    ...
    public void removeGroup(int i17) {
        ...
        int i19 = 0;
        while (true) {
            arrayList = this.f341785i;
            if (i19 >= size) {
                i19 = -1;
                break;
            } else if (((o.u) arrayList.get(i19)).f341805e == i17) {
                break;
            } else {
                i19++;
            }
        ...
        if (i19 >= 0) {
            ...
            while (true) {
                int i27 = i18 + 1;
                if (i18 >= size2 || ((o.u) arrayList.get(i19)).f341805e != i17) {
                    break;
                }
    ...
    public void removeItem(int i17) {
        ...
        while (true) {
            ...
            if (i18 >= size) {
                i18 = -1;
                break;
            } else if (((o.u) arrayList.get(i18)).f341804d == i17) {
                break;
            } else {
                i18++;
            }
        ...
        if (sparseParcelableArray != null) {
            ...
            while (it.hasNext()) {
                ...
                if (g0Var == null) {
                    ...
                    int id6 = g0Var.getId();
                    if (id6 > 0 && (parcelable = (android.os.Parcelable) sparseParcelableArray.get(id6)) != null) {
                        g0Var.f(parcelable);
                    }
                }
            }
    ...
    public void v(android.os.Bundle bundle) {
        ...
        while (it.hasNext()) {
            ...
            if (g0Var == null) {
                ...
                int id6 = g0Var.getId();
                if (id6 > 0 && (b17 = g0Var.b()) != null) {
                    sparseArray.put(id6, b17);
                }
            }
        }
    ...
    public final void x(int i17, java.lang.CharSequence charSequence, int i18, android.graphics.drawable.Drawable drawable, android.view.View view) {
        if (view != null) {
            ...
            if (i17 > 0) {
                this.f341792s = this.f341781e.getText(i17);
            } else if (charSequence != null) {
                this.f341792s = charSequence;
            }
            if (i18 > 0) {
                this.f341793t = b3.l.getDrawable(this.f341780d, i18);
            } else if (drawable != null) {
                this.f341793t = drawable;
            }
            this.f341794u = null;
        }
        p(false);
    ...
    public android.view.MenuItem add(int i17) {
        return a(0, 0, 0, this.f341781e.getString(i17));
    }

    @Override // android.view.Menu
    public android.view.SubMenu addSubMenu(int i17) {
        return addSubMenu(0, 0, 0, this.f341781e.getString(i17));
    }
    ...
    public android.view.SubMenu addSubMenu(int i17, int i18, int i19, java.lang.CharSequence charSequence) {
        ...
        o.o0 o0Var = new o.o0(this.f341780d, this, uVar);
        uVar.f341818u = o0Var;
        o0Var.setHeaderTitle(uVar.f341808h);
        return o0Var;
    }

    @Override // android.view.Menu
    public android.view.MenuItem add(int i17, int i18, int i19, int i27) {
        return a(i17, i18, i19, this.f341781e.getString(i27));
    }

    @Override // android.view.Menu
    public android.view.SubMenu addSubMenu(int i17, int i18, int i19, int i27) {
        return addSubMenu(i17, i18, i19, this.f341781e.getString(i27));
    }
}
