...
public class j implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.appbrand.openmaterial.ui.hybrid.HybridOpenMaterialView f262788d;

    public j(com.tencent.mm.plugin.appbrand.openmaterial.ui.hybrid.HybridOpenMaterialView hybridOpenMaterialView) {
        this.f262788d = hybridOpenMaterialView;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.appbrand.openmaterial.ui.hybrid.HybridOpenMaterialView hybridOpenMaterialView = this.f262788d;
        if (hybridOpenMaterialView.f86280n) {
