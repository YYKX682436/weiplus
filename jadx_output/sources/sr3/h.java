...
public abstract class h {
    public static void a(r45.mm mmVar, android.content.Context context, java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(mmVar.f380639h)) {
            return;
        }
        java.lang.String str2 = mmVar.f380639h;
        com.tencent.mars.xlog.Log.i("MicroMsg.NewBizInfoUtil", "jumpToSearch username: %s, suggestData: %s", str, str2);
    ...
    public static void b(r45.mm mmVar, android.content.Context context, java.lang.String str, int i17) {
        ...
        intent.putExtra("rawUrl", mmVar.f380639h);
    ...
    public static void c(r45.mm mmVar, android.content.Context context, java.lang.String str) {
        ...
        try {
            org.json.JSONObject jSONObject = new org.json.JSONObject(mmVar.f380639h);
            qk.o b17 = r01.z.b(str);
            java.lang.String str2 = mmVar.f380638g;
            java.lang.String format = java.lang.String.format("%s:%s:%s:%s", str, java.lang.Integer.valueOf(!com.tencent.mm.sdk.platformtools.t8.K0(str2) ? str2.length() - str2.replace("_", "").length() : 0), mmVar.f380637f, jSONObject.optString("pagePath"));
            ...
            appBrandStatObject.f87790f = 1102;
            appBrandStatObject.f87791g = format;
            ((com.tencent.mm.plugin.appbrand.launching.xc) ((com.tencent.mm.plugin.appbrand.service.h6) i95.n0.c(com.tencent.mm.plugin.appbrand.service.h6.class))).Vi(context, jSONObject.optString("userName"), null, 0, 0, jSONObject.optString("pagePath"), appBrandStatObject, b17 == null ? null : b17.field_appId);
        } catch (org.json.JSONException e17) {
            com.tencent.mars.xlog.Log.e("MicroMsg.NewBizInfoUtil", e17.getMessage());
        }
    }
}
