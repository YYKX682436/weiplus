...
public final class g {
    ...
    public final android.graphics.Rect f43434c;

    public g(float f17, float f18, android.graphics.Rect rect, int i17, kotlin.jvm.internal.i iVar) {
    ...
    public final android.graphics.Bitmap a(android.graphics.Bitmap bitmap) {
        ...
        android.graphics.Rect rect = this.f43434c;
        if (rect != null && bitmap2 != null && (bitmap.getWidth() != rect.width() || bitmap.getHeight() != rect.height())) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.FinalBitmapGenerateInterceptor", "onInterceptGenerateBitmap: outputRect w:[" + rect.width() + ",h:" + rect.height() + "], newResult [w:" + createBitmap.getWidth() + ",h:" + createBitmap.getHeight() + "], src [w:" + bitmap.getWidth() + ",h:" + bitmap.getHeight() + ']');
            bitmap.recycle();
            bitmap2 = createBitmap;
        }
        float f17 = this.f43432a;
        boolean z17 = f17 == 1.0f;
        float f18 = this.f43433b;
        if (z17) {
            if (f18 == 1.0f) {
                return bitmap2;
            }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FinalBitmapGenerateInterceptor", "onInterceptGenerateBitmap: finalScaleX=" + f17 + ", finalScaleY=" + f18 + ", newResult=[w:" + createBitmap2.getWidth() + ",h:" + createBitmap2.getHeight() + "], src=[w:" + bitmap2.getWidth() + ",h:" + bitmap2.getHeight() + ']');
        bitmap2.recycle();
