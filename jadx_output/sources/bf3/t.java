...
public final class t implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.webkit.WebView f19662d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bf3.z f19663e;

    public t(android.webkit.WebView webView, bf3.z zVar) {
        this.f19662d = webView;
        this.f19663e = zVar;
    }
    ...
    public void onAnimationUpdate(android.animation.ValueAnimator animation) {
        ...
        android.webkit.WebView webView = this.f19662d;
        if (z17) {
        ...
        webView.setTranslationY(((java.lang.Float) animatedValue2).floatValue() * this.f19663e.f());
