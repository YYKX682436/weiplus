...
public abstract class w3 {
    public static final kotlinx.coroutines.f2 a(final int i17, final java.lang.String str) {
        if (i17 >= 1) {
            final java.util.concurrent.atomic.AtomicInteger atomicInteger = new java.util.concurrent.atomic.AtomicInteger();
            return new kotlinx.coroutines.g2(java.util.concurrent.Executors.newScheduledThreadPool(i17, new java.util.concurrent.ThreadFactory() { // from class: kotlinx.coroutines.w3$$a
