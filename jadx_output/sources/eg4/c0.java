...
public final class c0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.widget.TextView f252681d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.widget.TextView f252682e;

    public c0(android.widget.TextView textView, android.widget.TextView textView2) {
        this.f252681d = textView;
        this.f252682e = textView2;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        this.f252681d.setVisibility(8);
        android.widget.TextView textView = this.f252682e;
        if (textView != null) {
