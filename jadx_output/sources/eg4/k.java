...
public final class k implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ eg4.t f252744d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f252745e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ y35.r f252746f;

    public k(eg4.t tVar, android.content.Context context, y35.r rVar) {
        this.f252744d = tVar;
        this.f252745e = context;
        this.f252746f = rVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        eg4.t tVar = this.f252744d;
        tVar.getClass();
        ns.k kVar = (ns.k) i95.n0.c(ns.k.class);
        android.content.Context context = this.f252745e;
        ((ms.a) kVar).Ai(context, new eg4.h(context, this.f252746f, tVar));
