...
public final class l implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ eg4.t f252751d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f252752e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ y35.r f252753f;

    public l(eg4.t tVar, android.content.Context context, y35.r rVar) {
        this.f252751d = tVar;
        this.f252752e = context;
        this.f252753f = rVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        eg4.t tVar = this.f252751d;
        tVar.getClass();
        ns.k kVar = (ns.k) i95.n0.c(ns.k.class);
        android.content.Context context = this.f252752e;
        ((ms.a) kVar).Ai(context, new eg4.n(context, this.f252753f, tVar));
