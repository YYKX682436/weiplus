...
public class h implements o22.f {
    ...
    public final /* synthetic */ android.content.Context f342408a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ android.content.Intent f342409b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ int f342410c;

    public h(android.content.Context context, android.content.Intent intent, int i17) {
        this.f342408a = context;
        this.f342409b = intent;
        this.f342410c = i17;
    }

    public void a(boolean z17) {
        if (z17) {
            android.content.Context context = this.f342408a;
            boolean z18 = context instanceof android.app.Activity;
            int i17 = this.f342410c;
            android.content.Intent intent = this.f342409b;
            if (z18) {
            ...
            android.content.Context context2 = this.f342408a;
