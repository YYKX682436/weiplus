...
public abstract class d {
    public static void a(java.util.Map map, r45.rq0 rq0Var) {
        ...
        if (map == null || rq0Var == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FavTagParser", "maps is null or item is null");
            return;
        }
        rq0Var.f385096e.clear();
        int i17 = 0;
        int i18 = 0;
        while (true) {
            linkedList = rq0Var.f385096e;
            if (i18 >= 1024) {
                break;
            }
        ...
        while (i19 < 1024) {
            ...
            int P = com.tencent.mm.sdk.platformtools.t8.P((java.lang.String) map.get(sb7.toString()), -1);
            if (P > 0) {
                rq0Var.f385097f.add(java.lang.Integer.valueOf(P));
            }
            i19++;
        }
        linkedList.isEmpty();
        java.util.LinkedList linkedList2 = rq0Var.f385095d;
        linkedList2.clear();
        while (i17 < 1024) {
