...
public class c implements gy1.a {
    ...
    public final int f367829a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.List f367830b = new java.util.ArrayList();
    ...
    public c() {
        ...
        try {
            ...
            while (i17 >= 0 && i17 < Zi.length() && i18 >= 0) {
                i18 = Zi.indexOf(",", i17);
                try {
                    this.f367830b.add(java.lang.Integer.valueOf(java.lang.Integer.parseInt(i18 >= 0 ? Zi.substring(i17, i18) : Zi.substring(i17))));
                } catch (java.lang.Throwable unused) {
                }
                i17 = i18 + 1;
            }
            if (((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_smc_max_log_item_size, 15) > 0) {
                this.f367829a = (r0 * 1024) - 50;
            }
