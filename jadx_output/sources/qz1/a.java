...
public class a implements gy1.a {
    ...
    public java.lang.Boolean f367827a = null;

    /* renamed from: b, reason: collision with root package name */
    public java.lang.Boolean f367828b = null;
    ...
    public boolean a(long j17, java.lang.String str, java.util.Map map, ky1.d dVar) {
        ...
        if (!u46.l.e(str) && dVar != null) {
            int i17 = dVar.f313500b;
            if (i17 == 5 || i17 == 9 || i17 == 999) {
                try {
                    java.util.Map Di = ((fm4.f) ((qk.k8) i95.n0.c(qk.k8.class))).Di(dVar.f313500b);
                    if (Di != null) {
            ...
            if (!"LiteAppCustomReportCgiEvent".equals(str)) {
                com.tencent.mars.xlog.Log.i("Amoeba.Test.CGI", "[route] eventId : " + str + ", routeRule : " + dVar.f313500b + ", params : " + sz1.a.a(map, 0));
                if (dVar.f313500b == 999) {
                    dVar.f313500b = 5;
                }
                if (map != null) {
                    ...
                    linkedList.add(c18);
                    if (c18 != null) {
                        oy1.p.f349911a.c(dVar.f313500b, linkedList, false);
                    }
                }
            } else if (map != null) {
                try {
                    ...
                    if (!linkedList2.isEmpty()) {
                        oy1.p.f349911a.c(dVar.f313500b, linkedList2, true);
                    }
                } catch (java.lang.Exception e17) {
                    com.tencent.mars.xlog.Log.i("MicroMsg.CGIReportRouter", "get params err %s", e17.toString());
                }
            }
        }
        return false;
 ...
 binds: [B:94:0x028f, B:118:0x02d7, B:113:0x02c8, B:108:0x02b9, B:103:0x02a9, B:97:0x0299] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final void e(java.util.Map map) {
        if (this.f367828b == null) {
            this.f367828b = java.lang.Boolean.valueOf(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.c0.clicfg_data_report_sdk_cgi_remove_page_info, true));
            com.tencent.mars.xlog.Log.i("MicroMsg.CGIReportRouter", "isRemovePageInfo = " + this.f367828b);
        }
        if (this.f367828b.booleanValue()) {
    ...
    public final java.lang.String f(java.util.Map map) {
        ...
        if (d(map) <= 2048 && (jSONObject = (org.json.JSONObject) sz1.f.c(map)) != null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.CGIReportRouter", "not removePageLargeParams cost time [%d]", java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime));
        ...
        if (d17 > 2048) {
            com.tencent.mars.xlog.Log.e("MicroMsg.CGIReportRouter", " [%d] params  remove,   cost time [%d]", java.lang.Integer.valueOf(i17 + 1), java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime));
            return "";
        }
        org.json.JSONObject jSONObject2 = (org.json.JSONObject) sz1.f.c(map);
        com.tencent.mars.xlog.Log.i("MicroMsg.CGIReportRouter", " [%d] params  remove,   cost time [%d]", java.lang.Integer.valueOf(i17 + 1), java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime));
