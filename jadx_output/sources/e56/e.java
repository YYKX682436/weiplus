...
public class e extends java.lang.AssertionError {
    ...
    public final java.lang.String f249689d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f249690e;
    ...
    public java.lang.String getMessage() {
        java.lang.String str = this.f249689d;
        java.lang.String str2 = this.f249690e;
        ...
        java.lang.String str3 = cVar.f249685a;
        if (str3.length() > 20) {
            str3 = "..." + str3.substring(str3.length() - 20);
        }
        java.lang.String str4 = cVar.f249686b;
        if (str4.length() > 20) {
