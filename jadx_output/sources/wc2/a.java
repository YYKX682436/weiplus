...
public class a {
    ...
    public final int f444497a;

    /* renamed from: b, reason: collision with root package name */
    public int f444498b;

    /* renamed from: e, reason: collision with root package name */
    public boolean f444501e = false;

    /* renamed from: c, reason: collision with root package name */
    public final android.util.SparseArray f444499c = new android.util.SparseArray();

    /* renamed from: d, reason: collision with root package name */
    public final android.util.SparseArray f444500d = new android.util.SparseArray();
    ...
    public final void a(wc2.b bVar, android.graphics.Point point, int i17) {
        bVar.f444502a++;
        bVar.f444503b += point.x;
        int i18 = point.y;
        int i19 = bVar.f444504c;
        if (i18 > i19) {
            i19 = i18;
        }
        bVar.f444504c = i19;
    ...
    public void b(int i17, int i18) {
        if (g()) {
            c(i17);
            int i19 = i17 + i18;
            android.util.SparseArray sparseArray = this.f444499c;
    ...
    public final void c(int i17) {
        ...
        int d17 = d(i17);
        android.util.SparseArray sparseArray = this.f444500d;
    ...
    public int d(int i17) {
        ...
        while (true) {
            ...
            i19 += ((wc2.b) sparseArray.get(i18)).f444502a;
            if (i19 >= i17 + 1) {
                return i18;
            }
            i18++;
    ...
    */
    public final void e() {
        ...
        Lc:
            ...
            r2 = r1
        Lf:
            android.util.SparseArray r3 = r11.f444500d
            int r4 = r3.size()
            if (r1 >= r4) goto L23
            ...
            goto Lf
        L23:
            android.util.SparseArray r1 = r11.f444499c
            int r4 = r1.size()
            if (r2 < r4) goto L2c
            r2 = -1
        L2c:
        ...
        L5e:
            ...
            r9 = 1
            int r0 = r0 + r9
            int r10 = r11.f444498b
            if (r8 > r10) goto L87
            int r10 = r11.f444497a
            if (r10 <= 0) goto L83
            if (r0 <= r10) goto L7f
            r3.put(r6, r7)
            wc2.b r0 = new wc2.b
