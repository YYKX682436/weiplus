...
public abstract class x2 {
    ...
    public static org.json.JSONObject b(java.util.Map map) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.MsgWrapper", "convertMapToJSON fail, exception = " + e17.getMessage());
            return null;
        }
    }
    ...
    public static java.lang.String e(java.lang.String str, java.lang.String str2, java.util.Map map, org.json.JSONObject jSONObject, boolean z17, java.lang.String str3) {
        ...
        try {
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.i("MicroMsg.MsgWrapper", "js digest verification contentStr = %s", replaceAll);
                java.lang.String b17 = kk.r.b(replaceAll + str3);
                com.tencent.mars.xlog.Log.i("MicroMsg.MsgWrapper", "js digest verification shaStr = %s", b17);
                jSONObject3.put("__sha_key", b17);
                return jSONObject3.toString();
            } catch (java.lang.Exception e17) {
                com.tencent.mars.xlog.Log.e("MicroMsg.MsgWrapper", "build fail, exception = " + e17.getMessage());
                return null;
            }
        } catch (java.lang.Exception e18) {
            com.tencent.mars.xlog.Log.e("MicroMsg.MsgWrapper", "build fail, exception = " + e18.getMessage());
            return null;
        }
    }
}
