    ...
    public static java.util.Map a(android.os.Bundle bundle) {
        ...
        if (!com.tencent.mm.sdk.platformtools.t8.K0(string)) {
            try {
                ...
                com.tencent.mars.xlog.Log.w("MicroMsg.AbsMsgWrapper", "convertBundleToMap ex %s", e17.getMessage());
            }
        }
        ...
        for (java.lang.String str : keySet) {
            ...
            if (z17 && hashSet.contains(str) && (obj instanceof java.lang.String)) {
                try {
                    ...
                    hashMap.put(str, obj);
                    com.tencent.mars.xlog.Log.w("MicroMsg.AbsMsgWrapper", "convertBundleToMap ex %s", e18.getMessage());
                }
            } else {
                hashMap.put(str, obj);
            }
