...
public final class k implements android.database.Cursor {
    ...
    public final android.content.ContentValues f325010d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.List f325011e;

    public k(android.content.ContentValues cv6, l75.e0 info, java.util.List coverFields) {
        kotlin.jvm.internal.o.g(cv6, "cv");
        kotlin.jvm.internal.o.g(info, "info");
        kotlin.jvm.internal.o.g(coverFields, "coverFields");
        this.f325010d = cv6;
        this.f325011e = coverFields;
    }
    ...
    public byte[] getBlob(int i17) {
        return this.f325010d.getAsByteArray((java.lang.String) this.f325011e.get(i17));
    }

    @Override // android.database.Cursor
    public int getColumnCount() {
        return this.f325011e.size();
    }
    ...
    public java.lang.String[] getColumnNames() {
        return (java.lang.String[]) this.f325011e.toArray(new java.lang.String[0]);
    }
    ...
    public double getDouble(int i17) {
        java.lang.Double asDouble = this.f325010d.getAsDouble((java.lang.String) this.f325011e.get(i17));
        if (asDouble == null) {
            return 0.0d;
        }
    ...
    public float getFloat(int i17) {
        java.lang.Float asFloat = this.f325010d.getAsFloat((java.lang.String) this.f325011e.get(i17));
        if (asFloat == null) {
            return 0.0f;
        }
    ...
    public int getInt(int i17) {
        java.lang.Integer asInteger = this.f325010d.getAsInteger((java.lang.String) this.f325011e.get(i17));
        if (asInteger == null) {
            return 0;
        }
    ...
    public long getLong(int i17) {
        java.lang.Long asLong = this.f325010d.getAsLong((java.lang.String) this.f325011e.get(i17));
        if (asLong == null) {
            return 0L;
        }
    ...
    public short getShort(int i17) {
        java.lang.Short asShort = this.f325010d.getAsShort((java.lang.String) this.f325011e.get(i17));
        if (asShort == null) {
            return (short) 0;
        }
    ...
    public java.lang.String getString(int i17) {
        return this.f325010d.getAsString((java.lang.String) this.f325011e.get(i17));
    }
    ...
    */
    public /* synthetic */ k(android.content.ContentValues r1, l75.e0 r2, java.util.List r3, int r4, kotlin.jvm.internal.i r5) {
        /*
            r0 = this;
            r4 = r4 & 4
            if (r4 == 0) goto Lf
            java.lang.String[] r3 = r2.f316954c
