...
public abstract class h {
    ...
    public static float b(android.content.Context context) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.FTS.FtsVideoPlayerUtils", "ex %s", e17.getMessage());
            return 0.0f;
        }
    }

    public static java.lang.String c(org.json.JSONObject jSONObject) {
        org.json.JSONArray optJSONArray = jSONObject.optJSONArray(com.tencent.live2.jsplugin.V2TXJSAdapterConstants.PLAYER_KEY_PLAY_URL);
