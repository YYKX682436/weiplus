...
public class j extends sz4.u {
    ...
    public final android.widget.ImageView f414202y;

    /* renamed from: z, reason: collision with root package name */
    public final int f414203z;

    public j(android.view.View view, mz4.j0 j0Var, mz4.d dVar) {
        super(view, j0Var, dVar);
        this.f414203z = 0;
        this.f414231f.setVisibility(0);
        this.f414239q.setVisibility(8);
        this.f414234i.setVisibility(8);
        this.f414231f.setTag(this);
        this.f414231f.setOnClickListener(this.f414244v);
        android.widget.ImageView imageView = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.h_2);
        this.f414202y = imageView;
        imageView.setVisibility(8);
        this.f414203z = mz4.j0.f333291w - ((int) android.util.TypedValue.applyDimension(1, 20.0f, mz4.j0.f333292x));
    }
    ...
    public void j(iz4.c cVar, int i17, int i18) {
        ...
        if (this.f414182d.f333309q == 3) {
            if (!com.tencent.mm.vfs.w6.j(str2)) {
                str2 = str;
            }
            str = str2;
        }
        android.graphics.Bitmap g17 = com.tencent.mm.sdk.platformtools.t8.K0(str) ? null : qz4.c.g(str, null);
        android.widget.ImageView imageView = this.f414231f;
        ...
        android.widget.ImageView imageView2 = this.f414202y;
        if (z17) {
