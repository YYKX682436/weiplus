...
public abstract class a {
    ...
    public static int f431907a;

    /* renamed from: b, reason: collision with root package name */
    public static final wy1.b f431908b = new wy1.b();

    /* renamed from: c, reason: collision with root package name */
    public static final wy1.a f431909c = new wy1.a();
    ...
    public static void a(hz1.a aVar) {
        ...
        wy1.b bVar = f431908b;
        bVar.getClass();
        java.lang.String str = aVar.f286290d + "_" + aVar.f286287a;
        if (u46.l.e(str)) {
            return;
        }
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) bVar.f450631a;
        if (concurrentHashMap.containsKey(str)) {
            vy1.b bVar2 = (vy1.b) concurrentHashMap.remove(str);
            if (bVar2 != null) {
                bVar2.a();
            }
            com.tencent.mars.xlog.Log.i("Amoeba.PageDataEntityStorage", "[clear] page : " + aVar + ", mPageDataMap size : " + concurrentHashMap.size());
        }
    }
    ...
    public static boolean c(java.lang.Object obj, java.lang.String str, boolean z17) {
        if (obj != null && !u46.l.e(str)) {
            vy1.b j17 = j(obj, false);
            java.lang.Object obj2 = (j17 == null || u46.l.e(str)) ? null : ((java.util.concurrent.ConcurrentHashMap) j17.f441432k).get(str);
    ...
    public static vy1.a h(java.lang.Object obj, boolean z17) {
        ...
        wy1.a aVar = f431909c;
        vy1.a aVar2 = (vy1.a) ((java.util.WeakHashMap) aVar.f450630a).get(obj);
        if (aVar2 != null || !z17) {
            return aVar2;
        }
        vy1.a aVar3 = new vy1.a();
        aVar.getClass();
        ((java.util.WeakHashMap) aVar.f450630a).put(obj, aVar3);
        return aVar3;
    }
    ...
    public static java.util.Map i(java.lang.Object obj, java.lang.String str) {
        ...
        if (obj != null && !u46.l.e(str)) {
            ...
            java.util.List list = h17.f441418c;
            if (list != null && ((java.util.concurrent.CopyOnWriteArrayList) list).size() > 0) {
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        com.tencent.mars.xlog.Log.e("Amoeba.DataEntityOperator", "[getObjectDynamicParams] getDynamicParams throw Exception : " + e17.getMessage());
                    }
    ...
    public static vy1.b j(java.lang.Object obj, boolean z17) {
        ...
        wy1.b bVar2 = f431908b;
        bVar2.getClass();
        if (obj instanceof hz1.a) {
            hz1.a aVar = (hz1.a) obj;
            java.lang.String str = aVar.f286290d + "_" + aVar.f286287a;
            if (!u46.l.e(str)) {
                bVar = (vy1.b) ((java.util.concurrent.ConcurrentHashMap) bVar2.f450631a).get(str);
            }
        }
        if (bVar == null && z17) {
            bVar = new vy1.b();
            ...
            if (obj instanceof hz1.a) {
                ...
                java.lang.String str2 = aVar2.f286290d + "_" + aVar2.f286287a;
                if (!u46.l.e(str2)) {
                    java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) bVar2.f450631a;
                    concurrentHashMap.put(str2, bVar);
                    com.tencent.mars.xlog.Log.i("Amoeba.PageDataEntityStorage", "[save] page : " + aVar2 + ", mPageDataMap size : " + concurrentHashMap.size());
                }
            }
        }
        return bVar;
    ...
    public static vy1.c l(java.lang.Object obj, boolean z17) {
        ...
        if (obj instanceof android.view.View) {
            try {
                java.lang.Object tag = ((android.view.View) obj).getTag(com.tencent.mm.R.id.p1e);
        ...
        if (cVar == null && z17) {
            ...
            if (obj instanceof android.view.View) {
                try {
                    ((android.view.View) obj).setTag(com.tencent.mm.R.id.p1e, cVar);
    ...
    public static int n(java.lang.Object obj) {
        ...
        vy1.c l17 = l(obj, false);
        if (l17 != null) {
            java.util.Iterator it = ((java.util.concurrent.ConcurrentHashMap) l17.f441451i).keySet().iterator();
            while (it.hasNext()) {
    ...
    public static void p(java.lang.Object obj) {
        ...
        sz1.i.b(new java.lang.Runnable() { // from class: uy1.a$$a
            ...
            public final void run() {
                ...
                ((java.util.concurrent.ConcurrentHashMap) bVar.f441440s).clear();
                java.util.Map map = hashMap;
                for (java.lang.String str : map.keySet()) {
                    java.lang.Object obj2 = map.get(str);
                    if (obj2 != null) {
                        ((java.util.concurrent.ConcurrentHashMap) bVar.f441440s).put(str, obj2);
                    }
                }
                java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) bVar.f441441t;
                ...
                java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = (java.util.concurrent.ConcurrentHashMap) bVar.f441442u;
    ...
    public static void t(java.lang.Object obj, int i17, int i18, int i19, boolean z17, boolean z18) {
        ...
        if (arrayList.size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) j17.f441433l;
    ...
    public static void u(java.lang.Object obj, java.lang.String str, long j17) {
        ...
        ((java.util.concurrent.ConcurrentHashMap) l17.f441453k).put(str, java.lang.Long.valueOf(j17));
    }
