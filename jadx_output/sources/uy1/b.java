...
public abstract class b {
    ...
    public static final java.util.Map f431914a = new java.util.WeakHashMap();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f431915b = new java.util.WeakHashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.Map f431916c = new java.util.WeakHashMap();

    public static vy1.b a(java.lang.Object obj, boolean z17) {
        if (obj == null) {
            return null;
        }
        java.util.Map map = f431914a;
