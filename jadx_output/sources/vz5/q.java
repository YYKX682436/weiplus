...
public abstract class q extends vz5.p {
    public static final boolean d(java.io.File file) {
        ...
        vz5.j jVar = new vz5.j(new vz5.l(file, vz5.m.f441801e));
        while (true) {
            boolean z17 = true;
            while (jVar.hasNext()) {
    ...
    public static final vz5.d e(vz5.d dVar) {
        java.io.File file = dVar.f441782a;
        java.util.List<java.io.File> list = dVar.f441783b;
        java.util.ArrayList arrayList = new java.util.ArrayList(list.size());
        for (java.io.File file2 : list) {
            java.lang.String name = file2.getName();
            if (!kotlin.jvm.internal.o.b(name, ".")) {
                if (!kotlin.jvm.internal.o.b(name, "..")) {
                    arrayList.add(file2);
                } else if (arrayList.isEmpty() || kotlin.jvm.internal.o.b(((java.io.File) kz5.n0.i0(arrayList)).getName(), "..")) {
                    arrayList.add(file2);
                } else {
    ...
    public static final java.io.File f(java.io.File file, java.lang.String relative) {
        java.io.File file2;
        kotlin.jvm.internal.o.g(file, "<this>");
        kotlin.jvm.internal.o.g(relative, "relative");
        ...
        kotlin.jvm.internal.o.f(file4, "toString(...)");
    ...
    */
    public static final java.lang.String g(java.io.File r18, java.io.File r19) {
        /*
            ...
            vz5.d r3 = e(r3)
            java.io.File r4 = r2.f441782a
            java.io.File r5 = r3.f441782a
            boolean r4 = kotlin.jvm.internal.o.b(r4, r5)
            if (r4 != 0) goto L29
            goto L68
        L29:
            java.util.List r3 = r3.f441783b
            int r4 = r3.size()
            java.util.List r2 = r2.f441783b
            int r5 = r2.size()
