...
public class u0 implements dg.c {
    ...
    public final /* synthetic */ bg.f f19838a;
    ...
    public void a(java.lang.String str, int i17, int i18) {
        bg.f fVar = this.f19838a;
        com.tencent.mars.xlog.Log.w(fVar.A(), "send video error event, what:%d, extra:%d", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
        if (fVar.U()) {
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.SameLayer.AppBrandVideoEventHandler", "OnXWebVideoError fail", e17);
            }
            b0Var.c(true);
            tf.m0 m0Var = b0Var.f261850i;
            if (m0Var != null) {
                m0Var.a();
            }
        }
        ...
        if (bVar != null) {
            ...
            if (eVar != null && b18 != null) {
                ...
                com.tencent.mars.xlog.Log.i("MicroMsg.SameLayer.AppBrandVideoProfileReport", "onMediaPlayerVideoError, what:%s, extra:%s, msg:%s", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18), str);
                if (oe1.x1.c(eVar)) {
        ...
        if (fVar.f19769o != null) {
            if (!oe1.x1.d(fVar.f19764h)) {
                ((fg1.q0) fVar.f19769o).a(928L, 42L, 1L, false);
            } else if (i17 == -1024) {
                ((fg1.q0) fVar.f19769o).a(928L, -i18, 1L, false);
                ((fg1.q0) fVar.f19769o).a(928L, 0L, 1L, false);
            } else {
                ((fg1.q0) fVar.f19769o).a(928L, 41L, 1L, false);
            }
        }
        fVar.W();
    }
