    ...
    */
    ...
    public void D1(java.lang.Object... objArr) {
        if (objArr == null || objArr.length < 1) {
            com.tencent.mars.xlog.Log.e("MicroMsg.HuaweiBiometricPayManagerImpl", "hy: param incorrect");
            return;
        }
        java.lang.String b17 = mz2.n0.b();
        if (mz2.n0.c()) {
            com.tencent.mm.plugin.fingerprint.FingerPrintAuth.clearData(mz2.n0.a(com.tencent.mm.sdk.platformtools.x2.f193071a), b17, ((java.lang.Integer) objArr[0]).intValue());
        } else {
            com.tencent.mars.xlog.Log.e("MicroMsg.HuaweiBiometricPayManagerImpl", "device is not support FingerPrintAuth");
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "clear fingerprint data id:" + b17 + " clear_rsa_key_level:" + objArr[0]);
    }
    ...
    public boolean Je() {
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "canUse: %s, %s", java.lang.Boolean.valueOf(mz2.n0.d()), java.lang.Boolean.valueOf(mz2.n0.f333160a));
        return wh() && mz2.n0.d() && mz2.n0.f333160a;
    }

    @Override // nz2.o
    public boolean Lf(android.content.Context context) {
        boolean Je = Je();
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "isSupportFingerprint:%s", java.lang.Boolean.valueOf(Je));
        return Je;
    }
    ...
    public void g9(android.content.Context context, nz2.f fVar, nz2.b bVar) {
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "request fingerprint authorize: %s", fVar.f341555c);
        if (this.f341567d == null) {
            c();
        }
        com.tencent.mm.sdk.platformtools.u3.i(new nz2.m(this, bVar, fVar), 300L);
    }

    @Override // nz2.o
    public boolean h1() {
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "isSupportFaceId");
        return false;
    }
    ...
    public boolean ja() {
        ...
        try {
            iArr = ((mb.h) eVar.f325280a).e(eVar.f325281b);
        } catch (android.os.RemoteException unused) {
            iArr = new int[0];
        }
        if (iArr == null || iArr.length <= 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.HuaweiBiometricPayManagerImpl", "ids is null");
        }
        try {
            this.f341567d.b();
        } catch (java.lang.Exception unused2) {
        ...
        ((ku5.t0) ku5.t0.f312615d).g(new nz2.j(this, z17));
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "isDeviceHasFingerPrint:%s", java.lang.Boolean.valueOf(z17));
        return z17;
    }
    ...
    @Override // nz2.o
    public void prepare() {
        if (((pz2.a) gm0.j1.s(pz2.a.class)).type() != 1) {
            com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "set soter manager");
            mz2.l0 l0Var = new mz2.l0();
            l0Var.c(this);
            gm0.j1.q(pz2.a.class, l0Var);
        }
        if (wo.w0.q()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "not support 64bit");
        } else {
    ...
    public boolean wh() {
        int[] iArr;
        boolean z17;
        boolean z18 = wo.v1.f447826f.f447867a == 1;
        boolean z19 = wo.v1.f447828h.f447810a;
        mb.j a17 = mb.e.a();
        if (a17 == null) {
            iArr = new int[0];
        } else {
            try {
                ...
                try {
                    ...
                    hVar.f325286d.transact(6, obtain, obtain2, 0);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "is support: %s, %s, %s", java.lang.Boolean.valueOf(z18), java.lang.Boolean.valueOf(a18), java.lang.Boolean.valueOf(z19));
        return z18 && a18 && !z19;
    }

    @Override // nz2.o
    public void z9(android.content.Context context, nz2.f fVar, nz2.d dVar) {
        com.tencent.mars.xlog.Log.i("MicroMsg.HuaweiBiometricPayManagerImpl", "request fingerprint authorize for pay");
        if (dVar == null) {
            return;
        }
