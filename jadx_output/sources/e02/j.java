...
public abstract class j {
    public static void a(com.tencent.mm.vfs.r6 r6Var, java.lang.String str) {
        e02.a aVar;
        ...
        if (r6Var.m() && r6Var.A()) {
            try {
                ...
                try {
                    ...
                    aVar = new e02.a();
                    aVar.f245845a = true;
                    aVar.f245846b = r6Var.C();
                    aVar.f245847c = a17;
                    aVar.f245848d = create;
                    aVar.f245849e = e17;
                    aVar.a();
                    com.tencent.mars.xlog.Log.i("MicroMsg.Channel.V2SchemeUtil", "baseApk : " + r6Var.o() + "\nApkSectionInfo = " + aVar);
                    B.close();
        ...
        try {
            ...
            for (java.lang.Object obj : properties.keySet()) {
                str2 = str2 + obj + "=" + properties.getProperty((java.lang.String) obj) + com.tencent.midas.comm.log.util.APLogFileUtil.SEPARATOR_LINE;
            }
            byte[] bytes = str2.getBytes(com.tencent.mapsdk.internal.rv.f51270c);
            int length = bytes.length;
            byteArrayOutputStream.write(new byte[]{(byte) (length & 255), (byte) ((65280 & length) >> 8)});
            byteArrayOutputStream.write(bytes);
        } catch (java.io.IOException e18) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Channel.GameComment", "encode, error: %s", e18.getMessage());
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.Channel.IdValueWriter", "addIdValueByteBufferMap , new IdValueMap = " + linkedHashMap);
        java.util.Map a18 = e02.n.a((java.nio.ByteBuffer) aVar.f245847c.first);
        if (!a18.containsKey(1896449818)) {
            throw new e02.d("No APK V2 Signature Scheme block in APK Signing Block");
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.Channel.IdValueWriter", "addIdValueByteBufferMap , existed IdValueMap = " + a18);
        a18.putAll(linkedHashMap);
        com.tencent.mars.xlog.Log.i("MicroMsg.Channel.IdValueWriter", "addIdValueByteBufferMap , final IdValueMap = " + a18);
        if (a18.isEmpty()) {
        ...
        allocate2.flip();
        com.tencent.mars.xlog.Log.i("MicroMsg.Channel.IdValueWriter", "addIdValueByteBufferMap , oldApkSigningBlock size = " + ((java.nio.ByteBuffer) aVar.f245847c.first).remaining() + " , newApkSigningBlock size = " + allocate2.remaining());
        android.util.Pair pair = aVar.f245848d;
        java.nio.ByteBuffer byteBuffer3 = (java.nio.ByteBuffer) pair.first;
        java.nio.ByteBuffer byteBuffer4 = (java.nio.ByteBuffer) aVar.f245849e.first;
        long longValue2 = ((java.lang.Long) pair.second).longValue();
        long remaining = allocate2.remaining() - ((java.nio.ByteBuffer) aVar.f245847c.first).remaining();
        e02.p.d(byteBuffer4, longValue2 + remaining);
        long j18 = aVar.f245846b + remaining;
        try {
            java.io.RandomAccessFile B2 = com.tencent.mm.vfs.w6.B(r6Var.u(), true);
            try {
                if (!aVar.f245845a) {
                    throw null;
                }
                B2.seek(((java.lang.Long) aVar.f245847c.second).longValue());
                ...
                B2.setLength(j18);
                com.tencent.mars.xlog.Log.i("MicroMsg.Channel.IdValueWriter", "addIdValueByteBufferMap , after add channel , new apk is " + r6Var.o() + " , length = " + r6Var.C());
