...
public abstract class e {
    ...
    public static long d(java.nio.ByteBuffer byteBuffer, long j17) {
        e02.p.a(byteBuffer);
        long j18 = byteBuffer.getInt(byteBuffer.position() + 16) & io.flutter.embedding.android.KeyboardMap.kValueMask;
        if (j18 < j17) {
            e02.p.a(byteBuffer);
            if ((io.flutter.embedding.android.KeyboardMap.kValueMask & byteBuffer.getInt(byteBuffer.position() + 12)) + j18 == j17) {
                return j18;
            }
