...
public class c implements java.lang.Runnable {
    ...
    public final /* synthetic */ int f352953d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f352954e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ pa1.e f352955f;
    ...
    */
    public void run() {
        /*
            ...
            pa1.e r1 = r8.f352955f
            r2 = 0
            boolean r3 = r1.d()     // Catch: java.lang.Throwable -> L11
            if (r3 != 0) goto L14
            java.lang.String r1 = "hy: game extension is null. stop"
            com.tencent.mars.xlog.Log.w(r0, r1)     // Catch: java.lang.Throwable -> L11
            return
        L11:
            r1 = move-exception
            goto Lbd
        L14:
            r45.vd7 r3 = r1.f352956a     // Catch: java.lang.Throwable -> L11
            if (r3 == 0) goto Lb7
            boolean r3 = r3.f388138d     // Catch: java.lang.Throwable -> L11
            if (r3 != 0) goto L1e
            goto Lb7
        L1e:
            java.lang.ref.WeakReference r3 = r1.f352957b     // Catch: java.lang.Throwable -> L11
            java.lang.Object r4 = r3.get()     // Catch: java.lang.Throwable -> L11
            if (r4 == 0) goto L51
            r45.vd7 r4 = r1.f352956a     // Catch: java.lang.Throwable -> L11
            if (r4 == 0) goto L51
            int r5 = r4.f388141g     // Catch: java.lang.Throwable -> L11
            if (r5 == 0) goto L51
            java.lang.Object r3 = r3.get()     // Catch: java.lang.Throwable -> L11
            com.tencent.mm.plugin.appbrand.AppBrandRuntime r3 = (com.tencent.mm.plugin.appbrand.AppBrandRuntime) r3     // Catch: java.lang.Throwable -> L11
            android.app.Activity r3 = r3.r0()     // Catch: java.lang.Throwable -> L11
            int r3 = com.tencent.mars.comm.NetStatusUtil.getNetType(r3)     // Catch: java.lang.Throwable -> L11
            int r4 = r4.f388141g     // Catch: java.lang.Throwable -> L11
            r5 = 3
            r6 = 1
            if (r4 == r6) goto L44
            if (r4 != r5) goto L47
        ...
        L52:
            ...
            return
        L5a:
            int r3 = r8.f352953d     // Catch: java.lang.Throwable -> L11
            if (r3 > 0) goto L88
        ...
        L75:
            ce.g r3 = r1.c()     // Catch: java.lang.Throwable -> L11
            ce.o r3 = (ce.o) r3     // Catch: java.lang.Throwable -> L11
            com.tencent.magicbrush.ui.MagicBrushView r3 = r3.f40686g     // Catch: java.lang.Throwable -> L11
            com.tencent.magicbrush.MagicBrush r3 = r3.getMagicBrush()     // Catch: java.lang.Throwable -> L11
            yg.b r3 = r3.f48591o     // Catch: java.lang.Throwable -> L11
        ...
        L88:
            ...
            com.tencent.mm.plugin.appbrand.page.n7 r3 = r1.b()     // Catch: java.lang.Throwable -> L11
            of1.w1 r3 = r3.s3()     // Catch: java.lang.Throwable -> L11
            com.tencent.mm.ui.widget.MMWebView r3 = r3.getWebView()     // Catch: java.lang.Throwable -> L11
            android.graphics.Bitmap r3 = r3.getBitmap()     // Catch: java.lang.Throwable -> L11
            goto La9
        La3:
            java.lang.String r3 = "hy: current html webview is null!!"
            com.tencent.mars.xlog.Log.e(r0, r3)     // Catch: java.lang.Throwable -> L11
            r3 = 0
        La9:
            if (r3 == 0) goto Lb1
            java.lang.String r4 = r8.f352954e     // Catch: java.lang.Throwable -> L11
            pa1.e.a(r1, r4, r3)     // Catch: java.lang.Throwable -> L11
            goto Lc4
        Lb1:
            java.lang.String r1 = "hy: current screen capture is null!!"
            com.tencent.mars.xlog.Log.e(r0, r1)     // Catch: java.lang.Throwable -> L11
            goto Lc4
        Lb7:
