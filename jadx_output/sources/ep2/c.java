...
public final class c implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.model.BaseFinderFeed f255699d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ in5.s0 f255700e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ep2.e f255701f;

    public c(com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed, in5.s0 s0Var, ep2.e eVar) {
        this.f255699d = baseFinderFeed;
        this.f255700e = s0Var;
        this.f255701f = eVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        in5.s0 s0Var = this.f255700e;
        long adapterPosition = s0Var.getAdapterPosition();
        com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed = this.f255699d;
        ...
        kotlin.jvm.internal.o.f(context, "getContext(...)");
        this.f255701f.f255708h.invoke(baseFinderFeed.getFeedObject(), baseFinderFeed.getFeedObject().getUserName());
        yj0.a.h(this, "com/tencent/mm/plugin/finder/nearby/live/convert/NearbyFinderRelatedLivingConvert$bindUserInfo$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
