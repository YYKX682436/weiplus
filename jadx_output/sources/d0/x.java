...
public final class x implements s1.t0 {
    ...
    public final /* synthetic */ boolean f225235a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ z0.d f225236b;
    ...
    public final s1.u0 d(s1.x0 MeasurePolicy, java.util.List measurables, long j17) {
        ...
        if (measurables.isEmpty()) {
            return s1.v0.b(MeasurePolicy, p2.c.j(j17), p2.c.i(j17), null, d0.u.f225212d, 4, null);
        }
        long a17 = this.f225235a ? j17 : p2.c.a(j17, 0, 0, 0, 0, 10, null);
        if (measurables.size() == 1) {
            s1.r0 r0Var = (s1.r0) measurables.get(0);
            java.lang.Object g17 = r0Var.g();
            d0.q qVar = g17 instanceof d0.q ? (d0.q) g17 : null;
            if (qVar != null ? qVar.f225192e : false) {
                j18 = p2.c.j(j17);
                int i18 = p2.c.i(j17);
                ...
                int max = java.lang.Math.max(p2.c.j(j17), m18.f402050d);
                i17 = java.lang.Math.max(p2.c.i(j17), m18.f402051e);
                m17 = m18;
                j18 = max;
            }
            return s1.v0.b(MeasurePolicy, j18, i17, null, new d0.v(m17, r0Var, MeasurePolicy, j18, i17, this.f225236b), 4, null);
        }
        s1.o1[] o1VarArr = new s1.o1[measurables.size()];
        kotlin.jvm.internal.f0 f0Var = new kotlin.jvm.internal.f0();
        f0Var.f310116d = p2.c.j(j17);
        kotlin.jvm.internal.f0 f0Var2 = new kotlin.jvm.internal.f0();
        f0Var2.f310116d = p2.c.i(j17);
        ...
        for (int i27 = 0; i27 < size; i27++) {
            ...
            if (qVar2 != null ? qVar2.f225192e : false) {
                z17 = true;
            } else {
                s1.o1 m19 = r0Var2.m(a17);
                o1VarArr[i27] = m19;
                f0Var.f310116d = java.lang.Math.max(f0Var.f310116d, m19.f402050d);
                f0Var2.f310116d = java.lang.Math.max(f0Var2.f310116d, m19.f402051e);
            }
        }
        if (z17) {
            int i28 = f0Var.f310116d;
            int i29 = i28 != Integer.MAX_VALUE ? i28 : 0;
            int i37 = f0Var2.f310116d;
            ...
            for (int i38 = 0; i38 < size2; i38++) {
                ...
                if (qVar3 != null ? qVar3.f225192e : false) {
                    o1VarArr[i38] = r0Var3.m(a18);
                }
            }
        }
        return s1.v0.b(MeasurePolicy, f0Var.f310116d, f0Var2.f310116d, null, new d0.w(o1VarArr, measurables, MeasurePolicy, f0Var, f0Var2, this.f225236b), 4, null);
    }
