...
public final class t implements s1.t0 {

    /* renamed from: a, reason: collision with root package name */
    public static final d0.t f225207a = new d0.t();
    ...
    @Override // s1.t0
    public final s1.u0 d(s1.x0 MeasurePolicy, java.util.List list, long j17) {
        kotlin.jvm.internal.o.g(MeasurePolicy, "$this$MeasurePolicy");
        kotlin.jvm.internal.o.g(list, "<anonymous parameter 0>");
        return s1.v0.b(MeasurePolicy, p2.c.j(j17), p2.c.i(j17), null, d0.s.f225203d, 4, null);
    }
