    ...
    public static final int a(java.util.List list, yz5.p pVar, yz5.p pVar2, int i17, int i18, d0.t1 t1Var, d0.t1 t1Var2) {
        if (t1Var == t1Var2) {
            ...
            for (int i28 = 0; i28 < size; i28++) {
                ...
                float c17 = c(b(tVar));
                int intValue = ((java.lang.Number) pVar.invoke(tVar, java.lang.Integer.valueOf(i17))).intValue();
                if (c17 == 0.0f) {
                    i27 += intValue;
                } else if (c17 > 0.0f) {
                    f17 += c17;
        ...
        for (int i37 = 0; i37 < size2; i37++) {
            ...
            float c18 = c(b(tVar2));
            if (c18 == 0.0f) {
                int min2 = java.lang.Math.min(((java.lang.Number) pVar2.invoke(tVar2, Integer.MAX_VALUE)).intValue(), i17 - min);
                min += min2;
                i29 = java.lang.Math.max(i29, ((java.lang.Number) pVar.invoke(tVar2, java.lang.Integer.valueOf(min2))).intValue());
            } else if (c18 > 0.0f) {
                f18 += c18;
            }
        }
        ...
        for (int i38 = 0; i38 < size3; i38++) {
            ...
            float c19 = c(b(tVar3));
            if (c19 > 0.0f) {
                i29 = java.lang.Math.max(i29, ((java.lang.Number) pVar.invoke(tVar3, java.lang.Integer.valueOf(b17 != Integer.MAX_VALUE ? a06.d.b(b17 * c19) : Integer.MAX_VALUE))).intValue());
            }
        }
        return i29;
    }
