...
public final class k implements android.view.GestureDetector.OnGestureListener {
    ...
    public final /* synthetic */ bp2.m f23070d;
    ...
    public boolean onDown(android.view.MotionEvent e17) {
        ...
        com.tencent.mars.xlog.Log.i("FinderLivePageScrollGuideHelper", "onDown");
        bp2.m mVar = this.f23070d;
        if (bp2.m.c(mVar, e17)) {
            return false;
        }
        if (bp2.m.a(mVar, e17)) {
    ...
    public void onLongPress(android.view.MotionEvent e17) {
        ...
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/finder/nearby/guide/FinderLivePageScrollGuideHelper$gestureDetectorListener$1", "android/view/GestureDetector$OnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V", this, array);
        kotlin.jvm.internal.o.g(e17, "e");
        com.tencent.mars.xlog.Log.i("FinderLivePageScrollGuideHelper", if1.m.NAME);
        yj0.a.h(this, "com/tencent/mm/plugin/finder/nearby/guide/FinderLivePageScrollGuideHelper$gestureDetectorListener$1", "android/view/GestureDetector$OnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V");
    }
    ...
    public boolean onSingleTapUp(android.view.MotionEvent e17) {
        ...
        kotlin.jvm.internal.o.g(e17, "e");
        com.tencent.mars.xlog.Log.i("FinderLivePageScrollGuideHelper", "onSingleTapUp");
        bp2.m mVar = this.f23070d;
        if (bp2.m.c(mVar, e17)) {
