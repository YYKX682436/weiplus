...
public final class s1 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.view.View f394887d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ rf2.c2 f394888e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f394889f;
    ...
    public final void onClick(android.view.View view) {
        ...
        android.view.View view2 = this.f394887d;
        ...
        rf2.c2 c2Var = this.f394888e;
        c2Var.f394687i = null;
        df2.un unVar = c2Var.f394680b;
        java.lang.String str = this.f394889f;
        if (str == null) {
            str = "";
        }
        unVar.getClass();
        com.tencent.mars.xlog.Log.i(unVar.f231539m, "backToLottery ".concat(str));
        android.view.View view3 = unVar.f231540n;
        if (view3 != null) {
            if (unVar.f231542p == null) {
                unVar.f231542p = new rf2.v0(view3, unVar);
            }
            kotlinx.coroutines.y0 y0Var = unVar.f231544r;
            if (y0Var != null) {
                kotlinx.coroutines.l.d(y0Var, null, null, new df2.mn(unVar, str, null), 3, null);
            }
        }
