...
public abstract class l {
    ...
    public static final java.util.regex.Pattern f352853a = java.util.regex.Pattern.compile("^NOTE(( |\t).*)?$");

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.regex.Pattern f352854b = java.util.regex.Pattern.compile("^\ufeff?WEBVTT(( |\t).*)?$");
    ...
    public static void c(t9.p pVar) {
        ...
        if (d17 == null || !f352854b.matcher(d17).matches()) {
