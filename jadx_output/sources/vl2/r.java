...
public final class r extends qz5.l implements yz5.p {
    ...
    public final /* synthetic */ vl2.h f437867e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(vl2.h hVar, kotlin.coroutines.Continuation continuation) {
    ...
    public final kotlin.coroutines.Continuation create(java.lang.Object obj, kotlin.coroutines.Continuation continuation) {
        return new vl2.r(this.f437867e, continuation);
    }

    @Override // yz5.p
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2) {
        return ((vl2.r) create((kotlinx.coroutines.y0) obj, (kotlin.coroutines.Continuation) obj2)).invokeSuspend(jz5.f0.f302826a);
    }

    @Override // qz5.a
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        pz5.a aVar = pz5.a.f359186d;
        int i17 = this.f437866d;
        boolean z17 = true;
        vl2.h hVar = this.f437867e;
        if (i17 == 0) {
            kotlin.ResultKt.throwOnFailure(obj);
            if (hVar == vl2.h.f437819e) {
                vl2.s sVar = vl2.s.f437868a;
                com.tencent.mars.xlog.Log.i("LiveUdrResourceLoader", hVar.f437840d + " loadRfxPagFile failed, resourceName is Unknown");
                return null;
            }
