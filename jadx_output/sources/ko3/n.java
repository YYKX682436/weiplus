...
public abstract class n extends android.os.Binder {
    ...
    public void dumpAsync(java.io.FileDescriptor fileDescriptor, java.lang.String[] strArr) {
        try {
            this.f309990d.dumpAsync(fileDescriptor, strArr);
        } catch (android.os.RemoteException unused) {
        }
    }
    ...
    public java.lang.String getInterfaceDescriptor() {
        try {
            return this.f309990d.getInterfaceDescriptor();
        } catch (android.os.RemoteException unused) {
            return "<failure>";
        }
    }
    ...
    public boolean onTransact(int i17, android.os.Parcel parcel, android.os.Parcel parcel2, int i18) {
        android.os.IBinder iBinder = this.f309990d;
        try {
    ...
    public boolean pingBinder() {
        return this.f309990d.pingBinder();
    }
    ...
    public boolean unlinkToDeath(android.os.IBinder.DeathRecipient deathRecipient, int i17) {
        return this.f309990d.unlinkToDeath(deathRecipient, i17);
    }
}
