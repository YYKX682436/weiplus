...
public abstract class o implements java.lang.reflect.InvocationHandler {
    ...
    public final android.os.IInterface f309992a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ ko3.u f309993b;

    public o(ko3.u uVar, android.os.IInterface iInterface) {
        this.f309993b = uVar;
        this.f309992a = iInterface;
    }

    public android.os.IBinder a() {
        return this.f309992a.asBinder();
    }

    @Override // java.lang.reflect.InvocationHandler
    public java.lang.Object invoke(java.lang.Object obj, java.lang.reflect.Method method, java.lang.Object[] objArr) {
        ko3.u uVar = this.f309993b;
        try {
            return "asBinder".equals(method.getName()) ? a() : method.invoke(this.f309992a, objArr);
