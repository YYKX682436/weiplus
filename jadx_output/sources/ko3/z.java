...
public class z extends android.hardware.camera2.CameraManager.AvailabilityCallback {
    ...
    public final /* synthetic */ ko3.a0 f310031a;
    ...
    public void onCameraAvailable(java.lang.String str) {
        this.f310031a.f309934d.d(str, true);
        ko3.a0.f309932f.postDelayed(new ko3.x(this), 2000L);
    }

    @Override // android.hardware.camera2.CameraManager.AvailabilityCallback
    public void onCameraUnavailable(java.lang.String str) {
        this.f310031a.f309934d.d(str, false);
        ko3.a0.f309932f.postDelayed(new ko3.y(this), 2000L);
    }
}
