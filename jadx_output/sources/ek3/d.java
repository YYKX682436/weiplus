...
public final class d {
    ...
    public final int f253587b;

    /* renamed from: d, reason: collision with root package name */
    public float[] f253589d;

    /* renamed from: e, reason: collision with root package name */
    public float[] f253590e;

    /* renamed from: f, reason: collision with root package name */
    public float[] f253591f;

    /* renamed from: g, reason: collision with root package name */
    public float[] f253592g;
    ...
    public android.view.VelocityTracker f253597l;

    /* renamed from: m, reason: collision with root package name */
    public float f253598m;

    /* renamed from: n, reason: collision with root package name */
    public float f253599n;

    /* renamed from: o, reason: collision with root package name */
    public final int f253600o;

    /* renamed from: p, reason: collision with root package name */
    public int f253601p;

    /* renamed from: q, reason: collision with root package name */
    public final android.widget.OverScroller f253602q;

    /* renamed from: r, reason: collision with root package name */
    public final ek3.b f253603r;

    /* renamed from: s, reason: collision with root package name */
    public android.view.View f253604s;

    /* renamed from: t, reason: collision with root package name */
    public boolean f253605t;

    /* renamed from: u, reason: collision with root package name */
    public final android.view.ViewGroup f253606u;

    /* renamed from: c, reason: collision with root package name */
    public int f253588c = -1;

    /* renamed from: v, reason: collision with root package name */
    public android.graphics.Rect f253607v = new android.graphics.Rect();

    /* renamed from: w, reason: collision with root package name */
    public final java.lang.Runnable f253608w = new ek3.c(this);

    public d(android.content.Context context, android.view.ViewGroup viewGroup, ek3.b bVar, android.view.animation.Interpolator interpolator, kotlin.jvm.internal.i iVar) {
        if (viewGroup == null) {
        ...
        this.f253606u = viewGroup;
        this.f253603r = bVar;
        android.view.ViewConfiguration viewConfiguration = android.view.ViewConfiguration.get(context);
        this.f253600o = (int) ((20 * context.getResources().getDisplayMetrics().density) + 0.5f);
        this.f253587b = viewConfiguration.getScaledTouchSlop();
        this.f253598m = viewConfiguration.getScaledMaximumFlingVelocity();
        this.f253599n = viewConfiguration.getScaledMinimumFlingVelocity();
        this.f253602q = new android.widget.OverScroller(context, interpolator);
    }

    public final void a() {
        b();
        if (this.f253586a == 2) {
            android.widget.OverScroller overScroller = this.f253602q;
            int currX = overScroller.getCurrX();
            int currY = overScroller.getCurrY();
            overScroller.abortAnimation();
            int currX2 = overScroller.getCurrX();
            int currY2 = overScroller.getCurrY();
            this.f253603r.e(this.f253604s, currX2, currY2, currX2 - currX, currY2 - currY);
        }
        o(0);
    }
    ...
    public final void b() {
        this.f253588c = -1;
        float[] fArr = this.f253589d;
        if (fArr != null) {
            java.util.Arrays.fill(fArr, 0.0f);
            java.util.Arrays.fill(this.f253590e, 0.0f);
            java.util.Arrays.fill(this.f253591f, 0.0f);
            java.util.Arrays.fill(this.f253592g, 0.0f);
            java.util.Arrays.fill(this.f253593h, 0);
            java.util.Arrays.fill(this.f253594i, 0);
            java.util.Arrays.fill(this.f253595j, 0);
            this.f253596k = 0;
        }
        android.view.VelocityTracker velocityTracker = this.f253597l;
    ...
    public final boolean c(float f17, float f18, int i17, int i18) {
        ...
        int[] iArr = this.f253593h;
        if (((iArr != null ? iArr[i17] : 0) & i18) != i18 || (this.f253601p & i18) == 0) {
            return false;
        }
        int[] iArr2 = this.f253595j;
        if (((iArr2 != null ? iArr2[i17] : 0) & i18) == i18) {
            return false;
        }
        int[] iArr3 = this.f253594i;
        if (((iArr3 != null ? iArr3[i17] : 0) & i18) == i18) {
            return false;
        }
        int i19 = this.f253587b;
        if (abs <= i19 && abs2 <= i19) {
            return false;
        }
        if (abs < abs2 * 0.5f) {
            this.f253603r.getClass();
        }
        int[] iArr4 = this.f253594i;
        return ((iArr4 != null ? iArr4[i17] : 0) & i18) == 0 && abs > ((float) i19);
    }

    public final boolean d(int i17, int i18) {
        if (!(((this.f253596k & 1) << i18) != 0)) {
            return false;
        }
        boolean z17 = (i17 & 1) == 1;
        boolean z18 = (i17 & 2) == 2;
        boolean z19 = (i17 & 8) == 8;
        boolean z27 = (i17 & 4) == 4;
        float[] fArr = this.f253591f;
        float[] fArr2 = this.f253592g;
        float[] fArr3 = this.f253589d;
        float[] fArr4 = this.f253590e;
    ...
    public final boolean e(android.view.View view, float f17, float f18) {
        ...
        ek3.b bVar = this.f253603r;
        boolean z17 = bVar.b(view) > 0;
        bVar.getClass();
        return z17 && java.lang.Math.abs(f17) > ((float) this.f253587b);
    }
    ...
    public final void f(int i17) {
        ...
        if (fArr != null) {
            ...
            float[] fArr2 = this.f253590e;
            if (fArr2 != null) {
                fArr2[i17] = 0.0f;
            }
            float[] fArr3 = this.f253591f;
            if (fArr3 != null) {
                fArr3[i17] = 0.0f;
            }
            float[] fArr4 = this.f253592g;
            if (fArr4 != null) {
                fArr4[i17] = 0.0f;
            }
            int[] iArr = this.f253593h;
            ...
            int[] iArr2 = this.f253594i;
            if (iArr2 != null) {
                iArr2[i17] = 0;
            }
            int[] iArr3 = this.f253595j;
            if (iArr3 != null) {
                iArr3[i17] = 0;
            }
            this.f253596k = (~(1 << i17)) & this.f253596k;
        }
    }
    ...
    public final int g(int i17, int i18, int i19) {
        ...
        float width = this.f253606u.getWidth() / 2;
        ...
        return java.lang.Math.min(abs > 0 ? java.lang.Math.round(1000 * java.lang.Math.abs(sin / abs)) * 4 : (int) (((java.lang.Math.abs(i17) / i19) + 1) * 256), com.tencent.thumbplayer.api.TPOptionalID.OPTION_ID_BEFORE_INT_AUDIO_STREAM_TYPE);
    }

    public final android.view.View h(int i17, int i18) {
        android.view.ViewGroup viewGroup = this.f253606u;
    ...
    public final boolean i(int i17, int i18, int i19, int i27, long j17, boolean z17) {
        ...
        float f19;
        float f27;
        android.view.View view = this.f253604s;
        int left = view != null ? view.getLeft() : 0;
        android.view.View view2 = this.f253604s;
        ...
        long j18 = 0;
        if (j17 == 0 && !z17) {
            android.view.View view3 = this.f253604s;
            int i37 = (int) this.f253599n;
            int i38 = (int) this.f253598m;
            int abs = java.lang.Math.abs(i19);
            int i39 = abs < i37 ? 0 : abs > i38 ? i19 > 0 ? i38 : -i38 : i19;
            int i47 = (int) this.f253599n;
            int i48 = (int) this.f253598m;
            ...
            j18 = (int) ((g(i28, i39, this.f253603r.b(view3)) * f28) + (g(i29, i49, 0) * (f27 / f19)));
        } else if (!z17) {
            j18 = j17;
        }
    ...
    public final void j(android.view.MotionEvent ev6) {
        ...
        if (this.f253597l == null) {
            this.f253597l = android.view.VelocityTracker.obtain();
        }
        android.view.VelocityTracker velocityTracker = this.f253597l;
        if (velocityTracker != null) {
        ...
        if (actionMasked == 0) {
            ...
            if (valueOf != null) {
                valueOf.intValue();
                if ((valueOf.intValue() & this.f253601p) != 0) {
                    valueOf.intValue();
                    bVar.getClass();
                    return;
                }
        ...
        if (actionMasked == 1) {
            if (this.f253586a == 1) {
                ...
                float[] fArr2 = this.f253589d;
                float f17 = x18 - (fArr2 != null ? fArr2[this.f253588c] : 0.0f);
                float[] fArr3 = this.f253590e;
                k(f17, y18 - (fArr3 != null ? fArr3[this.f253588c] : 0.0f));
            }
            b();
            return;
        }
        if (actionMasked != 2) {
            if (actionMasked == 3) {
                if (this.f253586a == 1) {
                    float[] fArr4 = this.f253589d;
                    if (fArr4 == null) {
                        return;
                    }
                    int length2 = fArr4.length;
                    int i27 = this.f253588c;
                    if (length2 <= i27) {
                        return;
                    }
                    ...
                    float[] fArr5 = this.f253589d;
                    float f18 = x19 - (fArr5 != null ? fArr5[this.f253588c] : 0.0f);
                    float[] fArr6 = this.f253590e;
                    float f19 = fArr6 != null ? fArr6[this.f253588c] : 0.0f;
                    this.f253605t = true;
                    this.f253603r.f(this.f253604s, 0.0f, 0.0f, f18, y19 - f19);
                    this.f253605t = false;
                    if (this.f253586a == 1) {
                        o(0);
                    }
            ...
            if (actionMasked != 5) {
                ...
                if (this.f253586a == 1 && pointerId2 == this.f253588c) {
            ...
            if (this.f253586a == 0) {
                ...
                int[] iArr2 = this.f253593h;
                if (iArr2 == null || (iArr2[pointerId4] & this.f253601p) == 0) {
                    return;
                }
                bVar.getClass();
                return;
        ...
        float[] fArr12 = this.f253589d;
        if (fArr12 != null) {
            int length3 = fArr12.length;
            int i39 = this.f253588c;
            if (length3 <= i39) {
                return;
            }
            ...
            float[] fArr13 = this.f253591f;
            int i47 = (int) ((x29 - (fArr13 != null ? fArr13[this.f253588c] : 0.0f)) / 1.6666666f);
            float[] fArr14 = this.f253592g;
            int i48 = (int) ((y29 - (fArr14 != null ? fArr14[this.f253588c] : 0.0f)) / 1.6666666f);
            android.view.View view3 = this.f253604s;
            int left = (view3 != null ? view3.getLeft() : 0) + i47;
            android.view.View view4 = this.f253604s;
            int top = (view4 != null ? view4.getTop() : 0) + i48;
            android.view.View view5 = this.f253604s;
            int left2 = view5 != null ? view5.getLeft() : 0;
            android.view.View view6 = this.f253604s;
            int top2 = view6 != null ? view6.getTop() : 0;
            if (i47 != 0) {
                left = bVar.a(this.f253604s, left, i47);
                android.view.View view7 = this.f253604s;
                if (view7 != null) {
            ...
            if (i48 != 0) {
                bVar.getClass();
                android.view.View view8 = this.f253604s;
                if (view8 != null) {
            ...
            if (i47 != 0 || i48 != 0) {
                this.f253603r.e(this.f253604s, i49, i17, i49 - left2, i17 - top2);
            }
            float[] fArr15 = this.f253589d;
            float f29 = x29 - (fArr15 != null ? fArr15[this.f253588c] : 0.0f);
            float[] fArr16 = this.f253590e;
            this.f253603r.g(x29, y29, i47, i48, (int) f29, (int) (y29 - (fArr16 != null ? fArr16[this.f253588c] : 0.0f)));
            n(ev6);
        }
    }
    ...
    public final void k(float f17, float f18) {
        ...
        android.view.VelocityTracker velocityTracker = this.f253597l;
        if (velocityTracker != null) {
            velocityTracker.computeCurrentVelocity(1000, this.f253598m);
        }
        float xVelocity = this.f253597l.getXVelocity(this.f253588c);
        float f27 = this.f253599n;
        float f28 = this.f253598m;
        ...
        float yVelocity = this.f253597l.getYVelocity(this.f253588c);
        float f37 = this.f253599n;
        float f38 = this.f253598m;
        ...
        float f39 = f29;
        this.f253605t = true;
        this.f253603r.f(this.f253604s, f19, f39, f17, f18);
        this.f253605t = false;
        if (this.f253586a == 1) {
            o(0);
        }
    ...
    public final void m(float f17, float f18, int i17) {
        ...
        if (fArr == null || fArr.length <= i17) {
            ...
            float[] fArr6 = this.f253590e;
            float[] fArr7 = this.f253591f;
            float[] fArr8 = this.f253592g;
            ...
            int[] iArr4 = this.f253593h;
            int[] iArr5 = this.f253594i;
            int[] iArr6 = this.f253595j;
        ...
        float[] fArr11 = this.f253592g;
        if (fArr11 != null) {
            fArr11[i17] = f18;
        }
        float[] fArr12 = this.f253590e;
        if (fArr12 != null) {
            fArr12[i17] = f18;
        }
        int[] iArr7 = this.f253593h;
        if (iArr7 != null) {
            int i19 = (int) f17;
            int i27 = (int) f18;
            android.view.ViewGroup viewGroup = this.f253606u;
            int left = viewGroup.getLeft();
            int i28 = this.f253600o;
    ...
    public final boolean p(android.view.MotionEvent ev6) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (actionMasked == 5) {
                        ...
                        } else if (i19 == 2 && (h17 = h((int) x18, (int) y18)) == this.f253604s) {
                            q(h17, pointerId2);
                        }
            ...
            if (h19 == this.f253604s && this.f253586a == 2) {
                q(h19, pointerId3);
            }
            int[] iArr2 = this.f253593h;
            valueOf = iArr2 != null ? java.lang.Integer.valueOf(iArr2[pointerId3]) : null;
            if (valueOf != null && (valueOf.intValue() & this.f253601p) != 0) {
                bVar.getClass();
            }
        }
        return this.f253586a == 1;
    }

    public final boolean q(android.view.View view, int i17) {
        if (view == this.f253604s && this.f253588c == i17) {
            return true;
        }
        if (view != null) {
            ek3.b bVar = this.f253603r;
