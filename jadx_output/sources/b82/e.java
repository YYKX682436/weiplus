...
public class e extends l75.n0 implements o72.v4 {
    ...
    public final l75.k0 f18313d;

    /* renamed from: e, reason: collision with root package name */
    public boolean f18314e;

    static {
        l75.n0.getCreateSQLs(o72.a3.f343309x, "FavSearchInfo");
    }

    public e(l75.k0 k0Var) {
        super(k0Var, o72.a3.f343309x, "FavSearchInfo", null);
        this.f18313d = k0Var;
    }
    ...
    public dm.p3 F(long j17) {
        o72.a3 a3Var = null;
        android.database.Cursor f17 = this.f18313d.f("select * from FavSearchInfo where localId = " + j17, null, 2);
        if (f17 == null) {
            return null;
        }
        if (f17.moveToFirst()) {
    ...
    public java.util.List I7(java.util.List list, java.util.List list2, java.util.List list3) {
        ...
        if (!com.tencent.mm.sdk.platformtools.t8.L0(arrayList2) || !com.tencent.mm.sdk.platformtools.t8.L0(arrayList3)) {
        ...
        android.database.Cursor f17 = this.f18313d.f(str, null, 2);
        if (f17 != null) {
    ...
    public boolean J5(java.lang.String str) {
        ...
        android.database.Cursor f17 = this.f18313d.f("select count(localId) from FavSearchInfo where tagContent like '%" + str + "%'", null, 2);
    ...
    public /* bridge */ /* synthetic */ boolean Md(dm.p3 p3Var) {
        return super.insert(p3Var);
    }

    @Override // o72.v4
    public java.util.List V7() {
        android.database.Cursor E = this.f18313d.E("FavSearchInfo", new java.lang.String[]{dm.i4.COL_LOCALID}, "tagContent!=?", new java.lang.String[]{""}, null, null, null);
    ...
    public void m3(long j17) {
        this.f18313d.A("FavSearchInfo", "delete from FavSearchInfo where localId = " + j17);
    }

    @Override // o72.v4
    public /* bridge */ /* synthetic */ boolean q7(dm.p3 p3Var, java.lang.String[] strArr) {
        return super.update(p3Var, strArr);
    }
}
