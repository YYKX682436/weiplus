...
public final class q implements dn2.e {
    ...
    public android.view.View f241961a;

    /* renamed from: b, reason: collision with root package name */
    public android.widget.TextView f241962b;
    ...
    public android.view.View c(android.view.View rootView, dk2.zf liveMsg, cn2.p0 widget) {
        ...
        android.widget.TextView textView2 = this.f241962b;
        if (textView2 == null) {
        ...
        if (D != null && (D instanceof r45.bj1)) {
            java.lang.String str = obj + ' ' + ((r45.bj1) D).getString(1);
            android.widget.TextView textView3 = this.f241962b;
            if (textView3 == null) {
                kotlin.jvm.internal.o.o("bulletContentTv");
                throw null;
            }
            ...
            com.tencent.mars.xlog.Log.i("LiveFollowBulletItem", "show bullet: " + str);
        }
        return rootView;
    }
