...
public final class m {
    ...
    public static java.util.Map f288860d;

    /* renamed from: e, reason: collision with root package name */
    public static boolean f288861e;

    /* renamed from: g, reason: collision with root package name */
    public static final java.util.Set f288863g;

    /* renamed from: h, reason: collision with root package name */
    public static final java.util.Map f288864h;

    /* renamed from: a, reason: collision with root package name */
    public static final i55.m f288857a = new i55.m();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f288858b = new java.util.LinkedHashMap();

    /* renamed from: c, reason: collision with root package name */
    public static int f288859c = -1;

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.concurrent.ConcurrentHashMap f288862f = new java.util.concurrent.ConcurrentHashMap();

    static {
        f55.e eVar = f55.e.f259771e;
        f288863g = kz5.o1.c(3);
        f55.e eVar2 = f55.e.f259771e;
        f288864h = kz5.c1.k(new jz5.l(2, 32024), new jz5.l(3, 37181));
    }

    public final void a(long j17, int i17) {
        java.util.Map map = f288860d;
        if (map != null) {
            ...
            map.put("bottom_red_dot_list", i55.f.f288847a.a());
        }
    }
    ...
    public final void b(long j17, java.lang.String curPageName, int i17, java.util.Map map, int i18, int i19) {
        ...
        if (i27 != -1) {
            ...
            if (!f288861e) {
                if (com.tencent.mm.ui.bk.v0()) {
                    com.tencent.mars.xlog.Log.i("MicroMsg.PageInfoReport", "report supportMagicWindow  tab event curPageName " + curPageName + " report event = " + str);
                    return;
                }
                com.tencent.mars.xlog.Log.w("MicroMsg.PageInfoReport", "page not pause! " + i17 + ", " + curPageName);
                d(j17, f288859c);
            }
            com.tencent.mars.xlog.Log.i("MicroMsg.PageInfoReport", "report tab event curPageName " + curPageName + " report event = " + str);
            java.util.Map map3 = (java.util.Map) ((java.util.LinkedHashMap) f288858b).get(java.lang.Integer.valueOf(f288859c));
            if (map3 != null) {
                if (map != null) {
                    map3.putAll(map);
                }
                ...
                java.util.Set set = (java.util.Set) f288862f.get(java.lang.Integer.valueOf(f288859c));
                if (set != null) {
                    java.util.ArrayList arrayList = new java.util.ArrayList();
                    arrayList.addAll(set);
                    map3.put("show_preference_list", arrayList);
                }
                java.lang.Integer num = (java.lang.Integer) f288864h.get(java.lang.Integer.valueOf(f288859c));
                if (num != null) {
        ...
        ((cy1.a) ((dy1.r) i95.n0.c(dy1.r.class))).Ej("launcher_ui_pause", f288860d, 33666);
        f288860d = null;
        com.tencent.mars.xlog.Log.i("MicroMsg.PageInfoReport", "report launcher ui pause!");
    }

    public final void c(int i17, long j17, java.util.Map map) {
        java.lang.String str;
        java.lang.String a17;
        i55.d i18 = e55.m.f249681a.i(i17);
        if (i18 != null) {
            java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
            java.util.LinkedHashMap linkedHashMap2 = new java.util.LinkedHashMap();
            for (java.util.Map.Entry entry : ((java.util.LinkedHashMap) i18.f288841b).entrySet()) {
                g55.e eVar = (g55.e) entry.getValue();
                if (eVar.f268966e > 0 && eVar.f268964c == i18.f288842c && (a17 = e55.e.f249667a.a(eVar.f268962a)) != null) {
                    ...
                    int e17 = kz5.c0.e(list, 0, list.size(), new i55.c(java.lang.Long.valueOf(eVar.f268967f)));
                    if (e17 < 0) {
                        e17 = (-e17) - 1;
                    }
                    if (list.size() < 4) {
            ...
            jz5.l lVar = (jz5.l) ((java.util.LinkedHashMap) i55.s.f288882e).get(java.lang.Integer.valueOf(i17));
            if (lVar == null || (str = (java.lang.String) lVar.f302833d) == null) {
                str = "";
            }
    ...
    public final void d(long j17, int i17) {
        java.util.Map map = (java.util.Map) ((java.util.LinkedHashMap) f288858b).get(java.lang.Integer.valueOf(i17));
        if (map != null) {
            map.putAll(e55.e.f249667a.j());
            java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
            ...
            if (aiWeixinGpsInfoStruct != null) {
                gVar.p("last_gps_time", aiWeixinGpsInfoStruct.f55028e);
                gVar.h("longitude", aiWeixinGpsInfoStruct.f55030g);
                gVar.h("latitude", aiWeixinGpsInfoStruct.f55031h);
            }
            ...
            i55.m mVar = f288857a;
            if (!f288863g.contains(java.lang.Integer.valueOf(i17))) {
                map.put("bottom_red_dot_list", i55.f.f288847a.a());
            }
            f55.e eVar = f55.e.f259771e;
            if (i17 == 0 || i17 == 1) {
