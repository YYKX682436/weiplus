...
public final class u {
    ...
    public static final i55.u f288889a = new i55.u();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.List f288890b;

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.Set f288891c;

    /* renamed from: d, reason: collision with root package name */
    public static final jz5.g f288892d;
    ...
    static {
        ...
        f288891c = kz5.o1.c("album_dyna_photo_ui_title");
        e55.e eVar = e55.e.f249667a;
        java.util.List list = e55.e.f249670d;
        ((java.util.ArrayList) list).addAll(k17);
        ((java.util.ArrayList) list).addAll(k18);
        f288892d = jz5.h.b(i55.t.f288888d);
    }
    ...
    */
    public final boolean a(int r15, long r16, android.view.View r18, java.lang.String r19, java.lang.String r20) {
        /*
            r14 = this;
            e55.e r0 = e55.e.f249667a
            r1 = r15
            r2 = r19
            r3 = r20
            java.lang.String r0 = r0.k(r15, r2, r3)
            i55.u r2 = i55.u.f288889a
            ...
            r12 = 1
            if (r5 == 0) goto Lb3
            boolean r6 = kotlin.jvm.internal.o.b(r0, r5)
            java.util.Map r13 = r1.f288836i
            if (r6 == 0) goto L7e
            r6 = r13
            java.util.LinkedHashMap r6 = (java.util.LinkedHashMap) r6
    ...
    public final java.util.Map b() {
        return (java.util.Map) ((jz5.n) f288892d).getValue();
    }
    ...
    public final void c(int i17, long j17) {
        ...
        if (bVar != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.BaseRedDotExposureMonitorLogic", "on pause");
        }
    }
    ...
    public final void d(int i17, long j17, android.view.View view, java.lang.String str, java.lang.String str2, java.util.Map map, int i18) {
        java.lang.String reportKey = e55.e.f249667a.k(i17, str, str2);
        i55.b bVar = (i55.b) f288889a.b().get(java.lang.Integer.valueOf(i17));
        if (bVar != null) {
            kotlin.jvm.internal.o.g(view, "view");
            kotlin.jvm.internal.o.g(reportKey, "reportKey");
            int hashCode = view.hashCode();
            java.util.Map map2 = bVar.f288835h;
            if (map2.containsKey(java.lang.Integer.valueOf(hashCode))) {
                com.tencent.mars.xlog.Log.e("MicroMsg.BaseRedDotExposureMonitorLogic", "last red dot not Disappear err");
            } else {
                view.addOnLayoutChangeListener(bVar.f288838n);
            }
            map2.put(java.lang.Integer.valueOf(hashCode), reportKey);
            java.util.Map map3 = bVar.f288836i;
            ...
            if (jVar != null) {
                ...
                java.util.Map map4 = jVar.f269002a;
                ...
                if (map != null) {
                    jVar.f269009h.putAll(map);
                }
                if (!bVar.f288832e || jVar.f269007f) {
                    return;
                }
