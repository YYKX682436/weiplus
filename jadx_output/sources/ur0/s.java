...
public final class s extends sr0.f {
    ...
    public final android.hardware.camera2.CameraManager f430330t;

    /* renamed from: u, reason: collision with root package name */
    public int f430331u;

    /* renamed from: v, reason: collision with root package name */
    public android.hardware.camera2.CaptureRequest.Builder f430332v;

    /* renamed from: w, reason: collision with root package name */
    public android.hardware.camera2.CameraDevice f430333w;

    /* renamed from: x, reason: collision with root package name */
    public android.hardware.camera2.CameraCharacteristics f430334x;

    /* renamed from: y, reason: collision with root package name */
    public android.hardware.camera2.CameraCaptureSession f430335y;

    /* renamed from: z, reason: collision with root package name */
    public final ur0.t f430336z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s(kotlinx.coroutines.flow.j2 stateFlow, int i17) {
        super(i17);
        ...
        this.f430330t = (android.hardware.camera2.CameraManager) systemService;
        this.f430331u = 1;
        this.f430336z = new ur0.t();
        this.A = new ur0.b();
    ...
    */
    public static final java.lang.Object I(ur0.s r11, kotlin.coroutines.Continuation r12) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final java.lang.Object J(ur0.s r8, kotlin.coroutines.Continuation r9) {
        /*
            r8.getClass()
        ...
        L16:
            ...
            r0.<init>(r8, r9)
        L1b:
            java.lang.Object r9 = r0.f430309f
            ...
            if (r2 == 0) goto L42
            if (r2 != r5) goto L3a
            java.lang.Object r8 = r0.f430308e
            android.hardware.camera2.CameraDevice r8 = (android.hardware.camera2.CameraDevice) r8
            java.lang.Object r0 = r0.f430307d
            ur0.s r0 = (ur0.s) r0
            kotlin.ResultKt.throwOnFailure(r9)     // Catch: android.hardware.camera2.CameraAccessException -> L37
            r2 = r8
            r8 = r0
            goto L97
        L37:
        ...
        L42:
            ...
            r2.append(r7)
            r2.append(r6)
            android.hardware.camera2.CameraDevice r6 = r8.f430333w
            if (r6 == 0) goto L77
            int r6 = r6.hashCode()
            goto L78
        L77:
        ...
        L78:
            ...
            android.hardware.camera2.CameraDevice r2 = r8.f430333w     // Catch: android.hardware.camera2.CameraAccessException -> La8
            if (r2 == 0) goto Lc7
            int r6 = r9.f456173a     // Catch: android.hardware.camera2.CameraAccessException -> La8
            int r9 = r9.f456174b     // Catch: android.hardware.camera2.CameraAccessException -> La8
            r0.f430307d = r8     // Catch: android.hardware.camera2.CameraAccessException -> La8
            r0.f430308e = r2     // Catch: android.hardware.camera2.CameraAccessException -> La8
            r0.f430311h = r5     // Catch: android.hardware.camera2.CameraAccessException -> La8
        ...
        L97:
            ...
            nr0.y r1 = r8.f411433g     // Catch: android.hardware.camera2.CameraAccessException -> La8
            kotlin.jvm.internal.o.d(r1)     // Catch: android.hardware.camera2.CameraAccessException -> La8
            pr0.n r1 = (pr0.n) r1     // Catch: android.hardware.camera2.CameraAccessException -> La8
            android.os.Handler r1 = r1.f357899o     // Catch: android.hardware.camera2.CameraAccessException -> La8
    ...
    public void F(int i17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "updateFocusParam >> " + i17 + ", " + jVar.f456174b + ", " + jVar.f456173a);
        this.A.a(v() ^ true, i17, B().f456173a, B().f456174b, jVar.f456173a, jVar.f456174b);
    }

    public final void K() {
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "close >> " + java.lang.Thread.currentThread());
        android.hardware.camera2.CameraCaptureSession cameraCaptureSession = this.f430335y;
        if (cameraCaptureSession != null) {
            cameraCaptureSession.close();
        }
        this.f430335y = null;
        android.hardware.camera2.CameraDevice cameraDevice = this.f430333w;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object L(boolean r22, kotlin.coroutines.Continuation r23) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object M(int r13, int r14, kotlin.coroutines.Continuation r15) {
        /*
    ...
    public final void N(android.hardware.camera2.CaptureRequest.Key key, int i17) {
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "makeCaptureRequest key:" + key + " value:" + i17);
        android.hardware.camera2.CaptureRequest.Builder builder = this.f430332v;
        if (builder != null) {
    ...
    public final java.lang.Integer O() {
        ...
        try {
            com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "setSessionReq >> " + java.lang.Thread.currentThread());
            android.hardware.camera2.CaptureRequest.Builder builder = this.f430332v;
            if (builder != null && (build = builder.build()) != null) {
                ...
                if (cameraCaptureSession != null) {
                    ...
                    num = java.lang.Integer.valueOf(cameraCaptureSession.setRepeatingRequest(build, iVar, yVar != null ? ((pr0.n) yVar).f357899o : null));
                }
                com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "setSessionReq captureSession:" + this.f430335y + " sequence:" + num);
                return num;
            }
            return -1;
        } catch (android.hardware.camera2.CameraAccessException unused) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Camera.Camera2Impl", "setRepeatingRequest failed, errMsg: ");
            return -1;
        }
    }
    ...
    public java.lang.Float a() {
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "onZoomOut");
        nr0.y yVar = this.f411433g;
        if (yVar != null) {
    ...
    public java.lang.Float b() {
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "onZoomIn");
        nr0.y yVar = this.f411433g;
        if (yVar != null) {
    ...
    public int d() {
        ...
        android.hardware.camera2.CameraCharacteristics cameraCharacteristics = this.f430334x;
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "getCameraOrientation sensorRotation:" + intValue + " lensFace:" + ((java.lang.Integer) cameraCharacteristics.get(android.hardware.camera2.CameraCharacteristics.LENS_FACING)));
        return intValue;
    }
    ...
    public java.lang.Float getHorizontalViewAngle() {
        ...
        android.hardware.camera2.CameraCharacteristics cameraCharacteristics2 = this.f430334x;
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object n(java.lang.Boolean r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
        ...
        L13:
            ...
            r7.<init>(r6, r8)
        L18:
            java.lang.Object r8 = r7.f430323e
        ...
        L2c:
            ...
            throw r7
        L34:
            java.lang.Object r1 = r7.f430322d
            ur0.s r1 = (ur0.s) r1
            kotlin.ResultKt.throwOnFailure(r8)
            goto L64
        L3c:
    ...
    */
    ...
    public java.lang.Object q(kotlin.coroutines.Continuation continuation) {
        com.tencent.mars.xlog.Log.i("MicroMsg.Camera.Camera2Impl", "stopPreview");
        K();
        super.q(continuation);
