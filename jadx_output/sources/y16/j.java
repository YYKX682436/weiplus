...
public final class j extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ y16.l f458962d;
    ...
    public java.lang.Object invoke() {
        ...
        y16.l lVar = this.f458962d;
        java.util.List h17 = lVar.h();
        java.util.ArrayList arrayList = new java.util.ArrayList(3);
        java.util.Collection a17 = lVar.f458966b.g().a();
        ...
        while (it7.hasNext()) {
            ...
            n16.g name = ((o06.d) next2).getName();
            java.lang.Object obj = linkedHashMap.get(name);
            if (obj == null) {
        ...
        for (java.util.Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            for (java.util.Map.Entry entry2 : linkedHashMap2.entrySet()) {
                ...
                r16.x xVar = r16.x.f368679d;
                if (booleanValue) {
                    collection = new java.util.ArrayList();
                    for (java.lang.Object obj4 : h17) {
                        if (kotlin.jvm.internal.o.b(((r06.v) ((o06.n0) obj4)).getName(), gVar)) {
                            collection.add(obj4);
                        }
                    }
                } else {
                ...
                xVar.h(gVar, list2, collection, lVar.f458966b, new y16.k(arrayList, lVar));
            }
        }
