...
public final class e0 implements com.tencent.mm.sdk.platformtools.k3 {

    /* renamed from: d, reason: collision with root package name */
    public static final fm3.e0 f264045d = new fm3.e0();

    @Override // android.os.Handler.Callback
    public final boolean handleMessage(android.os.Message it) {
        kotlin.jvm.internal.o.g(it, "it");
        if (it.what == 0) {
            java.util.Collection values = fm3.f0.f264060m.values();
            ...
            java.util.Collection values2 = fm3.f0.f264061n.values();
