...
public class m implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ mx1.a f367298d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ qx1.q f367299e;
    ...
    public void onClick(android.view.View view) {
        ...
        qx1.q qVar = this.f367299e;
        qVar.f367311e.setPressed(false);
        qVar.f367313g.setPressed(false);
        if (qVar.f367317k || qVar.f367319m) {
            qVar.f367318l = false;
        }
        px1.j jVar = px1.v.f358863d;
        java.lang.Boolean valueOf = java.lang.Boolean.valueOf(!qVar.f367318l);
        nx1.z zVar = qVar.f367307a;
        if (zVar != null) {
            zVar.d(jVar, valueOf);
        }
        boolean z17 = !qVar.f367318l;
        qVar.f367318l = z17;
        qx1.q.a(qVar, view, z17);
        qx1.q.b(qVar, this.f367298d);
        qVar.f367317k = false;
        qVar.f367319m = false;
