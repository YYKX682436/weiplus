...
public abstract class d {
    ...
    */
    public static byte[] a(java.lang.String r14, int r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: n51.d.a(java.lang.String, int):byte[]");
    }
    ...
    public static byte[] b(byte[] bArr, int i17) {
        ...
        boolean z18 = (i17 & 2) == 0;
        boolean z19 = (i17 & 4) != 0;
        byte[] bArr2 = (i17 & 8) == 0 ? n51.c.f335112a : n51.c.f335113b;
        int i19 = z18 ? 19 : -1;
        int i27 = (length / 3) * 4;
        if (!z17) {
            int i28 = length % 3;
    ...
    public static java.lang.String c(byte[] bArr, int i17) {
        try {
            return new java.lang.String(b(bArr, i17), "US-ASCII");
