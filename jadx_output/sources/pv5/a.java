...
public class a implements android.content.ServiceConnection {
    ...
    public final /* synthetic */ pv5.b f358621d;
    ...
    public void onServiceDisconnected(android.content.ComponentName componentName) {
        ...
        pv5.b bVar = this.f358621d;
        android.content.Context context = bVar.f358622a;
        if (context == null || (serviceConnection = bVar.f358623b) == null) {
            return;
        }
        try {
