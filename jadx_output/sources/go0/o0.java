...
public final class o0 extends os0.a {
    ...
    public o0(int i17, int i18, int i19, int i27, int i28, kotlin.jvm.internal.i iVar) {
        ...
        this.F = jz5.h.b(go0.m0.f273801d);
        this.G = jz5.h.b(go0.l0.f273797d);
        jz5.h.b(go0.n0.f273805d);
        ...
        this.f273808J = android.opengl.GLES20.glGetAttribLocation(t17, "a_texCoord");
    ...
    public void n() {
        super.n();
        ((is0.c) ((jz5.n) this.F).getValue()).close();
        ((is0.c) ((jz5.n) this.G).getValue()).close();
        this.E = null;
    }
    ...
    public void p() {
        ...
        android.opengl.GLES20.glTexParameterf(i18, com.google.android.gms.gcm.Task.EXTRAS_LIMIT_BYTES, 9729.0f);
        ...
        if (bitmap != null) {
            ...
            if (bitmap2 != null) {
                is0.c.c((is0.c) ((jz5.n) this.F).getValue(), bitmap2, 0, 33071, 2, null);
            }
        ...
        android.opengl.GLES20.glVertexAttribPointer(this.I, 2, 5126, false, 0, (java.nio.Buffer) this.f347999h);
        int i38 = this.I;
        ...
        android.opengl.GLES20.glVertexAttribPointer(this.f273808J, 2, 5126, false, 0, (java.nio.Buffer) this.f347998g);
        int i47 = this.f273808J;
        android.opengl.GLES20.glEnableVertexAttribArray(i47);
        android.opengl.GLES20.glUniformMatrix4fv(this.Q, 1, false, this.f348003l, 0);
    ...
    public void s(int i17) {
        this.f348005n = i17;
        com.tencent.mars.xlog.Log.i(this.C, "[setRotate] degree:" + i17);
    }
    ...
    public final void x(android.graphics.Bitmap bitmap, int i17, int i18, boolean z17) {
        ...
        sb6.append(',');
        sb6.append(this.f347994c / this.f347995d);
        sb6.append(",flip:");
        sb6.append(z17);
        ...
        float f29 = this.f347994c;
        float f37 = f29 / f27;
        float f38 = this.f347995d;
        float f39 = f38 / f28;
        ...
        com.tencent.mars.xlog.Log.i(str, "calcBlurBgTextureCoord:[" + f17 + ", " + f47 + " \n " + f18 + ", " + f47 + " \n " + f17 + ", " + f19 + " \n " + f18 + ", " + f19 + "], flip:" + z17 + '!');
