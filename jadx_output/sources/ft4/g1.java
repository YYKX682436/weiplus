...
public final class g1 extends androidx.recyclerview.widget.w2 {

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.wallet_core.ui.ledger.WalletLedgerPersonDetailUI f266617d;

    public g1(com.tencent.mm.plugin.wallet_core.ui.ledger.WalletLedgerPersonDetailUI walletLedgerPersonDetailUI) {
        this.f266617d = walletLedgerPersonDetailUI;
    }
    ...
    public void onScrolled(androidx.recyclerview.widget.RecyclerView recyclerView, int i17, int i18) {
        ...
        if (layoutManager instanceof androidx.recyclerview.widget.LinearLayoutManager) {
            ...
            com.tencent.mm.plugin.wallet_core.ui.ledger.WalletLedgerPersonDetailUI walletLedgerPersonDetailUI = this.f266617d;
            if (w17 > 0) {
                android.widget.LinearLayout linearLayout = walletLedgerPersonDetailUI.f180460s;
                if (linearLayout == null) {
                    kotlin.jvm.internal.o.o("toolBarLayout");
                    throw null;
                }
                linearLayout.setVisibility(0);
            } else {
                android.widget.LinearLayout linearLayout2 = walletLedgerPersonDetailUI.f180460s;
