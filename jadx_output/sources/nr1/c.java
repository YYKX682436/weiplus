...
public final class c implements hr1.d {
    ...
    public void a(hr1.e owner) {
        ...
        if (kotlin.jvm.internal.o.b(owner.field_sessionId, "bizphotofansnofiticationholder@picfansmsg")) {
            java.lang.String string = com.tencent.mm.sdk.platformtools.x2.f193071a.getString(com.tencent.mm.R.string.ngo);
            owner.f283345p0 = string;
            owner.Z = string;
            return;
        }
        if (kotlin.jvm.internal.o.b(owner.field_sessionId, "bizphotofansgreetholder@picfansmsg")) {
