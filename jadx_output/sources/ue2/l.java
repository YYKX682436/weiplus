...
public final class l implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ ue2.o f426824d;
    ...
    public final void onClick(android.view.View view) {
        ...
        ue2.o oVar = this.f426824d;
        ue2.e0 e0Var = oVar.f426837p;
        boolean z17 = false;
        if (e0Var != null) {
            e0Var.a(false);
        }
        yf2.s0 s0Var = (yf2.s0) oVar.getController(yf2.s0.class);
        if (s0Var != null) {
            if (!(s0Var.b7() == 1)) {
                z17 = true;
            }
        ...
        com.tencent.mars.xlog.Log.i(ue2.o.f426827y, "tryStartPost: waiting for license confirmation");
        yf2.s0 s0Var2 = (yf2.s0) oVar.getController(yf2.s0.class);
        if (s0Var2 != null) {
            s0Var2.g7(new ue2.j(oVar), new ue2.k(oVar), null, yf2.j2.f461730d);
        }
        yj0.a.h(this, "com/tencent/mm/plugin/finder/live/component/livechat/FinderLiveChatAnchorPluginLayout$setupDialogButtonListeners$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
