...
public class b0 extends android.animation.AnimatorListenerAdapter {
    ...
    public final /* synthetic */ wb4.c0 f444392d;
    ...
    public void onAnimationEnd(android.animation.Animator animator) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onAnimationEnd", "com.tencent.mm.plugin.sns.ui.animation.detail.SphereCardAdDetailBackAnimation$4");
        com.tencent.mars.xlog.Log.i("MicroMsg.SphereCardAdDetailBackAnimation", "onAnimation end");
        wb4.c0 c0Var = this.f444392d;
        android.view.View view = wb4.c0.b(c0Var).f228850z;
        java.lang.Float valueOf = java.lang.Float.valueOf(1.0f);
        view.setScaleX(1.0f);
        wb4.c0.b(c0Var).f228850z.setScaleY(1.0f);
        android.view.View view2 = wb4.c0.b(c0Var).f228850z;
        ...
        android.view.View view3 = wb4.c0.b(c0Var).f228841q;
        ...
        android.view.View view4 = wb4.c0.b(c0Var).f228842r;
        ...
        xb4.x xVar = c0Var.f444412a;
        if (xVar != null) {
            xVar.onAnimationEnd();
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationEnd", "com.tencent.mm.plugin.sns.ui.animation.detail.SphereCardAdDetailBackAnimation$4");
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public void onAnimationStart(android.animation.Animator animator) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onAnimationStart", "com.tencent.mm.plugin.sns.ui.animation.detail.SphereCardAdDetailBackAnimation$4");
        com.tencent.mars.xlog.Log.i("MicroMsg.SphereCardAdDetailBackAnimation", "onAnimation start");
        xb4.x xVar = this.f444392d.f444412a;
        if (xVar != null) {
            xVar.onAnimationStart();
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationStart", "com.tencent.mm.plugin.sns.ui.animation.detail.SphereCardAdDetailBackAnimation$4");
    }
}
