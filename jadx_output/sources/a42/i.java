...
public abstract class i {
    ...
    public static java.lang.String b(byte[] bArr, int i17) {
        ...
        if (bArr.length < i17) {
            com.tencent.mars.xlog.Log.w("MicroMsg.exdevice.Util", "data length is shorter then print command length");
            i17 = bArr.length;
        }
    ...
    public static boolean c(byte[] bArr, int i17, byte[] bArr2) {
        if (com.tencent.mm.sdk.platformtools.t8.M0(bArr) || com.tencent.mm.sdk.platformtools.t8.M0(bArr2) || bArr2.length + i17 > bArr.length || i17 < 0 || i17 >= bArr.length) {
            return false;
        }
        int i18 = 0;
        ...
        try {
            if (context != null) {
                try {
                    ...
                    com.tencent.mars.xlog.Log.i("MicroMsg.exdevice.Util", "getStatusHeight err: %s", objArr);
                    return i17;
                }
            }
    ...
    */
    public static long e() {
        ...
        L27:
            ...
            com.tencent.mars.xlog.Log.e(r2, r1, r0)
        L36:
            r0 = r3
        L37:
    ...
    public static long h(java.lang.String str) {
        ...
        if (str == null || str.length() == 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.Util", "mac string is null or nil");
            return 0L;
        }
        ...
        for (java.lang.String str2 : split) {
            if (str2.length() == 0) {
                com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.Util", "mac string parse fail");
                return 0L;
            }
    ...
    public static java.util.UUID j(byte[] bArr) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.M0(bArr)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.Util", "aUUIDByteArray is null or nil");
            return null;
        }
        if (16 != bArr.length) {
            com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.Util", "the length (%d) of this byte array is not 16", java.lang.Integer.valueOf(bArr.length));
            return null;
        }
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.Util", "%s", e17.getMessage());
            return null;
        }
    }
    ...
    public static java.lang.String k(java.lang.String str) {
        if (str == null || 12 != str.length()) {
            com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.Util", "%s is not server string mac", str);
            return null;
        }
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("");
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.exdevice.Util", "%s to %s is ok", str, sb6.toString());
        return sb6.toString();
    }
}
