    ...
    public void S(yb5.d dVar, rd5.d dVar2) {
        if (dVar2 instanceof qd5.i) {
            ...
            if (g95.e0.j(iVar.f394254d.f445300b)) {
                com.tencent.mars.xlog.Log.i("MicroMsg.ChattingItemMediaGroupItem", "ChattingItemMediaGroupItemTo onMsgExposed, msg is expired, skip download");
            } else {
                te5.d.f418622a.a(iVar.f394254d.f445300b, new ye5.h(dVar, dVar2));
            }
        }
    }
