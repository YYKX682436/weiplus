...
public final class sc {
    ...
    public static int f418413b;

    /* renamed from: a, reason: collision with root package name */
    public static final te2.sc f418412a = new te2.sc();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.List f418414c = new java.util.ArrayList();

    public final int a(int i17) {
        java.util.Iterator it = ((java.util.ArrayList) f418414c).iterator();
        int i18 = 0;
        while (it.hasNext()) {
    ...
    public final r45.s52 b(int i17) {
        ...
        while (true) {
            ...
            obj = it.next();
            boolean z17 = false;
            if (((r45.s52) obj).getInteger(0) == i17) {
                z17 = true;
            }
            if (z17) {
                break;
    ...
    public final void c(int i17, boolean z17, java.util.List list) {
        ...
        com.tencent.mars.xlog.Log.i("FinderLiveNoticeQRCodeHelper", sb6.toString());
        java.util.List list2 = f418414c;
