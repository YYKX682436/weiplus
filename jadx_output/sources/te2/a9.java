...
public final class a9 {
    ...
    public static final te2.a9 f417883a = new te2.a9();

    /* renamed from: b, reason: collision with root package name */
    public static long f417884b;

    /* renamed from: c, reason: collision with root package name */
    public static long f417885c;
    ...
    public static void f(te2.a9 a9Var, boolean z17, int i17, java.util.List list, mm2.k6 k6Var, int i18, java.lang.Object obj) {
        ...
        if (!(list2 == null || list2.isEmpty())) {
            l17.put("song_id", kz5.n0.g0(list2, "_", null, null, 0, null, te2.u8.f418476d, 30, null));
            l17.put("song_name", kz5.n0.g0(list2, "_", null, null, 0, null, te2.v8.f418498d, 30, null));
            l17.put("duration", kz5.n0.g0(list2, "_", null, null, 0, null, te2.w8.f418513d, 30, null));
            l17.put("singer_mid", kz5.n0.g0(list2, "_", null, null, 0, null, te2.x8.f418532d, 30, null));
            l17.put("singer_name", kz5.n0.g0(list2, "_", null, null, 0, null, te2.y8.f418548d, 30, null));
            l17.put("part_id", kz5.n0.g0(list2, "_", null, null, 0, null, te2.z8.f418567d, 30, null));
        }
        if (k6Var2 != null) {
        ...
        if (z17) {
            a9Var.c(ml2.z4.f328385w2, l17);
        } else {
            a9Var.d(ml2.c1.f327326f, l17);
        }
    }
    ...
    public final void a(boolean z17, int i17, r45.in inVar, r45.ch6 ch6Var, r45.ay1 ay1Var) {
        java.util.Map l17 = kz5.c1.l(new jz5.l("type", java.lang.String.valueOf(i17)), new jz5.l("style", "1"));
        if (inVar != null) {
            l17.put("tab_id", java.lang.String.valueOf(inVar.f377156d));
            java.lang.String board_name = inVar.f377157e;
            kotlin.jvm.internal.o.f(board_name, "board_name");
            l17.put("tab_name", board_name);
        }
        if (ch6Var != null) {
            l17.put("tab_sub_id", java.lang.String.valueOf(ch6Var.f371555d));
            java.lang.String sub_board_name = ch6Var.f371556e;
            kotlin.jvm.internal.o.f(sub_board_name, "sub_board_name");
        ...
        if (z17) {
            c(ml2.z4.f328389x2, l17);
        } else {
            d(ml2.c1.f327327g, l17);
        }
    }
    ...
    public final void d(ml2.c1 c1Var, java.util.Map map) {
        i95.m c17 = i95.n0.c(ml2.j0.class);
        kotlin.jvm.internal.o.f(c17, "getService(...)");
        zy2.zb.j5((zy2.zb) c17, c1Var.f327329d, new org.json.JSONObject(map).toString(), null, 4, null);
    }
    ...
    public final void e(int i17, java.lang.String str) {
        ...
        if (i17 == 7 || i17 == 8) {
            ...
            f417884b = currentTimeMillis;
        }
        c(ml2.z4.f328396z2, l17);
    }
}
