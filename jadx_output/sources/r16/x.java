...
public class x {
    ...
    public static final java.util.List f368678c = kz5.n0.S0(java.util.ServiceLoader.load(r16.l.class, r16.l.class.getClassLoader()));

    /* renamed from: d, reason: collision with root package name */
    public static final r16.x f368679d;

    /* renamed from: e, reason: collision with root package name */
    public static final g26.f f368680e;

    /* renamed from: a, reason: collision with root package name */
    public final g26.l f368681a;

    /* renamed from: b, reason: collision with root package name */
    public final g26.f f368682b;

    static {
        r16.q qVar = new r16.q();
        f368680e = qVar;
        f368679d = new r16.x(qVar, g26.k.f267994a, g26.h.f267993a, null);
    }
    ...
    */
    ...
    public static boolean b(f26.o0 o0Var, f26.o0 o0Var2, f26.b2 b2Var) {
        ...
        return f26.g.f259162a.e(b2Var, o0Var.z0(), o0Var2.z0());
    }
    ...
    public static java.util.List d(o06.b bVar) {
        ...
        if (c07 != null) {
            arrayList.add(((r06.g) c07).getType());
        }
        java.util.Iterator it = bVar.W().iterator();
        while (it.hasNext()) {
            arrayList.add(((r06.t1) ((o06.l2) it.next())).getType());
        }
        return arrayList;
    }
    ...
    */
    ...
    public static java.util.Collection g(java.lang.Object obj, java.util.Collection collection, yz5.l lVar, yz5.l lVar2) {
        ...
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(obj);
        o06.b bVar = (o06.b) lVar.invoke(obj);
        java.util.Iterator it = collection.iterator();
        while (it.hasNext()) {
            java.lang.Object next = it.next();
            o06.b bVar2 = (o06.b) lVar.invoke(next);
            if (obj == next) {
                it.remove();
            } else {
    ...
    public static boolean k(o06.b bVar, o06.b bVar2) {
        ...
        f26.o0 returnType = bVar.getReturnType();
        f26.o0 returnType2 = bVar2.getReturnType();
        if (!p(bVar, bVar2)) {
            return false;
        }
        f26.b2 f17 = f368679d.f(bVar.getTypeParameters(), bVar2.getTypeParameters());
        if (bVar instanceof o06.n0) {
            return o(bVar, returnType, bVar2, returnType2, f17);
        }
        ...
        if ((b17 == null || b18 == null) ? true : p(b17, b18)) {
            return (o1Var.v() && o1Var2.v()) ? f26.g.f259162a.e(f17, returnType.z0(), returnType2.z0()) : (o1Var.v() || !o1Var2.v()) && o(bVar, returnType, bVar2, returnType2, f17);
        }
        return false;
    }
    ...
    public static boolean p(o06.q qVar, o06.q qVar2) {
        ...
        if (qVar2 != null) {
            java.lang.Integer b17 = o06.f0.b(qVar.getVisibility(), qVar2.getVisibility());
    ...
    */
    ...
    public static java.lang.Object s(java.util.Collection collection, yz5.l lVar) {
        ...
        o06.b bVar = (o06.b) lVar.invoke(W2);
        for (java.lang.Object obj2 : collection) {
            o06.b bVar2 = (o06.b) lVar.invoke(obj2);
            if (bVar2 == null) {
                a(71);
                throw null;
            }
        ...
        while (true) {
            ...
            obj = it6.next();
            if (!f26.h0.b(((o06.b) lVar.invoke(obj)).getReturnType())) {
                break;
            }
        }
        if (obj != null) {
    ...
    public final f26.b2 f(java.util.List list, java.util.List list2) {
        ...
        if (isEmpty) {
            r16.z zVar = new r16.z(null, this.f368682b, this.f368681a, hVar, null);
            if (zVar.f368688e != null) {
                return new r16.y(true, true, zVar, zVar.f368687d, zVar.f368686c);
            }
            g26.j kotlinTypePreparator = zVar.f368687d;
            kotlin.jvm.internal.o.g(kotlinTypePreparator, "kotlinTypePreparator");
            g26.l kotlinTypeRefiner = zVar.f368686c;
        ...
        r16.z zVar2 = new r16.z(hashMap, this.f368682b, this.f368681a, hVar, null);
        if (zVar2.f368688e != null) {
            return new r16.y(true, true, zVar2, zVar2.f368687d, zVar2.f368686c);
        }
        g26.j kotlinTypePreparator2 = zVar2.f368687d;
        kotlin.jvm.internal.o.g(kotlinTypePreparator2, "kotlinTypePreparator");
        g26.l kotlinTypeRefiner2 = zVar2.f368686c;
        kotlin.jvm.internal.o.g(kotlinTypeRefiner2, "kotlinTypeRefiner");
    ...
    */
    ...
    public r16.w m(o06.b bVar, o06.b bVar2, o06.g gVar, boolean z17) {
        ...
        java.util.List<r16.l> list = f368678c;
