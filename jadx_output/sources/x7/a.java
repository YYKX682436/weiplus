...
public class a extends android.database.sqlite.SQLiteOpenHelper implements x7.b {
    ...
    public static final java.lang.String[] f452398d = {"_id", "url", "length", "mime"};
    ...
    public u7.u a(java.lang.String str) {
        ...
        u7.u uVar = null;
        try {
            cursor = getReadableDatabase().query("SourceInfo", f452398d, "url=?", new java.lang.String[]{str}, null, null, null);
            if (cursor != null) {
                try {
    ...
    public void b(java.lang.String str, u7.u uVar) {
        ...
        contentValues.put("url", uVar.f425080a);
        contentValues.put("length", java.lang.Long.valueOf(uVar.f425081b));
        contentValues.put("mime", uVar.f425082c);
        if (z17) {
