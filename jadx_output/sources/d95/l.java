...
public class l implements java.lang.Runnable {
    ...
    public final /* synthetic */ d95.f f227694d;
    ...
    public void run() {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MMDataBase", "willVacuumOnMidnight, s1 = true, s2 = " + l17 + ", s3 = " + l18);
        ...
        d95.f fVar = this.f227694d;
        java.lang.String substring = fVar.k().substring(fVar.k().lastIndexOf("/") + 1);
        com.tencent.mars.xlog.Log.i("MicroMsg.MMDataBase", "checkVacuumRunnable, before get freelist_count");
        ...
        if (substring.equals("EnMicroMsg.db")) {
            com.tencent.mm.sdk.platformtools.o4.L().B("report_freelist_daily_EnMicroMsg", h17);
            ...
            com.tencent.mm.sdk.platformtools.o4.L().B("report_freelist_daily_WxFileIndex", h17);
            ...
            com.tencent.mm.sdk.platformtools.o4.L().B("report_freelist_daily_FTS", h17);
            ...
            com.tencent.mm.sdk.platformtools.o4.L().B("report_freelist_daily_NewBiz", h17);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MMDataBase", "checkVacuumRunnable, after get freelist_count, duration = " + (java.lang.System.currentTimeMillis() - currentTimeMillis));
        long g18 = fVar.g() - h17;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMDataBase", "report vacuum, db.getPath() = " + fVar.k() + ", dbFileSize = " + fVar.g());
        com.tencent.mars.xlog.Log.i("MicroMsg.MMDataBase", "dbRealDataSize = " + g18 + ", freeListSize = " + h17);
        boolean z17 = g18 < j17 && h17 > 209715200;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMDataBase", "willVacuum = " + z17);
        if (z17) {
            com.tencent.mm.storage.va.f196289a.a(new d95.k(this, substring), "Vacuum-Task");
        }
    }
}
