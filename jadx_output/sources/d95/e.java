...
public final class e extends android.database.AbstractCursor {
    ...
    public final java.lang.String[] f227656d;

    /* renamed from: e, reason: collision with root package name */
    public java.lang.Object[] f227657e;

    /* renamed from: f, reason: collision with root package name */
    public int f227658f = 0;

    /* renamed from: g, reason: collision with root package name */
    public final int f227659g;

    public e(java.lang.String[] strArr) {
        this.f227656d = strArr;
        int length = strArr.length;
        this.f227659g = length;
        this.f227657e = new java.lang.Object[length * 16];
    }

    public void a(java.lang.Object[] objArr) {
        int length = objArr.length;
        int i17 = this.f227659g;
        if (length != i17) {
            throw new java.lang.IllegalArgumentException("columnNames.length = " + i17 + ", columnValues.length = " + objArr.length);
        }
        int i18 = this.f227658f;
        this.f227658f = i18 + 1;
        int i19 = i18 * i17;
        int i27 = i19 + i17;
        java.lang.Object[] objArr2 = this.f227657e;
        if (i27 > objArr2.length) {
            ...
            this.f227657e = objArr3;
            java.lang.System.arraycopy(objArr2, 0, objArr3, 0, objArr2.length);
        }
        java.lang.System.arraycopy(objArr, 0, this.f227657e, i19, i17);
    }
    ...
    */
    ...
    public final java.lang.Object get(int i17) {
        ...
        if (i19 < this.f227658f) {
            return this.f227657e[(i19 * i18) + i17];
        }
    ...
    public java.lang.String[] getColumnNames() {
        return this.f227656d;
    }

    @Override // android.database.AbstractCursor, android.database.Cursor
    public int getCount() {
        return this.f227658f;
    }
    ...
    public double getDouble(int i17) {
        ...
        return obj instanceof java.lang.Number ? ((java.lang.Number) obj).doubleValue() : com.tencent.mm.sdk.platformtools.t8.F(obj.toString(), 0.0d);
    }
    ...
    public float getFloat(int i17) {
        ...
        return obj instanceof java.lang.Number ? ((java.lang.Number) obj).floatValue() : com.tencent.mm.sdk.platformtools.t8.L(obj.toString(), 0.0f);
    }
    ...
    public int getInt(int i17) {
        ...
        return obj instanceof java.lang.Number ? ((java.lang.Number) obj).intValue() : com.tencent.mm.sdk.platformtools.t8.P(obj.toString(), 0);
    }
    ...
    public long getLong(int i17) {
        ...
        return obj instanceof java.lang.Number ? ((java.lang.Number) obj).longValue() : com.tencent.mm.sdk.platformtools.t8.V(obj.toString(), 0L);
    }
