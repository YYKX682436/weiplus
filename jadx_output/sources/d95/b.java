...
public abstract class b {
    ...
    public static final boolean f227600a;

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.String[] f227601b;

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.String[] f227602c;
    ...
    static {
        ...
        f227600a = z17;
        f227601b = new java.lang.String[]{"", " OR ROLLBACK", " OR ABORT", " OR FAIL", " OR IGNORE", " OR REPLACE"};
        f227602c = new java.lang.String[]{"", "-journal", "-wal"};
    }
    ...
    */
    public static int a(com.tencent.wcdb.core.Database r14, com.tencent.wcdb.core.Database r15, final java.lang.String r16, int r17, boolean r18, boolean r19, java.lang.String[] r20, java.lang.String r21, android.os.CancellationSignal r22) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static int b(l75.k0 r17, com.tencent.wcdb.database.SQLiteDatabase r18, java.lang.String r19, int r20, boolean r21, boolean r22, java.lang.String[] r23, java.lang.String r24, android.os.CancellationSignal r25) {
        /*
    ...
    public static android.database.Cursor c(l75.k0 k0Var, java.lang.String str, java.lang.String[] strArr) {
        ...
        if (k0Var instanceof d95.z) {
            return tp5.a.g(((d95.z) k0Var).f227718a.getInnerDB(), str, strArr, null);
        }
        if (k0Var instanceof d95.b0) {
            return k0Var.o(com.tencent.wcdb.database.SQLiteDirectCursor.FACTORY, str, strArr, "", null);
        }
        if (strArr != null) {
