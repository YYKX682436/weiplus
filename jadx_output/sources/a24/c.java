...
public final class c implements android.view.animation.Animation.AnimationListener {
    ...
    public final /* synthetic */ android.view.View f873a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ android.view.animation.AlphaAnimation f874b;

    public c(android.view.View view, android.view.animation.AlphaAnimation alphaAnimation) {
        this.f873a = view;
        this.f874b = alphaAnimation;
    }

    @Override // android.view.animation.Animation.AnimationListener
    public void onAnimationEnd(android.view.animation.Animation anim) {
        kotlin.jvm.internal.o.g(anim, "anim");
        new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(new a24.b(this.f873a, this.f874b), 600L);
    }
