...
public enum r2 implements vg3.q4 {
    ...
    public java.lang.Long f(java.lang.String str, java.lang.String str2) {
        k91.v Ui = com.tencent.mm.plugin.appbrand.app.r9.Ui();
        if (Ui == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WxaWeAppPushCommandMgr", "getExpireTime(appId:%s, type:%s), kvStorage==NULL, account initialized:%b", str, str2, java.lang.Boolean.valueOf(gm0.j1.b().f273254q));
            return null;
        }
        ...
        if (java.lang.Long.valueOf(z07).longValue() < java.lang.System.currentTimeMillis()) {
            com.tencent.mm.plugin.appbrand.app.r9.Ui().d(b(str, str2));
            com.tencent.mars.xlog.Log.i("MicroMsg.WxaWeAppPushCommandMgr", "delete data app id=" + str);
        }
    ...
    */
    public com.tencent.mm.modelbase.q0 k7(java.lang.String r18, java.util.Map r19, com.tencent.mm.modelbase.p0 r20) {
        /*
            r17 = this;
            r0 = r19
        ...
        L80:
            ...
            k91.v r11 = com.tencent.mm.plugin.appbrand.app.r9.Ui()
            r12 = r17
