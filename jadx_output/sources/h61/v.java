...
public class v implements lm5.e {
    ...
    public final /* synthetic */ h61.x f279175a;
    ...
    public java.lang.Object call(java.lang.Object obj) {
        ...
        h61.t tVar = this.f279175a.f279177a;
        tVar.getClass();
        tVar.f279173g = km5.u.b();
        com.tencent.mars.xlog.Log.i("MicroMsg.LaunchAALogic", "launchAAByPersonCustomize");
        if (tVar.f279170d) {
        ...
        tVar.f279172f = map;
        tVar.f279171e = 3;
        if (!map.containsKey(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_TITLE) || !tVar.f279172f.containsKey("launchScene") || !tVar.f279172f.containsKey("chatRoomName") || !tVar.f279172f.containsKey(com.google.android.gms.measurement.AppMeasurement.Param.TIMESTAMP)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.LaunchAALogic", "launchAAByPersonCustomize interrupt");
            tVar.f279173g.a(java.lang.Boolean.FALSE);
            tVar.f279170d = false;
            return null;
        }
        try {
            ...
            long longValue = ((java.lang.Long) tVar.f279172f.get(com.google.android.gms.measurement.AppMeasurement.Param.TIMESTAMP)).longValue();
            ...
            gm0.j1.i();
            gm0.j1.n().f273288b.g(new i61.h(str, intValue, str2, longValue, str3, str4, str5, str6, booleanValue, linkedList));
            tVar.f279173g.b();
            return null;
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.e("MicroMsg.LaunchAALogic", "launchAAByPersonCustomize error: %s", e17.getMessage());
            tVar.f279173g.a(java.lang.Boolean.FALSE);
            tVar.f279170d = false;
            return null;
        }
