...
public final class y0 {
    ...
    public final hf2.x f281200a;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f281201b;

    /* renamed from: c, reason: collision with root package name */
    public final int f281202c;

    /* renamed from: d, reason: collision with root package name */
    public com.tencent.mm.ui.tools.f5 f281203d;

    /* renamed from: e, reason: collision with root package name */
    public android.view.View f281204e;

    /* renamed from: f, reason: collision with root package name */
    public android.widget.EditText f281205f;

    /* renamed from: g, reason: collision with root package name */
    public android.view.View f281206g;

    /* renamed from: h, reason: collision with root package name */
    public android.view.View f281207h;

    /* renamed from: i, reason: collision with root package name */
    public android.view.View f281208i;

    /* renamed from: j, reason: collision with root package name */
    public hf2.l0 f281209j;

    /* renamed from: k, reason: collision with root package name */
    public kotlinx.coroutines.r2 f281210k;

    public y0(hf2.x controller) {
        kotlin.jvm.internal.o.g(controller, "controller");
        this.f281200a = controller;
        this.f281201b = controller.f281181m + "_Maas";
        this.f281202c = 8;
    }

    public static java.lang.Object b(hf2.y0 y0Var, r45.h84 h84Var, java.lang.String str, kotlin.coroutines.Continuation continuation, int i17, java.lang.Object obj) {
        java.util.LinkedList linkedList;
        r45.ji0 ji0Var;
        if ((i17 & 2) != 0) {
            r45.ei0 ei0Var = y0Var.f281200a.f281185q;
            str = (ei0Var == null || (linkedList = ei0Var.f373529d) == null || (ji0Var = (r45.ji0) kz5.n0.Z(linkedList)) == null) ? null : ji0Var.f377829n;
            if (str == null) {
                str = "";
            }
        }
        return y0Var.a(h84Var, str, continuation);
    }
    ...
    public static final void e(android.widget.EditText editText, hf2.y0 y0Var) {
        ...
        if (((editText == null || (text = editText.getText()) == null) ? 0 : text.length()) <= 0) {
            android.view.View view = y0Var.f281206g;
            if (view == null) {
                return;
            }
        ...
        android.view.View view2 = y0Var.f281206g;
        if (view2 == null) {
            return;
        }
    ...
    */
    public final java.lang.Object a(r45.h84 r28, java.lang.String r29, kotlin.coroutines.Continuation r30) {
        /*
    ...
    public final void c(android.widget.EditText editText) {
        ...
        android.view.View view = this.f281204e;
        if (view != null) {
