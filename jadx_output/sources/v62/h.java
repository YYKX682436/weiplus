...
public class h {
    public v62.i a(java.lang.String str, boolean z17) {
        if (!com.tencent.mm.vfs.w6.j(str)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ExtQbarYuvRetrieverFactory", "hy: handle not exist");
            return null;
        }
        byte[] N = com.tencent.mm.vfs.w6.N(str, 0, -1);
        if (N == null || N.length <= 14) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ExtQbarYuvRetrieverFactory", "hy: invalid yuv handle file!!");
            return null;
        }
        ...
        android.util.SparseArray sparseArray = v62.j.f433516a;
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ExtQbarYuvRetrieverFactory", "hy: retrieved result: %s", iVar);
        return iVar;
    }
}
