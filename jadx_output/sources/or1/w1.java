...
public class w1 extends fb5.b {
    ...
    public void a(android.view.View view, fb5.a aVar) {
        ...
        ((or1.x1) aVar).f347595a = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.o_y);
    }
    ...
    public void b(android.content.Context context, fb5.a aVar, fb5.c cVar, java.lang.Object... objArr) {
        if (context == null || aVar == null || cVar == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ReadMoreBtnDataItem", "Context or ViewHolder or DataItem or DataItem.data is null.");
            return;
        }
        if (!(aVar instanceof or1.x1)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ReadMoreBtnDataItem", "The ViewHolder is not a instance of MoreBtnViewHolder.");
        } else if (cVar instanceof or1.y1) {
            ((or1.x1) aVar).f347595a.setText(((or1.y1) cVar).f347599d);
        } else {
            com.tencent.mars.xlog.Log.e("MicroMsg.ReadMoreBtnDataItem", "The DataItem is not a instance of MoreBtnDataItem.");
        }
    }

    @Override // fb5.b
    public android.view.View c(android.content.Context context, android.view.ViewGroup viewGroup, android.view.View view) {
        return view == null ? android.view.View.inflate(context, com.tencent.mm.R.layout.f489436cj0, null) : view;
    }
        ...
        if (context != null && cVar != null) {
            if (objArr != null && objArr.length >= 2) {
                ...
                if (obj instanceof java.lang.Integer) {
                    ...
                    intent.putExtra("keyword", y1Var.f347601f);
                    intent.putExtra("businessType", y1Var.f347600e);
                    intent.putExtra("offset", y1Var.f347602g);
            ...
            android.content.Intent intent2 = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.plugin.brandservice.ui.BizSearchDetailPageUI.class);
            intent2.putExtra("keyword", y1Var2.f347601f);
            intent2.putExtra("businessType", y1Var2.f347600e);
            intent2.putExtra("offset", y1Var2.f347602g);
