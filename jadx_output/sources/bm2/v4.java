...
public final class v4 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ bm2.n5 f22384d;
    ...
    public final void onClick(android.view.View view) {
        ...
        while (true) {
            ...
            if ((((bm2.m4) next).f22102b == n5Var.f22154t ? 1 : 0) != 0) {
                arrayList3.add(next);
            }
        }
        ...
        if (size < 15) {
            if (size2 < 15) {
                ...
                n5Var.notifyItemRemoved(n5Var.N.size());
                z18 = true;
            } else {
                z18 = false;
            }
            ...
            while (i19 < size2) {
                ...
                if (arrayList5 != null && (r62Var2 = (r45.r62) arrayList5.get(i19)) != null) {
                    n5Var.B.add(size3, new bm2.m4((r45.xn1) r62Var2.getCustom(i17), n5Var.f22154t, 0, 0, false, r62Var2.getList(i18), 0, null, 208, null));
                    n5Var.N.add(size3, new bm2.m4((r45.xn1) r62Var2.getCustom(i17), n5Var.f22154t, 0, 0, false, r62Var2.getList(1), 0, null, 208, null));
                }
                i19++;
                i17 = 0;
                i18 = 1;
            }
            n5Var.notifyItemRangeInserted(size3, size2 - size);
        } else {
            int i27 = size + 10;
            if (i27 > size2) {
                i27 = size2;
            ...
            for (int i28 = size; i28 < i27; i28++) {
                ...
                if (arrayList6 != null && (r62Var = (r45.r62) arrayList6.get(i28)) != null) {
                    n5Var.B.add(size4, new bm2.m4((r45.xn1) r62Var.getCustom(0), n5Var.f22154t, 0, 0, false, r62Var.getList(1), 0, null, 208, null));
                    n5Var.N.add(size4, new bm2.m4((r45.xn1) r62Var.getCustom(0), n5Var.f22154t, 0, 0, false, r62Var.getList(1), 0, null, 208, null));
                }
            }
            n5Var.notifyItemRangeInserted(size4, i27 - size);
        }
