...
public final class i0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.content.Context f21963d;
    ...
    public final void onClick(android.view.View view) {
        ...
        android.content.Context context = this.f21963d;
        db5.t7.m(context, context.getResources().getString(com.tencent.mm.R.string.e9i));
