...
public final class h0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.z42 f21923d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f21924e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.protocal.protobuf.FinderJumpInfo f21925f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ bm2.v0 f21926g;

    public h0(r45.z42 z42Var, android.content.Context context, com.tencent.mm.protocal.protobuf.FinderJumpInfo finderJumpInfo, bm2.v0 v0Var) {
        this.f21923d = z42Var;
        this.f21924e = context;
        this.f21925f = finderJumpInfo;
        this.f21926g = v0Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        r45.z42 z42Var = this.f21923d;
        if (z42Var.getInteger(1) == 15) {
            dk2.ef efVar = dk2.ef.f233372a;
            gk2.e eVar = dk2.ef.I;
            if (eVar != null) {
                wt2.a aVar = this.f21926g.f22368n;
                boolean z17 = false;
                if (aVar != null && (q57 = aVar.q5()) != null && ((mm2.c1) q57.a(mm2.c1.class)).S) {
                    z17 = true;
                }
                bf2.c.b(bf2.c.f19598a, eVar, z17 ? 8 : 6, 11, null, 0, 24, null);
            }
        }
        int integer = z42Var.getInteger(1);
        com.tencent.mm.protocal.protobuf.FinderJumpInfo info = this.f21925f;
        android.content.Context context = this.f21924e;
        if (integer == 15) {
