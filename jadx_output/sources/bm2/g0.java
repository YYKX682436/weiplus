...
public final class g0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.content.Context f21902d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bm2.v0 f21903e;
    ...
    public final void onClick(android.view.View view) {
        ...
        if (eVar != null) {
            ...
            bf2.c.b(bf2.c.f19598a, eVar, z17 ? 8 : 6, 10, null, 0, 24, null);
        }
        c61.ub ubVar = (c61.ub) i95.n0.c(c61.ub.class);
        android.content.Context context = this.f21902d;
        kotlin.jvm.internal.o.f(context, "$context");
        wt2.a aVar2 = v0Var.f22368n;
        if (aVar2 == null || (q57 = aVar2.q5()) == null || (str = ((mm2.c1) q57.a(mm2.c1.class)).f328852o) == null) {
            str = "";
        }
        ((com.tencent.mm.plugin.finder.assist.i0) ubVar).Nk(context, null, str, 0, 0);
