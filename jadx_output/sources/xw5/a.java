...
public final class a extends android.graphics.drawable.Drawable {
    ...
    public final android.graphics.Paint f457737a;

    /* renamed from: b, reason: collision with root package name */
    public final android.graphics.Rect f457738b;
    ...
    public a(int i17) {
        ...
        this.f457737a = paint;
        this.f457738b = new android.graphics.Rect();
    }
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        android.graphics.Rect rect = this.f457738b;
        ...
        float f18 = f17 / 2.0f;
        android.graphics.Paint paint = this.f457737a;
