...
public final class h extends i95.w {
    ...
    public final wz3.l f450785d = new wz3.l(0);

    /* renamed from: e, reason: collision with root package name */
    public final java.util.concurrent.ConcurrentHashMap f450786e = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: g, reason: collision with root package name */
    public int f450788g = -1;
    ...
    */
    ...
    public final boolean Ai() {
        ...
        boolean z17;
        wz3.l lVar = this.f450785d;
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = this.f450786e;
        try {
            requireAccountInitialized();
            if (this.f450788g != -1) {
                requireAccountInitialized();
                return this.f450788g == 1;
            }
            ...
            org.json.JSONObject jSONObject = new org.json.JSONObject(com.tencent.mm.vfs.w6.M(str2));
            this.f450787f = jSONObject.optInt("version", 0);
            ...
            if (optJSONArray == null || optJSONArray.length() <= 0) {
                ...
                requireAccountInitialized();
                sb6.append(this.f450787f);
                com.tencent.mars.xlog.Log.e("MicroMsg.ScanProductModelResLogic", sb6.toString());
                return false;
            }
            int i17 = 0;
            while (true) {
                if (!(i17 < optJSONArray.length())) {
                    ...
                    requireAccountInitialized();
                    sb7.append(this.f450787f);
                    com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", sb7.toString());
                    java.lang.StringBuilder sb8 = new java.lang.StringBuilder();
                    sb8.append("下发模型已ready：");
                    requireAccountInitialized();
                    sb8.append(this.f450787f);
                    fj(sb8.toString());
                    lVar.a(2);
                    return true;
                }
            ...
            requireAccountInitialized();
            sb9.append(this.f450787f);
            sb9.append(", filePath:");
            sb9.append(str);
            com.tencent.mars.xlog.Log.e("MicroMsg.ScanProductModelResLogic", sb9.toString());
            requireAccountInitialized();
            concurrentHashMap.clear();
            this.f450787f = 0;
            this.f450788g = 0;
            ...
            this.f450787f = 0;
            lVar.a(3);
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanProductModelResLogic", e17, "checkIfDownloadModelResReady.", new java.lang.Object[0]);
            return false;
        }
    }
    ...
    public final boolean Bi() {
        try {
            ...
            if (Di <= Di2) {
                com.tencent.mars.xlog.Log.w("MicroMsg.ScanProductModelResLogic", "copyPendingDirToReadyDirIfNeed not copy, pendingVersion:" + Di + ", readyVersion:" + Di2);
                fj("下发模型已ready，无需拷贝：" + Di2 + ", " + Di);
                return true;
            }
            java.lang.String Vi = Vi();
            java.lang.String Ri = Ri();
            com.tencent.mm.vfs.w6.f(Vi);
            com.tencent.mm.vfs.w6.u(Vi);
            boolean b17 = com.tencent.mm.vfs.w6.b(Ri, Vi);
            wz3.l lVar = this.f450785d;
            if (b17) {
                lVar.a(9);
            } else {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "copyPendingDirToReadyDirIfNeed copy, pendingVersion:" + Di + ", readyVersion:" + Di2 + ", result:" + b17);
            fj("拷贝模型到ready目录：" + Di2 + ", " + Di + ", " + b17);
            return b17;
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanProductModelResLogic", e17, "copyPendingDirToReadyDirIfNeed", new java.lang.Object[0]);
            return false;
        }
    }
    ...
    public final int Di(java.lang.String str) {
        try {
            if (!com.tencent.mm.vfs.w6.j(str)) {
                com.tencent.mars.xlog.Log.w("MicroMsg.ScanProductModelResLogic", "getConfigJsonVersion file is not exist. filePath:" + str);
                return 0;
            }
            int optInt = new org.json.JSONObject(com.tencent.mm.vfs.w6.M(str)).optInt("version", 0);
            com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "getConfigJsonVersion version:" + optInt + " , filePath:" + str);
            return optInt;
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanProductModelResLogic", e17, "getConfigJsonVersion", new java.lang.Object[0]);
            return 0;
        }
    }
    ...
    */
    public final java.lang.String Ui() {
        /*
            ...
            com.tencent.mars.xlog.Log.e(r1, r2)     // Catch: java.lang.Exception -> L63
            return r0
        L15:
            r7.requireAccountInitialized()     // Catch: java.lang.Exception -> L63
            java.util.concurrent.ConcurrentHashMap r5 = r7.f450786e     // Catch: java.lang.Exception -> L63
        ...
        L2e:
            ...
            return r0
        L36:
            boolean r6 = com.tencent.mm.vfs.w6.j(r5)     // Catch: java.lang.Exception -> L63
            if (r6 != 0) goto L4c
            ...
            return r0
        L4c:
            java.lang.String r3 = com.tencent.mm.vfs.w6.M(r5)     // Catch: java.lang.Exception -> L63
            ...
            com.tencent.mars.xlog.Log.i(r1, r2)     // Catch: java.lang.Exception -> L63
            kotlin.jvm.internal.o.d(r3)     // Catch: java.lang.Exception -> L63
            return r3
        L63:
            r2 = move-exception
            java.lang.String r3 = "getReadyModelConfigString"
            java.lang.Object[] r4 = new java.lang.Object[r4]
            com.tencent.mars.xlog.Log.printErrStackTrace(r1, r2, r3, r4)
            return r0
        */
    ...
    public final boolean cj(java.lang.String str, java.lang.String str2) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "moveFileToPendingFilePath file tmp:" + str3 + "  pending:" + str4);
        if (!com.tencent.mm.vfs.w6.j(str3)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ScanProductModelResLogic", "moveFileToPendingFilePath file is not exist. tmpFilePath:" + str3);
            return false;
        }
        com.tencent.mm.vfs.w6.w(str3, str4);
        boolean b17 = kotlin.jvm.internal.o.b(uk.k.b(str4), str2);
        com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "moveFileToPendingFilePath move, result:" + b17 + "  file: " + str4);
        return b17;
    }
    ...
    public void onAccountInitialized(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "onAccountInitialized");
        try {
            this.f450787f = 0;
            this.f450788g = -1;
            requireAccountInitialized();
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanProductModelResLogic", e17, "resetData", new java.lang.Object[0]);
        }
        java.lang.String Ni = Ni();
        com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "checkFile pendingConfigFilePath : " + Ni);
        if (com.tencent.mm.vfs.w6.j(Ni)) {
            try {
                java.lang.String M = com.tencent.mm.vfs.w6.M(Ni);
                ...
                sb6.append(M);
                com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", sb6.toString());
                if (optJSONArray == null || optJSONArray.length() <= 0) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.ScanProductModelResLogic", "checkFile jsonFile is empty");
                } else {
                    int i17 = 0;
                    do {
                        if (!(i17 < optJSONArray.length())) {
                            Bi();
                            com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "checkFile true");
                            z17 = true;
                            break;
                        }
                        java.lang.Object obj = optJSONArray.get(i17);
                        i17++;
                        kotlin.jvm.internal.o.e(obj, "null cannot be cast to non-null type org.json.JSONObject");
                        str = Ri() + '/' + ((org.json.JSONObject) obj).optString(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
                    } while (com.tencent.mm.vfs.w6.j(str));
                    com.tencent.mars.xlog.Log.e("MicroMsg.ScanProductModelResLogic", "checkFile file not exist. filePath:" + str);
                }
            } catch (java.lang.Exception e18) {
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanProductModelResLogic", e18, "checkFile", new java.lang.Object[0]);
            }
        } else {
            com.tencent.mars.xlog.Log.w("MicroMsg.ScanProductModelResLogic", "checkFile config not exist.");
        }
        z17 = false;
        wz3.l lVar = this.f450785d;
        if (z17) {
        ...
        if (com.tencent.mm.vfs.w6.j(Bi)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ScanProductModelResLogic", "cache file exist " + Bi);
    ...
    public void onAccountReleased(android.content.Context context) {
        kotlin.jvm.internal.o.g(context, "context");
        com.tencent.mars.xlog.Log.e("MicroMsg.ScanProductModelResLogic", "onAccountReleased");
        try {
            this.f450787f = 0;
            this.f450788g = -1;
            requireAccountInitialized();
