...
public final class c {
    ...
    public static final uh2.c f427953a = new uh2.c();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.List f427954b = new java.util.ArrayList();
    ...
    public final void a(java.util.List list) {
        ...
        com.tencent.mars.xlog.Log.i("FinderLiveElementManager", sb6.toString());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        if (list != null) {
            java.util.Iterator it = list.iterator();
            while (it.hasNext()) {
                java.lang.String string = ((r45.h84) it.next()).getString(0);
                if (string != null) {
        ...
        ml2.j0.f327583i.a("accessories_id_list", android.text.TextUtils.join("#", arrayList));
        java.util.List list2 = f427954b;
        ...
        for (java.lang.Object obj : list) {
            ...
            sb7.append(' ');
            com.tencent.mars.xlog.Log.i("FinderLiveElementManager", sb7.toString());
            i17 = i18;
        }
        kotlinx.coroutines.l.d(kotlinx.coroutines.z0.b(), null, null, new uh2.b(null), 3, null);
    }
}
