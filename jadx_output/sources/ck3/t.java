...
public class t {
    ...
    public final android.view.View f42518a;

    /* renamed from: b, reason: collision with root package name */
    public android.animation.Animator f42519b;

    /* renamed from: c, reason: collision with root package name */
    public android.animation.Animator f42520c;
    ...
    public final android.animation.Animator a(int i17, android.animation.AnimatorListenerAdapter animatorListenerAdapter) {
        ...
        float f17 = 1.0f;
        android.view.View view = this.f42518a;
        ...
        ofFloat.setInterpolator(ta5.h.f416879a.a());
        animatorSet.playTogether(ofFloat);
        if (animatorListenerAdapter != null) {
            animatorSet.addListener(animatorListenerAdapter);
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.FloatBallViewAnimationHandler", "anim hide beginAlpha: %s, endAlpha: %s", java.lang.Float.valueOf(f17), java.lang.Float.valueOf(0.0f));
        return animatorSet;
    }

    public final android.animation.Animator b(qn5.a aVar, float f17, float f18) {
        android.animation.AnimatorSet animatorSet = new android.animation.AnimatorSet();
        android.animation.ObjectAnimator ofFloat = android.animation.ObjectAnimator.ofFloat(this.f42518a, "alpha", f17, f18);
        kotlin.jvm.internal.o.f(ofFloat, "ofFloat(...)");
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FloatBallViewAnimationHandler", "anim show beginAlpha: %s, endAlpha: %s", java.lang.Float.valueOf(f17), java.lang.Float.valueOf(f18));
        return animatorSet;
    }
    ...
    public final boolean d() {
        android.animation.Animator animator = this.f42520c;
        if (animator != null) {
    ...
    public final boolean e() {
        android.animation.Animator animator = this.f42519b;
        if (animator != null) {
            return animator.isRunning();
        }
        return false;
    ...
    public final void f(int i17, boolean z17, boolean z18, qn5.a aVar) {
        ...
        if (z17) {
            ...
            this.f42520c = animatorSet;
        } else if (z18) {
            this.f42520c = a(i17, new ck3.r(view, aVar));
        } else {
            ck3.r rVar2 = new ck3.r(view, aVar);
            android.animation.AnimatorSet animatorSet2 = new android.animation.AnimatorSet();
            animatorSet2.addListener(rVar2);
            this.f42520c = animatorSet2;
        }
        android.animation.Animator animator2 = this.f42520c;
        if (animator2 != null) {
            animator2.start();
        }
    }
    ...
    public final void h(boolean z17, qn5.a aVar, float f17, float f18) {
        ...
        if (!((com.tencent.mm.plugin.multitask.i1) i95.n0.c(com.tencent.mm.plugin.multitask.i1.class)).Di()) {
            ...
            float c17 = ((com.tencent.mm.plugin.multitask.p1) ((com.tencent.mm.plugin.multitask.l0) i95.n0.c(com.tencent.mm.plugin.multitask.l0.class))).Ni().c();
