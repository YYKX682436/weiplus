...
public final class j {
    ...
    public static final ck3.j f42489a = new ck3.j();

    /* renamed from: b, reason: collision with root package name */
    public static boolean f42490b;

    public final void a(android.app.Activity activity, android.view.View view, android.widget.TextView textView) {
        com.tencent.mars.xlog.Log.e("MicroMsg.MultiTaskAnimHelper", "dealCancel");
        ...
        android.widget.TextView textView2 = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.hbl);
        if (textView2 != null) {
    ...
    public final void b(android.app.Activity activity, android.view.View view, android.view.View view2) {
        ...
        zk3.c Ai = ((ia0.o) ((ia0.n) i95.n0.c(ia0.n.class))).Ai(activity);
        if (Ai != null) {
            ((com.tencent.mm.plugin.multitask.ui.uic.MultiTaskUIC) Ai).T6(true);
        }
        c();
    }
    ...
    public final void c() {
        ...
        com.tencent.mm.sdk.platformtools.o4.M("multitask_tips_config").putBoolean(((com.tencent.mm.plugin.multitask.i1) i95.n0.c(com.tencent.mm.plugin.multitask.i1.class)).Di() ? "multitask_new_tips_show" : "multitask_tips_show", true);
        com.tencent.mars.xlog.Log.i("MicroMsg.MultiTaskAnimHelper", "finishAnim");
    }
}
