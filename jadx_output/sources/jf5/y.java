...
public final class y extends kotlin.jvm.internal.q implements yz5.p {
    ...
    public final /* synthetic */ com.tencent.mm.ui.chatting.viewitems.mvvmview.markdown.nativeview.selectable.NativeSelectableLayout f299516d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y(com.tencent.mm.ui.chatting.viewitems.mvvmview.markdown.nativeview.selectable.NativeSelectableLayout nativeSelectableLayout) {
        super(2);
        this.f299516d = nativeSelectableLayout;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2) {
        ...
        com.tencent.mm.ui.chatting.viewitems.mvvmview.markdown.nativeview.selectable.NativeSelectableLayout nativeSelectableLayout = this.f299516d;
        if (nativeSelectableLayout.f204673t == null) {
            nativeSelectableLayout.f204673t = nativeSelectableLayout.f204679z;
        ...
        if (iVar == null) {
            iVar = nativeSelectableLayout.f204679z;
        }
        ...
        jf5.n0 n0Var = q0Var.f299498a;
        jf5.i iVar2 = nativeSelectableLayout.f204679z;
        jf5.i iVar3 = jf5.i.f299466d;
        com.tencent.mm.ui.chatting.viewitems.mvvmview.markdown.nativeview.selectable.SelectionHandleView selectionHandleView = nativeSelectableLayout.f204663g;
        if (iVar2 == iVar3) {
            selectionHandleView.setCurrentOffset(n0Var != null ? n0Var.f299485b : 0);
        } else {
            jf5.n0 n0Var2 = q0Var.f299499b;
