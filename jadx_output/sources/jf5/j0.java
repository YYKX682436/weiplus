...
public final class j0 implements jf5.f0 {
    ...
    public final android.widget.TextView f299474a;

    /* renamed from: b, reason: collision with root package name */
    public final jf5.l0 f299475b;

    public j0(android.widget.TextView textView) {
        kotlin.jvm.internal.o.g(textView, "textView");
        this.f299474a = textView;
        this.f299475b = new jf5.l0();
        textView.setTextIsSelectable(false);
    }

    public final jf5.k a(android.text.Spanned spanned, java.util.List list, int i17) {
        java.lang.Object obj;
        q26.h hVar = (q26.h) ((q26.i) q26.h0.i(kz5.n0.J(list), new jf5.g0(spanned, i17))).iterator();
        if (hVar.hasNext()) {
    ...
    public final jf5.k b(android.text.Spanned spanned, java.util.List list, int i17) {
        ...
        if (hVar.hasNext()) {
            next = hVar.next();
            if (hVar.hasNext()) {
                v11.s sVar = ((jf5.k) next).f299476a;
                int i18 = sVar == null ? Integer.MIN_VALUE : sVar.f432461d - sVar.f432460c;
                do {
                    java.lang.Object next2 = hVar.next();
                    v11.s sVar2 = ((jf5.k) next2).f299476a;
                    int i19 = sVar2 == null ? Integer.MIN_VALUE : sVar2.f432461d - sVar2.f432460c;
                    if (i18 < i19) {
                        next = next2;
                        i18 = i19;
                    }
    ...
    public java.lang.CharSequence c() {
        java.lang.CharSequence text = this.f299474a.getText();
    ...
    public java.lang.Integer d(int i17) {
        ...
        if (f17 == 0) {
            ...
            while (it6.hasNext()) {
                v11.s sVar2 = ((jf5.k) it6.next()).f299476a;
                if (sVar2 != null) {
            ...
            if (it8.hasNext()) {
                next2 = it8.next();
                if (it8.hasNext()) {
                    int i18 = ((v11.s) next2).f432460c;
                    do {
                        java.lang.Object next5 = it8.next();
                        int i19 = ((v11.s) next5).f432460c;
                        if (i18 > i19) {
                            next2 = next5;
                            i18 = i19;
                        }
            ...
            if (sVar3 != null) {
                return java.lang.Integer.valueOf(sVar3.f432460c);
            }
            return null;
        }
        if (f17 != c17.length()) {
            ...
            if ((b18 == null && (b18 = a(spanned, arrayList, intValue)) == null) || (sVar = b18.f299476a) == null || !jf5.k0.f(sVar)) {
                return null;
            }
            int spanStart = spanned.getSpanStart(b18);
            return intValue == spanStart ? java.lang.Integer.valueOf(sVar.f432460c) : e(intValue, spanStart, spanned.getSpanEnd(b18), sVar);
        }
        java.util.ArrayList arrayList4 = new java.util.ArrayList();
        java.util.Iterator it9 = arrayList.iterator();
        while (it9.hasNext()) {
            v11.s sVar4 = ((jf5.k) it9.next()).f299476a;
            if (sVar4 != null) {
        ...
        if (it11.hasNext()) {
            next = it11.next();
            if (it11.hasNext()) {
                int i27 = ((v11.s) next).f432461d;
                do {
                    java.lang.Object next7 = it11.next();
                    int i28 = ((v11.s) next7).f432461d;
                    if (i27 < i28) {
                        next = next7;
                        i27 = i28;
                    }
        ...
        if (sVar5 != null) {
            return java.lang.Integer.valueOf(sVar5.f432461d);
        }
        return null;
    }
    ...
    public int f(jf5.i handleType, int i17, boolean z17, boolean z18) {
        ...
        int f17 = e06.p.f(i17, 0, c17.length());
        if (!z17 || !z18 || (ordinal = this.f299475b.f299479a.ordinal()) == 0 || ordinal == 1 || ordinal == 2) {
            return f17;
        }
        throw new jz5.j();
    }
