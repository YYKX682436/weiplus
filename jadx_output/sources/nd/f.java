...
public abstract class f {
    ...
    public static final java.util.LinkedHashMap f336246a;

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f336247b;

    static {
        java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
        f336246a = linkedHashMap;
        nd.a aVar = new nd.a();
        com.tencent.mars.xlog.Log.i("Luggage.Luggage", "plugin:[%s] installed", "luggage-core");
        linkedHashMap.put("luggage-core", aVar);
        f336247b = new java.util.HashMap();
    }
    ...
    public static nd.b a(java.lang.Class cls) {
        ...
        java.util.LinkedHashMap linkedHashMap = f336246a;
        java.util.ListIterator listIterator = new java.util.ArrayList(linkedHashMap.values()).listIterator(linkedHashMap.size());
        while (listIterator.hasPrevious()) {
            if (((nd.c) listIterator.previous()) != null && (map = nd.a.f336244a) != null && ((java.util.concurrent.ConcurrentHashMap) map).get(cls) != null) {
        ...
        com.tencent.mars.xlog.Log.w("Luggage.Luggage", "no customize found for [%s]", cls.getCanonicalName());
        return null;
    }

    public static nd.d b(java.lang.Class cls) {
        java.util.Map map = f336247b;
    ...
    public static nd.d d(java.lang.Class cls, boolean z17) {
        ...
        java.util.ListIterator listIterator = new java.util.ArrayList(linkedHashMap.values()).listIterator(linkedHashMap.size());
        while (listIterator.hasPrevious()) {
            if (((nd.c) listIterator.previous()) != null && (map = nd.a.f336245b) != null && ((java.util.concurrent.ConcurrentHashMap) map).get(cls) != null) {
                return (nd.d) ((java.util.concurrent.ConcurrentHashMap) map).get(cls);
            }
        }
        com.tencent.mars.xlog.Log.w("Luggage.Luggage", "no profiler found for [%s], genDummy[%b]", cls.getCanonicalName(), java.lang.Boolean.valueOf(z17));
        if (z17) {
            return b(cls);
        }
        return null;
    ...
    public static void e(java.lang.Class cls, nd.b bVar) {
        ...
        ((nd.a) ((nd.c) f336246a.get("luggage-core"))).getClass();
        ((java.util.concurrent.ConcurrentHashMap) nd.a.f336244a).put(cls, bVar);
    }
    ...
    public static void f(java.lang.Class cls, nd.d dVar) {
        ...
        ((nd.a) ((nd.c) f336246a.get("luggage-core"))).getClass();
        ((java.util.concurrent.ConcurrentHashMap) nd.a.f336245b).put(cls, dVar);
    }
}
