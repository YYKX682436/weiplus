...
public class b0 extends androidx.recyclerview.widget.o3 {

    /* renamed from: s, reason: collision with root package name */
    public static android.animation.TimeInterpolator f395692s;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.ArrayList f395693h = new java.util.ArrayList();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.ArrayList f395694i = new java.util.ArrayList();

    /* renamed from: j, reason: collision with root package name */
    public final java.util.ArrayList f395695j = new java.util.ArrayList();

    /* renamed from: k, reason: collision with root package name */
    public final java.util.ArrayList f395696k = new java.util.ArrayList();

    /* renamed from: l, reason: collision with root package name */
    public final java.util.ArrayList f395697l = new java.util.ArrayList();

    /* renamed from: m, reason: collision with root package name */
    public final java.util.ArrayList f395698m = new java.util.ArrayList();

    /* renamed from: n, reason: collision with root package name */
    public final java.util.ArrayList f395699n = new java.util.ArrayList();

    /* renamed from: o, reason: collision with root package name */
    public final java.util.ArrayList f395700o = new java.util.ArrayList();

    /* renamed from: p, reason: collision with root package name */
    public final java.util.ArrayList f395701p = new java.util.ArrayList();

    /* renamed from: q, reason: collision with root package name */
    public final java.util.ArrayList f395702q = new java.util.ArrayList();

    /* renamed from: r, reason: collision with root package name */
    public final java.util.ArrayList f395703r = new java.util.ArrayList();
    ...
    public final void F(java.util.List list, androidx.recyclerview.widget.k3 k3Var) {
        for (int size = list.size() - 1; size >= 0; size--) {
            ...
            if (G(zVar, k3Var) && zVar.f395808a == null && zVar.f395809b == null) {
                list.remove(zVar);
            }
        }
    }

    public final boolean G(rh4.z zVar, androidx.recyclerview.widget.k3 k3Var) {
        if (zVar.f395809b == k3Var) {
            zVar.f395809b = null;
        } else {
            if (zVar.f395808a != k3Var) {
                return false;
            }
            zVar.f395808a = null;
        }
    ...
    public final void H(androidx.recyclerview.widget.k3 k3Var) {
        if (f395692s == null) {
            f395692s = new android.animation.ValueAnimator().getInterpolator();
        }
        k3Var.itemView.animate().setInterpolator(f395692s);
        j(k3Var);
    }
    ...
    public void j(androidx.recyclerview.widget.k3 k3Var) {
        android.view.View view = k3Var.itemView;
        view.animate().cancel();
        java.util.ArrayList arrayList = this.f395695j;
        ...
        while (true) {
            ...
            if (((rh4.a0) arrayList.get(size)).f395685a == k3Var) {
        ...
        F(this.f395696k, k3Var);
        float f17 = 1.0f;
        if (this.f395693h.remove(k3Var)) {
        ...
        java.util.ArrayList arrayList4 = this.f395699n;
        ...
        java.util.ArrayList arrayList6 = this.f395698m;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (((rh4.a0) arrayList7.get(size4)).f395685a == k3Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    x(k3Var);
        ...
        java.util.ArrayList arrayList8 = this.f395697l;
        ...
        this.f395702q.remove(k3Var);
        this.f395700o.remove(k3Var);
        this.f395703r.remove(k3Var);
        this.f395701p.remove(k3Var);
        E();
    }
    ...
    public void k() {
        ...
        while (true) {
            ...
            android.view.View view = a0Var.f395685a.itemView;
            view.setTranslationY(0.0f);
            view.setTranslationX(0.0f);
            x(a0Var.f395685a);
            arrayList.remove(size);
        }
        java.util.ArrayList arrayList2 = this.f395693h;
        ...
        java.util.ArrayList arrayList3 = this.f395694i;
        ...
        java.util.ArrayList arrayList5 = this.f395696k;
        ...
        while (true) {
            ...
            androidx.recyclerview.widget.k3 k3Var2 = zVar.f395808a;
            if (k3Var2 != null) {
                G(zVar, k3Var2);
            }
            androidx.recyclerview.widget.k3 k3Var3 = zVar.f395809b;
            if (k3Var3 != null) {
                G(zVar, k3Var3);
            }
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (size6 >= 0) {
                    ...
                    android.view.View view3 = a0Var2.f395685a.itemView;
        ...
        java.util.ArrayList arrayList11 = this.f395699n;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (size10 >= 0) {
                    ...
                    androidx.recyclerview.widget.k3 k3Var5 = zVar2.f395808a;
                    if (k3Var5 != null) {
                        G(zVar2, k3Var5);
                    }
                    androidx.recyclerview.widget.k3 k3Var6 = zVar2.f395809b;
                    if (k3Var6 != null) {
                        G(zVar2, k3Var6);
                    }
    ...
    @Override // androidx.recyclerview.widget.n2
    public boolean o() {
        return (this.f395694i.isEmpty() && this.f395696k.isEmpty() && this.f395695j.isEmpty() && this.f395693h.isEmpty() && this.f395701p.isEmpty() && this.f395702q.isEmpty() && this.f395700o.isEmpty() && this.f395703r.isEmpty() && this.f395698m.isEmpty() && this.f395697l.isEmpty() && this.f395699n.isEmpty()) ? false : true;
    }

    @Override // androidx.recyclerview.widget.n2
    public void s() {
        java.util.ArrayList arrayList = this.f395693h;
        boolean z17 = !arrayList.isEmpty();
        java.util.ArrayList arrayList2 = this.f395695j;
        boolean z18 = !arrayList2.isEmpty();
        java.util.ArrayList arrayList3 = this.f395696k;
        boolean z19 = !arrayList3.isEmpty();
        java.util.ArrayList arrayList4 = this.f395694i;
        ...
        if (z17 || z18 || z27 || z19) {
            ...
            if (z18) {
                ...
                this.f395698m.add(arrayList5);
                arrayList2.clear();
                rh4.r rVar = new rh4.r(this, arrayList5);
                if (z17) {
                    android.view.View view2 = ((rh4.a0) arrayList5.get(0)).f395685a.itemView;
            ...
            if (z19) {
                ...
                this.f395699n.add(arrayList6);
                arrayList3.clear();
                rh4.s sVar = new rh4.s(this, arrayList6);
                if (z17) {
                    android.view.View view3 = ((rh4.z) arrayList6.get(0)).f395808a.itemView;
    ...
    public boolean t(androidx.recyclerview.widget.k3 k3Var) {
        ...
        k3Var.itemView.setScaleX(0.75f);
        k3Var.itemView.setScaleY(0.75f);
        this.f395694i.add(k3Var);
        return true;
    }
    ...
    public boolean u(androidx.recyclerview.widget.k3 k3Var, androidx.recyclerview.widget.k3 k3Var2, int i17, int i18, int i19, int i27) {
        ...
        this.f395696k.add(new rh4.z(k3Var, k3Var2, i17, i18, i19, i27));
        return true;
    }
    ...
    public boolean v(androidx.recyclerview.widget.k3 k3Var, int i17, int i18, int i19, int i27) {
        ...
        this.f395695j.add(new rh4.a0(k3Var, translationX, translationY, i19, i27));
        return true;
    }
