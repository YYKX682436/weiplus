...
public class b {
    ...
    public final java.util.List f432153a = new java.util.ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public final int f432154b;
    ...
    public final void a() {
        java.util.Iterator it = ((java.util.ArrayList) this.f432153a).iterator();
        while (it.hasNext()) {
    ...
    public java.lang.Object c(android.view.View view) {
        ...
        a();
        if (!b(view) || (tag = view.getTag(this.f432154b)) == null) {
            return null;
        }
        return tag;
    }
    ...
    public void d(android.view.View view, java.lang.Object obj) {
        ...
        a();
        boolean b17 = b(view);
        int i17 = this.f432154b;
        java.util.List list = this.f432153a;
        if (b17) {
