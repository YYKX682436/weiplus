...
public abstract class g {
    ...
    public static final /* synthetic */ int f351721a = 0;
    ...
    public static long a(l36.a1 a1Var) {
        java.lang.String c17 = a1Var.f315460i.c("Content-Length");
        if (c17 != null) {
            try {
    ...
    public static boolean b(l36.a1 a1Var) {
        if (a1Var.f315455d.f315682b.equals("HEAD")) {
            return false;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:238:0x01c3, code lost:
        ...
        if ((r0.equals(r14) || (r0.endsWith(r14) && r0.charAt((r0.length() - r14.length()) - 1) == '.' && !m36.e.f323393h.matcher(r0).matches())) == false) goto L25;
     */
