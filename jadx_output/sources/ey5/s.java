...
public class s implements com.tencent.tencentmap.mapsdk.map.IMapView {

    /* renamed from: d, reason: collision with root package name */
    public final com.tencent.tencentmap.mapsdk.maps.TextureMapView f257682d;

    /* renamed from: e, reason: collision with root package name */
    public final com.tencent.tencentmap.mapsdk.map.TencentMap f257683e;

    public s(android.content.Context context, com.tencent.tencentmap.mapsdk.map.TencentMapOptions tencentMapOptions) {
        ...
        if (tencentMapOptions != null) {
            ...
            if (tencentMapOptions.isEnableLogger()) {
                com.tencent.mars.xlog.Log.i("MicroMsg.Map.VectorTextureMapView", "initLogger");
                ...
                newBuilder.level(4);
                newBuilder.logCallback(new com.tencent.tencentmap.mapsdk.maps.model.LoggerConfig.LogCallback() { // from class: ey5.s$$a
                    @Override // com.tencent.tencentmap.mapsdk.maps.model.LoggerConfig.LogCallback
                    public final void onLog(java.lang.String str) {
                        ey5.s.this.getClass();
                        com.tencent.mars.xlog.Log.i("MicroMsg.Map.VectorTextureMapView", "" + str);
                    }
                });
        ...
        com.tencent.tencentmap.mapsdk.maps.TextureMapView textureMapView = new com.tencent.tencentmap.mapsdk.maps.TextureMapView(context, tencentMapOptions2);
        this.f257682d = textureMapView;
        this.f257683e = new ey5.r(textureMapView.getMap());
    ...
    public void addView(android.view.View view, com.tencent.tencentmap.mapsdk.map.MapView.LayoutParams layoutParams) {
        com.tencent.tencentmap.mapsdk.maps.TextureMapView textureMapView = this.f257682d;
        if (textureMapView.getMap() != null) {
            textureMapView.getMap().addMarker(new com.tencent.tencentmap.mapsdk.maps.model.MarkerOptions().icon(com.tencent.tencentmap.mapsdk.maps.model.BitmapDescriptorFactory.fromView(view)).position(ey5.x.f(layoutParams.point)));
        }
    }
    ...
    public boolean dispatchTouchEvent(android.view.MotionEvent motionEvent) {
        ...
        return textureMapView.dispatchTouchEvent(motionEvent) || textureMapView.onTouchEvent(motionEvent);
    }

    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public com.tencent.tencentmap.mapsdk.map.TencentMap getMap() {
        return this.f257683e;
    }
    ...
    public android.view.View getMapView() {
        return this.f257682d;
    }

    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public com.tencent.tencentmap.mapsdk.map.Projection getProjection() {
        com.tencent.tencentmap.mapsdk.map.TencentMap tencentMap = this.f257683e;
        if (tencentMap != null) {
    ...
    public com.tencent.tencentmap.mapsdk.map.UiSettings getUiSettings() {
        com.tencent.tencentmap.mapsdk.maps.TextureMapView textureMapView = this.f257682d;
        if (textureMapView.getMap() != null) {
            return new ey5.y(textureMapView.getMap().getUiSettings());
        }
        return null;
    }
    ...
    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public void onPause() {
        this.f257682d.onPause();
    }

    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public void onRestart() {
        this.f257682d.onRestart();
    }

    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public void onResume() {
        this.f257682d.onResume();
    }
    ...
    public void onSizeChanged(int i17, int i18, int i19, int i27) {
        com.tencent.tencentmap.mapsdk.maps.TextureMapView textureMapView = this.f257682d;
        if (textureMapView != null) {
            textureMapView.onSizeChanged(i17, i18, i19, i27);
        }
    }

    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public void onStart() {
        this.f257682d.onStart();
    }

    @Override // com.tencent.tencentmap.mapsdk.map.IMapView
    public void onStop() {
        this.f257682d.onStop();
    }
    ...
    public void onSurfaceChanged(java.lang.Object obj, int i17, int i18) {
        com.tencent.tencentmap.mapsdk.maps.TextureMapView textureMapView = this.f257682d;
        if (textureMapView != null) {
            textureMapView.onSurfaceChanged(obj, i17, i18);
        }
    }
