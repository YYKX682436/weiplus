...
public final class q0 implements gm5.a {
    ...
    public final /* synthetic */ android.content.Intent f460523a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f460524b;

    public q0(android.content.Intent intent, android.content.Context context) {
        this.f460523a = intent;
        this.f460524b = context;
    }
    ...
    public java.lang.Object call(java.lang.Object obj) {
        ...
        android.content.Context context = this.f460524b;
        if ((i17 == 0 && fVar.f70616b == 0) || hc2.p.b(i17, fVar.f70616b)) {
            ...
            android.content.Intent intent = this.f460523a;
