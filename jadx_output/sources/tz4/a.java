...
public class a implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ tz4.i f423337d;
    ...
    public void onClick(android.view.View view) {
        ...
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/wenote/ui/nativenote/toolview/WNToolBarAdapter$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, array);
        tz4.i iVar = this.f423337d;
        if (iVar.f423346f.get() != null) {
            ...
            if (hVar != null) {
                ...
                favoriteNoteClickReportStruct.f56344d = 7;
            ...
            boolean z17 = !noteEditorUI.l7(oz4.b.class);
            oz4.b bVar = oz4.w.f350315a;
            java.lang.Boolean valueOf = java.lang.Boolean.valueOf(z17);
            mz4.j0 j0Var = noteEditorUI.f188147m;
            if (j0Var != null) {
                j0Var.g(bVar, valueOf);
            }
            noteEditorUI.z7(true, 50L);
            noteEditorUI.y7(1, 0L);
        }
        yj0.a.h(this, "com/tencent/mm/plugin/wenote/ui/nativenote/toolview/WNToolBarAdapter$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
