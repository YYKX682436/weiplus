...
public class f implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ tz4.i f423342d;
    ...
    public void onClick(android.view.View view) {
        ...
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/wenote/ui/nativenote/toolview/WNToolBarAdapter$6", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, array);
        tz4.i iVar = this.f423342d;
        if (iVar.f423346f.get() != null) {
            ...
            if (hVar != null) {
                ...
                favoriteNoteClickReportStruct.f56344d = 11;
            ...
            boolean z17 = !noteEditorUI.l7(oz4.k.class);
            oz4.k kVar = oz4.w.f350317c;
            java.lang.Boolean valueOf = java.lang.Boolean.valueOf(z17);
            mz4.j0 j0Var = noteEditorUI.f188147m;
            if (j0Var != null) {
                j0Var.g(kVar, valueOf);
            }
            noteEditorUI.E7();
            noteEditorUI.z7(true, 50L);
            noteEditorUI.y7(1, 0L);
        }
        yj0.a.h(this, "com/tencent/mm/plugin/wenote/ui/nativenote/toolview/WNToolBarAdapter$6", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
