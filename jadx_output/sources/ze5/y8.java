...
public abstract class y8 {
    public static final ze5.na a(yz5.p creator, yz5.r binder, yz5.p shown) {
        ...
        kotlin.jvm.internal.o.g(shown, "shown");
        return new ze5.x8(creator, binder, shown);
    }

    public static final void b(java.util.List list, android.widget.LinearLayout viewArea, yb5.d ui6, rd5.d msgData, com.tencent.mm.ui.chatting.viewitems.g0 holder) {
        ...
        while (it6.hasNext()) {
            ...
            if (((java.lang.Boolean) x8Var2.f472301c.invoke(ui6, msgData)).booleanValue()) {
                ...
                if (view != null) {
                    i17 = com.tencent.mm.R.id.uje;
                    str = name;
                    if (kotlin.jvm.internal.o.b(view.getTag(com.tencent.mm.R.id.uje), str)) {
                        x8Var = x8Var2;
                        ...
                        x8Var.f472300b.C(childAt, ui6, msgData, holder);
                        i19++;
                    }
                } else {
                    str = name;
                ...
                x8Var = x8Var2;
                android.view.View view2 = (android.view.View) x8Var.f472299a.invoke(ui6, viewArea);
                ...
                x8Var.f472300b.C(childAt2, ui6, msgData, holder);
                i19++;
            } else {
                it = it6;
                android.view.View view3 = (android.view.View) q26.h0.h(new n3.r1(viewArea), i19);
                if (kotlin.jvm.internal.o.b(view3 != null ? view3.getTag(com.tencent.mm.R.id.uje) : null, name) && view3 != null) {
