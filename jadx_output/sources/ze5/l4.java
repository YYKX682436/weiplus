...
public class l4 extends ze5.w8 {
    ...
    public boolean Q(db5.g4 menu, android.view.View v17, rd5.d msgData) {
        ...
        kotlin.jvm.internal.o.g(msgData, "msgData");
        com.tencent.mm.storage.f9 f9Var = msgData.f394254d.f445300b;
        if (f9Var == null || (dVar = this.f472066s) == null) {
            return false;
        }
    ...
    public com.tencent.mm.mvvm.MvvmView d0(android.content.Context context) {
        ...
        x17.setBackgroundResource(com.tencent.mm.R.drawable.f481182mi);
        x17.setForeground(context.getResources().getDrawable(com.tencent.mm.R.drawable.f481145lu));
