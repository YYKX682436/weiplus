...
public final class p7 extends ze5.w8 {
    ...
    public void d(android.view.View view, yb5.d dVar, com.tencent.mm.storage.f9 f9Var) {
        ...
        db5.e1.A(dVar.g(), dVar.s().getString(com.tencent.mm.R.string.b5h), "", dVar.s().getString(com.tencent.mm.R.string.f490543y2), dVar.s().getString(com.tencent.mm.R.string.f490347sg), new ze5.n7(f9Var, dVar), ze5.o7.f472131d);
    }
    ...
    public com.tencent.mm.mvvm.MvvmView d0(android.content.Context context) {
        ...
        l17.setBackgroundResource(com.tencent.mm.R.drawable.f481244ob);
        l17.setForeground(context.getResources().getDrawable(com.tencent.mm.R.drawable.f481171me));
