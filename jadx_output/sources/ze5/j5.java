...
public class j5 extends ze5.w8 {
    ...
    public boolean Q(db5.g4 menu, android.view.View v17, rd5.d msgData) {
        ...
        kotlin.jvm.internal.o.g(msgData, "msgData");
        com.tencent.mm.storage.f9 f9Var = msgData.f394254d.f445300b;
        if (f9Var == null || (dVar = this.f472030s) == null) {
            return false;
        }
    ...
    public void d(android.view.View view, yb5.d dVar, com.tencent.mm.storage.f9 f9Var) {
        ...
        db5.e1.A(dVar.g(), dVar.s().getString(com.tencent.mm.R.string.b5h), "", dVar.s().getString(com.tencent.mm.R.string.f490543y2), dVar.s().getString(com.tencent.mm.R.string.f490347sg), new ze5.h5(f9Var, dVar), new ze5.i5());
    }
    ...
    public com.tencent.mm.mvvm.MvvmView d0(android.content.Context context) {
        ...
        q17.setBackgroundResource(com.tencent.mm.R.drawable.f481244ob);
        q17.setForeground(context.getResources().getDrawable(com.tencent.mm.R.drawable.f481171me));
