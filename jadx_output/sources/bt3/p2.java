...
public class p2 implements dn.k {
    ...
    public final /* synthetic */ r45.gp0 f24368d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f24369e;
    ...
    public int r4(java.lang.String str, int i17, dn.g gVar, dn.h hVar, boolean z17) {
        boolean z18;
        java.lang.String str2 = this.f24369e;
        r45.gp0 gp0Var = this.f24368d;
        if (i17 == 0 && hVar != null && hVar.field_retCode == 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg.RecordMsgSendService", "[record] downloadTpUrl done id:%s, mediaId:%s, path:%s", gp0Var.T, str, str2);
            z18 = true;
        } else {
            z18 = false;
        }
        if (i17 != 0 || (hVar != null && hVar.field_retCode != 0)) {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.RecordMsgSendService", "[record] downloadTpUrl error id:%s, mediaId:%s, path:%s, err:(%d,%d)", objArr);
            z18 = true;
        }
        if (z18) {
            ...
            if (D0 == null) {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.RecordMsgSendService", "[record] downloadTpUrl error id:%s, mediaId:%s, tempMediaId:%s, path:%s, err:(%d,%d), cdnInfo==null", objArr2);
                return 0;
            }
            D0.field_status = 0;
