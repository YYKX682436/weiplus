...
public final class g extends y10.a {
    ...
    public void b(pq.a context, bw5.x7 jumpInfo, t10.d callback) {
        ...
        com.tencent.mars.xlog.Log.i("ECS_O.NativeHandler.GiftLottery", "launch mp lottery with params: " + jumpInfo.g().b().f192156a.length);
        ...
        if (context.f357553c != null) {
            ...
            com.tencent.mars.xlog.Log.i("ECS_O.NativeHandler.GiftLottery", "set open event callback, eventId:" + wi6);
