...
public final class d0 extends com.google.protobuf.q5 implements com.google.protobuf.r8 {
    ...
    public java.util.List f250117e;

    /* renamed from: f, reason: collision with root package name */
    public com.google.protobuf.p9 f250118f;

    public d0(e83.a aVar) {
        super(null);
        boolean z17;
        this.f250117e = java.util.Collections.emptyList();
    ...
    public com.google.protobuf.k8 build() {
        e83.e0 buildPartial = buildPartial();
    ...
    public e83.e0 buildPartial() {
        e83.e0 e0Var = new e83.e0(this, null);
        int i17 = this.f250116d;
        com.google.protobuf.p9 p9Var = this.f250118f;
        if (p9Var == null) {
            if ((i17 & 1) != 0) {
                this.f250117e = java.util.Collections.unmodifiableList(this.f250117e);
                this.f250116d &= -2;
            }
            e0Var.f250126d = this.f250117e;
        } else {
            e0Var.f250126d = p9Var.g();
        }
        onBuilt();
        return e0Var;
    }
    ...
    public java.lang.Object clone() {
        return (e83.d0) m83clone();
    }

    public final com.google.protobuf.p9 d() {
        if (this.f250118f == null) {
            this.f250118f = new com.google.protobuf.p9(this.f250117e, (this.f250116d & 1) != 0, getParentForChildren(), isClean());
            this.f250117e = null;
        }
        return this.f250118f;
    }
    ...
    */
    public e83.d0 e(com.google.protobuf.d0 r2, com.google.protobuf.t4 r3) {
        /*
            r1 = this;
            com.google.protobuf.e9 r0 = e83.e0.f250125g     // Catch: java.lang.Throwable -> Le com.google.protobuf.y6 -> L10
            e83.c0 r0 = (e83.c0) r0     // Catch: java.lang.Throwable -> Le com.google.protobuf.y6 -> L10
            java.lang.Object r2 = r0.parsePartialFrom(r2, r3)     // Catch: java.lang.Throwable -> Le com.google.protobuf.y6 -> L10
            e83.e0 r2 = (e83.e0) r2     // Catch: java.lang.Throwable -> Le com.google.protobuf.y6 -> L10
            r1.f(r2)
            return r1
        Le:
            r2 = move-exception
    ...
    public e83.d0 f(e83.e0 e0Var) {
        ...
        if (e0Var == e83.e0.f250124f) {
            return this;
        }
        if (this.f250118f == null) {
            if (!e0Var.f250126d.isEmpty()) {
                if (this.f250117e.isEmpty()) {
                    this.f250117e = e0Var.f250126d;
                    this.f250116d &= -2;
                } else {
                    if ((this.f250116d & 1) == 0) {
                        this.f250117e = new java.util.ArrayList(this.f250117e);
                        this.f250116d |= 1;
                    }
                    this.f250117e.addAll(e0Var.f250126d);
                }
                onChanged();
            }
        } else if (!e0Var.f250126d.isEmpty()) {
            if (this.f250118f.p()) {
                this.f250118f.f45409a = null;
                this.f250118f = null;
                this.f250117e = e0Var.f250126d;
                this.f250116d &= -2;
                z17 = com.google.protobuf.l6.alwaysUseFieldBuilders;
                this.f250118f = z17 ? d() : null;
            } else {
                this.f250118f.b(e0Var.f250126d);
            }
        }
    ...
    public com.google.protobuf.k8 getDefaultInstanceForType() {
        return e83.e0.f250124f;
    }

    @Override // com.google.protobuf.j8, com.google.protobuf.r8
    public com.google.protobuf.r3 getDescriptorForType() {
        return e83.o0.f250209o;
    }
    ...
    public com.google.protobuf.a m84mergeUnknownFields(com.google.protobuf.wa waVar) {
        return (e83.d0) m84mergeUnknownFields(waVar);
    }
    ...
    public d0(com.google.protobuf.r5 r5Var, e83.a aVar) {
        super(r5Var);
        boolean z17;
        this.f250117e = java.util.Collections.emptyList();
        z17 = com.google.protobuf.l6.alwaysUseFieldBuilders;
