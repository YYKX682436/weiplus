...
public class a extends java.io.InputStream {
    ...
    public final java.nio.ByteBuffer f360285d;

    /* renamed from: e, reason: collision with root package name */
    public int f360286e = -1;

    public a(java.nio.ByteBuffer byteBuffer) {
        this.f360285d = byteBuffer;
    }

    @Override // java.io.InputStream
    public int available() {
        return this.f360285d.remaining();
    }

    @Override // java.io.InputStream
    public synchronized void mark(int i17) {
        this.f360286e = this.f360285d.position();
    }
    ...
    @Override // java.io.InputStream
    public int read() {
        java.nio.ByteBuffer byteBuffer = this.f360285d;
