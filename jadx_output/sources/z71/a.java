...
public abstract class a {
    public static boolean a(com.tencent.mm.pointers.PFloat pFloat) {
        ...
        if (registerReceiver == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.AiDeviceData", "get battery charge intent is null");
            return false;
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.AiDeviceData", "get battery charge and level charging[%b] level[%f]", java.lang.Boolean.valueOf(z17), java.lang.Float.valueOf(pFloat.value));
        return z17;
    }
    ...
    public static int c() {
        ...
        if (hVar.e()) {
            ...
            java.lang.Boolean bool = oVar.f356833e;
            if (bool != null) {
                bool.booleanValue();
                ((ku5.t0) ku5.t0.f312615d).h(new pm1.k(oVar), oVar.f356829a);
                ...
                oVar.f356833e = java.lang.Boolean.valueOf(isWiredHeadsetOn2);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.AiDeviceData", "get current audio mode [%d]", java.lang.Integer.valueOf(i17));
        return i17;
    }
}
