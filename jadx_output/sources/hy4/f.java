...
public abstract class f {
    public static boolean a(hy4.e eVar) {
        java.lang.String str = (java.lang.String) ((java.util.HashMap) eVar.f286098b).get("Content-Type");
        if (str == null) {
            java.util.Map map = eVar.f286098b;
    ...
    public static void b(java.io.Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                com.tencent.mm.sdk.platformtools.Log.c("MicroMsg.RequestUtil", "", e17);
            } catch (java.lang.Exception e18) {
                com.tencent.mm.sdk.platformtools.Log.c("MicroMsg.RequestUtil", "", e18);
            }
        }
    }
        ...
        while (true) {
            try {
                try {
                    ...
                    com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", "convertStreamToBytes: " + e17);
                    com.tencent.mm.sdk.platformtools.t8.v1(inputStream);
                    return null;
                }
    ...
    public static hy4.e f(java.lang.String str, java.util.Map map, java.lang.String str2) {
        ...
        try {
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e17.getMessage());
                return null;
            }
            try {
                ...
                if (responseCode == 200) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e18.getMessage());
                        }
                        try {
                            httpURLConnection.disconnect();
                        } catch (java.lang.Exception e19) {
                            com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e19.getMessage());
                        }
                        return null;
                ...
                while (true) {
                    ...
                    if (headerFieldKey == null && headerField == null) {
                        try {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e27.getMessage());
                        }
                    } else {
                        ((java.util.HashMap) eVar.f286098b).put(headerFieldKey, headerField);
                        i17++;
                    }
                }
                httpURLConnection.getInputStream().close();
                try {
                    ...
                    com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e28.getMessage());
                }
                return eVar;
            } catch (java.net.MalformedURLException e29) {
                e = e29;
                com.tencent.mm.sdk.platformtools.Log.c("MicroMsg.RequestUtil", "", e);
                if (httpURLConnection != null) {
                    try {
                        httpURLConnection.getInputStream().close();
                    } catch (java.lang.Exception e37) {
                        com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e37.getMessage());
                    }
                    httpURLConnection.disconnect();
                }
                return null;
                ...
                if (httpURLConnection != null) {
                    try {
                        ...
                        com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e39.getMessage());
                    }
                    httpURLConnection.disconnect();
                }
                return null;
                ...
                if (httpURLConnection != null) {
                    try {
                        ...
                        com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e48.getMessage());
                    }
                    httpURLConnection.disconnect();
                }
                return null;
            ...
            if (r27 != 0) {
                try {
                    ...
                    com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e59.getMessage());
                }
                try {
                    r27.disconnect();
                } catch (java.lang.Exception e66) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.RequestUtil", e66.getMessage());
                }
            }
            throw th;
        }
