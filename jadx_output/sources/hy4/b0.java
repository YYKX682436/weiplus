...
public abstract class b0 {
    public static int a(android.content.Context context) {
        context.getSharedPreferences(com.tencent.mm.sdk.platformtools.x2.e(), 0);
    ...
    public static int b(android.content.Context context, com.tencent.mm.plugin.webview.stub.v0 v0Var, java.lang.String str) {
        com.tencent.mm.sdk.platformtools.o4 N;
        boolean z17;
        boolean c17;
        int i17 = 2;
        try {
            N = com.tencent.mm.sdk.platformtools.o4.N("WebViewFontUtil", 2, null);
            z17 = N.getBoolean("webview_key_font_use_system", false);
            c17 = c(str);
            com.tencent.mars.xlog.Log.i("MicroMsg.WebViewFontUtil", "useSystemFont = %b", java.lang.Boolean.valueOf(z17));
        } catch (java.lang.Exception e17) {
            e = e17;
        }
        if (!z17 && !c17) {
            boolean z18 = N.getBoolean("webview_key_font_has_set", false);
            if (com.tencent.mm.sdk.platformtools.t8.K0(str) || !cw4.a.f224192a.matcher(str).matches()) {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WebViewFontUtil", "onLoadJsApiFinished, ex = " + e.getMessage());
            return i17;
        }
        return a(context);
    }
