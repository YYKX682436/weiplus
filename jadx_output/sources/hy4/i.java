...
public abstract class i {
    ...
    public static final java.lang.String a(java.lang.String str, r45.zb5 session) {
        ...
        if (!r26.n0.B(str, "" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "", false)) {
            return str;
        }
        boolean z17 = session.f391890o;
        boolean z18 = z17;
        if (session.f391891p) {
            z18 = (z17 ? 1 : 0) | 2;
        }
        ...
        java.lang.String b17 = b(b(b(b(b(str, "sessionid", java.lang.String.valueOf(session.f391882d)), "subscene", java.lang.String.valueOf(session.f391887i)), com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, java.lang.String.valueOf(session.f391886h)), "ascene", java.lang.String.valueOf(session.f391888m)), "fasttmpl_type", java.lang.String.valueOf(session.f391885g));
        java.lang.String uid = session.f391889n;
    ...
    public static final java.lang.String b(java.lang.String str, java.lang.String param, java.lang.String value) {
        ...
        if (r26.n0.D(str2, param.concat("="), false, 2, null)) {
            sb6 = g(param).f368917d.matcher(str2).replaceFirst(value);
            kotlin.jvm.internal.o.f(sb6, "replaceFirst(...)");
        } else {
    ...
    public static final java.lang.String c(java.lang.String rawUrl, boolean z17) {
        ...
        return r26.n0.v0(e(rawUrl, "sessionid", "subscene", com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, "ascene", "enterid", "clicktime", "fasttmpl_type", "fasttmpl_fullversion", "fasttmpl_flag", "realreporttime", "reporttime", "from"), '?', '&') + str;
    }
    ...
    public static final java.lang.String e(java.lang.String str, java.lang.String... param) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("String", "clearUrlParams:" + e17.getMessage() + ", " + param + ", " + str);
        }
    ...
    public static final r26.t g(java.lang.String str) {
        jz5.g gVar = hy4.y.f286205a;
        if (((java.lang.Boolean) ((jz5.n) hy4.y.f286205a).getValue()).booleanValue()) {
    ...
    public static final boolean i(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fxy) + '/', false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fxy) + '/', false)) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean j(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/mp/appmsgalbum?", false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/mp/appmsgalbum?", false)) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean k(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/mp/appmsg/show?", false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/mp/appmsg/show?", false)) {
                if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/showappmsg? ", false)) {
                    if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/showappmsg?", false)) {
                        return false;
                    }
                }
            }
    ...
    public static final boolean l(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/s?", false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/s?", false)) {
                if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/s/", false)) {
                    if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/s/", false)) {
                        return false;
                    }
    ...
    public static final boolean m(java.lang.String str) {
        ...
        java.lang.String[] strArr2 = {com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9), "bc.weixin.qq.com"};
    ...
    public static final boolean n(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/recweb/clientjump?", false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/recweb/clientjump?", false)) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean o(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/tp/", false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + "/tp/", false)) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean p(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<this>");
        if (!r26.i0.y(str, "https://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + '/', false)) {
            if (!r26.i0.y(str, "http://" + com.tencent.mm.sdk.platformtools.t9.a(com.tencent.mm.R.string.fy9) + '/', false)) {
                return false;
            }
        }
        return true;
