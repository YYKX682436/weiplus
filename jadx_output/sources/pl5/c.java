...
public abstract class c {
    ...
    public static final android.text.SpannableStringBuilder a(android.text.SpannableStringBuilder builder, int i17, int i18, int i19, yz5.p hasEmoji) {
        ...
        kotlin.jvm.internal.o.g(hasEmoji, "hasEmoji");
        int length = builder.length() - i17;
        java.lang.Object[] objArr = i18 == i19;
        int i27 = i19 + 1;
        if (i18 < 0 || i19 > length) {
            com.tencent.mars.xlog.Log.e("MessageTruncateGradient", "invalid input,content size = " + builder.length() + ",colonIndex = " + i17 + ",contentStart = " + i18 + ",contentEnd = {" + i19 + '}');
            return builder;
        }
        android.text.SpannableStringBuilder spannableStringBuilder = new android.text.SpannableStringBuilder();
        spannableStringBuilder.append(builder.subSequence(0, i17));
        pl5.b bVar2 = pl5.b.f356739d;
        ...
        if (i18 > 0 && i27 < length) {
            ...
            if (b(spannableStringBuilder2, i28)) {
                int i29 = i28 - 1;
                if (b(spannableStringBuilder2, i29) && !((java.lang.Boolean) hasEmoji.invoke(java.lang.Integer.valueOf(i29), java.lang.Integer.valueOf(i28 + 1))).booleanValue()) {
                    z18 = false;
                    int i37 = i18 + i17;
                    int i38 = i37 - 1;
                    z17 = b(spannableStringBuilder2, i38) || !b(spannableStringBuilder2, i37) || ((java.lang.Boolean) hasEmoji.invoke(java.lang.Integer.valueOf(i38), java.lang.Integer.valueOf(i37 + 1))).booleanValue();
            ...
            if (b(spannableStringBuilder2, i39)) {
                int i47 = i39 - 1;
                if (b(spannableStringBuilder2, i47) && !((java.lang.Boolean) hasEmoji.invoke(java.lang.Integer.valueOf(i47), java.lang.Integer.valueOf(i39 + 1))).booleanValue()) {
                    z18 = false;
            ...
            int i48 = i18 + i17;
            int i49 = i48 - 1;
            z17 = (b(spannableStringBuilder2, i49) && b(spannableStringBuilder2, i48) && !((java.lang.Boolean) hasEmoji.invoke(java.lang.Integer.valueOf(i49), java.lang.Integer.valueOf(i48 + 1))).booleanValue()) ? false : true;
            spannableStringBuilder.append(builder.subSequence(i48 - (!z17 ? 1 : 0), i27 + i17));
            z18 = false;
        }
        com.tencent.mars.xlog.Log.i("MessageTruncateGradient", "clipContentText case = " + bVar + ",hasEmojiBefore  = " + z17 + ",hasEmojiAfter = " + z18);
