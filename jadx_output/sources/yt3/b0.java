...
public final class b0 extends yt3.a implements android.view.View.OnClickListener {
    ...
    public final android.view.View f465349f;
    ...
    public b0(android.view.ViewGroup parent, ju3.d0 status) {
        ...
        android.view.View findViewById = parent.findViewById(com.tencent.mm.R.id.d8i);
        this.f465349f = findViewById;
    ...
    public void onClick(android.view.View view) {
        ...
        ju3.d0.k(this.f465332d, ju3.c0.V2, null, 2, null);
    ...
    public void setVisibility(int i17) {
        android.view.View view = this.f465349f;
        if (view == null) {
            return;
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
