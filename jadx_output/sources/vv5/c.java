...
public final class c extends vv5.b {
    ...
    public final byte[] f440546a;

    /* renamed from: b, reason: collision with root package name */
    public final int f440547b;

    /* renamed from: c, reason: collision with root package name */
    public final java.nio.ByteOrder f440548c;
    ...
    public c(byte[] bArr, int i17, int i18, java.nio.ByteOrder byteOrder) {
        this.f440546a = bArr;
        this.f440547b = i17;
        this.f440548c = byteOrder;
    }

    public int a() {
        int i17;
        int i18;
        int i19 = this.f440549d;
        int i27 = this.f440547b + i19;
        java.nio.ByteOrder byteOrder = java.nio.ByteOrder.BIG_ENDIAN;
        byte[] bArr = this.f440546a;
        if (this.f440548c == byteOrder) {
            int i28 = i27 + 1;
            int i29 = i28 + 1;
    ...
    public short b() {
        int i17;
        byte b17;
        int i18 = this.f440549d;
        int i19 = this.f440547b + i18;
        java.nio.ByteOrder byteOrder = java.nio.ByteOrder.BIG_ENDIAN;
        byte[] bArr = this.f440546a;
        if (this.f440548c == byteOrder) {
            i17 = bArr[i19] << 8;
