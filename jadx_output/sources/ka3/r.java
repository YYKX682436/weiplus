...
public final class r implements dd1.a {
    ...
    public final /* synthetic */ ka3.u f306083a;
    ...
    */
    ...
    public void b(org.json.JSONObject resp) {
        ...
        ka3.u uVar = this.f306083a;
        sb6.append(uVar.f306093e == null);
        com.tencent.mars.xlog.Log.i("LiteAppNFCServiceMgr", sb6.toString());
        if (ka3.b.a(resp)) {
            ka3.u.a(uVar);
        }
        ka3.i iVar = uVar.f306093e;
        if (iVar != null) {
            iVar.a(resp);
        }
    }
