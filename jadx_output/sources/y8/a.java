...
public final class a {
    ...
    public final java.lang.String f459790a;

    /* renamed from: b, reason: collision with root package name */
    public final boolean f459791b;

    /* renamed from: c, reason: collision with root package name */
    public final boolean f459792c;

    /* renamed from: d, reason: collision with root package name */
    public final boolean f459793d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f459794e;

    /* renamed from: f, reason: collision with root package name */
    public final android.media.MediaCodecInfo.CodecCapabilities f459795f;

    /* JADX WARN: Code restructure failed: missing block: B:28:0x0057, code lost:
    
        if ((t9.d0.f416498a >= 21 && r4.isFeatureSupported("secure-playback")) != false) goto L37;
     */
    ...
    */
    ...
    public boolean a(int i17, int i18, double d17) {
        android.media.MediaCodecInfo.CodecCapabilities codecCapabilities = this.f459795f;
        ...
        if (i17 < i18) {
            if ((d17 == -1.0d || d17 <= 0.0d) ? videoCapabilities.isSizeSupported(i18, i17) : videoCapabilities.areSizeAndRateSupported(i18, i17, d17)) {
                int i28 = t9.d0.f416498a;
                return true;
            }
        }
        int i29 = t9.d0.f416498a;
        return false;
    }
}
