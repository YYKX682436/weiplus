...
public final class b extends i9.b {
    ...
    public static final java.util.regex.Pattern f335735n = java.util.regex.Pattern.compile("^([0-9][0-9]+):([0-9][0-9]):([0-9][0-9])(?:(\\.[0-9]+)|:([0-9][0-9])(?:\\.([0-9]+))?)?$");

    /* renamed from: o, reason: collision with root package name */
    public static final java.util.regex.Pattern f335736o = java.util.regex.Pattern.compile("^([0-9]+(?:\\.[0-9]+)?)(h|m|s|ms|f|t)$");

    /* renamed from: p, reason: collision with root package name */
    public static final java.util.regex.Pattern f335737p = java.util.regex.Pattern.compile("^(([0-9]*.)?[0-9]+)(px|em|%)$");

    /* renamed from: q, reason: collision with root package name */
    public static final java.util.regex.Pattern f335738q = java.util.regex.Pattern.compile("^(\\d+\\.?\\d*?)% (\\d+\\.?\\d*?)%$");

    /* renamed from: r, reason: collision with root package name */
    public static final n9.a f335739r = new n9.a(30.0f, 1, 1);

    /* renamed from: m, reason: collision with root package name */
    public final org.xmlpull.v1.XmlPullParserFactory f335740m;

    public b() {
        super("TtmlDecoder");
        try {
            org.xmlpull.v1.XmlPullParserFactory newInstance = org.xmlpull.v1.XmlPullParserFactory.newInstance();
            this.f335740m = newInstance;
    ...
    public static void i(java.lang.String str, n9.e eVar) {
        ...
        java.util.regex.Pattern pattern = f335737p;
        if (length == 1) {
        ...
        eVar.f335768k = java.lang.Float.valueOf(matcher.group(1)).floatValue();
    }
    ...
    */
    ...
    public i9.d f(byte[] bArr, int i17, boolean z17) {
        try {
            org.xmlpull.v1.XmlPullParser newPullParser = this.f335740m.newPullParser();
                    ...
                    if (eventType == 2) {
                        ...
                        if (!h(name)) {
                            ...
                            try {
                                ...
                                if (cVar != null) {
                                    if (cVar.f335751k == null) {
                                        cVar.f335751k = new java.util.ArrayList();
                                    }
                                    ((java.util.ArrayList) cVar.f335751k).add(l17);
                                }
                            } catch (i9.f unused) {
                            }
                        }
                        ...
                        ((java.util.ArrayList) cVar.f335751k).add(a17);
                    } else if (eventType == 3) {
