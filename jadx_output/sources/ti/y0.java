...
public final class y0 implements java.io.Serializable {
    ...
    public final java.util.List f419524d;

    public y0(java.util.List list) {
        this.f419524d = java.util.Collections.unmodifiableList(new java.util.ArrayList(list));
    }
    ...
    public java.lang.String toString() {
        ...
        int i17 = 0;
        while (true) {
            java.util.List list = this.f419524d;
            if (i17 >= list.size()) {
                return sb6.toString();
            }
