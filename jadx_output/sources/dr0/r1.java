...
public final class r1 extends dr0.s1 {
    ...
    public static final dr0.r1 f242519e = new dr0.r1();
    ...
    public void a() {
        ...
        if (wh.m.w(context)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.proc.Recycler", "check charging: true");
            throw new dr0.q1("Charge", "abortByCharging");
        }
        java.lang.String str = "";
        mm.d0 d0Var = mm.d0.f328475a;
        synchronized (d0Var.a()) {
            linkedList = d0Var.a().isEmpty() ? kz5.p0.f313996d : new java.util.LinkedList(d0Var.a());
        }
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.proc.Recycler", "check appliers: " + str);
        if (str.length() > 0) {
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.proc.Recycler", "collect RunningNetScenes: " + a17);
        java.lang.String concat = !a17.isEmpty() ? (android.text.TextUtils.isEmpty("") ? "" : ",").concat("run") : "";
        i17.collectRunningNetScene(a17);
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.proc.Recycler", "collect WaitingNetScenes: " + a18);
        if (!a18.isEmpty()) {
        ...
        i18.collectWaitingNetScene(a18);
        if (concat.length() > 0) {
