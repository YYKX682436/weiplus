...
public final class w extends androidx.lifecycle.h1 {

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ androidx.fragment.app.Fragment f353945b;

    public w(androidx.fragment.app.Fragment fragment) {
        this.f353945b = fragment;
    }
    ...
    public androidx.lifecycle.c1 a(java.lang.Class modelClass) {
        ...
        if ((pf5.o.class.isAssignableFrom(modelClass) ? modelClass : null) != null) {
            androidx.fragment.app.Fragment fragment = this.f353945b;
            try {
                kotlin.Result.Companion companion = kotlin.Result.INSTANCE;
                obj = kotlin.Result.m521constructorimpl((androidx.lifecycle.c1) modelClass.getConstructor(androidx.fragment.app.Fragment.class).newInstance(fragment));
