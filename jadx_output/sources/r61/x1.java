...
public class x1 extends l75.a1 {
    ...
    public static final java.lang.String[] f392997e = {"CREATE TABLE IF NOT EXISTS qqlist ( qq long  PRIMARY KEY , wexinstatus int  , groupid int  , username text  , nickname text  , pyinitial text  , quanpin text  , qqnickname text  , qqpyinitial text  , qqquanpin text  , qqremark text  , qqremarkpyinitial text  , qqremarkquanpin text  , reserved1 text  , reserved2 text  , reserved3 int  , reserved4 int  ) ", "CREATE INDEX IF NOT EXISTS groupid_index ON qqlist ( groupid ) ", "CREATE INDEX IF NOT EXISTS qq_index ON qqlist ( qq ) "};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f392998d;
    ...
    public int i(long j17, r61.w1 w1Var) {
        ...
        if (b17.size() > 0) {
            i17 = this.f392998d.p("qqlist", b17, "qq=?", new java.lang.String[]{"" + j17});
        } else {
            i17 = 0;
        }
        if (i17 > 0) {
