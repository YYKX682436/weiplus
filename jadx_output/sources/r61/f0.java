...
public class f0 extends l75.s0 {
    ...
    public static final java.lang.String[] f392868e = {"CREATE TABLE IF NOT EXISTS facebookfriend ( fbid long  PRIMARY KEY , fbname text  , fbimgkey int  , status int  , username text  , nickname text  , nicknamepyinitial text  , nicknamequanpin text  , sex int  , personalcard int  , province text  , city text  , signature text  , alias text  , type int  , email text  ) "};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f392869d;
    ...
    public boolean m0(r61.e0 e0Var) {
        iz5.a.g("Func Set always conv_flag == flag_all", e0Var.f392858q == -1);
        long j17 = e0Var.f392842a;
        ...
        int p17 = k0Var.p("facebookfriend", e0Var.b(), "fbid=?", new java.lang.String[]{"" + e0Var.f392842a});
        if (p17 > 0) {
            doNotify();
        }
        return p17 > 0;
