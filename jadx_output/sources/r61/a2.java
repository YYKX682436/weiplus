...
public class a2 implements android.widget.AbsListView.OnScrollListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.friend.model.RecoverFriendPresenter f392817d;

    public a2(com.tencent.mm.plugin.account.friend.model.RecoverFriendPresenter recoverFriendPresenter) {
        this.f392817d = recoverFriendPresenter;
    }
    ...
    public void onScroll(android.widget.AbsListView absListView, int i17, int i18, int i19) {
        ...
        if (i19 > 0 && i17 + i18 == i19) {
            com.tencent.mars.xlog.Log.i("MicroMsg.RecoverFriendPresenter", "scroll to the end");
            this.f392817d.e();
        }
