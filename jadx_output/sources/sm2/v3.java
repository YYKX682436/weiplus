...
public final class v3 extends kotlin.jvm.internal.q implements yz5.l {
    ...
    public final /* synthetic */ sm2.o4 f409754d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v3(sm2.o4 o4Var) {
        super(1);
        this.f409754d = o4Var;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj) {
        ...
        sm2.o4 o4Var = this.f409754d;
        if (booleanValue) {
            androidx.appcompat.app.AppCompatActivity appCompatActivity = o4Var.f19594b;
            db5.t7.makeText(appCompatActivity, appCompatActivity.getString(com.tencent.mm.R.string.f491604dn0), 0).show();
            i95.m c17 = i95.n0.c(ml2.j0.class);
            kotlin.jvm.internal.o.f(c17, "getService(...)");
            ml2.k1 k1Var = ml2.k1.f327638e;
            ml2.y4 y4Var = ml2.j0.f327583i;
            ((ml2.j0) c17).Bj(15, null);
        }
