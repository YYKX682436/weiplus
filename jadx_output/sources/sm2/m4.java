...
public final class m4 implements ek2.l {
    ...
    public final /* synthetic */ sm2.o4 f409566a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ v65.n f409567b;
    ...
    public void a(int i17, int i18, java.lang.String str, r45.tn1 resp) {
        ...
        sm2.o4 o4Var = this.f409566a;
        java.lang.String str2 = o4Var.f409610f;
        ...
        v65.n nVar = this.f409567b;
        if (i18 == 0 && i17 == 0) {
            if (nVar != null) {
                nVar.a(resp);
            }
        } else {
            dk2.ua.f234209a.a(true, i18, i17, ((mm2.e1) o4Var.c(mm2.e1.class)).f328988r.getLong(0));
            if (nVar != null) {
                nVar.a(null);
            }
        }
