...
public final class v extends com.tencent.mm.plugin.finder.live.widget.e0 implements android.view.View.OnClickListener {
    public final yz5.p H;
    public com.tencent.mm.ui.widget.picker.CustomOptionPickNew I;

    /* renamed from: J, reason: collision with root package name */
    public android.widget.Button f354815J;
    ...
    public void N(android.view.View rootView) {
        ...
        textView.setText(textView.getContext().getResources().getString(com.tencent.mm.R.string.mla));
        ...
        this.f354815J = (android.widget.Button) findViewById2;
        ...
        android.widget.Button button = this.f354815J;
        if (button == null) {
        ...
        if (customOptionPickNew2 != null) {
            customOptionPickNew2.setOnValueChangedListener(new pi2.u(this));
        } else {
            kotlin.jvm.internal.o.o("pickView");
            throw null;
        }
    ...
    public void onClick(android.view.View view) {
        ...
        if (valueOf != null && valueOf.intValue() == id6) {
            ...
            if (valueOf != null && valueOf.intValue() == id7) {
                ...
                this.H.invoke(obj, java.lang.String.valueOf(((java.lang.Number) linkedList.get(this.M)).intValue()));
            }
        }
