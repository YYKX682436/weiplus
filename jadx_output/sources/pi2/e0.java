...
public final class e0 extends com.tencent.mm.plugin.finder.live.widget.e0 implements android.view.View.OnClickListener {
    public final yz5.p H;
    public com.tencent.mm.ui.widget.picker.CustomOptionPickNew I;

    /* renamed from: J, reason: collision with root package name */
    public android.widget.Button f354773J;
    ...
    public void N(android.view.View rootView) {
        ...
        textView.setText(textView.getContext().getResources().getString(com.tencent.mm.R.string.mli));
        ...
        this.f354773J = (android.widget.Button) findViewById2;
        ...
        android.widget.Button button = this.f354773J;
        if (button == null) {
        ...
        if (customOptionPickNew2 != null) {
            customOptionPickNew2.setOnValueChangedListener(new pi2.d0(this));
        } else {
            kotlin.jvm.internal.o.o("pickView");
            throw null;
        }
