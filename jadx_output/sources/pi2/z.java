...
public final class z extends com.tencent.mm.plugin.finder.live.widget.e0 implements android.view.View.OnClickListener {
    public final yz5.p H;
    public com.tencent.mm.ui.widget.picker.CustomOptionPickNew I;

    /* renamed from: J, reason: collision with root package name */
    public android.widget.Button f354821J;
    ...
    public void N(android.view.View rootView) {
        ...
        textView.setText(textView.getContext().getResources().getString(com.tencent.mm.R.string.ml7));
        ...
        this.f354821J = (android.widget.Button) findViewById2;
        ...
        android.widget.Button button = this.f354821J;
        if (button == null) {
        ...
        if (customOptionPickNew2 != null) {
            customOptionPickNew2.setOnValueChangedListener(new pi2.y(this));
        } else {
            kotlin.jvm.internal.o.o("pickView");
            throw null;
        }
    ...
    public void onClick(android.view.View view) {
        ...
        if (valueOf != null && valueOf.intValue() == id6) {
            ...
            if (valueOf != null && valueOf.intValue() == id7) {
                ...
                java.lang.String string = this.f118183e.getResources().getString(com.tencent.mm.R.string.lzf, linkedList.get(this.M));
