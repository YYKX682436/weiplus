...
public class v extends c43.x {
    ...
    public final c43.h1 f38483p0;

    public v(android.view.View view, int i17) {
        super(view, i17);
        this.f38483p0 = new c43.h1();
    }
    ...
    public void k(com.tencent.mm.plugin.game.autogen.chatroom.ChatroomMsgPack chatroomMsgPack) {
        ...
        this.f38483p0.a(this.f38492g, chatroomMsgTpl.tpl_block_list, s(), new c43.u(this, chatroomMsgPack));
    }
    ...
    public android.view.View p(android.view.ViewGroup viewGroup) {
        ...
        mMNeat7extView.setOnTouchListener(new c43.t(this, mMNeat7extView, new com.tencent.mm.pluginsdk.ui.span.y0(this.Z.getContext())));
        return inflate;
    }
}
