...
public final class c extends dv5.e {
    ...
    public void a(int i17, int i18, java.lang.Object obj, int i19, int i27) {
        n(i17);
        int i28 = this.f244038c + 4;
        this.f244038c = i28;
        if (i27 == 1) {
            int length = ((byte[]) obj).length;
            this.f244038c = i28 + (length >> 1) + (length & 1);
        } else if (i27 == 2) {
            this.f244038c = i28 + (((short[]) obj).length * 1);
        } else if (i27 == 4) {
            this.f244038c = i28 + (((int[]) obj).length * 2);
        } else {
            if (i27 != 8) {
                throw new av5.z("bogus element_width: ".concat(ev5.a.b(i27)));
            }
            this.f244038c = i28 + (((long[]) obj).length * 4);
        }
    }
    ...
    public void g(int i17, int i18, int i19, int[] iArr) {
        n(i17);
        int i27 = this.f244038c + 4;
        this.f244038c = i27;
        this.f244038c = i27 + (iArr.length * 2);
    }
    ...
    public void i(int i17, int i18, int[] iArr, int[] iArr2) {
        n(i17);
        int i19 = this.f244038c + 2;
        this.f244038c = i19;
        int length = i19 + (iArr.length * 2);
        this.f244038c = length;
        this.f244038c = length + (iArr2.length * 2);
    }
    ...
    */
    ...
    public int m(int i17) {
        fv5.b bVar = this.f244037b;
        int d17 = bVar.d(i17);
        return d17 < 0 ? i17 : bVar.f267022e[d17];
    }

    public final void n(int i17) {
        int i18 = this.f244038c;
        if (i17 != i18) {
            fv5.b bVar = this.f244037b;
            int i19 = bVar.f267023f;
            if (i19 != 0 && i17 <= bVar.f267021d[i19 - 1]) {
                bVar.f(i17, i18);
                return;
            }
            bVar.f267021d = bVar.a(bVar.f267021d, i19, i17);
            bVar.f267022e = bVar.a(bVar.f267022e, bVar.f267023f, i18);
            bVar.f267023f++;
        }
    }
}
