...
public final class m extends in5.r {
    ...
    public final vm2.f f438098e;

    public m(vm2.f callback) {
        kotlin.jvm.internal.o.g(callback, "callback");
        this.f438098e = callback;
    }

    @Override // in5.r
    public int e() {
        return com.tencent.mm.R.layout.ec7;
    }
    ...
    public void h(in5.s0 holder, in5.c cVar, int i17, int i18, boolean z17, java.util.List list) {
        ...
        int i19 = item.f438100e;
        view3.setPadding(i19, 0, i19, 0);
        holder.itemView.setOnClickListener(new vm2.l(this, item, i17));
        android.widget.TextView textView2 = (android.widget.TextView) holder.itemView.findViewById(com.tencent.mm.R.id.tpo);
        dk2.rf rfVar = item.f438099d;
        if (textView2 != null) {
            textView2.setText(textView2.getContext().getResources().getString(com.tencent.mm.R.string.owb, rfVar.f234048p));
        }
        android.widget.TextView textView3 = (android.widget.TextView) holder.itemView.findViewById(com.tencent.mm.R.id.tpm);
        if (textView3 != null) {
            textView3.setText(textView3.getContext().getResources().getString(com.tencent.mm.R.string.owa, java.lang.Integer.valueOf(rfVar.f234049q)));
        }
        android.widget.TextView textView4 = (android.widget.TextView) holder.itemView.findViewById(com.tencent.mm.R.id.tpk);
        boolean z18 = true;
        if (textView4 != null) {
            java.lang.String str = rfVar.f234050r;
            if (str == null || str.length() == 0) {
                textView4.setVisibility(8);
            } else {
                textView4.setVisibility(0);
                textView4.setText(textView4.getContext().getResources().getString(com.tencent.mm.R.string.ow_, rfVar.f234050r));
            }
        }
        android.view.View findViewById = holder.itemView.findViewById(com.tencent.mm.R.id.tpn);
        if (findViewById != null) {
            java.lang.String str2 = rfVar.f234050r;
        ...
        android.widget.ImageView imageView = (android.widget.ImageView) holder.itemView.findViewById(com.tencent.mm.R.id.tpj);
        if (imageView != null) {
            mn2.g1 g1Var = mn2.g1.f329975a;
            g1Var.i().c(new mn2.n(rfVar.f234041f, null, 2, null), imageView, g1Var.h(mn2.f1.f329960n));
        }
        android.view.View findViewById2 = holder.itemView.findViewById(com.tencent.mm.R.id.tpl);
        android.view.View findViewById3 = holder.itemView.findViewById(com.tencent.mm.R.id.tpp);
        android.view.View findViewById4 = holder.itemView.findViewById(com.tencent.mm.R.id.tph);
        android.widget.ProgressBar progressBar2 = (android.widget.ProgressBar) holder.itemView.findViewById(com.tencent.mm.R.id.tpi);
        android.view.View findViewById5 = holder.itemView.findViewById(com.tencent.mm.R.id.tpf);
        android.widget.TextView textView5 = (android.widget.TextView) holder.itemView.findViewById(com.tencent.mm.R.id.tpg);
        android.widget.TextView textView6 = (android.widget.TextView) holder.itemView.findViewById(com.tencent.mm.R.id.tpe);
        ...
        if (i27 == 2) {
            ...
            progressBar3.setProgress((int) rfVar.f234043h);
            return;
        }
        if (i27 != 3) {
            if (findViewById2 != null) {
