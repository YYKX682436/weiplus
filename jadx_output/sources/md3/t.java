...
public final class t extends lc3.b0 {
    ...
    public void t(lc3.a0 data) {
        ...
        ((mq0.s0) ((mq0.d0) i95.n0.c(mq0.d0.class))).wi(mq0.g0.f330562h);
        java.lang.String optString = data.optString("url");
        if (com.tencent.mm.sdk.platformtools.t8.K0(optString)) {
            s().invoke(i(lc3.x.f317937d));
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.MBJsApiOpenUrlWithExtraWebview", "url:" + optString);
        ...
        int optInt = data.optInt(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, -1);
        ...
        if (optString2.length() > 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg.MBJsApiOpenUrlWithExtraWebview", "adInfo is set, length=" + optString2.length());
        }
        ...
        if (kotlin.jvm.internal.o.b(optString4 == null ? "" : optString4, "1")) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.MBJsApiOpenUrlWithExtraWebview", "adIsNeedReport=" + optString4 + ", adScene=" + optInt + " , adUxInfo:" + optString3);
        }
        ...
        putExtra.putExtra("kBizSessionId", com.tencent.mm.storage.c2.f193803a);
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MBADFullLinkReporter", "[MBAd] reportFullLink38097Invoke failed", e17);
        }
    }
}
