...
public final class p {
    ...
    public p(int i17) {
        this.f416540a = new byte[i17];
        this.f416542c = i17;
    }

    public int a() {
        byte[] bArr = this.f416540a;
        if (bArr == null) {
            return 0;
        }
        return bArr.length;
    ...
    public void b(byte[] bArr, int i17, int i18) {
        java.lang.System.arraycopy(this.f416540a, this.f416541b, bArr, i17, i18);
        this.f416541b += i18;
    }

    public int c() {
        byte[] bArr = this.f416540a;
        int i17 = this.f416541b;
        int i18 = i17 + 1;
        int i19 = i18 + 1;
    ...
    public java.lang.String d() {
        int i17 = this.f416542c;
        int i18 = this.f416541b;
        if (i17 - i18 == 0) {
            return null;
        }
        while (i18 < this.f416542c) {
            byte b17 = this.f416540a[i18];
        ...
        byte[] bArr2 = this.f416540a;
        int i28 = this.f416541b;
        java.lang.String str = new java.lang.String(bArr2, i28, i18 - i28);
        this.f416541b = i18;
        int i29 = this.f416542c;
        if (i18 == i29) {
            return str;
        }
        byte[] bArr3 = this.f416540a;
        if (bArr3[i18] == 13) {
            int i37 = i18 + 1;
            this.f416541b = i37;
            if (i37 == i29) {
    ...
    public java.lang.String i() {
        ...
        while (i18 < this.f416542c && this.f416540a[i18] != 0) {
            i18++;
        }
        byte[] bArr = this.f416540a;
        int i19 = this.f416541b;
        java.lang.String str = new java.lang.String(bArr, i19, i18 - i19);
        this.f416541b = i18;
        if (i18 < this.f416542c) {
            this.f416541b = i18 + 1;
        }
        return str;
    }
    ...
    public java.lang.String j(int i17) {
        ...
        int i18 = this.f416541b;
        int i19 = (i18 + i17) - 1;
        java.lang.String str = new java.lang.String(this.f416540a, i18, (i19 >= this.f416542c || this.f416540a[i19] != 0) ? i17 : i17 - 1);
        this.f416541b += i17;
        return str;
    }

    public java.lang.String k(int i17) {
        java.lang.String str = new java.lang.String(this.f416540a, this.f416541b, i17, java.nio.charset.Charset.forName(com.tencent.mapsdk.internal.rv.f51270c));
        this.f416541b += i17;
        return str;
    }
    ...
    public void t(int i17) {
        u(a() < i17 ? new byte[i17] : this.f416540a, i17);
    }
    ...
    public void v(int i17) {
        t9.a.a(i17 >= 0 && i17 <= this.f416540a.length);
        this.f416542c = i17;
    }

    public void w(int i17) {
        if (i17 >= 0) {
            int i18 = this.f416542c;
        }
        t9.a.a(i17 >= 0 && i17 <= this.f416542c);
        this.f416541b = i17;
    }
