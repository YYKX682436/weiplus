...
public final class v extends lf3.n implements zf3.a {
    ...
    public void I(mf3.k mediaInfo) {
        ...
        j45.l.j(getContext(), "sns", ".ui.SnsUploadUI", intent, null);
    }
    ...
    public final void W6(java.lang.String str, java.lang.String str2, mf3.k kVar) {
        ...
        if (kVar == null) {
            com.tencent.mars.xlog.Log.e("MediaGallery.CommonForwardComponent", "onUserConfirmed return, data null");
            return;
        }
        int ordinal = kVar.getType().ordinal();
        ...
        if (ordinal == 1) {
            ...
            if (strArr.length == 0) {
                com.tencent.mars.xlog.Log.w("MediaGallery.CommonForwardComponent", "want to send record msg, but toUser is null");
                return;
            }
            ...
            ((ku5.t0) ku5.t0.f312615d).g(new zh5.s(strArr, this, kVar, str2, new zh5.t(Q)));
            return;
        }
        if (ordinal != 2) {
            return;
        ...
        if (j0Var == null) {
            com.tencent.mars.xlog.Log.e("MediaGallery.CommonForwardComponent", "media info is not IForwardMediaInfo, send failed");
            return;
        }
        for (java.lang.String str4 : strArr2) {
            ...
            gg3.c a17 = kVar.a();
            com.tencent.mm.plugin.fav.ui.x5.j(activity, str4, g19, str5, a17 != null ? ((int) a17.f271730e) / 1000 : 0, "", uVar, j0Var.b());
    ...
    public void onActivityResult(int i17, int i18, android.content.Intent intent) {
        ...
        com.tencent.mars.xlog.Log.e("MediaGallery.CommonForwardComponent", "onActivityResult return, data invalid. toUsers: ".concat(str));
    }
    ...
    public void z4(mf3.k mediaInfo, java.lang.String userName) {
        ...
        this.f473072d = mediaInfo;
        if (!(userName.length() == 0)) {
            zh5.q qVar = new zh5.q(this, userName, mediaInfo);
            co.a V6 = V6(mediaInfo);
            if (V6 == null) {
                com.tencent.mars.xlog.Log.e("MediaGallery.CommonForwardComponent", "openConfirmDialog return, model invalid");
                return;
            }
