...
public final class b {
    ...
    public static final int f21141h = i65.a.b(com.tencent.mm.sdk.platformtools.x2.f193071a, 192);

    /* renamed from: a, reason: collision with root package name */
    public final zh2.c f21142a;

    /* renamed from: b, reason: collision with root package name */
    public final com.tencent.mm.view.ratio.RatioLayout f21143b;

    /* renamed from: c, reason: collision with root package name */
    public final bj2.c f21144c;
    ...
    public java.util.LinkedList f21147f;

    /* renamed from: g, reason: collision with root package name */
    public final dj2.k f21148g;

    public b(android.content.Context context, zh2.c pluginAbility, com.tencent.mm.view.ratio.RatioLayout ratioLayout) {
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(pluginAbility, "pluginAbility");
        kotlin.jvm.internal.o.g(ratioLayout, "ratioLayout");
        this.f21142a = pluginAbility;
        this.f21143b = ratioLayout;
    ...
    public final void a(java.util.LinkedList linkedList, java.util.LinkedList linkedList2, java.lang.String str) {
        ...
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((xh2.a) obj).f454521b.f454553e == 1) {
                    break;
                }
            } else {
                obj = null;
        ...
        km2.q qVar = aVar != null ? aVar.f454520a : null;
        if (aVar != null) {
            aVar.f454520a = aVar2 != null ? aVar2.f454520a : null;
        }
        if (aVar2 != null) {
            aVar2.f454520a = qVar;
        }
        int i17 = (aVar == null || (iVar2 = aVar.f454521b) == null) ? 0 : iVar2.f454557i;
        xh2.i iVar3 = aVar != null ? aVar.f454521b : null;
        if (iVar3 != null) {
            iVar3.f454557i = (aVar2 == null || (iVar = aVar2.f454521b) == null) ? 0 : iVar.f454557i;
        }
        xh2.i iVar4 = aVar2 != null ? aVar2.f454521b : null;
        if (iVar4 != null) {
            iVar4.f454557i = i17;
        }
        int size = linkedList.size();
        for (int i18 = 0; i18 < size; i18++) {
            xh2.a aVar3 = (xh2.a) kz5.n0.a0(linkedList2, ((xh2.a) linkedList.get(i18)).f454521b.f454553e - 1);
            if (aVar3 != null) {
                aVar3.f454520a = ((xh2.a) linkedList.get(i18)).f454520a;
                xh2.i iVar5 = aVar3.f454521b;
                iVar5.f454556h = false;
                iVar5.f454557i = ((xh2.a) linkedList.get(i18)).f454521b.f454557i;
            }
        }
    }
    ...
    public final java.util.LinkedList b(int i17, java.util.LinkedList list, java.lang.String curFocusId) {
        ...
        if (i27 != i17 || i17 == 2) {
            ...
            for (xh2.a aVar : linkedList3) {
                int i29 = aVar.f454521b.f454553e;
                if (i29 <= 0 || i29 > 9) {
                    arrayList2.add(aVar);
                } else if (hashMap.containsKey(java.lang.Integer.valueOf(i29))) {
                    arrayList2.add(aVar);
                } else {
                    hashMap.put(java.lang.Integer.valueOf(aVar.f454521b.f454553e), aVar);
                }
            }
            int i37 = 0;
            for (int i38 = 1; i38 < 10; i38++) {
                if (!hashMap.containsKey(java.lang.Integer.valueOf(i38))) {
                    ...
                    xh2.i iVar3 = aVar2 != null ? aVar2.f454521b : null;
                    if (iVar3 != null) {
                        iVar3.f454553e = i38;
                    }
                    i37 = i39;
            ...
            if (i17 == 1) {
                ...
                java.lang.String str2 = ((mm2.e1) cVar.g().a(mm2.e1.class)).f328987q.f380301n;
                str = str2 != null ? str2 : "";
                java.util.ArrayList arrayList3 = new java.util.ArrayList();
                for (java.lang.Object obj7 : linkedList3) {
                    if (kotlin.jvm.internal.o.b(((xh2.a) obj7).b(), str)) {
                        arrayList3.add(obj7);
                    }
                }
                ...
                if (aVar3 != null) {
                    ...
                    aVar4.f454520a = aVar3.f454520a;
                    xh2.i iVar4 = aVar4.f454521b;
                    iVar4.f454556h = false;
                    iVar4.f454553e = 1;
                    ...
                    while (i58 < size2) {
                        ...
                        if (aVar5 != null) {
                            aVar5.f454520a = ((xh2.a) linkedList3.get(i58)).f454520a;
                            xh2.i iVar5 = aVar5.f454521b;
                            iVar5.f454556h = false;
                            iVar5.f454553e = i58 + 2;
                            iVar5.f454557i = ((xh2.a) linkedList3.get(i58)).f454521b.f454557i;
                        }
                        i58 = i59;
                    }
                }
                ...
                while (true) {
                    ...
                    obj2 = it6.next();
                    if (kotlin.jvm.internal.o.b(((xh2.a) obj2).b(), curFocusId)) {
                        break;
                    }
                }
                xh2.a aVar7 = (xh2.a) obj2;
                km2.q qVar = aVar6 != null ? aVar6.f454520a : null;
                if (aVar6 != null) {
                    aVar6.f454520a = aVar7 != null ? aVar7.f454520a : null;
                }
                if (aVar7 != null) {
                    aVar7.f454520a = qVar;
                }
                int i66 = (aVar6 == null || (iVar2 = aVar6.f454521b) == null) ? 0 : iVar2.f454557i;
                xh2.i iVar6 = aVar6 != null ? aVar6.f454521b : null;
                if (iVar6 != null) {
                    iVar6.f454557i = (aVar7 == null || (iVar = aVar7.f454521b) == null) ? 0 : iVar.f454557i;
                }
                xh2.i iVar7 = aVar7 != null ? aVar7.f454521b : null;
                if (iVar7 != null) {
                    iVar7.f454557i = i66;
                }
                ...
                for (java.lang.Object obj8 : linkedList3) {
                    ...
                    ((xh2.a) linkedList2.get(i69)).f454520a = ((xh2.a) linkedList3.get(i69)).f454520a;
                    ((xh2.a) linkedList2.get(i69)).f454521b.f454557i = ((xh2.a) linkedList3.get(i69)).f454521b.f454557i;
                    i69 = i76;
                }
            } else if (i17 == 3) {
                if (this.f21145d == 4) {
                    ...
                    while (true) {
                        ...
                        obj3 = it7.next();
                        if (((xh2.a) obj3).f454521b.f454553e == 1) {
                            break;
                        }
                    }
                    xh2.a aVar8 = (xh2.a) obj3;
                    if (aVar8 != null) {
                        java.lang.String str3 = ((mm2.e1) cVar.g().a(mm2.e1.class)).f328987q.f380301n;
                        if (str3 == null) {
                            str3 = "";
                        }
                        if (!kotlin.jvm.internal.o.b(aVar8.b(), str3)) {
                            ...
                            while (true) {
                                ...
                                obj4 = it8.next();
                                if (kotlin.jvm.internal.o.b(((xh2.a) obj4).b(), str3)) {
                                    break;
                                }
                            }
                            xh2.a aVar9 = (xh2.a) obj4;
                            if (aVar9 != null) {
                                km2.q qVar2 = aVar8.f454520a;
                                aVar8.f454520a = aVar9.f454520a;
                                aVar9.f454520a = qVar2;
                                xh2.i iVar8 = aVar8.f454521b;
                                int i77 = iVar8 != null ? iVar8.f454557i : 0;
                                if (iVar8 != null) {
                                    xh2.i iVar9 = aVar9.f454521b;
                                    iVar8.f454557i = iVar9 != null ? iVar9.f454557i : 0;
                                }
                                xh2.i iVar10 = aVar9.f454521b;
                                if (iVar10 != null) {
                                    iVar10.f454557i = i77;
                                }
                            }
                ...
                java.lang.String str4 = ((mm2.e1) cVar.g().a(mm2.e1.class)).f328987q.f380301n;
            ...
            if (!kotlin.jvm.internal.o.b(aVar10.b(), curFocusId)) {
                ...
                while (true) {
                    ...
                    if (kotlin.jvm.internal.o.b(aVar11.b(), curFocusId)) {
                        km2.q qVar3 = aVar10.f454520a;
                        aVar10.f454520a = aVar11.f454520a;
                        aVar11.f454520a = qVar3;
                        xh2.i iVar11 = aVar10.f454521b;
                        int i88 = iVar11 != null ? iVar11.f454557i : 0;
                        if (iVar11 != null) {
                            xh2.i iVar12 = aVar11.f454521b;
                            iVar11.f454557i = iVar12 != null ? iVar12.f454557i : 0;
                        }
                        xh2.i iVar13 = aVar11.f454521b;
                        if (iVar13 != null) {
                            iVar13.f454557i = i88;
                        }
                    } else {
                ...
                java.lang.String str5 = ((mm2.e1) cVar.g().a(mm2.e1.class)).f328987q.f380301n;
                str = str5 != null ? str5 : "";
                ...
                while (true) {
                    ...
                    if (kotlin.jvm.internal.o.b(((xh2.a) obj5).b(), str)) {
                        break;
                    }
                }
                xh2.a aVar12 = (xh2.a) obj5;
                if (aVar12 != null) {
                    this.f21146e = aVar12.f454521b.f454553e;
                }
            }
        }
        boolean c17 = cVar.c();
        bj2.c cVar2 = this.f21144c;
        cVar2.f21155h = c17;
        this.f21145d = i17;
        fj2.r rVar = fj2.r.f263182a;
        dj2.k kVar = this.f21148g;
        if (i17 == 3) {
            i18 = 2;
            z17 = false;
            java.util.LinkedList k17 = rVar.k(list);
            com.tencent.mars.xlog.Log.i("FinderLiveMicNewPreviewLayoutManager", "pointList size = " + k17.size() + " list = " + k17);
            ...
            com.tencent.mars.xlog.Log.i("FinderLiveMicNewPreviewLayoutManager", "pointList size = " + j17.size() + " list = " + j17);
        ...
        android.view.ViewGroup.LayoutParams layoutParams = this.f21143b.getLayoutParams();
