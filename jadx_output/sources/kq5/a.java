    ...
    public void loadLibrary(java.lang.String str) {
        for (int i17 = 0; i17 < 3; i17++) {
            try {
                ...
                kq5.g.f311288a.e("hi.LoadDelegate", "loadSo " + str + " failed NullPointerException " + (e17.getMessage() == null ? "null" : e17.getMessage()), new java.lang.Object[0]);
            } catch (java.lang.SecurityException e18) {
                kq5.g.f311288a.e("hi.LoadDelegate", "loadSo " + str + " failed SecurityException " + (e18.getMessage() == null ? "null" : e18.getMessage()), new java.lang.Object[0]);
            } catch (java.lang.UnsatisfiedLinkError e19) {
                kq5.g.f311288a.e("hi.LoadDelegate", "loadSo " + str + " failed UnsatisfiedLinkError " + (e19.getMessage() == null ? "null" : e19.getMessage()), new java.lang.Object[0]);
