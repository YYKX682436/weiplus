...
public class z extends i95.w implements pm4.v {
    public void Ai(android.content.Context context, int i17, android.os.Bundle bundle, java.lang.String str, nw4.a aVar) {
        ...
        java.util.Map map = aVar.f340790a;
        boolean z19 = false;
        if (map != null) {
            try {
            ...
            try {
                if (map.containsKey("category")) {
                    bundle.putInt("key_forceEnterTabCategory", com.tencent.mm.sdk.platformtools.t8.P(java.lang.String.valueOf(map.get("category")), -1));
                }
                bundle.putBoolean("key_is_jump_tab_find_when_back", z17);
                bundle.putBoolean("key_is_jump_tab_haokan", z18);
            } catch (java.lang.Exception e19) {
                e = e19;
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.TopStory.TopStoryUIServiceImpl", e, "startTopStoryHomeUI throw Exception", new java.lang.Object[0]);
                z19 = z17;
                com.tencent.mars.xlog.Log.i("MicroMsg.TopStory.TopStoryUIServiceImpl", "doHandleHaoKanAction: jumpToWow isJumpTabFindWhenBack:%s isJumpTabHaoKan:%s", java.lang.Boolean.valueOf(z19), java.lang.Boolean.valueOf(z18));
