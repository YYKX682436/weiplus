...
public class d0 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ qx5.e0 f367488d;
    ...
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        qx5.e0 e0Var = this.f367488d;
        android.content.Context context = e0Var.f367489d.getContext();
        com.tencent.xweb.WebView webView = e0Var.f367489d.f367537c;
        ...
        if (webView != null) {
            ...
            by5.c4.f("XWebSavePageHelper", "savePage, result:" + savePage + ", mainFile:" + str3);
            if (!savePage) {
                return;
            }
        }
