...
public final /* synthetic */ class l0$$b implements java.lang.Runnable {

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f367502d;

    @Override // java.lang.Runnable
    public final void run() {
        java.io.File file;
        java.io.File[] listFiles;
        java.lang.String str = this.f367502d;
        ...
        try {
            ...
            if (!d17) {
                yu5.c.b(new qx5.l0$$e("保存文件至下载文件夹失败"));
                return;
            }
