...
public class a {
    ...
    public final java.lang.String f441320a;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f441321b;

    /* renamed from: c, reason: collision with root package name */
    public final java.lang.String f441322c;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.Boolean f441323d;

    /* renamed from: e, reason: collision with root package name */
    public final boolean f441324e;

    /* renamed from: f, reason: collision with root package name */
    public java.lang.Object f441325f;

    /* renamed from: g, reason: collision with root package name */
    public final java.lang.ClassLoader f441326g;

    /* renamed from: h, reason: collision with root package name */
    public java.lang.Class f441327h;
    ...
    */
    ...
    public final void a(android.app.Service service, android.content.Context context) {
        boolean z17;
        java.lang.ClassLoader classLoader = this.f441326g;
        try {
            by5.c4.f("ChildProcessServiceWrapper", "createChildProcessServiceByCustom, start");
            this.f441325f = classLoader.loadClass("com.tencent.xweb.pinus.PSViewDelegate").getMethod("createChildProcessService", android.app.Service.class, android.content.Context.class).invoke(null, service, context);
            z17 = true;
        ...
        this.f441325f = classLoader.loadClass("org.chromium.content_public.app.ChildProcessServiceFactory").getMethod("create", android.app.Service.class, android.content.Context.class).invoke(null, service, context);
    }

    public final int b() {
        by5.z e17 = by5.a0.e(this.f441320a);
        if (e17.f36615a) {
            return e17.b();
        }
        return -1;
    ...
    public final java.lang.Class d() {
        java.lang.Class cls = this.f441327h;
        if (cls != null) {
            return cls;
        }
        java.lang.ClassLoader classLoader = this.f441326g;
    ...
    public final java.lang.String e() {
        java.lang.String str = this.f441321b;
    ...
    public final void g(android.content.Context context, android.os.IBinder iBinder, android.os.Parcel parcel, android.os.Parcel parcel2) {
        java.lang.String a17 = com.tencent.xweb.b0.a(context, "xweb_linker");
        ...
        java.lang.String str = "app_xwalk_" + this.f441320a + "/extracted_xwalkcore/libxwebcore.so";
        ...
        if (lVar.k(classLoader)) {
            ...
            com.tencent.xweb.pinus.sdk.JNIUtils.setClassLoader(classLoader);
            by5.c4.f("ChildProcessServiceWrapper", "loadXWebLibraryInIsolatedProcess, from sdk, libPath:" + str);
            com.tencent.xweb.pinus.sdk.library_loader.Linker.getInstance().loadLibraryByFd(str, false, parcelFileDescriptor.detachFd(), true);
        }
        if (this.f441323d.booleanValue()) {
    ...
    public final void j(android.os.IBinder iBinder, android.os.Parcel parcel, android.os.Parcel parcel2) {
        ...
        if (z17) {
            this.f441326g.loadClass("com.tencent.xweb.XWebCommJni").getMethod("SetCustomFontFD", java.lang.Integer.TYPE).invoke(null, java.lang.Integer.valueOf(((android.os.ParcelFileDescriptor) parcel2.readParcelable(vx5.a.class.getClassLoader())).detachFd()));
        }
    }
