...
public final class f {
    ...
    public final java.io.InputStream f448327b;
    ...
    public f(java.io.InputStream is6) {
        kotlin.jvm.internal.o.g(is6, "is");
        this.f448327b = is6;
        this.f448328c = is6.read();
        this.f448329d = is6.read();
    }

    public final int a(boolean z17) {
        if (this.f448326a == 8) {
            this.f448328c = this.f448329d;
            this.f448329d = this.f448327b.read();
            this.f448326a = 0;
            if (this.f448328c == -1) {
                return -1;
            }
        }
        int i17 = this.f448328c;
        int i18 = this.f448326a;
        int i19 = (i17 >> (7 - i18)) & 1;
        this.f448326a = i18 + 1;
        return i19;
    }
