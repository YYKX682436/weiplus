...
public abstract class v {
    ...
    public static int[] Capability = {0, 0};
    public static int[] ColorStateListItem = {0, android.R.attr.alpha, android.R.attr.color, 16844359, 0};
    public static int[] FontFamily = {0, 0, 0, 0, 0, 0, 0};
