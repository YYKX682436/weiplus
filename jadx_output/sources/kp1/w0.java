...
public final class w0 implements db5.t4 {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4 f310946d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ boolean f310947e;

    public w0(com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4 audioPanelTaskBarViewV4, boolean z17) {
        this.f310946d = audioPanelTaskBarViewV4;
        this.f310947e = z17;
    }
    ...
    public final void onMMMenuItemSelected(android.view.MenuItem menuItem, int i17) {
        ...
        com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4 audioPanelTaskBarViewV4 = this.f310946d;
        if (itemId == 0) {
            com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4.q(audioPanelTaskBarViewV4);
        }
        if (1 == menuItem.getItemId()) {
            jm4.a0 a17 = jm4.c0.f300377d.a();
            if (a17 != null) {
                ((jm4.c0) a17).a("clicfg_ting_radio_audio_square_one_channel", this.f310947e ? "0" : "1");
            }
            com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4.q(audioPanelTaskBarViewV4);
        ...
        if (2 == menuItem.getItemId()) {
            com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4.s();
        ...
        if (5 == menuItem.getItemId()) {
            com.tencent.mm.plugin.ball.audio_panel.view.AudioPanelTaskBarViewV4.r();
        ...
        if (10 == menuItem.getItemId()) {
            ...
            android.content.Context context = audioPanelTaskBarViewV4.getContext();
        ...
        if (11 == menuItem.getItemId()) {
            ...
            android.content.Context context2 = audioPanelTaskBarViewV4.getContext();
            kotlin.jvm.internal.o.f(context2, "getContext(...)");
            o40.e.ta((o40.e) c17, context2, null, null, 6, null);
        }
