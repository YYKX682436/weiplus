...
public final class y0 implements n0.o {
    ...
    public final n0.e f333761b;

    /* renamed from: c, reason: collision with root package name */
    public final n0.g1 f333762c;

    /* renamed from: d, reason: collision with root package name */
    public final n0.k4 f333763d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Set f333764e;

    /* renamed from: f, reason: collision with root package name */
    public java.util.List f333765f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.List f333766g;

    /* renamed from: h, reason: collision with root package name */
    public final n0.p1 f333767h;

    /* renamed from: i, reason: collision with root package name */
    public final n0.d5 f333768i;

    /* renamed from: j, reason: collision with root package name */
    public n0.d3 f333769j;

    /* renamed from: k, reason: collision with root package name */
    public int f333770k;

    /* renamed from: l, reason: collision with root package name */
    public final n0.h2 f333771l;

    /* renamed from: m, reason: collision with root package name */
    public int f333772m;

    /* renamed from: n, reason: collision with root package name */
    public final n0.h2 f333773n;

    /* renamed from: o, reason: collision with root package name */
    public int[] f333774o;

    /* renamed from: p, reason: collision with root package name */
    public java.util.HashMap f333775p;

    /* renamed from: q, reason: collision with root package name */
    public boolean f333776q;

    /* renamed from: r, reason: collision with root package name */
    public boolean f333777r;

    /* renamed from: s, reason: collision with root package name */
    public final java.util.List f333778s;

    /* renamed from: t, reason: collision with root package name */
    public final n0.h2 f333779t;

    /* renamed from: u, reason: collision with root package name */
    public p0.f f333780u;

    /* renamed from: v, reason: collision with root package name */
    public final java.util.HashMap f333781v;

    /* renamed from: w, reason: collision with root package name */
    public boolean f333782w;

    /* renamed from: x, reason: collision with root package name */
    public final n0.h2 f333783x;

    /* renamed from: y, reason: collision with root package name */
    public boolean f333784y;
    ...
    public y0(n0.e applier, n0.g1 parentContext, n0.k4 slotTable, java.util.Set abandonSet, java.util.List changes, java.util.List lateChanges, n0.p1 composition) {
        ...
        this.f333761b = applier;
        this.f333762c = parentContext;
        this.f333763d = slotTable;
        this.f333764e = abandonSet;
        this.f333765f = changes;
        this.f333766g = lateChanges;
        this.f333767h = composition;
        this.f333768i = new n0.d5();
        this.f333771l = new n0.h2();
        this.f333773n = new n0.h2();
        this.f333778s = new java.util.ArrayList();
        this.f333779t = new n0.h2();
        this.f333780u = r0.d.f367962f;
        this.f333781v = new java.util.HashMap();
        this.f333783x = new n0.h2();
        this.f333785z = -1;
        this.B = x0.z.i();
        this.C = new n0.d5();
    ...
    public static final int M(n0.y0 y0Var, int i17, boolean z17, int i18) {
        ...
        if (!((iArr[(i17 * 5) + 1] & 134217728) != 0)) {
            if (!n0.l4.a(iArr, i17)) {
                return n0.l4.h(y0Var.E.f333570b, i17);
            }
        ...
        android.support.v4.media.f.a(j17);
        y0Var.E.f(i17, 0);
        y0Var.E.a(i17);
        int g18 = y0Var.E.g(i17) + i17;
        java.util.List list = y0Var.f333778s;
        ...
        for (int i28 = 0; i28 < size; i28++) {
            ...
            arrayList3.add(new jz5.l(i2Var2.f333537a, i2Var2.f333539c));
        }
        y0Var.k(java.lang.Integer.valueOf(i17));
        kotlin.jvm.internal.o.g(null, "content");
        throw null;
    }

    public static final void x(n0.o4 o4Var, n0.e eVar, int i17) {
        while (true) {
            int i18 = o4Var.f333661s;
            if ((i17 > i18 && i17 < o4Var.f333649g) || (i18 == 0 && i17 == 0)) {
                return;
            }
            o4Var.E();
            if (o4Var.r(o4Var.f333661s)) {
                eVar.i();
            }
            o4Var.h();
        }
    ...
    public final void B(boolean z17) {
        int i17 = z17 ? this.E.f333576h : this.E.f333574f;
        int i18 = i17 - this.P;
        if (!(i18 >= 0)) {
    ...
    public final boolean D(o0.b invalidationsRequested) {
        ...
        if (!this.f333765f.isEmpty()) {
            n0.e1.c("Expected applyChanges() to have been called".toString());
            throw null;
        }
        if (!(invalidationsRequested.f341835c > 0) && !(!this.f333778s.isEmpty())) {
            return false;
        }
        l(invalidationsRequested, null);
        return !this.f333765f.isEmpty();
    }
    ...
    */
    public final java.lang.Object E(n0.p1 r10, n0.p1 r11, java.lang.Integer r12, java.util.List r13, yz5.a r14) {
        /*
            ...
            r9.f333770k = r3     // Catch: java.lang.Throwable -> L7f
        ...
        L13:
            ...
            java.lang.Object r8 = r7.f302833d     // Catch: java.lang.Throwable -> L7f
            n0.l3 r8 = (n0.l3) r8     // Catch: java.lang.Throwable -> L7f
            java.lang.Object r7 = r7.f302834e     // Catch: java.lang.Throwable -> L7f
        ...
        L48:
            ...
            kotlin.jvm.internal.o.g(r14, r13)     // Catch: java.lang.Throwable -> L7f
            if (r11 == 0) goto L6e
            boolean r13 = kotlin.jvm.internal.o.b(r11, r10)     // Catch: java.lang.Throwable -> L7f
            if (r13 != 0) goto L6e
            if (r12 < 0) goto L6e
            n0.j1 r11 = (n0.j1) r11     // Catch: java.lang.Throwable -> L7f
            r10.f333560u = r11     // Catch: java.lang.Throwable -> L7f
            r10.f333561v = r12     // Catch: java.lang.Throwable -> L7f
            java.lang.Object r11 = r14.invoke()     // Catch: java.lang.Throwable -> L68
            r10.f333560u = r6     // Catch: java.lang.Throwable -> L7f
            r10.f333561v = r3     // Catch: java.lang.Throwable -> L7f
            goto L72
        L68:
            r11 = move-exception
            r10.f333560u = r6     // Catch: java.lang.Throwable -> L7f
        ...
        L6e:
            java.lang.Object r11 = r14.invoke()     // Catch: java.lang.Throwable -> L7f
        L72:
            if (r11 != 0) goto L78
        L74:
            java.lang.Object r11 = r14.invoke()     // Catch: java.lang.Throwable -> L7f
    ...
    */
    ...
    public final void G(yz5.q qVar) {
        this.f333765f.add(qVar);
    }

    public final void H() {
        M(this, this.E.f333574f, false, 0);
        A();
        java.lang.Object obj = n0.e1.f333492a;
        n0.a1 a1Var = n0.a1.f333427d;
        B(false);
        n0.j4 j4Var = this.E;
        if (j4Var.f333571c > 0) {
            int i17 = j4Var.f333576h;
            n0.h2 h2Var = this.S;
            int i18 = h2Var.f333527b;
            if ((i18 > 0 ? h2Var.f333526a[i18 - 1] : -1) != i17) {
                if (!this.Q && this.R) {
                    J(false, n0.d1.f333481d);
                    this.Q = true;
                }
        ...
        int i19 = this.P;
        n0.j4 j4Var2 = this.E;
        this.P = i19 + n0.l4.c(j4Var2.f333570b, j4Var2.f333574f);
    }
    ...
    */
    public final void L(int r7, int r8, int r9) {
        /*
            r6 = this;
            n0.j4 r0 = r6.E
            java.lang.Object r1 = n0.e1.f333492a
            if (r7 != r8) goto L7
            goto L1c
        L7:
            if (r7 == r9) goto L6c
    ...
    public final void N() {
        n0.j4 j4Var = this.E;
        int i17 = j4Var.f333576h;
        this.f333772m = i17 >= 0 ? n0.l4.h(j4Var.f333570b, i17) : 0;
        this.E.n();
    }
    ...
    public void O() {
        ...
        if (((java.util.ArrayList) this.f333778s).isEmpty()) {
            N();
        } else {
            F();
        }
    ...
    public final void P(int i17, java.lang.Object obj, boolean z17, java.lang.Object obj2) {
        ...
        if (z18) {
            ...
            n0.d3 d3Var2 = this.f333769j;
            if (d3Var2 != null) {
                int i19 = (-2) - i18;
                n0.l2 l2Var = new n0.l2(i17, -1, i19, -1, 0);
                d3Var2.f333487e.put(java.lang.Integer.valueOf(i19), new n0.e2(-1, this.f333770k - d3Var2.f333484b, 0));
                ((java.util.ArrayList) d3Var2.f333486d).add(l2Var);
            }
            s(z17, null);
            return;
        }
        if (this.f333769j == null) {
            if (this.E.e() == i17) {
                n0.j4 j4Var = this.E;
                int i27 = j4Var.f333574f;
                if (kotlin.jvm.internal.o.b(obj4, i27 < j4Var.f333575g ? j4Var.j(j4Var.f333570b, i27) : null)) {
                    T(z17, obj2);
                }
            }
            n0.j4 j4Var2 = this.E;
            j4Var2.getClass();
            java.util.ArrayList arrayList = new java.util.ArrayList();
            if (j4Var2.f333577i <= 0) {
                int i28 = j4Var2.f333574f;
                int i29 = 0;
                while (i28 < j4Var2.f333575g) {
                    int i37 = i28 * 5;
                    int[] iArr = j4Var2.f333570b;
                    arrayList.add(new n0.l2(iArr[i37], j4Var2.j(iArr, i28), i28, n0.l4.f(iArr, i28) ? 1 : n0.l4.h(iArr, i28), i29));
                    i28 += iArr[i37 + 3];
                    i29++;
                }
            }
            this.f333769j = new n0.d3(arrayList, this.f333770k);
        }
        n0.d3 d3Var3 = this.f333769j;
        if (d3Var3 != null) {
            java.lang.Object k2Var = obj4 != null ? new n0.k2(java.lang.Integer.valueOf(i17), obj4) : java.lang.Integer.valueOf(i17);
            java.util.HashMap hashMap = (java.util.HashMap) ((jz5.n) d3Var3.f333488f).getValue();
            ...
            java.util.HashMap hashMap2 = d3Var3.f333487e;
            java.util.List list = d3Var3.f333486d;
            int i38 = d3Var3.f333484b;
            if (l2Var2 != null) {
                ((java.util.ArrayList) list).add(l2Var2);
                this.f333770k = d3Var3.a(l2Var2) + i38;
                int i39 = l2Var2.f333603c;
                n0.e2 e2Var = (n0.e2) hashMap2.get(java.lang.Integer.valueOf(i39));
                int i47 = e2Var != null ? e2Var.f333498a : -1;
                int i48 = d3Var3.f333485c;
                int i49 = i47 - i48;
                if (i47 > i48) {
                    java.util.Collection<n0.e2> values = hashMap2.values();
                    kotlin.jvm.internal.o.f(values, "groupInfos.values");
                    for (n0.e2 e2Var2 : values) {
                        int i57 = e2Var2.f333498a;
                        if (i57 == i47) {
                            e2Var2.f333498a = i48;
                        } else if (i48 <= i57 && i57 < i47) {
                            e2Var2.f333498a = i57 + 1;
                        }
                    }
                } else if (i48 > i47) {
                    ...
                    for (n0.e2 e2Var3 : values2) {
                        int i58 = e2Var3.f333498a;
                        if (i58 == i47) {
                            e2Var3.f333498a = i48;
                        } else if (i47 + 1 <= i58 && i58 < i48) {
                            e2Var3.f333498a = i58 - 1;
                        }
                    }
                }
                n0.j4 j4Var3 = this.E;
                this.P = i39 - (j4Var3.f333574f - this.P);
                j4Var3.l(i39);
                if (i49 > 0) {
                    n0.t0 t0Var = new n0.t0(i49);
                    B(false);
                    n0.j4 j4Var4 = this.E;
                    if (j4Var4.f333571c > 0) {
                        int i59 = j4Var4.f333576h;
                        n0.h2 h2Var = this.S;
                        int i66 = h2Var.f333527b;
                        if ((i66 > 0 ? h2Var.f333526a[i66 - 1] : -1) != i59) {
                            if (!this.Q && this.R) {
                                java.lang.Object obj7 = n0.e1.f333492a;
                                J(false, n0.d1.f333481d);
                                this.Q = true;
                            }
                ...
                n0.o4 o4Var2 = this.G;
                int i67 = o4Var2.f333655m;
                o4Var2.f333655m = i67 + 1;
                if (i67 == 0) {
                    o4Var2.f333658p.b(((o4Var2.f333644b.length / 5) - o4Var2.f333648f) - o4Var2.f333649g);
                }
                n0.o4 o4Var3 = this.G;
                int i68 = o4Var3.f333660r;
                if (z17) {
                ...
                this.f333760J = this.G.b(i68);
                int i69 = (-2) - i68;
                n0.l2 l2Var3 = new n0.l2(i17, -1, i69, -1, 0);
                hashMap2.put(java.lang.Integer.valueOf(i69), new n0.e2(-1, this.f333770k - i38, 0));
                ((java.util.ArrayList) list).add(l2Var3);
                d3Var = new n0.d3(new java.util.ArrayList(), z17 ? 0 : this.f333770k);
            }
        }
        s(z17, d3Var);
    }
    ...
    public void Q() {
        P(org.chromium.net.NetError.ERR_PROXY_AUTH_REQUESTED, null, false, null);
    }
    ...
    public void S() {
        int i17 = 125;
        if (!this.L && (!this.f333784y ? this.E.e() == 126 : this.E.e() == 125)) {
            i17 = 126;
        }
    ...
    public final void T(boolean z17, java.lang.Object obj) {
        ...
        n0.j4 j4Var = this.E;
        if (j4Var.f333577i <= 0) {
            if (!n0.l4.f(j4Var.f333570b, j4Var.f333574f)) {
    ...
    public n0.o V(int i17) {
        ...
        boolean z17 = this.L;
        n0.d5 d5Var = this.C;
        n0.p1 p1Var = this.f333767h;
        if (z17) {
            n0.l3 l3Var2 = new n0.l3((n0.j1) p1Var);
            d5Var.b(l3Var2);
            g0(l3Var2);
            l3Var2.f333609e = this.B.d();
            l3Var2.f333606b &= -17;
        } else {
            java.util.List list = this.f333778s;
            int d17 = n0.e1.d(list, this.E.f333576h);
            n0.i2 i2Var = d17 >= 0 ? (n0.i2) ((java.util.ArrayList) list).remove(d17) : null;
            n0.j4 j4Var = this.E;
            int i19 = j4Var.f333577i;
            java.lang.Object obj2 = n0.n.f333620a;
            if (i19 > 0 || (i18 = j4Var.f333578j) >= j4Var.f333579k) {
                obj = obj2;
            } else {
                j4Var.f333578j = i18 + 1;
                obj = j4Var.f333572d[i18];
            }
    ...
    public void W(int i17, java.lang.Object obj) {
        if (this.E.e() == i17 && !kotlin.jvm.internal.o.b(this.E.d(), obj) && this.f333785z < 0) {
            this.f333785z = this.E.f333574f;
            this.f333784y = true;
        }
    ...
    public final void Y() {
        ...
        n0.k4 k4Var = this.f333763d;
        this.E = k4Var.h();
        P(100, null, false, null);
        n0.g1 g1Var = this.f333762c;
        g1Var.k();
        this.f333780u = g1Var.d();
        boolean z17 = this.f333782w;
        java.lang.Object obj = n0.e1.f333492a;
        this.f333783x.b(z17 ? 1 : 0);
        this.f333782w = e(this.f333780u);
        this.I = null;
        if (!this.f333776q) {
            this.f333776q = g1Var.c();
        }
        n0.h3 key = y0.d.f458489a;
        p0.f fVar = this.f333780u;
        kotlin.jvm.internal.o.g(fVar, "<this>");
        kotlin.jvm.internal.o.g(key, "key");
        if (fVar.containsKey(key)) {
            n0.e5 e5Var = (n0.e5) fVar.get(key);
            value = e5Var != null ? e5Var.getValue() : null;
        } else {
            value = key.f333600a.getValue();
        }
    ...
    public final boolean Z(n0.l3 scope, java.lang.Object obj) {
        ...
        if (d17 < 0) {
            ...
            ((n0.i2) ((java.util.ArrayList) list).get(d17)).f333539c = null;
        } else {
            o0.d dVar3 = ((n0.i2) ((java.util.ArrayList) list).get(d17)).f333539c;
            if (dVar3 != null) {
                dVar3.add(obj);
            }
        }
    ...
    public final void a() {
        g();
        this.f333768i.f333489a.clear();
        this.f333771l.f333527b = 0;
        this.f333773n.f333527b = 0;
        this.f333779t.f333527b = 0;
        this.f333783x.f333527b = 0;
        this.f333781v.clear();
        this.E.b();
        this.M = 0;
        this.A = 0;
    ...
    public final void a0(int i17, java.lang.Object obj, java.lang.Object obj2) {
        ...
        if (obj2 == null || i17 != 207 || kotlin.jvm.internal.o.b(obj2, n0.n.f333620a)) {
    ...
    public final void d0(int i17, int i18) {
        if (h0(i17) != i18) {
            if (i17 < 0) {
                java.util.HashMap hashMap = this.f333775p;
                if (hashMap == null) {
                    hashMap = new java.util.HashMap();
                    this.f333775p = hashMap;
                }
                hashMap.put(java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
                return;
            }
            int[] iArr = this.f333774o;
            if (iArr == null) {
                int i19 = this.E.f333571c;
    ...
    public boolean e(java.lang.Object obj) {
        if (kotlin.jvm.internal.o.b(y(), obj)) {
            return false;
        }
        g0(obj);
        return true;
    ...
    public final void e0(int i17, int i18) {
        ...
        if (h07 != i18) {
            int i19 = i18 - h07;
            n0.d5 d5Var = this.f333768i;
            int size = d5Var.f333489a.size() - 1;
            while (i17 != -1) {
                int h08 = h0(i17) + i19;
                d0(i17, h08);
                int i27 = size;
                while (true) {
                    if (-1 < i27) {
                        n0.d3 d3Var = (n0.d3) d5Var.f333489a.get(i27);
    ...
    public final void g0(java.lang.Object obj) {
        boolean z17 = this.L;
        java.util.Set set = this.f333764e;
        if (!z17) {
            n0.j4 j4Var = this.E;
            int j17 = (j4Var.f333578j - n0.l4.j(j4Var.f333570b, j4Var.f333576h)) - 1;
        ...
        n0.o4 o4Var = this.G;
        if (o4Var.f333655m > 0) {
            o4Var.q(1, o4Var.f333661s);
        }
        java.lang.Object[] objArr = o4Var.f333645c;
        int i17 = o4Var.f333650h;
        o4Var.f333650h = i17 + 1;
        java.lang.Object obj2 = objArr[o4Var.g(i17)];
        int i18 = o4Var.f333650h;
        if (!(i18 <= o4Var.f333651i)) {
            n0.e1.c("Writing to an invalid slot".toString());
            throw null;
        }
        o4Var.f333645c[o4Var.g(i18 - 1)] = obj;
        if (obj instanceof n0.e4) {
            G(new n0.w0(obj));
            set.add(obj);
        }
    ...
    public final int h(int i17, int i18, int i19) {
        ...
        n0.j4 j4Var = this.E;
        boolean e17 = n0.l4.e(j4Var.f333570b, i17);
        int[] iArr = j4Var.f333570b;
        if (e17) {
            java.lang.Object j17 = j4Var.j(iArr, i17);
            ...
            if (i29 == 207) {
                ...
                java.lang.Object obj2 = n0.n.f333620a;
                if (d17) {
                    obj = j4Var.f333572d[i28 >= iArr.length ? iArr.length : n0.l4.m(iArr[i28 + 1] >> 29) + iArr[i28 + 4]];
                } else {
                    obj = obj2;
                }
                if (obj != null && !kotlin.jvm.internal.o.b(obj, obj2)) {
                    i27 = obj.hashCode();
                }
            }
            i27 = i29;
    ...
    public final int h0(int i17) {
        ...
        if (i17 >= 0) {
            int[] iArr = this.f333774o;
            return (iArr == null || (i18 = iArr[i17]) < 0) ? n0.l4.h(this.E.f333570b, i17) : i18;
        }
        java.util.HashMap hashMap = this.f333775p;
    ...
    public void i0() {
        ...
        n0.j4 j4Var = this.E;
        this.O.b(j4Var.i(j4Var.f333576h));
    }
    ...
    public void j(yz5.a factory) {
        ...
        int i17 = this.f333771l.f333526a[r0.f333527b - 1];
        n0.o4 o4Var = this.G;
        n0.d b17 = o4Var.b(o4Var.f333661s);
        this.f333772m++;
    ...
    public final p0.f k(java.lang.Integer num) {
        ...
        if (z17 && this.H) {
            int i17 = this.G.f333661s;
            while (i17 > 0) {
                n0.o4 o4Var = this.G;
                if (o4Var.f333644b[o4Var.m(i17) * 5] == 202) {
                    n0.o4 o4Var2 = this.G;
                    int m17 = o4Var2.m(i17);
                    if (kotlin.jvm.internal.o.b(n0.l4.e(o4Var2.f333644b, m17) ? o4Var2.f333645c[n0.l4.i(o4Var2.f333644b, m17)] : null, n0.e1.f333494c)) {
                        n0.o4 o4Var3 = this.G;
                        int m18 = o4Var3.m(i17);
                        if (n0.l4.d(o4Var3.f333644b, m18)) {
                            obj = o4Var3.f333645c[o4Var3.d(o4Var3.f333644b, m18)];
                        }
                        if (obj == null) {
        ...
        n0.j4 j4Var = this.E;
        if (j4Var.f333571c > 0) {
            int intValue = num != null ? num.intValue() : j4Var.f333576h;
            while (intValue > 0) {
                n0.j4 j4Var2 = this.E;
                int i18 = intValue * 5;
                int[] iArr = j4Var2.f333570b;
                if (iArr[i18] == 202 && kotlin.jvm.internal.o.b(j4Var2.j(iArr, intValue), n0.e1.f333494c)) {
                    p0.f fVar3 = (p0.f) this.f333781v.get(java.lang.Integer.valueOf(intValue));
                    if (fVar3 == null) {
                        n0.j4 j4Var3 = this.E;
                        int[] iArr2 = j4Var3.f333570b;
                        if (n0.l4.d(iArr2, intValue)) {
                            obj = j4Var3.f333572d[i18 >= iArr2.length ? iArr2.length : iArr2[i18 + 4] + n0.l4.m(iArr2[i18 + 1] >> 29)];
                        }
                        if (obj == null) {
                            throw new java.lang.NullPointerException("null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentMap<androidx.compose.runtime.CompositionLocal<kotlin.Any?>, androidx.compose.runtime.State<kotlin.Any?>>{ androidx.compose.runtime.ComposerKt.CompositionLocalMap }");
                        }
    ...
    public final void l(o0.b bVar, yz5.p pVar) {
        ...
        while (true) {
            ...
            java.lang.Object obj = bVar.f341833a[i18];
            if (obj == null) {
            ...
            o0.d dVar = (o0.d) bVar.f341834b[i18];
            n0.l3 l3Var = (n0.l3) obj;
            n0.d dVar2 = l3Var.f333607c;
            if (dVar2 == null) {
                return;
            }
            ((java.util.ArrayList) list).add(new n0.i2(l3Var, dVar2.f333477a, dVar));
            i18++;
        }
    }
    ...
    public final void o(boolean z17) {
        ...
        if (z28) {
            n0.o4 o4Var = this.G;
            int i19 = o4Var.f333661s;
            int i27 = o4Var.f333644b[o4Var.m(i19) * 5];
            n0.o4 o4Var2 = this.G;
            int m17 = o4Var2.m(i19);
            java.lang.Object obj2 = n0.l4.e(o4Var2.f333644b, m17) ? o4Var2.f333645c[n0.l4.i(o4Var2.f333644b, m17)] : null;
            n0.o4 o4Var3 = this.G;
            ...
            n0.j4 j4Var = this.E;
            int i28 = j4Var.f333576h;
            int i29 = i28 * 5;
            int[] iArr = j4Var.f333570b;
            int i37 = iArr[i29];
            java.lang.Object j17 = j4Var.j(iArr, i28);
            n0.j4 j4Var2 = this.E;
            int[] iArr2 = j4Var2.f333570b;
            if (n0.l4.d(iArr2, i28)) {
                obj = j4Var2.f333572d[i29 >= iArr2.length ? iArr2.length : iArr2[i29 + 4] + n0.l4.m(iArr2[i29 + 1] >> 29)];
            }
            b0(i37, j17, obj);
        }
        int i38 = this.f333772m;
        n0.d3 d3Var2 = this.f333769j;
        java.util.List list = this.f333778s;
        if (d3Var2 != null) {
            java.util.List list2 = d3Var2.f333483a;
            if (list2.size() > 0) {
                java.util.List list3 = d3Var2.f333486d;
                kotlin.jvm.internal.o.g(list3, "<this>");
                ...
                while (i47 < size3) {
                    ...
                    int i57 = d3Var2.f333484b;
                    if (contains) {
                        hashSet = hashSet2;
                        if (!linkedHashSet2.contains(l2Var)) {
                            if (i48 < size2) {
                                n0.l2 keyInfo = (n0.l2) arrayList2.get(i48);
                                java.util.HashMap hashMap = d3Var2.f333487e;
                                if (keyInfo != l2Var) {
                                    int a17 = d3Var2.a(keyInfo);
                                    linkedHashSet2.add(keyInfo);
                                    if (a17 != i49) {
                                        d3Var = d3Var2;
                                        n0.e2 e2Var = (n0.e2) hashMap.get(java.lang.Integer.valueOf(keyInfo.f333603c));
                                        int i58 = e2Var != null ? e2Var.f333500c : keyInfo.f333604d;
                                        ...
                                        if (a17 > i49) {
                                            ...
                                            kotlin.jvm.internal.o.f(values, "groupInfos.values");
                                            for (n0.e2 e2Var2 : values) {
                                                int i68 = e2Var2.f333499b;
                                                if (a17 <= i68 && i68 < a17 + i58) {
                                                    e2Var2.f333499b = (i68 - a17) + i49;
                                                } else if (i49 <= i68 && i68 < a17) {
                                                    e2Var2.f333499b = i68 + i58;
                                                }
                                            }
                                        } else if (i49 > a17) {
                                            ...
                                            kotlin.jvm.internal.o.f(values2, "groupInfos.values");
                                            for (n0.e2 e2Var3 : values2) {
                                                int i69 = e2Var3.f333499b;
                                                if (a17 <= i69 && i69 < a17 + i58) {
                                                    e2Var3.f333499b = (i69 - a17) + i49;
                                                } else if (a17 + 1 <= i69 && i69 < i49) {
                                                    e2Var3.f333499b = i69 - i58;
                                                }
                                            }
                                        }
                                    } else {
                                ...
                                n0.e2 e2Var4 = (n0.e2) hashMap.get(java.lang.Integer.valueOf(keyInfo.f333603c));
                                i49 += e2Var4 != null ? e2Var4.f333500c : keyInfo.f333604d;
                                hashSet2 = hashSet;
                                d3Var2 = d3Var;
                        ...
                        I(d3Var2.a(l2Var) + i57, l2Var.f333604d);
                        int i76 = l2Var.f333603c;
                        d3Var2.b(i76, 0);
                        n0.j4 j4Var3 = this.E;
                        hashSet = hashSet2;
                        this.P = i76 - (j4Var3.f333574f - this.P);
                        j4Var3.l(i76);
                        H();
                        this.E.m();
                ...
                if (list2.size() > 0) {
                    n0.j4 j4Var4 = this.E;
                    this.P = j4Var4.f333575g - (j4Var4.f333574f - this.P);
                    j4Var4.n();
                }
            }
        }
        int i77 = this.f333770k;
        while (true) {
            n0.j4 j4Var5 = this.E;
            if ((j4Var5.f333577i > 0) || j4Var5.f333574f == j4Var5.f333575g) {
                break;
            }
            int i78 = j4Var5.f333574f;
            H();
            I(i77, this.E.m());
            n0.e1.a(list, i78, this.E.f333574f);
        }
        boolean z29 = this.L;
        n0.h2 h2Var = this.S;
        if (z29) {
            ...
            n0.j4 j4Var6 = this.E;
            int i79 = j4Var6.f333577i;
            if (!(i79 > 0)) {
                throw new java.lang.IllegalArgumentException("Unbalanced begin/end empty".toString());
            }
            j4Var6.f333577i = i79 - 1;
            n0.o4 o4Var4 = this.G;
            int i86 = o4Var4.f333661s;
            o4Var4.h();
            if (!(this.E.f333577i > 0)) {
                int i87 = (-2) - i86;
                this.G.i();
                this.G.e();
                n0.d dVar = this.f333760J;
                boolean isEmpty = ((java.util.ArrayList) list4).isEmpty();
                n0.d1 d1Var = n0.d1.f333481d;
                if (isEmpty) {
                    n0.p0 p0Var = new n0.p0(this.F, dVar);
                    B(false);
                    n0.j4 j4Var7 = this.E;
                    if (j4Var7.f333571c > 0) {
                        int i88 = j4Var7.f333576h;
                        int i89 = h2Var.f333527b;
                        if ((i89 > 0 ? h2Var.f333526a[i89 - 1] : -1) != i88) {
                            if (this.Q || !this.R) {
                                z27 = false;
                            } else {
                    ...
                    B(false);
                    n0.j4 j4Var8 = this.E;
                    if (j4Var8.f333571c > 0) {
                        int i96 = j4Var8.f333576h;
                        int i97 = h2Var.f333527b;
                        if ((i97 > 0 ? h2Var.f333526a[i97 - 1] : -1) != i96) {
                            if (this.Q || !this.R) {
                                z19 = false;
                            } else {
                ...
                this.L = r47;
                if (!(this.f333763d.f333591e == 0 ? true : r47)) {
                    d0(i87, r47);
                    e0(i87, i38);
                }
            }
            ...
            int i98 = this.E.f333576h;
            int i99 = h2Var.f333527b;
            if (!((i99 > 0 ? h2Var.f333526a[i99 + (-1)] : -1) <= i98)) {
            ...
            if ((i99 > 0 ? h2Var.f333526a[i99 - 1] : -1) == i98) {
                ...
                J(false, n0.z0.f333800d);
            }
            int i100 = this.E.f333576h;
            if (i38 != h0(i100)) {
                e0(i100, i38);
            }
            if (z17) {
        ...
        n0.d3 d3Var3 = (n0.d3) this.f333768i.a();
        if (d3Var3 != null && !z29) {
            d3Var3.f333485c++;
        }
        this.f333769j = d3Var3;
        this.f333770k = this.f333771l.a() + i38;
        this.f333772m = this.f333773n.a() + i38;
    }
    ...
    */
    public n0.f4 q() {
        /*
            r9 = this;
            n0.d5 r0 = r9.C
            java.util.ArrayList r1 = r0.f333489a
        ...
        L39:
            if (r7 >= r6) goto L59
            java.lang.Object[] r8 = r5.f341831b
            r8 = r8[r7]
            if (r8 == 0) goto L51
            int[] r8 = r5.f341832c
            r8 = r8[r7]
    ...
    public final void r() {
        ...
        C();
        if (!this.f333768i.f333489a.isEmpty()) {
            n0.e1.c("Start/end imbalance".toString());
            throw null;
        }
        if (!(this.S.f333527b == 0)) {
            n0.e1.c("Missed recording an endGroup()".toString());
            throw null;
        }
        g();
    ...
    public final void s(boolean z17, n0.d3 d3Var) {
        this.f333768i.b(this.f333769j);
        this.f333769j = d3Var;
        this.f333771l.b(this.f333770k);
        if (z17) {
            this.f333770k = 0;
        }
        this.f333773n.b(this.f333772m);
        this.f333772m = 0;
    }
    ...
    public final n0.l3 t() {
        if (this.A == 0) {
            n0.d5 d5Var = this.C;
            if (!d5Var.f333489a.isEmpty()) {
                return (n0.l3) d5Var.f333489a.get(r0.size() - 1);
            }
        }
        return null;
    }
    ...
    */
    ...
    public void w(java.util.List references) {
        ...
        java.util.List list = this.f333766g;
        java.util.List list2 = this.f333765f;
        try {
            this.f333765f = list;
            java.lang.Object obj = n0.e1.f333492a;
            G(n0.b1.f333439d);
            ...
            n0.u2 u2Var = (n0.u2) lVar.f302833d;
            u2Var.getClass();
            u2Var.getClass();
            throw null;
        } catch (java.lang.Throwable th6) {
    ...
    public final java.lang.Object y() {
        ...
        n0.j4 j4Var = this.E;
        if (j4Var.f333577i > 0 || (i17 = j4Var.f333578j) >= j4Var.f333579k) {
            obj = obj2;
        } else {
            j4Var.f333578j = i17 + 1;
            obj = j4Var.f333572d[i17];
        }
        return this.f333784y ? obj2 : obj;
    }

    public final void z() {
        n0.d5 d5Var = this.O;
        if (!d5Var.f333489a.isEmpty()) {
            java.util.ArrayList arrayList = d5Var.f333489a;
            int size = arrayList.size();
