...
public final class i0 extends kotlin.jvm.internal.q implements yz5.q {
    ...
    public final /* synthetic */ kotlin.jvm.internal.f0 f333531d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.util.List f333532e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i0(kotlin.jvm.internal.f0 f0Var, java.util.List list) {
        super(3);
        this.f333531d = f0Var;
        this.f333532e = list;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2, java.lang.Object obj3) {
        ...
        int i17 = this.f333531d.f310116d;
        if (i17 > 0) {
            applier = new n0.x2(applier, i17);
        }
        java.util.List list = this.f333532e;
        int size = list.size();
