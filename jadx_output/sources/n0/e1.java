...
public abstract class e1 {
    ...
    public static final java.lang.Object f333492a = new n0.y2("provider");

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.Object f333493b = new n0.y2("provider");

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.Object f333494c = new n0.y2("compositionLocalMap");

    /* renamed from: d, reason: collision with root package name */
    public static final java.lang.Object f333495d = new n0.y2("providerValues");

    /* renamed from: e, reason: collision with root package name */
    public static final java.lang.Object f333496e = new n0.y2("providers");

    /* renamed from: f, reason: collision with root package name */
    public static final java.lang.Object f333497f = new n0.y2("reference");
    ...
    public static final void a(java.util.List list, int i17, int i18) {
        ...
        while (d17 < list.size() && ((n0.i2) list.get(d17)).f333538b < i18) {
            list.remove(d17);
        }
    }
    ...
    public static final int d(java.util.List list, int i17) {
        ...
        while (i18 <= size) {
            int i19 = (i18 + size) >>> 1;
            int i27 = kotlin.jvm.internal.o.i(((n0.i2) list.get(i19)).f333538b, i17);
            if (i27 < 0) {
                i18 = i19 + 1;
            } else {
                if (i27 <= 0) {
    ...
    public static final void e(n0.o4 o4Var, n0.d4 rememberManager) {
        ...
        int f17 = o4Var.f(o4Var.f333644b, o4Var.m(o4Var.f333660r));
        int[] iArr = o4Var.f333644b;
        int i17 = o4Var.f333660r;
        ...
        while (n4Var.hasNext()) {
            ...
            } else if ((next instanceof n0.l3) && (j1Var = (l3Var = (n0.l3) next).f333605a) != null) {
                j1Var.f333559t = true;
                l3Var.f333605a = null;
            }
        }
