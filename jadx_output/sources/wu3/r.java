...
public final class r implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.recordvideo.ui.editor.EditorAudioSearchView f449800d;

    public r(com.tencent.mm.plugin.recordvideo.ui.editor.EditorAudioSearchView editorAudioSearchView) {
        this.f449800d = editorAudioSearchView;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.widget.EditText editText = this.f449800d.f155957n;
        if (editText != null) {
            editText.clearFocus();
        }
