...
public class f extends java.util.concurrent.AbstractExecutorService {
    ...
    public static final java.util.concurrent.ConcurrentLinkedQueue f312571s = new java.util.concurrent.ConcurrentLinkedQueue();

    /* renamed from: t, reason: collision with root package name */
    public static final java.lang.Class f312572t;

    /* renamed from: u, reason: collision with root package name */
    public static final java.lang.reflect.Field f312573u;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicInteger f312574d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.concurrent.BlockingQueue f312575e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.concurrent.locks.ReentrantLock f312576f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.HashSet f312577g;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.LinkedList f312578h;

    /* renamed from: i, reason: collision with root package name */
    public final java.util.concurrent.locks.Condition f312579i;

    /* renamed from: m, reason: collision with root package name */
    public int f312580m;

    /* renamed from: n, reason: collision with root package name */
    public long f312581n;

    /* renamed from: o, reason: collision with root package name */
    public volatile ku5.p f312582o;

    /* renamed from: p, reason: collision with root package name */
    public volatile int f312583p;

    /* renamed from: q, reason: collision with root package name */
    public volatile int f312584q;

    /* renamed from: r, reason: collision with root package name */
    public volatile java.lang.String f312585r;
    ...
    public f(java.lang.String str, int i17, int i18, java.util.concurrent.BlockingQueue blockingQueue, ku5.p pVar) {
        ...
        this.f312574d = new java.util.concurrent.atomic.AtomicInteger(-536870912);
        java.util.concurrent.locks.ReentrantLock reentrantLock = new java.util.concurrent.locks.ReentrantLock();
        this.f312576f = reentrantLock;
        this.f312577g = new java.util.HashSet();
        this.f312578h = new java.util.LinkedList();
        this.f312579i = reentrantLock.newCondition();
        ...
        if (blockingQueue != null && defaultThreadFactory != null && pVar != null) {
            this.f312583p = i17;
            this.f312584q = i18;
            this.f312575e = blockingQueue;
            timeUnit.toNanos(com.tencent.wcdb.core.Database.DictDefaultMatchValue);
            this.f312582o = pVar;
            this.f312585r = str;
            return;
        }
    ...
    */
    ...
    public boolean awaitTermination(long j17, java.util.concurrent.TimeUnit timeUnit) {
        ...
        java.util.concurrent.locks.ReentrantLock reentrantLock = this.f312576f;
        reentrantLock.lock();
        while (true) {
            try {
                if (this.f312574d.get() >= 1610612736) {
                    return true;
                }
                if (nanos <= 0) {
                    return false;
                }
                nanos = this.f312579i.awaitNanos(nanos);
            } finally {
    ...
    public void execute(java.lang.Runnable runnable) {
        runnable.getClass();
        int i17 = this.f312574d.get();
        if ((i17 & 536870911) < this.f312583p) {
            if (a(runnable, true)) {
                return;
            } else {
                i17 = this.f312574d.get();
            }
        }
        if (!(i17 < 0) || !this.f312575e.offer(runnable)) {
            if (a(runnable, false)) {
                return;
            }
            this.f312582o.a(runnable, this);
            return;
        }
        int i18 = this.f312574d.get();
        if (!(i18 < 0)) {
            boolean remove = this.f312575e.remove(runnable);
            v();
            if (remove) {
                this.f312582o.a(runnable, this);
                return;
    ...
    public final java.lang.Runnable f() {
        int i17;
        java.util.concurrent.atomic.AtomicInteger atomicInteger = this.f312574d;
        int i18 = atomicInteger.get() & (-536870912);
        java.util.concurrent.BlockingQueue blockingQueue = this.f312575e;
    ...
    public boolean isShutdown() {
        return !(this.f312574d.get() < 0);
    }

    @Override // java.util.concurrent.ExecutorService
    public boolean isTerminated() {
        return this.f312574d.get() >= 1610612736;
    }
    ...
    public final void k(boolean z17) {
        ...
        reentrantLock.lock();
        try {
            java.util.Iterator it = this.f312577g.iterator();
            while (it.hasNext()) {
                ((ku5.e) it.next()).a();
                if (z17) {
                    break;
    ...
    public final boolean l(java.lang.Runnable runnable) {
        if ((this.f312574d.get() & (-536870912)) >= 0) {
            return false;
        }
        java.util.concurrent.locks.ReentrantLock reentrantLock = this.f312576f;
        reentrantLock.lock();
        java.util.LinkedList linkedList = this.f312578h;
        try {
            ku5.e eVar = linkedList.isEmpty() ? null : (ku5.e) linkedList.remove();
            if (eVar == null) {
                return false;
            }
            eVar.f312567g.compareAndSet(true, false);
            eVar.b(runnable);
            ku5.t0 t0Var = (ku5.t0) ku5.t0.f312615d;
            t0Var.getClass();
            eVar.f312568h = t0Var.k(eVar, 0L);
            return true;
        } finally {
            reentrantLock.unlock();
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x001b, code lost:
        ...
        r6.f312581n += r7.f312566f.get();
        r6.f312577g.remove(r7);
        r7.f312564d = null;
        r7.f312568h = null;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0038, code lost:
        ...
        if (r7.f312567g.compareAndSet(false, true) == false) goto L14;
     */
    ...
    */
    public final void p(ku5.e r7, boolean r8) {
        /*
            ...
            if (r8 == 0) goto L14
        L6:
            java.util.concurrent.atomic.AtomicInteger r1 = r6.f312574d
            int r2 = r1.get()
            int r3 = r2 + (-1)
            boolean r1 = r1.compareAndSet(r2, r3)
            if (r1 == 0) goto L6
        L14:
            java.util.concurrent.locks.ReentrantLock r1 = r6.f312576f
            r1.lock()
            if (r8 == 0) goto L31
            long r2 = r6.f312581n     // Catch: java.lang.Throwable -> L4f
            java.util.concurrent.atomic.AtomicLong r8 = r7.f312566f     // Catch: java.lang.Throwable -> L4f
            long r4 = r8.get()     // Catch: java.lang.Throwable -> L4f
            long r2 = r2 + r4
            r6.f312581n = r2     // Catch: java.lang.Throwable -> L4f
            java.util.HashSet r8 = r6.f312577g     // Catch: java.lang.Throwable -> L4f
            r8.remove(r7)     // Catch: java.lang.Throwable -> L4f
            r8 = 0
            r7.f312564d = r8     // Catch: java.lang.Throwable -> L4f
            r7.f312568h = r8     // Catch: java.lang.Throwable -> L4f
            goto L48
        L31:
            java.util.concurrent.atomic.AtomicBoolean r8 = r7.f312567g     // Catch: java.lang.Throwable -> L4f
            r2 = 0
            boolean r8 = r8.compareAndSet(r2, r0)     // Catch: java.lang.Throwable -> L4f
            if (r8 == 0) goto L48
            java.util.LinkedList r8 = r6.f312578h     // Catch: java.lang.Throwable -> L4f
    ...
    public void q() {
        java.util.Iterator it = f312571s.iterator();
        while (it.hasNext()) {
    ...
    public java.lang.String toString() {
        ...
        reentrantLock.lock();
        try {
            long j17 = this.f312581n;
            java.util.HashSet hashSet = this.f312577g;
            int size = hashSet.size();
            java.util.Iterator it = hashSet.iterator();
            int i17 = 0;
            while (it.hasNext()) {
                ku5.e eVar = (ku5.e) it.next();
                j17 += eVar.f312566f.get();
                if (eVar.isHeldExclusively()) {
                    i17++;
                    sb6.append(eVar.f312565e);
                }
            }
            reentrantLock.unlock();
            int i18 = this.f312574d.get();
            ...
            return super.toString() + "[" + str + ", pool size = " + size + ", active threads = " + i17 + ", queued tasks = " + this.f312575e.size() + ", completed tasks = " + j17 + ", running tasks = " + ((java.lang.Object) sb6) + "]";
        } catch (java.lang.Throwable th6) {
            reentrantLock.unlock();
            throw th6;
        }
    ...
    public final void v() {
        java.util.concurrent.locks.Condition condition = this.f312579i;
        while (true) {
            java.util.concurrent.atomic.AtomicInteger atomicInteger = this.f312574d;
            ...
            if (((-536870912) & i17) == 0 && !this.f312575e.isEmpty()) {
                return;
            }
            if ((536870911 & i17) != 0) {
                k(true);
