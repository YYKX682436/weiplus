...
public class a extends android.text.SpannableString {
    ...
    public java.lang.Object[] f341275d;
    ...
    public a(java.lang.CharSequence charSequence) {
        ...
        this.f341275d = new java.lang.Object[20];
        this.f341276e = new int[60];
    ...
    public int getSpanEnd(java.lang.Object obj) {
        int i17 = this.f341277f;
        java.lang.Object[] objArr = this.f341275d;
        int[] iArr = this.f341276e;
    ...
    public void setSpan(java.lang.Object obj, int i17, int i18, int i19) {
        ...
        if (i28 >= objArr.length) {
            ...
            java.lang.System.arraycopy(this.f341276e, 0, iArr, 0, this.f341277f * 3);
            this.f341275d = objArr2;
            this.f341276e = iArr;
        }
        java.lang.Object[] objArr3 = this.f341275d;
        int i37 = this.f341277f;
        objArr3[i37] = obj;
        int[] iArr2 = this.f341276e;
        iArr2[(i37 * 3) + 0] = i17;
        iArr2[(i37 * 3) + 1] = i18;
        iArr2[(i37 * 3) + 2] = i19;
        this.f341277f = i37 + 1;
