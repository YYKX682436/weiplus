...
public abstract class s0 {
    ...
    */
    ...
    public static final f26.o0 c(o06.d dVar) {
        ...
        o06.r1 Z = dVar.Z();
        if (c07 != null) {
            return ((r06.g) c07).getType();
        }
        if (Z != null) {
            if (dVar instanceof o06.l) {
                return ((r06.g) Z).getType();
            }
            o06.m e17 = dVar.e();
    ...
    public static final java.lang.reflect.Method d(java.lang.Class cls, o06.d descriptor) {
        ...
        try {
            ...
            kotlin.jvm.internal.o.d(declaredMethod);
    ...
    public static final java.util.List f(f26.z0 z0Var) {
        ...
        for (jz5.l lVar : w0Var.f342001a) {
            n16.g gVar = (n16.g) lVar.f302833d;
            java.util.List f17 = f((f26.z0) lVar.f302834e);
            if (f17 != null) {
    ...
    public static final java.lang.Class h(o06.m mVar) {
        ...
        throw new i06.a4("Class object for the class " + gVar.getName() + " cannot be found (classId=" + v16.f.f((o06.j) mVar) + ')');
    }
}
