...
public final class c implements j06.k {
    ...
    public final java.lang.Class f297044a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.List f297045b;

    /* renamed from: c, reason: collision with root package name */
    public final j06.a f297046c;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.List f297047d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.List f297048e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.List f297049f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.List f297050g;
    ...
    public c(java.lang.Class jClass, java.util.List parameterNames, j06.a callMode, j06.b origin, java.util.List methods) {
        ...
        kotlin.jvm.internal.o.g(parameterNames, "parameterNames");
        kotlin.jvm.internal.o.g(callMode, "callMode");
        kotlin.jvm.internal.o.g(origin, "origin");
        kotlin.jvm.internal.o.g(methods, "methods");
        this.f297044a = jClass;
        this.f297045b = parameterNames;
        this.f297046c = callMode;
        this.f297047d = methods;
        ...
        this.f297048e = arrayList;
        java.util.List list = this.f297047d;
        ...
        while (it6.hasNext()) {
            ...
            java.util.List list2 = u06.i.f423505a;
            java.lang.Class<?> cls = (java.lang.Class) u06.i.f423507c.get(returnType);
            if (cls != null) {
                returnType = cls;
            }
            arrayList2.add(returnType);
        }
        this.f297049f = arrayList2;
        java.util.List list3 = this.f297047d;
        ...
        this.f297050g = arrayList3;
        if (this.f297046c == j06.a.f297037e && origin == j06.b.f297040d) {
            java.util.List list4 = this.f297045b;
            kotlin.jvm.internal.o.g(list4, "<this>");
            ...
            while (true) {
                ...
                if (!z17 && kotlin.jvm.internal.o.b(next, "value")) {
                    z17 = true;
                    z18 = false;
                }
                if (z18) {
    ...
    */
    public java.lang.Object call(java.lang.Object[] r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: j06.c.call(java.lang.Object[]):java.lang.Object");
    }

    @Override // j06.k
    public java.lang.reflect.Type getReturnType() {
        return this.f297044a;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ c(java.lang.Class r7, java.util.List r8, j06.a r9, j06.b r10, java.util.List r11, int r12, kotlin.jvm.internal.i r13) {
        /*
            r6 = this;
            r12 = r12 & 16
            if (r12 == 0) goto L2a
