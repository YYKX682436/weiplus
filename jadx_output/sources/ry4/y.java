...
public final class y implements android.view.View.OnFocusChangeListener {
    ...
    public final /* synthetic */ ry4.c0 f401688d;
    ...
    public final void onFocusChange(android.view.View view, boolean z17) {
        if (z17) {
            ry4.c0 c0Var = this.f401688d;
            c0Var.f401596n = c0Var.f401594i;
            android.widget.ScrollView scrollView = c0Var.f401600r;
            if (scrollView == null || c0Var.f401601s == null) {
                return;
            }
            android.view.View childAt = scrollView.getChildAt(0);
            c0Var.f401602t = childAt != null ? childAt.getHeight() : 0;
            c0Var.V6();
        }
    }
}
