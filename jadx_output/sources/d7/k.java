...
public class k extends d7.f {
    ...
    public static final byte[] f226818b = "com.bumptech.glide.load.resource.bitmap.CircleCrop.1".getBytes(t6.h.f415967a);

    @Override // t6.h
    public void b(java.security.MessageDigest messageDigest) {
        messageDigest.update(f226818b);
    }
    ...
    public android.graphics.Bitmap c(x6.d dVar, android.graphics.Bitmap bitmap, int i17, int i18) {
        ...
        try {
            ...
            canvas.drawCircle(f18, f18, f18, d7.n0.f226826b);
            canvas.drawBitmap(d17, (android.graphics.Rect) null, rectF, d7.n0.f226827c);
