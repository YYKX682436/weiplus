...
public final class y {
    ...
    public static final t6.k f226851f = t6.k.a("com.bumptech.glide.load.resource.bitmap.Downsampler.DecodeFormat", t6.b.f415961f);

    /* renamed from: g, reason: collision with root package name */
    public static final t6.k f226852g = t6.k.a("com.bumptech.glide.load.resource.bitmap.Downsampler.PreferredColorSpace", t6.m.SRGB);

    /* renamed from: h, reason: collision with root package name */
    public static final t6.k f226853h;

    /* renamed from: i, reason: collision with root package name */
    public static final t6.k f226854i;

    /* renamed from: j, reason: collision with root package name */
    public static final d7.x f226855j;

    /* renamed from: k, reason: collision with root package name */
    public static final java.util.Queue f226856k;

    /* renamed from: a, reason: collision with root package name */
    public final x6.d f226857a;

    /* renamed from: b, reason: collision with root package name */
    public final android.util.DisplayMetrics f226858b;

    /* renamed from: c, reason: collision with root package name */
    public final x6.b f226859c;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.List f226860d;

    /* renamed from: e, reason: collision with root package name */
    public final d7.e0 f226861e;

    static {
        d7.v vVar = d7.v.f226838a;
        java.lang.Boolean bool = java.lang.Boolean.FALSE;
        f226853h = t6.k.a("com.bumptech.glide.load.resource.bitmap.Downsampler.FixBitmapSize", bool);
        f226854i = t6.k.a("com.bumptech.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", bool);
        java.util.Collections.unmodifiableSet(new java.util.HashSet(java.util.Arrays.asList("image/vnd.wap.wbmp", "image/x-ico")));
        f226855j = new d7.w();
        java.util.Collections.unmodifiableSet(java.util.EnumSet.of(com.bumptech.glide.load.ImageHeaderParser$ImageType.JPEG, com.bumptech.glide.load.ImageHeaderParser$ImageType.PNG_A, com.bumptech.glide.load.ImageHeaderParser$ImageType.PNG));
        char[] cArr = q7.p.f360310a;
        f226856k = new java.util.ArrayDeque(0);
    }
    ...
    public y(java.util.List list, android.util.DisplayMetrics displayMetrics, x6.d dVar, x6.b bVar) {
        ...
        this.f226861e = d7.e0.f226799g;
        this.f226860d = list;
        q7.n.b(displayMetrics);
        this.f226858b = displayMetrics;
        q7.n.b(dVar);
        this.f226857a = dVar;
        q7.n.b(bVar);
        this.f226859c = bVar;
    ...
    public w6.z0 a(java.io.InputStream inputStream, int i17, int i18, t6.l lVar, d7.x xVar) {
        ...
        byte[] bArr = (byte[]) ((x6.l) this.f226859c).c(65536, byte[].class);
        ...
        t6.b bVar = (t6.b) lVar.c(f226851f);
        t6.m mVar = (t6.m) lVar.c(f226852g);
        d7.v vVar = (d7.v) lVar.c(d7.v.f226843f);
        boolean booleanValue = ((java.lang.Boolean) lVar.c(f226853h)).booleanValue();
        t6.k kVar = f226854i;
        try {
            d7.e b17 = d7.e.b(b(inputStream, options2, vVar, bVar, mVar, lVar.c(kVar) != null && ((java.lang.Boolean) lVar.c(kVar)).booleanValue(), i17, i18, booleanValue, xVar), this.f226857a);
            f(options2);
            synchronized (queue) {
                ((java.util.ArrayDeque) queue).offer(options2);
            }
            ((x6.l) this.f226859c).g(bArr);
            return b17;
        } catch (java.lang.Throwable th6) {
            f(options2);
            java.util.Queue queue2 = f226856k;
            synchronized (queue2) {
