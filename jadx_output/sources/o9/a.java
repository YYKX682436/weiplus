...
public final class a extends i9.b {
    ...
    public static final int f343677t = t9.d0.f("styl");

    /* renamed from: u, reason: collision with root package name */
    public static final int f343678u = t9.d0.f("tbox");

    /* renamed from: m, reason: collision with root package name */
    public final t9.p f343679m;

    /* renamed from: n, reason: collision with root package name */
    public boolean f343680n;
    ...
    public java.lang.String f343683q;

    /* renamed from: r, reason: collision with root package name */
    public float f343684r;
    ...
    public a(java.util.List list) {
        super("Tx3gDecoder");
        this.f343679m = new t9.p();
        if (list == null || list.size() != 1 || (((byte[]) list.get(0)).length != 48 && ((byte[]) list.get(0)).length != 53)) {
            this.f343681o = 0;
            this.f343682p = -1;
            this.f343683q = "sans-serif";
            this.f343680n = false;
            this.f343684r = 0.85f;
            return;
        }
        byte[] bArr = (byte[]) list.get(0);
        this.f343681o = bArr[24];
        this.f343682p = ((bArr[26] & 255) << 24) | ((bArr[27] & 255) << 16) | ((bArr[28] & 255) << 8) | (bArr[29] & 255);
        this.f343683q = "Serif".equals(new java.lang.String(bArr, 43, bArr.length - 43)) ? "serif" : "sans-serif";
        int i17 = bArr[25] * 20;
        this.f343685s = i17;
        ...
        this.f343684r = f17;
        this.f343684r = java.lang.Math.max(0.0f, java.lang.Math.min(f17, 0.95f));
    }
    ...
    public i9.d f(byte[] bArr, int i17, boolean z17) {
        ...
        int i18;
        t9.p pVar = this.f343679m;
        pVar.u(bArr, i17);
        int i19 = 1;
        int i27 = 0;
        if (!(pVar.f416542c - pVar.f416541b >= 2)) {
        ...
        if (r17 == 0) {
            ...
            if (i28 - i29 >= 2) {
                ...
                if (c17 == 65279 || c17 == 65534) {
                    str = new java.lang.String(pVar.f416540a, pVar.f416541b, r17, java.nio.charset.Charset.forName("UTF-16"));
                    pVar.f416541b += r17;
                    str2 = str;
                }
            }
            str = new java.lang.String(pVar.f416540a, pVar.f416541b, r17, java.nio.charset.Charset.forName(com.tencent.mapsdk.internal.rv.f51270c));
            pVar.f416541b += r17;
            str2 = str;
        }
        if (str2.isEmpty()) {
            return o9.b.f343686e;
        }
        android.text.SpannableStringBuilder spannableStringBuilder = new android.text.SpannableStringBuilder(str2);
        g(spannableStringBuilder, this.f343681o, 0, 0, spannableStringBuilder.length(), 16711680);
        int i37 = this.f343682p;
        int length = spannableStringBuilder.length();
        if (i37 != -1) {
            spannableStringBuilder.setSpan(new android.text.style.ForegroundColorSpan((i37 >>> 8) | ((i37 & 255) << 24)), 0, length, 16711713);
        }
        java.lang.String str3 = this.f343683q;
        int length2 = spannableStringBuilder.length();
        if (str3 != "sans-serif") {
            spannableStringBuilder.setSpan(new android.text.style.TypefaceSpan(str3), 0, length2, 16711713);
        }
        float f17 = this.f343684r;
        while (true) {
            int i38 = pVar.f416542c;
            int i39 = pVar.f416541b;
            if (i38 - i39 < 8) {
            ...
            int c19 = pVar.c();
            if (c19 == f343677t) {
                if ((pVar.f416542c - pVar.f416541b >= 2 ? i19 : i27) == 0) {
                    throw new i9.f("Unexpected subtitle format.");
                }
                int r18 = pVar.r();
                int i47 = i27;
                while (i47 < r18) {
                    if ((pVar.f416542c - pVar.f416541b >= 12 ? i19 : i27) == 0) {
                        throw new i9.f("Unexpected subtitle format.");
                    }
                    int r19 = pVar.r();
                    int r27 = pVar.r();
                    ...
                    int i49 = r18;
                    int i57 = i39;
                    g(spannableStringBuilder, m17, this.f343681o, r19, r27, 0);
                    if (c27 != this.f343682p) {
                ...
                i18 = i39;
                if (c19 == f343678u && this.f343680n) {
                    if (!(pVar.f416542c - pVar.f416541b >= 2)) {
                        throw new i9.f("Unexpected subtitle format.");
                    }
                    f17 = java.lang.Math.max(0.0f, java.lang.Math.min(pVar.r() / this.f343685s, 0.95f));
                }
            }
            pVar.w(i18 + c18);
            i19 = 1;
