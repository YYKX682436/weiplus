...
public final class a {
    ...
    public static final vw4.a f441211a = new vw4.a();
    ...
    */
    public final com.tencent.xweb.y0 a(java.lang.String r24) {
        /*
    ...
    public final java.net.HttpURLConnection b(java.lang.String str) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("AdH5ContentFetcher", "getConnection, exp=" + th6);
            return null;
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.tencent.xweb.y0 c(java.lang.String r6) {
        /*
            r5 = this;
            if (r6 == 0) goto Ld
        ...
        Le:
            ...
            java.nio.charset.Charset r4 = r26.c.f368865a     // Catch: java.lang.Throwable -> Lb
            byte[] r6 = r6.getBytes(r4)     // Catch: java.lang.Throwable -> Lb
            java.lang.String r4 = "getBytes(...)"
            kotlin.jvm.internal.o.f(r6, r4)     // Catch: java.lang.Throwable -> Lb
    ...
    public final java.lang.String d(java.io.InputStream inputStream) {
        ...
        while (true) {
            try {
                ...
                try {
                    com.tencent.mars.xlog.Log.e("AdH5ContentFetcher", "readStringFromStream, exp=" + th6);
                    try {
                        bufferedOutputStream.close();
                    } catch (java.lang.Exception e17) {
                        com.tencent.mars.xlog.Log.e("AdH5ContentFetcher", "readStringFromStream, bufferOs.close exp=" + e17);
                    }
                    try {
                        inputStream.close();
                        return "";
                    } catch (java.lang.Exception e18) {
                        com.tencent.mars.xlog.Log.e("AdH5ContentFetcher", "readStringFromStream, is.close exp=" + e18);
                        return "";
                    }
                } finally {
                }
        ...
        java.lang.String byteArrayOutputStream2 = byteArrayOutputStream.toString(com.tencent.mapsdk.internal.rv.f51270c);
        kotlin.jvm.internal.o.f(byteArrayOutputStream2, "toString(...)");
        try {
            bufferedOutputStream.close();
        } catch (java.lang.Exception e19) {
            com.tencent.mars.xlog.Log.e("AdH5ContentFetcher", "readStringFromStream, bufferOs.close exp=" + e19);
        }
        try {
            inputStream.close();
        } catch (java.lang.Exception e27) {
            com.tencent.mars.xlog.Log.e("AdH5ContentFetcher", "readStringFromStream, is.close exp=" + e27);
        }
