...
public abstract class j {
    ...
    public final jv5.a f295159a;

    /* renamed from: b, reason: collision with root package name */
    public final av5.y f295160b;

    /* renamed from: c, reason: collision with root package name */
    public final kv5.i f295161c;
    ...
    public void b() {
        ...
        int i18;
        int i19;
        jv5.a aVar = this.f295159a;
        bv5.b bVar = aVar.f302265a;
        bVar.getClass();
        int[] g17 = g(av5.f0.b(bVar));
        bv5.b bVar2 = aVar.f302265a;
        bVar2.getClass();
        int[] g18 = g(av5.f0.b(bVar2));
        bVar2.getClass();
        int[] g19 = g(av5.f0.b(bVar2));
        av5.y yVar = this.f295160b;
        av5.n0 c17 = c(yVar);
        int i27 = 0;
        if (c17.h()) {
            uVar = yVar.d(c17);
        ...
        while (true) {
            ...
            if (i38 < length2 && g18[i38] == i27) {
                ...
                int i48 = i37;
                kv5.i iVar = this.f295161c;
                if (binarySearch >= 0) {
                    java.lang.Comparable e17 = e(uVar);
                    i18 = i38;
                    d(iVar, i39, e17 instanceof av5.m0 ? ((av5.m0) e17).f14417d : i39);
                    i39++;
                    i29++;
                } else {
                    i18 = i38;
                    if (java.util.Arrays.binarySearch(g19, i39) >= 0) {
                        ...
                        d(iVar, i39, e18 instanceof av5.m0 ? ((av5.m0) e18).f14417d : i39);
                        i39++;
                    } else if (i39 < i17) {
                        java.lang.Comparable a17 = a(iVar, e(uVar));
                        int i49 = i29;
                        int i57 = i27;
                        h(this.f295161c, i39, a17 instanceof av5.m0 ? ((av5.m0) a17).f14417d : i39, i57, i(a17));
                        i39++;
                        i27 = i57 + 1;
                        i28 = i47;
                        i37 = i48;
    ...
    public final int[] g(int i17) {
        ...
        for (int i19 = 0; i19 < i17; i19++) {
            bv5.b bVar = this.f295159a.f302265a;
            bVar.getClass();
            i18 += av5.f0.a(bVar);
            iArr[i19] = i18;
        }
