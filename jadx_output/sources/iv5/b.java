...
public class b extends iv5.j {
    ...
    public final av5.n0 f295141d;

    /* renamed from: e, reason: collision with root package name */
    public final av5.u f295142e;
    ...
    public b(jv5.a aVar, av5.y yVar, av5.y yVar2, kv5.i iVar) {
        ...
        this.f295142e = null;
        if (yVar2 != null) {
            av5.n0 n0Var = yVar2.f14462a.f14435l;
            this.f295141d = n0Var;
            this.f295142e = yVar2.d(n0Var);
        }
    }
    ...
    public java.lang.Comparable a(kv5.f fVar, java.lang.Comparable comparable) {
        ...
        fVar.getClass();
        int length = cVar.f14357e.length;
        int[] iArr = new int[length];
        for (int i17 = 0; i17 < length; i17++) {
            iArr[i17] = fVar.a(cVar.f14357e[i17]);
        }
        return new av5.c(cVar.f14417d, iArr);
    }

    @Override // iv5.j
    public av5.n0 c(av5.y yVar) {
        return yVar.f14462a.f14435l;
    }
    ...
    public int i(java.lang.Comparable comparable) {
        av5.c cVar = (av5.c) comparable;
        this.f295141d.f14420f++;
        av5.u uVar = this.f295142e;
        uVar.A(uVar.f14457f.f14462a.f14435l, true);
        int position = uVar.f24762a.position();
        uVar.w(cVar.f14357e.length);
        for (int i17 : cVar.f14357e) {
            uVar.w(i17);
        }
        return position;
    }
