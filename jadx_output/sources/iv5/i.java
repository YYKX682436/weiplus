...
public class i extends iv5.j {
    ...
    public final av5.n0 f295157d;

    /* renamed from: e, reason: collision with root package name */
    public final av5.u f295158e;
    ...
    public i(jv5.a aVar, av5.y yVar, av5.y yVar2, kv5.i iVar) {
        ...
        this.f295158e = null;
        if (yVar2 != null) {
            av5.n0 n0Var = yVar2.f14462a.f14440q;
            this.f295157d = n0Var;
            this.f295158e = yVar2.d(n0Var);
        }
    }

    /* JADX WARN: Code restructure failed: missing block: B:32:0x009f, code lost:
    
        return new av5.m(r9.f14417d, r9.f14414e, r2, r4.toByteArray());
     */
    @Override // iv5.j
    /*
    ...
    */
    ...
    public int i(java.lang.Comparable comparable) {
        ...
        this.f295157d.f14420f++;
        av5.u uVar = this.f295158e;
        uVar.A(uVar.f14457f.f14462a.f14440q, true);
        int position = uVar.f24762a.position();
        av5.f0.d(uVar, mVar.f14414e);
        int[] iArr = mVar.f14415f;
