...
public class h extends l75.n0 {
    ...
    public static final java.lang.String[] f426902e = {l75.n0.getCreateSQLs(ue3.g.f426901J, "MagicPkgInfo")};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f426903d;

    public h(l75.k0 k0Var) {
        super(k0Var, ue3.g.f426901J, "MagicPkgInfo", null);
        this.f426903d = k0Var;
    }

    @Override // l75.n0, l75.g0
    public boolean insert(l75.f0 f0Var) {
        this.f426903d.l("MagicPkgInfo", "pkgId", ((ue3.g) f0Var).convertTo());
        return true;
    }

    @Override // l75.n0
    public boolean replace(l75.f0 f0Var) {
        this.f426903d.m("MagicPkgInfo", "pkgId", ((ue3.g) f0Var).convertTo());
        return true;
    }
    ...
    */
    public ue3.g y0(java.lang.String r9) {
        ...
        L4:
            ...
            l75.k0 r3 = r8.f426903d     // Catch: java.lang.Throwable -> L38 java.lang.Exception -> L3d
            r4 = 2
