...
public abstract class c {
    ...
    public static final kk.j f367937a;

    static {
        new java.util.HashMap();
        new java.util.HashMap();
        f367937a = new jt0.j(30);
    }
    ...
    public static iz4.c a(iz4.c cVar, nz4.h hVar) {
        ...
        switch (cVar.d()) {
            ...
            case 1:
                ...
                iVar.f296155t = ((iz4.i) cVar).f296155t;
                oVar = iVar;
                break;
            case 2:
                iz4.f fVar = new iz4.f();
                fVar.f296138t = ((iz4.f) cVar).f296138t;
                oVar = fVar;
                break;
            case 3:
                iz4.g gVar = new iz4.g();
                iz4.g gVar2 = (iz4.g) cVar;
                gVar.f296149u = gVar2.f296149u;
                gVar.f296150v = gVar2.f296150v;
                gVar.f296151w = gVar2.f296151w;
                gVar.f296152x = gVar2.f296152x;
                gVar.f296148t = gVar2.f296148t;
                gVar.f296153y = gVar2.f296153y;
                gVar.f296154z = gVar2.f296154z;
                gVar.A = gVar2.A;
                gVar.B = gVar2.B;
                gVar.C = gVar2.C;
                gVar.D = gVar2.D;
            ...
            case 4:
                ...
                lVar.f296161v = lVar2.f296161v;
                lVar.f296163x = lVar2.f296163x;
                lVar.f296162w = lVar2.f296162w;
                lVar.f296159t = lVar2.f296159t;
                oVar = lVar;
                break;
            case 5:
                iz4.d dVar = new iz4.d();
                iz4.d dVar2 = (iz4.d) cVar;
                dVar.f296156t = dVar2.f296156t;
                dVar.f296157u = dVar2.f296157u;
                dVar.f296158v = dVar2.f296158v;
                oVar = dVar;
                break;
            case 6:
                iz4.k kVar = new iz4.k();
                iz4.k kVar2 = (iz4.k) cVar;
                kVar.f296117t = kVar2.f296117t;
                kVar.f296118u = kVar2.f296118u;
                kVar.f296119v = kVar2.f296119v;
                oVar = kVar;
                break;
            case 7:
                ...
                if (((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_android_we_note_force_check_cdn, 0) == 1) {
                    ...
                    java.util.LinkedList list = pVar.f296136t;
                    if (hVar != null && (i17 = hVar.f341619a) == hVar.f341621c && i17 == pVar.a()) {
        ...
        oVar.f296133q = oVar2.f296133q;
        oVar.f296134r = oVar2.f296134r;
        oVar.f296135s = oVar2.f296135s;
        return oVar;
    }
    ...
    public static java.lang.String b(android.content.Context context, iz4.c cVar) {
        ...
        int d17 = cVar.d();
        return d17 == 1 ? ((iz4.i) cVar).f296155t : d17 == 3 ? context.getString(com.tencent.mm.R.string.l_q) : d17 == 2 ? context.getString(com.tencent.mm.R.string.l_p) : d17 == 6 ? context.getString(com.tencent.mm.R.string.l_r) : d17 == 4 ? context.getString(com.tencent.mm.R.string.l_s) : d17 == 5 ? context.getString(com.tencent.mm.R.string.l_o) : "";
    }
    ...
    public static java.lang.String c(java.lang.String origPath, java.lang.String thumbFullPath) {
        ...
        int i27;
        java.lang.String Y;
        if (com.tencent.mm.sdk.platformtools.t8.K0(thumbFullPath)) {
            thumbFullPath = o72.p5.c() + "/" + (kk.k.g((origPath + java.lang.System.currentTimeMillis()).getBytes()) + "_HD");
        }
        if (!com.tencent.mm.vfs.w6.j(thumbFullPath)) {
            android.graphics.BitmapFactory.Options n07 = com.tencent.mm.sdk.platformtools.x.n0(origPath);
            if (n07 == null || (i17 = n07.outWidth) <= 0 || (i18 = n07.outHeight) <= 0) {
                com.tencent.mars.xlog.Log.e("MicroMsg.WNNoteUtil", "GetImageOptions Error");
                return null;
            }
            ...
            if (com.tencent.mm.sdk.platformtools.q2.d(origPath) > 0) {
                i19 = n07.outHeight;
                i27 = n07.outWidth;
            } else {
                i19 = i29;
            ...
            if (com.tencent.mm.sdk.platformtools.x.x(origPath, i19, i27, format, 95, thumbFullPath, true) && (Y = com.tencent.mm.sdk.platformtools.x.Y(origPath)) != null) {
    ...
    public static java.lang.String d(java.lang.String origPath, java.lang.String thumbFullPath) {
        ...
        if (!com.tencent.mm.vfs.w6.j(thumbFullPath)) {
            android.graphics.BitmapFactory.Options n07 = com.tencent.mm.sdk.platformtools.x.n0(origPath);
            if (n07 == null || (i17 = n07.outWidth) <= 0 || (i18 = n07.outHeight) <= 0) {
                com.tencent.mars.xlog.Log.e("MicroMsg.WNNoteUtil", "GetImageOptions Error,use orignal file");
                return null;
            }
            ...
            kotlin.jvm.internal.o.g(format, "format");
            kotlin.jvm.internal.o.g(thumbFullPath, "thumbFullPath");
            if (com.tencent.mm.sdk.platformtools.x.x(origPath, i17, i18, format, 95, thumbFullPath, true) && (Y = com.tencent.mm.sdk.platformtools.x.Y(origPath)) != null) {
                com.tencent.mm.sdk.platformtools.x.L0(Y, thumbFullPath);
            }
        }
        return thumbFullPath;
    ...
    public static java.util.HashMap j(java.lang.String str, java.lang.String str2, boolean z17, android.content.Context context) {
        ...
        while (matcher.find()) {
            ...
            if (!com.tencent.mm.sdk.platformtools.t8.K0(group)) {
                ...
                while (matcher2.find()) {
                    if (z17) {
                        str3 = str3 + context.getString(com.tencent.mm.R.string.l_u) + i17 + matcher2.group(1);
                    } else {
                        str3 = str3 + context.getString(com.tencent.mm.R.string.f492738ho4) + matcher2.group(1);
                    }
                    i17++;
                }
    ...
    public static java.lang.String k(iz4.c cVar) {
        return cVar == null ? "" : cVar.d() == 2 ? ((iz4.f) cVar).f296135s : cVar.d() == 6 ? ((iz4.k) cVar).f296117t : "";
    }
    ...
    public static java.lang.String l(java.lang.String str, android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WNNoteUtil", sb6.toString());
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str) && cVar.g(true)) {
            try {
                java.lang.String replaceAll = str.replaceAll("<wn-todo checked=\"0\" >", context.getString(com.tencent.mm.R.string.kdu)).replaceAll("<wn-todo checked=\"1\" >", context.getString(com.tencent.mm.R.string.kdt)).replaceAll("</wn-todo>", "");
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.WNNoteUtil", "e = " + e17);
            }
            com.tencent.mars.xlog.Log.i("MicroMsg.WNNoteUtil", "end htmlStr = " + str);
        }
        return str;
    }
}
