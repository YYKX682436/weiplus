...
public final class j0 extends android.animation.AnimatorListenerAdapter {
    ...
    public boolean f460116d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ y84.h3 f460117e;
    ...
    public void onAnimationCancel(android.animation.Animator animation) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onAnimationCancel", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
        kotlin.jvm.internal.o.g(animation, "animation");
        this.f460116d = true;
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationCancel", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public void onAnimationEnd(android.animation.Animator animation) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onAnimationEnd", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
        kotlin.jvm.internal.o.g(animation, "animation");
        boolean z17 = this.f460116d;
        y84.h3 h3Var = this.f460117e;
        if (z17) {
            com.tencent.mars.xlog.Log.w(h3Var.j(), "select card part status, anim is canceled");
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationEnd", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
        } else {
            y84.h3.O(h3Var);
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationEnd", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
        }
    ...
    public void onAnimationStart(android.animation.Animator animation) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onAnimationStart", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
        kotlin.jvm.internal.o.g(animation, "animation");
        ...
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationStart", "com.tencent.mm.plugin.sns.ad.widget.randomselectcard.AdRandomSelectCardComponent$getSelectCardAnim$recycleViewAlphaAnim$1$1");
    }
}
