...
public class f1 implements android.view.ViewTreeObserver.OnPreDrawListener, android.view.View.OnAttachStateChangeListener {
    ...
    public final androidx.transition.Transition f424475d;

    /* renamed from: e, reason: collision with root package name */
    public final android.view.ViewGroup f424476e;

    public f1(androidx.transition.Transition transition, android.view.ViewGroup viewGroup) {
        this.f424475d = transition;
        this.f424476e = viewGroup;
    }
    ...
    */
    ...
    public void onViewDetachedFromWindow(android.view.View view) {
        android.view.ViewGroup viewGroup = this.f424476e;
        viewGroup.getViewTreeObserver().removeOnPreDrawListener(this);
        viewGroup.removeOnAttachStateChangeListener(this);
        u4.g1.f424480c.remove(viewGroup);
        java.util.ArrayList arrayList = (java.util.ArrayList) u4.g1.b().getOrDefault(viewGroup, null);
        if (arrayList != null && arrayList.size() > 0) {
            java.util.Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                ((androidx.transition.Transition) it.next()).G(viewGroup);
            }
        }
        this.f424475d.l(true);
    }
}
