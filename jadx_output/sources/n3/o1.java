...
public abstract class o1 {
    ...
    public static final java.lang.reflect.Method f334378a;

    static {
        if (android.os.Build.VERSION.SDK_INT == 25) {
            try {
                f334378a = android.view.ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new java.lang.Class[0]);
    ...
    public static float a(android.view.ViewConfiguration viewConfiguration, android.content.Context context) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 25 && (method = f334378a) != null) {
            try {
