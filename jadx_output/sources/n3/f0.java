...
public class f0 {
    ...
    public android.view.ViewParent f334331a;

    /* renamed from: b, reason: collision with root package name */
    public android.view.ViewParent f334332b;

    /* renamed from: c, reason: collision with root package name */
    public final android.view.View f334333c;

    /* renamed from: d, reason: collision with root package name */
    public boolean f334334d;
    ...
    public boolean a(float f17, float f18, boolean z17) {
        ...
        if (!this.f334334d || (g17 = g(0)) == null) {
            return false;
        }
        try {
            return n3.y1.a(g17, this.f334333c, f17, f18, z17);
    ...
    public boolean b(float f17, float f18) {
        ...
        try {
            return n3.y1.b(g17, this.f334333c, f17, f18);
        } catch (java.lang.AbstractMethodError unused) {
            java.util.Objects.toString(g17);
            return false;
        }
    ...
    public boolean d(int i17, int i18, int[] iArr, int[] iArr2, int i19) {
        ...
        int i28;
        int[] iArr3;
        if (!this.f334334d || (g17 = g(i19)) == null) {
            return false;
        }
        if (i17 == 0 && i18 == 0) {
            if (iArr2 == null) {
        ...
        android.view.View view = this.f334333c;
        if (iArr2 != null) {
        ...
        if (iArr == null) {
            if (this.f334335e == null) {
                this.f334335e = new int[2];
            }
            iArr3 = this.f334335e;
        } else {
            iArr3 = iArr;
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        android.view.View view2 = this.f334333c;
    ...
    public final boolean f(int i17, int i18, int i19, int i27, int[] iArr, int i28, int[] iArr2) {
        ...
        int i37;
        int[] iArr3;
        if (!this.f334334d || (g17 = g(i28)) == null) {
            return false;
        }
    ...
    public final android.view.ViewParent g(int i17) {
        if (i17 == 0) {
            return this.f334331a;
        }
        if (i17 != 1) {
            return null;
        }
        return this.f334332b;
    }
    ...
    public boolean j(int i17, int i18) {
        ...
        if (this.f334334d) {
            ...
            for (android.view.ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                ...
                if (f17) {
                    if (i18 == 0) {
                        this.f334331a = parent;
                    } else if (i18 == 1) {
                        this.f334332b = parent;
                    }
                    if (z17) {
