...
public class d3 {
    ...
    public static final n3.g3 f334328b;

    /* renamed from: a, reason: collision with root package name */
    public final n3.g3 f334329a;

    static {
        int i17 = android.os.Build.VERSION.SDK_INT;
        f334328b = (i17 >= 30 ? new n3.w2() : i17 >= 29 ? new n3.v2() : new n3.u2()).b().f334338a.a().f334338a.b().f334338a.c();
    }
