...
public abstract class x2 {
    ...
    public final n3.g3 f334438a;

    /* renamed from: b, reason: collision with root package name */
    public e3.d[] f334439b;
    ...
    public final void a() {
        ...
        if (dVarArr != null) {
            ...
            e3.d dVar2 = this.f334439b[n3.e3.a(2)];
            n3.g3 g3Var = this.f334438a;
            if (dVar2 == null) {
                dVar2 = g3Var.a(2);
            }
            if (dVar == null) {
            ...
            g(e3.d.a(dVar, dVar2));
            e3.d dVar3 = this.f334439b[n3.e3.a(16)];
            if (dVar3 != null) {
                f(dVar3);
            }
            e3.d dVar4 = this.f334439b[n3.e3.a(32)];
            if (dVar4 != null) {
                d(dVar4);
            }
            e3.d dVar5 = this.f334439b[n3.e3.a(64)];
            if (dVar5 != null) {
                h(dVar5);
            }
        }
    ...
    public void c(int i17, e3.d dVar) {
        if (this.f334439b == null) {
            this.f334439b = new e3.d[9];
        }
        for (int i18 = 1; i18 <= 256; i18 <<= 1) {
            if ((i17 & i18) != 0) {
                this.f334439b[n3.e3.a(i18)] = dVar;
            }
        }
    }
