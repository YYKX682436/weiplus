...
public class c3 extends n3.b3 {
    ...
    public static final n3.g3 f334327q = n3.g3.i(android.view.WindowInsets.CONSUMED, null);
    ...
    public e3.d g(int i17) {
        return e3.d.d(this.f334446c.getInsets(n3.f3.a(i17)));
    }

    @Override // n3.y2, n3.d3
    public e3.d h(int i17) {
        return e3.d.d(this.f334446c.getInsetsIgnoringVisibility(n3.f3.a(i17)));
    }

    @Override // n3.y2, n3.d3
    public boolean p(int i17) {
        return this.f334446c.isVisible(n3.f3.a(i17));
    }
