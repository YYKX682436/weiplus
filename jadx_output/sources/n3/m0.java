...
public final class m0 implements android.view.ViewTreeObserver.OnPreDrawListener, android.view.View.OnAttachStateChangeListener {
    ...
    public final android.view.View f334367d;

    /* renamed from: e, reason: collision with root package name */
    public android.view.ViewTreeObserver f334368e;

    /* renamed from: f, reason: collision with root package name */
    public final java.lang.Runnable f334369f;

    public m0(android.view.View view, java.lang.Runnable runnable) {
        this.f334367d = view;
        this.f334368e = view.getViewTreeObserver();
        this.f334369f = runnable;
    }
    ...
    public boolean onPreDraw() {
        boolean isAlive = this.f334368e.isAlive();
        android.view.View view = this.f334367d;
        if (isAlive) {
            this.f334368e.removeOnPreDrawListener(this);
        } else {
    ...
    public void onViewDetachedFromWindow(android.view.View view) {
        boolean isAlive = this.f334368e.isAlive();
        android.view.View view2 = this.f334367d;
        if (isAlive) {
            this.f334368e.removeOnPreDrawListener(this);
        } else {
