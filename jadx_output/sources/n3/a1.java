...
public abstract class a1 {
    public static void a(android.view.WindowInsets windowInsets, android.view.View view) {
        android.view.View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (android.view.View.OnApplyWindowInsetsListener) view.getTag(com.tencent.mm.R.id.nxg);
    ...
    public static n3.g3 j(android.view.View view) {
        if (n3.t2.f334416d && view.isAttachedToWindow()) {
            try {
                java.lang.Object obj = n3.t2.f334413a.get(view.getRootView());
                if (obj != null) {
                    android.graphics.Rect rect = (android.graphics.Rect) n3.t2.f334414b.get(obj);
                    android.graphics.Rect rect2 = (android.graphics.Rect) n3.t2.f334415c.get(obj);
                    if (rect != null && rect2 != null) {
                        ...
                        n3.g3 b17 = w2Var.b();
                        b17.f334338a.s(b17);
                        b17.f334338a.d(view.getRootView());
                        return b17;
                    }
                }
    ...
    public static void u(android.view.View view, n3.k0 k0Var) {
        if (android.os.Build.VERSION.SDK_INT < 30) {
            view.setTag(com.tencent.mm.R.id.f487214nx0, k0Var);
        }
        if (k0Var == null) {
            view.setOnApplyWindowInsetsListener((android.view.View.OnApplyWindowInsetsListener) view.getTag(com.tencent.mm.R.id.nxg));
        } else {
