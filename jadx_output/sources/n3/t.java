...
public abstract class t {
    ...
    public static boolean f334407a;

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.reflect.Method f334408b;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f334409c;

    /* renamed from: d, reason: collision with root package name */
    public static java.lang.reflect.Field f334410d;
    ...
    public static boolean a(android.view.View view, android.view.KeyEvent keyEvent) {
        ...
        if (android.os.Build.VERSION.SDK_INT < 28) {
            ...
            java.lang.ref.WeakReference weakReference2 = k1Var.f334352c;
            if (weakReference2 == null || weakReference2.get() != keyEvent) {
                k1Var.f334352c = new java.lang.ref.WeakReference(keyEvent);
                if (k1Var.f334351b == null) {
                    k1Var.f334351b = new android.util.SparseArray();
                }
                android.util.SparseArray sparseArray = k1Var.f334351b;
    ...
    */
    public static boolean b(n3.s r7, android.view.View r8, android.view.Window.Callback r9, android.view.KeyEvent r10) {
        ...
        Lf:
            ...
            n3.t.f334408b = r1     // Catch: java.lang.NoSuchMethodException -> L4a
        L4a:
            n3.t.f334407a = r3
        L4c:
            java.lang.reflect.Method r1 = n3.t.f334408b
            if (r1 == 0) goto L61
