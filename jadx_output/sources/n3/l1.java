...
public abstract class l1 {
    ...
    public static java.util.WeakHashMap f334362a;

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.reflect.Field f334363b;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f334364c;
    ...
    public static n3.z1 a(android.view.View view) {
        if (f334362a == null) {
            f334362a = new java.util.WeakHashMap();
        }
        n3.z1 z1Var = (n3.z1) f334362a.get(view);
        if (z1Var != null) {
            return z1Var;
        }
        n3.z1 z1Var2 = new n3.z1(view);
        f334362a.put(view, z1Var2);
        return z1Var2;
    }
    ...
    public static boolean c(android.view.View view, android.view.KeyEvent keyEvent) {
        ...
        java.util.ArrayList arrayList = n3.k1.f334349d;
        n3.k1 k1Var = (n3.k1) view.getTag(com.tencent.mm.R.id.nxd);
        if (k1Var == null) {
            k1Var = new n3.k1();
            view.setTag(com.tencent.mm.R.id.nxd, k1Var);
        }
        if (keyEvent.getAction() == 0) {
            java.util.WeakHashMap weakHashMap = k1Var.f334350a;
            if (weakHashMap != null) {
                weakHashMap.clear();
            }
            java.util.ArrayList arrayList2 = n3.k1.f334349d;
            if (!arrayList2.isEmpty()) {
                synchronized (arrayList2) {
                    if (k1Var.f334350a == null) {
                        k1Var.f334350a = new java.util.WeakHashMap();
                    }
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (a17 != null && !android.view.KeyEvent.isModifierKey(keyCode)) {
                if (k1Var.f334351b == null) {
                    k1Var.f334351b = new android.util.SparseArray();
                }
                k1Var.f334351b.put(keyCode, new java.lang.ref.WeakReference(a17));
            }
        }
        return a17 != null;
    }
    ...
    public static n3.c e(android.view.View view) {
        ...
        return f17 instanceof n3.a ? ((n3.a) f17).f334321a : new n3.c(f17);
    }
    ...
    public static android.view.View.AccessibilityDelegate f(android.view.View view) {
        ...
        try {
            java.lang.Object obj = f334363b.get(view);
    ...
    public static java.lang.CharSequence g(android.view.View view) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 28) {
            ...
            tag = view.getTag(com.tencent.mm.R.id.nwi);
    ...
    public static void j(int i17, android.view.View view) {
        java.util.ArrayList arrayList = (java.util.ArrayList) view.getTag(com.tencent.mm.R.id.nwf);
        if (arrayList == null) {
            arrayList = new java.util.ArrayList();
            view.setTag(com.tencent.mm.R.id.nwf, arrayList);
        }
        for (int i18 = 0; i18 < arrayList.size(); i18++) {
            if (((android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction) ((o3.f) arrayList.get(i18)).f342636a).getId() == i17) {
    ...
    public static void k(android.view.View view, o3.f fVar, java.lang.CharSequence charSequence, o3.a0 a0Var) {
        if (a0Var == null && charSequence == null) {
            j(((android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction) fVar.f342636a).getId(), view);
            h(view, 0);
            return;
        }
        o3.f fVar2 = new o3.f(null, fVar.f342637b, charSequence, a0Var, fVar.f342638c);
        d(view);
        j(((android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction) fVar2.f342636a).getId(), view);
        java.util.ArrayList arrayList = (java.util.ArrayList) view.getTag(com.tencent.mm.R.id.nwf);
        if (arrayList == null) {
            arrayList = new java.util.ArrayList();
            view.setTag(com.tencent.mm.R.id.nwf, arrayList);
    ...
    public static void n(android.view.View view, java.lang.String[] strArr, n3.l0 l0Var) {
        ...
        view.setTag(com.tencent.mm.R.id.f487216nx2, strArr);
        view.setTag(com.tencent.mm.R.id.f487215nx1, l0Var);
    }
    ...
    public static void o(android.view.View view, n3.j2 j2Var) {
        ...
        java.lang.Object tag = view.getTag(com.tencent.mm.R.id.f487214nx0);
        if (j2Var == null) {
            view.setTag(com.tencent.mm.R.id.nxg, null);
            if (tag == null) {
        ...
        view.setTag(com.tencent.mm.R.id.nxg, n2Var);
        if (tag == null) {
