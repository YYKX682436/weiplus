...
public class f extends i95.w implements qk.k8 {
    ...
    public java.util.Map Di(int i17) {
        ...
        if (i17 == 999) {
            ...
            jm4.i4 i4Var = (a17 == null || (d17 = ((jm4.w2) a17).d(eq0Var)) == null) ? null : (jm4.i4) urgen.ur_0025.UR_882D.UR_F14F(((jm4.p2) d17).getCppPointer());
            Zi = i4Var == null ? z8Var.Zi() : i4Var;
        }
        if (Zi != null) {
            return Ni(urgen.ur_0025.UR_5769.UR_1E61(((jm4.k4) Zi).getCppPointer()));
        }
        return null;
    }
    ...
    public bw5.xa wi(int i17, java.util.Map map, java.util.Map map2, java.util.Map map3) {
        ...
        java.lang.String f17 = ((cy1.a) ((dy1.r) i95.n0.c(dy1.r.class))).f224690m.f();
        if (f17 == null) {
            f17 = "";
        }
        java.lang.String str = ((cy1.a) ((dy1.r) i95.n0.c(dy1.r.class))).f224690m.f413870y;
        if (str == null) {
            str = "";
        }
        dj0Var.f26506d = f17;
        boolean[] zArr = dj0Var.f26508f;
        zArr[1] = true;
        dj0Var.f26507e = str;
        zArr[2] = true;
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        int i18 = i17 & 1;
        boolean[] zArr2 = xaVar.f35022i;
        if (i18 != 0) {
            bw5.s sVar = new bw5.s();
            sVar.f32718d = currentTimeMillis;
            boolean[] zArr3 = sVar.C;
            zArr3[1] = true;
            j17 = currentTimeMillis;
            sVar.f32719e = Ai(map, com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, 0);
            zArr3[2] = true;
            sVar.f32720f = dj0Var;
            zArr3[3] = true;
            ...
            if (map.containsKey("baseidissharedfrom3rd")) {
                sVar.f32732u = Ai(map, "baseidissharedfrom3rd", 0);
                zArr3[16] = true;
            }
            ...
            if (map2 != null && map2.size() > 0) {
                for (java.lang.String str2 : map2.keySet()) {
                    ...
                    gj0Var.f27877d = str2;
                    boolean[] zArr4 = gj0Var.f27879f;
                    zArr4[1] = true;
                    gj0Var.f27878e = (java.lang.String) map2.get(str2);
                    zArr4[2] = true;
                    sVar.f32736y.add(gj0Var);
                    zArr3[20] = true;
                }
            }
            if (map3 != null && map3.size() > 0) {
                for (java.lang.String str3 : map3.keySet()) {
                    ...
                    gj0Var2.f27877d = str3;
                    boolean[] zArr5 = gj0Var2.f27879f;
                    zArr5[1] = true;
                    gj0Var2.f27878e = (java.lang.String) map3.get(str3);
                    zArr5[2] = true;
                    sVar.B.add(gj0Var2);
                    zArr3[23] = true;
                }
        ...
        if ((i17 & 2) != 0) {
            ...
            j18 = j17;
            r1Var.f32362d = j18;
            boolean[] zArr6 = r1Var.f32365g;
            zArr6[1] = true;
            r1Var.f32364f = Ai(map, com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, 0);
            zArr6[3] = true;
            r1Var.f32363e = dj0Var;
            zArr6[2] = true;
            xaVar.f35018e = r1Var;
            zArr2[2] = true;
        } else {
        ...
        if ((i17 & 4) != 0) {
            ...
            xk0Var.f35178d = j18;
            xk0Var.f35179e[1] = true;
            xaVar.f35019f = xk0Var;
            zArr2[3] = true;
        }
        if ((i17 & 8) != 0) {
            bw5.wk0 wk0Var = new bw5.wk0();
            wk0Var.f34756d = j18;
            boolean[] zArr7 = wk0Var.f34769t;
            zArr7[1] = true;
            wk0Var.f34757e = dj0Var;
            zArr7[2] = true;
            ...
            if (map.containsKey("lineloc")) {
                wk0Var.f34760h = Ai(map, "lineloc", 0);
                zArr7[6] = true;
            }
