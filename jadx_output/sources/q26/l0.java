...
public final class l0 implements q26.n, q26.f {
    ...
    public q26.n a(int i17) {
        int i18 = this.f359869b;
        return i17 >= i18 ? q26.g.f359840a : new q26.j0(this.f359868a, i17, i18);
    }

    @Override // q26.f
    public q26.n b(int i17) {
        return i17 >= this.f359869b ? this : new q26.l0(this.f359868a, i17);
    }
