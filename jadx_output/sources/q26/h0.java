...
public abstract class h0 extends q26.z {
    ...
    public static final java.lang.Object g(q26.n nVar, int i17, yz5.l defaultValue) {
        ...
        if (i17 < 0) {
            return defaultValue.invoke(java.lang.Integer.valueOf(i17));
        }
        int i18 = 0;
    ...
    public static final q26.n m(q26.n nVar, yz5.l transform) {
        ...
        return new q26.k(nVar, transform, q26.d0.f359835d);
    }
    ...
    public static final q26.n p(q26.n nVar, yz5.l transform) {
        kotlin.jvm.internal.o.g(nVar, "<this>");
        kotlin.jvm.internal.o.g(transform, "transform");
        return j(new q26.r0(nVar, transform), q26.c0.f359832d);
    }
    ...
    public static final q26.n w(q26.n nVar, int i17) {
        kotlin.jvm.internal.o.g(nVar, "<this>");
        if (i17 >= 0) {
            return i17 == 0 ? q26.g.f359840a : nVar instanceof q26.f ? ((q26.f) nVar).b(i17) : new q26.l0(nVar, i17);
        }
