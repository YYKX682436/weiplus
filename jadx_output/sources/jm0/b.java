...
public class b implements java.util.Iterator {
    ...
    public int f300262d = 0;

    public b(jm0.c cVar, jm0.a aVar) {
    }

    @Override // java.util.Iterator
    public boolean hasNext() {
        return this.f300262d < 61;
    }

    @Override // java.util.Iterator
    public java.lang.Object next() {
        int i17 = this.f300262d;
        this.f300262d = i17 + 1;
        switch (i17) {
            case 0:
            ...
            default:
                throw new java.lang.IndexOutOfBoundsException("No more elements, total count: 61");
        }
    }
}
