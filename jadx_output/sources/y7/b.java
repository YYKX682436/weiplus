...
public abstract class b {
    ...
    public static final java.io.FileFilter f459666a = new y7.a();
    ...
    public static int a(byte[] bArr, int i17) {
        ...
        while (i17 < bArr.length && (b17 = bArr[i17]) != 10) {
            if (java.lang.Character.isDigit(b17)) {
                ...
                return com.tencent.mm.sdk.platformtools.t8.D1(new java.lang.String(bArr, 0, i17, i18 - i17), 0);
            }
            i17++;
        }
        return -1;
    ...
    public static int b() {
        ...
        for (int i27 = 0; i27 < d(); i27++) {
            try {
                ...
                if (file.exists() && file.canRead()) {
                    ...
                    try {
                        com.tencent.mm.vfs.w6.E(file.getPath()).read(bArr);
                        int i28 = 0;
                        while (java.lang.Character.isDigit(bArr[i28]) && i28 < 128) {
                            i28++;
                        }
                        java.lang.Integer valueOf = java.lang.Integer.valueOf(com.tencent.mm.sdk.platformtools.t8.D1(new java.lang.String(bArr, 0, i28), 0));
        ...
        if (i19 == -1) {
            java.io.InputStream E = com.tencent.mm.vfs.w6.E("/proc/cpuinfo");
            try {
    ...
    */
    public static int c(java.lang.String r3) {
        /*
            r0 = -1
            r1 = 0
            java.io.InputStream r1 = com.tencent.mm.vfs.w6.E(r3)     // Catch: java.lang.Throwable -> L34 java.io.IOException -> L3b
        ...
        L22:
            ...
            r2 = 0
            int r3 = com.tencent.mm.sdk.platformtools.t8.P(r3, r2)     // Catch: java.lang.Throwable -> L34 java.io.IOException -> L3b
            int r0 = r3 + 1
        L2e:
            if (r1 == 0) goto L33
    ...
    public static int d() {
        try {
            ...
            return c17 == -1 ? new java.io.File("/sys/devices/system/cpu/").listFiles(f459666a).length : c17;
    ...
    public static long e(android.content.Context context) {
        ...
        ((android.app.ActivityManager) context.getSystemService(com.tencent.tinker.loader.hotplug.EnvConsts.ACTIVITY_MANAGER_SRVNAME)).getMemoryInfo(memoryInfo);
