...
public class h {
    ...
    public static final java.lang.Class[] f257264c = {android.content.Context.class, android.util.AttributeSet.class};

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.HashMap f257265d = new java.util.HashMap();

    /* renamed from: a, reason: collision with root package name */
    public final android.content.Context f257266a;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.Object[] f257267b = new java.lang.Object[2];

    public h(android.content.Context context) {
        this.f257266a = context;
    }
    ...
    public final android.preference.Preference a(java.lang.String str, java.lang.String str2, android.util.AttributeSet attributeSet) {
        ...
        java.util.HashMap hashMap = f257265d;
        java.lang.reflect.Constructor<?> constructor = (java.lang.reflect.Constructor) hashMap.get(str);
        if (constructor == null) {
            try {
                java.lang.ClassLoader classLoader = this.f257266a.getClassLoader();
                if (str2 != null) {
                    str3 = str2 + str;
                } else {
                    str3 = str;
                }
                constructor = classLoader.loadClass(str3).getConstructor(f257264c);
        ...
        java.lang.Object[] objArr = this.f257267b;
