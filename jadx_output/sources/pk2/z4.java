...
public final class z4 extends qk2.d {
    ...
    public final java.lang.String f356423i;

    /* renamed from: j, reason: collision with root package name */
    public final java.lang.String f356424j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z4(pk2.o9 helper, int i17) {
        super(helper, i17);
        kotlin.jvm.internal.o.g(helper, "helper");
        this.f356423i = "AssistantAskProductionOption";
        this.f356424j = "anchorlive.more.commentmanage.askproduction";
    }

    @Override // qk2.f
    public java.lang.String i() {
        return this.f356424j;
    }
    ...
    public void t(pk2.o9 o9Var, com.tencent.mm.plugin.finder.view.e3 bottomSheet, java.lang.Integer num) {
        ...
        if (L >= 0 && string.length() + L <= string2.length()) {
            spannableString.setSpan(new pk2.y4(this, mMActivity), L, string.length() + L, 33);
        }
