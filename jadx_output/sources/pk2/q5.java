...
public final class q5 extends qk2.d {
    ...
    public final java.lang.String f356192i;

    /* renamed from: j, reason: collision with root package name */
    public final java.lang.String f356193j;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q5(pk2.o9 helper, int i17) {
        super(helper, i17);
        kotlin.jvm.internal.o.g(helper, "helper");
        this.f356192i = "AssistantDesignedGiftOption";
        this.f356193j = "assistant.more.morefunction.designedgift";
    }

    @Override // qk2.f
    public java.lang.String i() {
        return this.f356193j;
    }

    @Override // qk2.d, qk2.f
    public boolean o() {
        return ((mm2.c1) this.f364427a.c(mm2.c1.class)).C;
    }
    ...
    public void t(pk2.o9 o9Var, com.tencent.mm.plugin.finder.view.e3 bottomSheet, java.lang.Integer num) {
        ...
        if (textView != null) {
            ...
            if (L >= 0 && string.length() + L <= string2.length()) {
                spannableString.setSpan(new pk2.o5(this, mMActivity), L, string.length() + L, 33);
            }
            textView.setText(spannableString);
            textView.setMovementMethod(android.text.method.LinkMovementMethod.getInstance());
        }
        boolean A = pm0.v.A(((mm2.c1) o9Var.c(mm2.c1.class)).f328866q, 4294967296L);
        if (!o()) {
        ...
        com.tencent.mm.plugin.finder.view.LoadingSwitchBtn g17 = o9Var.g(view, com.tencent.mm.R.id.vbp, A);
