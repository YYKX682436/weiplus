...
public final class y4 extends android.text.style.ClickableSpan {
    ...
    public final /* synthetic */ pk2.z4 f356395d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f356396e;

    public y4(pk2.z4 z4Var, android.content.Context context) {
        this.f356395d = z4Var;
        this.f356396e = context;
    }
    ...
    public void updateDrawState(android.text.TextPaint ds6) {
        ...
        ds6.setColor(this.f356396e.getResources().getColor(com.tencent.mm.R.color.f479308vo));
