...
public final class y extends a24.g {
    ...
    public void h(in5.s0 holder, in5.c cVar, int i17, int i18, boolean z17, java.util.List list) {
        ...
        android.view.ViewGroup viewGroup = (android.view.ViewGroup) holder.itemView.findViewById(com.tencent.mm.R.id.f486681m43);
        if (viewGroup != null) {
            int i19 = 0;
            while (true) {
        ...
        if (iVar instanceof s24.g) {
            com.tencent.mm.ui.widget.MMSwitchBtn mMSwitchBtn = (com.tencent.mm.ui.widget.MMSwitchBtn) holder.p(com.tencent.mm.R.id.btf);
            if (mMSwitchBtn != null) {
                s24.g gVar = (s24.g) iVar;
                mMSwitchBtn.setSwitchListener(gVar.getF161961h());
                mMSwitchBtn.setCheck(gVar.getF161990i());
            }
            android.widget.TextView textView = (android.widget.TextView) holder.p(android.R.id.title);
            if (textView != null) {
                textView.setText(iVar.c7());
            }
            android.view.View p17 = holder.p(com.tencent.mm.R.id.vaj);
            if (p17 != null) {
            ...
            q(holder, iVar.getF161878p(), android.R.id.summary, t24.v.f415341d);
            q(holder, null, android.R.id.icon, t24.w.f415342d);
            q(holder, holder.f293121e.getDrawable(com.tencent.mm.R.drawable.bfj), com.tencent.mm.R.id.oct, t24.x.f415343d);
        }
    }
    ...
    public java.lang.Integer n(in5.s0 holder, a24.i baseItem, int i17, int i18) {
        ...
        return java.lang.Integer.valueOf(com.tencent.mm.R.layout.f489297c13);
    }
}
