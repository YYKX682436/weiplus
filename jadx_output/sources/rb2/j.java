...
public final class j extends ym5.n0 {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.FinderCommentAdVideoView f393655a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ long f393656b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ in5.s0 f393657c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ so2.y0 f393658d;

    public j(com.tencent.mm.plugin.finder.view.FinderCommentAdVideoView finderCommentAdVideoView, long j17, in5.s0 s0Var, so2.y0 y0Var) {
        this.f393655a = finderCommentAdVideoView;
        this.f393656b = j17;
        this.f393657c = s0Var;
        this.f393658d = y0Var;
    }
    ...
    public boolean getAdditionalCondition(android.view.View target) {
        ...
        android.content.Context context2 = this.f393657c.f293121e;
    ...
    public void onViewExposed(android.view.View view, long j17, long j18, boolean z17) {
        ...
        so2.y0 y0Var = this.f393658d;
        in5.s0 s0Var = this.f393657c;
        com.tencent.mm.plugin.finder.view.FinderCommentAdVideoView finderCommentAdVideoView = this.f393655a;
        if (!z17) {
            ...
            if (player != null ? player.isPlaying() : false) {
                ...
                com.tencent.mars.xlog.Log.w("Finder.FinderCommentConvert", "onViewExposed: ad video view is not playing, do not pause");
                return;
            }
        }
        finderCommentAdVideoView.getMediaReporter().e(this.f393656b);
        ...
        if (finderCommentAdVideoView.getPlayerState() == 6) {
            com.tencent.mm.plugin.mmplayer.player.view.MMVideoFrameLayout.r(this.f393655a, null, 0L, 3, null);
        } else {
