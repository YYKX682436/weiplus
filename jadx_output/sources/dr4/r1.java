...
public abstract class r1 extends os0.a {
    ...
    public android.util.Size A() {
        return new android.util.Size(this.f347992a, this.f347993b);
    }

    public boolean B() {
        return gq4.v.wi().f365977k;
    }
    ...
    public void u(int i17, int i18) {
        if (B() && (i17 != this.I || i18 != this.f242737J)) {
            int i19 = this.f347994c;
            this.G = i19;
            int i27 = this.f347995d;
            this.H = i27;
            this.I = i17;
            this.f242737J = i18;
    ...
    public final boolean x() {
        ...
        if (this.O && (str = this.P) != null) {
            for (java.lang.String str2 : r26.n0.f0(str, new java.lang.String[]{"$"}, false, 0, 6, null)) {
                ...
                if ((str3 != null && r26.n0.B(str3, str2, false)) && !kotlin.jvm.internal.o.b(str2, "")) {
                    return true;
                }
            }
        }
