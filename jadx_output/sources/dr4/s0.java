...
public class s0 extends dr4.r1 {
    ...
    public s0(int i17, int i18, int i19, int i27, int i28, int i29, int i37, kotlin.jvm.internal.i iVar) {
    ...
    public void n() {
        cr4.a aVar = this.T;
        if (aVar != null) {
            android.opengl.GLES20.glDeleteProgram(aVar.f221976f);
            q05.c cVar = aVar.f221971a;
            if (cVar != null) {
                cVar.a();
            }
        }
        cr4.d dVar = this.S;
        if (dVar != null) {
            is0.c cVar2 = dVar.f221995d;
            if (cVar2 != null) {
                cVar2.close();
            }
            is0.c cVar3 = dVar.f221996e;
            if (cVar3 != null) {
                cVar3.close();
            }
            is0.c cVar4 = dVar.f221997f;
            if (cVar4 != null) {
                cVar4.close();
            }
            android.opengl.GLES20.glDeleteProgram(dVar.f221992a);
        }
        android.opengl.GLES20.glDeleteProgram(this.R.f221985b);
        super.n();
    }
    ...
    */
    ...
    public void s(int i17) {
        if (this.f347996e == 2) {
            this.f348005n = (i17 + 180) % com.tencent.wxmm.v2helper.VOIP_ENC_HEIGHT_LV1;
        } else {
            this.f348005n = i17;
        }
    }
    ...
    public void y(java.nio.ByteBuffer pBuff, int i17, int i18) {
        kotlin.jvm.internal.o.g(pBuff, "pBuff");
        cr4.d dVar = this.S;
        if (dVar != null) {
            pBuff.position(0);
            is0.c cVar = dVar.f221995d;
            if (cVar != null) {
                cVar.a(i17, i18, 6409, pBuff, 9729, 33071);
            }
            int i19 = i17 * i18;
            pBuff.position(i19);
            is0.c cVar2 = dVar.f221996e;
            if (cVar2 != null) {
                cVar2.a(i17 / 2, i18 / 2, 6409, pBuff, 9729, 33071);
            }
            pBuff.position((i19 * 5) / 4);
            is0.c cVar3 = dVar.f221997f;
            if (cVar3 != null) {
