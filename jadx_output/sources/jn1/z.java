...
public class z extends jn1.c {
    ...
    public j75.b handleConvertDataToBitmap(g75.z state, gk0.e action) {
        ...
        sVar.rj(str, bitmap);
        com.tencent.mars.xlog.Log.i("MicroMsg.Avatar.HdAvatarLoadBitmapFlowPPC", "put HD bitmap to cache " + str);
    ...
    public j75.b handleDataFromFile(g75.z state, gk0.q action) {
        ...
        if (action.f272450d != null) {
            state.l("Avatar_HdImgPath", action.f272449c);
        }
    ...
    public j75.b handleDataFromRemote(g75.z state, y01.c action) {
        ...
        if (action.f458588d != null) {
            state.l("Avatar_HdImgPath", action.f458587c);
        }
    ...
    public j75.b l(g75.z state) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.Avatar.HdAvatarLoadBitmapFlowPPC", "hit hd bitmap cache " + k17);
        g75.z zVar = new g75.z();
