...
public class s2 extends t23.f {
    ...
    public final android.content.ContentResolver f415264h = com.tencent.mm.sdk.platformtools.x2.f193071a.getContentResolver();

    /* renamed from: i, reason: collision with root package name */
    public final boolean f415265i;

    public s2() {
        com.tencent.mm.repairer.config.albumpicker.RepairerConfigAlbumQueryDuration repairerConfigAlbumQueryDuration = new com.tencent.mm.repairer.config.albumpicker.RepairerConfigAlbumQueryDuration();
        int h17 = bm5.o1.f22719a.h(repairerConfigAlbumQueryDuration);
        boolean z17 = true;
        if (h17 != 1 && (h17 == 2 || 1 != ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).nj(repairerConfigAlbumQueryDuration))) {
            z17 = false;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.GalleryQueryConfig", "checkEnableQueryDurationValue: local:" + h17 + ", result:" + z17);
        this.f415265i = z17;
    }
    ...
    */
    public java.util.LinkedList b() {
        /*
            ...
            r0.<init>()
            android.content.ContentResolver r1 = r7.f415264h     // Catch: java.lang.Exception -> L63
        ...
        L34:
            ...
            if (r3 == 0) goto L42
            java.lang.String r4 = r3.f138418g     // Catch: java.lang.Throwable -> L53
    ...
    public java.lang.String[] l() {
        return this.f415265i ? new java.lang.String[]{"_id", "_data", "datetaken", "date_modified", "mime_type", "latitude", "longitude", "duration"} : new java.lang.String[]{"_id", "_data", "datetaken", "date_modified", "mime_type", "latitude", "longitude"};
    }
