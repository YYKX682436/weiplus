    ...
    */
    public void a(android.content.Context r14, xt5.e r15, int r16, android.os.CancellationSignal r17, xt5.c r18, android.os.Handler r19) {
        /*
            ...
            goto L25
        L6:
            javax.crypto.Cipher r3 = r1.f457165b
            if (r3 == 0) goto L10
            xt5.k r1 = new xt5.k
            r1.<init>(r3)
            goto L26
        L10:
            java.security.Signature r3 = r1.f457164a
            if (r3 == 0) goto L1a
            xt5.k r1 = new xt5.k
            r1.<init>(r3)
            goto L26
        L1a:
            javax.crypto.Mac r1 = r1.f457166c
            if (r1 == 0) goto L25
            xt5.k r3 = new xt5.k
            r3.<init>(r1)
            r1 = r3
        ...
        L40:
            ...
            goto L6b
        L4e:
            javax.crypto.Cipher r0 = r1.f457170b     // Catch: java.lang.SecurityException -> L83
            if (r0 == 0) goto L58
            ...
            goto L6b
        L58:
            java.security.Signature r0 = r1.f457169a     // Catch: java.lang.SecurityException -> L83
            if (r0 == 0) goto L62
            android.hardware.fingerprint.FingerprintManager$CryptoObject r2 = new android.hardware.fingerprint.FingerprintManager$CryptoObject     // Catch: java.lang.SecurityException -> L83
            r2.<init>(r0)     // Catch: java.lang.SecurityException -> L83
            goto L6b
        L62:
            javax.crypto.Mac r0 = r1.f457171c     // Catch: java.lang.SecurityException -> L83
            if (r0 == 0) goto L6b
            android.hardware.fingerprint.FingerprintManager$CryptoObject r2 = new android.hardware.fingerprint.FingerprintManager$CryptoObject     // Catch: java.lang.SecurityException -> L83
            r2.<init>(r0)     // Catch: java.lang.SecurityException -> L83
        L6b:
    ...
    public boolean b(android.content.Context context) {
        ...
        if (xt5.l.a(context, "android.permission.USE_FINGERPRINT") != 0) {
            ...
            try {
                android.hardware.fingerprint.FingerprintManager fingerprintManager = (android.hardware.fingerprint.FingerprintManager) context.getSystemService(com.tencent.soter.core.biometric.FingerprintManagerProxy.FINGERPRINT_SERVICE);
