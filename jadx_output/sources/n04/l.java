...
public class l implements u13.i {
    ...
    public boolean b(android.content.Context context, android.view.View view, u13.g gVar, java.lang.Object... objArr) {
        ...
        if (!com.tencent.mm.storage.z3.m4(p0Var.f246927s) && !com.tencent.mm.storage.z3.q4(p0Var.f246927s)) {
            boolean G = c01.e2.G(p0Var.f246927s);
            com.tencent.mm.sdk.platformtools.f9 f9Var = com.tencent.mm.sdk.platformtools.f9.SessionOa;
            if (!G) {
                java.lang.String str = p0Var.f246927s;
        ...
        } else if (!com.tencent.mm.sdk.platformtools.f9.GlobalWeCom.k(view.getContext(), null)) {
            return true;
        }
        int i17 = p0Var.f246926r;
        if (i17 == 0) {
            android.content.Intent putExtra = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.plugin.fts.ui.FTSConvMessageUI.class).putExtra("Search_Scene", p0Var.f423765h).putExtra("key_conv", p0Var.f246927s).putExtra("key_query", p0Var.i()).putExtra("key_count", 1);
        ...
        if (i17 == 1) {
            ...
            java.lang.String str2 = p0Var.f246927s;
            ((qv.o) u2Var).getClass();
            if (r01.z.j(str2)) {
                ((bt.d) ((ct.u2) i95.n0.c(ct.u2.class))).f24068d.l(new android.content.Intent().putExtra("Contact_User", p0Var.f246927s), context);
            } else {
                rv.u2 u2Var2 = (rv.u2) i95.n0.c(rv.u2.class);
                java.lang.String str3 = p0Var.f246927s;
                ((qv.o) u2Var2).getClass();
                if (r01.z.g(str3)) {
                    android.content.Intent intent = new android.content.Intent();
                    intent.putExtra("Contact_User", p0Var.f246927s);
                    intent.addFlags(67108864);
                    intent.putExtra("biz_chat_from_scene", 5);
                    j45.l.u(context, ".ui.bizchat.BizChatConversationUI", intent, null);
                } else if (r01.z.l(p0Var.f246927s)) {
                    qk.o b17 = r01.z.b(p0Var.f246927s);
                    ...
                    intent2.putExtra("srcUsername", p0Var.f246927s);
                    intent2.putExtra("bizofstartfrom", "enterpriseHomeSubBrand");
                    intent2.addFlags(67108864);
                    j45.l.j(context, "webview", ".ui.tools.WebViewUI", intent2, null);
                } else if (com.tencent.mm.storage.z3.C3(p0Var.f246927s)) {
                    java.util.ArrayList P1 = com.tencent.mm.sdk.platformtools.t8.P1(p0Var.f423762e.f351131c);
                    android.content.Intent intent3 = new android.content.Intent();
                    intent3.putExtra("Chat_User", p0Var.f246925q.f351189g);
                    ...
                    intent3.putExtra("msg_local_id", p0Var.f246925q.f351186d);
                ...
                } else if (com.tencent.mm.storage.z3.a4(p0Var.f246927s)) {
                    android.content.Intent putExtra2 = new android.content.Intent().putExtra("Chat_User", p0Var.f246927s).putExtra("Chat_Self", ((f63.e) ((f63.h) ((u53.e0) i95.n0.c(u53.e0.class))).Ai(p0Var.f246927s)).t0()).putExtra("finish_direct", true);
                    putExtra2.putExtra("chat_from_scene", 5);
                    ((bt.d) ((ct.u2) i95.n0.c(ct.u2.class))).f24068d.j(putExtra2, context);
                } else {
                    android.content.Intent putExtra3 = new android.content.Intent().putExtra("Chat_User", p0Var.f246927s).putExtra("finish_direct", true).putExtra("from_global_search", true).putExtra("msg_local_id", p0Var.f246925q.f351186d).putExtra("highlight_keyword_list", com.tencent.mm.sdk.platformtools.t8.P1(p0Var.f423762e.f351131c));
                    putExtra3.putExtra("chat_from_scene", 5);
                    ((bt.d) ((ct.u2) i95.n0.c(ct.u2.class))).f24068d.j(putExtra3, context);
                }
            }
        } else {
            rv.u2 u2Var3 = (rv.u2) i95.n0.c(rv.u2.class);
            java.lang.String str5 = p0Var.f246927s;
            ((qv.o) u2Var3).getClass();
            if (r01.z.g(str5)) {
                android.content.Intent intent4 = new android.content.Intent();
                intent4.putExtra("Contact_User", p0Var.f246927s);
                intent4.addFlags(67108864);
                intent4.putExtra("biz_chat_from_scene", 5);
                j45.l.u(context, ".ui.bizchat.BizChatConversationUI", intent4, null);
            } else if (r01.z.l(p0Var.f246927s)) {
                qk.o b18 = r01.z.b(p0Var.f246927s);
                ...
                intent5.putExtra("srcUsername", p0Var.f246927s);
                intent5.putExtra("bizofstartfrom", "enterpriseHomeSubBrand");
                intent5.addFlags(67108864);
                j45.l.j(context, "webview", ".ui.tools.WebViewUI", intent5, null);
            } else if (com.tencent.mm.storage.z3.a4(p0Var.f246927s)) {
                android.content.Intent putExtra4 = new android.content.Intent().putExtra("Chat_User", p0Var.f246927s).putExtra("Chat_Self", ((f63.e) ((f63.h) ((u53.e0) i95.n0.c(u53.e0.class))).Ai(p0Var.f246927s)).t0()).putExtra("finish_direct", true);
                putExtra4.putExtra("chat_from_scene", 5);
                ((bt.d) ((ct.u2) i95.n0.c(ct.u2.class))).f24068d.j(putExtra4, context);
            } else if (p0Var instanceof e23.p1) {
                e23.p1 p1Var = (e23.p1) p0Var;
                android.content.Intent putExtra5 = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.plugin.fts.ui.FTSConvTalkerMessageUI.class).putExtra("Search_Scene", p1Var.f423765h).putExtra("key_talker_query", p1Var.B.f351203u.f351129a).putExtra("key_talker", p1Var.B.f351187e).putExtra("key_conv", p1Var.f246927s).putExtra("key_query", p1Var.i()).putExtra("detail_type", p1Var.C);
                ...
                android.content.Intent putExtra6 = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.plugin.fts.ui.FTSConvMessageUI.class).putExtra("Search_Scene", p0Var.f423765h).putExtra("key_conv", p0Var.f246927s).putExtra("key_query", p0Var.i()).putExtra("key_count", p0Var.f246926r);
