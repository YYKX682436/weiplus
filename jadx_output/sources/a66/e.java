...
public final class e implements p56.s {
    ...
    public final java.util.concurrent.atomic.AtomicReference f1800d = new java.util.concurrent.atomic.AtomicReference(new a66.d(false, new a66.b()));
    ...
    public void a(p56.s sVar) {
        ...
        java.util.concurrent.atomic.AtomicReference atomicReference = this.f1800d;
        do {
            a66.d dVar = (a66.d) atomicReference.get();
            boolean z18 = dVar.f1798a;
            if (z18) {
                sVar.c();
                return;
            }
    ...
    @Override // p56.s
    public boolean b() {
        return ((a66.d) this.f1800d.get()).f1798a;
    }
