...
public final class m extends kotlin.jvm.internal.q implements yz5.l {
    ...
    public final /* synthetic */ kk5.q f308668d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ boolean f308669e;
    ...
    public java.lang.Object invoke(java.lang.Object obj) {
        ...
        kk5.q qVar = this.f308668d;
        if (dVar != null && (dVar instanceof wi5.o)) {
            com.tencent.mm.sdk.coroutines.LifecycleScope O62 = qVar.O6();
            if (O62 != null) {
                v65.i.b(O62, null, new kk5.f(qVar, state, null), 1, null);
            }
            boolean z17 = this.f308669e;
            if (z17 && (O6 = qVar.O6()) != null) {
                v65.i.b(O6, null, new kk5.h(qVar, null), 1, null);
            }
            com.tencent.mm.sdk.coroutines.LifecycleScope O63 = qVar.O6();
            if (O63 != null) {
                v65.i.b(O63, null, new kk5.j(qVar, z17, null), 1, null);
            }
            com.tencent.mm.sdk.coroutines.LifecycleScope O64 = qVar.O6();
            if (O64 != null) {
        ...
        if (dVar2 != null && (dVar2 instanceof wi5.h)) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.CreateChatRoomOtherHeaderStrictDupUIC", "CreateGroupSelectHeaderAction " + hVar.f446291b.f396111f);
            java.lang.String str = hVar.f446291b.f396111f;
            int hashCode = str.hashCode();
            java.util.LinkedList linkedList = state.f446319o;
            switch (hashCode) {
                case -1140598940:
                    if (str.equals("fake_user_create_chatroom_choose_open_im") && com.tencent.mm.sdk.platformtools.f9.ContactWeCom.k(qVar.getActivity(), null)) {
                        android.content.Intent intent = new android.content.Intent(qVar.getActivity().getIntent());
                        ...
                        cVar.d(intent);
                        cVar.f20922a.f20924a = qVar.getActivity();
                        cVar.a(com.tencent.mm.ui.contact.OpenIMSelectContactUI.class.getName());
                        cVar.h(5);
                        break;
                    }
                    break;
                case -181849474:
                    if (str.equals("fake_user_create_chatroom_select_contact_in_chatroom")) {
                        qVar.getClass();
                        com.tencent.mars.xlog.Log.i("MicroMsg.CreateChatRoomOtherHeaderStrictDupUIC", "onImportContactFromChatRoomClick() called");
                        android.content.Intent intent2 = new android.content.Intent();
                        intent2.putExtra("titile", qVar.getActivity().getString(com.tencent.mm.R.string.f489925fo));
                        intent2.putExtra("list_attr", 2097152);
                        java.util.HashSet hashSet = new java.util.HashSet();
                        hashSet.addAll(state.f446318n);
                        hashSet.addAll(linkedList);
                        java.lang.String g07 = kz5.n0.g0(hashSet, ",", null, null, 0, null, null, 62, null);
                        intent2.putExtra("always_select_contact", g07);
                        com.tencent.mars.xlog.Log.i("MicroMsg.CreateChatRoomOtherHeaderStrictDupUIC", "ImportContactFromChatRoom ".concat(g07));
                        ...
                        cVar2.d(intent2);
                        cVar2.f20922a.f20924a = qVar.getActivity();
                ...
                case 434583587:
                    if (str.equals("fake_user_create_chatroom_select_chatroom")) {
                        ...
                        intent3.setClassName(qVar.getActivity(), "com.tencent.mm.ui.contact.GroupCardSelectUI");
                        intent3.putExtra("group_select_type", true);
                        intent3.putExtra("grou_order_by_conversation_time", true);
                        if (qVar.getActivity().getIntent().getBooleanExtra("group_select_need_result", false)) {
                            intent3.putExtra("group_select_need_result", true);
                            qVar.getActivity().startActivityForResult(intent3, 0);
                        } else {
                            androidx.appcompat.app.AppCompatActivity activity = qVar.getActivity();
                            java.util.ArrayList arrayList2 = new java.util.ArrayList();
                            arrayList2.add(intent3);
                            java.util.Collections.reverse(arrayList2);
                            yj0.a.d(activity, arrayList2.toArray(), "com/tencent/mm/ui/uic/CreateChatRoomOtherHeaderStrictDupUIC", "onGroupCardClick", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
                            activity.startActivity((android.content.Intent) arrayList2.get(0));
                            yj0.a.f(activity, "com/tencent/mm/ui/uic/CreateChatRoomOtherHeaderStrictDupUIC", "onGroupCardClick", "()V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
                        }
                        com.tencent.mars.xlog.Log.i("MicroMsg.CreateChatRoomOtherHeaderStrictDupUIC", "onGroupCardClick");
                        break;
                    }
                    break;
                case 1914591481:
                    if (str.equals("fake_user_create_chatroom_face_2_face")) {
                        ...
                        j45.l.h(qVar.getActivity(), "pwdgroup", ".ui.FacingCreateChatRoomAllInOneUI");
                        break;
                    }
                    break;
            }
