...
public class hb extends hr3.va {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.profile.ui.NormalUserFooterPreference f283611f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public hb(com.tencent.mm.plugin.profile.ui.NormalUserFooterPreference normalUserFooterPreference) {
        super(normalUserFooterPreference);
        this.f283611f = normalUserFooterPreference;
    }

    @Override // hr3.va
    public void f() {
        com.tencent.mm.plugin.profile.ui.NormalUserFooterPreference normalUserFooterPreference = this.f283611f;
        ...
        normalUserFooterPreference.B1.setOnClickListener(new hr3.gb(this));
    }

    @Override // hr3.va
    public void g() {
        com.tencent.mm.storage.z3 z3Var = this.f283611f.L;
