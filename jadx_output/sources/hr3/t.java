...
public class t implements android.view.View.OnLongClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.profile.ui.AddDescriptionUI f283993d;

    public t(com.tencent.mm.plugin.profile.ui.AddDescriptionUI addDescriptionUI) {
        this.f283993d = addDescriptionUI;
    }
    ...
    public boolean onLongClick(android.view.View view) {
        ...
        rl5.r rVar = new rl5.r(this.f283993d.getContext(), view);
        rVar.f397351u = new hr3.r(this);
        rVar.f397354x = new hr3.s(this);
        rVar.m();
