...
public abstract class m0 {
    ...
    public static final m8.m0 f324635a = new m8.j0();

    public abstract int a(java.lang.Object obj);

    public final int b(int i17, m8.k0 k0Var, m8.l0 l0Var, int i18) {
        int i19 = d(i17, k0Var, false).f324597c;
        if (g(i19, l0Var).f324626d != i17) {
            return i17 + 1;
        }
        if (i18 == 0) {
            i19 = i19 == i() - 1 ? -1 : i19 + 1;
    ...
    public final android.util.Pair f(m8.l0 l0Var, m8.k0 k0Var, int i17, long j17, long j18) {
        ...
        int i18 = l0Var.f324625c;
        long j19 = l0Var.f324629g + j17;
        long j27 = d(i18, k0Var, false).f324598d;
        while (j27 != -9223372036854775807L && j19 >= j27 && i18 < l0Var.f324626d) {
            j19 -= j27;
            i18++;
            j27 = d(i18, k0Var, false).f324598d;
        }
