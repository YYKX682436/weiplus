...
public class x implements p11.h {
    ...
    public final /* synthetic */ k53.b0 f304408a;
    ...
    public void b(java.lang.String str, android.view.View view, q11.b bVar) {
        if (bVar == null || bVar.f359534d == null) {
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.Haowan.GameVideoPreviewUI", "load thumb:%s, from:%d", str, java.lang.Integer.valueOf(bVar.f359532b));
        this.f304408a.f304340g.post(new k53.w(this));
    }
