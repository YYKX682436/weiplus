...
public abstract class b {
    ...
    public static final java.lang.String[] f320258a = {null};

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.String[] f320259b = {null};

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.String[] f320260c = {null};

    /* renamed from: d, reason: collision with root package name */
    public static final java.lang.String[] f320261d = {null};

    /* renamed from: e, reason: collision with root package name */
    public static final com.tencent.mm.vfs.r6[] f320262e = {null};
    ...
    public static synchronized java.lang.String K() {
        java.lang.String str;
        synchronized (lp0.b.class) {
            str = ((java.lang.String) b0().f323092a) + "/image/";
        }
        return str;
    }
    ...
    public static synchronized java.lang.String X() {
        java.lang.String str;
        synchronized (lp0.b.class) {
            java.lang.String[] strArr = f320258a;
            if (strArr[0] == null) {
    ...
    public static synchronized java.lang.String Y() {
        java.lang.String str;
        synchronized (lp0.b.class) {
            java.lang.String[] strArr = f320260c;
            if (strArr[0] == null) {
                strArr[0] = com.tencent.mm.sdk.platformtools.x2.r() ? "/sdcard" : android.os.Environment.getExternalStorageDirectory().getAbsolutePath();
            }
            str = strArr[0];
        }
        return str;
    ...
    public static synchronized java.lang.String Z(boolean z17) {
        ...
        synchronized (lp0.b.class) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.CConstants", sb6.toString());
            try {
                java.lang.String canonicalPath = file.getCanonicalPath();
                com.tencent.mars.xlog.Log.i("MicroMsg.CConstants", "canonical=" + canonicalPath);
                str = canonicalPath + "/";
    ...
    public static synchronized m3.d b0() {
        ...
        synchronized (lp0.b.class) {
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.CConstants", "getExternalCacheDir err: " + th6.getMessage());
            ...
            if (file == null) {
                ...
                java.io.File file3 = new java.io.File(file2, "Android/data/" + com.tencent.mm.sdk.platformtools.x2.f193072b + "/cache");
                if (!file3.exists()) {
                    file3.mkdirs();
                }
                file = file3;
        ...
        synchronized (lp0.b.class) {
            ...
            if (com.tencent.mm.sdk.platformtools.m2.d().equals("zh_CN")) {
                try {
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CConstants", th6, "[-] Fail to create weixin camera dir marker.", new java.lang.Object[0]);
                }
                return "WeiXin/";
            }
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CConstants", th7, "[-] Fail to create wechat camera dir marker.", new java.lang.Object[0]);
            }
            return "WeChat/";
        }
    }
    ...
    public static synchronized java.lang.String d0() {
        ...
        synchronized (lp0.b.class) {
            java.lang.String str = f320261d[0];
            if (str != null) {
                return str;
            }
            m3.d b07 = b0();
            java.lang.String str2 = (java.lang.String) b07.f323092a;
            java.lang.Boolean bool = (java.lang.Boolean) b07.f323093b;
            ...
            if (com.tencent.mm.sdk.platformtools.x2.r() || !bool.booleanValue()) {
                f320261d[0] = absolutePath;
                java.lang.String[] strArr = f320259b;
                if (strArr[0] == null) {
    ...
    public static synchronized java.lang.String e0() {
        synchronized (lp0.b.class) {
            java.lang.String str = f320259b[0];
            if (str != null) {
                return str;
            }
            return d0();
    ...
    public static com.tencent.mm.vfs.r6 h0(java.lang.String str) {
        com.tencent.mm.vfs.r6[] r6VarArr = f320262e;
        if (r6VarArr[0] == null) {
            synchronized (r6VarArr) {
                if (r6VarArr[0] == null) {
                    r6VarArr[0] = new com.tencent.mm.vfs.r6(com.tencent.mm.vfs.r6.j(com.tencent.mm.sdk.platformtools.x2.f193071a.getCacheDir()), "temp");
                }
            }
        }
        com.tencent.mm.vfs.r6 r6Var = r6VarArr[0];
        if (str != null) {
            r6Var = new com.tencent.mm.vfs.r6(r6Var, str);
        }
        r6Var.J();
        return r6Var;
    }
    ...
    public static synchronized java.lang.String m() {
        ...
        synchronized (lp0.b.class) {
            ...
            com.tencent.mars.xlog.Log.w("MicroMsg.CConstants", "use legacy sdcard camera path");
            return b();
        }
    }
