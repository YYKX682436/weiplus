...
public final class q1 extends i95.w implements qk.a8 {
    ...
    public final jk3.d f252303d = new ef0.j1();

    /* renamed from: e, reason: collision with root package name */
    public final jz5.g f252304e = jz5.h.b(ef0.l1.f252264d);

    public static void wi(ef0.q1 q1Var, android.app.Activity activity, androidx.fragment.app.Fragment fragment, bw5.ar0 ar0Var, bw5.v70 v70Var, qk.z7 z7Var, int i17, int i18, android.view.View view, android.graphics.Rect rect, android.graphics.Bitmap bitmap, boolean z17, int i19, java.lang.Object obj) {
        ...
        q1Var.getClass();
        com.tencent.mars.xlog.Log.i("MicroMsg.TingAddToPlayListFeatureService", "addToPlayList type: " + v70Var.f34189e + ", title: " + v70Var.getTitle() + ", currentTimeMs:" + i27 + ", durationMs:" + i28);
        ...
        if (q1Var.Bi() && !z18) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.TingAddToPlayListFeatureService", sb6.toString());
            cl4.l.c0(new cl4.l(new cl4.m(activity)), v70Var, false, il4.l.k(v70Var.f34189e), rect2, bitmap2, false, 32, null);
        }
        vk4.b bVar = new vk4.b(v70Var, ar0Var);
        bVar.l().q(new ef0.k1(v70Var, q1Var, activity, fragment, bVar, i27, i28, z7Var));
    }
    ...
    public final boolean Bi() {
        return ((java.lang.Boolean) ((jz5.n) this.f252304e).getValue()).booleanValue();
    }
}
