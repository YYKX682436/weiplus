...
public class c extends au5.b implements zt5.b {
    ...
    public static boolean f14147c;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f14148b;

    public c(java.lang.String str) {
        this.f14148b = "SoterKeyStore";
        this.f14148b = str;
    }
    ...
    public zt5.k b() {
        ...
        if (m()) {
            try {
                java.security.KeyStore.getInstance(this.f14148b).load(null);
                java.security.KeyPairGenerator keyPairGenerator = java.security.KeyPairGenerator.getInstance("RSA", "SoterKeyStore");
                keyPairGenerator.initialize(yt5.c.b(zt5.j.a().f475604a + ".addcounter.auto_signed_when_get_pubkey_attk", 4).c("SHA-256").d("PSS").a());
    ...
    public zt5.k c(java.lang.String str) {
        java.lang.String str2 = this.f14148b;
        if (zt5.l.b(str)) {
        ...
        if (m()) {
            try {
                ...
                try {
                    keyPairGenerator.initialize(yt5.c.b(str + java.lang.String.format(".addcounter.auto_signed_when_get_pubkey(%s).secmsg_and_counter_signed_when_sign", zt5.j.a().f475604a), 4).c("SHA-256").e(true).d("PSS").a());
                    long nanoTime = java.lang.System.nanoTime();
                    keyPairGenerator.generateKeyPair();
    ...
    public zt5.r d() {
        ...
        if (m()) {
            try {
                ...
                keyStore.load(null);
                try {
                    java.security.Key key = keyStore.getKey(zt5.j.a().f475604a, "from_soter_ui".toCharArray());
                    if (key != null) {
                        zt5.o.b();
    ...
    public java.security.Signature e(java.lang.String str) {
        ...
        if (!m()) {
            zt5.h.b("Soter.SoterCoreBeforeTreble", "soter: not support soter" + this.f14148b, new java.lang.Object[0]);
            return null;
        }
        try {
            zt5.o.b();
    ...
    public boolean g() {
        try {
            java.security.KeyStore keyStore = java.security.KeyStore.getInstance(this.f14148b);
            keyStore.load(null);
            return keyStore.getCertificate(zt5.j.a().f475604a) != null;
        } catch (java.lang.Exception e17) {
    ...
    public zt5.k o() {
        ...
        try {
            java.security.KeyStore keyStore = java.security.KeyStore.getInstance(this.f14148b);
            keyStore.load(null);
            keyStore.deleteEntry(zt5.j.a().f475604a);
            return new zt5.k(0);
        } catch (java.lang.Exception e17) {
