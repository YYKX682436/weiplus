...
public final class s implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.feature.ecs.test.EcsTestUI f459023d;

    public s(com.tencent.mm.feature.ecs.test.EcsTestUI ecsTestUI) {
        this.f459023d = ecsTestUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.feature.ecs.test.EcsTestUI ecsTestUI = this.f459023d;
        android.widget.EditText editText = ecsTestUI.d;
        if (editText == null) {
            kotlin.jvm.internal.o.o("searchEdit");
            throw null;
        }
