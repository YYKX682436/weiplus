...
public abstract class a implements zt5.b {
    ...
    public static au5.k f449536b;

    /* renamed from: c, reason: collision with root package name */
    public static au5.b f449537c;
    ...
    public static zt5.s a(byte[] bArr) {
        ...
        try {
            ...
            sVar2.f475629j = str;
            sVar2.f475620a = jSONObject.optString(com.tencent.tinker.loader.shareutil.ShareConstants.DEXMODE_RAW);
            sVar2.f475621b = jSONObject.optString("fid");
            sVar2.f475622c = jSONObject.optLong("counter");
            sVar2.f475623d = jSONObject.optString("tee_n");
            sVar2.f475624e = jSONObject.optString("tee_v");
            sVar2.f475625f = jSONObject.optString("fp_n");
            sVar2.f475626g = jSONObject.optString("fp_v");
            sVar2.f475627h = jSONObject.optString("cpu_id");
            sVar2.f475628i = jSONObject.optInt("rsa_pss_saltlen", 20);
            sVar = sVar2;
        ...
        if (sVar != null) {
            sVar.f475630k = android.util.Base64.encodeToString(bArr4, 2);
        }
        return sVar;
    }
    ...
    public static au5.b f() {
        ...
        au5.c.v();
        if (zt5.o.f475608a.b() || (providers = java.security.Security.getProviders()) == null) {
            return null;
        }
    ...
    public static boolean k(android.content.Context context, int i17) {
        return (com.tencent.soter.core.biometric.BiometricManagerCompat.from(context, java.lang.Integer.valueOf(i17)).isCurrentFailTimeAvailable() || com.tencent.soter.core.biometric.BiometricManagerCompat.from(context, java.lang.Integer.valueOf(i17)).isCurrentTweenTimeAvailable(context)) ? false : true;
    }
    ...
    public static boolean m(android.content.Context context, int i17) {
        boolean isHardwareDetected = com.tencent.soter.core.biometric.BiometricManagerCompat.from(context, java.lang.Integer.valueOf(i17)).isHardwareDetected();
        zt5.h.b("Soter.SoterCore", "soter: isSupportBiometric type[" + i17 + "] return[" + isHardwareDetected + "]", new java.lang.Object[0]);
        return isHardwareDetected;
    }

    public static boolean n(android.content.Context context) {
        boolean isHardwareDetected = com.tencent.soter.core.biometric.BiometricManagerCompat.from(context, 1).isHardwareDetected();
        zt5.h.b("Soter.SoterCore", "soter: isSupportFingerprint return[" + isHardwareDetected + "]", new java.lang.Object[0]);
        return isHardwareDetected;
    }

    public static boolean o(android.content.Context context, int i17) {
        return com.tencent.soter.core.biometric.BiometricManagerCompat.from(context, java.lang.Integer.valueOf(i17)).hasEnrolledBiometric();
    }

    public static boolean p(android.content.Context context) {
        return com.tencent.soter.core.biometric.BiometricManagerCompat.from(context, 1).hasEnrolledBiometric();
    }
