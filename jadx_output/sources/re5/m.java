...
public final class m implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ re5.s f394583d;
    ...
    public final void onClick(android.view.View view) {
        ...
        re5.s sVar = this.f394583d;
        sVar.getClass();
        com.tencent.mm.ui.widget.dialog.k0 k0Var = new com.tencent.mm.ui.widget.dialog.k0((android.content.Context) sVar.getContext(), 1, false);
        k0Var.f211872n = new re5.g(sVar);
        k0Var.f211881s = new re5.h(sVar);
        k0Var.v();
