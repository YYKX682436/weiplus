...
public abstract class w {
    ...
    public static java.lang.String b(com.tencent.mm.plugin.location.model.LocationInfo locationInfo) {
        if (locationInfo.f144591m == null) {
            locationInfo.f144591m = "";
        }
        ...
        sb6.append("\" scale=\"");
        sb6.append(locationInfo.f144588g);
        sb6.append("\" label=\"");
        sb6.append(com.tencent.mm.sdk.platformtools.t8.p(locationInfo.f144589h));
        sb6.append("\" poiname=\"");
        sb6.append(com.tencent.mm.sdk.platformtools.t8.p(locationInfo.f144591m));
        sb6.append("\" maptype=\"0\" poiid=\"");
        sb6.append(locationInfo.f144594p);
        sb6.append("\" isFromPoiList=\"");
        sb6.append(locationInfo.f144595q);
        sb6.append("\" poiCategoryTips=\"");
        java.lang.String str = locationInfo.f144596r;
        if (str == null) {
            str = "";
        }
        sb6.append(str);
        sb6.append("\" poiBusinessHour=\"");
        java.lang.String str2 = locationInfo.f144597s;
        if (str2 == null) {
            str2 = "";
        }
        sb6.append(str2);
        sb6.append("\" poiPhone=\"");
        java.lang.String str3 = locationInfo.f144598t;
        sb6.append(str3 != null ? str3 : "");
        sb6.append("\" poiPriceTips=\"");
        sb6.append(locationInfo.f144599u);
        sb6.append("\" buildingId=\"");
        sb6.append(locationInfo.f144600v);
        sb6.append("\" floorName=\"");
        sb6.append(locationInfo.f144601w);
        sb6.append("\" /></msg>");
        return sb6.toString();
    }
    ...
    public static android.content.pm.PackageInfo c(android.content.Context context, java.lang.String str) {
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MapUtil", e17, "", new java.lang.Object[0]);
            return null;
        } catch (android.content.pm.PackageManager.NameNotFoundException e18) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MapUtil", e18, "", new java.lang.Object[0]);
            return null;
        }
    }
