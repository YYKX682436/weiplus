...
public final class a2 extends i95.w implements su4.z0 {
    ...
    public boolean f407666d;

    /* renamed from: e, reason: collision with root package name */
    public boolean f407667e;

    /* renamed from: f, reason: collision with root package name */
    public boolean f407668f = true;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.String f407669g = "";

    /* renamed from: h, reason: collision with root package name */
    public boolean f407670h = true;

    /* renamed from: i, reason: collision with root package name */
    public final java.util.List f407671i = new java.util.ArrayList();

    /* renamed from: m, reason: collision with root package name */
    public final sg0.y1 f407672m = new sg0.y1(this);

    /* renamed from: n, reason: collision with root package name */
    public final sg0.z1 f407673n = new sg0.z1(this, android.os.Looper.getMainLooper());

    /* renamed from: o, reason: collision with root package name */
    public final sg0.n1 f407674o = new sg0.n1(this);

    public final void Ai() {
        if (Ri()) {
            if (!com.tencent.mm.sdk.platformtools.t8.K0(this.f407669g)) {
                if (((com.tencent.mm.feature.lite.i) ((q80.g0) i95.n0.c(q80.g0.class))).tk(this.f407669g)) {
                    return;
                }
            }
            uv4.g g17 = com.tencent.mm.plugin.websearch.l2.g(0);
            if (g17 == null) {
                com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "checkCreateStore fail, getSearchTemplate fail");
                return;
            }
            java.lang.String l17 = g17.l();
            com.tencent.mm.vfs.r6 p17 = ((uv4.b) g17).p();
            ...
            if ((l17.length() == 0) || properties.isEmpty()) {
                com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "checkCreateStore fail, fTSTemplatePath or templateConfigValues isEmpty");
                return;
            }
            ...
            if (!(obj == null)) {
                if (!(obj2 == null)) {
                    ...
                    ((com.tencent.mm.feature.lite.i) ((q80.g0) i95.n0.c(q80.g0.class))).pj(str, -1, concat);
                    ((com.tencent.mm.feature.lite.i) ((q80.g0) i95.n0.c(q80.g0.class))).Di(this.f407672m);
                    this.f407669g = str;
                    com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "checkCreateStore, liteappStoreFullPath: " + concat + ", currLiteAppId: " + str);
                    return;
                }
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "checkCreateStore fail, liteappStoreAppidVal or liteappStorePathVal isNull");
        }
    }
    ...
    */
    public final void Bi(org.json.JSONObject r11, yz5.l r12) {
        ...
        L28:
            ...
            com.tencent.mm.sdk.platformtools.Log.a(r1, r0, r7)
        L30:
            r7 = r6
        L31:
        ...
        L44:
            ...
            com.tencent.mm.sdk.platformtools.Log.a(r1, r0, r11)
        L4c:
            if (r7 == 0) goto L57
            int r11 = r7.length()
            if (r11 != 0) goto L55
        ...
        L6d:
            ...
            com.tencent.mm.feature.lite.i r11 = (com.tencent.mm.feature.lite.i) r11
    ...
    */
    ...
    public boolean Ni() {
        ...
        if (this.f407667e != l17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "enableFinderSearchPreloadByExpose: " + this.f407667e + " -> " + l17);
            this.f407667e = l17;
        }
        return this.f407667e;
    }

    public boolean Ri() {
        boolean l17 = j62.e.g().l("clicfg_android_search_use_service_worker", false, true, true);
        if (this.f407666d != l17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "enableServiceWorker: " + this.f407666d + " -> " + l17);
            this.f407666d = l17;
        }
        return this.f407666d;
    }
    ...
    */
    ...
    public void Vi(java.lang.String tabName) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "notifyBottomTabSwitch exp:" + e17);
        }
    }
    ...
    public final void Zi(boolean z17) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "notifyLifecycleStateChange exp:" + e17);
        }
    }
    ...
    public void aj(int i17, int i18) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "notifySearchEntryClick exp:" + e17);
        }
    }
    ...
    public void bj(int i17, int i18, org.json.JSONObject extParams) {
        ...
        try {
            extParams.put(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, i17);
    ...
    public void cj(int i17, int i18) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "notifySearchEntryExpose exp:" + e17);
        }
    }
    ...
    public void hj(int i17, java.lang.String str, org.json.JSONObject jSONObject) {
        if (jSONObject == null) {
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.ServiceWorkerFeatureService", "notifySearchQuit exp:" + e17);
                return;
            }
        }
        jSONObject.put(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, i17);
    ...
    public final void ij(java.lang.String str, org.json.JSONObject jSONObject) {
        if (Ri()) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "publishGlobalEventToAll, " + str + ", " + jSONObject);
        }
    }
    ...
    */
    public final void mj(org.json.JSONObject r11, yz5.l r12) {
        ...
        L87:
            ...
            com.tencent.mars.xlog.Log.e(r11, r3)
            r11 = -1
            r2.put(r1, r11)
    ...
    public final void nj() {
        java.lang.String str = this.f407669g;
        if (str == null || str.length() == 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "releaseStore, isNullOrEmpty");
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "releaseStore, currLiteAppId: " + this.f407669g);
        ((com.tencent.mm.feature.lite.i) ((q80.g0) i95.n0.c(q80.g0.class))).ak(this.f407672m);
        ((com.tencent.mm.feature.lite.i) ((q80.g0) i95.n0.c(q80.g0.class))).Zj(this.f407669g);
        this.f407669g = "";
    }

    public final void oj(int i17) {
        sg0.z1 z1Var = this.f407673n;
        if (i17 == 1 && z1Var.hasMessages(1)) {
            z1Var.removeMessages(1);
            this.f407670h = false;
            Zi(false);
            com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "removeDelayMessageIfNeeded, give delay create store!");
        }
        if (i17 == 101 && z1Var.hasMessages(101)) {
            z1Var.removeMessages(101);
            com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "removeDelayMessageIfNeeded, give up release store!");
        }
    }
    ...
    public void onAccountInitialized(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "onAccountInitialized, enableServiceWorker: " + Ri());
        super.onAccountInitialized(context);
        com.tencent.mm.app.w.INSTANCE.a(this.f407674o);
    }

    @Override // i95.w
    public void onAccountReleased(android.content.Context context) {
        kotlin.jvm.internal.o.g(context, "context");
        com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "onAccountInitialized, onAccountReleased: " + Ri());
        nj();
        com.tencent.mm.app.w.INSTANCE.p(this.f407674o);
    ...
    public void onCreate(android.content.Context context) {
        kotlin.jvm.internal.o.g(context, "context");
        com.tencent.mars.xlog.Log.i("MicroMsg.WebSearch.ServiceWorkerFeatureService", "onCreate");
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:86:0x0050, code lost:
        ...
        com.tencent.mm.sdk.platformtools.Log.a("safeGetInt", "", r13);
     */
    ...
    */
    ...
    public void wi(org.json.JSONObject parmas, java.lang.ref.WeakReference webView) {
        kotlin.jvm.internal.o.g(parmas, "parmas");
        ...
        try {
            try {
                if (parmas.has(ya.b.METHOD)) {
                    str = parmas.getString(ya.b.METHOD);
                }
            } catch (java.lang.Exception e17) {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.WebSearch.WebSearchJSApiFeatureFeatureService", e18, "callLiteAppConnectEvent exception", new java.lang.Object[0]);
        }
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.WebSearchJSApiFeatureFeatureService", "callLiteAppConnectEvent, method unset");
        jSONObject.put("err_code", -1);
        jSONObject.put("err_msg", "callLiteAppConnectEvent:fail");
        p1Var.invoke(jSONObject);
    }
}
