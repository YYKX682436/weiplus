...
public final class l3 extends i95.w implements qg0.e0 {
    ...
    public final java.lang.String f354021d = "MicroMsg.WalletSecurityUtilService";

    /* renamed from: e, reason: collision with root package name */
    public final int f354022e = 255;
    ...
    public boolean Ai() {
        ...
        java.util.Iterator a17 = kotlin.jvm.internal.c.a(allNetworks);
        while (true) {
    ...
    public float Di() {
        ...
        if (cls == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Honor.TouchDetect", "This device does not support get TouchDetect result");
            return -1.0f;
        }
        try {
            java.lang.reflect.Method method = cls.getMethod("getDetectResult", new java.lang.Class[0]);
            if (method != null) {
                java.lang.Object invoke = method.invoke(((jz5.n) v75.m.f433972c).getValue(), new java.lang.Object[0]);
                if (invoke != null) {
                    ...
                    v75.m.f433970a = str2;
                    com.tencent.mars.xlog.Log.i("MicroMsg.Honor.TouchDetect", "getTouchResult " + invoke2 + "  " + floatValue + "  " + v75.m.f433970a);
                    if (kotlin.jvm.internal.o.b(invoke2, -1)) {
                        com.tencent.mars.xlog.Log.e("MicroMsg.Honor.TouchDetect", "get touch detect result failed");
                        return -2.0f;
                    }
                    if (kotlin.jvm.internal.o.b(invoke2, -2)) {
                        return -3.0f;
                    }
                    if (kotlin.jvm.internal.o.b(invoke2, java.lang.Float.valueOf(-6.0f))) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.Honor.TouchDetect", "no touch data, please touch screen first");
                    } else if (floatValue < 0.0f) {
                        com.tencent.mars.xlog.Log.e("MicroMsg.Honor.TouchDetect", "exception occurred, please try getTouchResult again");
                    }
                    return floatValue;
                }
                com.tencent.mars.xlog.Log.w("MicroMsg.Honor.TouchDetect", "startTouchResult is null");
            }
            return -5.0f;
        } catch (java.lang.Throwable th6) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.Honor.TouchDetect", th6, "old version of touch detect api ", new java.lang.Object[0]);
            return -4.0f;
        }
    }
    ...
    public float Ni() {
        ...
        try {
            ...
            int i18 = this.f354022e;
            if (i17 > i18) {
                i17 = i18;
            }
            return i17 / 255.0f;
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.e(this.f354021d, "Failed to get system screen brightness %s", e17.getLocalizedMessage());
            return 0.0f;
        }
    }
    ...
    public void Ri() {
        ...
        java.lang.Class cls = (java.lang.Class) ((jz5.n) v75.m.f433971b).getValue();
        if (cls == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Honor.TouchDetect", "This device does not support start TouchDetect");
            return;
        }
        try {
            ...
            if (num != null && num.intValue() == 0) {
                com.tencent.mars.xlog.Log.i("MicroMsg.Honor.TouchDetect", "start touch detect success");
                return;
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.Honor.TouchDetect", "start touch detect failed");
        } catch (java.lang.Throwable th6) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.Honor.TouchDetect", th6, "old version of touch detect api ", new java.lang.Object[0]);
        }
    }
    ...
    public void Ui() {
        ...
        java.lang.Class cls = (java.lang.Class) ((jz5.n) v75.m.f433971b).getValue();
        if (cls == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Honor.TouchDetect", "This device does not support stop TouchDetect");
            return;
        }
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.Honor.TouchDetect", th6, "stopTouchDetect", new java.lang.Object[0]);
        }
    }

    public boolean wi() {
        kotlin.jvm.internal.b bVar;
        android.content.Context context = com.tencent.mm.sdk.platformtools.x2.f193071a;
        ...
        java.util.Iterator a17 = kotlin.jvm.internal.c.a(displays);
        do {
            bVar = (kotlin.jvm.internal.b) a17;
            if (!bVar.hasNext()) {
                return false;
            }
