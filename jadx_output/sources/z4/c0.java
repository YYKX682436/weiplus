...
public class c0 extends z4.i {
    ...
    public final java.util.regex.Pattern f470058d;

    public c0(java.lang.String str, java.lang.String str2) {
        super(str, str2);
        this.f470058d = java.util.regex.Pattern.compile("\\A\\d+");
    }
    ...
    public boolean b() {
        ...
        java.util.regex.Matcher matcher = this.f470058d.matcher(packageInfo.versionName);
