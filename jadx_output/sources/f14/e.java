...
public abstract class e {
    public static float a(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FontSizeService", "CURRENT_TEXT_SIZE_KEY put result:%s, currentFont:%s", java.lang.Boolean.TRUE, java.lang.Float.valueOf(f17));
        return f17;
    }
    ...
    public static int b(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FontSizeService", "CURRENT_TEXT_INDEX_KEY put result:%s, currentFont:%s", java.lang.Boolean.TRUE, java.lang.Integer.valueOf(i17));
        return i17;
    }
    ...
    public static void d(android.content.Context context, float f17, int i17) {
        ...
        e(context, f17);
        com.tencent.mm.sdk.platformtools.o4.M(com.tencent.mm.sdk.platformtools.x2.e()).putInt("current_text_size_index_key", i17);
        com.tencent.mars.xlog.Log.i("MicroMsg.FontSizeService", "set CURRENT_TEXT_INDEX_KEY result: true");
        ((yg0.g4) ((zg0.h3) i95.n0.c(zg0.h3.class))).getClass();
        com.tencent.mm.sdk.platformtools.o4.N("WebViewFontUtil", 2, null).putBoolean("webview_key_font_use_system", true);
    }
