...
public class d implements lt5.a {
    ...
    public final mt5.g f331312a = new mt5.g();

    /* renamed from: b, reason: collision with root package name */
    public lt5.f f331313b;

    @Override // lt5.a
    public synchronized lt5.f a(android.content.Context context) {
        lt5.f fVar = this.f331313b;
        if (fVar == null || fVar.f321304b != 0) {
            this.f331313b = b(context);
        }
        return this.f331313b;
    }

    public final lt5.f b(android.content.Context context) {
        java.lang.String str;
        lt5.f a17 = this.f331312a.a(context);
        if (a17.f321304b == 0) {
            java.lang.String str2 = a17.f321303a;
        ...
        try {
            ...
            z17 = fVar.f331318g.await(2000L, java.util.concurrent.TimeUnit.MILLISECONDS);
            str = fVar.f331315d;
