...
public final /* synthetic */ class a$$d implements vh.x {
    @Override // vh.x
    public final java.util.List a(java.util.List list) {
        ...
        while (it.hasNext()) {
            ...
            if (batteryRecord instanceof com.tencent.matrix.batterycanary.stats.BatteryRecord.EventStatRecord) {
                ...
                if ("BATTERY_STAT".equals(eventStatRecord.f52604g) && (eventStatRecord.f52605h.containsKey("battery-change") || eventStatRecord.f52605h.containsKey("battery-low"))) {
