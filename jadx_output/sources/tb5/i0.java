...
public final class i0 {
    ...
    public static final tb5.i0 f417055a = new tb5.i0();

    public final java.lang.String a(java.util.List msgList) {
        kotlin.jvm.internal.o.g(msgList, "msgList");
        return kz5.n0.g0(msgList, "#", null, null, 0, null, tb5.h0.f417053d, 30, null);
    }
    ...
    public final void b(java.lang.String eventId, java.util.List selectedItems, tb5.g0 state) {
        ...
        ((cy1.a) ((dy1.r) i95.n0.c(dy1.r.class))).Cj(eventId, null, kz5.c1.m(kz5.c1.k(new jz5.l("selected_how_many_msgs_to_forward", java.lang.Integer.valueOf(selectedItems.size())), new jz5.l("selected_msgs_succ_cnt", java.lang.Integer.valueOf(selectedItems.size())), new jz5.l("selected_msg_list", a(selectedItems))), state.f417051a), 35480);
    }
    ...
    public final void c(java.util.List selectItems, java.lang.String reportId, java.lang.String str, tb5.g0 state) {
        ...
        kotlin.jvm.internal.o.g(state, "state");
        java.util.Map map = state.f417051a;
    ...
    public final void d(java.util.List selectItems, boolean z17, tb5.g0 state) {
        ...
        ((cy1.a) rVar).Cj("multi_select_msg_add_to_mail_end", null, kz5.c1.m(kz5.c1.k(lVarArr), state.f417051a), 35480);
    }
}
