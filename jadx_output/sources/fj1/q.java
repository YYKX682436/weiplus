...
public interface q {
    static java.lang.String b(java.lang.String str) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.WAMagicBrushFrameMBJsApiWrapper", "extraAppIdFromPrivateData get exception:%s", e17);
            return null;
        }
    }
    ...
    static lc3.a0 c(jc1.d dVar) {
        try {
            return (lc3.a0) new lc3.a0().put("errno", dVar.f298903a).put("errMsg", dVar.f298904b);
