...
public abstract class a {
    ...
    public static final java.util.Set f342751a = new java.util.HashSet(java.util.Arrays.asList("ppt", "pdf", "doc", "docx", "pptx"));
    ...
    public static boolean a(java.lang.String str) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloaderFileUtils", "deleteFilePath, %s -> %s", str, com.tencent.mm.vfs.w6.i(str, false));
    ...
    */
    public static java.lang.String c(android.net.Uri r11) {
        ...
        L5:
            ...
            r1 = 0
            r3 = 0
            android.content.Context r4 = com.tencent.mm.sdk.platformtools.x2.f193071a     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            ...
            com.tencent.mars.xlog.Log.i(r2, r7, r4)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            boolean r4 = com.tencent.mm.sdk.platformtools.t8.K0(r6)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            if (r4 != 0) goto L68
        ...
        L68:
            ...
            if (r4 == r5) goto L97
            java.lang.String r4 = r3.getString(r4)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            boolean r5 = com.tencent.mm.sdk.platformtools.t8.K0(r4)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            if (r5 != 0) goto L97
            ...
            com.tencent.mars.xlog.Log.i(r2, r6, r4)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            boolean r4 = com.tencent.mm.sdk.platformtools.t8.K0(r5)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            if (r4 != 0) goto L97
            boolean r11 = r3.isClosed()
            if (r11 != 0) goto L96
            r3.close()
        ...
        L97:
            ...
            java.lang.String r4 = com.tencent.mm.vfs.w6.n(r4)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            boolean r5 = com.tencent.mm.sdk.platformtools.t8.K0(r4)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            if (r5 != 0) goto Lc2
            ...
            com.tencent.mars.xlog.Log.w(r2, r5, r6)     // Catch: java.lang.Throwable -> Lcb java.lang.Exception -> Lcd
            if (r3 == 0) goto Lc1
            boolean r11 = r3.isClosed()
            if (r11 != 0) goto Lc1
            r3.close()
        ...
        Lcd:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r2, r11, r4, r1)     // Catch: java.lang.Throwable -> Lcb
            if (r3 == 0) goto Le0
            boolean r11 = r3.isClosed()
            if (r11 != 0) goto Le0
        Ldd:
    ...
    */
    public static java.lang.String d(java.lang.String r10) {
        ...
        L21:
            r0 = 0
            android.content.Context r3 = com.tencent.mm.sdk.platformtools.x2.f193071a     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L78
            ...
            com.tencent.mars.xlog.Log.i(r1, r4, r10)     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L78
            boolean r10 = com.tencent.mm.sdk.platformtools.t8.K0(r3)     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L78
            if (r10 != 0) goto L6a
        ...
        L78:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r1, r10, r3, r4)     // Catch: java.lang.Throwable -> L76
            if (r0 == 0) goto L8a
            boolean r10 = r0.isClosed()
            if (r10 != 0) goto L8a
            goto L72
    ...
    public static java.lang.String e(java.lang.String str) {
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e17, "getExtensionFromFileName", new java.lang.Object[0]);
            return "";
        }
    }
    ...
    public static java.lang.String f(java.lang.String str, java.lang.String str2) {
        try {
            ...
            if (!com.tencent.mm.sdk.platformtools.t8.K0(str) && str.startsWith("content://")) {
                n17 = d(str);
            }
            return !com.tencent.mm.sdk.platformtools.t8.K0(n17) ? n17 : e(str2);
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e17, "getFileExt", new java.lang.Object[0]);
            return "";
        }
    }
    ...
    public static long g(java.lang.String str) {
        ...
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6(com.tencent.mm.vfs.z7.a(str));
        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloaderFileUtils", "getFileLength %s -> %s", str, com.tencent.mm.vfs.w6.i(str, false));
        if (r6Var.A()) {
            return r6Var.C();
        }
        return 0L;
    ...
    */
    public static java.lang.String h(android.net.Uri r10) {
        ...
        L5:
            ...
            com.tencent.mars.xlog.Log.i(r2, r1)
            r1 = 0
            android.content.Context r3 = com.tencent.mm.sdk.platformtools.x2.f193071a     // Catch: java.lang.Throwable -> L5c java.lang.Exception -> L5e
        ...
        L5e:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r2, r10, r3, r4)     // Catch: java.lang.Throwable -> L5c
            if (r1 == 0) goto L70
            boolean r10 = r1.isClosed()
            if (r10 != 0) goto L70
            goto L58
    ...
    public static byte[] i(java.lang.String str) {
        ...
        try {
            ...
            try {
                com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloaderFileUtils", "readBytes %s -> %s", str, com.tencent.mm.vfs.w6.i(str, false));
                ...
                try {
                    ...
                    e = e17;
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e, "", new java.lang.Object[0]);
                    j(inputStream);
                    j(byteArrayOutputStream);
                    return null;
    ...
    public static void j(java.io.Closeable closeable) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e17, "", new java.lang.Object[0]);
            com.tencent.mars.xlog.Log.e("MicroMsg.ResDownloaderFileUtils", java.lang.String.format("%s close failed (%s)", closeable.getClass().getSimpleName(), e17.getMessage()));
        }
    }
    ...
    public static boolean k(java.lang.String str, byte[] bArr) {
        ...
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6(com.tencent.mm.vfs.z7.a(str));
        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloaderFileUtils", "writeBytes %s -> %s", str, com.tencent.mm.vfs.w6.i(str, false));
        r6Var.l();
        r6Var.s().J();
        ...
        try {
            try {
                try {
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e18, "", new java.lang.Object[0]);
                    if (outputStream != null) {
                        try {
                            outputStream.flush();
                            outputStream.close();
                        } catch (java.io.IOException e19) {
                            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e19, "", new java.lang.Object[0]);
                        }
                    }
                    return false;
                }
            } catch (java.io.FileNotFoundException e27) {
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e27, "", new java.lang.Object[0]);
                if (outputStream != null) {
                    try {
                        outputStream.flush();
                        outputStream.close();
                    } catch (java.io.IOException e28) {
                        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e28, "", new java.lang.Object[0]);
                    }
                }
                return false;
            }
            ...
            if (outputStream != null) {
                try {
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloaderFileUtils", e29, "", new java.lang.Object[0]);
                }
            }
            throw th6;
        }
