...
public class h0 implements a91.d {
    ...
    public boolean a(z81.i iVar, android.graphics.Canvas canvas, org.json.JSONArray jSONArray) {
        ...
        if ("linear".equalsIgnoreCase(optString)) {
            if (jSONArray.length() >= 3 && (optJSONArray2 = jSONArray.optJSONArray(1)) != null && optJSONArray2.length() >= 4) {
                ...
                if (optJSONArray3 != null && optJSONArray3.length() != 0) {
                    ...
                    iVar.f470711a.setShader(new android.graphics.LinearGradient(g17, g18, g19, g27, iArr, fArr, android.graphics.Shader.TileMode.CLAMP));
                }
            }
            return false;
        }
        if ("radial".equalsIgnoreCase(optString)) {
            ...
            iVar.f470711a.setShader(new android.graphics.RadialGradient(g28, g29, g37, iArr2, fArr2, android.graphics.Shader.TileMode.CLAMP));
            ...
            iVar.f470711a.setColor(ik1.w.b(optJSONArray7));
        }
        return true;
    }
    ...
    public boolean b(z81.i iVar, android.graphics.Canvas canvas, com.tencent.mm.plugin.appbrand.canvas.action.arg.DrawActionArg drawActionArg) {
        com.tencent.mm.plugin.appbrand.canvas.action.arg.SetStrokeStyleActionArg setStrokeStyleActionArg = (com.tencent.mm.plugin.appbrand.canvas.action.arg.SetStrokeStyleActionArg) drawActionArg;
        if (setStrokeStyleActionArg == null) {
            return false;
        }
        return setStrokeStyleActionArg.a(iVar, canvas);
    }
