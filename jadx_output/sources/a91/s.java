...
public class s implements a91.d {
        ...
        if (!"radial".equalsIgnoreCase(optString)) {
            ...
            if ("normal".equalsIgnoreCase(optString)) {
                ...
                if (com.tencent.mm.sdk.platformtools.t8.K0(optString2)) {
                    com.tencent.mars.xlog.Log.w("MicroMsg.Canvas.SetFillStyleAction", "setFillStyle failed, type is pattern but image path is null or nil.");
                    return false;
                }
                android.graphics.Bitmap a17 = ((zg1.d) iVar.f470716f).a(iVar, optString2, null, null);
            ...
            if (g37 <= 0.0f) {
                com.tencent.mars.xlog.Log.i("MicroMsg.Canvas.SetFillStyleAction", "setFillStyle(radial) failed, sr(%s) <= 0.", java.lang.Float.valueOf(g37));
                return false;
            }
    ...
    public boolean b(z81.i iVar, android.graphics.Canvas canvas, com.tencent.mm.plugin.appbrand.canvas.action.arg.DrawActionArg drawActionArg) {
        com.tencent.mm.plugin.appbrand.canvas.action.arg.SetFillStyleActionArg setFillStyleActionArg = (com.tencent.mm.plugin.appbrand.canvas.action.arg.SetFillStyleActionArg) drawActionArg;
