...
public class m extends android.graphics.SurfaceTexture {
    ...
    public android.graphics.SurfaceTexture f356509a;
    ...
    public void attachToGLContext(int i17) {
        ...
        this.f356509a.attachToGLContext(i17);
    }
    ...
    public void detachFromGLContext() {
        ...
        try {
            this.f356509a.detachFromGLContext();
            z17 = false;
        } catch (java.lang.Exception e17) {
            ...
            try {
                try {
                    try {
                        try {
                            try {
                                try {
                                    ...
                                    int intValue = ((java.lang.Integer) declaredMethod.invoke(this.f356509a, new java.lang.Object[0])).intValue();
                            ...
                            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e19, "%s", "detect texture problem, InvocationTargetException");
                        ...
                        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e27, "%s", "detect texture problem, NoSuchMethodException");
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e29, "%s", "detect texture problem, IllegalAccessException");
    ...
    public void setDefaultBufferSize(int i17, int i18) {
        ...
        this.f356509a.setDefaultBufferSize(i17, i18);
    }
    ...
    public void setOnFrameAvailableListener(android.graphics.SurfaceTexture.OnFrameAvailableListener onFrameAvailableListener) {
        ...
        this.f356509a.setOnFrameAvailableListener(onFrameAvailableListener);
    }

    public java.lang.String toString() {
        return this.f356509a.toString();
    }

    @Override // android.graphics.SurfaceTexture
    public void updateTexImage() {
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, updateTexImage");
        this.f356509a.updateTexImage();
    }
}
