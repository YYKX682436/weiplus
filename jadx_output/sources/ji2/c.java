...
public final class c extends gi2.e {
    ...
    public gi2.g b() {
        ...
        kotlin.jvm.internal.o.e(gVar2, "null cannot be cast to non-null type com.tencent.mm.plugin.finder.live.mic.custom.IMicLayout<Layout of com.tencent.mm.plugin.finder.live.mic.ktv.adapter.FinderLivePrepareKTVRoomAdapter.getMicLayout>");
        return gVar2;
    }
    ...
    public void d(int i17, android.view.View view) {
        ...
        if (view instanceof lj2.j) {
            ((lj2.j) view).l(pm2.a.f356856i, g(i17));
        }
    }
