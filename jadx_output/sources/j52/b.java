...
public class b implements yj0.d {
    ...
    public final /* synthetic */ j52.c f297797a;
    ...
    public void b(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.Object obj, java.lang.Object[] objArr) {
        ...
        j52.c cVar = this.f297797a;
        if (equals) {
            if (objArr.length >= 1) {
                com.tencent.mars.xlog.Log.i("HABBYGE-MALI.StoryGalleryMonitor", "StoryGalleryMonitor, onPostOpen: %b", objArr[0]);
        ...
        if ("onPostClose".equals(str2)) {
            com.tencent.mars.xlog.Log.i("HABBYGE-MALI.StoryGalleryMonitor", "StoryGalleryMonitor, onPostClose:");
