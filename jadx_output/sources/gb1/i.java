...
public abstract class i extends com.tencent.mm.plugin.appbrand.jsapi.f {
    public void C(com.tencent.mm.plugin.appbrand.jsapi.l lVar, org.json.JSONObject jSONObject) {
    }

    public final android.view.View D(com.tencent.mm.plugin.appbrand.jsapi.l lVar, org.json.JSONObject jSONObject) {
        try {
            int H = H(jSONObject);
            ...
            com.tencent.mars.xlog.Log.w("MicroMsg.BaseViewOperateJsApi", "get view by viewId(%s) return null.", java.lang.Integer.valueOf(H));
    ...
    public final com.tencent.mm.plugin.appbrand.jsapi.t E(com.tencent.mm.plugin.appbrand.jsapi.l lVar, org.json.JSONObject jSONObject) {
        gb1.k kVar = (gb1.k) lVar.q(gb1.k.class);
        if (kVar != null) {
            return kVar.Q(lVar, jSONObject);
        }
        com.tencent.mars.xlog.Log.e("MicroMsg.BaseViewOperateJsApi", "getComponentView NULL IComponentConverter");
        return null;
    }
