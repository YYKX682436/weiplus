...
public final class n {
    ...
    public static final ka4.n f306147a = new ka4.n();

    /* renamed from: b, reason: collision with root package name */
    public static boolean f306148b;

    public final boolean a() {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("enable", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
        boolean z17 = false;
        if (!com.tencent.mm.plugin.sns.model.y6.a()) {
            com.tencent.mars.xlog.Log.e("MicroMsg.SnsVideoDownloadStrategy", "not enable for can not play online video");
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("enable", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
            return false;
        }
        ...
        if (!fj6) {
            com.tencent.mars.xlog.Log.e("MicroMsg.SnsVideoDownloadStrategy", "not enable for can not use tp player");
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("enable", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
            return false;
        }
        ...
        if (r17 == -2 || r17 == 1 || r17 == 2) {
            ...
            z17 = ka4.o.f306149a.a();
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.SnsVideoDownloadStrategy", "enable:" + z17 + " lastEnable:" + f306148b);
        if (f306148b != z17) {
            f306148b = z17;
            com.tencent.mm.plugin.sns.model.y6.f164773a.d(-1);
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("enable", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
        return z17;
    }
    ...
    public final int b(r45.jj4 media) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("getMediaIlogo", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
        kotlin.jvm.internal.o.g(media, "media");
        if (android.text.TextUtils.isEmpty(media.f377858g)) {
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("getMediaIlogo", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
            return 0;
        }
        java.lang.String Url = media.f377858g;
        ...
        try {
            java.lang.String query = new java.net.URI(media.f377858g).getQuery();
            if (query == null) {
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("getMediaIlogo", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
                return 0;
            }
            ...
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("string2Long", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
            if (str != null && str.length() != 0) {
                z17 = false;
            }
            long j17 = 0;
            if (z17) {
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("string2Long", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
            } else {
                try {
                    j17 = pm0.d.a(str);
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SnsVideoDownloadStrategy", e17, "getMediaIlogo error:", new java.lang.Object[0]);
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("getMediaIlogo", "com.tencent.mm.plugin.sns.model.config.SnsVideoDownloadStrategy");
            return 0;
        }
    }
    ...
    */
    public final void c(com.tencent.mm.plugin.sns.storage.SnsInfo r41, r45.jj4 r42, boolean r43) {
        /*
