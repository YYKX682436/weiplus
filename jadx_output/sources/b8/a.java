...
public class a implements b8.c {
    ...
    public final android.os.IBinder f18238d;

    public a(android.os.IBinder iBinder) {
        this.f18238d = iBinder;
    }
    ...
    public java.lang.String d(java.util.Map map) {
        ...
        try {
            ...
            obtain.writeMap(map);
            this.f18238d.transact(7, obtain, obtain2, 0);
    ...
    public java.lang.String e(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.finshell.wallet.nfc.transit.IPostPayOpenService");
            obtain.writeMap(map);
            this.f18238d.transact(5, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String g(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.finshell.wallet.nfc.transit.IPostPayOpenService");
            obtain.writeMap(map);
            this.f18238d.transact(2, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String j() {
        ...
        try {
            obtain.writeInterfaceToken("com.finshell.wallet.nfc.transit.IPostPayOpenService");
            this.f18238d.transact(1, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String k() {
        ...
        try {
            obtain.writeInterfaceToken("com.finshell.wallet.nfc.transit.IPostPayOpenService");
            this.f18238d.transact(8, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String l(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.finshell.wallet.nfc.transit.IPostPayOpenService");
            obtain.writeMap(map);
            this.f18238d.transact(4, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
    ...
    public java.lang.String p(java.util.Map map) {
        ...
        try {
            obtain.writeInterfaceToken("com.finshell.wallet.nfc.transit.IPostPayOpenService");
            obtain.writeMap(map);
            this.f18238d.transact(3, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readString();
        } finally {
            obtain2.recycle();
