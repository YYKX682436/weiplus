...
public final class s0 implements ai4.b {
    ...
    public final ai4.i0 f5194a;

    /* renamed from: b, reason: collision with root package name */
    public long f5195b;

    /* renamed from: c, reason: collision with root package name */
    public final jz5.g f5196c = jz5.h.b(ai4.q0.f5190d);

    /* renamed from: d, reason: collision with root package name */
    public final jz5.g f5197d = jz5.h.b(ai4.r0.f5192d);

    /* renamed from: e, reason: collision with root package name */
    public final jz5.g f5198e = jz5.h.b(ai4.o0.f5184d);
    ...
    public s0(ai4.i0 i0Var) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", sb6.toString());
    }
    ...
    public boolean A(mj4.e eVar) {
        ...
        ai4.i0 i0Var = this.f5194a;
        if (i0Var != null) {
            i0Var.A(eVar);
        }
        ri4.d dVar = (ri4.d) O();
        dVar.getClass();
        return dVar.y().update(eVar, new java.lang.String[0]);
    }
    ...
    public boolean C(mj4.l item) {
        ...
        ti4.d dVar = (ti4.d) R();
        dVar.getClass();
        return dVar.z().delete(item, new java.lang.String[0]);
    }
    ...
    public java.util.List D() {
        ...
        android.database.Cursor B = z17.f327077d.B("select rowid, * from TextStatusLike where Read != 1 and HashUserName != ? and DeleteInMsgList != 1 order by CreateTime DESC ", new java.lang.String[]{a17});
        if (B != null) {
            while (B.moveToNext()) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusLikeStorage", "getUnreadInfos: size=" + linkedList.size());
        if (!linkedList.isEmpty()) {
            java.util.ArrayList arrayList = new java.util.ArrayList(kz5.d0.q(linkedList, 10));
            for (mj4.l lVar2 : linkedList) {
                arrayList.add(lVar2.field_TextStatusId + '_' + lVar2.field_CreateTime + '_' + lVar2.field_DisplayName);
            }
            arrayList.toString();
        }
        return linkedList;
    ...
    public void F(int i17) {
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "[markLikeTabShown]");
    ...
    */
    ...
    public java.util.List K() {
        ...
        z17.getClass();
        java.util.LinkedList<mj4.l> linkedList = new java.util.LinkedList();
        android.database.Cursor B = z17.f327077d.B("select rowid,* from TextStatusLike where Read != 1 and DeleteInMsgList != 1", null);
        if (B != null) {
            while (B.moveToNext()) {
                mj4.l lVar = new mj4.l();
                lVar.convertFrom(B);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusLikeStorage", "getAllUnreadInfos: size=" + linkedList.size());
        if (!linkedList.isEmpty()) {
            java.util.ArrayList arrayList3 = new java.util.ArrayList(kz5.d0.q(linkedList, 10));
            for (mj4.l lVar2 : linkedList) {
                arrayList3.add(lVar2.field_TextStatusId + '_' + lVar2.field_DisplayName + '_' + lVar2.field_CreateTime + '_' + lVar2.field_LikeId);
            }
            arrayList3.toString();
        }
        for (mj4.l lVar3 : linkedList) {
            arrayList2.add(new ai4.n0(lVar3.field_CreateTime, lVar3.getUserName()));
        }
        for (mj4.e eVar : ((ri4.d) O()).z()) {
            int i17 = eVar.field_CreateTime;
        ...
        for (ai4.n0 n0Var : kz5.n0.F0(arrayList2, new ai4.p0())) {
            if (arrayList.size() < 3 && !hashSet.contains(n0Var.f5177b)) {
                java.lang.String str = n0Var.f5177b;
                arrayList.add(str);
                hashSet.add(str);
            }
        }
    ...
    */
    ...
    public mj4.h M(java.lang.String str) {
        if (str == null || r26.n0.N(str)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "[getStatus] userName null or blank");
            return null;
        }
        ((k30.a) ((l30.h) i95.n0.c(l30.h.class))).Ai("xlab");
        return com.tencent.mm.storage.z3.H4(str) ? ki4.l0.f308144a.a(str) : P().b(str);
    }
    ...
    public final ri4.a O() {
        return (ri4.a) ((jz5.n) this.f5198e).getValue();
    }

    public final si4.a P() {
        return (si4.a) this.f5196c.getValue();
    }

    public final int Q() {
        java.lang.Object m17 = gm0.j1.u().c().m(com.tencent.mm.storage.u3.USERINFO_TEXT_STATUS_LASTTIME_NOTIFY_SHOWN_INT, null);
    ...
    public final ti4.a R() {
        return (ti4.a) ((jz5.n) this.f5197d).getValue();
    }
    ...
    public final int S(int i17) {
        ...
        int i18 = A + A2;
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "[getUnreadCnt] handleNotify, afterTime:" + i17 + " unreadCnt:" + i18 + " likeUnreadCnt:" + A + " commentUnreadCnt:" + A2);
        return i18;
    }
    ...
    @Override // ai4.b
    public void b() {
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "[markNotifyShown]");
        int e17 = c01.id.e();
    ...
    public void f() {
        ...
        ((ri4.d) O()).y().f327060d.A("TextStatusComment", "update TextStatusComment set DeleteInMsgList = 1 where DeleteInMsgList != 1");
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusCommentStorage", "markDeleteInMsgList: ");
        ((ti4.d) R()).z().f327077d.A("TextStatusLike", "update TextStatusLike set DeleteInMsgList = 1 where DeleteInMsgList != 1");
    }
    ...
    public hj4.b i() {
        ...
        bVar.f281661b = S;
        if (S > 0) {
            android.database.Cursor B = ((ti4.d) R()).z().f327077d.B("select rowid, * from TextStatusLike order by CreateTime DESC LIMIT 1", null);
            if (B != null) {
                lVar = new mj4.l();
                if (B.moveToNext()) {
                    lVar.convertFrom(B);
            ...
            bVar.f281662c = lVar != null ? lVar.getUserName() : null;
        }
        return bVar;
    }
    ...
    public java.util.List k() {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusLikeStorage", "getReadInfos: size=" + linkedList.size());
        if (!linkedList.isEmpty()) {
            java.util.ArrayList arrayList = new java.util.ArrayList(kz5.d0.q(linkedList, 10));
            for (mj4.l lVar2 : linkedList) {
                arrayList.add(lVar2.field_TextStatusId + '_' + lVar2.field_DisplayName);
            }
            arrayList.toString();
        }
        return linkedList;
    ...
    public java.util.List l() {
        ...
        android.database.Cursor B = y17.f327060d.B("select rowid, * from TextStatusComment where Read = 1 and DeleteInMsgList != 1 order by CreateTime DESC ", null);
        if (B != null) {
            while (B.moveToNext()) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusCommentStorage", "getReadInfos: size=" + linkedList.size());
        if (!linkedList.isEmpty()) {
            java.util.ArrayList arrayList = new java.util.ArrayList(kz5.d0.q(linkedList, 10));
    ...
    public void m(boolean z17) {
        long c17 = c01.id.c();
        if (z17 || java.lang.Math.abs(c17 - this.f5195b) > 600000) {
            mj4.h M = M(en1.a.a());
            java.lang.String l17 = M != null ? ((mj4.k) M).l() : null;
            com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "[reqGetSelfInfo] forceRequest = " + z17 + " selfStatusId = " + l17);
    ...
    @Override // ai4.b
    public void n() {
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "[markNotifyRedDotClick]");
        int e17 = c01.id.e();
    ...
    public boolean o(java.lang.String str) {
        ...
        java.lang.String a17 = en1.a.a();
        kotlin.jvm.internal.o.f(a17, "username(...)");
        android.database.Cursor B = z17.f327077d.B("select count(rowid) from TextStatusLike where TextStatusId = ? and HashUserName = ?", new java.lang.String[]{str, a17});
        if (B != null) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusLikeStorage", "[getIsLikeOther]statusId:%s result:%s", str, java.lang.Integer.valueOf(i17));
        return i17 > 0;
    }
    ...
    public void p(qi4.b bVar, qi4.b bVar2) {
        if (bVar != null) {
            ti4.d dVar = (ti4.d) R();
            dVar.getClass();
            java.util.HashMap hashMap = dVar.f419651c;
        ...
        if (bVar2 != null) {
            ri4.d dVar2 = (ri4.d) O();
            dVar2.getClass();
            java.util.HashMap hashMap2 = dVar2.f396096c;
            l75.q0 q0Var2 = (l75.q0) hashMap2.get(bVar2);
            com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.StatusCommentNativeStorage", "unObserve: " + bVar2.hashCode());
            if (q0Var2 != null) {
                hashMap2.remove(bVar2);
                dVar2.y().remove(q0Var2);
            }
        }
    }
    ...
    public boolean r() {
        ...
        while (true) {
            ...
            if (!(str == null || str.length() == 0)) {
                java.lang.String str2 = lVar.field_HashUserName;
                if (!(str2 == null || str2.length() == 0)) {
                    ti4.a R = R();
                    java.lang.String field_TextStatusId = lVar.field_TextStatusId;
                    kotlin.jvm.internal.o.f(field_TextStatusId, "field_TextStatusId");
                    java.lang.String field_HashUserName = lVar.field_HashUserName;
                    kotlin.jvm.internal.o.f(field_HashUserName, "field_HashUserName");
                    ti4.d dVar = (ti4.d) R;
                    dVar.getClass();
                    mj4.n z17 = dVar.z();
                    z17.getClass();
                    com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusLikeStorage", "markRead() called with: statusId = " + field_TextStatusId + ", hashUserName:" + field_HashUserName + ' ');
                    p75.n0 n0Var = rj4.e.f396290v;
                    android.content.ContentValues contentValues = new android.content.ContentValues();
                    contentValues.put("Read", (java.lang.Integer) 1);
                    p75.m c17 = rj4.e.f396291w.j(field_TextStatusId).c(rj4.e.f396292x.j(field_HashUserName));
                    p75.h1 j17 = rj4.e.f396290v.j(contentValues);
                    j17.b(c17);
                    j17.a().f(z17.f327077d);
                }
            }
        }
        for (mj4.e eVar : d17) {
            java.lang.String str3 = eVar.field_CommentId;
            if (!(str3 == null || str3.length() == 0)) {
                ri4.a O = O();
                java.lang.String field_CommentId = eVar.field_CommentId;
                kotlin.jvm.internal.o.f(field_CommentId, "field_CommentId");
                kotlin.jvm.internal.o.f(en1.a.a(), "username(...)");
                ri4.d dVar2 = (ri4.d) O;
                dVar2.getClass();
                mj4.f y17 = dVar2.y();
                y17.getClass();
                boolean N = r26.n0.N(field_CommentId);
                l75.k0 k0Var = y17.f327060d;
                if (N) {
    ...
    public boolean u(mj4.l item) {
        ...
        ti4.d dVar = (ti4.d) R();
        dVar.getClass();
        return dVar.z().update(item, new java.lang.String[0]);
    }
    ...
    public boolean v(java.lang.String str, boolean z17) {
        ...
        if (!z17 && y17 != null) {
            ...
            y17.field_HashUserName = en1.a.a();
            y17.field_TextStatusId = str;
            y17.field_Read = 1;
            y17.field_CreateTime = c01.id.e();
            y17.field_LikeId = mj4.m.a(y17);
            z18 = ((int) y17.systemRowid) == -1 ? t(y17) : u(y17);
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "doLikeFriend: " + z18 + ", statusId=" + str + " isLike=" + z17);
        return z18;
    }
    ...
    public mj4.l y(java.lang.String hashUserName, java.lang.String statusId) {
        ...
        mj4.n z17 = dVar.z();
        z17.getClass();
        com.tencent.mm.sdk.platformtools.t8.n(statusId);
        com.tencent.mm.sdk.platformtools.t8.n(hashUserName);
        android.database.Cursor B = z17.f327077d.B("select rowid, * from TextStatusLike where TextStatusId = ? and HashUserName = ? ", new java.lang.String[]{statusId, hashUserName});
        mj4.l lVar = null;
        if (B != null) {
            if (B.moveToFirst()) {
                lVar = new mj4.l();
    ...
    public void z(java.util.Map values) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.StatusNativeLogicManager", "dealTextStatusLike:textStatusId:%s version:%s likeCountVersion:%s likeId:%s hashUserName:%s", java.lang.Integer.valueOf(parseInt), java.lang.Integer.valueOf(parseInt2), str2, str3, str);
        boolean z17 = true;
        if (!(str2 == null || str2.length() == 0)) {
            if (!(str == null || str.length() == 0)) {
                ...
                if (parseInt3 != 1 || y17 == null) {
                    if (parseInt3 != 1 && t17 != null) {
                        ...
                        y17.field_HashUserName = str;
                        y17.field_TextStatusId = str2;
                        java.lang.String str7 = (java.lang.String) values.get(".sysmsg.textstatuslike.Type");
                        y17.field_Type = str7 != null ? java.lang.Integer.parseInt(str7) : 0;
                        y17.field_LikeId = str3;
                        java.lang.String str8 = (java.lang.String) values.get(".sysmsg.textstatuslike.Notify");
                        y17.field_Notify = str8 != null ? java.lang.Integer.parseInt(str8) : 0;
                        java.lang.String str9 = (java.lang.String) values.get(".sysmsg.textstatuslike.CreateTime");
                        y17.field_CreateTime = str9 != null ? java.lang.Integer.parseInt(str9) : 0;
                        y17.field_DisplayName = (java.lang.String) values.get(".sysmsg.textstatuslike.NickName");
                        y17.field_HeadImgUrl = (java.lang.String) values.get(".sysmsg.textstatuslike.HeadImgUrl");
                        ...
                        if (((int) y17.systemRowid) == -1) {
                            ...
                            com.tencent.mars.xlog.Log.w("MicroMsg.StatusNativeLogicManager", "doReceiveLikeMsg: update. version:%s field_Version:%s", java.lang.Integer.valueOf(parseInt), java.lang.Integer.valueOf(y17.field_Version));
                        }
                        ((c70.e) ((d70.i) i95.n0.c(d70.i.class))).getClass();
                    ...
                    com.tencent.mars.xlog.Log.w("MicroMsg.StatusNativeLogicManager", "dealTextStatusLike: likeMsg delete. version:%s field_Version:%s", java.lang.Integer.valueOf(parseInt), java.lang.Integer.valueOf(y17.field_Version));
                }
                if (t17 != null) {
                    if (parseInt2 != 0 && parseInt2 <= ((mj4.k) t17).f327067b.field_LikeCountVersion) {
                        z17 = false;
                    }
                    if (z17) {
                        mj4.j jVar = new mj4.j((mj4.k) t17);
                        jVar.b(com.tencent.mm.sdk.platformtools.t8.P((java.lang.String) values.get(".sysmsg.textstatuslike.LikeCount"), 0));
