        ...
        if (json.has("subMetas")) {
            try {
                ...
                while (it6.hasNext()) {
                    ...
                    xf1.n nVar = xf1.o.f454246c;
                    kotlin.jvm.internal.o.d(jSONObject);
                    xf1.o a17 = nVar.a(jSONObject);
                    kotlin.jvm.internal.o.d(a17);
                    arrayList2.add(a17);
                }
                java.lang.String string = json.getString(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
                long j17 = json.getLong("lastModified");
                kotlin.jvm.internal.o.d(string);
                mVar = new xf1.m(string, j17, arrayList2, null);
            } catch (java.lang.Exception e17) {
                com.tencent.mars.xlog.Log.w("MicroMsg.AppBrand.AppBrandResCacheChecker", "DirMetaData#fromJsonFile, fail since " + e17);
                return null;
            }
        } else {
            try {
                java.lang.String string2 = json.getString(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
                long j18 = json.getLong("lastModified");
                kotlin.jvm.internal.o.d(string2);
                mVar = new xf1.o(string2, j18);
            } catch (java.lang.Exception e18) {
                com.tencent.mars.xlog.Log.w("MicroMsg.AppBrand.AppBrandResCacheChecker", "FileMetaData#fromJsonFile, fail since " + e18);
                return null;
            }
        }
        return mVar;
