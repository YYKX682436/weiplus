...
public class e extends i95.w implements tg3.k1 {
    ...
    public final java.util.Map f291566d = new java.util.HashMap();

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Map f291567e = new java.util.HashMap();

    /* renamed from: f, reason: collision with root package name */
    public final java.util.Map f291568f = new java.util.HashMap();

    /* renamed from: g, reason: collision with root package name */
    public final java.util.LinkedList f291569g = new java.util.LinkedList();
    ...
    public java.lang.CharSequence Ai(java.lang.String str, android.os.Bundle bundle) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.SysMsgTemplateImp", "hy: [digest] request translate content is null!");
            return null;
        }
        java.util.Map d17 = com.tencent.mm.sdk.platformtools.aa.d(str, "sysmsg", null);
        if (d17 == null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.SysMsgTemplateImp", "hy: [digest] not retrieved sysmsg from new xml!");
            return null;
        }
        java.lang.String str2 = (java.lang.String) d17.get(".sysmsg.$type");
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str2) && "sysmsgtemplate".equals(str2)) {
            return Ri(d17, bundle, null, 1, null);
        }
        com.tencent.mars.xlog.Log.w("MicroMsg.SysMsgTemplateImp", "hy: [digest] not acceptable sysmsg: %s", str2);
        return null;
    }
    ...
    public void Di(final java.lang.String str, final java.util.Map map, final android.os.Bundle bundle, final java.lang.ref.WeakReference weakReference, final java.lang.ref.WeakReference weakReference2) {
        try {
            ...
            java.util.HashSet hashSet = (java.util.HashSet) ((java.util.HashMap) this.f291568f).get(string);
            if (hashSet != null) {
    ...
    public final java.lang.CharSequence Ni(java.lang.String str, java.util.Map map) {
        ...
        sb6.append(str);
        sb6.append(".$hidden");
        if (com.tencent.mm.sdk.platformtools.t8.P((java.lang.String) map.get(sb6.toString()), 0) == 1) {
        ...
        ((ke0.e) xVar).getClass();
        return new android.text.SpannableString(com.tencent.mm.pluginsdk.ui.span.c0.i(context, str3));
    }
    ...
    public final java.lang.CharSequence Ri(java.util.Map map, android.os.Bundle bundle, java.lang.ref.WeakReference weakReference, int i17, java.lang.ref.WeakReference weakReference2) {
        ...
        while (true) {
            ...
            if (map.get(str12) == null) {
                ...
                com.tencent.mars.xlog.Log.w("MicroMsg.SysMsgTemplateImp", "hy: not handled");
                return new android.text.SpannableString("");
            }
            ...
            if (!("tmpl_type_profile".equals(str13) || "tmpl_type_profilewithrevoke".equals(str13) || "tmpl_type_profilewithrevokeqrcode".equals(str13) || "tmpl_type_wxappnotifywithview".equals(str13) || "tmpl_type_succeed_contact".equals(str13) || "tmpl_type_jump_chat".equals(str13) || "tmpl_type_gamelife_link_url".equals(str13) || "tmpl_type_gamelife_plain".equals(str13) || "new_tmpl_type_succeed_contact".equals(str13) || "tmpl_type_chatroom_finder".equals(str13) || "tmpl_type_massend_newxml".equals(str13) || "tmpl_type_ecs_receive_gift".equals(str13) || "tmpl_type_ecs_jump_info".equals(str13) || "tmpl_type_profilewithrevokeandunbindapp".equals(str13))) {
                com.tencent.mars.xlog.Log.w("MicroMsg.SysMsgTemplateImp", "hy: non supported type: %s", str13);
                java.lang.CharSequence Ni = Ni(str12, map);
                arrayList4.add(Ni);
                if (!com.tencent.mm.sdk.platformtools.t8.J0(Ni)) {
                    return wi(arrayList4);
                }
            }
            if (bundle != null) {
            ...
            while (true) {
                ...
                if (str13 != null && !str13.isEmpty() && qVar.hasKey(str13) && ((tg3.d1) qVar.get()) != null) {
                    if (bundle == null || (str10 = bundle.getString("conv_talker_username")) == null) {
                        str10 = "";
                    }
                    com.tencent.mm.storage.a3 z07 = ((qv1.a) ((rv1.f) gm0.j1.s(rv1.f.class))).a().z0(str10);
                    if (z07 == null) {
                        it7 = it9;
                        equals = false;
                    } else {
                        it7 = it9;
                        equals = c01.z1.r().equals(z07.field_roomowner);
                    }
                    java.lang.String str15 = equals ? "owner" : "member";
                    java.util.Iterator it10 = m90.f1.f324863d.iterator();
                    while (true) {
                        i18 = i28;
                        str11 = "";
                        while (it10.hasNext()) {
                            ...
                            if (kotlin.jvm.internal.o.b((java.lang.String) map.get(str12 + ".template" + str16 + ".$type"), str15)) {
                    ...
                    arrayList = arrayList4;
                    com.tencent.mars.xlog.Log.i("HandleFinderTemplateParseListener", "[onParse] roomId=" + str10 + " handleType=" + i17 + " targetType=" + str15 + " templateStr=" + str11);
                    str14 = str11;
                    if (!str11.isEmpty()) {
                        break;
                    }
            ...
            while (it11.hasNext()) {
                ...
                if (str13 != null && !str13.isEmpty() && qVar2.hasKey(str13) && ((tg3.e1) qVar2.get()) != null) {
                    java.lang.String str17 = (java.lang.String) map.get(str12 + ".reportextradata");
                    if (str17 != null) {
                        java.lang.String b17 = fp.s0.b(str17, com.tencent.mapsdk.internal.rv.f51270c);
                        if (weakReference2 != null && (neatTextView = (com.tencent.neattextview.textview.view.NeatTextView) weakReference2.get()) != null) {
                            cy1.a aVar = (cy1.a) ((dy1.r) i95.n0.c(dy1.r.class));
                            str8 = str13;
                            aVar.pk(neatTextView, "ecs_new_xml_jump_view");
                            it6 = it11;
                            str9 = str;
                            aVar.Tj(neatTextView, 32, 12, false);
                            aVar.gk(neatTextView, kz5.b1.e(new jz5.l("reportextradata", b17)));
                            str13 = str8;
                            it11 = it6;
                            str = str9;
                        }
            ...
            if (a17 == null || a17.size() == 0) {
                ...
                while (it12.hasNext()) {
                    ...
                    int i29 = oVar.f291596a;
                    java.lang.String str19 = oVar.f291597b;
                    if (i29 == 0) {
                        java.util.Iterator it13 = this.f291569g.iterator();
                        while (true) {
                            if (!it13.hasNext()) {
                                z0Var = null;
                                break;
                        ...
                        if (z0Var != null) {
                            ...
                            java.lang.String string = com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getString(com.tencent.mm.R.string.f491803ea3);
                            java.lang.String string2 = com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getString(com.tencent.mm.R.string.f491804ea4, str24, string);
                            ...
                            if (indexOf == -1 || string.length() + indexOf > string2.length()) {
                                ...
                                android.content.Context context = com.tencent.mm.sdk.platformtools.x2.f193071a;
                                ((ke0.e) xVar).getClass();
                                ?? i37 = com.tencent.mm.pluginsdk.ui.span.c0.i(context, string2);
                                it = it12;
                                android.graphics.drawable.Drawable drawable = com.tencent.mm.sdk.platformtools.x2.f193071a.getDrawable(com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getIdentifier("systemmessages_hongbaoicon", "drawable", com.tencent.mm.sdk.platformtools.x2.f193071a.getPackageName()));
                                if (drawable != null) {
                                    int dimensionPixelOffset = com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getDimensionPixelOffset(com.tencent.mm.R.dimen.f479908im);
                            ...
                            arrayList5.add(new android.text.SpannableString(com.tencent.mm.pluginsdk.ui.span.c0.i(context2, str19)));
                        }
                        str2 = str18;
                    } else {
                        it = it12;
                        ...
                        if (i29 == 1) {
                            ...
                            while (true) {
                                ...
                                if (str27.equals((java.lang.String) map.get(str28 + ".$name"))) {
                                    ...
                                    if (i17 != 0) {
                                        ...
                                        i27 = i39;
                                        if (i17 != i19) {
                                            com.tencent.mars.xlog.Log.e("MicroMsg.SysMsgTemplateImp", "hy: not supported digest type");
                                        } else if (Bi(str29)) {
                                            java.util.HashMap hashMap = (java.util.HashMap) this.f291567e;
                                            java.util.List list = (java.util.List) hashMap.get(str29);
                                            if (list != null && list.size() > 0) {
                                                android.support.v4.media.f.a(((java.util.LinkedList) hashMap.get(str29)).getLast());
                                            }
                                            java.util.Iterator it15 = ((fs.e) ((fs.c) fs.g.f(tg3.b1.class)).all()).iterator();
                                            java.lang.String str30 = null;
                                            while (it15.hasNext()) {
                                                fs.q qVar3 = (fs.q) it15.next();
                                                if (qVar3.hasKey(str29)) {
                                        ...
                                        java.util.HashMap hashMap2 = (java.util.HashMap) this.f291566d;
                                        java.util.List list2 = (java.util.List) hashMap2.get(str29);
                                        if ("link_ecs_gift".equals(str29)) {
                                            com.tencent.mars.xlog.Log.i("MicroMsg.SysMsgTemplateImp", "translateInternal, type is %s, node size is %d", str29, java.lang.Integer.valueOf(arrayList5.size()));
                                        ...
                                        if (obj != null) {
                                            ...
                                            i27 = i39;
                                            if (com.tencent.mm.sdk.platformtools.t8.K0(str28)) {
                                                com.tencent.mars.xlog.Log.w("MicroMsg.SysMsgTemp.SysMsgTemplateLinkHandlerBase", "hy: non header!!");
                                            } else if (com.tencent.mm.sdk.platformtools.t8.K0(string3)) {
                                                com.tencent.mars.xlog.Log.w("MicroMsg.SysMsgTemp.SysMsgTemplateLinkHandlerBase", "hy: not resolved talker!!");
                                            } else {
                                                str5 = str28;
                                                str3 = str27;
                                                str4 = str32;
                                                i19 = 1;
                                                charSequence = kVar.f291592a.b(map, str28, bundle, weakReference, weakReference2);
                                            }
                                            str5 = str28;
                                            str3 = str27;
                                            str4 = str32;
                                        ...
                                        if (charSequence != null) {
                                            ...
                                            com.tencent.mars.xlog.Log.i("MicroMsg.SysMsgTemplateImp", "listener == null: %b", objArr);
                                        ...
                                        objArr2[0] = str33;
                                        com.tencent.mars.xlog.Log.i("MicroMsg.SysMsgTemplateImp", "not support link type: %s", objArr2);
                                        arrayList5.add(Ni(str28, map));
                                    }
                                } else {
                                    str3 = str27;
                            ...
                            str2 = str18;
                            com.tencent.mars.xlog.Log.e("MicroMsg.SysMsgTemplateImp", "hy: invalid! should not get here");
                        }
                    }
                    str18 = str2;
                    it12 = it;
