...
public final class c1 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.backup.roambackup.ui.component.DialogActionBar f447914d;

    public c1(com.tencent.mm.plugin.backup.roambackup.ui.component.DialogActionBar dialogActionBar) {
        this.f447914d = dialogActionBar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        java.lang.Runnable runnable = this.f447914d.f92747e;
        if (runnable != null) {
            runnable.run();
        }
