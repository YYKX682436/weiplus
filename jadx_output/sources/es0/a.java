...
public abstract class a {
    ...
    public final java.lang.String[] f256309a;

    public a() {
        this.f256309a = new java.lang.String[]{"OMX.oppo.h264.encoder"};
        ...
        this.f256309a = strArr;
        com.tencent.mars.xlog.Log.i("MicroMsg.VideoCodecConfig", "supportedHardcodeEncoderList : " + Zi + "  supportedHardcodeEncoder size:" + strArr.length);
        if (strArr.length == 0) {
            es0.b.f256310a = false;
        }
    }
    ...
    public final android.media.MediaCodecInfo a(java.lang.String mimeType) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.VideoCodecConfig", "numCodec:" + codecCount);
        for (int i17 = 0; i17 < codecCount; i17++) {
            ...
            if (codecInfoAt.isEncoder()) {
                ...
                java.lang.String[] strArr = this.f256309a;
                ...
                for (java.lang.String str : strArr) {
                    if (r26.i0.p(codecInfoAt.getName(), str, true)) {
                        ...
                        for (int i18 = 0; i18 < length; i18++) {
                            com.tencent.mars.xlog.Log.i("MicroMsg.VideoCodecConfig", "hardcodeEncoder: " + codecInfoAt.getName() + "  type:" + supportedTypes[i18]);
                            if (r26.i0.p(supportedTypes[i18], mimeType, true)) {
                                es0.b.f256310a = true;
                                return codecInfoAt;
                            }
                        }
                        com.tencent.mars.xlog.Log.i("MicroMsg.VideoCodecConfig", "selectCodec from hardcodeEncoder " + strArr + ": " + codecInfoAt.getName());
                    }
                }
            }
        }
        for (int i19 = 0; i19 < codecCount; i19++) {
            ...
            if (codecInfoAt2.isEncoder()) {
                ...
                for (int i27 = 0; i27 < length2; i27++) {
                    com.tencent.mars.xlog.Log.i("MicroMsg.VideoCodecConfig", "selectCodec:  " + codecCount + "  type: " + supportedTypes2[i27]);
