...
public abstract class a0 {
    ...
    */
    ...
    public static final long c(long j17) {
        long j18 = (j17 & io.flutter.embedding.android.KeyboardMap.kValueMask) << 32;
    ...
    public static final float g(long j17) {
        f1.d f17 = e1.y.f(j17);
        long j18 = f17.f258472b;
        int i17 = f1.c.f258470e;
        if (!f1.c.a(j18, f1.c.f258466a)) {
            throw new java.lang.IllegalArgumentException(("The specified color must be encoded in an RGB color space. The supplied color space is " + ((java.lang.Object) f1.c.b(f17.f258472b))).toString());
        }
        f1.w wVar = (f1.w) ((f1.y) f17).f258533n;
        float doubleValue = (float) ((((java.lang.Number) wVar.invoke(java.lang.Double.valueOf(e1.y.h(j17)))).doubleValue() * 0.2126d) + (((java.lang.Number) wVar.invoke(java.lang.Double.valueOf(e1.y.g(j17)))).doubleValue() * 0.7152d) + (((java.lang.Number) wVar.invoke(java.lang.Double.valueOf(e1.y.e(j17)))).doubleValue() * 0.0722d));
        float f18 = 0.0f;
        if (doubleValue > 0.0f) {
            f18 = 1.0f;
            if (doubleValue < 1.0f) {
