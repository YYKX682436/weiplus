...
public abstract class c0 implements java.lang.Comparable {
    ...
    public static final e1.b0 f246230d = new e1.b0(null);

    /* renamed from: e, reason: collision with root package name */
    public static final float f246231e;

    static {
        a(1.0f);
        a(-1.0f);
        f246231e = java.lang.Float.intBitsToFloat(1056964608);
    }
    ...
    public static short a(float f17) {
        ...
        if (i27 == 255) {
            ...
            int i38 = i27 + org.chromium.net.NetError.ERR_PROXY_AUTH_REQUESTED + 15;
            if (i38 >= 31) {
                i29 = 49;
            } else if (i38 > 0) {
                i37 = i28 >> 13;
    ...
    public static final float b(short s17) {
        ...
        if (i29 != 0) {
            ...
            if (i37 != 0) {
                float intBitsToFloat = java.lang.Float.intBitsToFloat(i37 + 1056964608) - f246231e;
