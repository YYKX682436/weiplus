...
public abstract class b {
    ...
    public static boolean f(int i17) {
        ...
        if (d17 && !zt5.l.b(str)) {
            return wt5.a.s(str, false).f475605a == 0;
        }
        if (d17) {
    ...
    public static void g(eu5.b bVar, ju5.c cVar) {
        zt5.h.c("Soter.SoterWrapperApi", "soter: request authorize provide challenge. scene: %d", java.lang.Integer.valueOf(cVar.f302066a));
        int i17 = cVar.f302069d;
        if (i17 == 1 || i17 == 2) {
