...
public final class u0 extends az2.j {
    ...
    public u0(long j17, java.lang.String objectNonceId, java.lang.String str, int i17, int i18, r45.qt2 qt2Var, int i19) {
        ...
        c31Var.set(6, ((c61.p2) ((c61.yb) i95.n0.c(c61.yb.class))).Zi(j17, integer, str));
        t4Var.h((r45.kv0) c31Var.getCustom(5), null, kz5.b0.c(new jz5.o(java.lang.Integer.valueOf(integer), java.lang.Long.valueOf(j17), str)));
        lVar.f70664a = c31Var;
        ...
        lVar.f70667d = 3912;
        p(lVar.a());
        com.tencent.mars.xlog.Log.i("CgiFinderLiveFeedBack", "[CgiFinderLiveFeedBack] feedId=" + j17 + " feedbackType=" + i17 + " subType=" + i18);
    }
    ...
    public void A(int i17, int i18, java.lang.String str, com.tencent.mm.protobuf.f fVar, com.tencent.mm.modelbase.m1 m1Var) {
        ...
        com.tencent.mars.xlog.Log.i("CgiFinderLiveFeedBack", "[CgiFinderLiveFeedBack] failed errType=" + i17 + " errCode=" + i18 + " errMsg=" + str);
    }
}
