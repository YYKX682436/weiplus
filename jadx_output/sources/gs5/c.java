...
public abstract class c {
    ...
    public static final java.util.Map f275167a = new java.util.HashMap();
    ...
    public static void a(tr5.g0 g0Var) {
        ...
        if (cVar.f266363r) {
            java.lang.String[] split2 = cVar.f266353e.split(",");
            java.lang.String[] split3 = cVar.f266354f.split(",");
            ...
            split = cVar.f266353e.split(",");
        }
        for (java.lang.String str2 : split) {
            java.util.HashMap hashMap = (java.util.HashMap) f275167a;
            if (hashMap.containsKey(str2)) {
                java.lang.Object[] objArr = (java.lang.Object[]) hashMap.get(str2);
                objArr[0] = java.lang.Integer.valueOf(((java.lang.Integer) objArr[0]).intValue() + cVar.f266358m.f266349f);
                if (cVar.f266360o) {
            ...
            } else if (cVar.f266360o) {
                hashMap.put(str2, new java.lang.Object[]{java.lang.Integer.valueOf(cVar.f266358m.f266349f), 0, 1});
            } else {
                hashMap.put(str2, new java.lang.Object[]{java.lang.Integer.valueOf(cVar.f266358m.f266349f), 1, 0});
            }
        }
    }
}
