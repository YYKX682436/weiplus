...
public final class g8 extends i95.w implements pp0.o0 {
    ...
    public final java.lang.String f468112d = "MicroMsg.Maas.BackgroundVideoWorkService";

    public void Ai(java.lang.String workTagId, n55.e callback) {
        kotlin.jvm.internal.o.g(workTagId, "workTagId");
        kotlin.jvm.internal.o.g(callback, "callback");
        kotlinx.coroutines.l.d(kotlinx.coroutines.z0.b(), kotlinx.coroutines.q1.f310570c, null, new yy0.x7(workTagId, this, callback, null), 2, null);
    }

    public o55.a Bi(java.lang.String workTagId) {
        kotlin.jvm.internal.o.g(workTagId, "workTagId");
        dm.ib d17 = iz0.d.f296044a.d(workTagId);
        java.lang.String str = this.f468112d;
        if (d17 == null) {
            com.tencent.mars.xlog.Log.e(str, "getBackgroundVideoBasicInfo >> workTagId: " + workTagId + ", is not find");
            return null;
        }
        com.tencent.mars.xlog.Log.i(str, "getBackgroundVideoBasicInfo >> workTagId: " + workTagId + ", workType: " + d17.field_work_type + ", is find");
    ...
    public void Di(java.lang.String workTagId, int i17) {
        kotlin.jvm.internal.o.g(workTagId, "workTagId");
        com.tencent.mars.xlog.Log.i(this.f468112d, "updateWorkTypeByUploadAction >> workTagId: " + workTagId + ", action: " + i17);
        kotlinx.coroutines.l.d(kotlinx.coroutines.z0.b(), kotlinx.coroutines.q1.f310570c, null, new yy0.f8(workTagId, this, i17, null), 2, null);
    }
    ...
    */
    public java.lang.Object wi(java.lang.String r5, kotlin.coroutines.Continuation r6) {
        /*
            r4 = this;
        ...
        L13:
            ...
            r0.<init>(r4, r6)
        L18:
            java.lang.Object r6 = r0.f468324e
            pz5.a r1 = pz5.a.f359186d
            int r2 = r0.f468326g
            r3 = 1
            if (r2 == 0) goto L33
            if (r2 != r3) goto L2b
            java.lang.Object r5 = r0.f468323d
        ...
        L33:
            ...
            java.lang.String r2 = r4.f468112d
            ...
            return r1
        L56:
            com.tencent.maas.export.MJExportManager r6 = (com.tencent.maas.export.MJExportManager) r6
            if (r6 == 0) goto L62
