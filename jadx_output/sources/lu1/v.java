...
public abstract class v {
    public static java.util.ArrayList a(java.lang.String str, int i17) {
        if (android.text.TextUtils.isEmpty(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.CardListItemParser", "parseCardListItemArray jsonContent is null");
            return null;
        }
        try {
                    ...
                    if (optJSONObject == null) {
                        if (i17 == 26 && (optJSONArray.opt(i18) instanceof java.lang.String)) {
                            try {
                                ...
                                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CardListItemParser", e17, "protect itemJSON for AppBrand", new java.lang.Object[0]);
                            }
                        }
                    }
                    r45.hu huVar = new r45.hu();
                    huVar.f376446d = optJSONObject.optString(i17 == 26 ? "cardId" : "card_id");
                    huVar.f376447e = optJSONObject.optString(i17 == 26 ? "cardExt" : "card_ext");
                    arrayList.add(huVar);
                }
                return arrayList;
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.CardListItemParser", "parseCardListItemArray cardItemListJson is null");
            return null;
        } catch (org.json.JSONException e18) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CardListItemParser", e18, "", new java.lang.Object[0]);
            return null;
        }
    }
    ...
    public static java.lang.String b(java.util.LinkedList linkedList, boolean z17, int i17) {
        if (linkedList == null || linkedList.size() == 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.CardListItemParser", "parseCardListItemToJson list == null || list.size() == 0");
            return "";
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.CardListItemParser", "parseCardListItemToJson is_succ:" + z17 + " scene:" + i17);
        ...
        if (i17 == 8) {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CardListItemParser", e17, "", new java.lang.Object[0]);
                return "";
            }
        }
        jSONStringer.array();
        ...
        while (it.hasNext()) {
            ...
            jSONStringer.value(gVar.f376446d);
            jSONStringer.key(i17 == 26 ? "cardExt" : "card_ext");
            java.lang.String str = gVar.f376447e;
            if (str == null) {
                str = "";
            }
            ...
            java.lang.String str2 = gVar.f456477f;
            if (str2 == null) {
                str2 = "";
            }
        ...
        try {
            ...
            if (optJSONArray != null && optJSONArray.length() != 0) {
                ...
                for (int i18 = 0; i18 < optJSONArray.length(); i18++) {
                    ...
                    com.tencent.mars.xlog.Log.i("MicroMsg.CardListItemParser", sb6.toString());
                }
                jSONStringer.endArray();
                return jSONStringer.toString();
            }
