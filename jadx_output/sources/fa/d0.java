...
public abstract class d0 {
    ...
    public static final int[] f260593a = {com.tencent.mm.R.attr.f478177cq};

    /* renamed from: b, reason: collision with root package name */
    public static final int[] f260594b = {com.tencent.mm.R.attr.f478179cs};

    public static void a(android.content.Context context, android.util.AttributeSet attributeSet, int i17, int i18) {
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v9.a.f434134x, i17, i18);
        boolean z17 = obtainStyledAttributes.getBoolean(1, false);
        obtainStyledAttributes.recycle();
        if (z17) {
            c(context, f260594b, "Theme.MaterialComponents");
        }
        c(context, f260593a, "Theme.AppCompat");
    }
