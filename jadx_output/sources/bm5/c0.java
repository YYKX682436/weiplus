...
public final class c0 {
    ...
    /* renamed from: c */
    public static long f22552c;

    /* renamed from: d */
    public static long f22553d;

    /* renamed from: e */
    public static long f22554e;

    /* renamed from: a */
    public static final bm5.c0 f22550a = new bm5.c0();

    /* renamed from: b */
    public static final java.util.concurrent.ConcurrentHashMap f22551b = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: f */
    public static final java.lang.ThreadLocal f22555f = new java.lang.ThreadLocal();
    ...
    public final int b(bm5.y fileDescriptor) {
        ...
        if (c17 != 0) {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.C2CPath", str);
        }
        return c17;
    }
    ...
    */
    public final boolean c(java.lang.String r4, boolean r5) {
        ...
        L4:
            ...
            com.tencent.mm.vfs.z7 r2 = com.tencent.mm.vfs.z7.a(r4)
            r1.<init>(r2)
            boolean r2 = r1.m()
            if (r2 == 0) goto L4f
            boolean r2 = r1.y()
        ...
        L2b:
            if (r1 == 0) goto L4f
            boolean r0 = com.tencent.mm.vfs.w6.g(r4, r0)
            if (r5 == 0) goto L4e
    ...
    public final bm5.f0 d(boolean z17) {
        return z17 ? bm5.f0.f22562g : bm5.f0.f22563h;
    }
    ...
    public final java.lang.String e(bm5.v businessType, java.lang.String chatUsername, long j17, boolean z17) {
        ...
        if (r26.n0.N(chatUsername)) {
            ...
            java.util.concurrent.ConcurrentHashMap concurrentHashMap = f22551b;
            java.lang.String str3 = (java.lang.String) concurrentHashMap.get(chatUsername);
            if (str3 == null) {
                byte[] bytes = chatUsername.getBytes(r26.c.f368865a);
            ...
            if (str3.length() < 2) {
                ...
                str = h17 + '/' + R;
                if (!com.tencent.mm.vfs.w6.j(str) && z17) {
        ...
        if (!com.tencent.mm.vfs.w6.j(str5) && z17) {
    ...
    public final java.lang.String f(bm5.v businessType, java.lang.String chatUsername, long j17, boolean z17) {
        ...
        java.lang.String str = com.tencent.mm.vfs.q7.c(ordinal != 0 ? ordinal != 1 ? "c2c_origin_file" : "c2c_origin_video" : "c2c_origin_image") + '/';
        if (!com.tencent.mm.vfs.w6.j(str) && z17) {
            com.tencent.mm.vfs.w6.u(str);
        }
        ...
        if (j17 <= 0) {
            ...
            if ((g17 != null ? g17.length() : 0) < 3) {
                ...
                if (!com.tencent.mm.vfs.w6.j(str2) && z17) {
    ...
    public final java.lang.String h(bm5.v businessType, boolean z17) {
        kotlin.jvm.internal.o.g(businessType, "businessType");
        java.lang.String str = com.tencent.mm.vfs.q7.c("c2c") + '/';
        if (!com.tencent.mm.vfs.w6.j(str) && z17) {
            com.tencent.mm.vfs.w6.u(str);
        }
        java.lang.String str2 = str + businessType.f22753d + '/';
        if (!com.tencent.mm.vfs.w6.j(str2) && z17) {
            com.tencent.mm.vfs.w6.u(str2);
            if (java.lang.System.currentTimeMillis() - f22553d > 3600000) {
                com.tencent.mars.xlog.Log.i("MicroMsg.C2CPath", "mkdir c2c root path: " + str2 + ", stack: " + r26.p0.E0(jz5.a.b(new java.lang.Throwable()), 1000));
                f22553d = java.lang.System.currentTimeMillis();
                if (businessType == bm5.v.f22750p) {
                    com.tencent.mars.xlog.Log.i("MicroMsg.C2CPath", "mkdir unknown business type c2c root path: " + str2);
                    ...
                    msgRefactorReportStruct.p("c2c_error_business_type_c2c_root_dir");
    ...
    public final java.lang.String k(bm5.v businessType, bm5.f0 resType, java.lang.String str, boolean z17, long j17, java.lang.String str2, boolean z18, boolean z19) {
        ...
        if (j17 > 0) {
            if (!(str == null || r26.n0.N(str))) {
                ...
                switch (resType.ordinal()) {
                    case 0:
                        com.tencent.mars.xlog.Log.e("MicroMsg.C2CPath", "unknown res type path, businessType: " + businessType + ", resType: " + resType + ", msgTalker: " + str + ", isTmp: " + z17);
                        return "";
                    case 1:
                    case 9:
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.C2CPath", "mediaId is null, businessType: " + businessType + ", resType: " + resType + ", msgTalker: " + str + ", isTmp: " + z17);
        return "";
    }
    ...
    public final java.lang.String n(bm5.v businessType, java.lang.String chatUsername, boolean z17, boolean z18) {
        ...
        if (z18) {
            try {
                java.lang.ThreadLocal threadLocal = f22555f;
                ...
                byte[] bytes2 = chatUsername.getBytes(r26.c.f368865a);
            ...
            if (str2 == null) {
                byte[] bytes3 = chatUsername.getBytes(r26.c.f368865a);
    ...
    public final java.lang.String p(bm5.v businessType, boolean z17, boolean z18) {
        ...
        java.lang.String str = com.tencent.mm.vfs.q7.c("c2c_temp") + '/';
        if (!com.tencent.mm.vfs.w6.j(str) && z18) {
            com.tencent.mm.vfs.w6.u(str);
        }
        java.lang.String str2 = str + businessType.f22753d + '/';
        if (com.tencent.mm.vfs.w6.j(str2) || !z18) {
            return str2;
        }
        com.tencent.mm.vfs.w6.u(str2);
        if (java.lang.System.currentTimeMillis() - f22554e <= 3600000) {
            return str2;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.C2CPath", "mkdir c2c root temp path: " + str2 + ", stack: " + r26.p0.E0(jz5.a.b(new java.lang.Throwable()), 1000));
        f22554e = java.lang.System.currentTimeMillis();
        if (businessType != bm5.v.f22750p) {
            return str2;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.C2CPath", "mkdir unknown business type c2c root temp path: " + str2);
        com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct msgRefactorReportStruct = new com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct();
        msgRefactorReportStruct.p("c2c_error_business_type_c2c_root_temp_dir");
        msgRefactorReportStruct.q(com.tencent.mm.sdk.platformtools.z.f193109e);
        msgRefactorReportStruct.k();
        return str2;
    }
    ...
    public final java.lang.String q(bm5.v vVar, java.lang.String str, boolean z17, long j17, boolean z18, java.lang.String str2, boolean z19) {
        ...
        java.lang.String str4 = (java.lang.String) f22551b.get(str);
        if (str4 == null) {
        ...
        if (z19 || com.tencent.mm.vfs.w6.j(str5)) {
            return str5;
        }
        java.lang.String str6 = o(vVar, str, j17, z17, z18) + '/' + str2;
        return com.tencent.mm.vfs.w6.j(str6) ? str6 : str5;
    }

    public final void r(java.lang.String str, bm5.v vVar) {
        if (java.lang.System.currentTimeMillis() - f22552c > 3600000) {
            com.tencent.mars.xlog.Log.i("MicroMsg.C2CPath", "mkdir c2c path: " + str + ", stack: " + r26.p0.E0(jz5.a.b(new java.lang.Throwable()), 1000));
            f22552c = java.lang.System.currentTimeMillis();
            if (vVar == bm5.v.f22750p) {
                com.tencent.mars.xlog.Log.i("MicroMsg.C2CPath", "mkdir unknown business type c2c path: " + str);
                com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct msgRefactorReportStruct = new com.tencent.mm.autogen.mmdata.rpt.MsgRefactorReportStruct();
                msgRefactorReportStruct.p("c2c_error_business_type_c2c_dir");
                msgRefactorReportStruct.q(com.tencent.mm.sdk.platformtools.z.f193109e);
                msgRefactorReportStruct.k();
            }
        }
