...
public class g0 implements java.util.concurrent.ForkJoinPool.ManagedBlocker {
    ...
    public final /* synthetic */ java.util.Collection f22581a;

    public g0(java.util.Collection collection) {
        this.f22581a = collection;
    }
    ...
    */
    public boolean block() {
        /*
            r2 = this;
            java.util.Collection r0 = r2.f22581a
    ...
    public boolean isReleasable() {
        for (java.util.concurrent.Future future : this.f22581a) {
