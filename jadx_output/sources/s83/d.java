...
public class d extends l75.n0 {
    ...
    public static final java.lang.String[] f404870e = {l75.n0.getCreateSQLs(s83.c.f404868u, "IPCallAddressItem")};

    /* renamed from: f, reason: collision with root package name */
    public static final java.lang.String[] f404871f = {"*", "rowid"};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f404872d;

    public d(l75.k0 k0Var) {
        super(k0Var, s83.c.f404868u, "IPCallAddressItem", null);
        this.f404872d = k0Var;
    }
    ...
    */
    public s83.c D0(java.lang.String r12) {
        /*
            ...
            return r1
        L8:
            l75.k0 r2 = r11.f404872d
            java.lang.String r3 = "IPCallAddressItem"
            java.lang.String[] r4 = s83.d.f404871f
    ...
    public s83.c J0(long j17) {
        android.database.Cursor D = this.f404872d.D("IPCallAddressItem", f404871f, "rowid=?", new java.lang.String[]{j17 + ""}, null, null, null, 2);
        try {
            try {
                if (D.moveToFirst()) {
    ...
    */
    ...
    public android.database.Cursor P0(java.lang.String str) {
        return this.f404872d.E("IPCallAddressItem", f404871f, "systemAddressBookUsername LIKE ? or sortKey LIKE ?", new java.lang.String[]{"%" + str + "%", "%" + str + "%"}, null, null, "upper(sortKey) asc");
    }

    public void y0(long j17) {
        l75.k0 k0Var = this.f404872d;
        if (k0Var == null || j17 == -1) {
            return;
        }
    ...
    public java.util.ArrayList z0() {
        android.database.Cursor D = this.f404872d.D("IPCallAddressItem", f404871f, null, null, null, null, null, 2);
        try {
            if (D != null) {
                if (D.moveToFirst()) {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.IPCallAddressStorage", "getAllAddress, error: %s", e17.getMessage());
            return null;
        } finally {
            D.close();
        }
