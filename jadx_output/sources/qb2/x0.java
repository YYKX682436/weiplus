...
public final class x0 extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ qb2.r1 f361309d;
    ...
    public java.lang.Object invoke() {
        ...
        for (java.util.Map.Entry entry : r1Var.j().entrySet()) {
            int i17 = ((qb2.a1) entry.getValue()).f361160a;
            if (((qb2.a1) entry.getValue()).f361161b) {
        ...
        if (notificationManager != null && (activeNotifications = notificationManager.getActiveNotifications()) != null) {
            for (android.service.notification.StatusBarNotification statusBarNotification : activeNotifications) {
                if (statusBarNotification.getNotification().extras.getBoolean("Finder.GlobalPushNewXmlConsumer", false)) {
                    ...
                    com.tencent.mars.xlog.Log.w("Finder.GlobalPushNewXmlConsumer", "fallback cancel(" + statusBarNotification.getId() + ')');
                }
            }
        }
