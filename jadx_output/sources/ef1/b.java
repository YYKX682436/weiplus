...
public class b extends android.view.GestureDetector.SimpleOnGestureListener {
    ...
    public final /* synthetic */ ef1.e f252383d;
    ...
    public boolean onDoubleTap(android.view.MotionEvent motionEvent) {
        ...
        ef1.e eVar = this.f252383d;
        eVar.f252390b.removeCallbacks(eVar.f252399k);
        com.tencent.mm.plugin.appbrand.jsapi.video.AppBrandVideoView appBrandVideoView = ((oe1.s) eVar.f252393e).f344737a;
        java.util.Objects.toString(appBrandVideoView.C1);
        if (appBrandVideoView.W) {
    ...
    public void onLongPress(android.view.MotionEvent motionEvent) {
        ...
        java.lang.Object[] array = arrayList.toArray();
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/appbrand/jsapi/video/ui/VideoPlayerGestureController$2", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V", this, array);
        super.onLongPress(motionEvent);
        yj0.a.h(this, "com/tencent/mm/plugin/appbrand/jsapi/video/ui/VideoPlayerGestureController$2", "android/view/GestureDetector$SimpleOnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V");
    }
    ...
    */
    ...
    public boolean onSingleTapUp(android.view.MotionEvent motionEvent) {
        ...
        ef1.e eVar = this.f252383d;
        eVar.f252390b.postDelayed(eVar.f252399k, 200L);
