...
public class u0 implements vc1.s2 {
    ...
    public float f426354b;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f426357e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.appbrand.jsapi.t f426358f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ vc1.a3 f426359g;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicBoolean f426353a = new java.util.concurrent.atomic.AtomicBoolean(false);

    /* renamed from: c, reason: collision with root package name */
    public final org.json.JSONObject f426355c = new org.json.JSONObject();

    /* renamed from: d, reason: collision with root package name */
    public final uc1.h1 f426356d = new uc1.h1();

    public u0(uc1.i1 i1Var, int i17, com.tencent.mm.plugin.appbrand.jsapi.t tVar, vc1.a3 a3Var) {
        this.f426357e = i17;
        this.f426358f = tVar;
        this.f426359g = a3Var;
    }
    ...
    public void a(vc1.q1 q1Var, boolean z17) {
        vc1.a3 a3Var = this.f426359g;
        org.json.JSONObject jSONObject = this.f426355c;
        if (this.f426353a.compareAndSet(true, false)) {
            try {
                jSONObject.remove("mapId");
                jSONObject.put("mapId", this.f426357e);
                jSONObject.remove("type");
                jSONObject.put("type", "end");
                jSONObject.remove("causedBy");
                boolean z18 = q1Var.f435127a != this.f426354b;
                if (!z17) {
            ...
            uc1.h1 h1Var = this.f426356d;
            h1Var.f82374f = jSONObject2;
            this.f426358f.i(h1Var, null);
            jSONObject.toString();
        }
    }
    ...
    public void b(vc1.q1 q1Var, boolean z17) {
        org.json.JSONObject jSONObject = this.f426355c;
        if (this.f426353a.compareAndSet(false, true)) {
            try {
                jSONObject.remove("mapId");
                jSONObject.put("mapId", this.f426357e);
                jSONObject.remove("type");
