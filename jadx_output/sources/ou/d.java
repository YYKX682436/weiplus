...
public final class d extends ku.a {
    ...
    public boolean a(oi3.g simpleMsgInfo, s15.h recordDataItem) {
        ...
        recordDataItem.set(i17 + 2, 10133);
        ...
        v05.b k29 = cVar.k();
        f0Var.n((k29 == null || (hVar3 = (e15.h) k29.getCustom(k29.f432315e + 45)) == null) ? 0 : hVar3.getType());
        v05.b k37 = cVar.k();
        if (k37 == null || (hVar2 = (e15.h) k37.getCustom(k37.f432315e + 45)) == null || (str6 = hVar2.k()) == null) {
            str6 = "";
        }
        f0Var.l(str6);
        v05.b k38 = cVar.k();
        if (k38 != null && (hVar = (e15.h) k38.getCustom(k38.f432315e + 45)) != null && (j17 = hVar.j()) != null) {
            str7 = j17;
        }
        f0Var.k(str7);
