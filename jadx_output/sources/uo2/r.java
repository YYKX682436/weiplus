...
public final class r implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.music.FinderFollowTopicHeaderView f429639d;

    public r(com.tencent.mm.plugin.finder.music.FinderFollowTopicHeaderView finderFollowTopicHeaderView) {
        this.f429639d = finderFollowTopicHeaderView;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.finder.music.FinderFollowTopicHeaderView finderFollowTopicHeaderView = this.f429639d;
        com.tencent.mm.plugin.finder.music.FinderImgFeedMusicTag bgmPlayBtn = finderFollowTopicHeaderView.getBgmPlayBtn();
        if (bgmPlayBtn != null) {
            bgmPlayBtn.e();
        }
        ...
        if (weImageView2 != null) {
            weImageView2.setOnClickListener(finderFollowTopicHeaderView.P);
        }
        finderFollowTopicHeaderView.setCurrentListener(finderFollowTopicHeaderView.P);
