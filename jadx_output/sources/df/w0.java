...
public final class w0 implements df.d {
    ...
    public static java.lang.Integer f229571c;

    /* renamed from: d, reason: collision with root package name */
    public static io.flutter.embedding.engine.systemchannels.TextInputChannel.WxKeyboardType f229572d;

    /* renamed from: e, reason: collision with root package name */
    public static ef.d f229573e;

    /* renamed from: f, reason: collision with root package name */
    public static android.view.inputmethod.InputConnection f229574f;

    /* renamed from: g, reason: collision with root package name */
    public static java.lang.ref.WeakReference f229575g;

    /* renamed from: a, reason: collision with root package name */
    public static final df.w0 f229569a = new df.w0();

    /* renamed from: b, reason: collision with root package name */
    public static final boolean f229570b = df.h.f229476g;

    /* renamed from: h, reason: collision with root package name */
    public static io.flutter.embedding.engine.systemchannels.TextInputChannel.WxKeyboardType f229576h = io.flutter.embedding.engine.systemchannels.TextInputChannel.WxKeyboardType.TEXT;

    /* renamed from: i, reason: collision with root package name */
    public static final android.view.inputmethod.EditorInfo f229577i = new android.view.inputmethod.EditorInfo();

    /* renamed from: j, reason: collision with root package name */
    public static final java.util.ArrayList f229578j = new java.util.ArrayList();

    /* renamed from: k, reason: collision with root package name */
    public static final java.util.List f229579k = new java.util.ArrayList();

    @Override // df.d
    public void a(android.view.inputmethod.InputConnection inputConnection) {
        ef.e eVar;
        f229574f = inputConnection;
        ef.d dVar = f229573e;
        if (dVar != null) {
            ef.m mVar = (ef.m) dVar;
            com.tencent.mars.xlog.Log.i("WebViewExtendInputClient", "onCreateInputConnection");
            if (!mVar.f252129f || inputConnection == null) {
                return;
            }
            if ((com.tencent.mm.plugin.appbrand.widget.input.r1.f(mVar.f252135l) || kotlin.jvm.internal.o.b(mVar.f252135l, "safe-password")) && (eVar = mVar.f252126c) != null) {
    ...
    public void hideKeyboard() {
        ...
        java.lang.ref.WeakReference weakReference = f229575g;
        if (weakReference != null) {
            weakReference.clear();
        }
        f229575g = null;
        android.view.inputmethod.InputConnection inputConnection = f229574f;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:177:0x01a9, code lost:
        ...
        com.tencent.mars.xlog.Log.e("TextAreaInfo", "TextAreaInfo add dartWidgetId error");
     */
    /* JADX WARN: Code restructure failed: missing block: B:179:0x0193, code lost:
    
        com.tencent.mars.xlog.Log.e("TextAreaInfo", "TextAreaInfo add inputId error");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0039, code lost:
        ...
        if ((r27 != null ? r27.keyboardType : null) != r3) goto L21;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:202:0x0045, code lost:
        ...
        if ((r27 != null ? r27.keyboardType : null) != r3) goto L27;
     */
    ...
    */
    public void showKeyboard(android.view.View r26, io.flutter.embedding.engine.systemchannels.TextInputChannel.WxInputConfiguration r27) {
        /*
            Method dump skipped, instructions count: 791
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: df.w0.showKeyboard(android.view.View, io.flutter.embedding.engine.systemchannels.TextInputChannel$WxInputConfiguration):void");
    }
}
