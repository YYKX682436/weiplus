...
public abstract class b {
    ...
    public static com.tencent.mm.vfs.r6 b(java.lang.String str) {
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6(java.lang.String.format("%s%s/%d/", gm0.j1.u().d(), "chatroom_notice/", java.lang.Integer.valueOf(str.hashCode() & 255)));
        if (!r6Var.m() || !r6Var.y()) {
            r6Var.J();
        }
        return r6Var;
    ...
    public static java.lang.String c(r45.gp0 gp0Var) {
        ...
        if (!g(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.EditorLogic", "getDataPath: blocked unsafe dataId: %s", str);
            return "";
        }
        java.lang.String str2 = gp0Var.K;
        if (!g(str2)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.EditorLogic", "getDataPath: blocked unsafe data fmt: %s", str2);
            return "";
        }
        com.tencent.mm.vfs.r6 b17 = b(str);
        int i17 = gp0Var.I;
        if ((i17 == 8 || i17 == 10130) && !com.tencent.mm.sdk.platformtools.t8.K0(gp0Var.f375404d)) {
            str = gp0Var.f375404d;
            if (!g(str)) {
                com.tencent.mars.xlog.Log.e("MicroMsg.EditorLogic", "getDataPath: blocked unsafe title: %s", str);
                return "";
            }
            b17 = b(gp0Var.T);
            z17 = true;
        ...
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6(b17, str);
        java.lang.String o17 = r6Var.o();
        if (!f(o17, gm0.j1.u().d() + "chatroom_notice/")) {
            com.tencent.mars.xlog.Log.e("MicroMsg.EditorLogic", "getDataPath: blocked path traversal, dataId:%s absPath:%s", gp0Var.T, o17);
            return "";
        }
        ...
        com.tencent.mm.vfs.r6 r6Var2 = new com.tencent.mm.vfs.r6(b17, g17);
        if (r6Var2.m()) {
            return r6Var2.o();
        }
        ...
        return new com.tencent.mm.vfs.r6(b17, str5).o();
    }
    ...
    public static java.lang.String e(r45.gp0 gp0Var) {
        ...
        java.lang.String str = gp0Var.T;
        if (!g(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.EditorLogic", "getThumbPath: blocked unsafe dataId: %s", str);
            return "";
        }
        java.lang.String str2 = str + "_t";
        java.lang.String o17 = new com.tencent.mm.vfs.r6(b(str2), str2).o();
        if (f(o17, gm0.j1.u().d() + "chatroom_notice/")) {
            return o17;
        }
        com.tencent.mars.xlog.Log.e("MicroMsg.EditorLogic", "getThumbPath: blocked path traversal, dataId:%s absPath:%s", str, o17);
        return "";
    }
    ...
    public static boolean f(java.lang.String str, java.lang.String str2) {
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str) && !com.tencent.mm.sdk.platformtools.t8.K0(str2)) {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.EditorLogic", e17, "isPathInsideSandbox", new java.lang.Object[0]);
            }
        }
        return false;
    }
