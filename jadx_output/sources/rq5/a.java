...
public abstract class a {
    ...
    public static boolean b() {
        ...
        if ((i17 != 27 || (a17 = wo.w1.a("ro.mediatek.platform")) == null || (!a17.startsWith("mt6765") && !a17.startsWith("MT6765"))) && fp.f0.a()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.BigImageJudge", "alvinluo checkUseBigImageOpt is MTK platform");
            if (i17 == 24 || i17 == 25 || i17 == 27) {
                com.tencent.mars.xlog.Log.i("MicroMsg.BigImageJudge", "alvinluo checkUseBigImgOpt is MTK platform, android api: %d, cannot use BigImgOpt", java.lang.Integer.valueOf(i17));
                com.tencent.mars.xlog.Log.i("BigImageReporter", "alvinluo reportMTKPlatform apiLevel: %d", java.lang.Integer.valueOf(i17));
                if (i17 == 24) {
                    com.tencent.mm.plugin.report.service.g0.INSTANCE.C(896L, 0L, 1L);
                    return true;
                }
                if (i17 != 25) {
                    return true;
                }
                com.tencent.mm.plugin.report.service.g0.INSTANCE.C(896L, 1L, 1L);
                return true;
            }
        }
        return false;
    ...
    public static boolean c(java.lang.String str) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.BigImageJudge", "alvinluo checkUseBigImgOpt ignore abTestFlag, widthFactor: %f, heightFactor: %f, width: %d, height: %d", java.lang.Float.valueOf(1.0f), java.lang.Float.valueOf(1.0f), java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
    ...
    public static boolean d(java.lang.String str) {
        ...
        int i17 = a17.outWidth;
        int i18 = a17.outHeight;
        com.tencent.mars.xlog.Log.i("MicroMsg.BigImageJudge", "alvinluo checkUseBigImgOpt ignore abTestFlag, widthFactor: %f, heightFactor: %f, width: %d, height: %d", java.lang.Float.valueOf(2.0f), java.lang.Float.valueOf(2.5f), java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
        android.content.Context context = com.tencent.mm.sdk.platformtools.x2.f193071a;
        int i19 = context == null ? 0 : context.getResources().getDisplayMetrics().widthPixels;
        android.content.Context context2 = com.tencent.mm.sdk.platformtools.x2.f193071a;
