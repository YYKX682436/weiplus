...
public final class d extends ym3.a implements o75.a {
    ...
    public final java.util.ArrayList f418960d = new java.util.ArrayList();

    /* renamed from: e, reason: collision with root package name */
    public final jz5.g f418961e = jz5.h.b(tf5.c.f418958d);

    /* renamed from: f, reason: collision with root package name */
    public com.tencent.mm.plugin.mvvmlist.MvvmList f418962f;
    ...
    public kotlinx.coroutines.flow.j a(v65.i scope, ym3.c request) {
        ...
        java.util.ArrayList arrayList = this.f418960d;
        ...
        if (i17 < size) {
            ...
            for (com.tencent.mm.storage.z3 z3Var : g95.e.f269801a.f(arrayList2)) {
                if (((int) z3Var.E2) != 0) {
                    dVar.f463149c.add(new tf5.g(z3Var, 1, 32));
                }
            }
        }
        k0Var.e(dVar);
    ...
    public final void e(o75.c cVar) {
        ...
        if (z3Var != null) {
            ...
            if (kotlin.jvm.internal.o.b(bVar3, bVar2)) {
                if (!d(gVar) || (mvvmList2 = this.f418962f) == null) {
                    return;
                }
            ...
            if (!kotlin.jvm.internal.o.b(bVar3, o75.b.f343583d)) {
                if (!kotlin.jvm.internal.o.b(bVar3, o75.b.f343584e) || (mvvmList = this.f418962f) == null) {
                    return;
                }
                mvvmList.u(gVar);
                return;
            ...
            if (d(gVar)) {
                com.tencent.mm.plugin.mvvmlist.MvvmList mvvmList3 = this.f418962f;
                if (mvvmList3 != null) {
            ...
            com.tencent.mm.plugin.mvvmlist.MvvmList mvvmList4 = this.f418962f;
            if (mvvmList4 != null) {
                mvvmList4.u(gVar);
            }
        }
    ...
    public void onCreate() {
        ...
        g95.d dVar2 = g95.e.f269801a;
        p75.y yVar = (p75.y) c17;
        yVar.f(dVar2.g());
        p75.i0 g17 = dm.e2.N1.g(kz5.b0.c(dVar));
        g17.f352656c = "MicroMsg.Mvvm.AddressFavorDataSource";
        g17.f352657d = yVar;
        g17.f352659f = dVar2.h();
        java.util.Iterator it = g17.a().k(((jm0.l) ((jz5.n) this.f418961e).getValue()).Q4(), com.tencent.mm.storage.z3.class).iterator();
        while (it.hasNext()) {
            arrayList.add(((com.tencent.mm.storage.z3) it.next()).d1());
        }
    }
}
