...
public final class o extends androidx.recyclerview.widget.k3 implements lo0.h, lo0.g {

    /* renamed from: d, reason: collision with root package name */
    public final yz5.l f455233d;

    /* renamed from: e, reason: collision with root package name */
    public final yz5.l f455234e;

    /* renamed from: f, reason: collision with root package name */
    public final android.view.View f455235f;

    /* renamed from: g, reason: collision with root package name */
    public final android.view.View f455236g;

    /* renamed from: h, reason: collision with root package name */
    public final android.widget.TextView f455237h;

    /* renamed from: i, reason: collision with root package name */
    public final android.view.View f455238i;

    /* renamed from: m, reason: collision with root package name */
    public final android.view.View f455239m;

    /* renamed from: n, reason: collision with root package name */
    public final android.view.View f455240n;

    /* renamed from: o, reason: collision with root package name */
    public final android.view.View f455241o;

    /* renamed from: p, reason: collision with root package name */
    public java.lang.Integer f455242p;

    /* renamed from: q, reason: collision with root package name */
    public zm2.c f455243q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(android.content.Context context, yz5.l itemSelectionHandler, yz5.l itemFineTuningHandler) {
        super(android.view.LayoutInflater.from(context).inflate(com.tencent.mm.R.layout.e8y, (android.view.ViewGroup) null));
        ...
        this.f455233d = itemSelectionHandler;
        this.f455234e = itemFineTuningHandler;
        ...
        this.f455236g = findViewById2;
        android.view.View findViewById3 = this.itemView.findViewById(com.tencent.mm.R.id.hrz);
        kotlin.jvm.internal.o.f(findViewById3, "findViewById(...)");
        this.f455237h = (android.widget.TextView) findViewById3;
        android.view.View findViewById4 = this.itemView.findViewById(com.tencent.mm.R.id.twe);
        ...
        this.f455238i = findViewById4;
        android.view.View findViewById5 = this.itemView.findViewById(com.tencent.mm.R.id.uzf);
        ...
        this.f455239m = findViewById5;
        android.view.View findViewById6 = this.itemView.findViewById(com.tencent.mm.R.id.sgs);
        kotlin.jvm.internal.o.f(findViewById6, "findViewById(...)");
        this.f455240n = findViewById6;
        android.view.View findViewById7 = this.itemView.findViewById(com.tencent.mm.R.id.twd);
        kotlin.jvm.internal.o.f(findViewById7, "findViewById(...)");
        this.f455241o = findViewById7;
    }
    ...
    public void c(lo0.b badge) {
        ...
        badge.c(this);
        android.view.View view = this.f455240n;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(8);
        java.util.Collections.reverse(arrayList);
    ...
    public final void i(boolean z17) {
        int i17;
        lo0.f fVar;
        android.view.View view = this.f455235f;
        int i18 = 4;
        int i19 = z17 ? 0 : 4;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        ...
        android.view.View view2 = this.f455238i;
        if (z17) {
            zm2.c cVar = this.f455243q;
            if (cVar != null && cVar.f474169e) {
                i18 = 0;
            }
        }
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        ...
        android.view.View view3 = this.f455241o;
        if (z17) {
            zm2.c cVar2 = this.f455243q;
            if ((cVar2 == null || (fVar = cVar2.f474170f) == null || !fVar.a()) ? false : true) {
                i17 = 0;
                java.util.ArrayList arrayList3 = new java.util.ArrayList();
                ...
                android.view.View view4 = this.f455239m;
                int visibility = this.f455238i.getVisibility();
        ...
        yj0.a.f(view3, "com/tencent/mm/plugin/finder/live/widget/beauty/controlpanels/FinderLiveBeautyPresetControlPanelWidget$ItemViewHolder", "setSelected", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
        android.view.View view42 = this.f455239m;
        int visibility2 = this.f455238i.getVisibility();
