...
public abstract class f {
    ...
    public static final uk.o f428494a = new uk.o(84298576);

    /* renamed from: b, reason: collision with root package name */
    public static final uk.o f428495b = new uk.o(50613072);

    /* renamed from: c, reason: collision with root package name */
    public static int f428496c = 0;

    /* renamed from: d, reason: collision with root package name */
    public static final uk.o f428497d = new uk.o(101010256);
    ...
    public static java.lang.String b(java.io.File file) {
        ...
        try {
            ...
            try {
                ...
                eVar.a(c17);
                java.lang.String property = eVar.f428492a.getProperty("apkSecurityCode");
                randomAccessFile2.close();
                java.lang.System.err.println("exit getSecurityCode");
                return property;
    ...
    public static void d(java.io.File file, java.lang.String str) {
        ...
        try {
            ...
            uk.e eVar = new uk.e(null);
            eVar.a(a17);
            eVar.f428492a.setProperty("apkSecurityCode", str);
            byte[] b17 = eVar.b();
            randomAccessFile.seek(f428496c);
            int length = b17.length;
            randomAccessFile.write(new byte[]{(byte) (length & 255), (byte) ((length & 65280) >> 8)});
            randomAccessFile.write(b17);
            randomAccessFile.setLength(f428496c + b17.length + 2);
