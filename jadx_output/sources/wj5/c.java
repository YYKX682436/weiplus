...
public abstract class c extends in5.r implements android.view.View.OnCreateContextMenuListener {
    ...
    public void i(androidx.recyclerview.widget.RecyclerView recyclerView, in5.s0 holder, int i17) {
        ...
        android.view.View view = new android.view.View(holder.itemView.getContext());
    ...
    public final void n(android.view.View longClickView, int i17, com.tencent.mm.ui.tipsbar.d tipsBarContext, db5.t4 t4Var) {
        kotlin.jvm.internal.o.g(longClickView, "longClickView");
    ...
    public void o(in5.s0 holder, xj5.a item, int i17, int i18, boolean z17, java.util.List list) {
        ...
        aVar.pk(holder.itemView, "group_msg_set_top_bar");
        aVar.ik(holder.itemView, 40, 26356);
        aVar.gk(holder.itemView, item.b());
    ...
    public void onCreateContextMenu(android.view.ContextMenu contextMenu, android.view.View view, android.view.ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        if (contextMenu != null) {
            contextMenu.add(0, 0, 0, (view == null || (context = view.getContext()) == null) ? null : context.getString(com.tencent.mm.R.string.f490356so));
        }
    }
}
