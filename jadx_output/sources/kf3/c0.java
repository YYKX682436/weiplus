...
public class c0 implements android.view.View.OnClickListener {
    ...
    public final java.lang.String f307325d;

    /* renamed from: e, reason: collision with root package name */
    public final int f307326e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ kf3.k0 f307327f;
    ...
    public void onClick(android.view.View view) {
        ...
        kf3.k0 k0Var = this.f307327f;
        if (!E) {
            db5.t7.k(k0Var.f307381t, null);
        ...
        java.lang.String str = if3.f0.a() + this.f307325d;
        if (str == null || str.equals("") || !com.tencent.mm.vfs.w6.j(str)) {
            yj0.a.h(this, "com/tencent/mm/plugin/masssend/ui/MassSendHistoryAdapter$OnImageClickListener", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
            return;
        }
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("key_compress_type", this.f307326e);
        intent.putExtra("key_favorite", false);
        intent.putExtra("key_image_path", str);
        ((bt.d) ((ct.u2) i95.n0.c(ct.u2.class))).f24068d.B(k0Var.f307381t, intent);
        yj0.a.h(this, "com/tencent/mm/plugin/masssend/ui/MassSendHistoryAdapter$OnImageClickListener", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
