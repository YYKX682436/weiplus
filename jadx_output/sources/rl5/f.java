...
public class f implements android.view.View.OnLongClickListener {
    ...
    public final /* synthetic */ android.view.View.OnCreateContextMenuListener f397313d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ rl5.r f397314e;

    public f(rl5.r rVar, android.view.View.OnCreateContextMenuListener onCreateContextMenuListener) {
        this.f397314e = rVar;
        this.f397313d = onCreateContextMenuListener;
    }
    ...
    public boolean onLongClick(android.view.View view) {
        ...
        rl5.r rVar = this.f397314e;
        rVar.f397356z.clear();
        rVar.f397338f = view;
        this.f397313d.onCreateContextMenu(rVar.f397356z, view, null);
        ...
        view.setTag(com.tencent.mm.R.id.qgm, java.lang.Boolean.TRUE);
