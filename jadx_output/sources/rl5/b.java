...
public class b implements android.widget.AdapterView.OnItemLongClickListener {
    ...
    public final /* synthetic */ android.view.View.OnCreateContextMenuListener f397306d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ rl5.r f397307e;

    public b(rl5.r rVar, android.view.View.OnCreateContextMenuListener onCreateContextMenuListener) {
        this.f397307e = rVar;
        this.f397306d = onCreateContextMenuListener;
    }

    @Override // android.widget.AdapterView.OnItemLongClickListener
    public boolean onItemLongClick(android.widget.AdapterView adapterView, android.view.View view, int i17, long j17) {
        rl5.r rVar = this.f397307e;
        rVar.f397356z.clear();
        ...
        this.f397306d.onCreateContextMenu(rVar.f397356z, view, adapterContextMenuInfo);
