...
public class d implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ rl5.r f397310d;
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if ((motionEvent.getAction() & 255) == 0) {
            rl5.r.f397333x0 = (int) motionEvent.getRawX();
            rl5.r.f397334y0 = (int) motionEvent.getRawY();
            rl5.r rVar = this.f397310d;
            rVar.A = rVar.f397338f;
            rl5.r.f397332l1 = true;
            com.tencent.mm.ui.yk.c("MicroMsg.MMPopupMenu", "popmenu view set , x_down=" + rl5.r.f397333x0 + "y_down=" + rl5.r.f397334y0, new java.lang.Object[0]);
        }
