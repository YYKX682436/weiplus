...
public abstract class f {
    public static void a(java.util.Map map) {
        ...
        d(map, new sz1.c(obj));
        com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[compressMaxLengthParams] maxLengthParam : " + obj);
    }
    ...
    public static java.lang.Object c(java.lang.Object obj) {
        ...
        if (obj instanceof java.util.List) {
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] object : " + obj + ", throw Exception : " + e17.getMessage());
            }
            ...
            try {
                ...
                for (java.lang.Object obj2 : map.keySet()) {
                    ...
                    if (obj3 != null && (obj2 instanceof java.lang.String) && (!(obj3 instanceof java.lang.String) || !u46.l.e((java.lang.String) obj3))) {
                        ...
                        if (!u46.l.c(lowerCase, str)) {
                            if (sz1.a.j()) {
                                com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] key contain upperCase, key : " + obj2);
                            } else {
                ...
                com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] object : " + obj + ", throw Exception : " + e18.getMessage());
            }
        } else {
            if (!(obj instanceof java.util.Set)) {
                if (!(obj instanceof java.lang.String) && !(obj instanceof java.lang.StringBuilder) && !(obj instanceof java.lang.StringBuffer)) {
                    ...
                    com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] type is error, object : " + obj + ", type : " + obj.getClass());
                    return obj.toString();
                }
                ...
                try {
                    if (obj4.contains(",")) {
                        if (obj4.contains("|")) {
                            com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] str contain '|' , str : ".concat(obj4));
                        }
                        return obj4.replace(",", "|");
                    }
                } catch (java.lang.Exception e19) {
                    com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] object : " + obj + ", throw Exception : " + e19.getMessage());
                }
                return obj4;
            }
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.e("Amoeba.ParamsUtils", "[genJSONObject] object : " + obj + ", throw Exception : " + e27.getMessage());
            }
        }
        return null;
    }
