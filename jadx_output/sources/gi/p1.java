...
public final class p1 {
    ...
    public static final java.util.HashMap f272082b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.HashMap f272083c = new java.util.HashMap();

    /* renamed from: a, reason: collision with root package name */
    public gi.n1[] f272084a;

    public double a(java.lang.String str) {
        java.util.HashMap hashMap = f272082b;
        if (hashMap.containsKey(str)) {
            return ((java.lang.Double) hashMap.get(str)).doubleValue();
        }
        java.util.HashMap hashMap2 = f272083c;
    ...
    public double c(java.lang.String str) {
        int length;
        if (f272082b.containsKey(str)) {
            length = 1;
        } else {
            java.util.HashMap hashMap = f272083c;
    ...
    public void d() {
        ...
        if (!hashMap.containsKey("cpu.clusters.cores")) {
            this.f272084a = new gi.n1[1];
            java.util.HashMap hashMap2 = f272082b;
            this.f272084a[0] = new gi.n1("cpu.core_speeds.cluster0", "cpu.cluster_power.cluster0", "cpu.core_power.cluster0", hashMap2.containsKey("cpu.clusters.cores") ? (int) java.lang.Math.round(((java.lang.Double) hashMap2.get("cpu.clusters.cores")).doubleValue()) : 1, null);
            return;
        }
        java.lang.Double[] dArr = (java.lang.Double[]) hashMap.get("cpu.clusters.cores");
        this.f272084a = new gi.n1[dArr.length];
        for (int i17 = 0; i17 < dArr.length; i17++) {
            int round = (int) java.lang.Math.round(dArr[i17].doubleValue());
            this.f272084a[i17] = new gi.n1("cpu.core_speeds.cluster" + i17, "cpu.cluster_power.cluster" + i17, "cpu.core_power.cluster" + i17, round, null);
        }
    }
    ...
    public final void g(android.content.Context context, org.xmlpull.v1.XmlPullParser xmlPullParser) {
        ...
        try {
            gi.o1.a(xmlPullParser, com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.Common.COMMON_DEVICE_NAME);
            boolean z17 = false;
