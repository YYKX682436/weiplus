...
public final class r {
    ...
    public static final fj2.r f263182a = new fj2.r();
    ...
    public final java.util.LinkedList a(android.graphics.Point windowSize, java.util.LinkedList tempList, java.util.LinkedHashMap rectMap) {
        ...
        kotlin.jvm.internal.o.g(rectMap, "rectMap");
        ...
        while (it.hasNext()) {
            ...
            xh2.a aVar2 = new xh2.a(aVar.f454520a, aVar.f454521b.a());
            xh2.i iVar = aVar2.f454521b;
            if (!(iVar.f282611c == 1.0f)) {
                if (!(iVar.f282612d == 1.0f)) {
                    float f17 = i17;
                    iVar.f282609a = (((android.graphics.Rect) rectMap.get(aVar2.b())) != null ? r4.left : 0.0f) / f17;
                    float f18 = i18;
                    aVar2.f454521b.f282610b = (((android.graphics.Rect) rectMap.get(aVar2.b())) != null ? r4.top : 0.0f) / f18;
                    aVar2.f454521b.f282611c = (((android.graphics.Rect) rectMap.get(aVar2.b())) != null ? r4.width() : 0.0f) / f17;
                    aVar2.f454521b.f282612d = (((android.graphics.Rect) rectMap.get(aVar2.b())) != null ? r4.height() : 0.0f) / f18;
                }
            }
            arrayList.add(aVar2);
        }
    ...
    public final boolean b(java.lang.String curAnchorUid, org.json.JSONObject jSONObject, xh2.d dVar) {
        ...
        java.lang.Float f59;
        java.lang.Float f66;
        kotlin.jvm.internal.o.g(curAnchorUid, "curAnchorUid");
        ...
        if (!(curAnchorUid.length() == 0)) {
            java.util.LinkedList linkedList = dVar.f454540a;
            int size = linkedList.size();
            int i37 = dVar.f454541b;
            if (size != 1 || !kotlin.jvm.internal.o.b(((xh2.a) linkedList.get(0)).b(), curAnchorUid) || length != 0 || optInt != i37) {
                ...
                while (true) {
                    ...
                    obj = it.next();
                    str4 = str14;
                    if (kotlin.jvm.internal.o.b(((xh2.a) obj).b(), curAnchorUid)) {
                        break;
                    }
                    str14 = str4;
                }
                ...
                for (java.lang.Object obj3 : linkedList) {
                    ...
                    int i38 = length2;
                    if (!kotlin.jvm.internal.o.b(((xh2.a) obj3).b(), curAnchorUid)) {
                        arrayList2.add(obj3);
                    }
                ...
                float f67 = (aVar == null || (iVar14 = aVar.f454521b) == null) ? 0.0f : iVar14.f282609a;
                float f68 = (aVar == null || (iVar13 = aVar.f454521b) == null) ? 0.0f : iVar13.f282610b;
                float f69 = f18;
                float f76 = (aVar == null || (iVar12 = aVar.f454521b) == null) ? 0.0f : iVar12.f282611c;
                float f77 = f17;
                float f78 = (aVar == null || (iVar11 = aVar.f454521b) == null) ? 0.0f : iVar11.f282612d;
                int i47 = (aVar == null || (iVar10 = aVar.f454521b) == null) ? 0 : iVar10.f454555g;
                int i48 = (aVar == null || (iVar9 = aVar.f454521b) == null) ? 0 : iVar9.f454553e;
                float f79 = floatValue3;
                if (!android.text.TextUtils.equals(curAnchorUid, b17)) {
                    com.tencent.mars.xlog.Log.i("FinderLiveMicRatioUtil", "diffLastMicCoverDataList diff curAnchorUid: " + curAnchorUid + " lastAnchorUid: " + b17);
                    return true;
                }
                java.lang.String str15 = b17;
                java.lang.String str16 = " lastMode: ";
                java.lang.String str17 = " curMode: ";
                float f86 = dVar.f454542c;
                            ...
                            if (f79 == f76) {
                                if (f77 == f78) {
                                    if (!(f69 == f86)) {
                                        ...
                                        str6 = " lastFocus: ";
                                        str7 = " curFocus: ";
                                        com.tencent.mars.xlog.Log.i(str8, "diffLastMicCoverDataList diff curAnchorPos : " + optInt3 + " lastAnchorPos: " + i48 + str5 + i17 + " lastMode: " + i18 + str7 + optInt2 + str6 + i47 + "curAnchorUid: " + curAnchorUid + " lastAnchorUid: " + str15 + "  curAnchorX: " + floatValue + " lastAnchorX: " + f67 + " curAnchorY: " + floatValue2 + " lastAnchorY: " + f68 + " curAnchorW: " + f79 + " lastAnchorW: " + f27 + " curAnchorH: " + f77 + " lastAnchorH: " + f78 + " curVideoRate: " + f69 + " lastVideoRate: " + f19);
                                        return true;
                                    }
                                    if (i39 != size2) {
                                        com.tencent.mars.xlog.Log.i("FinderLiveMicRatioUtil", "diffLastMicCoverDataList diff curTotalSize: " + i39 + " lastDataListSize: " + size2);
                                        return true;
                                    }
                                    java.util.ArrayList arrayList3 = new java.util.ArrayList();
                                    for (java.lang.Object obj4 : linkedList3) {
                                        xh2.a aVar2 = (xh2.a) obj4;
                                        if ((kotlin.jvm.internal.o.b(aVar2.b(), curAnchorUid) || aVar2.f454521b.f454556h) ? false : true) {
                                            arrayList3.add(obj4);
                                        }
                                    }
                                    if (jSONArray == null) {
                                    ...
                                    if (jSONArray.length() != arrayList3.size()) {
                                        com.tencent.mars.xlog.Log.i("FinderLiveMicRatioUtil", "diffLastMicCoverDataList curList size: " + jSONArray.length() + " lastList size: " + arrayList3.size());
                                        return true;
                                    }
                                    ...
                                    while (i49 < length3) {
                                        ...
                                        java.lang.String optString10 = optJSONObject != null ? optJSONObject.optString(com.tencent.tmassistantsdk.downloadservice.DownloadInfo.UID) : null;
                                        ...
                                        while (true) {
                                            ...
                                            obj2 = it6.next();
                                            arrayList = arrayList3;
                                            if (kotlin.jvm.internal.o.b(((xh2.a) obj2).b(), optString10)) {
                                                break;
                                            }
                                        ...
                                        int i58 = i28;
                                        float f87 = (aVar3 == null || (iVar8 = aVar3.f454521b) == null) ? 0.0f : iVar8.f282609a;
                                        java.lang.String str23 = str17;
                                        float f88 = (aVar3 == null || (iVar7 = aVar3.f454521b) == null) ? 0.0f : iVar7.f282610b;
                                        int i59 = i49;
                                        float f89 = (aVar3 == null || (iVar6 = aVar3.f454521b) == null) ? 0.0f : iVar6.f282611c;
                                        long j19 = j17;
                                        float f96 = (aVar3 == null || (iVar5 = aVar3.f454521b) == null) ? 0.0f : iVar5.f282612d;
                                        java.lang.Integer valueOf = (aVar3 == null || (iVar4 = aVar3.f454521b) == null) ? null : java.lang.Integer.valueOf(iVar4.f454555g);
                                        int i66 = optInt4;
                                        int i67 = (aVar3 == null || (iVar3 = aVar3.f454521b) == null) ? 0 : iVar3.f454557i;
                                        int i68 = (aVar3 == null || (iVar2 = aVar3.f454521b) == null) ? 0 : iVar2.f454553e;
                                        if (aVar3 == null || (iVar = aVar3.f454521b) == null) {
                                            f37 = f28;
                                            j18 = 0;
                                        } else {
                                            f37 = f28;
                                        ...
                                        if (!android.text.TextUtils.equals(optString10, b18)) {
                                            com.tencent.mars.xlog.Log.i(str11, "diffLastMicCoverDataList diff curUid: " + optString10 + " lastUid: " + b18);
                                            return true;
                                        }
        ...
        com.tencent.mars.xlog.Log.i("FinderLiveMicRatioUtil", "diffLastMicCoverDataList data is same return false curSize: " + length);
        return false;
    }
    ...
    public final java.util.LinkedHashMap c(gk2.e buContext, android.graphics.Point windowSize, java.util.LinkedList linkedList, float f17, fj2.l renderMode) {
        ...
        java.lang.String str = ((mm2.e1) buContext.a(mm2.e1.class)).f328987q.f380301n;
        if (str == null) {
            str = "";
        }
    ...
    public final java.util.LinkedHashMap d(java.lang.String anchorUid, android.graphics.Point windowSize, java.util.LinkedList linkedList, float f17, fj2.l renderMode) {
        ...
        java.lang.String str7;
        java.lang.String str8;
        kotlin.jvm.internal.o.g(anchorUid, "anchorUid");
        kotlin.jvm.internal.o.g(windowSize, "windowSize");
        kotlin.jvm.internal.o.g(renderMode, "renderMode");
        ...
        if (ordinal == 1 || ordinal == 2) {
            ...
            boolean z17 = renderMode == fj2.l.f263180f;
            linkedHashMap = new java.util.LinkedHashMap();
            int i17 = windowSize.x;
            int i18 = windowSize.y;
            float f18 = i17;
            int i19 = (int) (f18 / f17);
            int h17 = z17 ? com.tencent.mm.ui.bl.h(com.tencent.mm.sdk.platformtools.x2.f193071a) : (i18 - i19) / 2;
            if ((linkedList != null ? linkedList.size() : 0) > 0) {
                if (linkedList != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        float f19 = iVar.f282609a;
                        java.util.Iterator it6 = it;
                        float f27 = iVar.f282610b;
                        java.lang.String str15 = str14;
                        float f28 = i19;
                        linkedHashMap.put(aVar.b(), new android.graphics.Rect((int) (f19 * f18), ((int) (f27 * f28)) + h17, (int) ((f19 + iVar.f282611c) * f18), ((int) ((f27 + iVar.f282612d) * f28)) + h17));
                        it = it6;
                        str11 = str11;
                        str13 = str13;
                        str14 = str15;
            ...
            com.tencent.mars.xlog.Log.i(str4, "genMicFocusRectMapForScreenShare windowWidth:" + i17 + " windowHeight:" + i18 + str3 + i19 + str + h17 + str2 + f17);
            ...
            if ((linkedList != null ? linkedList.size() : 0) > 0) {
                if (linkedList != null) {
                    ...
                    while (it7.hasNext()) {
                        ...
                        xh2.i iVar2 = aVar2.f454521b;
                        float f38 = iVar2.f282609a;
                        float f39 = iVar2.f282610b;
                        linkedHashMap.put(aVar2.b(), new android.graphics.Rect(((int) (f38 * f37)) - i29, (int) (f39 * f29), ((int) ((f38 + iVar2.f282611c) * f37)) - i29, (int) ((f39 + iVar2.f282612d) * f29)));
                        it7 = it7;
                        str11 = str11;
                    }
                }
            ...
            com.tencent.mars.xlog.Log.i(str8, "genMicFocusRectMapFixedByHeight windowWidth:" + i27 + " windowHeight:" + i28 + " realVideoWidth:" + f37 + " leftOffestMargin: " + i29 + " videoRate:" + f17);
        } else {
            ...
            if ((linkedList != null ? linkedList.size() : 0) > 0) {
                if (linkedList != null) {
                    ...
                    while (it8.hasNext()) {
                        ...
                        xh2.i iVar3 = aVar3.f454521b;
                        float f49 = iVar3.f282609a;
                        java.util.Iterator it9 = it8;
                        float f57 = iVar3.f282610b;
                        linkedHashMap.put(aVar3.b(), new android.graphics.Rect((int) (f49 * f47), ((int) (f57 * f48)) - i39, (int) ((f49 + iVar3.f282611c) * f47), ((int) ((f57 + iVar3.f282612d) * f48)) - i39));
                        it8 = it9;
                        str16 = str16;
                        str12 = str12;
                        str9 = str9;
            ...
            com.tencent.mars.xlog.Log.i(str5, "genMicFocusRectMapFixedByWidth windowWidth:" + i37 + " windowHeight:" + i38 + " realVideoHeight:" + f48 + str6 + i39 + str7 + f17);
        }
    ...
    public final java.util.LinkedList e(org.json.JSONObject jSONObject, km2.q qVar, yz5.l userFilterBlock) {
        ...
        java.lang.Float f49;
        kotlin.jvm.internal.o.g(userFilterBlock, "userFilterBlock");
        ...
        if ((optJSONArray != null ? optJSONArray.length() : 0) > 0) {
            ...
            while (i17 < length) {
                ...
                java.lang.String optString13 = optJSONObject != null ? optJSONObject.optString(com.tencent.tmassistantsdk.downloadservice.DownloadInfo.UID) : null;
                ...
                km2.q qVar2 = (km2.q) userFilterBlock.invoke(optString13);
                if (qVar2 != null) {
                    qVar2.f309191v = optInt;
                    linkedList2.add(new xh2.a(qVar2, new xh2.i(floatValue, floatValue2, floatValue3, floatValue4, optInt2, 0, 0, false, optInt, 0, optLong, com.hilive.mediasdk.SdkInfo.ErrCode.kErrCodeNotFound, null)));
                }
                i17++;
                str2 = str3;
            }
        ...
        if ((optJSONArray2 != null ? optJSONArray2.length() : 0) > 0) {
            ...
            sb6.append(' ');
            com.tencent.mars.xlog.Log.i("FinderLiveMicRatioUtil", sb6.toString());
    ...
    public final java.util.LinkedList g(org.json.JSONObject jSONObject, km2.q qVar, yz5.l userFilterBlock) {
        ...
        if ((optJSONArray != null ? optJSONArray.length() : 0) > 0) {
            ...
            while (i19 < i17) {
                ...
                java.lang.String optString9 = jSONObject2 != null ? jSONObject2.optString(com.tencent.tmassistantsdk.downloadservice.DownloadInfo.UID) : null;
                org.json.JSONArray jSONArray = optJSONArray;
                int optInt7 = jSONObject2 != null ? jSONObject2.optInt("us") : 0;
                if (optString9 == null) {
                    optString9 = "";
                }
                km2.q qVar2 = (km2.q) userFilterBlock.invoke(optString9);
                if (qVar2 != null) {
                    qVar2.f309191v = optInt7;
            ...
            com.tencent.mars.xlog.Log.i("FinderLiveMicRatioUtil", "genMicDataList add anchorLinkMicUser default ");
    ...
    public final java.util.LinkedList h(org.json.JSONObject jSONObject, km2.q qVar, yz5.l userFilterBlock) {
        ...
        if ((optJSONArray != null ? optJSONArray.length() : 0) > 0) {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                org.json.JSONObject optJSONObject = optJSONArray != null ? optJSONArray.optJSONObject(i17) : null;
                java.lang.String optString = optJSONObject != null ? optJSONObject.optString(com.tencent.tmassistantsdk.downloadservice.DownloadInfo.UID) : null;
                int optInt = optJSONObject != null ? optJSONObject.optInt("us") : 0;
                int optInt2 = optJSONObject != null ? optJSONObject.optInt("i") : 0;
                if (optString == null) {
                    optString = "";
                }
                jz5.l lVar = (jz5.l) userFilterBlock.invoke(optString);
                km2.q qVar2 = (km2.q) lVar.f302833d;
                if (qVar2 != null) {
                    qVar2.f309191v = optInt;
                    if (((java.lang.Boolean) lVar.f302834e).booleanValue()) {
                        qVar2.f309183n = pm0.v.z(optInt, 1);
                    }
    ...
    public final java.util.LinkedList j(java.util.LinkedList dataList) {
        ...
        for (java.lang.Object obj : dataList) {
            if (true ^ ((xh2.a) obj).f454521b.f454556h) {
                arrayList.add(obj);
            }
        }
        ...
        while (it.hasNext()) {
            arrayList2.add(java.lang.Integer.valueOf(((xh2.a) it.next()).f454521b.f454553e));
        }
    ...
    public final android.graphics.RectF[] l(int i17, int i18, int i19, int i27, java.util.LinkedList dataList) {
        ...
        for (java.lang.Object obj : dataList) {
            xh2.a aVar = (xh2.a) obj;
            if ((aVar.f454520a == null || aVar.f454521b.f454556h) ? false : true) {
                arrayList.add(obj);
            }
        }
        ...
        for (java.lang.Object obj2 : arrayList) {
            ...
            xh2.i iVar = ((xh2.a) obj2).f454521b;
            float f17 = iVar.f282609a;
            float f18 = iVar.f282610b;
            rectFArr[i28] = new android.graphics.RectF(f17, f18, iVar.f282611c + f17, iVar.f282612d + f18);
            i28 = i37;
        }
        return rectFArr;
    }
    ...
    public final float m(float f17, android.graphics.Point curWindowSize, int i17) {
        ...
        java.lang.Float valueOf = java.lang.Float.valueOf((i65.a.b(com.tencent.mm.sdk.platformtools.x2.f193071a, 172) * f17) - ((curWindowSize.y - (i65.a.b(com.tencent.mm.sdk.platformtools.x2.f193071a, i17 == 5 ? 359 : 299) * f17)) / 2));
