...
public class r extends nv5.a {
    ...
    public int a(java.io.InputStream inputStream, java.io.InputStream inputStream2, java.io.File file, boolean z17) {
        ...
        int patch = com.tencent.mm.patchligthdiff.hdiff.HPatch.patch(file2.getAbsolutePath(), file3.getAbsolutePath(), file.getAbsolutePath(), 262144L);
        if (z17) {
            try {
                file.setReadOnly();
        ...
        java.lang.String format = java.lang.String.format("%s:  res:%s, oldSize:%s, diffSize:%s, newSize:%s", file.getName(), java.lang.Integer.valueOf(patch), java.lang.Long.valueOf(file2.length()), java.lang.Long.valueOf(file3.length()), java.lang.Long.valueOf(file.length()));
