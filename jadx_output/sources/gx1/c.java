...
public class c implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ gx1.d f277294d;
    ...
    public void onClick(android.view.View view) {
        ...
        gx1.d dVar = this.f277294d;
        android.content.Intent intent = new android.content.Intent(dVar.f277304f.getContext(), (java.lang.Class<?>) com.tencent.mm.plugin.component.editor.EditorImageUI.class);
        java.lang.String str = dVar.f277303e.f295311a;
        if (str != null) {
            intent.putExtra("key_detail_data_id", str);
        }
        android.content.Context context = dVar.f277304f.getContext();
