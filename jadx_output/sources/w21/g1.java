...
public class g1 extends l75.s0 {
    ...
    public g1(l75.k0 k0Var) {
        ...
        if (B == null) {
            ...
            qt0.b.f366491a.b(new qt0.e(k0Var, f442372i, "voiceinfo", "voiceinfo", 1));
        }
        this.f442373d = k0Var;
    }
    ...
    public boolean L0(w21.w0 w0Var) {
        ...
        if (android.text.TextUtils.isEmpty(w0Var.f442507x)) {
            w0Var.f442507x = "";
            w0Var.f442484a |= 4194304;
        }
        pt0.p.G6(w0Var.f442496m, w0Var.f442507x);
        android.content.ContentValues b17 = w0Var.b();
        if (b17.size() <= 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VoiceStorage", "insert falied, no values set");
        } else if (this.f442373d.l("voiceinfo", "FileName", b17) != -1) {
            doNotify();
            return true;
        }
        return false;
    ...
    public boolean P0(java.lang.String str, w21.w0 w0Var) {
        ...
        android.content.ContentValues b17 = w0Var.b();
        if (b17.size() <= 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VoiceStorage", "update failed, no values set");
        } else {
            if (this.f442373d.p("voiceinfo", b17, "FileName= ?", new java.lang.String[]{str}) > 0) {
                doNotify();
                return true;
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.VoiceStorage", "update failed, fileName:%s", str);
        }
        return false;
    }
    ...
    public boolean d(java.lang.String str) {
        iz5.a.g(null, str.length() > 0);
        if (this.f442373d.delete("voiceinfo", "FileName= ?", new java.lang.String[]{str}) <= 0) {
            com.tencent.mars.xlog.Log.w("MicroMsg.VoiceStorage", "delete failed, no such file:".concat(str));
        }
        return true;
    }
    ...
    public void m0(bm5.y yVar, java.lang.String str) {
        ...
        java.util.Map map = this.f442374e;
        if (b17 == 0) {
        ...
        if (b17 == 1) {
            java.util.Map map2 = this.f442375f;
        ...
        java.util.Map map3 = this.f442376g;
