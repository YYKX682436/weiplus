...
public abstract class i {
    ...
    public static double g(wh.n1 n1Var, rh.f1 f1Var, long j17, boolean z17) {
        java.util.Iterator it = f1Var.f395386e.iterator();
        boolean z18 = false;
        while (it.hasNext()) {
            ...
            while (true) {
                ...
                if (((java.lang.Long) ((rh.x2) it6.next()).f395552a).longValue() > 0) {
                    z18 = true;
                    break;
                }
            }
    ...
    public static double h(wh.n1 n1Var, rh.f1 f1Var, long j17) {
        ...
        if (j17 > 0) {
            long j19 = 0;
            for (int i17 = 0; i17 < f1Var.f395385d.size(); i17++) {
                java.util.Iterator it = ((rh.y2) f1Var.f395385d.get(i17)).f395560a.iterator();
                while (it.hasNext()) {
                    j19 += ((java.lang.Long) ((rh.x2) it.next()).f395552a).longValue();
                }
            }
            int i18 = 0;
            while (i18 < f1Var.f395385d.size()) {
                java.util.List list = ((rh.y2) f1Var.f395385d.get(i18)).f395560a;
                long j27 = j18;
                for (int i19 = 0; i19 < list.size(); i19++) {
                    j27 += ((java.lang.Long) ((rh.x2) list.get(i19)).f395552a).longValue();
                }
                long j28 = ((((float) j27) * 1.0f) / ((float) j19)) * ((float) j17);
                int f17 = n1Var.f(i18);
                if (f17 >= 0 && f17 < n1Var.f445842a.length) {
    ...
    public static double i(wh.n1 n1Var, rh.f1 f1Var, long j17, boolean z17) {
        ...
        if (j17 > 0) {
            ...
            int i17 = 0;
            while (true) {
                if (i17 >= f1Var.f395386e.size()) {
                    break;
                }
                java.util.List list = ((rh.y2) f1Var.f395386e.get(i17)).f395560a;
                int i18 = z17 ? n1Var.f445842a[i17].f445829d : 1;
                java.util.Iterator it = list.iterator();
                while (it.hasNext()) {
                    j18 += ((java.lang.Long) ((rh.x2) it.next()).f395552a).longValue() * i18;
                }
                i17++;
            }
            for (int i19 = 0; i19 < f1Var.f395386e.size(); i19++) {
                int i27 = z17 ? n1Var.f445842a[i19].f445829d : 1;
                int i28 = 0;
                long j19 = 0;
                for (java.util.List list2 = ((rh.y2) f1Var.f395386e.get(i19)).f395560a; i28 < list2.size(); list2 = list2) {
                    j19 += ((java.lang.Long) ((rh.x2) list2.get(i28)).f395552a).longValue() * i27;
                    i28++;
                }
    ...
    public static double k(wh.n1 n1Var, rh.f1 f1Var, long j17) {
        ...
        if (j17 > 0) {
            for (int i17 = 0; i17 < f1Var.f395385d.size(); i17++) {
                java.util.Iterator it = ((rh.y2) f1Var.f395385d.get(i17)).f395560a.iterator();
                while (it.hasNext()) {
                    j18 += ((java.lang.Long) ((rh.x2) it.next()).f395552a).longValue();
                }
            }
            for (int i18 = 0; i18 < f1Var.f395385d.size(); i18++) {
                java.util.List list = ((rh.y2) f1Var.f395385d.get(i18)).f395560a;
                for (int i19 = 0; i19 < list.size(); i19++) {
                    long longValue = ((((float) ((java.lang.Long) ((rh.x2) list.get(i19)).f395552a).longValue()) * 1.0f) / ((float) j18)) * ((float) j17);
                    int f17 = n1Var.f(i18);
                    if (f17 >= 0 && f17 < n1Var.f445842a.length) {
    ...
    public static double l(wh.n1 n1Var, rh.f1 f1Var, long j17, boolean z17) {
        ...
        if (j17 > 0) {
            ...
            for (int i19 = 0; i19 < f1Var.f395386e.size(); i19++) {
                java.util.List list2 = ((rh.y2) f1Var.f395386e.get(i19)).f395560a;
                int i27 = z17 ? n1Var.f445842a[i19].f445829d : 1;
                for (int i28 = 0; i28 < list2.size(); i28++) {
                    d17 += (n1Var.d(i19, i28) / 3600000.0d) * ((((float) (((java.lang.Long) ((rh.x2) list2.get(i28)).f395552a).longValue() * i27)) * 1.0f) / ((float) j18)) * ((float) j17);
                }
            }
        }
        return d17;
