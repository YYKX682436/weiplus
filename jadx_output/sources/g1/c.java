...
public final class c implements g1.i {
    ...
    public final g1.a f267506d = new g1.a(null, null, null, 0, 15, null);

    /* renamed from: e, reason: collision with root package name */
    public final g1.g f267507e = new g1.b(this);

    /* renamed from: f, reason: collision with root package name */
    public e1.n0 f267508f;

    /* renamed from: g, reason: collision with root package name */
    public e1.n0 f267509g;
    ...
    public static e1.n0 b(g1.c cVar, long j17, g1.j jVar, float f17, e1.z zVar, int i17, int i18, int i19, java.lang.Object obj) {
        ...
        if (!kotlin.jvm.internal.o.b(gVar.f246257d, zVar)) {
            gVar.f(zVar);
        }
        if (!(gVar.f246255b == i17)) {
            gVar.d(i17);
        }
    ...
    public void A(long j17, long j18, long j19, float f17, g1.j style, e1.z zVar, int i17) {
        ...
        this.f267506d.f267502c.q(d1.e.c(j18), d1.e.d(j18), d1.e.c(j18) + d1.k.d(j19), d1.e.d(j18) + d1.k.b(j19), b(this, j17, style, f17, zVar, i17, 0, 32, null));
    }

    @Override // g1.i
    public void F(long j17, long j18, long j19, float f17, int i17, e1.q0 q0Var, float f18, e1.z zVar, int i18) {
        e1.u uVar = this.f267506d.f267502c;
        e1.n0 n0Var = this.f267509g;
        e1.n0 n0Var2 = n0Var;
        if (n0Var == null) {
            e1.g gVar = new e1.g();
            gVar.l(1);
        ...
        android.graphics.Paint paint = gVar2.f246254a;
        kotlin.jvm.internal.o.g(paint, "<this>");
        if (!e1.y.c(e1.a0.b(paint.getColor()), i19)) {
            gVar2.e(i19);
        }
        if (gVar2.f246256c != null) {
            gVar2.h(null);
        }
        if (!kotlin.jvm.internal.o.b(gVar2.f246257d, zVar)) {
            gVar2.f(zVar);
        }
        if (!(gVar2.f246255b == i18)) {
            gVar2.d(i18);
        }
        android.graphics.Paint paint2 = gVar2.f246254a;
        kotlin.jvm.internal.o.g(paint2, "<this>");
        ...
        if (!kotlin.jvm.internal.o.b(null, q0Var)) {
            kotlin.jvm.internal.o.g(paint2, "<this>");
            android.support.v4.media.f.a(q0Var);
    ...
    public void L(e1.r brush, long j17, long j18, long j19, float f17, g1.j style, e1.z zVar, int i17) {
        ...
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.s(d1.e.c(j17), d1.e.d(j17), d1.e.c(j17) + d1.k.d(j18), d1.e.d(j17) + d1.k.b(j18), d1.a.b(j19), d1.a.c(j19), g(this, brush, style, f17, zVar, i17, 0, 32, null));
    }

    @Override // g1.i
    public void M(long j17, long j18, long j19, long j27, g1.j style, float f17, e1.z zVar, int i17) {
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.s(d1.e.c(j18), d1.e.d(j18), d1.e.c(j18) + d1.k.d(j19), d1.e.d(j18) + d1.k.b(j19), d1.a.b(j27), d1.a.c(j27), b(this, j17, style, f17, zVar, i17, 0, 32, null));
    }
    ...
    public void T(e1.p0 path, e1.r brush, float f17, g1.j style, e1.z zVar, int i17) {
        ...
        kotlin.jvm.internal.o.g(brush, "brush");
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.l(path, g(this, brush, style, f17, zVar, i17, 0, 32, null));
    }

    @Override // g1.i
    public void U(long j17, float f17, long j18, float f18, g1.j style, e1.z zVar, int i17) {
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.r(j18, f17, b(this, j17, style, f18, zVar, i17, 0, 32, null));
    }
    ...
    public void f(e1.g0 image, long j17, float f17, g1.j style, e1.z zVar, int i17) {
        ...
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.f(image, j17, g(this, null, style, f17, zVar, i17, 0, 32, null));
    }

    @Override // p2.f
    public float getDensity() {
        return this.f267506d.f267500a.getDensity();
    }

    @Override // p2.f
    public float getFontScale() {
        return this.f267506d.f267500a.getFontScale();
    }

    @Override // g1.i
    public p2.s getLayoutDirection() {
        return this.f267506d.f267501b;
    }

    @Override // g1.i
    public void h(long j17, float f17, float f18, boolean z17, long j18, long j19, float f19, g1.j style, e1.z zVar, int i17) {
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.j(d1.e.c(j18), d1.e.d(j18), d1.e.c(j18) + d1.k.d(j19), d1.e.d(j18) + d1.k.b(j19), f17, f18, z17, b(this, j17, style, f19, zVar, i17, 0, 32, null));
    }
    ...
    public final e1.n0 j(g1.j jVar) {
        if (kotlin.jvm.internal.o.b(jVar, g1.m.f267512a)) {
            e1.n0 n0Var = this.f267508f;
            if (n0Var != null) {
                return n0Var;
            }
            e1.g gVar = new e1.g();
        ...
        android.graphics.Paint paint = gVar3.f246254a;
        kotlin.jvm.internal.o.g(paint, "<this>");
        float strokeWidth = paint.getStrokeWidth();
        g1.n nVar = (g1.n) jVar;
        float f17 = nVar.f267513a;
        if (!(strokeWidth == f17)) {
            gVar3.k(f17);
        }
        int a17 = gVar3.a();
        int i17 = nVar.f267515c;
        if (!(a17 == i17)) {
            gVar3.i(i17);
        }
        android.graphics.Paint paint2 = gVar3.f246254a;
        kotlin.jvm.internal.o.g(paint2, "<this>");
        float strokeMiter = paint2.getStrokeMiter();
        float f18 = nVar.f267514b;
        if (!(strokeMiter == f18)) {
            kotlin.jvm.internal.o.g(paint2, "<this>");
            paint2.setStrokeMiter(f18);
        }
        int b17 = gVar3.b();
        int i18 = nVar.f267516d;
        if (!(b17 == i18)) {
            gVar3.j(i18);
        }
    ...
    public void q(e1.r brush, long j17, long j18, float f17, g1.j style, e1.z zVar, int i17) {
        kotlin.jvm.internal.o.g(brush, "brush");
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.q(d1.e.c(j17), d1.e.d(j17), d1.e.c(j17) + d1.k.d(j18), d1.e.d(j17) + d1.k.b(j18), g(this, brush, style, f17, zVar, i17, 0, 32, null));
    }
    ...
    public void w(e1.g0 image, long j17, long j18, long j19, long j27, float f17, g1.j style, e1.z zVar, int i17, int i18) {
        kotlin.jvm.internal.o.g(image, "image");
        kotlin.jvm.internal.o.g(style, "style");
        this.f267506d.f267502c.t(image, j17, j18, j19, j27, c(null, style, f17, zVar, i17, i18));
    }
