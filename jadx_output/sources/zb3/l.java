...
public class l implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.luckymoney.sns.SnsLuckyMoneyPrepareUI f471275d;

    public l(com.tencent.mm.plugin.luckymoney.sns.SnsLuckyMoneyPrepareUI snsLuckyMoneyPrepareUI) {
        this.f471275d = snsLuckyMoneyPrepareUI;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.luckymoney.sns.SnsLuckyMoneyPrepareUI snsLuckyMoneyPrepareUI = this.f471275d;
        android.view.View view2 = snsLuckyMoneyPrepareUI.f145766t;
