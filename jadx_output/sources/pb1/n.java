...
public abstract class n {
    ...
    public static final android.os.ParcelUuid f353158a;
    ...
    static {
        ...
        f353158a = android.os.ParcelUuid.fromString("00000000-0000-1000-8000-00805F9B34FB");
    }
    ...
    public static android.os.ParcelUuid a(byte[] bArr) {
        ...
        android.os.ParcelUuid parcelUuid = f353158a;
