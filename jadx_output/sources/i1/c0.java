...
public final class c0 {
    ...
    public final java.util.List f286846a = new java.util.ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public final i1.b0 f286847b = new i1.b0(0.0f, 0.0f, 3, null);

    /* renamed from: c, reason: collision with root package name */
    public final i1.b0 f286848c = new i1.b0(0.0f, 0.0f, 3, null);

    /* renamed from: d, reason: collision with root package name */
    public final i1.b0 f286849d = new i1.b0(0.0f, 0.0f, 3, null);

    /* renamed from: e, reason: collision with root package name */
    public final i1.b0 f286850e = new i1.b0(0.0f, 0.0f, 3, null);

    public final void a(char c17, float[] args) {
        java.util.ArrayList arrayList;
        java.util.ArrayList arrayList2;
        java.util.List list;
        java.util.List list2 = this.f286846a;
        kotlin.jvm.internal.o.g(args, "args");
        if (c17 == 'z' || c17 == 'Z') {
            list = kz5.b0.c(i1.i.f286927c);
        } else {
            char c18 = 2;
            if (c17 == 'm') {
    ...
    public final void b(e1.p0 p0Var, double d17, double d18, double d19, double d27, double d28, double d29, double d37, boolean z17, boolean z18) {
        ...
        while (i17 < ceil) {
            ...
            ((e1.i) p0Var).f246263a.cubicTo((float) (d104 + (d105 * sin5)), (float) (d108 + (d107 * sin5)), (float) (d111 - (sin5 * d113)), (float) (d112 - (sin5 * d114)), (float) d111, (float) d112);
            i17++;
            sin2 = sin2;
            d101 = d101;
            d108 = d112;
    ...
    public final e1.p0 c(e1.p0 target) {
        ...
        iVar2.c();
        i1.b0 b0Var5 = this.f286847b;
        b0Var5.a();
        i1.b0 b0Var6 = this.f286848c;
        b0Var6.a();
        i1.b0 b0Var7 = this.f286849d;
        b0Var7.a();
        i1.b0 b0Var8 = this.f286850e;
        b0Var8.a();
        java.util.ArrayList arrayList2 = (java.util.ArrayList) this.f286846a;
        ...
        while (i27 < size) {
            ...
            android.graphics.Path path2 = iVar2.f246263a;
            if (z17) {
                b0Var5.f286832a = b0Var7.f286832a;
                b0Var5.f286833b = b0Var7.f286833b;
                b0Var6.f286832a = b0Var7.f286832a;
                b0Var6.f286833b = b0Var7.f286833b;
                path.close();
                path2.moveTo(b0Var5.f286832a, b0Var5.f286833b);
            } else if (a0Var3 instanceof i1.u) {
                i1.u uVar = (i1.u) a0Var3;
                float f17 = b0Var5.f286832a;
                float f18 = uVar.f287046c;
                b0Var5.f286832a = f17 + f18;
                float f19 = b0Var5.f286833b;
                float f27 = uVar.f287047d;
                b0Var5.f286833b = f19 + f27;
                path.rMoveTo(f18, f27);
                b0Var7.f286832a = b0Var5.f286832a;
                b0Var7.f286833b = b0Var5.f286833b;
            } else if (a0Var3 instanceof i1.m) {
                i1.m mVar = (i1.m) a0Var3;
                float f28 = mVar.f286971c;
                b0Var5.f286832a = f28;
                float f29 = mVar.f286972d;
                b0Var5.f286833b = f29;
                path.moveTo(f28, f29);
                b0Var7.f286832a = b0Var5.f286832a;
                b0Var7.f286833b = b0Var5.f286833b;
                ...
                float f37 = tVar.f287025c;
                float f38 = tVar.f287026d;
                path.rLineTo(f37, f38);
                b0Var5.f286832a += tVar.f287025c;
                b0Var5.f286833b += f38;
            } else if (a0Var3 instanceof i1.l) {
                i1.l lVar = (i1.l) a0Var3;
                float f39 = lVar.f286967c;
                float f47 = lVar.f286968d;
                path.lineTo(f39, f47);
                b0Var5.f286832a = lVar.f286967c;
                b0Var5.f286833b = f47;
            } else if (a0Var3 instanceof i1.s) {
                i1.s sVar = (i1.s) a0Var3;
                path.rLineTo(sVar.f287021c, 0.0f);
                b0Var5.f286832a += sVar.f287021c;
            } else if (a0Var3 instanceof i1.k) {
                i1.k kVar = (i1.k) a0Var3;
                path.lineTo(kVar.f286964c, b0Var5.f286833b);
                b0Var5.f286832a = kVar.f286964c;
            } else if (a0Var3 instanceof i1.y) {
                i1.y yVar = (i1.y) a0Var3;
                path.rLineTo(0.0f, yVar.f287074c);
                b0Var5.f286833b += yVar.f287074c;
            } else if (a0Var3 instanceof i1.z) {
                i1.z zVar = (i1.z) a0Var3;
                path.lineTo(b0Var5.f286832a, zVar.f287080c);
                b0Var5.f286833b = zVar.f287080c;
            } else {
                if (a0Var3 instanceof i1.r) {
                    i1.r rVar = (i1.r) a0Var3;
                    i17 = size;
                    path.rCubicTo(rVar.f287012c, rVar.f287013d, rVar.f287014e, rVar.f287015f, rVar.f287016g, rVar.f287017h);
                    b0Var6.f286832a = b0Var5.f286832a + rVar.f287014e;
                    b0Var6.f286833b = b0Var5.f286833b + rVar.f287015f;
                    b0Var5.f286832a += rVar.f287016g;
                    b0Var5.f286833b += rVar.f287017h;
                } else {
                    i17 = size;
                    if (a0Var3 instanceof i1.j) {
                        i1.j jVar = (i1.j) a0Var3;
                        path.cubicTo(jVar.f286939c, jVar.f286940d, jVar.f286941e, jVar.f286942f, jVar.f286943g, jVar.f286944h);
                        b0Var6.f286832a = jVar.f286941e;
                        b0Var6.f286833b = jVar.f286942f;
                        b0Var5.f286832a = jVar.f286943g;
                        b0Var5.f286833b = jVar.f286944h;
                    } else if (a0Var3 instanceof i1.w) {
                        i1.w wVar = (i1.w) a0Var3;
                        kotlin.jvm.internal.o.d(a0Var2);
                        if (a0Var2.f286813a) {
                            b0Var8.f286832a = b0Var5.f286832a - b0Var6.f286832a;
                            b0Var8.f286833b = b0Var5.f286833b - b0Var6.f286833b;
                        } else {
                            b0Var8.a();
                        }
                        iVar2.f246263a.rCubicTo(b0Var8.f286832a, b0Var8.f286833b, wVar.f287057c, wVar.f287058d, wVar.f287059e, wVar.f287060f);
                        b0Var6.f286832a = b0Var5.f286832a + wVar.f287057c;
                        b0Var6.f286833b = b0Var5.f286833b + wVar.f287058d;
                        b0Var5.f286832a += wVar.f287059e;
                        b0Var5.f286833b += wVar.f287060f;
                    } else if (a0Var3 instanceof i1.o) {
                        i1.o oVar = (i1.o) a0Var3;
                        kotlin.jvm.internal.o.d(a0Var2);
                        if (a0Var2.f286813a) {
                            float f48 = 2;
                            b0Var8.f286832a = (b0Var5.f286832a * f48) - b0Var6.f286832a;
                            b0Var8.f286833b = (f48 * b0Var5.f286833b) - b0Var6.f286833b;
                        } else {
                            b0Var8.f286832a = b0Var5.f286832a;
                            b0Var8.f286833b = b0Var5.f286833b;
                        }
                        iVar2.f246263a.cubicTo(b0Var8.f286832a, b0Var8.f286833b, oVar.f286982c, oVar.f286983d, oVar.f286984e, oVar.f286985f);
                        b0Var6.f286832a = oVar.f286982c;
                        b0Var6.f286833b = oVar.f286983d;
                        b0Var5.f286832a = oVar.f286984e;
                        b0Var5.f286833b = oVar.f286985f;
                    } else if (a0Var3 instanceof i1.v) {
                        i1.v vVar = (i1.v) a0Var3;
                        float f49 = vVar.f287051c;
                        float f57 = vVar.f287052d;
                        float f58 = vVar.f287053e;
                        float f59 = vVar.f287054f;
                        path.rQuadTo(f49, f57, f58, f59);
                        b0Var6.f286832a = b0Var5.f286832a + vVar.f287051c;
                        b0Var6.f286833b = b0Var5.f286833b + f57;
                        b0Var5.f286832a += f58;
                        b0Var5.f286833b += f59;
                    } else if (a0Var3 instanceof i1.n) {
                        i1.n nVar = (i1.n) a0Var3;
                        float f66 = nVar.f286975c;
                        float f67 = nVar.f286976d;
                        float f68 = nVar.f286977e;
                        float f69 = nVar.f286978f;
                        path.quadTo(f66, f67, f68, f69);
                        b0Var6.f286832a = nVar.f286975c;
                        b0Var6.f286833b = f67;
                        b0Var5.f286832a = f68;
                        b0Var5.f286833b = f69;
                        ...
                        float f76 = b0Var8.f286832a;
                        float f77 = b0Var8.f286833b;
                        float f78 = xVar.f287069c;
                        float f79 = xVar.f287070d;
                        path2.rQuadTo(f76, f77, f78, f79);
                        b0Var6.f286832a = b0Var5.f286832a + b0Var8.f286832a;
                        b0Var6.f286833b = b0Var5.f286833b + b0Var8.f286833b;
                        b0Var5.f286832a += xVar.f287069c;
                        b0Var5.f286833b += f79;
                        ...
                        if (a0Var2.f286814b) {
                            float f86 = 2;
                            b0Var8.f286832a = (b0Var5.f286832a * f86) - b0Var6.f286832a;
                            b0Var8.f286833b = (f86 * b0Var5.f286833b) - b0Var6.f286833b;
                        } else {
                            b0Var8.f286832a = b0Var5.f286832a;
                            b0Var8.f286833b = b0Var5.f286833b;
                        }
                        float f87 = b0Var8.f286832a;
                        float f88 = b0Var8.f286833b;
                        float f89 = pVar.f286998c;
                        float f96 = pVar.f286999d;
                        path2.quadTo(f87, f88, f89, f96);
                        b0Var6.f286832a = b0Var8.f286832a;
                        b0Var6.f286833b = b0Var8.f286833b;
                        b0Var5.f286832a = pVar.f286998c;
                        b0Var5.f286833b = f96;
                    } else {
                        if (a0Var3 instanceof i1.q) {
                            i1.q qVar = (i1.q) a0Var3;
                            float f97 = qVar.f287008h;
                            float f98 = b0Var5.f286832a;
                            float f99 = f97 + f98;
                            float f100 = b0Var5.f286833b;
                            float f101 = qVar.f287009i + f100;
                            i18 = i27;
                            i19 = i17;
                            b0Var = b0Var8;
                            ...
                            iVar = iVar2;
                            b(target, f98, f100, f99, f101, qVar.f287003c, qVar.f287004d, qVar.f287005e, qVar.f287006f, qVar.f287007g);
                            b0Var10.f286832a = f99;
                            b0Var10.f286833b = f101;
                            b0Var9.f286832a = f99;
                            b0Var9.f286833b = f101;
                            b0Var4 = b0Var10;
                            b0Var3 = b0Var9;
                            a0Var = a0Var3;
                        } else {
                            ...
                            if (a0Var3 instanceof i1.h) {
                                ...
                                double d17 = b0Var11.f286832a;
                                double d18 = b0Var11.f286833b;
                                double d19 = hVar.f286922h;
                                float f102 = hVar.f286923i;
                                a0Var = a0Var3;
                                b(target, d17, d18, d19, f102, hVar.f286917c, hVar.f286918d, hVar.f286919e, hVar.f286920f, hVar.f286921g);
                                float f103 = hVar.f286922h;
                                b0Var4 = b0Var11;
                                b0Var4.f286832a = f103;
                                b0Var4.f286833b = f102;
                                b0Var3 = b0Var12;
                                b0Var3.f286832a = f103;
                                b0Var3.f286833b = f102;
                            } else {
                                a0Var = a0Var3;
                                b0Var3 = b0Var12;
                                b0Var4 = b0Var11;
