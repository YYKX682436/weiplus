...
public final class e0 extends n0.a {
    ...
    public void b(int i17, int i18) {
        k((i1.d0) this.f333426c).e(i17, i18);
    }

    @Override // n0.e
    public void e(int i17, int i18, int i19) {
        i1.b k17 = k((i1.d0) this.f333426c);
        java.util.List list = k17.f286817c;
        int i27 = 0;
        if (i17 > i18) {
            while (i27 < i19) {
    ...
    @Override // n0.a
    public void j() {
        i1.b k17 = k((i1.d0) this.f333424a);
        k17.e(0, ((java.util.ArrayList) k17.f286817c).size());
    }
