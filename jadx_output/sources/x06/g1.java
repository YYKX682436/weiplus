...
public abstract class g1 {
    ...
    public static final x06.c1 f451242a = new x06.c1(null);

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.List f451243b;

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.List f451244c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.Map f451245d;

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.Map f451246e;

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.Set f451247f;

    /* renamed from: g, reason: collision with root package name */
    public static final java.util.Set f451248g;

    /* renamed from: h, reason: collision with root package name */
    public static final x06.b1 f451249h;

    /* renamed from: i, reason: collision with root package name */
    public static final java.util.Map f451250i;

    /* renamed from: j, reason: collision with root package name */
    public static final java.util.Map f451251j;

    /* renamed from: k, reason: collision with root package name */
    public static final java.util.List f451252k;

    /* renamed from: l, reason: collision with root package name */
    public static final java.util.Map f451253l;
    ...
    static {
        ...
        kotlin.jvm.internal.o.f(h27, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h28, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h29, "getDesc(...)");
        jz5.l lVar5 = new jz5.l(x06.c1.a(c1Var2, g28, "remove", "Ljava/lang/Object;Ljava/lang/Object;", h29), f1Var);
        jz5.l lVar6 = new jz5.l(x06.c1.a(c1Var2, a1Var.g("Map"), "getOrDefault", "Ljava/lang/Object;Ljava/lang/Object;", "Ljava/lang/Object;"), x06.f1.f451238h);
        x06.b1 a18 = x06.c1.a(c1Var2, a1Var.g("Map"), "get", "Ljava/lang/Object;", "Ljava/lang/Object;");
        x06.f1 f1Var2 = x06.f1.f451235e;
        ...
        for (java.util.Map.Entry entry : k17.entrySet()) {
            linkedHashMap.put(((x06.b1) entry.getKey()).f451210e, entry.getValue());
        }
        f451246e = linkedHashMap;
        java.util.Set i17 = kz5.q1.i(f451245d.keySet(), f451243b);
        java.util.ArrayList arrayList4 = new java.util.ArrayList(kz5.d0.q(i17, 10));
        java.util.Iterator it7 = i17.iterator();
        while (it7.hasNext()) {
            arrayList4.add(((x06.b1) it7.next()).f451207b);
        }
        f451247f = kz5.n0.X0(arrayList4);
        java.util.ArrayList arrayList5 = new java.util.ArrayList(kz5.d0.q(i17, 10));
        java.util.Iterator it8 = i17.iterator();
        while (it8.hasNext()) {
            arrayList5.add(((x06.b1) it8.next()).f451210e);
        }
        f451248g = kz5.n0.X0(arrayList5);
        x06.c1 c1Var3 = f451242a;
        w16.e eVar3 = w16.e.INT;
        java.lang.String h39 = eVar3.h();
        kotlin.jvm.internal.o.f(h39, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h47, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h48, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h49, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h57, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h58, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h59, "getDesc(...)");
        ...
        kotlin.jvm.internal.o.f(h66, "getDesc(...)");
        java.lang.String h67 = w16.e.CHAR.h();
        kotlin.jvm.internal.o.f(h67, "getDesc(...)");
        ...
        for (java.util.Map.Entry entry2 : k18.entrySet()) {
            linkedHashMap2.put(((x06.b1) entry2.getKey()).f451210e, entry2.getValue());
        }
        f451251j = linkedHashMap2;
        java.util.Map map = f451250i;
        ...
        for (java.util.Map.Entry entry3 : map.entrySet()) {
            ...
            java.lang.String classInternalName = b1Var.f451206a;
            java.lang.String parameters = b1Var.f451208c;
            java.lang.String returnType = b1Var.f451209d;
            b1Var.getClass();
        ...
        for (jz5.l lVar17 : arrayList7) {
            linkedHashMap3.put((n16.g) lVar17.f302834e, (n16.g) lVar17.f302833d);
        }
        f451253l = linkedHashMap3;
    }
}
