...
public final class i implements xe5.h0 {
    ...
    public android.view.View f454040a;

    /* renamed from: b, reason: collision with root package name */
    public android.widget.ImageView f454041b;

    /* renamed from: c, reason: collision with root package name */
    public android.widget.TextView f454042c;

    /* renamed from: d, reason: collision with root package name */
    public android.widget.ImageView f454043d;

    /* renamed from: e, reason: collision with root package name */
    public android.view.View f454044e;

    /* renamed from: f, reason: collision with root package name */
    public android.widget.TextView f454045f;

    /* renamed from: g, reason: collision with root package name */
    public android.widget.LinearLayout f454046g;

    /* renamed from: h, reason: collision with root package name */
    public android.view.View f454047h;

    /* renamed from: i, reason: collision with root package name */
    public android.widget.TextView f454048i;

    /* renamed from: j, reason: collision with root package name */
    public android.view.View f454049j;

    /* renamed from: k, reason: collision with root package name */
    public android.widget.TextView f454050k;

    /* renamed from: l, reason: collision with root package name */
    public android.widget.TextView f454051l;

    /* renamed from: m, reason: collision with root package name */
    public android.widget.LinearLayout f454052m;

    /* renamed from: n, reason: collision with root package name */
    public android.widget.ImageView f454053n;

    /* renamed from: o, reason: collision with root package name */
    public android.view.View f454054o;

    /* renamed from: p, reason: collision with root package name */
    public android.view.View f454055p;

    /* renamed from: q, reason: collision with root package name */
    public final boolean f454056q;

    public i() {
        ((r40.i) ((tc.e) i95.n0.c(tc.e.class))).getClass();
        this.f454056q = ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.V3).getValue()).r()).intValue() == 1;
    }

    public void a(boolean z17) {
        android.view.View view = this.f454040a;
        if (view == null) {
            return;
        }
        int i17 = z17 ? 0 : 8;
    ...
    public final void b(int i17, long j17, java.lang.String tipsId, java.lang.String url, int i18) {
        ...
        if (i18 == 1) {
            c(i17, j17, tipsId, url, qs5.n.f366447g, null);
        } else {
            c(i17, j17, tipsId, url, qs5.n.f366448h, null);
        }
    }
    ...
    public final void c(int i17, long j17, java.lang.String tipsId, java.lang.String url, qs5.n state, r45.nw1 nw1Var) {
        ...
        android.view.View view = this.f454047h;
        if (view == null) {
            num = 0;
        } else {
            java.util.ArrayList arrayList = new java.util.ArrayList();
        ...
        android.view.View view2 = this.f454047h;
        android.widget.ImageView imageView = view2 != null ? (android.widget.ImageView) view2.findViewById(com.tencent.mm.R.id.fs7) : null;
        android.view.View view3 = this.f454047h;
        android.view.View findViewById = view3 != null ? view3.findViewById(com.tencent.mm.R.id.f4x) : null;
        android.view.View view4 = this.f454047h;
        android.view.View findViewById2 = view4 != null ? view4.findViewById(com.tencent.mm.R.id.f7y) : null;
        ...
        sb6.append('!');
        com.tencent.mars.xlog.Log.i("FinderLiveNotifyTmplV1", sb6.toString());
        if (!(url.length() > 0)) {
            android.view.View view5 = this.f454047h;
            if (view5 == null) {
                return;
            }
        ...
        if (ordinal != 0) {
            if (ordinal == 1) {
                ...
                if (!((com.tencent.mm.feature.finder.live.v4) ((s40.w0) i95.n0.c(s40.w0.class))).vk(nw1Var, "tmp")) {
                    ...
                    g92Var2.set(38, java.lang.Integer.valueOf(nw1Var != null ? nw1Var.getInteger(37) : 0));
                    i95.m c18 = i95.n0.c(s40.w0.class);
                    kotlin.jvm.internal.o.f(c18, "getService(...)");
                    s40.w0.O1((s40.w0) c18, findViewById, qs5.n.f366445e, false, g92Var2, 4, null);
                    ((com.tencent.mm.feature.finder.live.v4) ((s40.w0) i95.n0.c(s40.w0.class))).Hk(findViewById2, qs5.n.f366448h, true, g92Var2);
                    return;
                }
            ...
            if (ordinal != 3) {
                ...
                s40.w0.g6((s40.w0) c37, findViewById2, qs5.n.f366448h, false, null, 12, null);
                i95.m c38 = i95.n0.c(s40.w0.class);
                kotlin.jvm.internal.o.f(c38, "getService(...)");
                s40.w0.O1((s40.w0) c38, findViewById, qs5.n.f366447g, false, null, 4, null);
                return;
            }
        }
        java.lang.Integer num4 = num;
        i95.m c39 = i95.n0.c(vd2.i5.class);
        kotlin.jvm.internal.o.f(c39, "getService(...)");
        ...
        if (nw1Var != null) {
            g92Var = new r45.g92();
            g92Var.set(38, java.lang.Integer.valueOf(nw1Var.getInteger(37)));
        } else {
            g92Var = null;
        }
        i95.m c47 = i95.n0.c(s40.w0.class);
        kotlin.jvm.internal.o.f(c47, "getService(...)");
        s40.w0.O1((s40.w0) c47, findViewById, state, false, g92Var, 4, null);
        ((com.tencent.mm.feature.finder.live.v4) ((s40.w0) i95.n0.c(s40.w0.class))).Hk(findViewById2, qs5.n.f366448h, true, g92Var);
    }
}
