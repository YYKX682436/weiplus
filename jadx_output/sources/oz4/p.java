...
public abstract class p<V, C extends oz4.h> extends oz4.v<V, C> {
    @Override // oz4.v
    public final void a(com.tencent.mm.plugin.wenote.model.nativenote.manager.WXRTEditText wXRTEditText, java.lang.Object obj) {
        mz4.t paragraphsInSelection = wXRTEditText.getParagraphsInSelection();
        if (wXRTEditText.K) {
            int i17 = wXRTEditText.getSelection().f333350d;
            int i18 = paragraphsInSelection.f333350d;
            if (i17 == i18 && i18 > 1) {
                java.util.ArrayList d17 = d(wXRTEditText.getText(), paragraphsInSelection, oz4.u.SPAN_FLAGS);
                if (!d17.isEmpty() && wXRTEditText.getLayout().getPrimaryHorizontal(wXRTEditText.getSelection().f333350d) == mz4.b.b()) {
                    java.util.Iterator it = d17.iterator();
                    while (it.hasNext()) {
                        wXRTEditText.getText().removeSpan(it.next());
                    }
                    wXRTEditText.getText().insert(paragraphsInSelection.f333350d - 1, "\n");
                }
            }
        }
        f(wXRTEditText, paragraphsInSelection, obj);
        oz4.w.b(wXRTEditText, this);
    }

    @Override // oz4.v
    public final mz4.t c(com.tencent.mm.plugin.wenote.model.nativenote.manager.WXRTEditText wXRTEditText) {
    ...
    */
    ...
    public abstract void f(com.tencent.mm.plugin.wenote.model.nativenote.manager.WXRTEditText wXRTEditText, mz4.t tVar, java.lang.Object obj);
