...
public class k extends oz4.p<java.lang.Boolean, oz4.l> {
    ...
    public final oz4.r f350279a = new oz4.r();
    ...
    public void f(com.tencent.mm.plugin.wenote.model.nativenote.manager.WXRTEditText wXRTEditText, mz4.t tVar, java.lang.Object obj) {
        ...
        while (i17 < size) {
            ...
            boolean z18 = (lVar2 == null || !lVar2.f350285i) ? r76 : true;
            boolean z19 = (lVar != null && lVar == lVar2 && z18) ? r76 : z18;
            boolean z27 = !d17.isEmpty();
            boolean booleanValue = (i17 <= 0 || oVar.c() != 1 || paragraphs.get(i17 + (-1)).c() != 1 || bool.booleanValue()) ? r76 : true ? r76 : oVar.d(tVar) ? bool.booleanValue() : z27;
            if (booleanValue) {
                z17 = false;
                r37.f350298a.add(new oz4.q(new oz4.l(z19, mz4.b.b(), oVar.a(), oVar.f350293f, oVar.f350294g), oVar, false));
                oz4.w.f350319e.g(text, oVar, r37);
                oz4.w.f350318d.g(text, oVar, r37);
            } else {
                z17 = r76;
            }
            if (!booleanValue && z27) {
