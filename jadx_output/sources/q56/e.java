...
public final class e extends java.lang.RuntimeException {
    ...
    public final java.util.List f360209d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f360210e;

    /* renamed from: f, reason: collision with root package name */
    public java.lang.Throwable f360211f;
    ...
    public e(java.util.Collection collection) {
        ...
        if (collection != null) {
            ...
            while (it.hasNext()) {
                ...
                if (th6 instanceof q56.e) {
                    linkedHashSet.addAll(((q56.e) th6).f360209d);
                } else if (th6 != null) {
        ...
        this.f360209d = unmodifiableList;
        this.f360210e = unmodifiableList.size() + " exceptions occurred. ";
    }
    ...
    public final void b(q56.b bVar) {
        ...
        int i17 = 1;
        for (java.lang.Throwable th6 : this.f360209d) {
    ...
    public synchronized java.lang.Throwable getCause() {
        ...
        return this.f360211f;
    }

    @Override // java.lang.Throwable
    public java.lang.String getMessage() {
        return this.f360210e;
    }
