...
public class d extends qm5.j {
    ...
    public void e() {
        super.e();
        this.f364804q = android.opengl.GLES20.glGetUniformLocation(this.f364795d, "mvControl");
        this.f364805r = android.opengl.GLES20.glGetUniformLocation(this.f364795d, "mvSwitch");
        this.f364806s = android.opengl.GLES20.glGetUniformLocation(this.f364795d, "noiseLevel");
        this.f364807t = android.opengl.GLES20.glGetUniformLocation(this.f364795d, "texelWidth");
        this.f364808u = android.opengl.GLES20.glGetUniformLocation(this.f364795d, "texelHeight");
        this.f364802o = 1;
        this.f364803p = 0.05f;
        g(new qm5.a(this, this.f364804q, 0));
        int i17 = this.f364802o;
        this.f364802o = i17;
        g(new qm5.a(this, this.f364805r, i17));
        float f17 = this.f364803p;
        this.f364803p = f17;
        g(new qm5.b(this, this.f364806s, f17));
    }
}
