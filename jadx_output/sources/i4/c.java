...
public final class c {
    ...
    public static final java.util.Comparator f288332f = new i4.a();

    /* renamed from: a, reason: collision with root package name */
    public final int[] f288333a;

    /* renamed from: b, reason: collision with root package name */
    public final int[] f288334b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.List f288335c;

    /* renamed from: d, reason: collision with root package name */
    public final i4.g[] f288336d;

    /* renamed from: e, reason: collision with root package name */
    public final float[] f288337e = new float[3];

    public c(int[] iArr, int i17, i4.g[] gVarArr) {
        i4.b bVar;
        this.f288336d = gVarArr;
        ...
        if (i28 <= i17) {
            this.f288335c = new java.util.ArrayList();
            while (i18 < i28) {
                int i39 = iArr3[i18];
                ((java.util.ArrayList) this.f288335c).add(new i4.i(android.graphics.Color.rgb(b((i39 >> 10) & 31, 5, 8), b((i39 >> 5) & 31, 5, 8), b(i39 & 31, 5, 8)), iArr2[i39]));
                i18++;
            }
            return;
        }
        java.util.PriorityQueue priorityQueue = new java.util.PriorityQueue(i17, f288332f);
        priorityQueue.offer(new i4.b(this, 0, this.f288333a.length - 1));
        while (priorityQueue.size() < i17 && (bVar = (i4.b) priorityQueue.poll()) != null) {
            int i47 = bVar.f288323b;
            int i48 = bVar.f288322a;
            ...
            int i49 = bVar.f288326e - bVar.f288325d;
            int i57 = bVar.f288328g - bVar.f288327f;
            int i58 = bVar.f288330i - bVar.f288329h;
            int i59 = (i49 < i57 || i49 < i58) ? (i57 < i49 || i57 < i58) ? -1 : -2 : -3;
            i4.c cVar = bVar.f288331j;
            int[] iArr4 = cVar.f288333a;
            a(iArr4, i59, i48, i47);
            java.util.Arrays.sort(iArr4, i48, bVar.f288323b + 1);
            a(iArr4, i59, i48, bVar.f288323b);
            int i66 = bVar.f288324c / 2;
            int i67 = i18;
            int i68 = i48;
            while (true) {
                int i69 = bVar.f288323b;
                if (i68 <= i69) {
                    i67 += cVar.f288334b[iArr4[i68]];
                    if (i67 >= i66) {
            ...
            i4.b bVar2 = new i4.b(cVar, i48 + 1, bVar.f288323b);
            bVar.f288323b = i48;
            bVar.a();
        ...
        while (it.hasNext()) {
            ...
            i4.c cVar2 = bVar3.f288331j;
            int[] iArr5 = cVar2.f288333a;
            int i76 = 0;
            int i77 = 0;
            int i78 = 0;
            int i79 = 0;
            for (int i86 = bVar3.f288322a; i86 <= bVar3.f288323b; i86++) {
                int i87 = iArr5[i86];
                int i88 = cVar2.f288334b[i87];
                i77 += i88;
                i76 += ((i87 >> 10) & 31) * i88;
                i78 += ((i87 >> 5) & 31) * i88;
                i79 += i88 * (i87 & 31);
            ...
            if (!c(iVar.f288349d, iVar.b())) {
                arrayList.add(iVar);
            }
        }
        this.f288335c = arrayList;
    }
