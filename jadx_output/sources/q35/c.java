...
public abstract class c implements android.hardware.SensorEventListener {
    ...
    public static int f359971f = 5;

    /* renamed from: d, reason: collision with root package name */
    public final float[] f359972d = {2.0f, 2.5f, 0.5f};

    /* renamed from: e, reason: collision with root package name */
    public final float[] f359973e = new float[3];
    ...
    public void onSensorChanged(android.hardware.SensorEvent sensorEvent) {
        ...
        for (int i17 = 0; i17 < 3; i17++) {
            float f17 = this.f359972d[i17];
            float f18 = fArr2[i17];
            float[] fArr3 = this.f359973e;
