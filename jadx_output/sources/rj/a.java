...
public final class a extends ot0.h {
    ...
    public w05.h f396132b;

    @Override // ot0.h
    public ot0.h a() {
        rj.a aVar = new rj.a();
        aVar.f396132b = this.f396132b;
        return aVar;
    }
    ...
    */
    ...
    public void d(java.util.Map map, ot0.q qVar) {
        if (map == null) {
            this.f396132b = null;
            com.tencent.mars.xlog.Log.i("AppContentEcsInfoPiece", "parseContent skip, values is null");
            return;
        }
        if (map.get(".msg.appmsg.ecsInfo") == null) {
            this.f396132b = null;
            com.tencent.mars.xlog.Log.i("AppContentEcsInfoPiece", "parseContent skip, .msg.appmsg.ecsInfo is missing");
            return;
        }
        ...
        hVar.I(com.tencent.mm.sdk.platformtools.t8.P(str2 != null ? str2 : "0", 0));
        java.lang.String str3 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.realAppId");
        if (str3 != null) {
            java.lang.String T1 = com.tencent.mm.sdk.platformtools.t8.T1(str3);
            kotlin.jvm.internal.o.f(T1, "unescapeXMLSafe(...)");
            hVar.S(T1);
        }
        java.lang.String str4 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.activityId");
        if (str4 != null) {
            hVar.E(com.tencent.mm.sdk.platformtools.b8.c(str4));
        }
        java.lang.String str5 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.bulkId");
        if (str5 != null) {
            hVar.G(com.tencent.mm.sdk.platformtools.b8.c(str5));
        }
        java.lang.String str6 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.ecsJumpInfoBase64");
        if (str6 != null) {
            java.lang.String T12 = com.tencent.mm.sdk.platformtools.t8.T1(str6);
            kotlin.jvm.internal.o.f(T12, "unescapeXMLSafe(...)");
            hVar.K(T12);
        }
        java.lang.String str7 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.ecmsgsignature");
        if (str7 != null) {
            java.lang.String T13 = com.tencent.mm.sdk.platformtools.t8.T1(str7);
            kotlin.jvm.internal.o.f(T13, "unescapeXMLSafe(...)");
            hVar.J(T13);
        }
        java.lang.String str8 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.sceneNote");
        if (str8 != null) {
            java.lang.String T14 = com.tencent.mm.sdk.platformtools.t8.T1(str8);
            kotlin.jvm.internal.o.f(T14, "unescapeXMLSafe(...)");
            hVar.U(T14);
        }
        java.lang.String str9 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.reportExtraInfoJson");
        if (str9 != null) {
            java.lang.String T15 = com.tencent.mm.sdk.platformtools.t8.T1(str9);
            kotlin.jvm.internal.o.f(T15, "unescapeXMLSafe(...)");
            hVar.T(T15);
        }
        java.lang.String str10 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.bizReportData");
        if (str10 != null) {
            java.lang.String T16 = com.tencent.mm.sdk.platformtools.t8.T1(str10);
            kotlin.jvm.internal.o.f(T16, "unescapeXMLSafe(...)");
            hVar.F(T16);
        }
        java.lang.String str11 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.friendReceiveTitle");
        if (str11 != null) {
            java.lang.String T17 = com.tencent.mm.sdk.platformtools.t8.T1(str11);
            kotlin.jvm.internal.o.f(T17, "unescapeXMLSafe(...)");
            hVar.Q(T17);
        }
        java.lang.String str12 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.friendReceiveDesc");
        if (str12 != null) {
            java.lang.String T18 = com.tencent.mm.sdk.platformtools.t8.T1(str12);
            kotlin.jvm.internal.o.f(T18, "unescapeXMLSafe(...)");
            hVar.N(T18);
        }
        java.lang.String str13 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.friendReceiveSourceName");
        if (str13 != null) {
            java.lang.String T19 = com.tencent.mm.sdk.platformtools.t8.T1(str13);
            kotlin.jvm.internal.o.f(T19, "unescapeXMLSafe(...)");
            hVar.P(T19);
        }
        java.lang.String str14 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.friendReceiveImageUrl");
        if (str14 != null) {
            java.lang.String T110 = com.tencent.mm.sdk.platformtools.t8.T1(str14);
            kotlin.jvm.internal.o.f(T110, "unescapeXMLSafe(...)");
            hVar.O(T110);
        }
        java.lang.String str15 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.passBuffer");
        if (str15 != null) {
            java.lang.String T111 = com.tencent.mm.sdk.platformtools.t8.T1(str15);
            kotlin.jvm.internal.o.f(T111, "unescapeXMLSafe(...)");
            hVar.R(T111);
        }
        java.lang.String str16 = (java.lang.String) map.get(".msg.appmsg.ecsInfo.fetchAndPreloadFlags");
        if (str16 != null) {
            hVar.L(com.tencent.mm.sdk.platformtools.t8.P(str16, 0));
        }
        this.f396132b = hVar;
    }
}
