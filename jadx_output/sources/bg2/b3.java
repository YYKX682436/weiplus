...
public final class b3 extends tc2.c implements tc2.h {
    ...
    public final java.lang.String f19937e;
    ...
    public final char f19940h;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b3(tc2.g store) {
        super(store);
        kotlin.jvm.internal.o.g(store, "store");
        this.f19937e = "LiveConvertShareGuideController";
        this.f19938f = 5;
        this.f19939g = 86400;
        this.f19940h = (char) 8197;
    }

    public static final void Y6(bg2.b3 b3Var, int i17) {
        bg2.d1 d1Var;
        in5.s0 s0Var = b3Var.f417141d.f417149i;
        ...
        android.text.SpannableString spannableString = new android.text.SpannableString(context.getResources().getString(com.tencent.mm.R.string.npl));
        android.graphics.drawable.Drawable e17 = com.tencent.mm.ui.uk.e(context, com.tencent.mm.R.raw.icons_outlined_share, context.getResources().getColor(com.tencent.mm.R.color.aaz));
        ...
        int K = r26.n0.K(spannableString, b3Var.f19940h, 0, false, 6, null);
        ...
        sb6.append('}');
        com.tencent.mars.xlog.Log.i(b3Var.f19937e, sb6.toString());
        if (e76 != null) {
