...
public final class o3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.y23 f20348d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bg2.z3 f20349e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f20350f;
    ...
    public final void onClick(android.view.View view) {
        ...
        intent.putExtra("KEY_PARAMS_AUTO_OPEN_PRODUCT_INFO", this.f20348d.toByteArray());
        bg2.z3 z3Var = this.f20349e;
        com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed = z3Var.f417141d.f417148h;
        if (baseFinderFeed != null && (feedObject2 = baseFinderFeed.getFeedObject()) != null) {
            feedObject2.getFeedObject();
        }
        uc2.i iVar = (uc2.i) z3Var.O6(uc2.i.class);
        if (iVar != null) {
            ((sb2.o) iVar).Y6(this.f20350f, intent);
        }
        ...
        if (baseFinderFeed3 != null) {
            ...
            v3Var.a(c76, baseFinderFeed3, jSONObject2);
        }
