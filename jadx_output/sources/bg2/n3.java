...
public final class n3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.y23 f20328d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bg2.z3 f20329e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f20330f;
    ...
    public final void onClick(android.view.View view) {
        ...
        intent.putExtra("KEY_PARAMS_AUTO_OPEN_PRODUCT_INFO", this.f20328d.toByteArray());
        bg2.z3 z3Var = this.f20329e;
        uc2.i iVar = (uc2.i) z3Var.O6(uc2.i.class);
        if (iVar != null) {
            ((sb2.o) iVar).Y6(this.f20330f, intent);
        }
