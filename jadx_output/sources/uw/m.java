...
public final class m implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ android.content.Context f431498d;

    public m(android.content.Context context) {
        this.f431498d = context;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public final void onClick(android.content.DialogInterface dialogInterface, int i17) {
        android.content.Context context = this.f431498d;
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.BrsNotificationPushUtils", "gotoSystemAppSettingsPage error: " + e17.getMessage());
        }
        uw.p.a(uw.p.f431501a, 1);
