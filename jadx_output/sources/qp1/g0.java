...
public final class g0 {
    ...
    public static final qp1.g0 f365722a = new qp1.g0();

    /* renamed from: b, reason: collision with root package name */
    public static qp1.c f365723b;
    ...
    public static final int c(int i17, int i18, int i19, int i27, yz5.l isValidPosY) {
        int i28;
        kotlin.jvm.internal.o.g(isValidPosY, "isValidPosY");
        if (i19 > i17) {
            int i29 = i18 + i17;
            if (i29 <= i19) {
                return i19;
            }
            if (((java.lang.Boolean) isValidPosY.invoke(java.lang.Integer.valueOf(i29))).booleanValue()) {
                return i29;
            }
            i28 = i17 - i27;
        } else {
            ...
            int i37 = i17 - i27;
            if (((java.lang.Boolean) isValidPosY.invoke(java.lang.Integer.valueOf(i37))).booleanValue()) {
                return i37;
            }
            i28 = i17 + i18;
        }
    ...
    public final int d(int i17) {
        if (i17 == 1) {
            return com.tencent.mm.R.raw.mini_program_circle_filled;
        }
        if (i17 == 2) {
            return com.tencent.mm.R.raw.link_filled;
        }
        if (i17 == 3) {
            return com.tencent.mm.R.raw.favorites_filled;
        }
        if (i17 == 4) {
            return com.tencent.mm.R.raw.folder_filled;
        }
        if (i17 == 55) {
        ...
        switch (i17) {
            case com.tencent.mm.opensdk.modelmsg.WXMediaMessage.IMediaObject.TYPE_OPENSDK_WEWORK_OBJECT /* 49 */:
                return com.tencent.mm.R.raw.channels_filled;
            case 50:
                return com.tencent.mm.R.raw.subscriptions_filled;
            case 51:
                return com.tencent.mm.R.raw.picture_filled;
            default:
                return com.tencent.mm.R.raw.link_filled;
        }
    }
