...
public abstract class u extends tb0.k {
    ...
    public static final java.util.HashMap f297521a = new java.util.HashMap();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.HashMap f297522b = new java.util.HashMap();
    ...
    public static boolean b(android.app.Activity activity, java.lang.String str, int i17, java.lang.String str2, java.lang.String str3, com.tencent.mm.ui.widget.dialog.v1 v1Var, java.lang.Boolean bool) {
        try {
            if (str.equals("android.permission.WRITE_EXTERNAL_STORAGE") && android.os.Build.VERSION.SDK_INT > 30) {
                str = "android.permission.READ_EXTERNAL_STORAGE";
            }
            if (((!str.equals("android.permission.READ_EXTERNAL_STORAGE") || android.os.Build.VERSION.SDK_INT < 33 || activity.getApplicationInfo().targetSdkVersion < 33) ? b3.l.checkSelfPermission(activity, str) : !c(activity) ? -1 : 0) == 0) {
                return true;
            }
    ...
    public static boolean c(android.content.Context context) {
        ...
        if (i17 >= 33 && (b3.l.checkSelfPermission(context, "android.permission.READ_MEDIA_IMAGES") == 0 || b3.l.checkSelfPermission(context, "android.permission.READ_MEDIA_VIDEO") == 0)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "full access on Android 13 (API level 33) or higher");
            return true;
        }
        if (i17 < 34 || b3.l.checkSelfPermission(context, "android.permission.READ_MEDIA_VISUAL_USER_SELECTED") != 0) {
            return context.getApplicationInfo().targetSdkVersion < 33 && b3.l.checkSelfPermission(context, "android.permission.READ_EXTERNAL_STORAGE") == 0;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "partial access on Android 14 (API level 34) or higher");
        return true;
    }
    ...
    public static boolean e(android.content.Context context, java.lang.String str) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "check permission: " + str + ", checkMedia: " + z17);
        if (z17) {
            return c(context);
        }
        try {
    ...
    public static long f(java.lang.String str, int i17) {
        return com.tencent.mm.sdk.platformtools.o4.L().getLong("had_request_permission_" + str + "_" + i17, 0L);
    }
    ...
    public static void k(android.content.Context context, int i17, j35.b0 b0Var, java.lang.String[] strArr, java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4) {
        ...
        if (b0Var == null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "listener is null");
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "requestPermission requestCode:%s", java.lang.Integer.valueOf(i17));
        ...
        if (h(context, strArr2)) {
            b0Var.onRequestPermissionsResult(i17, strArr2, iArr);
            return;
        }
        int i27 = 0;
        while (true) {
        ...
        f297521a.put(valueOf, b0Var);
        android.content.Intent intent = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.pluginsdk.permission.PermissionActivity.class);
    ...
    public static void l(android.app.Activity activity, java.lang.String[] strArr, int i17) {
        try {
            ...
            if ((activity instanceof com.tencent.mm.ui.vas.VASActivity) && ((com.tencent.mm.ui.vas.VASActivity) activity).handleRequestPermissions(strArr, i17)) {
                com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "requestPermissions: VAS finish");
            } else {
                z2.h.a(activity, strArr, i17);
            }
        } catch (java.lang.Throwable th6) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MPermissionUtil", th6, "requestPermissions err", new java.lang.Object[0]);
        }
    }

    public static void m(java.lang.String str, int i17) {
        com.tencent.mm.sdk.platformtools.o4.L().putLong("had_request_permission_" + str + "_" + i17, java.lang.System.currentTimeMillis());
    }

    public static void n(android.content.Intent intent, java.lang.String str, java.lang.String str2, j35.g0 g0Var) {
        com.tencent.mars.xlog.Log.i("MicroMsg.MPermissionUtil", "startSettings reasonTitle:%s, reasonMsg:%s", str, str2);
        java.lang.String valueOf = java.lang.String.valueOf(java.lang.System.currentTimeMillis());
        f297522b.put(valueOf, g0Var);
        ...
        android.content.Intent intent2 = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.pluginsdk.permission.PermissionActivity.class);
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.MPermissionUtil", "processNameOfComponent: catch e: " + e17.getMessage());
            intent2.addFlags(268435456);
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
