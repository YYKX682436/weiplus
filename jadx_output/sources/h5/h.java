...
public class h extends h5.f {
    ...
    public static final java.lang.String f278993i = a5.a0.e("NetworkStateTracker");

    /* renamed from: g, reason: collision with root package name */
    public final android.net.ConnectivityManager f278994g;

    /* renamed from: h, reason: collision with root package name */
    public final h5.g f278995h;

    public h(android.content.Context context, m5.a aVar) {
        super(context, aVar);
        this.f278994g = (android.net.ConnectivityManager) this.f278988b.getSystemService("connectivity");
        this.f278995h = new h5.g(this);
    }
    ...
    @Override // h5.f
    public void c() {
        java.lang.String str = f278993i;
        try {
            a5.a0.c().a(str, "Registering network callback", new java.lang.Throwable[0]);
            this.f278994g.registerDefaultNetworkCallback(this.f278995h);
    ...
    public void d() {
        ...
        try {
            ...
            this.f278994g.unregisterNetworkCallback(this.f278995h);
        } catch (java.lang.IllegalArgumentException | java.lang.SecurityException e17) {
    ...
    public f5.b e() {
        ...
        android.net.ConnectivityManager connectivityManager = this.f278994g;
        ...
        try {
            ...
            a5.a0.c().b(f278993i, "Unable to validate active network", e17);
        }
