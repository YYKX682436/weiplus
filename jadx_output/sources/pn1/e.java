...
public class e implements on1.i {
    ...
    public boolean a(r45.ed edVar, com.tencent.mm.storage.f9 f9Var) {
        ...
        boolean z18 = false;
        if (f9Var.z2()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.FastBackupItemImg", "complementMediaFile, msg.isClean");
            return false;
        }
        java.lang.String str = edVar.f373283h.f372756d;
        ...
        if (d17 != null) {
            z17 = com.tencent.mm.sdk.platformtools.t8.V((java.lang.String) d17.get(".msg.img.$hdlength"), 0L) > 0;
            java.util.Iterator it = edVar.f373290r.iterator();
            while (it.hasNext()) {
                if (((r45.eu5) it.next()).f373733d == 3) {
                    z17 = true;
                }
            }
        } else {
        ...
        if (f9Var.A0() == 1) {
            b27 = f9Var.getMsgId() != 0 ? f17.T1(f9Var.Q0(), f9Var.getMsgId()) : null;
        ...
        if (!b27.k()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.FastBackupItemImg", " complementMediaFile img == null");
            return false;
        }
        if (com.tencent.mm.vfs.w6.k(((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).mj(f9Var, b27.f322639g, true)) == 0) {
            ...
            f17.i1(f9Var, edVar.f373294v, y17, pString, pInt, pInt2);
            com.tencent.mars.xlog.Log.i("MicroMsg.FastBackupItemImg", "genThumb, pThumbWidth = " + pInt + ", pThumbHeight = " + pInt2);
            z18 = true;
        }
        java.lang.String bj6 = ((k90.b) ((tg3.u0) i95.n0.c(tg3.u0.class))).bj(f9Var, bm5.c0.f22550a.d(b27.l()), b27.f322637e, "", "", true, false);
        if (com.tencent.mm.vfs.w6.k(bj6) != 0) {
            return z18;
        }
        if (z17 && b27.j() && d18.k()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.FastBackupItemImg", "writeItem, BACKUPITEM_IMAGE_HD");
            kn1.k.F(edVar, 3, bj6);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.FastBackupItemImg", "writeItem, BACKUPITEM_IMAGE");
            kn1.k.F(edVar, 2, bj6);
        }
        ((t02.e) ((a00.i) i95.n0.c(a00.i.class))).bj(bj6, f9Var.getType(), null, null);
        return true;
    }
    ...
    */
    public int b(java.lang.String r31, r45.ed r32, com.tencent.mm.storage.f9 r33, on1.a r34) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public int c(r45.ed r31, boolean r32, com.tencent.mm.storage.f9 r33, java.lang.String r34, java.util.LinkedList r35, boolean r36) {
        /*
    ...
    public final java.lang.String d(java.lang.String str) {
        ...
        com.tencent.mm.vfs.r6 h07 = lp0.b.h0("MicroMsg.BackupMoveServer");
        if (!h07.m()) {
            h07.J();
        }
        com.tencent.mm.vfs.r6 n17 = h07.n();
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FastBackupItemImg", "convertFromWxam2Jpg, duration = " + (java.lang.System.currentTimeMillis() - currentTimeMillis) + ", ret = " + aj6);
