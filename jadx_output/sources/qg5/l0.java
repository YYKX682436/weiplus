...
public final class l0 extends jm0.o implements ct.q2 {
    ...
    public bc5.e f363059u;

    /* renamed from: w, reason: collision with root package name */
    public java.lang.String f363061w;

    /* renamed from: m, reason: collision with root package name */
    public final jz5.g f363051m = jz5.h.b(qg5.v.f363218d);

    /* renamed from: n, reason: collision with root package name */
    public final jz5.g f363052n = jz5.h.b(qg5.z.f363270d);

    /* renamed from: o, reason: collision with root package name */
    public final jz5.g f363053o = jz5.h.b(qg5.k0.f363031d);

    /* renamed from: p, reason: collision with root package name */
    public final jz5.g f363054p = jz5.h.b(qg5.j0.f363024d);

    /* renamed from: q, reason: collision with root package name */
    public final jz5.g f363055q = jz5.h.b(qg5.w.f363233d);

    /* renamed from: r, reason: collision with root package name */
    public final jz5.g f363056r = jz5.h.b(qg5.a0.f362900d);

    /* renamed from: s, reason: collision with root package name */
    public com.tencent.mm.feature.chatrecordstts.SupervisedLifecycleScope f363057s = new com.tencent.mm.feature.chatrecordstts.SupervisedLifecycleScope("ChatRecordsStagingFS", null, 0, 6, null);

    /* renamed from: t, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicReference f363058t = new java.util.concurrent.atomic.AtomicReference(null);

    /* renamed from: v, reason: collision with root package name */
    public final java.lang.Object f363060v = new java.lang.Object();
    ...
    public void Zi(boolean z17) {
        qg5.r rVar = (qg5.r) this.f363058t.get();
        if (rVar == null) {
            return;
        }
        ...
        while (true) {
            ...
            if ((obVar.f37374b == null || obVar.f37373a == null) ? false : true) {
                arrayList.add(next);
            }
        }
        java.util.Iterator it6 = arrayList.iterator();
        while (it6.hasNext()) {
            v65.i.b(this.f363057s, null, new qg5.u((c01.ob) it6.next(), this, z17, null), 1, null);
        }
    }

    public final tg3.u0 aj() {
        return (tg3.u0) ((jz5.n) this.f363051m).getValue();
    }
    ...
    */
    public java.lang.Object bj(java.util.List r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
        ...
        L13:
            ...
            r0.<init>(r6, r8)
        L18:
            java.lang.Object r8 = r0.f363250d
        ...
        L73:
            ...
            if (r0 == 0) goto L8b
            jz5.l r1 = new jz5.l
            java.lang.String r2 = r0.f413775a
            java.lang.String r0 = r0.f413776b
            r1.<init>(r2, r0)
            goto L8c
        L8b:
            r1 = 0
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object cj(com.tencent.mm.storage.f9 r10, boolean r11, kotlin.coroutines.Continuation r12) {
        /*
            r9 = this;
        ...
        L13:
            ...
            r0.<init>(r9, r12)
        L18:
            java.lang.Object r12 = r0.f363261f
            pz5.a r1 = pz5.a.f359186d
            int r2 = r0.f363263h
            r3 = 0
            r4 = 1
            ...
            if (r2 == 0) goto L3d
            if (r2 != r4) goto L35
            java.lang.Object r10 = r0.f363260e
            qg5.l0 r10 = (qg5.l0) r10
            java.lang.Object r11 = r0.f363259d
            com.tencent.mm.storage.f9 r11 = (com.tencent.mm.storage.f9) r11
    ...
    public final wf0.q1 fj() {
        return (wf0.q1) ((jz5.n) this.f363054p).getValue();
    }

    public final boolean hj(com.tencent.mm.storage.f9 f9Var) {
        v05.a aVar;
        ...
        if (f9Var.J2()) {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ChatRecordsStagingFeatureService", e17, "ImgMsg.fromXml failed", new java.lang.Object[0]);
                return false;
            }
        }
        if (f9Var.isVideo()) {
            ...
            try {
                ...
                dVar2.fromXml(str);
                y15.c n17 = dVar2.n();
                java.lang.String string = n17.getString(n17.f458922d + 5);
                return !(string == null || r26.n0.N(string));
            } catch (java.lang.Exception e18) {
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ChatRecordsStagingFeatureService", e18, "VideoMsg.fromXml failed", new java.lang.Object[0]);
                return false;
            }
        }
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ChatRecordsStagingFeatureService", e19, "[buildFileIdInfo] CommonMsg.fromXml failed", new java.lang.Object[0]);
            return false;
        }
    }
    ...
    public void ij() {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ChatRecordsStagingFeatureService", "releaseStagedChatRecords");
        kotlinx.coroutines.z0.d(this.f363057s, "Staged records were released", null, 2, null);
        this.f363057s = new com.tencent.mm.feature.chatrecordstts.SupervisedLifecycleScope("ChatRecordsStagingFS", null, 0, 6, null);
        synchronized (this.f363060v) {
            this.f363059u = null;
            this.f363061w = null;
        }
        qg5.r rVar = (qg5.r) this.f363058t.get();
        ...
        for (c01.ob obVar : rVar.f363152c) {
            c01.nb nbVar = obVar.f37374b;
            if (nbVar != null && (zVar2 = nbVar.f37352b) != null) {
                kotlinx.coroutines.p2.a(zVar2, null, 1, null);
            }
            c01.nb nbVar2 = obVar.f37374b;
            if (nbVar2 != null && (zVar = nbVar2.f37353c) != null) {
                kotlinx.coroutines.p2.a(zVar, null, 1, null);
            }
            kotlinx.coroutines.p2.a(obVar.f37375c, null, 1, null);
        }
        this.f363058t.set(null);
    }

    /* JADX WARN: Code restructure failed: missing block: B:113:0x01a1, code lost:
    
        if (com.tencent.mm.vfs.w6.j(r2) != false) goto L113;
     */
    /* JADX WARN: Code restructure failed: missing block: B:91:0x0148, code lost:
    
        r2 = r2.field_fileFullPath;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.String mj(com.tencent.mm.storage.f9 r13) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object nj(java.lang.String r20, kotlin.coroutines.Continuation r21) {
        /*
    ...
    public void oj(android.content.Context uiCtx, java.lang.String str, com.tencent.mm.storage.z3 z3Var, java.util.List messages, boolean z17) {
        c01.nb nbVar;
        int b17;
        kotlin.jvm.internal.o.g(uiCtx, "uiCtx");
        kotlin.jvm.internal.o.g(messages, "messages");
        if (this.f363058t.get() != null) {
        ...
        while (it.hasNext()) {
            com.tencent.mm.storage.f9 message = (com.tencent.mm.storage.f9) it.next();
            kotlin.jvm.internal.o.g(message, "message");
            int type = message.getType();
            if (type == 3 || type == 13 || type == 23 || type == 33 || type == 39 || type == 62 || type == 268435505 || type == 1090519089 || type == 43 || type == 44 || (message.getType() == 49 || message.k2() ? (b17 = g95.e0.b(message)) == 2 || b17 == 4 || b17 == 6 || b17 == 74 || b17 == 130 || b17 == 131 : message.J2() || message.isVideo() || message.n2() || message.o2())) {
                java.lang.String uuid = java.util.UUID.randomUUID().toString();
                kotlin.jvm.internal.o.f(uuid, "toString(...)");
                nbVar = new c01.nb(uuid, kotlinx.coroutines.b0.a(null, 1, null), kotlinx.coroutines.b0.a(null, 1, null));
            } else {
                nbVar = null;
            }
            arrayList.add(new c01.ob(message, nbVar, kotlinx.coroutines.b0.a(null, 1, null)));
        }
        this.f363058t.set(new qg5.r(str, z3Var, arrayList));
        qg5.r rVar = (qg5.r) this.f363058t.get();
        if (rVar != null) {
        }
        synchronized (this.f363060v) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:101:0x024b, code lost:
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.ChatRecordsStagingFeatureService", "tryDownloadFile error: " + r0.getMessage(), r0);
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object pj(com.tencent.mm.storage.f9 r22, kotlin.coroutines.Continuation r23) {
        /*
