...
public abstract class b0 extends mu4.w {
    ...
    public static final nu4.k f340241J = new nu4.k(null);
    public static final java.util.Set K = kz5.o1.c("transfer-encoding");
    public static final com.tencent.mm.sdk.platformtools.v3 L;
    ...
    public final jz5.g E = jz5.h.b(nu4.a0.f340240d);
    public final mu4.x0 F;
    public final com.tencent.mm.app.s2 G;
    public final java.util.HashMap H;
    public final java.util.concurrent.ConcurrentHashMap I;

    static {
        com.tencent.mm.sdk.platformtools.o4 M2 = com.tencent.mm.sdk.platformtools.o4.M("__WebPrefetchLocalData__");
        kotlin.jvm.internal.o.f(M2, "getMMKV(...)");
        L = new com.tencent.mm.sdk.platformtools.v3(M2, 15552000L);
        M = jz5.h.b(nu4.i.f340253d);
        N = jz5.h.b(nu4.j.f340254d);
    ...
    */
    ...
    public cl0.g A0(java.lang.String type) {
        ...
        java.lang.Object value = ((jz5.n) this.f331456t).getValue();
        kotlin.jvm.internal.o.f(value, "getValue(...)");
        cl0.g a17 = ((cl0.g) value).a("client").a(type);
        kotlin.jvm.internal.o.f(a17, "getJSONObject(...)");
        return a17;
    }

    @Override // mu4.w
    public com.tencent.mm.plugin.appbrand.appcache.u3 B0() {
        return (com.tencent.mm.plugin.appbrand.appcache.u3) this.E.getValue();
    }

    public final com.tencent.mm.plugin.appbrand.appcache.u3 F0(java.lang.String str, boolean z17) {
        mu4.n nVar = mu4.w.f331452y;
        return mu4.n.b(nVar, nVar.a("prefetcher/" + str + ".wspkg", ku4.z.f312539a.k() == 1, ku4.z.i(str), str), new nu4.l(str, this), null, z17, 4, null);
    }
    ...
    */
    ...
    public final void H0(com.tencent.mm.plugin.appbrand.appcache.u3 u3Var, java.lang.String appId, yz5.l lVar) {
        ...
        if (hashMap.containsKey(concat)) {
            ...
            com.tencent.mm.plugin.appbrand.jsruntime.r x07 = x0(((java.lang.Number) obj).intValue());
            if (x07 != null) {
                if (lVar != null) {
                    lVar.invoke(x07);
                    return;
        ...
        java.lang.String d17 = com.tencent.mm.plugin.appbrand.appcache.v3.d(u3Var, "/prefetcher.js");
        if (!(d17.length() > 0)) {
            com.tencent.mars.xlog.Log.w(this.C, "createPrefetcherJsContext prefetcherJs is empty, appId: ".concat(appId));
            return;
        }
        com.tencent.mm.plugin.appbrand.jsruntime.r t07 = t0();
        new lu4.v(new nu4.m(concat, appId, this)).a(t07);
        new lu4.q(new nu4.y(this, appId)).a(t07);
        mu4.w.z0(this, t07, "WebPrefetcher#".concat(appId), "prefetcher", null, new mu4.i(appId, A0("prefetcher").getLong("idKey")), 8, null);
        ((com.tencent.mm.plugin.appbrand.jsruntime.n) t07).evaluateJavascript(d17, new nu4.o(this, concat, t07, appId, "/prefetcher.js", lVar));
    }

    public final java.lang.Object I0(nu4.a aVar, java.lang.String str, java.util.List list, kotlin.coroutines.Continuation continuation) {
    ...
    public final synchronized void J0(nu4.a manifest, java.lang.String func, java.util.List list, yz5.l callback) {
        ...
        if (str == null) {
            str = nu4.d0.a(nu4.d0.b(manifest) + '-' + manifest.f340234b.f380231e);
        }
        ...
        if (this.H.containsKey(str2)) {
            ...
            if (c0Var.f310112d) {
                com.tencent.mars.xlog.Log.i(this.C, "invoke pending create, enqueue: id=" + str2 + " func=" + func);
                concurrentLinkedDeque.add(new nu4.s(this, str2, func, list, callback));
            } else {
                com.tencent.mars.xlog.Log.i(this.C, "invoke create start: id=" + str2 + " func=" + func);
