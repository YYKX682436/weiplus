...
public abstract class n0 {
    public static final void a(int i17, int i18, int i19, boolean z17, java.lang.String str) {
        ...
        com.tencent.mars.xlog.Log.i("SnsAdUtilKt", "idkey, id=" + i17 + ". key=" + i18 + ", count=" + i19 + ", reportKv=" + z17);
        if (i19 <= 0) {
    ...
    public static final boolean c(android.content.Context context) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("isActivityFinishing", "com.tencent.mm.plugin.sns.data.SnsAdUtilKt");
        android.app.Activity activity = context instanceof android.app.Activity ? (android.app.Activity) context : null;
        boolean z17 = true;
        if (activity == null) {
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("isActivityFinishing", "com.tencent.mm.plugin.sns.data.SnsAdUtilKt");
            return true;
        }
    ...
    */
    public static final boolean d(java.lang.String r10) {
        ...
        L26:
            ...
            r9 = 0
            java.util.Map r7 = com.tencent.mm.sdk.platformtools.aa.d(r10, r7, r9)     // Catch: java.lang.Throwable -> L45
            if (r7 == 0) goto L58
    ...
    public static final int e(java.lang.String str, int i17) {
        ...
        int parseInt;
        int parseInt2;
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("parseColorStr", "com.tencent.mm.plugin.sns.data.SnsAdUtilKt");
        if (str != null) {
            try {
                obj = r26.n0.u0(str).toString();
            } catch (java.lang.Throwable th6) {
                ca4.q.c("ad_dynamic_error", th6);
                com.tencent.mars.xlog.Log.w("SnsAdUtilKt", "parse color from string failed, return default value!");
            }
            if (obj != null) {
                ...
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("parseColorStr", "com.tencent.mm.plugin.sns.data.SnsAdUtilKt");
                return i18;
            }
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("parseColorStr", "com.tencent.mm.plugin.sns.data.SnsAdUtilKt");
