...
public final class l extends oh5.d {
    ...
    public static volatile int f345504f;

    /* renamed from: g, reason: collision with root package name */
    public static final java.util.HashMap f345505g = new java.util.HashMap();

    /* renamed from: h, reason: collision with root package name */
    public static boolean f345506h;

    /* renamed from: d, reason: collision with root package name */
    public java.util.List f345507d;

    /* renamed from: e, reason: collision with root package name */
    public final oh5.q[] f345508e;

    public l() {
        f345505g.put(java.lang.Integer.valueOf(f345504f), this);
        this.f345508e = new oh5.q[]{new oh5.q("FTSMainUI", oh5.r.a("2022-12-28")), new oh5.q("MMWebViewUI", oh5.r.a("2022-12-28")), new oh5.q("TmplWebViewMMUI", oh5.r.a("2022-12-28"))};
    }
    ...
    */
    public void a(android.content.Intent r15) {
        /*
            ...
            java.util.HashMap r1 = oh5.l.f345505g
        ...
        L2a:
            ...
            r9 = r8
            oi.e r9 = (oi.e) r9
            oi.h r10 = oi.h.f345567e
            java.util.List r11 = r10.f345569b
            monitor-enter(r11)
            java.util.List r12 = r10.f345569b     // Catch: java.lang.Throwable -> L71
        ...
        L49:
            ...
            if (r12 != 0) goto L6a
            java.util.List r11 = r10.f345571d
            monitor-enter(r11)
            java.util.List r10 = r10.f345571d     // Catch: java.lang.Throwable -> L67
            long r12 = r9.f345561g     // Catch: java.lang.Throwable -> L67
    ...
    public java.lang.String c() {
        return com.tencent.mm.ui.matrix.MatrixOpenGLLeakResultUI.class.getName();
    }

    public final java.util.List d() {
        java.util.List list = this.f345507d;
        if (list != null) {
            return list;
        }
        kotlin.jvm.internal.o.o("openGLInfoList");
        throw null;
    }
    ...
    public final void e(java.util.List list) {
        ...
        if (f345506h) {
            com.tencent.mars.xlog.Log.i("MicroMsg.MatrixOpenGLLeakResultHelper", "muted");
            return;
        }
        ...
        while (true) {
            ...
            oi.e eVar = (oi.e) next;
            java.lang.String name = eVar.f345565k.f354493b;
            kotlin.jvm.internal.o.f(name, "name");
            java.util.ArrayList arrayList2 = new java.util.ArrayList();
            oh5.q[] qVarArr = this.f345508e;
            ...
            if (!arrayList2.isEmpty()) {
                ...
                while (true) {
                    if (it6.hasNext()) {
                        if (r26.n0.D(name, (java.lang.CharSequence) ((oh5.q) it6.next()).f345518a, false, 2, null)) {
                            z17 = true;
                            break;
                        }
                    } else {
            ...
            if (z17) {
                com.tencent.mars.xlog.Log.i("MicroMsg.MatrixOpenGLLeakResultHelper", "leak white list: " + eVar3);
            }
            if (!z17) {
                arrayList.add(next);
            }
        ...
        for (java.lang.Object obj : arrayList) {
            kotlin.jvm.internal.o.f(((oi.e) obj).a(), "getJavaStack(...)");
            if (!r26.n0.B(r6, "com.tencent.matrix.openglleak.utils.EGLHelper", false)) {
                arrayList3.add(obj);
            }
        }
        this.f345507d = arrayList3;
        if (d().isEmpty()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.MatrixOpenGLLeakResultHelper", "no leak");
        } else {
