...
public abstract class e {
    public static void a(b21.r rVar, boolean z17) {
        ...
        java.lang.String str3 = rVar.f17351m;
        if (str3 != null) {
            v70Var.q(str3);
        }
        ...
        java.lang.String str5 = rVar.f17349h;
        if (str5 != null) {
            z90Var.C(str5);
        }
        java.lang.String str6 = rVar.f17354p;
        if (str6 != null) {
            z90Var.B(str6);
        }
        java.lang.String str7 = rVar.f17352n;
        if (str7 != null) {
            z90Var.z(str7);
        }
        java.lang.String str8 = rVar.f17358t;
        if (str8 != null) {
            z90Var.y(str8);
        }
        java.lang.String str9 = rVar.f17351m;
        if (str9 != null) {
            z90Var.r(str9);
        }
        java.lang.String str10 = rVar.f17350i;
        if (str10 != null) {
            z90Var.q(str10);
        }
        java.lang.String str11 = rVar.f17355q;
        if (str11 != null) {
            z90Var.x(str11);
        }
        java.lang.String str12 = rVar.P;
        if (str12 != null) {
            z90Var.A(str12);
        }
        v70Var.w(z90Var);
