...
public final class f extends y9.c {
    ...
    public final /* synthetic */ wd2.g f444830a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ float f444831b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ float f444832c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ float f444833d;
    ...
    public void a(android.view.View view, float f17) {
        ...
        if (isNaN) {
            ...
            float max = java.lang.Math.max(java.lang.Math.min(java.lang.Math.abs(a17 ? height * (1.0f - java.lang.Math.abs(f17)) : height * f17) / this.f444831b, 1.0f), 0.0f);
            f19 = max;
        ...
        android.view.ViewGroup.LayoutParams layoutParams = gVar.f444849p.getLayoutParams();
        kotlin.jvm.internal.o.f(layoutParams, "getLayoutParams(...)");
        float f27 = this.f444833d;
        float f28 = this.f444832c;
        layoutParams.height = (int) (f28 + (f19 * (f27 - f28)));
        gVar.f444849p.setLayoutParams(layoutParams);
        android.view.View view2 = gVar.f444850q;
    ...
    public void b(android.view.View view, int i17) {
        ...
        wd2.g gVar = this.f444830a;
        sb6.append(gVar.f444836c.f());
        com.tencent.mars.xlog.Log.i("FinderLiveBottomSheet", sb6.toString());
        if (i17 == 5 && gVar.f444836c.f()) {
            gVar.f444836c.q();
        }
        if (i17 == 4 && gVar.a() && gVar.f444836c.f()) {
            gVar.f444836c.q();
        }
    }
}
