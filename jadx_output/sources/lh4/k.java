...
public final class k implements java.lang.Runnable {
    ...
    public final /* synthetic */ lh4.l f318718d;
    ...
    public final void run() {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TaskBarView", "onGuideClick isTingEntryClose: %s, discoverCtrlFlag: %s", java.lang.Boolean.valueOf(z17), java.lang.Long.valueOf(h17));
        lh4.l lVar = this.f318718d;
        if (z17) {
            lVar.getClass();
            com.tencent.mars.xlog.Log.i("MicroMsg.TaskBarSectionMusicGuideView", "jumpToSettingsAndOpenHalfScreen");
            android.content.Intent intent = new android.content.Intent();
            intent.putExtra("KEY_START_HALF_ACTIVITY_PREFERENCE", "settings_ting_switch");
            java.lang.Long TASKBAR_MUSIC_GUIDE = com.tencent.mm.ui.t2.f209870d;
            kotlin.jvm.internal.o.f(TASKBAR_MUSIC_GUIDE, "TASKBAR_MUSIC_GUIDE");
        ...
        lVar.getClass();
        com.tencent.mars.xlog.Log.i("MicroMsg.TaskBarSectionMusicGuideView", "jumpToDiscoverAndHighLight");
