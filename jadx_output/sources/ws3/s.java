...
public class s implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ ws3.y f449190d;
    ...
    public void onClick(android.view.View view) {
        ...
        us3.e.Ai().Ni(null);
        ws3.y yVar = this.f449190d;
        android.widget.EditText editText = yVar.f449204n.f155164f;
        if (editText != null) {
            editText.setText("");
        }
        java.util.LinkedList linkedList = new java.util.LinkedList();
        synchronized (yVar) {
            yVar.f449199f = linkedList;
            yVar.notifyDataSetChanged();
        }
        if (yVar.f449206p != null) {
