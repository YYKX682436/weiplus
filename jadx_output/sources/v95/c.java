...
public abstract class c {
    ...
    public static final java.util.Comparator f434178a = new v95.b();

    public static java.util.List a(u95.a aVar) {
        int min = (int) java.lang.Math.min(32768, aVar.f425891h);
        byte[] bArr = new byte[min];
        long j17 = min;
        long j18 = aVar.f425891h - j17;
        aVar.a(j18, j17);
        int i17 = 0;
        ...
        long j28 = b18;
        java.util.Collections.sort(arrayList, f434178a);
        while (i17 < arrayList.size()) {
            v95.a aVar2 = (v95.a) arrayList.get(i17);
            long j29 = i17 < arrayList.size() - 1 ? ((v95.a) arrayList.get(i17 + 1)).f434175g : j28;
            long j37 = aVar2.f434175g;
            aVar.a(j37, j29 - j37);
            if (((int) v95.d.b(aVar)) != 67324752) {
                throw new java.util.zip.ZipException("Bad local entry header");
            }
            v95.d.e(aVar, 22);
            aVar2.f434176h = aVar2.f434175g + v95.d.a(aVar) + 30 + v95.d.a(aVar);
            i17++;
        }
        return arrayList;
    }
