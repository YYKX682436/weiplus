...
public class d extends m95.b {
    ...
    public d(android.graphics.Picture picture, int i17) {
        ...
        this.f325089i = new m95.c(picture, i17);
        this.f325079b.set(0, 0, this.f325084g, this.f325085h);
    }

    public void c() {
        m95.c cVar = this.f325089i;
        android.graphics.Bitmap bitmap = cVar.f325087b;
        if (bitmap == null || bitmap.isRecycled()) {
            return;
        }
        n95.d.b("MicroMsg.SVGPictureDrawable", "recycle bitmap:%s", cVar.f325087b.toString());
        cVar.f325087b.recycle();
        cVar.f325087b = null;
    }
    ...
    public void d() {
        int i17;
        m95.c cVar = this.f325089i;
        android.graphics.Picture picture = cVar.f325086a;
        int i18 = this.f325078a;
        if (picture == null) {
        ...
        android.graphics.Bitmap bitmap = cVar.f325087b;
        if (bitmap == null || bitmap.isRecycled()) {
            int i19 = this.f325084g;
            if (i19 > 2048 || (i17 = this.f325085h) > 2048) {
            ...
            cVar.f325086a.draw(canvas);
            cVar.f325087b = createBitmap;
    ...
    */
    public void draw(android.graphics.Canvas r15) {
        /*
            ...
            r14.f325083f = r5     // Catch: java.lang.Throwable -> L1d
        ...
        L20:
            ...
            android.graphics.Rect r6 = r14.f325079b
            m95.c r7 = r14.f325089i
            android.graphics.Paint r8 = r14.f325081d
        ...
        L49:
            ...
            android.graphics.Bitmap r5 = r7.f325087b     // Catch: java.lang.Throwable -> L1a
            if (r5 == 0) goto L7b
            boolean r5 = r5.isRecycled()     // Catch: java.lang.Throwable -> L1a
            if (r5 == 0) goto L5d
            goto L7b
        L5d:
            boolean r5 = r14.f325080c     // Catch: java.lang.Throwable -> L1a
            if (r5 == 0) goto L6e
            android.graphics.Rect r5 = r14.getBounds()     // Catch: java.lang.Throwable -> L1a
            android.graphics.Rect r11 = r14.f325079b     // Catch: java.lang.Throwable -> L1a
            int r12 = r14.f325084g     // Catch: java.lang.Throwable -> L1a
            int r13 = r14.f325085h     // Catch: java.lang.Throwable -> L1a
            android.view.Gravity.apply(r9, r12, r13, r5, r11)     // Catch: java.lang.Throwable -> L1a
        L6e:
            r14.f325080c = r10     // Catch: java.lang.Throwable -> L1a
            android.graphics.Bitmap r5 = r7.f325087b     // Catch: java.lang.Throwable -> L1a
            r11 = 0
        ...
        L7c:
            ...
            android.graphics.Picture r4 = r7.f325086a     // Catch: java.lang.Throwable -> L1a
            if (r4 == 0) goto La4
            boolean r5 = r14.f325080c     // Catch: java.lang.Throwable -> L1a
            if (r5 == 0) goto L99
            android.graphics.Rect r5 = r14.getBounds()     // Catch: java.lang.Throwable -> L1a
            android.graphics.Rect r7 = r14.f325079b     // Catch: java.lang.Throwable -> L1a
            int r8 = r14.f325084g     // Catch: java.lang.Throwable -> L1a
            int r11 = r14.f325085h     // Catch: java.lang.Throwable -> L1a
