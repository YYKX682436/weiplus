...
public final class t implements android.view.View.OnClickListener {
    ...
    public static final f41.t f259514d = new f41.t();
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.OVC.SelectContactCard", "contentContainer clicked, event consumed (should not trigger close)");
