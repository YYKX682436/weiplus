...
public class util {
    ...
    public static int f345663a = 1;

    /* renamed from: b, reason: collision with root package name */
    public static k36.c f345664b;

    public static java.security.Key RSAPrivKeyFromJNI(byte[] bArr) {
        if (bArr == null) {
            return null;
        }
        byte[] bArr2 = {48, -126, 2, 117, 2, 1, 0, 48, 13, 6, 9, 42, -122, 72, -122, -9, 13, 1, 1, 1, 5, 0, 4, -126, 2, 95};
        int length = bArr.length + org.chromium.net.NetError.ERR_FTP_BAD_COMMAND_SEQUENCE;
    ...
    public static java.security.Key RSAPubKeyFromJNI(byte[] bArr) {
        boolean z17;
        if (bArr == null) {
            return null;
        }
    ...
    public static void a(java.lang.String str) {
        k36.c cVar;
        try {
            if (f345663a < 2 || (cVar = f345664b) == null) {
                return;
            }
            ((com.tencent.mm.modelbase.m3) cVar).a(2, "", str);
    ...
    public static void c(java.lang.String str) {
        k36.c cVar;
        try {
            if (f345663a < 1 || (cVar = f345664b) == null) {
                return;
            }
            ((com.tencent.mm.modelbase.m3) cVar).a(1, "", str);
        } catch (java.lang.Exception unused) {
        }
    }
    ...
    public static void d(java.lang.String str, java.lang.String str2) {
        k36.c cVar;
        try {
            if (f345663a < 0 || (cVar = f345664b) == null) {
                return;
            }
            cVar.a(0, str, str2);
        } catch (java.lang.Exception unused) {
    ...
    public static int g(byte[] bArr, int i17) {
        return ((bArr[i17] << 24) & (-16777216)) + ((bArr[i17 + 1] << com.tencent.wxmm.v2encoder.enumCODEC_vcodec2) & 16711680) + ((bArr[i17 + 2] << 8) & 65280) + ((bArr[i17 + 3] << 0) & 255);
    }
