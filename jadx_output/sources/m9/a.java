...
public final class a extends i9.b {
    ...
    public static final java.util.regex.Pattern f324835n = java.util.regex.Pattern.compile("\\s*((?:(\\d+):)?(\\d+):(\\d+),(\\d+))\\s*-->\\s*((?:(\\d+):)?(\\d+):(\\d+),(\\d+))?\\s*");

    /* renamed from: m, reason: collision with root package name */
    public final java.lang.StringBuilder f324836m;

    public a() {
        super("SubripDecoder");
        this.f324836m = new java.lang.StringBuilder();
    }
    ...
    */
    public i9.d f(byte[] r8, int r9, boolean r10) {
        ...
        L1d:
            ...
            goto L9f
        L28:
            java.util.regex.Pattern r3 = m9.a.f324835n
        ...
        L63:
            ...
            r9 = r6
        L65:
            java.lang.StringBuilder r2 = r7.f324836m
            r2.setLength(r8)
        L6a:
