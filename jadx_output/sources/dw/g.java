...
public final class g extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ com.tencent.mm.storage.f9 f244076d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(com.tencent.mm.storage.f9 f9Var) {
        super(0);
        this.f244076d = f9Var;
    }
    ...
    public java.lang.Object invoke() {
        java.util.Map a17 = uw.f.f431490a.a(uw.e.f431486d, this.f244076d);
        if (a17 == null || com.tencent.mm.sdk.platformtools.t8.K0((java.lang.String) a17.get(".msg.appmsg.mmreader.notify_msg.act"))) {
            return "";
        }
