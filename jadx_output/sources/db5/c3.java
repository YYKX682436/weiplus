...
public class c3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ db5.d3 f228303d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ db5.f3 f228304e;
    ...
    public void onClick(android.view.View view) {
        ...
        db5.f3 f3Var = this.f228304e;
        java.lang.String trim = (f3Var.M.getText() == null || f3Var.M.getText().toString() == null) ? "" : f3Var.M.getText().toString().trim();
        db5.d3 d3Var = this.f228303d;
        if (d3Var != null && !com.tencent.mm.sdk.platformtools.t8.K0(trim)) {
            d3Var.a(trim);
        }
