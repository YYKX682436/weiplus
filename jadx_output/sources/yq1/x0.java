...
public final class x0 implements zq1.m0 {
    public void a(java.lang.String str, java.lang.String str2, java.lang.String url) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WebPrefetcherCacheManager", "clearPrefetchContent webId: " + str + ", bizId: " + str2);
        com.tencent.mm.vfs.r6 Q = nu4.b0.P.Q(str2);
        if (Q.m()) {
            Q.l();
        }
        com.tencent.mm.sdk.platformtools.o4 o4Var = (com.tencent.mm.sdk.platformtools.o4) com.tencent.mm.plugin.brandservice.ui.timeline.preload.t2.f94447c.d(str2);
        if (o4Var != null) {
            o4Var.remove(str2);
        }
        if (str == null) {
        ...
        com.tencent.mm.sdk.platformtools.o4 o4Var2 = (com.tencent.mm.sdk.platformtools.o4) ts1.p.f421613b.d(str);
        if (o4Var2 != null) {
            o4Var2.W(str);
        }
    }
    ...
    public zq1.j0 b(java.lang.String url, java.lang.String str) {
        ...
        if (b17.length() == 0) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.WebPrefetcherCacheManager", "getPrefetchContentResp id: %s, prefetchInfoId: %s", i17, b17);
            ts1.p pVar = ts1.p.f421612a;
            java.lang.String s17 = ts1.p.f421613b.s(b17, "");
    ...
    public int c(java.lang.String str) {
        com.tencent.mm.sdk.platformtools.v3 v3Var = at1.a.f13631a;
        if (str == null) {
            return 0;
        }
        java.lang.String i17 = com.tencent.mm.plugin.brandservice.ui.timeline.preload.d.i(str, false);
        com.tencent.mm.sdk.platformtools.o4 o4Var = (com.tencent.mm.sdk.platformtools.o4) at1.a.f13631a.d(i17);
        if (o4Var != null) {
    ...
    public boolean d(int i17, java.lang.String str) {
        ...
        if (!z18 && i17 == 4) {
            if (!(str == null || r26.n0.N(str))) {
                try {
                    z18 = kotlin.jvm.internal.o.b(android.net.Uri.parse(str).getHost(), "wzq.tenpay.com");
                } catch (java.lang.Exception e17) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.WebPrefetchServiceImpl", "isEntranceOpen ex=" + e17.getMessage());
                }
            }
        }
    ...
    */
    public void f(java.util.List r7, int r8) {
        ...
        L25:
            ...
            r1 = r0
            zq1.i0 r1 = (zq1.i0) r1
            java.lang.String r2 = r1.f474983a
            java.lang.String r3 = "url"
            kotlin.jvm.internal.o.f(r2, r3)
            boolean r2 = com.tencent.mm.plugin.brandservice.ui.timeline.preload.t2.h(r2)
            if (r2 == 0) goto L5b
            java.lang.String r2 = r1.f474983a
            kotlin.jvm.internal.o.f(r2, r3)
            java.lang.String r4 = ":"
            ...
            if (r2 == 0) goto L5c
            java.lang.String r1 = r1.f474983a
        ...
        L62:
            r0 = -1
            com.tencent.mm.plugin.brandservice.ui.timeline.preload.t2.k(r0, r8)
            return
        */
    ...
    */
    ...
    public void h(java.util.List preAuthInfoList) {
        kotlin.jvm.internal.o.g(preAuthInfoList, "preAuthInfoList");
        g(-1L, preAuthInfoList);
    }

    public void i(java.util.List preAuthInfoList) {
        kotlin.jvm.internal.o.g(preAuthInfoList, "preAuthInfoList");
        com.tencent.mars.xlog.Log.i("MicroMsg.WebPrefetchServiceImpl", "preloadVideo:" + java.lang.Integer.valueOf(preAuthInfoList.size()));
        if (preAuthInfoList.isEmpty()) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WebPrefetchServiceImpl", "preloadVideo preAuthInfoList is null or empty");
            return;
        }
        java.util.Iterator it = preAuthInfoList.iterator();
        while (it.hasNext()) {
            zq1.i0 i0Var = (zq1.i0) it.next();
            com.tencent.mm.plugin.brandservice.ui.timeline.preload.u.f94451a.f(i0Var.f474983a, -1, i0Var.f474991i);
        }
    }
}
