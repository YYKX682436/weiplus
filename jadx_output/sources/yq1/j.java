...
public final class j implements q25.a {
    ...
    public static final yq1.e f464436b = new yq1.e(null);

    /* renamed from: c, reason: collision with root package name */
    public static boolean f464437c = true;

    /* renamed from: a, reason: collision with root package name */
    public final jz5.g f464438a = jz5.h.b(yq1.f.f464429d);
    ...
    public boolean a(android.content.Context context, java.lang.String[] strArr, java.lang.String str) {
        ...
        int i17 = 0;
        i17 = 0;
        if (strArr != null && kotlin.jvm.internal.o.b("//biz", strArr[0])) {
            if (kotlin.jvm.internal.o.b("openrectimeline", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineOpenStatus", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                return true;
            }
            boolean b17 = kotlin.jvm.internal.o.b("openfluttertimeline", strArr[1]);
            yq1.e eVar = f464436b;
            if (b17 && strArr.length > 2) {
                b().A("BizTimeLineOpenFlutter", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("openflutterAfftimeline", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineUserAff", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("recFeed", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineRecFeedStatus", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                return true;
            }
            if (kotlin.jvm.internal.o.b("finderLive", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineFinderLiveStatus", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                return true;
            }
            if (kotlin.jvm.internal.o.b("biztlbold", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineTitleBold", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("showbottomnav", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.o4.M("WebViewUIShowBottom").A("WebViewUIShowBottomNav", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                return true;
            }
            if (kotlin.jvm.internal.o.b("adautotest", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineAdOpen", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().A("BizTimeLineAdTestMode", com.tencent.mm.sdk.platformtools.t8.P(strArr[3], -1));
                b().A("BizAdInsertPos", com.tencent.mm.sdk.platformtools.t8.P(strArr[4], -1));
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("autoreboot", strArr[1]) && strArr.length > 2) {
                f464437c = com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1) == 1;
                return true;
            }
            if (kotlin.jvm.internal.o.b("deleteolddata", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineDeleteOldData", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                return true;
            }
            java.util.Map map = null;
            if (kotlin.jvm.internal.o.b("addPayAlbum", strArr[1]) && strArr.length > 2) {
                byte[] decode = android.util.Base64.decode(strArr[2], 2);
                kotlin.jvm.internal.o.f(decode, "decode(...)");
                java.lang.String str2 = new java.lang.String(decode, r26.c.f368865a);
                ...
                if (L != -1) {
                    ...
                    if (map == null) {
                        com.tencent.mars.xlog.Log.e("//biz", "XmlParser values is null, msgContent %s", str2);
                        return true;
                    }
                }
                eq1.z.f255876a.b(map, str2);
                return true;
            }
            if (kotlin.jvm.internal.o.b("paySuccess", strArr[1]) && strArr.length > 2) {
                byte[] decode2 = android.util.Base64.decode(strArr[2], 2);
                kotlin.jvm.internal.o.f(decode2, "decode(...)");
                java.util.Map d17 = com.tencent.mm.sdk.platformtools.aa.d(new java.lang.String(decode2, r26.c.f368865a), "sysmsg", null);
                lr1.f fVar = lr1.f.f320657a;
                kotlin.jvm.internal.o.d(d17);
                fVar.c(d17);
                return true;
            }
            if (kotlin.jvm.internal.o.b("profileCrash", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.o4.R("ProfileCrashCheck").A("testCrash", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 1));
                return true;
            }
            if (kotlin.jvm.internal.o.b("updateAppInfo", strArr[1]) && strArr.length > 2) {
                java.lang.String str3 = strArr[2];
                if (com.tencent.mm.sdk.platformtools.t8.K0(str3)) {
                    return true;
                }
                ((ku5.t0) ku5.t0.f312615d).h(new yq1.h(str3), "GetAppInfoASyncThread");
                return true;
            }
            if (kotlin.jvm.internal.o.b("resortbizmsgcheck", strArr[1]) && strArr.length > 2) {
                int P = com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 1);
            ...
            if (kotlin.jvm.internal.o.b("recycleCardCheck", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineRecycleCardCheck", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 1));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("updateCard", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineUpdateCard", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 1));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("showdigest", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineShowDigest", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                b().getClass();
                return true;
            }
            if (kotlin.jvm.internal.o.b("oftenread", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1);
                eq1.n0 n0Var = eq1.n0.f255837a;
                return true;
            }
            if (kotlin.jvm.internal.o.b("videochannel", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1);
                eq1.n0 n0Var2 = eq1.n0.f255837a;
                return true;
            }
            if (kotlin.jvm.internal.o.b("sl", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.o4.M("bizCommand").A("sameLayerOpen", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], -1));
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("adtest", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineAdTestMode", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("setadquata", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineHardcodeAdQuota", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("setadexposecount", strArr[1]) && strArr.length > 2) {
                int P2 = com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0);
                com.tencent.mm.storage.u wi6 = r01.q3.wi();
                wi6.getClass();
                ((ku5.t0) ku5.t0.f312615d).g(new com.tencent.mm.storage.t(wi6, P2));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("forbidDeleteCanvasFromJS", strArr[1]) && strArr.length > 2) {
                b().G("forbidDeleteCanvasFromJS", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0) == 1);
                b().getClass();
                return true;
            }
            if (kotlin.jvm.internal.o.b("testAdCrashEnv", strArr[1]) && strArr.length > 2) {
                b().G("testAdCrashEnv", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0) == 1);
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("clearTestAdCrash", strArr[1])) {
                ((com.tencent.mm.sdk.platformtools.o4) ((com.tencent.mm.sdk.platformtools.v3) ((jz5.n) eq1.n0.f255839c).getValue()).i()).clear();
                return true;
            }
            if (kotlin.jvm.internal.o.b("adtestext", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.o4.R("brandService").D("BizTimeLineAdTestExtInfo", strArr[2]);
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("adtestaction", strArr[1]) && strArr.length > 2) {
                ((yq1.z) ((zq1.a0) gm0.j1.s(zq1.a0.class))).e("wxa06c02b5c00ff39b", null, "adTestExtAction", "data:" + strArr[2]);
                return true;
            }
            if (kotlin.jvm.internal.o.b("ad", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineAdOpen", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("adprefetch", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineAdPrefetcherOpen", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("adInsertPos", strArr[1]) && strArr.length > 2) {
                b().A("BizAdInsertPos", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 3));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("clearadexposetime", strArr[1])) {
                com.tencent.mm.sdk.platformtools.o4.R("biz_timeline_ad").B("BizLastExposeAdTime", 0L);
                return true;
            }
            if (kotlin.jvm.internal.o.b("clearadexposecount", strArr[1])) {
                r01.q3.wi().y0();
                return true;
            }
            if (kotlin.jvm.internal.o.b("clearpkg", strArr[1])) {
                ku4.z.f312539a.c(true);
                return true;
            }
            if (kotlin.jvm.internal.o.b("adpreview", strArr[1]) && strArr.length > 2) {
                com.tencent.mm.sdk.platformtools.o4.M("WebCanvasStorage").A("BizTimeLineAdPkgPreviewMode", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0));
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("test", strArr[1]) && strArr.length > 2) {
                b().A("BizTimeLineTestMode", com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0));
                b().getClass();
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("checkfinderreddot", strArr[1])) {
                com.tencent.mm.pluginsdk.model.b0 b0Var = com.tencent.mm.pluginsdk.model.b0.f189197a;
                b0Var.b();
                r45.fm6 a17 = bs1.a.a();
                if (a17 != null && (linkedList2 = a17.f374454d) != null) {
                    b0Var.s(linkedList2);
                }
                dp.a.makeText(com.tencent.mm.sdk.platformtools.x2.f193071a, "Success!", 1).show();
                return true;
            }
            if (kotlin.jvm.internal.o.b("addfinderreddot", strArr[1])) {
                eVar.a();
                return true;
            }
            if (kotlin.jvm.internal.o.b("mockInsertAdCanvas", strArr[1])) {
                com.tencent.wechat.mm.biz.b1 b18 = yw.q3.f466437a.b();
                if (b18 != null) {
                    b18.c(1, "frameSetName-" + java.lang.System.currentTimeMillis(), "frameSetData-" + java.lang.System.currentTimeMillis());
                }
                return true;
            }
            if (kotlin.jvm.internal.o.b("setAdRequestInfo", strArr[1])) {
                com.tencent.wechat.mm.biz.b1 b19 = yw.q3.f466437a.b();
                if (b19 != null) {
                    b19.e("adFetchControl-" + java.lang.System.currentTimeMillis(), "adFetchInfo-" + java.lang.System.currentTimeMillis());
                }
                return true;
            }
            if (kotlin.jvm.internal.o.b("getAllDynamicCardInfo", strArr[1])) {
                com.tencent.wechat.mm.biz.b1 b27 = yw.q3.f466437a.b();
                com.tencent.wechat.mm.biz.r3 b28 = b27 != null ? b27.b(1) : null;
                java.lang.StringBuilder sb6 = new java.lang.StringBuilder("getAllDynamicCardInfo size = ");
                if (b28 != null && (linkedList = b28.f218522d) != null) {
                    i17 = linkedList.size();
                }
                sb6.append(i17);
                com.tencent.mars.xlog.Log.i("MicroMsg.BizProcessorCommand", sb6.toString());
                return true;
            }
            if (kotlin.jvm.internal.o.b("flutterFlingFactor", strArr[1]) && strArr.length > 3) {
                b().z("flingFriction", com.tencent.mm.sdk.platformtools.t8.L(strArr[2], 0.01f));
                b().z("minFlingVelocityFactor", com.tencent.mm.sdk.platformtools.t8.L(strArr[3], 5.0f));
                eVar.b();
                return true;
            }
            if (kotlin.jvm.internal.o.b("videofetchdebug", strArr[1])) {
                eq1.n0.f255843g = true;
                com.tencent.mars.xlog.Log.i("MicroMsg.BizProcessorCommand", "mpManifestPath=" + ((java.lang.String) ((jz5.n) eq1.n0.f255842f).getValue()));
                return true;
            }
            if (kotlin.jvm.internal.o.b("clearsubscribemsg", strArr[1])) {
                ((ba0.h) ((ca0.e) i95.n0.c(ca0.e.class))).getClass();
                k31.h.f303839a.a();
                return true;
            }
            if (kotlin.jvm.internal.o.b("clearimg", strArr[1])) {
                ((ku5.t0) ku5.t0.f312615d).g(yq1.i.f464435d);
                return true;
            }
            if (kotlin.jvm.internal.o.b("gamejs", strArr[1]) && strArr.length > 2) {
            ...
            if (kotlin.jvm.internal.o.b("mbad", strArr[1]) && kotlin.jvm.internal.o.b("mock", strArr[2])) {
            ...
            if (kotlin.jvm.internal.o.b("mbad", strArr[1]) && strArr.length > 2) {
    ...
    public final com.tencent.mm.sdk.platformtools.o4 b() {
        return (com.tencent.mm.sdk.platformtools.o4) ((jz5.n) this.f464438a).getValue();
    }
}
