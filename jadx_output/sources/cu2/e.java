...
public final class e implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.model.BaseFinderFeed f222383d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f222384e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f222385f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ android.view.View f222386g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.e3 f222387h;

    /* renamed from: i, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f222388i;

    public e(com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed, android.view.View view, android.view.View view2, android.view.View view3, com.tencent.mm.plugin.finder.view.e3 e3Var, android.content.Context context) {
        this.f222383d = baseFinderFeed;
        this.f222384e = view;
        this.f222385f = view2;
        this.f222386g = view3;
        this.f222387h = e3Var;
        this.f222388i = context;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed = this.f222383d;
        b0Var.o(baseFinderFeed.getFeedObject().getId(), baseFinderFeed.getFeedObject().getFeedObject(), baseFinderFeed.getFeedObject().getObjectNonceId(), r45.uh2.SelectComment, new cu2.d(baseFinderFeed, this.f222388i));
        android.view.View view2 = this.f222384e;
        ...
        android.view.View view3 = this.f222385f;
        ...
        android.view.View view4 = this.f222386g;
