...
public final class e2 extends i95.w implements qc0.c1 {
    ...
    public final java.util.HashSet f353249d = new java.util.HashSet();

    public boolean Ai(androidx.activity.ComponentActivity ui6, android.os.Bundle bundle, androidx.activity.result.b callback) {
        ...
        if (bundle3 != null) {
            ui6.getActivityResultRegistry().c(bundle3);
            ...
            if (stringArrayList != null) {
                for (java.lang.String str : stringArrayList) {
                    ...
                    if (r26.i0.y(str, "media_opt_", false) && this.f353249d.contains(str)) {
                        ui6.getActivityResultRegistry().e(str, new pc0.a2(-1), new pc0.d2(str, this, callback));
                        com.tencent.mars.xlog.Log.i("MicroMsg.MediaOptService", "restoreCallback success key:".concat(str));
                        return true;
                    }
                }
            }
    ...
    */
    public java.lang.Object wi(androidx.activity.ComponentActivity r12, com.tencent.mm.plugin.recordvideo.jumper.RecordConfigProvider r13, kotlin.coroutines.Continuation r14) {
        /*
            r11 = this;
        ...
        L28:
            ...
            goto L60
        L4b:
            boolean r14 = com.tencent.mm.sdk.platformtools.t8.f192989a
            java.lang.String r14 = com.tencent.mm.sdk.platformtools.z3.b(r0)
            java.lang.Object[] r14 = new java.lang.Object[]{r14}
            java.lang.String r1 = "checkPermission %s"
            com.tencent.mars.xlog.Log.i(r7, r1, r14)
            goto L61
        L5b:
        ...
        L7d:
            ...
            com.tencent.mm.sdk.platformtools.Log.c(r7, r0, r1)
            boolean r0 = com.tencent.mm.ui.bk.Q()
            if (r0 != 0) goto Lbe
            boolean r0 = com.tencent.mm.ui.bk.A()
            if (r0 == 0) goto Lc3
        Lbe:
            java.util.HashSet r0 = r11.f353249d
            r0.add(r9)
        Lc3:
            androidx.activity.result.h r0 = r12.getActivityResultRegistry()
