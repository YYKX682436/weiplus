...
public class d implements p75.l {
    ...
    public final java.lang.String f352625a;

    /* renamed from: b, reason: collision with root package name */
    public final java.lang.String f352626b;

    /* renamed from: c, reason: collision with root package name */
    public final java.lang.String f352627c;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.String f352628d;
    ...
    public d(java.lang.String name, java.lang.String dataType, java.lang.String tableName, java.lang.String referTo) {
        ...
        this.f352625a = name;
        this.f352626b = dataType;
        this.f352627c = tableName;
        this.f352628d = referTo;
    }
    ...
    public final p75.m f(java.lang.Number max, java.lang.Number min, boolean z17, boolean z18) {
        ...
        kotlin.jvm.internal.o.g(min, "min");
    ...
    public final p75.j h() {
        return new p75.j(this.f352625a, this.f352626b, this.f352627c, this.f352628d, "count");
    }
    ...
    public final p75.m0 k(java.util.List numberList) {
        kotlin.jvm.internal.o.g(numberList, "numberList");
    ...
    public final p75.m0 l(java.util.List strList) {
        kotlin.jvm.internal.o.g(strList, "strList");
    ...
    public final p75.j y() {
        return new p75.j(this.f352625a, this.f352626b, this.f352627c, this.f352628d, "sum");
    }

    public java.lang.String z() {
        return this.f352627c + '.' + this.f352625a;
    }
}
