...
public class l0 extends p75.e1 {
    ...
    public final long f352670c;

    /* renamed from: d, reason: collision with root package name */
    public final boolean f352671d;

    /* renamed from: e, reason: collision with root package name */
    public final boolean f352672e;
    ...
    public final android.database.Cursor f(l75.k0 k0Var, boolean z17) {
        ...
        boolean z18 = this.f352671d;
        java.lang.String str = this.f352636a;
        if (!z18 && z17) {
            str = str + " LIMIT 1";
        }
        boolean z19 = this.f352672e;
        java.lang.String[] strArr = this.f352637b;
        if (z19) {
            java.lang.String str2 = "EXPLAIN QUERY PLAN " + str;
            if (k0Var != null && (B = k0Var.B(str2, strArr)) != null) {
                try {
                    com.tencent.mars.xlog.Log.i("MicroMsg.Sql.SelectSql", "explainQueryPlanSql: " + str2);
                    while (B.moveToNext()) {
                        int columnIndex = B.getColumnIndex(dm.i4.COL_ID);
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.Sql.SelectSql", "===== selectId:" + B.getInt(columnIndex) + " order:" + B.getInt(columnIndex2) + " from:" + B.getInt(columnIndex3) + " detail:" + B.getString(columnIndex4));
                    }
                    vz5.b.a(B, null);
    ...
    public final void g(java.lang.Exception exc) {
        if (!kotlin.jvm.internal.o.b(exc.getClass().getSimpleName(), "OperationCanceledException")) {
            throw exc;
        }
        throw new p75.d0("SQLTimeoutException SQL:" + this.f352636a + " Timeout:" + this.f352670c, exc);
    }
    ...
    */
    public final java.util.List k(l75.k0 r6, java.lang.Class r7) {
        ...
        L17:
            ...
            r4.convertFrom(r6)     // Catch: java.lang.Throwable -> L2f
    ...
    */
    public final l75.f0 o(l75.k0 r5, java.lang.Class r6) {
        /*
            ...
            r6.convertFrom(r5)     // Catch: java.lang.Throwable -> L2d
    ...
    */
    ...
    public final wu5.c q(android.database.Cursor cursor) {
        ...
        return ((ku5.t0) ku5.t0.f312615d).k(new p75.k0(cursor), this.f352670c);
    }
}
