...
public abstract class f {
    public static final f26.l2 a(f26.l2 l2Var, o06.e2 e2Var) {
        if (e2Var == null || l2Var.c() == f26.d3.f259143f) {
            return l2Var;
        }
        if (e2Var.q() != l2Var.c()) {
            s16.c cVar = new s16.c(l2Var);
            f26.r1.f259214e.getClass();
            return new f26.n2(new s16.a(l2Var, cVar, false, f26.r1.f259215f));
        }
        if (!l2Var.b()) {
            return new f26.n2(l2Var.getType());
        }
        e26.c0 NO_LOCKS = e26.u.f247037e;
        kotlin.jvm.internal.o.f(NO_LOCKS, "NO_LOCKS");
    ...
    public static f26.q2 b(f26.q2 q2Var, boolean z17, int i17, java.lang.Object obj) {
        ...
        f26.l2[] l2VarArr = i0Var.f259174c;
        kotlin.jvm.internal.o.g(l2VarArr, "<this>");
        o06.e2[] other = i0Var.f259173b;
        ...
        while (it.hasNext()) {
            ...
            arrayList2.add(a((f26.l2) lVar.f302833d, (o06.e2) lVar.f302834e));
        }
