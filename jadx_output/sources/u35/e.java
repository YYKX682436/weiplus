...
public final class e {
    ...
    public static final u35.e f424436a = new u35.e();
    ...
    public final void a(long j17, java.lang.String sttVoiceSessionId, java.lang.String chatUsername, java.lang.String voiceId) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.QuickVoice2TxtReporter", "reportCancel sessionId:%s, chatUsername:%s, voiceId:%s, duration:%s", sttVoiceSessionId, chatUsername, voiceId, java.lang.Long.valueOf(j17));
    ...
    public final void b(java.lang.String sttVoiceSessionId, java.lang.String chatUsername, int i17, int i18, java.lang.String voiceId) {
        ...
        kotlin.jvm.internal.o.g(chatUsername, "chatUsername");
        kotlin.jvm.internal.o.g(voiceId, "voiceId");
        com.tencent.mars.xlog.Log.i("MicroMsg.QuickVoice2TxtReporter", "reportError sessionId:%s, chatUsername:%s, voiceId:%s, errReason:%s, textCnt:%s", sttVoiceSessionId, chatUsername, voiceId, java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(i17));
        java.util.HashMap hashMap = new java.util.HashMap();
        hashMap.put("stt_voice_session_id", sttVoiceSessionId);
        hashMap.put("chat_username", chatUsername);
    ...
    public final void c(int i17, java.lang.String sttVoiceSessionId, java.lang.String chatUsername, long j17, long j18, java.lang.String voiceId) {
        ...
        kotlin.jvm.internal.o.g(chatUsername, "chatUsername");
        kotlin.jvm.internal.o.g(voiceId, "voiceId");
        com.tencent.mars.xlog.Log.i("MicroMsg.QuickVoice2TxtReporter", "reportSend sessionId:%s, chatUsername:%s, voiceId:%s, textCnt:%s, duration:%s, msgSvrId:%s", sttVoiceSessionId, chatUsername, voiceId, java.lang.Integer.valueOf(i17), java.lang.Long.valueOf(j17), java.lang.Long.valueOf(j18));
        java.util.HashMap hashMap = new java.util.HashMap();
        hashMap.put("text_utf8_cnt", java.lang.Integer.valueOf(i17));
        hashMap.put("stt_voice_session_id", sttVoiceSessionId);
        hashMap.put("chat_username", chatUsername);
