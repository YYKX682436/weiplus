...
public class j1 {
    ...
    public static md1.j1 f325750e;

    /* renamed from: c, reason: collision with root package name */
    public mi1.w0 f325753c;

    /* renamed from: a, reason: collision with root package name */
    public com.tencent.mm.plugin.appbrand.page.v5 f325751a = null;

    /* renamed from: b, reason: collision with root package name */
    public int f325752b = 2;

    /* renamed from: d, reason: collision with root package name */
    public boolean f325754d = false;
    ...
    */
    public final void a(boolean r10, boolean r11) {
        /*
            ...
            com.tencent.mm.plugin.appbrand.page.v5 r0 = r9.f325751a     // Catch: java.lang.Exception -> La3
            if (r0 == 0) goto La2
        ...
        L13:
            ...
            com.tencent.mars.xlog.Log.i(r1, r6)     // Catch: java.lang.Exception -> La3
            r9.f325754d = r4     // Catch: java.lang.Exception -> La3
            r6 = r11
            r7 = r5
            goto L4b
        L35:
            mi1.w0 r6 = r9.f325753c     // Catch: java.lang.Exception -> La3
            if (r6 == 0) goto L49
            int r6 = r0.j()     // Catch: java.lang.Exception -> La3
            if (r6 != r3) goto L49
            java.lang.String r6 = "showing voice CapsuleBar"
            com.tencent.mars.xlog.Log.i(r1, r6)     // Catch: java.lang.Exception -> La3
            r9.f325754d = r5     // Catch: java.lang.Exception -> La3
            r7 = r4
            r6 = r5
            goto L4b
        L49:
            ...
            r7 = r4
        L4b:
            mi1.w0 r8 = r9.f325753c     // Catch: java.lang.Exception -> La3
            if (r8 == 0) goto L55
            r8.dismiss()     // Catch: java.lang.Exception -> La3
            r8 = 0
            r9.f325753c = r8     // Catch: java.lang.Exception -> La3
        L55:
            if (r10 == 0) goto Lb9
            if (r6 != 0) goto L67
        ...
        L67:
            if (r6 != 0) goto L6e
            boolean r10 = r9.f325754d     // Catch: java.lang.Exception -> La3
            if (r10 == 0) goto L6e
            r6 = r5
        L6e:
            if (r6 != 0) goto L75
            int r10 = r9.f325752b     // Catch: java.lang.Exception -> La3
            if (r10 != r3) goto L75
            r6 = r4
        L75:
            ...
            com.tencent.mars.xlog.Log.i(r1, r10, r0)     // Catch: java.lang.Exception -> La3
            com.tencent.mm.plugin.appbrand.page.v5 r10 = r9.f325751a     // Catch: java.lang.Exception -> La3
        ...
        L99:
            ...
            r9.f325753c = r10     // Catch: java.lang.Exception -> La3
            r9.f325754d = r6     // Catch: java.lang.Exception -> La3
            goto Lb9
        La2:
            return
        La3:
            ...
            com.tencent.mars.xlog.Log.e(r1, r10)
        Lb9:
            return
        */
    ...
    public void c() {
        com.tencent.mars.xlog.Log.i("MicroMsg.OpenVoice.OpenVoiceCapsuleBarBlinkManager", "hideCapsuleBar");
        if (!com.tencent.mm.sdk.platformtools.u3.e()) {
            com.tencent.mm.sdk.platformtools.u3.h(new md1.i1(this));
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.OpenVoice.OpenVoiceCapsuleBarBlinkManager", "_hide");
        this.f325754d = false;
        mi1.w0 w0Var = this.f325753c;
        if (w0Var != null) {
            w0Var.dismiss();
            this.f325753c = null;
        }
    ...
    public void d(boolean z17) {
        ...
        objArr[1] = java.lang.Boolean.valueOf(this.f325752b == 2);
        com.tencent.mars.xlog.Log.i("MicroMsg.OpenVoice.OpenVoiceCapsuleBarBlinkManager", "showCapsuleBar recording:%b, isAudioRecordOnly:%b", objArr);
        boolean z18 = this.f325752b == 2;
        com.tencent.mars.xlog.Log.i("MicroMsg.OpenVoice.OpenVoiceCapsuleBarBlinkManager", "showCapsuleBar");
        if (com.tencent.mm.sdk.platformtools.u3.e()) {
            a(z17, z18);
        } else {
            com.tencent.mm.sdk.platformtools.u3.h(new md1.h1(this, z17, z18));
        }
    }
}
