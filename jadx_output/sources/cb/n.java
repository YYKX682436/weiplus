...
public final class n extends android.os.Handler {
    ...
    public final /* synthetic */ cb.m f40155a;
        ...
        if (message != null) {
            ...
            if (obj instanceof android.content.Intent) {
                ...
                if (intent.hasExtra("google.messenger")) {
                    ...
                    if (parcelableExtra instanceof com.google.firebase.iid.zzi) {
                        mVar.f40153f = (com.google.firebase.iid.zzi) parcelableExtra;
                    }
                    if (parcelableExtra instanceof android.os.Messenger) {
                        mVar.f40152e = (android.os.Messenger) parcelableExtra;
                    }
                }
                ...
                if (!stringExtra.startsWith("|")) {
                    synchronized (mVar.f40148a) {
                        int i17 = 0;
                        while (true) {
                            x.n nVar = mVar.f40148a;
                            if (i17 < nVar.f450846f) {
