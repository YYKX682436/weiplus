...
public final class g0 {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.google.android.gms.internal.firebase_messaging.zzh.zza(th6, th8);
                }
                throw th7;
            }
        }
    ...
    public static void c(android.content.Context context, java.lang.String str, cb.h0 h0Var) {
        try {
            ...
            i17.createNewFile();
            java.util.Properties properties = new java.util.Properties();
            properties.setProperty("pub", android.util.Base64.encodeToString(h0Var.f40127a.getPublic().getEncoded(), 11));
            properties.setProperty("pri", android.util.Base64.encodeToString(h0Var.f40127a.getPrivate().getEncoded(), 11));
            properties.setProperty("cre", java.lang.String.valueOf(h0Var.f40128b));
    ...
    public static java.io.File i(android.content.Context context, java.lang.String str) {
        ...
        return new java.io.File(noBackupFilesDir, sb6);
    }
    ...
    public final void d(android.content.Context context, java.lang.String str, cb.h0 h0Var) {
        ...
        try {
            if (h0Var.equals(a(sharedPreferences, str))) {
                return;
            }
        } catch (cb.i0 unused) {
        }
        ...
        edit.putString(cb.p.d(str, "|P|"), android.util.Base64.encodeToString(h0Var.f40127a.getPublic().getEncoded(), 11));
        edit.putString(cb.p.d(str, "|K|"), android.util.Base64.encodeToString(h0Var.f40127a.getPrivate().getEncoded(), 11));
        edit.putString(cb.p.d(str, "cre"), java.lang.String.valueOf(h0Var.f40128b));
        edit.commit();
    }
