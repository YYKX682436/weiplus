...
public final class b implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ qx2.g f367325d;
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mars.xlog.Log.i("FinderLawLicensePopupView", "#btn on cancel click");
        com.tencent.mm.ui.widget.dialog.y1 y1Var = this.f367325d.f367333e;
        if (y1Var != null) {
            y1Var.q();
        }
