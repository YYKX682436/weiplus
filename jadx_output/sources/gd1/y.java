...
public final class y extends kotlin.jvm.internal.q implements yz5.q {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.appbrand.jsapi.l f270517d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ gd1.b0 f270518e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y(com.tencent.mm.plugin.appbrand.jsapi.l lVar, gd1.b0 b0Var) {
        super(3);
        this.f270517d = lVar;
        this.f270518e = b0Var;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2, java.lang.Object obj3) {
        ...
        gd1.b0 b0Var = this.f270518e;
        com.tencent.mm.plugin.appbrand.jsapi.l lVar = this.f270517d;
        if (list != null) {
            list.toString();
            ...
            while (true) {
                ...
                while (i17 < length) {
                    ...
                    java.util.Map k17 = kz5.c1.k(lVar2, lVar3, new jz5.l(dm.i4.COL_ID, new java.lang.String(encode2, UTF_82)));
                    k17.toString();
                    arrayList2.add(new jz5.l(k17, com.tencent.mm.plugin.appbrand.utils.v3.e(ndefRecord.getPayload())));
                    i17++;
                    it = it6;
                }
            ...
            while (it10.hasNext()) {
                arrayList5.add((java.util.List) ((jz5.l) it10.next()).f302833d);
            }
            ...
            while (it11.hasNext()) {
                ...
                int i27 = 0;
                for (java.lang.Object obj4 : (java.lang.Iterable) ((jz5.l) next).f302834e) {
                    int i28 = i27 + 1;
                    if (i27 < 0) {
                        kz5.c0.p();
                        throw null;
            ...
            if (com.tencent.mm.plugin.appbrand.utils.u3.FAIL_SIZE_EXCEED_LIMIT == com.tencent.mm.plugin.appbrand.utils.v3.d(lVar.getJsRuntime(), hashMap, (com.tencent.mm.plugin.appbrand.utils.t3) lVar.b(com.tencent.mm.plugin.appbrand.utils.t3.class))) {
                com.tencent.mars.xlog.Log.w("MicroMsg.AppBrand.JsApiStartNFCDiscovery", "invoke, convert NativeBuffer fail");
            } else {
                gd1.f fVar = (gd1.f) ((jz5.n) b0Var.f270483g).getValue();
                fVar.v(lVar);
                fVar.u(bArr, techs, hashMap);
            }
        } else {
            gd1.f fVar2 = (gd1.f) ((jz5.n) b0Var.f270483g).getValue();
            fVar2.v(lVar);
