...
public final class k1 {
    ...
    public final f0.q f258135a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.ArrayList f258136b;
    ...
    public final java.util.List f258141g;

    /* renamed from: h, reason: collision with root package name */
    public java.util.List f258142h;
    ...
    public k1(f0.q itemProvider) {
        ...
        this.f258135a = itemProvider;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(new f0.g1(0, 0, 2, null));
        this.f258136b = arrayList;
        this.f258140f = -1;
        this.f258141g = new java.util.ArrayList();
        this.f258142h = kz5.p0.f313996d;
    }

    public final int a() {
        return ((int) java.lang.Math.sqrt((d() * 1.0d) / this.f258143i)) + 1;
    }
  ...
  0x00c9: PHI (r6v5 int) = (r6v4 int), (r6v12 int) binds: [B:39:0x00c7, B:68:0x00c9] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final int c(int i17) {
        ...
        if (!((f0.b0) ((f0.s) this.f258135a).f258226a.getValue()).f258008b) {
            return i17 / this.f258143i;
        }
        java.util.ArrayList arrayList = this.f258136b;
        int e17 = kz5.c0.e(arrayList, 0, arrayList.size(), new f0.j1(i17));
        if (e17 < 0) {
            e17 = (-e17) - 2;
        }
        int a17 = a() * e17;
        int i18 = ((f0.g1) arrayList.get(e17)).f258093a;
        if (!(i18 <= i17)) {
            throw new java.lang.IllegalArgumentException("Failed requirement.".toString());
        }
        int i19 = 0;
        while (i18 < i17) {
            int i27 = i18 + 1;
            int e18 = e(i18, this.f258143i - i19);
            i19 += e18;
            int i28 = this.f258143i;
            if (i19 >= i28) {
                a17++;
                i19 = i19 == i28 ? 0 : e18;
            }
        ...
        return i19 + e(i17, this.f258143i - i19) > this.f258143i ? a17 + 1 : a17;
    }

    public final int d() {
        return ((f0.s) this.f258135a).e();
    }

    public final int e(int i17, int i18) {
        f0.h1 h1Var = f0.h1.f258109a;
        f0.s sVar = (f0.s) this.f258135a;
        sVar.getClass();
        f0.b0 b0Var = (f0.b0) sVar.f258226a.getValue();
        b0Var.getClass();
        androidx.compose.foundation.lazy.layout.c b17 = b0Var.b(i17);
        return e06.p.f((int) ((f0.d) ((f0.j) b17.f10396c).f258120b.invoke(h1Var, java.lang.Integer.valueOf(i17 - b17.f10394a))).f258040a, 1, this.f258143i);
    }
}
