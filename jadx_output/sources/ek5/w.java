...
public final class w extends ek5.c {
    ...
    public co.a d(android.content.Intent intent, n50.i param) {
        ...
        while (it.hasNext()) {
            com.tencent.mm.storage.f9 k17 = pt0.f0.f358209b1.k(bVar.getString(bVar.f43702d + 1), ((java.lang.Number) it.next()).longValue());
            if (k17 != null) {
                arrayList2.add(k17);
            }
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ForwardMediaGroupConfig", "genViewModelByRetransmitIntent, original size: " + arrayList.size() + ", forwardable size: " + arrayList3.size());
        ...
        while (it6.hasNext()) {
            arrayList4.add(g45.b.f268846a.b((com.tencent.mm.storage.f9) it6.next()));
        }
