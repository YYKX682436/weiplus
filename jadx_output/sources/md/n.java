...
public abstract class n {
    ...
    public static java.lang.String f325702a;

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.String f325703b;
    ...
    */
    public static boolean c(android.content.Context r4) {
        /*
            r0 = 1
            r1 = 0
            java.lang.String r2 = md.n.f325702a     // Catch: java.lang.Exception -> L72
            boolean r2 = f(r2)     // Catch: java.lang.Exception -> L72
            if (r2 == 0) goto Le
            java.lang.String r2 = android.os.Build.BRAND     // Catch: java.lang.Exception -> L72
            md.n.f325702a = r2     // Catch: java.lang.Exception -> L72
        Le:
            java.lang.String r2 = md.n.f325703b     // Catch: java.lang.Exception -> L72
            boolean r2 = f(r2)     // Catch: java.lang.Exception -> L72
            if (r2 == 0) goto L1a
            java.lang.String r2 = android.os.Build.MODEL     // Catch: java.lang.Exception -> L72
            md.n.f325703b = r2     // Catch: java.lang.Exception -> L72
        L1a:
            java.lang.String r2 = md.n.f325702a     // Catch: java.lang.Exception -> L72
            boolean r2 = f(r2)     // Catch: java.lang.Exception -> L72
            if (r2 != 0) goto L2a
        ...
        L56:
            ...
            java.lang.String r3 = md.n.f325702a     // Catch: java.lang.Exception -> L72
    ...
    public static int e(android.content.Context context) {
        ...
        int intValue;
        n3.g3 g3Var;
        if (context != null && md.m.f325701a < 0.0f) {
            md.m.f325701a = context.getResources().getDisplayMetrics().density;
        }
        int round = java.lang.Math.round(md.m.f325701a * 25);
        if (android.os.Build.VERSION.SDK_INT >= 34) {
            ...
            return g3Var != null ? g3Var.a(1).f247045b : round;
        }
        try {
