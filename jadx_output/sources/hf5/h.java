...
public final class h {
    ...
    public final java.util.Map f281243a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Set f281244b;
    ...
    public h(java.util.Collection values) {
        ...
        this.f281243a = linkedHashMap2;
        this.f281244b = linkedHashMap2.keySet();
    }
    ...
    public final java.lang.String a(java.lang.String text, int i17) {
        ...
        java.util.List list = (java.util.List) ((java.util.LinkedHashMap) this.f281243a).get(java.lang.Character.valueOf(text.charAt(i17)));
        if (list == null) {
            return null;
        }
