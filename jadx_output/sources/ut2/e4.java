...
public final class e4 {
    public e4(kotlin.jvm.internal.i iVar) {
    }
    ...
    public final void a(android.view.View headerLine, android.view.View headerArrow, int i17, float f17) {
        ...
        zl2.r4.f473950a.M2("ShoppingPanelHeadIndicatorHolder", "updatePanelHead " + f17 + ",panelPosY:" + i17);
        float intValue = f17 / ((float) ((java.lang.Number) ((jz5.n) ut2.f4.f430879e).getValue()).intValue());
        ...
        if (layoutParams != null) {
            ut2.e4 e4Var = ut2.f4.f430878d;
            jz5.g gVar = ut2.f4.f430881g;
            layoutParams.height = (int) (((java.lang.Number) ((jz5.n) gVar).getValue()).intValue() + (f19 * (((java.lang.Number) ((jz5.n) ut2.f4.f430880f).getValue()).intValue() - ((java.lang.Number) ((jz5.n) gVar).getValue()).intValue())));
        } else {
            layoutParams = null;
        }
