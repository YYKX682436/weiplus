...
public final class v0 implements android.animation.Animator.AnimatorListener {
    ...
    public final /* synthetic */ android.animation.Animator.AnimatorListener f19019d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ bb2.q0 f19020e;
    ...
    public v0(bb2.q0 q0Var) {
        ...
        this.f19019d = (android.animation.Animator.AnimatorListener) newProxyInstance;
    }

    @Override // android.animation.Animator.AnimatorListener
    public void onAnimationCancel(android.animation.Animator animation) {
        kotlin.jvm.internal.o.g(animation, "animation");
        bb2.q0 q0Var = this.f19020e;
        android.view.View view = q0Var.f18954g;
    ...
    public void onAnimationRepeat(android.animation.Animator p07) {
        ...
        this.f19019d.onAnimationRepeat(p07);
    }

    @Override // android.animation.Animator.AnimatorListener
    public void onAnimationStart(android.animation.Animator p07) {
        kotlin.jvm.internal.o.g(p07, "p0");
        this.f19019d.onAnimationStart(p07);
    }
}
