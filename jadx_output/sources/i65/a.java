...
public abstract class a {
    ...
    public static final android.util.SparseIntArray f289384a = new android.util.SparseIntArray();

    /* renamed from: b, reason: collision with root package name */
    public static float f289385b = 0.0f;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f289386c = false;

    /* renamed from: d, reason: collision with root package name */
    public static boolean f289387d = true;
    ...
    public static int B(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get widthPixels but context is null");
        return 0;
    }
    ...
    public static void F(android.content.Context context, float f17) {
        com.tencent.mm.sdk.platformtools.o4.M(com.tencent.mm.sdk.platformtools.x2.e()).putFloat("text_size_scale_key", f17);
        f289385b = f17;
    }
    ...
    public static int d(android.content.Context context, int i17) {
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get color, resId %d, but context is null", java.lang.Integer.valueOf(i17));
        return 0;
    }
    ...
    public static android.content.res.ColorStateList e(android.content.Context context, int i17) {
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get color state list, resId %d, but context is null", java.lang.Integer.valueOf(i17));
        return null;
    }
    ...
    public static int f(android.content.Context context, int i17) {
        int i18;
        if (context == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get dimension pixel size, resId %d, but context is null", java.lang.Integer.valueOf(i17));
            return 0;
        }
        android.util.SparseIntArray sparseIntArray = f289384a;
    ...
    public static android.graphics.drawable.Drawable i(android.content.Context context, int i17) {
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get drawable, resId %d, but context is null", java.lang.Integer.valueOf(i17));
        return null;
    }
    ...
    public static int k(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get heightPixels but context is null");
        return 0;
    }

    public static boolean l(android.content.Context context) {
        if (context != null && !f289386c) {
            f289387d = context.getSharedPreferences(com.tencent.mm.sdk.platformtools.x2.e(), 0).getBoolean("screenResolution_isModifyDensity", true);
            f289386c = true;
        }
        return f289387d;
    }
    ...
    public static float n(android.content.Context context) {
        ...
        return com.tencent.mm.sdk.platformtools.o4.M(com.tencent.mm.sdk.platformtools.x2.e()).contains("text_size_scale_key") ? com.tencent.mm.sdk.platformtools.o4.M(com.tencent.mm.sdk.platformtools.x2.e()).getFloat("text_size_scale_key", 1.0f) : context.getSharedPreferences(com.tencent.mm.sdk.platformtools.x2.e(), 0).getFloat("text_size_scale_key", 1.0f);
    }
    ...
    public static float q(android.content.Context context) {
        ...
        if (f289387d && (C(f289385b, 1.1f) || C(f289385b, 0.8f))) {
            f289385b = 1.0f;
        }
        return f289385b;
    }
    ...
    public static java.lang.String r(android.content.Context context, int i17) {
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.ResourceHelper", "get string, resId %d, but context is null", java.lang.Integer.valueOf(i17));
        return "";
    }
