...
public class l {
    ...
    public static volatile te1.l f417790c;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Set f417792b = java.util.Collections.synchronizedSet(new java.util.HashSet());

    /* renamed from: a, reason: collision with root package name */
    public final te1.r f417791a = new te1.r();
    ...
    public long a(java.lang.String str) {
        te1.r rVar = this.f417791a;
        rVar.getClass();
        long j17 = 0;
        if (!android.text.TextUtils.isEmpty(str) && rVar.f417810c != null) {
            java.lang.String u17 = ve1.g.u(str);
            re1.m mVar = (re1.m) rVar.f417810c;
            synchronized (mVar) {
                java.util.NavigableSet<re1.i> c17 = mVar.c(u17);
                if (c17 != null) {
                    re1.i iVar = (re1.i) c17.first();
                    if (iVar == null || !iVar.f394340i || iVar.f394338g < 0 || iVar.f394336e == 0) {
                        if (iVar != null && iVar.f394338g >= 0) {
                            for (re1.i iVar2 : c17) {
                                if (!iVar2.f394340i) {
                                    break;
                                }
    ...
    public void e(java.util.ArrayList arrayList, java.lang.String str) {
        ...
        while (it.hasNext()) {
            ...
            if (!c(gVar.f417777a)) {
                ...
                ve1.g.p(4, str, "preloadMediasAsync, url " + gVar.f417777a + " already cached, cacheMaxBytes=-1", null);
            }
        }
