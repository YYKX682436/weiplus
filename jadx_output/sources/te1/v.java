...
public class v {
    ...
    public final java.util.LinkedHashMap f417843a = new java.util.LinkedHashMap(8, 0.75f);

    public synchronized void a(java.lang.String str, te1.s sVar) {
        java.util.ArrayList arrayList = (java.util.ArrayList) this.f417843a.get(str);
        if (arrayList == null) {
            arrayList = new java.util.ArrayList();
            this.f417843a.put(str, arrayList);
    ...
    public void b(java.lang.String str, te1.s sVar) {
        ...
        java.lang.String str2 = "VideoProxy/" + sVar.f417826f + "/RequestManager";
        ...
        if (arrayList.size() > 0) {
            ...
            while (it6.hasNext()) {
                ...
                sVar3.f417824d = uVar;
                if (sVar3.f417821a != null) {
                    if (sVar3.u(0, 1) && qe1.a.a().f362017b) {
                        ve1.g.p(3, sVar3.f(), "cancel start, seq=" + sVar3.f417826f, null);
                    }
                    sVar3.s(1);
                    sVar3.f417821a.cancel(true);
                }
            }
            try {
    ...
    public synchronized java.util.ArrayList c(java.lang.String str, int i17) {
        ...
        arrayList = new java.util.ArrayList();
        java.util.Iterator it = this.f417843a.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (arrayList2.size() > 0) {
                ...
                if (str.equals(sVar.f417834n)) {
                    if (i17 == -1) {
                        arrayList.addAll(arrayList2);
                    } else if (i17 == sVar.f417828h) {
                        arrayList.addAll(arrayList2);
                    }
                }
            }
    ...
    public synchronized void d(te1.s sVar) {
        java.util.ArrayList arrayList = (java.util.ArrayList) this.f417843a.get(sVar.f417835o);
        if (arrayList != null) {
    ...
    public synchronized java.lang.String toString() {
        ...
        while (it.hasNext()) {
            ...
            while (it6.hasNext()) {
                str = (str + ((te1.s) it6.next()).toString()) + ",\n";
            }
        }
        return str + "]";
    }
