...
public class x3 extends i95.w implements m33.v1 {
    public static void wi(android.content.Context context, int i17, java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4, java.lang.String str5, boolean z17, java.lang.String str6, int i18, android.os.Bundle bundle, int i19) {
        com.tencent.mars.xlog.Log.i("MicroMsg.Haowan.GameVideoEditorLauncher", "goToEditor, from[%d], businessType[%s], appid[%s], videoPath[%s], videoUrl[%s], needEdit[%b], gameInfo[%s]", java.lang.Integer.valueOf(i17), str, str2, str3, str4, java.lang.Boolean.valueOf(z17), str6);
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(str3) || !com.tencent.mm.vfs.w6.j(str3)) {
            if (com.tencent.mm.sdk.platformtools.t8.K0(str4)) {
                com.tencent.mars.xlog.Log.e("MicroMsg.Haowan.GameVideoEditorLauncher", "videoPath and videoUrl is invalid");
                if (i17 == 3) {
        ...
        if (z18) {
            if (context2 instanceof android.app.Activity) {
                ...
                j45.l.j(com.tencent.mm.sdk.platformtools.x2.f193071a, "game", ".media.GameVideoDownloadUI", intent, null);
                return;
            }
        }
        if (context2 instanceof android.app.Activity) {
            ...
            j45.l.j(com.tencent.mm.sdk.platformtools.x2.f193071a, "game", ".media.GameVideoEditorProxyUI", intent, null);
        }
    }
    ...
    public void Bi(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3, int i17, android.os.Bundle bundle) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.Haowan.GameVideoEditorLauncher", e17, "hy: put appname failed!", new java.lang.Object[0]);
        }
