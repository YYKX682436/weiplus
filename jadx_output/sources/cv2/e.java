...
public final class e extends uh4.c {
    ...
    public java.lang.String b(android.content.Context context) {
        ...
        java.lang.String string = context.getString(com.tencent.mm.R.string.i3e);
        ...
        if (eVar != null) {
            ...
            if (i17 == 10) {
                if (equals) {
                    ...
                    if (ordinal == 0) {
                        aVar.f427964h.setText(context2.getResources().getString(com.tencent.mm.R.string.i3_, java.lang.Integer.valueOf(c17), java.lang.Integer.valueOf(c17)));
                        return;
                    }
                    if (ordinal == 1) {
                ...
                if (ordinal2 == 0) {
                    aVar.f427963g.setText(context3.getResources().getString(com.tencent.mm.R.string.i3a));
                    aVar.f427964h.setText(context3.getResources().getString(com.tencent.mm.R.string.i39, java.lang.Integer.valueOf(c18), java.lang.Integer.valueOf(c18)));
                    return;
                } else if (ordinal2 == 1) {
            ...
            if (equals) {
                ...
                if (ordinal3 == 0) {
                    aVar.f427964h.setText(context4.getResources().getString(com.tencent.mm.R.string.i38, str, str2, java.lang.Integer.valueOf(c19)));
                    return;
                }
                if (ordinal3 == 1) {
                    ...
                    aVar.f427964h.setText(context4.getResources().getString(com.tencent.mm.R.string.f492843i35, str, str2, str, java.lang.Integer.valueOf(c19)));
                    return;
                } else {
                    if (ordinal3 != 3) {
                        return;
            ...
            if (ordinal4 == 0) {
                aVar.f427963g.setText(context5.getResources().getString(com.tencent.mm.R.string.i3a));
                aVar.f427964h.setText(context5.getResources().getString(com.tencent.mm.R.string.i37, str3, str4, java.lang.Integer.valueOf(c27)));
            } else if (ordinal4 == 1) {
