...
public class a implements wh.a2 {
    ...
    public void b(java.lang.reflect.Method method, java.lang.Object[] objArr) {
                    ...
                    if (length != 1) {
                        if (objArr.length != 2) {
                            ...
                            if (obj == null || (obj instanceof android.app.PendingIntent)) {
                                bVar.f445737a = (android.app.PendingIntent) obj;
                                bVar2 = bVar;
                            } else {
                        ...
                        if (obj2 == null || (obj2 instanceof android.app.PendingIntent)) {
                            bVar.f445737a = (android.app.PendingIntent) obj2;
                            bVar2 = bVar;
                        } else {
                ...
                synchronized (wh.e.class) {
                    while (true) {
                        ...
                        if (i17 < ((java.util.ArrayList) list).size()) {
                            ...
                            android.app.PendingIntent pendingIntent = bVar2.f445737a;
                            rh.h hVar = (rh.h) cVar;
                            hVar.getClass();
                            if (pendingIntent != null) {
                                pendingIntent.hashCode();
                                synchronized (hVar.f395405a.f395451c.f395438a) {
                                    r0.f395440c--;
                                }
                            }
                            i17++;
        ...
        synchronized (wh.e.class) {
            int i27 = 0;
            while (true) {
                java.util.List list2 = wh.e.f445765c;
                if (i27 < ((java.util.ArrayList) list2).size()) {
                    ((rh.h) ((wh.c) ((java.util.ArrayList) list2).get(i27))).a(dVar2.f445753a, dVar2.f445754b, dVar2.f445755c, dVar2.f445756d, dVar2.f445757e, dVar2.f445758f, null);
                    i27++;
                }
            }
        }
