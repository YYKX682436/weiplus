...
public final class j0 {
    ...
    public static final jz5.g f445806e;

    /* renamed from: f, reason: collision with root package name */
    public static final jz5.g f445807f;

    /* renamed from: g, reason: collision with root package name */
    public static final wh.y f445808g = new wh.y(null);

    /* renamed from: a, reason: collision with root package name */
    public final jz5.o f445809a = new jz5.o(new java.util.concurrent.atomic.AtomicInteger(0), new java.util.concurrent.atomic.AtomicInteger(0), new java.util.concurrent.atomic.AtomicInteger(0));

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Map f445810b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public final java.util.List f445811c = new java.util.ArrayList();
    ...
    static {
        ...
        f445806e = jz5.h.a(iVar, wh.w.f445888d);
        f445807f = jz5.h.a(iVar, wh.x.f445899d);
    }
    ...
    public final void a(java.lang.String threadName, int i17, java.lang.String stackTrace) {
        ...
        jz5.o oVar = this.f445809a;
        java.util.concurrent.atomic.AtomicInteger atomicInteger = (java.util.concurrent.atomic.AtomicInteger) oVar.f302841d;
        java.util.concurrent.atomic.AtomicInteger atomicInteger2 = (java.util.concurrent.atomic.AtomicInteger) oVar.f302842e;
        java.util.concurrent.atomic.AtomicInteger atomicInteger3 = (java.util.concurrent.atomic.AtomicInteger) oVar.f302843f;
        wh.y yVar = f445808g;
        ...
        if (!a17) {
            ...
            for (java.lang.String str : (java.lang.String[]) array) {
                ...
                int i27 = 0;
                while (i27 <= length) {
                    boolean z18 = kotlin.jvm.internal.o.i(str.charAt(!z17 ? i27 : length), 32) <= 0;
                    if (z17) {
                        if (!z18) {
                            break;
                        } else {
                ...
                r26.m d17 = ((r26.t) f445807f.getValue()).d(line);
                if (d17 != null) {
        ...
        while (i28 < length2) {
            ...
            boolean z19 = false;
            while (i29 <= length3) {
                boolean z27 = kotlin.jvm.internal.o.i(str5.charAt(!z19 ? i29 : length3), i18) <= 0;
                if (z19) {
                    if (!z27) {
                        break;
                    } else {
            ...
            r26.m b17 = ((r26.t) f445806e.getValue()).b(line2, 0);
            if (b17 != null) {
    ...
    public final void b(java.lang.String str, int i17, java.util.List list) {
        ...
        synchronized (this) {
            ((java.util.HashMap) this.f445810b).put(java.lang.Integer.valueOf(i17), str);
            java.util.List x07 = kz5.n0.x0(list);
            wh.d0 d0Var = (wh.d0) x07.get(0);
            java.util.Iterator it = this.f445811c.iterator();
            while (true) {
                if (it.hasNext()) {
                    obj = it.next();
                    if (kotlin.jvm.internal.o.b(((wh.z) obj).f445904c, d0Var)) {
                        break;
                    }
                } else {
                    obj = null;
            ...
            if (zVar == null) {
                ...
                ((java.util.ArrayList) this.f445811c).add(zVar);
            }
            zVar.f445902a++;
            this.f445812d++;
            for (wh.d0 d0Var2 : kz5.n0.R(x07, 1)) {
                java.util.LinkedHashMap linkedHashMap = (java.util.LinkedHashMap) zVar.f445903b;
    ...
    public final int c(wh.z zVar) {
        wh.z zVar2 = zVar.f445905d;
        return (zVar2 == null ? 0 : c(zVar2)) + 1;
    }

    public final int d(wh.z zVar) {
        wh.z zVar2 = zVar.f445905d;
        return zVar.f445902a + (zVar2 == null ? 0 : d(zVar2));
    }
    ...
    public final java.util.List f(java.util.List list) {
        ...
        while (it.hasNext()) {
            kz5.h0.u(arrayList, f(kz5.n0.S0(((java.util.LinkedHashMap) ((wh.z) it.next()).f445903b).values())));
        }
    ...
    public final void g() {
        java.lang.Object obj;
        synchronized (this) {
            java.util.List<wh.z> e17 = e(this.f445811c);
            java.util.ArrayList arrayList = new java.util.ArrayList(kz5.d0.q(e17, 10));
            for (wh.z zVar : e17) {
                wh.d0 d0Var = zVar.f445904c;
                if (d0Var instanceof wh.b0) {
                    if (kotlin.jvm.internal.o.b(d0Var.b(), java.lang.Thread.class.getName() + ".start")) {
            ...
            if (it.hasNext()) {
                ...
                if (it.hasNext()) {
                    int intValue = ((java.lang.Number) ((jz5.l) next).f302834e).intValue();
                    do {
                        java.lang.Object next2 = it.next();
                        int intValue2 = ((java.lang.Number) ((jz5.l) next2).f302834e).intValue();
            ...
            if (lVar != null && ((java.lang.Number) lVar.f302834e).intValue() >= 80) {
                throw new java.lang.IllegalStateException("Stacktrace too long:\n" + h((wh.z) lVar.f302833d));
            }
        }
    }
