...
public abstract class q1 {
    ...
    public static wh.t1 a(java.lang.String str, byte[] bArr) {
        ...
        try {
            try {
                ...
                t1Var.f445873a = java.lang.String.valueOf(d17);
                t1Var.f445874b = java.lang.String.valueOf(e17);
                t1Var.f445875c = b(p1Var);
                t1Var.f445876d = b(p1Var);
                t1Var.f445877e = b(p1Var);
                t1Var.f445878f = b(p1Var);
                try {
                    p1Var.a();
    ...
    public static long b(wh.p1 p1Var) {
        ...
        while (true) {
            ...
            p1Var.c();
            if (!java.lang.Character.isDigit(p1Var.f445853f)) {
                if (!z18) {
                    p1Var.g();
                    break;
                }
