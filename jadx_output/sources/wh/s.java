...
public class s {
    public java.lang.String a(int i17) {
        ...
        if (i17 == android.os.Process.myPid()) {
            ...
            kotlin.jvm.internal.o.f(thread, "Looper.getMainLooper().thread");
        ...
        if (com.tencent.matrix.hook.junwind.PthreadHackJni.d() && com.tencent.matrix.hook.junwind.JUnwindJni.e(false, 1, null)) {
            return com.tencent.matrix.hook.junwind.JUnwindJni.f(i17, null, false, null, 14, null);
        }
        for (java.lang.Thread thread2 : java.lang.Thread.getAllStackTraces().keySet()) {
            if ((thread2 instanceof android.os.HandlerThread) && ((android.os.HandlerThread) thread2).getThreadId() == i17) {
                kotlin.jvm.internal.o.g(thread2, "thread");
                ...
                for (java.lang.StackTraceElement stackTraceElement3 : stackTrace2) {
                    ...
                    kotlin.jvm.internal.o.f(className2, "className");
