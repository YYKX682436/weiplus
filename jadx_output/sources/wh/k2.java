...
public class k2 implements wh.a2 {
    ...
    public void b(java.lang.reflect.Method method, java.lang.Object[] objArr) {
        if ("startScan".equals(method.getName())) {
            java.util.Iterator it = ((java.util.ArrayList) wh.m2.f445833a).iterator();
            while (it.hasNext()) {
                rh.e4 e4Var = ((rh.a4) ((wh.l2) it.next())).f395305a;
                java.lang.String b17 = e4Var.j() ? e4Var.f395294a.f363335d.A.b() : "";
        ...
        if ("getScanResults".equals(method.getName())) {
            java.util.Iterator it6 = ((java.util.ArrayList) wh.m2.f445833a).iterator();
            while (it6.hasNext()) {
                rh.e4 e4Var2 = ((rh.a4) ((wh.l2) it6.next())).f395305a;
                java.lang.String b18 = e4Var2.j() ? e4Var2.f395294a.f363335d.A.b() : "";
                oj.j.c("Matrix.battery.WifiMonitorFeature", "#onGetScanResults, stack = " + b18, new java.lang.Object[0]);
                rh.d4 d4Var2 = e4Var2.f395372b;
                d4Var2.getClass();
