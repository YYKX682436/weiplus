...
public final class e1 {
    ...
    public static boolean f445766a;

    /* renamed from: b, reason: collision with root package name */
    public static wh.d1 f445767b;

    /* renamed from: c, reason: collision with root package name */
    public static final wh.e1 f445768c = new wh.e1();

    public static final java.lang.String a(android.content.Context context) {
        java.lang.String str;
        kotlin.jvm.internal.o.g(context, "context");
        wh.d1 b17 = f445768c.b(context);
        return (b17 == null || (str = b17.f445760b) == null) ? "android.os.action.POWER_SAVE_MODE_CHANGED" : str;
    }
    ...
    public static final boolean c(android.content.Context context) {
        ...
        wh.d1 b17 = f445768c.b(context);
        if (b17 != null) {
            return android.provider.Settings.System.getInt(context.getContentResolver(), b17.f445761c, Integer.MIN_VALUE) == b17.f445762d;
        }
    ...
    */
    public final wh.d1 b(android.content.Context r7) {
        ...
        L54:
            ...
            java.lang.String r0 = r1.f445761c     // Catch: java.lang.Throwable -> L6c
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            int r7 = android.provider.Settings.System.getInt(r7, r0, r2)     // Catch: java.lang.Throwable -> L6c
            if (r7 == r2) goto L66
            wh.e1.f445767b = r1     // Catch: java.lang.Throwable -> L6c
        L66:
            wh.e1.f445766a = r4     // Catch: java.lang.Throwable -> L6c
        L68:
            monitor-exit(r6)
            wh.d1 r7 = wh.e1.f445767b
            return r7
        L6c:
            r7 = move-exception
            monitor-exit(r6)
