...
public class d extends oj2.m {
    ...
    public android.view.ViewGroup f446657l1;

    /* renamed from: p0, reason: collision with root package name */
    public android.widget.Space f446658p0;

    /* renamed from: p1, reason: collision with root package name */
    public android.view.ViewGroup f446659p1;

    /* renamed from: x0, reason: collision with root package name */
    public android.widget.FrameLayout f446660x0;

    /* renamed from: x1, reason: collision with root package name */
    public android.widget.TextView f446661x1;

    /* renamed from: y0, reason: collision with root package name */
    public boolean f446662y0;

    /* renamed from: y1, reason: collision with root package name */
    public wj2.j0 f446663y1;

    /* renamed from: z1, reason: collision with root package name */
    public android.widget.ImageView f446664z1;
    ...
    private final int getAudioWaveIconSize() {
        return (getCurWidgetMode() == pm2.a.f356854g || this.f446662y0) ? getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479688cn) : getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479691cq);
    }

    private final int getAvatarSize() {
        return (getCurWidgetMode() == pm2.a.f356854g || this.f446662y0) ? getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479723df) : getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479731dn);
    }
    ...
    */
    private final int getGiftMargin() {
        ...
        Lb3:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: wj2.d.getGiftMargin():int");
    }

    private final int getMuteIconCircleSize() {
        return (getCurWidgetMode() == pm2.a.f356854g || this.f446662y0) ? getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479672c9) : getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479673ca);
    }

    private final int getMuteIconSize() {
        return (getCurWidgetMode() == pm2.a.f356854g || this.f446662y0) ? getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479688cn) : getContext().getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479693cs);
    }
    ...
    public void R() {
        super.R();
        android.widget.Space space = this.f446658p0;
        if (space != null) {
    ...
    @Override // oj2.m
    public void Z() {
        android.view.View inflate = com.tencent.mm.ui.id.b(getContext()).inflate(com.tencent.mm.R.layout.avb, (android.view.ViewGroup) this, false);
        int i17 = com.tencent.mm.R.id.ejo;
        android.widget.Space space = (android.widget.Space) x4.b.a(inflate, com.tencent.mm.R.id.ejo);
        if (space != null) {
            i17 = com.tencent.mm.R.id.thz;
            if (((androidx.constraintlayout.widget.ConstraintLayout) x4.b.a(inflate, com.tencent.mm.R.id.thz)) != null) {
                ...
                if (frameLayout != null) {
                    ...
                    if (((com.tencent.mm.plugin.finder.live.view.FinderLiveLikeContainer) x4.b.a(inflate, com.tencent.mm.R.id.tka)) != null) {
                        i17 = com.tencent.mm.R.id.f8o;
                        android.view.View a17 = x4.b.a(inflate, com.tencent.mm.R.id.f8o);
                        if (a17 != null) {
                            fg2.z.a(a17);
                            i17 = com.tencent.mm.R.id.f8p;
                            android.view.View a18 = x4.b.a(inflate, com.tencent.mm.R.id.f8p);
                            if (a18 != null) {
                                fg2.a0.a(a18);
                                                                ...
                                                                if (imageView2 != null) {
                                                                    ...
                                                                    if (finderFixedTextView != null) {
                                                                        ...
                                                                        if (mMPAGView != null) {
                                                                            ...
                                                                            this.f446659p1 = finderLiveMicHeartTeamLayout;
                                                                            ...
                                                                            this.f446661x1 = finderLiveMicTeamHeartText;
                                                                            ...
                                                                            this.f446658p0 = space;
                                                                            this.f446660x0 = frameLayout;
                                                                            android.widget.LinearLayout linearLayout = a38.f262315a;
                                                                            kotlin.jvm.internal.o.f(linearLayout, "getRoot(...)");
                                                                            this.f446663y1 = new wj2.j0(linearLayout, getPluginAbility(), getService());
                                                                            return;
                                                                        }
    ...
    public void e() {
        ...
        if (K != null) {
            android.view.ViewGroup viewGroup = this.f446659p1;
            if (viewGroup == null) {
        ...
        if (f0Var == null) {
            android.view.ViewGroup viewGroup2 = this.f446659p1;
            if (viewGroup2 == null) {
                kotlin.jvm.internal.o.o("teamHeartLayout");
                throw null;
            }
        ...
        if (K2 == null) {
            ...
            android.view.ViewGroup viewGroup3 = this.f446657l1;
            if (viewGroup3 == null) {
            ...
            yj0.a.d(finderLiveMicHeartText, arrayList2.toArray(), "com/tencent/mm/plugin/finder/live/mic/widget/normal/FinderLiveMicCoverAudioWidget", "onBindLinkMicUserUpdate", "()V", "android/view/View_EXEC_", "setVisibility", "(I)V");
            finderLiveMicHeartText.setVisibility(((java.lang.Integer) arrayList2.get(0)).intValue());
            yj0.a.f(finderLiveMicHeartText, "com/tencent/mm/plugin/finder/live/mic/widget/normal/FinderLiveMicCoverAudioWidget", "onBindLinkMicUserUpdate", "()V", "android/view/View_EXEC_", "setVisibility", "(I)V");
            ...
            if (x17 && g17.size() == 1 && (!getPluginAbility().a0().l().isEmpty())) {
                ...
                if (m()) {
                    android.view.ViewGroup viewGroup4 = this.f446657l1;
                    if (viewGroup4 == null) {
                        kotlin.jvm.internal.o.o("pkHearLayout");
                        throw null;
                    }
                    cVar.c(viewGroup4.getId(), 1);
                    android.view.ViewGroup viewGroup5 = this.f446657l1;
                    if (viewGroup5 == null) {
                        kotlin.jvm.internal.o.o("pkHearLayout");
                        throw null;
                    }
                    cVar.c(viewGroup5.getId(), 2);
                    android.view.ViewGroup viewGroup6 = this.f446657l1;
                    if (viewGroup6 == null) {
                        kotlin.jvm.internal.o.o("pkHearLayout");
                        throw null;
                    }
                    ...
                    android.view.ViewGroup viewGroup7 = this.f446657l1;
                    if (viewGroup7 == null) {
                        kotlin.jvm.internal.o.o("pkHearLayout");
                        throw null;
                    }
                    cVar.c(viewGroup7.getId(), 1);
                    android.view.ViewGroup viewGroup8 = this.f446657l1;
                    if (viewGroup8 == null) {
                        kotlin.jvm.internal.o.o("pkHearLayout");
                        throw null;
                    }
                    cVar.c(viewGroup8.getId(), 2);
                    android.view.ViewGroup viewGroup9 = this.f446657l1;
                    if (viewGroup9 == null) {
                        kotlin.jvm.internal.o.o("pkHearLayout");
                        throw null;
                    }
                ...
                android.view.ViewGroup viewGroup10 = this.f446659p1;
                if (viewGroup10 == null) {
                    kotlin.jvm.internal.o.o("teamHeartLayout");
                    throw null;
                }
                viewGroup10.setVisibility(0);
                android.widget.ImageView imageView = this.f446664z1;
                if (imageView == null) {
                    kotlin.jvm.internal.o.o("teamGiftIcon");
                    throw null;
                }
                imageView.setVisibility(8);
                android.widget.TextView textView = this.f446661x1;
                if (textView == null) {
                    kotlin.jvm.internal.o.o("teamHeartText");
                    throw null;
                }
                textView.setTypeface(android.graphics.Typeface.defaultFromStyle(0));
                android.widget.TextView textView2 = this.f446661x1;
                if (textView2 == null) {
                    kotlin.jvm.internal.o.o("teamHeartText");
                    throw null;
                }
                ...
                if (K2.f234161h == 1) {
                    android.widget.TextView textView3 = this.f446661x1;
                    if (textView3 == null) {
                        kotlin.jvm.internal.o.o("teamHeartText");
                        throw null;
                    }
                    android.widget.ImageView imageView2 = this.f446664z1;
                    if (imageView2 == null) {
                        kotlin.jvm.internal.o.o("teamGiftIcon");
                        throw null;
                    }
                    ...
                    android.widget.TextView textView4 = this.f446661x1;
                    if (textView4 == null) {
                        kotlin.jvm.internal.o.o("teamHeartText");
                        throw null;
                    }
                ...
                fj2.k m17 = a07.m(str);
                if ((m17 == null ? -1 : wj2.c.f446648b[m17.ordinal()]) == 1) {
                    android.view.ViewGroup viewGroup11 = this.f446659p1;
                    if (viewGroup11 == null) {
                        kotlin.jvm.internal.o.o("teamHeartLayout");
                        throw null;
                    }
                    ...
                    android.view.ViewGroup viewGroup12 = this.f446659p1;
                    if (viewGroup12 == null) {
                        kotlin.jvm.internal.o.o("teamHeartLayout");
                        throw null;
                    }
            ...
            super.e();
            android.view.ViewGroup viewGroup13 = this.f446657l1;
            if (viewGroup13 == null) {
                kotlin.jvm.internal.o.o("pkHearLayout");
                throw null;
            }
        ...
        if (f0Var2 == null) {
            super.e();
            android.view.ViewGroup viewGroup14 = this.f446657l1;
            if (viewGroup14 != null) {
    ...
    public android.widget.FrameLayout getCriticalGiftLayout() {
        android.widget.FrameLayout frameLayout = this.f446660x0;
        if (frameLayout != null) {
            return frameLayout;
        }
    ...
    public android.view.ViewGroup getLuckyMoneyRootView() {
        ...
        if (wj2.c.f446647a[getCurWidgetMode().ordinal()] != 1) {
    ...
    public void j(boolean z17) {
        ...
        if (i17 != space.getVisibility()) {
            ...
            android.widget.Space space2 = this.f446658p0;
            if (space2 == null) {
                kotlin.jvm.internal.o.o("anchorCriticalLayoutSpace");
                throw null;
            }
    ...
    */
    ...
    public void x() {
        ...
        android.view.ViewGroup.LayoutParams layoutParams2 = getFinderLiveMicStateAudioAvatar().getLayoutParams();
        if (layoutParams2 != null) {
            int avatarSize = getAvatarSize();
            layoutParams2.width = avatarSize;
            layoutParams2.height = avatarSize;
        }
        android.view.ViewGroup.LayoutParams layoutParams3 = getFinderLiveMicStateAudioWaveIcon().getLayoutParams();
        ...
        android.view.ViewGroup.LayoutParams layoutParams4 = getFinderLiveMicMuteIcon().getLayoutParams();
        if (layoutParams4 != null) {
            int muteIconSize = getMuteIconSize();
            layoutParams4.width = muteIconSize;
            layoutParams4.height = muteIconSize;
        }
        android.view.ViewGroup.LayoutParams layoutParams5 = getFinderLiveMicMuteIconWe().getLayoutParams();
