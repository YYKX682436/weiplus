...
public final class b {
    ...
    public final int f359042a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Map f359043b = new java.util.LinkedHashMap();
    ...
    */
    public final void a(long r6, r45.uc4 r8, int r9, boolean r10) {
        /*
            ...
            qy1.g r1 = qy1.g.f367725a
            int r2 = r5.f359042a
            java.lang.String r2 = r1.d(r2, r8)
            if (r2 != 0) goto Lf
            java.lang.String r2 = ""
        Lf:
            java.lang.String r8 = r8.f387219f
            if (r8 == 0) goto L63
            int r3 = r8.hashCode()
        ...
        L5c:
            ...
            r5.e(r3, r9)
        L63:
            java.util.Map r9 = r5.f359043b
            monitor-enter(r9)
            java.lang.String r3 = "history"
            boolean r3 = kotlin.jvm.internal.o.b(r8, r3)     // Catch: java.lang.Throwable -> Lc3
            if (r3 != 0) goto Lc1
            if (r10 != 0) goto Lc1
            java.util.Map r10 = r5.f359043b     // Catch: java.lang.Throwable -> Lc3
            ...
            r1.f359039b = r6     // Catch: java.lang.Throwable -> Lc3
            kotlin.jvm.internal.o.d(r8)     // Catch: java.lang.Throwable -> Lc3
            r1.f359041d = r8     // Catch: java.lang.Throwable -> Lc3
        ...
        L96:
            ...
            com.tencent.mars.xlog.Log.e(r10, r6)     // Catch: java.lang.Throwable -> Lc3
        Lc1:
            monitor-exit(r9)
            return
        Lc3:
        ...
        switch (eventType.ordinal()) {
            case 0:
                if (l17 != null) {
                    ...
                    if ((obj instanceof jz5.l ? (jz5.l) obj : null) != null) {
                        ...
                        a(longValue, (r45.uc4) lVar.f302833d, ((java.lang.Number) lVar.f302834e).intValue(), false);
                        return;
                    }
                    return;
                }
            ...
            case 1:
                if (l17 != null) {
                    ...
                    if ((obj instanceof jz5.l ? (jz5.l) obj : null) != null) {
                        ...
                        a(longValue2, (r45.uc4) lVar2.f302833d, ((java.lang.Number) lVar2.f302834e).intValue(), true);
                        return;
                    }
                    return;
                }
            ...
            case 2:
                if (l17 != null) {
                    ...
                    synchronized (this.f359043b) {
                        py1.a aVar = (py1.a) ((java.util.LinkedHashMap) this.f359043b).get(java.lang.Long.valueOf(longValue3));
                        if (aVar != null) {
                            if (!kotlin.jvm.internal.o.b(aVar.f359041d, "history")) {
                                aVar.f359040c = java.lang.System.currentTimeMillis();
            ...
            case 3:
                if (l17 != null) {
                    ...
                    synchronized (this.f359043b) {
                        py1.a aVar2 = (py1.a) ((java.util.LinkedHashMap) this.f359043b).get(java.lang.Long.valueOf(longValue4));
                        if (aVar2 != null) {
                            if (!kotlin.jvm.internal.o.b(aVar2.f359041d, "history")) {
                                if (aVar2.f359040c > 0) {
                                    long currentTimeMillis = java.lang.System.currentTimeMillis() - aVar2.f359040c;
                                    c(16, currentTimeMillis, aVar2.f359038a);
                                    aVar2.f359040c = 0L;
            ...
            case 4:
                if (l17 != null) {
                    ...
                    synchronized (this.f359043b) {
                        py1.a aVar3 = (py1.a) ((java.util.LinkedHashMap) this.f359043b).get(java.lang.Long.valueOf(longValue5));
                        if (aVar3 != null) {
                            if (!kotlin.jvm.internal.o.b(aVar3.f359041d, "history") && aVar3.f359039b > 0) {
                                long currentTimeMillis2 = java.lang.System.currentTimeMillis() - aVar3.f359039b;
                                c(11, currentTimeMillis2, aVar3.f359038a);
            ...
            case 9:
                ...
                return;
            case 10:
                jx3.f.INSTANCE.t(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_PLAY_LOADING, 36);
                qy1.g.f367725a.l(1, "");
                return;
            case 11:
                jx3.f.INSTANCE.t(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_PLAY_LOADING, 37);
                qy1.g.f367725a.l(2, "");
                return;
            case 12:
                d(101);
    ...
    public final void c(int i17, long j17, java.lang.String str) {
        ...
        if (j18 > 4) {
            com.tencent.mars.xlog.Log.i("MicroMsg.CgiEventObserveService", str + "  total time = " + j18);
        }
    }
    ...
    public final void f(int i17) {
        jx3.f.INSTANCE.t(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_PLAY_LOADING, 42);
        qy1.g.f367725a.l(i17, "");
    }
}
