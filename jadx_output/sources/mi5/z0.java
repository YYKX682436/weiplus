...
public final class z0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ bw5.o50 f326951d;

    public z0(bw5.o50 o50Var) {
        this.f326951d = o50Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        if (this.f326951d != null) {
            qk.f9 aj6 = ((rk4.z8) ((qk.g9) i95.n0.c(qk.g9.class))).aj();
            android.content.Context context = com.tencent.mm.sdk.platformtools.x2.f193071a;
            kotlin.jvm.internal.o.f(context, "getContext(...)");
            qk.f9.a(aj6, context, this.f326951d, bw5.ar0.TingScene_Chat, false, null, 24, null);
        }
