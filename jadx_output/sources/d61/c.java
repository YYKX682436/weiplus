            ...
            try {
                ...
                if (inputStream.read(bArr, 0, 8) < 8) {
                    try {
                        ...
                        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e17, "", new java.lang.Object[0]);
                    }
                    return false;
                }
                int e18 = e(bArr, 0);
                if (e(bArr, 4) != d61.a.f226689e || e18 <= 0) {
                    try {
                        inputStream.close();
                    } catch (java.io.IOException e19) {
                        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e19, "", new java.lang.Object[0]);
                    }
                    return false;
                }
                try {
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e27, "", new java.lang.Object[0]);
                }
                return true;
                ...
                if (inputStream != null) {
                    try {
                        ...
                        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e28, "", new java.lang.Object[0]);
                    }
                }
                throw th6;
            }
        } catch (java.lang.Exception e29) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e29, "", new java.lang.Object[0]);
            if (inputStream != null) {
                try {
                    inputStream.close();
                } catch (java.io.IOException e37) {
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e37, "", new java.lang.Object[0]);
                }
            }
            return false;
        }
    ...
    public static d61.a b(java.io.RandomAccessFile randomAccessFile, byte[] bArr, int i17) {
        ...
        try {
            ...
            while (read >= 8) {
                ...
                if (e18 != d61.a.f226690f && e18 != d61.a.f226694j) {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AtomUtil", e19, "", new java.lang.Object[0]);
            com.tencent.mars.xlog.Log.e("MicroMsg.AtomUtil", "find Atom error: " + e19.toString());
            return aVar;
        }
    }
