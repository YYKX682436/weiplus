...
public final class k1 {
    ...
    public static volatile ws2.k1 f449067s;

    /* renamed from: b, reason: collision with root package name */
    public zs2.c f449070b;

    /* renamed from: c, reason: collision with root package name */
    public gk2.e f449071c;

    /* renamed from: e, reason: collision with root package name */
    public dt2.b0 f449073e;

    /* renamed from: f, reason: collision with root package name */
    public dt2.t f449074f;

    /* renamed from: m, reason: collision with root package name */
    public boolean f449081m;

    /* renamed from: n, reason: collision with root package name */
    public boolean f449082n;

    /* renamed from: o, reason: collision with root package name */
    public dt2.a0 f449083o;

    /* renamed from: p, reason: collision with root package name */
    public ws2.b f449084p;

    /* renamed from: q, reason: collision with root package name */
    public ws2.l f449085q;

    /* renamed from: r, reason: collision with root package name */
    public static final ws2.u0 f449066r = new ws2.u0(null);

    /* renamed from: t, reason: collision with root package name */
    public static final jz5.g f449068t = jz5.h.b(ws2.t0.f449142d);

    /* renamed from: a, reason: collision with root package name */
    public final java.util.List f449069a = new java.util.ArrayList();

    /* renamed from: d, reason: collision with root package name */
    public final zs2.a f449072d = new zs2.a();

    /* renamed from: g, reason: collision with root package name */
    public final jz5.g f449075g = jz5.h.b(new ws2.w0(this));

    /* renamed from: h, reason: collision with root package name */
    public final jz5.g f449076h = jz5.h.b(new ws2.j1(this));

    /* renamed from: i, reason: collision with root package name */
    public final jz5.g f449077i = jz5.h.b(new ws2.h1(this));

    /* renamed from: j, reason: collision with root package name */
    public final jz5.g f449078j = jz5.h.b(new ws2.d1(this));

    /* renamed from: k, reason: collision with root package name */
    public final java.util.HashSet f449079k = new java.util.HashSet();

    /* renamed from: l, reason: collision with root package name */
    public final java.util.HashSet f449080l = new java.util.HashSet();

    public static final boolean a(ws2.k1 k1Var) {
        k1Var.getClass();
        com.tencent.mm.app.w.INSTANCE.getClass();
        java.lang.String str = (java.lang.String) kz5.n0.i0(new java.util.ArrayList(com.tencent.mm.app.w.f53877v));
        dt2.b0 b0Var = k1Var.f449073e;
        android.content.Context uIContext = b0Var != null ? b0Var.getUIContext() : null;
        android.app.Activity activity = uIContext instanceof android.app.Activity ? (android.app.Activity) uIContext : null;
        return kotlin.jvm.internal.o.b(activity != null ? activity.getClass().getName() : null, str);
    }

    public static final void b(ws2.k1 k1Var, int i17) {
        ct2.j jVar = (ct2.j) k1Var.e(ct2.j.class);
        boolean z17 = false;
        int i18 = jVar != null ? jVar.f222274r : 0;
        ...
        sb6.append(jVar3 != null ? java.lang.Integer.valueOf(jVar3.f222273q) : null);
    ...
    public static final void d(ws2.k1 k1Var, android.content.Intent intent) {
        ...
        if (tVar != null) {
            ...
            android.graphics.Point a17 = c1Var != null ? ko0.t.f309903a.a(c1Var.f328879s2, c1Var.f328885t2) : new android.graphics.Point(com.tencent.mm.ui.zk.e(com.tencent.mm.sdk.platformtools.x2.f193071a, com.tencent.mm.R.dimen.f480520a10), com.tencent.mm.ui.zk.e(com.tencent.mm.sdk.platformtools.x2.f193071a, com.tencent.mm.R.dimen.a0z));
            ct2.j jVar = (ct2.j) k1Var.e(ct2.j.class);
            ...
            ws2.u0 u0Var = f449066r;
            u0Var.a().k((ws2.l2) ((jz5.n) tVar.f243202n).getValue());
            fo0.n a18 = tVar.a();
            dt2.a0 a0Var = u0Var.a().f449083o;
            a18.d(a17, O6, T6, intExtra, 12, new fo0.s(a0Var != null && a0Var.f243158a.isPlaying(), 0, false, false, false, null, null, false, 254, null));
        }
    }
    ...
    public final androidx.lifecycle.c1 e(java.lang.Class bu6) {
        kotlin.jvm.internal.o.g(bu6, "bu");
        gk2.e eVar = this.f449071c;
        if (eVar != null) {
            return eVar.a(bu6);
        }
        return null;
    ...
    public final com.tencent.mm.plugin.finder.live.controller.base.LiveRoomControllerStore f() {
        km2.m a17;
        zs2.c cVar = this.f449070b;
    ...
    public final boolean g(long j17, android.content.Intent intent, r45.mt2 mt2Var, boolean z17) {
        ...
        if (mt2Var == null) {
            com.tencent.mars.xlog.Log.e("FinderLiveReplayService", "initData fail!");
            return false;
        }
        l(3, j17, true);
        zs2.c cVar2 = new zs2.c();
        cVar2.f475246a = mt2Var;
        cVar2.b(mt2Var.getInteger(4));
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.LinkedList list = mt2Var.getList(1);
        ...
        while (true) {
            ...
            if (finderObject != null) {
                ...
                aVar.v(mVar, finderObject, 2);
            }
            if (mVar != null) {
                r45.nw1 liveInfo = finderObject.getLiveInfo();
                if (liveInfo != null && (i72Var = (r45.i72) liveInfo.getCustom(44)) != null) {
                    ((ct2.j) mVar.f309130e.a(ct2.j.class)).a7(i72Var.getInteger(2), java.lang.Boolean.TRUE);
                }
                arrayList.add(mVar);
            }
        }
        cVar2.f475248c = arrayList;
        if (intent.hasExtra("KEY_PAGE_TYPE")) {
            java.lang.String stringExtra = intent.getStringExtra("KEY_PAGE_TYPE");
            if (stringExtra == null) {
                stringExtra = "";
            }
            com.tencent.mars.xlog.Log.i("FinderReplayLiveData", "set pageType from " + cVar2.f475250e + " to " + stringExtra);
            cVar2.f475250e = stringExtra;
        }
        if (intent.hasExtra("KEY_PAGE_SUB_TYPE")) {
            int intExtra = intent.getIntExtra("KEY_PAGE_SUB_TYPE", 0);
            com.tencent.mars.xlog.Log.i("FinderReplayLiveData", "set pageSubType from " + cVar2.f475251f + " to " + intExtra);
            cVar2.f475251f = intExtra;
        }
        cVar2.c(null);
        java.util.Iterator it6 = cVar2.f475248c.iterator();
        while (it6.hasNext()) {
            r45.i72 i72Var2 = (r45.i72) ((mm2.e1) ((km2.m) it6.next()).f309130e.a(mm2.e1.class)).f328988r.getCustom(44);
            if (i72Var2 != null) {
                i72Var2.set(1, 0L);
            }
        }
        com.tencent.mars.xlog.Log.i("FinderLiveReplayService", "set replayData:" + cVar2.hashCode() + ',' + i());
        this.f449070b = cVar2;
        km2.m a17 = cVar2.a();
        if (a17 == null || (eVar = a17.f309130e) == null || (nw1Var = ((mm2.e1) eVar.a(mm2.e1.class)).f328988r) == null) {
            return true;
        }
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("initData liveInfo:");
        sb6.append(aVar.y(nw1Var));
        sb6.append(",replayInfo:");
        r45.i72 i72Var3 = (r45.i72) nw1Var.getCustom(44);
    ...
    */
    public final void h() {
        /*
            r8 = this;
            dt2.t r0 = r8.f449074f
            if (r0 != 0) goto Le
            jz5.g r0 = r8.f449075g
            jz5.n r0 = (jz5.n) r0
    ...
    public final java.lang.String i() {
        ...
        if (this.f449071c == null) {
            ...
            dt2.a0 a0Var = this.f449083o;
            sb6.append(a0Var != null ? a0Var.hashCode() : 0);
            sb6.append("-player:");
            dt2.a0 a0Var2 = this.f449083o;
            finderLiveThumbPlayerProxy = a0Var2 != null ? a0Var2.f243158a : null;
            sb6.append(finderLiveThumbPlayerProxy != null ? finderLiveThumbPlayerProxy.hashCode() : 0);
            sb6.append("-layout:");
            dt2.b0 b0Var = this.f449073e;
        ...
        dt2.a0 a0Var3 = this.f449083o;
        sb7.append(a0Var3 != null ? a0Var3.hashCode() : 0);
        sb7.append("-player:");
        dt2.a0 a0Var4 = this.f449083o;
        finderLiveThumbPlayerProxy = a0Var4 != null ? a0Var4.f243158a : null;
        sb7.append(finderLiveThumbPlayerProxy != null ? finderLiveThumbPlayerProxy.hashCode() : 0);
        sb7.append("-layout:");
        dt2.b0 b0Var2 = this.f449073e;
    ...
    public final jz5.l j(long j17, dt2.a0 a0Var) {
        ...
        ws2.i1 i1Var = (ws2.i1) ((jz5.n) this.f449076h).getValue();
        com.tencent.mm.plugin.finder.replay.FinderLiveThumbPlayerProxy finderLiveThumbPlayerProxy = a0Var2.f243158a;
        finderLiveThumbPlayerProxy.setVideoViewCallback(i1Var);
        finderLiveThumbPlayerProxy.setLifecycle((ws2.g1) ((jz5.n) this.f449077i).getValue());
        ws2.x0 x0Var = new ws2.x0(this);
        finderLiveThumbPlayerProxy.setSeiInfoCallback(a0Var2.f243160c);
        a0Var2.f243159b = x0Var;
        return new jz5.l(a0Var2, java.lang.Boolean.FALSE);
    }

    public final void k(ws2.m2 proxy) {
        kotlin.jvm.internal.o.g(proxy, "proxy");
        com.tencent.mars.xlog.Log.i("FinderLiveReplayService", "registerSeiProcessViewCallbackProxy:" + proxy.hashCode());
        this.f449080l.add(proxy);
        proxy.g(this.f449081m, this.f449082n);
    }
    ...
    */
    ...
    public final void o(gk2.e buContext, zs2.a config) {
        ...
        n(buContext);
        zs2.a aVar = this.f449072d;
        aVar.getClass();
        aVar.f475244a = config.f475244a;
        aVar.f475245b = config.f475245b;
        if (aVar.f475245b) {
            zs2.g gVar = (zs2.g) ((ct2.e) pf5.u.f353936a.e(zy2.b6.class).a(ct2.e.class)).f222254e.get(java.lang.Long.valueOf(((ct2.j) buContext.a(ct2.j.class)).O6()));
            java.lang.Integer valueOf = gVar != null ? java.lang.Integer.valueOf(gVar.f475257a) : null;
            if (valueOf != null) {
                int intValue = valueOf.intValue();
                str = "change offset:" + ((ct2.j) buContext.a(ct2.j.class)).f222273q + " to " + intValue;
        ...
        dt2.t tVar = this.f449074f;
        if (tVar != null) {
            tVar.p(this.f449071c);
        }
        je2.y yVar = (je2.y) e(je2.y.class);
        if (yVar != null) {
            ws2.c1 c1Var = (ws2.c1) ((jz5.n) this.f449078j).getValue();
        ...
        sb7.append(' ');
        sb7.append(str);
        com.tencent.mars.xlog.Log.i("FinderLiveReplayService", sb7.toString());
    }

    /* JADX WARN: Code restructure failed: missing block: B:37:0x00bf, code lost:
    
        if (((g25.e) r8).f267980c == true) goto L45;
     */
    ...
    */
    public final void p(dt2.b0 r7, qs5.o r8) {
        ...
        L3d:
            ...
            goto L4b
        L46:
            kn0.m r1 = kn0.m.f309573d
            r0.e7(r1)
        L4b:
            dt2.b0 r0 = r6.f449073e
            if (r0 == 0) goto L57
        ...
        L62:
            ...
            r1.i(r0, r2)
        L79:
            qs5.o r7 = qs5.o.f366455h
            if (r8 != r7) goto Ld0
            ws2.l r7 = r6.f449085q
            if (r7 != 0) goto L86
            ws2.l r7 = new ws2.l
            r7.<init>()
        L86:
    ...
    public final void q(dt2.b0 b0Var) {
        zl2.r4.f473950a.N2("FinderLiveReplayService", "set replayFullScreenView:" + b0Var);
        this.f449073e = b0Var;
    }
    ...
    public final void r(android.content.Intent intent) {
        ...
        if (((c61.p2) ((c61.yb) i95.n0.c(c61.yb.class))).Hj()) {
            com.tencent.mm.sdk.platformtools.u3.i(new java.lang.Runnable(f1Var) { // from class: ws2.b1

                /* renamed from: d, reason: collision with root package name */
                public final /* synthetic */ yz5.a f449010d;
    ...
    public final void s(ws2.m2 proxy) {
        kotlin.jvm.internal.o.g(proxy, "proxy");
        com.tencent.mars.xlog.Log.i("FinderLiveReplayService", "unregisterSeiProcessViewCallbackProxy:" + proxy.hashCode());
        this.f449080l.remove(proxy);
    }
}
