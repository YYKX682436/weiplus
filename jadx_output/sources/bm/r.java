...
public class r extends xn5.g {
    ...
    public android.view.View c(android.content.Context context) {
        ...
        com.tencent.mm.plugin.sns.ui.item.improve.view.ImproveVideoFrameLayout improveVideoFrameLayout = (com.tencent.mm.plugin.sns.ui.item.improve.view.ImproveVideoFrameLayout) h(context, "com.tencent.mm.plugin.sns.ui.item.improve.view.ImproveVideoFrameLayout", 1);
        ...
        com.tencent.mm.plugin.sns.ui.MaskImageView maskImageView = (com.tencent.mm.plugin.sns.ui.MaskImageView) h(context, "com.tencent.mm.plugin.sns.ui.MaskImageView", 2);
        ...
        com.tencent.mm.view.x2c.X2CImageView x2CImageView = (com.tencent.mm.view.x2c.X2CImageView) h(context, "com.tencent.mm.view.x2c.X2CImageView", 3);
        ...
        i0Var.v(context, layoutParams3, "X2CRelativeLayout.LayoutParams", -1);
    ...
    public android.view.View f(android.content.Context context, android.util.AttributeSet attributeSet, java.lang.String str, int i17) {
        ...
        if (i17 == 1) {
            view = (com.tencent.mm.plugin.sns.ui.item.improve.view.ImproveVideoFrameLayout) h(context, "com.tencent.mm.plugin.sns.ui.item.improve.view.ImproveVideoFrameLayout", 1);
            if (view != null) {
        ...
        if (i17 == 2) {
            view = (com.tencent.mm.plugin.sns.ui.MaskImageView) h(context, "com.tencent.mm.plugin.sns.ui.MaskImageView", 2);
            if (view != null) {
                xn5.i0 i0Var = xn5.j0.f455685a;
        ...
        if (i17 == 3) {
            view = (com.tencent.mm.view.x2c.X2CImageView) h(context, "com.tencent.mm.view.x2c.X2CImageView", 3);
            if (view != null) {
    ...
    public int getLayoutId() {
        return com.tencent.mm.R.layout.csr;
    }
