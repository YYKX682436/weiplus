...
public class k implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.friend.ui.FindMContactAddUI f403362d;

    public k(com.tencent.mm.plugin.account.friend.ui.FindMContactAddUI findMContactAddUI) {
        this.f403362d = findMContactAddUI;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        android.widget.ListView listView = this.f403362d.f73116e;
