...
public class b extends co.a {
    ...
    public l15.c j() {
        return (l15.c) super.getCustom(this.f344815e + 0);
    }

    public void k(java.lang.String str) {
        super.set(this.f344815e + 1, str);
    }

    public void l(l15.c cVar) {
        super.set(this.f344815e + 0, cVar);
    }
}
