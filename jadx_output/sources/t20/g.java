...
public final class g extends i95.w implements pq.r {
    ...
    public final java.util.Map f414671d = new java.util.LinkedHashMap();

    public final y02.n0 Ai(android.view.View view) {
        kotlin.jvm.internal.o.g(view, "view");
        java.lang.Object tag = view.getTag(com.tencent.mm.R.id.t68);
    ...
    public void Bi(android.view.View view) {
        ...
        y02.n0 Ai = Ai(view);
        if (Ai == null) {
            com.tencent.mars.xlog.Log.w("Ecs.Oracle.EcsOracleService", "[handleClick] session is null, view:%s", view);
            return;
        }
        com.tencent.mars.xlog.Log.i("Ecs.Oracle.EcsOracleService", "[handleClick] view:%s", view);
        t20.c cVar = new t20.c(Ai);
        if (!kotlin.jvm.internal.o.b(android.os.Looper.myLooper(), android.os.Looper.getMainLooper())) {
            cVar.invoke();
            return;
        }
        ((ku5.t0) ku5.t0.f312615d).i(new t20.f(cVar));
    }

    public final void Di(android.view.View view) {
        kotlin.jvm.internal.o.g(view, "view");
        java.lang.Object tag = view.getTag(com.tencent.mm.R.id.t67);
        java.lang.String str = tag instanceof java.lang.String ? (java.lang.String) tag : null;
        if (str != null) {
            java.util.Map map = this.f414671d;
            ...
            view.setTag(com.tencent.mm.R.id.t67, null);
        }
        b30.t tVar = b30.t.f17582a;
        if (tVar.a() == null) {
            com.tencent.mars.xlog.Log.e("ViewTouchBinderHelper", "Failed to unbind preload jump info on touch");
        } else {
            b30.s a17 = tVar.a();
            if (a17 != null) {
                android.view.View.OnTouchListener a18 = a17.a(view);
                if (a18 instanceof b30.r) {
                    view.setOnTouchListener(((b30.r) a18).f17577d);
                }
            }
        }
        view.setTag(com.tencent.mm.R.id.t68, null);
        com.tencent.mars.xlog.Log.i("Ecs.Oracle.EcsOracleService", "[unbindFromView] view:%s", view);
    }
    ...
    public final void wi(android.view.View view) {
        ...
        b30.t tVar = b30.t.f17582a;
        if (tVar.a() == null) {
            com.tencent.mars.xlog.Log.e("ViewTouchBinderHelper", "Failed to bind preload jump info on touch");
        } else {
            b30.s a17 = tVar.a();
