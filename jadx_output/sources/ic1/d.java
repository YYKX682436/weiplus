...
public class d extends com.tencent.mm.plugin.appbrand.jsapi.f {
    ...
    public static final java.lang.String NAME = "setEntryPagePath";
    ...
    public void A(com.tencent.mm.plugin.appbrand.jsapi.l lVar, org.json.JSONObject jSONObject, int i17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.JsApiSetEntryPagePath", "setEntryPagePath value:%s appId %s", optString, appId);
        if (!com.tencent.mm.sdk.platformtools.t8.K0(appId)) {
            lVar.o(new ic1.c(this, optString, appId, lVar, i17));
            return;
        }
