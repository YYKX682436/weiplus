...
public class l2 {
    ...
    public final java.util.Map f37305a = new c01.k2(null);

    public boolean a(java.lang.String str) {
        return ((java.util.concurrent.ConcurrentHashMap) this.f37305a).containsKey(str);
    }

    public java.lang.Object b(java.lang.String str) {
        return ((c01.k2) this.f37305a).get(str);
    }
    ...
    public boolean d(java.lang.String str, boolean z17) {
        ...
        java.lang.Object obj = ((c01.k2) this.f37305a).get(str);
    ...
    public void h() {
        ((java.util.concurrent.ConcurrentHashMap) this.f37305a).clear();
    }

    public c01.l2 i(java.lang.String str, java.lang.Object obj) {
        if (!android.text.TextUtils.isEmpty(str)) {
            ((c01.k2) this.f37305a).put(str, obj);
        }
        return this;
    }
    ...
    public c01.l2 j(java.lang.String str, boolean z17) {
        if (!android.text.TextUtils.isEmpty(str)) {
            ((c01.k2) this.f37305a).put(str, java.lang.Boolean.valueOf(z17));
        }
        return this;
    }
    ...
    public c01.l2 k(java.lang.String str, java.lang.String str2) {
        if (!android.text.TextUtils.isEmpty(str)) {
            ((c01.k2) this.f37305a).put(str, str2);
        }
        return this;
    }
}
