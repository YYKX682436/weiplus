...
public abstract class h2 {
    ...
    public static final java.util.Comparator f37224a = new c01.f2();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.List f37225b = new java.util.ArrayList();
    ...
    public static int a(java.lang.String str, java.lang.String str2) {
        ...
        synchronized (f37225b) {
            int i18 = 0;
            z17 = false;
            while (true) {
                java.util.List list = f37225b;
                if (i18 < ((java.util.ArrayList) list).size()) {
                    c01.g2 g2Var = (c01.g2) ((java.util.ArrayList) list).get(i18);
                    if (g2Var != null && (z17 = ((aq1.j1) g2Var).a(str, str2, pInt))) {
                        i17 = pInt.value;
                        break;
                    }
                    i18++;
    ...
    public static int b(java.lang.String str) {
        ...
        if (com.tencent.mm.storage.z3.C3(str) || com.tencent.mm.storage.z3.B3(str) || com.tencent.mm.storage.z3.j4(str)) {
            return 7;
        }
        if (com.tencent.mm.storage.z3.o4(str)) {
            return 9;
        }
        if (com.tencent.mm.storage.z3.y4(str)) {
            return 8;
        }
        if (c01.e2.G(str)) {
            return 6;
    ...
    public static int c(int i17) {
        int i18 = 0;
        if (!gm0.j1.a()) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ConversationLogic", "get total unread with black list, but has not set uin");
            return 0;
        }
        ...
        while (it.hasNext()) {
            i18 += ((com.tencent.mm.storage.l4) it.next()).d1();
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ConversationLogic", "get count %d with black list use %d ms", java.lang.Integer.valueOf(i18), java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime));
        return i18;
    }
    ...
    public static int d(java.lang.String str, java.lang.String[] strArr) {
        ...
        int i17 = 0;
        if (!gm0.j1.a()) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ConversationLogic", "get total unread, but has not set uin");
            return 0;
        }
        com.tencent.mm.storage.m4 Di = ((com.tencent.mm.plugin.messenger.foundation.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Di();
        Di.getClass();
        android.database.Cursor B = Di.f195117d.B("select unReadCount, parentRef from rconversation where username = '" + str + "' AND unReadCount > 0 ", null);
    ...
    public static java.util.Map e(java.lang.String str) {
        ...
        if (!gm0.j1.a()) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ConversationLogic", "get Total Unread Talker, but has not set uin");
            return hashMap;
        }
        boolean z17 = com.tencent.mm.sdk.platformtools.t8.f192989a;
        long elapsedRealtime = android.os.SystemClock.elapsedRealtime();
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ConversationStorage", "get total unread contact with black list, sql is %s", sb7);
        android.database.Cursor B = Di.f195117d.B(sb7, null);
        if (B != null) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ConversationLogic", "[getTotalUnreadTalker] cost %d ms  unread contact: %s, stack %s", java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime), hashMap.keySet(), new com.tencent.mm.sdk.platformtools.z3());
        return hashMap;
    }
    ...
    public static java.util.HashMap f(int i17) {
        ...
        com.tencent.mm.storage.m4 Di = ((com.tencent.mm.plugin.messenger.foundation.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Di();
        Di.getClass();
        com.tencent.mars.xlog.Log.i("MicroMsg.ConversationStorage", "getUnreadConversationCursor filterType[%d] [%s]", java.lang.Integer.valueOf(i17), new com.tencent.mm.sdk.platformtools.z3());
        ...
        android.database.Cursor B2 = Di.f195117d.B(sb6.toString(), null);
        java.util.HashMap hashMap = new java.util.HashMap();
        if (B2 == null) {
            return hashMap;
        }
        ...
        if (!hashSet3.isEmpty() && (B = ((com.tencent.mm.plugin.messenger.foundation.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Bi().B(new java.util.ArrayList(hashSet3))) != null) {
            while (B.moveToNext()) {
                com.tencent.mm.storage.z3 z3Var = new com.tencent.mm.storage.z3();
                z3Var.convertFrom(B);
                if (i(z3Var)) {
        ...
        java.util.Collection<com.tencent.mm.storage.l4> values = hashMap.values();
        java.lang.String b17 = com.tencent.mm.sdk.platformtools.z3.b(true);
        if (values == null) {
            boolean z18 = com.tencent.mm.sdk.platformtools.t8.f192989a;
            com.tencent.mars.xlog.Log.i("MicroMsg.ConversationLogic", "print2log conversations=null, cost=%d, stack=%s", java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime), b17);
        } else {
            java.util.Comparator comparator = f37224a;
            java.util.PriorityQueue priorityQueue = new java.util.PriorityQueue(10, comparator);
            for (com.tencent.mm.storage.l4 l4Var2 : values) {
                if (priorityQueue.size() < 10) {
                    priorityQueue.offer(l4Var2);
                } else if (((c01.f2) comparator).compare((com.tencent.mm.storage.l4) priorityQueue.peek(), l4Var2) < 0) {
                    priorityQueue.poll();
                    priorityQueue.offer(l4Var2);
                }
            }
            ...
            while (priorityQueue.size() > 0) {
                com.tencent.mm.storage.l4 l4Var3 = (com.tencent.mm.storage.l4) priorityQueue.poll();
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.ConversationLogic", "print2log totalSize=%d, conversations=%s; cost=%d, stack=%s", valueOf, sb10, java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime), b17);
        }
        return hashMap;
    }
    ...
    public static java.util.List g() {
        ...
        if (!gm0.j1.u().c().o(com.tencent.mm.storage.u3.USERINFO_SERVICE_NOTIFY_MESSAGE_NOTICE_BOOLEAN_SYNC, true)) {
            arrayList.add("notifymessage");
        }
        if (!gm0.j1.u().c().o(com.tencent.mm.storage.u3.USERINFO_WXA_CUSTOM_SESSION_MESSAGE_NOTICE_BOOLEAN_SYNC, true)) {
    ...
    public static boolean i(com.tencent.mm.storage.z3 z3Var) {
        ...
        return com.tencent.mm.storage.z3.R4(z3Var.d1()) && z3Var.T == 0;
    }
    ...
    public static void j(java.lang.String str) {
        ...
        if (p17 != null && (com.tencent.mm.sdk.platformtools.t8.K0(p17.W0()) || "message_fold".equalsIgnoreCase(p17.W0()) || "conversationboxservice".equalsIgnoreCase(p17.W0()))) {
            ((com.tencent.mm.plugin.messenger.foundation.h2) ((vg3.x3) gm0.j1.s(vg3.x3.class))).Di().P(new java.lang.String[]{str}, "hidden_conv_parent");
            return;
        }
