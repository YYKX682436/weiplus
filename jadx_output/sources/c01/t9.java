...
public class t9 {
    ...
    public static c01.t9 f37466b;

    /* renamed from: a, reason: collision with root package name */
    public c01.s9 f37467a;
        ...
        if (i17 != -1) {
            ...
            if (i17 == 1) {
                ...
                if (a17 == r9Var || a17 == c01.r9.SUCC_UNLOAD) {
                    d01.f.wi().getClass();
                    com.tencent.mars.xlog.Log.i("MicorMsg.MainFrameBannerStorage", "already Bind the Mobile");
                } else {
                    d01.f.wi().getClass();
                }
            } else if (i17 != 2) {
                if (i17 == 3) {
                    com.tencent.mars.xlog.Log.i("MicorMsg.MainFrameBannerStorage", "avatar already existed");
                    return null;
                }
                ...
                if (a() == r9Var) {
                    d01.f.wi().getClass();
                    com.tencent.mars.xlog.Log.i("MicorMsg.MainFrameBannerStorage", "already upload the contacts");
                    return null;
                }
                d01.f.wi().getClass();
            }
    ...
    public boolean g(c01.q9 q9Var) {
        ...
        if (contains) {
            edit.putInt("CurrentType", i17).putInt("CurrentShowType", q9Var.f37400b).putString("CurrentData", q9Var.f37401c).commit();
        }
        c01.s9 s9Var2 = this.f37467a;
        if (s9Var2 != null) {
            ((com.tencent.mm.ui.conversation.banner.r) s9Var2).a();
        }
        return contains;
    }
}
