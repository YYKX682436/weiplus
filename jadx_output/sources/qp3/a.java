...
public abstract class a {
    public static void a(java.lang.String str, java.lang.String str2, android.os.PersistableBundle persistableBundle) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.WxPayAdUxInfoTracer", "AppBrandRuntime(%s)-%s, adUxInfo=%s, commonUxInfo=%s", str2, str, str3, string);
    }

    public static void b(java.lang.String str, java.lang.Object... objArr) {
        com.tencent.mars.xlog.Log.i("MicroMsg.WxPayAdUxInfoTracer", "trace: " + str, objArr);
    }

    public static void c(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4) {
        com.tencent.mars.xlog.Log.i("MicroMsg.WxPayAdUxInfoTracer", "trace: scene[%s] api[%s] adUxInfo[%s] source[%s]", str, str2, str3, str4);
    }

    public static void d(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4) {
        com.tencent.mars.xlog.Log.i("MicroMsg.WxPayAdUxInfoTracer", "trace: scene[%s] api[%s] commonUxInfo[%s] source[%s]", str, str2, str3, str4);
    }
}
