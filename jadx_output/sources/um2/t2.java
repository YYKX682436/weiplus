...
public final class t2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ um2.x5 f428965d;
    ...
    public final void onClick(android.view.View view) {
        ...
        if (((pl2.x) pf5.z.f353948a.a(activity).a(pl2.x.class)).f356683f) {
            androidx.appcompat.app.AppCompatActivity activity2 = x5Var.f19605b;
            kotlin.jvm.internal.o.g(activity2, "activity");
            pl2.s sVar = ((pl2.x) pf5.z.f353948a.a(activity2).a(pl2.x.class)).f356684g;
            if (sVar != null) {
                pl2.s.e(sVar, 0L, null, 3, null);
            }
            androidx.appcompat.app.AppCompatActivity activity3 = x5Var.f19605b;
            kotlin.jvm.internal.o.g(activity3, "activity");
            ((pl2.x) pf5.z.f353948a.a(activity3).a(pl2.x.class)).f356687m.f356678h = 3;
        }
