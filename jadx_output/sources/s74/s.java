...
public final class s implements android.view.View.OnLayoutChangeListener {
    ...
    public final /* synthetic */ s74.o0 f404531d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f404532e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ s74.f3 f404533f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ android.view.View f404534g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ android.widget.FrameLayout f404535h;

    /* renamed from: i, reason: collision with root package name */
    public final /* synthetic */ android.view.ViewGroup.MarginLayoutParams f404536i;
    ...
    public s(s74.o0 o0Var, android.view.View view, s74.f3 f3Var, android.view.View view2, android.widget.FrameLayout frameLayout, android.view.ViewGroup.MarginLayoutParams marginLayoutParams) {
        ...
        this.f404533f = f3Var;
        this.f404534g = view2;
        this.f404535h = frameLayout;
        this.f404536i = marginLayoutParams;
    }
    ...
    public final void onLayoutChange(android.view.View view, int i17, int i18, int i19, int i27, int i28, int i29, int i37, int i38) {
        ...
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onLayoutChange", "com.tencent.mm.plugin.sns.ad.timeline.item.dynamicview.AbsDynamicComponent$measureAbsolute$1$2$1");
        s74.o0 o0Var = this.f404531d;
        ...
        android.view.View view2 = this.f404532e;
        org.json.JSONObject g17 = q4Var.g(view2);
        s74.f3 f3Var = this.f404533f;
        sb6.append(g17 != null ? f3Var.l(g17) : null);
        sb6.append(" cd = ");
        android.view.View view3 = this.f404534g;
        ...
        if (view2.getParent() instanceof android.view.View) {
            android.widget.FrameLayout frameLayout = this.f404535h;
            if (!kotlin.jvm.internal.o.b(view2, frameLayout) && !kotlin.jvm.internal.o.b(view2.getParent(), frameLayout)) {
        ...
        android.view.View view5 = this.f404534g;
        ...
        android.view.ViewGroup.MarginLayoutParams marginLayoutParams = this.f404536i;
        ...
        while (true) {
            ...
            if (((java.lang.Number) lVar.f302833d).intValue() != ((java.lang.Number) lVar.f302834e).intValue()) {
                break;
            }
        }
        if (obj != null) {
            ...
            kotlinx.coroutines.y0 h17 = o0Var.h();
            if (h17 != null) {
                kotlinx.coroutines.l.d(h17, null, null, new s74.r(view3, null), 3, null);
            }
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onLayoutChange", "com.tencent.mm.plugin.sns.ad.timeline.item.dynamicview.AbsDynamicComponent$measureAbsolute$1$2$1");
    }
}
