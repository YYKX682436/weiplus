...
public final class h4 implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ double f404331d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ double f404332e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f404333f;
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator value) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onAnimationUpdate", "com.tencent.mm.plugin.sns.ad.timeline.item.dynamicview.DynamicViewUtils$processAlphaAnimation$1");
        ...
        float floatValue = (float) (((1 - r3) * this.f404331d) + (((f17 != null ? f17.floatValue() : 0.0f) / 100.0f) * this.f404332e));
        if (floatValue >= 1.0f) {
            android.view.View view = this.f404333f;
            ...
            android.view.View view2 = this.f404333f;
            ...
            android.view.View view3 = this.f404333f;
        ...
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onAnimationUpdate", "com.tencent.mm.plugin.sns.ad.timeline.item.dynamicview.DynamicViewUtils$processAlphaAnimation$1");
    }
}
