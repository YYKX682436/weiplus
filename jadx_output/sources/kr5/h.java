...
public class h implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.content.Context f311565d;

    public h(android.content.Context context) {
        this.f311565d = context;
    }

    @Override // java.lang.Runnable
    public void run() {
        try {
            boolean z17 = kr5.p.f311571b.f311564s;
            android.content.Context context = this.f311565d;
            if (z17) {
