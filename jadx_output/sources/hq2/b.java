...
public final class b implements so2.j5, wp2.a {
    ...
    public final r45.fa2 f283207d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.ArrayList f283208e;

    public b(r45.fa2 container) {
        kotlin.jvm.internal.o.g(container, "container");
        this.f283207d = container;
        this.f283208e = new java.util.ArrayList();
    }

    @Override // wp2.a
    public com.tencent.mm.protobuf.g a() {
        return this.f283207d.f374132n;
    }

    @Override // wp2.a
    public void b(int i17) {
        this.f283207d.f374130i = i17;
    }

    @Override // wp2.a
    public int c() {
        return this.f283208e.size();
    }

    @Override // com.tencent.mm.plugin.finder.feed.model.internal.r0
    public int d(com.tencent.mm.plugin.finder.feed.model.internal.r0 obj) {
        kotlin.jvm.internal.o.g(obj, "obj");
        return ((obj instanceof hq2.b) && ((hq2.b) obj).f283207d.f374125d == this.f283207d.f374125d) ? 0 : -1;
    }

    @Override // wp2.a
    public void f(com.tencent.mm.protobuf.g gVar) {
        this.f283207d.f374132n = gVar;
    }

    @Override // wp2.a
    public java.util.List g() {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.LinkedList card_list = this.f283207d.f374129h;
