...
public class f2 extends android.animation.AnimatorListenerAdapter {
    ...
    public final /* synthetic */ rp1.h2 f398396d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.ViewPropertyAnimator f398397e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f398398f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ rp1.k2 f398399g;

    public f2(rp1.k2 k2Var, rp1.h2 h2Var, android.view.ViewPropertyAnimator viewPropertyAnimator, android.view.View view) {
        this.f398399g = k2Var;
        this.f398396d = h2Var;
        this.f398397e = viewPropertyAnimator;
        this.f398398f = view;
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public void onAnimationEnd(android.animation.Animator animator) {
        this.f398397e.setListener(null);
        android.view.View view = this.f398398f;
        ...
        android.view.View view2 = this.f398398f;
        view2.setTranslationX(0.0f);
        view2.setTranslationY(0.0f);
        rp1.h2 h2Var = this.f398396d;
        androidx.recyclerview.widget.k3 k3Var = h2Var.f398411a;
        rp1.k2 k2Var = this.f398399g;
        k2Var.h(k3Var);
        k2Var.f398464r.remove(h2Var.f398411a);
        k2Var.E();
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public void onAnimationStart(android.animation.Animator animator) {
        androidx.recyclerview.widget.k3 k3Var = this.f398396d.f398411a;
        this.f398399g.getClass();
    }
}
