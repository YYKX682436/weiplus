...
public class b extends u32.c0 {
    ...
    public void p5(int i17, long j17, int i18, int i19, byte[] bArr) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.exdevice.DeviceRequestManager", "------onDeviceRequest------ errorCode = %d, deviceId = %d, seq = %d, cmdId = %d, datalength = %d", objArr);
        t32.a.a(j17, i17 == 0 ? 1 : 0);
        if (a42.i.a(bArr) == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.exdevice.DeviceRequestManager", "dataIn is null!!! Just leave without process data");
        } else {
