...
public class k {
    ...
    public final android.view.View f292973a;

    /* renamed from: b, reason: collision with root package name */
    public final android.view.View f292974b;

    /* renamed from: c, reason: collision with root package name */
    public final android.view.View f292975c;

    /* renamed from: d, reason: collision with root package name */
    public final sm4.f f292976d;

    /* renamed from: e, reason: collision with root package name */
    public final in4.j f292977e;

    /* renamed from: f, reason: collision with root package name */
    public final java.lang.String f292978f;

    public k(android.content.Context context, android.view.View view, in4.j jVar, sm4.f fVar, java.lang.String str) {
        this.f292973a = view;
        this.f292976d = fVar;
        this.f292974b = view.findViewById(com.tencent.mm.R.id.d2p);
        this.f292975c = view.findViewById(com.tencent.mm.R.id.f487501ot0);
        this.f292977e = jVar;
        this.f292978f = str;
    ...
    public void a(android.view.View view, boolean z17, int i17, int i18) {
        ...
        int i19 = com.tencent.mm.ui.bk.h(context).x;
        android.view.View view3 = this.f292973a;
        view3.measure(0, 0);
        ...
        iArr[0] = iArr[0] + i17;
        iArr[1] = iArr[1] + i18;
        android.view.View view4 = this.f292975c;
        if (view4 != null && (view2 = this.f292974b) != null) {
            int[] iArr3 = new int[2];
            view.getLocationOnScreen(iArr3);
            int width = (iArr3[0] + (view.getWidth() / 2)) - ((int) ((16 * view.getContext().getResources().getDisplayMetrics().density) + 0.5f));
            if (z17) {
                android.view.View view5 = this.f292975c;
                ...
                android.view.View view6 = this.f292974b;
                ...
                android.view.View view7 = this.f292975c;
                ...
                android.view.View view8 = this.f292974b;
