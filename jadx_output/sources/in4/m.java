...
public class m implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ in4.p f292981d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ r45.xn6 f292982e;

    public m(in4.q qVar, in4.p pVar, r45.xn6 xn6Var) {
        this.f292981d = pVar;
        this.f292982e = xn6Var;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TopStory.MorePopupWindow", "onClick favorite");
        in4.p pVar = this.f292981d;
        if (pVar != null) {
            pVar.c(this.f292982e);
        }
