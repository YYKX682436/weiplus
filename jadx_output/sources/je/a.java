    ...
    */
    public static int a(java.lang.String r6) {
        /*
            ...
            return r1
        Lf:
            java.io.InputStream r0 = com.tencent.mm.vfs.w6.E(r6)     // Catch: java.lang.Exception -> L36
            if (r0 != 0) goto L17
        L15:
            r3 = r1
            goto L30
        L17:
            ...
            r5 = 1
            int r3 = r3.getAttributeInt(r4, r5)     // Catch: java.lang.Throwable -> L15 java.lang.Throwable -> L24
            goto L30
        L24:
            r3 = move-exception
            if (r0 == 0) goto L2f
        ...
        L36:
            ...
            com.tencent.mars.xlog.Log.e(r2, r3, r6)
            return r1
        */
    ...
    public static java.lang.String c(android.graphics.BitmapFactory.Options options) {
        ...
        return (lowerCase.indexOf("jpg") < 0 && lowerCase.indexOf("jpeg") < 0) ? lowerCase.indexOf("png") >= 0 ? "png" : lowerCase.indexOf("gif") >= 0 ? "gif" : com.eclipsesource.mmv8.Platform.UNKNOWN : "jpeg";
    }
