...
public final class a1 {
    ...
    public final void a(java.lang.String name, yz5.l block) {
        ...
        java.util.Map map = this.f258700b.f258704a;
        f16.z0 z0Var = new f16.z0(this, name);
        block.invoke(z0Var);
        java.lang.String internalName = z0Var.f258790d.f258699a;
        java.util.List list = z0Var.f258788b;
        ...
        java.lang.String ret = (java.lang.String) z0Var.f258789c.f302833d;
        java.lang.String name2 = z0Var.f258787a;
        kotlin.jvm.internal.o.g(name2, "name");
        kotlin.jvm.internal.o.g(ret, "ret");
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        sb6.append(name2);
        sb6.append('(');
        sb6.append(kz5.n0.g0(arrayList, "", null, null, 0, null, g16.z0.f267678d, 30, null));
        sb6.append(')');
        if (ret.length() > 1) {
            str = "L" + ret + ';';
        } else {
        ...
        f16.e1 e1Var = (f16.e1) z0Var.f258789c.f302834e;
        java.util.ArrayList arrayList3 = new java.util.ArrayList(kz5.d0.q(list, 10));
        java.util.Iterator it6 = arrayList2.iterator();
        while (it6.hasNext()) {
            arrayList3.add((f16.e1) ((jz5.l) it6.next()).f302834e);
        }
