...
public final class m extends f26.x implements f26.w0 {
    ...
    public final f26.z0 f258753e;

    public m(f26.z0 delegate) {
        kotlin.jvm.internal.o.g(delegate, "delegate");
        this.f258753e = delegate;
    }

    @Override // f26.z0, f26.c3
    public f26.c3 C0(f26.r1 newAttributes) {
        kotlin.jvm.internal.o.g(newAttributes, "newAttributes");
        return new f16.m(this.f258753e.C0(newAttributes));
    }

    @Override // f26.z0
    /* renamed from: D0 */
    public f26.z0 A0(boolean z17) {
        return z17 ? this.f258753e.A0(true) : this;
    }
    ...
    public f26.o0 G(f26.o0 replacement) {
        ...
        if (z07 instanceof f26.e0) {
            ...
            return f26.b3.c(f26.r0.a(I0(e0Var.f259153e), I0(e0Var.f259154f)), f26.b3.a(z07));
        }
