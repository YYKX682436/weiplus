    ...
    */
    ...
    public final f16.h b(f26.c3 c3Var, yz5.l lVar, int i17, boolean z17) {
        ...
        if (!(c3Var instanceof f26.e0)) {
            ...
            f16.i a17 = a((f26.z0) c3Var, lVar, i17, f16.d1.f258717f, false, z17);
            f26.o0 o0Var3 = a17.f258734a;
            if (a17.f258736c) {
                o0Var3 = f26.b3.c(c3Var, o0Var3);
            }
            return new f16.h(o0Var3, a17.f258735b);
        }
        boolean z18 = c3Var instanceof f26.y0;
        f26.e0 e0Var = (f26.e0) c3Var;
        f16.i a18 = a(e0Var.f259153e, lVar, i17, f16.d1.f258715d, z18, z17);
        f16.i a19 = a(e0Var.f259154f, lVar, i17, f16.d1.f258716e, z18, z17);
        f26.z0 z0Var = a19.f258734a;
        f26.z0 z0Var2 = a18.f258734a;
            ...
            if (!a18.f258736c) {
                ...
                if (!a19.f258736c) {
                    if (z18) {
                        ...
                        if (z0Var2 == null) {
                            z0Var4 = e0Var.f259153e;
                        }
                        if (z0Var == null) {
                            z0Var = e0Var.f259154f;
                        }
                        o0Var2 = new c16.k(z0Var4, z0Var);
                    } else {
                        if (z0Var2 == null) {
                            z0Var3 = e0Var.f259153e;
                        }
                        if (z0Var == null) {
                            z0Var = e0Var.f259154f;
                        }
        ...
        return new f16.h(o0Var2, a18.f258735b);
    }
}
