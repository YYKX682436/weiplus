...
public abstract class p0 {
    public static final java.lang.String a(n16.g gVar) {
        ...
        boolean z18 = true;
        if (!((java.util.HashSet) q16.i0.f359759a).contains(h17)) {
            int i17 = 0;
            while (true) {
                if (i17 >= h17.length()) {
                    z17 = false;
        ...
        kotlin.jvm.internal.o.f(h19, "asString(...)");
    ...
    public static final java.lang.String b(java.util.List pathSegments) {
        kotlin.jvm.internal.o.g(pathSegments, "pathSegments");
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
    ...
    public static final boolean d(java.lang.String lower, java.lang.String upper) {
        ...
        if (!kotlin.jvm.internal.o.b(lower, r26.i0.t(upper, "?", "", false)) && (!r26.i0.n(upper, "?", false) || !kotlin.jvm.internal.o.b(lower.concat("?"), upper))) {
