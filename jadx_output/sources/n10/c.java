...
public final class c extends lc3.b0 {
    ...
    public void t(lc3.a0 data) {
        ...
        com.tencent.mm.feature.ecs.nirvana.ui.MagicEcsNirvanaUI magicEcsNirvanaUI = (com.tencent.mm.feature.ecs.nirvana.ui.MagicEcsNirvanaUI) B0;
        com.tencent.mars.xlog.Log.i("MicroMsg.MagicEcsNirvanaUI", "setEnableSwipeBack, enable:" + optBoolean);
        magicEcsNirvanaUI.f65848t = optBoolean;
        com.tencent.mm.ui.widget.SwipeBackLayout swipeBackLayout = magicEcsNirvanaUI.getSwipeBackLayout();
        if (swipeBackLayout != null) {
            swipeBackLayout.setEnableGesture(optBoolean);
        }
        s().invoke(k());
    }
}
