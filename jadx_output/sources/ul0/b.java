...
public class b extends l75.n0 {
    ...
    public static final java.lang.String[] f428556e = {l75.n0.getCreateSQLs(dm.m7.f238502t, "LiveHomeNoRedDotEvent")};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f428557d;

    public b(l75.k0 k0Var) {
        super(k0Var, dm.m7.f238502t, "LiveHomeNoRedDotEvent", f428556e);
        this.f428557d = k0Var;
    ...
    public int y0(int i17, boolean z17, long j17, long j18, int i18, int i19) {
        ...
        sb6.append(")");
        android.database.Cursor B = this.f428557d.B(sb6.toString(), new java.lang.String[]{java.lang.String.valueOf(j17), java.lang.String.valueOf(j18), java.lang.String.valueOf(i17)});
        try {
    ...
    public void z0(int i17) {
        ...
        m7Var.field_timestamp = currentTimeMillis;
        m7Var.field_dayOfWeek = i19;
        m7Var.field_hourOfDay = i18;
        m7Var.field_hasDisturbance = zs.c.f475223a ? 1 : 0;
        m7Var.field_action = i17;
        this.f428557d.l("LiveHomeNoRedDotEvent", null, m7Var.convertTo());
    }
}
