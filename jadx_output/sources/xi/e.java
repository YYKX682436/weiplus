...
public class e {
    ...
    public final android.content.Context f454651a;

    /* renamed from: b, reason: collision with root package name */
    public final android.os.Handler f454652b;

    public e(android.content.Context context) {
        android.os.Handler handler = new android.os.Handler(android.os.Looper.getMainLooper());
        this.f454651a = context;
        this.f454652b = handler;
    }

    public java.io.File a(boolean z17) {
        java.io.File file;
        try {
            file = xi.k.f454661e.f("", false);
        ...
        android.os.Handler handler = this.f454652b;
        handler.post(bVar);
        java.util.concurrent.TimeUnit timeUnit = java.util.concurrent.TimeUnit.SECONDS;
        java.util.concurrent.CountDownLatch countDownLatch = aVar.f21101b;
        try {
            ...
            try {
                ...
                handler.post(new xi.c(this, (android.widget.Toast) aVar.f21100a.get()));
                return file;
