...
public final class r3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ ku3.y3 f312379d;
    ...
    public final void onClick(android.view.View view) {
        ...
        ku3.y3 y3Var = this.f312379d;
        if (y3Var.B != 10) {
            com.tencent.mars.xlog.Log.i("MicroMsg.RecordMenuCountDownPlugin", "select ten count down");
            zt3.a aVar = y3Var.f312469d;
            android.os.Bundle bundle = new android.os.Bundle();
            bundle.putInt("PARAM_1_INT", 10);
            zt3.a.V6(aVar, 9, true, bundle, false, false, 24, null);
            y3Var.B = 10;
            ku3.y3.a(y3Var, y3Var.f312480r);
        }
