...
public final class w2 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ ku3.e3 f312444d;
    ...
    public final void onClick(android.view.View view) {
        ...
        ku3.e3 e3Var = this.f312444d;
        if (e3Var.f312222y != 2) {
            com.tencent.mars.xlog.Log.i("MicroMsg.RecordMenuBeautyPlugin", "select beauty light");
            zt3.a aVar = e3Var.f312204d;
            android.os.Bundle bundle = new android.os.Bundle();
            bundle.putInt("PARAM_1_INT", 2);
            zt3.a.V6(aVar, 6, true, bundle, false, false, 24, null);
            e3Var.f312222y = 2;
            ku3.e3.a(e3Var, e3Var.f312217t);
        }
