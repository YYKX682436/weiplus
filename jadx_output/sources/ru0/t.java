...
public abstract class t {
    public static final java.util.List a(org.json.JSONArray jSONArray, java.lang.String wordKey, java.lang.String beginTimeKey, java.lang.String endTimeKey, boolean z17) {
        ...
        kotlin.jvm.internal.o.g(wordKey, "wordKey");
        kotlin.jvm.internal.o.g(beginTimeKey, "beginTimeKey");
        kotlin.jvm.internal.o.g(endTimeKey, "endTimeKey");
        java.util.ArrayList arrayList = new java.util.ArrayList();
        ru0.p pVar = new ru0.p(z17, jSONArray, wordKey, beginTimeKey, endTimeKey, arrayList);
        int length = jSONArray.length();
        for (int i17 = 0; i17 < length; i17++) {
            pVar.invoke(java.lang.Integer.valueOf(i17), jSONArray.get(i17));
        }
        return arrayList;
    }
    ...
    public static final java.util.List b(java.util.List list, java.lang.String langId, int i17) {
        ...
        kotlin.jvm.internal.o.g(langId, "langId");
        java.util.ArrayList arrayList = new java.util.ArrayList();
        ...
        while (true) {
            ...
            java.lang.String e17 = e(nVar.f399690a, "__");
            java.lang.String t17 = r26.i0.t(e17, "__", "", false);
            if (t17.length() > 0) {
                arrayList2.add(new ru0.n(t17, nVar.f399691b, nVar.f399692c));
            }
        ...
        int i18 = 2;
        if (arrayList.size() <= 2) {
            return kz5.c0.d(new ru0.f(kz5.n0.g0(arrayList, "\n", null, null, arrayList.size(), null, ru0.r.f399701d, 22, null), ((ru0.f) kz5.n0.X(arrayList)).f399668b, ((ru0.f) kz5.n0.i0(arrayList)).f399669c));
        }
        kz5.s1.a(2, 2);
        ...
        while (true) {
            ...
            int i28 = i27 + i19;
            kz5.h.f313973d.a(i19, i28, f1Var.f313967e.size());
            f1Var.f313968f = i19;
            f1Var.f313969g = i28 - i19;
            ru0.f fVar = (ru0.f) kz5.n0.X(f1Var);
            ru0.f fVar2 = (ru0.f) kz5.n0.k0(f1Var);
            arrayList3.add(new ru0.f(kz5.n0.g0(f1Var, "\n", null, null, f1Var.size(), null, ru0.s.f399702d, 22, null), fVar.f399668b, (fVar2 == null ? fVar : fVar2).f399669c));
            i19 += 2;
            i18 = 2;
        }
        return arrayList3;
    ...
    public static final int c(java.lang.String langId) {
        ...
        com.tencent.mars.xlog.Log.i("Word_Ext", "getRecommendedTextLength: langId " + langId + " recommendedLength " + intValue);
        return intValue;
    }
    ...
    public static final java.util.ArrayList f(java.util.List list, java.lang.String str, int i17) {
        ...
        if (i17 <= c(str) || list.size() <= 1) {
            ...
            while (it.hasNext()) {
                ...
                int length = nVar.f399690a.length() + i19;
                java.lang.String str2 = nVar.f399690a;
                if (length >= i17) {
                    sb6.append(str2);
                    long j18 = nVar.f399692c;
            ...
            if (!arrayList2.isEmpty()) {
                ...
                int i39 = 0;
                while (it7.hasNext()) {
                    i39 += ((ru0.n) it7.next()).f399690a.length();
                }
            ...
            if (!arrayList3.isEmpty()) {
                ...
                int i47 = 0;
                while (it8.hasNext()) {
                    i47 += ((ru0.n) it8.next()).f399690a.length();
                }
            ...
            if (!arrayList4.isEmpty()) {
                ...
                int i48 = 0;
                while (it9.hasNext()) {
                    i48 += ((ru0.n) it9.next()).f399690a.length();
                }
            ...
            if (!arrayList5.isEmpty()) {
                ...
                int i49 = 0;
                while (it10.hasNext()) {
                    i49 += ((ru0.n) it10.next()).f399690a.length();
                }
