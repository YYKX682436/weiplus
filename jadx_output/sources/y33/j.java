...
public final class j extends l75.n0 implements y33.h {
    ...
    public static final java.lang.String[] f459179f;

    /* renamed from: d, reason: collision with root package name */
    public final d95.b0 f459180d;

    /* renamed from: e, reason: collision with root package name */
    public final j43.a f459181e;

    static {
        java.util.ArrayList d17 = kz5.c0.d(l75.n0.getCreateSQLs(y33.g.f459178z, "GameSimpleUserInfo"));
        java.lang.String[] INDEX_CREATE = dm.w5.f240808o;
        kotlin.jvm.internal.o.f(INDEX_CREATE, "INDEX_CREATE");
        kz5.h0.w(d17, INDEX_CREATE);
        f459179f = (java.lang.String[]) d17.toArray(new java.lang.String[0]);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(d95.b0 storage) {
        super(storage, y33.g.f459178z, "GameSimpleUserInfo", dm.w5.f240808o);
        kotlin.jvm.internal.o.g(storage, "storage");
        this.f459180d = storage;
        this.f459181e = new y33.i(storage);
    }
    ...
    public java.util.List Q1(java.util.List userNameList, java.lang.String chatroomName) {
        ...
        android.database.Cursor f17 = this.f459180d.f(str, null, 2);
        try {
            if (f17.moveToFirst()) {
                while (!f17.isAfterLast()) {
                    y33.g gVar = new y33.g();
                    gVar.convertFrom(f17);
                    arrayList.add(gVar);
                    f17.moveToNext();
                }
            }
            vz5.b.a(f17, null);
            com.tencent.stubs.logger.Log.i("ChatroomMemberPreloadManager.daoImpl", "query cost time = " + (java.lang.System.currentTimeMillis() - currentTimeMillis) + " rawSize = " + userNameList.size() + "   result.size = " + arrayList.size() + ' ');
            return arrayList;
        } finally {
        }
    }
    ...
    public java.util.List Wd(java.lang.String keyword, java.lang.String chatroomName) {
        ...
        try {
            ...
            vz5.b.a(f17, null);
            com.tencent.stubs.logger.Log.i("ChatroomMemberPreloadManager.daoImpl", "query cost time = " + (java.lang.System.currentTimeMillis() - currentTimeMillis) + " keyword = " + keyword + "  result.size = " + arrayList.size() + ' ');
            return arrayList;
        } finally {
        }
    }
    ...
    public long e3(java.lang.String chatroomName) {
        kotlin.jvm.internal.o.g(chatroomName, "chatroomName");
        android.database.Cursor f17 = this.f459180d.f("SELECT count(*) FROM GameSimpleUserInfo WHERE roomName = " + d95.b0.O(chatroomName), null, 2);
    ...
    public void jc(java.lang.String chatroomName) {
        kotlin.jvm.internal.o.g(chatroomName, "chatroomName");
        com.tencent.stubs.logger.Log.i("ChatroomMemberPreloadManager.daoImpl", "deleteAll By chatroomName = " + chatroomName + "  delete num = " + this.f459180d.delete("GameSimpleUserInfo", "roomName = ?", new java.lang.String[]{chatroomName}));
    }
    ...
    */
    public java.util.List jd(java.lang.String r4, int r5) {
        ...
        L32:
            ...
            r0.convertFrom(r4)     // Catch: java.lang.Throwable -> L5b
            java.lang.String r1 = r0.field_nickName     // Catch: java.lang.Throwable -> L5b
            if (r1 == 0) goto L4d
    ...
    public void q9(java.lang.String chatroomName, java.lang.String userName) {
        kotlin.jvm.internal.o.g(chatroomName, "chatroomName");
        kotlin.jvm.internal.o.g(userName, "userName");
        com.tencent.stubs.logger.Log.i("ChatroomMemberPreloadManager.daoImpl", "deleteByUserName chatroomName = " + chatroomName + "  userName " + userName + "  result = " + this.f459180d.delete("GameSimpleUserInfo", "roomName = ? and userName=? ", new java.lang.String[]{chatroomName, userName}));
    }
    ...
    public void z2(java.util.List users, java.lang.String chatroomName) {
        ...
        kotlin.jvm.internal.o.g(chatroomName, "chatroomName");
        if (users.isEmpty()) {
            com.tencent.stubs.logger.Log.i("ChatroomMemberPreloadManager.daoImpl", "insertAll  size = " + users.size());
            return;
        }
        int size = users.size();
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        d95.b0 b0Var = this.f459180d;
        long b17 = b0Var.b();
        try {
            this.f459181e.c(users);
            b0Var.w(java.lang.Long.valueOf(b17));
            com.tencent.stubs.logger.Log.i("ChatroomMemberPreloadManager.daoImpl", "insertAll insertDataSize = " + size + "  cost time = " + (java.lang.System.currentTimeMillis() - currentTimeMillis));
