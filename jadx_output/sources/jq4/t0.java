...
public final class t0 implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.view.View f301198d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ jq4.z0 f301199e;
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator animator) {
        ...
        android.view.View view = this.f301198d;
        ...
        if (layoutParams2 != null) {
            ...
            android.view.ViewManager viewManager = this.f301199e.f301235d;
            if (viewManager != null) {
