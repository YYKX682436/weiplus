...
public class l {
    ...
    public static int f342641d;

    /* renamed from: a, reason: collision with root package name */
    public final android.view.accessibility.AccessibilityNodeInfo f342642a;

    /* renamed from: b, reason: collision with root package name */
    public int f342643b = -1;

    /* renamed from: c, reason: collision with root package name */
    public int f342644c = -1;

    public l(java.lang.Object obj) {
        this.f342642a = (android.view.accessibility.AccessibilityNodeInfo) obj;
    }
    ...
    public void a(int i17) {
        this.f342642a.addAction(i17);
    }

    public void b(o3.f fVar) {
        this.f342642a.addAction((android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction) fVar.f342636a);
    }

    public final java.util.List c(java.lang.String str) {
        android.view.accessibility.AccessibilityNodeInfo accessibilityNodeInfo = this.f342642a;
    ...
    public final boolean e(int i17) {
        android.os.Bundle c17 = o3.g.c(this.f342642a);
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        android.view.accessibility.AccessibilityNodeInfo accessibilityNodeInfo2 = this.f342642a;
        ...
        return this.f342644c == lVar.f342644c && this.f342643b == lVar.f342643b;
    }

    public void f(android.graphics.Rect rect) {
        this.f342642a.getBoundsInParent(rect);
    }
    ...
    public void i(boolean z17) {
        this.f342642a.setAccessibilityFocused(z17);
    }
    ...
    public void k(android.graphics.Rect rect) {
        this.f342642a.setBoundsInParent(rect);
    }

    public void l(android.graphics.Rect rect) {
        this.f342642a.setBoundsInScreen(rect);
    }

    public void m(boolean z17) {
        this.f342642a.setCheckable(z17);
    }

    public void n(java.lang.CharSequence charSequence) {
        this.f342642a.setClassName(charSequence);
    }

    public void o(java.lang.Object obj) {
        this.f342642a.setCollectionItemInfo(obj == null ? null : (android.view.accessibility.AccessibilityNodeInfo.CollectionItemInfo) ((o3.k) obj).f342640a);
    }

    public void p(java.lang.CharSequence charSequence) {
        this.f342642a.setContentDescription(charSequence);
    }

    public void q(boolean z17) {
        this.f342642a.setEnabled(z17);
    }

    public void r(boolean z17) {
        this.f342642a.setFocusable(z17);
    }

    public void s(boolean z17) {
        if (android.os.Build.VERSION.SDK_INT >= 28) {
            this.f342642a.setScreenReaderFocusable(z17);
        } else {
            j(1, z17);
        }
    }
    ...
    public void t(boolean z17) {
        this.f342642a.setScrollable(z17);
    }
    ...
    public java.lang.String toString() {
        ...
        for (int i19 = 0; i19 < emptyList.size(); i19++) {
            ...
            java.lang.String d17 = d(((android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction) fVar.f342636a).getId());
            if (d17.equals("ACTION_UNKNOWN")) {
                java.lang.Object obj = fVar.f342636a;
