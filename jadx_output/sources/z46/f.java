...
public class f {
    ...
    public final java.util.Set f470154a;

    /* renamed from: b, reason: collision with root package name */
    public final z46.b f470155b;

    /* renamed from: c, reason: collision with root package name */
    public final z46.a f470156c;

    /* renamed from: d, reason: collision with root package name */
    public boolean f470157d;

    public f() {
        z46.j jVar = new z46.j();
        z46.h hVar = new z46.h();
        this.f470154a = new java.util.HashSet();
        this.f470155b = jVar;
        this.f470156c = hVar;
    }

    public java.io.File a(android.content.Context context, java.lang.String str, java.lang.String str2) {
        java.lang.String b17 = ((z46.j) this.f470155b).b(str);
