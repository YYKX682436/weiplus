...
public final class c1 extends java.util.Vector {
    ...
    public final java.util.List f359266d = new java.util.ArrayList();
    ...
    public final void d(java.lang.Object obj, int i17) {
        java.util.Iterator it = ((java.util.ArrayList) this.f359266d).iterator();
        while (it.hasNext()) {
            q01.b0 b0Var = (q01.b0) ((q01.b1) it.next());
            b0Var.getClass();
            com.tencent.mm.modelbase.m1 element = (com.tencent.mm.modelbase.m1) obj;
            kotlin.jvm.internal.o.g(element, "element");
            int size = super.size();
            q01.e0 e0Var = q01.e0.f359270a;
            if (size >= gm0.j1.d().f70766f) {
                e0Var.b();
            }
            b0Var.b(element);
        }
    ...
    public final void g(java.lang.Object obj, java.lang.Object obj2, int i17) {
        java.util.Iterator it = this.f359266d.iterator();
        while (it.hasNext()) {
            q01.b0 b0Var = (q01.b0) ((q01.b1) it.next());
            b0Var.getClass();
            com.tencent.mm.modelbase.m1 oldElement = (com.tencent.mm.modelbase.m1) obj;
            com.tencent.mm.modelbase.m1 newElement = (com.tencent.mm.modelbase.m1) obj2;
            kotlin.jvm.internal.o.g(oldElement, "oldElement");
            kotlin.jvm.internal.o.g(newElement, "newElement");
            b0Var.b(newElement);
            b0Var.a(oldElement);
        }
    }
    ...
    public final void h(java.util.Collection removes) {
        ...
        while (it.hasNext()) {
            q01.b0 b0Var = (q01.b0) ((q01.b1) it.next());
            b0Var.getClass();
            kotlin.jvm.internal.o.g(removes, "removes");
            int size = super.size();
            q01.e0 e0Var = q01.e0.f359270a;
            if (size < gm0.j1.d().f70766f) {
                e0Var.b();
            ...
            while (it6.hasNext()) {
                b0Var.a((com.tencent.mm.modelbase.m1) it6.next());
            }
        }
    }
    ...
    public synchronized boolean removeAll(java.util.Collection elements) {
        ...
        if (removeAll) {
            for (jz5.l lVar : arrayList) {
                e(lVar.f302833d, ((java.lang.Number) lVar.f302834e).intValue());
            }
        }
        return removeAll;
    }
