...
public final class j implements java.util.Set {
    ...
    public final /* synthetic */ x.m f450831d;
    ...
    public boolean contains(java.lang.Object obj) {
        return this.f450831d.e(obj) >= 0;
    }

    @Override // java.util.Set, java.util.Collection
    public boolean containsAll(java.util.Collection collection) {
        java.util.Map c17 = this.f450831d.c();
    ...
    public boolean isEmpty() {
        return this.f450831d.d() == 0;
    }

    @Override // java.util.Set, java.util.Collection, java.lang.Iterable
    public java.util.Iterator iterator() {
        return new x.h(this.f450831d, 0);
    }
    ...
    public boolean retainAll(java.util.Collection collection) {
        return x.m.k(this.f450831d.c(), collection);
    }

    @Override // java.util.Set, java.util.Collection
    public int size() {
        return this.f450831d.d();
    }

    @Override // java.util.Set, java.util.Collection
    public java.lang.Object[] toArray(java.lang.Object[] objArr) {
        return this.f450831d.l(objArr, 0);
    }
