...
public final class sd implements java.lang.Runnable {
    ...
    public final /* synthetic */ df2.ud f231331d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ jz5.l f231332e;
    ...
    public final void run() {
        ...
        r45.rk6 rk6Var = (r45.rk6) this.f231332e.f302833d;
        df2.ud udVar = this.f231331d;
        udVar.getClass();
        r45.d62 a17 = r45.d62.a(rk6Var.getInteger(1));
        kotlin.jvm.internal.o.f(a17, "forNumber(...)");
        android.view.View Z6 = udVar.Z6(a17);
        android.view.View view2 = udVar.f231513p;
        jz5.f0 f0Var = null;
        if (Z6 == null || view2 == null) {
            oVar = null;
        } else {
            android.graphics.Rect r17 = pm0.v.r(Z6);
            if (pm0.v.t(Z6)[1] > com.tencent.mm.ui.bl.b(udVar.O6()).y / 2) {
                android.view.View view3 = udVar.f231514q;
                if (view3 != null) {
                ...
                android.view.View view4 = udVar.f231515r;
                if (view4 != null) {
                ...
                android.view.View view5 = udVar.f231514q;
                if (view5 != null) {
                ...
                android.view.View view6 = udVar.f231515r;
                if (view6 != null) {
        ...
        android.view.View view7 = udVar.f231513p;
        if (oVar != null && view7 != null) {
            df2.od.f230952w.a(udVar.getStore().getLiveRoomData(), 1, 6, udVar.f231519v, udVar.f231518u);
            android.view.View view8 = udVar.f231512o;
            if (view8 != null) {
            ...
            int i27 = com.tencent.mm.ui.bl.b(udVar.O6()).x - width;
            if (i19 > i27) {
                i19 = i27;
            }
            view7.setTranslationX(i19);
            jz5.g gVar = udVar.f231517t;
            if (booleanValue) {
                android.view.View view9 = udVar.f231515r;
                if (view9 != null) {
                    view9.setTranslationX(((intValue - view7.getTranslationX()) - view7.getPaddingLeft()) - (((java.lang.Number) ((jz5.n) gVar).getValue()).intValue() / 2));
                }
                view7.setTranslationY(intValue2 - height);
            } else {
                android.view.View view10 = udVar.f231514q;
                if (view10 != null) {
                    view10.setTranslationX(((intValue - view7.getTranslationX()) - view7.getPaddingLeft()) - (((java.lang.Number) ((jz5.n) gVar).getValue()).intValue() / 2));
                }
                view7.setTranslationY(intValue2);
            }
            f0Var = jz5.f0.f302826a;
        }
        if (f0Var != null || (view = udVar.f231512o) == null) {
            return;
        }
