...
public final class g4 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ com.tencent.mm.view.MMPAGView f230186d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ df2.l4 f230187e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.view.View f230188f;

    public g4(com.tencent.mm.view.MMPAGView mMPAGView, df2.l4 l4Var, android.view.View view) {
        this.f230186d = mMPAGView;
        this.f230187e = l4Var;
        this.f230188f = view;
    }
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        com.tencent.mm.view.MMPAGView mMPAGView = this.f230186d;
        if (mMPAGView != null) {
            mMPAGView.h();
        }
        this.f230187e.f230634r = true;
        boolean z17 = this.f230188f.getVisibility() == 0;
