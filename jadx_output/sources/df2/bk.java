...
public final class bk implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ df2.pk f229815d;
    ...
    public final void onClick(android.view.View view) {
        ...
        int integer = (iVar == null || (D0 = iVar.D0()) == null || (pa0Var = (r45.pa0) D0.getCustom(1)) == null) ? 0 : pa0Var.getInteger(1);
        zl2.r4.f473950a.Z2(editText, null, integer, integer, false, com.tencent.mm.ui.tools.t4.MODE_CHINESE_AS_1, new df2.ok(pkVar, editText));
        if (editText != null) {
        ...
        if (view2 != null) {
            ...
            view2.setEnabled(!kotlin.jvm.internal.o.b(obj, pkVar.f231072J != null ? r7.A0() : null));
        }
        android.view.View view3 = pkVar.f231077q;
        if (view3 != null) {
        ...
        android.view.View view4 = pkVar.f231086z;
        if (view4 != null) {
