...
public final class yc implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.view.View f231855d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ df2.ad f231856e;
    ...
    public final void run() {
        df2.ad adVar = this.f231856e;
        android.view.ViewGroup Z6 = adVar.Z6();
        android.view.View view = this.f231855d;
        if (view != null && Z6 != null) {
            ...
            int dimension = i18 - (r4Var.Y1(context) ? ((int) Z6.getContext().getResources().getDimension(com.tencent.mm.R.dimen.f479704cz)) * 2 : 0);
            android.view.View findViewById = Z6.findViewById(com.tencent.mm.R.id.a4f);
            android.view.View findViewById2 = Z6.findViewById(com.tencent.mm.R.id.f484806fl2);
            ...
            view.getContext().getResources().getDimension(com.tencent.mm.R.dimen.f479644bj);
            ...
            float width2 = (dimension - width) + (((view.getWidth() / 6) / 2) - (Z6.getContext().getResources().getDimension(com.tencent.mm.R.dimen.f479704cz) / 2));
