...
public final class p implements com.tencent.pigeon.ting.TingFinderSourceApi, io.flutter.embedding.engine.plugins.FlutterPlugin {
    ...
    public void requestMediaInfo(byte[] finderInfo, yz5.l callback) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FlutterBizAudioFinderSourcePlugin", "requestMediaInfo");
        ...
        ((c61.l7) b6Var).ml(r26.q0.c(tid), parseFrom.b(), 0, true, false, "", new vm1.o(parseFrom, callback));
    }
}
