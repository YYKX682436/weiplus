...
public final class g {
    ...
    public final ih0.p f267308a;

    public g(ih0.p holder) {
        kotlin.jvm.internal.o.g(holder, "holder");
        this.f267308a = holder;
    }

    public static final com.tencent.wechat.aff.favorites.j a(fz4.g gVar, java.lang.String str) {
        com.tencent.wechat.aff.favorites.j jVar;
        java.lang.String b17;
        java.lang.String c17;
        long j17;
        gVar.getClass();
        try {
            jVar = new com.tencent.wechat.aff.favorites.j();
            b17 = hz4.l.b("ImageDataItem-" + str, 18);
            com.tencent.mars.xlog.Log.i("MicroMsg.WeNoteAsyncMediaProcessor", "createImageMediaInfoResp: generated initial dataId=" + b17 + " for image: " + str);
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.WeNoteAsyncMediaProcessor", e17, "createImageMediaInfoResp copy file error", new java.lang.Object[0]);
                j17 = -1;
            }
        } catch (java.lang.Exception e18) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.WeNoteAsyncMediaProcessor", e18, "createImageMediaInfoResp error", new java.lang.Object[0]);
        }
        if (j17 < 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WeNoteAsyncMediaProcessor", "createImageMediaInfoResp copy file failed, imgPath: " + str);
            return null;
        }
        jz5.l d17 = gVar.d(c17);
        int intValue = ((java.lang.Number) d17.f302833d).intValue();
        int intValue2 = ((java.lang.Number) d17.f302834e).intValue();
        jVar.k(c17);
        ...
        jVar.f216810r = true;
        zArr[12] = true;
        com.tencent.mars.xlog.Log.i("MicroMsg.WeNoteAsyncMediaProcessor", "createImageMediaInfoResp: dataId=" + b17 + ", thumbPath=" + jVar.getThumbPath() + ", media_path=" + jVar.getMediaPath() + ", needCompress=true");
        return jVar;
    }
    ...
    */
    public static final void b(fz4.g r8, android.graphics.Bitmap r9, java.lang.String r10) {
        ...
        L1f:
            ...
            com.tencent.mm.sdk.platformtools.x.D0(r9, r3, r6, r10, r4)     // Catch: java.lang.Exception -> L56
            ...
            boolean r0 = com.tencent.mm.vfs.w6.j(r10)     // Catch: java.lang.Exception -> L53
            r9.append(r0)     // Catch: java.lang.Exception -> L53
            java.lang.String r9 = r9.toString()     // Catch: java.lang.Exception -> L53
            com.tencent.mars.xlog.Log.i(r2, r9)     // Catch: java.lang.Exception -> L53
            r0 = r4
            goto L61
        L53:
            r9 = move-exception
        ...
        L58:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r2, r9, r6, r7)
            goto L61
        L60:
            r0 = r5
        L61:
            ...
            android.graphics.Bitmap r9 = com.tencent.mm.sdk.platformtools.x.q(r6, r9, r0)     // Catch: java.lang.Exception -> L9d
            android.graphics.Bitmap$CompressFormat r0 = android.graphics.Bitmap.CompressFormat.JPEG     // Catch: java.lang.Exception -> L9d
            com.tencent.mm.sdk.platformtools.x.D0(r9, r3, r0, r10, r4)     // Catch: java.lang.Exception -> L9d
            ...
            boolean r8 = com.tencent.mm.vfs.w6.j(r10)     // Catch: java.lang.Exception -> L9d
            r9.append(r8)     // Catch: java.lang.Exception -> L9d
            java.lang.String r8 = r9.toString()     // Catch: java.lang.Exception -> L9d
            com.tencent.mars.xlog.Log.i(r2, r8)     // Catch: java.lang.Exception -> L9d
            goto La5
        L9d:
            r8 = move-exception
            java.lang.String r9 = "createThumbnail create black thumbnail failed"
            java.lang.Object[] r10 = new java.lang.Object[r5]
            com.tencent.mars.xlog.Log.printErrStackTrace(r2, r8, r9, r10)
        La5:
            return
        */
    ...
    public static final com.tencent.wechat.aff.favorites.j c(fz4.g gVar, iz4.k kVar) {
        gVar.getClass();
        ...
        jz5.l d17 = gVar.d(kVar.f296117t);
        int intValue = ((java.lang.Number) d17.f302833d).intValue();
        int intValue2 = ((java.lang.Number) d17.f302834e).intValue();
        jVar.n(intValue);
        jVar.j(intValue2);
        ...
        jVar.f216810r = true;
        zArr[12] = true;
        com.tencent.mars.xlog.Log.i("MicroMsg.WeNoteAsyncMediaProcessor", "createVideoMediaInfoResp: dataId=" + kVar.f296103a + ", thumbPath=" + jVar.getThumbPath() + ", media_path=" + jVar.getMediaPath() + ", needCompress=true");
        return jVar;
    }

    public final jz5.l d(java.lang.String str) {
        if ((str == null || str.length() == 0) || !com.tencent.mm.vfs.w6.j(str)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.WeNoteAsyncMediaProcessor", "getImageDimensions but imagePath err");
        ...
        try {
            ...
            if (d17 != null) {
                com.tencent.mars.xlog.Log.i("MicroMsg.WeNoteAsyncMediaProcessor", "recycle bitmap:%s", d17.toString());
                d17.recycle();
            }
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WeNoteAsyncMediaProcessor", "Failed to get image dimensions for path: " + str + ", error: " + e17.getMessage());
            return new jz5.l(0, 0);
        }
    }
}
