...
public class m implements android.text.Html.TagHandler {
    ...
    public static final java.util.regex.Pattern f313956c = java.util.regex.Pattern.compile("\\d+");

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.regex.Pattern f313957d = java.util.regex.Pattern.compile("#[a-f0-9]+");

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.HashMap f313958e;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.Stack f313959a = new java.util.Stack();

    /* renamed from: b, reason: collision with root package name */
    public final java.util.HashMap f313960b = new java.util.HashMap();
    ...
    public static int b(java.lang.String str) {
        int i17;
        int i18;
        java.lang.Integer num = (java.lang.Integer) f313958e.get(str.toLowerCase());
        if (num != null) {
            return num.intValue();
        }
        try {
    ...
    public static void d(android.text.Editable editable) {
        ...
        if ((length < 1 || editable.charAt(length - 1) != '\n') && length != 0) {
            editable.append("\n");
            editable.setSpan(kz4.f.f313949a, editable.length() - 1, editable.length(), 33);
        }
    }
    ...
    */
    public final void a(boolean r7) {
        /*
            r6 = this;
            java.util.Stack r0 = r6.f313959a
            boolean r1 = r0.isEmpty()
            if (r1 != 0) goto L4b
            java.lang.Object r1 = r0.peek()
            oz4.a r1 = (oz4.a) r1
            oz4.s r2 = r1.f350272a
            r3 = 0
            r4 = 1
            if (r7 == 0) goto L20
            r2.getClass()
    ...
    public final void e(boolean z17, oz4.s sVar) {
        ...
        java.util.Stack stack = this.f313959a;
        oz4.a aVar = stack.isEmpty() ? null : (oz4.a) stack.peek();
        if (aVar == null) {
            stack.push(new oz4.a(sVar, 1, 1));
        } else if (aVar.f350272a != sVar) {
            stack.push(new oz4.a(sVar, aVar.f350273b + 1, 1));
        } else {
            aVar.f350273b++;
            aVar.f350274c++;
        }
    ...
    public void handleTag(boolean z17, java.lang.String str, android.text.Editable editable, org.xml.sax.XMLReader xMLReader) {
        ...
        java.util.HashMap hashMap = this.f313960b;
        hashMap.clear();
        try {
            ...
            java.lang.reflect.Field declaredField3 = obj2.getClass().getDeclaredField(com.tencent.thumbplayer.tplayer.plugins.report.TPReportParams.PROP_KEY_DATA);
        ...
        if (z17) {
            ...
            if (equalsIgnoreCase) {
                ...
                if (equalsIgnoreCase2) {
                    ...
                    if (equalsIgnoreCase3) {
                        ...
                        java.lang.Object kVar = new kz4.k(((oz4.a) stack.peek()).f350273b, false, !com.tencent.mm.sdk.platformtools.t8.K0(str4) && str4.equals("1"));
                        int length = editable.length();
                        ...
                        if (str.equalsIgnoreCase("wx-li")) {
                            ...
                            boolean z18 = !com.tencent.mm.sdk.platformtools.t8.K0(str5) && str5.equals("true");
                            if (stack.isEmpty()) {
                                obj3 = new kz4.l(0, false);
                            } else {
                                oz4.a aVar = (oz4.a) stack.peek();
                                oz4.s sVar3 = aVar.f350272a;
                            ...
                            if (str6 != null) {
                                ...
                                for (java.lang.String str7 : str6.toLowerCase(java.util.Locale.ENGLISH).split(";")) {
                                    if (str7.startsWith("font-size")) {
                                        java.util.regex.Matcher matcher = f313956c.matcher(str7);
                                        if (matcher.find(0)) {
                                            try {
                                        ...
                                        java.util.regex.Pattern pattern = f313957d;
                                        if (startsWith) {
            ...
            if (str.equalsIgnoreCase("wx-ul")) {
                ...
                if (iVar != null) {
                    ...
                    if (!iVar.f313954a) {
                        editable.setSpan(new oz4.l(((kz4.k) iVar).f313955b, mz4.b.b(), spanStart == length6, false, false), spanStart, length6, 33);
                    }
                ...
                if (c17 != null) {
                    ...
                    if (spanStart3 != length8) {
                        ...
                        if (!android.text.TextUtils.isEmpty(gVar2.f313953d)) {
                            editable.setSpan(new android.text.style.TypefaceSpan(gVar2.f313953d), spanStart3, length8, 33);
                        }
                        int i28 = gVar2.f313950a;
                        if (i28 > 0) {
                            editable.setSpan(new android.text.style.AbsoluteSizeSpan(java.lang.Math.round(i28 * mz4.b.a())), spanStart3, length8, 33);
                        }
                        if ((!android.text.TextUtils.isEmpty(gVar2.f313951b)) && (b18 = b(gVar2.f313951b)) != -1) {
                            editable.setSpan(new android.text.style.ForegroundColorSpan(b18 | (-16777216)), spanStart3, length8, 33);
                        }
                        if ((!android.text.TextUtils.isEmpty(gVar2.f313952c)) && (b17 = b(gVar2.f313952c)) != -1) {
                            editable.setSpan(new android.text.style.BackgroundColorSpan(b17 | (-16777216)), spanStart3, length8, 33);
                        }
                    }
                }
            } else if (str.equalsIgnoreCase("wx-b")) {
                java.lang.Object boldSpan = new com.tencent.mm.plugin.wenote.model.nativenote.spans.BoldSpan();
                ...
                java.lang.Object highlightSpan = new com.tencent.mm.plugin.wenote.model.nativenote.spans.HighlightSpan();
