...
public final class k implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.widget.CheckBox f5936d;

    public k(android.widget.CheckBox checkBox) {
        this.f5936d = checkBox;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.widget.CheckBox checkBox = this.f5936d;
        checkBox.performClick();
        com.tencent.mars.xlog.Log.i("MicroMsg.CheckBoxTextViewLayout", "onClicked, checkBox.isChecked = %s", java.lang.Boolean.valueOf(checkBox.isChecked()));
