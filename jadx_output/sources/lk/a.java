...
public abstract class a {
    public static void a(java.lang.Object obj) {
        if (a.b.c().f44a && "3191139514".equals(a.b.c().b())) {
            final ry5.c f17 = ry5.c.f();
            if (obj == null) {
                f17.getClass();
                return;
            }
            if (android.text.TextUtils.isEmpty(f17.f401703a)) {
                ry5.b bVar = f17.f401704b;
                if (!bVar.f401700f && !bVar.f401701g) {
                    f17.a(0);
                    return;
                }
                ...
                if (f17.f401708f.contains(aj6)) {
                    return;
                }
                final wy5.c cVar = new wy5.c();
                ((my1.c) a.b.c().f49f).getClass();
                cVar.f450661a = cy1.a.Ui().Zi(obj);
                cVar.f450662b = obj.getClass().getSimpleName();
                int i17 = ry5.d.f401747a;
                ((my1.c) a.b.c().f49f).getClass();
                cVar.f450665e = ry5.d.f(sz1.a.h(obj), 0);
                mk.d dVar = a.b.c().f49f;
                wy5.a aVar = cVar.f450664d;
                ((my1.c) dVar).a(obj, aVar.f450656b);
                java.util.List b17 = ((my1.c) a.b.c().f49f).b(obj);
                if (b17 != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            bVar2.f450657a = ((java.lang.Integer) map.get("route_type")).intValue();
                            bVar2.f450658b = ((java.lang.Integer) map.get("route_rule")).intValue();
                            bVar2.f450659c = ((java.lang.Boolean) map.get("is_rt_report")).booleanValue();
                            bVar2.f450660d = ((java.lang.Boolean) map.get("is_batch_report")).booleanValue();
                            aVar.f450655a.add(bVar2);
                        } catch (java.lang.Exception unused) {
                        }
                    }
                }
                int i18 = ry5.d.f401747a;
                ry5.d.i(obj, f17.f401705c, new yz5.p() { // from class: ry5.c$$e
                    @Override // yz5.p
                    public final java.lang.Object invoke(java.lang.Object obj2, java.lang.Object obj3) {
                        ...
                        android.os.Handler handler = cVar2.f401705c;
                        ...
                        handler.postDelayed(new java.lang.Runnable() { // from class: ry5.c$$l
                            ...
                            public final void run() {
                                ...
                                wy5.c cVar5 = cVar3;
                                cVar5.f450663c = e17;
                                java.lang.String str2 = cVar5.f450662b;
                                ...
                                hashMap.put("page_id", java.lang.Integer.valueOf(cVar5.f450661a));
                                hashMap.put("page_name", cVar5.f450662b);
                                hashMap.put("img_base64", cVar5.f450663c);
                                wy5.a aVar2 = cVar5.f450664d;
                                if (aVar2 != null) {
                                    hashMap.put("bind_report_info", aVar2.a());
                                }
                                wy5.e eVar = cVar5.f450665e;
                                if (eVar != null) {
                                ...
                                cVar4.f401704b.c(jSONObject.toString());
                                cVar4.f401708f.add(str);
                            }
                        }, 1000L);
                        return null;
                    }
