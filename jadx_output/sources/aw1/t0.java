...
public final class t0 {
    ...
    public static final aw1.t0 f14682a = new aw1.t0();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.HashMap f14683b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.String[] f14684c = {"pdf", "docx", "xlsx", "doc", "xls", "zip", "pptx", "dwg", "rar", "mp3", "m4a", "txt", "wps", "PDF", "cdr", "ai", "et", "psd", "ofd", "stp", "mp4", "jpg", "wav", "ppt", "exe", "apk", "7z", "dxf", "csv", "JPG", "MOV", "STEP", "XLS", "MP3", "prj", "tif", "bin", "xlsm", "aac", "m4v", "DWG", "GBQ6", "prt", "wma", "lnk", "1", "MP4", "x_t", "XLSX", "xml", "png", "HEIC", "amr", "html", "rtf", "skp", "plt", "stl", "PNG"};

    /* renamed from: d, reason: collision with root package name */
    public static long f14685d;

    /* renamed from: e, reason: collision with root package name */
    public static long f14686e;

    /* renamed from: f, reason: collision with root package name */
    public static long f14687f;

    /* renamed from: g, reason: collision with root package name */
    public static long f14688g;

    /* renamed from: h, reason: collision with root package name */
    public static long f14689h;

    public static /* synthetic */ void b(aw1.t0 t0Var, com.tencent.mm.vfs.x1 x1Var, int i17, boolean z17, boolean z18, boolean z19, java.lang.String str, int i18, java.lang.Object obj) {
        if ((i18 & 32) != 0) {
            str = "";
        }
    ...
    public final void a(com.tencent.mm.vfs.x1 x1Var, int i17, boolean z17, boolean z18, boolean z19, java.lang.String str) {
        if (x1Var == null) {
            return;
        }
        java.lang.String n17 = com.tencent.mm.vfs.w6.n(x1Var.f213232b);
        java.lang.String[] strArr = f14684c;
        ...
        if (i17 == 21) {
            if ((str.length() > 0) && com.tencent.mm.vfs.w6.j(str)) {
        ...
        long j19 = 1000;
        long j27 = (s0Var.f14673a / j19) / j19;
        int i18 = j27 < 1 ? 1 : j27 < 10 ? 2 : j27 < 25 ? 3 : j27 < 50 ? 4 : j27 < 100 ? 5 : j27 < 200 ? 6 : j27 < 500 ? 7 : j27 < 1000 ? 8 : 9;
        int i19 = s0Var.f14676d ? 1 : 2;
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        sb6.append(i18);
        sb6.append('_');
        sb6.append(s0Var.f14674b);
        sb6.append('_');
        sb6.append(i19);
        java.lang.String sb7 = sb6.toString();
        java.util.HashMap hashMap = f14683b;
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "addC2CFileItem, item = " + s0Var);
    }
    ...
    public final synchronized void d() {
        long currentTimeMillis = java.lang.System.currentTimeMillis() - com.tencent.mm.sdk.platformtools.o4.L().getLong("report_c2c_file_exist_last_report_" + gm0.j1.b().h(), 0L);
        com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "reportExistC2CHistory, timeSpent = " + currentTimeMillis);
        if (!z65.c.a()) {
            java.lang.String str = com.tencent.mm.sdk.platformtools.z.f193105a;
            if (currentTimeMillis < 86400000) {
                com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "reportExistC2CHistory, not time, return");
                return;
            }
        }
        com.tencent.mm.sdk.platformtools.o4 J2 = com.tencent.mm.sdk.platformtools.o4.J("report_c2c_file_exist_history", gm0.j1.b().h(), 1);
        java.lang.String[] b17 = J2.b();
        kotlin.jvm.internal.o.f(b17, "allKeys(...)");
        if (b17.length == 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "reportExistC2CHistory, history is empty, return");
            return;
        }
        ...
        for (java.lang.String str2 : b18) {
            ...
            if (u17.length() > 0) {
                try {
                    java.util.Map b19 = com.tencent.mm.plugin.webview.ui.tools.newjsapi.wechatpay.i.b(new cl0.g(u17));
                    com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "reportExistC2CHistory, key = " + str2 + ", reportDataMap = " + b19);
                    ((cy1.a) ((dy1.r) i95.n0.c(dy1.r.class))).Ej("stock_chat_history_report", b19, 35066);
                } catch (java.lang.Throwable th6) {
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ReportC2CFileExist", th6, "", new java.lang.Object[0]);
                }
            }
        }
        com.tencent.mm.sdk.platformtools.o4.L().putLong("report_c2c_file_exist_last_report_" + gm0.j1.b().h(), java.lang.System.currentTimeMillis());
        com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "reportExistC2CHistory done");
    }
    ...
    public final void e() {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ReportC2CFileExist", "saveVideoFormatData, h264VideoCount = " + f14686e + ", h264VideoSize = " + f14687f + ", h265VideoCount = " + f14688g + ", h265VideoSize = " + f14689h);
        com.tencent.mm.sdk.platformtools.o4 J2 = com.tencent.mm.sdk.platformtools.o4.J("MicroMsg.ReportC2CFileExist", gm0.j1.b().h(), 1);
        J2.putLong("h264_video_cnt", f14686e);
        J2.putLong("h264_video_size", f14687f);
        J2.putLong("h265_video_cnt", f14688g);
        J2.putLong("h265_video_size", f14689h);
        java.util.HashMap hashMap3 = f14683b;
        ...
        while (it.hasNext()) {
            ...
            if (arrayList != null) {
                ...
                while (it6.hasNext()) {
                    ...
                    boolean z17 = s0Var.f14675c;
                    long j28 = j19;
                    long j29 = s0Var.f14673a;
                    if (z17) {
                        i19++;
                        j27 += j29;
                    } else {
                ...
                if (f07.size() < 3) {
                    ...
                    if (kotlin.jvm.internal.o.b(str9, "0")) {
                        return;
                    }
                    java.util.Map k17 = kz5.c1.k(new jz5.l("file_size_range", str8), new jz5.l("file_memory_type", str9), new jz5.l("scan_start_timestamp", java.lang.Long.valueOf(f14685d)), new jz5.l("file_upload_or_download", str10), new jz5.l("chat_file_source_list", str5), new jz5.l("chat_scene_type_list", str6), new jz5.l("file_send_type_list", ""), new jz5.l("file_extension_type_list", sb10));
                    com.tencent.mm.sdk.platformtools.o4.J("report_c2c_file_exist_history", gm0.j1.b().h(), 1).D(str2, new cl0.g(k17).toString());
                    str = str4;
                    com.tencent.mars.xlog.Log.i(str, "addC2CFileItem, data = " + k17);
                    it = it7;
                    hashMap3 = hashMap6;
                }
            }
    ...
    */
    public final synchronized void f(com.tencent.wcdb.support.CancellationSignal r59) {
        /*
