...
public class f extends com.tencent.wcdb.AbstractCursor {

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.String[] f250415d;

    /* renamed from: f, reason: collision with root package name */
    public final int f250417f;

    /* renamed from: h, reason: collision with root package name */
    public int f250419h;

    /* renamed from: g, reason: collision with root package name */
    public final int f250418g = 3000;

    /* renamed from: e, reason: collision with root package name */
    public final android.util.SparseArray f250416e = new android.util.SparseArray();

    public f(java.lang.String[] strArr) {
        this.f250415d = strArr;
        this.f250417f = strArr.length;
    }
    ...
    public boolean b(int i17) {
        int i18 = this.f250418g;
        int i19 = i17 / i18;
        android.util.SparseArray sparseArray = this.f250416e;
        if (sparseArray.indexOfKey(i19) < 0) {
            return false;
        }
        return ((java.lang.Object[]) sparseArray.get(i19))[(i17 % i18) * this.f250417f] != null;
    }
    ...
    public final java.lang.Object get(int i17) {
        ...
        if (i19 >= this.f250419h) {
            throw new android.database.CursorIndexOutOfBoundsException("After last row.");
        }
        int i27 = this.f250418g;
        return ((java.lang.Object[]) this.f250416e.get(i19 / i27))[((i19 % i27) * i18) + i17];
    }
    ...
    public java.lang.String[] getColumnNames() {
        return this.f250415d;
    }

    @Override // com.tencent.wcdb.AbstractCursor, com.tencent.wcdb.Cursor, android.database.Cursor
    public int getCount() {
        return this.f250419h;
    }
