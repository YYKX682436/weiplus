...
public abstract class p {
    ...
    /* JADX WARN: Removed duplicated region for block: B:79:0x02c1 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:82:0x0312 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:85:0x0394  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void a(z0.t r29, long r30, boolean r32, float r33, int r34, float r35, int r36, float r37, float r38, yz5.p r39, n0.o r40, int r41, int r42) {
        /*
            Method dump skipped, instructions count: 1225
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ky.p.a(z0.t, long, boolean, float, int, float, int, float, float, yz5.p, n0.o, int, int):void");
    }

    public static final void b(g1.i iVar, boolean z17, long j17, d1.g gVar, float f17, float f18, float f19, float f27) {
        if (z17) {
            float f28 = gVar.f225631c;
            float f29 = gVar.f225629a;
            float f37 = 2;
            g1.h.b(iVar, e1.y.b(j17, f18, 0.0f, 0.0f, 0.0f, 14, null), ((f28 - f29) / f37) + f17, d1.f.a((gVar.f225631c - f29) / f37, (gVar.f225632d - gVar.f225630b) / f37), 0.0f, new g1.n(f27, 0.0f, 0, 0, null, 30, null), null, 0, 104, null);
            return;
        }
        float f38 = gVar.f225629a - f17;
        float f39 = gVar.f225630b - f17;
        float f47 = gVar.f225631c + f17;
        float f48 = gVar.f225632d + f17;
        long b17 = e1.y.b(j17, f18, 0.0f, 0.0f, 0.0f, 14, null);
        long a17 = d1.f.a(f38, f39);
        long a18 = d1.l.a(f47 - f38, f48 - f39);
        long b18 = d1.b.b(f19, 0.0f, 2, null);
        g1.n nVar = new g1.n(f27, 0.0f, 0, 0, null, 30, null);
        int i17 = g1.i.J0;
        iVar.M(b17, a17, a18, b18, nVar, 1.0f, null, 3);
    }
}
