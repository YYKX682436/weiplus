...
public abstract class i {
    public static final void a(ky.a aVar, n0.o oVar, int i17, int i18) {
        ...
        if ((i19 & 11) == 2 && y0Var2.v()) {
            ...
            int i29 = n0.o.f333629a;
            if (y17 == n0.n.f333620a) {
                p2.h hVar = new p2.h(50);
                y0Var2.g0(hVar);
                y17 = hVar;
            }
            float f17 = ((p2.h) y17).f351380d;
            y0Var2.o(false);
            y0Var = y0Var2;
            ky.p.a(null, 0L, aVar3.a() != ky.m0.f313392d, 20, 800, 0.4f, 200, 0.0f, 0.0f, u0.j.b(y0Var2, 1937488041, true, new ky.c(aVar3, f17)), y0Var2, 807103488, 387);
            aVar2 = aVar3;
        }
        n0.f4 q17 = y0Var.q();
        if (q17 != null) {
            ((n0.l3) q17).f333608d = new ky.d(aVar2, i17, i18);
        }
    }
