...
public abstract class t {
    ...
    public static void a(android.view.View view, org.json.JSONObject jSONObject) {
        ...
        if (view instanceof if1.u) {
            ...
            uVar.setBgColor(a17);
            uVar.setBorderColor(a18);
            uVar.setBorderRadius(h18);
            uVar.setBorderWidth(h17);
            uVar.setBorderRadius(fArr2);
            z17 = true;
        } else {
            z17 = false;
        }
        ...
        float optDouble = (float) jSONObject.optDouble(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_VIDEO_ROTATION, 0.0d);
        float optDouble2 = (float) jSONObject.optDouble("scaleX", 1.0d);
        float optDouble3 = (float) jSONObject.optDouble("scaleY", 1.0d);
        if (jSONObject.has(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_VIDEO_ROTATION)) {
