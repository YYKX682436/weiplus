...
public abstract class s {
    public static boolean a(android.view.ViewGroup viewGroup, android.view.MotionEvent motionEvent, boolean z17, android.view.View view, int i17) {
        ...
        if (i27 != i18) {
            android.view.MotionEvent c17 = com.tencent.mm.plugin.appbrand.widget.base.AppBrandViewMotionCompat.c(motionEvent, i27);
        ...
        if (!isIdentity) {
            android.graphics.Matrix matrix = (android.graphics.Matrix) view.getTag(com.tencent.mm.R.id.f483249a36);
            if (matrix == null) {
                matrix = new android.graphics.Matrix();
                view.setTag(com.tencent.mm.R.id.f483249a36, matrix);
            }
    ...
    public static void b(android.view.ViewGroup viewGroup, android.view.MotionEvent motionEvent) {
        ...
        for (int i17 = childCount - 1; i17 >= 0; i17--) {
            ...
            if (com.tencent.mm.plugin.appbrand.widget.base.AppBrandViewMotionCompat.a(childAt) && com.tencent.mm.plugin.appbrand.widget.base.AppBrandViewMotionCompat.b(viewGroup, x17, y17, childAt, null) && childAt.isDuplicateParentStateEnabled()) {
