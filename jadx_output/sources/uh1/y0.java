...
public class y0 implements javax.net.ssl.X509TrustManager {
    ...
    public final java.security.KeyStore f427934c;

    /* renamed from: d, reason: collision with root package name */
    public final boolean f427935d;

    /* renamed from: g, reason: collision with root package name */
    public java.security.cert.X509Certificate[] f427938g;

    /* renamed from: e, reason: collision with root package name */
    public java.util.List f427936e = null;

    /* renamed from: f, reason: collision with root package name */
    public java.security.KeyStore f427937f = null;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.LinkedList f427932a = new java.util.LinkedList();

    /* renamed from: b, reason: collision with root package name */
    public final java.util.LinkedList f427933b = new java.util.LinkedList();
    ...
    public y0(boolean z17) {
        ...
        try {
            ...
            this.f427934c = keyStore;
            keyStore.load(null, null);
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AppBrandX509TrustManager", e17, "Exception: Local KeyStore init failed", new java.lang.Object[0]);
        }
    }

    public void a() {
        java.util.LinkedList linkedList = this.f427932a;
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AppBrandX509TrustManager", e17, "Exception: init SystemTrustManager", new java.lang.Object[0]);
        }
        java.util.LinkedList linkedList2 = this.f427933b;
        java.security.KeyStore keyStore = this.f427934c;
        if (keyStore != null) {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AppBrandX509TrustManager", e18, "Exception: init LocalTrustManager", new java.lang.Object[0]);
            }
        }
        ...
        this.f427938g = x509CertificateArr;
        this.f427938g = (java.security.cert.X509Certificate[]) arrayList.toArray(x509CertificateArr);
        com.tencent.mars.xlog.Log.i("MicroMsg.AppBrandX509TrustManager", "initAcceptedIssuers: %d, %d, %d", java.lang.Long.valueOf(currentTimeMillis2 - currentTimeMillis), java.lang.Long.valueOf(currentTimeMillis3 - currentTimeMillis2), java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis3));
        java.lang.System.currentTimeMillis();
    }
