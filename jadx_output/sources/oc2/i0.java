...
public abstract class i0 extends android.widget.FrameLayout {
    ...
    public oc2.y0 f344207d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.finder.extension.reddot.render.RenderView f344208e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i0(com.tencent.mm.plugin.finder.extension.reddot.render.RenderView renderView, android.content.Context context) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
        this.f344208e = renderView;
    }
    ...
    public final r45.cp5 a(oc2.w renderNodeType) {
        ...
        java.util.Iterator it = getSplit().f344322b.iterator();
        do {
            ...
            z17 = true;
            if (ordinal == 0) {
                r45.ap5 ap5Var = yVar.f344311a.f371769e;
                if (ap5Var != null && (x80Var2 = ap5Var.f370176d) != null && (wm5Var2 = x80Var2.f389855f) != null && (xy3Var = wm5Var2.f389291e) != null) {
                    str = xy3Var.f390593d;
                }
                if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
                    r45.ap5 ap5Var2 = yVar.f344311a.f371769e;
                    if (((ap5Var2 == null || (x80Var = ap5Var2.f370176d) == null || (wm5Var = x80Var.f389855f) == null) ? 0 : wm5Var.f389290d) > 0) {
                    }
                    z17 = false;
                }
            } else if (ordinal == 1) {
                r45.ap5 ap5Var3 = yVar.f344311a.f371769e;
                if (ap5Var3 != null && (x80Var4 = ap5Var3.f370177e) != null && (wm5Var4 = x80Var4.f389855f) != null && (xy3Var2 = wm5Var4.f389291e) != null) {
                    str = xy3Var2.f390593d;
                }
                if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
                    r45.ap5 ap5Var4 = yVar.f344311a.f371769e;
                    if (((ap5Var4 == null || (x80Var3 = ap5Var4.f370177e) == null || (wm5Var3 = x80Var3.f389855f) == null) ? 0 : wm5Var3.f389290d) > 0) {
                    }
                    z17 = false;
                }
            } else {
                ...
                r45.ap5 ap5Var5 = yVar.f344311a.f371769e;
                if (ap5Var5 != null && (x80Var6 = ap5Var5.f370178f) != null && (wm5Var6 = x80Var6.f389855f) != null && (xy3Var3 = wm5Var6.f389291e) != null) {
                    str = xy3Var3.f390593d;
                }
                if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
                    r45.ap5 ap5Var6 = yVar.f344311a.f371769e;
                    if (((ap5Var6 == null || (x80Var5 = ap5Var6.f370178f) == null || (wm5Var5 = x80Var5.f389855f) == null) ? 0 : wm5Var5.f389290d) > 0) {
                    }
                    z17 = false;
                }
            }
        } while (!z17);
        return yVar.f344311a;
    }
    ...
    */
    public final int c(r45.zo5 r3, int r4) {
        /*
            ...
            if (r0 == 0) goto L1a
            if (r3 == 0) goto L11
            java.lang.String r0 = r3.f392254e
            if (r0 != 0) goto Lf
            goto L11
        Lf:
            r1 = r0
        ...
        L11:
            if (r3 == 0) goto L16
            java.lang.String r3 = r3.f392253d
            goto L17
        L16:
            r3 = 0
        L17:
    ...
    public final void e(android.widget.ImageView imageView, java.lang.String url, int i17) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(url)) {
            imageView.setImageResource(i17 == 1 ? com.tencent.mm.R.drawable.b8i : com.tencent.mm.R.raw.finder_live_icon);
            return;
        }
        oc2.v vVar = oc2.v.f344282a;
        mn2.g1 g1Var = mn2.g1.f329975a;
        wo0.c b17 = g1Var.e().b(new mn2.q3(url, com.tencent.mm.plugin.finder.storage.y90.f128356f), g1Var.h(mn2.f1.f329964r));
        com.tencent.mm.plugin.finder.extension.reddot.render.RenderView renderView = this.f344208e;
        vVar.u(b17, renderView.h(), renderView.getCtrlInfo(), renderView.getShowInfo(), url);
        b17.c(imageView);
    }

    public final void f(android.view.ViewGroup container, android.view.View redDotView) {
        kotlin.jvm.internal.o.g(container, "container");
        kotlin.jvm.internal.o.g(redDotView, "redDotView");
    ...
    public final oc2.y0 getSplit() {
        oc2.y0 y0Var = this.f344207d;
        if (y0Var != null) {
            return y0Var;
        }
        kotlin.jvm.internal.o.o("split");
        throw null;
    }
    ...
    public final int h(r45.cp5 node) {
        ...
        r45.yo5 yo5Var = node.f371770f;
        if (yo5Var == null || (t60Var = yo5Var.f391261d) == null) {
            return 0;
        }
        return t60Var.f386169g;
    }

    public final void setSplit(oc2.y0 y0Var) {
