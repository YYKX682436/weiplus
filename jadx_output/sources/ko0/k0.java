...
public final class k0 extends qz5.l implements yz5.p {
    ...
    public final kotlin.coroutines.Continuation create(java.lang.Object obj, kotlin.coroutines.Continuation continuation) {
        return new ko0.k0(continuation);
    }

    @Override // yz5.p
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2) {
        return new ko0.k0((kotlin.coroutines.Continuation) obj2).invokeSuspend(jz5.f0.f302826a);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        int i17 = this.f309869d;
        if (i17 == 0) {
            kotlin.ResultKt.throwOnFailure(obj);
            i95.m c17 = i95.n0.c(zy.u.class);
            kotlin.jvm.internal.o.f(c17, "getService(...)");
            zy.w p37 = zy.u.p3((zy.u) c17, null, 1, null);
            java.lang.String str = ko0.l0.f309885h;
            java.lang.String str2 = ko0.l0.f309886i;
            this.f309869d = 1;
            z17 = true;
        ...
        if (booleanValue) {
            ...
            com.tencent.mars.xlog.Log.i("LiveMakeupUtil", sb6.toString());
            java.lang.String str3 = ((java.lang.String) obj2) + "/manifest.json";
            if (!com.tencent.mm.vfs.w6.j(str3)) {
                com.tencent.mars.xlog.Log.e("LiveMakeupUtil", "#checkAndMakeToReady manifestFile not exist");
                try {
                    ...
                    pm0.z.b(xy2.b.f458155b, "vfs_clear_health_in_makeup", false, null, null, false, false, new ko0.h0(sb7), 60, null);
                } catch (java.lang.Exception e17) {
                    com.tencent.mars.xlog.Log.e("LiveMakeupUtil", e17.toString());
                }
                com.tencent.mm.vfs.w6.f((java.lang.String) obj2);
                return f0Var;
            }
            pm0.z.b(xy2.b.f458155b, "vfs_clear_health_in_makeup", false, null, null, false, false, ko0.i0.f309864d, 60, null);
            try {
                java.lang.String M = com.tencent.mm.vfs.w6.M(str3);
                kotlin.jvm.internal.o.d(M);
                com.tencent.mars.xlog.Log.i("LiveMakeupUtil", "#checkAndMakeToReady manifestFileText=".concat(r26.i0.t(r26.i0.t(M, "\n", "", false), " ", "", false)));
                ...
                if (!c0Var.f310112d) {
                    com.tencent.mars.xlog.Log.e("LiveMakeupUtil", "#checkAndMakeToReady something wrong. rm dir " + ((java.lang.String) obj2));
                    com.tencent.mm.vfs.w6.f((java.lang.String) obj2);
                    return f0Var;
                }
                ko0.l0 l0Var = ko0.l0.f309878a;
                ko0.l0.f309883f = new lo0.p0((java.lang.String) obj2);
                ko0.l0 l0Var2 = ko0.l0.f309878a;
                ko0.l0.f309882e = z17;
                com.tencent.mars.xlog.Log.i("LiveMakeupUtil", "#checkAndMakeToReady nice done!");
            } catch (java.lang.Exception e18) {
                com.tencent.mars.xlog.Log.e("LiveMakeupUtil", "#checkAndMakeToReady package parsing failed. " + e18);
            }
        }
        return f0Var;
    }
