...
public abstract class l {
    public static int a(java.lang.String str) {
        ...
        sb6.append(" and ");
        sb6.append(Di.O());
        android.database.Cursor f17 = Di.f195117d.f(sb6.toString(), null, 2);
        if (f17 != null) {
    ...
    public static int b() {
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.NotificationConfig", "getUnReadMsgCoun, but mmcore not ready");
        return 0;
    }

    public static int c() {
        if (gm0.j1.a()) {
            return ((java.util.HashMap) c01.h2.e(c01.e2.f37121e)).size();
        }
        com.tencent.mars.xlog.Log.w("MicroMsg.NotificationConfig", "getUnReadTalkerCount, but mmcore not ready");
        return 0;
    }

    public static boolean d(java.lang.String str) {
        return c01.e2.Q(str) || (com.tencent.mm.storage.z3.R4(str) && !c01.e2.I(str)) || (com.tencent.mm.storage.z3.q4(str) && !c01.e2.I(str));
    }
    ...
    public static boolean g(java.lang.String str) {
        ...
        y00Var.f8414a = str;
        voipEvent.e();
        return voipEvent.f54946h.f8500a == 2;
    }
    ...
    public static boolean h(java.lang.String str) {
        ...
        y00Var.f8414a = str;
        voipEvent.e();
        return voipEvent.f54946h.f8500a == 3;
    }
    ...
    */
    ...
    public static void j(boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : KEY_RINGTONE_CAN_HEAR: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void k(boolean z17) {
        ip.b.v().edit().putBoolean("settings_shake", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsShake: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void l(boolean z17) {
        ip.b.v().edit().putBoolean("settings_special_scene_shake", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsShakeInSpecialScene: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void m(boolean z17) {
        ip.b.v().edit().putBoolean("settings_voip_scene_shake", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsShakeInVoip: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void n(boolean z17) {
        ip.b.v().edit().putBoolean("settings_show_detail", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsShowDetail: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void o(boolean z17) {
        ip.b.v().edit().putBoolean("settings_sound", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsSound: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void p(boolean z17) {
        ip.b.v().edit().putBoolean("settings_special_scene_sound", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsSoundInSpecialScene: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void q(boolean z17) {
        ip.b.v().edit().putBoolean("settings_voip_scene_sound", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveIsSoundInVoip: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void r(boolean z17) {
        ip.b.v().edit().putBoolean("settings_new_msg_notification", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveNewMsgNotification: %B", java.lang.Boolean.valueOf(z17));
    }

    public static void s(boolean z17) {
        ip.b.v().edit().putBoolean("settings_new_voip_msg_notification", z17).commit();
        com.tencent.mars.xlog.Log.i("MicroMsg.NotificationConfig", "[NOTIFICATION SETTINGS]double write : saveNewVoIPMsgNotification: %B", java.lang.Boolean.valueOf(z17));
    }
