...
public class d extends uk1.b {
    ...
    public java.nio.ByteBuffer f428516b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.Random f428517c = new java.util.Random();
    ...
    public uk1.a a(xk1.a aVar, xk1.g gVar) {
        ...
        if (!K0 && !com.tencent.mm.sdk.platformtools.t8.K0(a18)) {
        ...
        if (fVar.f455007a.containsKey("Sec-WebSocket-Key") && fVar2.f455007a.containsKey("Sec-WebSocket-Accept")) {
    ...
    public java.util.List f(java.nio.ByteBuffer byteBuffer) {
        ...
        if (this.f428516b != null) {
            try {
                byteBuffer.mark();
                int remaining = byteBuffer.remaining();
                int remaining2 = this.f428516b.remaining();
                if (remaining2 > remaining) {
                    this.f428516b.put(byteBuffer.array(), byteBuffer.position(), remaining);
                    byteBuffer.position(byteBuffer.position() + remaining);
                    return java.util.Collections.emptyList();
                }
                this.f428516b.put(byteBuffer.array(), byteBuffer.position(), remaining2);
                byteBuffer.position(byteBuffer.position() + remaining2);
                linkedList.add(j((java.nio.ByteBuffer) this.f428516b.duplicate().position(0)));
                this.f428516b = null;
            } catch (uk1.c e17) {
                this.f428516b.limit();
                int i17 = e17.f428515d;
                if (i17 < 0) {
                    throw new vk1.b(1002, "Negative count");
                }
                java.nio.ByteBuffer allocate = java.nio.ByteBuffer.allocate(i17);
                this.f428516b.rewind();
                allocate.put(this.f428516b);
                this.f428516b = allocate;
                return f(byteBuffer);
            }
        }
    ...
    public final java.lang.String h(java.lang.String str) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.AppBrandNetWork.Draft_10", "not such algorithm " + e17.toString());
            return "";
        }
    }
        ...
        if (i18 < 0 || i18 > 125) {
            ...
            if (i18 != 126) {
                ...
                if (longValue > 2147483647L) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.AppBrandNetWork.Draft_10", "Payloadsize is to big...");
                } else {
                    i18 = (int) longValue;
                }
            } else {
