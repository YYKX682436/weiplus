...
public abstract class j1 {
    public static final void a(cq.k kVar, com.tencent.mm.network.v0 v0Var, java.util.List objectList, long j17, boolean z17, r45.qt2 qt2Var) {
        ...
        while (true) {
            ...
            jVar.n(finderItem, new bu2.h(i17, j17));
        }
        ...
        for (com.tencent.mm.plugin.finder.storage.FinderItem finderItem2 : arrayList) {
            ...
            com.tencent.mars.xlog.Log.i("FinderFeedCgi", "getBatchFeed: ".concat(pm0.v.u(finderItem2.getId())));
            rv0Var.set(0, java.lang.Long.valueOf(finderItem2.getId()));
            arrayList2.add(rv0Var);
        }
        if (((java.lang.Boolean) com.tencent.mm.plugin.finder.storage.t70.f127590a.j1().r()).booleanValue() && z17 && (!arrayList2.isEmpty())) {
            com.tencent.mars.xlog.Log.i("NetSceneFinderFeedBase", "listSize: " + arrayList2.size());
    ...
    public static final void e(cq.k kVar, java.lang.String userName, long j17, r45.qt2 qt2Var, long j18, long j19, com.tencent.mm.protobuf.g lastBuffer, int i17, long j27, yz5.l lVar, yz5.l lVar2, yz5.a aVar) {
        kotlin.jvm.internal.o.g(kVar, "<this>");
        kotlin.jvm.internal.o.g(userName, "userName");
    ...
    public static void g(cq.k kVar, android.content.Context context, com.tencent.mm.plugin.finder.storage.FinderItem feed, long j17, com.tencent.mm.protobuf.g gVar, r45.qt2 qt2Var, int i17, java.util.LinkedList linkedList, java.lang.String clientUdfKv, com.tencent.mm.protobuf.g gVar2, yz5.l lVar, yz5.l lVar2, int i18, java.lang.Object obj) {
    ...
    public static final void j(cq.k kVar, java.lang.String filePath, int i17, java.lang.String str, int i18, androidx.lifecycle.y yVar, yz5.q qVar, yz5.l lVar) {
        kotlin.jvm.internal.o.g(kVar, "<this>");
        kotlin.jvm.internal.o.g(filePath, "filePath");
        boolean z17 = true;
        if (filePath.length() == 0) {
            com.tencent.mars.xlog.Log.e("requestFinderUploadHeadImg", "filePath is null");
            if (lVar != null) {
                lVar.invoke(null);
                return;
            }
        ...
        com.tencent.mars.xlog.Log.i("requestFinderUploadHeadImg", "filePath " + filePath + " and size: " + com.tencent.mm.sdk.platformtools.t8.f0(com.tencent.mm.vfs.w6.k(filePath)) + " total:" + com.tencent.mm.vfs.w6.k(filePath));
        ...
        if (z17) {
            ((ku5.t0) ku5.t0.f312615d).q(new cq.t0(filePath, i17, lVar, yVar, f0Var, qVar));
        } else {
            l(filePath, i17, lVar, yVar, f0Var, qVar, str, i18, 0);
        }
    }

    public static final void l(java.lang.String str, int i17, yz5.l lVar, androidx.lifecycle.y yVar, kotlin.jvm.internal.f0 f0Var, yz5.q qVar, java.lang.String str2, int i18, int i19) {
        ((ku5.t0) ku5.t0.f312615d).q(new cq.w0(str, i19, i17, str2, i18, lVar, yVar, f0Var, qVar));
    }
    ...
    public static bq.z1 n(cq.k kVar, java.lang.String reqUsername, long j17, com.tencent.mm.protobuf.g gVar, int i17, r45.qt2 qt2Var, int i18, long j18, boolean z17, java.lang.String str, long j19, java.lang.Integer num, java.lang.Long l17, java.lang.String str2, boolean z18, boolean z19, java.lang.Long l18, boolean z27, r45.a34 a34Var, r45.y13 y13Var, androidx.lifecycle.y yVar, java.lang.String str3, yz5.p pVar, yz5.p pVar2, int i19, java.lang.Object obj) {
        long j27 = (i19 & 2) != 0 ? 0L : j17;
        com.tencent.mm.protobuf.g gVar2 = (i19 & 4) != 0 ? null : gVar;
