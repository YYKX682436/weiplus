    ...
    */
    public static final java.util.List a(cq.k r6, java.lang.String r7, java.lang.Boolean r8) {
        ...
        L17:
            if (r2 != 0) goto L30
            if (r8 == 0) goto L30
            com.tencent.wcdb.orm.Field r6 = ni0.b.f337191c     // Catch: java.lang.Exception -> Lcc
            com.tencent.wcdb.winq.Expression r6 = r6.eq(r7)     // Catch: java.lang.Exception -> Lcc
            com.tencent.wcdb.orm.Field r0 = ni0.b.f337196h     // Catch: java.lang.Exception -> Lcc
        ...
        L42:
            if (r8 == 0) goto L4f
            com.tencent.wcdb.orm.Field r6 = ni0.b.f337196h     // Catch: java.lang.Exception -> Lcc
            boolean r8 = r8.booleanValue()     // Catch: java.lang.Exception -> Lcc
        ...
        L50:
            if (r6 == 0) goto L62
            jz5.g r8 = c66.q.f39507o     // Catch: java.lang.Exception -> Lcc
            jz5.n r8 = (jz5.n) r8     // Catch: java.lang.Exception -> Lcc
            java.lang.Object r8 = r8.getValue()     // Catch: java.lang.Exception -> Lcc
            com.tencent.wcdb.core.Table r8 = (com.tencent.wcdb.core.Table) r8     // Catch: java.lang.Exception -> Lcc
            java.util.List r6 = r8.getAllObjects(r6)     // Catch: java.lang.Exception -> Lcc
            if (r6 != 0) goto L70
        L62:
            jz5.g r6 = c66.q.f39507o     // Catch: java.lang.Exception -> Lcc
            jz5.n r6 = (jz5.n) r6     // Catch: java.lang.Exception -> Lcc
            java.lang.Object r6 = r6.getValue()     // Catch: java.lang.Exception -> Lcc
            com.tencent.wcdb.core.Table r6 = (com.tencent.wcdb.core.Table) r6     // Catch: java.lang.Exception -> Lcc
            java.util.List r6 = r6.getAllObjects()     // Catch: java.lang.Exception -> Lcc
        L70:
            kotlin.jvm.internal.o.d(r6)     // Catch: java.lang.Exception -> Lcc
        ...
        L7c:
            ...
            java.lang.String r3 = r2.f337226d     // Catch: java.lang.Exception -> Lcc
            boolean r3 = com.tencent.mm.vfs.w6.j(r3)     // Catch: java.lang.Exception -> Lcc
            if (r3 != 0) goto Lc6
            ...
            com.tencent.mars.xlog.Log.i(r1, r4)     // Catch: java.lang.Exception -> Lcc
            java.lang.String r2 = r2.f337223a     // Catch: java.lang.Exception -> Lcc
            java.lang.String r4 = "taskId"
            kotlin.jvm.internal.o.f(r2, r4)     // Catch: java.lang.Exception -> Lcc
            jz5.g r4 = c66.q.f39507o     // Catch: java.lang.Exception -> Lc1
            jz5.n r4 = (jz5.n) r4     // Catch: java.lang.Exception -> Lc1
            java.lang.Object r4 = r4.getValue()     // Catch: java.lang.Exception -> Lc1
            com.tencent.wcdb.core.Table r4 = (com.tencent.wcdb.core.Table) r4     // Catch: java.lang.Exception -> Lc1
            com.tencent.wcdb.orm.Field r5 = ni0.b.f337191c     // Catch: java.lang.Exception -> Lc1
            com.tencent.wcdb.winq.Expression r2 = r5.eq(r2)     // Catch: java.lang.Exception -> Lc1
            r4.deleteObjects(r2)     // Catch: java.lang.Exception -> Lc1
            goto Lc6
        Lc1:
            java.lang.String r2 = "deleteFinderAsyncAIGCDraftItem fail"
            com.tencent.mars.xlog.Log.e(r1, r2)     // Catch: java.lang.Exception -> Lcc
        Lc6:
            if (r3 == 0) goto L7c
