...
public abstract class n {
    ...
    public static final byte[] f297580a = {112, 114, 111, 0};

    /* renamed from: b, reason: collision with root package name */
    public static final byte[] f297581b = {112, 114, 109, 0};

    public static byte[] a(j4.b[] bVarArr, byte[] bArr) {
        int i17 = 0;
        int i18 = 0;
        for (j4.b bVar : bVarArr) {
            i18 += b(bVar.f297559a, bVar.f297560b, bArr).getBytes(java.nio.charset.StandardCharsets.UTF_8).length + 16 + (bVar.f297563e * 2) + bVar.f297564f + (((((bVar.f297565g * 2) + 8) - 1) & (-8)) / 8);
        }
        java.io.ByteArrayOutputStream byteArrayOutputStream = new java.io.ByteArrayOutputStream(i18);
        if (java.util.Arrays.equals(bArr, j4.o.f297584c)) {
            int length = bVarArr.length;
            while (i17 < length) {
                j4.b bVar2 = bVarArr[i17];
                l(byteArrayOutputStream, bVar2, b(bVar2.f297559a, bVar2.f297560b, bArr));
            ...
            for (j4.b bVar3 : bVarArr) {
                l(byteArrayOutputStream, bVar3, b(bVar3.f297559a, bVar3.f297560b, bArr));
            }
    ...
    public static java.lang.String b(java.lang.String str, java.lang.String str2, byte[] bArr) {
        ...
        if (str2.equals(com.tencent.tinker.loader.shareutil.ShareConstants.DEX_IN_JAR)) {
            return str;
        }
    ...
    public static j4.b[] e(java.io.InputStream inputStream, byte[] bArr, byte[] bArr2, j4.b[] bVarArr) {
        byte[] bArr3 = j4.o.f297587f;
        if (!java.util.Arrays.equals(bArr, bArr3)) {
            if (!java.util.Arrays.equals(bArr, j4.o.f297588g)) {
        ...
        if (java.util.Arrays.equals(j4.o.f297582a, bArr2)) {
        ...
        for (int i18 = 0; i18 < i17; i18++) {
            ...
            if (bVarArr.length > 0) {
                ...
                for (int i19 = 0; i19 < bVarArr.length; i19++) {
                    if (bVarArr[i19].f297560b.equals(substring)) {
                        bVar = bVarArr[i19];
                        break;
                    }
                }
            ...
            if (java.util.Arrays.equals(bArr, j4.o.f297586e)) {
                bVar.f297563e = e17;
                bVar.f297566h = d18;
            }
        }
    ...
    public static j4.b[] h(java.io.InputStream inputStream, byte[] bArr, java.lang.String str) {
        if (!java.util.Arrays.equals(bArr, j4.o.f297583b)) {
    ...
    public static j4.b[] i(java.io.InputStream inputStream, java.lang.String str, int i17) {
        ...
        for (int i19 = 0; i19 < i17; i19++) {
            j4.b bVar = bVarArr[i19];
            int available = inputStream.available() - bVar.f297564f;
            int i27 = 0;
            while (true) {
                int available2 = inputStream.available();
                treeMap = bVar.f297567i;
            ...
            bVar.f297566h = d(inputStream, bVar.f297563e);
            int i28 = bVar.f297565g;
    ...
    public static boolean j(java.io.OutputStream outputStream, byte[] bArr, j4.b[] bVarArr) {
        ...
        int length;
        byte[] bArr2 = j4.o.f297582a;
        int i17 = 0;
        if (!java.util.Arrays.equals(bArr, bArr2)) {
            byte[] bArr3 = j4.o.f297583b;
            if (java.util.Arrays.equals(bArr, bArr3)) {
        ...
        try {
            ...
            int i28 = 2;
            for (j4.b bVar3 : bVarArr) {
                j4.c.f(byteArrayOutputStream, bVar3.f297561c, 4);
                j4.c.f(byteArrayOutputStream, bVar3.f297562d, 4);
                j4.c.f(byteArrayOutputStream, bVar3.f297565g, 4);
                java.lang.String b19 = b(bVar3.f297559a, bVar3.f297560b, bArr2);
            ...
            for (int i37 = 0; i37 < bVarArr.length; i37++) {
                try {
                    ...
                    j4.c.g(byteArrayOutputStream2, bVar4.f297563e);
                    i29 = i29 + 2 + 2 + (bVar4.f297563e * 2);
            ...
            while (i38 < bVarArr.length) {
                try {
                    ...
                    java.util.Iterator it7 = bVar5.f297567i.entrySet().iterator();
                    int i47 = i17;
                    while (it7.hasNext()) {
            ...
            while (i49 < arrayList2.size()) {
                ...
                j4.c.f(outputStream, pVar4.f297589a.f297572d, 4);
                j4.c.f(outputStream, size2, 4);
                boolean z17 = pVar4.f297591c;
                byte[] bArr7 = pVar4.f297590b;
                if (z17) {
    ...
    public static void l(java.io.OutputStream outputStream, j4.b bVar, java.lang.String str) {
        ...
        j4.c.g(outputStream, bVar.f297563e);
        j4.c.f(outputStream, bVar.f297564f, 4);
        j4.c.f(outputStream, bVar.f297561c, 4);
        j4.c.f(outputStream, bVar.f297565g, 4);
    ...
    public static void m(java.io.OutputStream outputStream, j4.b bVar) {
        byte[] bArr = new byte[((((bVar.f297565g * 2) + 8) - 1) & (-8)) / 8];
        for (java.util.Map.Entry entry : bVar.f297567i.entrySet()) {
            int intValue = ((java.lang.Integer) entry.getKey()).intValue();
            int intValue2 = ((java.lang.Integer) entry.getValue()).intValue();
            int i17 = intValue2 & 2;
            int i18 = bVar.f297565g;
            if (i17 != 0) {
