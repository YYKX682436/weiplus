...
public class v extends wu5.l {
    ...
    public boolean cancel(boolean z17) {
        ...
        xu5.u uVar = this.f457343z;
        if (uVar != null) {
            ((xu5.d) uVar).getClass();
            xu5.t tVar = this.f457342y.f457303b;
            synchronized (tVar) {
                if (tVar.f457338h.remove(this)) {
                    tVar.f457334d.removeMessages(1, this);
                }
                java.util.Iterator it = tVar.f457339i.iterator();
                while (it.hasNext()) {
    ...
    public void run() {
        ...
        try {
            ...
            xu5.b.f457298c.set(null);
            xu5.u uVar2 = this.f457343z;
            if (uVar2 != null) {
