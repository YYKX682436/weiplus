...
public class h implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.appbrand.jsapi.l f434480d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f434481e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ org.json.JSONObject f434482f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ vb1.i f434483g;

    public h(vb1.i iVar, com.tencent.mm.plugin.appbrand.jsapi.l lVar, int i17, org.json.JSONObject jSONObject) {
        this.f434483g = iVar;
        this.f434480d = lVar;
        this.f434481e = i17;
        this.f434482f = jSONObject;
    }
    ...
    public void run() {
        ...
        if (!this.f434480d.isRunning()) {
            com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCanvasToTempFilePath", "invoke JsApi insertView failed, current page view is null.");
            this.f434480d.a(this.f434481e, this.f434483g.o("fail"));
            return;
        }
        com.tencent.mm.plugin.appbrand.jsapi.t Q = ((gb1.k) this.f434480d.q(gb1.k.class)).Q(this.f434480d, this.f434482f);
        if (Q == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCanvasToTempFilePath", "invoke JsApi canvasToTempFilePath failed, component view is null.");
            this.f434480d.a(this.f434481e, this.f434483g.o("fail:page is null"));
            return;
        }
        vb1.i iVar5 = this.f434483g;
        org.json.JSONObject jSONObject = this.f434482f;
        gb1.n nVar5 = new gb1.n(this.f434480d, this.f434481e);
        iVar5.getClass();
        try {
            int i47 = jSONObject.getInt("canvasId");
            android.view.View o17 = ((com.tencent.mm.plugin.appbrand.page.ia) Q.M(jSONObject.optBoolean("independent", false))).o(i47);
            if (o17 == null) {
                com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCanvasToTempFilePath", "get view by viewId(%s) return null.", java.lang.Integer.valueOf(i47));
            ...
            if (!(o17 instanceof com.tencent.mm.plugin.appbrand.jsapi.coverview.CoverViewContainer)) {
                com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCanvasToTempFilePath", "the view(%s) is not a instance of CoverViewContainer.", java.lang.Integer.valueOf(i47));
                nVar5.a(iVar5.o("fail:the view is not a instance of CoverViewContainer"));
                return;
            }
            android.view.View view = (android.view.View) ((com.tencent.mm.plugin.appbrand.jsapi.coverview.CoverViewContainer) o17).d(android.view.View.class);
            if (view == 0) {
                com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCanvasToTempFilePath", "getTargetView return null, viewId(%s).", java.lang.Integer.valueOf(i47));
            ...
            try {
                ...
                float L = com.tencent.mm.sdk.platformtools.t8.L(jSONObject.optString("destWidth"), h19);
                float L2 = com.tencent.mm.sdk.platformtools.t8.L(jSONObject.optString("destHeight"), h27);
                int i48 = (int) h17;
                if (i48 < 0 || (i27 = (int) h18) < 0 || (i28 = (int) h19) <= 0) {
                    ...
                    if (i49 > 0 && ((int) (h17 + h19)) <= measuredWidth && ((int) (h18 + h27)) <= measuredHeight && (i29 = (int) L) > 0 && (i37 = (int) L2) > 0) {
                        ...
                        if (h19 == f17 && h27 == f18) {
                            ...
                            try {
                                com.tencent.mars.xlog.Log.i(str10, "bitmap recycle %s", createBitmap2);
                                ...
                                str11 = "create bitmap failed, viewId(%s). Exception : %s";
                                str12 = "fail:create bitmap failed";
                                com.tencent.mars.xlog.Log.w(str10, str11, java.lang.Integer.valueOf(i39), e);
                                ...
                                i38 = i47;
                                str9 = "fail:create bitmap failed";
                                com.tencent.mars.xlog.Log.w(str10, str8, java.lang.Integer.valueOf(i38), th);
                        ...
                        if (h19 != L || h27 != L2) {
                            try {
                                ...
                                com.tencent.mars.xlog.Log.w(str10, "create bitmap failed, viewId(%s). Exception : %s", java.lang.Integer.valueOf(i47), e28);
                                nVar5.a(iVar5.o("fail:create bitmap failed"));
                                return;
                            } catch (java.lang.Throwable th9) {
                                com.tencent.mars.xlog.Log.w(str10, "create bitmap failed, viewId(%s). Throwable : %s", java.lang.Integer.valueOf(i47), th9);
                                nVar5.a(iVar5.o("fail:create bitmap failed"));
                                return;
                            }
                        }
                        ...
                        com.tencent.mm.vfs.r6 allocTempFile = Q.getFileSystem().allocTempFile("canvas_" + i47 + "." + str13);
                        if (allocTempFile == null) {
                            com.tencent.mars.xlog.Log.e(str10, "toTempFilePath, alloc file failed");
                            nVar5.a(iVar5.o("fail alloc file failed"));
                            return;
                        }
                        java.lang.String o18 = allocTempFile.o();
                        try {
                            com.tencent.mm.sdk.platformtools.x.D0(createBitmap2, vb1.i.D(jSONObject), C, o18, true);
                            ik1.b0 b0Var = new ik1.b0();
                            Q.getFileSystem().createTempFileFrom(new com.tencent.mm.vfs.r6(com.tencent.mm.vfs.z7.a(o18)), str13, true, b0Var);
                            java.lang.String str14 = (java.lang.String) b0Var.f291824a;
                            java.util.HashMap hashMap = new java.util.HashMap();
                            hashMap.put("tempFilePath", str14);
                            nVar5.a(iVar5.p("ok", hashMap));
                            return;
                        } catch (java.io.IOException e29) {
                            com.tencent.mars.xlog.Log.w(str10, "save bitmap to file failed, viewId(%s). exception : %s", java.lang.Integer.valueOf(i47), e29);
                            nVar5.a(iVar5.o("fail:write file failed"));
                            return;
                        } catch (java.lang.Throwable th10) {
                            com.tencent.mars.xlog.Log.w(str10, "save bitmap to file failed, viewId(%s). throwable : %s", java.lang.Integer.valueOf(i47), th10);
                            nVar5.a(iVar5.o("fail:write file failed"));
                            return;
                        }
                    }
                ...
                com.tencent.mars.xlog.Log.e(str7, "illegal arguments(x : %s, y : %s, width : %s, height : %s) failed, viewId(%s).", java.lang.Float.valueOf(h17), java.lang.Float.valueOf(h18), java.lang.Float.valueOf(h19), java.lang.Float.valueOf(h27), java.lang.Integer.valueOf(i19));
                ...
                iVar = iVar5;
                str6 = "create bitmap failed, viewId(%s). Exception : %s";
                com.tencent.mars.xlog.Log.w(str4, str6, java.lang.Integer.valueOf(i18), e);
                nVar.a(iVar.o(str5));
                ...
                i17 = i47;
                str3 = "fail:create bitmap failed";
                com.tencent.mars.xlog.Log.w(str, str2, java.lang.Integer.valueOf(i17), th);
                nVar5.a(iVar5.o(str3));
            }
        } catch (org.json.JSONException e38) {
            com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCanvasToTempFilePath", "canvasId do not exist. exception : %s", e38);
