...
public final class e extends ie3.j {
    ...
    public void haveSpecifiedResourceAsync(long j17, java.lang.String projectId, java.lang.String name, int i17, int i18, int i19) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.UDRMagicEcsShopFeatureService", "haveSpecifiedResource projectId " + projectId + ", name " + name + ", version " + i17 + " errNo " + i18 + " errCode " + i19);
    }
    ...
    public void postProcessAsync(long j17, com.tencent.wechat.aff.udr.x resource) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.UDRMagicEcsShopFeatureService", "postProcess " + resource);
    }
}
