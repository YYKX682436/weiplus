...
public class e extends gi2.e {
    ...
    @Override // gi2.d
    public gi2.g b() {
        jz5.g gVar = hj2.k.f281588b;
        gi2.g gVar2 = (gi2.g) ((jz5.n) hj2.k.f281588b).getValue();
        kotlin.jvm.internal.o.e(gVar2, "null cannot be cast to non-null type com.tencent.mm.plugin.finder.live.mic.custom.IMicLayout<Layout of com.tencent.mm.plugin.finder.live.mic.voiceroom.adapter.FinderLiveSingleVoiceRoomAdapter.getMicLayout>");
        return gVar2;
    }
    ...
    public void d(int i17, android.view.View view) {
        ...
        if (view instanceof lj2.j) {
            ((lj2.j) view).l(pm2.a.f356863s, g(i17));
        }
    }
