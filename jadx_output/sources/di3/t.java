...
public abstract class t {
    public static android.graphics.Point a(java.util.ArrayList arrayList, android.graphics.Point point, boolean z17, int i17) {
        ...
        while (it.hasNext()) {
            ...
            if (i37 == i18 && size.height == i28) {
                com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "findEqualsPrewViewSize FindBestSize %d %d", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(i28));
    ...
    public static di3.s c(android.util.Size[] sizeArr, android.graphics.Point point, int i17, boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "findPreviewSizeWithoutCrop supportedPreviewSizes: %s", ai3.d.t(sizeArr));
        int i18 = point.x;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "screen.x: %d, screen.y: %d, ratio: %f, upperBoundPrewView: %s ", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(point.y), java.lang.Float.valueOf(i18 / point.y), java.lang.Integer.valueOf(i17));
        com.tencent.mm.sdk.platformtools.t8.w(com.tencent.mm.sdk.platformtools.x2.f193071a);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "preViewPoint: %s ", point2);
        sVar.f232761e = new android.graphics.Point(point2.x, point2.y);
        sVar.f232760d = new android.graphics.Point(point2.x, point2.y);
        sVar.f232762f = ai3.d.e(point, point2, z17, true);
        android.graphics.Point point3 = new android.graphics.Point(point2.x, point2.y);
        sVar.f232757a = point3;
        sVar.f232758b = point2;
        sVar.f232759c = ai3.d.e(point, point3, z17, true);
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "find bestPreviewSize  %s -> %s ", point3, point2);
        return sVar;
    }
    ...
    public static di3.s d(android.util.Size[] sizeArr, android.graphics.Point point, int i17, boolean z17) {
        android.graphics.Point point2 = null;
        java.util.Arrays.sort(sizeArr, new di3.q(null));
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "findPreviewSizeWithoutCrop isRotate: %b, supportedPreviewSizes: %s", java.lang.Boolean.valueOf(z17), ai3.d.t(sizeArr));
        int i18 = point.x;
        float f17 = i18 / point.y;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "screen.x: %d, screen.y: %d, ratio: %f, upperBoundPrewView: %s ", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(point.y), java.lang.Float.valueOf(f17), java.lang.Integer.valueOf(i17));
        com.tencent.mm.sdk.platformtools.t8.w(com.tencent.mm.sdk.platformtools.x2.f193071a);
        di3.s sVar = new di3.s();
        int i19 = ((int) (i17 * 1.05f)) + 64;
        int length = sizeArr.length;
    ...
    */
    ...
    public static di3.s g(android.hardware.Camera.Parameters parameters, android.graphics.Point point, int i17, boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "tryFindPreviewSizeAnyWay supportedPreviewSizes: %s", ai3.d.u(arrayList));
        int i18 = point.x;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "screen.x: %d, screen.y: %d, ratio: %f, upperBoundPrewView: %s", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(point.y), java.lang.Float.valueOf(i18 / point.y), java.lang.Integer.valueOf(i17));
        com.tencent.mm.sdk.platformtools.t8.w(com.tencent.mm.sdk.platformtools.x2.f193071a);
        di3.s sVar = new di3.s();
        ...
        if (a17 == null) {
            ...
            sVar.f232758b = ai3.d.d(point, a17, z17, false);
            sVar.f232759c = ai3.d.d(point, sVar.f232757a, z17, true);
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "final tryFindBestSize prewViewSize %s cropSize %s findcount %d with any way", sVar.f232757a, sVar.f232758b, 0);
        return sVar;
    }

    public static di3.s h(android.util.Size[] sizeArr, android.graphics.Point point, int i17, boolean z17) {
        java.util.Arrays.sort(sizeArr, new di3.q(null));
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "tryFindPreviewSizeAnyWay supportedPreviewSizes: %s", ai3.d.t(sizeArr));
        int i18 = point.x;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "screen.x: %d, screen.y: %d, ratio: %f, upperBoundPrewView: %s", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(point.y), java.lang.Float.valueOf(i18 / point.y), java.lang.Integer.valueOf(i17));
        com.tencent.mm.sdk.platformtools.t8.w(com.tencent.mm.sdk.platformtools.x2.f193071a);
        di3.s sVar = new di3.s();
        ...
        if (b17 == null) {
            ...
            sVar.f232758b = ai3.d.d(point, b17, z17, false);
            sVar.f232759c = ai3.d.d(point, sVar.f232757a, z17, true);
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "final tryFindBestSize prewViewSize %s cropSize %s findcount %d with any way", sVar.f232757a, sVar.f232758b, 0);
        return sVar;
    ...
    public static di3.s i(android.util.Size[] sizeArr, android.graphics.Point point, int i17, boolean z17) {
        java.util.Arrays.sort(sizeArr, new di3.q(null));
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "tryFindPreviewSizeAnyWayV1 isRoate:%b,supportedPreviewSizes: %s", java.lang.Boolean.valueOf(z17), ai3.d.t(sizeArr));
        int i18 = point.x;
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "screen.x: %d, screen.y: %d, ratio: %f, upperBoundPrewView: %s", java.lang.Integer.valueOf(i18), java.lang.Integer.valueOf(point.y), java.lang.Float.valueOf(i18 / point.y), java.lang.Integer.valueOf(i17));
        com.tencent.mm.sdk.platformtools.t8.w(com.tencent.mm.sdk.platformtools.x2.f193071a);
        di3.s sVar = new di3.s();
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.MMSightCameraInfo", "final tryFindPreviewSizeAnyWayV1 prewViewSize %s cropSize %s findcount %d with any way", sVar.f232757a, sVar.f232758b, 0);
        return sVar;
    }
}
