...
public abstract class j5 {
    public static final java.lang.String a(bw5.lp0 lp0Var) {
        ...
        if (il4.l.l(lp0Var.d().f34189e)) {
            bw5.z90 j17 = lp0Var.d().j();
            if (j17 != null) {
                return j17.f35903x1[4] ? j17.f35884g : "";
            }
            return null;
        }
    ...
    */
    public static final java.lang.String b(bw5.v70 r7) {
        ...
        L55:
            ...
            boolean r5 = r5[r6]
            if (r5 == 0) goto L64
            java.lang.String r0 = r0.f26761g
            goto L67
        L64:
            r0 = r3
            goto L67
    ...
    public static final int e(bw5.lp0 lp0Var) {
        ...
        if (!il4.l.l(lp0Var.d().f34189e)) {
            ...
            if (!(lp0Var.d().f34189e == 4)) {
                return lp0Var.d().f34203v;
            }
        ...
        bw5.z90 j17 = lp0Var.d().j();
        int i17 = j17 != null ? j17.f35898u : 0;
        if (i17 == 0) {
            int i18 = lp0Var.d().f34189e;
            if (i18 != 7 && i18 != 8) {
                r1 = false;
            }
            if (r1) {
    ...
    public static final java.lang.String f(java.lang.String str) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.i("TingItemEx", "Exception err: " + e17.getMessage());
            return "";
        }
    }
    ...
    public static final boolean g(bw5.lp0 lp0Var) {
        kotlin.jvm.internal.o.g(lp0Var, "<this>");
        return il4.l.l(lp0Var.d().f34189e);
    }

    public static final boolean h(bw5.lp0 lp0Var) {
        kotlin.jvm.internal.o.g(lp0Var, "<this>");
        int i17 = lp0Var.d().f34189e;
    ...
    public static final int i(bw5.lp0 lp0Var) {
        kotlin.jvm.internal.o.g(lp0Var, "<this>");
        if (lp0Var.c() != null && lp0Var.c().f27453e > 0) {
            return lp0Var.c().f27453e;
        }
        return 0;
    }
    ...
    public static final java.lang.String j(bw5.lp0 lp0Var) {
        kotlin.jvm.internal.o.g(lp0Var, "<this>");
        bw5.v70 d17 = lp0Var.d();
        java.lang.String title = d17 != null ? d17.getTitle() : null;
    ...
    public static final java.lang.String k(bw5.lp0 lp0Var) {
        ...
        return l17.f30621o[5] ? l17.f30617h : "";
    }
    ...
    public static final java.lang.String l(bw5.lp0 lp0Var) {
        ...
        return l17.f30621o[6] ? l17.f30618i : "";
    }
}
