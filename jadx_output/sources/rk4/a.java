...
public final class a extends i95.w implements qk.k6 {
    ...
    public java.util.ArrayList f396526d;

    /* renamed from: e, reason: collision with root package name */
    public qk.j6 f396527e;

    public int Ai(qk.p9 p9Var, java.lang.String str, bw5.v70 v70Var, java.lang.String str2) {
        java.util.ArrayList arrayList = this.f396526d;
        if (arrayList == null) {
    ...
    */
    ...
    public void Ui(java.lang.String taskId, bw5.lp0 item, il4.e ext) {
        ...
        while (it.hasNext()) {
            qk.j6 j6Var = (qk.j6) it.next();
            if (j6Var.m(null, item.d().getListenId(), item.d(), null)) {
    ...
    public void Vi(bw5.lp0 lp0Var, java.util.List list, bw5.o50 o50Var, bw5.pp0 pp0Var, il4.e ext) {
        ...
        while (it.hasNext()) {
            qk.j6 j6Var = (qk.j6) it.next();
            if (j6Var.m(null, (lp0Var == null || (d17 = lp0Var.d()) == null) ? null : d17.getListenId(), lp0Var != null ? lp0Var.d() : null, o50Var != null ? o50Var.c() : null)) {
    ...
    public void onCreate(android.content.Context context) {
        ...
        this.f396527e = new rk4.h();
        qk.j6[] j6VarArr = new qk.j6[2];
        j6VarArr[0] = new rk4.f();
        qk.j6 j6Var = this.f396527e;
        if (j6Var == null) {
            kotlin.jvm.internal.o.o("mFallbackImpl");
            throw null;
        }
        j6VarArr[1] = j6Var;
        this.f396526d = kz5.c0.d(j6VarArr);
    }
