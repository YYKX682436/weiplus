...
public final class y4 extends i95.w implements qk.s8 {
    public void Ai(boolean z17) {
        com.tencent.mars.xlog.Log.i("MicroMsg.Ting.FloatBallController", "setCouldShowFloatBall couldShow: " + z17);
        zk4.f.f473532b = z17;
    }

    public void Bi(boolean z17) {
        com.tencent.mars.xlog.Log.i("MicroMsg.Ting.FloatBallController", "showTingFloatBall show: " + z17 + ", couldShow: " + zk4.f.f473532b);
        zk4.l lVar = zk4.l.f473538a;
        if (zk4.l.f473540c != null) {
