...
public class a implements java.lang.Iterable {
    ...
    public final java.util.ArrayList f448699d;

    public a() {
        this.f448699d = new java.util.ArrayList();
    }

    public final void d(java.util.Collection collection, boolean z17) {
        java.util.ArrayList arrayList = this.f448699d;
        ...
        try {
            ...
            if (size != 0) {
                ...
                while (i27 < size) {
                    ...
                    java.util.regex.Pattern pattern = wq5.e.f448700b;
                ...
                java.util.regex.Pattern pattern2 = wq5.e.f448700b;
    ...
    public a(java.util.Collection collection) {
        if (collection == null) {
            ...
            this.f448699d = new java.util.ArrayList(collection.size());
            d(collection, true);
        }
    }
    ...
    public a(java.lang.Object obj) {
        ...
        if (obj.getClass().isArray()) {
            ...
            if (obj instanceof wq5.a) {
                arrayList.addAll(((wq5.a) obj).f448699d);
                return;
            }
