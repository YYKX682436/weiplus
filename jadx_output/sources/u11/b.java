...
public abstract class b {
    public static u11.a a(java.lang.String str) {
        ...
        return com.tencent.mm.sdk.platformtools.x9.b() ? (u11.a) e17.get("US") : (u11.a) e17.get(str.toUpperCase());
    }
    ...
    public static java.lang.String c(java.lang.String str) {
        for (u11.a aVar : e(null, str, true, true).values()) {
            if (aVar.f423728b.equals(str)) {
                return aVar.f423729c;
            }
        }
        return "";
    }
    ...
    public static java.util.Map e(java.lang.String str, java.lang.String str2, boolean z17, boolean z18) {
        ...
        java.lang.String[] stringArray = com.tencent.mm.sdk.platformtools.x2.f193075e.getStringArray(com.tencent.mm.R.array.f477999bf);
        for (int i28 = 0; i28 < stringArray.length; i28++) {
            java.lang.String[] split = stringArray[i28].trim().split(":");
            if (split.length < 4) {
                com.tencent.mars.xlog.Log.e("MicroMsg.CountryCodeUtil", "this country item has problem %s", stringArray[i28].trim());
            } else if ((str == null || split[0].equalsIgnoreCase(str)) && (str2 == null || split[1].equalsIgnoreCase(str2))) {
                java.lang.String str3 = split[2];
                if (z17) {
                    str3 = com.tencent.mm.storage.ha.k().l(split[0]);
                    if (com.tencent.mm.sdk.platformtools.t8.K0(str3)) {
                        str3 = split[2];
                    }
                }
                if (z18 && com.tencent.mm.sdk.platformtools.m2.n()) {
                    java.lang.String str4 = split[0];
                    java.lang.String str5 = split[1];
                    java.lang.String str6 = split[3];
                    if (str3 == null || str3.length() <= 0) {
                        com.tencent.mars.xlog.Log.e("Big5Util", "getStrokesCount buffer is empty");
                        i17 = 0;
                    } else {
                        try {
                            ...
                            com.tencent.mars.xlog.Log.e("Big5Util", "exception:%s", com.tencent.mm.sdk.platformtools.z3.c(e17));
                        }
                        ...
                        com.tencent.mars.xlog.Log.e("Big5Util", "byteToShort");
                        i19 = 0;
                        if (i19 < 42048) {
                        }
                        if (i19 < 42050) {
                ...
                u11.a aVar2 = aVar;
                hashMap.put(aVar2.f423727a + aVar2.f423728b, aVar2);
            }
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.CountryCodeUtil", "initCacheMapCountryCode cost %d", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis));
        return hashMap;
    }
}
