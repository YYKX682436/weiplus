...
public class d implements android.opengl.GLSurfaceView.EGLConfigChooser {
    ...
    public final int[] f281537a = {12324, 4, 12323, 4, 12322, 4, 12352, 4, 12344};

    /* renamed from: b, reason: collision with root package name */
    public final int[] f281538b = new int[1];

    public d(com.tencent.mm.plugin.mmsight.ui.cameraglview.MMSightCameraGLSurfaceView mMSightCameraGLSurfaceView, int i17, int i18, int i19, int i27, int i28, int i29) {
    }
    ...
    public javax.microedition.khronos.egl.EGLConfig chooseConfig(javax.microedition.khronos.egl.EGL10 egl10, javax.microedition.khronos.egl.EGLDisplay eGLDisplay) {
        int[] iArr = new int[1];
        egl10.eglChooseConfig(eGLDisplay, this.f281537a, null, 0, iArr);
        int i17 = iArr[0];
        if (i17 <= 0) {
        ...
        egl10.eglChooseConfig(eGLDisplay, this.f281537a, eGLConfigArr, i17, iArr);
