...
public class XWalkEnvironment {
    ...
    public static android.content.Context f347970c = null;

    /* renamed from: d, reason: collision with root package name */
    public static by5.u3 f347971d = null;

    /* renamed from: e, reason: collision with root package name */
    public static java.lang.String f347972e = null;

    /* renamed from: f, reason: collision with root package name */
    public static java.lang.String f347973f = null;

    /* renamed from: g, reason: collision with root package name */
    public static java.lang.String f347974g = null;

    /* renamed from: h, reason: collision with root package name */
    public static boolean f347975h = false;

    /* renamed from: i, reason: collision with root package name */
    public static boolean f347976i = false;

    /* renamed from: j, reason: collision with root package name */
    public static int f347977j = 2;

    /* renamed from: k, reason: collision with root package name */
    public static boolean f347978k;

    /* renamed from: o, reason: collision with root package name */
    public static by5.t0 f347982o;

    /* renamed from: p, reason: collision with root package name */
    public static java.lang.String f347983p;

    /* renamed from: a, reason: collision with root package name */
    public static final zx5.k f347968a = new zx5.k();

    /* renamed from: b, reason: collision with root package name */
    public static final wx5.b f347969b = new wx5.b();

    /* renamed from: l, reason: collision with root package name */
    public static final android.os.Bundle f347979l = new android.os.Bundle();
    public static boolean isTurnOnKVLog = false;

    /* renamed from: m, reason: collision with root package name */
    public static final java.util.Set f347980m = new java.util.HashSet();

    /* renamed from: n, reason: collision with root package name */
    public static final android.os.Bundle f347981n = new android.os.Bundle();

    /* renamed from: q, reason: collision with root package name */
    public static int f347984q = 0;

    /* renamed from: r, reason: collision with root package name */
    public static boolean f347985r = false;

    public static void a(java.lang.String str) {
        by5.c4.f("XWalkEnvironment", "appendAppInfo:" + str);
        ((java.util.HashSet) f347980m).add(str);
    }
    ...
    public static boolean containsAppInfo(java.lang.String str) {
        by5.c4.f("XWalkEnvironment", "containsAppInfo, strInfos:" + str);
        java.lang.String[] split = str.split("&");
        if (split != null && split.length != 0) {
            for (java.lang.String str2 : split) {
                if (!android.text.TextUtils.isEmpty(str2)) {
                    if (!((java.util.HashSet) f347980m).contains(str2.trim())) {
                        return false;
                    }
                }
            }
    ...
    public static int d() {
        by5.u3 u3Var = f347971d;
        if (u3Var == null) {
            return -1;
        }
        return u3Var.f36605a;
    }

    public static java.lang.String dumpAppInfo() {
        java.lang.String join = android.text.TextUtils.join(";", f347980m);
    ...
    public static synchronized boolean e() {
        boolean z17;
        synchronized (org.xwalk.core.XWalkEnvironment.class) {
            if (android.os.Build.VERSION.SDK_INT < 26) {
                by5.c4.f("XWalkEnvironment", "getEnableSandbox, disable sandbox because android version below O");
                f347985r = false;
            }
            by5.c4.f("XWalkEnvironment", "getEnableSandbox:" + f347985r);
            z17 = f347985r;
        }
        return z17;
    }
    ...
    public static boolean f(int i17) {
        ...
        return g17.hasFeature(i17);
    }

    public static int g(java.lang.String str) {
        return by5.u3.c(str).f36605a;
    }
    ...
    public static java.lang.String getProcessName() {
        ...
        if (!android.text.TextUtils.isEmpty(f347983p)) {
            return f347983p;
        }
        android.os.Bundle bundle = f347981n;
        synchronized (bundle) {
        ...
        android.content.Context context = f347970c;
    ...
    public static synchronized int k() {
        synchronized (org.xwalk.core.XWalkEnvironment.class) {
            ...
            by5.c4.f("XWalkEnvironment", "getMultiProcessType, multiProcessType:" + f347984q);
            return f347984q;
        }
    }
    ...
    public static java.lang.String m(java.lang.String str) {
        try {
            ...
            if (!"tools".equalsIgnoreCase(processName) && !"mm".equalsIgnoreCase(processName) && !"support".equalsIgnoreCase(processName)) {
                ...
                by5.c4.f("XWalkEnvironment", "getSafeModuleName, unknown:" + processName + ", use defaultVal:" + str);
                return str;
            }
            by5.c4.f("XWalkEnvironment", "getSafeModuleName, module = " + processName);
            return processName;
    ...
    public static com.tencent.xweb.f1 n(int i17) {
        boolean p17 = p();
        ...
        if (by5.z3.s(i17, "libxwebcore.so")) {
            return com.tencent.xweb.f1.WV_KIND_PINUS;
        }
    ...
    public static synchronized void q(android.content.Context context) {
        synchronized (org.xwalk.core.XWalkEnvironment.class) {
            ...
            by5.c4.g("XWalkEnvironment", "init start, sdkVersion:20260502, processName:" + getProcessName() + ", stack:" + android.util.Log.getStackTraceString(new java.lang.Exception("please ignore this exception")));
            f347970c = b(context);
            ...
            f347971d = r();
            by5.c4.f("XWalkEnvironment", "init, initCoreInfo costTime:" + (java.lang.System.currentTimeMillis() - currentTimeMillis2) + ", coreInfo:" + f347971d);
            ...
            u0Var.e(context);
            f347972e = "com.tencent.xweb.pinus.sdk.process.PrivilegedProcessService";
            f347973f = "com.tencent.xweb.pinus.sdk.process.SandboxedProcessService";
            com.tencent.xweb.t1.i();
            ...
            zx5.n.b(f347970c, f347968a);
            wx5.e.b(f347970c, f347969b);
            com.tencent.xweb.XWebCoreContentProvider.d();
            by5.c4.g("XWalkEnvironment", "init end, processName:" + getProcessName() + ", costTime:" + (java.lang.System.currentTimeMillis() - currentTimeMillis));
        }
    }
    ...
    public static by5.u3 r() {
        ...
        if (g18 != null && l().equalsIgnoreCase(getProcessName())) {
        ...
        if (i17 > 0) {
            ...
            if (!(file.exists() && file.isFile())) {
                by5.c4.f("XWalkEnvironment", "initCoreVersionInfo, no apk in version(" + c17.f36605a + ") dir");
                c17 = new by5.u3(-1, null, b17);
                by5.u3.e(c17.f36605a, c17.f36606b, c17.f36607c);
            }
        }
        int i18 = c17.f36605a;
        if (i18 > 0 && by5.z3.s(i18, "libxwalkcore.so")) {
            by5.c4.f("XWalkEnvironment", "initCoreVersionInfo, xwalk core version(" + c17.f36605a + ") no longer support");
            c17 = new by5.u3(-1, null, b17);
            by5.u3.e(c17.f36605a, c17.f36606b, c17.f36607c);
        }
        int i19 = c17.f36605a;
    ...
    public static void s(android.content.Context context, boolean z17) {
        ...
        if (!z17) {
            by5.d4.h(f347970c);
            f347971d = r();
            by5.c4.f("XWalkEnvironment", "initInChildProcess, coreInfo:" + f347971d);
        }
        by5.c4.g("XWalkEnvironment", "initInChildProcess end, processName:" + getProcessName());
    }
