...
final class WebRtcAudioUtils {
    ...
    public static java.lang.String audioEncodingToString(int i17) {
        if (i17 == 0) {
            return "INVALID";
        }
        switch (i17) {
    ...
    public static java.lang.String audioSourceToString(int i17) {
        switch (i17) {
            case 0:
    ...
    public static java.lang.String channelMaskToString(int i17) {
        return i17 != 12 ? i17 != 16 ? "INVALID" : "IN_MONO" : "IN_STEREO";
    }

    public static java.lang.String deviceTypeToString(int i17) {
        switch (i17) {
            case 1:
    ...
    private static boolean hasMicrophone(android.content.Context context) {
    ...
    public static void logAudioState(java.lang.String str, android.content.Context context, android.media.AudioManager audioManager) {
        logDeviceInfo(str);
    ...
    private static void logAudioStateBasic(java.lang.String str, android.content.Context context, android.media.AudioManager audioManager) {
        org.webrtc.Logging.d(str, "Audio State: audio mode: " + modeToString(audioManager.getMode()) + ", has mic: " + hasMicrophone(context) + ", mic muted: " + audioManager.isMicrophoneMute() + ", music active: " + audioManager.isMusicActive() + ", speakerphone: " + audioManager.isSpeakerphoneOn() + ", BT SCO: " + audioManager.isBluetoothScoOn());
    }
