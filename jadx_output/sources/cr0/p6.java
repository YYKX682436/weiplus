...
public final class p6 extends com.tencent.matrix.lifecycle.g {

    /* renamed from: b, reason: collision with root package name */
    public static final cr0.p6 f221711b = new cr0.p6();

    /* renamed from: c, reason: collision with root package name */
    public static final jz5.g f221712c;

    /* renamed from: d, reason: collision with root package name */
    public static final jz5.g f221713d;

    /* renamed from: e, reason: collision with root package name */
    public static final jz5.g f221714e;

    /* renamed from: f, reason: collision with root package name */
    public static final jz5.g f221715f;

    /* renamed from: g, reason: collision with root package name */
    public static final jz5.g f221716g;

    /* renamed from: h, reason: collision with root package name */
    public static final jz5.g f221717h;

    /* renamed from: i, reason: collision with root package name */
    public static final jz5.g f221718i;

    static {
        jz5.i iVar = jz5.i.f302829d;
        f221712c = jz5.h.a(iVar, cr0.o6.f221704d);
        f221713d = jz5.h.a(iVar, cr0.n6.f221694d);
        f221714e = jz5.h.a(iVar, cr0.h6.f221645d);
        f221715f = jz5.h.a(iVar, cr0.j6.f221662d);
        f221716g = jz5.h.a(iVar, cr0.i6.f221653d);
        f221717h = jz5.h.b(cr0.h5.f221644d);
        f221718i = jz5.h.b(cr0.l6.f221681d);
    }

    @Override // com.tencent.matrix.lifecycle.g
    public void a() {
        if (f()) {
            android.os.Handler handler = cr0.z6.f221826f;
            kotlin.jvm.internal.o.d(handler);
            jz5.g gVar = f221717h;
            handler.removeCallbacks((java.lang.Runnable) ((jz5.n) gVar).getValue());
            android.os.Handler handler2 = cr0.z6.f221826f;
            kotlin.jvm.internal.o.d(handler2);
            handler2.removeCallbacks((java.lang.Runnable) ((jz5.n) f221718i).getValue());
            android.os.Handler handler3 = cr0.z6.f221826f;
            kotlin.jvm.internal.o.d(handler3);
            handler3.postDelayed((java.lang.Runnable) ((jz5.n) gVar).getValue(), 300000);
        }
    }
    ...
    public void b() {
        if (f()) {
            android.os.Handler handler = cr0.z6.f221826f;
            kotlin.jvm.internal.o.d(handler);
            handler.removeCallbacks((java.lang.Runnable) ((jz5.n) f221717h).getValue());
            android.os.Handler handler2 = cr0.z6.f221826f;
            kotlin.jvm.internal.o.d(handler2);
            jz5.g gVar = f221718i;
            handler2.removeCallbacks((java.lang.Runnable) ((jz5.n) gVar).getValue());
            android.os.Handler handler3 = cr0.z6.f221826f;
            kotlin.jvm.internal.o.d(handler3);
            handler3.post((java.lang.Runnable) ((jz5.n) gVar).getValue());
        }
    }

    public final java.util.List c() {
        return (java.util.List) f221714e.getValue();
    }

    public final java.util.List d() {
        return (java.util.List) f221716g.getValue();
    }

    public final java.util.List e() {
        return (java.util.List) f221713d.getValue();
    }

    public final boolean f() {
        boolean z17;
        ((cr0.z6) ((ob0.p3) i95.n0.c(ob0.p3.class))).getClass();
        if (cr0.z6.f221826f != null) {
            jz5.g gVar = f221712c;
            synchronized (((java.util.Set) gVar.getValue())) {
                z17 = !((java.util.Set) gVar.getValue()).isEmpty();
            }
            if (z17) {
                return true;
            }
    ...
    public final void g() {
        ...
        if (f() && com.tencent.matrix.lifecycle.supervisor.AppExplicitBackgroundOwner.INSTANCE.isBackground()) {
            cr0.f5 f5Var = cr0.z6.f221824d;
            if (((java.lang.Boolean) ((jz5.n) cr0.z6.f221825e).getValue()).booleanValue() && (wi6 = cr0.z6.wi()) != null) {
                wi6.post(cr0.i5.f221652d);
            }
            java.util.Map a17 = kh.q3.f307897a.a();
            synchronized (c()) {
                int Bi = cr0.z6.Bi();
                ...
                for (java.util.Map.Entry entry : a17.entrySet()) {
                    ...
                    cr0.p6 p6Var = f221711b;
                    if (!p6Var.e().contains(str)) {
                        java.util.Iterator it6 = list.iterator();
                        while (true) {
                            if (it6.hasNext()) {
                                int a18 = ((kh.f3) ((jz5.l) it6.next()).c()).a();
                                if (!((java.util.Set) f221712c.getValue()).contains(java.lang.Integer.valueOf(a18))) {
                                    if (!com.tencent.matrix.lifecycle.supervisor.AppExplicitBackgroundOwner.INSTANCE.isBackground()) {
                                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE break: fg");
                                        break;
                                    }
                                    if (wh.u1.b(android.os.Process.myPid(), a18)) {
                                        ...
                                        if (threadPriority != Bi) {
                                            ...
                                            if (((p6Var.f() && cr0.z6.f221827g) ? 1 : i18) != 0) {
                                                try {
                                                    jz5.l c17 = com.tencent.matrix.hook.junwind.PthreadHackJni.c(a18);
                                                    int intValue = ((java.lang.Number) c17.a()).intValue();
                                                    int intValue2 = ((java.lang.Number) c17.b()).intValue();
                                                    cr0.f5 f5Var2 = cr0.z6.f221824d;
                                                    if (intValue != ((java.lang.Number) cr0.f5.a(f5Var2).c()).intValue()) {
                                                        ...
                                                        java.lang.Integer valueOf2 = java.lang.Integer.valueOf(com.tencent.matrix.hook.junwind.PthreadHackJni.nativeSetTidSchedPolicy(a18, intValue3, intValue4));
                                            ...
                                            if (p6Var.f() && cr0.z6.f221828h) {
                                                try {
                                                    boolean[] b17 = com.tencent.matrix.hook.junwind.PthreadHackJni.b(a18);
                                                    if (zh.c.a(b17) && !java.util.Arrays.equals(cr0.z6.Ai(), b17)) {
                                                        java.lang.Integer valueOf3 = java.lang.Integer.valueOf(com.tencent.matrix.hook.junwind.PthreadHackJni.f(a18, cr0.z6.Ai()));
                ...
                for (java.util.Map.Entry entry3 : linkedHashMap4.entrySet()) {
                    ...
                    if (intValue5 == 0) {
                        ...
                        cr0.p6 p6Var2 = f221711b;
                        p6Var2.c().clear();
                        p6Var2.c().addAll(F02);
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE nice_succ: " + list2.size());
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE nice_fail: " + list2.size());
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + intValue5 + ": tids=" + kz5.n0.g0(list2, ",", null, null, 0, null, cr0.k5.f221672d, 30, null));
                    }
                    i27 = 16;
                }
                ...
                for (java.util.Map.Entry entry7 : linkedHashMap7.entrySet()) {
                    ...
                    if (intValue7 == 0) {
                        ...
                        ((java.util.List) gVar.getValue()).addAll(F05);
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE policy_succ: " + list4.size());
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", sb8.toString());
                    } else {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE policy_fail: " + list4.size());
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + intValue7 + ": tids=" + kz5.n0.g0(list4, ",", null, null, 0, null, cr0.l5.f221680d, 30, null));
                    }
                }
                ...
                for (java.util.Map.Entry entry9 : linkedHashMap8.entrySet()) {
                    ...
                    if (intValue8 == 0) {
                        ...
                        cr0.p6 p6Var3 = f221711b;
                        p6Var3.d().clear();
                        p6Var3.d().addAll(F07);
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE affinity_succ: " + list5.size());
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", sb9.toString());
                    } else {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "REDUCE affinity_fail: " + list5.size());
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + intValue8 + ": tids=" + kz5.n0.g0(list5, ",", null, null, 0, null, cr0.j5.f221661d, 30, null));
                    }
                }
            }
        }
    ...
    public final void h() {
        ...
        int nativeSetTidSchedPolicy;
        android.os.Handler wi6;
        if (f()) {
            cr0.f5 f5Var = cr0.z6.f221824d;
            if (((java.lang.Boolean) ((jz5.n) cr0.z6.f221825e).getValue()).booleanValue() && (wi6 = cr0.z6.wi()) != null) {
                wi6.post(cr0.t5.f221755d);
            }
            synchronized (c()) {
                java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
                java.util.LinkedHashMap linkedHashMap2 = new java.util.LinkedHashMap();
                ...
                for (jz5.o oVar : p6Var.c()) {
                    ...
                    try {
                        if (wh.u1.b(android.os.Process.myPid(), intValue)) {
                            if (f221711b.f() && cr0.z6.f221827g) {
                                java.util.Iterator it = ((java.util.List) f221715f.getValue()).iterator();
                                while (true) {
                                    if (it.hasNext()) {
                                        obj5 = it.next();
                                ...
                                if (oVar2 != null) {
                                    ...
                                    try {
                                        jz5.l c17 = com.tencent.matrix.hook.junwind.PthreadHackJni.c(intValue);
                                        ...
                                        if (!(intValue4 == ((java.lang.Number) lVar3.c()).intValue() && intValue5 == ((java.lang.Number) lVar3.d()).intValue()) && kz5.p1.f(0, 3, 5, lVar2.c()).contains(java.lang.Integer.valueOf(intValue4))) {
                                            ...
                                            if (intValue4 == ((java.lang.Number) lVar2.c()).intValue() && intValue5 == ((java.lang.Number) lVar2.d()).intValue()) {
                                                nativeSetTidSchedPolicy = 0;
                                            } else {
                                                int intValue6 = ((java.lang.Number) lVar2.c()).intValue();
                                                int intValue7 = ((java.lang.Number) lVar2.d()).intValue();
                                                com.tencent.matrix.hook.junwind.PthreadHackJni.f52654c.a();
                                                nativeSetTidSchedPolicy = com.tencent.matrix.hook.junwind.PthreadHackJni.nativeSetTidSchedPolicy(intValue, intValue6, intValue7);
                                            }
                                            java.lang.Integer valueOf = java.lang.Integer.valueOf(nativeSetTidSchedPolicy);
                                    ...
                                    try {
                                        ...
                                        if (zh.c.a(b17)) {
                                            if (java.util.Arrays.equals(b17, zArr2)) {
                                                java.lang.Integer valueOf2 = java.lang.Integer.valueOf(java.util.Arrays.equals(b17, zArr) ? 0 : com.tencent.matrix.hook.junwind.PthreadHackJni.f(intValue, zArr));
                ...
                for (java.util.Map.Entry entry2 : linkedHashMap4.entrySet()) {
                    ...
                    if (intValue8 == -114514) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE nice_skip: " + list.size());
                        java.util.LinkedHashMap linkedHashMap5 = new java.util.LinkedHashMap();
                        for (java.lang.Object obj13 : list) {
                            ...
                            java.util.Iterator it7 = f221711b.c().iterator();
                            while (true) {
                                if (it7.hasNext()) {
                                    obj3 = it7.next();
                        ...
                        for (java.util.Map.Entry entry4 : linkedHashMap6.entrySet()) {
                            ...
                            com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + str2 + ": " + list2.size() + ", tids=" + kz5.n0.g0(list2, ",", null, null, 0, null, cr0.w5.f221805d, 30, null));
                        }
                    } else if (intValue8 != 0) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE nice_fail: " + list.size());
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + intValue8 + ": tids=" + kz5.n0.g0(list, ",", null, null, 0, null, cr0.x5.f221809d, 30, null));
                    } else {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE nice_succ: " + list.size());
                ...
                for (java.util.Map.Entry entry8 : linkedHashMap9.entrySet()) {
                    ...
                    if (intValue11 == -114514) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE policy_skip: " + list4.size());
                        ...
                        for (java.lang.Object obj17 : list4) {
                            ...
                            java.util.Iterator it9 = ((java.util.List) f221715f.getValue()).iterator();
                            while (true) {
                                if (it9.hasNext()) {
                                    obj2 = it9.next();
                        ...
                        for (java.util.Map.Entry entry10 : linkedHashMap11.entrySet()) {
                            ...
                            com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + str6 + ": " + list5.size() + ", tids=" + kz5.n0.g0(list5, ",", null, null, 0, null, cr0.y5.f221814d, 30, null));
                        }
                    } else if (intValue11 != 0) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE policy_fail: " + list4.size());
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + intValue11 + ": tids=" + kz5.n0.g0(list4, ",", null, null, 0, null, cr0.z5.f221823d, 30, null));
                    } else {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE policy_succ: " + list4.size());
                        java.lang.StringBuilder sb8 = new java.lang.StringBuilder();
                        sb8.append(" - ");
                ...
                for (java.util.Map.Entry entry12 : linkedHashMap12.entrySet()) {
                    ...
                    if (intValue14 == -114514) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE affinity_skip: " + list6.size());
                        ...
                        for (java.lang.Object obj19 : list6) {
                            ...
                            java.util.Iterator it11 = f221711b.d().iterator();
                            while (true) {
                                if (it11.hasNext()) {
                                    obj = it11.next();
                        ...
                        for (java.util.Map.Entry entry14 : linkedHashMap14.entrySet()) {
                            ...
                            com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + str8 + ": " + list7.size() + ", tids=" + kz5.n0.g0(list7, ",", null, null, 0, null, cr0.u5.f221774d, 30, null));
                        }
                    } else if (intValue14 != 0) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE affinity_fail: " + list6.size());
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", " - " + intValue14 + ": tids=" + kz5.n0.g0(list6, ",", null, null, 0, null, cr0.v5.f221785d, 30, null));
                    } else {
                        com.tencent.mars.xlog.Log.i("MicroMsg.ThreadSchedFeatureService", "RESTORE affinity_succ: " + list6.size());
                        java.lang.StringBuilder sb9 = new java.lang.StringBuilder();
                        sb9.append(" - ");
                ...
                cr0.p6 p6Var3 = f221711b;
                p6Var3.c().clear();
                ((java.util.List) f221715f.getValue()).clear();
                p6Var3.d().clear();
            }
        }
    }
