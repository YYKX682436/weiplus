...
public final class y0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.vlog.ui.thumb.TrackCropView f311159d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.util.LinkedList f311160e;

    public y0(com.tencent.mm.plugin.vlog.ui.thumb.TrackCropView trackCropView, java.util.LinkedList linkedList, long j17) {
        this.f311159d = trackCropView;
        this.f311160e = linkedList;
    }

    @Override // java.lang.Runnable
    public final void run() {
        com.tencent.mm.plugin.vlog.ui.thumb.TrackCropView trackCropView = this.f311159d;
        ...
        java.util.LinkedList<kp4.c1> linkedList = this.f311160e;
        ...
        yj0.a.d(linearLayoutManager, arrayList.toArray(), "com/tencent/mm/plugin/vlog/ui/thumb/TrackCropView$setTrack$2", "run", "()V", "Undefined", "scrollToPositionWithOffset", "(II)V");
        linearLayoutManager.P(((java.lang.Integer) arrayList.get(0)).intValue(), ((java.lang.Integer) arrayList.get(1)).intValue());
        yj0.a.f(linearLayoutManager, "com/tencent/mm/plugin/vlog/ui/thumb/TrackCropView$setTrack$2", "run", "()V", "Undefined", "scrollToPositionWithOffset", "(II)V");
        ...
        if (seekSlider != null) {
            ...
            seekSlider.post(new com.tencent.mm.plugin.mmsight.segment.i1(seekSlider, width2 - (i19 * 2), i19, (int) (((float) 1000) * trackCropView.f176065r)));
        }
        ...
        if (seekSlider3 != null) {
            seekSlider3.post(new kp4.x0(trackCropView, max));
        }
    }
}
