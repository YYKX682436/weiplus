...
public final class l0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.vlog.ui.thumb.MultiTrackCropView f311123d;

    public l0(com.tencent.mm.plugin.vlog.ui.thumb.MultiTrackCropView multiTrackCropView) {
        this.f311123d = multiTrackCropView;
    }

    @Override // java.lang.Runnable
    public final void run() {
        com.tencent.mm.plugin.vlog.ui.thumb.MultiTrackCropView multiTrackCropView = this.f311123d;
        ...
        if (multiTrackRecyclerView6 != null) {
            multiTrackRecyclerView6.post(new kp4.k0(multiTrackCropView));
        } else {
            kotlin.jvm.internal.o.o("recyclerView");
            throw null;
        }
