...
public final class h extends oh2.d {
    ...
    public final java.lang.String f345373x;

    /* renamed from: y, reason: collision with root package name */
    public final java.lang.String f345374y;

    /* renamed from: z, reason: collision with root package name */
    public final float f345375z;
    ...
    public h(android.content.Context context, java.lang.String rotateCharsPattern) {
        ...
        this.f345373x = rotateCharsPattern;
        this.f345374y = "FinderLiveNormalRoomVerticalLyricsDrawer";
        this.f345375z = i65.a.a(context, 24.0f);
    ...
    public void c(android.graphics.Canvas canvas, int i17) {
        ...
        if (aVar == null || (i18 = this.f345354l) > (i19 = this.f345355m + 1)) {
            return;
        }
        while (true) {
            java.util.ArrayList arrayList = aVar.f332852a;
            if (i18 >= 0 && i18 < arrayList.size()) {
                my5.c cVar = (my5.c) arrayList.get(i18);
                kotlin.jvm.internal.o.d(cVar);
                java.lang.String str = cVar.f332857a;
                kotlin.jvm.internal.o.d(str);
                if (!(str.length() == 0)) {
                    android.graphics.Paint paint = this.f345348f;
                    paint.setColor(i18 < this.f345353k ? this.f345351i : this.f345350h);
                    paint.setTypeface(i18 == this.f345353k ? android.graphics.Typeface.create(android.graphics.Typeface.DEFAULT, 1) : android.graphics.Typeface.DEFAULT);
                    if (i18 == this.f345353k) {
                        f17 = this.f345358p;
                    } else {
                        int i27 = this.f345354l;
                        f17 = (i18 != i27 || i27 < 0) ? this.f345344b : this.f345359q;
                    }
                    paint.setTextSize(f17);
                    i(i18);
                    float f19 = this.f345347e;
                    float f27 = this.f345375z;
                    float f28 = f19 + f27;
                    float f29 = 2;
                    float f37 = f27 / f29;
                    float f38 = ((i18 * f28) + f37) - this.f345357o;
                    float p17 = p(str);
                    float f39 = this.f345362t;
                    if (p17 <= f39) {
                        f18 = (f39 - p17) / f29;
                    } else {
                        f18 = 0.0f;
                        if (i18 == this.f345353k) {
                            float f47 = -(o(cVar, i17) - (this.f345362t * 0.7f));
                            if (f47 <= 0.0f) {
                                f18 = f47;
                            }
                        }
    ...
    public void f(android.graphics.Canvas canvas) {
        ...
        float f17 = this.f345375z / 2;
        android.graphics.Rect rect = this.f345365w;
        rect.left = -((int) f17);
        rect.right = (int) (this.f345361s + f17);
        rect.top = 0;
    ...
    public void h() {
        ...
        this.f345358p = f17;
        this.f345359q = f17;
        com.tencent.mars.xlog.Log.i("FinderLiveNormalRoomVerticalLyricsDrawer", "reset");
    }

    @Override // oh2.d
    public void k(int i17) {
        b(i17 * (this.f345375z + this.f345347e), false).start();
    }
    ...
    public final float o(my5.c cVar, int i17) {
        ...
        if (d17 >= 0) {
            ...
            if (!mCharacters.isEmpty()) {
                ...
                float f17 = ((float) (i17 - bVar.f332853a)) / ((float) bVar.f332854b);
        ...
        int i18 = (int) cVar.f332858b;
        int i19 = (int) cVar.f332859c;
        int i27 = i18 + i19;
        if (i17 < i18) {
            r1 = 0.0f;
        } else if (i17 < i27) {
        ...
        java.lang.String mText3 = cVar.f332857a;
        kotlin.jvm.internal.o.f(mText3, "mText");
        return p(mText3) * r1;
    }
    ...
    public final boolean q(char c17, java.lang.Character ch6) {
        jz5.g gVar = this.B;
        if (c17 == '\'' && ch6 != null && ((r26.t) ((jz5.n) gVar).getValue()).e(ch6.toString())) {
            return true;
        }
        return ((r26.t) ((jz5.n) gVar).getValue()).e(java.lang.String.valueOf(c17));
    }
}
