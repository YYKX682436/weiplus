...
public abstract class c0 {
    public static void a(tr5.a0 a0Var, tr5.r rVar, tr5.q qVar, java.lang.String[] strArr) {
        ...
        java.util.concurrent.CountDownLatch countDownLatch = a0Var.f421445f;
    ...
    public static void c(tr5.p pVar, tr5.a0 a0Var, boolean z17) {
        ...
        bs5.g gVar = fVar.f24023e;
        if (gVar.d() || gVar.f266348e) {
            if (!z17) {
                a0Var.e().remove(pVar);
            }
            java.util.Set c18 = a0Var.c();
            tr5.r rVar = fVar.f24021c;
            c18.remove(rVar);
