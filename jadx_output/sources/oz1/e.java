...
public class e {
    ...
    public static volatile oz1.e f350232e;

    /* renamed from: b, reason: collision with root package name */
    public oz1.b f350234b;

    /* renamed from: a, reason: collision with root package name */
    public int f350233a = 7118;

    /* renamed from: c, reason: collision with root package name */
    public java.lang.Boolean f350235c = null;

    /* renamed from: d, reason: collision with root package name */
    public java.lang.Boolean f350236d = null;
    ...
    public final boolean b() {
        if (this.f350235c == null) {
            this.f350235c = java.lang.Boolean.valueOf(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.d0.clicfg_data_report_open_new_uba_switch, true));
            com.tencent.mars.xlog.Log.i("Amoeba.NewUserBehaviourReporter", "[isOpenNewUBA] mOpenNewUBASwitch : " + this.f350235c);
        }
        return this.f350235c.booleanValue();
    }
    ...
    public final void c(java.util.List list, boolean z17) {
        ...
        while (it.hasNext()) {
            ...
            if (aVar != null && !u46.l.e(aVar.f350213s)) {
                java.lang.String replace = aVar.f350213s.replace("#", "/");
                byte[] bytes = replace.getBytes(java.nio.charset.StandardCharsets.UTF_8);
                if (bytes.length + i17 <= this.f350233a) {
                    sb6.append(replace);
                    sb6.append("#");
                    i17 += bytes.length;
                } else {
        ...
        while (it6.hasNext()) {
            ...
            if (z17) {
                com.tencent.mm.plugin.report.service.g0.INSTANCE.p(35244, str.replace(",", ";"), false, false, true);
            } else {
                com.tencent.mm.plugin.report.service.g0.INSTANCE.p(26251, str.replace(",", ";"), false, false, true);
            }
        }
    }
    ...
    */
    public void d(java.lang.String r6, long r7, java.util.Map r9) {
        ...
        L60:
            ...
            com.tencent.mm.sdk.platformtools.o4 r6 = com.tencent.mm.sdk.platformtools.o4.M(r6)
    ...
    /* JADX WARN: Code restructure failed: missing block: B:150:0x01ce, code lost:
        ...
        r0 = new oz1.a();
        r0.convertFrom(r10);
        r0.f350212r = r0.field_cacheTime;
        r0.f350213s = r0.field_reportStr;
        r0.f350214t = r0.field_isKeyView;
        r9.add(r0);
     */
    ...
    */
    ...
    public void f(long j17, java.lang.String str, java.lang.Object obj, java.util.Map map) {
        ...
        sy1.f fVar;
        if (u46.l.e(str) || this.f350234b == null || !b()) {
            return;
        }
        java.util.HashMap hashMap = new java.util.HashMap();
        ((sy1.d) cy1.a.Ui().f224694q).a(hashMap);
        cy1.a.Ui().wi(str, hashMap);
        if (map != null && map.size() > 0) {
            hashMap.putAll(map);
        }
        java.lang.Object obj5 = (obj != null || !(u46.l.c(str, "app_out") || u46.l.c(str, "app_in")) || (fVar = cy1.a.Ui().f224690m) == null) ? obj : fVar.f413847b;
        java.lang.String str8 = "";
        if (sz1.a.j() && (u46.l.c(str, "page_in") || u46.l.c(str, "page_out"))) {
            java.lang.String str9 = obj5 instanceof hz1.a ? ((hz1.a) obj5).f286289c : "";
            if (u46.l.e(str9) && map != null && (obj4 = map.get("page_name")) != null) {
                str9 = obj4.toString();
            }
            com.tencent.mm.plugin.report.service.g0.INSTANCE.p(36843, str + "," + str9 + "," + java.lang.System.currentTimeMillis(), false, false, true);
        }
        ry1.a a17 = ry1.b.a(str, obj5);
        if (a17 != null) {
            java.lang.String str10 = a17.f401362a;
            if (!u46.l.e(str10)) {
                hashMap.put("page_id", str10);
            }
            java.util.Map map2 = a17.f401363b;
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("Amoeba.NewUserBehaviourReporter", "[reportStandardEvent] throw Exception e : " + e17.getMessage());
        }
        ...
        if (!str.contains("view_") && !str.contains("cgi_")) {
            ...
            if (hashMap.get("page_name") != null) {
                ...
                objArr[4] = java.lang.Integer.valueOf(aVar != null ? aVar.f286296j : -1);
                com.tencent.mars.xlog.Log.i("Amoeba.NewUserBehaviourReporter", java.lang.String.format("[reportStandardEvent] eventId : %s, pageName : %s, pageId : %s, bizId : %s, stackDeep : %d", objArr));
                if (u46.l.c(str, str6) && z17 && ((hz1.a) obj5).f286293g) {
                ...
                com.tencent.mars.xlog.Log.e("Amoeba.NewUserBehaviourReporter", "[reportStandardEvent] --- --- ---");
            } else {
                ...
                objArr2[1] = obj5;
                com.tencent.mars.xlog.Log.e("Amoeba.NewUserBehaviourReporter", java.lang.String.format("[reportStandardEvent] pageName is null, eventId : %s, target : %s", objArr2));
                java.lang.String str12 = aVar != null ? aVar.f286289c : "unknow";
                if (pz1.a.a()) {
                    java.util.ArrayList arrayList = new java.util.ArrayList();
                    arrayList.add("9");
                    arrayList.add(str12);
            ...
            com.tencent.mars.xlog.Log.i("enricwu.test.rd", java.lang.String.format("[reportStandardEvent] eventId : %s, view_id : %s, expose_start_time : %s", str, hashMap.get(obj3), hashMap.get("expose_start_time")));
        }
        if (u46.l.e(str) || u46.l.e(str11)) {
            return;
        }
        if (this.f350236d == null) {
            this.f350236d = java.lang.Boolean.valueOf(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.d0.clicfg_data_report_is_report_all_uba, false));
            com.tencent.mars.xlog.Log.i("Amoeba.NewUserBehaviourReporter", "[isReportAllUBA] mIsReportAllUBA : " + this.f350236d);
        }
        if (this.f350236d.booleanValue()) {
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
            sb6.append(str);
            ...
            sb6.append(str13);
            sb6.append(str11);
            com.tencent.mars.xlog.Log.i("Amoeba.NewUserBehaviourReporter", "[reportAllUBA] sb : " + ((java.lang.Object) sb6));
            if (u46.l.c(str, "app_in") || u46.l.c(str, str5) || u46.l.c(str, "biz_in") || u46.l.c(str, str4) || u46.l.c(str, "session_in") || u46.l.c(str, str3) || u46.l.c(str, str2) || u46.l.c(str, str6) || u46.l.c(str, "view_clk") || u46.l.c(str, "view_double_tap") || u46.l.c(str, "view_long_press")) {
                com.tencent.mm.plugin.report.service.g0.INSTANCE.p(28356, sb6.toString(), false, false, true);
            }
        }
    }
}
