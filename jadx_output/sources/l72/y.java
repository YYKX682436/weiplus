...
public class y implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ android.text.Spannable f316872d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.widget.TextView f316873e;

    public y(com.tencent.mm.plugin.facedetectaction.ui.FaceAgreementUI faceAgreementUI, android.text.Spannable spannable, android.widget.TextView textView) {
        this.f316872d = spannable;
        this.f316873e = textView;
    }
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        android.widget.TextView textView2 = this.f316873e;
        android.text.Spannable spannable = this.f316872d;
        boolean z17 = false;
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FaceAgreementUI", "touch ${event.x}, ${event.y}, ret:${ret}");
