...
public final class f0 extends f26.e0 implements f26.s {
    ...
    public f26.c3 A0(boolean z17) {
        return f26.r0.a(this.f259153e.A0(z17), this.f259154f.A0(z17));
    }
    ...
    public f26.c3 y0(g26.l kotlinTypeRefiner) {
        ...
        return new f26.f0((f26.z0) kotlinTypeRefiner.a(this.f259153e), (f26.z0) kotlinTypeRefiner.a(this.f259154f));
    }

    @Override // f26.c3
    public f26.c3 C0(f26.r1 newAttributes) {
        kotlin.jvm.internal.o.g(newAttributes, "newAttributes");
        return f26.r0.a(this.f259153e.C0(newAttributes), this.f259154f.C0(newAttributes));
    }
    ...
    public java.lang.String E0(q16.s renderer, q16.c0 options) {
        ...
        f26.z0 z0Var = this.f259154f;
        f26.z0 z0Var2 = this.f259153e;
        if (!c17) {
    ...
    public boolean s0() {
        ...
        return (z0Var.w0().i() instanceof o06.e2) && kotlin.jvm.internal.o.b(z0Var.w0(), this.f259154f.w0());
    }

    @Override // f26.e0
    public java.lang.String toString() {
        return "(" + this.f259153e + ".." + this.f259154f + ')';
    }
