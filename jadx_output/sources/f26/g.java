...
public final class g {
    ...
    public static final f26.g f259162a = new f26.g();
    ...
    */
    ...
    public static final boolean b(i26.o oVar, f26.b2 b2Var, i26.j jVar, i26.j jVar2, boolean z17) {
        ...
        for (i26.i iVar : s17) {
            if (kotlin.jvm.internal.o.b(oVar.S(iVar), oVar.o(jVar2)) || (z17 && i(f259162a, b2Var, jVar2, iVar, false, 8, null))) {
                return true;
            }
        }
        return false;
    ...
    */
    ...
    public final java.util.List c(f26.b2 b2Var, i26.j jVar, i26.m mVar) {
        ...
        if (oVar.G(mVar)) {
            ...
            i26.j z17 = oVar.z(jVar, i26.b.f288087d);
            if (z17 != null) {
                jVar = z17;
            }
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            if (uVar.add(jVar2)) {
                i26.j z18 = oVar.z(jVar2, i26.b.f288087d);
                if (z18 == null) {
                    z18 = jVar2;
                }
                boolean L = oVar.L(oVar.o(z18), mVar);
                f26.y1 y1Var = f26.y1.f259239a;
                i26.o oVar2 = b2Var.f259131c;
                if (L) {
                    qVar.add(z18);
                    c17 = y1Var;
                } else {
                    c17 = oVar.v(z18) == 0 ? f26.x1.f259234a : oVar2.c(z18);
                }
                if (!(!kotlin.jvm.internal.o.b(c17, y1Var))) {
                    c17 = null;
                }
                if (c17 != null) {
    ...
    */
    ...
    public final boolean g(i26.o oVar, i26.i iVar) {
        return (!oVar.D(oVar.S(iVar)) || oVar.g(iVar) || oVar.U(iVar) || oVar.s0(iVar) || !kotlin.jvm.internal.o.b(oVar.o(oVar.g0(iVar)), oVar.o(oVar.l0(iVar)))) ? false : true;
    }
    ...
    public final boolean j(i26.o oVar, i26.i iVar, i26.i iVar2, i26.m mVar) {
        ...
        if (m07 instanceof i26.d) {
            ...
            if (oVar.H(dVar) || !oVar.q0(oVar.K(oVar.l(dVar))) || oVar.W(dVar) != i26.b.f288087d) {
                return false;
            }
            oVar.S(iVar2);
        }
