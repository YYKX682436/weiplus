...
public final class e {
    ...
    public static final zp4.e f474954a = new zp4.e();
    ...
    public final void b() {
        ...
        com.tencent.mm.storage.u3 u3Var = com.tencent.mm.storage.u3.USERINFO_SNS_BACKGROUND_VIDEO_DATA_DB_VERSION_INT;
        ...
        if (intValue != 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg，BackgroundVideoInfoStorageManager", "diff sql version， delete sql file, " + intValue + ", 0");
            com.tencent.mm.vfs.w6.f(gm0.j1.u().h() + "mediaOpt/remux/dbFolder/");
        }
        synchronized (jm0.k.f300270i) {
            ...
            a17 = new androidx.lifecycle.j1(gm0.j1.b().f273245h, new jm0.h()).a(zp4.c.class);
        }
    ...
    public final dm.q0 c(int i17, int i18) {
        ...
        i19.f352656c = "MicroMsg，BackgroundVideoInfoStorageManager";
        i19.f352657d = c17;
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg，BackgroundVideoInfoStorageManager", sb6.toString());
        return q0Var;
    }
    ...
    public final dm.q0 d(java.lang.String workTagId) {
        ...
        i17.f352657d = dm.q0.S.j(workTagId);
        i17.f352656c = "MicroMsg.SDK.BaseBackgroundVideoInfo";
    ...
    public final void e(java.lang.String workTagId, boolean z17) {
        ...
        j18.b(j17);
        com.tencent.mars.xlog.Log.i("MicroMsg，BackgroundVideoInfoStorageManager", "updateUseSnsDoubleCheckByWorkTagId >> workTagId: " + workTagId + ", isUse: " + z17 + ", result: " + j18.a().f(a17));
    }
    ...
    public final void f(java.lang.String workTagId, int i17) {
        ...
        p75.h1 j18 = dm.q0.R.j(contentValues);
        j18.b(j17);
        com.tencent.mars.xlog.Log.i("MicroMsg，BackgroundVideoInfoStorageManager", "updateWorkTypeByWorkTagId >> workTagId: " + workTagId + ", workType: " + i17 + ", result: " + j18.a().f(a17));
    }
}
