...
public class b implements on5.b, qn5.b, android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final android.view.View f429492d;

    /* renamed from: e, reason: collision with root package name */
    public final tn5.g f429493e;

    /* renamed from: f, reason: collision with root package name */
    public int f429494f;

    /* renamed from: g, reason: collision with root package name */
    public boolean f429495g;

    /* renamed from: h, reason: collision with root package name */
    public boolean f429496h;

    /* renamed from: i, reason: collision with root package name */
    public android.view.View f429497i;

    /* renamed from: m, reason: collision with root package name */
    public final android.view.View f429498m;

    public b(android.view.View outView) {
        kotlin.jvm.internal.o.g(outView, "outView");
        this.f429492d = outView;
        this.f429493e = e();
        this.f429495g = true;
        this.f429496h = true;
        this.f429497i = outView;
        this.f429498m = outView;
    }
    ...
    public android.animation.ValueAnimator.AnimatorUpdateListener a(int i17) {
        ...
        if ((i17 >= 0 || !this.f429497i.canScrollVertically(1)) && (i17 <= 0 || !this.f429497i.canScrollVertically(-1))) {
            return null;
        }
        this.f429494f = i17;
        return this;
    ...
    public boolean b() {
        return this.f429496h && this.f429493e.a(this.f429498m);
    }

    public boolean c() {
        return this.f429495g && this.f429493e.b(this.f429498m);
    }
    ...
    */
    ...
    public void onAnimationUpdate(android.animation.ValueAnimator animation) {
        ...
        try {
            float scaleY = (intValue - this.f429494f) * this.f429497i.getScaleY();
