...
public final class e {
    ...
    public static void b(ll2.e eVar, java.lang.String path, boolean z17, boolean z18, int i17, java.lang.Object obj) {
        ...
        java.lang.String str = f17 != null ? f17.f388500u : null;
        com.tencent.mars.xlog.Log.i("FinderLiveRedDotNotifier", "dispose " + path + " with group id " + str + ", fromExpose = " + z17);
        if (!z17 && z18) {
            eVar.m(path, 2);
        }
    ...
    public static void l(ll2.e eVar, androidx.lifecycle.y yVar, java.lang.String path, android.view.View view, android.view.View view2, android.widget.TextView textView, int i17, java.lang.Object obj) {
        if ((i17 & 8) != 0) {
            view2 = null;
        }
        if ((i17 & 16) != 0) {
    ...
    public final boolean a(java.lang.String path) {
        ...
        sb6.append(q40Var != null ? java.lang.Integer.valueOf(q40Var.f383656d) : null);
        sb6.append(" limit = ");
        sb6.append(I0.f373900t);
        ...
        return i17 <= (q40Var2 != null ? q40Var2.f383656d : 0);
    }
    ...
    public final void c(java.lang.String path, boolean z17, boolean z18) {
        ...
        zy2.fa nk6 = ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).nk();
        r45.vs2 f17 = f(path);
        com.tencent.mars.xlog.Log.i("FinderLiveRedDotNotifier", "disposeRedDotByPathWithGroupId " + path + " with group id " + (f17 != null ? f17.f388500u : null) + ", fromExpose = " + z17);
        if (!z17 && z18) {
            m(path, 2);
        }
        nk6.N(path);
    ...
    public final r45.vs2 f(java.lang.String str) {
        ...
        while (true) {
            ...
            obj = it.next();
            java.util.LinkedList<r45.f03> show_infos = ((com.tencent.mm.plugin.finder.extension.reddot.jb) obj).field_ctrInfo.f388489g;
            kotlin.jvm.internal.o.f(show_infos, "show_infos");
            boolean z17 = false;
            for (r45.f03 f03Var : show_infos) {
                if (kotlin.jvm.internal.o.b(f03Var.f373892i, str) && f03Var.f373891h == 1) {
                    z17 = true;
                }
            }
            if (z17) {
        ...
        com.tencent.mm.plugin.finder.extension.reddot.jb jbVar = (com.tencent.mm.plugin.finder.extension.reddot.jb) obj;
        if (jbVar != null) {
            return jbVar.field_ctrInfo;
        }
        return null;
    }

    public final androidx.lifecycle.j0 g(java.lang.String path) {
        kotlin.jvm.internal.o.g(path, "path");
        java.util.LinkedHashMap linkedHashMap = (java.util.LinkedHashMap) f319134b;
    ...
    public final boolean h(java.lang.String path) {
        kotlin.jvm.internal.o.g(path, "path");
        com.tencent.mm.plugin.finder.extension.reddot.a aVar = (com.tencent.mm.plugin.finder.extension.reddot.a) g(path).getValue();
        return aVar != null && aVar.f105327a;
    }

    public final void i(int i17, java.util.List showInfos, java.lang.String str) {
        kotlin.jvm.internal.o.g(showInfos, "showInfos");
        ...
        while (it.hasNext()) {
            vs2Var.f388489g.add((r45.f03) it.next());
        }
    ...
    public final void j(java.lang.String path, boolean z17) {
        ...
        e(path, z17);
        r45.f03 I0 = ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).nk().I0(path);
        if (I0 != null && I0.f373900t > 0) {
            com.tencent.mars.xlog.Log.i("FinderLiveRedDotNotifier", "reddot path " + I0.f373892i + " exposed, exposeCount = " + ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).nk().U0(path));
        }
    }

    public final void k(androidx.lifecycle.y yVar, java.lang.String path, yz5.l callback) {
        kotlin.jvm.internal.o.g(path, "path");
        ...
        o(yVar, path, false);
        com.tencent.mars.xlog.Log.i("FinderLiveRedDotNotifier", "register reddot ".concat(path));
    ...
    public final void m(java.lang.String str, int i17) {
        ...
        r45.vs2 f17 = f319133a.f(str);
        if (f17 != null && (str2 = f17.f388490h) != null) {
    ...
    public final java.lang.String n(java.lang.String currUI, java.lang.String path, int i17, java.lang.String lastTids) {
        ...
        kotlin.jvm.internal.o.g(path, "path");
        kotlin.jvm.internal.o.g(lastTids, "lastTids");
        zy2.fa nk6 = ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).nk();
        ...
        if (I0 != null && L0 != null) {
            ...
            if (i17 == 1) {
                ...
                str = str2 != null ? str2 : "";
                if (kotlin.jvm.internal.o.b(lastTids, str)) {
                    com.tencent.mars.xlog.Log.i("FinderLiveRedDotNotifier", "[checkLivePersonCenterRedDotReport] repeat report tipsId = ".concat(str));
                    return str;
                }
            }
    ...
    public final void o(androidx.lifecycle.y yVar, java.lang.String path, boolean z17) {
        kotlin.jvm.internal.o.g(path, "path");
        if (yVar != null) {
            if (z17) {
                com.tencent.mars.xlog.Log.i("FinderLiveRedDotNotifier", "unregister reddot ".concat(path));
            }
            f319133a.g(path).removeObservers(yVar);
        }
    }
}
