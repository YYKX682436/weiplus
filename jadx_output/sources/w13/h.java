...
public class h extends o13.a {
    ...
    public com.tencent.wcdb.database.SQLiteStatement f442214r;

    /* renamed from: s, reason: collision with root package name */
    public com.tencent.wcdb.database.SQLiteStatement f442215s;
    ...
    public void E() {
        if (C()) {
            ((com.tencent.mm.plugin.fts.o) this.f342198f).q(-105L, 3L);
            ((com.tencent.mm.plugin.fts.o) this.f342198f).q(-200L, com.tencent.wcdb.core.Database.DictDefaultMatchValue);
        }
        ...
        ((com.tencent.mm.plugin.fts.o) this.f342198f).i(java.lang.String.format("CREATE INDEX IF NOT EXISTS %s_aux_subtype_ts ON %s(aux_index, subtype, timestamp);", r(), r()));
        this.f442214r = ((com.tencent.mm.plugin.fts.o) this.f342198f).e(java.lang.String.format("UPDATE %s SET status = ? WHERE aux_index = ? AND status <> ?", r()));
        this.f442215s = ((com.tencent.mm.plugin.fts.o) this.f342198f).e(java.lang.String.format("INSERT OR REPLACE INTO %s (docid, type, subtype, entity_id, aux_index, timestamp, talker) VALUES (last_insert_rowid(), ?, ?, ?, ?, ?, ?);", r()));
    }
    ...
    */
    public void N(int r12, int r13, long r14, java.lang.String r16, long r17, java.lang.String r19, java.lang.String r20) {
        ...
        La:
            ...
            com.tencent.wcdb.database.SQLiteStatement r0 = r1.f442215s     // Catch: com.tencent.wcdb.database.SQLiteException -> L6b
            r3 = r12
            long r4 = (long) r3
            r0.bindLong(r2, r4)     // Catch: com.tencent.wcdb.database.SQLiteException -> L69
            com.tencent.wcdb.database.SQLiteStatement r0 = r1.f442215s     // Catch: com.tencent.wcdb.database.SQLiteException -> L69
            r2 = 2
            r4 = r13
            long r5 = (long) r4
            r0.bindLong(r2, r5)     // Catch: com.tencent.wcdb.database.SQLiteException -> L67
            com.tencent.wcdb.database.SQLiteStatement r0 = r1.f442215s     // Catch: com.tencent.wcdb.database.SQLiteException -> L67
            r2 = 3
            r5 = r14
            r0.bindLong(r2, r14)     // Catch: com.tencent.wcdb.database.SQLiteException -> L65
            com.tencent.wcdb.database.SQLiteStatement r0 = r1.f442215s     // Catch: com.tencent.wcdb.database.SQLiteException -> L65
            r2 = 4
            ...
            com.tencent.wcdb.database.SQLiteStatement r0 = r1.f442215s     // Catch: com.tencent.wcdb.database.SQLiteException -> L63
            java.lang.String r2 = ""
            if (r20 != 0) goto L57
            goto L59
        L57:
    ...
    public android.database.Cursor O(p13.r rVar, java.lang.String str, java.util.Set set) {
        ...
        return ((com.tencent.mm.plugin.fts.o) this.f342198f).o(java.lang.String.format("SELECT %s.docid, type, subtype, entity_id, aux_index, timestamp, talker FROM %s JOIN %s ON (%s.docid = %s.rowid) WHERE %s MATCH '%s'" + str2 + format + " AND status >= 0" + q() + ";", r(), r(), o(), r(), o(), o(), f17), null);
    }
    ...
    public final java.lang.String q() {
        return !(j62.e.g().c(new com.tencent.mm.repairer.config.fts.RepairerConfigFTSVoiceMsgEnable()) == 1) ? " AND subtype != 70" : "";
    }

    @Override // o13.u
    public android.database.Cursor q1(int[] iArr, java.lang.String str) {
        if (iArr == null || iArr.length == 0) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FTS.FTS5MessageStorage", "queryConversationTypeMessage: subTypes is null or empty, return EmptyCursor");
            return new d95.d();
        }
        ...
        return ((com.tencent.mm.plugin.fts.o) this.f342198f).o(java.lang.String.format("SELECT type, subtype, entity_id, aux_index, timestamp, talker FROM %s WHERE subtype IN (%s) %s AND status >= 0 ORDER BY timestamp desc;", r(), sb6.substring(0, sb6.length() - 1), str2), z17 ? new java.lang.String[]{str} : null);
    }
