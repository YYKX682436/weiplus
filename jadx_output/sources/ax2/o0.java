...
public final class o0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.crit.LivePkCritDoingView f15079d;

    public o0(com.tencent.mm.plugin.finder.view.crit.LivePkCritDoingView livePkCritDoingView) {
        this.f15079d = livePkCritDoingView;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        yz5.l lVar = this.f15079d.f131844v;
        if (lVar != null) {
            lVar.invoke("");
        }
