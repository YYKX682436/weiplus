...
public final class o extends android.widget.LinearLayout {
    ...
    public final java.lang.String f423093d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicInteger f423094e;

    /* renamed from: f, reason: collision with root package name */
    public int f423095f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.List f423096g;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.Map f423097h;
    ...
    public o(android.content.Context context, java.lang.String tag) {
        ...
        this.f423093d = tag;
        this.f423094e = new java.util.concurrent.atomic.AtomicInteger(0);
        setOrientation(0);
        this.f423096g = new java.util.ArrayList();
        this.f423097h = new java.util.LinkedHashMap();
    }
    ...
    public final java.lang.Integer a(java.lang.String str) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(this.f423093d, th6, "", new java.lang.Object[0]);
            return null;
        }
    }
    ...
    */
    public final java.lang.Object b(bw5.o5 r17, int r18, kotlin.coroutines.Continuation r19) {
        /*
    ...
    public final void c() {
        removeAllViews();
        this.f423095f = 0;
        ((java.util.ArrayList) this.f423096g).clear();
        java.util.Map map = this.f423097h;
        java.util.Iterator it = ((java.util.LinkedHashMap) map).entrySet().iterator();
        while (it.hasNext()) {
            kotlinx.coroutines.p2.a((kotlinx.coroutines.r2) ((java.util.Map.Entry) it.next()).getValue(), null, 1, null);
        }
