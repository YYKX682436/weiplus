...
public final class f0 extends p1.y {
    ...
    public p1.b0 f350815f = p1.b0.Unknown;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ p1.g0 f350816g;
    ...
    @Override // p1.y
    public void b() {
        if (this.f350815f == p1.b0.Dispatching) {
            long uptimeMillis = android.os.SystemClock.uptimeMillis();
            p1.g0 g0Var = this.f350816g;
            ...
            e0Var.invoke(obtain);
            obtain.recycle();
            this.f350815f = p1.b0.Unknown;
            g0Var.f350822f = false;
        }
    }
    ...
    */
    public void c(p1.l r7, p1.n r8, long r9) {
        /*
            ...
            p1.g0 r9 = r6.f350816g
            boolean r10 = r9.f350822f
            r0 = 0
            r1 = 1
            java.util.List r2 = r7.f350842a
            if (r10 != 0) goto L3e
            int r10 = r2.size()
            r3 = r0
        L19:
    ...
    public final void v(p1.l lVar) {
        ...
        p1.g0 g0Var = this.f350816g;
        if (z17) {
            if (this.f350815f == b0Var) {
                s1.z zVar = this.f350925d;
                if (zVar == null) {
                    throw new java.lang.IllegalStateException("layoutCoordinates not set".toString());
                }
                int i18 = d1.e.f225626e;
                p1.i0.a(lVar, ((u1.c1) zVar).t0(d1.e.f225623b), new p1.c0(g0Var), true);
            }
            this.f350815f = p1.b0.NotDispatching;
            return;
        }
        s1.z zVar2 = this.f350925d;
        if (zVar2 == null) {
            throw new java.lang.IllegalStateException("layoutCoordinates not set".toString());
        }
        int i19 = d1.e.f225626e;
        p1.i0.a(lVar, ((u1.c1) zVar2).t0(d1.e.f225623b), new p1.d0(this, g0Var), false);
        if (this.f350815f == b0Var) {
            int size2 = list.size();
