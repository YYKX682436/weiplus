...
public final class m {
    ...
    public static final u24.m f424129a = new u24.m();

    public final void a(a24.i iVar) {
        if (kotlin.jvm.internal.o.b(iVar.getClass(), com.tencent.mm.plugin.setting.ui.setting_new.settings.SettingGroupMain.class)) {
            return;
        }
        ...
        com.tencent.mars.xlog.Log.e("MicroMsg.SettingDataFactory", iVar.getClass() + " parentGroup is itself");
    }

    public final java.util.HashMap b(androidx.appcompat.app.AppCompatActivity context) {
    ...
    public final jz5.l c(java.lang.String key, com.tencent.mm.plugin.setting.ui.setting_new.base.BaseSettingUI context) {
        ...
        kz5.n0.g0(values, null, null, null, 0, null, u24.k.f424126d, 31, null);
    ...
    public final jz5.l d(a24.i rootItem, java.util.List list) {
        kotlin.jvm.internal.o.g(rootItem, "rootItem");
        ...
        while (it.hasNext()) {
            ...
            a24.u b76 = iVar.b7();
            if (kotlin.jvm.internal.o.b(rootItem.getClass(), b76.f908a)) {
                if (kotlin.jvm.internal.o.b(rootItem, iVar)) {
                    f424129a.a(iVar);
                } else {
                    hashMap.put(b76.f909b, iVar);
                }
            }
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        ...
        if (hashMap.size() != arrayList.size()) {
            ...
            if ((i17 == 788529167 || i17 == 788529166) || z65.c.a()) {
                ...
                for (java.util.Map.Entry entry : hashMap.entrySet()) {
                    ...
                    sb7.append(" value: ");
                    sb7.append(kotlin.jvm.internal.i0.a(entry.getValue().getClass()).g());
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.SettingDataFactory", "checkSize error");
        }
