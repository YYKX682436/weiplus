...
public abstract class g2 {
    public static final void a(android.content.Context context, c01.ka kaVar) {
        ...
        sb6.append(kaVar != null ? java.lang.Integer.valueOf(kaVar.f37288a) : null);
        com.tencent.mars.xlog.Log.i("MicroMsg.ScanMyQrCodeHelper", sb6.toString());
        ...
        intent.putExtra("key_enter_scene", kaVar != null ? kaVar.f37288a : 0);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(b04.f.class);
        if (((yz3.m) ((kd0.r2) i95.n0.c(kd0.r2.class))).f468535e) {
            ((gh0.e) i95.n0.c(gh0.e.class)).getClass();
            arrayList.add(com.tencent.mm.wedrop.ui.code.TransferFileUIC.class);
        }
        ...
        pf5.j0.a(intent, com.tencent.mm.plugin.setting.ui.setting.i0.class);
