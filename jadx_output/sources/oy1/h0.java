...
public final class h0 extends com.tencent.mm.sdk.event.n {
    ...
    public final boolean b(int i17) {
        java.util.Set set;
        if (this.f349873d == null) {
            this.f349873d = new java.util.LinkedHashSet();
            ...
            if (!kotlin.jvm.internal.o.b(Zi, "")) {
                ...
                while (it.hasNext()) {
                    ...
                    if (h17 != null && (set = this.f349873d) != null) {
                        set.add(h17);
                    }
                }
            }
        }
        java.util.Set set2 = this.f349873d;
        if (set2 != null) {
    ...
    public final java.util.List c(org.json.JSONArray jSONArray, int i17) {
        if (i17 >= 50) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "parseJsonArray get JSONArray data err! more than 50");
    ...
    public boolean callback(com.tencent.mm.sdk.event.IEvent iEvent) {
        com.tencent.mm.autogen.events.JsSdkCgiReportEvent event = (com.tencent.mm.autogen.events.JsSdkCgiReportEvent) iEvent;
        kotlin.jvm.internal.o.g(event, "event");
        am.xh xhVar = event.f54448g;
        if (xhVar != null) {
            if (xhVar.f8378a <= 0) {
                com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "bizId err !! " + xhVar + ".businessId");
            } else {
                java.lang.String str = xhVar.f8380c;
                if (str == null || str.length() == 0) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "jsonInfoStringList empty !!");
                } else {
                    try {
                        org.json.JSONArray jSONArray = new org.json.JSONArray(xhVar.f8380c);
                        if (jSONArray.length() <= 0) {
                            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "jsonArray empty !!");
                        } else {
                            h(xhVar.f8378a, xhVar.f8379b, jSONArray);
                        }
                    } catch (java.lang.Exception unused) {
                        com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "parse json err !!");
                    }
                }
            }
        }
    ...
    public final java.util.Map f(org.json.JSONObject jSONObject, int i17) {
        ...
        if (i17 >= 50) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "parseJsonToMapString get JSONArray data err! more than 50 ");
        ...
        try {
            ...
            while (i29 < length) {
                ...
                if (jSONObject5 != null) {
                    ...
                    boolean b17 = kotlin.jvm.internal.o.b(optString3, "");
                    ...
                    if (b17) {
                        ...
                        if (f0Var3 == null) {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "cur page err !! " + optString3);
                        }
                    }
                    java.lang.String optString4 = jSONObject5.optString("refPageJson", "");
                    if (kotlin.jvm.internal.o.b(optString4, "")) {
                        str = str3;
                    } else {
                        ...
                        if (f0Var2 == null) {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "ref page err !! " + optString4);
                        }
                    }
                    java.lang.String optString5 = jSONObject5.optString("sourcePageJson", "");
                    if (!kotlin.jvm.internal.o.b(optString5, "")) {
                        ...
                        if (f0Var == null) {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "ref page err !! " + optString5);
                        }
                    }
                    java.lang.String optString6 = jSONObject5.optString("dataJson", "");
                    if (kotlin.jvm.internal.o.b(optString6, "")) {
                        i27 = -1;
                    } else {
                        ...
                        if (f0Var5 == null) {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "ref page err !! " + optString6);
                        }
                    }
                    boolean z27 = z18;
                    linkedHashMap2.put("event_time", java.lang.Long.valueOf(jSONObject5.optLong("eventTime", -1L)));
                    linkedHashMap2.put("session_id", jSONObject5.optString(com.tencent.liteapp.storage.WxaLiteAppInfo.KEY_SESSION_ID));
                    if (!b(i17) || i27 == -1) {
                        com.tencent.mars.xlog.Log.i("MicroMsg.JsCgiReportListener", "report " + optString + ' ' + optString2 + ' ' + z27);
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.JsCgiReportListener", " wqBatch report " + optString + ' ' + optString2 + ' ' + i27);
                    }
                    z19 = z27;
                } else {
                    str = str3;
            ...
            if (!linkedHashMap.isEmpty()) {
                for (java.util.Map.Entry entry : linkedHashMap.entrySet()) {
                    ...
                    com.tencent.mars.xlog.Log.i("MicroMsg.JsCgiReportListener", str6 + "  report wq = " + intValue + " size = " + list2.size() + ' ');
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.JsCgiReportListener", "sendReportDataList get JSONArray data err! " + e17.getMessage());
        }
    }
}
