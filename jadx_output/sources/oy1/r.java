...
public final class r implements java.lang.Runnable {
    ...
    public final /* synthetic */ oy1.s f349923d;
    ...
    public final void run() {
        ...
        if (e17 != null) {
            ...
            if (currentTimeMillis > 86400000) {
                ...
                arrayList.add(nVar);
                this.f349923d.c(16, arrayList, false);
                com.tencent.mars.xlog.Log.i("MicroMsg.CgiReporter", "bizId = 16 start get config time " + currentTimeMillis + '!');
            }
        }
    }
}
