...
public final class t3 implements vd2.h5 {
    ...
    public static final vd2.t3 f435921a = new vd2.t3();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.concurrent.ConcurrentHashMap f435922b = new java.util.concurrent.ConcurrentHashMap();

    public static /* synthetic */ void k(vd2.t3 t3Var, com.tencent.mm.protocal.protobuf.FinderObject finderObject, java.lang.String str, java.lang.String str2, vd2.g5 g5Var, java.lang.String str3, long j17, vd2.g5 g5Var2, java.lang.String str4, java.lang.String str5, r45.u32 u32Var, long j18, android.content.Intent intent, java.util.Map map, java.lang.String str6, int i17, java.lang.Object obj) {
        t3Var.j(finderObject, str, str2, g5Var, str3, j17, g5Var2, str4, (i17 & 256) != 0 ? "" : str5, (i17 & 512) != 0 ? null : u32Var, (i17 & 1024) != 0 ? 0L : j18, (i17 & 2048) != 0 ? null : intent, (i17 & 4096) != 0 ? null : map, (i17 & 8192) != 0 ? null : str6);
    }
    ...
    public void a(android.content.Context context, java.lang.String str, java.lang.String str2, int i17) {
        if (context != null) {
            ...
            ((com.tencent.mm.plugin.finder.assist.i0) i95.n0.c(com.tencent.mm.plugin.finder.assist.i0.class)).Ck(context, intent);
        }
    }
    ...
    public void c(java.lang.String str, java.lang.String str2, vd2.g5 g5Var, vd2.g5 g5Var2) {
        ...
        j1Var.getClass();
        vd2.i1 i1Var = (vd2.i1) j1Var.f435771e.get(new vd2.h1(str, str2));
        if (i1Var == null || c01.id.e() - i1Var.f435762b >= j1Var.f435770d) {
            bool = null;
        } else {
            bool = java.lang.Boolean.valueOf(i1Var.f435761a.getInteger(1) == 0);
        }
        if (bool == null) {
    ...
    public void d(android.content.Context context, java.lang.String str, long j17, java.lang.String str2, java.lang.String str3, java.util.Map map, vd2.g5 g5Var, vd2.g5 g5Var2) {
        ...
        if ((map != null && map.containsKey("is_from_ad")) && kotlin.jvm.internal.o.b(map.get("is_from_ad"), java.lang.Boolean.TRUE)) {
            c0Var.f310112d = true;
        }
        if (h(j17)) {
            if (c0Var.f310112d) {
                com.tencent.mm.plugin.report.service.g0.INSTANCE.C(1837L, 1L, 1L);
            }
    ...
    public boolean e() {
        ...
        return ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.I2).getValue()).r()).intValue() == 1;
    }

    public boolean f() {
        return c92.g.f39738a.b();
    }

    public boolean g() {
        ae2.in inVar = ae2.in.f3688a;
        boolean z17 = ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.f3934z1).getValue()).r()).intValue() == 1;
        boolean z18 = ((com.tencent.mm.plugin.zero.a) ((c25.e) gm0.j1.s(c25.e.class))).b().b("FinderNearbyLiveSwitch", 1) == 1;
        boolean el6 = ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).el();
        boolean z19 = ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.f3907w1).getValue()).r()).intValue() == 1;
        com.tencent.mars.xlog.Log.i("Finder.FinderUtilApi", "isEnableNearbyLiveFriends isValidUser:" + z18 + " hasFinder:" + el6 + " isEnableNearbyLiveFriends:" + z19);
        return z17 || (z18 && el6 && z19);
    }

    public final boolean h(long j17) {
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = f435922b;
        ...
        long longValue = lVar != null ? ((java.lang.Number) lVar.f302833d).longValue() : 0L;
        ae2.in inVar = ae2.in.f3688a;
        return java.lang.System.currentTimeMillis() - longValue > ((long) (ae2.in.f3762h3 * 1000));
    }
    ...
    public void i(int i17, android.content.Intent intent, java.lang.String feedExportId, long j17, java.lang.String str, java.lang.String str2, java.lang.String reportExtraInfo) {
        kotlin.jvm.internal.o.g(feedExportId, "feedExportId");
        kotlin.jvm.internal.o.g(reportExtraInfo, "reportExtraInfo");
        ...
        f1Var.getClass();
        java.lang.String string = pk0Var.getString(0);
        if (string == null || string.length() == 0) {
            com.tencent.mars.xlog.Log.i(f1Var.f435725d, "enterLiveD encryptedObjectId invalid");
            return;
        }
        com.tencent.mars.xlog.Log.i("Finder.FinderLiveDataTransferUtil", "EncryptedLiveFeedInfo.logInfo enterLiveD, encryptedObjectId: " + pk0Var.getString(0) + ", nonceId: " + pk0Var.getString(1) + ", liveId: " + pm0.v.u(pk0Var.getLong(2)) + ", ");
        ...
        java.lang.String string2 = pk0Var.getString(1);
        c61.yb.W3(ybVar, 0L, string2 == null ? "" : string2, 65, 2, "", true, null, null, 0L, null, false, false, string, null, 0, null, 53184, null).l().K(new vd2.d1(q3Var, f1Var, context, intent2, wk0Var));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:229:0x0136, code lost:
        ...
        com.tencent.mars.xlog.Log.printErrStackTrace("Finder.FinderUtilApi", r0, "parse snsUxInfo failed", new java.lang.Object[0]);
     */
    ...
    */
    public final void j(com.tencent.mm.protocal.protobuf.FinderObject r55, java.lang.String r56, java.lang.String r57, vd2.g5 r58, java.lang.String r59, long r60, vd2.g5 r62, java.lang.String r63, java.lang.String r64, r45.u32 r65, long r66, android.content.Intent r68, java.util.Map r69, java.lang.String r70) {
        /*
    ...
    public java.lang.String l(java.lang.String str, int i17, java.lang.String str2, java.lang.String str3, java.lang.String str4) {
        ...
        if (str4 == null || str4.length() == 0) {
            ...
            jSONObject.put(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, jSONObject2);
        } else {
            jSONObject.put(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_BUFFERING_SCENE, str4);
        }
