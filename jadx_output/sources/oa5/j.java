...
public class j extends oa5.b {
    ...
    public final java.lang.ref.WeakReference f343882g;

    /* renamed from: h, reason: collision with root package name */
    public android.animation.Animator.AnimatorListener f343883h;

    /* renamed from: i, reason: collision with root package name */
    public android.view.animation.Interpolator f343884i;

    public j(android.view.View view) {
        this.f343882g = new java.lang.ref.WeakReference(view.animate());
    }
    ...
    public oa5.b i(android.animation.Animator.AnimatorListener animatorListener) {
        if (((android.view.ViewPropertyAnimator) this.f343882g.get()) != null) {
            this.f343883h = animatorListener;
        }
        return this;
    }
    ...
    public void l() {
        ...
        java.lang.ref.WeakReference weakReference = this.f343882g;
        ...
        if (this.f343859e != null) {
            ...
            android.view.animation.Interpolator interpolator = this.f343884i;
