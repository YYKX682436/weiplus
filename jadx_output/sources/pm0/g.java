...
public final class g implements android.view.View.OnLayoutChangeListener {
    ...
    public final yz5.a f356770d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f356771e;

    public g(yz5.a aVar, android.view.View view) {
        this.f356771e = view;
        this.f356770d = new pm0.f(aVar, view, this);
    }

    @Override // android.view.View.OnLayoutChangeListener
    public void onLayoutChange(android.view.View view, int i17, int i18, int i19, int i27, int i28, int i29, int i37, int i38) {
        yz5.a aVar = this.f356770d;
        android.view.View view2 = this.f356771e;
        if (view == null) {
