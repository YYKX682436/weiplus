...
public class k implements android.os.MessageQueue.IdleHandler {
    ...
    public static final java.util.Map f272353p;

    /* renamed from: q, reason: collision with root package name */
    public static final gj.k f272354q;

    /* renamed from: r, reason: collision with root package name */
    public static boolean f272355r;

    /* renamed from: m, reason: collision with root package name */
    public gj.i f272362m;

    /* renamed from: n, reason: collision with root package name */
    public android.os.Looper f272363n;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Queue f272356d = new java.util.concurrent.ConcurrentLinkedQueue();

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Queue f272357e = new java.util.concurrent.ConcurrentLinkedQueue();

    /* renamed from: f, reason: collision with root package name */
    public java.lang.String f272358f = "";

    /* renamed from: g, reason: collision with root package name */
    public long f272359g = 0;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.HashSet f272360h = new java.util.HashSet();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.Map f272361i = new java.util.HashMap();

    /* renamed from: o, reason: collision with root package name */
    public long f272364o = 0;

    static {
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = new java.util.concurrent.ConcurrentHashMap();
        f272353p = concurrentHashMap;
    ...
    public static void d(jj.d dVar) {
        ...
        synchronized (kVar.f272361i) {
            ((java.util.HashMap) kVar.f272361i).remove(dVar);
        }
    }

    public void a() {
        ((java.util.concurrent.ConcurrentLinkedQueue) this.f272357e).clear();
        this.f272359g = 0L;
    }

    public synchronized void b() {
        if (this.f272362m != null) {
            synchronized (this.f272360h) {
                this.f272360h.clear();
            }
            synchronized (this.f272361i) {
                ((java.util.HashMap) this.f272361i).clear();
            }
            oj.j.e("Matrix.LooperMonitor", "[onRelease] %s, origin printer:%s", this.f272363n.getThread().getName(), this.f272362m.f272347d);
            android.os.Looper looper = this.f272363n;
            synchronized (this) {
                looper.getQueue().removeIdleHandler(this);
                this.f272363n.setMessageLogging(this.f272362m.f272347d);
                this.f272363n = null;
                this.f272362m = null;
            }
        }
    ...
    */
    public final synchronized void c() {
        /*
            ...
            r2 = 1
            r3 = 0
            boolean r4 = gj.k.f272355r     // Catch: java.lang.Throwable -> L71 java.lang.Exception -> L73
            if (r4 != 0) goto L75
            android.os.Looper r4 = r8.f272363n     // Catch: java.lang.Throwable -> L71 java.lang.Exception -> L73
            java.lang.Class r4 = r4.getClass()     // Catch: java.lang.Throwable -> L71 java.lang.Exception -> L73
            java.lang.String r5 = "mLogging"
            android.os.Looper r6 = r8.f272363n     // Catch: java.lang.Throwable -> L71 java.lang.Exception -> L73
            ...
            gj.i r3 = r8.f272362m     // Catch: java.lang.Exception -> L6f java.lang.Throwable -> L71
            if (r4 != r3) goto L22
            if (r3 == 0) goto L22
            monitor-exit(r8)
            return
        L22:
            ...
            gj.i r5 = r8.f272362m     // Catch: java.lang.Exception -> L6f java.lang.Throwable -> L71
            ...
            gj.i r0 = r8.f272362m     // Catch: java.lang.Exception -> L6f java.lang.Throwable -> L71
        ...
        L71:
            ...
            goto Lbe
        L73:
            gj.k.f272355r = r2     // Catch: java.lang.Throwable -> L71
        L75:
            gj.i r0 = r8.f272362m     // Catch: java.lang.Throwable -> L71
            r4 = 2
            if (r0 == 0) goto L96
            ...
            android.os.Looper r7 = r8.f272363n     // Catch: java.lang.Throwable -> L71
            ...
            gj.i r7 = r8.f272362m     // Catch: java.lang.Throwable -> L71
        ...
        L96:
            android.os.Looper r0 = r8.f272363n     // Catch: java.lang.Throwable -> L71
            gj.i r5 = new gj.i     // Catch: java.lang.Throwable -> L71
            r5.<init>(r8, r3)     // Catch: java.lang.Throwable -> L71
            r8.f272362m = r5     // Catch: java.lang.Throwable -> L71
            ...
            android.os.Looper r1 = r8.f272363n     // Catch: java.lang.Throwable -> L71
    ...
    public boolean queueIdle() {
        if (android.os.SystemClock.uptimeMillis() - this.f272364o < 60000) {
            return true;
        }
        c();
        this.f272364o = android.os.SystemClock.uptimeMillis();
        return true;
    }
}
