...
public final class u3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ ns4.b4 f339663d;
    ...
    public final void onClick(android.view.View view) {
        ...
        ns4.b4 b4Var = this.f339663d;
        b4Var.f339458r = true;
        ns4.e4 e4Var = new ns4.e4(b4Var.f339441a, b4Var.f339442b, new ns4.t3(b4Var));
        b4Var.f339443c.r(true);
        e4Var.f339514b.s();
