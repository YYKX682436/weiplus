...
public final class c {
    ...
    public static final by2.c f36368a = new by2.c();
    ...
    public final java.util.List b(android.view.View view, java.lang.Integer num, yz5.p pVar) {
        ...
        if ((intValue & 2) != 0) {
            hashSet.add(java.lang.Integer.valueOf(com.tencent.mm.R.id.g1y));
            hashSet.add(java.lang.Integer.valueOf(com.tencent.mm.R.id.chy));
        }
        ...
        if (pVar != null) {
            ...
            while (it6.hasNext()) {
                pVar.invoke(this, (android.view.View) it6.next());
            }
        }
        return arrayList;
    }
