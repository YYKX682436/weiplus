...
public final class m extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ xk0.n f454995d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.graphics.Rect f454996e;
    ...
    public java.lang.Object invoke() {
        ...
        xk0.n nVar = this.f454995d;
        android.graphics.Rect safeInteractRect = nVar.G;
        android.graphics.Rect layerRect = this.f454996e;
        kotlin.jvm.internal.o.g(layerRect, "layerRect");
        kotlin.jvm.internal.o.g(safeInteractRect, "safeInteractRect");
        android.graphics.BitmapFactory.Options n07 = com.tencent.mm.sdk.platformtools.x.n0(nVar.H);
        ...
        com.tencent.mars.xlog.Log.i(nVar.F(), "createDefaultThumbBitmapSize: result:[w:" + size.getWidth() + " h:" + size.getHeight() + "], decode:[w:" + n07.outWidth + ",h:" + n07.outHeight + "], safeInteractRect:[w:" + safeInteractRect.width() + ",h:" + safeInteractRect.height() + ']');
        return size;
    }
}
