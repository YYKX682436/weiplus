...
public abstract class u {
    ...
    public static java.lang.Boolean f256279a;

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.Boolean f256280b;

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.Boolean f256281c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.lang.String f256282d;

    /* renamed from: e, reason: collision with root package name */
    public static java.lang.Boolean f256283e;

    /* renamed from: f, reason: collision with root package name */
    public static java.lang.Boolean f256284f;
    ...
    static {
        ...
        f256280b = null;
        f256281c = null;
        f256282d = "xiaomi&28, redmi&28, samsung&28, vivo&28, oppo&29, huawei&29, honor&29, oneplus&29, meizu&24, smartisan&24, other&29";
        f256283e = null;
        f256284f = null;
    }
    ...
    */
    public static android.view.ViewGroup a(android.view.Window r6, android.view.View r7) {
        ...
        L4:
            ...
            r1.<init>(r6, r2, r0)
            r1.b()
            java.lang.reflect.Field r2 = r1.f242781c
            r3 = 0
            if (r2 == 0) goto L15
            r2 = 1
            goto L16
    ...
    */
    ...
    public static boolean e() {
        boolean z17;
        if (f256283e == null) {
            f256283e = java.lang.Boolean.FALSE;
        }
        if (!f256283e.booleanValue()) {
            return false;
        }
        if (f256279a == null) {
            f256279a = new java.lang.Boolean(true);
        }
        if (f256279a.booleanValue()) {
            if (f256284f == null) {
                f256284f = java.lang.Boolean.FALSE;
            }
            if ((f256284f.booleanValue() || g()) && android.os.Build.VERSION.SDK_INT >= 26) {
                z17 = true;
                return !z17 || f();
            }
        }
    ...
    public static boolean f() {
        ...
        if (f256279a.booleanValue()) {
            ...
            if (f256284f.booleanValue() || g()) {
                if (f256281c == null) {
                    f256281c = new java.lang.Boolean(false);
                    try {
                    ...
                    if (!android.text.TextUtils.isEmpty("")) {
                        ...
                        if (f256282d.contains(lowerCase)) {
                                    ...
                                    if (split.length >= 2 && !android.text.TextUtils.isEmpty(split[1])) {
                                        try {
                                            ...
                                            if (android.os.Build.VERSION.SDK_INT >= parseInt) {
                                                f256281c = new java.lang.Boolean(true);
                                            }
    ...
    public static boolean g() {
        if (f256280b == null) {
            try {
                f256280b = new java.lang.Boolean(false);
            } catch (java.lang.Exception e17) {
                kd.c.b("MicroMsg.UIUtils", "isDarkModeUnusedOn %s", e17.toString());
                f256280b = new java.lang.Boolean(false);
            }
        }
        return f256280b.booleanValue();
    }
}
