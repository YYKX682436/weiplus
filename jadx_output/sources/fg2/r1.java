...
public final class r1 implements x4.a {
    ...
    public final android.widget.RelativeLayout f262284a;

    public r1(android.widget.RelativeLayout relativeLayout, com.tencent.mm.plugin.finder.live.view.FinderLiveGiftTextView finderLiveGiftTextView, com.tencent.mm.view.MMPAGView mMPAGView, android.widget.RelativeLayout relativeLayout2) {
        this.f262284a = relativeLayout;
    }
    ...
    public static fg2.r1 a(android.view.View view) {
        ...
        if (finderLiveGiftTextView != null) {
            ...
            if (mMPAGView != null) {
                ...
                return new fg2.r1(relativeLayout, finderLiveGiftTextView, mMPAGView, relativeLayout);
            }
        }
