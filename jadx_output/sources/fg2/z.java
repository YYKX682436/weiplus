...
public final class z implements x4.a {
    ...
    public final android.widget.RelativeLayout f262406a;

    public z(android.widget.RelativeLayout relativeLayout, com.tencent.mm.plugin.finder.live.view.FinderLiveGiftTextView finderLiveGiftTextView, android.widget.RelativeLayout relativeLayout2, com.tencent.mm.view.MMPAGView mMPAGView) {
        this.f262406a = relativeLayout;
    }
    ...
    public static fg2.z a(android.view.View view) {
        ...
        if (finderLiveGiftTextView != null) {
            ...
            if (mMPAGView != null) {
                return new fg2.z(relativeLayout, finderLiveGiftTextView, relativeLayout, mMPAGView);
            }
