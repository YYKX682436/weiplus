...
public final class c1 implements x4.a {
    ...
    public final android.widget.RelativeLayout f261958a;

    /* renamed from: b, reason: collision with root package name */
    public final androidx.constraintlayout.widget.ConstraintLayout f261959b;

    /* renamed from: c, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.live.view.FinderFixedTextView f261960c;

    /* renamed from: d, reason: collision with root package name */
    public final android.widget.LinearLayout f261961d;

    /* renamed from: e, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.live.view.FinderFixedTextView f261962e;

    /* renamed from: f, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.live.view.FinderFixedTextView f261963f;

    /* renamed from: g, reason: collision with root package name */
    public final android.widget.ImageView f261964g;

    /* renamed from: h, reason: collision with root package name */
    public final android.widget.ImageView f261965h;

    public c1(android.widget.RelativeLayout relativeLayout, androidx.constraintlayout.widget.ConstraintLayout constraintLayout, com.tencent.mm.plugin.finder.live.view.FinderFixedTextView finderFixedTextView, android.widget.LinearLayout linearLayout, android.widget.RelativeLayout relativeLayout2, com.tencent.mm.plugin.finder.live.view.FinderFixedTextView finderFixedTextView2, com.tencent.mm.plugin.finder.live.view.FinderFixedTextView finderFixedTextView3, android.widget.ImageView imageView, android.widget.ImageView imageView2) {
        this.f261958a = relativeLayout;
        this.f261959b = constraintLayout;
        this.f261960c = finderFixedTextView;
        this.f261961d = linearLayout;
        this.f261962e = finderFixedTextView2;
        this.f261963f = finderFixedTextView3;
        this.f261964g = imageView;
        this.f261965h = imageView2;
    }
                    ...
                    if (finderFixedTextView2 != null) {
                        ...
                        if (finderFixedTextView3 != null) {
                            ...
                            if (imageView != null) {
                                ...
                                if (imageView2 != null) {
                                    return new fg2.c1(relativeLayout, constraintLayout, finderFixedTextView, linearLayout, relativeLayout, finderFixedTextView2, finderFixedTextView3, imageView, imageView2);
                                }
                            }
                        }
                    }
