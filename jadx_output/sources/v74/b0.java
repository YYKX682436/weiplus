...
public final class b0 implements v74.a1 {
    ...
    public final /* synthetic */ v74.k0 f433768a;
    ...
    */
    public void a(float r10) {
        /*
            ...
            r6 = 0
            if (r5 == 0) goto L23
            androidx.recyclerview.widget.f2 r5 = r5.getAdapter()
            goto L24
        L23:
            r5 = r6
        L24:
        ...
        L2b:
            ...
            if (r5 < 0) goto L58
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs(r3, r4)
            boolean r5 = r2.f433858x
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs(r3, r4)
            if (r5 != 0) goto L70
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs(r7, r4)
            r2.f433858x = r8
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs(r7, r4)
            if (r6 == 0) goto L4e
            r6.z(r8)
        L4e:
            r3 = 2
        ...
        L70:
            ...
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs(r3, r4)
            com.tencent.mm.view.MMPAGView r5 = r2.f433897g
            if (r5 == 0) goto Lcf
            int r6 = r2.f433898h
            if (r6 == 0) goto Lcb
            int r2 = r2.f433899i
