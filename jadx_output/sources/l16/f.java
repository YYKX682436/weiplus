...
public final class f extends p16.p implements p16.i0 {
    ...
    */
    public p16.g0 I3(p16.h r2, p16.l r3) {
        /*
            r1 = this;
            p16.j0 r0 = l16.g.f315031n     // Catch: java.lang.Throwable -> Le p16.z -> L10
    ...
    public l16.g c() {
        ...
        int i17 = this.f315027e;
        int i18 = (i17 & 1) != 1 ? 0 : 1;
        gVar.f315034f = this.f315028f;
        if ((i17 & 2) == 2) {
            i18 |= 2;
        }
        gVar.f315035g = this.f315029g;
        gVar.f315033e = i18;
        return gVar;
    }
    ...
    public l16.f d(l16.g gVar) {
        ...
        if ((i17 & 2) == 2) {
            int i19 = gVar.f315035g;
            this.f315027e = 2 | this.f315027e;
            this.f315029g = i19;
        }
        this.f351337d = this.f351337d.e(gVar.f315032d);
        return this;
    }
}
