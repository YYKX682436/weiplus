...
public final class x0 extends com.tencent.mm.plugin.finder.live.widget.e0 implements android.view.View.OnClickListener {
    public final qo0.c H;
    public final com.tencent.mm.plugin.finder.live.plugin.l I;

    /* renamed from: J, reason: collision with root package name */
    public final ni2.w2 f337502J;
    ...
    public android.view.View f337503p0;

    /* renamed from: x0, reason: collision with root package name */
    public android.view.View f337504x0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x0(android.content.Context context, qo0.c statusMonitor, com.tencent.mm.plugin.finder.live.plugin.l pluginLayout, ni2.w2 service, zh2.c cVar, yz5.q settingInvoke) {
    ...
    public int A() {
        return com.tencent.mm.R.layout.drz;
    }

    @Override // com.tencent.mm.plugin.finder.live.widget.e0
    public java.lang.String L() {
        java.lang.String string = this.f118183e.getResources().getString(com.tencent.mm.R.string.mlh);
    ...
    public void N(android.view.View rootView) {
        ...
        android.view.View findViewById = rootView.findViewById(com.tencent.mm.R.id.pzc);
        kotlin.jvm.internal.o.f(findViewById, "findViewById(...)");
        this.T = findViewById;
        android.view.View findViewById2 = rootView.findViewById(com.tencent.mm.R.id.rzp);
        kotlin.jvm.internal.o.f(findViewById2, "findViewById(...)");
        this.V = findViewById2;
        android.view.View findViewById3 = rootView.findViewById(com.tencent.mm.R.id.rzr);
        kotlin.jvm.internal.o.f(findViewById3, "findViewById(...)");
        this.X = findViewById3;
        android.view.View findViewById4 = rootView.findViewById(com.tencent.mm.R.id.rxs);
        kotlin.jvm.internal.o.f(findViewById4, "findViewById(...)");
        this.Y = (android.widget.TextView) findViewById4;
        android.view.View findViewById5 = rootView.findViewById(com.tencent.mm.R.id.rxt);
        kotlin.jvm.internal.o.f(findViewById5, "findViewById(...)");
        this.Z = (android.widget.TextView) findViewById5;
        android.view.View findViewById6 = rootView.findViewById(com.tencent.mm.R.id.bzi);
        kotlin.jvm.internal.o.f(findViewById6, "findViewById(...)");
        this.f337503p0 = findViewById6;
        android.view.View findViewById7 = rootView.findViewById(com.tencent.mm.R.id.s59);
        kotlin.jvm.internal.o.f(findViewById7, "findViewById(...)");
        this.U = findViewById7;
        android.view.View findViewById8 = rootView.findViewById(com.tencent.mm.R.id.s5a);
        kotlin.jvm.internal.o.f(findViewById8, "findViewById(...)");
        this.W = findViewById8;
        android.view.View findViewById9 = rootView.findViewById(com.tencent.mm.R.id.s4a);
        kotlin.jvm.internal.o.f(findViewById9, "findViewById(...)");
        this.f337504x0 = findViewById9;
        android.view.View view = this.T;
        if (view == null) {
            kotlin.jvm.internal.o.o("normalModeLayout");
            throw null;
        }
        ...
        android.view.View view3 = this.f337503p0;
        if (view3 == null) {
            kotlin.jvm.internal.o.o("closeLayout");
            throw null;
        }
        view3.setOnClickListener(this);
        android.widget.TextView textView = this.Y;
        if (textView == null) {
            kotlin.jvm.internal.o.o("payModSettingText");
            throw null;
        }
    ...
    public void U() {
        ...
        if (view == null) {
            kotlin.jvm.internal.o.o("normalSelectIcon");
            throw null;
        }
        if (view.getVisibility() != 0) {
            android.view.View view2 = this.W;
            if (view2 == null) {
                kotlin.jvm.internal.o.o("payModeSelectIcon");
                throw null;
            }
            if (view2.getVisibility() == 0) {
                i17 = 2;
            } else {
                android.view.View view3 = this.f337504x0;
                if (view3 == null) {
                    kotlin.jvm.internal.o.o("closeSelectIcon");
                    throw null;
                }
                view3.getVisibility();
                i17 = 0;
        ...
        d3Var2.getClass();
        boolean z17 = d3Var2.f229937b;
        df2.g3 g3Var = d3Var2.f229936a;
        ((mm2.o4) g3Var.business(mm2.o4.class)).U.f377132g = kf5Var2;
        com.tencent.mm.plugin.finder.live.util.y.d(g3Var, null, null, new df2.f3(g3Var, i18, z17, t0Var, null), 3, null);
    }
    ...
    public final void g0() {
        ...
        android.view.View view4 = this.f337504x0;
        if (view4 == null) {
            kotlin.jvm.internal.o.o("closeSelectIcon");
            throw null;
        }
    ...
    public final void h0() {
        int i17 = this.M;
        java.util.regex.Pattern pattern = pm0.v.f356802a;
        this.M = i17 | 64 | com.tencent.thumbplayer.core.common.TPMediaCodecProfileLevel.HEVCMainTierLevel62;
        android.view.View view = this.U;
        if (view == null) {
            kotlin.jvm.internal.o.o("normalSelectIcon");
            throw null;
        ...
        if (kf5Var != null) {
            ...
            if (textView != null) {
                textView.setText(this.f118183e.getResources().getString(com.tencent.mm.R.string.mmw, java.lang.Integer.valueOf(kf5Var.f378658f), java.lang.Integer.valueOf(kf5Var.f378656d)));
            } else {
                kotlin.jvm.internal.o.o("paySettingText");
                throw null;
            }
        }
    }
    ...
    public final void j0() {
        ...
        pi2.q0 q0Var = (pi2.q0) ((jz5.n) this.S).getValue();
        r45.kf5 kf5Var = ((mm2.o4) ((df2.d3) this.f337502J).a().a(mm2.o4.class)).U.f377132g;
        q0Var.getClass();
        com.tencent.mm.plugin.finder.live.widget.e0.W(q0Var, null, false, 0, 7, null);
        if (kf5Var != null) {
            int i17 = kf5Var.f378656d;
            java.lang.String string = q0Var.f118183e.getResources().getString(com.tencent.mm.R.string.lzf, java.lang.Integer.valueOf(kf5Var.f378656d));
            kotlin.jvm.internal.o.f(string, "getString(...)");
            q0Var.j0(i17, string);
            r45.p52 p52Var = ((mm2.g5) q0Var.H.a(mm2.g5.class)).f329090g;
            if (p52Var != null && (list = p52Var.getList(1)) != null) {
                synchronized (list) {
                    ...
                    while (true) {
                        if (!it.hasNext()) {
                            ...
                            obj4 = it.next();
                            if (((r45.jf5) obj4).getInteger(0) == kf5Var.f378657e) {
                                break;
                            }
                        }
                    }
                ...
                if (jf5Var != null) {
                    java.lang.String string2 = jf5Var.getString(1);
                    if (string2 == null) {
                        string2 = "";
                    }
                    q0Var.g0(jf5Var, string2);
                }
            }
            int i18 = kf5Var.f378658f;
            q0Var.h0(i18, java.lang.String.valueOf(i18));
            int i19 = kf5Var.f378660h;
            ...
            m1Var.f262143e.setCheck(kf5Var.f378659g);
            fg2.m1 m1Var2 = q0Var.X;
            if (m1Var2 == null) {
                kotlin.jvm.internal.o.o("uiBinding");
                throw null;
            }
            m1Var2.f262156r.setVisibility(kf5Var.f378659g ? 0 : 8);
            boolean z17 = kf5Var.f378662m;
            xh2.c cVar = (xh2.c) ((mm2.o4) q0Var.I.g().a(mm2.o4.class)).A.getValue();
            q0Var.f0(z17, (cVar == null || (linkedList = cVar.f454531a) == null || (aVar = (xh2.a) kz5.n0.Z(linkedList)) == null) ? "" : aVar.b());
        ...
        if (f0Var == null) {
            ...
            m1Var3.f262143e.setCheck(false);
            fg2.m1 m1Var4 = q0Var.X;
            if (m1Var4 == null) {
                kotlin.jvm.internal.o.o("uiBinding");
                throw null;
            }
            m1Var4.f262156r.setVisibility(8);
            r45.p52 p52Var2 = ((mm2.g5) q0Var.H.a(mm2.g5.class)).f329090g;
            if (p52Var2 != null) {
                java.util.LinkedList list2 = p52Var2.getList(0);
                kotlin.jvm.internal.o.f(list2, "getMic_duration_list(...)");
                ...
                if (num2 == null) {
                    java.util.LinkedList list3 = p52Var2.getList(0);
                    kotlin.jvm.internal.o.f(list3, "getMic_duration_list(...)");
                    num2 = (java.lang.Integer) kz5.n0.Z(list3);
                }
                if (num2 != null) {
                    int intValue = num2.intValue();
                    java.lang.String string3 = q0Var.f118183e.getResources().getString(com.tencent.mm.R.string.lzf, java.lang.Integer.valueOf(intValue));
                    kotlin.jvm.internal.o.f(string3, "getString(...)");
                    q0Var.j0(intValue, string3);
                }
                java.util.LinkedList list4 = p52Var2.getList(2);
                kotlin.jvm.internal.o.f(list4, "getPurchase_mic_price_list(...)");
                ...
                if (num4 == null) {
                    java.util.LinkedList list5 = p52Var2.getList(2);
                    kotlin.jvm.internal.o.f(list5, "getPurchase_mic_price_list(...)");
                    num4 = (java.lang.Integer) kz5.n0.Z(list5);
                }
                if (num4 != null) {
                    int intValue2 = num4.intValue();
                    q0Var.h0(intValue2, java.lang.String.valueOf(intValue2));
                }
                java.util.LinkedList list6 = p52Var2.getList(1);
                kotlin.jvm.internal.o.f(list6, "getMic_break_list(...)");
                java.util.Iterator it8 = list6.iterator();
                while (true) {
                    if (!it8.hasNext()) {
                        obj3 = null;
                        break;
                        ...
                        obj3 = it8.next();
                        if (((r45.jf5) obj3).getInteger(0) == 2) {
                            break;
                        }
                    }
                }
                ...
                if (jf5Var2 != null) {
                    java.lang.String string4 = jf5Var2.getString(1);
                    if (string4 == null) {
                        string4 = "";
                    }
                    q0Var.g0(jf5Var2, string4);
                }
            }
        }
        q0Var.e0();
        if (((mm2.g5) q0Var.H.a(mm2.g5.class)).f329089f == 0.0d) {
            fg2.m1 m1Var5 = q0Var.X;
            if (m1Var5 == null) {
                kotlin.jvm.internal.o.o("uiBinding");
                throw null;
            }
            m1Var5.f262142d.setVisibility(0);
            fg2.m1 m1Var6 = q0Var.X;
            if (m1Var6 == null) {
                kotlin.jvm.internal.o.o("uiBinding");
                throw null;
            }
            m1Var6.f262158t.setVisibility(8);
        } else {
            ...
            m1Var7.f262142d.setVisibility(8);
            fg2.m1 m1Var8 = q0Var.X;
            if (m1Var8 == null) {
                kotlin.jvm.internal.o.o("uiBinding");
                throw null;
            }
            m1Var8.f262158t.setVisibility(0);
        }
        android.view.View G = q0Var.G();
        if (G == null) {
            return;
        }
        int i27 = ((mm2.g5) q0Var.H.a(mm2.g5.class)).f329091h != null ? 0 : 8;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
