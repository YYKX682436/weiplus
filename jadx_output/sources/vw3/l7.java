...
public final class l7 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.RepairerXLogUI f441027d;

    public l7(com.tencent.mm.plugin.repairer.ui.RepairerXLogUI repairerXLogUI) {
        this.f441027d = repairerXLogUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.repairer.ui.RepairerXLogUI repairerXLogUI = this.f441027d;
        repairerXLogUI.d = com.tencent.mm.ui.widget.dialog.u3.f(repairerXLogUI, "正在处理...", true, 0, null);
        ((ku5.t0) ku5.t0.f312615d).g(new vw3.k7(this.f441027d));
