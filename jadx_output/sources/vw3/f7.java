...
public final class f7 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.RepairerXLogUI f440955d;

    public f7(com.tencent.mm.plugin.repairer.ui.RepairerXLogUI repairerXLogUI) {
        this.f440955d = repairerXLogUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.content.Intent intent = new android.content.Intent((android.content.Context) this.f440955d, (java.lang.Class<?>) com.tencent.mm.plugin.repairer.ui.RepairerFileListUI.class);
        intent.putExtra(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_TITLE, "XLog");
        intent.putExtra("dirPath", lp0.b.g0());
        com.tencent.mm.plugin.repairer.ui.RepairerXLogUI repairerXLogUI = this.f440955d;
