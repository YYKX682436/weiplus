...
public final class q1 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.RepairerFolderUI f441079d;

    public q1(com.tencent.mm.plugin.repairer.ui.RepairerFolderUI repairerFolderUI) {
        this.f441079d = repairerFolderUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.content.Intent intent = new android.content.Intent((android.content.Context) this.f441079d, (java.lang.Class<?>) com.tencent.mm.plugin.repairer.ui.RepairerFileListUI.class);
        intent.putExtra(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_TITLE, "聊天记录消息");
        intent.putExtra("dirPath", "wcf://record/");
        com.tencent.mm.plugin.repairer.ui.RepairerFolderUI repairerFolderUI = this.f441079d;
