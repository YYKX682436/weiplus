...
public class i implements java.io.Closeable {
    ...
    public void a(java.nio.ByteBuffer byteBuffer, long j17, int i17) {
        ...
        long j18 = 0;
        while (j18 < i17) {
            int read = this.f1638d.read(byteBuffer, j17 + j18);
            if (read == -1) {
    ...
    public java.util.List c() {
        ...
        long j17;
        a56.c a17;
        java.nio.channels.FileChannel fileChannel = this.f1638d;
        ...
        do {
            ...
            long j28 = a17.f1623a;
            if (j28 == 1) {
                arrayList2.add(java.lang.Long.valueOf(a17.f1624b));
            } else if (j28 == 5) {
                j27 = a17.f1624b;
            }
            i17++;
        ...
        for (long j29 = 0; j29 < j18; j29++) {
            ...
            if (b18.f1631a == 1) {
                long j37 = b18.f1633c;
                if (j37 <= j27 && j27 <= b18.f1634d + j37) {
                    long j38 = (j27 - j37) + b18.f1632b;
