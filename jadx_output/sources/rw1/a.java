...
public final class a implements hw1.c {
    ...
    public final java.lang.ThreadLocal f400582a = new java.lang.ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    public final boolean f400583b = true;
    ...
    */
    public java.lang.Object c(rw1.b r23, kotlin.coroutines.Continuation r24) {
        /*
    ...
    */
    public final void e(java.nio.ByteBuffer r16, rw1.b r17) {
        /*
            ...
            r1 = r17
            r16.clear()
            pw1.g r10 = r1.f400585b
            qw1.e r11 = r1.f400586c
            java.util.concurrent.locks.ReentrantLock r12 = r11.f367087e
            r12.lock()
            boolean r1 = r11.f367086d     // Catch: java.lang.Throwable -> L95
            r13 = 0
            if (r1 == 0) goto L1e
            qw1.d r1 = r11.f367083a     // Catch: java.lang.Throwable -> L95
            boolean r2 = r1.f367081b     // Catch: java.lang.Throwable -> L95
            if (r2 == 0) goto L1e
            is0.c r1 = r1.f367080a     // Catch: java.lang.Throwable -> L95
            goto L1f
        L1e:
            r1 = r13
        L1f:
            if (r1 == 0) goto L31
            int r2 = r10.f358676a     // Catch: java.lang.Throwable -> L95
            int r3 = r10.f358677b     // Catch: java.lang.Throwable -> L95
        ...
        L31:
            int r1 = r10.f358676a     // Catch: java.lang.Throwable -> L95
            int r14 = r10.f358677b
            int r1 = r1 * r14
            r0.position(r1)     // Catch: java.lang.Throwable -> L95
            boolean r1 = r11.f367086d     // Catch: java.lang.Throwable -> L95
            if (r1 == 0) goto L46
            qw1.d r1 = r11.f367084b     // Catch: java.lang.Throwable -> L95
            boolean r2 = r1.f367081b     // Catch: java.lang.Throwable -> L95
            if (r2 == 0) goto L46
            is0.c r1 = r1.f367080a     // Catch: java.lang.Throwable -> L95
            goto L47
        ...
        L5b:
            ...
            boolean r1 = r11.f367086d     // Catch: java.lang.Throwable -> L95
            if (r1 == 0) goto L71
            qw1.d r1 = r11.f367085c     // Catch: java.lang.Throwable -> L95
            boolean r2 = r1.f367081b     // Catch: java.lang.Throwable -> L95
            if (r2 == 0) goto L71
            is0.c r1 = r1.f367080a     // Catch: java.lang.Throwable -> L95
            goto L72
        ...
        L84:
            ...
            r1 = r15
            boolean r0 = r1.f400583b     // Catch: java.lang.Throwable -> L93
            if (r0 == 0) goto L8f
