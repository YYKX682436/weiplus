...
public final class zc implements java.lang.Runnable {
    ...
    public void run() {
        ...
        if (eVar != null) {
            ...
            if (!z17 && j17 == j18) {
                com.tencent.mars.xlog.Log.i("Finder.FinderLiveService", "keepAlive manual recovery liveId:" + j17);
                pm0.z.b(xy2.b.f458155b, "liveKeepAliveBreak_manualRecovery", false, null, null, false, false, new dk2.yc(j17), 60, null);
                efVar.B(0L);
                return;
            }
        }
