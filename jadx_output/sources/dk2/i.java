...
public final class i {
    ...
    public static final dk2.i f233596a = new dk2.i();
    ...
    public final int a(java.lang.String str, int i17) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.i("Finder.FinderBannerUtil", "parse color fail " + str);
            return i17;
        }
    }
    ...
    public final r45.bm1 b(java.lang.String str) {
        ...
        if (android.text.TextUtils.isEmpty(str)) {
            com.tencent.mars.xlog.Log.e("Finder.FinderBannerUtil", "parseBannerExtInfo bannerExtInfo is empty");
            return null;
        }
        try {
            jSONObject = new org.json.JSONObject(str);
            jSONObject.toString();
            optString = jSONObject.optString(dm.i4.COL_ID);
            ...
            optInt3 = jSONObject.optInt(com.tencent.mm.opensdk.constants.ConstantsAPI.WXWebPage.KEY_ACTIVITY_ID, 0);
        ...
        try {
            ...
            e = e18;
            com.tencent.mars.xlog.Log.printErrStackTrace(str2, e, "parseBannerExtInfo fail", new java.lang.Object[0]);
            return null;
        }
    }
}
