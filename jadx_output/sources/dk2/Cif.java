...
public final class Cif {
    ...
    /* renamed from: a */
    public static final dk2.Cif f233626a = new dk2.Cif();

    /* renamed from: b */
    public static final kk.l f233627b = new kk.l(10);
    ...
    public final void a(qo0.c statusMonitor, long j17, dk2.hf scene, boolean z17) {
        ...
        sb6.append(dVar2 != null ? dVar2.f328942f : false);
        com.tencent.mars.xlog.Log.i("Finder.FinderLiveShowFollowBtnLogic", sb6.toString());
        if (z17 && !N6) {
            qo0.b bVar = qo0.b.U;
        ...
        if (lVar.k(java.lang.Long.valueOf(j17))) {
            com.tencent.mars.xlog.Log.i("Finder.FinderLiveShowFollowBtnLogic", "#checkTriggerShow out");
            return;
        }
        com.tencent.mars.xlog.Log.i("Finder.FinderLiveShowFollowBtnLogic", "#checkTriggerShow come in");
