...
public final class r9 {
    ...
    public static final dk2.r9 f234025a = new dk2.r9();
    ...
    public static final void j(dk2.x4 x4Var, android.content.Intent intent, android.content.Context context) {
        int i17 = x4Var.f234319m;
        if (i17 == 1 || i17 == 0) {
            intent.setClass(context, zl2.r4.f473950a.o0(context));
            ...
            intent.setClass(context, zl2.r4.f473950a.n0(context));
            ...
            com.tencent.mars.xlog.Log.i("Finder.LiveJumpChecker", "config.secondaryDeviceFlag is not legal: " + x4Var.f234319m);
        }
        android.app.Activity activity = context instanceof android.app.Activity ? (android.app.Activity) context : null;
        if (activity != null) {
            gk2.e eVar = gk2.e.f272471n;
            activity.overridePendingTransition(eVar != null && ((mm2.c1) eVar.a(mm2.c1.class)).a8() ? com.tencent.mm.R.anim.f477728p : com.tencent.mm.R.anim.f477876e0, com.tencent.mm.R.anim.f477728p);
        }
    }
    ...
    public final void b(android.content.Intent intent) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.LiveJumpChecker", "checkFluentEnterCountDown feedId: " + longExtra + " isLaunchWithFluentAnimate: " + booleanExtra);
        if (!booleanExtra || longExtra == 0) {
            return;
        }
        ig2.m mVar = ig2.m.f291393a;
        com.tencent.mars.xlog.Log.i("FinderFluentSwitchManager", "startEnterLiveCountDown feedId: " + longExtra);
        java.util.HashMap hashMap = ig2.m.f291394b;
        if (hashMap.get(java.lang.Long.valueOf(longExtra)) != null && (r2Var = (kotlinx.coroutines.r2) hashMap.get(java.lang.Long.valueOf(longExtra))) != null) {
            kotlinx.coroutines.p2.a(r2Var, null, 1, null);
        }
        hashMap.put(java.lang.Long.valueOf(longExtra), kotlinx.coroutines.l.d(kotlinx.coroutines.i2.f310477d, null, null, new ig2.l(longExtra, null), 3, null));
    }
    ...
    */
    public final boolean c() {
        ...
        L53:
            ...
            boolean r0 = com.tencent.mars.comm.NetStatusUtil.isConnected(r0)
            if (r0 != 0) goto L65
            goto L66
        L65:
            r1 = r5
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0068, code lost:
        ...
        if ((sn0.b.f409964e2 != null) != false) goto L37;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final dk2.r9 e(android.content.Context r9, boolean r10, yz5.l r11) {
        ...
        Lf:
            ...
            androidx.lifecycle.c1 r4 = r0.business(r4)
            mm2.e1 r4 = (mm2.e1) r4
        ...
        L30:
            ...
            if (r0 == 0) goto L3d
            java.lang.String r10 = r0.f328852o
            goto L3e
        L3d:
            r10 = r1
        L3e:
            boolean r9 = com.tencent.mm.sdk.platformtools.t8.D0(r9, r10)
    ...
    public final void h(android.content.Context context, dk2.x4 x4Var, java.lang.String str, java.lang.String str2, android.content.Intent intent) {
        ...
        intent.putExtra("KEY_PARAMS_NOTICE", h32Var != null ? h32Var.toByteArray() : null);
        r45.uy1 uy1Var = x4Var.f234308b;
        intent.putExtra("KEY_PARAMS_LIVE_TASK_INFO", uy1Var != null ? uy1Var.toByteArray() : null);
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).Cj(str, intent);
        }
        intent.putExtra("key_click_tab_context_id", str2);
        java.util.LinkedList linkedList = x4Var.f234311e;
        if (linkedList != null) {
        ...
        intent.putExtra("KEY_PARAMS_VISIBLE_ROOM_MAX_COUNT", x4Var.f234312f);
        intent.putExtra("KEY_PARAMS_VISIBLE_USER_MAX_COUNT", x4Var.f234313g);
        intent.putExtra("KEY_PARAMS_LUCKY_MONEY_CONFIG", x4Var.f234314h);
        int intExtra = intent.getIntExtra("KEY_PARAMS_SOURCE_TYPE", -1);
        com.tencent.mars.xlog.Log.i("Finder.LiveJumpChecker", "[gotoAnchorLive] config.secondaryDeviceFlag" + x4Var.f234319m + ", sourceType:" + intExtra);
        if (intExtra == 5) {
            intent.setClass(context, zl2.r4.f473950a.n0(context));
            java.util.ArrayList arrayList2 = new java.util.ArrayList();
            arrayList2.add(intent);
        ...
        com.tencent.mm.live.api.LiveConfig liveConfig = (com.tencent.mm.live.api.LiveConfig) x4Var.f234318l.get(0);
        if (liveConfig != null && x4Var.f234319m == -1) {
            com.tencent.mm.plugin.finder.storage.FinderItem h17 = bu2.j.f24534a.h(liveConfig.f68549s);
        ...
        com.tencent.mm.live.api.LiveConfig liveConfig2 = (com.tencent.mm.live.api.LiveConfig) x4Var.f234318l.get(0);
        if (liveConfig2 != null) {
            ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).ml(liveConfig2.f68549s, liveConfig2.f68556z, 0, false, true, "", new dk2.j9(x4Var, liveConfig2, intent, context));
        }
    }
    ...
    public final void k(android.content.Context context, dk2.x4 x4Var, java.lang.String str, java.lang.String str2, android.content.Intent intent, boolean z17) {
        ...
        boolean z18 = c61.cc.f38928a;
        com.tencent.mars.xlog.Log.i("Finder.LiveJumpChecker", "gotoVisitLive isAuthorizeFromAnim=" + z18);
