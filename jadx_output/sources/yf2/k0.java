...
public final class k0 extends android.text.style.ClickableSpan {
    ...
    public final /* synthetic */ android.content.Context f461735d;

    public k0(android.content.Context context) {
        this.f461735d = context;
    }
    ...
    public void onClick(android.view.View widget) {
        ...
        j45.l.j(this.f461735d, "webview", ".ui.tools.WebViewUI", intent, null);
    ...
    public void updateDrawState(android.text.TextPaint ds6) {
        ...
        ds6.setColor(this.f461735d.getResources().getColor(com.tencent.mm.R.color.Link_100));
