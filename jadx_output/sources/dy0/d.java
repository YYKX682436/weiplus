...
public final class d implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.mj_publisher.finder.widgets.ComposingBottomToolBar f244551d;

    public d(com.tencent.mm.mj_publisher.finder.widgets.ComposingBottomToolBar composingBottomToolBar) {
        this.f244551d = composingBottomToolBar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        dy0.j jVar = this.f244551d.f69681n;
        if (jVar != null) {
            kotlin.jvm.internal.o.d(view);
            jVar.a(view, dy0.a.f244539d);
        }
