...
public class i extends ce1.c {
    ...
    public static final java.lang.String NAME = "rechargeTrafficCard";
    ...
    public void C(com.tencent.mm.plugin.appbrand.jsapi.d0 d0Var, int i17, android.os.IInterface iInterface, org.json.JSONObject jSONObject) {
        if (jSONObject == null) {
            ...
            D(5, dVar.f40771a, "deviceData is null");
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiRechargeTrafficCard", "deviceData is null, invoke fail: [%s] ! with appId[%s] callbackId[%s]", dVar.f40772b, d0Var.getAppId(), java.lang.Integer.valueOf(i17));
            return;
        }
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiRechargeTrafficCard", "rechargeCardString: [%s]! params: [%s]", p17, new org.json.JSONObject(hashMap2).toString());
            if (!android.text.TextUtils.isEmpty(p17)) {
                jSONObject2 = new org.json.JSONObject(p17);
            }
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiRechargeTrafficCard", "call remote interface fail: [%s] ! ", e17.getMessage());
        }
        ...
        if (jSONObject2 == null) {
            ...
            D(5, dVar2.f40771a, "call remote interface exception");
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiRechargeTrafficCard", "call remote interface exception.");
            return;
        }
        ...
        D(5, a17.f40771a, str);
        com.tencent.mars.xlog.Log.e("MicroMsg.JsApiRechargeTrafficCard", "Return code from remote interface! with RetCode rechargeCard[%s] ", java.lang.Integer.valueOf(optInt));
    }
}
