...
public final class z implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.content.Context f335903d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f335904e;

    public z(android.content.Context context, java.lang.String str) {
        this.f335903d = context;
        this.f335904e = str;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        j45.l.j(this.f335903d, "webview", ".ui.tools.WebViewUI", new android.content.Intent().putExtra("rawUrl", this.f335904e).putExtra("forceHideShare", true), null);
