...
public abstract class e {
    ...
    public static final java.util.Map f321299a;

    /* renamed from: b, reason: collision with root package name */
    public static final lt5.f[] f321300b;

    /* renamed from: c, reason: collision with root package name */
    public static final boolean[] f321301c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.lang.String f321302d;

    static {
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = new java.util.concurrent.ConcurrentHashMap();
        f321299a = concurrentHashMap;
        f321300b = new lt5.f[]{null};
        f321301c = new boolean[]{false};
        ...
        try {
            ...
            f321302d = substring;
            com.tencent.stubs.logger.Log.i("MicroMsg.MsaIdManager", "start %s", substring);
    ...
    public static synchronized void a(android.content.Context context) {
        ...
        synchronized (lt5.e.class) {
            com.tencent.stubs.logger.Log.i("MicroMsg.MsaIdManager", "[+] asyncInit called.");
            boolean[] zArr = f321301c;
            synchronized (zArr) {
                synchronized (zArr) {
                    z17 = zArr[0];
                }
            ...
            if (z17) {
                ...
                com.tencent.stubs.logger.Log.w("MicroMsg.MsaIdManager", "[!] Initializing before, ignore this invocation. call_stack: %s", new com.tencent.mm.sdk.platformtools.z3());
                return;
            }
            synchronized (zArr) {
                zArr[0] = true;
            }
            lt5.d dVar = (lt5.d) ((java.util.concurrent.ConcurrentHashMap) f321299a).get(b(context));
            if (dVar != null) {
                ((ku5.t0) ku5.t0.f312615d).j(new lt5.c(dVar, context), "sn-msa-init-waiter");
                return;
            }
            com.tencent.stubs.logger.Log.e("MicroMsg.MsaIdManager", "[-] asyncInit, Unsupport device.");
            lt5.f[] fVarArr = f321300b;
    ...
    public static java.lang.String b(android.content.Context context) {
        ...
        try {
            ...
            com.tencent.stubs.logger.Log.i("TuringMSa", "support = " + z17);
        } catch (java.lang.Throwable unused) {
            z17 = false;
        }
        if (z17) {
        ...
        try {
            ...
            com.tencent.stubs.logger.Log.e("TuringMSa", th6, "error");
            str = null;
        }
        ...
        java.util.Map map = f321299a;
        java.lang.String str2 = f321302d;
    ...
    public static synchronized lt5.f c(android.content.Context context) {
        ...
        synchronized (lt5.e.class) {
            ...
            synchronized (fVarArr) {
                ...
                if (fVar3 != null && (i17 = fVar3.f321304b) != -12) {
                    com.tencent.stubs.logger.Log.i("MicroMsg.MsaIdManager", "[+] getOAID, hit cache, errcode: %s, oaid: %s", java.lang.Integer.valueOf(i17), fVarArr[0].f321303a);
                    return fVarArr[0];
                }
                boolean[] zArr = f321301c;
                synchronized (zArr) {
                ...
                if (z17) {
                    com.tencent.stubs.logger.Log.w("MicroMsg.MsaIdManager", "[!] still initializing, skip rest logic.");
                    synchronized (fVarArr) {
                        a18 = lt5.f.a(-12);
                        fVarArr[0] = a18;
                    }
                ...
                if (dVar == null) {
                    synchronized (fVarArr) {
                        fVarArr[0] = lt5.f.a(-10);
                        com.tencent.stubs.logger.Log.w("MicroMsg.MsaIdManager", "[!] getOAID, unsupported device.");
                        fVar = fVarArr[0];
                    }
                    return fVar;
                }
                int i18 = dVar.f321298b;
                if (i18 > 5) {
                    synchronized (fVarArr) {
                        fVarArr[0] = lt5.f.a(-13);
                        com.tencent.stubs.logger.Log.w("MicroMsg.MsaIdManager", "[!] getOAID, too many attempts.");
                        fVar2 = fVarArr[0];
                    }
                    return fVar2;
                }
                dVar.f321298b = i18 + 1;
                com.tencent.stubs.logger.Log.w("MicroMsg.MsaIdManager", "[!] getOAID, no cached res, trigger async init now.");
                a(context);
                synchronized (fVarArr) {
                    a17 = lt5.f.a(-12);
                    fVarArr[0] = a17;
