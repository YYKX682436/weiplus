...
public class PlatformViewsController implements io.flutter.plugin.platform.PlatformViewsAccessibilityDelegate {
    private static final java.lang.String TAG = "PlatformViewsController";
    private static java.lang.Class[] VIEW_TYPES_REQUIRE_NON_TLHC = {android.view.SurfaceView.class};
    ...
    io.flutter.view.TextureRegistry textureRegistry;
    ...
    private final io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewsHandler channelHandler = new io.flutter.plugin.platform.PlatformViewsController.AnonymousClass1();
    ...
    public class AnonymousClass1 implements io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewsHandler {
        ...
        public /* synthetic */ void lambda$resize$0(io.flutter.plugin.platform.VirtualDisplayController virtualDisplayController, float f17, io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
            io.flutter.plugin.platform.PlatformViewsController.this.unlockInputConnection(virtualDisplayController);
            if (io.flutter.plugin.platform.PlatformViewsController.this.context != null) {
                f17 = io.flutter.plugin.platform.PlatformViewsController.this.getDisplayDensity();
            }
            platformViewBufferResized.run(new io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewBufferSize(io.flutter.plugin.platform.PlatformViewsController.this.toLogicalPixels(virtualDisplayController.getRenderTargetWidth(), f17), io.flutter.plugin.platform.PlatformViewsController.this.toLogicalPixels(virtualDisplayController.getRenderTargetHeight(), f17)));
        }

        @Override // io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewsHandler
        public void clearFocus(int i17) {
            android.view.View view;
            if (io.flutter.plugin.platform.PlatformViewsController.this.usesVirtualDisplay(i17)) {
                view = io.flutter.plugin.platform.PlatformViewsController.this.vdControllers.get(java.lang.Integer.valueOf(i17)).getView();
            } else {
                io.flutter.plugin.platform.PlatformView platformView = (io.flutter.plugin.platform.PlatformView) io.flutter.plugin.platform.PlatformViewsController.this.platformViews.get(i17);
                if (platformView == null) {
                    io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Clearing focus on an unknown view with id: " + i17);
                    return;
                }
            ...
            io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Clearing focus on a null view with id: " + i17);
        }
        ...
        public void createForPlatformViewLayer(io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
            io.flutter.plugin.platform.PlatformViewsController.this.enforceMinimumAndroidApiVersion(19);
            io.flutter.plugin.platform.PlatformViewsController.this.ensureValidRequest(platformViewCreationRequest);
            io.flutter.plugin.platform.PlatformViewsController.this.throwIfHCPPEnabled();
            io.flutter.plugin.platform.PlatformViewsController.this.configureForHybridComposition(io.flutter.plugin.platform.PlatformViewsController.this.createPlatformView(platformViewCreationRequest, false), platformViewCreationRequest);
        }
        ...
        public long createForTextureLayer(io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
            ...
            if (io.flutter.plugin.platform.PlatformViewsController.this.viewWrappers.get(i17) != null) {
                throw new java.lang.IllegalStateException("Trying to create an already created platform view, view id: " + i17);
            }
            io.flutter.plugin.platform.PlatformViewsController platformViewsController = io.flutter.plugin.platform.PlatformViewsController.this;
            ...
            io.flutter.plugin.platform.PlatformView createPlatformView = io.flutter.plugin.platform.PlatformViewsController.this.createPlatformView(platformViewCreationRequest, true);
            ...
            if (!(io.flutter.util.ViewUtils.hasChildViewOfType(view, io.flutter.plugin.platform.PlatformViewsController.VIEW_TYPES_REQUIRE_NON_TLHC) ? false : true)) {
                if (platformViewCreationRequest.displayMode == io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewCreationRequest.RequestedDisplayMode.TEXTURE_WITH_HYBRID_FALLBACK) {
                    io.flutter.plugin.platform.PlatformViewsController.this.configureForHybridComposition(createPlatformView, platformViewCreationRequest);
                    return -2L;
                }
                if (!io.flutter.plugin.platform.PlatformViewsController.this.usesSoftwareRendering) {
                    return io.flutter.plugin.platform.PlatformViewsController.this.configureForVirtualDisplay(createPlatformView, platformViewCreationRequest);
                }
            }
            return io.flutter.plugin.platform.PlatformViewsController.this.configureForTextureLayerComposition(createPlatformView, platformViewCreationRequest);
        }
        ...
        public void dispose(int i17) {
            io.flutter.plugin.platform.PlatformView platformView = (io.flutter.plugin.platform.PlatformView) io.flutter.plugin.platform.PlatformViewsController.this.platformViews.get(i17);
            if (platformView == null) {
                io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Disposing unknown platform view with id: " + i17);
                return;
            }
            ...
            io.flutter.plugin.platform.PlatformViewsController.this.platformViews.remove(i17);
            try {
                platformView.dispose();
            } catch (java.lang.RuntimeException e17) {
                io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Disposing platform view threw an exception", e17);
            }
            if (io.flutter.plugin.platform.PlatformViewsController.this.usesVirtualDisplay(i17)) {
                io.flutter.plugin.platform.VirtualDisplayController virtualDisplayController = io.flutter.plugin.platform.PlatformViewsController.this.vdControllers.get(java.lang.Integer.valueOf(i17));
                android.view.View view2 = virtualDisplayController.getView();
                if (view2 != null) {
                    io.flutter.plugin.platform.PlatformViewsController.this.contextToEmbeddedView.remove(view2.getContext());
                }
                virtualDisplayController.dispose();
                io.flutter.plugin.platform.PlatformViewsController.this.vdControllers.remove(java.lang.Integer.valueOf(i17));
                return;
            }
            io.flutter.plugin.platform.PlatformViewWrapper platformViewWrapper = (io.flutter.plugin.platform.PlatformViewWrapper) io.flutter.plugin.platform.PlatformViewsController.this.viewWrappers.get(i17);
            if (platformViewWrapper != null) {
                ...
                io.flutter.plugin.platform.PlatformViewsController.this.viewWrappers.remove(i17);
                return;
            }
            io.flutter.embedding.engine.mutatorsstack.FlutterMutatorView flutterMutatorView = (io.flutter.embedding.engine.mutatorsstack.FlutterMutatorView) io.flutter.plugin.platform.PlatformViewsController.this.platformViewParent.get(i17);
            if (flutterMutatorView != null) {
                ...
                io.flutter.plugin.platform.PlatformViewsController.this.platformViewParent.remove(i17);
            }
        }
        ...
        public void offset(int i17, double d17, double d18) {
            ...
            io.flutter.plugin.platform.PlatformViewWrapper platformViewWrapper = (io.flutter.plugin.platform.PlatformViewWrapper) io.flutter.plugin.platform.PlatformViewsController.this.viewWrappers.get(i17);
            if (platformViewWrapper == null) {
                io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Setting offset for unknown platform view with id: " + i17);
            } else {
                int physicalPixels = io.flutter.plugin.platform.PlatformViewsController.this.toPhysicalPixels(d17);
                int physicalPixels2 = io.flutter.plugin.platform.PlatformViewsController.this.toPhysicalPixels(d18);
        ...
        public void onTouch(io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewTouch platformViewTouch) {
            ...
            float f17 = io.flutter.plugin.platform.PlatformViewsController.this.context.getResources().getDisplayMetrics().density;
            if (io.flutter.plugin.platform.PlatformViewsController.this.usesVirtualDisplay(i17)) {
                io.flutter.plugin.platform.PlatformViewsController.this.vdControllers.get(java.lang.Integer.valueOf(i17)).dispatchTouchEvent(io.flutter.plugin.platform.PlatformViewsController.this.toMotionEvent(f17, platformViewTouch, true));
                return;
            }
            io.flutter.plugin.platform.PlatformView platformView = (io.flutter.plugin.platform.PlatformView) io.flutter.plugin.platform.PlatformViewsController.this.platformViews.get(i17);
            if (platformView == null) {
                io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Sending touch to an unknown view with id: " + i17);
                return;
            }
            android.view.View view = platformView.getView();
            if (view != null) {
                view.dispatchTouchEvent(io.flutter.plugin.platform.PlatformViewsController.this.toMotionEvent(f17, platformViewTouch, false));
                return;
            }
            io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Sending touch to a null view with id: " + i17);
        }
        ...
        public void resize(io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewResizeRequest platformViewResizeRequest, final io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
            int physicalPixels = io.flutter.plugin.platform.PlatformViewsController.this.toPhysicalPixels(platformViewResizeRequest.newLogicalWidth);
            int physicalPixels2 = io.flutter.plugin.platform.PlatformViewsController.this.toPhysicalPixels(platformViewResizeRequest.newLogicalHeight);
            int i17 = platformViewResizeRequest.viewId;
            if (io.flutter.plugin.platform.PlatformViewsController.this.usesVirtualDisplay(i17)) {
                final float displayDensity = io.flutter.plugin.platform.PlatformViewsController.this.getDisplayDensity();
                final io.flutter.plugin.platform.VirtualDisplayController virtualDisplayController = io.flutter.plugin.platform.PlatformViewsController.this.vdControllers.get(java.lang.Integer.valueOf(i17));
                io.flutter.plugin.platform.PlatformViewsController.this.lockInputConnection(virtualDisplayController);
                virtualDisplayController.resize(physicalPixels, physicalPixels2, new java.lang.Runnable() { // from class: io.flutter.plugin.platform.PlatformViewsController$1$$a
                    @Override // java.lang.Runnable
                    public final void run() {
                        io.flutter.plugin.platform.PlatformViewsController.AnonymousClass1.this.lambda$resize$0(virtualDisplayController, displayDensity, platformViewBufferResized);
                    }
                });
                return;
            }
            ...
            if (platformView == null || platformViewWrapper == null) {
                io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Resizing unknown platform view with id: " + i17);
                return;
            }
            ...
            platformViewBufferResized.run(new io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewBufferSize(io.flutter.plugin.platform.PlatformViewsController.this.toLogicalPixels(platformViewWrapper.getRenderTargetWidth()), io.flutter.plugin.platform.PlatformViewsController.this.toLogicalPixels(platformViewWrapper.getRenderTargetHeight())));
        }

        @Override // io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewsHandler
        public void setDirection(int i17, int i18) {
            android.view.View view;
            if (!io.flutter.plugin.platform.PlatformViewsController.validateDirection(i18)) {
            ...
            if (io.flutter.plugin.platform.PlatformViewsController.this.usesVirtualDisplay(i17)) {
                ...
                io.flutter.plugin.platform.PlatformView platformView = (io.flutter.plugin.platform.PlatformView) io.flutter.plugin.platform.PlatformViewsController.this.platformViews.get(i17);
                if (platformView == null) {
                    io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Setting direction to an unknown view with id: " + i17);
                    return;
                }
                view = platformView.getView();
            }
            ...
            io.flutter.Log.e(io.flutter.plugin.platform.PlatformViewsController.TAG, "Setting direction to a null view with id: " + i17);
        }

        @Override // io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewsHandler
        public void synchronizeToNativeViewHierarchy(boolean z17) {
            io.flutter.plugin.platform.PlatformViewsController.this.synchronizeToNativeViewHierarchy = z17;
        }
    }
    ...
    public long configureForVirtualDisplay(io.flutter.plugin.platform.PlatformView platformView, final io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        io.flutter.plugin.platform.VirtualDisplayController create = io.flutter.plugin.platform.VirtualDisplayController.create(this.context, this.accessibilityEventsDelegate, platformView, makePlatformViewRenderTarget, toPhysicalPixels(platformViewCreationRequest.logicalWidth), toPhysicalPixels(platformViewCreationRequest.logicalHeight), platformViewCreationRequest.viewId, null, new android.view.View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$d
            ...
            public final void onFocusChange(android.view.View view, boolean z17) {
                io.flutter.plugin.platform.PlatformViewsController.this.lambda$configureForVirtualDisplay$0(platformViewCreationRequest, view, z17);
            }
        });
        if (create != null) {
    ...
    private void finishFrame(boolean z17) {
        ...
        for (int i18 = 0; i18 < this.platformViewParent.size(); i18++) {
            ...
            if (!this.currentFrameUsedPlatformViewIds.contains(java.lang.Integer.valueOf(keyAt2)) || (!z17 && this.synchronizeToNativeViewHierarchy)) {
                ...
                yj0.a.d(flutterMutatorView, arrayList.toArray(), "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
                flutterMutatorView.setVisibility(((java.lang.Integer) arrayList.get(0)).intValue());
                yj0.a.f(flutterMutatorView, "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
            } else {
                java.util.ArrayList arrayList2 = new java.util.ArrayList();
                java.lang.ThreadLocal threadLocal2 = zj0.c.f473285a;
                arrayList2.add(0);
                java.util.Collections.reverse(arrayList2);
                yj0.a.d(flutterMutatorView, arrayList2.toArray(), "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
    ...
    private static io.flutter.plugin.platform.PlatformViewRenderTarget makePlatformViewRenderTarget(io.flutter.view.TextureRegistry textureRegistry) {
        int i17;
        if (enableSurfaceProducerRenderTarget && (i17 = android.os.Build.VERSION.SDK_INT) >= 29) {
            io.flutter.view.TextureRegistry.SurfaceProducer createSurfaceProducer = textureRegistry.createSurfaceProducer(i17 <= 34 ? io.flutter.view.TextureRegistry.SurfaceLifecycle.resetInBackground : io.flutter.view.TextureRegistry.SurfaceLifecycle.manual);
    ...
    public void attach(android.content.Context context, io.flutter.view.TextureRegistry textureRegistry, io.flutter.embedding.engine.dart.DartExecutor dartExecutor) {
        ...
        io.flutter.embedding.engine.systemchannels.PlatformViewsChannel platformViewsChannel2 = new io.flutter.embedding.engine.systemchannels.PlatformViewsChannel(dartExecutor);
    ...
    public void attachToView(io.flutter.embedding.android.FlutterView flutterView) {
        ...
        io.flutter.embedding.engine.systemchannels.PlatformViewsChannel platformViewsChannel = this.platformViewsChannel;
        if (platformViewsChannel != null) {
            platformViewsChannel.flushCachedCalls();
        }
    }
    ...
    public long configureForTextureLayerComposition(io.flutter.plugin.platform.PlatformView platformView, final io.flutter.embedding.engine.systemchannels.PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        platformViewWrapper.setOnDescendantFocusChangeListener(new android.view.View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$a
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(android.view.View view2, boolean z17) {
                io.flutter.plugin.platform.PlatformViewsController.this.lambda$configureForTextureLayerComposition$1(platformViewCreationRequest, view2, z17);
            }
        });
    ...
    public void detach() {
        ...
        if (this.preRegistered) {
            io.flutter.embedding.engine.systemchannels.PlatformViewsChannel platformViewsChannel2 = this.platformViewsChannel;
            if (platformViewsChannel2 != null) {
                platformViewsChannel2.clearCachedCalls();
                this.platformViewsChannel.enableCaching();
            }
        } else {
    ...
    public boolean initializePlatformViewIfNeeded(final int i17) {
        ...
        flutterMutatorView.setOnDescendantFocusChangeListener(new android.view.View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$b
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(android.view.View view2, boolean z17) {
                io.flutter.plugin.platform.PlatformViewsController.this.lambda$initializePlatformViewIfNeeded$2(i17, view2, z17);
            }
        });
    ...
    public void onEndFrame() {
        ...
        if (this.flutterViewConvertedToImageView && this.currentFrameUsedPlatformViewIds.isEmpty()) {
            this.flutterViewConvertedToImageView = false;
            this.flutterView.revertImageView(new java.lang.Runnable() { // from class: io.flutter.plugin.platform.PlatformViewsController$$c
                @Override // java.lang.Runnable
                public final void run() {
                    io.flutter.plugin.platform.PlatformViewsController.this.lambda$onEndFrame$3();
                }
            });
        } else {
    ...
    public void preRegisterChannel(io.flutter.embedding.engine.dart.DartExecutor dartExecutor) {
        if (this.platformViewsChannel != null) {
            io.flutter.Log.w(TAG, "preRegisterChannel called but channel already exists, ignoring.");
            return;
        }
        ...
        platformViewsChannel.enableCaching();
