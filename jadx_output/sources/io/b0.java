...
public final class b0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ xb5.a f293168d;
    ...
    public final void onClick(android.view.View view) {
        ...
        xb5.a aVar = this.f293168d;
        yz5.l lVar = aVar.f453010h;
        if (lVar != null) {
            lVar.invoke(aVar);
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactItemView", "onClick, viewModel: " + aVar);
