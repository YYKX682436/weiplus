...
public class c implements x51.o0 {
    ...
    public static final java.lang.String f282940b = com.tencent.mm.wallet_core.f.a();

    /* renamed from: a, reason: collision with root package name */
    public final java.lang.String f282941a;
    ...
    public java.lang.String k() {
        java.lang.String str = this.f282941a;
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.WalletGetPicStrategy", "getStoragePath: but url is null");
            return null;
        }
        return java.lang.String.format("%s/%s", f282940b, kk.k.g(str.getBytes()));
    }
    ...
    public android.graphics.Bitmap l(android.graphics.Bitmap bitmap, x51.m0 m0Var, java.lang.String str) {
        if (x51.m0.NET == m0Var) {
            try {
                ...
                com.tencent.mm.vfs.z7 a17 = com.tencent.mm.vfs.z7.a(f282940b);
