...
public final class u implements s1.t0 {
    ...
    public static final s2.u f402253a = new s2.u();
    ...
    public final s1.u0 d(s1.x0 Layout, java.util.List measurables, long j17) {
        ...
        if (size == 0) {
            return s1.v0.b(Layout, 0, 0, null, s2.r.f402250d, 4, null);
        }
        int i19 = 0;
        if (size == 1) {
            s1.o1 m17 = ((s1.r0) measurables.get(0)).m(j17);
            return s1.v0.b(Layout, m17.f402050d, m17.f402051e, null, new s2.s(m17), 4, null);
        }
        ...
        if (h17 >= 0) {
            ...
            while (true) {
                ...
                i28 = java.lang.Math.max(i28, o1Var.f402050d);
                i29 = java.lang.Math.max(i29, o1Var.f402051e);
                if (i19 == h17) {
                    break;
                }
                i19++;
