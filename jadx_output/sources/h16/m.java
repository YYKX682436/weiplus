...
public class m implements g16.m0 {
    ...
    public final /* synthetic */ h16.n f278244a;
    ...
    public void b(n16.g gVar, java.lang.Object obj) {
        ...
        h16.n nVar = this.f278244a;
        if (equals) {
            if (obj instanceof int[]) {
                nVar.f278247a = (int[]) obj;
            }
        } else if ("multifileClassName".equals(h17)) {
            nVar.f278248b = obj instanceof java.lang.String ? (java.lang.String) obj : null;
        }
    }
    ...
    public g16.n0 d(n16.g gVar) {
        ...
        if (com.tencent.thumbplayer.tplayer.plugins.report.TPReportParams.PROP_KEY_DATA.equals(h17) || "filePartClassNames".equals(h17)) {
