...
public class o extends tf.c {
    ...
    public final /* synthetic */ wf.b f445477i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(wf.b bVar, eg.a aVar, com.tencent.mm.plugin.appbrand.jsapi.x0 x0Var) {
        super(aVar, x0Var);
        this.f445477i = bVar;
    }
    ...
    public void a(java.lang.String str, sf.f fVar) {
        ...
        if (str.contains("insert") || str.contains("update")) {
            ...
            if (!com.tencent.mm.sdk.platformtools.t8.K0(optString) && (optString.equalsIgnoreCase(com.tencent.tav.core.AssetExtension.SCENE_PLAY) || optString.equalsIgnoreCase("resume"))) {
                this.f418790d = true;
            }
