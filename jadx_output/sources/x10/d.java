...
public final class d extends y10.a {
    ...
    public void b(pq.a context, bw5.x7 jumpInfo, t10.d callback) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(c17)) {
            com.tencent.mars.xlog.Log.i("ECS_O.NativeHandler.RevealBlindGift", "handle params nil");
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.i("ECS_O.NativeHandler.RevealBlindGift", "set open event callback, eventId:" + wi6);
            ...
            k1Var.getClass();
            com.tencent.mars.xlog.Log.i("MicroMsg.EcsGiftMsgService", "openEcsGiftRevealBlindGiftPageWithParams, open with loading");
            k1Var.sj(c18, e17, null, new j00.y0(k1Var, c18));
            callback.d(null);
        } catch (java.lang.Exception e18) {
            com.tencent.mars.xlog.Log.e("ECS_O.NativeHandler.RevealBlindGift", "handle error:" + e18);
