...
public enum ar0 implements com.tencent.mm.protobuf.h {
    ...
    TingScene_LikedListHalfScreen(230),
    TingScene_HistoryListHalfScreen(231),
    TingScene_AlbumHalfScreen(232),
    TingScene_SingerWikiHalfScreen(com.tencent.cloud.huiyan.exception.CallbackErrorCode.HY_API_RESPONSE_ERROR),
    TingScene_AudioWikiHalfScreen(234),
    TingScene_UgcPlayListHalfScreen(235),
    TingScene_RecommandPlayListHalfScreen(com.tencent.mm.plugin.appbrand.jsapi.j6.CTRL_INDEX),
    ...
    TingScene_AudioAuthorAudioCollectionPageLivePlayBackHalfScreen(com.tencent.mm.plugin.appbrand.jsapi.cd.CTRL_INDEX),
    TingScene_DailyNewsHalfScreen(247),
    TingScene_MoreSingerRadioPageHalfScreen(268),
    TingScene_MusicAllWorkPageHalfScreen(272),
    TingScene_MusicTopicUGCPageHalfScreen(bd1.f.CTRL_INDEX),
    ...
    TingScene_Minimization_Chatplay(1005),
    ...
    TingScene_ChatMusicSearch(com.tencent.mm.plugin.appbrand.jsapi.finder.v.CTRL_INDEX),
    TingScene_Moment(v31.j.CTRL_INDEX),
    TingScene_Fav(1500),
    TingScene_FavTabTytSquare(com.tencent.mm.plugin.appbrand.jsapi.ecs.jsapi.t.CTRL_INDEX),
    ...
    TingScene_FinderListenToMusic(1623),
    ...
    TingScene_FinderProfileAudioHalfScreen(com.hilive.mediasdk.SdkInfo.ErrCode.kErrCodeNotFound),
    ...
    TingScene_FinderFinderMusicTabMusicAllWorkPageHalfScreen(com.tencent.mm.plugin.appbrand.jsapi.ia.CTRL_INDEX),
    TingScene_WXSearch(2000),
    TingScene_TextState(2001),
    TingScene_RecentUsed(2002),
    TingScene_Shake(2004),
    TingScene_CommonWeb(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_PLAY_PROGRESS),
    TingScene_ListenLaterNewUserGuideJump(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_PLAY_END),
    TingScene_BellSquare(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_PLAY_LOADING),
    TingScene_BizAudioTab(2008),
    TingScene_BellHistory(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_CHANGE_RESOLUTION),
    TingScene_SysLockScreen(com.tencent.rtmp.TXLiveConstants.PLAY_EVT_GET_PLAYINFO_SUCC),
    ...
    TingScene_FloatBallPermissionDialog(com.tencent.rtmp.TXLiveConstants.PLAY_WARNING_RECONNECT),
    TingScene_Live(2200),
    ...
    TingScene_EmotionalCommentary(2204),
    ...
    TingScene_RequestMuiscRoom_Square(3101),
    TingScene_RequestMuiscRoom(3102),
    TingScene_RequestMusicRoom_Create(3103),
    TingScene_ai_CategoryPage(4000);
    ...
    public static bw5.ar0 i(int i17) {
        if (i17 == 0) {
        ...
        switch (i17) {
            ...
            case 1005:
                return TingScene_Minimization_Chatplay;
            case 1101:
            ...
            case 1623:
                return TingScene_FinderListenToMusic;
            case 1680:
            ...
            case 2204:
                return TingScene_EmotionalCommentary;
            case 2301:
            ...
            case 3101:
                return TingScene_RequestMuiscRoom_Square;
            case 3102:
                return TingScene_RequestMuiscRoom;
            case 3103:
                return TingScene_RequestMusicRoom_Create;
            case 4000:
                return TingScene_ai_CategoryPage;
            default:
                switch (i17) {
                    case 12:
