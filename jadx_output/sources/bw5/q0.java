...
public class q0 extends com.tencent.mm.protobuf.f {
    ...
    public static final bw5.q0 f31875i = new bw5.q0();

    /* renamed from: d, reason: collision with root package name */
    public bw5.bj0 f31876d;

    /* renamed from: e, reason: collision with root package name */
    public java.lang.String f31877e;
    ...
    public final boolean[] f31880h = new boolean[5];

    public bw5.bj0 b() {
        return this.f31880h[1] ? this.f31876d : bw5.bj0.NOTIFY_CODE_NONE;
    }

    @Override // com.tencent.mm.protobuf.f
    /* renamed from: c, reason: merged with bridge method [inline-methods] */
    public bw5.q0 parseFrom(byte[] bArr) {
        return (bw5.q0) super.parseFrom(bArr);
    }
    ...
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        ...
        return n51.f.a(this.f31876d, q0Var.f31876d) && n51.f.a(this.f31877e, q0Var.f31877e) && n51.f.a(java.lang.Boolean.valueOf(this.f31878f), java.lang.Boolean.valueOf(q0Var.f31878f)) && n51.f.a(java.lang.Boolean.valueOf(this.f31879g), java.lang.Boolean.valueOf(q0Var.f31879g));
    }
    ...
    public final int op(int i17, java.lang.Object... objArr) {
        bw5.bj0 bj0Var;
        int i18 = 0;
        boolean[] zArr = this.f31880h;
        if (i17 == 0) {
            g36.f fVar = (g36.f) objArr[0];
            bw5.bj0 bj0Var2 = this.f31876d;
            if (bj0Var2 != null && zArr[1]) {
                fVar.e(1, bj0Var2.f25713d);
            }
            java.lang.String str = this.f31877e;
            if (str != null && zArr[2]) {
                fVar.j(2, str);
            }
            if (zArr[3]) {
                fVar.a(3, this.f31878f);
            }
            if (zArr[4]) {
                fVar.a(4, this.f31879g);
            }
            return 0;
        }
        if (i17 == 1) {
            bw5.bj0 bj0Var3 = this.f31876d;
            if (bj0Var3 != null && zArr[1]) {
                i18 = 0 + b36.f.e(1, bj0Var3.f25713d);
            }
            java.lang.String str2 = this.f31877e;
            if (str2 != null && zArr[2]) {
                i18 += b36.f.j(2, str2);
            }
            if (zArr[3]) {
                i18 += b36.f.a(3, this.f31878f);
            }
            return zArr[4] ? i18 + b36.f.a(4, this.f31879g) : i18;
        }
        if (i17 == 2) {
        ...
        if (intValue != 1) {
            if (intValue == 2) {
                this.f31877e = aVar2.k(intValue);
                zArr[2] = true;
                return 0;
            }
            if (intValue == 3) {
                this.f31878f = aVar2.c(intValue);
                zArr[3] = true;
                return 0;
            }
            if (intValue != 4) {
