...
public class f2 extends com.tencent.mm.protobuf.f {
    ...
    public final java.util.LinkedList f373933d = new java.util.LinkedList();

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        return fVar != null && (fVar instanceof r45.f2) && n51.f.a(this.f373933d, ((r45.f2) fVar).f373933d);
    }
    ...
    */
    public com.tencent.mm.protobuf.f fromJson(java.lang.String r7) {
        ...
        L43:
            ...
            if (r3 == 0) goto L64
            java.util.LinkedList r3 = r6.f373933d     // Catch: java.lang.Exception -> L67
        ...
        L67:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: r45.f2.fromJson(java.lang.String):com.tencent.mm.protobuf.f");
    }

    @Override // com.tencent.mm.protobuf.f
    public final int op(int i17, java.lang.Object... objArr) {
        java.util.LinkedList linkedList = this.f373933d;
        if (i17 == 0) {
        ...
        for (int i18 = 0; i18 < size; i18++) {
            ...
            if (bArr2 != null && bArr2.length > 0) {
                d2Var.parseFrom(bArr2);
            }
            f2Var.f373933d.add(d2Var);
        }
        return 0;
    }
    ...
    public java.lang.Object toJSON() {
        ...
        try {
            n51.f.f335114a.d(jSONObject, "activities", this.f373933d, false);
