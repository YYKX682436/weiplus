...
public class i96 extends com.tencent.mm.protobuf.f {

    /* renamed from: d, reason: collision with root package name */
    public r45.d96 f376852d;

    /* renamed from: e, reason: collision with root package name */
    public r45.fb6 f376853e;
    ...
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        ...
        return n51.f.a(this.f376852d, i96Var.f376852d) && n51.f.a(this.f376853e, i96Var.f376853e);
    }
    ...
    */
    public com.tencent.mm.protobuf.f fromJson(java.lang.String r6) {
        ...
        L4b:
            ...
            r5.f376853e = r2     // Catch: java.lang.Exception -> L7d
            goto L15
        L64:
            java.lang.Object r1 = r0.opt(r1)     // Catch: java.lang.Exception -> L7d
            boolean r2 = r1 instanceof org.json.JSONObject     // Catch: java.lang.Exception -> L7d
            ...
            java.lang.String r1 = r1.toString()     // Catch: java.lang.Exception -> L7d
            r2.fromJson(r1)     // Catch: java.lang.Exception -> L7d
            r5.f376852d = r2     // Catch: java.lang.Exception -> L7d
            goto L15
        L7d:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: r45.i96.fromJson(java.lang.String):com.tencent.mm.protobuf.f");
    }
    ...
    public final int op(int i17, java.lang.Object... objArr) {
        if (i17 == 0) {
            ...
            r45.d96 d96Var = this.f376852d;
            if (d96Var != null) {
                fVar.i(1, d96Var.computeSize());
                this.f376852d.writeFields(fVar);
            }
            r45.fb6 fb6Var = this.f376853e;
            if (fb6Var != null) {
                fVar.i(2, fb6Var.computeSize());
                this.f376853e.writeFields(fVar);
            }
            return 0;
        }
        if (i17 == 1) {
            r45.d96 d96Var2 = this.f376852d;
            int i18 = d96Var2 != null ? 0 + b36.f.i(1, d96Var2.computeSize()) : 0;
            r45.fb6 fb6Var2 = this.f376853e;
            return fb6Var2 != null ? i18 + b36.f.i(2, fb6Var2.computeSize()) : i18;
        }
        if (i17 == 2) {
        ...
        if (intValue == 1) {
            ...
            for (int i19 = 0; i19 < size; i19++) {
                ...
                if (bArr != null && bArr.length > 0) {
                    d96Var3.parseFrom(bArr);
                }
                i96Var.f376852d = d96Var3;
            }
            return 0;
        }
        if (intValue != 2) {
        ...
        for (int i27 = 0; i27 < size2; i27++) {
            ...
            if (bArr2 != null && bArr2.length > 0) {
                fb6Var3.parseFrom(bArr2);
            }
            i96Var.f376853e = fb6Var3;
        }
        return 0;
    }
    ...
    public java.lang.Object toJSON() {
        ...
        try {
            ...
            eVar.d(jSONObject, "video_info", this.f376853e, false);
