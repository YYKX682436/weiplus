...
public class y54 extends com.tencent.mm.protobuf.f {

    /* renamed from: d, reason: collision with root package name */
    public java.util.LinkedList f390801d = new java.util.LinkedList();

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        return fVar != null && (fVar instanceof r45.y54) && n51.f.a(this.f390801d, ((r45.y54) fVar).f390801d);
    }
    ...
    */
    public com.tencent.mm.protobuf.f fromJson(java.lang.String r7) {
        ...
        L44:
            ...
            if (r3 == 0) goto L65
            java.util.LinkedList r3 = r6.f390801d     // Catch: java.lang.Exception -> L68
        ...
        L68:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: r45.y54.fromJson(java.lang.String):com.tencent.mm.protobuf.f");
    }

    @Override // com.tencent.mm.protobuf.f
    public final int op(int i17, java.lang.Object... objArr) {
        if (i17 == 0) {
            ((g36.f) objArr[0]).g(1, 8, this.f390801d);
            return 0;
        }
        if (i17 == 1) {
            return b36.f.g(1, 8, this.f390801d) + 0;
        }
        if (i17 == 2) {
        ...
        for (int i18 = 0; i18 < size; i18++) {
            ...
            if (bArr2 != null && bArr2.length > 0) {
                x54Var.parseFrom(bArr2);
            }
            y54Var.f390801d.add(x54Var);
        }
        return 0;
    }
    ...
    public java.lang.Object toJSON() {
        ...
        try {
            n51.f.f335114a.d(jSONObject, "layer_render_info_list", this.f390801d, false);
