...
public final class o {
    ...
    public static final v24.o f432940a = new v24.o();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:85:0x01ac, code lost:
        ...
        if ((r5.f432930c + r5.f432931d) <= 8) goto L69;
     */
    /* JADX WARN: Code restructure failed: missing block: B:86:0x01ae, code lost:
    
        com.tencent.mars.xlog.Log.i("MicroMsg.ListFile", r26.i0.s("  ", r3) + '[' + r5.f432929b + " bytes, " + r5.f432931d + " dirs, " + r5.f432930c + " files | " + r5.f432928a + ']');
     */
    ...
    */
    ...
    public final void a() {
        int i17;
        int i18;
        android.database.Cursor B = gm0.j1.u().f273153f.B("SELECT name,sum(pgsize) FROM dbstat GROUP BY name ORDER BY sum(pgsize) DESC", null);
        if (B == null) {
            return;
        }
        while (true) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.ListFile", "name = " + B.getString(0) + ", size = " + B.getLong(1));
        }
        B.close();
        ...
        while (Ai.moveToNext()) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.ListFile", "type = " + j17 + ", count = " + j18 + ", contentSize = " + j19 + ", lvbufferSize = " + j27 + ", reservedSize = " + j28 + ", sumSize = " + (j19 + j27 + j28));
            i17 = 1;
            i18 = 0;
        }
        Ai.close();
