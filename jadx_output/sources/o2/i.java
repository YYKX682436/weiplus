...
public abstract class i {
    ...
    public static final p2.o f342347a = new p2.o(0, 0, 0, 0);

    /* renamed from: b, reason: collision with root package name */
    public static final r26.t f342348b = new r26.t("(\\d+)|([,])|([*])|([:])|L|(P\\([^)]*\\))|(C(\\(([^)]*)\\))?)|@");

    /* renamed from: c, reason: collision with root package name */
    public static final r26.t f342349c = new r26.t("(\\d+)|,|[!P()]|:([^,!)]+)");

    public static final java.lang.reflect.Field a(java.lang.Class cls, java.lang.String str) {
        java.lang.reflect.Field field;
        java.lang.reflect.Field[] declaredFields = cls.getDeclaredFields();
        kotlin.jvm.internal.o.f(declaredFields, "declaredFields");
        ...
        while (true) {
            ...
            if (kotlin.jvm.internal.o.b(field.getName(), str)) {
                break;
            }
            i17++;
        }
    ...
    public static final o2.c b(y0.a aVar) {
        ...
        return bVar != null ? c(bVar, null) : o2.b.f342329h;
    }
    ...
    */
    ...
    public static final boolean e(r26.m mVar, java.lang.String str) {
        return kotlin.jvm.internal.o.b(d(mVar), str);
    }

    public static final boolean f(r26.m mVar) {
        return ((r26.p) ((r26.q) mVar).f368911c).e(1) != null;
    }
    ...
    public static final void h(kotlin.jvm.internal.h0 h0Var, java.lang.String str) {
        r26.m mVar = (r26.m) h0Var.f310123d;
        if (mVar == null || !kotlin.jvm.internal.o.b(d(mVar), str)) {
            throw new o2.g();
        }
        l(h0Var);
    }

    public static final java.lang.String i(kotlin.jvm.internal.h0 h0Var) {
        r26.m mVar = (r26.m) h0Var.f310123d;
        if (mVar != null) {
            if (((r26.p) ((r26.q) mVar).f368911c).e(2) != null) {
                l(h0Var);
    ...
    public static final int j(kotlin.jvm.internal.h0 h0Var) {
        r26.m mVar = (r26.m) h0Var.f310123d;
        if (mVar != null) {
            if (((r26.p) ((r26.q) mVar).f368911c).e(1) != null) {
                l(h0Var);
                try {
    ...
    public static final boolean k(kotlin.jvm.internal.h0 h0Var, java.lang.String str) {
        r26.m mVar = (r26.m) h0Var.f310123d;
        return mVar == null || kotlin.jvm.internal.o.b(d(mVar), str);
    }

    public static final r26.m l(kotlin.jvm.internal.h0 h0Var) {
        r26.m mVar = (r26.m) h0Var.f310123d;
        if (mVar != null) {
            h0Var.f310123d = ((r26.q) mVar).d();
        }
        return (r26.m) h0Var.f310123d;
    }

    public static final r26.m m(kotlin.jvm.internal.h0 h0Var) {
        r26.m mVar = (r26.m) h0Var.f310123d;
        if (mVar != null) {
            h0Var.f310123d = ((r26.q) mVar).d();
        }
