...
public class h extends com.tencent.mm.plugin.fts.ui.a {

    /* renamed from: p, reason: collision with root package name */
    public boolean f297272p;
    ...
    public p13.c q(com.tencent.mm.sdk.platformtools.n3 n3Var, java.util.HashSet hashSet) {
        ...
        uVar.f351152n = n3Var;
        if (this.f297272p) {
            com.tencent.mars.xlog.Log.i("MicroMsg.FTS.FTSContactDetailUIUnit", "fts: search by pinyin: %s", str);
            uVar.f351140b = 18;
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.FTS.FTSContactDetailUIUnit", "fts: search: %s", str);
            uVar.f351140b = 16;
        }
