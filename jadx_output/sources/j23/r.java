...
public final class r extends com.tencent.mm.plugin.fts.ui.a {
    ...
    public boolean a(android.view.View view, u13.g gVar, boolean z17) {
        ...
        if (gVar.f423772o) {
            ...
            if (i17 == 1 || i17 == 2 || i17 == 3) {
                ...
                kFContactSessionSearchLogStruct.f58544e = 2L;
                ...
                java.lang.String str2 = this.f138007i;
                kotlin.jvm.internal.o.f(str2, "getQuery(...)");
                long j18 = this.f297280p;
                com.tencent.mm.autogen.mmdata.rpt.KFContactSessionSearchLogStruct kFContactSessionSearchLogStruct2 = new com.tencent.mm.autogen.mmdata.rpt.KFContactSessionSearchLogStruct();
                kFContactSessionSearchLogStruct2.q(g23.j.f267932c);
                kFContactSessionSearchLogStruct2.f58543d = 6L;
                kFContactSessionSearchLogStruct2.f58544e = 2L;
                kFContactSessionSearchLogStruct2.p(str2);
                kFContactSessionSearchLogStruct2.f58546g = j18;
                kFContactSessionSearchLogStruct2.f58547h = 2L;
                kFContactSessionSearchLogStruct2.k();
                com.tencent.mars.xlog.Log.i("MicroMsg.FTSKefuBoxReporter", "report 29105 " + kFContactSessionSearchLogStruct2.m());
            }
        }
        return true;
    }
    ...
    public void s(p13.v ftsResult, java.util.HashSet blockSet) {
        ...
        this.f297280p = ftsResult.f351160e.size();
        java.lang.String str = this.f138007i;
        kotlin.jvm.internal.o.f(str, "getQuery(...)");
        long j17 = this.f297280p;
        com.tencent.mm.autogen.mmdata.rpt.KFContactSessionSearchLogStruct kFContactSessionSearchLogStruct = new com.tencent.mm.autogen.mmdata.rpt.KFContactSessionSearchLogStruct();
