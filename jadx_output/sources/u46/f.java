...
public class f {
    ...
    public void a(java.lang.String[][] strArr) {
        ...
        while (i17 < strArr.length) {
            ...
            java.lang.String str = strArr2[c17];
            int parseInt = java.lang.Integer.parseInt(strArr2[1]);
            u46.e eVar = (u46.e) this.f424678a;
            ((java.util.HashMap) eVar.f424672a).put(str, new java.lang.Integer(parseInt));
            u46.h hVar = eVar.f424673b;
            u46.g[] gVarArr = hVar.f424682a;
            int i18 = Integer.MAX_VALUE;
            int i19 = parseInt & Integer.MAX_VALUE;
            int length = i19 % gVarArr.length;
            u46.g gVar = gVarArr[length];
            while (true) {
                if (gVar == null) {
                    if (hVar.f424683b >= hVar.f424684c) {
                        u46.g[] gVarArr2 = hVar.f424682a;
                        int length2 = gVarArr2.length;
                        int i27 = (length2 * 2) + 1;
                        u46.g[] gVarArr3 = new u46.g[i27];
                        hVar.f424684c = (int) (i27 * 0.75f);
                        hVar.f424682a = gVarArr3;
                        while (true) {
                            int i28 = length2 - 1;
                            if (length2 <= 0) {
                                break;
                            }
                            u46.g gVar2 = gVarArr2[i28];
                            while (gVar2 != null) {
                                u46.g gVar3 = gVar2.f424681c;
                                int i29 = (gVar2.f424679a & i18) % i27;
                                gVar2.f424681c = gVarArr3[i29];
                                gVarArr3[i29] = gVar2;
                                gVar2 = gVar3;
                        ...
                        gVarArr = hVar.f424682a;
                        length = i19 % gVarArr.length;
                    }
                    gVarArr[length] = new u46.g(parseInt, parseInt, str, gVarArr[length]);
                    hVar.f424683b++;
                } else {
                    if (gVar.f424679a == parseInt) {
                        gVar.f424680b = str;
                        break;
                    }
                    gVar = gVar.f424681c;
    ...
    */
    public final void b(java.io.Writer r11, java.lang.String r12, int r13) {
        /*
            r10 = this;
            r0 = 0
        ...
        L30:
            ...
            if (r2 == r5) goto L5b
            java.lang.String r2 = r13.substring(r4)     // Catch: java.lang.NumberFormatException -> L82
            r5 = 10
            int r2 = java.lang.Integer.parseInt(r2, r5)     // Catch: java.lang.NumberFormatException -> L82
            goto L66
        L5b:
            r2 = 2
            java.lang.String r2 = r13.substring(r2)     // Catch: java.lang.NumberFormatException -> L82
            r5 = 16
            int r2 = java.lang.Integer.parseInt(r2, r5)     // Catch: java.lang.NumberFormatException -> L82
        L66:
            ...
            goto L82
        L6c:
            u46.c r2 = r10.f424678a
            u46.e r2 = (u46.e) r2
            java.util.Map r2 = r2.f424672a
        ...
        L9a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: u46.f.b(java.io.Writer, java.lang.String, int):void");
    }
}
