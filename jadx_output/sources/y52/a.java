    ...
    */
    public static synchronized r45.iw3 a() {
        ...
        L10:
            ...
            r2.parseFrom(r1)     // Catch: java.lang.Exception -> L19 java.lang.Throwable -> L3c
            goto L2a
        L19:
            r1 = move-exception
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r3, r1, r4, r2)     // Catch: java.lang.Throwable -> L3c
        L29:
            r2 = 0
        L2a:
            if (r2 != 0) goto L4e
        ...
        L3e:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r4, r1, r5, r3)     // Catch: java.lang.Throwable -> L3c
        L4e:
            monitor-exit(r0)
            return r2
        L50:
    ...
    public static synchronized void b(r45.iw3 iw3Var) {
        synchronized (y52.a.class) {
            ...
            try {
                c52.c.d("mmkv_key_hell_PFLOW", iw3Var.toByteArray());
            } catch (java.lang.Exception e17) {
                com.tencent.mars.xlog.Log.printErrStackTrace("HABBYGE-MALI.HellPageFlowDao", e17, "HellPageFlowDao.writeBack crash: %s", e17.getMessage());
            }
        }
    }
}
