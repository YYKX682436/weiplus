...
public final class j implements jc2.d {
    ...
    public static void c(jc2.j jVar, r45.vs2 vs2Var, java.lang.String str, int i17, java.lang.Object obj) {
        ...
        jVar.getClass();
        if (vs2Var.f388487e == 15) {
            java.util.HashSet hashSet = new java.util.HashSet();
            java.util.Iterator it = vs2Var.f388489g.iterator();
            while (it.hasNext()) {
                java.lang.String str2 = ((r45.f03) it.next()).f373892i;
                if (str2 == null) {
                    str2 = "";
                }
                hashSet.add(str2);
            ...
            synchronized (f17) {
                ...
                while (true) {
                    if (listIterator.hasPrevious()) {
                        ...
                        if (kotlin.jvm.internal.o.b(str, ((com.tencent.mm.plugin.finder.extension.reddot.jb) obj2).field_username)) {
                            break;
                        }
                    } else {
                        obj2 = null;
    ...
    */
    public com.tencent.mm.plugin.finder.extension.reddot.jb a(jc2.c r45) {
        /*
    ...
    public final long b() {
        return c01.id.c() - gm0.j1.u().c().t(com.tencent.mm.storage.u3.USERINFO_FINDER_EXIT_NEARBY_LONG_SYNC, 0L);
    }
}
