...
public abstract class c {
    ...
    public static final long d(double d17, s26.d unit) {
        ...
        double a17 = s26.e.a(d17, unit, s26.d.f402370e);
        ...
        return -4611686018426999999L <= c17 && c17 < 4611686018427000000L ? c(c17) : b(a06.d.c(s26.e.a(d17, unit, s26.d.f402371f)));
    }

    public static final long e(int i17, s26.d unit) {
        kotlin.jvm.internal.o.g(unit, "unit");
        return unit.compareTo(s26.d.f402372g) <= 0 ? c(s26.e.c(i17, unit, s26.d.f402370e)) : f(i17, unit);
    }

    public static final long f(long j17, s26.d unit) {
        kotlin.jvm.internal.o.g(unit, "unit");
        s26.d dVar = s26.d.f402370e;
        long c17 = s26.e.c(4611686018426999999L, dVar, unit);
        boolean z17 = false;
        if ((-c17) <= j17 && j17 <= c17) {
            z17 = true;
        }
        return z17 ? c(s26.e.c(j17, unit, dVar)) : a(e06.p.h(s26.e.b(j17, unit, s26.d.f402371f), -4611686018427387903L, 4611686018427387903L));
    }
}
