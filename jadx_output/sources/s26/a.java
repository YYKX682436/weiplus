...
public abstract class a implements java.lang.Comparable {
    ...
    public static final long f402366d;

    /* renamed from: e, reason: collision with root package name */
    public static final long f402367e;

    /* renamed from: f, reason: collision with root package name */
    public static final /* synthetic */ int f402368f = 0;

    static {
        int i17 = s26.b.f402369a;
        f402366d = s26.c.a(4611686018427387903L);
        f402367e = s26.c.a(-4611686018427387903L);
    }
    ...
    public static int d(long j17, long j18) {
        ...
        return kotlin.jvm.internal.o.j(j17, j18);
    }

    public static final long e(long j17) {
        return (((((int) j17) & 1) == 1) && (f(j17) ^ true)) ? j17 >> 1 : g(j17, s26.d.f402371f);
    }

    public static final boolean f(long j17) {
        return j17 == f402366d || j17 == f402367e;
    }
    ...
    public static final long g(long j17, s26.d unit) {
        ...
        return s26.e.b(j17 >> 1, (((int) j17) & 1) == 0 ? s26.d.f402370e : s26.d.f402371f, unit);
    }
    ...
    public static java.lang.String h(long j17) {
        ...
        if (j17 < 0) {
            ...
            int i19 = s26.b.f402369a;
        } else {
            j18 = j17;
        }
        long g18 = g(j18, s26.d.f402375m);
        int g19 = f(j18) ? 0 : (int) (g(j18, s26.d.f402374i) % 24);
        if (f(j18)) {
            g17 = 0;
            z17 = z18;
        } else {
            z17 = z18;
            g17 = (int) (g(j18, s26.d.f402373h) % 60);
        }
        int g27 = f(j18) ? 0 : (int) (g(j18, s26.d.f402372g) % 60);
        if (f(j18)) {
            i17 = 0;
        } else {
