...
public abstract class o {
    public static void a(kk.n nVar, kk.n nVar2, int i17) {
        for (int i18 = 0; i18 < i17; i18++) {
            nVar.f308468a[nVar.f308469b + i18] = (byte) ((nVar2.f308468a[(i18 >> 3) + nVar2.f308469b] >> (i18 & 7)) & 1);
        }
    }
    ...
    public static void b(kk.n nVar, kk.n nVar2, int i17, int i18) {
        ...
        for (int i19 = 0; i19 < i17 - i18; i19++) {
            byte[] bArr = nVar.f308468a;
            int i27 = nVar.f308469b;
            bArr[i27 + i19] = bArr[i27 + i19 + i18];
        }
        for (int i28 = 0; i28 < i18; i28++) {
            nVar.f308468a[((nVar.f308469b + i28) + i17) - i18] = nVar2.f308468a[nVar2.f308469b + i28];
        }
    }
    ...
    public static void c(kk.n nVar, kk.n nVar2, kk.n[] nVarArr, int i17, kk.n nVar3, kk.n nVar4, kk.n nVar5, kk.n nVar6, kk.n nVar7, kk.n nVar8) {
        byte[] bArr = {58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4, 62, 54, 46, 38, 30, 22, 14, 6, 64, 56, 48, 40, 32, 24, com.tencent.wxmm.v2encoder.enumCODEC_vcodec2, 8, 57, 49, 41, 33, 25, 17, 9, 1, 59, 51, 43, 35, 27, 19, 11, 3, 61, 53, 45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7};
        byte[] bArr2 = {40, 8, 48, com.tencent.wxmm.v2encoder.enumCODEC_vcodec2, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53, 21, 61, 29, 36, 4, 44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51, 19, 59, 27, 34, 2, 42, 10, 50, 18, 58, 26, 33, 1, 41, 9, 49, 17, 57, 25};
        a(nVar3, nVar2, 64);
        ...
        for (int i27 = 0; i27 < 8; i27++) {
            nVar.f308468a[nVar.f308469b + i27] = (byte) 0;
        }
        for (int i28 = 0; i28 < 64; i28++) {
            byte[] bArr3 = nVar.f308468a;
            int i29 = nVar.f308469b + (i28 >> 3);
            bArr3[i29] = (byte) (bArr3[i29] | (nVar3.f308468a[nVar3.f308469b + i28] << (i28 & 7)));
        }
    }

    public static void d(kk.n nVar, kk.n nVar2, kk.n nVar3, kk.n nVar4) {
        byte[] bArr = {32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15, com.tencent.wxmm.v2encoder.enumCODEC_vcodec2, 17, com.tencent.wxmm.v2encoder.enumCODEC_vcodec2, 17, 18, 19, 20, 21, 20, 21, 22, 23, 24, 25, 24, 25, 26, 27, 28, 29, 28, 29, 30, 31, 32, 1};
        byte[] bArr2 = {com.tencent.wxmm.v2encoder.enumCODEC_vcodec2, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 31, 10, 2, 8, 24, 14, 32, 27, 3, 9, 19, 13, 30, 6, 22, 11, 4, 25};
        ...
        int i17 = nVar3.f308469b;
        int i18 = nVar.f308469b;
        for (byte b18 = 8; b17 < b18; b18 = 8) {
            byte[] bArr4 = nVar3.f308468a;
            int i19 = nVar3.f308469b;
    ...
    public static void e(kk.n nVar, kk.n nVar2, byte[] bArr, int i17, kk.n nVar3) {
        for (int i18 = 0; i18 < i17; i18++) {
            nVar3.f308468a[nVar3.f308469b + i18] = nVar2.f308468a[(nVar2.f308469b + bArr[i18]) - 1];
        }
        i(nVar, nVar3, i17);
    }
    ...
    public static char f(byte[] bArr, byte[] bArr2, long j17, int i17, byte[] bArr3, int i18) {
        ...
        nVar6.f308469b = 0;
        nVar6.f308468a = nVar5.f308468a;
        nVar7.f308469b = 28;
        nVar7.f308468a = nVar5.f308468a;
        nVar8.f308469b = 0;
        nVar8.f308468a = nVar10.f308468a;
        nVar9.f308469b = 32;
        nVar9.f308468a = nVar10.f308468a;
        int i29 = 0;
        while (i29 < 24) {
            bArr4[0 + i29] = (byte) 0;
            i29++;
        ...
        byte[] bArr6 = {14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26, 8, com.tencent.wxmm.v2encoder.enumCODEC_vcodec2, 7, 27, 20, 13, 2, 41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48, 44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29, 32};
        ...
        while (true) {
            ...
            nVar5.f308468a[nVar5.f308469b + i39] = (byte) ((bArr4[(i39 >> 3) + 0] >> (i39 & 7)) & 1);
            i39++;
            nVar14 = nVar;
            nVar9 = nVar9;
            bArr4 = bArr4;
        ...
        int i48 = nVar3.f308469b;
        int i49 = nVar2.f308469b;
        if (i18 == 0) {
            i27 = i48;
            i19 = i49;
    ...
    public static void g(kk.n nVar, kk.n nVar2, int i17) {
        for (int i18 = 0; i18 < i17; i18++) {
            byte[] bArr = nVar.f308468a;
            int i19 = nVar.f308469b + i18;
            bArr[i19] = (byte) (bArr[i19] ^ nVar2.f308468a[nVar2.f308469b + i18]);
        }
    }

    public static void h(kk.n nVar, kk.n nVar2, kk.n nVar3) {
        for (int i17 = 0; i17 < 8; i17++) {
            nVar.f308468a[nVar.f308469b + i17] = (byte) (nVar2.f308468a[nVar2.f308469b + i17] ^ nVar3.f308468a[nVar3.f308469b + i17]);
        }
    }

    public static void i(kk.n nVar, kk.n nVar2, int i17) {
        for (int i18 = 0; i18 < i17; i18++) {
            nVar.f308468a[nVar.f308469b + i18] = nVar2.f308468a[nVar2.f308469b + i18];
        }
    }
}
