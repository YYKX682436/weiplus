...
public class h extends java.util.concurrent.FutureTask {
    ...
    public final /* synthetic */ androidx.loader.content.m f11678d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(androidx.loader.content.m mVar, java.util.concurrent.Callable callable) {
        super(callable);
        this.f11678d = mVar;
    }
    ...
    public void done() {
        androidx.loader.content.m mVar = this.f11678d;
        try {
