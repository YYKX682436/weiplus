...
public class j0 implements android.view.View.OnClickListener {
    ...
    public final android.view.View f9154d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.String f9155e;

    /* renamed from: f, reason: collision with root package name */
    public java.lang.reflect.Method f9156f;

    /* renamed from: g, reason: collision with root package name */
    public android.content.Context f9157g;
    ...
    public void onClick(android.view.View view) {
        ...
        if (this.f9156f == null) {
            android.view.View view2 = this.f9154d;
            android.content.Context context = view2.getContext();
            while (true) {
                java.lang.String str2 = this.f9155e;
                if (context == null) {
                    int id6 = view2.getId();
                    if (id6 == -1) {
                        str = "";
        ...
        try {
            this.f9156f.invoke(this.f9157g, view);
