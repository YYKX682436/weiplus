...
public abstract class y0 {
    ...
    public static final android.graphics.Rect f9738a = new android.graphics.Rect();

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.Class f9739b;

    static {
        try {
            f9739b = java.lang.Class.forName("android.graphics.Insets");
    ...
    public static boolean a(android.graphics.drawable.Drawable drawable) {
        if (!(drawable instanceof android.graphics.drawable.DrawableContainer)) {
            ...
            if (drawable instanceof l.a) {
                return a(((l.a) drawable).f314023d);
            }
