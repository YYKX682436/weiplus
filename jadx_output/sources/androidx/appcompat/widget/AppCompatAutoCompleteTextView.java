...
public class AppCompatAutoCompleteTextView extends android.widget.AutoCompleteTextView {
    ...
    public static final int[] f9360f = {android.R.attr.popupBackground};

    /* renamed from: d, reason: collision with root package name */
    public final androidx.appcompat.widget.d0 f9361d;

    /* renamed from: e, reason: collision with root package name */
    public final androidx.appcompat.widget.t0 f9362e;
    ...
    public void drawableStateChanged() {
        ...
        androidx.appcompat.widget.d0 d0Var = this.f9361d;
        if (d0Var != null) {
            d0Var.a();
        }
        androidx.appcompat.widget.t0 t0Var = this.f9362e;
        if (t0Var != null) {
            t0Var.b();
        }
    }
    ...
    public AppCompatAutoCompleteTextView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        androidx.appcompat.widget.n2.a(context);
        androidx.appcompat.widget.q2 l17 = androidx.appcompat.widget.q2.l(getContext(), attributeSet, f9360f, i17, 0);
        if (l17.k(0)) {
