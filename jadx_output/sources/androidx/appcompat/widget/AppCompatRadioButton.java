...
public class AppCompatRadioButton extends android.widget.RadioButton {
    ...
    public final androidx.appcompat.widget.e0 f9375d;

    public AppCompatRadioButton(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, com.tencent.mm.R.attr.f478378i6);
    }

    @Override // android.widget.CompoundButton, android.widget.TextView
    public int getCompoundPaddingLeft() {
        int compoundPaddingLeft = super.getCompoundPaddingLeft();
        androidx.appcompat.widget.e0 e0Var = this.f9375d;
        if (e0Var != null) {
            e0Var.getClass();
        }
    ...
    public AppCompatRadioButton(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        ...
        new androidx.appcompat.widget.t0(this).d(attributeSet, i17);
    }
