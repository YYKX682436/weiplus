...
public class CameraExecutor implements java.util.concurrent.Executor {
    ...
    private static java.util.concurrent.ThreadPoolExecutor createExecutor() {
        java.util.concurrent.ThreadPoolExecutor threadPoolExecutor = new java.util.concurrent.ThreadPoolExecutor(1, 1, 0L, java.util.concurrent.TimeUnit.MILLISECONDS, new java.util.concurrent.LinkedBlockingQueue(), THREAD_FACTORY);
        threadPoolExecutor.setRejectedExecutionHandler(new androidx.camera.core.CameraExecutor$$a());
