...
public class OutputConfigurationCompatApi26Impl extends androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi24Impl {
    ...
    public static final class OutputConfigurationParamsApi26 {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            return java.util.Objects.equals(this.mOutputConfiguration, outputConfigurationParamsApi26.mOutputConfiguration) && this.mDynamicRangeProfile == outputConfigurationParamsApi26.mDynamicRangeProfile && java.util.Objects.equals(this.mPhysicalCameraId, outputConfigurationParamsApi26.mPhysicalCameraId);
        }
    ...
    public OutputConfigurationCompatApi26Impl(android.view.Surface surface) {
    ...
    private static java.util.List<android.view.Surface> getMutableSurfaceListApi26(android.hardware.camera2.params.OutputConfiguration outputConfiguration) {
    ...
    public static androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi26Impl wrap(android.hardware.camera2.params.OutputConfiguration outputConfiguration) {
    ...
    public long getDynamicRangeProfile() {
        return ((androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi26Impl.OutputConfigurationParamsApi26) this.mObject).mDynamicRangeProfile;
    }
    ...
    public int getMaxSharedSurfaceCount() {
        try {
            ...
            androidx.camera.core.Logger.e("OutputConfigCompat", "Unable to retrieve max shared surface count.", e17);
    ...
    public java.lang.Object getOutputConfiguration() {
        m3.h.a(this.mObject instanceof androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi26Impl.OutputConfigurationParamsApi26);
    ...
    public void removeSurface(android.view.Surface surface) {
        ...
        try {
            ...
            androidx.camera.core.Logger.e("OutputConfigCompat", "Unable to remove surface from this output configuration.", e17);
        }
    }

    @Override // androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi24Impl, androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatBaseImpl, androidx.camera.camera2.internal.compat.params.OutputConfigurationCompat.OutputConfigurationCompatImpl
    public void setDynamicRangeProfile(long j17) {
        ((androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi26Impl.OutputConfigurationParamsApi26) this.mObject).mDynamicRangeProfile = j17;
    }

    @Override // androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi24Impl, androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatBaseImpl, androidx.camera.camera2.internal.compat.params.OutputConfigurationCompat.OutputConfigurationCompatImpl
    public void setPhysicalCameraId(java.lang.String str) {
        ((androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi26Impl.OutputConfigurationParamsApi26) this.mObject).mPhysicalCameraId = str;
    }

    public OutputConfigurationCompatApi26Impl(int i17, android.view.Surface surface) {
        this(new androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi26Impl.OutputConfigurationParamsApi26(new android.hardware.camera2.params.OutputConfiguration(i17, surface)));
    }

    public OutputConfigurationCompatApi26Impl(java.lang.Object obj) {
        super(obj);
    }
}
