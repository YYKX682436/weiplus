...
public class StillCaptureFlow {
    ...
    public boolean shouldStopRepeatingBeforeCapture(java.util.List<android.hardware.camera2.CaptureRequest> list, boolean z17) {
        if (this.mShouldStopRepeatingBeforeStillCapture && z17) {
