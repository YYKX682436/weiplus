...
public class Camera2CameraCaptureResult implements androidx.camera.core.impl.CameraCaptureResult {
    ...
    public androidx.camera.core.impl.CameraCaptureMetaData.AeMode getAeMode() {
        java.lang.Integer num = (java.lang.Integer) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.CONTROL_AE_MODE);
        if (num == null) {
        ...
        if (intValue == 5 && android.os.Build.VERSION.SDK_INT >= 28) {
            return androidx.camera.core.impl.CameraCaptureMetaData.AeMode.ON_EXTERNAL_FLASH;
        }
        return androidx.camera.core.impl.CameraCaptureMetaData.AeMode.UNKNOWN;
    }
    ...
    public androidx.camera.core.impl.CameraCaptureMetaData.AwbMode getAwbMode() {
        java.lang.Integer num = (java.lang.Integer) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_MODE);
        if (num == null) {
    ...
    public long getTimestamp() {
        java.lang.Long l17 = (java.lang.Long) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.SENSOR_TIMESTAMP);
        if (l17 == null) {
            return -1L;
        }
    ...
    public void populateExifData(androidx.camera.core.impl.utils.ExifData.Builder builder) {
        ...
        try {
            java.lang.Integer num = (java.lang.Integer) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.JPEG_ORIENTATION);
            if (num != null) {
        ...
        java.lang.Long l17 = (java.lang.Long) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.SENSOR_EXPOSURE_TIME);
        if (l17 != null) {
            builder.setExposureTimeNanos(l17.longValue());
        }
        java.lang.Float f17 = (java.lang.Float) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.LENS_APERTURE);
        if (f17 != null) {
            builder.setLensFNumber(f17.floatValue());
        }
        java.lang.Integer num2 = (java.lang.Integer) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.SENSOR_SENSITIVITY);
        if (num2 != null) {
            if (((java.lang.Integer) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.CONTROL_POST_RAW_SENSITIVITY_BOOST)) != null) {
                num2 = java.lang.Integer.valueOf(num2.intValue() * ((int) (r1.intValue() / 100.0f)));
            }
            builder.setIso(num2.intValue());
        }
        java.lang.Float f18 = (java.lang.Float) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.LENS_FOCAL_LENGTH);
        if (f18 != null) {
            builder.setFocalLength(f18.floatValue());
        }
        java.lang.Integer num3 = (java.lang.Integer) this.mCaptureResult.get(android.hardware.camera2.CaptureResult.CONTROL_AWB_MODE);
        if (num3 != null) {
    ...
    public Camera2CameraCaptureResult(android.hardware.camera2.CaptureResult captureResult) {
        this(androidx.camera.core.impl.TagBundle.emptyBundle(), captureResult);
    }
}
