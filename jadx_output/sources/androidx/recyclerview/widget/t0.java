...
public abstract class t0 {
    ...
    public final android.util.SparseIntArray f12224a = new android.util.SparseIntArray();
    ...
    */
    public int b(int r9, int r10) {
        /*
            ...
            return r1
        L8:
            boolean r2 = r8.f12225b
            if (r2 == 0) goto L46
            android.util.SparseIntArray r2 = r8.f12224a
            int r3 = r2.size()
            if (r3 <= 0) goto L46
            int r3 = r2.size()
            r4 = -1
        ...
        L5d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.t0.b(int, int):int");
    }
