...
public class z extends androidx.recyclerview.widget.o3 {

    /* renamed from: s, reason: collision with root package name */
    public static android.animation.TimeInterpolator f12296s;

    /* renamed from: h, reason: collision with root package name */
    public final java.util.ArrayList f12297h = new java.util.ArrayList();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.ArrayList f12298i = new java.util.ArrayList();

    /* renamed from: j, reason: collision with root package name */
    public final java.util.ArrayList f12299j = new java.util.ArrayList();

    /* renamed from: k, reason: collision with root package name */
    public final java.util.ArrayList f12300k = new java.util.ArrayList();

    /* renamed from: l, reason: collision with root package name */
    public final java.util.ArrayList f12301l = new java.util.ArrayList();

    /* renamed from: m, reason: collision with root package name */
    public final java.util.ArrayList f12302m = new java.util.ArrayList();

    /* renamed from: n, reason: collision with root package name */
    public final java.util.ArrayList f12303n = new java.util.ArrayList();

    /* renamed from: o, reason: collision with root package name */
    public final java.util.ArrayList f12304o = new java.util.ArrayList();

    /* renamed from: p, reason: collision with root package name */
    public final java.util.ArrayList f12305p = new java.util.ArrayList();

    /* renamed from: q, reason: collision with root package name */
    public final java.util.ArrayList f12306q = new java.util.ArrayList();

    /* renamed from: r, reason: collision with root package name */
    public final java.util.ArrayList f12307r = new java.util.ArrayList();
    ...
    public final void F(java.util.List list, androidx.recyclerview.widget.k3 k3Var) {
        for (int size = list.size() - 1; size >= 0; size--) {
            androidx.recyclerview.widget.x xVar = (androidx.recyclerview.widget.x) list.get(size);
            if (G(xVar, k3Var) && xVar.f12262a == null && xVar.f12263b == null) {
                list.remove(xVar);
            }
        }
    }

    public final boolean G(androidx.recyclerview.widget.x xVar, androidx.recyclerview.widget.k3 k3Var) {
        if (xVar.f12263b == k3Var) {
            xVar.f12263b = null;
        } else {
            if (xVar.f12262a != k3Var) {
                return false;
            }
            xVar.f12262a = null;
        }
    ...
    public final void H(androidx.recyclerview.widget.k3 k3Var) {
        if (f12296s == null) {
            f12296s = new android.animation.ValueAnimator().getInterpolator();
        }
        k3Var.itemView.animate().setInterpolator(f12296s);
        j(k3Var);
    }
    ...
    public void j(androidx.recyclerview.widget.k3 k3Var) {
        android.view.View view = k3Var.itemView;
        view.animate().cancel();
        java.util.ArrayList arrayList = this.f12299j;
        ...
        while (true) {
            ...
            if (((androidx.recyclerview.widget.y) arrayList.get(size)).f12282a == k3Var) {
        ...
        F(this.f12300k, k3Var);
        float f17 = 1.0f;
        if (this.f12297h.remove(k3Var)) {
        ...
        java.util.ArrayList arrayList4 = this.f12303n;
        ...
        java.util.ArrayList arrayList6 = this.f12302m;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (((androidx.recyclerview.widget.y) arrayList7.get(size4)).f12282a == k3Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    x(k3Var);
        ...
        java.util.ArrayList arrayList8 = this.f12301l;
        ...
        this.f12306q.remove(k3Var);
        this.f12304o.remove(k3Var);
        this.f12307r.remove(k3Var);
        this.f12305p.remove(k3Var);
        E();
    }
    ...
    public void k() {
        ...
        while (true) {
            ...
            androidx.recyclerview.widget.y yVar = (androidx.recyclerview.widget.y) arrayList.get(size);
            android.view.View view = yVar.f12282a.itemView;
            view.setTranslationY(0.0f);
            view.setTranslationX(0.0f);
            x(yVar.f12282a);
            arrayList.remove(size);
        }
        java.util.ArrayList arrayList2 = this.f12297h;
        ...
        java.util.ArrayList arrayList3 = this.f12298i;
        ...
        java.util.ArrayList arrayList5 = this.f12300k;
        ...
        while (true) {
            ...
            androidx.recyclerview.widget.x xVar = (androidx.recyclerview.widget.x) arrayList5.get(size4);
            androidx.recyclerview.widget.k3 k3Var2 = xVar.f12262a;
            if (k3Var2 != null) {
                G(xVar, k3Var2);
            }
            androidx.recyclerview.widget.k3 k3Var3 = xVar.f12263b;
            if (k3Var3 != null) {
                G(xVar, k3Var3);
            }
        }
        ...
        while (true) {
            ...
            while (true) {
                size6--;
                if (size6 >= 0) {
                    androidx.recyclerview.widget.y yVar2 = (androidx.recyclerview.widget.y) arrayList7.get(size6);
                    android.view.View view3 = yVar2.f12282a.itemView;
        ...
        java.util.ArrayList arrayList11 = this.f12303n;
        ...
        while (true) {
            ...
            while (true) {
                size10--;
                if (size10 >= 0) {
                    androidx.recyclerview.widget.x xVar2 = (androidx.recyclerview.widget.x) arrayList12.get(size10);
                    androidx.recyclerview.widget.k3 k3Var5 = xVar2.f12262a;
                    if (k3Var5 != null) {
                        G(xVar2, k3Var5);
                    }
                    androidx.recyclerview.widget.k3 k3Var6 = xVar2.f12263b;
                    if (k3Var6 != null) {
                        G(xVar2, k3Var6);
                    }
    ...
    @Override // androidx.recyclerview.widget.n2
    public boolean o() {
        return (this.f12298i.isEmpty() && this.f12300k.isEmpty() && this.f12299j.isEmpty() && this.f12297h.isEmpty() && this.f12305p.isEmpty() && this.f12306q.isEmpty() && this.f12304o.isEmpty() && this.f12307r.isEmpty() && this.f12302m.isEmpty() && this.f12301l.isEmpty() && this.f12303n.isEmpty()) ? false : true;
    }

    @Override // androidx.recyclerview.widget.n2
    public void s() {
        java.util.ArrayList arrayList = this.f12297h;
        boolean z17 = !arrayList.isEmpty();
        java.util.ArrayList arrayList2 = this.f12299j;
        boolean z18 = !arrayList2.isEmpty();
        java.util.ArrayList arrayList3 = this.f12300k;
        boolean z19 = !arrayList3.isEmpty();
        java.util.ArrayList arrayList4 = this.f12298i;
        ...
        if (z17 || z18 || z27 || z19) {
            ...
            while (it.hasNext()) {
                ...
                this.f12306q.add(k3Var);
                animate.setDuration(this.f12169d).alpha(0.0f).setListener(new androidx.recyclerview.widget.s(this, k3Var, animate, view)).start();
            }
            arrayList.clear();
            if (z18) {
                java.util.ArrayList arrayList5 = new java.util.ArrayList();
                arrayList5.addAll(arrayList2);
                this.f12302m.add(arrayList5);
                arrayList2.clear();
                androidx.recyclerview.widget.p pVar = new androidx.recyclerview.widget.p(this, arrayList5);
                if (z17) {
                    android.view.View view2 = ((androidx.recyclerview.widget.y) arrayList5.get(0)).f12282a.itemView;
            ...
            if (z19) {
                ...
                this.f12303n.add(arrayList6);
                arrayList3.clear();
                androidx.recyclerview.widget.q qVar = new androidx.recyclerview.widget.q(this, arrayList6);
                if (z17) {
                    android.view.View view3 = ((androidx.recyclerview.widget.x) arrayList6.get(0)).f12262a.itemView;
            ...
            if (z27) {
                ...
                this.f12301l.add(arrayList7);
                arrayList4.clear();
                androidx.recyclerview.widget.r rVar = new androidx.recyclerview.widget.r(this, arrayList7);
                if (!z17 && !z18 && !z19) {
                    rVar.run();
                    return;
                }
    ...
    public boolean u(androidx.recyclerview.widget.k3 k3Var, androidx.recyclerview.widget.k3 k3Var2, int i17, int i18, int i19, int i27) {
        ...
        this.f12300k.add(new androidx.recyclerview.widget.x(k3Var, k3Var2, i17, i18, i19, i27));
        return true;
    }
    ...
    public boolean v(androidx.recyclerview.widget.k3 k3Var, int i17, int i18, int i19, int i27) {
        ...
        this.f12299j.add(new androidx.recyclerview.widget.y(k3Var, translationX, translationY, i19, i27));
        return true;
    }
