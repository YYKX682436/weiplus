...
public class Slide extends androidx.transition.Visibility {
    ...
    public android.animation.Animator V(android.view.ViewGroup viewGroup, android.view.View view, u4.m1 m1Var, u4.m1 m1Var2) {
        ...
        int[] iArr = (int[]) ((java.util.HashMap) m1Var2.f424514a).get("android:slide:screenPosition");
    ...
    public android.animation.Animator W(android.view.ViewGroup viewGroup, android.view.View view, u4.m1 m1Var, u4.m1 m1Var2) {
        ...
        int[] iArr = (int[]) ((java.util.HashMap) m1Var.f424514a).get("android:slide:screenPosition");
    ...
    public void g(u4.m1 m1Var) {
        ...
        ((java.util.HashMap) m1Var.f424514a).put("android:slide:screenPosition", iArr);
    }
    ...
    public Slide(android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        this.N = W;
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, u4.u0.f424563g);
