...
public class x2 extends androidx.fragment.app.b3 {
    public static boolean y(android.transition.Transition transition) {
        return (androidx.fragment.app.b3.j(transition.getTargetIds()) && androidx.fragment.app.b3.j(transition.getTargetNames()) && androidx.fragment.app.b3.j(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void b(java.lang.Object obj, java.util.ArrayList arrayList) {
        ...
        if (y(transition) || !androidx.fragment.app.b3.j(transition.getTargets())) {
            return;
        }
    ...
    public void p(java.lang.Object obj, android.view.View view, java.util.ArrayList arrayList) {
        ((android.transition.Transition) obj).addListener(new androidx.fragment.app.t2(this, view, arrayList));
    }
    ...
    public void q(java.lang.Object obj, java.lang.Object obj2, java.util.ArrayList arrayList, java.lang.Object obj3, java.util.ArrayList arrayList2, java.lang.Object obj4, java.util.ArrayList arrayList3) {
        ((android.transition.Transition) obj).addListener(new androidx.fragment.app.u2(this, obj2, arrayList, obj3, arrayList2, obj4, arrayList3));
    }

    @Override // androidx.fragment.app.b3
    public void r(java.lang.Object obj, android.graphics.Rect rect) {
        if (obj != null) {
            ((android.transition.Transition) obj).setEpicenterCallback(new androidx.fragment.app.w2(this, rect));
        }
    }
    ...
    public void s(java.lang.Object obj, android.view.View view) {
        if (view != null) {
            ...
            i(view, rect);
            ((android.transition.Transition) obj).setEpicenterCallback(new androidx.fragment.app.s2(this, rect));
        }
    }

    @Override // androidx.fragment.app.b3
    public void t(androidx.fragment.app.Fragment fragment, java.lang.Object obj, j3.h hVar, java.lang.Runnable runnable) {
        ((android.transition.Transition) obj).addListener(new androidx.fragment.app.v2(this, runnable));
    }
    ...
    public void v(java.lang.Object obj, android.view.View view, java.util.ArrayList arrayList) {
        ...
        for (int i17 = 0; i17 < size; i17++) {
            androidx.fragment.app.b3.d(targets, (android.view.View) arrayList.get(i17));
        }
        targets.add(view);
        arrayList.add(view);
