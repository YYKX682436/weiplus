...
public abstract class a0 {
    public static l3.d a(android.widget.TextView textView) {
        ...
        if (i17 >= 28) {
            return new l3.d(androidx.core.widget.y.c(textView));
        }
        ...
        int a17 = androidx.core.widget.v.a(textView);
        int d17 = androidx.core.widget.v.d(textView);
        if (textView.getTransformationMethod() instanceof android.text.method.PasswordTransformationMethod) {
            ...
            if (i17 < 28 || (textView.getInputType() & 15) != 3) {
                boolean z17 = androidx.core.widget.u.b(textView) == 1;
                switch (androidx.core.widget.u.c(textView)) {
                    case 2:
                ...
                byte directionality = java.lang.Character.getDirectionality(androidx.core.widget.y.b(androidx.core.widget.w.a(androidx.core.widget.u.d(textView)))[0].codePointAt(0));
    ...
    public static void b(android.widget.TextView textView, int i17, int i18, int i19, int i27) {
        if (android.os.Build.VERSION.SDK_INT >= 27) {
            androidx.core.widget.x.f(textView, i17, i18, i19, i27);
        } else if (textView instanceof androidx.core.widget.d) {
            ((androidx.core.widget.d) textView).setAutoSizeTextTypeUniformWithConfiguration(i17, i18, i19, i27);
        }
    }
    ...
    public static void c(android.widget.TextView textView, int i17) {
        if (android.os.Build.VERSION.SDK_INT >= 27) {
            androidx.core.widget.x.h(textView, i17);
        } else if (textView instanceof androidx.core.widget.d) {
            ((androidx.core.widget.d) textView).setAutoSizeTextTypeWithDefaults(i17);
        }
    }
    ...
    public static void d(android.widget.TextView textView, int i17) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 28) {
            androidx.core.widget.y.d(textView, i17);
            return;
        }
        android.graphics.Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        int i18 = androidx.core.widget.t.a(textView) ? fontMetricsInt.top : fontMetricsInt.ascent;
    ...
    public static void e(android.widget.TextView textView, int i17) {
        ...
        android.graphics.Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        int i18 = androidx.core.widget.t.a(textView) ? fontMetricsInt.bottom : fontMetricsInt.descent;
        if (i17 > java.lang.Math.abs(i18)) {
    ...
    public static android.view.ActionMode.Callback g(android.widget.TextView textView, android.view.ActionMode.Callback callback) {
        int i17 = android.os.Build.VERSION.SDK_INT;
        return (i17 < 26 || i17 > 27 || (callback instanceof androidx.core.widget.z) || callback == null) ? callback : new androidx.core.widget.z(callback, textView);
    }
}
