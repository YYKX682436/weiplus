...
public abstract class c implements android.view.View.OnTouchListener {
    ...
    public static final int f11084w = android.view.ViewConfiguration.getTapTimeout();

    /* renamed from: d, reason: collision with root package name */
    public final androidx.core.widget.a f11085d;

    /* renamed from: e, reason: collision with root package name */
    public final android.view.animation.Interpolator f11086e;

    /* renamed from: f, reason: collision with root package name */
    public final android.view.View f11087f;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.Runnable f11088g;

    /* renamed from: h, reason: collision with root package name */
    public final float[] f11089h;

    /* renamed from: i, reason: collision with root package name */
    public final float[] f11090i;
    ...
    public c(android.view.View view) {
        androidx.core.widget.a aVar = new androidx.core.widget.a();
        this.f11085d = aVar;
        this.f11086e = new android.view.animation.AccelerateInterpolator();
    ...
    */
    public final float a(int r4, float r5, float r6, float r7) {
        /*
            ...
            android.view.animation.Interpolator r0 = r3.f11086e
            if (r6 >= 0) goto L27
            float r5 = -r5
    ...
    public final float c(float f17, float f18) {
        ...
        int i17 = this.f11091m;
        if (i17 == 0 || i17 == 1) {
            if (f17 < f18) {
                if (f17 >= 0.0f) {
                    return 1.0f - (f17 / f18);
                }
                if (this.f11099u && i17 == 1) {
                    return 1.0f;
                }
            }
    ...
    public final void d() {
        ...
        androidx.core.widget.a aVar = this.f11085d;
        aVar.getClass();
        long currentAnimationTimeMillis = android.view.animation.AnimationUtils.currentAnimationTimeMillis();
        int i18 = (int) (currentAnimationTimeMillis - aVar.f11078e);
        int i19 = aVar.f11075b;
        if (i18 > i19) {
            i17 = i19;
        } else if (i18 >= 0) {
            i17 = i18;
        ...
        aVar.f11082i = i17;
        aVar.f11081h = aVar.a(currentAnimationTimeMillis);
        aVar.f11080g = currentAnimationTimeMillis;
    }
    ...
    */
    public boolean e() {
        /*
            r9 = this;
            androidx.core.widget.a r0 = r9.f11085d
            float r1 = r0.f11077d
            ...
            if (r1 == 0) goto L55
            r3 = r9
            androidx.core.widget.k r3 = (androidx.core.widget.k) r3
            android.widget.ListView r3 = r3.f11103x
            int r4 = r3.getCount()
            r5 = 1
            if (r4 != 0) goto L23
        L21:
        ...
        L55:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.c.e():boolean");
    }
    ...
    */
    public boolean onTouch(android.view.View r8, android.view.MotionEvent r9) {
        ...
        L1e:
            ...
            int r3 = r8.getWidth()
            float r3 = (float) r3
            android.view.View r4 = r7.f11087f
            int r5 = r4.getWidth()
            float r5 = (float) r5
            ...
            androidx.core.widget.a r9 = r7.f11085d
            r9.f11076c = r0
            r9.f11077d = r8
            boolean r8 = r7.f11099u
            if (r8 != 0) goto L7d
            boolean r8 = r7.e()
            if (r8 == 0) goto L7d
            java.lang.Runnable r8 = r7.f11088g
            if (r8 != 0) goto L5f
        ...
        L5f:
            r7.f11099u = r2
            r7.f11097s = r2
            boolean r8 = r7.f11096r
            if (r8 != 0) goto L74
            int r8 = r7.f11092n
            if (r8 <= 0) goto L74
            java.lang.Runnable r9 = r7.f11088g
            long r5 = (long) r8
        ...
        L74:
            java.lang.Runnable r8 = r7.f11088g
            androidx.core.widget.b r8 = (androidx.core.widget.b) r8
            r8.run()
        L7b:
            r7.f11096r = r2
        L7d:
