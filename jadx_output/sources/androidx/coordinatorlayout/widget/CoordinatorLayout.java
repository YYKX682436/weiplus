...
public class CoordinatorLayout extends android.view.ViewGroup implements n3.g0 {
    ...
    public static final java.lang.String f10985y;

    /* renamed from: z, reason: collision with root package name */
    public static final java.lang.Class[] f10986z;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.List f10987d;

    /* renamed from: e, reason: collision with root package name */
    public final x2.e f10988e;

    /* renamed from: f, reason: collision with root package name */
    public final java.util.List f10989f;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.List f10990g;
    ...
    public android.view.View f10995o;

    /* renamed from: p, reason: collision with root package name */
    public android.view.View f10996p;
    ...
    public n3.g3 f10999s;

    /* renamed from: t, reason: collision with root package name */
    public boolean f11000t;

    /* renamed from: u, reason: collision with root package name */
    public android.graphics.drawable.Drawable f11001u;

    /* renamed from: v, reason: collision with root package name */
    public android.view.ViewGroup.OnHierarchyChangeListener f11002v;

    /* renamed from: w, reason: collision with root package name */
    public n3.k0 f11003w;

    /* renamed from: x, reason: collision with root package name */
    public final n3.j0 f11004x;
    ...
    public static abstract class Behavior<V extends android.view.View> {
        ...
        public boolean i(androidx.coordinatorlayout.widget.CoordinatorLayout coordinatorLayout, android.view.View view, android.view.View view2, float f17, float f18, boolean z17) {
            return false;
        }
        ...
        public void l(androidx.coordinatorlayout.widget.CoordinatorLayout coordinatorLayout, android.view.View view, android.view.View view2, int i17, int i18, int[] iArr, int i19) {
            if (i19 == 0) {
                k(coordinatorLayout, view, view2, i17, i18, iArr);
            }
        }
        ...
        public void o(androidx.coordinatorlayout.widget.CoordinatorLayout coordinatorLayout, android.view.View view, android.view.View view2, int i17, int i18, int i19, int i27, int i28) {
            if (i28 == 0) {
                m(coordinatorLayout, view, view2, i17, i18, i19, i27);
            }
        }

        public void p(androidx.coordinatorlayout.widget.CoordinatorLayout coordinatorLayout, android.view.View view, android.view.View view2, android.view.View view3, int i17, int i18) {
        }
        ...
        public boolean u(androidx.coordinatorlayout.widget.CoordinatorLayout coordinatorLayout, android.view.View view, android.view.View view2, android.view.View view3, int i17, int i18) {
            if (i18 == 0) {
                return t(coordinatorLayout, view, view2, view3, i17);
            }
            return false;
        }
    ...
    public static class SavedState extends androidx.customview.view.AbsSavedState {
        public static final android.os.Parcelable.Creator<androidx.coordinatorlayout.widget.CoordinatorLayout.SavedState> CREATOR = new androidx.coordinatorlayout.widget.d();

        /* renamed from: f, reason: collision with root package name */
        public android.util.SparseArray f11005f;
        ...
        public SavedState(android.os.Parcel parcel, java.lang.ClassLoader classLoader) {
            ...
            this.f11005f = new android.util.SparseArray(readInt);
            for (int i17 = 0; i17 < readInt; i17++) {
                this.f11005f.append(iArr[i17], readParcelableArray[i17]);
            }
        }
        ...
        public void writeToParcel(android.os.Parcel parcel, int i17) {
            ...
            android.util.SparseArray sparseArray = this.f11005f;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            android.os.Parcelable[] parcelableArr = new android.os.Parcelable[size];
            for (int i18 = 0; i18 < size; i18++) {
                iArr[i18] = this.f11005f.keyAt(i18);
                parcelableArr[i18] = (android.os.Parcelable) this.f11005f.valueAt(i18);
            }
    ...
    static {
        java.lang.Package r07 = androidx.coordinatorlayout.widget.CoordinatorLayout.class.getPackage();
        f10985y = r07 != null ? r07.getName() : null;
        B = new x2.d();
        f10986z = new java.lang.Class[]{android.content.Context.class, android.util.AttributeSet.class};
    ...
    public CoordinatorLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, com.tencent.mm.R.attr.f478213dr);
    }
    ...
    public boolean B(android.view.View view, android.view.View view2, int i17, int i18) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt.getVisibility() != 8) {
                androidx.coordinatorlayout.widget.c cVar = (androidx.coordinatorlayout.widget.c) childAt.getLayoutParams();
                androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior behavior = cVar.f11006a;
                if (behavior != null) {
    ...
    public final void D() {
        ...
        if (this.f11003w == null) {
            this.f11003w = new x2.a(this);
        }
        n3.a1.u(this, this.f11003w);
        setSystemUiVisibility(1280);
    }

    @Override // android.view.ViewGroup
    public boolean checkLayoutParams(android.view.ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof androidx.coordinatorlayout.widget.c) && super.checkLayoutParams(layoutParams);
    }

    @Override // android.view.ViewGroup
    public boolean drawChild(android.graphics.Canvas canvas, android.view.View view, long j17) {
        androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior behavior = ((androidx.coordinatorlayout.widget.c) view.getLayoutParams()).f11006a;
        if (behavior != null) {
            behavior.getClass();
        }
    ...
    public void drawableStateChanged() {
        ...
        android.graphics.drawable.Drawable drawable = this.f11001u;
        boolean z17 = false;
    ...
    public final void f(androidx.coordinatorlayout.widget.c cVar, android.graphics.Rect rect, int i17, int i18) {
        int width = getWidth();
    ...
    public void g(android.view.View view) {
        java.util.List list = (java.util.List) this.f10988e.f451479b.getOrDefault(view, null);
    ...
    public android.view.ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new androidx.coordinatorlayout.widget.c(-2, -2);
    }

    @Override // android.view.ViewGroup
    public android.view.ViewGroup.LayoutParams generateLayoutParams(android.util.AttributeSet attributeSet) {
        return new androidx.coordinatorlayout.widget.c(getContext(), attributeSet);
    }

    public final java.util.List<android.view.View> getDependencySortedChildren() {
        w();
        return java.util.Collections.unmodifiableList(this.f10987d);
    }

    public final n3.g3 getLastWindowInsets() {
        return this.f10999s;
    }

    @Override // android.view.ViewGroup
    public int getNestedScrollAxes() {
        n3.j0 j0Var = this.f11004x;
    ...
    public void h(android.view.View view, android.view.View view2, int i17, int i18) {
        ...
        this.f11004x.a(view, view2, i17, i18);
        this.f10996p = view2;
        int childCount = getChildCount();
        for (int i19 = 0; i19 < childCount; i19++) {
            android.view.View childAt = getChildAt(i19);
            androidx.coordinatorlayout.widget.c cVar = (androidx.coordinatorlayout.widget.c) childAt.getLayoutParams();
            if (cVar.a(i18) && (behavior = cVar.f11006a) != null) {
    ...
    public java.util.List k(android.view.View view) {
        x.n nVar = this.f10988e.f451479b;
        ...
        java.util.List list = this.f10990g;
    ...
    public void l(android.view.View view, int i17, int i18, int i19, int i27, int i28) {
        ...
        for (int i29 = 0; i29 < childCount; i29++) {
            ...
            if (childAt.getVisibility() != 8) {
                androidx.coordinatorlayout.widget.c cVar = (androidx.coordinatorlayout.widget.c) childAt.getLayoutParams();
                if (cVar.a(i28) && (behavior = cVar.f11006a) != null) {
    ...
    public void m(android.view.View view, android.graphics.Rect rect) {
        java.lang.ThreadLocal threadLocal = x2.f.f451482a;
        rect.set(0, 0, view.getWidth(), view.getHeight());
        java.lang.ThreadLocal threadLocal2 = x2.f.f451482a;
        ...
        java.lang.ThreadLocal threadLocal3 = x2.f.f451483b;
    ...
    public final void n(android.view.View view, int i17, android.graphics.Rect rect, android.graphics.Rect rect2, androidx.coordinatorlayout.widget.c cVar, int i18, int i19) {
        int i27 = cVar.f11008c;
        if (i27 == 0) {
            i27 = 17;
        }
        int absoluteGravity = android.view.Gravity.getAbsoluteGravity(i27, i17);
        int i28 = cVar.f11009d;
        if ((i28 & 7) == 0) {
            i28 |= 8388611;
        }
        if ((i28 & 112) == 0) {
    ...
    public androidx.coordinatorlayout.widget.c o(android.view.View view) {
        androidx.coordinatorlayout.widget.c cVar = (androidx.coordinatorlayout.widget.c) view.getLayoutParams();
        if (!cVar.f11007b) {
            if (view instanceof androidx.coordinatorlayout.widget.a) {
                cVar.b(((androidx.coordinatorlayout.widget.a) view).getBehavior());
                cVar.f11007b = true;
            } else {
                androidx.coordinatorlayout.widget.b bVar = null;
                for (java.lang.Class<?> cls = view.getClass(); cls != null; cls = cls.getSuperclass()) {
                    bVar = (androidx.coordinatorlayout.widget.b) cls.getAnnotation(androidx.coordinatorlayout.widget.b.class);
                    if (bVar != null) {
                        break;
                    }
                }
                if (bVar != null) {
                    try {
                        cVar.b((androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior) bVar.value().getDeclaredConstructor(new java.lang.Class[0]).newInstance(new java.lang.Object[0]));
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f10998r) {
            if (this.f10997q == null) {
                this.f10997q = new x2.c(this);
            }
            getViewTreeObserver().addOnPreDrawListener(this.f10997q);
        }
    ...
    public void onDetachedFromWindow() {
        ...
        y(false);
        if (this.f10998r && this.f10997q != null) {
            getViewTreeObserver().removeOnPreDrawListener(this.f10997q);
        }
        android.view.View view = this.f10996p;
        if (view != null) {
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        super.onDraw(canvas);
        if (!this.f11000t || this.f11001u == null) {
            return;
        }
        n3.g3 g3Var = this.f10999s;
        int e17 = g3Var != null ? g3Var.e() : 0;
        if (e17 > 0) {
            this.f11001u.setBounds(0, 0, getWidth(), e17);
            this.f11001u.draw(canvas);
        }
    }
    ...
    public void onLayout(boolean z17, int i17, int i18, int i19, int i27) {
        ...
        java.util.List list = this.f10987d;
        int size = ((java.util.ArrayList) list).size();
        for (int i28 = 0; i28 < size; i28++) {
            android.view.View view = (android.view.View) ((java.util.ArrayList) list).get(i28);
            if (view.getVisibility() != 8 && ((behavior = ((androidx.coordinatorlayout.widget.c) view.getLayoutParams()).f11006a) == null || !behavior.g(this, view, d17))) {
                s(view, d17);
            }
        }
    }
    ...
    */
    ...
    public boolean onNestedFling(android.view.View view, float f17, float f18, boolean z17) {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt.getVisibility() != 8) {
                androidx.coordinatorlayout.widget.c cVar = (androidx.coordinatorlayout.widget.c) childAt.getLayoutParams();
                if (cVar.a(0) && (behavior = cVar.f11006a) != null) {
    ...
    public void onRestoreInstanceState(android.os.Parcelable parcelable) {
        ...
        android.util.SparseArray sparseArray = savedState.f11005f;
        int childCount = getChildCount();
        for (int i17 = 0; i17 < childCount; i17++) {
            android.view.View childAt = getChildAt(i17);
            int id6 = childAt.getId();
            androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior behavior = o(childAt).f11006a;
    ...
    public android.os.Parcelable onSaveInstanceState() {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            android.view.View childAt = getChildAt(i17);
            int id6 = childAt.getId();
            androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior behavior = ((androidx.coordinatorlayout.widget.c) childAt.getLayoutParams()).f11006a;
            if (id6 != -1 && behavior != null && (s17 = behavior.s(this, childAt)) != null) {
                sparseArray.append(id6, s17);
            }
        }
        savedState.f11005f = sparseArray;
        return savedState;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        /*
            ...
            android.view.View r3 = r0.f10995o
            r4 = 1
            r5 = 0
            if (r3 != 0) goto L15
        ...
        L15:
            r3 = r5
        L16:
            android.view.View r6 = r0.f10995o
            android.view.ViewGroup$LayoutParams r6 = r6.getLayoutParams()
            androidx.coordinatorlayout.widget.c r6 = (androidx.coordinatorlayout.widget.c) r6
            androidx.coordinatorlayout.widget.CoordinatorLayout$Behavior r6 = r6.f11006a
            if (r6 == 0) goto L29
            android.view.View r7 = r0.f10995o
    ...
    */
    ...
    public void setOnHierarchyChangeListener(android.view.ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f11002v = onHierarchyChangeListener;
    }

    public void setStatusBarBackground(android.graphics.drawable.Drawable drawable) {
        android.graphics.drawable.Drawable drawable2 = this.f11001u;
        if (drawable2 != drawable) {
            ...
            if (mutate != null) {
                if (mutate.isStateful()) {
                    this.f11001u.setState(getDrawableState());
                }
                android.graphics.drawable.Drawable drawable3 = this.f11001u;
                java.util.WeakHashMap weakHashMap = n3.l1.f334362a;
                f3.c.b(drawable3, n3.v0.d(this));
                this.f11001u.setVisible(getVisibility() == 0, false);
                this.f11001u.setCallback(this);
            }
    ...
    public void setStatusBarBackgroundColor(int i17) {
        setStatusBarBackground(new android.graphics.drawable.ColorDrawable(i17));
    }

    public void setStatusBarBackgroundResource(int i17) {
        setStatusBarBackground(i17 != 0 ? b3.l.getDrawable(getContext(), i17) : null);
    }
    ...
    public void setVisibility(int i17) {
        ...
        this.f11001u.setVisible(z17, false);
    }
    ...
    public void t(android.view.View view, int i17, int i18, int[] iArr, int i19) {
        ...
        for (int i29 = 0; i29 < childCount; i29++) {
            ...
            if (childAt.getVisibility() != 8) {
                androidx.coordinatorlayout.widget.c cVar = (androidx.coordinatorlayout.widget.c) childAt.getLayoutParams();
                if (cVar.a(i19) && (behavior = cVar.f11006a) != null) {
                    int[] iArr2 = this.f10991h;
                    iArr2[1] = 0;
                    iArr2[0] = 0;
                    behavior.l(this, childAt, view, i17, i18, iArr2, i19);
                    int[] iArr3 = this.f10991h;
    ...
    public final boolean v(android.view.MotionEvent motionEvent, int i17) {
        boolean z17;
        int actionMasked = motionEvent.getActionMasked();
        java.util.ArrayList arrayList = (java.util.ArrayList) this.f10989f;
        arrayList.clear();
    ...
    public boolean verifyDrawable(android.graphics.drawable.Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f11001u;
    }
    ...
    */
    ...
    public final void y(boolean z17) {
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ((androidx.coordinatorlayout.widget.c) getChildAt(i18).getLayoutParams()).f11018m = false;
        }
        this.f10995o = null;
        this.f10992i = false;
    }

    public CoordinatorLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        android.content.res.TypedArray obtainStyledAttributes;
        this.f10987d = new java.util.ArrayList();
        this.f10988e = new x2.e();
        this.f10989f = new java.util.ArrayList();
        this.f10990g = new java.util.ArrayList();
        this.f10991h = new int[2];
        this.f11004x = new n3.j0(this);
        int[] iArr = w2.a.f442273a;
        if (i17 == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, 0, com.tencent.mm.R.style.f494757vf);
        } else {
        ...
        if (resourceId != 0) {
            ...
            this.f10994n = intArray;
            float f17 = resources.getDisplayMetrics().density;
            int length = intArray.length;
            for (int i18 = 0; i18 < length; i18++) {
                this.f10994n[i18] = (int) (r0[i18] * f17);
            }
        }
        this.f11001u = obtainStyledAttributes.getDrawable(1);
    ...
    public android.view.ViewGroup.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams layoutParams) {
        if (layoutParams instanceof androidx.coordinatorlayout.widget.c) {
            return new androidx.coordinatorlayout.widget.c((androidx.coordinatorlayout.widget.c) layoutParams);
        }
        if (layoutParams instanceof android.view.ViewGroup.MarginLayoutParams) {
            return new androidx.coordinatorlayout.widget.c((android.view.ViewGroup.MarginLayoutParams) layoutParams);
        }
        return new androidx.coordinatorlayout.widget.c(layoutParams);
    }
}
