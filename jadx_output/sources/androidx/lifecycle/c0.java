...
public abstract class c0 {
    ...
    public static final java.util.Map f11614a = new java.util.HashMap();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f11615b = new java.util.HashMap();

    public static androidx.lifecycle.j a(java.lang.reflect.Constructor constructor, java.lang.Object obj) {
        try {
            android.support.v4.media.f.a(constructor.newInstance(obj));
            return null;
    ...
    public static int c(java.lang.Class cls) {
        ...
        java.util.HashMap hashMap = (java.util.HashMap) f11614a;
        ...
        if (cls.getCanonicalName() != null) {
            ...
            java.util.Map map = f11615b;
            if (constructor != null) {
                ((java.util.HashMap) map).put(cls, java.util.Collections.singletonList(constructor));
            } else {
                androidx.lifecycle.d dVar = androidx.lifecycle.d.f11616c;
                java.util.HashMap hashMap2 = (java.util.HashMap) dVar.f11618b;
                ...
                if (bool != null) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            if (((androidx.lifecycle.l0) declaredMethods[i18].getAnnotation(androidx.lifecycle.l0.class)) != null) {
                ...
                if (!z17) {
                    ...
                    if (superclass != null && androidx.lifecycle.x.class.isAssignableFrom(superclass)) {
                    ...
                    while (true) {
                        if (i19 < length2) {
                            ...
                            if (cls2 != null && androidx.lifecycle.x.class.isAssignableFrom(cls2)) {
                                if (c(cls2) == 1) {
                                    break;
                                }
                                if (arrayList == null) {
