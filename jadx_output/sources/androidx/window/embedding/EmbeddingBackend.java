...
public interface EmbeddingBackend {
    ...
    void registerRule(androidx.window.embedding.EmbeddingRule embeddingRule);

    void registerSplitListenerForActivity(android.app.Activity activity, java.util.concurrent.Executor executor, m3.a aVar);

    void setSplitRules(java.util.Set<? extends androidx.window.embedding.EmbeddingRule> set);

    void unregisterRule(androidx.window.embedding.EmbeddingRule embeddingRule);

    void unregisterSplitListenerForActivity(m3.a aVar);
}
