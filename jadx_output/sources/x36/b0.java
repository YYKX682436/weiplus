...
public final class b0 implements x36.m {
    ...
    public final x36.k f451654d;

    /* renamed from: e, reason: collision with root package name */
    public boolean f451655e;

    /* renamed from: f, reason: collision with root package name */
    public final x36.h0 f451656f;

    public b0(x36.h0 source) {
        kotlin.jvm.internal.o.g(source, "source");
        this.f451656f = source;
        this.f451654d = new x36.k();
    }
    ...
    public java.lang.String A0(long j17) {
        ...
        long j18 = j17 == com.tencent.wcdb.core.Database.DictDefaultMatchValue ? Long.MAX_VALUE : j17 + 1;
        byte b17 = (byte) 10;
        long a17 = a(b17, 0L, j18);
        x36.k kVar = this.f451654d;
        if (a17 != -1) {
            return y36.a.a(kVar, a17);
        }
        if (j18 < com.tencent.wcdb.core.Database.DictDefaultMatchValue && d(j18) && kVar.c(j18 - 1) == ((byte) 13) && d(1 + j18) && kVar.c(j18) == b17) {
            return y36.a.a(kVar, j18);
        }
        x36.k kVar2 = new x36.k();
        x36.k kVar3 = this.f451654d;
        kVar3.b(kVar2, 0L, java.lang.Math.min(32, kVar3.f451694e));
        throw new java.io.EOFException("\\n not found: limit=" + java.lang.Math.min(kVar.f451694e, j17) + " content=" + kVar2.l().m() + "…");
    }
    ...
    public long B(x36.k sink, long j17) {
        ...
        x36.k kVar = this.f451654d;
        if (kVar.f451694e == 0) {
            if (this.f451656f.B(kVar, 8192) == -1) {
                return -1L;
            }
        }
        return kVar.B(sink, java.lang.Math.min(j17, kVar.f451694e));
    }

    @Override // x36.m
    public x36.o H(long j17) {
        c1(j17);
        return this.f451654d.H(j17);
    }
    ...
    public long a(byte b17, long j17, long j18) {
        ...
        while (j17 < j18) {
            long f17 = this.f451654d.f(b17, j17, j18);
            if (f17 != -1) {
                return f17;
            }
            x36.k kVar = this.f451654d;
            long j19 = kVar.f451694e;
            if (j19 >= j18) {
                return -1L;
            }
            if (this.f451656f.B(kVar, 8192) == -1) {
    ...
    public int b() {
        c1(4L);
        int readInt = this.f451654d.readInt();
    ...
    public boolean d(long j17) {
        ...
        do {
            kVar = this.f451654d;
            if (kVar.f451694e >= j17) {
                return true;
            }
        } while (this.f451656f.B(kVar, 8192) != -1);
        return false;
    }

    @Override // x36.m
    public x36.k getBuffer() {
        return this.f451654d;
    }

    @Override // x36.h0
    public x36.j0 h() {
        return this.f451656f.h();
    }

    @Override // java.nio.channels.Channel
    public boolean isOpen() {
        return !this.f451655e;
    }
    ...
    */
    ...
    public int readInt() {
        c1(4L);
        return this.f451654d.readInt();
    }

    @Override // x36.m
    public long readLong() {
        c1(8L);
        return this.f451654d.readLong();
    }

    @Override // x36.m
    public short readShort() {
        c1(2L);
        return this.f451654d.readShort();
    }
    ...
    public void skip(long j17) {
        ...
        while (j17 > 0) {
            ...
            long min = java.lang.Math.min(j17, kVar.f451694e);
            kVar.skip(min);
            j17 -= min;
        }
    }
