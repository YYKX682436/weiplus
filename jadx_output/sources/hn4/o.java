...
public class o implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ hn4.z f282591d;
    ...
    public void onClick(android.view.View view) {
        ...
        hn4.z zVar = this.f282591d;
        if (zVar.C == fn4.f.MOBILE_NET) {
            ((com.tencent.mm.plugin.topstory.ui.video.TopStoryBaseVideoUI) zVar.getListVideoUIComponent()).G.f264567a = true;
            zVar.A.k4(2);
        }
        if (((com.tencent.mm.plugin.topstory.ui.video.TopStoryBaseVideoUI) zVar.getListVideoUIComponent()).G.b()) {
