...
public class d0 extends fn4.m implements hn4.a {
    ...
    public android.widget.ImageView f282549J;
    public android.widget.ImageView K;
    public final boolean L;

    /* renamed from: h, reason: collision with root package name */
    public fn4.g f282550h;

    /* renamed from: i, reason: collision with root package name */
    public android.widget.FrameLayout f282551i;

    /* renamed from: m, reason: collision with root package name */
    public android.widget.ImageView f282552m;

    /* renamed from: n, reason: collision with root package name */
    public android.view.View f282553n;

    /* renamed from: o, reason: collision with root package name */
    public android.view.View f282554o;

    /* renamed from: p, reason: collision with root package name */
    public android.view.View f282555p;

    /* renamed from: q, reason: collision with root package name */
    public android.view.View f282556q;

    /* renamed from: r, reason: collision with root package name */
    public android.widget.ImageView f282557r;

    /* renamed from: s, reason: collision with root package name */
    public android.widget.TextView f282558s;

    /* renamed from: t, reason: collision with root package name */
    public android.widget.TextView f282559t;

    /* renamed from: u, reason: collision with root package name */
    public android.widget.TextView f282560u;

    /* renamed from: v, reason: collision with root package name */
    public android.view.View f282561v;

    /* renamed from: w, reason: collision with root package name */
    public android.view.View f282562w;

    /* renamed from: x, reason: collision with root package name */
    public android.view.View f282563x;

    /* renamed from: y, reason: collision with root package name */
    public android.view.View f282564y;

    /* renamed from: z, reason: collision with root package name */
    public android.view.View f282565z;
    ...
    @Override // fn4.m
    public fn4.g i() {
        return this.f282550h;
    }

    @Override // fn4.m
    public android.view.View j() {
        return this.f282556q;
    }

    @Override // fn4.m
    public void k(android.view.View view) {
        int id6 = view.getId();
        int id7 = this.f282560u.getId();
        fn4.b bVar = this.f264583d;
        if (id6 == id7) {
            r45.xn6 xn6Var = this.f264584e;
            if (xn6Var == null || com.tencent.mm.sdk.platformtools.t8.K0(xn6Var.f390275z)) {
                return;
            }
            java.lang.String str = this.f264584e.f390275z;
            android.content.Intent intent = new android.content.Intent();
            intent.putExtra("rawUrl", str);
            j45.l.j(bVar.B(), "webview", "com.tencent.mm.plugin.webview.ui.tools.WebViewUI", intent, null);
            if (bVar.I2().f264576e) {
                this.f282550h.getClass();
                bVar.I2().h();
            }
            bVar.o4().d(this.f264584e);
            ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).Ai().a(bVar.r0(), this.f264584e, u(), 1, "");
            return;
        }
        if (view.getId() == this.f282555p.getId()) {
            uu4.a.a(8);
            r(bVar, bVar.B(), this.f282550h, u());
            return;
        }
        if (view.getId() == this.f282554o.getId()) {
            bVar.F2(this.f282554o, u());
            return;
        }
        if (view.getId() != this.F.getId() && view.getId() != this.G.getId()) {
            if (view.getId() == this.f282552m.getId() || view.getId() == this.f282559t.getId() || view.getId() == this.f282561v.getId()) {
                if (fn4.z0.h(this.f264584e, bVar.B())) {
                    ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).Ai().a(bVar.r0(), this.f264584e, u(), 3, "");
                    return;
                }
                return;
            } else {
                if (view.getId() == this.f282556q.getId()) {
                    bVar.U0(this.f264584e, view);
                    if (this.f264584e.R) {
                        this.f282557r.setImageResource(com.tencent.mm.R.raw.top_story_wow_selected);
                        android.widget.TextView textView = this.f282558s;
                        textView.setTextColor(textView.getResources().getColor(com.tencent.mm.R.color.a9b));
                        return;
                    } else {
                        this.f282557r.setImageResource(com.tencent.mm.R.raw.top_story_wow_unselected);
                        android.widget.TextView textView2 = this.f282558s;
        ...
        uu4.a.a(28);
        ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).Ai().a(bVar.r0(), this.f264584e, u(), 4, x56Var.f389796e + ":" + x56Var.f389795d);
    }

    @Override // fn4.m
    public void l(android.view.View view) {
        if ((1 >= com.tencent.mars.xlog.Log.getLogLevel()) && view.getId() == this.f282560u.getId()) {
            this.f264583d.I2().f264579h = true;
        }
        super.l(view);
    }
    ...
    public void n(android.view.View view) {
        this.f282551i = (android.widget.FrameLayout) view.findViewById(com.tencent.mm.R.id.p0y);
        this.f282552m = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.ne8);
        this.f282559t = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.nec);
        this.f282560u = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.odf);
        this.f282561v = view.findViewById(com.tencent.mm.R.id.ne7);
        this.f282555p = view.findViewById(com.tencent.mm.R.id.msx);
        this.f282556q = view.findViewById(com.tencent.mm.R.id.poj);
        this.f282557r = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.poi);
        this.f282558s = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.poh);
        this.f282553n = view.findViewById(com.tencent.mm.R.id.jqz);
        this.f282554o = view.findViewById(com.tencent.mm.R.id.jrb);
        this.A = view.findViewById(com.tencent.mm.R.id.avu);
        this.B = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.au7);
        this.C = view.findViewById(com.tencent.mm.R.id.nvx);
        this.D = view.findViewById(com.tencent.mm.R.id.f487209nw1);
        this.E = view.findViewById(com.tencent.mm.R.id.f487213nw5);
        this.F = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.nvy);
        this.G = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.f487210nw2);
        this.H = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.nw6);
        this.I = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.nvw);
        this.f282549J = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.f487208nw0);
        this.K = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.f487212nw4);
        this.f282563x = view.findViewById(com.tencent.mm.R.id.at7);
        this.f282564y = view.findViewById(com.tencent.mm.R.id.gyv);
        this.f282565z = view.findViewById(com.tencent.mm.R.id.gby);
        this.f282562w = view.findViewById(com.tencent.mm.R.id.gbu);
        if (this.L) {
    ...
    @Override // fn4.m
    public boolean o() {
        return (this.f282565z.getAlpha() == 0.0f || this.f282564y.getAlpha() == 0.0f) ? false : true;
    }

    @Override // fn4.m
    public void p() {
        fn4.b bVar;
        if (com.tencent.mm.sdk.platformtools.t8.K0(this.f264584e.f390255d)) {
            this.f282560u.setVisibility(8);
        } else {
            this.f282560u.setText(this.f264584e.f390255d);
            this.f282560u.setVisibility(0);
            this.f282560u.requestLayout();
        }
        android.widget.TextView textView = this.f282560u;
        android.view.View.OnClickListener onClickListener = this.f264585f;
        textView.setOnClickListener(onClickListener);
        this.f282559t.setText(this.f264584e.f390269t);
        if (fn4.z0.f(this.f264584e)) {
            android.view.View view = this.f282561v;
            java.util.ArrayList arrayList = new java.util.ArrayList();
            java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
            arrayList.add(0);
            java.util.Collections.reverse(arrayList);
            ...
            android.view.View view2 = this.f282561v;
            java.util.ArrayList arrayList2 = new java.util.ArrayList();
            java.lang.ThreadLocal threadLocal2 = zj0.c.f473285a;
            arrayList2.add(8);
            java.util.Collections.reverse(arrayList2);
        ...
        this.f282552m.setOnClickListener(onClickListener);
        this.f282559t.setOnClickListener(onClickListener);
        this.f282561v.setOnClickListener(onClickListener);
        if (com.tencent.mm.sdk.platformtools.t8.K0(this.f264584e.C)) {
            this.f282552m.setImageResource(com.tencent.mm.R.drawable.bhm);
        } else {
            n11.a.b().h(this.f264584e.C, this.f282552m, wm4.u.f447309a);
        }
        fn4.b bVar2 = this.f264583d;
        if (bVar2.H6()) {
            android.view.View view3 = this.f282555p;
            ...
            this.f282555p.setOnClickListener(onClickListener);
        } else {
            android.view.View view4 = this.f282555p;
        ...
        if (bVar2.H4()) {
            this.f282554o.setTag(this.f264584e);
            this.f282554o.setOnClickListener(onClickListener);
            android.view.View view5 = this.f282554o;
            ...
            android.view.View view6 = this.f282553n;
            ...
            android.view.View view7 = this.f282554o;
            ...
            android.view.View view8 = this.f282553n;
        ...
        this.f282554o.setTag(this.f264584e);
        this.f282554o.setOnClickListener(onClickListener);
        this.f282562w.setOnClickListener(onClickListener);
        android.view.View view9 = this.f282563x;
        ...
        android.view.View view10 = this.f282564y;
        ...
        android.view.View view11 = this.f282565z;
        ...
        if (this.f282550h == null) {
            this.f282550h = new hn4.z(bVar2.B(), bVar2, this);
            this.f282551i.removeAllViews();
            android.widget.FrameLayout frameLayout = this.f282551i;
            fn4.g gVar = this.f282550h;
            com.tencent.mars.xlog.Log.i("MicroMsg.TopStory.TopStoryBaseVideoHolder", "lxl getVideoViewLayoutParams: %s, %s", java.lang.Integer.valueOf(bVar2.getVideoWidth()), java.lang.Integer.valueOf(bVar2.getVideoHeight()));
            frameLayout.addView(gVar, new android.widget.FrameLayout.LayoutParams(bVar2.getVideoWidth(), bVar2.getVideoHeight()));
        }
        this.f282550h.q(this.f264584e, u());
        if (bVar2.Y2() == u()) {
            super.m();
        }
        this.B.setText(this.f264584e.f390264p);
        if (!this.L || this.f264584e.D.size() <= 0) {
            bVar = bVar2;
            ...
            r45.x56 x56Var = (r45.x56) this.f264584e.D.get(0);
            this.F.setTag(x56Var);
            this.F.setText(x56Var.f389796e);
            ...
            if (!com.tencent.mm.sdk.platformtools.t8.K0(x56Var.f389802n)) {
                n11.a.b().h(x56Var.f389802n, this.I, wm4.u.f447310b);
                this.I.setVisibility(0);
            }
            if (this.f264584e.D.size() > 1) {
                r45.x56 x56Var2 = (r45.x56) this.f264584e.D.get(1);
                this.G.setTag(x56Var2);
                this.G.setText(x56Var2.f389796e);
                ...
                this.f282549J.setVisibility(8);
                if (!com.tencent.mm.sdk.platformtools.t8.K0(x56Var2.f389802n)) {
                    n11.a.b().h(x56Var2.f389802n, this.f282549J, wm4.u.f447310b);
                    this.f282549J.setVisibility(0);
                }
            } else {
            ...
            if (this.f264584e.D.size() > 2) {
                r45.x56 x56Var3 = (r45.x56) this.f264584e.D.get(2);
                this.H.setTag(x56Var3);
                this.H.setText(x56Var3.f389796e);
                ...
                if (!com.tencent.mm.sdk.platformtools.t8.K0(x56Var3.f389802n)) {
                    n11.a.b().h(x56Var3.f389802n, this.K, wm4.u.f447310b);
        ...
        if ((this.f264584e.L & 128) <= 0) {
            android.view.View view19 = this.f282556q;
        ...
        android.view.View view20 = this.f282556q;
        ...
        this.f282556q.setOnClickListener(onClickListener);
        if (this.f264584e.R) {
            this.f282557r.setImageResource(com.tencent.mm.R.raw.top_story_wow_selected);
            android.widget.TextView textView2 = this.f282558s;
            textView2.setTextColor(textView2.getResources().getColor(com.tencent.mm.R.color.a9b));
        } else {
            this.f282557r.setImageResource(com.tencent.mm.R.raw.top_story_wow_unselected);
            android.widget.TextView textView3 = this.f282558s;
            textView3.setTextColor(textView3.getResources().getColor(com.tencent.mm.R.color.f479549ab0));
        }
        this.f282558s.setText(wm4.u.p(this.f264584e.X));
    }
    ...
    public void t() {
        super.t();
        this.f282565z.animate().cancel();
        this.f282564y.animate().cancel();
        android.view.View view = this.f282565z;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        ...
        android.view.View view2 = this.f282564y;
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
    ...
    public void v() {
        this.f282565z.animate().cancel();
        this.f282564y.animate().cancel();
        this.f282563x.animate().cancel();
        android.view.View view = this.f282563x;
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Float.valueOf(0.0f));
        java.util.Collections.reverse(arrayList);
        ...
        android.view.View view2 = this.f282565z;
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        arrayList2.add(java.lang.Float.valueOf(0.0f));
        java.util.Collections.reverse(arrayList2);
        ...
        android.view.View view3 = this.f282564y;
        java.util.ArrayList arrayList3 = new java.util.ArrayList();
