...
public class q0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ java.lang.String f282596d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.topstory.ui.video.list.TopStoryListVideoUI f282597e;

    public q0(com.tencent.mm.plugin.topstory.ui.video.list.TopStoryListVideoUI topStoryListVideoUI, java.lang.String str) {
        this.f282597e = topStoryListVideoUI;
        this.f282596d = str;
    }

    @Override // java.lang.Runnable
    public void run() {
        com.tencent.mm.plugin.topstory.ui.video.list.TopStoryListVideoUI topStoryListVideoUI = this.f282597e;
        ...
        if (!com.tencent.mars.comm.NetStatusUtil.isNetworkConnected(topStoryListVideoUI)) {
            android.widget.Toast.makeText(topStoryListVideoUI, topStoryListVideoUI.getString(com.tencent.mm.R.string.hsi), 1).show();
            return;
        }
        java.lang.String str = this.f282596d;
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            android.widget.Toast.makeText(topStoryListVideoUI, topStoryListVideoUI.getString(com.tencent.mm.R.string.hsj), 1).show();
        } else {
            android.widget.Toast.makeText(topStoryListVideoUI, str, 1).show();
        }
    }
}
