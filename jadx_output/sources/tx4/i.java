...
public abstract class i {
    public static db5.g4 a(android.content.Context context, java.util.List list) {
        ...
        while (it.hasNext()) {
            ...
            if (rk4Var != null) {
                if (tx4.h.f422687f.containsValue(java.lang.Integer.valueOf(rk4Var.f384967g))) {
        ...
        int i17 = ((r45.rk4) arrayList.get(arrayList.size() - 1)).f384969i;
        ...
        while (it6.hasNext()) {
            ...
            int i19 = rk4Var2.f384969i;
            if (i19 > 0 && i19 <= arrayList2.size()) {
                arrayList2.set(rk4Var2.f384969i - 1, rk4Var2);
            }
        }
        ...
        while (it7.hasNext()) {
            ...
            if (rk4Var3 == null) {
                ...
                g4Var.f(rk4Var3.f384964d, rk4Var3.f384965e + "__" + rk4Var3.f384966f);
            }
        }
        return g4Var;
    }
