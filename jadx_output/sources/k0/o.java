...
public final class o implements k0.v {
    ...
    public long a(a2.k1 textLayoutResult, long j17, int i17, boolean z17, a2.m1 m1Var) {
        ...
        if (m1Var == null) {
            return k0.u.a(k0.u.f302962a, textLayoutResult, j17, new k0.s(textLayoutResult));
        }
        boolean b17 = a2.m1.b(j17);
        long j18 = m1Var.f783a;
        if (b17) {
            return k0.w.a((int) (j17 >> 32), r26.n0.H(textLayoutResult.f765a.f754a), z17, a2.m1.g(j18));
        }
        if (z17) {
