...
public final class m0 implements s1.t0 {
    ...
    public static final k0.m0 f302950a = new k0.m0();
    ...
    public final s1.u0 d(s1.x0 Layout, java.util.List measurables, long j17) {
        ...
        for (int i18 = 0; i18 < size2; i18++) {
            num2 = java.lang.Integer.valueOf(java.lang.Math.max(num2.intValue(), ((s1.o1) arrayList.get(i18)).f402050d));
        }
        int intValue = num2.intValue();
        int size3 = arrayList.size();
        for (int i19 = 0; i19 < size3; i19++) {
            num = java.lang.Integer.valueOf(java.lang.Math.max(num.intValue(), ((s1.o1) arrayList.get(i19)).f402051e));
        }
