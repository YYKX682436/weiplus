...
public class y implements c01.yc {
    ...
    public void O0(com.tencent.mm.modelbase.p0 p0Var) {
        ...
        if (g17 == null || g17.length() == 0) {
            com.tencent.mars.xlog.Log.e("ShakeCardRedDotMsgListener", "onReceiveMsg, ShakeCardRedDotMsg msgContent is null");
        } else {
            ((c34.h0) i95.n0.c(c34.h0.class)).f38198i.post(new d34.x(this, g17, p0Var));
        }
    }
