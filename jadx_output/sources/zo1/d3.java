...
public final class d3 extends com.tencent.mm.ui.contact.o4 implements rd0.z0 {

    /* renamed from: m, reason: collision with root package name */
    public final rd0.a1 f474581m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d3(com.tencent.mm.ui.contact.l4 selectContactUI, rd0.b1 resultFilter) {
    ...
    public com.tencent.mm.ui.contact.item.d a(int i17, int i18) {
        return ((qd0.n0) this.f474581m).f(i17, i18);
    }

    @Override // rd0.z0
    public com.tencent.mm.ui.contact.item.d c(int i17) {
        return ((qd0.n0) this.f474581m).d(i17);
    }

    @Override // rd0.z0
    public com.tencent.mm.ui.contact.item.d d(int i17) {
        return ((qd0.n0) this.f474581m).c(i17);
    }
    ...
    public int getCount() {
        return ((qd0.n0) this.f474581m).f361575z;
    }

    @Override // com.tencent.mm.ui.contact.p4
    public com.tencent.mm.ui.contact.item.d j(int i17) {
        com.tencent.mm.ui.contact.item.d e17 = ((qd0.n0) this.f474581m).e(i17);
    ...
    public void r() {
        ((qd0.n0) this.f474581m).i();
    }

    @Override // com.tencent.mm.ui.contact.o4
    public void s(java.lang.String str, int[] iArr, boolean z17) {
        ((qd0.n0) this.f474581m).g(str, iArr, z17);
    }
}
