...
public final class c {
    ...
    public static eb.c f250691f;

    /* renamed from: a, reason: collision with root package name */
    public final android.content.Context f250692a;

    /* renamed from: b, reason: collision with root package name */
    public android.os.Bundle f250693b;

    /* renamed from: c, reason: collision with root package name */
    public java.lang.reflect.Method f250694c;

    /* renamed from: d, reason: collision with root package name */
    public java.lang.reflect.Method f250695d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.concurrent.atomic.AtomicInteger f250696e = new java.util.concurrent.atomic.AtomicInteger((int) android.os.SystemClock.elapsedRealtime());

    public c(android.content.Context context) {
        this.f250692a = context.getApplicationContext();
    }
    ...
    public final android.os.Bundle c() {
        ...
        android.content.Context context = this.f250692a;
        android.os.Bundle bundle2 = this.f250693b;
        if (bundle2 != null) {
            return bundle2;
        }
        try {
    ...
    public final boolean d(int i17) {
        ...
        try {
            return !(this.f250692a.getResources().getDrawable(i17, null) instanceof android.graphics.drawable.AdaptiveIconDrawable);
    ...
    */
    public final java.lang.String e(android.os.Bundle r12, java.lang.String r13) {
        ...
        Lb:
            ...
            return r3
        L21:
            android.content.Context r2 = r11.f250692a
