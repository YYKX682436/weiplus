...
public class j0 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.bind.ui.BindMContactIntroUI f352294d;

    public j0(com.tencent.mm.plugin.account.bind.ui.BindMContactIntroUI bindMContactIntroUI) {
        this.f352294d = bindMContactIntroUI;
    }
    ...
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        ...
        com.tencent.mm.plugin.account.bind.ui.BindMContactIntroUI bindMContactIntroUI = this.f352294d;
        if (a17) {
