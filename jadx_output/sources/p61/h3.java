...
public class h3 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.bind.ui.BindQQUI f352281d;

    public h3(com.tencent.mm.plugin.account.bind.ui.BindQQUI bindQQUI) {
        this.f352281d = bindQQUI;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        android.content.Intent intent = new android.content.Intent();
        com.tencent.mm.plugin.account.bind.ui.BindQQUI bindQQUI = this.f352281d;
