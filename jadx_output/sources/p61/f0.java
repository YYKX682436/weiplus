...
public class f0 extends android.text.style.ClickableSpan {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.bind.ui.BindLinkedInUI f352244d;

    public f0(com.tencent.mm.plugin.account.bind.ui.BindLinkedInUI bindLinkedInUI) {
        this.f352244d = bindLinkedInUI;
    }
    ...
    public void updateDrawState(android.text.TextPaint textPaint) {
        textPaint.setColor(this.f352244d.getResources().getColor(com.tencent.mm.R.color.f479308vo));
