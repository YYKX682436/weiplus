...
public final class b0 extends x0.c0 {
    ...
    public boolean contains(java.lang.Object obj) {
        return this.f450868d.containsKey(obj);
    }
    ...
    public boolean containsAll(java.util.Collection elements) {
        ...
        while (it.hasNext()) {
            if (!this.f450868d.containsKey(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public java.util.Iterator iterator() {
        ...
        return new x0.w0(l0Var, ((p0.c) l0Var.b().f450901c.entrySet()).iterator());
    }

    @Override // java.util.Set, java.util.Collection
    public boolean remove(java.lang.Object obj) {
        return this.f450868d.remove(obj) != null;
    }
    ...
    public boolean removeAll(java.util.Collection elements) {
        ...
        while (true) {
            boolean z17 = false;
            while (it.hasNext()) {
                if (this.f450868d.remove(it.next()) != null || z17) {
                    z17 = true;
                }
            }
            return z17;
