...
public final class a0 extends x0.c0 {
    ...
    public final boolean contains(java.lang.Object obj) {
        ...
        java.util.Map.Entry element = (java.util.Map.Entry) obj;
        kotlin.jvm.internal.o.g(element, "element");
        return kotlin.jvm.internal.o.b(this.f450868d.get(element.getKey()), element.getValue());
    }
    ...
    public java.util.Iterator iterator() {
        ...
        return new x0.u0(l0Var, ((p0.c) l0Var.b().f450901c.entrySet()).iterator());
    }
    ...
    public final boolean remove(java.lang.Object obj) {
        ...
        java.util.Map.Entry element = (java.util.Map.Entry) obj;
        kotlin.jvm.internal.o.g(element, "element");
        return this.f450868d.remove(element.getKey()) != null;
    }
    ...
    public boolean removeAll(java.util.Collection elements) {
        ...
        while (true) {
            boolean z17 = false;
            while (it.hasNext()) {
                if (this.f450868d.remove(((java.util.Map.Entry) it.next()).getKey()) != null || z17) {
                    z17 = true;
                }
            }
            return z17;
    ...
    public boolean retainAll(java.util.Collection elements) {
        ...
        do {
            ...
            while (true) {
                ...
                if ((linkedHashMap.containsKey(entry2.getKey()) && kotlin.jvm.internal.o.b(linkedHashMap.get(entry2.getKey()), entry2.getValue())) ? false : true) {
