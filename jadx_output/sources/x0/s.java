...
public final class s implements java.lang.Iterable, zz5.a {
    ...
    public static final x0.s f450939h = new x0.s(0, 0, 0, null);

    /* renamed from: d, reason: collision with root package name */
    public final long f450940d;

    /* renamed from: e, reason: collision with root package name */
    public final long f450941e;

    /* renamed from: f, reason: collision with root package name */
    public final int f450942f;

    /* renamed from: g, reason: collision with root package name */
    public final int[] f450943g;
    ...
    public final x0.s d(x0.s bits) {
        ...
        int i17 = this.f450942f;
        if (bits.f450942f == i17 && bits.f450943g == (iArr = this.f450943g)) {
            return new x0.s(this.f450940d & (~bits.f450940d), (~bits.f450941e) & this.f450941e, i17, iArr);
        }
    ...
    public final x0.s e(int i17) {
        int[] iArr;
        int b17;
        int i18 = this.f450942f;
        int i19 = i17 - i18;
        if (i19 >= 0 && i19 < 64) {
            long j17 = 1 << i19;
            long j18 = this.f450941e;
            if ((j18 & j17) != 0) {
                return new x0.s(this.f450940d, j18 & (~j17), i18, this.f450943g);
            }
        } else if (i19 >= 64 && i19 < 128) {
            long j19 = 1 << (i19 - 64);
            long j27 = this.f450940d;
            if ((j27 & j19) != 0) {
                return new x0.s(j27 & (~j19), this.f450941e, i18, this.f450943g);
            }
        } else if (i19 < 0 && (iArr = this.f450943g) != null && (b17 = x0.t.b(iArr, i17)) >= 0) {
            int length = iArr.length - 1;
            if (length == 0) {
                return new x0.s(this.f450940d, this.f450941e, this.f450942f, null);
            }
            ...
            return new x0.s(this.f450940d, this.f450941e, this.f450942f, iArr2);
        }
        return this;
    }
    ...
    public final boolean g(int i17) {
        int[] iArr;
        int i18 = i17 - this.f450942f;
        if (i18 >= 0 && i18 < 64) {
            return ((1 << i18) & this.f450941e) != 0;
        }
        if (i18 >= 64 && i18 < 128) {
            return ((1 << (i18 - 64)) & this.f450940d) != 0;
        }
        if (i18 <= 0 && (iArr = this.f450943g) != null) {
    ...
    public final x0.s h(x0.s bits) {
        ...
        int i17 = this.f450942f;
        if (bits.f450942f == i17 && bits.f450943g == (iArr = this.f450943g)) {
            return new x0.s(this.f450940d | bits.f450940d, this.f450941e | bits.f450941e, i17, iArr);
        }
        if (this.f450943g == null) {
    ...
    public java.util.Iterator iterator() {
        ...
        oVar.f359881g = pz5.f.a(rVar, oVar, oVar);
        return oVar;
    }
    ...
    public final x0.s j(int i17) {
        long j17;
        int i18;
        int i19 = this.f450942f;
        int i27 = i17 - i19;
        long j18 = this.f450941e;
        if (i27 < 0 || i27 >= 64) {
            long j19 = this.f450940d;
            if (i27 < 64 || i27 >= 128) {
                int[] iArr = this.f450943g;
                if (i27 < 128) {
                    if (iArr == null) {
                        return new x0.s(this.f450940d, this.f450941e, i19, new int[]{i17});
                    }
                ...
                long j28 = 1 << (i27 - 64);
                if ((j19 & j28) == 0) {
                    return new x0.s(j19 | j28, this.f450941e, i19, this.f450943g);
                }
            }
        } else {
            long j29 = 1 << i27;
            if ((j18 & j29) == 0) {
                return new x0.s(this.f450940d, j18 | j29, i19, this.f450943g);
            }
        }
        return this;
    }
    ...
    public java.lang.String toString() {
        ...
        kotlin.jvm.internal.o.f(sb8, "fastJoinTo(StringBuilder…form)\n        .toString()");
        sb6.append(sb8);
        sb6.append(']');
        return sb6.toString();
    }
