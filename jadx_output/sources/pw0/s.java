...
public final class s extends gv0.b {
    ...
    public s(yz5.p onItemClickListener) {
        ...
        fVar.f464078b = true;
        fVar.f464077a = true;
        this.f358665h = fVar.a();
    }

    @Override // androidx.recyclerview.widget.f2
    public androidx.recyclerview.widget.k3 onCreateViewHolder(android.view.ViewGroup parent, int i17) {
        kotlin.jvm.internal.o.g(parent, "parent");
        android.view.View inflate = com.tencent.mm.ui.id.b(parent.getContext()).inflate(com.tencent.mm.R.layout.dfm, parent, false);
