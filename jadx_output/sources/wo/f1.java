...
public abstract class f1 {
    ...
    public static final java.lang.Object f447685a = new java.lang.Object();
    ...
    public static wo.d1 a(int i17, android.os.Looper looper) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MMCamera", e17, "opnImpl error, try camera directly, myLooper: %s", android.os.Looper.myLooper());
    ...
    public static android.hardware.Camera d(int i17, android.os.Looper looper) {
        ...
        ((ku5.t0) ku5.t0.f312615d).g(new wo.e1(i17, cameraArr));
        java.lang.Object obj2 = f447685a;
        synchronized (obj2) {
            try {
                if (cameraArr[0] == null) {
                    obj2.wait();
                }
                com.tencent.mars.xlog.Log.i("MicroMsg.MMCamera", "openCamera wait finish");
            } catch (java.lang.Exception e17) {
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.MMCamera", e17, "MMCamera_openLooperNull wait error", new java.lang.Object[0]);
            }
        }
        return cameraArr[0];
    }
