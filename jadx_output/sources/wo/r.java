...
public abstract class r {
    ...
    public static volatile int f447792a = -1;
    ...
    public static int b() {
        ...
        wo.u uVar = wo.v1.f447821a;
        boolean z17 = uVar.f447803a;
        if (z17 && uVar.f447805c == 0) {
            i17 &= -3;
        }
        if (z17 && uVar.f447804b == 0) {
            i17 &= -5;
        }
        int d17 = wo.t.d();
        if (d17 > 16) {
        ...
        int P = com.tencent.mm.sdk.platformtools.t8.P(e(), 0) / 1000;
        com.tencent.mars.xlog.Log.i("MicroMsg.CpuChecker", "nCores: " + d17 + ", nFreq: " + P);
        if (d17 >= 8) {
            P *= 5;
        } else if (d17 >= 4) {
            P *= 2;
        ...
        f447792a = (((d17 << 4) + i17) << 8) + ((i18 > 5 || d17 < 4) ? i18 : 15);
        return f447792a;
    }
    ...
    */
    public static int[] c() {
        ...
        L4d:
            ...
            com.tencent.mars.xlog.Log.e(r6, r4)     // Catch: java.lang.Throwable -> L70
            if (r7 == 0) goto L5f
        ...
        try {
            try {
                ...
                try {
                    ...
                    e17 = e18;
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CpuChecker", e17, "unexpected exception occurred.", new java.lang.Object[0]);
                    com.tencent.mm.sdk.platformtools.t8.v1(bufferedReader);
                    return "0";
                }
    ...
    public static java.lang.String e() {
        ...
        try {
            ...
            try {
                ...
                th6 = th7;
                try {
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CpuChecker", th6, "unexpected exception occurred.", new java.lang.Object[0]);
                    return "0";
                } finally {
                    com.tencent.mm.sdk.platformtools.t8.v1(bufferedReader);
                }
