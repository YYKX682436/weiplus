...
public class j implements java.lang.Runnable {
    ...
    public final /* synthetic */ java.util.List f259659d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.game.luggage.ui.circle.AtSomeoneView f259660e;

    public j(com.tencent.mm.plugin.game.luggage.ui.circle.AtSomeoneView atSomeoneView, java.util.List list) {
        this.f259660e = atSomeoneView;
        this.f259659d = list;
    }

    @Override // java.lang.Runnable
    public void run() {
        java.util.List list = this.f259659d;
        int size = list.size();
        com.tencent.mm.plugin.game.luggage.ui.circle.AtSomeoneView atSomeoneView = this.f259660e;
        if (size > 0) {
        ...
        mVar.f259674d = list.size();
        java.util.LinkedList linkedList = (java.util.LinkedList) mVar.f259675e;
        linkedList.clear();
