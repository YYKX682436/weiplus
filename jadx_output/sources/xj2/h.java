...
public class h extends oj2.o {
    ...
    @Override // oj2.o
    public void a0() {
        android.view.View inflate = com.tencent.mm.ui.id.b(getContext()).inflate(com.tencent.mm.R.layout.dky, (android.view.ViewGroup) this, false);
                                ...
                                if (a28 != null) {
                                    ...
                                    if (a37 != null) {
                                        ...
                                        if (finderFixedTextView != null) {
                                            ...
                                            this.f454841p0 = new lj2.s0(relativeLayout3);
                                            return;
                                        }
    ...
    public final void c0() {
        ...
        if (n()) {
            ...
            if (finderLiveMicHeartText != null) {
                ...
                cVar.f(finderLiveMicHeartText.getId(), 1, 0, 1, i65.a.b(getRoot().getContext(), 4));
            }
        } else {
            ...
            if (finderLiveMicHeartText2 != null) {
                ...
                cVar.f(finderLiveMicHeartText2.getId(), 2, 0, 2, i65.a.b(getRoot().getContext(), 4));
            }
        }
