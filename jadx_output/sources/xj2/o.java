...
public final class o extends wj2.w implements android.view.View.OnClickListener {
    ...
    @Override // wj2.w
    public void R() {
        this.K.f262030a.setBackground(p() ? getContext().getResources().getDrawable(com.tencent.mm.R.drawable.cq6) : getContext().getResources().getDrawable(com.tencent.mm.R.drawable.f481802cq5));
    }
    ...
    public void l(pm2.a widgetMode, xh2.a data) {
        ...
        this.f454856J = data.f454521b.f454553e;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        if (valueOf != null && valueOf.intValue() == id6) {
            if (!zl2.r4.f473950a.w1()) {
                ...
                if (service2 != null) {
                    service2.S(this.f454856J);
                }
            } else if (getPluginAbility().a0().o() && (bindMicData = getBindMicData()) != null && (service = getService()) != null) {
