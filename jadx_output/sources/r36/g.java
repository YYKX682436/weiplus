...
public abstract class g {
    ...
    public static final x36.o f369391a = x36.o.f451696h.a("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.String[] f369392b = {"DATA", "HEADERS", "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", "PING", "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.String[] f369393c = new java.lang.String[64];

    /* renamed from: d, reason: collision with root package name */
    public static final java.lang.String[] f369394d = new java.lang.String[256];

    static {
        int i17 = 0;
        int i18 = 0;
        while (true) {
            java.lang.String[] strArr = f369394d;
        ...
        java.lang.String[] strArr2 = f369393c;
        strArr2[0] = "";
        ...
        for (int i27 = 0; i27 < 3; i27++) {
            int i28 = iArr2[i27];
            int i29 = iArr[0];
            java.lang.String[] strArr3 = f369393c;
            int i37 = i29 | i28;
            strArr3[i37] = strArr3[i29] + '|' + strArr3[i28];
            strArr3[i37 | 8] = strArr3[i29] + '|' + strArr3[i28] + "|PADDED";
        }
        while (true) {
            java.lang.String[] strArr4 = f369393c;
            if (i17 >= strArr4.length) {
                return;
            }
            if (strArr4[i17] == null) {
                strArr4[i17] = f369394d[i17];
            }
            i17++;
        }
    }
