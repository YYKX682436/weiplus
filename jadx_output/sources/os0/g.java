...
public final class g extends os0.a {
    ...
    */
    public g(int r9, int r10, int r11, int r12, int r13, int r14, kotlin.jvm.internal.i r15) {
        /*
    ...
    public void p() {
        ...
        y(true);
        y(false);
        int i17 = this.f347995d / 3;
        android.opengl.GLES20.glViewport(0, i17 + 0, this.f347994c, i17 * 2);
        android.opengl.GLES20.glUseProgram(this.M);
        android.opengl.GLES20.glUniform1i(this.N, 0);
        android.opengl.GLES20.glUniform1f(this.R, this.f347992a);
        android.opengl.GLES20.glUniform1f(this.S, this.f347993b);
        android.opengl.GLES20.glUniform1i(this.P, (this.f347995d / 3) + 0);
        ...
        android.opengl.GLES20.glUniformMatrix4fv(this.O, 1, false, this.f348003l, 0);
        this.f347999h.position(0);
        android.opengl.GLES20.glVertexAttribPointer(0, 2, 5126, false, 0, (java.nio.Buffer) this.f347999h);
        android.opengl.GLES20.glEnableVertexAttribArray(0);
        this.f347998g.position(0);
        android.opengl.GLES20.glVertexAttribPointer(this.T, 2, 5126, false, 0, (java.nio.Buffer) this.f347998g);
        int i18 = this.T;
    ...
    public final void x() {
        com.tencent.mars.xlog.Log.i("RGB2YUVI420RenderProc", "refreshCalculateParams: fullRange " + this.V + ", 709 " + this.W);
    ...
    public final void y(boolean z17) {
        android.opengl.GLES20.glViewport(0, (z17 ? this.f347995d / 6 : 0) + 0, this.f347994c, this.f347995d / 6);
        android.opengl.GLES20.glUseProgram(this.F);
        android.opengl.GLES20.glUniform1i(this.H, 0);
        android.opengl.GLES20.glUniform1i(this.G, (z17 ? this.f347995d / 6 : 0) + 0);
        android.opengl.GLES20.glUniform1f(this.K, this.f347992a);
        android.opengl.GLES20.glUniform1f(this.L, this.f347993b);
        int i17 = this.I;
        if (z17) {
        ...
        android.opengl.GLES20.glUniformMatrix4fv(this.f348021J, 1, false, this.f348003l, 0);
        this.f347999h.position(0);
        android.opengl.GLES20.glVertexAttribPointer(0, 2, 5126, false, 0, (java.nio.Buffer) this.f347999h);
        android.opengl.GLES20.glEnableVertexAttribArray(0);
        this.f347998g.position(0);
