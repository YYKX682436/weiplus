...
public final class l3 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ android.widget.SeekBar f473880d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f473881e;

    public l3(android.widget.SeekBar seekBar, int i17) {
        this.f473880d = seekBar;
        this.f473881e = i17;
    }
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        android.widget.SeekBar seekBar = this.f473880d;
        seekBar.getHitRect(rect);
        float y17 = motionEvent.getY();
        int i17 = rect.top;
        int i18 = this.f473881e;
