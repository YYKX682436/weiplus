...
public final class y0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ java.lang.String f474029d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f474030e;

    public y0(java.lang.String str, android.content.Context context) {
        this.f474029d = str;
        this.f474030e = context;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        java.lang.String str = this.f474029d;
        if (str == null) {
            str = "";
        }
        intent.putExtra("rawUrl", str);
        intent.putExtra("convertActivityFromTranslucent", true);
        j45.l.j(this.f474030e, "webview", ".ui.tools.WebViewUI", intent, null);
