...
public final class a {
    ...
    public static final yb.a f460609a = new yb.a();

    /* renamed from: b, reason: collision with root package name */
    public static final char[] f460610b = {19968, 20108, 19977, 22235, 20116, 20845, 19971, 20843, 20061};

    /* renamed from: c, reason: collision with root package name */
    public static final char[] f460611c = {21313, 30334, 21315, 19975, 20159};
    ...
    public final java.lang.String a(int i17) {
        ...
        if (valueOf.length() == 2) {
            ...
            if (kotlin.jvm.internal.o.b(substring, "1")) {
                str = "十";
                if (i17 % 10 == 0) {
                    return "十";
                }
