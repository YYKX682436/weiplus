...
public final class p implements android.animation.Animator.AnimatorListener {
    ...
    public final /* synthetic */ android.view.View f431702d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.MotionEvent f431703e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ float f431704f;

    public p(android.view.View view, android.view.MotionEvent motionEvent, float f17) {
        this.f431702d = view;
        this.f431703e = motionEvent;
        this.f431704f = f17;
    }
    ...
    public void onAnimationStart(android.animation.Animator animator) {
        android.view.View view = this.f431702d;
        ...
        android.view.View view2 = this.f431702d;
        ...
        android.view.MotionEvent motionEvent = this.f431703e;
        if (motionEvent != null) {
            android.view.View view3 = this.f431702d;
            view3.setTranslationX(0.0f);
            view3.setTranslationY(0.0f);
            view3.getLocationInWindow(new int[2]);
            view3.setTranslationX((motionEvent.getRawX() - r4[0]) - (view3.getWidth() / 2));
            view3.setTranslationY(((motionEvent.getRawY() - r4[1]) - (view3.getHeight() / 2)) + this.f431704f);
        }
        android.view.View view4 = this.f431702d;
