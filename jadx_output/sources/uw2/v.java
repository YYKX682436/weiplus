...
public final class v implements android.animation.Animator.AnimatorListener {
    ...
    public final /* synthetic */ android.view.View f431713d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.MotionEvent f431714e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ float f431715f;

    public v(android.view.View view, android.view.MotionEvent motionEvent, float f17) {
        this.f431713d = view;
        this.f431714e = motionEvent;
        this.f431715f = f17;
    }
    ...
    public void onAnimationStart(android.animation.Animator animator) {
        android.view.View view = this.f431713d;
        ...
        android.view.View view2 = this.f431713d;
        ...
        android.view.MotionEvent motionEvent = this.f431714e;
        if (motionEvent != null) {
            android.view.View view3 = this.f431713d;
            view3.setTranslationX(0.0f);
            view3.setTranslationY(0.0f);
            view3.getLocationInWindow(new int[2]);
            view3.setTranslationX((motionEvent.getRawX() - r4[0]) - (view3.getWidth() / 2));
            view3.setTranslationY(((motionEvent.getRawY() - r4[1]) - (view3.getHeight() / 2)) + this.f431715f);
        }
    }
}
