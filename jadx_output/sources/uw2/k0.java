...
public final class k0 extends rs.k {
    ...
    public void E(androidx.recyclerview.widget.k3 k3Var) {
        ...
        animate.setDuration(200L).alpha(0.0f).translationY(k3Var.itemView.getContext().getResources().getDimension(com.tencent.mm.R.dimen.f479723df)).setStartDelay(0L).setListener(new uw2.j0(this, k3Var, itemView, animate)).start();
    }
