...
public final class y extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ java.util.List f431718d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.ViewGroup f431719e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ in5.s0 f431720f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y(java.util.List list, android.view.ViewGroup viewGroup, in5.s0 s0Var) {
        super(0);
        this.f431718d = list;
        this.f431719e = viewGroup;
        this.f431720f = s0Var;
    }

    @Override // yz5.a
    public java.lang.Object invoke() {
        java.util.List list = this.f431718d;
        android.view.View view = (android.view.View) list.get(2);
        uw2.h0 h0Var = uw2.h0.f431674a;
        if (view != null) {
            this.f431719e.getGlobalVisibleRect(new android.graphics.Rect());
            h0Var.d(view);
        }
        ...
        java.lang.Object systemService = this.f431720f.f293121e.getSystemService("vibrator");
