...
public final class i {
    ...
    public static final ki.i f308101c = new ki.i();

    /* renamed from: a, reason: collision with root package name */
    public static final java.util.ArrayList f308099a = new java.util.ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.ArrayList f308100b = new java.util.ArrayList();
    ...
    public final void b(ki.a callback) {
        ...
        java.util.ArrayList arrayList = f308100b;
        synchronized (arrayList) {
    ...
    public final void c(ki.a callback) {
        kotlin.jvm.internal.o.g(callback, "callback");
        java.util.ArrayList arrayList = f308099a;
        synchronized (arrayList) {
            arrayList.add(callback);
        }
    }
