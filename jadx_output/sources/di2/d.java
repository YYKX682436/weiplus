...
public final class d extends oj2.c {
    ...
    public void R() {
        ...
        e();
        getPluginAbility().a0().b(new di2.a(this));
    ...
    public void Z() {
        ...
        getPluginAbility().a0().b(new di2.c(this));
    ...
    public java.lang.String getTagText() {
        java.lang.String string = getContext().getResources().getString(com.tencent.mm.R.string.d5o);
