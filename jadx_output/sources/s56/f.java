...
public final class f implements p56.i {
    ...
    public static final p56.l f403207d;
    ...
    public static s56.f valueOf(java.lang.String str) {
        return (s56.f) java.lang.Enum.valueOf(s56.f.class, str);
    }

    public static s56.f[] values() {
        return (s56.f[]) f403208e.clone();
    }

    @Override // r56.b
    public void call(java.lang.Object obj) {
        ((p56.r) obj).onCompleted();
    }
}
