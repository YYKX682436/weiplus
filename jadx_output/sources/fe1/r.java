...
public final class r extends fe1.a {
    public static final int CTRL_INDEX = 1578;
    public static final java.lang.String NAME = "issueTransitCard";
    ...
    public void C(com.tencent.mm.plugin.appbrand.jsapi.l env, org.json.JSONObject data, int i17, fe1.v manager) {
            ...
            if (!(optString2.length() == 0)) {
                ...
                if (!(optString3.length() == 0)) {
                    ...
                    if (!(optString4.length() == 0)) {
                        ...
                        com.tencent.mm.plugin.appbrand.jsapi.transitcard.task.IssueCardTask issueCardTask = new com.tencent.mm.plugin.appbrand.jsapi.transitcard.task.IssueCardTask(manager.f261502a, optString, optString2, optString4, optString5, optString3, optString6, optString7);
                        issueCardTask.F(qVar);
                        issueCardTask.d();
                        return;
                    }
                }
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.AppBrand.TransitCard.JsApiIssue", "execute, missing required parameters");
