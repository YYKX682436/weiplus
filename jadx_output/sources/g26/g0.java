...
public final class g0 {
    ...
    public static final g26.g0 f267992a = new g26.g0();
    ...
    */
    ...
    public final f26.z0 b(java.util.List types) {
        ...
        while (it7.hasNext()) {
            ...
            if (d0Var == g26.d0.f267989g) {
                if (z0Var3 instanceof g26.n) {
                    g26.n nVar = (g26.n) z0Var3;
                    kotlin.jvm.internal.o.g(nVar, "<this>");
                    z0Var3 = new g26.n(nVar.f267996e, nVar.f267997f, nVar.f267998g, nVar.f267999h, nVar.f268000i, true);
                }
                kotlin.jvm.internal.o.g(z0Var3, "<this>");
                f26.z0 a18 = f26.u.a(f26.v.f259227g, z0Var3, false, false, 4, null);
        ...
        while (true) {
            ...
            if (!next.isEmpty() || !other.isEmpty()) {
                ...
                while (it10.hasNext()) {
                    ...
                    f26.o1 o1Var = (f26.o1) next.f315227d.get(intValue);
                    f26.o1 o1Var2 = (f26.o1) other.f315227d.get(intValue);
                    if (o1Var == null) {
                        if (o1Var2 != null) {
                            oVar = (f26.o) o1Var2;
                            if (kotlin.jvm.internal.o.b((f26.o) o1Var, oVar)) {
                            }
                        }
                        oVar = null;
                    } else {
                        f26.o oVar2 = (f26.o) o1Var;
                        if (kotlin.jvm.internal.o.b((f26.o) o1Var2, oVar2)) {
                            oVar = oVar2;
                        }
                        oVar = null;
                    }
        ...
        if (linkedHashSet.size() == 1) {
                ...
                while (it11.hasNext()) {
                    ...
                    if (next2 != 0 && z0Var4 != null) {
                        ...
                        if (z17 && (w08 instanceof t16.s)) {
                            ...
                            t16.s sVar2 = new t16.s(sVar.f414622a, sVar.f414623b, kz5.n0.Y0(sVar.f414624c, ((t16.s) w08).f414624c), null);
                            f26.r1.f259214e.getClass();
                            next2 = f26.r0.b(f26.r1.f259215f, sVar2, false);
                        } else if (z17) {
                            if (((t16.s) w07).f414624c.contains(z0Var4)) {
                                next2 = z0Var4;
                            }
                        } else if ((w08 instanceof t16.s) && ((t16.s) w08).f414624c.contains(next2)) {
                        }
                    }
                    next2 = 0;
                }
            ...
            if (z0Var != null) {
                ...
                java.util.Collection a27 = a(a19, new g26.f0(g26.t.f268013b));
