...
public abstract class b {
    public static boolean A(g26.d dVar, i26.i receiver, n16.c fqName) {
        ...
        if (receiver instanceof f26.o0) {
            return ((f26.o0) receiver).getAnnotations().I(fqName);
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static boolean C(g26.d dVar, i26.j a17, i26.j b17) {
        ...
        if (!(a17 instanceof f26.z0)) {
            throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + a17 + ", " + kotlin.jvm.internal.i0.a(a17.getClass())).toString());
        }
        if (b17 instanceof f26.z0) {
            return ((f26.z0) a17).u0() == ((f26.z0) b17).u0();
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + b17 + ", " + kotlin.jvm.internal.i0.a(b17.getClass())).toString());
    }

    public static boolean D(g26.d dVar, i26.m receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.c2) {
            return l06.o.K((f26.c2) receiver, l06.w.f314918b);
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static boolean F(g26.d dVar, i26.m receiver) {
        ...
        if (receiver instanceof f26.c2) {
            ...
            return (!(gVar.f() == o06.t0.f341985e && gVar.j() != o06.h.f341962f) || gVar.j() == o06.h.f341963g || gVar.j() == o06.h.f341964h) ? false : true;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static boolean M(g26.d dVar, i26.m receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.c2) {
            return l06.o.K((f26.c2) receiver, l06.w.f314920c);
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static boolean P(g26.d dVar, i26.d receiver) {
        ...
        if (receiver instanceof g26.n) {
            return ((g26.n) receiver).f268001m;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static i26.j U(g26.d dVar, i26.g receiver) {
        ...
        if (receiver instanceof f26.e0) {
            return ((f26.e0) receiver).f259153e;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static i26.i V(g26.d dVar, i26.d receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof g26.n) {
            return ((g26.n) receiver).f267998g;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static i26.j X(g26.d dVar, i26.e receiver) {
        ...
        if (receiver instanceof f26.v) {
            return ((f26.v) receiver).f259228e;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static int Y(g26.d dVar, i26.m receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.c2) {
            return ((f26.c2) receiver).getParameters().size();
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static boolean a(g26.d dVar, i26.m c17, i26.m c27) {
        ...
        if (!(c17 instanceof f26.c2)) {
            throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + c17 + ", " + kotlin.jvm.internal.i0.a(c17.getClass())).toString());
        }
        if (c27 instanceof f26.c2) {
            return kotlin.jvm.internal.o.b(c17, c27);
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + c27 + ", " + kotlin.jvm.internal.i0.a(c27.getClass())).toString());
    }

    public static i26.l a0(g26.d dVar, i26.c receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof g26.s) {
            return ((g26.s) receiver).f268007a;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static f26.a2 b0(g26.d dVar, i26.j type) {
        ...
        if (type instanceof f26.z0) {
            return new g26.c(dVar, f26.v2.e(f26.f2.f259161b.a((f26.o0) type)));
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + type + ", " + kotlin.jvm.internal.i0.a(type.getClass())).toString());
    }
    ...
    public static i26.d d(g26.d dVar, i26.j receiver) {
        ...
        if (receiver instanceof f26.z0) {
            if (receiver instanceof f26.c1) {
                return dVar.i0(((f26.c1) receiver).f259138e);
            }
            if (receiver instanceof g26.n) {
    ...
    public static i26.c d0(g26.d dVar, i26.d receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof g26.n) {
            return ((g26.n) receiver).f267997f;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static i26.j f0(g26.d dVar, i26.g receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.e0) {
            return ((f26.e0) receiver).f259154f;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    */
    ...
    public static i26.b k(g26.d dVar, i26.d receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof g26.n) {
            return ((g26.n) receiver).f267996e;
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static i26.i l(g26.d dVar, i26.j lowerBound, i26.j upperBound) {
        ...
        if (!(lowerBound instanceof f26.z0)) {
            throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + dVar + ", " + kotlin.jvm.internal.i0.a(dVar.getClass())).toString());
        }
    ...
    public static n16.e o(g26.d dVar, i26.m receiver) {
        ...
        if (receiver instanceof f26.c2) {
            o06.j i17 = ((f26.c2) receiver).i();
            kotlin.jvm.internal.o.e(i17, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
    ...
    public static i26.n p(g26.d dVar, i26.m receiver, int i17) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.c2) {
            java.lang.Object obj = ((f26.c2) receiver).getParameters().get(i17);
    ...
    public static java.util.List q(g26.d dVar, i26.m receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.c2) {
            java.util.List parameters = ((f26.c2) receiver).getParameters();
    ...
    public static i26.i u(g26.d dVar, i26.l receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof f26.l2) {
            return ((f26.l2) receiver).getType().z0();
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
    ...
    public static java.util.List x(g26.d dVar, i26.n receiver) {
        kotlin.jvm.internal.o.g(receiver, "$receiver");
        if (receiver instanceof o06.e2) {
            java.util.List upperBounds = ((o06.e2) receiver).getUpperBounds();
    ...
    public static i26.r z(g26.d dVar, i26.n receiver) {
        ...
        if (receiver instanceof o06.e2) {
            ...
            kotlin.jvm.internal.o.f(q17, "getVariance(...)");
            return i26.p.a(q17);
        }
        throw new java.lang.IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + kotlin.jvm.internal.i0.a(receiver.getClass())).toString());
    }
