...
public final class i extends com.google.protobuf.q5 implements kg.k {

    /* renamed from: d, reason: collision with root package name */
    public kg.f f307554d;

    /* renamed from: e, reason: collision with root package name */
    public kg.a2 f307555e;

    /* renamed from: f, reason: collision with root package name */
    public float f307556f;

    /* renamed from: g, reason: collision with root package name */
    public boolean f307557g;
    ...
    public com.google.protobuf.k8 build() {
        kg.j buildPartial = buildPartial();
    ...
    public kg.j buildPartial() {
        kg.j jVar = new kg.j(this);
        jVar.asset_ = this.f307554d;
        jVar.timeRange_ = this.f307555e;
        jVar.volume_ = this.f307556f;
        jVar.looping_ = this.f307557g;
        onBuilt();
        return jVar;
    }

    public java.lang.Object clone() {
        return (kg.i) m83clone();
    }
    ...
    */
    public kg.i d(com.google.protobuf.d0 r3, com.google.protobuf.t4 r4) {
        /*
            r2 = this;
            r0 = 0
            com.google.protobuf.e9 r1 = kg.j.access$14300()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.y6 -> L13
            java.lang.Object r3 = r1.parsePartialFrom(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.y6 -> L13
            kg.j r3 = (kg.j) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.y6 -> L13
            if (r3 == 0) goto L10
            r2.e(r3)
        L10:
            return r2
    ...
    public kg.i e(kg.j jVar) {
        ...
        if (jVar == kg.j.getDefaultInstance()) {
            return this;
        }
        if (jVar.hasAsset()) {
            kg.f asset = jVar.getAsset();
            kg.f fVar = this.f307554d;
            if (fVar != null) {
                kg.d newBuilder = kg.f.newBuilder(fVar);
                newBuilder.e(asset);
                this.f307554d = newBuilder.buildPartial();
            } else {
                this.f307554d = asset;
            }
            onChanged();
        }
        if (jVar.hasTimeRange()) {
            kg.a2 timeRange = jVar.getTimeRange();
            kg.a2 a2Var = this.f307555e;
            if (a2Var != null) {
                kg.z1 newBuilder2 = kg.a2.newBuilder(a2Var);
                newBuilder2.e(timeRange);
                this.f307555e = newBuilder2.buildPartial();
            } else {
                this.f307555e = timeRange;
            }
            onChanged();
        }
        if (jVar.getVolume() != 0.0f) {
            this.f307556f = jVar.getVolume();
            onChanged();
        }
        if (jVar.getLooping()) {
            this.f307557g = jVar.getLooping();
            onChanged();
        }
    ...
    public com.google.protobuf.k8 getDefaultInstanceForType() {
        return kg.j.getDefaultInstance();
    }
    ...
    public com.google.protobuf.a m84mergeUnknownFields(com.google.protobuf.wa waVar) {
        return (kg.i) m84mergeUnknownFields(waVar);
    }
    ...
    public i(com.google.protobuf.r5 r5Var, kg.b bVar) {
        super(r5Var);
        boolean unused;
        unused = com.google.protobuf.l6.alwaysUseFieldBuilders;
    }
