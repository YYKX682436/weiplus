...
public final class j2 extends com.google.protobuf.q5 implements kg.l2 {

    /* renamed from: d, reason: collision with root package name */
    public float f307563d;

    /* renamed from: e, reason: collision with root package name */
    public float f307564e;

    /* renamed from: f, reason: collision with root package name */
    public float f307565f;

    /* renamed from: g, reason: collision with root package name */
    public float f307566g;
    ...
    public kg.k2 build() {
        kg.k2 buildPartial = buildPartial();
    ...
    public java.lang.Object clone() {
        return (kg.j2) m467clone();
    }

    @Override // com.google.protobuf.n8, com.google.protobuf.j8
    /* renamed from: d, reason: merged with bridge method [inline-methods] */
    public kg.k2 buildPartial() {
        kg.k2 k2Var = new kg.k2(this);
        k2Var.x_ = this.f307563d;
        k2Var.y_ = this.f307564e;
        k2Var.z_ = this.f307565f;
        k2Var.w_ = this.f307566g;
        onBuilt();
        return k2Var;
    }
    ...
    */
    public kg.j2 e(com.google.protobuf.d0 r3, com.google.protobuf.t4 r4) {
        /*
            r2 = this;
            r0 = 0
            com.google.protobuf.e9 r1 = kg.k2.access$2200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.y6 -> L13
            java.lang.Object r3 = r1.parsePartialFrom(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.y6 -> L13
            kg.k2 r3 = (kg.k2) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.y6 -> L13
            if (r3 == 0) goto L10
            r2.f(r3)
        L10:
            return r2
    ...
    public kg.j2 f(kg.k2 k2Var) {
        ...
        if (k2Var == kg.k2.getDefaultInstance()) {
            return this;
        }
        if (k2Var.getX() != 0.0f) {
            this.f307563d = k2Var.getX();
            onChanged();
        }
        if (k2Var.getY() != 0.0f) {
            this.f307564e = k2Var.getY();
            onChanged();
        }
        if (k2Var.getZ() != 0.0f) {
            this.f307565f = k2Var.getZ();
            onChanged();
        }
        if (k2Var.getW() != 0.0f) {
            this.f307566g = k2Var.getW();
            onChanged();
        }
        waVar = ((com.google.protobuf.l6) k2Var).unknownFields;
        onChanged();
        return this;
    }
    ...
    public com.google.protobuf.k8 getDefaultInstanceForType() {
        return kg.k2.getDefaultInstance();
    }
    ...
    public com.google.protobuf.a m468mergeUnknownFields(com.google.protobuf.wa waVar) {
        return (kg.j2) m468mergeUnknownFields(waVar);
    }
    ...
    public j2(com.google.protobuf.r5 r5Var, kg.b bVar) {
        super(r5Var);
        boolean unused;
        unused = com.google.protobuf.l6.alwaysUseFieldBuilders;
    }
