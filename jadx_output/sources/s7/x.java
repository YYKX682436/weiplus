...
public class x {
    ...
    public final s7.h f403887a;

    /* renamed from: b, reason: collision with root package name */
    public final s7.w f403888b;

    /* renamed from: c, reason: collision with root package name */
    public boolean f403889c = false;
    ...
    public static java.util.List c(s7.f fVar) {
        ...
        while (!fVar.f()) {
            ...
            if (!fVar.f()) {
                int i17 = fVar.f403771b;
                java.lang.String str2 = fVar.f403770a;
                ...
                if ((charAt < 'A' || charAt > 'Z') && (charAt < 'a' || charAt > 'z')) {
                    ...
                    str = str2.substring(i17, fVar.f403771b);
                }
            }
            if (str == null) {
                break;
            ...
            try {
                arrayList.add(s7.h.valueOf(str));
    ...
    public static boolean f(s7.s sVar, s7.u uVar, int i17, java.util.List list, int i18, s7.y1 y1Var) {
        s7.v vVar = (s7.v) ((java.util.ArrayList) uVar.f403840a).get(i17);
        if (!i(sVar, vVar, list, i18, y1Var)) {
            return false;
        }
        s7.g gVar = s7.g.DESCENDANT;
        s7.g gVar2 = vVar.f403851a;
        if (gVar2 == gVar) {
            if (i17 == 0) {
                return true;
            }
        ...
        return f(sVar, uVar, i17 - 1, list, i18, (s7.y1) y1Var.f403586b.c().get(a17 - 1));
    }

    public static boolean g(s7.s sVar, s7.u uVar, s7.y1 y1Var) {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.Object obj = y1Var.f403586b;
        while (true) {
            if (obj == null) {
                break;
            }
            arrayList.add(0, obj);
            obj = ((s7.a2) obj).f403586b;
        }
        int size = arrayList.size() - 1;
        java.util.List list = uVar.f403840a;
        if ((list == null ? 0 : ((java.util.ArrayList) list).size()) == 1) {
            return i(sVar, (s7.v) ((java.util.ArrayList) uVar.f403840a).get(0), arrayList, size, y1Var);
        }
        return f(sVar, uVar, (uVar.f403840a != null ? ((java.util.ArrayList) r0).size() : 0) - 1, arrayList, size, y1Var);
    }
    ...
    public static boolean i(s7.s sVar, s7.v vVar, java.util.List list, int i17, s7.y1 y1Var) {
        ...
        java.lang.String str = vVar.f403852b;
        if (str != null && !str.equals(y1Var.n().toLowerCase(java.util.Locale.US))) {
            return false;
        }
        java.util.List list3 = vVar.f403853c;
        if (list3 != null) {
            java.util.Iterator it = ((java.util.ArrayList) list3).iterator();
            while (it.hasNext()) {
                s7.c cVar = (s7.c) it.next();
                java.lang.String str2 = cVar.f403602a;
                str2.getClass();
                boolean equals = str2.equals(dm.i4.COL_ID);
                java.lang.String str3 = cVar.f403604c;
                if (equals) {
                    if (!str3.equals(y1Var.f403898c)) {
                        return false;
                    }
                } else if (!str2.equals("class") || (list2 = y1Var.f403902g) == null || !list2.contains(str3)) {
                    return false;
                }
            }
        }
        java.util.List list4 = vVar.f403854d;
        if (list4 == null) {
            return true;
        }
    ...
    public final void b(s7.t tVar, s7.f fVar) {
        ...
        int i17 = 0;
        if (!this.f403889c && t17.equals("media")) {
            ...
            while (it.hasNext()) {
                ...
                if (hVar == s7.h.all || hVar == this.f403887a) {
                    z17 = true;
                    break;
                }
            }
        ...
        } else if (this.f403889c || !t17.equals("import")) {
                ...
                if (fVar.e("url(")) {
                    ...
                    if (s17 == null) {
                        ...
                        while (!fVar.f()) {
                            ...
                            if (charAt == '\\') {
                                if (!fVar.f()) {
                                    int i27 = fVar.f403771b;
                                    fVar.f403771b = i27 + 1;
                                    charAt = str2.charAt(i27);
                                    if (charAt != '\n' && charAt != '\r' && charAt != '\f') {
                                        int r18 = fVar.r(charAt);
                                        if (r18 != -1) {
                                            for (int i28 = 1; i28 <= 5 && !fVar.f() && (r17 = fVar.r(str2.charAt(fVar.f403771b))) != -1; i28++) {
                                                fVar.f403771b++;
                                                r18 = (r18 * 16) + r17;
                                            }
                                            sb6.append((char) r18);
    ...
    public final boolean d(s7.t tVar, s7.f fVar) {
        ...
        while (it.hasNext()) {
            tVar.a(new s7.r((s7.u) it.next(), r1Var, this.f403888b));
        }
        return true;
    }
