...
public class r3 {
    ...
    public s7.t2 f403814a = null;

    /* renamed from: b, reason: collision with root package name */
    public s7.w1 f403815b = null;

    /* renamed from: c, reason: collision with root package name */
    public boolean f403816c = false;

    /* renamed from: e, reason: collision with root package name */
    public boolean f403818e = false;

    /* renamed from: f, reason: collision with root package name */
    public s7.o3 f403819f = null;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.StringBuilder f403820g = null;

    /* renamed from: h, reason: collision with root package name */
    public boolean f403821h = false;

    /* renamed from: i, reason: collision with root package name */
    public java.lang.StringBuilder f403822i = null;
    ...
    public static void B(s7.c2 c2Var, java.lang.String str) {
        ...
        s7.a0 a0Var = (s7.a0) ((java.util.HashMap) s7.i3.f403683a).get(l17);
        p3Var.q();
        if (p3Var.f()) {
            b0Var = null;
        } else {
        ...
        c2Var.f403617n = new s7.c0(a0Var, b0Var);
    }
    ...
    public static void H(s7.r1 r1Var, java.lang.String str, java.lang.String str2) {
        ...
        if (ordinal == 4) {
            ...
            r1Var.f403789d |= 536870912;
            return;
        }
        try {
            if (ordinal == 5) {
                r1Var.f403802t = p(str2);
                r1Var.f403789d |= 4096;
                return;
            }
            if (ordinal == 8) {
                s7.p1 p1Var = !str2.equals("ltr") ? !str2.equals("rtl") ? null : s7.p1.RTL : s7.p1.LTR;
                r1Var.f403808z = p1Var;
                if (p1Var != null) {
                    r1Var.f403789d |= 68719476736L;
                    return;
                }
                return;
            }
            if (ordinal == 35) {
                r1Var.M = v(str2, str);
                r1Var.f403789d |= 1073741824;
                return;
            }
            if (ordinal == 40) {
                r1Var.f403801s = z(str2);
                r1Var.f403789d |= 2048;
                return;
            }
            if (ordinal == 42) {
                ...
                r1Var.B = bool;
                if (bool != null) {
                    r1Var.f403789d |= 524288;
                    return;
                }
                return;
            }
            if (ordinal == 78) {
                s7.q1 q1Var = !str2.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE) ? !str2.equals("non-scaling-stroke") ? null : s7.q1.NonScalingStroke : s7.q1.None;
                r1Var.S = q1Var;
                if (q1Var != null) {
                    r1Var.f403789d |= 34359738368L;
                    return;
                }
                return;
            }
            s7.k0 k0Var = s7.k0.f403698d;
            if (ordinal == 58) {
                ...
                r1Var.f403789d |= 2147483648L;
                return;
            }
            if (ordinal == 59) {
                r1Var.P = z(str2);
                r1Var.f403789d |= 4294967296L;
                return;
            }
            if (ordinal == 74) {
                switch (str2.hashCode()) {
            ...
            if (ordinal == 75) {
                switch (str2.hashCode()) {
                    ...
                    case -1026963764:
                        ...
                        break;
                    case 3387192:
                        if (str2.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE)) {
                            c19 = 2;
                            break;
                        }
                        c19 = 65535;
                ...
                r1Var.f403807y = o1Var;
                if (o1Var != null) {
                    r1Var.f403789d |= 131072;
                    return;
                }
                return;
            }
            switch (ordinal) {
                case 14:
                    if (str2.indexOf(124) < 0) {
                        if ("|inline|block|list-item|run-in|compact|marker|table|inline-table|table-row-group|table-header-group|table-footer-group|table-row|table-column-group|table-column|table-cell|table-caption|none|".contains("|" + str2 + '|')) {
                            r1Var.G = java.lang.Boolean.valueOf(!str2.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE));
                            r1Var.f403789d |= 16777216;
                            return;
                        }
                        return;
                    }
                    ...
                    if ("|caption|icon|menu|message-box|small-caption|status-bar|".contains("|" + str2 + '|')) {
                        ...
                        while (true) {
                            ...
                            if (num == null || j1Var == null) {
                                if (!m17.equals("normal") && (num != null || (num = (java.lang.Integer) ((java.util.HashMap) s7.l3.f403714a).get(m17)) == null)) {
                            ...
                            try {
                                t0Var2 = (s7.t0) ((java.util.HashMap) s7.k3.f403703a).get(m17);
                                if (t0Var2 == null) {
                                    t0Var2 = w(m17);
                                }
                            } catch (s7.g3 unused) {
                            ...
                            if (p3Var2.f()) {
                                ...
                                int i17 = p3Var2.f403771b;
                                p3Var2.f403771b = p3Var2.f403772c;
                                substring = p3Var2.f403770a.substring(i17);
                            }
                            r1Var.f403803u = t(substring);
                            r1Var.f403804v = t0Var2;
                            r1Var.f403805w = java.lang.Integer.valueOf(num == null ? 400 : num.intValue());
                            if (j1Var == null) {
                                j1Var = s7.j1.Normal;
                            }
                            r1Var.f403806x = j1Var;
                            r1Var.f403789d |= 122880;
                            return;
                        }
                    }
                    return;
                ...
                case 20:
                    try {
                        s7.t0 t0Var3 = (s7.t0) ((java.util.HashMap) s7.k3.f403703a).get(str2);
                        if (t0Var3 == null) {
                            t0Var3 = w(str2);
                        }
                        t0Var = t0Var3;
                    ...
                    r1Var.f403804v = t0Var;
                    if (t0Var != null) {
                        r1Var.f403789d |= 16384;
                        return;
                    }
                    return;
                case 21:
                    java.lang.Integer num2 = (java.lang.Integer) ((java.util.HashMap) s7.l3.f403714a).get(str2);
                    r1Var.f403805w = num2;
                    if (num2 != null) {
                        r1Var.f403789d |= 32768;
                        return;
                    }
                    return;
                case 22:
                ...
                default:
                    switch (ordinal) {
                        ...
                        case 28:
                            ...
                            r1Var.E = v17;
                            r1Var.F = v17;
                            r1Var.f403789d |= 14680064;
                            return;
                        case 29:
                            r1Var.D = v(str2, str);
                            r1Var.f403789d |= 2097152;
                            return;
                        case 30:
                            r1Var.E = v(str2, str);
                            r1Var.f403789d |= 4194304;
                            return;
                        case 31:
                            r1Var.F = v(str2, str);
                            r1Var.f403789d |= 8388608;
                            return;
                        default:
                            switch (ordinal) {
                                case 62:
                                    ...
                                    r1Var.f403789d |= 67108864;
                                    return;
                                case 63:
                                    r1Var.f403788J = z(str2);
                                    r1Var.f403789d |= 134217728;
                                    return;
                                case 64:
                                    s7.b2 A2 = A(str2);
                                    r1Var.f403793h = A2;
                                    ...
                                    return;
                                case 65:
                                    if (com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE.equals(str2)) {
                                        r1Var.f403799q = null;
                                        r1Var.f403789d |= 512;
                                        return;
                                    }
                                ...
                                case 68:
                                    ...
                                    return;
                                case 69:
                                    r1Var.f403798p = java.lang.Float.valueOf(r(str2));
                                    r1Var.f403789d |= 256;
                                    return;
                                case 70:
    ...
    public static s7.j0 p(java.lang.String str) {
        ...
        if (str.charAt(0) == '#') {
            ...
            if (1 < length) {
                ...
                while (i18 < length) {
                    ...
                    j27 = j18 + j19;
                    if (j27 > io.flutter.embedding.android.KeyboardMap.kValueMask) {
                        break;
                    }
                    i18++;
                }
            ...
            long j28 = yVar.f403895b;
            int i19 = yVar.f403894a;
            if (i19 == 4) {
                int i27 = (int) j28;
                int i28 = i27 & 3840;
                int i29 = i27 & 240;
        ...
        if (!startsWith2 && !lowerCase.startsWith("hsl(")) {
            java.lang.Integer num = (java.lang.Integer) ((java.util.HashMap) s7.j3.f403697a).get(lowerCase);
            if (num != null) {
    ...
    public static s7.b2 q(java.lang.String str) {
        ...
        if (str.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE)) {
            return s7.j0.f403690f;
        }
        if (str.equals("currentColor")) {
            return s7.k0.f403698d;
        }
        try {
            return p(str);
        } catch (s7.g3 unused) {
    ...
    public static java.lang.String v(java.lang.String str, java.lang.String str2) {
        if (!str.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE) && str.startsWith("url(")) {
    ...
    public static s7.t0 w(java.lang.String str) {
        ...
        if (charAt == '%') {
            ...
            length -= 2;
            try {
                q2Var = s7.q2.valueOf(str.substring(length).toLowerCase(java.util.Locale.US));
    ...
    public static java.util.List x(java.lang.String str) {
        ...
        while (!p3Var.f()) {
            ...
            if (java.lang.Float.isNaN(i17)) {
                ...
                int i18 = p3Var.f403771b;
                while (true) {
                    boolean f17 = p3Var.f();
                    str2 = p3Var.f403770a;
                    if (f17 || p3Var.g(str2.charAt(p3Var.f403771b))) {
                        break;
                    }
                    p3Var.f403771b++;
                }
                java.lang.String substring = str2.substring(i18, p3Var.f403771b);
                p3Var.f403771b = i18;
    ...
    public final android.graphics.Matrix D(java.lang.String str) {
        ...
        while (!p3Var.f()) {
            ...
            if (!p3Var.f()) {
                int i17 = p3Var.f403771b;
                java.lang.String str3 = p3Var.f403770a;
            ...
            switch (str2.hashCode()) {
                case -1081239615:
                    ...
                    break;
                case -925180581:
                    if (str2.equals(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_VIDEO_ROTATION)) {
                        c17 = 1;
                        break;
                    }
                    break;
    ...
    */
    ...
    public final void I(org.xml.sax.Attributes attributes) {
        s7.w1 w1Var = this.f403815b;
        if (w1Var == null) {
            throw new s7.g3("Invalid document. Root element must be <svg>");
        }
        s7.g1 g1Var = new s7.g1();
        g1Var.f403585a = this.f403814a;
        g1Var.f403586b = w1Var;
        i(g1Var, attributes);
        l(g1Var, attributes);
        this.f403815b.h(g1Var);
        this.f403815b = g1Var;
    }
    ...
    */
    ...
    public final void K(org.xml.sax.Attributes attributes) {
        if (this.f403815b == null) {
            throw new s7.g3("Invalid document. Root element must be <svg>");
        }
        boolean z17 = false;
        java.lang.String str = com.tencent.matrix.battery.accumulate.persist.FlattProperty.PROC_ALL;
        boolean z18 = true;
    ...
    public final void L(java.lang.String str) {
        ...
        if (this.f403818e) {
            if (this.f403820g == null) {
                this.f403820g = new java.lang.StringBuilder(str.length());
            }
            this.f403820g.append(str);
        } else if (this.f403821h) {
            if (this.f403822i == null) {
                this.f403822i = new java.lang.StringBuilder(str.length());
            }
            this.f403822i.append(str);
        } else if (this.f403815b instanceof s7.l2) {
            a(str);
        }
    }
    ...
    public final void M(char[] cArr, int i17, int i18) {
        ...
        if (this.f403818e) {
            if (this.f403820g == null) {
                this.f403820g = new java.lang.StringBuilder(i18);
            }
            this.f403820g.append(cArr, i17, i18);
        } else if (this.f403821h) {
            if (this.f403822i == null) {
                this.f403822i = new java.lang.StringBuilder(i18);
            }
            this.f403822i.append(cArr, i17, i18);
        } else if (this.f403815b instanceof s7.l2) {
    ...
    public final void a(java.lang.String str) {
        s7.u1 u1Var = (s7.u1) this.f403815b;
        int size = u1Var.f403846i.size();
        s7.a2 a2Var = size == 0 ? null : (s7.a2) u1Var.f403846i.get(size - 1);
        if (!(a2Var instanceof s7.p2)) {
            this.f403815b.h(new s7.p2(str));
            return;
        }
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
        s7.p2 p2Var = (s7.p2) a2Var;
        sb6.append(p2Var.f403769c);
        sb6.append(str);
        p2Var.f403769c = sb6.toString();
    }

    public final void c(java.lang.String str, java.lang.String str2, java.lang.String str3) {
        if (this.f403816c) {
            int i17 = this.f403817d - 1;
            this.f403817d = i17;
            if (i17 == 0) {
                this.f403816c = false;
                return;
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || "".equals(str)) {
            ...
            s7.o3 o3Var = (s7.o3) ((java.util.HashMap) s7.o3.f403763h).get(str2);
            if (o3Var == null) {
            ...
            switch (o3Var.ordinal()) {
                ...
                case 26:
                    this.f403818e = false;
                    if (this.f403820g != null) {
                        s7.o3 o3Var2 = this.f403819f;
                        if (o3Var2 == s7.o3.title) {
                            this.f403814a.getClass();
                        } else if (o3Var2 == s7.o3.desc) {
                            this.f403814a.getClass();
                        }
                        this.f403820g.setLength(0);
                        return;
                    }
                    return;
                case 21:
                    java.lang.StringBuilder sb6 = this.f403822i;
                    if (sb6 != null) {
                        this.f403821h = false;
                        java.lang.String sb7 = sb6.toString();
                        s7.x xVar = new s7.x(s7.h.screen, s7.w.Document);
                        s7.t2 t2Var = this.f403814a;
                        s7.f fVar = new s7.f(sb7);
                        fVar.q();
                        t2Var.f403838c.b(xVar.e(fVar));
                        this.f403822i.setLength(0);
                        return;
                    }
                    return;
            }
    ...
    */
    public final void f(org.xml.sax.Attributes r8) {
        /*
            r7 = this;
            s7.w1 r0 = r7.f403815b
            if (r0 == 0) goto Lc2
            s7.w0 r0 = new s7.w0
            r0.<init>()
            s7.t2 r1 = r7.f403814a
            r0.f403585a = r1
            s7.w1 r1 = r7.f403815b
            r0.f403586b = r1
            r7.i(r0, r8)
            r7.l(r0, r8)
            r7.h(r0, r8)
    ...
    public final void i(s7.y1 y1Var, org.xml.sax.Attributes attributes) {
        for (int i17 = 0; i17 < attributes.getLength(); i17++) {
            ...
            if (qName.equals(dm.i4.COL_ID) || qName.equals("xml:id")) {
                y1Var.f403898c = attributes.getValue(i17).trim();
                return;
            }
            if (qName.equals("xml:space")) {
                java.lang.String trim = attributes.getValue(i17).trim();
                if ("default".equals(trim)) {
                    y1Var.f403899d = java.lang.Boolean.FALSE;
                    return;
                } else {
                    if (!"preserve".equals(trim)) {
                        throw new s7.g3("Invalid value for \"xml:space\" attribute: " + trim);
                    }
                    y1Var.f403899d = java.lang.Boolean.TRUE;
                    return;
                }
            }
        }
            ...
            if (ordinal == 23) {
                ...
                if (ordinal != 26) {
                    if (ordinal != 60) {
                        ...
                        try {
                            n0Var.f403732k = s7.o0.valueOf(trim);
                        } catch (java.lang.IllegalArgumentException unused) {
                ...
                n0Var.f403730i = java.lang.Boolean.FALSE;
            } else {
                if (!"userSpaceOnUse".equals(trim)) {
                    throw new s7.g3("Invalid value for attribute gradientUnits");
                }
                n0Var.f403730i = java.lang.Boolean.TRUE;
            }
        }
    }
    ...
    public final void k(s7.d1 d1Var, org.xml.sax.Attributes attributes, java.lang.String str) {
        for (int i17 = 0; i17 < attributes.getLength(); i17++) {
            if (s7.n3.a(attributes.getLocalName(i17)) == s7.n3.points) {
                ...
                d1Var.f403632o = new float[arrayList.size()];
                java.util.Iterator it = arrayList.iterator();
                int i27 = 0;
                while (it.hasNext()) {
                    d1Var.f403632o[i27] = ((java.lang.Float) it.next()).floatValue();
                    i27++;
                }
            }
        }
        ...
        for (int i17 = 0; i17 < attributes.getLength(); i17++) {
            ...
            if (trim.length() != 0) {
                ...
                if (ordinal == 0) {
                    ...
                    y1Var.f403902g = arrayList;
                } else if (ordinal != 72) {
                    if (y1Var.f403900e == null) {
                        y1Var.f403900e = new s7.r1();
                    }
                    H(y1Var.f403900e, attributes.getLocalName(i17), attributes.getValue(i17).trim());
                } else {
                    ...
                    while (!fVar2.f()) {
                        ...
                        if (!fVar2.d(';')) {
                            ...
                            if (u17 != null) {
                                fVar2.q();
                                if (fVar2.f() || fVar2.d(';')) {
                                    if (y1Var.f403901f == null) {
                                        y1Var.f403901f = new s7.r1();
                                    }
                                    H(y1Var.f403901f, t17, u17);
                                    fVar2.q();
                                }
                            }
                        }
    ...
    public final void m(s7.n2 n2Var, org.xml.sax.Attributes attributes) {
        for (int i17 = 0; i17 < attributes.getLength(); i17++) {
            ...
            int ordinal = s7.n3.a(attributes.getLocalName(i17)).ordinal();
            if (ordinal == 9) {
                n2Var.f403740p = x(trim);
            } else if (ordinal == 10) {
                n2Var.f403741q = x(trim);
            } else if (ordinal == 82) {
                n2Var.f403738n = x(trim);
            } else if (ordinal == 83) {
                n2Var.f403739o = x(trim);
            }
        }
    }
    ...
    public final void o(s7.e2 e2Var, org.xml.sax.Attributes attributes) {
        for (int i17 = 0; i17 < attributes.getLength(); i17++) {
            ...
            if (ordinal == 48) {
                ...
                e2Var.f403640o = new s7.f0(i18, i19, i27, i28);
            }
        }
    }
}
