...
public class a1 implements s7.b1 {
    ...
    public int f403582b = 0;

    /* renamed from: d, reason: collision with root package name */
    public int f403584d = 0;

    /* renamed from: a, reason: collision with root package name */
    public byte[] f403581a = new byte[8];

    /* renamed from: c, reason: collision with root package name */
    public float[] f403583c = new float[16];

    @Override // s7.b1
    public void a(float f17, float f18) {
        f((byte) 0);
        g(2);
        float[] fArr = this.f403583c;
        int i17 = this.f403584d;
        int i18 = i17 + 1;
        fArr[i17] = f17;
        this.f403584d = i18 + 1;
        fArr[i18] = f18;
    ...
    public final void f(byte b17) {
        int i17 = this.f403582b;
        byte[] bArr = this.f403581a;
        if (i17 == bArr.length) {
            byte[] bArr2 = new byte[bArr.length * 2];
            java.lang.System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
            this.f403581a = bArr2;
        }
        byte[] bArr3 = this.f403581a;
        int i18 = this.f403582b;
        this.f403582b = i18 + 1;
        bArr3[i18] = b17;
    }
    ...
    public final void g(int i17) {
        float[] fArr = this.f403583c;
        if (fArr.length < this.f403584d + i17) {
    ...
    public void h(s7.b1 b1Var) {
        int i17;
        int i18 = 0;
        for (int i19 = 0; i19 < this.f403582b; i19++) {
            byte b17 = this.f403581a[i19];
            if (b17 == 0) {
                float[] fArr = this.f403583c;
                int i27 = i18 + 1;
                i17 = i27 + 1;
