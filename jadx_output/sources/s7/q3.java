...
public class q3 implements org.xml.sax.Attributes {
    ...
    public final org.xmlpull.v1.XmlPullParser f403784a;

    public q3(s7.r3 r3Var, org.xmlpull.v1.XmlPullParser xmlPullParser) {
        this.f403784a = xmlPullParser;
    }
    ...
    public int getLength() {
        return this.f403784a.getAttributeCount();
    }

    @Override // org.xml.sax.Attributes
    public java.lang.String getLocalName(int i17) {
        return this.f403784a.getAttributeName(i17);
    }

    @Override // org.xml.sax.Attributes
    public java.lang.String getQName(int i17) {
        org.xmlpull.v1.XmlPullParser xmlPullParser = this.f403784a;
    ...
    public java.lang.String getURI(int i17) {
        return this.f403784a.getAttributeNamespace(i17);
    }
    ...
    public java.lang.String getValue(int i17) {
        return this.f403784a.getAttributeValue(i17);
    }
}
