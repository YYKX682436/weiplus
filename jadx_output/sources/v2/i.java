...
public class i {
    ...
    public boolean f432650a0;

    /* renamed from: b0, reason: collision with root package name */
    public boolean f432652b0;

    /* renamed from: c, reason: collision with root package name */
    public v2.p f432653c;

    /* renamed from: c0, reason: collision with root package name */
    public boolean f432654c0;

    /* renamed from: d, reason: collision with root package name */
    public v2.p f432655d;

    /* renamed from: d0, reason: collision with root package name */
    public int f432656d0;

    /* renamed from: e0, reason: collision with root package name */
    public int f432658e0;

    /* renamed from: f0, reason: collision with root package name */
    public final float[] f432660f0;

    /* renamed from: g0, reason: collision with root package name */
    public final v2.i[] f432662g0;

    /* renamed from: h0, reason: collision with root package name */
    public final v2.i[] f432664h0;

    /* renamed from: s, reason: collision with root package name */
    public final v2.g f432675s;

    /* renamed from: t, reason: collision with root package name */
    public final v2.g f432676t;

    /* renamed from: u, reason: collision with root package name */
    public final v2.g f432677u;

    /* renamed from: v, reason: collision with root package name */
    public final v2.g f432678v;

    /* renamed from: w, reason: collision with root package name */
    public final v2.g f432679w;

    /* renamed from: x, reason: collision with root package name */
    public final v2.g f432680x;

    /* renamed from: y, reason: collision with root package name */
    public final v2.g f432681y;

    /* renamed from: z, reason: collision with root package name */
    public final v2.g f432682z;

    /* renamed from: a, reason: collision with root package name */
    public int f432649a = -1;

    /* renamed from: b, reason: collision with root package name */
    public int f432651b = -1;

    /* renamed from: e, reason: collision with root package name */
    public int f432657e = 0;

    /* renamed from: f, reason: collision with root package name */
    public int f432659f = 0;

    /* renamed from: g, reason: collision with root package name */
    public final int[] f432661g = new int[2];

    /* renamed from: h, reason: collision with root package name */
    public int f432663h = 0;

    /* renamed from: i, reason: collision with root package name */
    public int f432665i = 0;

    /* renamed from: j, reason: collision with root package name */
    public float f432666j = 1.0f;

    /* renamed from: k, reason: collision with root package name */
    public int f432667k = 0;

    /* renamed from: l, reason: collision with root package name */
    public int f432668l = 0;

    /* renamed from: m, reason: collision with root package name */
    public float f432669m = 1.0f;

    /* renamed from: n, reason: collision with root package name */
    public int f432670n = -1;

    /* renamed from: o, reason: collision with root package name */
    public float f432671o = 1.0f;

    /* renamed from: p, reason: collision with root package name */
    public v2.k f432672p = null;

    /* renamed from: q, reason: collision with root package name */
    public final int[] f432673q = {Integer.MAX_VALUE, Integer.MAX_VALUE};

    /* renamed from: r, reason: collision with root package name */
    public float f432674r = 0.0f;
    ...
    public i() {
        ...
        this.Y = 0;
        this.Z = null;
        this.f432650a0 = false;
        this.f432652b0 = false;
        this.f432654c0 = false;
        this.f432656d0 = 0;
        this.f432658e0 = 0;
        this.f432660f0 = new float[]{-1.0f, -1.0f};
        this.f432662g0 = new v2.i[]{null, null};
        this.f432664h0 = new v2.i[]{null, null};
        arrayList.add(gVar);
        arrayList.add(gVar2);
        arrayList.add(gVar3);
        arrayList.add(gVar4);
    ...
    */
    ...
    public void c(int i17) {
        ...
        for (int i27 = 0; i27 < 6; i27++) {
            v2.o oVar = this.A[i27].f432634a;
            v2.g gVar = oVar.f432717c;
            v2.g gVar2 = gVar.f432637d;
            if (gVar2 != null) {
                v2.g gVar3 = gVar2.f432637d;
        ...
        v2.o oVar3 = gVar4.f432634a;
        v2.g gVar5 = this.f432676t;
        v2.o oVar4 = gVar5.f432634a;
        v2.g gVar6 = this.f432677u;
        v2.o oVar5 = gVar6.f432634a;
        v2.g gVar7 = this.f432678v;
        v2.o oVar6 = gVar7.f432634a;
        boolean z17 = (i17 & 8) == 8;
        v2.h[] hVarArr = this.C;
        v2.h hVar = hVarArr[0];
        v2.h hVar2 = v2.h.MATCH_CONSTRAINT;
        boolean z18 = hVar == hVar2 && v2.n.a(this, 0);
        int i28 = oVar3.f432722h;
        v2.h hVar3 = v2.h.FIXED;
        if (i28 != 4 && oVar5.f432722h != 4) {
            if (hVarArr[0] == hVar3 || (z18 && this.Y == 8)) {
                v2.g gVar8 = gVar4.f432637d;
                if (gVar8 == null && gVar6.f432637d == null) {
                    i19 = 1;
                    oVar3.f432722h = 1;
                    oVar5.f432722h = 1;
                    if (z17) {
                    ...
                    if (gVar8 != null && gVar6.f432637d == null) {
                    ...
                    } else if (gVar8 == null && gVar6.f432637d != null) {
                        oVar3.f432722h = 1;
                        oVar5.f432722h = 1;
                        oVar3.h(oVar5, -l());
                        if (z17) {
                        ...
                        if (z17) {
                            ...
                            k().a(oVar5);
                            v2.p k17 = k();
                            oVar3.f432723i = oVar5;
                            oVar3.f432726l = k17;
                            v2.p k18 = k();
                            oVar5.f432723i = oVar3;
                            oVar5.f432726l = k18;
                        } else {
                            oVar3.f432723i = oVar5;
                            oVar5.f432723i = oVar3;
                ...
                if (oVar4.f432722h != 4 || oVar6.f432722h == 4) {
                }
                v2.h hVar4 = hVarArr[i18];
                v2.g gVar9 = this.f432679w;
                if (hVar4 != hVar3 && (i29 == 0 || this.Y != 8)) {
                    if (i29 != 0) {
                        int h17 = h();
                        oVar4.f432722h = i18;
                        oVar6.f432722h = i18;
                        v2.g gVar10 = gVar5.f432637d;
                        if (gVar10 == null && gVar7.f432637d == null) {
                            if (z17) {
                                oVar6.i(oVar4, i18, j());
                                return;
                            } else {
                        ...
                        if (this.G == 0.0f) {
                            oVar4.f432722h = 3;
                            oVar6.f432722h = 3;
                            oVar4.f432723i = oVar6;
                            oVar6.f432723i = oVar4;
                            return;
                        }
                        oVar4.f432722h = 2;
                        oVar6.f432722h = 2;
                ...
                int i38 = i18;
                v2.g gVar11 = gVar5.f432637d;
                if (gVar11 == null && gVar7.f432637d == null) {
                    oVar4.f432722h = i38;
                    oVar6.f432722h = i38;
                    if (z17) {
                        oVar6.i(oVar4, i38, j());
                    ...
                    if (gVar9.f432637d != null) {
                        v2.o oVar7 = gVar9.f432634a;
                        oVar7.f432722h = i38;
                ...
                if (gVar11 != null && gVar7.f432637d == null) {
                    ...
                    int i39 = this.Q;
                    if (i39 > 0) {
                        gVar9.f432634a.g(i38, oVar4, i39);
                        return;
                    }
                    return;
                }
            ...
            if (z18) {
                ...
                oVar3.f432722h = 1;
                oVar5.f432722h = 1;
                v2.g gVar12 = gVar4.f432637d;
                if (gVar12 == null && gVar6.f432637d == null) {
                    if (z17) {
                        oVar5.i(oVar3, 1, k());
                    } else {
                        oVar5.h(oVar3, l17);
                    }
                } else if (gVar12 == null || gVar6.f432637d != null) {
                    if (gVar12 != null || gVar6.f432637d == null) {
                        if (gVar12 != null && gVar6.f432637d != null) {
                            if (z17) {
                                k().a(oVar3);
    ...
    */
    ...
    public void e(u2.f fVar) {
        fVar.j(this.f432675s);
        fVar.j(this.f432676t);
        fVar.j(this.f432677u);
        fVar.j(this.f432678v);
        if (this.Q > 0) {
            fVar.j(this.f432679w);
        }
    }
    ...
    public v2.g f(v2.f fVar) {
        switch (fVar) {
            case NONE:
                return null;
            case LEFT:
                return this.f432675s;
            case TOP:
                return this.f432676t;
            case RIGHT:
                return this.f432677u;
            case BOTTOM:
                return this.f432678v;
            case BASELINE:
                return this.f432679w;
            case CENTER:
                return this.f432682z;
            case CENTER_X:
                return this.f432680x;
            case CENTER_Y:
                return this.f432681y;
            default:
    ...
    public v2.p j() {
        if (this.f432655d == null) {
            this.f432655d = new v2.p();
        }
        return this.f432655d;
    }

    public v2.p k() {
        if (this.f432653c == null) {
            this.f432653c = new v2.p();
        }
        return this.f432653c;
    }
    ...
    public final boolean n(int i17) {
        ...
        v2.g gVar4 = gVar3.f432637d;
        return (gVar4 == null || gVar4.f432637d == gVar3 || (gVar2 = (gVar = gVarArr[i18 + 1]).f432637d) == null || gVar2.f432637d != gVar) ? false : true;
    }

    public boolean o() {
        return this.f432675s.f432634a.f432729b == 1 && this.f432677u.f432634a.f432729b == 1 && this.f432676t.f432634a.f432729b == 1 && this.f432678v.f432634a.f432729b == 1;
    }
    ...
    public void p() {
        ...
        this.f432656d0 = 0;
        this.f432658e0 = 0;
        float[] fArr = this.f432660f0;
        fArr[0] = -1.0f;
        fArr[1] = -1.0f;
        this.f432649a = -1;
        this.f432651b = -1;
        int[] iArr = this.f432673q;
        ...
        this.f432666j = 1.0f;
        this.f432669m = 1.0f;
        this.f432665i = Integer.MAX_VALUE;
        this.f432668l = Integer.MAX_VALUE;
        this.f432663h = 0;
        this.f432667k = 0;
        this.f432670n = -1;
        this.f432671o = 1.0f;
        v2.p pVar = this.f432653c;
        if (pVar != null) {
            pVar.f();
        }
        v2.p pVar2 = this.f432655d;
        if (pVar2 != null) {
            pVar2.f();
        }
        this.f432672p = null;
    ...
    public void q() {
        for (int i17 = 0; i17 < 6; i17++) {
            this.A[i17].f432634a.j();
        }
    }

    public void r(u2.c cVar) {
        this.f432675s.e(cVar);
        this.f432676t.e(cVar);
        this.f432677u.e(cVar);
        this.f432678v.e(cVar);
        this.f432679w.e(cVar);
        this.f432682z.e(cVar);
        this.f432680x.e(cVar);
        this.f432681y.e(cVar);
    }
    ...
    public void z(u2.f fVar) {
        int i17;
        int i18;
        int m17 = fVar.m(this.f432675s);
        int m18 = fVar.m(this.f432676t);
        int m19 = fVar.m(this.f432677u);
        int m27 = fVar.m(this.f432678v);
        int i19 = m27 - m18;
