...
public abstract class s extends p16.v implements p16.i0 {
    ...
    public final p16.n f351343d;

    public s() {
        this.f351343d = new p16.n();
    }

    public boolean d() {
        int i17 = 0;
        while (true) {
            p16.n nVar = this.f351343d;
            ...
            if (!nVar.f((java.util.Map.Entry) w0Var.f351365e.get(i17))) {
                return false;
            }
            i17++;
        }
    ...
    public final java.lang.Object f(p16.u uVar) {
        k(uVar);
        p16.n nVar = this.f351343d;
        p16.t tVar = uVar.f351356d;
        java.lang.Object e17 = nVar.e(tVar);
        if (e17 == null) {
            return uVar.f351354b;
        }
        if (!tVar.f351348f) {
            return uVar.a(e17);
        }
        if (tVar.f351347e.f351290d != p16.h1.ENUM) {
            return e17;
        }
    ...
    public final boolean g(p16.u uVar) {
        ...
        return nVar.f351324a.get(tVar) != null;
    }
    ...
    */
    ...
    public final void k(p16.u uVar) {
        if (uVar.f351353a != getDefaultInstanceForType()) {
