...
public class b implements c8.d {
                ...
                while (true) {
                    ...
                    if (i27 < 5) {
                        for (java.lang.String str3 : strArr) {
                            java.lang.String str4 = com.tencent.tinker.loader.shareutil.ShareConstants.SO_PATH + java.io.File.separatorChar + str3 + java.io.File.separatorChar + str;
    ...
    public final java.lang.String[] c(android.content.Context context, java.lang.String str) {
        java.util.regex.Pattern compile = java.util.regex.Pattern.compile(com.tencent.tinker.loader.shareutil.ShareConstants.SO_PATH + java.io.File.separatorChar + "([^\\" + java.io.File.separatorChar + "]*)" + java.io.File.separatorChar + str);
