...
public final class x extends eg2.c0 {
    ...
    public final jz5.g f252644g;

    /* renamed from: h, reason: collision with root package name */
    public android.widget.TextView f252645h;
    ...
    public x(ju3.d0 status, android.view.ViewGroup parent, qc0.a editContext) {
        ...
        this.f252644g = jz5.h.b(new eg2.w(parent));
    }

    @Override // yt3.r2
    public void onAttach() {
        com.tencent.mars.xlog.Log.i("MicroMsg.FinderCoverPreviewBtnPlugin", "onAttach");
        qc0.a aVar = this.f252546f;
        int i17 = aVar.f361351f;
        ...
        android.view.View findViewById2 = viewGroup.findViewById(aVar.f361352g);
        ...
        if (this.f252645h == null) {
            android.widget.RelativeLayout relativeLayout = (android.widget.RelativeLayout) viewGroup.findViewById(aVar.f361350e);
            if (relativeLayout == null) {
                return;
            }
            android.widget.TextView textView = (android.widget.TextView) viewGroup.findViewById(aVar.f361353h);
            ...
            this.f252645h = textView2;
            android.widget.RelativeLayout.LayoutParams layoutParams = new android.widget.RelativeLayout.LayoutParams(-2, -2);
            layoutParams.addRule(21);
            relativeLayout.addView(textView2, layoutParams);
        }
        android.widget.TextView textView3 = this.f252645h;
        if (textView3 != null) {
            textView3.setVisibility(0);
        }
        jz5.g gVar = this.f252644g;
        ((hk0.u0) ((jz5.n) gVar).getValue()).Z6(2, new eg2.r(this));
        ((hk0.u0) ((jz5.n) gVar).getValue()).Z6(3, new eg2.s(this));
        ((hk0.u0) ((jz5.n) gVar).getValue()).Z6(4, new eg2.t(this));
        ((hk0.u0) ((jz5.n) gVar).getValue()).a7(1, new eg2.u(this));
    }

    @Override // yt3.r2
    public void onDetach() {
        com.tencent.mars.xlog.Log.i("MicroMsg.FinderCoverPreviewBtnPlugin", "onDetach");
        android.widget.TextView textView = this.f252645h;
        if (textView == null) {
            return;
        }
