...
public abstract class w implements a0.s1 {
    ...
    public final void f(g1.i drawStateLayer, float f17, long j17) {
        ...
        if (floatValue > 0.0f) {
            ...
            long b19 = bVar.b();
            bVar.a().c();
            ((g1.d) bVar.f267504a).a(0.0f, 0.0f, d17, b18, 1);
            g1.h.b(drawStateLayer, b17, a17, 0L, 0.0f, null, null, 0, 124, null);
            bVar.a().b();
            bVar.c(b19);
        }
