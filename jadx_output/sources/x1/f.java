...
public abstract class f {
    public static final h1.c a(int i17, n0.o oVar, int i18) {
        ...
        if (charSequence != null && r26.n0.F(charSequence, ".xml", false, 2, null)) {
            ...
            y0Var.U(2112503116);
            x1.e eVar = (x1.e) y0Var.i(androidx.compose.ui.platform.a1.f10504c);
            x1.d dVar = new x1.d(theme, i17);
            eVar.getClass();
            java.util.HashMap hashMap = eVar.f451347a;
            ...
            if (cVar == null) {
                ...
                kotlin.jvm.internal.o.f(xml, "res.getXml(id)");
                j1.c.b(xml);
                if (!kotlin.jvm.internal.o.b(xml.getName(), "vector")) {
            ...
            y0Var.o(false);
            aVar = i1.c2.b(cVar.f451343a, y0Var, 0);
            y0Var.o(false);
        } else {
            y0Var.U(-738265196);
            ...
            if (e17 || y18 == obj) {
                ...
                kotlin.jvm.internal.o.f(bitmap, "res.getDrawable(id, null…as BitmapDrawable).bitmap");
                y18 = e1.e.b(bitmap);
                y0Var.g0(y18);
            }
            y0Var.o(false);
