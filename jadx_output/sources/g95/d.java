...
public final class d {
    ...
    public final boolean a() {
        ...
        g18.d(linkedList2);
        g18.b(linkedList3);
        return g18.a().h(gm0.j1.u().f273153f);
    }
    ...
    public final java.util.List b(java.util.List usernameList) {
        ...
        for (java.util.List list : d75.b.c(usernameList, 100)) {
            ...
            g17.f352657d = dVar.l(list).c(dm.e2.U1.g(8, 0));
            hashSet.addAll(kz5.n0.X0(g17.a().l(gm0.j1.u().f273153f)));
        }
    ...
    public final long c(java.lang.String username) {
        ...
        g17.d(linkedList2);
        g17.b(linkedList3);
        return g17.a().n(gm0.j1.u().f273153f);
    }
    ...
    public final java.util.List d(java.util.List usernameList) {
        ...
        for (java.util.List list : d75.b.c(usernameList, 100)) {
            ...
            for (com.tencent.mm.storage.z3 z3Var : g17.a().k(gm0.j1.u().f273153f, com.tencent.mm.storage.z3.class)) {
            ...
            while (it.hasNext()) {
                com.tencent.mm.storage.z3 z3Var2 = (com.tencent.mm.storage.z3) hashMap.get((java.lang.String) it.next());
                if (z3Var2 != null) {
    ...
    public final java.util.List e(java.util.List usernameList) {
        ...
        for (java.util.List list : d75.b.c(usernameList, 100)) {
            ...
            i17.f352657d = dm.e2.P1.l(list);
            for (com.tencent.mm.storage.z3 z3Var : i17.a().k(gm0.j1.u().f273153f, com.tencent.mm.storage.z3.class)) {
                java.lang.String d17 = z3Var.d1();
                kotlin.jvm.internal.o.f(d17, "getUsername(...)");
                hashMap.put(d17, z3Var);
            }
    ...
    public final java.util.List f(java.util.List usernameList) {
        kotlin.jvm.internal.o.g(usernameList, "usernameList");
        p75.i0 i17 = dm.e2.N1.i();
        i17.f352657d = dm.e2.P1.l(usernameList);
        p75.l0 a17 = i17.a();
        java.util.HashMap hashMap = new java.util.HashMap();
        java.util.ArrayList arrayList = new java.util.ArrayList();
        for (com.tencent.mm.storage.z3 z3Var : a17.k(gm0.j1.u().f273153f, com.tencent.mm.storage.z3.class)) {
            java.lang.String d17 = z3Var.d1();
            kotlin.jvm.internal.o.f(d17, "getUsername(...)");
            hashMap.put(d17, z3Var);
        }
