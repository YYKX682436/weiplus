...
public final class n implements java.lang.Runnable {
    ...
    public final /* synthetic */ android.view.View f354168d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.app.Activity f354169e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ ug5.v f354170f;

    public n(android.view.View view, android.app.Activity activity, ug5.v vVar) {
        this.f354168d = view;
        this.f354169e = activity;
        this.f354170f = vVar;
    }
    ...
    public final void run() {
        ...
        android.view.View view = this.f354168d;
        ...
        android.app.Activity activity = this.f354169e;
        if (activity != null && (window = activity.getWindow()) != null) {
            ug5.x.e(window, -16777216);
        }
        ug5.v vVar = this.f354170f;
