...
public final class f3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ r45.n30 f397738d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ rn2.z2 f397739e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ rn2.y2 f397740f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ rn2.h3 f397741g;

    public f3(r45.n30 n30Var, rn2.z2 z2Var, rn2.y2 y2Var, rn2.h3 h3Var) {
        this.f397738d = n30Var;
        this.f397739e = z2Var;
        this.f397740f = y2Var;
        this.f397741g = h3Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        r45.n30 n30Var = this.f397738d;
        int integer = n30Var.getInteger(1) - 1;
        rn2.z2 z2Var = this.f397739e;
        if (integer >= 0) {
            ...
            if (integer == 0) {
                com.tencent.mars.xlog.Log.i("FinderLive.GiftSelectorAdapter", "giftCountMinus click to 0");
                z2Var.f397939h.setChecked(false);
                this.f397740f.f397926a = false;
            }
        }
        if (n30Var.getInteger(1) == 0) {
            z2Var.f397942n.setAlpha(0.3f);
        } else {
            z2Var.f397942n.setAlpha(1.0f);
        }
        rn2.h3 h3Var = this.f397741g;
