...
public final class l implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.ui.widget.dialog.y1 f397790d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ rn2.w f397791e;

    public l(com.tencent.mm.ui.widget.dialog.y1 y1Var, rn2.w wVar) {
        this.f397790d = y1Var;
        this.f397791e = wVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        if (textView != null) {
            textView.setText(com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getString(com.tencent.mm.R.string.liy));
        }
        android.widget.TextView textView2 = wVar.f397902a.f397863p0;
        if (textView2 != null) {
            textView2.setText(com.tencent.mm.sdk.platformtools.x2.f193071a.getString(com.tencent.mm.R.string.lis));
        }
