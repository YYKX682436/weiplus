...
public class v implements q25.a {
    ...
    public static final /* synthetic */ int f320245a = 0;
    ...
    public boolean a(android.content.Context context, java.lang.String[] strArr, java.lang.String str) {
        ...
        switch (c17) {
            case 0:
                if (strArr.length >= 3) {
                    gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_FORCE_USE_NEW_CASHIER_INT_SYNC, java.lang.Integer.valueOf(com.tencent.mm.sdk.platformtools.t8.P(strArr[2], 0)));
                }
                return true;
            case 1:
                gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_LUCKY_MONEY_STORY_GUIDE_TIME_INT_SYNC, 0);
                gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_LUCKY_MONEY_STORY_PREVIEW_GUIDE_TIME_INT_SYNC, 0);
                return true;
            case 2:
                j45.l.h(context, "wallet", ".pwd.ui.WalletUniversalPayOrderUI");
                return true;
            case 3:
                ((h45.q) i95.n0.c(h45.q.class)).startUiTest("");
                return true;
            case 4:
