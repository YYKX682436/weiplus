...
public class w implements q25.a {
    ...
    public static final /* synthetic */ int f320246a = 0;
    ...
    public boolean a(android.content.Context context, java.lang.String[] strArr, java.lang.String str) {
        ...
        switch (c17) {
            case 0:
                try {
                    gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_CALC_WX_SCAN_SHOW_FILE_INT, 0);
                    db5.t7.makeText(context, "hide file now.", 0).show();
                } catch (java.lang.Exception unused) {
                }
                return true;
            case 1:
                try {
                    gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_CALC_WX_SCAN_SHOW_FILE_INT, 1);
                    db5.t7.makeText(context, "show file now.", 0).show();
