...
public class m implements q25.a {
    ...
    public static final /* synthetic */ int f320234a = 0;
    ...
    public boolean a(android.content.Context context, java.lang.String[] strArr, java.lang.String str) {
        ...
        if (lowerCase.equals("testrpp")) {
            ...
            dp.a.makeText(context, "info is reported.", 0).show();
        } else {
            if (!lowerCase.equals("oaid")) {
                return false;
            }
            java.lang.String k96 = fo3.s.INSTANCE.k9();
            dp.a.makeText(context, "oaid: " + k96, 1).show();
            com.tencent.mars.xlog.Log.i("MicroMsg.NorMsgTest", "[+] oaid: %s", k96);
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.NorMsgTest", format);
        dp.a.makeText(context, format, 0).show();
        return true;
    }
}
