...
public final class g0 implements j5.x {
    ...
    public final l4.q f297734a;

    /* renamed from: b, reason: collision with root package name */
    public final l4.b f297735b;

    /* renamed from: c, reason: collision with root package name */
    public final l4.w f297736c;

    /* renamed from: d, reason: collision with root package name */
    public final l4.w f297737d;

    /* renamed from: e, reason: collision with root package name */
    public final l4.w f297738e;

    /* renamed from: f, reason: collision with root package name */
    public final l4.w f297739f;

    /* renamed from: g, reason: collision with root package name */
    public final l4.w f297740g;

    /* renamed from: h, reason: collision with root package name */
    public final l4.w f297741h;

    /* renamed from: i, reason: collision with root package name */
    public final l4.w f297742i;

    public g0(l4.q qVar) {
        this.f297734a = qVar;
        this.f297735b = new j5.y(this, qVar);
        this.f297736c = new j5.z(this, qVar);
        this.f297737d = new j5.a0(this, qVar);
        this.f297738e = new j5.b0(this, qVar);
        this.f297739f = new j5.c0(this, qVar);
        this.f297740g = new j5.d0(this, qVar);
        this.f297741h = new j5.e0(this, qVar);
        this.f297742i = new j5.f0(this, qVar);
        new java.util.concurrent.atomic.AtomicBoolean(false);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public void a(java.lang.String str) {
        l4.q qVar = this.f297734a;
        qVar.b();
        l4.w wVar = this.f297736c;
        p4.i a17 = wVar.a();
        if (str == null) {
            ((q4.h) a17).bindNull(1);
        } else {
        ...
        try {
            ...
            try {
                ...
                while (a17.moveToNext()) {
                    ...
                    int i57 = a69;
                    wVar.f297772i = a17.getLong(i57);
                    int i58 = a76;
                    wVar.f297774k = a17.getInt(i58);
                    int i59 = a77;
                    wVar.f297775l = j5.l0.b(a17.getInt(i59));
                    int i66 = a78;
                    wVar.f297776m = a17.getLong(i66);
                    int i67 = a79;
                    wVar.f297777n = a17.getLong(i67);
                    int i68 = a86;
                    wVar.f297778o = a17.getLong(i68);
                    int i69 = a87;
                    wVar.f297779p = a17.getLong(i69);
                    int i76 = a88;
                    wVar.f297780q = a17.getInt(i76) != 0;
                    int i77 = a89;
                    wVar.f297781r = j5.l0.d(a17.getInt(i77));
                    wVar.f297773j = fVar;
                    arrayList.add(wVar);
                    i18 = i38;
                    a19 = i29;
        ...
        try {
            ...
            try {
                ...
                while (a17.moveToNext()) {
                    ...
                    wVar.f297768e = a5.m.a(a17.getBlob(a58));
                    int i37 = i17;
                    wVar.f297769f = a5.m.a(a17.getBlob(i37));
                    int i38 = a58;
                    int i39 = a67;
                    wVar.f297770g = a17.getLong(i39);
                    int i47 = a28;
                    int i48 = a68;
                    wVar.f297771h = a17.getLong(i48);
                    int i49 = a69;
                    wVar.f297772i = a17.getLong(i49);
                    int i57 = a76;
                    wVar.f297774k = a17.getInt(i57);
                    int i58 = a77;
                    wVar.f297775l = j5.l0.b(a17.getInt(i58));
                    int i59 = a78;
                    wVar.f297776m = a17.getLong(i59);
                    int i66 = a79;
                    wVar.f297777n = a17.getLong(i66);
                    int i67 = a86;
                    wVar.f297778o = a17.getLong(i67);
                    int i68 = a87;
                    wVar.f297779p = a17.getLong(i68);
                    int i69 = a88;
                    wVar.f297780q = a17.getInt(i69) != 0;
                    int i76 = a89;
                    wVar.f297781r = j5.l0.d(a17.getInt(i76));
                    wVar.f297773j = fVar;
                    arrayList.add(wVar);
                    i17 = i37;
                    a19 = i28;
        ...
        try {
            ...
            try {
                ...
                if (a17.moveToFirst()) {
                    ...
                    wVar2.f297765b = j5.l0.e(a17.getInt(a48));
                    wVar2.f297767d = a17.getString(a57);
                    wVar2.f297768e = a5.m.a(a17.getBlob(a58));
                    wVar2.f297769f = a5.m.a(a17.getBlob(a59));
                    wVar2.f297770g = a17.getLong(a67);
                    wVar2.f297771h = a17.getLong(a68);
                    wVar2.f297772i = a17.getLong(a69);
                    wVar2.f297774k = a17.getInt(a76);
                    wVar2.f297775l = j5.l0.b(a17.getInt(a77));
                    wVar2.f297776m = a17.getLong(a78);
                    wVar2.f297777n = a17.getLong(a79);
                    wVar2.f297778o = a17.getLong(a86);
                    wVar2.f297779p = a17.getLong(a87);
                    wVar2.f297780q = a17.getInt(a88) != 0;
                    wVar2.f297781r = j5.l0.d(a17.getInt(a89));
                    wVar2.f297773j = fVar;
                    wVar = wVar2;
                } else {
                    wVar = null;
    ...
    public java.util.List j(java.lang.String str) {
        ...
        android.database.Cursor a17 = n4.b.a(qVar, c17, false, null);
        try {
            int a18 = n4.a.a(a17, dm.i4.COL_ID);
            int a19 = n4.a.a(a17, "state");
            java.util.ArrayList arrayList = new java.util.ArrayList(a17.getCount());
            while (a17.moveToNext()) {
                j5.v vVar = new j5.v();
                vVar.f297761a = a17.getString(a18);
                vVar.f297762b = j5.l0.e(a17.getInt(a19));
                arrayList.add(vVar);
            }
            return arrayList;
        } finally {
    ...
    public int l(java.lang.String str, long j17) {
        l4.q qVar = this.f297734a;
        qVar.b();
        l4.w wVar = this.f297741h;
        p4.i a17 = wVar.a();
        ((q4.h) a17).bindLong(1, j17);
        if (str == null) {
            ((q4.h) a17).bindNull(2);
        } else {
            ((q4.h) a17).bindString(2, str);
        }
        qVar.c();
        try {
            int a18 = ((q4.i) a17).a();
    ...
    public void n(java.lang.String str, a5.m mVar) {
        l4.q qVar = this.f297734a;
        qVar.b();
        l4.w wVar = this.f297737d;
        p4.i a17 = wVar.a();
        byte[] d17 = a5.m.d(mVar);
        if (d17 == null) {
            ((q4.h) a17).bindNull(1);
        } else {
            ((q4.h) a17).bindBlob(1, d17);
        }
        if (str == null) {
            ((q4.h) a17).bindNull(2);
        } else {
    ...
    public int p(a5.q0 q0Var, java.lang.String... strArr) {
        ...
        qVar.a();
        qVar.b();
        android.database.sqlite.SQLiteStatement compileStatement = ((q4.c) qVar.f315748c.d0()).f360007d.compileStatement(sb7);
