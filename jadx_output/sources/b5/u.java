...
public abstract class u {
    ...
    public static final java.lang.String f17889a = a5.a0.e("WrkDbPathHelper");

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.String[] f17890b = {"-journal", "-shm", "-wal"};

    public static void a(android.content.Context context) {
        if (context.getDatabasePath("androidx.work.workdb").exists()) {
            java.lang.String str = f17889a;
            ...
            for (java.lang.String str2 : f17890b) {
