...
public final class g0 implements android.view.View.OnLongClickListener {
    ...
    public final /* synthetic */ nl5.s0 f338271d;
    ...
    public final boolean onLongClick(android.view.View view) {
        ...
        nl5.s0 s0Var = this.f338271d;
        android.view.View.OnLongClickListener onLongClickListener = s0Var.f338364o;
        boolean onLongClick = onLongClickListener != null ? onLongClickListener.onLongClick(view) : false;
        if (s0Var.f338375z) {
            com.tencent.mm.ui.yk.c("SelectableEditTextHelper", "onLongClick:" + s0Var.C, new java.lang.Object[0]);
            s0Var.getClass();
            ...
            if (!android.text.TextUtils.isEmpty(BRAND)) {
                ...
                kotlin.jvm.internal.o.b("vivo", lowerCase);
            }
            if (s0Var.C) {
