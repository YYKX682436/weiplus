...
public class SdkInfo {
    ...
    public static class MediaInfo {
        ...
        public java.lang.String audioCodecName = "";
        ...
        public java.lang.String videoCodecName = "";
        ...
        public java.lang.String toString() {
            java.lang.String str = "{ file: { size: " + this.fileSize + ", bitrate:" + this.fileBitrate + ", duration: " + this.fileDuration + " }";
            if (this.audioEnable) {
