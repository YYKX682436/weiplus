...
public class BaselineLayout extends android.view.ViewGroup {
    ...
    public void onLayout(boolean z17, int i17, int i18, int i19, int i27) {
        ...
        for (int i28 = 0; i28 < childCount; i28++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int baseline = (this.f44508d == -1 || childAt.getBaseline() == -1) ? paddingTop : (this.f44508d + paddingTop) - childAt.getBaseline();
    ...
    public BaselineLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
