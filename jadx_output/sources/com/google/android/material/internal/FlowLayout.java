...
public class FlowLayout extends android.view.ViewGroup {
    ...
    public void onLayout(boolean z17, int i17, int i18, int i19, int i27) {
        ...
        for (int i47 = 0; i47 < getChildCount(); i47++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (!this.f44513f && measuredWidth > i37) {
                    i39 = this.f44511d + paddingTop;
                    i38 = paddingRight;
                }
                int i48 = i38 + i29;
                ...
                i38 += i29 + i28 + childAt.getMeasuredWidth() + this.f44512e;
    ...
    public void onMeasure(int i17, int i18) {
        ...
        while (i39 < getChildCount()) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (paddingLeft + i28 + childAt.getMeasuredWidth() > paddingRight && !this.f44513f) {
                    paddingLeft = getPaddingLeft();
                    i38 = this.f44511d + paddingTop;
                }
                ...
                paddingLeft += i28 + i27 + childAt.getMeasuredWidth() + this.f44512e;
            }
            i39++;
    ...
    public void setItemSpacing(int i17) {
        this.f44512e = i17;
    }

    public void setLineSpacing(int i17) {
        this.f44511d = i17;
    }
    ...
    public FlowLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        ...
        this.f44513f = false;
        android.content.res.TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, v9.a.f434122l, 0, 0);
        this.f44511d = obtainStyledAttributes.getDimensionPixelSize(2, 0);
        this.f44512e = obtainStyledAttributes.getDimensionPixelSize(1, 0);
