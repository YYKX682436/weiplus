...
public class zzhp {
    private static com.google.android.gms.wearable.internal.zzhp zzfs;
    ...
    private final android.content.Context zzft;

    private zzhp(android.content.Context context) {
        this.zzft = context.getApplicationContext();
    }

    public static com.google.android.gms.wearable.internal.zzhp zza(android.content.Context context) {
        com.google.android.gms.common.internal.Preconditions.checkNotNull(context);
        synchronized (com.google.android.gms.wearable.internal.zzhp.class) {
            if (zzfs == null) {
                zzfs = new com.google.android.gms.wearable.internal.zzhp(context);
            }
        }
        return zzfs;
    }
    ...
    private final android.content.pm.PackageInfo zzf(java.lang.String str) {
        try {
            return com.google.android.gms.common.wrappers.Wrappers.packageManager(this.zzft).getPackageInfo(str, 64);
    ...
    private static boolean zza(android.content.pm.PackageInfo packageInfo, boolean z17) {
        ...
        return z17 ? zza(packageInfo, zzfu, zzfv) : zza(packageInfo, zzfu);
    }
