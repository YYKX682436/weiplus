...
public class FastParser<T extends com.google.android.gms.common.server.response.FastJsonResponse> {
                ...
                if (!java.lang.Character.isISOControl(c17) || (cArr2 != null && cArr2[0] == c17)) {
                    ...
                    if (c17 == '\"') {
                        if (!z17) {
                            ...
                            return z18 ? com.google.android.gms.common.util.JsonUtils.unescapeString(sb6.toString()) : sb6.toString();
                        }
                    } else if (c17 == '\\') {
                        z17 = !z17;
                        z18 = true;
    ...
    */
    ...
    private final java.util.ArrayList zau(java.io.BufferedReader bufferedReader, com.google.android.gms.common.server.response.zai zaiVar) {
        char zai2 = zai(bufferedReader);
        if (zai2 == 'n') {
            zax(bufferedReader, zaa);
            return null;
    ...
    private final java.util.ArrayList zav(java.io.BufferedReader bufferedReader, com.google.android.gms.common.server.response.FastJsonResponse.Field field) {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        char zai2 = zai(bufferedReader);
        if (zai2 == ']') {
            zaw(5);
        ...
        while (true) {
            try {
                ...
                throw new com.google.android.gms.common.server.response.FastParser.ParseException("Error instantiating inner object", e17);
            } catch (java.lang.InstantiationException e18) {
                throw new com.google.android.gms.common.server.response.FastParser.ParseException("Error instantiating inner object", e18);
            }
        }
    }
    ...
    private final void zaw(int i17) {
        if (this.zat.isEmpty()) {
            throw new com.google.android.gms.common.server.response.FastParser.ParseException("Expected state " + i17 + " but had empty stack");
        }
        int intValue = ((java.lang.Integer) this.zat.pop()).intValue();
        if (intValue == i17) {
            return;
        }
        throw new com.google.android.gms.common.server.response.FastParser.ParseException("Expected state " + i17 + " but had " + intValue);
    }
    ...
    */
    ...
    public void parse(java.io.InputStream inputStream, T t17) {
        ...
        try {
            try {
                ...
                if (zai2 == '[') {
                    this.zat.push(5);
                    java.util.Map<java.lang.String, com.google.android.gms.common.server.response.FastJsonResponse.Field<?, ?>> fieldMappings = t17.getFieldMappings();
                    ...
                    t17.addConcreteTypeArrayInternal(value, value.zae, zav(bufferedReader, value));
                } else {
                    if (zai2 != '{') {
                        throw new com.google.android.gms.common.server.response.FastParser.ParseException("Unexpected token: " + zai2);
                    }
                ...
                throw new com.google.android.gms.common.server.response.FastParser.ParseException(e17);
            }
