...
public class GooglePlayServicesUtilLight {
    ...
    @java.lang.Deprecated
    public static void ensurePlayServicesAvailable(android.content.Context context, int i17) {
        int isGooglePlayServicesAvailable = com.google.android.gms.common.GoogleApiAvailabilityLight.getInstance().isGooglePlayServicesAvailable(context, i17);
    ...
    public static java.lang.String getErrorString(int i17) {
        return com.google.android.gms.common.ConnectionResult.zza(i17);
    }

    @java.lang.Deprecated
    public static android.content.Intent getGooglePlayServicesAvailabilityRecoveryIntent(int i17) {
        return com.google.android.gms.common.GoogleApiAvailabilityLight.getInstance().getErrorResolutionIntent(null, i17, null);
    }
    ...
    public static boolean isGooglePlayServicesUid(android.content.Context context, int i17) {
        return com.google.android.gms.common.util.UidVerifier.isGooglePlayServicesUid(context, i17);
    }

    @java.lang.Deprecated
    public static boolean isPlayServicesPossiblyUpdating(android.content.Context context, int i17) {
        if (i17 == 18) {
            return true;
        }
        if (i17 == 1) {
    ...
    @java.lang.Deprecated
    public static boolean isPlayStorePossiblyUpdating(android.content.Context context, int i17) {
        if (i17 == 9) {
    ...
    public static boolean uidHasPackageName(android.content.Context context, int i17, java.lang.String str) {
        return com.google.android.gms.common.util.UidVerifier.uidHasPackageName(context, i17, str);
    }
    ...
    public static int isGooglePlayServicesAvailable(android.content.Context context, int i17) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzc.get()) {
            int zza2 = com.google.android.gms.common.internal.zzah.zza(context);
            if (zza2 != 0) {
        ...
        boolean z17 = (com.google.android.gms.common.util.DeviceProperties.isWearableWithoutPlayStore(context) || com.google.android.gms.common.util.DeviceProperties.zzb(context)) ? false : true;
        ...
        try {
            ...
            if (com.google.android.gms.common.GoogleSignatureVerifier.zzb(packageInfo2, true)) {
                ...
                if (!z17 || packageInfo == null || packageInfo.signatures[0].equals(packageInfo2.signatures[0])) {
                    if (com.google.android.gms.common.util.zza.zza(packageInfo2.versionCode) < com.google.android.gms.common.util.zza.zza(i17)) {
                        return 2;
                    }
