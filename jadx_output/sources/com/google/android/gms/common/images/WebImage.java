...
public final class WebImage extends com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable {
    ...
    public WebImage(int i17, android.net.Uri uri, int i18, int i19) {
        this.zaa = i17;
        this.zab = uri;
        this.zac = i18;
        this.zad = i19;
    ...
    public void writeToParcel(android.os.Parcel parcel, int i17) {
        ...
        com.google.android.gms.common.internal.safeparcel.SafeParcelWriter.writeParcelable(parcel, 2, getUrl(), i17, false);
    ...
    public WebImage(android.net.Uri uri) {
        this(uri, 0, 0);
    }

    public WebImage(android.net.Uri uri, int i17, int i18) {
        this(1, uri, i17, i18);
        if (uri == null) {
