...
public final class zzl {
    private final java.nio.ByteBuffer zzhb;
    ...
    private final void zzj(int i17) {
        ...
        if (!this.zzhb.hasRemaining()) {
            throw new com.google.android.gms.internal.wearable.zzm(this.zzhb.position(), this.zzhb.limit());
        }
        this.zzhb.put(b17);
    }
    ...
    public final void zzr() {
        if (this.zzhb.remaining() != 0) {
            throw new java.lang.IllegalStateException(java.lang.String.format("Did not write as much data as expected, %s bytes remaining.", java.lang.Integer.valueOf(this.zzhb.remaining())));
        }
    }
    ...
    public static int zzb(int i17, com.google.android.gms.internal.wearable.zzt zztVar) {
        int zzk = zzk(i17);
        int zzx = zztVar.zzx();
    ...
    public static com.google.android.gms.internal.wearable.zzl zzb(byte[] bArr) {
    ...
    public static com.google.android.gms.internal.wearable.zzl zzb(byte[] bArr, int i17, int i18) {
        return new com.google.android.gms.internal.wearable.zzl(bArr, 0, i18);
    }

    public final void zza(int i17, com.google.android.gms.internal.wearable.zzt zztVar) {
        zzf(i17, 2);
        if (zztVar.zzhl < 0) {
            zztVar.zzx();
        }
    ...
    public final void zza(int i17, java.lang.String str) {
        ...
        try {
            ...
            if (this.zzhb.remaining() < zzm) {
                throw new com.google.android.gms.internal.wearable.zzm(position + zzm, this.zzhb.limit());
            }
            ...
            com.google.android.gms.internal.wearable.zzm zzmVar = new com.google.android.gms.internal.wearable.zzm(this.zzhb.position(), this.zzhb.limit());
