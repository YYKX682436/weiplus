...
public final class zzhx implements java.lang.Runnable {
    ...
    public zzhx(com.google.android.gms.internal.measurement.zzhk zzhkVar, java.util.concurrent.atomic.AtomicReference atomicReference) {
        this.zzanw = zzhkVar;
    ...
    public final void run() {
        synchronized (this.zzanv) {
            try {
                ...
                atomicReference.set(java.lang.Integer.valueOf(zzgg.zzb(zzgg.zzfv().zzah(), com.google.android.gms.internal.measurement.zzew.zzahs)));
            } finally {
                this.zzanv.notify();
            }
        }
