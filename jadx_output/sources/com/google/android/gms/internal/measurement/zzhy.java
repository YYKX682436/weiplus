...
public final class zzhy implements java.lang.Runnable {
    ...
    public zzhy(com.google.android.gms.internal.measurement.zzhk zzhkVar, java.util.concurrent.atomic.AtomicReference atomicReference) {
        this.zzanw = zzhkVar;
    ...
    public final void run() {
        synchronized (this.zzanv) {
            try {
                ...
                atomicReference.set(java.lang.Double.valueOf(zzgg.zzc(zzgg.zzfv().zzah(), com.google.android.gms.internal.measurement.zzew.zzaht)));
            } finally {
                this.zzanv.notify();
            }
        }
