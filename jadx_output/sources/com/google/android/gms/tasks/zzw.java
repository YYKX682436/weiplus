...
public final class zzw<TResult> extends com.google.android.gms.tasks.Task<TResult> {
    ...
    @Override // com.google.android.gms.tasks.Task
    public final <X extends java.lang.Throwable> TResult getResult(java.lang.Class<X> cls) {
        TResult tresult;
        synchronized (this.zza) {
            zzf();
            zzg();
