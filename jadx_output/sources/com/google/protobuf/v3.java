...
public final class v3 {
    ...
    public final java.util.Map f45607c = new java.util.HashMap();

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Map f45608d = new java.util.HashMap();

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Map f45609e = new java.util.HashMap();

    /* renamed from: a, reason: collision with root package name */
    public final java.util.Set f45605a = new java.util.HashSet();

    public v3(com.google.protobuf.d4[] d4VarArr, boolean z17) {
        this.f45606b = z17;
        for (int i17 = 0; i17 < d4VarArr.length; i17++) {
            ((java.util.HashSet) this.f45605a).add(d4VarArr[i17]);
            d(d4VarArr[i17]);
        }
        java.util.Iterator it = ((java.util.HashSet) this.f45605a).iterator();
        while (it.hasNext()) {
            com.google.protobuf.d4 d4Var = (com.google.protobuf.d4) it.next();
            try {
                a(d4Var.f45004d.g(), d4Var);
    ...
    public void a(java.lang.String str, com.google.protobuf.d4 d4Var) {
        ...
        com.google.protobuf.t3 t3Var = new com.google.protobuf.t3(substring, str, d4Var);
        java.util.Map map = this.f45607c;
        com.google.protobuf.e4 e4Var = (com.google.protobuf.e4) map.put(str, t3Var);
        if (e4Var != null) {
            map.put(str, e4Var);
            if (e4Var instanceof com.google.protobuf.t3) {
                return;
            }
            java.lang.String name = e4Var.h().getName();
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder(java.lang.String.valueOf(substring).length() + 69 + java.lang.String.valueOf(name).length());
            sb6.append('\"');
            sb6.append(substring);
            sb6.append("\" is already defined (as something other than a package) in file \"");
            sb6.append(name);
            sb6.append("\".");
            throw new com.google.protobuf.w3(d4Var, sb6.toString(), null);
        }
    }

    public void b(com.google.protobuf.e4 e4Var) {
        java.lang.String name = e4Var.getName();
        if (name.length() == 0) {
            throw new com.google.protobuf.w3(e4Var, "Missing name.");
        }
        for (int i17 = 0; i17 < name.length(); i17++) {
            ...
            if (('a' > charAt || charAt > 'z') && (('A' > charAt || charAt > 'Z') && charAt != '_' && ('0' > charAt || charAt > '9' || i17 <= 0))) {
                java.lang.StringBuilder sb6 = new java.lang.StringBuilder(name.length() + 29);
                sb6.append('\"');
                sb6.append(name);
                sb6.append("\" is not a valid identifier.");
                throw new com.google.protobuf.w3(e4Var, sb6.toString());
            }
        }
        java.lang.String i18 = e4Var.i();
        java.util.Map map = this.f45607c;
        com.google.protobuf.e4 e4Var2 = (com.google.protobuf.e4) ((java.util.HashMap) map).put(i18, e4Var);
        if (e4Var2 != null) {
            ((java.util.HashMap) map).put(i18, e4Var2);
            if (e4Var.h() != e4Var2.h()) {
                java.lang.String name2 = e4Var2.h().getName();
                java.lang.StringBuilder sb7 = new java.lang.StringBuilder(java.lang.String.valueOf(i18).length() + 33 + java.lang.String.valueOf(name2).length());
                sb7.append('\"');
                sb7.append(i18);
                sb7.append("\" is already defined in file \"");
                sb7.append(name2);
                sb7.append("\".");
                throw new com.google.protobuf.w3(e4Var, sb7.toString());
            }
            ...
            if (lastIndexOf == -1) {
                ...
                throw new com.google.protobuf.w3(e4Var, sb8.toString());
            }
            ...
            sb9.append("\".");
            throw new com.google.protobuf.w3(e4Var, sb9.toString());
        }
    }
    ...
    */
    public com.google.protobuf.e4 c(java.lang.String r9, com.google.protobuf.u3 r10) {
        ...
        L47:
            ...
            com.google.protobuf.v3 r6 = r6.f45010m
            java.util.Map r6 = r6.f45607c
    ...
    public final void d(com.google.protobuf.d4 d4Var) {
        for (com.google.protobuf.d4 d4Var2 : java.util.Collections.unmodifiableList(java.util.Arrays.asList(d4Var.f45009i))) {
            if (this.f45605a.add(d4Var2)) {
                d(d4Var2);
            }
        }
    }

    public com.google.protobuf.e4 e(java.lang.String str, com.google.protobuf.e4 e4Var, com.google.protobuf.u3 u3Var) {
        com.google.protobuf.e4 c17;
        ...
        if (str.startsWith(".")) {
            ...
            while (true) {
                ...
                sb6.setLength(i17);
                sb6.append(substring);
                com.google.protobuf.e4 c18 = c(sb6.toString(), com.google.protobuf.u3.AGGREGATES_ONLY);
                if (c18 != null) {
                    if (indexOf != -1) {
                        sb6.setLength(i17);
                        sb6.append(str);
        ...
        if (!this.f45606b || u3Var != com.google.protobuf.u3.TYPES_ONLY) {
        ...
        java.util.logging.Logger logger = com.google.protobuf.i4.f45191a;
        ...
        com.google.protobuf.r3 r3Var = new com.google.protobuf.r3(str2);
        ((java.util.HashSet) this.f45605a).add(r3Var.f45468f);
        return r3Var;
    }
}
