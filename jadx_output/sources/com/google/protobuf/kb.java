            ...
            if (b18 >= 0) {
                ...
                if (!(b18 < -32)) {
                    if (b18 < -16) {
                        ...
                        int i38 = i29 + 1;
                        com.google.protobuf.jb.c(b18, byteBuffer.get(i29), byteBuffer.get(i38), cArr, i28);
                        i17 = i38 + 1;
                        i28++;
                    } else {
                        if (i29 >= i19 - 2) {
                        ...
                        int i47 = i39 + 1;
                        com.google.protobuf.jb.a(b18, b27, byteBuffer.get(i39), byteBuffer.get(i47), cArr, i28);
                        i28 = i28 + 1 + 1;
                        i17 = i47 + 1;
                    }
                } else {
                    ...
                    com.google.protobuf.jb.b(b18, byteBuffer.get(i29), cArr, i28);
                    i17 = i29 + 1;
                    i28++;
                }
            }
