        ...
        if (view instanceof android.widget.EditText) {
            ...
            if (!android.text.TextUtils.isEmpty(contentDescription)) {
                for (int i18 = 0; i18 < contentDescription.length(); i18++) {
                    com.tenpay.miniapp.TenpayTTSUtil.speak(java.lang.String.valueOf(contentDescription.charAt(i18)));
                }
            }
        } else {
            contentDescription = view.getContentDescription();
            com.tenpay.miniapp.TenpayTTSUtil.speak(contentDescription);
        }
        if (android.text.TextUtils.isEmpty(contentDescription)) {
            return;
        }
