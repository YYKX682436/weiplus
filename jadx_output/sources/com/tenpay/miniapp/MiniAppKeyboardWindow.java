...
public class MiniAppKeyboardWindow extends android.widget.LinearLayout {
    ...
    private com.tenpay.miniapp.MiniAppKeyboardWindow.OnTouchListener mOnTouchListener;
    private int mXMode;
    ...
    public MiniAppKeyboardWindow(android.content.Context context) {
        super(context);
        this.mXMode = 0;
    ...
    private void init(android.content.Context context) {
        ...
        com.tenpay.miniapp.TenpayTTSUtil.init(context);
        ...
        android.view.View.OnClickListener onClickListener = new android.view.View.OnClickListener() { // from class: com.tenpay.miniapp.MiniAppKeyboardWindow.1
            ...
            public void onClick(android.view.View view) {
                if (com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText == null) {
                    return;
                }
                if (view.getId() != com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_x")) {
                    int i18 = view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_1") ? 8 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_2") ? 9 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_3") ? 10 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_4") ? 11 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_5") ? 12 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_6") ? 13 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_7") ? 14 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_8") ? 15 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_9") ? 16 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_0") ? 7 : view.getId() == com.tenpay.miniapp.MiniAppKeyboardWindow.this.getId("tenpay_keyboard_d") ? 67 : 0;
                    com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText.dispatchKeyEvent(new android.view.KeyEvent(0, i18));
                    com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText.dispatchKeyEvent(new android.view.KeyEvent(1, i18));
                    return;
                }
                int i19 = com.tenpay.miniapp.MiniAppKeyboardWindow.this.mXMode;
                if (i19 != 1) {
                    if (i19 != 2) {
                        return;
                    }
                    com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText.dispatchKeyEvent(new android.view.KeyEvent(0, 56));
                } else {
                    com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText.dispatchKeyEvent(new android.view.KeyEvent(0, 59));
                    com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText.dispatchKeyEvent(new android.view.KeyEvent(0, 52));
                    com.tenpay.miniapp.MiniAppKeyboardWindow.this.mInputEditText.dispatchKeyEvent(new android.view.KeyEvent(1, 59));
                }
            }
        };
    ...
    public boolean dispatchTouchEvent(android.view.MotionEvent motionEvent) {
        try {
            com.tenpay.miniapp.MiniAppKeyboardWindow.OnTouchListener onTouchListener = this.mOnTouchListener;
    ...
    public void onDetachedFromWindow() {
        ...
        com.tenpay.miniapp.TenpayTTSUtil.destroy();
    }
    ...
    public void setOnTouchListener(com.tenpay.miniapp.MiniAppKeyboardWindow.OnTouchListener onTouchListener) {
    ...
    public MiniAppKeyboardWindow(android.content.Context context, android.util.AttributeSet attributeSet) {
