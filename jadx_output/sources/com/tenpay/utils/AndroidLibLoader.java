...
public class AndroidLibLoader {
    private static com.tenpay.utils.AndroidLibLoader.ILoader sLoaderImpl = com.tenpay.utils.AndroidLibLoader.ILoader.DEFAULT;

    /* loaded from: classes.dex */
    public interface ILoader {
        public static final com.tenpay.utils.AndroidLibLoader.ILoader DEFAULT = new com.tenpay.utils.AndroidLibLoader.ILoader() { // from class: com.tenpay.utils.AndroidLibLoader.ILoader.1
    ...
    public static void setLoader(com.tenpay.utils.AndroidLibLoader.ILoader iLoader) {
        if (iLoader == null) {
            sLoaderImpl = com.tenpay.utils.AndroidLibLoader.ILoader.DEFAULT;
        } else {
            sLoaderImpl = iLoader;
        }
    }
