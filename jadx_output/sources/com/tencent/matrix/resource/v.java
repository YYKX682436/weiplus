...
public class v extends com.tencent.matrix.lifecycle.a {
    ...
    public void onActivityDestroyed(android.app.Activity activity) {
        ...
        if (activity == null || activity.getWindow() == null || activity.getWindow().peekDecorView() == null) {
            ...
            try {
                com.tencent.matrix.resource.b.b(rootView);
                if (android.os.Build.VERSION.SDK_INT >= 31 && com.tencent.matrix.resource.b.f52938b) {
        ...
        try {
            ...
            if (com.tencent.matrix.resource.b.f52937a == null) {
                ...
                com.tencent.matrix.resource.b.f52937a = new android.util.Pair(frameLayout, new java.util.ArrayList());
            }
            android.util.Pair pair = com.tencent.matrix.resource.b.f52937a;
