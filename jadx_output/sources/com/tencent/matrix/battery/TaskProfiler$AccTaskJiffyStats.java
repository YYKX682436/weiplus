...
public final class TaskProfiler$AccTaskJiffyStats extends com.tencent.matrix.battery.accumulate.persist.FlattParcelable {
    ...
    public static final kh.m1 Companion = new kh.m1(null);
    public static final android.os.Parcelable.Creator<com.tencent.matrix.battery.TaskProfiler$AccTaskJiffyStats> CREATOR = new kh.l1();
    ...
    private java.util.Map<java.lang.String, com.tencent.matrix.battery.TaskProfiler$Timer> accFinTaskStats = new java.util.LinkedHashMap();
    ...
    public final java.util.Map<java.lang.String, com.tencent.matrix.battery.TaskProfiler$Timer> getAccFinTaskStats() {
    ...
    public final java.util.Map<java.lang.String, java.lang.Long> getAccRunTaskStats() {
    ...
    public final void setAccFinTaskStats(java.util.Map<java.lang.String, com.tencent.matrix.battery.TaskProfiler$Timer> map) {
    ...
    public final void setAccRunTaskStats(java.util.Map<java.lang.String, java.lang.Long> map) {
        kotlin.jvm.internal.o.g(map, "<set-?>");
