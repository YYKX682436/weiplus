...
public final class IncrementComponentManager {
    ...
    private static final java.util.Map<java.lang.String, android.content.pm.ActivityInfo> CLASS_NAME_TO_ACTIVITY_INFO_MAP = new java.util.HashMap();
    private static final java.util.Map<java.lang.String, android.content.IntentFilter> CLASS_NAME_TO_INTENT_FILTER_MAP = new java.util.HashMap();
    private static final com.tencent.tinker.loader.hotplug.IncrementComponentManager.AttrTranslator<android.content.pm.ActivityInfo> ACTIVITY_INFO_ATTR_TRANSLATOR = new com.tencent.tinker.loader.hotplug.IncrementComponentManager.AttrTranslator<android.content.pm.ActivityInfo>() { // from class: com.tencent.tinker.loader.hotplug.IncrementComponentManager.1
        private int parseLaunchMode(java.lang.String str) {
            ...
            com.tencent.tinker.loader.shareutil.ShareTinkerLog.w(com.tencent.tinker.loader.hotplug.IncrementComponentManager.TAG, "Unknown launchMode: " + str, new java.lang.Object[0]);
            return 0;
        }
        ...
        public void onInit(android.content.Context context, int i17, org.xmlpull.v1.XmlPullParser xmlPullParser) {
            if (i17 == 0) {
                try {
        ...
        @Override // com.tencent.tinker.loader.hotplug.IncrementComponentManager.AttrTranslator
        public void onTranslate(android.content.Context context, int i17, java.lang.String str, java.lang.String str2, android.content.pm.ActivityInfo activityInfo) {
            int i18 = 0;
            if (com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME.equals(str)) {
                if (str2.charAt(0) == '.') {
            ...
            if (!"showOnLockScreen".equals(str) && !"showForAllUsers".equals(str)) {
                ...
                if ("allowEmbedded".equals(str)) {
                    int valueOfStaticIntField = com.tencent.tinker.loader.shareutil.ShareReflectUtil.getValueOfStaticIntField(android.content.pm.ActivityInfo.class, "FLAG_ALLOW_EMBEDDED", 0);
                    if ("true".equalsIgnoreCase(str2)) {
                ...
                if ("label".equals(str)) {
                    try {
                        i18 = context.getResources().getIdentifier(str2, "string", com.tencent.tinker.loader.hotplug.IncrementComponentManager.sPackageName);
                ...
                try {
                    if ("icon".equals(str)) {
                        activityInfo.icon = context.getResources().getIdentifier(str2, null, com.tencent.tinker.loader.hotplug.IncrementComponentManager.sPackageName);
                    } else if ("banner".equals(str)) {
                        activityInfo.banner = context.getResources().getIdentifier(str2, null, com.tencent.tinker.loader.hotplug.IncrementComponentManager.sPackageName);
                    } else if (!"logo".equals(str)) {
                        return;
                    } else {
                        activityInfo.logo = context.getResources().getIdentifier(str2, null, com.tencent.tinker.loader.hotplug.IncrementComponentManager.sPackageName);
                    }
                    return;
            ...
            int valueOfStaticIntField2 = com.tencent.tinker.loader.shareutil.ShareReflectUtil.getValueOfStaticIntField(android.content.pm.ActivityInfo.class, "FLAG_SHOW_FOR_ALL_USERS", 0);
            if ("true".equalsIgnoreCase(str2)) {
    ...
    public static abstract class AttrTranslator<T_RESULT> {
        ...
        public abstract void onTranslate(android.content.Context context, int i17, java.lang.String str, java.lang.String str2, T_RESULT t_result);

        public final void translate(android.content.Context context, int i17, org.xmlpull.v1.XmlPullParser xmlPullParser, T_RESULT t_result) {
            onInit(context, i17, xmlPullParser);
            int attributeCount = xmlPullParser.getAttributeCount();
            for (int i18 = 0; i18 < attributeCount; i18++) {
                if (com.eclipsesource.mmv8.Platform.ANDROID.equals(xmlPullParser.getAttributePrefix(i18))) {
                    onTranslate(context, i17, xmlPullParser.getAttributeName(i18), xmlPullParser.getAttributeValue(i18), t_result);
                }
            }
        }
    }
    ...
    private static synchronized void ensureInitialized() {
        synchronized (com.tencent.tinker.loader.hotplug.IncrementComponentManager.class) {
            if (!sInitialized) {
    ...
    */
    public static synchronized boolean init(android.content.Context r6, com.tencent.tinker.loader.shareutil.ShareSecurityCheck r7) {
        /*
            ...
            monitor-enter(r0)
            java.util.HashMap r1 = r7.getMetaContentMap()     // Catch: java.lang.Throwable -> Lad
            ...
            com.tencent.tinker.loader.shareutil.ShareTinkerLog.i(r6, r7, r2)     // Catch: java.lang.Throwable -> Lad
            monitor-exit(r0)
            return r1
        L1b:
        ...
        L29:
            ...
            goto L1b
        L2b:
            com.tencent.tinker.loader.hotplug.IncrementComponentManager.sContext = r6     // Catch: java.lang.Throwable -> Lad
            java.lang.String r1 = r6.getPackageName()     // Catch: java.lang.Throwable -> Lad
            com.tencent.tinker.loader.hotplug.IncrementComponentManager.sPackageName = r1     // Catch: java.lang.Throwable -> Lad
            java.util.HashMap r7 = r7.getMetaContentMap()     // Catch: java.lang.Throwable -> Lad
        ...
        L57:
            ...
            if (r4 == 0) goto L6f
            android.content.pm.ActivityInfo r3 = parseActivity(r6, r2)     // Catch: java.lang.Throwable -> L95 org.xmlpull.v1.XmlPullParserException -> L97
            java.util.Map<java.lang.String, android.content.pm.ActivityInfo> r4 = com.tencent.tinker.loader.hotplug.IncrementComponentManager.CLASS_NAME_TO_ACTIVITY_INFO_MAP     // Catch: java.lang.Throwable -> L95 org.xmlpull.v1.XmlPullParserException -> L97
        ...
        L86:
            ...
            goto L50
        L8b:
            com.tencent.tinker.loader.hotplug.IncrementComponentManager.sInitialized = r4     // Catch: java.lang.Throwable -> L95 org.xmlpull.v1.XmlPullParserException -> L97
            r2.setInput(r7)     // Catch: java.lang.Throwable -> L90
        L90:
            com.tencent.tinker.loader.shareutil.SharePatchFileUtil.closeQuietly(r1)     // Catch: java.lang.Throwable -> Lad
            monitor-exit(r0)
            return r4
        L95:
            r6 = move-exception
    ...
    private static synchronized android.content.pm.ActivityInfo parseActivity(android.content.Context context, org.xmlpull.v1.XmlPullParser xmlPullParser) {
        ...
        synchronized (com.tencent.tinker.loader.hotplug.IncrementComponentManager.class) {
            ...
            if ((applicationInfo.flags & com.tencent.wcdb.database.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0) {
                activityInfo.flags |= 512;
            }
    ...
    private static synchronized void parseIntentFilter(android.content.Context context, java.lang.String str, org.xmlpull.v1.XmlPullParser xmlPullParser) {
        synchronized (com.tencent.tinker.loader.hotplug.IncrementComponentManager.class) {
            android.content.IntentFilter intentFilter = new android.content.IntentFilter();
            java.lang.String attributeValue = xmlPullParser.getAttributeValue(null, com.tencent.tmassistantsdk.downloadservice.DownloadInfo.PRIORITY);
            ...
            while (true) {
                ...
                if (next != 3 && next != 4) {
                    ...
                    if ("action".equals(name)) {
                        java.lang.String attributeValue3 = xmlPullParser.getAttributeValue(null, com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
                        if (attributeValue3 != null) {
                            intentFilter.addAction(attributeValue3);
                        }
                    } else if ("category".equals(name)) {
                        java.lang.String attributeValue4 = xmlPullParser.getAttributeValue(null, com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
                        ...
                        java.lang.String attributeValue12 = xmlPullParser.getAttributeValue(null, com.tencent.kinda.framework.widget.tools.ConstantsKinda.INTENT_LITEAPP_PATH);
    ...
    private static synchronized void parseMetaData(android.content.Context context, android.content.pm.ActivityInfo activityInfo, org.xmlpull.v1.XmlPullParser xmlPullParser) {
        synchronized (com.tencent.tinker.loader.hotplug.IncrementComponentManager.class) {
    ...
    public static android.content.pm.ResolveInfo resolveIntent(android.content.Intent intent) {
        ...
        android.content.pm.ActivityInfo activityInfo = CLASS_NAME_TO_ACTIVITY_INFO_MAP.get(str);
    ...
    private static void skipCurrentTag(org.xmlpull.v1.XmlPullParser xmlPullParser) {
        int depth = xmlPullParser.getDepth();
        while (true) {
            int next = xmlPullParser.next();
            if (next == 1) {
