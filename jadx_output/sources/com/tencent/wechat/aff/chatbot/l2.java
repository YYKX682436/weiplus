...
public enum l2 implements com.tencent.mm.protobuf.h {
    MSG_VOIP_WELCOME(0),
    MSG_POI(1),
    MSG_VOICE_BUTTON(2),
    MSG_PLAYGROUND(3),
    ...
    public final int f216370d;

    l2(int i17) {
        this.f216370d = i17;
    }

    public static com.tencent.wechat.aff.chatbot.l2 a(int i17) {
        switch (i17) {
            case 0:
