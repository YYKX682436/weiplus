...
public class NewLifeSyncResponse extends com.tencent.mm.protobuf.f {
    private static final com.tencent.wechat.aff.newlife.NewLifeSyncResponse DEFAULT_INSTANCE = new com.tencent.wechat.aff.newlife.NewLifeSyncResponse();
    ...
    public static com.tencent.wechat.aff.newlife.NewLifeSyncResponse create() {
        return new com.tencent.wechat.aff.newlife.NewLifeSyncResponse();
    }

    public static com.tencent.wechat.aff.newlife.NewLifeSyncResponse getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.wechat.aff.newlife.NewLifeSyncResponse newBuilder() {
        return new com.tencent.wechat.aff.newlife.NewLifeSyncResponse();
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse addAllElementCmdList(java.util.Collection<com.tencent.wechat.aff.newlife.FinderCmdItem> collection) {
        this.CmdList.addAll(collection);
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse addElementCmdList(com.tencent.wechat.aff.newlife.FinderCmdItem finderCmdItem) {
        this.CmdList.add(finderCmdItem);
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.wechat.aff.newlife.NewLifeSyncResponse)) {
            return false;
        }
        com.tencent.wechat.aff.newlife.NewLifeSyncResponse newLifeSyncResponse = (com.tencent.wechat.aff.newlife.NewLifeSyncResponse) fVar;
        return n51.f.a(this.BaseResponse, newLifeSyncResponse.BaseResponse) && n51.f.a(java.lang.Integer.valueOf(this.ContinueFlag), java.lang.Integer.valueOf(newLifeSyncResponse.ContinueFlag)) && n51.f.a(this.KeyBuf, newLifeSyncResponse.KeyBuf) && n51.f.a(this.CmdList, newLifeSyncResponse.CmdList) && n51.f.a(this.entrance_expose_switch, newLifeSyncResponse.entrance_expose_switch) && n51.f.a(this.last_buffer, newLifeSyncResponse.last_buffer);
    }
    ...
    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setBaseResponse(com.tencent.wechat.aff.newlife.BaseResponse baseResponse) {
        this.BaseResponse = baseResponse;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setCmdList(java.util.LinkedList<com.tencent.wechat.aff.newlife.FinderCmdItem> linkedList) {
        this.CmdList = linkedList;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setContinueFlag(int i17) {
        this.ContinueFlag = i17;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setEntranceExposeSwitch(com.tencent.wechat.aff.newlife.EntranceReportSwitch entranceReportSwitch) {
        this.entrance_expose_switch = entranceReportSwitch;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setEntrance_expose_switch(com.tencent.wechat.aff.newlife.EntranceReportSwitch entranceReportSwitch) {
        this.entrance_expose_switch = entranceReportSwitch;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setKeyBuf(com.tencent.wechat.aff.newlife.SKBuiltinBuffer_t sKBuiltinBuffer_t) {
        this.KeyBuf = sKBuiltinBuffer_t;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setLastBuffer(com.tencent.mm.protobuf.g gVar) {
        this.last_buffer = gVar;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse setLast_buffer(com.tencent.mm.protobuf.g gVar) {
        this.last_buffer = gVar;
        return this;
    }

    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.wechat.aff.newlife.NewLifeSyncResponse parseFrom(byte[] bArr) {
        return (com.tencent.wechat.aff.newlife.NewLifeSyncResponse) super.parseFrom(bArr);
    }
}
