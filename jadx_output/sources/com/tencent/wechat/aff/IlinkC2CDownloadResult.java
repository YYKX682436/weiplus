...
public class IlinkC2CDownloadResult extends com.tencent.mm.protobuf.f {
    private static final com.tencent.wechat.aff.IlinkC2CDownloadResult DEFAULT_INSTANCE = new com.tencent.wechat.aff.IlinkC2CDownloadResult();
    ...
    public static com.tencent.wechat.aff.IlinkC2CDownloadResult create() {
        return new com.tencent.wechat.aff.IlinkC2CDownloadResult();
    }

    public static com.tencent.wechat.aff.IlinkC2CDownloadResult getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.wechat.aff.IlinkC2CDownloadResult newBuilder() {
        return new com.tencent.wechat.aff.IlinkC2CDownloadResult();
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.wechat.aff.IlinkC2CDownloadResult)) {
            return false;
        }
        com.tencent.wechat.aff.IlinkC2CDownloadResult ilinkC2CDownloadResult = (com.tencent.wechat.aff.IlinkC2CDownloadResult) fVar;
    ...
    public com.tencent.wechat.aff.IlinkC2CDownloadResult mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.wechat.aff.IlinkC2CDownloadResult setEnQueuetime(long j17) {
        this.en_queuetime = j17;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setEndTime(long j17) {
        this.end_time = j17;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setErrorCode(int i17) {
        this.error_code = i17;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setFileSize(long j17) {
        this.file_size = j17;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setRecvedBytes(long j17) {
        this.recved_bytes = j17;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setStartTime(long j17) {
        this.start_time = j17;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setSvrfallbackCount(int i17) {
        this.svrfallback_count = i17;
        this.hasSetFields[8] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setTaskIdent(java.lang.String str) {
        this.task_ident = str;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult setTraceId(long j17) {
        this.trace_id = j17;
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownloadResult mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.wechat.aff.IlinkC2CDownloadResult parseFrom(byte[] bArr) {
        return (com.tencent.wechat.aff.IlinkC2CDownloadResult) super.parseFrom(bArr);
    }
}
