...
public class IlinkC2CDownload extends com.tencent.mm.protobuf.f {
    private static final com.tencent.wechat.aff.IlinkC2CDownload DEFAULT_INSTANCE = new com.tencent.wechat.aff.IlinkC2CDownload();
    ...
    private java.util.LinkedList<com.tencent.wechat.aff.IlinkCustomHttpHeader> custom_headers = new java.util.LinkedList<>();
    private final boolean[] hasSetFields = new boolean[16];

    public static com.tencent.wechat.aff.IlinkC2CDownload create() {
        return new com.tencent.wechat.aff.IlinkC2CDownload();
    }

    public static com.tencent.wechat.aff.IlinkC2CDownload getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.wechat.aff.IlinkC2CDownload newBuilder() {
        return new com.tencent.wechat.aff.IlinkC2CDownload();
    }

    public com.tencent.wechat.aff.IlinkC2CDownload addAllElementCustomHeaders(java.util.Collection<com.tencent.wechat.aff.IlinkCustomHttpHeader> collection) {
        this.custom_headers.addAll(collection);
        this.hasSetFields[12] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload addElementCustomHeaders(com.tencent.wechat.aff.IlinkCustomHttpHeader ilinkCustomHttpHeader) {
        this.custom_headers.add(ilinkCustomHttpHeader);
        this.hasSetFields[12] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.wechat.aff.IlinkC2CDownload)) {
            return false;
        }
        com.tencent.wechat.aff.IlinkC2CDownload ilinkC2CDownload = (com.tencent.wechat.aff.IlinkC2CDownload) fVar;
    ...
    public java.util.LinkedList<com.tencent.wechat.aff.IlinkCustomHttpHeader> getCustomHeaders() {
    ...
    public com.tencent.wechat.aff.IlinkC2CDownload mergeFrom(com.tencent.mm.protobuf.f fVar) {
        ...
        switch (intValue) {
            ...
            case 12:
                ...
                for (int i19 = 0; i19 < size; i19++) {
                    ...
                    com.tencent.wechat.aff.IlinkCustomHttpHeader ilinkCustomHttpHeader = new com.tencent.wechat.aff.IlinkCustomHttpHeader();
    ...
    public com.tencent.wechat.aff.IlinkC2CDownload setAeskey(com.tencent.mm.protobuf.g gVar) {
        this.aeskey = gVar;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setAppType(int i17) {
        this.app_type = i17;
        this.hasSetFields[10] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setBizid(int i17) {
        this.bizid = i17;
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setConcurrentCount(int i17) {
        this.concurrent_count = i17;
        this.hasSetFields[8] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setCustomHeaders(java.util.LinkedList<com.tencent.wechat.aff.IlinkCustomHttpHeader> linkedList) {
        this.custom_headers = linkedList;
        this.hasSetFields[12] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setDebugip(java.lang.String str) {
        this.debugip = str;
        this.hasSetFields[13] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setDownloadMode(int i17) {
        this.download_mode = i17;
        this.hasSetFields[11] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setFilePath(java.lang.String str) {
        this.file_path = str;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setFileSize(long j17) {
        this.file_size = j17;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setFileType(int i17) {
        this.file_type = i17;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setFileUrl(java.lang.String str) {
        this.file_url = str;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setFileid(com.tencent.mm.protobuf.g gVar) {
        this.fileid = gVar;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setNeedReport(boolean z17) {
        this.need_report = z17;
        this.hasSetFields[14] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setSnsDecryptKey(long j17) {
        this.sns_decrypt_key = j17;
        this.hasSetFields[15] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload setTaskIdent(java.lang.String str) {
        this.task_ident = str;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkC2CDownload mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.wechat.aff.IlinkC2CDownload parseFrom(byte[] bArr) {
        return (com.tencent.wechat.aff.IlinkC2CDownload) super.parseFrom(bArr);
    }
}
