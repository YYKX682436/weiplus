...
public class IlinkPullLogCmd extends com.tencent.mm.protobuf.f {
    private static final com.tencent.wechat.aff.IlinkPullLogCmd DEFAULT_INSTANCE = new com.tencent.wechat.aff.IlinkPullLogCmd();
    ...
    public static com.tencent.wechat.aff.IlinkPullLogCmd create() {
        return new com.tencent.wechat.aff.IlinkPullLogCmd();
    }

    public static com.tencent.wechat.aff.IlinkPullLogCmd getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.wechat.aff.IlinkPullLogCmd newBuilder() {
        return new com.tencent.wechat.aff.IlinkPullLogCmd();
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd addAllElementIlinkAppids(java.util.Collection<java.lang.String> collection) {
        this.ilink_appids.addAll(collection);
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd addAllElementIlinkLogs(java.util.Collection<java.lang.String> collection) {
        this.ilink_logs.addAll(collection);
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd addElementIlinkAppids(java.lang.String str) {
        this.ilink_appids.add(str);
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd addElementIlinkLogs(java.lang.String str) {
        this.ilink_logs.add(str);
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.wechat.aff.IlinkPullLogCmd)) {
            return false;
        }
        com.tencent.wechat.aff.IlinkPullLogCmd ilinkPullLogCmd = (com.tencent.wechat.aff.IlinkPullLogCmd) fVar;
    ...
    public com.tencent.wechat.aff.IlinkPullLogCmd mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.wechat.aff.IlinkPullLogCmd setEndTime(int i17) {
        this.end_time = i17;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setExtBuffer(java.lang.String str) {
        this.ext_buffer = str;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setIlinkAppids(java.util.LinkedList<java.lang.String> linkedList) {
        this.ilink_appids = linkedList;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setIlinkCapath(java.lang.String str) {
        this.ilink_capath = str;
        this.hasSetFields[8] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setIlinkLogs(java.util.LinkedList<java.lang.String> linkedList) {
        this.ilink_logs = linkedList;
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setIncludeDevlog(boolean z17) {
        this.include_devlog = z17;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setStartTime(int i17) {
        this.start_time = i17;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setUploadToken(java.lang.String str) {
        this.upload_token = str;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd setUseNettype(int i17) {
        this.use_nettype = i17;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.wechat.aff.IlinkPullLogCmd mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.wechat.aff.IlinkPullLogCmd parseFrom(byte[] bArr) {
        return (com.tencent.wechat.aff.IlinkPullLogCmd) super.parseFrom(bArr);
    }
}
