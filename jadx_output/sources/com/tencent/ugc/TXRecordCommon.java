...
public class TXRecordCommon {
    ...
    public static final java.lang.String EVT_DESCRIPTION = "EVT_DESCRIPTION";
    ...
    public static final java.lang.String EVT_PARAM1 = "EVT_PARAM1";
    public static final java.lang.String EVT_PARAM2 = "EVT_PARAM2";
    public static final java.lang.String EVT_TIME = "EVT_TIME";
    ...
    public interface ITXVideoRecordListener {
        void onRecordComplete(com.tencent.ugc.TXRecordCommon.TXRecordResult tXRecordResult);

        void onRecordEvent(int i17, android.os.Bundle bundle);

        void onRecordProgress(long j17);
    }

    /* loaded from: classes14.dex */
    public static final class TXRecordResult {
        public java.lang.String coverPath;
        public java.lang.String descMsg;
        public int retCode;
    ...
    public static final class TXUGCCustomConfig {
        ...
        public android.graphics.Bitmap watermark = null;
        ...
        public int maxDuration = com.tencent.thumbplayer.tmediacodec.codec.CodecError.DEQUEUEOUTPUTBUFFER_ILLEGAL;
