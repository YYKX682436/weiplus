...
public class AppDeviceSession extends com.tencent.wechat.zidl2.ZidlBaseCaller {
    private com.tencent.ilink.AppDeviceSession.Destructor destructor;
    com.tencent.ilink.ZIDL_AbazfhOlK jniCaller = new com.tencent.ilink.ZIDL_AbazfhOlK();
    ...
    public static class Destructor extends com.tencent.wechat.zidl2.DestructorThread.Destructor {
        ...
        public Destructor(java.lang.Object obj, long j17) {
            super(obj);
            com.tencent.wechat.zlog.Zlog.a(TAG, "constructor AppDeviceSession Destructor()", new java.lang.Object[0]);
        }

        @Override // com.tencent.wechat.zidl2.DestructorThread.Destructor
        public void destruct() {
            com.tencent.wechat.zlog.Zlog.a(TAG, "destructor AppDeviceSession Destructor() id:" + this.zidlIdentity + "svrid: " + this.zidlSvrIdentity, new java.lang.Object[0]);
            com.tencent.ilink.ZIDL_AbazfhOlK.ZIDL_AbazfhOlD(this.nativeHandler, this.zidlIdentity, this.zidlSvrIdentity);
        }
    }
    ...
    public AppDeviceSession(com.tencent.wechat.zidl2.ZidlBaseCaller.ObjConstructorKey objConstructorKey, java.lang.String str, java.lang.String str2, long j17) {
        ...
        this.jniCaller.ZIDL_AbazfhOlC(this, this.zidlCreateName, this.zidlSvrIdentity, null);
    }

    public static com.tencent.ilink.AppDeviceSession buildZidlObjForHolder(java.lang.String str, java.lang.String str2, long j17) {
        return new com.tencent.ilink.AppDeviceSession(new com.tencent.wechat.zidl2.ZidlBaseCaller.ObjConstructorKey(), str, str2, j17);
    }
    ...
    public void manualDestroy() {
        this.jniCaller.ZIDL_F(this.nativeHandler);
    }
    ...
    public void readyForLifeCycle() {
        com.tencent.ilink.AppDeviceSession.Destructor destructor = new com.tencent.ilink.AppDeviceSession.Destructor(this, this.nativeHandler);
