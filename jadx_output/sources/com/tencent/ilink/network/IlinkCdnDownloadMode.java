...
public enum IlinkCdnDownloadMode implements com.tencent.mm.protobuf.h {
    ...
    public static com.tencent.ilink.network.IlinkCdnDownloadMode forNumber(int i17) {
        if (i17 == 0) {
            return kModeStorage;
        }
        if (i17 == 1) {
    ...
    public static com.tencent.ilink.network.IlinkCdnDownloadMode valueOf(int i17) {
