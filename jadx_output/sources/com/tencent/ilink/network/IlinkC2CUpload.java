...
public class IlinkC2CUpload extends com.tencent.mm.protobuf.f {
    private static final com.tencent.ilink.network.IlinkC2CUpload DEFAULT_INSTANCE = new com.tencent.ilink.network.IlinkC2CUpload();
    private int app_type;
    private com.tencent.ilink.network.IlinkEBizScene biz_scene;
    ...
    public static com.tencent.ilink.network.IlinkC2CUpload create() {
        return new com.tencent.ilink.network.IlinkC2CUpload();
    }

    public static com.tencent.ilink.network.IlinkC2CUpload getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.ilink.network.IlinkC2CUpload newBuilder() {
        return new com.tencent.ilink.network.IlinkC2CUpload();
    }

    public com.tencent.ilink.network.IlinkC2CUpload build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.ilink.network.IlinkC2CUpload)) {
            return false;
        }
        com.tencent.ilink.network.IlinkC2CUpload ilinkC2CUpload = (com.tencent.ilink.network.IlinkC2CUpload) fVar;
    ...
    public com.tencent.ilink.network.IlinkEBizScene getBizScene() {
        return this.hasSetFields[5] ? this.biz_scene : com.tencent.ilink.network.IlinkEBizScene.kC2CScene;
    }
    ...
    public com.tencent.ilink.network.IlinkC2CUpload mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public final int op(int i17, java.lang.Object... objArr) {
        if (i17 == 0) {
            ...
            com.tencent.ilink.network.IlinkEBizScene ilinkEBizScene = this.biz_scene;
        ...
        if (i17 == 1) {
            ...
            com.tencent.ilink.network.IlinkEBizScene ilinkEBizScene2 = this.biz_scene;
        ...
        switch (intValue) {
            ...
            case 4:
                ...
                return 0;
            case 5:
                this.biz_scene = com.tencent.ilink.network.IlinkEBizScene.forNumber(aVar2.g(intValue));
    ...
    public com.tencent.ilink.network.IlinkC2CUpload setAppType(int i17) {
        this.app_type = i17;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setBizScene(com.tencent.ilink.network.IlinkEBizScene ilinkEBizScene) {
        this.biz_scene = ilinkEBizScene;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setDebugip(java.lang.String str) {
        this.debugip = str;
        this.hasSetFields[11] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setFileData(com.tencent.mm.protobuf.g gVar) {
        this.file_data = gVar;
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setFilePath(java.lang.String str) {
        this.file_path = str;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setFileType(int i17) {
        this.file_type = i17;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setIsStorageMode(boolean z17) {
        this.is_storage_mode = z17;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setNeedReport(boolean z17) {
        this.need_report = z17;
        this.hasSetFields[12] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setSnsUploadVersion(int i17) {
        this.sns_upload_version = i17;
        this.hasSetFields[8] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setTaskIdent(java.lang.String str) {
        this.task_ident = str;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setThumbFiledata(com.tencent.mm.protobuf.g gVar) {
        this.thumb_filedata = gVar;
        this.hasSetFields[10] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload setThumbFilepath(java.lang.String str) {
        this.thumb_filepath = str;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUpload mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.ilink.network.IlinkC2CUpload parseFrom(byte[] bArr) {
        return (com.tencent.ilink.network.IlinkC2CUpload) super.parseFrom(bArr);
    }
}
