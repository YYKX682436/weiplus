...
public class IlinkDeviceSessionInfo extends com.tencent.mm.protobuf.f {
    private static final com.tencent.ilink.network.IlinkDeviceSessionInfo DEFAULT_INSTANCE = new com.tencent.ilink.network.IlinkDeviceSessionInfo();
    ...
    public static com.tencent.ilink.network.IlinkDeviceSessionInfo create() {
        return new com.tencent.ilink.network.IlinkDeviceSessionInfo();
    }

    public static com.tencent.ilink.network.IlinkDeviceSessionInfo getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.ilink.network.IlinkDeviceSessionInfo newBuilder() {
        return new com.tencent.ilink.network.IlinkDeviceSessionInfo();
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.ilink.network.IlinkDeviceSessionInfo)) {
            return false;
        }
        com.tencent.ilink.network.IlinkDeviceSessionInfo ilinkDeviceSessionInfo = (com.tencent.ilink.network.IlinkDeviceSessionInfo) fVar;
    ...
    public com.tencent.ilink.network.IlinkDeviceSessionInfo mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.ilink.network.IlinkDeviceSessionInfo setAutoauthEncKey(com.tencent.mm.protobuf.g gVar) {
        this.autoauth_enc_key = gVar;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setClientRandomKey(com.tencent.mm.protobuf.g gVar) {
        this.client_random_key = gVar;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setCookie(com.tencent.mm.protobuf.g gVar) {
        this.cookie = gVar;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setIlinkDeviceid(com.tencent.mm.protobuf.g gVar) {
        this.ilink_deviceid = gVar;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setIlinkProductid(int i17) {
        this.ilink_productid = i17;
        this.hasSetFields[8] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setServerRandomKey(com.tencent.mm.protobuf.g gVar) {
        this.server_random_key = gVar;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setServerid(com.tencent.mm.protobuf.g gVar) {
        this.serverid = gVar;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo setUin(long j17) {
        this.uin = j17;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkDeviceSessionInfo mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.ilink.network.IlinkDeviceSessionInfo parseFrom(byte[] bArr) {
        return (com.tencent.ilink.network.IlinkDeviceSessionInfo) super.parseFrom(bArr);
    }
}
