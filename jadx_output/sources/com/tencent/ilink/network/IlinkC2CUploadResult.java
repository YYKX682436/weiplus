...
public class IlinkC2CUploadResult extends com.tencent.mm.protobuf.f {
    private static final com.tencent.ilink.network.IlinkC2CUploadResult DEFAULT_INSTANCE = new com.tencent.ilink.network.IlinkC2CUploadResult();
    ...
    public static com.tencent.ilink.network.IlinkC2CUploadResult create() {
        return new com.tencent.ilink.network.IlinkC2CUploadResult();
    }

    public static com.tencent.ilink.network.IlinkC2CUploadResult getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.ilink.network.IlinkC2CUploadResult newBuilder() {
        return new com.tencent.ilink.network.IlinkC2CUploadResult();
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.ilink.network.IlinkC2CUploadResult)) {
            return false;
        }
        com.tencent.ilink.network.IlinkC2CUploadResult ilinkC2CUploadResult = (com.tencent.ilink.network.IlinkC2CUploadResult) fVar;
    ...
    public com.tencent.ilink.network.IlinkC2CUploadResult mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.ilink.network.IlinkC2CUploadResult setAeskey(com.tencent.mm.protobuf.g gVar) {
        this.aeskey = gVar;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult setErrorCode(int i17) {
        this.error_code = i17;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult setFileSize(long j17) {
        this.file_size = j17;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult setFileUrl(java.lang.String str) {
        this.file_url = str;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult setFileid(com.tencent.mm.protobuf.g gVar) {
        this.fileid = gVar;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult setTaskIdent(java.lang.String str) {
        this.task_ident = str;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult setThumbUrl(java.lang.String str) {
        this.thumb_url = str;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CUploadResult mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.ilink.network.IlinkC2CUploadResult parseFrom(byte[] bArr) {
        return (com.tencent.ilink.network.IlinkC2CUploadResult) super.parseFrom(bArr);
    }
}
