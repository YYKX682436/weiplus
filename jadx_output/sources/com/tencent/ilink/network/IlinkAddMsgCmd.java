...
public class IlinkAddMsgCmd extends com.tencent.mm.protobuf.f {
    private static final com.tencent.ilink.network.IlinkAddMsgCmd DEFAULT_INSTANCE = new com.tencent.ilink.network.IlinkAddMsgCmd();
    ...
    public static com.tencent.ilink.network.IlinkAddMsgCmd create() {
        return new com.tencent.ilink.network.IlinkAddMsgCmd();
    }

    public static com.tencent.ilink.network.IlinkAddMsgCmd getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.ilink.network.IlinkAddMsgCmd newBuilder() {
        return new com.tencent.ilink.network.IlinkAddMsgCmd();
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.ilink.network.IlinkAddMsgCmd)) {
            return false;
        }
        com.tencent.ilink.network.IlinkAddMsgCmd ilinkAddMsgCmd = (com.tencent.ilink.network.IlinkAddMsgCmd) fVar;
    ...
    public com.tencent.ilink.network.IlinkAddMsgCmd mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.ilink.network.IlinkAddMsgCmd setContent(java.lang.String str) {
        this.Content = str;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setCreateTime(long j17) {
        this.CreateTime = j17;
        this.hasSetFields[9] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setFromUsername(java.lang.String str) {
        this.FromUsername = str;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setId(long j17) {
        this.Id = j17;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setMsgType(int i17) {
        this.MsgType = i17;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setPushContent(java.lang.String str) {
        this.PushContent = str;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setRoomName(java.lang.String str) {
        this.RoomName = str;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setSeq(long j17) {
        this.Seq = j17;
        this.hasSetFields[8] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setStatus(long j17) {
        this.Status = j17;
        this.hasSetFields[10] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd setToUsername(java.lang.String str) {
        this.ToUsername = str;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkAddMsgCmd mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.ilink.network.IlinkAddMsgCmd parseFrom(byte[] bArr) {
        return (com.tencent.ilink.network.IlinkAddMsgCmd) super.parseFrom(bArr);
    }
}
