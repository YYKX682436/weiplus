...
public class IlinkC2CBatchSnsReqImageData extends com.tencent.mm.protobuf.f {
    private static final com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData DEFAULT_INSTANCE = new com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData();
    ...
    public static com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData create() {
        return new com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData();
    }

    public static com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData newBuilder() {
        return new com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData();
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData)) {
            return false;
        }
        com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData ilinkC2CBatchSnsReqImageData = (com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData) fVar;
    ...
    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setDecryptKey(long j17) {
        this.decryptKey = j17;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setFileKey(com.tencent.mm.protobuf.g gVar) {
        this.fileKey = gVar;
        this.hasSetFields[6] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setImageCachePath(com.tencent.mm.protobuf.g gVar) {
        this.imageCachePath = gVar;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setPicIndex(int i17) {
        this.picIndex = i17;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setRetry(boolean z17) {
        this.retry = z17;
        this.hasSetFields[7] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setTotalFileSize(long j17) {
        this.totalFileSize = j17;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData setUrl(com.tencent.mm.protobuf.g gVar) {
        this.url = gVar;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData parseFrom(byte[] bArr) {
        return (com.tencent.ilink.network.IlinkC2CBatchSnsReqImageData) super.parseFrom(bArr);
    }
}
