...
public enum IlinkPullLogNetType implements com.tencent.mm.protobuf.h {
    ...
    public static com.tencent.ilink.network.IlinkPullLogNetType forNumber(int i17) {
        if (i17 == 0) {
            return kIlinkLan;
        }
        if (i17 != 1) {
    ...
    public static com.tencent.ilink.network.IlinkPullLogNetType valueOf(int i17) {
