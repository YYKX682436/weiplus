...
public class IlinkSmcBaseInfo extends com.tencent.mm.protobuf.f {
    private static final com.tencent.ilink.network.IlinkSmcBaseInfo DEFAULT_INSTANCE = new com.tencent.ilink.network.IlinkSmcBaseInfo();
    ...
    public static com.tencent.ilink.network.IlinkSmcBaseInfo create() {
        return new com.tencent.ilink.network.IlinkSmcBaseInfo();
    }

    public static com.tencent.ilink.network.IlinkSmcBaseInfo getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    public static com.tencent.ilink.network.IlinkSmcBaseInfo newBuilder() {
        return new com.tencent.ilink.network.IlinkSmcBaseInfo();
    }

    public com.tencent.ilink.network.IlinkSmcBaseInfo build() {
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public boolean compareContent(com.tencent.mm.protobuf.f fVar) {
        if (fVar == null || !(fVar instanceof com.tencent.ilink.network.IlinkSmcBaseInfo)) {
            return false;
        }
        com.tencent.ilink.network.IlinkSmcBaseInfo ilinkSmcBaseInfo = (com.tencent.ilink.network.IlinkSmcBaseInfo) fVar;
    ...
    public com.tencent.ilink.network.IlinkSmcBaseInfo mergeFrom(com.tencent.mm.protobuf.f fVar) {
    ...
    public com.tencent.ilink.network.IlinkSmcBaseInfo setDeviceBrand(java.lang.String str) {
        this.device_brand = str;
        this.hasSetFields[2] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkSmcBaseInfo setDeviceModel(java.lang.String str) {
        this.device_model = str;
        this.hasSetFields[1] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkSmcBaseInfo setLanguageVer(java.lang.String str) {
        this.language_ver = str;
        this.hasSetFields[5] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkSmcBaseInfo setOsname(java.lang.String str) {
        this.osname = str;
        this.hasSetFields[3] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkSmcBaseInfo setOsversion(java.lang.String str) {
        this.osversion = str;
        this.hasSetFields[4] = true;
        return this;
    }

    public com.tencent.ilink.network.IlinkSmcBaseInfo mergeFrom(byte[] bArr) {
        parseFrom(bArr);
        return this;
    }

    @Override // com.tencent.mm.protobuf.f
    public com.tencent.ilink.network.IlinkSmcBaseInfo parseFrom(byte[] bArr) {
        return (com.tencent.ilink.network.IlinkSmcBaseInfo) super.parseFrom(bArr);
    }
}
