...
public class LogUtil {
    ...
    private static final java.util.Map<java.lang.Integer, com.tencent.mapsdk.internal.ky> f48745a = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    private static com.tencent.mapsdk.internal.ky f48746b;

    public static com.tencent.mapsdk.internal.ky a(int i17) {
        com.tencent.mapsdk.internal.ky kyVar;
        java.util.Map<java.lang.Integer, com.tencent.mapsdk.internal.ky> map = f48745a;
        if (map.containsKey(java.lang.Integer.valueOf(i17)) && (kyVar = map.get(java.lang.Integer.valueOf(i17))) != null) {
            return kyVar;
        }
        if (f48746b == null) {
            f48746b = (com.tencent.mapsdk.internal.ky) com.tencent.mapsdk.internal.hp.a(com.tencent.mapsdk.internal.ky.class, "Methods invoke by default Logger !");
        }
        return f48746b;
    }
    ...
    public static void c(java.lang.String str, java.lang.String str2) {
        com.tencent.mapsdk.internal.ky kyVar = f48746b;
        if (kyVar != null) {
            kyVar.c(str, str2);
        } else {
            f(str, str2);
    ...
    public static void printNativeLog(java.lang.String str, java.lang.String str2) {
        java.util.Map<java.lang.Integer, com.tencent.mapsdk.internal.ky> map = f48745a;
        if (map.isEmpty()) {
            return;
        }
    ...
    public static void a(int i17, com.tencent.mapsdk.internal.ky kyVar) {
        java.util.Map<java.lang.Integer, com.tencent.mapsdk.internal.ky> map = f48745a;
        if (map.containsKey(java.lang.Integer.valueOf(i17))) {
            return;
        }
    ...
    public static void a(com.tencent.mapsdk.internal.ky kyVar) {
        f48746b = kyVar;
    }
