...
public final class n {
    ...
    public java.nio.ByteBuffer f50484a;

    /* renamed from: b, reason: collision with root package name */
    protected java.lang.String f50485b;

    /* renamed from: c, reason: collision with root package name */
    private com.tencent.mapsdk.internal.r f50486c;

    private n(java.nio.ByteBuffer byteBuffer) {
        this.f50485b = "GBK";
        this.f50484a = byteBuffer;
    }
    ...
    private void c(java.lang.String str, int i17) {
        a(str.length() + 10);
        byte[] a17 = com.tencent.mapsdk.internal.i.a(str);
        if (a17.length > 255) {
            b((byte) 7, i17);
            this.f50484a.putInt(a17.length);
            this.f50484a.put(a17);
        } else {
            b((byte) 6, i17);
            this.f50484a.put((byte) a17.length);
            this.f50484a.put(a17);
        }
    }

    public final byte[] a() {
        byte[] bArr = new byte[this.f50484a.position()];
        java.lang.System.arraycopy(this.f50484a.array(), 0, bArr, 0, this.f50484a.position());
        return bArr;
    }

    private void b(byte b17, int i17) {
        if (i17 < 15) {
            this.f50484a.put((byte) (b17 | (i17 << 4)));
        } else {
            if (i17 < 256) {
                this.f50484a.put((byte) (b17 | 240));
                this.f50484a.put((byte) i17);
                return;
            }
            throw new com.tencent.mapsdk.internal.l("tag is too large: ".concat(java.lang.String.valueOf(i17)));
        }
    }

    private void a(int i17) {
        if (this.f50484a.remaining() < i17) {
            java.nio.ByteBuffer allocate = java.nio.ByteBuffer.allocate((this.f50484a.capacity() + i17) * 2);
            allocate.put(this.f50484a.array(), 0, this.f50484a.position());
            this.f50484a = allocate;
        }
    }

    public n(int i17) {
        this.f50485b = "GBK";
        this.f50484a = java.nio.ByteBuffer.allocate(i17);
    }
    ...
    public final void a(byte b17, int i17) {
        ...
        if (b17 == 0) {
            ...
            b((byte) 0, i17);
            this.f50484a.put(b17);
        }
    }

    private com.tencent.mapsdk.internal.r c() {
        return this.f50486c;
    }
    ...
    public final void a(java.lang.String str, int i17) {
        ...
        if (bytes.length > 255) {
            b((byte) 7, i17);
            this.f50484a.putInt(bytes.length);
            this.f50484a.put(bytes);
        } else {
            b((byte) 6, i17);
            this.f50484a.put((byte) bytes.length);
            this.f50484a.put(bytes);
        }
    }
    ...
    public final void a(com.tencent.mapsdk.internal.p pVar, int i17) {
        a(2);
        b((byte) 10, i17);
        pVar.writeTo(this);
        a(2);
    ...
    public final void a(java.lang.Object obj, int i17) {
        ...
        if (obj instanceof com.tencent.mapsdk.internal.p) {
            a((com.tencent.mapsdk.internal.p) obj, i17);
            return;
        }
        ...
        if (obj.getClass().isArray()) {
            ...
            throw new com.tencent.mapsdk.internal.l("write object error: unsupport type. " + obj.getClass());
        }
    }
    ...
    private void a(com.tencent.mapsdk.internal.r rVar) {
        this.f50486c = rVar;
    }
}
