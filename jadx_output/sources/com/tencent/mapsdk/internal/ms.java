...
public final class ms implements com.tencent.mapsdk.internal.mu {

    /* renamed from: g, reason: collision with root package name */
    private int f50447g = 0;

    /* renamed from: h, reason: collision with root package name */
    private byte[] f50448h;
    ...
    private byte c() {
        int i17;
        byte[] bArr = this.f50448h;
        if (bArr == null || (i17 = this.f50447g) >= bArr.length) {
            return (byte) 0;
        }
        this.f50447g = i17 + 1;
        return bArr[i17];
    ...
    private boolean k() {
        return this.f50447g == this.f50448h.length - 1;
    }
