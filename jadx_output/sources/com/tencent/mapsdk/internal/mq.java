...
public final class mq {
    ...
    public static final int f50445a = 1;

    /* renamed from: b, reason: collision with root package name */
    public static final int f50446b = 2;
    ...
    private static android.graphics.Bitmap c(com.tencent.tencentmap.mapsdk.maps.TencentMapContext tencentMapContext, android.graphics.Bitmap bitmap, java.lang.String str, int i17, int i18) {
        float width = bitmap.getWidth();
        float height = bitmap.getHeight();
        com.tencent.mapsdk.internal.na naVar = new com.tencent.mapsdk.internal.na(tencentMapContext);
        naVar.setColor(i17);
    ...
    private static int b(javax.microedition.khronos.opengles.GL10 gl10) {
        ...
        gl10.glTexParameterf(3553, com.google.android.gms.gcm.Task.EXTRAS_LIMIT_BYTES, 9729.0f);
    ...
    private static android.graphics.Bitmap b(com.tencent.tencentmap.mapsdk.maps.TencentMapContext tencentMapContext, android.graphics.Bitmap bitmap, java.lang.String str, int i17, int i18) {
        float width = bitmap.getWidth();
        float height = bitmap.getHeight();
        com.tencent.mapsdk.internal.na naVar = new com.tencent.mapsdk.internal.na(tencentMapContext);
        naVar.setColor(i17);
    ...
    private static int a(javax.microedition.khronos.opengles.GL10 gl10, int i17, int i18, int i19, int i27, java.nio.IntBuffer intBuffer) {
        int b17 = b(gl10);
        gl10.glTexImage2D(3553, 0, com.github.henryye.nativeiv.bitmap.NativeBitmapStruct.GLFormat.GL_RGBA, i17, i18, 0, com.github.henryye.nativeiv.bitmap.NativeBitmapStruct.GLFormat.GL_RGBA, com.github.henryye.nativeiv.bitmap.NativeBitmapStruct.GLType.GL_UNSIGNED_BYTE, null);
        gl10.glTexSubImage2D(3553, 0, 0, 0, i19, i27, com.github.henryye.nativeiv.bitmap.NativeBitmapStruct.GLFormat.GL_RGBA, com.github.henryye.nativeiv.bitmap.NativeBitmapStruct.GLType.GL_UNSIGNED_BYTE, intBuffer);
        return b17;
    }

    private static float a(com.tencent.tencentmap.mapsdk.maps.TencentMapContext tencentMapContext, java.lang.String str, int i17, float f17) {
        com.tencent.mapsdk.internal.na naVar = new com.tencent.mapsdk.internal.na(tencentMapContext);
    ...
    private static android.graphics.Bitmap a(com.tencent.tencentmap.mapsdk.maps.TencentMapContext tencentMapContext, android.graphics.Bitmap bitmap, java.lang.String str, int i17, int i18) {
        float width = bitmap.getWidth();
        float height = bitmap.getHeight();
        com.tencent.mapsdk.internal.na naVar = new com.tencent.mapsdk.internal.na(tencentMapContext);
        naVar.setColor(i17);
