...
public final class rc implements com.tencent.mapsdk.core.utils.cache.DiskCache.a {

    /* renamed from: a, reason: collision with root package name */
    private final int f51142a = 128;

    /* renamed from: b, reason: collision with root package name */
    private java.lang.String f51143b;
    ...
    private static int b(byte[] bArr) {
        return ((bArr[3] << 24) & (-16777216)) | (bArr[0] & 255) | ((bArr[1] << 8) & 65280) | ((bArr[2] << com.tencent.wxmm.v2encoder.enumCODEC_vcodec2) & 16711680);
    }
    ...
    public final java.io.File a(java.lang.String str, java.lang.String str2, byte[] bArr) {
        if (android.text.TextUtils.isEmpty(this.f51143b)) {
            return null;
        }
    ...
    public final byte[] a(java.lang.String str, java.io.File file) {
        java.lang.String str2 = this.f51143b;
        int lastIndexOf = str.lastIndexOf(java.io.File.separatorChar);
        if (lastIndexOf >= 0) {
            java.lang.String substring = str.substring(0, lastIndexOf);
            if (!android.text.TextUtils.isEmpty(substring)) {
    ...
    public final boolean a(java.io.File file) {
        return com.tencent.mapsdk.internal.ks.b(new java.io.File(this.f51143b));
    }
    ...
    private static boolean a(java.lang.String str, int i17, int i18, byte[] bArr) {
        ...
        if (!file.exists() && !com.tencent.mapsdk.internal.ks.a(file)) {
            return false;
        }
        ...
        try {
            ...
            if (!file2.exists() && !com.tencent.mapsdk.internal.ks.a(file2)) {
                return false;
            }
            try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    com.tencent.mapsdk.core.utils.log.LogUtil.c("读取瓦片缓存的大小异常", th6);
                                    return null;
                                } finally {
