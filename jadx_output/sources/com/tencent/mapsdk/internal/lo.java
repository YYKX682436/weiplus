...
public final class lo {
    private static float[][] a(float[] fArr, float[] fArr2) {
        ...
        float[][] fArr4 = (float[][]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) java.lang.Float.TYPE, 6, 4);
        float[] fArr5 = fArr4[0];
        fArr5[0] = fArr3[3] - fArr3[0];
        fArr5[1] = fArr3[7] - fArr3[4];
        fArr5[2] = fArr3[11] - fArr3[8];
        fArr5[3] = fArr3[15] - fArr3[12];
        double sqrt = java.lang.Math.sqrt((r7 * r7) + (r9 * r9) + (r12 * r12));
        float[] fArr6 = fArr4[0];
        ...
        double sqrt2 = java.lang.Math.sqrt((r2 * r2) + (r5 * r5) + (r11 * r11));
        float[] fArr8 = fArr4[1];
        ...
        double sqrt3 = java.lang.Math.sqrt((r2 * r2) + (r5 * r5) + (r12 * r12));
        ...
        double sqrt4 = java.lang.Math.sqrt((r2 * r2) + (r5 * r5) + (r13 * r13));
        ...
        double sqrt5 = java.lang.Math.sqrt((r1 * r1) + (r5 * r5) + (r12 * r12));
        ...
        double sqrt6 = java.lang.Math.sqrt((r2 * r2) + (r5 * r5) + (r8 * r8));
    ...
    private static boolean b(float[][] fArr, float[] fArr2) {
        ...
        for (int i17 = 0; i17 < 6; i17++) {
            ...
            while (i18 < length) {
                ...
                int i27 = i19 + 1;
                int i28 = i27 + 1;
                float f17 = (fArr3[0] * fArr2[i19]) + (fArr3[1] * fArr2[i27]);
                int i29 = i28 + 1;
                if (f17 + (fArr3[2] * fArr2[i28]) + fArr3[3] > 0.0f) {
                    break;
                }
                i18++;
                i19 = i29;
