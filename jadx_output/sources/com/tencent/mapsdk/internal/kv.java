...
public final class kv {
    ...
    private static final int f50192a = 49152;
    ...
    public static boolean a(java.io.File[] fileArr, java.io.File file, java.lang.String str) {
        ...
        java.io.File a17 = com.tencent.mapsdk.internal.ks.a(file, str);
        for (java.io.File file2 : fileArr) {
            com.tencent.mapsdk.internal.ks.b(file2, a17);
        }
        try {
            a(a17, file.getAbsolutePath());
            com.tencent.mapsdk.internal.ks.f(a17);
            return true;
        } catch (java.lang.Exception unused) {
            com.tencent.mapsdk.internal.ks.f(a17);
            return false;
    ...
    private static byte[] a(java.lang.String str) {
        ...
        if (!android.text.TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                try {
                    gZIPOutputStream2.write(str.getBytes(com.tencent.mapsdk.internal.rv.f51270c));
                    gZIPOutputStream2.finish();
                    byte[] byteArray = byteArrayOutputStream.toByteArray();
                    com.tencent.mapsdk.internal.kt.a(gZIPOutputStream2);
                    com.tencent.mapsdk.internal.kt.a(byteArrayOutputStream);
                    return byteArray;
                } catch (java.io.IOException unused2) {
                    gZIPOutputStream = gZIPOutputStream2;
                    com.tencent.mapsdk.internal.kt.a(gZIPOutputStream);
                    com.tencent.mapsdk.internal.kt.a(byteArrayOutputStream);
                    return new byte[0];
    ...
    public static byte[] a(java.io.InputStream inputStream) {
        ...
        if (inputStream != null) {
            try {
                ...
                try {
                    byte[] b17 = com.tencent.mapsdk.internal.kt.b(gZIPInputStream2);
                    com.tencent.mapsdk.internal.kt.a((java.io.Closeable) gZIPInputStream2);
                    return b17;
                } catch (java.io.IOException unused) {
                    ...
                    th = th6;
                    gZIPInputStream = gZIPInputStream2;
                    com.tencent.mapsdk.internal.kt.a((java.io.Closeable) gZIPInputStream);
                    throw th;
                }
            } catch (java.io.IOException unused2) {
            } catch (java.lang.Throwable th7) {
