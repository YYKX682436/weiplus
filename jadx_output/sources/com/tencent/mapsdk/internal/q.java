...
public final class q {
    ...
    private static final int f50850a = 37;

    /* renamed from: b, reason: collision with root package name */
    private static final int f50851b = 17;

    /* renamed from: c, reason: collision with root package name */
    private static final byte[] f50852c;

    /* renamed from: d, reason: collision with root package name */
    private static final byte[] f50853d;
    ...
    private static java.lang.String b(byte[] bArr) {
        ...
        stringBuffer.append((char) f50852c[i17]);
        stringBuffer.append((char) f50853d[i17]);
        while (true) {
            remaining--;
            if (remaining > 0) {
                stringBuffer.append(' ');
                int i18 = wrap.get() & 255;
                stringBuffer.append((char) f50852c[i18]);
                stringBuffer.append((char) f50853d[i18]);
            } else {
    ...
    private static int a(com.tencent.mapsdk.internal.p[] pVarArr) {
        if (pVarArr == null) {
            return 629;
        }
        int i17 = 17;
        for (com.tencent.mapsdk.internal.p pVar : pVarArr) {
        ...
        while (obj != null) {
            if (obj.getClass().isArray()) {
                if (obj instanceof com.tencent.mapsdk.internal.p[]) {
                    int i17 = 17;
                    for (com.tencent.mapsdk.internal.p pVar : (com.tencent.mapsdk.internal.p[]) obj) {
                        i17 = (i17 * 37) + pVar.hashCode();
                    }
                    return i17;
                }
