...
public final class mt implements com.tencent.mapsdk.internal.mu {

    /* renamed from: g, reason: collision with root package name */
    private static final java.lang.String f50449g = "UTF-16LE";

    /* renamed from: h, reason: collision with root package name */
    private java.io.ByteArrayOutputStream f50450h = new java.io.ByteArrayOutputStream();

    private void a(byte b17) {
        this.f50450h.write(b17);
    }
    ...
    private void c(byte[] bArr) {
        this.f50450h.write(bArr, 0, bArr.length);
    }
    ...
    public static java.lang.String b(byte[] bArr) {
        try {
            return new java.lang.String(bArr, f50449g).trim();
        } catch (java.lang.Exception unused) {
            return null;
        }
    }
    ...
    private void a(java.lang.String str) {
        ...
        a(bytes.length, 2);
        this.f50450h.write(bytes, 0, bytes.length);
    }
    ...
    private byte[] a() {
        ...
        try {
            this.f50450h.close();
            byte[] byteArray = this.f50450h.toByteArray();
            try {
                this.f50450h = null;
                return byteArray;
