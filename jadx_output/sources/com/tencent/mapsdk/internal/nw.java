...
public class nw extends com.tencent.mapsdk.internal.ng<com.tencent.mapsdk.internal.ny> implements com.tencent.map.sdk.utilities.visualization.heatmap.GradientVectorOverlay {
    public nw(com.tencent.mapsdk.internal.nx nxVar, com.tencent.mapsdk.internal.ny nyVar) {
        super(nxVar, nyVar);
    }
    ...
    public com.tencent.map.lib.models.ReturnInfoModelClass.ReturnStatus executeCommandFunction(com.tencent.map.lib.models.CommandFunctionModelClass.BaseCommandFunction baseCommandFunction) {
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$SetZoomLevelRangeCommand")) {
            ...
            ((com.tencent.mapsdk.internal.ny) this.f50567d).setZoomLevelRange(zoomLevelRangeParams.minLevel, zoomLevelRangeParams.maxLevel);
            a((com.tencent.mapsdk.internal.nw) this.f50567d);
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$GetVisibleCommand")) {
            return new com.tencent.map.lib.models.ReturnInfoModelClass.BaseBooleanReturnInfo(((com.tencent.mapsdk.internal.ny) this.f50567d).isVisible());
        }
    ...
    public java.lang.String getType() {
        return com.tencent.mapsdk.internal.ef.Gradient.f49245h;
    }
    ...
    public void setLevel(int i17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.ny) t17).f50589a != null) {
            ((com.tencent.mapsdk.internal.ny) t17).f50589a.displayLevel(i17);
        }
        ((com.tencent.mapsdk.internal.ny) this.f50567d).setLevel(i17);
        a((com.tencent.mapsdk.internal.nw) this.f50567d);
    }
    ...
    public void setOpacity(float f17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.ny) t17).f50589a != null) {
            ((com.tencent.mapsdk.internal.ny) t17).f50589a.opacity(f17);
        }
        ((com.tencent.mapsdk.internal.ny) this.f50567d).setOpacity(f17);
        a((com.tencent.mapsdk.internal.nw) this.f50567d);
    }
    ...
    public void setVisibility(boolean z17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.ny) t17).f50589a != null) {
            ((com.tencent.mapsdk.internal.ny) t17).f50589a.visibility(z17);
        }
        ((com.tencent.mapsdk.internal.ny) this.f50567d).setVisible(z17);
        a((com.tencent.mapsdk.internal.nw) this.f50567d);
    }
    ...
    public void setZIndex(int i17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.ny) t17).f50589a != null) {
            ((com.tencent.mapsdk.internal.ny) t17).f50589a.zIndex(i17);
        }
        ((com.tencent.mapsdk.internal.ny) this.f50567d).setzIndex(i17);
        a((com.tencent.mapsdk.internal.nw) this.f50567d);
    }
}
