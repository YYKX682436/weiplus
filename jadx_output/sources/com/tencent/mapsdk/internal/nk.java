...
public class nk extends com.tencent.mapsdk.internal.ng<com.tencent.mapsdk.internal.nl> implements com.tencent.map.sdk.utilities.visualization.aggregation.AggregationOverlay, com.tencent.tencentmap.mapsdk.maps.model.VectorHeatOverlay {
    public nk(com.tencent.mapsdk.internal.nm nmVar, com.tencent.mapsdk.internal.nl nlVar) {
        super(nmVar, nlVar);
    }
    ...
    public com.tencent.map.lib.models.ReturnInfoModelClass.ReturnStatus executeCommandFunction(com.tencent.map.lib.models.CommandFunctionModelClass.BaseCommandFunction baseCommandFunction) {
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$SetZoomLevelRangeCommand")) {
            ...
            ((com.tencent.mapsdk.internal.nl) this.f50567d).setZoomLevelRange(zoomLevelRangeParams.minLevel, zoomLevelRangeParams.maxLevel);
            a((com.tencent.mapsdk.internal.nk) this.f50567d);
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$GetVisibleCommand")) {
            return new com.tencent.map.lib.models.ReturnInfoModelClass.BaseBooleanReturnInfo(((com.tencent.mapsdk.internal.nl) this.f50567d).isVisible());
        }
    ...
    public java.lang.String getType() {
        return com.tencent.mapsdk.internal.ef.Aggregation.f49245h;
    }
    ...
    public com.tencent.tencentmap.mapsdk.maps.model.VectorHeatAggregationUnit getUnit(com.tencent.tencentmap.mapsdk.maps.model.LatLng latLng) {
        java.lang.Object obj = this.f50566c;
        if (obj == null) {
            return null;
        }
        long j17 = this.f50565b;
        if (j17 == 0) {
            return null;
        }
        return ((com.tencent.mapsdk.internal.nm) obj).a(j17, latLng);
    }
    ...
    public void setLevel(int i17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.nl) t17).f50580a != null) {
            ((com.tencent.mapsdk.internal.nl) t17).f50580a.displayLevel(i17);
        }
        ((com.tencent.mapsdk.internal.nl) this.f50567d).setDisplayLevel(i17);
        a((com.tencent.mapsdk.internal.nk) this.f50567d);
    }
    ...
    public void setOpacity(float f17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.nl) t17).f50580a != null) {
            ((com.tencent.mapsdk.internal.nl) t17).f50580a.opacity(f17);
        }
        ((com.tencent.mapsdk.internal.nl) this.f50567d).setOpacity(f17);
        a((com.tencent.mapsdk.internal.nk) this.f50567d);
    }
    ...
    public void setVisibility(boolean z17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.nl) t17).f50580a != null) {
            ((com.tencent.mapsdk.internal.nl) t17).f50580a.visibility(z17);
        }
        ((com.tencent.mapsdk.internal.nl) this.f50567d).setVisibility(z17);
        a((com.tencent.mapsdk.internal.nk) this.f50567d);
    }
    ...
    public void setZIndex(int i17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.nl) t17).f50580a != null) {
            ((com.tencent.mapsdk.internal.nl) t17).f50580a.zIndex(i17);
        }
        ((com.tencent.mapsdk.internal.nl) this.f50567d).setZIndex(i17);
        a((com.tencent.mapsdk.internal.nk) this.f50567d);
    }
}
