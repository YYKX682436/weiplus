...
public class nn extends com.tencent.mapsdk.internal.ng<com.tencent.mapsdk.internal.np> implements com.tencent.map.sdk.utilities.visualization.od.ArcLineOverlay {
    public nn(com.tencent.mapsdk.internal.no noVar, com.tencent.mapsdk.internal.np npVar) {
        super(noVar, npVar);
    }
    ...
    public com.tencent.map.lib.models.ReturnInfoModelClass.ReturnStatus executeCommandFunction(com.tencent.map.lib.models.CommandFunctionModelClass.BaseCommandFunction baseCommandFunction) {
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$SetZoomLevelRangeCommand")) {
            ...
            ((com.tencent.mapsdk.internal.np) this.f50567d).setZoomLevelRange(zoomLevelRangeParams.minLevel, zoomLevelRangeParams.maxLevel);
            a((com.tencent.mapsdk.internal.nn) this.f50567d);
        ...
        if (name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$GetVisibleCommand")) {
            return new com.tencent.map.lib.models.ReturnInfoModelClass.BaseBooleanReturnInfo(((com.tencent.mapsdk.internal.np) this.f50567d).isVisible());
        }
    ...
    public java.lang.String getType() {
        return com.tencent.mapsdk.internal.ef.ArcLine.f49245h;
    }
    ...
    public void setLevel(int i17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.np) t17).f50581a != null) {
            ((com.tencent.mapsdk.internal.np) t17).f50581a.displayLevel(i17);
        }
        ((com.tencent.mapsdk.internal.np) this.f50567d).setDisplayLevel(i17);
        a((com.tencent.mapsdk.internal.nn) this.f50567d);
    }
    ...
    public void setOpacity(float f17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.np) t17).f50581a != null) {
            ((com.tencent.mapsdk.internal.np) t17).f50581a.opacity(f17);
        }
        ((com.tencent.mapsdk.internal.np) this.f50567d).setOpacity(f17);
        a((com.tencent.mapsdk.internal.nn) this.f50567d);
    }
    ...
    public void setVisibility(boolean z17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.np) t17).f50581a != null) {
            ((com.tencent.mapsdk.internal.np) t17).f50581a.visibility(z17);
        }
        ((com.tencent.mapsdk.internal.np) this.f50567d).setVisibility(z17);
        a((com.tencent.mapsdk.internal.nn) this.f50567d);
    }
    ...
    public void setZIndex(int i17) {
        T t17 = this.f50567d;
        if (((com.tencent.mapsdk.internal.np) t17).f50581a != null) {
            ((com.tencent.mapsdk.internal.np) t17).f50581a.zIndex(i17);
        }
        ((com.tencent.mapsdk.internal.np) this.f50567d).setzIndex(i17);
        a((com.tencent.mapsdk.internal.nn) this.f50567d);
    }
}
