...
public class TXLiveConstants {
    ...
    public static final java.lang.String EVT_BLOCK_DURATION = "EVT_BLOCK_DURATION";
    public static final java.lang.String EVT_DESCRIPTION = "EVT_MSG";
    public static final java.lang.String EVT_GET_MSG = "EVT_GET_MSG";
    public static final java.lang.String EVT_GET_MSG_TYPE = "EVT_GET_MSG_TYPE";
    public static final java.lang.String EVT_PARAM1 = "EVT_PARAM1";
    public static final java.lang.String EVT_PARAM2 = "EVT_PARAM2";
    public static final java.lang.String EVT_PLAYABLE_DURATION_MS = "EVT_PLAYABLE_DURATION_MS";
    public static final java.lang.String EVT_PLAYABLE_RATE = "EVT_PLAYABLE_RATE";
    public static final java.lang.String EVT_PLAY_COVER_URL = "EVT_PLAY_COVER_URL";
    public static final java.lang.String EVT_PLAY_DESCRIPTION = "EVT_PLAY_DESCRIPTION";
    public static final java.lang.String EVT_PLAY_DURATION = "EVT_PLAY_DURATION";
    public static final java.lang.String EVT_PLAY_DURATION_MS = "EVT_PLAY_DURATION_MS";
    public static final java.lang.String EVT_PLAY_NAME = "EVT_PLAY_NAME";
    public static final java.lang.String EVT_PLAY_PROGRESS = "EVT_PLAY_PROGRESS";
    public static final java.lang.String EVT_PLAY_PROGRESS_MS = "EVT_PLAY_PROGRESS_MS";
    public static final java.lang.String EVT_PLAY_URL = "EVT_PLAY_URL";
    public static final java.lang.String EVT_TIME = "EVT_TIME";
    public static final java.lang.String EVT_UTC_TIME = "EVT_UTC_TIME";
    ...
    public static final java.lang.String NET_STATUS_AUDIO_BITRATE = "AUDIO_BITRATE";
    public static final java.lang.String NET_STATUS_AUDIO_BLOCK_TIME = "AUDIO_BLOCK_TIME";
    public static final java.lang.String NET_STATUS_AUDIO_CACHE = "AUDIO_CACHE";
    public static final java.lang.String NET_STATUS_AUDIO_CACHE_THRESHOLD = "AUDIO_CACHE_THRESHOLD";
    public static final java.lang.String NET_STATUS_AUDIO_DROP = "AUDIO_DROP";
    public static final java.lang.String NET_STATUS_AUDIO_INFO = "AUDIO_PLAY_INFO";
    public static final java.lang.String NET_STATUS_AV_PLAY_INTERVAL = "AV_PLAY_INTERVAL";
    public static final java.lang.String NET_STATUS_AV_RECV_INTERVAL = "AV_RECV_INTERVAL";
    public static final java.lang.String NET_STATUS_CPU_USAGE = "CPU_USAGE";
    public static final java.lang.String NET_STATUS_NET_JITTER = "NET_JITTER";
    public static final java.lang.String NET_STATUS_NET_SPEED = "NET_SPEED";
    public static final java.lang.String NET_STATUS_QUALITY_LEVEL = "NET_QUALITY_LEVEL";
    public static final java.lang.String NET_STATUS_SERVER_IP = "SERVER_IP";
    public static final java.lang.String NET_STATUS_VIDEO_BITRATE = "VIDEO_BITRATE";
    public static final java.lang.String NET_STATUS_VIDEO_BLOCK_TIME = "VIDEO_BLOCK_TIME";
    public static final java.lang.String NET_STATUS_VIDEO_CACHE = "VIDEO_CACHE";
    public static final java.lang.String NET_STATUS_VIDEO_DPS = "VIDEO_DPS";
    public static final java.lang.String NET_STATUS_VIDEO_DROP = "VIDEO_DROP";
    public static final java.lang.String NET_STATUS_VIDEO_FPS = "VIDEO_FPS";
    public static final java.lang.String NET_STATUS_VIDEO_GOP = "VIDEO_GOP";
    public static final java.lang.String NET_STATUS_VIDEO_HEIGHT = "VIDEO_HEIGHT";
    public static final java.lang.String NET_STATUS_VIDEO_LARGE_BLOCK_COUNT = "VIDEO_LARGE_BLOCK_COUNT";
    public static final java.lang.String NET_STATUS_VIDEO_LIGHT_BLOCK_COUNT = "VIDEO_LIGHT_BLOCK_COUNT";
    public static final java.lang.String NET_STATUS_VIDEO_MEDIUM_BLOCK_COUNT = "VIDEO_MEDIUM_BLOCK_COUNT";
    public static final java.lang.String NET_STATUS_VIDEO_WIDTH = "VIDEO_WIDTH";
    public static final java.lang.String NET_STATUS_V_DEC_CACHE_SIZE = "V_DEC_CACHE_SIZE";
    public static final java.lang.String NET_STATUS_V_SUM_CACHE_SIZE = "V_SUM_CACHE_SIZE";
    ...
    public static final java.lang.String TXRTMPSDK_AUDIO_PCMSOURCE_LOCALMERGER = "TXRTMPSDK_AUDIO_PCMSOURCE_LOCALMERGER";
    public static final java.lang.String TXRTMPSDK_PUSHEVENT_SOURCE_OPENCAMERA = "TXRTMPSDK_PUSHEVENT_SOURCE_OPENCAMERA";
    public static final java.lang.String TXRTMPSDK_PUSHEVENT_SOURCE_OPENMIC = "TXRTMPSDK_PUSHEVENT_SOURCE_OPENMIC";
    public static final java.lang.String TXRTMPSDK_VIDEO_YUVSOURCE_LOCALCAMERA = "TXRTMPSDK_VIDEO_YUVSOURCE_LOCALCAMERA";
