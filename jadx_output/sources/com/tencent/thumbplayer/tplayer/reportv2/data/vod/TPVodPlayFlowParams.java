...
public class TPVodPlayFlowParams extends com.tencent.thumbplayer.tplayer.reportv2.data.TPCommonParams {
    ...
    @com.tencent.thumbplayer.tplayer.reportv2.data.TPCommonParams.TPReportParam(key = "videodecodeframetotalcount")
    ...
    @com.tencent.thumbplayer.tplayer.reportv2.data.TPCommonParams.TPReportParam(key = "videorenderframetotalcount")
    ...
    public void setAvgStreamBitrateKbps(long j17) {
    ...
    public void setMaxStreamBitrateKbps(long j17) {
    ...
    public void setMinStreamBitrateKbps(long j17) {
    ...
    public void setVideoDecodeFrameTotalCount(int i17) {
        this.mVideoDecodeFrameTotalCount = i17;
    }
    ...
    public void setVideoRenderFrameTotalCount(int i17) {
        this.mVideoRenderFrameTotalCount = i17;
    }
}
