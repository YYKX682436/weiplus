...
public final class TPMediaCodecProfileLevel {
    ...
    public static final java.util.HashMap<java.lang.Integer, java.lang.Integer> av1LumaSampleMap;
    public static final java.util.HashMap<java.lang.Integer, java.lang.Integer> avcLumaSampleMap;
    public static final java.util.HashMap<java.lang.Integer, java.lang.Integer> hevcLumaSampleMap;
    public static final java.util.HashMap<java.lang.Integer, java.lang.Integer> vp8LumaSampleMap;
    public static final java.util.HashMap<java.lang.Integer, java.lang.Integer> vp9LumaSampleMap;
    ...
    static {
        ...
        hashMap.put(512, java.lang.Integer.valueOf(com.tencent.tmassistantsdk.downloadservice.Downloads.SPLIT_RANGE_SIZE_NET));
        ...
        hashMap2.put(java.lang.Integer.valueOf(HEVCMainTierLevel62), 35651584);
        hashMap2.put(java.lang.Integer.valueOf(HEVCHighTierLevel62), 35651584);
        java.util.HashMap<java.lang.Integer, java.lang.Integer> hashMap3 = new java.util.HashMap<>();
    ...
    public static int getAV1MaxLumaSample(int i17) {
        java.util.HashMap<java.lang.Integer, java.lang.Integer> hashMap = av1LumaSampleMap;
        java.lang.Integer num = hashMap.get(java.lang.Integer.valueOf(i17));
        if (num == null) {
    ...
    public static int getAVCMaxLumaSample(int i17) {
        java.util.HashMap<java.lang.Integer, java.lang.Integer> hashMap = avcLumaSampleMap;
        return hashMap.containsKey(java.lang.Integer.valueOf(i17)) ? hashMap.get(java.lang.Integer.valueOf(i17)).intValue() : hashMap.get(256).intValue();
    }

    public static int getHEVCMaxLumaSample(int i17) {
        java.util.HashMap<java.lang.Integer, java.lang.Integer> hashMap = hevcLumaSampleMap;
        return hashMap.containsKey(java.lang.Integer.valueOf(i17)) ? hashMap.get(java.lang.Integer.valueOf(i17)).intValue() : hashMap.get(64).intValue();
    }

    public static int getVP8MaxLumaSample(int i17) {
        java.util.HashMap<java.lang.Integer, java.lang.Integer> hashMap = vp8LumaSampleMap;
        return hashMap.containsKey(java.lang.Integer.valueOf(i17)) ? hashMap.get(java.lang.Integer.valueOf(i17)).intValue() : hashMap.get(2).intValue();
    }

    public static int getVP9MaxLumaSample(int i17) {
        java.util.HashMap<java.lang.Integer, java.lang.Integer> hashMap = vp9LumaSampleMap;
        return hashMap.containsKey(java.lang.Integer.valueOf(i17)) ? hashMap.get(java.lang.Integer.valueOf(i17)).intValue() : hashMap.get(16).intValue();
    }
}
