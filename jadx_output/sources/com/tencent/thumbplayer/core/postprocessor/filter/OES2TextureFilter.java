...
public class OES2TextureFilter {
    ...
    public OES2TextureFilter(java.lang.String str) {
        this.mFrameBuffer = r2;
        int[] iArr = {0};
        this.mTextureid = r2;
        int[] iArr2 = {0};
        this.mOESTextureid = r2;
        int[] iArr3 = {0};
    ...
    public void genOESTexture() {
        android.opengl.GLES20.glGenTextures(1, this.mOESTextureid, 0);
        android.opengl.GLES20.glBindTexture(36197, this.mOESTextureid[0]);
    ...
    public int process(android.graphics.SurfaceTexture surfaceTexture, int i17, int i18, boolean z17, boolean z18) {
        if (!z18 && (this.mWidth != i17 || this.mHeight != i18)) {
            updatebuffer(i17, i18);
        }
        if (!z18) {
