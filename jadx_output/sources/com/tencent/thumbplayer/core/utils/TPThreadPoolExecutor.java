...
public class TPThreadPoolExecutor {
    ...
    public static class CustomRejectedExecutionHandler implements java.util.concurrent.RejectedExecutionHandler {
        ...
        public void rejectedExecution(java.lang.Runnable runnable, java.util.concurrent.ThreadPoolExecutor threadPoolExecutor) {
            try {
                ...
                com.tencent.thumbplayer.core.common.TPNativeLog.printLog(2, com.tencent.thumbplayer.core.utils.TPThreadPoolExecutor.TAG, "rejectedExecution put task to queue");
            } catch (java.lang.InterruptedException e17) {
                com.tencent.thumbplayer.core.common.TPNativeLog.printLog(4, com.tencent.thumbplayer.core.utils.TPThreadPoolExecutor.TAG, "rejectedExecution has exception:" + e17.toString());
            }
        }
    }
    ...
    public static class CustomThreadFactory implements java.util.concurrent.ThreadFactory {
        ...
        public java.lang.Thread newThread(java.lang.Runnable runnable) {
            ...
            thread.setName(com.tencent.thumbplayer.core.utils.TPThreadPoolExecutor.THREAD_POOL_NAME + this.threadAtomicCount.incrementAndGet());
            return thread;
        }
    }

    public static java.util.concurrent.ExecutorService newCustomThreadExecutor(int i17, int i18) {
        return new java.util.concurrent.ThreadPoolExecutor(i17, i18, 60L, java.util.concurrent.TimeUnit.SECONDS, new java.util.concurrent.LinkedBlockingQueue(20), new com.tencent.thumbplayer.core.utils.TPThreadPoolExecutor.CustomThreadFactory(), new com.tencent.thumbplayer.core.utils.TPThreadPoolExecutor.CustomRejectedExecutionHandler());
    }
}
