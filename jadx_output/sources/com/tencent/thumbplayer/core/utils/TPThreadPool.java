...
public class TPThreadPool {
    ...
    private static final java.lang.String PRE_THREAD_NAME = "TPCoreHdr";
    private static final java.lang.String SHARE_THREAD_NAME = "TPCore-ShareThread";
    ...
    private static volatile com.tencent.thumbplayer.core.utils.TPThreadPool sInstance;
    ...
    public static com.tencent.thumbplayer.core.utils.TPThreadPool getInstance() {
        if (sInstance == null) {
            synchronized (com.tencent.thumbplayer.core.utils.TPThreadPool.class) {
                if (sInstance == null) {
                    sInstance = new com.tencent.thumbplayer.core.utils.TPThreadPool();
                }
            }
        }
        return sInstance;
    ...
    private static void initMainThreadHandler() {
        ...
        synchronized (com.tencent.thumbplayer.core.utils.TPThreadPool.class) {
            ...
            if (mainLooper != null) {
                ...
                com.tencent.thumbplayer.core.common.TPNativeLog.printLog(4, TAG, "cannot get thread looper");
            }
        }
    }
    ...
    public java.util.concurrent.ScheduledExecutorService obtainScheduledExecutorService() {
        if (sScheduler == null) {
            synchronized (com.tencent.thumbplayer.core.utils.TPThreadPool.class) {
                if (sScheduler == null) {
                    sScheduler = java.util.concurrent.Executors.newScheduledThreadPool(1);
                }
            }
        }
        return sScheduler;
    ...
    public android.os.HandlerThread obtainShareThread() {
        ...
        synchronized (com.tencent.thumbplayer.core.utils.TPThreadPool.class) {
            sShareThreadCount++;
            com.tencent.thumbplayer.core.common.TPNativeLog.printLog(2, TAG, "handlerThread obtainShareThread mShareThreadCount:" + sShareThreadCount);
    ...
    public java.util.concurrent.ExecutorService obtainThreadExecutor() {
        if (sCustomExecutor == null) {
            synchronized (com.tencent.thumbplayer.core.utils.TPThreadPool.class) {
                if (sCustomExecutor == null) {
                    sCustomExecutor = com.tencent.thumbplayer.core.utils.TPThreadPoolExecutor.newCustomThreadExecutor(1, 20);
                }
            }
        }
    ...
    public void recycle(android.os.HandlerThread handlerThread, android.os.Handler handler) {
        ...
        synchronized (com.tencent.thumbplayer.core.utils.TPThreadPool.class) {
            sShareThreadCount--;
            com.tencent.thumbplayer.core.common.TPNativeLog.printLog(2, TAG, "handlerThread recycle mShareThreadCount:" + sShareThreadCount);
        }
    }
