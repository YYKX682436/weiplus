...
public class TPNativeJitterBufferConfig {
    ...
    public static final class Builder {
        ...
        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig build() {
            return new com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig(this.mMinDecreaseDurationMs, this.mMaxIncreaseDurationMs, this.mPerIncreaseDurationMs, this.mPerDecreaseDurationMs, this.mAdjustIntervalThresholdMs, this.mFrozenThresholdMs);
        }

        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig.Builder setAdjustIntervalThresholdMs(long j17) {
            this.mAdjustIntervalThresholdMs = j17;
            return this;
        }

        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig.Builder setFrozenThresholdMs(long j17) {
            this.mFrozenThresholdMs = j17;
            return this;
        }

        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig.Builder setMaxIncreaseDurationMs(long j17) {
            this.mMaxIncreaseDurationMs = j17;
            return this;
        }

        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig.Builder setMinDecreaseDurationMs(long j17) {
            this.mMinDecreaseDurationMs = j17;
            return this;
        }

        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig.Builder setPerDecreaseDurationMs(long j17) {
            this.mPerDecreaseDurationMs = j17;
            return this;
        }

        public com.tencent.thumbplayer.core.demuxer.TPNativeJitterBufferConfig.Builder setPerIncreaseDurationMs(long j17) {
            this.mPerIncreaseDurationMs = j17;
            return this;
        }
    }

    public TPNativeJitterBufferConfig(long j17, long j18, long j19, long j27, long j28, long j29) {
        this.mMinDecreaseDurationMs = j17;
