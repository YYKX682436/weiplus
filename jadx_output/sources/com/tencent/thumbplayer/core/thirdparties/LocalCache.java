...
public class LocalCache {
    ...
    private static java.util.Map<java.lang.String, com.tencent.thumbplayer.core.thirdparties.LocalCache> mInstanceMap = new java.util.HashMap();
    private com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager mCache;
    ...
    public class ACacheManager {
        ...
        private void calculateCacheSizeAndCacheCount() {
            com.tencent.thumbplayer.core.utils.TPThreadPool.getInstance().obtainThreadExecutor().execute(new java.lang.Runnable() { // from class: com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager.1
                @Override // java.lang.Runnable
                public void run() {
                    java.io.File[] listFiles = com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager.this.cacheDir.listFiles();
                    if (listFiles != null) {
                        int i17 = 0;
                        int i18 = 0;
                        for (java.io.File file : listFiles) {
                            i17 = (int) (i17 + com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager.this.calculateSize(file));
                            i18++;
                            com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager.this.lastUsageDates.put(file, java.lang.Long.valueOf(file.lastModified()));
                        }
                        com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager.this.cacheSize.set(i17);
                        com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager.this.cacheCount.set(i18);
                    }
                }
            });
        }
    ...
    private LocalCache(java.io.File file, long j17, int i17) {
        if (file.exists() || file.mkdirs()) {
            this.mCache = new com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager(file, j17, i17);
        } else {
            this.mCache = null;
        }
    }

    public static com.tencent.thumbplayer.core.thirdparties.LocalCache get(android.content.Context context) {
    ...
    public void clear() {
        com.tencent.thumbplayer.core.thirdparties.LocalCache.ACacheManager aCacheManager = this.mCache;
    ...
    public byte[] getAsBinary(java.lang.String str) {
        ...
        try {
            ...
            try {
                ...
                if (com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.isDue(bArr)) {
                    try {
                        randomAccessFile.close();
                ...
                byte[] clearDateInfo = com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.clearDateInfo(bArr);
                try {
                    randomAccessFile.close();
    ...
    public android.graphics.Bitmap getAsBitmap(java.lang.String str) {
        ...
        return com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.Bytes2Bimap(getAsBinary(str));
    }
    ...
    public android.graphics.drawable.Drawable getAsDrawable(java.lang.String str) {
        ...
        return com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.bitmap2Drawable(com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.Bytes2Bimap(getAsBinary(str)));
    }
    ...
    public java.lang.String getAsString(java.lang.String str) {
        ...
        try {
            ...
            if (com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.isDue(str2)) {
                try {
                    bufferedReader.close();
                } catch (java.io.IOException unused4) {
                }
            ...
            java.lang.String clearDateInfo = com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.clearDateInfo(str2);
            try {
                bufferedReader.close();
            } catch (java.io.IOException unused5) {
            }
    ...
    public static com.tencent.thumbplayer.core.thirdparties.LocalCache get(android.content.Context context, java.lang.String str) {
        return get(new java.io.File(context.getCacheDir(), str), 50000000L, Integer.MAX_VALUE);
    }

    public static com.tencent.thumbplayer.core.thirdparties.LocalCache get(java.io.File file) {
        return get(file, 50000000L, Integer.MAX_VALUE);
    }

    public static com.tencent.thumbplayer.core.thirdparties.LocalCache get(android.content.Context context, long j17, int i17) {
        return get(new java.io.File(context.getCacheDir(), "LocalCache"), j17, i17);
    }

    public static com.tencent.thumbplayer.core.thirdparties.LocalCache get(java.io.File file, long j17, int i17) {
        com.tencent.thumbplayer.core.thirdparties.LocalCache localCache;
        try {
        ...
        try {
            com.tencent.thumbplayer.core.thirdparties.LocalCache localCache2 = new com.tencent.thumbplayer.core.thirdparties.LocalCache(file, j17, i17);
            try {
    ...
    public void put(java.lang.String str, java.lang.String str2, int i17) {
        put(str, com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.newStringWithDateInfo(i17, str2));
    }
    ...
    public void put(java.lang.String str, byte[] bArr, int i17) {
        put(str, com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.newByteArrayWithDateInfo(i17, bArr));
    }
    ...
    public void put(java.lang.String str, android.graphics.Bitmap bitmap) {
        put(str, com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.Bitmap2Bytes(bitmap));
    }

    public void put(java.lang.String str, android.graphics.Bitmap bitmap, int i17) {
        put(str, com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.Bitmap2Bytes(bitmap), i17);
    }

    public void put(java.lang.String str, android.graphics.drawable.Drawable drawable) {
        put(str, com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.drawable2Bitmap(drawable));
    }

    public void put(java.lang.String str, android.graphics.drawable.Drawable drawable, int i17) {
        put(str, com.tencent.thumbplayer.core.thirdparties.LocalCache.Utils.drawable2Bitmap(drawable), i17);
    }
}
