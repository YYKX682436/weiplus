...
public class TPErrorCode {
    ...
    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1000)
    public static final int TP_ERROR_OK = 1000;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1210)
    public static final int TP_ERROR_TYPE_DECODER_AUDIO_NOT_SUPPORT = 1210;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1211)
    public static final int TP_ERROR_TYPE_DECODER_AUDIO_STREAM = 1211;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1200)
    public static final int TP_ERROR_TYPE_DECODER_OTHERS = 1200;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1230)
    public static final int TP_ERROR_TYPE_DECODER_SUBTITLE_NOT_SUPPORT = 1230;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1231)
    public static final int TP_ERROR_TYPE_DECODER_SUBTITLE_STREAM = 1231;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1220)
    public static final int TP_ERROR_TYPE_DECODER_VIDEO_NOT_SUPPORT = 1220;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1221)
    public static final int TP_ERROR_TYPE_DECODER_VIDEO_STREAM = 1221;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1103)
    public static final int TP_ERROR_TYPE_DEMUXER_BUFFERING_TIMEOUT = 1103;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1101)
    public static final int TP_ERROR_TYPE_DEMUXER_NETWORK = 1101;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1100)
    public static final int TP_ERROR_TYPE_DEMUXER_OTHERS = 1100;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1102)
    public static final int TP_ERROR_TYPE_DEMUXER_STREAM = 1102;
    public static final int TP_ERROR_TYPE_DOWNLOAD_PROXY = 4000;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1500)
    public static final int TP_ERROR_TYPE_PROCESS_AUDIO_OTHERS = 1500;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1600)
    public static final int TP_ERROR_TYPE_PROCESS_VIDEO_OTHERS = 1600;

    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1300)
    ...
    @com.tencent.thumbplayer.adapter.strategy.utils.TPNativeKeyMap.MapErrorType(1001)
