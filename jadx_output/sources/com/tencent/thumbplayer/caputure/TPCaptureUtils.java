...
public class TPCaptureUtils {
    ...
    private static android.graphics.Bitmap byte2Bitmap(byte[] bArr, int i17, int i18, int i19) {
    ...
    public static android.graphics.Bitmap frame2Bitmap(com.tencent.thumbplayer.core.common.TPVideoFrame tPVideoFrame) {
        int i17;
        int i18;
        byte[][] bArr = tPVideoFrame.data;
        if (bArr.length <= 0 || (i17 = tPVideoFrame.height) == 0 || (i18 = tPVideoFrame.width) == 0) {
            return null;
        }
        return byte2Bitmap(bArr[0], i18, i17, tPVideoFrame.rotation);
    }

    public static android.graphics.Bitmap[] frame2Bitmaps(com.tencent.thumbplayer.core.common.TPVideoFrame tPVideoFrame) {
        byte[][] bArr = tPVideoFrame.data;
        ...
        while (true) {
            ...
            bitmapArr[i17] = byte2Bitmap(bArr2[i17], tPVideoFrame.width, tPVideoFrame.height, tPVideoFrame.rotation);
            i17++;
        }
    }
}
