...
public final class PlayStuckMonitor {
    ...
    public static final /* synthetic */ yz5.r access$getMCallback$p(com.tencent.qqmusic.mediaplayer.PlayStuckMonitor playStuckMonitor) {
    ...
    public final void init() {
        ...
        if (handlerThread2 != null) {
            ...
            kotlin.jvm.internal.o.o("mHandlerThread");
            throw null;
        }
    }

    public final void onAudioTrackFlush(final int i17, final int i18) {
        ...
        handler.post(new java.lang.Runnable() { // from class: com.tencent.qqmusic.mediaplayer.PlayStuckMonitor$onAudioTrackFlush$$inlined$apply$lambda$1
            ...
            public final void run() {
                yz5.p.this.invoke(java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
            }
        });
    }

    public final void onPlayStuck(final long j17, final long j18, final boolean z17, final int i17) {
        if (mEnable) {
            ...
            if (handler != null) {
                handler.post(new java.lang.Runnable() { // from class: com.tencent.qqmusic.mediaplayer.PlayStuckMonitor$onPlayStuck$1
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.tencent.qqmusic.mediaplayer.PlayStuckMonitor.access$getMCallback$p(com.tencent.qqmusic.mediaplayer.PlayStuckMonitor.INSTANCE).C(java.lang.Long.valueOf(j17), java.lang.Long.valueOf(j18), java.lang.Boolean.valueOf(z17), java.lang.Integer.valueOf(i17));
                    }
                });
            } else {
                kotlin.jvm.internal.o.o("mHandler");
                throw null;
            }
        }
    }

    public final void setAudioTrackFlushListener(yz5.p callback) {
        kotlin.jvm.internal.o.h(callback, "callback");
        mAudioTrackFlushCallback = callback;
    }

    public final void setOnPlayStuckListener(yz5.r callback) {
        kotlin.jvm.internal.o.h(callback, "callback");
        mCallback = callback;
        mEnable = true;
    }
