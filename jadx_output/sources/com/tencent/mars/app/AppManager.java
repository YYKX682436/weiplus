...
public class AppManager extends com.tencent.mars.app.BaseManager {
    protected long nativeHandle = 0;
    protected long callbackHandle = 0;

    /* loaded from: classes12.dex */
    public interface CallBack {
        com.tencent.mars.app.AppManager.AccountInfo getAccountInfo();

        java.lang.String getAppFilePath();

        java.lang.String getClientConfig(java.lang.String str, java.lang.String str2);

        long getClientConfigID(java.lang.String str);

        int getClientVersion();

        com.tencent.mars.app.AppManager.DeviceInfo getDeviceType();
    }
    ...
    public void setCallback(com.tencent.mars.app.AppManager.CallBack callBack) {
    ...
    public AppManager(com.tencent.mars.app.Context context) {
