...
public class MMDnsManager extends com.tencent.mars.app.BaseManager {
    ...
    public native java.util.ArrayList<com.tencent.mars.mmdns.MMDnsManager.MMDnsRespItem> OnJniGetSimpleDnsIP(java.util.ArrayList<java.lang.String> arrayList, int i17, int i18);
    ...
    public java.util.ArrayList<com.tencent.mars.mmdns.MMDnsManager.MMDnsRespItem> getSimpleDnsIP(java.util.ArrayList<java.lang.String> arrayList, int i17, int i18) {
    ...
    public MMDnsManager(com.tencent.mars.app.Context context) {
