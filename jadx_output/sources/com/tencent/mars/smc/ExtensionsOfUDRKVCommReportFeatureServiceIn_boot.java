...
public enum ExtensionsOfUDRKVCommReportFeatureServiceIn_boot implements fs.i {
    ...
    public static class LazyIterable<T extends fs.n> implements java.lang.Iterable<fs.q> {
        ...
        public java.util.Iterator<fs.q> iterator() {
            return new com.tencent.mars.smc.ExtensionsOfUDRKVCommReportFeatureServiceIn_boot.LazyIterable.LazyIterator();
        }
    }

    @Override // fs.i
    public java.lang.Iterable<fs.q> all() {
        return new com.tencent.mars.smc.ExtensionsOfUDRKVCommReportFeatureServiceIn_boot.LazyIterable();
    }
}
