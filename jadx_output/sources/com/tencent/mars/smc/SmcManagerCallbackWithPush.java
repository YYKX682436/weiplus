...
public class SmcManagerCallbackWithPush implements com.tencent.mars.smc.SmcManager.CallBack {
    ...
    public boolean onSelfMonitorOpLogReady(byte[] bArr) {
        ...
        try {
            ...
            kVar.parseFrom(bArr);
            if (com.tencent.mars.smc.SmcProtoBufUtil.toMMSelfMonitor(kVar).f392453d <= 0) {
