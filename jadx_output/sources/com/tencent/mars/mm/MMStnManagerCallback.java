...
public class MMStnManagerCallback implements com.tencent.mars.mm.MMStnManager.CallBack {
    ...
    private final java.util.concurrent.locks.Lock f52534l = new java.util.concurrent.locks.ReentrantLock();
    ...
    public int OnActionNotify(java.lang.String str, long j17, final byte[] bArr, byte[] bArr2, final byte[] bArr3, final long j18) {
        ...
        if (j17 == 2) {
            if (bArr != null) {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.5
        ...
        if (j17 == 4) {
            if (bArr != null) {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.6
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        if (j17 == 7) {
            if (bArr != null) {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.7
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        if (j17 == 5) {
            ...
            com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.8
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        ...
                        com.tencent.mars.xlog.Log.printErrStackTrace(com.tencent.mars.mm.MMStnManagerCallback.TAG, e18, null, new java.lang.Object[0]);
                    }
                }
            });
        ...
        if (j17 == 8) {
            if (bArr != null) {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback$$a
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.tencent.mars.mm.MMStnManagerCallback.lambda$OnActionNotify$0(bArr);
                    }
                });
            }
            return ACTION_ACK_OK;
        ...
        if (j17 == 9) {
            if (bArr != null) {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback$$b
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.tencent.mars.mm.MMStnManagerCallback.lambda$OnActionNotify$1(bArr);
                    }
                });
            }
            return ACTION_ACK_OK;
        ...
        if (j17 == 11) {
            if (bArr != null) {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback$$c
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.tencent.mars.mm.MMStnManagerCallback.lambda$OnActionNotify$2(bArr);
                    }
                });
            }
            return ACTION_ACK_OK;
    ...
    public int doLiveSpeedTest(java.lang.String str, int i17, int i18, int i19, int i27, byte[] bArr, byte[] bArr2, android.os.IInterface iInterface) {
        if (iInterface instanceof com.tencent.mm.network.c1) {
            return com.tencent.mars.mm.MMLiveSpeedTestInterfaces.getInstance().doLiveSpeedTest(str, i17, i18, i19, i27, bArr, bArr2, (com.tencent.mm.network.c1) iInterface);
        }
        com.tencent.mars.xlog.Log.e(TAG, "Callback type mismatch!");
        return 0;
    }
    ...
    public void doNetIdRequest() {
        com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.10
            @Override // java.lang.Runnable
            public void run() {
                com.tencent.mm.network.x2.f().a(6238, null);
            }
        });
    }
    ...
    public int getHostByName(java.lang.String str, java.util.List<java.lang.String> list) {
        ...
        com.tencent.mars.mm.GetDnsReturn getDnsReturn = new com.tencent.mars.mm.GetDnsReturn();
        ((com.tencent.mars.mm.MMStnManager) com.tencent.mars.MarsContext.getManager(com.tencent.mars.mm.MMStnManager.class)).getHostIps(str, getDnsReturn);
        for (int i17 = 0; i17 < getDnsReturn.length; i17++) {
            list.add(getDnsReturn.aryIps[i17]);
        }
        long currentTimeMillis2 = java.lang.System.currentTimeMillis();
        com.tencent.mars.mm.MMStnManager.ReportInfo reportInfo = new com.tencent.mars.mm.MMStnManager.ReportInfo();
        ...
        reportInfo.f52533ip = getDnsReturn.length > 0 ? getDnsReturn.aryIps[0] : "0.0.0.0";
    ...
    public int getSnsIpsForScene(java.util.List<java.lang.String> list, boolean z17) {
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        com.tencent.mars.mm.GetDnsReturn getDnsReturn = new com.tencent.mars.mm.GetDnsReturn();
        ((com.tencent.mars.mm.MMStnManager) com.tencent.mars.MarsContext.getManager(com.tencent.mars.mm.MMStnManager.class)).getSnsIps(z17, getDnsReturn);
        for (int i17 = 0; i17 < getDnsReturn.length; i17++) {
            list.add(getDnsReturn.aryIps[i17]);
        }
        long currentTimeMillis2 = java.lang.System.currentTimeMillis();
    ...
    public int getSnsIpsForSceneWithHostName(java.util.List<java.lang.String> list, java.lang.String str, boolean z17) {
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        com.tencent.mars.mm.GetDnsReturn getDnsReturn = new com.tencent.mars.mm.GetDnsReturn();
        ((com.tencent.mars.mm.MMStnManager) com.tencent.mars.MarsContext.getManager(com.tencent.mars.mm.MMStnManager.class)).getSnsIpsWithHostName(str, z17, getDnsReturn);
        for (int i17 = 0; i17 < getDnsReturn.length; i17++) {
            list.add(getDnsReturn.aryIps[i17]);
        }
        long currentTimeMillis2 = java.lang.System.currentTimeMillis();
    ...
    public void notifyNewSpeedTestReport(byte[] bArr, int i17, int i18, int i19, int i27, java.lang.String str, int i28, java.lang.String str2, int i29, int i37) {
        ...
        try {
            ...
            com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.4
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void notifyStnWeaknet(final boolean z17) {
        com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.9
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void onLiveSpeedTestCallback(com.tencent.mars.mm.LiveSpeedTestResult liveSpeedTestResult, boolean z17) {
        com.tencent.mars.mm.MMLiveSpeedTestInterfaces.getInstance().onLiveSpeedTestCallback(liveSpeedTestResult, z17);
    }
    ...
    public void onOOBNotify(final java.lang.String str) {
        ...
        try {
            com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.3
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void reportFlow(int i17, int i18, int i19, int i27) {
        ...
        if (i39 >= 102400 || com.tencent.mm.sdk.platformtools.t8.H1(this.lastReportTime) >= 30) {
            ...
            try {
                com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.2
                    @Override // java.lang.Runnable
                    public void run() {
                        try {
    ...
    @Override // com.tencent.mars.mm.MMStnManager.CallBack
    public void reportStat(final com.tencent.mars.mm.MMStnManager.ReportInfo reportInfo) {
        try {
            com.tencent.mm.network.x2.e().post(new java.lang.Runnable() { // from class: com.tencent.mars.mm.MMStnManagerCallback.1
                @Override // java.lang.Runnable
                public void run() {
                    int javaActionId = com.tencent.mars.mm.MMStnManagerCallback.this.getJavaActionId(reportInfo.actionId);
                    if (javaActionId == 0) {
    ...
    public void simpleTestCommand(java.lang.String str) {
        ...
        if (str.contains("testReportFlush")) {
            ((com.tencent.mars.mm.MMStnManager) com.tencent.mars.MarsContext.getManager(com.tencent.mars.mm.MMStnManager.class)).testReportFlush();
            return;
        }
        ...
        if (str.contains("oversea")) {
            ...
            ((com.tencent.mars.mm.MMStnManager) com.tencent.mars.MarsContext.getManager(com.tencent.mars.mm.MMStnManager.class)).getMarsTimestamp();
        }
    }
}
