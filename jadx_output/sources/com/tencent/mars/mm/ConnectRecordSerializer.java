...
public class ConnectRecordSerializer {
    public static com.tencent.mars.mm.ConnectRecord[] deserialize(byte[] bArr) {
        java.io.ObjectInputStream objectInputStream = new java.io.ObjectInputStream(new java.io.ByteArrayInputStream(bArr));
        com.tencent.mars.mm.ConnectRecord[] connectRecordArr = (com.tencent.mars.mm.ConnectRecord[]) objectInputStream.readObject();
        objectInputStream.close();
        return connectRecordArr;
    }

    public static byte[] serialize(com.tencent.mars.mm.ConnectRecord[] connectRecordArr) {
