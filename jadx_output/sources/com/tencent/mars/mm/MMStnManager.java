...
public class MMStnManager extends com.tencent.mars.app.BaseManager {
    ...
    public com.tencent.mars.mm.MMStnManager.CallBack mCallBack;
    ...
    public interface CallBack {
        ...
        void onLiveSpeedTestCallback(com.tencent.mars.mm.LiveSpeedTestResult liveSpeedTestResult, boolean z17);
        ...
        void reportStat(com.tencent.mars.mm.MMStnManager.ReportInfo reportInfo);
    ...
    public static class ReportInfo {
        ...
        public java.lang.String f52533ip = "";
        public int port = 0;
    ...
    public native void OnJniCombineGetHostIps(java.lang.String str, int i17, int i18, com.tencent.mars.mm.GetDnsReturn getDnsReturn);
    ...
    public native void OnJniDoLiveSpeedTest(java.lang.String str, int i17, int i18, int i19, int i27, com.tencent.mars.mm.SpeedTestCtx speedTestCtx, int i28);

    public native void OnJniForceAsyncRefreshNewdns();

    public native void OnJniForceUseV6(boolean z17);

    public native void OnJniGetHostIps(java.lang.String str, com.tencent.mars.mm.GetDnsReturn getDnsReturn);
    ...
    public native com.tencent.mars.mm.NetworkIdInfo OnJniGetNetworkId(java.lang.String str);
    ...
    public native void OnJniGetSnsIps(boolean z17, com.tencent.mars.mm.GetDnsReturn getDnsReturn);

    public native void OnJniGetSnsIpsWithHostName(java.lang.String str, boolean z17, com.tencent.mars.mm.GetDnsReturn getDnsReturn);
    ...
    public void addMMNetCommonCallback(android.os.IInterface iInterface) {
        com.tencent.mars.mm.MMStnManager.CallBack callBack = this.mCallBack;
        if (callBack == null) {
            com.tencent.mars.xlog.Log.w(TAG, "mCallBack is null");
        } else {
    ...
    public void forceAsyncRefreshNewdns() {
        OnJniForceAsyncRefreshNewdns();
    }
    ...
    public void getHostIps(java.lang.String str, com.tencent.mars.mm.GetDnsReturn getDnsReturn) {
    ...
    public com.tencent.mars.mm.NetworkIdInfo getNetworkId(java.lang.String str) {
    ...
    public void getSnsIps(boolean z17, com.tencent.mars.mm.GetDnsReturn getDnsReturn) {
    ...
    public void getSnsIpsWithHostName(java.lang.String str, boolean z17, com.tencent.mars.mm.GetDnsReturn getDnsReturn) {
    ...
    public void setCallback(com.tencent.mars.mm.MMStnManager.CallBack callBack) {
    ...
    public void doLiveSpeedTest(java.lang.String str, int i17, int i18, int i19, int i27, com.tencent.mars.mm.SpeedTestCtx speedTestCtx, int i28) {
        OnJniDoLiveSpeedTest(str, i17, i18, i19, i27, speedTestCtx, i28);
    }

    public MMStnManager(com.tencent.mars.app.Context context) {
