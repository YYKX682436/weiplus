...
public class HardwareEarMonitorXiaomi {
    ...
    public HardwareEarMonitorXiaomi(long j17) {
        this.mNativeHardwareEarMonitorHandle = j17;
    }

    public static com.tencent.trtc.hardwareearmonitor.xiaomi.HardwareEarMonitorXiaomi create(long j17) {
        return new com.tencent.trtc.hardwareearmonitor.xiaomi.HardwareEarMonitorXiaomi(j17);
    }
