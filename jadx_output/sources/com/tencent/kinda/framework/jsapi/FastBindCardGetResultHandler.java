...
public class FastBindCardGetResultHandler implements com.tencent.kinda.framework.jsapi.KindaJSInvokeListener.JSHandler {
    public static final java.lang.String LiteAppNotifyName = "JSAPIFastBindCardGetResultLiteAppNotifyEvent";
    ...
    public void handle(final com.tencent.mm.autogen.events.KindaJSInvokeEvent kindaJSInvokeEvent) {
        ...
        kindaJSEvent.setDelegate(new com.tencent.kinda.framework.module.impl.KindaJSEvent.KindaJsEventDelegate() { // from class: com.tencent.kinda.framework.jsapi.FastBindCardGetResultHandler.1
            ...
            public void kindaEndWithResult(java.lang.String str, java.util.HashMap<java.lang.String, java.lang.String> hashMap) {
                com.tencent.mars.xlog.Log.i(com.tencent.kinda.framework.jsapi.FastBindCardGetResultHandler.TAG, "callback: %s", str);
                am.hi hiVar = kindaJSInvokeEvent.f54458h;
                if (hiVar.f6835a == null) {
                    hiVar.f6835a = new android.os.Bundle();
                }
