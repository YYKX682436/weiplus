...
public final class NavigateBackToSourceAppForWXPayJSHandler implements com.tencent.kinda.framework.jsapi.KindaJSInvokeListener.JSHandler {
    ...
    public void handle(final com.tencent.mm.autogen.events.KindaJSInvokeEvent kindaJSInvokeEvent) {
        ...
        kindaJSEvent.setDelegate(new com.tencent.kinda.framework.module.impl.KindaJSEvent.KindaJsEventDelegate() { // from class: com.tencent.kinda.framework.jsapi.NavigateBackToSourceAppForWXPayJSHandler$handle$1
            ...
            public void kindaEndWithResult(java.lang.String str2, java.util.HashMap<java.lang.String, java.lang.String> hashMap) {
                ...
                am.hi hiVar3;
                str3 = com.tencent.kinda.framework.jsapi.NavigateBackToSourceAppForWXPayJSHandler.this.TAG;
        ...
        java.lang.String deeplinkUrlInMemory = ((h45.q) i95.n0.c(h45.q.class)).getDeeplinkUrlInMemory();
        ...
        create.putString("deepLinkForPay", deeplinkUrlInMemory);
        ((h45.q) i95.n0.c(h45.q.class)).saveDeeplinkUrlInMemory("");
        if (kindaJSInvokeEvent != null && (giVar2 = kindaJSInvokeEvent.f54457g) != null && (bundle2 = giVar2.f6765b) != null) {
            ...
            create.putString("sourceDeeplink", bundle2.getString("sourceDeeplink"));
            create.putString("returnUrl", bundle2.getString("returnUrl"));
        }
        ...
        sb6.append(deeplinkUrlInMemory);
        sb6.append(", data is  : ");
        ...
        ((h45.q) i95.n0.c(h45.q.class)).startUseCase("navigateBackToSourceApp", create, new com.tencent.kinda.gen.UseCaseCallback() { // from class: com.tencent.kinda.framework.jsapi.NavigateBackToSourceAppForWXPayJSHandler$handle$2
