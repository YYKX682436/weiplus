...
public class v2helper {
    ...
    public static final int EMethodSetCarplayOff = 479;
    public static final int EMethodSetCarplayOn = 478;
    ...
    public static final int WXCONF_ERR_BLOCKED_BY_COUNTRY = 50;
    ...
    public static final int WXCONF_ERR_REMOTE_NOT_SUPPORT = 6;
    public static final int WXCONF_ERR_REMOTE_UNSAFE = 8;
    public static final int WXCONF_ERR_REPLY_BY_OTHER = 15;
    public static final int WXCONF_ERR_REQUIRE_VERIFICATION = 51;
    ...
    public static final int WXCONF_ERR_VOIP_BLOCK = 7;
    ...
    static java.io.BufferedOutputStream mOutputStream;

    static {
        int i17 = (1053 & 1024) != 0 ? 16000 : 8000;
        VOICE_SAMPLERATE = i17;
        VOICE_FRAME_BYTES = (i17 / 1000) * 20 * 2;
        mOutputStream = null;
    }

    public static void Logd(java.lang.String str, java.lang.String str2) {
    ...
    public static void Logi(java.lang.String str, java.lang.String str2) {
        java.lang.Thread.currentThread().getId();
        writeLogToFile(str + ":" + str2 + " \n");
    }

    public static void Logw(java.lang.String str, java.lang.String str2) {
        java.lang.Thread.currentThread().getId();
        writeLogToFile(str + ":" + str2 + " \n");
    }

    public static void closeLogFile() {
        java.io.BufferedOutputStream bufferedOutputStream = mOutputStream;
    ...
    public static void outputJniLog(byte[] bArr, java.lang.String str, int i17) {
    ...
    public static void writeLogToFile(java.lang.String str) {
        java.io.BufferedOutputStream bufferedOutputStream = mOutputStream;
        if (bufferedOutputStream == null) {
            return;
        }
