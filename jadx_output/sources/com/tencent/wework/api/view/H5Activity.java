...
public class H5Activity extends com.tencent.mm.hellhoundlib.activities.HellActivity {
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        setContentView(com.tencent.mm.R.layout.d_j);
        findViewById(com.tencent.mm.R.id.f483313aa1).setOnClickListener(new android.view.View.OnClickListener() { // from class: com.tencent.wework.api.view.H5Activity.1
            @Override // android.view.View.OnClickListener
            public void onClick(android.view.View view) {
                com.tencent.wework.api.view.H5Activity.this.finish();
            }
        });
        android.webkit.WebView webView = (android.webkit.WebView) findViewById(com.tencent.mm.R.id.phw);
        ...
        webView.setDownloadListener(new android.webkit.DownloadListener() { // from class: com.tencent.wework.api.view.H5Activity.2
            ...
            public void onDownloadStart(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4, long j17) {
                try {
                    ...
                    com.tencent.wework.api.view.H5Activity h5Activity = com.tencent.wework.api.view.H5Activity.this;
                    java.util.ArrayList arrayList = new java.util.ArrayList();
                    arrayList.add(intent);
                    java.util.Collections.reverse(arrayList);
                    yj0.a.d(h5Activity, arrayList.toArray(), "com/tencent/wework/api/view/H5Activity$2", "onDownloadStart", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
                    h5Activity.startActivity((android.content.Intent) arrayList.get(0));
                    yj0.a.f(h5Activity, "com/tencent/wework/api/view/H5Activity$2", "onDownloadStart", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        ...
        webView.setWebChromeClient(new android.webkit.WebChromeClient() { // from class: com.tencent.wework.api.view.H5Activity.3
            ...
            public void onReceivedTitle(android.webkit.WebView webView2, java.lang.String str) {
                ...
                ((android.widget.TextView) com.tencent.wework.api.view.H5Activity.this.findViewById(com.tencent.mm.R.id.obc)).setText(str);
            }
        });
            ...
            public boolean shouldOverrideUrlLoading(android.webkit.WebView webView2, java.lang.String str) {
                try {
                    if (!android.net.Uri.parse(str).getScheme().toLowerCase().contains("http")) {
                        ...
                        arrayList.add(intent);
                        java.util.Collections.reverse(arrayList);
                        yj0.a.d(h5Activity, arrayList.toArray(), "com/tencent/wework/api/view/H5Activity$4", "shouldOverrideUrlLoading", "(Landroid/webkit/WebView;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
                        h5Activity.startActivity((android.content.Intent) arrayList.get(0));
                        yj0.a.f(h5Activity, "com/tencent/wework/api/view/H5Activity$4", "shouldOverrideUrlLoading", "(Landroid/webkit/WebView;Ljava/lang/String;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
                        return true;
                    }
                } catch (java.lang.Throwable unused) {
                }
