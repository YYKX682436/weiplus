...
public class MultiTextureFilter {
    ...
    public com.tencent.tav.core.MultiTextureFilter subFilter;
    ...
    public com.tencent.tav.coremedia.TextureInfo applyFilter(com.tencent.tav.coremedia.TextureInfo textureInfo, android.graphics.Matrix matrix, android.graphics.Matrix matrix2, float f17, com.tencent.tav.coremedia.CGRect cGRect) {
        ...
        com.tencent.tav.coremedia.CGRect cGRect3 = cGRect2;
        float f18 = cGRect3.origin.x + cGRect3.size.width;
        int i17 = textureInfo.width;
        if (f18 > i17) {
            f18 = i17;
            com.tencent.tav.decoder.logger.Logger.e(TAG, "applyFilter: crop right pixel exceed texture width");
        }
        float f19 = cGRect3.origin.y + cGRect3.size.height;
        ...
        android.graphics.PointF pointF = cGRect3.origin;
        float f27 = pointF.x;
        float f28 = pointF.y;
        ...
        if (multiTextureFilter != null) {
            multiTextureFilter.applyFilter(this._textureInfo, matrix, matrix2, f17, cGRect3);
        }
    ...
    public void setDesTextureInfo(com.tencent.tav.coremedia.TextureInfo textureInfo) {
        com.tencent.tav.coremedia.TextureInfo textureInfo2 = this._textureInfo;
    ...
    public void setSubFilter(com.tencent.tav.core.MultiTextureFilter multiTextureFilter) {
    ...
    public com.tencent.tav.core.MultiTextureFilter mo410clone() {
        ...
        com.tencent.tav.core.MultiTextureFilter multiTextureFilter2 = this.subFilter;
        if (multiTextureFilter2 != null) {
            multiTextureFilter.setSubFilter(multiTextureFilter2.mo410clone());
        }
