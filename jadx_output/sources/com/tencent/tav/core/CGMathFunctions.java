...
public class CGMathFunctions {
    public static com.tencent.tav.coremedia.CGRect initGLViewportDefault(com.tencent.tav.coremedia.CGSize cGSize, com.tencent.tav.coremedia.CGSize cGSize2) {
        return new com.tencent.tav.coremedia.CGRect(new android.graphics.PointF((cGSize.width - cGSize2.width) / 2.0f, (cGSize.height - cGSize2.height) / 2.0f), cGSize2);
    }

    public static com.tencent.tav.coremedia.CGRect initGLViewportFill(com.tencent.tav.coremedia.CGSize cGSize, com.tencent.tav.coremedia.CGSize cGSize2) {
        float f17;
        float f18 = cGSize2.height;
        float f19 = cGSize2.width;
        float f27 = cGSize.height;
        float f28 = cGSize.width;
        float f29 = 0.0f;
        if (f28 / f27 > f19 / f18) {
        ...
        return new com.tencent.tav.coremedia.CGRect(new android.graphics.PointF(f29, f17), new com.tencent.tav.coremedia.CGSize(f28, f27));
    }

    public static com.tencent.tav.coremedia.CGRect initGLViewportFit(com.tencent.tav.coremedia.CGSize cGSize, com.tencent.tav.coremedia.CGSize cGSize2) {
        float f17;
        float f18 = cGSize2.height;
        float f19 = cGSize2.width;
        float f27 = cGSize.height;
    ...
    private static com.tencent.tav.coremedia.CGRect rectFill(com.tencent.tav.coremedia.CGRect cGRect, com.tencent.tav.coremedia.CGRect cGRect2) {
    ...
    private static com.tencent.tav.coremedia.CGRect rectFit(com.tencent.tav.coremedia.CGRect cGRect, com.tencent.tav.coremedia.CGRect cGRect2) {
    ...
    private static com.tencent.tav.coremedia.CGSize sizeFill(com.tencent.tav.coremedia.CGSize cGSize, com.tencent.tav.coremedia.CGSize cGSize2) {
    ...
    public static android.graphics.Matrix transformByScaleFitRect(com.tencent.tav.coremedia.CGRect cGRect, com.tencent.tav.coremedia.CGRect cGRect2) {
        android.graphics.Matrix matrix = new android.graphics.Matrix();
        com.tencent.tav.coremedia.CGSize cGSize = cGRect2.size;
        float f17 = cGSize.width;
        com.tencent.tav.coremedia.CGSize cGSize2 = cGRect.size;
        matrix.postScale(f17 / cGSize2.width, cGSize.height / cGSize2.height);
        return matrix;
    }
