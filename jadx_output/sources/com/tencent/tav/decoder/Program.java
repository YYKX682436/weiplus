...
public class Program {
    ...
    public static synchronized int createProgram(java.lang.String str, java.lang.String str2) {
        int createProgram;
        synchronized (com.tencent.tav.decoder.Program.class) {
    ...
    public static synchronized int createProgram(java.lang.String str, java.lang.String str2, int[] iArr) {
        synchronized (com.tencent.tav.decoder.Program.class) {
            ...
            if (glCreateProgram == 0) {
                com.tencent.tav.decoder.logger.Logger.e(TAG, "Could not create program");
            }
            ...
            if (iArr2[0] != 1) {
                com.tencent.tav.decoder.logger.Logger.e(TAG, "Could not link program: ");
                com.tencent.tav.decoder.logger.Logger.e(TAG, android.opengl.GLES20.glGetProgramInfoLog(glCreateProgram));
