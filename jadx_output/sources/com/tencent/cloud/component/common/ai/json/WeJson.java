...
public class WeJson {
    ...
    public final <T> void a(java.lang.StringBuilder sb6, T t17, int i17) {
        ...
        while (i29 < length) {
            ...
            if ((modifiers & 8) == 0 && ((com.tencent.cloud.component.common.ai.json.WeJsonExpose) field.getAnnotation(com.tencent.cloud.component.common.ai.json.WeJsonExpose.class)) == null) {
                java.lang.String name = field.getName();
                com.tencent.cloud.component.common.ai.json.WeJsonSerializedName weJsonSerializedName = (com.tencent.cloud.component.common.ai.json.WeJsonSerializedName) field.getAnnotation(com.tencent.cloud.component.common.ai.json.WeJsonSerializedName.class);
                java.lang.String value2 = weJsonSerializedName != null ? weJsonSerializedName.value() : name;
                if (!name.contains("$")) {
                    if ((modifiers & 1) != 0) {
                        ...
                        java.lang.String str2 = com.tencent.tmassistantsdk.downloadservice.DownloadSetting.TYPE_BOOLEAN.equals(field.getType().getName()) ? "is" : "get";
                        try {
                            cls = t17.getClass();
        ...
        for (java.util.Map.Entry entry2 : hashMap.entrySet()) {
            ...
            if ((value3 instanceof java.lang.String) && value3.equals("") && i17 < 1) {
            ...
            sb6.append('\"');
            sb6.append(':');
            a(sb6, (java.lang.StringBuilder) value3, i17);
            if (i37 < size2) {
                sb6.append(',');
            }
        }
    ...
    public <T> T fromJson(java.lang.String str, java.lang.Class<T> cls) {
        ...
        if (cls == null) {
            throw new com.tencent.cloud.component.common.ai.json.WeJsonException("必须指定classOfT");
        }
        ...
        if (trim.startsWith("[")) {
            try {
                ...
                throw new com.tencent.cloud.component.common.ai.json.WeJsonException("json 解析错误" + e17.getMessage(), e17);
            }
        } else if (trim.startsWith("{")) {
            try {
                return (T) a(new org.json.JSONObject(trim), cls, (java.lang.Class<?>) null);
            } catch (java.lang.Exception e18) {
                throw new com.tencent.cloud.component.common.ai.json.WeJsonException("json 解析错误:" + e18.getMessage(), e18);
            }
        }
        throw new com.tencent.cloud.component.common.ai.json.WeJsonException("classOfT 指定错误");
    }
    ...
    public final <T> T a(org.json.JSONArray jSONArray, java.lang.Class<T> cls, java.lang.Class<?> cls2) {
        ...
        if (!cls.equals(java.util.List.class)) {
            ...
            throw new com.tencent.cloud.component.common.ai.json.WeJsonException("json 解析错误:不支持的类型:".concat(cls.getName()));
        }
        if (cls2 != null) {
            if (cls.getName().equals("java.util.List")) {
                ...
                try {
                    ...
                    throw new com.tencent.cloud.component.common.ai.json.WeJsonException("创建List类型失败,该列表不支持无参实例化", e17);
                }
            }
            for (int i17 = 0; i17 < jSONArray.length(); i17++) {
                try {
                    ...
                    throw new com.tencent.cloud.component.common.ai.json.WeJsonException("JSONArray.get() cause JSONException", e18);
                }
            }
            return t17;
        }
        throw new com.tencent.cloud.component.common.ai.json.WeJsonException("无法确定列表项的类型");
    }
    ...
    public final <T> T a(org.json.JSONObject jSONObject, java.lang.Class<T> cls, java.lang.Class<?> cls2) {
            ...
            if (cls2 != null) {
                if (cls.getName().equals("java.util.Map")) {
                    ...
                    try {
                        ...
                        throw new com.tencent.cloud.component.common.ai.json.WeJsonException("创建Map类型失败,该Map不支持无参实例化", e17);
                    }
                }
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ...
                        throw new com.tencent.cloud.component.common.ai.json.WeJsonException("JSONObject.get() cause JSONException", e18);
                    }
                }
                return t17;
            }
        ...
        try {
            ...
            for (int i18 = 0; i18 < length; i18++) {
                ...
                if (((com.tencent.cloud.component.common.ai.json.WeJsonExpose) field.getAnnotation(com.tencent.cloud.component.common.ai.json.WeJsonExpose.class)) == null) {
                    java.lang.String name = field.getName();
                    com.tencent.cloud.component.common.ai.json.WeJsonSerializedName weJsonSerializedName = (com.tencent.cloud.component.common.ai.json.WeJsonSerializedName) field.getAnnotation(com.tencent.cloud.component.common.ai.json.WeJsonSerializedName.class);
                    java.lang.String value = weJsonSerializedName != null ? weJsonSerializedName.value() : name;
                    if (value.contains("$")) {
                        continue;
                    } else {
                        int modifiers = field.getModifiers();
                        java.lang.Object opt = jSONObject.opt(value);
                        if (opt != null) {
                            if (field.getGenericType() instanceof java.lang.reflect.TypeVariable) {
                                ...
                                if (genericSuperclass instanceof java.lang.reflect.ParameterizedType) {
                                    ...
                                    if (type2 instanceof java.lang.Class) {
                                        ...
                                        throw new com.tencent.cloud.component.common.ai.json.WeJsonException("不支持嵌套泛型");
                                    }
                                } else {
                                    throw new com.tencent.cloud.component.common.ai.json.WeJsonException("缺少泛型信息:" + cls);
                                }
                            } else {
                                type = field.getType();
                            }
                            ...
                            if ((modifiers & 1) != 0) {
                                try {
                                    ...
                                    throw new com.tencent.cloud.component.common.ai.json.WeJsonException("设置成员变量值失败.", e19);
                                }
                            } else {
                                ...
                                try {
                                    try {
                                        ...
                                        throw new com.tencent.cloud.component.common.ai.json.WeJsonException("调用set方法失败.", e27);
                                    }
            ...
            throw new com.tencent.cloud.component.common.ai.json.WeJsonException("必须为该类型提供一个无参构造方法:".concat(cls.getName()), e28);
        }
    }
    ...
    public final <T> T a(org.json.JSONArray jSONArray, java.lang.Class<T> cls) {
        ...
        for (int i17 = 0; i17 < jSONArray.length(); i17++) {
            try {
                ...
                throw new com.tencent.cloud.component.common.ai.json.WeJsonException("JSONArray.get() cause JSONException", e17);
            }
        }
        return t17;
    }
    ...
    public final java.lang.Class a(java.lang.Class cls, java.lang.reflect.Field field) {
        ...
        if (field.getType().equals(java.util.List.class)) {
            ...
            if (genericType instanceof java.lang.reflect.ParameterizedType) {
                ...
                throw new com.tencent.cloud.component.common.ai.json.WeJsonException("不支持嵌套泛型:" + field.getName());
            }
            throw new com.tencent.cloud.component.common.ai.json.WeJsonException("缺少泛型类型声明:" + field.getName());
        }
