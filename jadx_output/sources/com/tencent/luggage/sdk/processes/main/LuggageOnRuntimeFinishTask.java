...
public final class LuggageOnRuntimeFinishTask extends com.tencent.luggage.sdk.processes.main.LuggageMainProcessTaskExt {
    public static final android.os.Parcelable.Creator<com.tencent.luggage.sdk.processes.main.LuggageOnRuntimeFinishTask> CREATOR = new ye.f();

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    public com.tencent.luggage.sdk.processes.main.RuntimeInfo runtimeInfo;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LuggageOnRuntimeFinishTask(com.tencent.luggage.sdk.processes.main.RuntimeInfo runtimeInfo) {
        super(runtimeInfo);
    ...
    public void z() {
        ...
        com.tencent.luggage.sdk.processes.main.RuntimeInfo runtimeInfo = getRuntimeInfo();
        kotlin.jvm.internal.o.g(runtimeInfo, "runtimeInfo");
        java.lang.String str = runtimeInfo.f47660e;
        com.tencent.mm.plugin.appbrand.task.k kVar = (com.tencent.mm.plugin.appbrand.task.k) ((com.tencent.mm.plugin.appbrand.task.u0) rVar).g(str);
        com.tencent.mm.plugin.appbrand.task.o oVar = (com.tencent.mm.plugin.appbrand.task.o) (kVar != null ? com.tencent.luggage.sdk.processes.h.f(kVar, str, 0, 2, null) : null);
        ...
        if (eVar != null) {
            com.tencent.mm.plugin.appbrand.task.e.Bi(eVar, runtimeInfo.f47664i, null, 2, null);
        }
        new com.tencent.mm.plugin.appbrand.api.OnWeAppFinishedEvent(runtimeInfo.f47665m, str).e();
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public LuggageOnRuntimeFinishTask(ze.n rt6) {
        this(ye.e.a(rt6));
