...
public class BitmapUtils {
    ...
    public static android.graphics.Bitmap createBitmap(android.graphics.Bitmap bitmap, android.graphics.Matrix matrix, boolean z17) {
        if (bitmap == null) {
            return null;
        }
        bitmap.getConfig();
    ...
    public static android.graphics.Bitmap createBitmapFromBuffer(java.nio.ByteBuffer byteBuffer, int i17, int i18) {
        try {
            ...
            com.tencent.liteav.base.util.LiteavLog.e("BitmapUtils", "build bitmap failed.", th6);
            return null;
        }
    }

    public static android.graphics.Bitmap createBitmapFromFile(java.lang.String str, int i17, int i18) {
        boolean z17;
        int i19;
        try {
            switch (new android.media.ExifInterface(str).getAttributeInt(androidx.exifinterface.media.ExifInterface.TAG_ORIENTATION, 1)) {
                case 1:
                    z17 = false;
                    i19 = 0;
                    break;
            ...
            android.graphics.Bitmap loadBitmapFile = loadBitmapFile(str, i17, i18, i19);
            ...
            com.tencent.liteav.base.util.LiteavLog.e("BitmapUtils", "build bitmap failed, path: ".concat(java.lang.String.valueOf(str)), th6);
            return null;
        }
    }

    private static android.graphics.Bitmap loadBitmapFile(java.lang.String str, int i17, int i18, int i19) {
        int i27;
        if (i17 <= 0 || i18 <= 0) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(str);
    ...
    public static void saveBitmapToFile(android.graphics.Bitmap bitmap, java.lang.String str) {
        ...
        try {
            ...
            com.tencent.liteav.base.util.LiteavLog.e("BitmapUtils", "save jpg file failed.", e);
