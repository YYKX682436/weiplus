...
public final class WXMediaMessage {
    ...
    public java.lang.String msgSignature;
    public int sdkVer;
    public byte[] thumbData;
    public java.lang.String thumbDataHash;
    ...
    public static class Builder {
        ...
        public static com.tencent.mm.opensdk.modelmsg.WXMediaMessage fromBundle(android.os.Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    com.tencent.mm.opensdk.utils.Log.e(com.tencent.mm.opensdk.modelmsg.WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e17.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static java.lang.String pathOldToNew(java.lang.String str) {
            com.tencent.mm.opensdk.utils.Log.i(com.tencent.mm.opensdk.modelmsg.WXMediaMessage.TAG, "pathOldToNew, oldPath = ".concat(java.lang.String.valueOf(str)));
            if (str == null || str.length() == 0) {
            ...
            if (lastIndexOf == -1) {
                com.tencent.mm.opensdk.utils.Log.e(com.tencent.mm.opensdk.modelmsg.WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = ".concat(str));
                return str;
            }
    ...
    public final boolean checkArgs() {
        ...
        } else if (getType() == 76 && com.tencent.mm.opensdk.utils.d.b(this.title)) {
            str = "checkArgs fail, Type = Music Video, but title == null";
        } else if (com.tencent.mm.opensdk.utils.d.a(getType()) && ((bArr3 = this.thumbData) == null || bArr3.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (!com.tencent.mm.opensdk.utils.d.b(getType()) || ((bArr2 = this.thumbData) != null && bArr2.length <= 262144)) {
            if ((com.tencent.mm.opensdk.utils.d.a(getType()) || com.tencent.mm.opensdk.utils.d.b(getType())) || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public final void setThumbImage(android.graphics.Bitmap bitmap) {
        try {
            ...
            com.tencent.mm.opensdk.utils.Log.e(TAG, "setThumbImage exception:" + e17.getMessage());
        }
    }
