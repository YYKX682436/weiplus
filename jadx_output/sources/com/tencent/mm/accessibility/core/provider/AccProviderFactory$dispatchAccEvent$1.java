...
public final class AccProviderFactory$dispatchAccEvent$1 extends kotlin.jvm.internal.q implements yz5.a {
    final /* synthetic */ android.view.accessibility.AccessibilityEvent $event;
    final /* synthetic */ android.view.View $view;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccProviderFactory$dispatchAccEvent$1(android.view.View view, android.view.accessibility.AccessibilityEvent accessibilityEvent) {
        super(0);
        this.$view = view;
    ...
    public final void m54invoke() {
        ...
        android.view.accessibility.AccessibilityEvent accessibilityEvent = this.$event;
