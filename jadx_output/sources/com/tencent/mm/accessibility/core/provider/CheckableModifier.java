...
public final class CheckableModifier extends com.tencent.mm.accessibility.core.provider.Provider {
    public static final int $stable;
    private static final long CLEAR_DELAY_TIME = 500;
    public static final com.tencent.mm.accessibility.core.provider.CheckableModifier INSTANCE;
    ...
    public static final class AnonymousClass1 extends kotlin.jvm.internal.q implements yz5.p {
        public static final com.tencent.mm.accessibility.core.provider.CheckableModifier.AnonymousClass1 INSTANCE = new com.tencent.mm.accessibility.core.provider.CheckableModifier.AnonymousClass1();
        ...
        public final java.util.List<java.lang.Integer> invoke(android.view.View view, com.tencent.mm.accessibility.base.MMBaseAccessibilityConfig config) {
            ...
            java.util.Map<java.lang.Integer, jz5.l> map = config.getViewRootCheckedMap$plugin_autoaccessibility_release().get(java.lang.Integer.valueOf(view.getId()));
    ...
    static {
        com.tencent.mm.accessibility.core.provider.CheckableModifier checkableModifier = new com.tencent.mm.accessibility.core.provider.CheckableModifier();
        ...
        clearTask = new java.lang.Runnable() { // from class: com.tencent.mm.accessibility.core.provider.CheckableModifier$clearTask$1
            ...
            public final void run() {
                com.tencent.mm.accessibility.core.provider.CheckableModifier.hoverViewId = -1;
            }
        };
        hoverViewId = -1;
        checkableModifier.addRootIdMapper$plugin_autoaccessibility_release(com.tencent.mm.accessibility.core.provider.CheckableModifier.AnonymousClass1.INSTANCE);
        $stable = 8;
    }
    ...
    public void dealNodeInfo(android.view.View view, android.view.accessibility.AccessibilityNodeInfo nodeInfo) {
        ...
        getConfig(view, new com.tencent.mm.accessibility.core.provider.CheckableModifier$dealNodeInfo$1(view, nodeInfo));
    }
