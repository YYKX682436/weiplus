...
public enum PropID {
    ...
    PropID(int i17) {
        this.propIDIndex = i17;
    }

    public static com.tencent.mm.mm7zip.PropID getPropIDByIndex(int i17) {
        if (i17 >= 0 && i17 < values().length && values()[i17].getPropIDIndex() == i17) {
            return values()[i17];
        }
        ...
        } while (values()[length].getPropIDIndex() != i17);
