...
public abstract class b7 {
    ...
    */
    public static android.net.Uri a(android.content.Context r10, java.lang.String r11, android.net.Uri r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.sdk.platformtools.b7.a(android.content.Context, java.lang.String, android.net.Uri):android.net.Uri");
    }
    ...
    public static android.net.Uri b(android.content.Context context, long j17, android.net.Uri uri) {
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.ScopedStorageUtil", "#pathToUri unsupported contentUri: " + uri);
        return null;
    }
        ...
        if (!android.text.TextUtils.isEmpty(str) && uri != null) {
            ...
            if (cursor != null) {
                try {
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScopedStorageUtil", th6, "convert uri fail", new java.lang.Object[0]);
                }
            }
        }
        return null;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void d(android.content.Context r17, java.lang.String r18, android.net.Uri r19, com.tencent.mm.sdk.platformtools.y6 r20) {
        /*
            Method dump skipped, instructions count: 861
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.sdk.platformtools.b7.d(android.content.Context, java.lang.String, android.net.Uri, com.tencent.mm.sdk.platformtools.y6):void");
    }
}
