...
public abstract class j {
    public static android.graphics.Bitmap a(java.lang.String str, float f17) {
        ...
        android.graphics.Bitmap j07 = com.tencent.mm.sdk.platformtools.x.j0(str, 0, 0, f17);
        if (j07 != null) {
    ...
    public static android.graphics.Bitmap b(java.lang.String str, int i17) {
        ...
        if (n07 == null || android.text.TextUtils.isEmpty(n07.outMimeType)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.SDK.BackwardSupportUtil", "[-] [tomys] Fail to get image size: %s", str);
            return null;
        }
        int i19 = n07.outWidth;
        if (i19 == 0 || (i18 = n07.outHeight) == 0) {
            com.tencent.mars.xlog.Log.w("MicroMsg.SDK.BackwardSupportUtil", "[!] [tomys] Bad image size: %s x %s, try to decode it directly.", java.lang.Integer.valueOf(i19), java.lang.Integer.valueOf(n07.outHeight));
        ...
        return com.tencent.mm.graphics.e.d(str, n07);
    }

    public static android.graphics.Bitmap c(java.io.InputStream inputStream, float f17) {
        float f18 = 160.0f * f17;
        android.graphics.Bitmap P = com.tencent.mm.sdk.platformtools.x.P(inputStream, f17, 0, 0, false);
        if (P != null) {
    ...
    */
    public static android.graphics.Bitmap e(java.lang.String r6) {
        /*
            ...
            android.graphics.Bitmap r3 = com.tencent.mm.sdk.platformtools.x.O(r2)     // Catch: java.io.IOException -> L34 java.lang.Throwable -> L60
        ...
        L3d:
            ...
            com.tencent.mars.xlog.Log.e(r0, r3)     // Catch: java.lang.Throwable -> L60
            java.lang.String r3 = ""
            r4 = 0
            java.lang.Object[] r4 = new java.lang.Object[r4]     // Catch: java.lang.Throwable -> L60
            com.tencent.mars.xlog.Log.printErrStackTrace(r0, r2, r3, r4)     // Catch: java.lang.Throwable -> L60
            if (r6 == 0) goto L5f
        ...
        L76:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.sdk.platformtools.j.e(java.lang.String):android.graphics.Bitmap");
    }
