...
public class q1 implements com.tencent.mm.console.g5 {
    ...
    public void a(android.content.Intent intent) {
        ...
        if (com.tencent.mm.sdk.platformtools.x2.n()) {
            ...
            if (stringExtra3 != null && stringExtra3.equals(ya.b.INDEX)) {
                k0Var = mt1.b0.f331191a.n().f348849d;
                ...
                k0Var = new d95.b0(d95.f.t(com.tencent.mm.plugin.backup.roambackup.v1.f92920g, false));
            } else if (stringExtra3 == null || !stringExtra3.equals("dupcheck")) {
                k0Var = gm0.j1.u().f273153f;
            } else {
                k0Var = new d95.b0(d95.f.t(gm0.j1.u().h() + "DupCheck-1.db", false));
            }
            if (stringExtra != null && !stringExtra.isEmpty()) {
                ((ku5.t0) ku5.t0.f312615d).a(new java.lang.Runnable() { // from class: com.tencent.mm.console.q1$$a
                    ...
                    public final void run() {
                        ...
                        try {
                            try {
                                ...
                                com.tencent.mars.xlog.Log.i("MicroMsg.Shell", "Executing SQL from shell: " + str);
                                if (length > 0) {
                                    com.tencent.mars.xlog.Log.i("MicroMsg.Shell", " > " + android.text.TextUtils.join(com.tencent.midas.comm.log.util.APLogFileUtil.SEPARATOR_LOG, columnNames));
                                }
                                ...
                                while (cursor.moveToNext()) {
                                    ...
                                    com.tencent.mars.xlog.Log.i("MicroMsg.Shell", sb6.toString());
                                }
                                com.tencent.mars.xlog.Log.i("MicroMsg.Shell", "Finish executing SQL in %d ms: %s", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis), str);
                            } catch (java.lang.RuntimeException e17) {
                                com.tencent.mars.xlog.Log.e("MicroMsg.Shell", "Failed to execute SQL '%s': %s", str, e17.getMessage());
                                if (cursor == null) {
                                    return;
                                }
                            }
                ...
                ((ku5.t0) ku5.t0.f312615d).a(new java.lang.Runnable() { // from class: com.tencent.mm.console.q1$$b
                    ...
                    */
                    public final void run() {
                        /*
                            ...
                            com.tencent.mars.xlog.Log.i(r1, r2)     // Catch: java.lang.Throwable -> L52 java.lang.Exception -> L54 java.io.FileNotFoundException -> L57
                        L2b:
                        ...
                        L35:
                            ...
                            com.tencent.mars.xlog.Log.i(r1, r2, r7)     // Catch: java.lang.Throwable -> L52 java.lang.Exception -> L54 java.io.FileNotFoundException -> L57
                        ...
                        L5c:
                            ...
                            com.tencent.mars.xlog.Log.printErrStackTrace(r1, r2, r0, r6)     // Catch: java.lang.Throwable -> L59
                            if (r7 == 0) goto L77
                        ...
                        L7e:
                            ...
                            com.tencent.mars.xlog.Log.e(r1, r0)     // Catch: java.lang.Throwable -> L59
                            if (r7 == 0) goto L97
                        ...
                        Lb8:
                            throw r0
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.console.q1$$b.run():void");
                    }
                });
            }
        }
