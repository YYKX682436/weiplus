...
public final class FinderLiveFeedThreePartsRecommendWordingView extends android.widget.FrameLayout {
    ...
    public FinderLiveFeedThreePartsRecommendWordingView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public FinderLiveFeedThreePartsRecommendWordingView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        kotlin.jvm.internal.o.g(context, "context");
        android.view.LayoutInflater.from(context).inflate(com.tencent.mm.R.layout.e_k, (android.view.ViewGroup) this, true);
        android.view.View findViewById = findViewById(com.tencent.mm.R.id.usk);
        kotlin.jvm.internal.o.f(findViewById, "findViewById(...)");
        this.prefix = (android.widget.TextView) findViewById;
        android.view.View findViewById2 = findViewById(com.tencent.mm.R.id.cgi);
        kotlin.jvm.internal.o.f(findViewById2, "findViewById(...)");
        this.content = (android.widget.TextView) findViewById2;
        android.view.View findViewById3 = findViewById(com.tencent.mm.R.id.f487170vb3);
