...
public class mike_no_circle_regular extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        instancePath2.close();
        instancePath2.moveTo(12.0f, 7.2002f);
        instancePath2.cubicTo(11.1475f, 7.20043f, 10.4561f, 7.89156f, 10.4561f, 8.74414f);
        instancePath2.lineTo(10.4561f, 12.4023f);
        instancePath2.cubicTo(10.4561f, 13.2549f, 11.1475f, 13.9461f, 12.0f, 13.9463f);
        instancePath2.cubicTo(12.8527f, 13.9462f, 13.5439f, 13.255f, 13.5439f, 12.4023f);
        instancePath2.lineTo(13.5439f, 8.74414f);
        instancePath2.cubicTo(13.5439f, 7.89146f, 12.8527f, 7.20027f, 12.0f, 7.2002f);
        instancePath2.close();
