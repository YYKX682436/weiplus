...
public class welab_bg_right extends l95.c {
    private final int width = com.tencent.tavkit.component.TAVPlayer.VIDEO_PLAYER_WIDTH;
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 0.70710677f, 0.70710677f, 0.10347748f, -0.70710677f, 0.70710677f, 314.05887f, 0.0f, 0.0f, 1.0f);
        ...
        instancePath.close();
        canvas.saveLayerAlpha(null, 127, 31);
