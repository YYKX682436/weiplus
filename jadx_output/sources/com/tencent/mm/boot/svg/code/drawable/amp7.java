...
public class amp7 extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -401.0f, 0.0f, 1.0f, -50.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 401.0f, 0.0f, 1.0f, 50.25f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        canvas.drawPath(instancePath8, l95.c.instancePaint(instancePaint11, looper));
        canvas.restore();
        canvas.restore();
        canvas.restore();
        l95.c.done(looper);
