...
public class icons_filled_record_effect_beauty extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 2.666667f, 0.0f, 1.0f, 2.0f, 0.0f, 0.0f, 1.0f);
        ...
        canvas.restore();
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 6.666667f, 0.0f, 1.0f, 9.733333f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
