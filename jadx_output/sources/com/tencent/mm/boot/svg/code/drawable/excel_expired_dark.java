...
public class excel_expired_dark extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        instancePath2.moveTo(29.623f, 22.8359f);
        instancePath2.lineTo(25.5874f, 29.1909f);
        instancePath2.lineTo(29.5674f, 35.4995f);
        instancePath2.lineTo(26.6821f, 35.4995f);
        instancePath2.lineTo(23.9917f, 31.0186f);
        instancePath2.lineTo(23.8804f, 31.0186f);
        instancePath2.lineTo(21.1807f, 35.4995f);
        instancePath2.lineTo(18.4531f, 35.4995f);
        instancePath2.lineTo(22.3774f, 29.1167f);
        instancePath2.lineTo(18.4902f, 22.8359f);
        instancePath2.lineTo(21.4404f, 22.8359f);
        instancePath2.lineTo(24.0752f, 27.3911f);
        instancePath2.lineTo(24.1865f, 27.3911f);
        instancePath2.lineTo(26.7935f, 22.8359f);
        instancePath2.lineTo(29.623f, 22.8359f);
        instancePath2.close();
        ...
        instancePaint5.setColor(-12759996);
