...
public class finder_poi_fav_star extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        instancePath.moveTo(35.9998f, 50.4159f);
        instancePath.lineTo(49.4201f, 57.4713f);
        instancePath.lineTo(46.857f, 42.5276f);
        instancePath.lineTo(57.7143f, 31.9444f);
        instancePath.lineTo(42.7099f, 29.7641f);
        instancePath.lineTo(35.9998f, 16.1678f);
        instancePath.lineTo(29.2896f, 29.7641f);
        instancePath.lineTo(14.2852f, 31.9444f);
        instancePath.lineTo(25.1425f, 42.5276f);
        instancePath.lineTo(22.5794f, 57.4713f);
        instancePath.lineTo(35.9998f, 50.4159f);
        instancePath.close();
        instancePath.moveTo(26.3013f, 25.6511f);
