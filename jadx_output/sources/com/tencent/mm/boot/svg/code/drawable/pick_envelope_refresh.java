...
public class pick_envelope_refresh extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -39.0f, 0.0f, 1.0f, -37.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 33.0f, 0.0f, 1.0f, 34.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray3 = l95.c.setMatrixFloatArray(matrixFloatArray2, -0.70710677f, -0.70710677f, 36.499157f, -0.70710677f, 0.70710677f, 15.118446f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray4 = l95.c.setMatrixFloatArray(matrixFloatArray3, 0.70710677f, 0.70710677f, -16.161968f, -0.70710677f, 0.70710677f, 24.876308f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
