...
public class clock_filled extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        if (i17 != 0 && i17 != 1) {
            ...
            if (i17 == 2) {
                ...
                instancePath.close();
                instancePath.moveTo(13.0f, 11.2762f);
                instancePath.lineTo(13.0f, 6.0f);
                instancePath.lineTo(11.0f, 6.0f);
                instancePath.lineTo(11.0f, 12.1047f);
                instancePath.lineTo(15.3129f, 16.4176f);
                instancePath.lineTo(16.7271f, 15.0034f);
                instancePath.lineTo(13.0f, 11.2762f);
                instancePath.close();
