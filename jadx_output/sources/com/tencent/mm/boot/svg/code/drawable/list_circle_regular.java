...
public class list_circle_regular extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        if (i17 != 0 && i17 != 1) {
            ...
            if (i17 == 2) {
                ...
                instancePath.lineTo(8.2f, 8.0f);
                instancePath.lineTo(8.2f, 9.2f);
                instancePath.lineTo(7.0f, 9.2f);
                instancePath.lineTo(7.0f, 8.0f);
                instancePath.close();
                instancePath.moveTo(9.2f, 9.2f);
                instancePath.lineTo(9.2f, 8.0f);
                instancePath.lineTo(17.0f, 8.0f);
                instancePath.lineTo(17.0f, 9.2f);
                instancePath.lineTo(9.2f, 9.2f);
                instancePath.close();
                instancePath.moveTo(7.0f, 11.4f);
                instancePath.lineTo(8.2f, 11.4f);
                instancePath.lineTo(8.2f, 12.6f);
                instancePath.lineTo(7.0f, 12.6f);
                instancePath.lineTo(7.0f, 11.4f);
                instancePath.close();
                instancePath.moveTo(17.0f, 11.4f);
                instancePath.lineTo(9.2f, 11.4f);
                instancePath.lineTo(9.2f, 12.6f);
                instancePath.lineTo(17.0f, 12.6f);
                instancePath.lineTo(17.0f, 11.4f);
                instancePath.close();
                instancePath.moveTo(7.0f, 14.8f);
                instancePath.lineTo(8.2f, 14.8f);
                instancePath.lineTo(8.2f, 16.0f);
                instancePath.lineTo(7.0f, 16.0f);
                instancePath.lineTo(7.0f, 14.8f);
                instancePath.close();
                instancePath.moveTo(17.0f, 16.0f);
                instancePath.lineTo(9.2f, 16.0f);
                instancePath.lineTo(9.2f, 14.8f);
                instancePath.lineTo(17.0f, 14.8f);
