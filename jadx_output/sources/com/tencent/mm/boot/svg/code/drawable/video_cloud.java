...
public class video_cloud extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -159.0f, 0.0f, 1.0f, -226.0f, 0.0f, 0.0f, 1.0f);
        ...
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray4 = l95.c.setMatrixFloatArray(matrixFloatArray3, 1.0f, 0.0f, 159.0f, 0.0f, 1.0f, 114.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
