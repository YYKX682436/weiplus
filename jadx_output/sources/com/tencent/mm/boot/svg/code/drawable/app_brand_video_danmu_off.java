...
public class app_brand_video_danmu_off extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -510.0f, 0.0f, 1.0f, -60.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 510.0f, 0.0f, 1.0f, 60.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        canvas.drawPath(instancePath3, l95.c.instancePaint(instancePaint9, looper));
        canvas.restore();
        canvas.save();
