...
public class radio_on_red extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -218.0f, 0.0f, 1.0f, -230.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 224.0f, 0.0f, 1.0f, 236.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
