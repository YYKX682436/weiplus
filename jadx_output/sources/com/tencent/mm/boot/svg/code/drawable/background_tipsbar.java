...
public class background_tipsbar extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -232.0f, 0.0f, 1.0f, -529.0f, 0.0f, 0.0f, 1.0f);
        ...
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 264.0f, 0.0f, 232.0f, 0.0f, 601.0f, 529.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray2);
        com.tencent.mm.svg.WeChatSVGRenderC2Java.setLinearGradient(instancePaint3, 0.5f, 0.0f, 0.5f, 0.40058053f, new int[]{1290661357, -1184275}, new float[]{0.0f, 1.0f}, instanceMatrix, 0);
