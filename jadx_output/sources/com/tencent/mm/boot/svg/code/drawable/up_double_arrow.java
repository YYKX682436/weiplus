...
public class up_double_arrow extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        instancePath.close();
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 6.123234E-17f, 1.0f, 5.0f, -1.0f, 6.123234E-17f, 12.0f, 0.0f, 0.0f, 1.0f);
        ...
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, -1.0f, 1.2246469E-16f, 8.041568f, -1.2246469E-16f, -1.0f, 14.01054f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        canvas.restore();
        canvas.save();
        float[] matrixFloatArray3 = l95.c.setMatrixFloatArray(matrixFloatArray2, 6.123234E-17f, 1.0f, 5.0f, -1.0f, 6.123234E-17f, 19.5f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray4 = l95.c.setMatrixFloatArray(matrixFloatArray3, -1.0f, 1.2246469E-16f, 8.041568f, -1.2246469E-16f, -1.0f, 14.01054f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
