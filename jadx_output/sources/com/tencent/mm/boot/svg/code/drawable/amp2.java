...
public class amp2 extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -108.0f, 0.0f, 1.0f, -50.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 108.666664f, 0.0f, 1.0f, 50.25f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        instancePath4.close();
        canvas.saveLayerAlpha(null, 76, 31);
        canvas.drawPath(instancePath4, l95.c.instancePaint(instancePaint7, looper));
        canvas.restore();
        ...
        instancePath6.close();
        canvas.saveLayerAlpha(null, 76, 31);
        canvas.drawPath(instancePath6, l95.c.instancePaint(instancePaint9, looper));
        canvas.restore();
