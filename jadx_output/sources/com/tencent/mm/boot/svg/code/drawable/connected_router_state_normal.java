...
public class connected_router_state_normal extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        canvas.restore();
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 58.0f, 0.0f, 1.0f, 75.0f, 0.0f, 0.0f, 1.0f);
        ...
        canvas.restore();
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 0.095238f, 0.0f, 1.0f, 0.652174f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
