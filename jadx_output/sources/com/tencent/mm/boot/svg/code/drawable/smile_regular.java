...
public class smile_regular extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        if (i17 != 0 && i17 != 1) {
            ...
            if (i17 == 2) {
                ...
                instancePath.close();
                instancePath.moveTo(8.5f, 10.5f);
                instancePath.cubicTo(9.32843f, 10.5f, 10.0f, 9.82843f, 10.0f, 9.0f);
                instancePath.cubicTo(10.0f, 8.17157f, 9.32843f, 7.5f, 8.5f, 7.5f);
                instancePath.cubicTo(7.67157f, 7.5f, 7.0f, 8.17157f, 7.0f, 9.0f);
                instancePath.cubicTo(7.0f, 9.82843f, 7.67157f, 10.5f, 8.5f, 10.5f);
                instancePath.close();
                ...
                instancePath.cubicTo(15.3137f, 18.5f, 18.0f, 15.8137f, 18.0f, 12.5f);
                instancePath.lineTo(6.0f, 12.5f);
                instancePath.lineTo(6.00414f, 12.7249f);
                instancePath.cubicTo(6.12243f, 15.9344f, 8.7616f, 18.5f, 12.0f, 18.5f);
                instancePath.close();
                instancePath.moveTo(7.352f, 13.7f);
                instancePath.lineTo(16.648f, 13.7f);
                instancePath.lineTo(16.5762f, 13.953f);
                instancePath.cubicTo(15.9605f, 15.8937f, 14.1445f, 17.3f, 12.0f, 17.3f);
                instancePath.lineTo(11.7797f, 17.295f);
                instancePath.cubicTo(9.66195f, 17.1992f, 7.89451f, 15.7286f, 7.3633f, 13.7469f);
                instancePath.lineTo(7.352f, 13.7f);
                instancePath.close();
