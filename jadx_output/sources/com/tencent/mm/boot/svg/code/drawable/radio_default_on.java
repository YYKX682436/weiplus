...
public class radio_default_on extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        if (i17 != 0 && i17 != 1) {
            ...
            if (i17 == 2) {
                ...
                canvas.save();
                float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -392.0f, 0.0f, 1.0f, -141.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                instanceMatrix.setValues(matrixFloatArray);
                canvas.concat(instanceMatrix);
                canvas.save();
                float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 392.0f, 0.0f, 1.0f, 141.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
