...
public class music_expired_dark extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        instancePaint3.setColor(-12237228);
        ...
        instancePaint4.setColor(-10461084);
        android.graphics.Path instancePath2 = l95.c.instancePath(looper);
        instancePath2.moveTo(29.4081f, 24.926f);
        instancePath2.cubicTo(28.1997f, 23.901f, 26.4581f, 23.901f, 25.4247f, 22.7426f);
        instancePath2.cubicTo(25.1247f, 22.401f, 24.9414f, 21.9843f, 24.9081f, 21.5593f);
        instancePath2.cubicTo(24.8581f, 21.1593f, 24.4331f, 21.0676f, 24.1747f, 21.2343f);
        instancePath2.cubicTo(24.1581f, 21.2426f, 24.1414f, 21.251f, 24.1331f, 21.2676f);
        instancePath2.cubicTo(24.0914f, 21.301f, 24.0581f, 21.3426f, 24.0331f, 21.3843f);
        instancePath2.cubicTo(23.8997f, 21.576f, 23.8247f, 21.8843f, 23.8247f, 22.3843f);
        instancePath2.lineTo(23.8247f, 28.8843f);
        instancePath2.cubicTo(23.8247f, 31.7843f, 23.2497f, 31.1676f, 21.4164f, 31.6343f);
        instancePath2.cubicTo(20.0664f, 31.976f, 18.9414f, 32.8843f, 18.9414f, 34.276f);
        instancePath2.cubicTo(18.9414f, 35.6676f, 20.1747f, 36.826f, 21.6081f, 36.776f);
        instancePath2.cubicTo(25.1747f, 36.6676f, 25.0664f, 32.8843f, 25.0664f, 31.426f);
        instancePath2.lineTo(25.0664f, 25.5426f);
        instancePath2.cubicTo(25.1164f, 24.4093f, 25.9164f, 24.6843f, 27.4414f, 25.2426f);
        instancePath2.cubicTo(27.8831f, 25.4176f, 28.3081f, 25.6093f, 28.6831f, 25.8676f);
        instancePath2.cubicTo(30.1664f, 26.876f, 29.4247f, 28.6593f, 28.0497f, 29.3843f);
        instancePath2.cubicTo(27.8831f, 29.476f, 27.9747f, 29.726f, 28.1581f, 29.6926f);
        instancePath2.cubicTo(30.2664f, 29.326f, 31.4664f, 26.5093f, 29.4081f, 24.926f);
        instancePath2.close();
        ...
        instancePaint5.setColor(-12566452);
