...
public class circle_notvisible extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 5.0f, 0.0f, 0.0f, 1.0f);
        ...
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 25.0f, 0.0f, 1.0f, 35.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray3 = l95.c.setMatrixFloatArray(matrixFloatArray2, 1.0f, 0.0f, 28.0f, 0.0f, 1.0f, 24.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
