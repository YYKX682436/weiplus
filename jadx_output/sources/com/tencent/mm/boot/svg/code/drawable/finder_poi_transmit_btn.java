...
public class finder_poi_transmit_btn extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        if (i17 != 0 && i17 != 1) {
            ...
            if (i17 == 2) {
                ...
                instancePath.moveTo(39.0111f, 8.99414f);
                ...
                instancePath.close();
                instancePath.moveTo(39.6089f, 13.4341f);
                instancePath.lineTo(39.6111f, 25.0023f);
                instancePath.lineTo(36.5714f, 25.4813f);
                instancePath.cubicTo(22.0947f, 27.7626f, 12.6429f, 39.0402f, 12.8502f, 54.7583f);
                instancePath.lineTo(12.87f, 55.6201f);
                instancePath.lineTo(12.9459f, 55.4956f);
                instancePath.cubicTo(18.2676f, 46.9253f, 26.3082f, 42.2004f, 34.8653f, 41.258f);
                instancePath.lineTo(35.7226f, 41.1764f);
                instancePath.lineTo(39.6111f, 40.8638f);
                instancePath.lineTo(39.6089f, 53.1721f);
                instancePath.lineTo(59.6729f, 33.3031f);
                instancePath.lineTo(39.6089f, 13.4341f);
                instancePath.close();
