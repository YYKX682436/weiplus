...
public class icons_filled_detail_skin_hb_mask extends l95.c {
    private final int width = com.tencent.liteav.TXLiteAVCode.WARNING_MICROPHONE_DEVICE_EMPTY;
    private final int height = 444;

    @Override // l95.c
    public int doCommand(int i17, java.lang.Object... objArr) {
        if (i17 == 0) {
            return com.tencent.liteav.TXLiteAVCode.WARNING_MICROPHONE_DEVICE_EMPTY;
        }
        if (i17 == 1) {
            return 444;
        }
        ...
        canvas.save();
        float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -96.0f, 0.0f, 1.0f, -71.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 96.0f, 0.0f, 1.0f, 71.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray3 = l95.c.setMatrixFloatArray(matrixFloatArray2, 1200.0099f, 0.0f, 0.009927948f, 0.0f, 444.0f, 275.6f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray3);
        com.tencent.mm.svg.WeChatSVGRenderC2Java.setLinearGradient(instancePaint3, 0.5f, 0.0f, 0.5f, 1.0f, new int[]{-1, -1, -1}, new float[]{0.0f, 0.889228f, 1.0f}, instanceMatrix, 0);
