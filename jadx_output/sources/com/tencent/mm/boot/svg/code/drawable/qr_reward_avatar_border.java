...
public class qr_reward_avatar_border extends l95.c {
    private final int width = com.tencent.mm.plugin.appbrand.jsapi.audio.a0.CTRL_INDEX;
    private final int height = com.tencent.mm.plugin.appbrand.jsapi.audio.a0.CTRL_INDEX;

    @Override // l95.c
    public int doCommand(int i17, java.lang.Object... objArr) {
        int i18 = com.tencent.mm.plugin.appbrand.jsapi.audio.a0.CTRL_INDEX;
        if (i17 != 0 && i17 != 1) {
            i18 = 0;
            if (i17 == 2) {
