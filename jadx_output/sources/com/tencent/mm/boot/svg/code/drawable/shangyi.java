...
public class shangyi extends l95.c {
    ...
    public int doCommand(int i17, java.lang.Object... objArr) {
        ...
        if (i17 == 2) {
            ...
            float[] matrixFloatArray = l95.c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 16.0f, 0.0f, 1.0f, 18.0f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
            instanceMatrix.setValues(matrixFloatArray);
            canvas.concat(instanceMatrix);
            canvas.save();
            android.graphics.Paint instancePaint4 = l95.c.instancePaint(instancePaint3, looper);
            float[] matrixFloatArray2 = l95.c.setMatrixFloatArray(matrixFloatArray, -0.70710677f, -0.70710677f, 49.86225f, -0.70710677f, 0.70710677f, 20.653622f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
