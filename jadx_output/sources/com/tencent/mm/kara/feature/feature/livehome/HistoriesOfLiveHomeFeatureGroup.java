...
public class HistoriesOfLiveHomeFeatureGroup extends pl0.e {
    ...
    public void build() {
        ...
        this.dayOfTheWeek_countThatHappened = k0Var.d(null, 1, false, d17, currentTimeMillis, i18);
        ...
        this.hourOfTheDay_countThatHappened = k0Var.e(null, 1, false, d17, currentTimeMillis, i18);
        ...
        this.hourOfTheWeekAndDay_countThatHappened = k0Var.c(null, 1, false, d17, currentTimeMillis, i18, i17);
        ...
        this.total_countThatHappened = k0Var.b(null, 1, false, d17, currentTimeMillis);
