...
public final class d3 implements gm5.a {
    ...
    public final /* synthetic */ com.tencent.mm.chatroom.ui.GroupAdminManagerUI f64103a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ java.util.LinkedList f64104b;

    public d3(com.tencent.mm.chatroom.ui.GroupAdminManagerUI groupAdminManagerUI, java.util.LinkedList linkedList) {
        this.f64103a = groupAdminManagerUI;
        this.f64104b = linkedList;
    }

    @Override // gm5.a
    public java.lang.Object call(java.lang.Object obj) {
        com.tencent.mm.modelbase.f fVar = (com.tencent.mm.modelbase.f) obj;
        com.tencent.mm.chatroom.ui.GroupAdminManagerUI groupAdminManagerUI = this.f64103a;
        ...
        if (fVar.f70615a == 0 && fVar.f70616b == 0) {
            com.tencent.mm.chatroom.ui.GroupAdminManagerUI.T6(groupAdminManagerUI, this.f64104b);
            return null;
        }
        ...
        objArr[3] = str;
        com.tencent.mars.xlog.Log.i("MicroMsg.GroupAdminManagerUI", "CgiOpenImAddChatRoomAdmin scene type:%s errCode:%s, errType:%s, errMsg:%s", objArr);
