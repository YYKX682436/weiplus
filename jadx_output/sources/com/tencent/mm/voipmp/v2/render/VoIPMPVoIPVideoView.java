package com.tencent.mm.voipmp.v2.render;
...
public final class VoIPMPVoIPVideoView extends android.view.TextureView implements android.view.TextureView.SurfaceTextureListener, bp5.h {
    ...
    public VoIPMPVoIPVideoView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    @Override // bp5.h
    public /* bridge */ /* synthetic */ boolean getImpellerEnabled() {
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ long getRenderPts() {
        return -1L;
    }
    ...
    public void onSurfaceTextureAvailable(android.graphics.SurfaceTexture surface, int i17, int i18) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ILinkVoIPVideoView", "onSurfaceTextureAvailable() called with: surface = " + surface + ", width = " + i17 + ", height = " + i18);
        this.size = new android.util.Size(i17, i18);
        this.renderSurface = surface;
        yz5.q qVar = this.onSurfaceTextureChanged;
        if (qVar != null) {
            qVar.invoke(surface, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
        }
    }
    ...
    public void onSurfaceTextureSizeChanged(android.graphics.SurfaceTexture surface, int i17, int i18) {
        kotlin.jvm.internal.o.g(surface, "surface");
        com.tencent.mars.xlog.Log.i("MicroMsg.ILinkVoIPVideoView", "onSurfaceTextureSizeChanged() called with: surface = " + surface + ", width = " + i17 + ", height = " + i18);
        this.size = new android.util.Size(i17, i18);
        yz5.q qVar = this.onSurfaceTextureChanged;
        if (qVar != null) {
            qVar.invoke(surface, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
    ...
    public final void setOnSurfaceTextureChanged(yz5.q qVar) {
