...
final class MigrationStatistics$MigrationStatisticsFileSystem extends com.tencent.mm.vfs.k4 implements com.tencent.mm.vfs.FileSystem {
    public static final android.os.Parcelable.Creator<com.tencent.mm.vfs.MigrationStatistics$MigrationStatisticsFileSystem> CREATOR = new com.tencent.mm.vfs.w3();

    public MigrationStatistics$MigrationStatisticsFileSystem(com.tencent.mm.vfs.v3 v3Var) {
    }
    ...
    public final long f(java.util.List list, java.lang.String str, final com.tencent.mm.vfs.q2 q2Var, final java.lang.String[] strArr, long j17, android.os.CancellationSignal cancellationSignal, org.json.JSONArray jSONArray) {
        if (list.isEmpty()) {
            return -1L;
        }
        pm5.a aVar = new pm5.a() { // from class: com.tencent.mm.vfs.MigrationStatistics$MigrationStatisticsFileSystem$$b
            ...
            public final java.lang.Iterable a(java.lang.Object obj) {
                final com.tencent.mm.vfs.q2 q2Var2 = com.tencent.mm.vfs.q2.this;
                java.lang.Iterable list2 = q2Var2.list((java.lang.String) obj);
                if (list2 == null) {
                    list2 = java.util.Collections.emptyList();
                }
                final java.lang.String[] strArr2 = strArr;
                return new pm5.b(list2, new pm5.a() { // from class: com.tencent.mm.vfs.MigrationStatistics$MigrationStatisticsFileSystem$$c
                    @Override // pm5.a
                    public final java.lang.Iterable a(java.lang.Object obj2) {
                        com.tencent.mm.vfs.x1 x1Var = (com.tencent.mm.vfs.x1) obj2;
                        if (java.util.Arrays.binarySearch(strArr2, x1Var.f213232b) < 0) {
                            return null;
                        }
                        return new pm5.i(java.util.Collections.singleton(x1Var), com.tencent.mm.vfs.e8.p(q2Var2, x1Var.f213231a, false, null));
                    }
                });
            }
        };
        ...
        while (cVar.hasNext()) {
            ...
            if (x1Var.f213236f) {
                ...
                i17++;
                j18 += java.lang.Math.max(0L, currentTimeMillis - x1Var.f213235e);
            }
        }
        long j27 = i17 > 0 ? j18 / i17 : 0L;
        com.tencent.mars.xlog.Log.i("VFS.MigrationStatistics", "Stat >> " + str + ": " + j19 + ", " + i17 + ", " + i19 + ", " + j27);
        if (j19 > j17) {
            try {
                jSONArray.put(new org.json.JSONObject().put("n", str).put("ts", j19).put("f", i17).put("d", i19).put("a", j27));
            } catch (org.json.JSONException e17) {
                com.tencent.mars.xlog.Log.printErrStackTrace("VFS.MigrationStatistics", e17, "Cannot append report", new java.lang.Object[0]);
            }
        }
        return j19;
    }
    ...
    public void q(android.os.CancellationSignal cancellationSignal) {
        ...
        final com.tencent.mm.vfs.q2 b18 = new com.tencent.mm.vfs.NativeFileSystem("${storage}/tencent/MicroMsg").b(c17);
        com.tencent.mm.vfs.q2 b19 = new com.tencent.mm.vfs.NativeFileSystem("${extData}/MicroMsg").b(c17);
        java.lang.Iterable list = b18.list("");
        if (list == null) {
        ...
        final int i18 = i17;
        int i19 = i17;
        pm5.c cVar = new pm5.c(list.iterator(), new pm5.a() { // from class: com.tencent.mm.vfs.MigrationStatistics$MigrationStatisticsFileSystem$$a
            @Override // pm5.a
            public final java.lang.Iterable a(java.lang.Object obj) {
                ...
                if (!matcher.matches()) {
                    if (java.util.Arrays.binarySearch(com.tencent.mm.vfs.x3.f213239b, str) < 0) {
                        return null;
                    }
                    return new pm5.i(java.util.Collections.singleton(x1Var), com.tencent.mm.vfs.e8.p(b18, x1Var.f213231a, false, null));
                }
                ...
                treeMap.put(java.lang.Long.valueOf(x1Var.f213235e), str);
                return null;
            }
        });
        int i27 = 0;
        ...
        java.lang.String[] strArr = com.tencent.mm.vfs.x3.f213238a;
        ...
        com.tencent.mm.sdk.platformtools.o4.L().D("storage_migration_report_items", jSONArray.toString());
    }
