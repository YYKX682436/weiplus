...
public final class PickerTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public final android.graphics.RectF f214340m;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public PickerTextView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        ...
        kotlin.jvm.internal.o.e(getParent(), "null cannot be cast to non-null type android.view.View");
        ...
        float y17 = getY();
        android.graphics.RectF rectF = this.f214340m;
    ...
    public final void setPTextColor(int i17) {
        this.pTextColor = i17;
    }

    public final void setPTextSelectColor(int i17) {
        this.pTextSelectColor = i17;
    }

    public final void setPTextSelectMedium(boolean z17) {
        this.pTextSelectMedium = z17;
    }

    public /* synthetic */ PickerTextView(android.content.Context context, android.util.AttributeSet attributeSet, int i17, int i18, kotlin.jvm.internal.i iVar) {
        this(context, (i18 & 2) != 0 ? null : attributeSet, (i18 & 4) != 0 ? 0 : i17);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PickerTextView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        kotlin.jvm.internal.o.g(context, "context");
        this.pTextSelectColor = -16777216;
        this.pTextColor = -16777216;
        this.f214340m = new android.graphics.RectF();
    }
}
