...
public final class InterceptRelativeLayout extends android.widget.RelativeLayout {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public yz5.l beforeDispatchTouchEvent;

    public InterceptRelativeLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent motionEvent) {
        ...
        if (lVar != null) {
            return ((java.lang.Boolean) lVar.invoke(motionEvent)).booleanValue();
        }
        return false;
    }

    public final void setBeforeDispatchTouchEvent(yz5.l lVar) {
        this.beforeDispatchTouchEvent = lVar;
    }

    public InterceptRelativeLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
