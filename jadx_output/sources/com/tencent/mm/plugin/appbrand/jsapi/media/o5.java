...
public class o5 implements com.tencent.mm.plugin.appbrand.jsapi.media.n5 {
    public o5(com.tencent.mm.plugin.appbrand.jsapi.media.k5 k5Var) {
    }
    ...
    public com.tencent.mm.plugin.appbrand.jsapi.media.l5 a(com.tencent.mm.plugin.appbrand.jsapi.l lVar, java.lang.String str, int i17, int i18, int i19) {
        ...
        if (lVar == null || !(lVar instanceof com.tencent.mm.plugin.appbrand.e9)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCompressImage.javayhu", "compressImage fail:not in service context");
            return new com.tencent.mm.plugin.appbrand.jsapi.media.l5(false, "fail:internal error invalid js component", dVar2);
        }
        com.tencent.mm.plugin.appbrand.appstorage.u1 fileSystem = lVar.getFileSystem();
        if (fileSystem == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.JsApiCompressImage.javayhu", "compressImage fail:runtime fileSystem is null");
            return new com.tencent.mm.plugin.appbrand.jsapi.media.l5(false, "fail:runtime fileSystem is null", dVar2);
        }
        java.io.InputStream q17 = com.tencent.mm.plugin.appbrand.appcache.la.q(((com.tencent.mm.plugin.appbrand.e9) lVar).t3(), str);
        if (q17 == null) {
        ...
        try {
            ...
            android.graphics.Bitmap Va = com.tencent.mm.plugin.appbrand.jsapi.media.y1.a().Va(q17, null, options);
            if (Va == null) {
            ...
            android.graphics.Bitmap C = com.tencent.mm.plugin.appbrand.jsapi.media.j5.C(Va, i18, i19);
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiCompressImage.javayhu", "compressImage fail:compress image exception:%s", e18);
