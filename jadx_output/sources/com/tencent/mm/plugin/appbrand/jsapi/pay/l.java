...
public class l extends com.tencent.mm.plugin.appbrand.jsapi.f implements com.tencent.mm.plugin.appbrand.jsapi.g {
    public static final int CTRL_INDEX = 86;
    public static final java.lang.String NAME = "bindPaymentCard";
    ...
    public void h(com.tencent.mm.plugin.appbrand.jsapi.ff ffVar) {
        ...
        try {
            if (com.tencent.mm.plugin.appbrand.jsapi.pay.f.d(c0Var, jSONObject2, jSONObject, NAME, false)) {
                com.tencent.mm.plugin.appbrand.jsapi.pay.AppBrandJsApiPayService.INSTANCE.startBindBankcard(Z0, c0Var.t3().l2(), jSONObject2, new com.tencent.mm.plugin.appbrand.jsapi.pay.k(this, c0Var, i17));
            } else {
                c0Var.a(i17, o("fail illegal appId"));
            }
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiBindPaymentCard", e17.getMessage());
            c0Var.a(i17, o("fail"));
        }
    }
}
