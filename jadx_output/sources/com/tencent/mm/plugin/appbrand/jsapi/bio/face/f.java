...
public abstract class f extends com.tencent.mm.plugin.appbrand.jsapi.f {
    ...
    public void A(com.tencent.mm.plugin.appbrand.jsapi.l lVar, org.json.JSONObject jSONObject, int i17) {
        ...
        if (a17 == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiFaceAsyncBaseV2", "JsApiFaceAsyncBaseV2 context is null, appId is %s", lVar.getAppId());
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiFaceAsyncBaseV2", "build verifyPreInfo failed: %s", e17.getMessage());
        }
        ...
        nf.g.a(a17).f(new com.tencent.mm.plugin.appbrand.jsapi.bio.face.e(this, b17, eVar, lVar, i17));
        try {
        ...
        try {
            ...
            e = e19;
            com.tencent.mars.xlog.Log.e(str, "startActivityForResult failed: %s", e.getMessage());
            if (b17) {
                ((com.tencent.mm.plugin.appbrand.utils.j5) eVar).a(z17);
            }
            C(lVar, i17, null, "fail");
        }
    }

    public final void C(com.tencent.mm.plugin.appbrand.jsapi.l lVar, int i17, android.os.Bundle bundle, java.lang.String str) {
        int i18;
