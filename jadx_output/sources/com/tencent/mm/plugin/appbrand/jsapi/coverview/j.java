...
public abstract class j {
    ...
    public static int f80689a;

    /* renamed from: b, reason: collision with root package name */
    public static int f80690b;

    /* renamed from: c, reason: collision with root package name */
    public static long f80691c;

    /* renamed from: d, reason: collision with root package name */
    public static long f80692d;

    public static void a(com.tencent.mm.plugin.appbrand.jsapi.t tVar, android.view.View view, int i17, android.view.MotionEvent motionEvent, java.lang.String str, boolean z17) {
        com.tencent.mm.plugin.appbrand.jsapi.n5 oVar;
        int actionIndex = motionEvent.getActionIndex();
        int pointerId = motionEvent.getPointerId(actionIndex);
        float x17 = motionEvent.getX(actionIndex);
        float y17 = motionEvent.getY(actionIndex);
        if (f80689a == motionEvent.getAction() && f80690b == pointerId && f80691c == motionEvent.getEventTime() && f80692d == motionEvent.getDownTime()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.InsertViewTouchEventDispatch", "action:%d, eventId:%d, eventTime:%d, downTime:%d, don't send Duplicate event", java.lang.Integer.valueOf(motionEvent.getAction()), java.lang.Integer.valueOf(pointerId), java.lang.Long.valueOf(motionEvent.getEventTime()), java.lang.Long.valueOf(motionEvent.getDownTime()));
            return;
        }
        f80689a = motionEvent.getAction();
        f80690b = pointerId;
        f80691c = motionEvent.getEventTime();
        f80692d = motionEvent.getDownTime();
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.InsertViewTouchEventDispatch", "action:%d, eventId:%d, eventTime:%d, downTime:%d", java.lang.Integer.valueOf(motionEvent.getAction()), java.lang.Integer.valueOf(pointerId), java.lang.Long.valueOf(f80691c), java.lang.Long.valueOf(f80692d));
        int action = motionEvent.getAction();
        if (action == 0) {
            try {
                org.json.JSONObject jSONObject2 = new org.json.JSONObject();
                try {
                    jSONObject2.put(dm.i4.COL_ID, pointerId);
            ...
            try {
                ...
                try {
                    jSONObject3.put(dm.i4.COL_ID, pointerId);
    ...
    public static if1.r[] b(android.view.MotionEvent motionEvent) {
        ...
        for (int i17 = 0; i17 < motionEvent.getPointerCount(); i17++) {
            ...
            rVar.f291093a = motionEvent.getPointerId(i17);
