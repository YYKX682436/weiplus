...
public final class BuyWCCoinResult extends com.tencent.mm.plugin.appbrand.ipc.AppBrandProxyUIProcessTask$ProcessResult {
    public static final com.tencent.mm.plugin.appbrand.jsapi.wccoin.b CREATOR = new com.tencent.mm.plugin.appbrand.jsapi.wccoin.b(null);

    /* renamed from: d, reason: collision with root package name */
    public java.lang.String f83739d;
    ...
    public void readParcel(android.os.Parcel parcel) {
        ...
        this.f83739d = readString;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(android.os.Parcel dest, int i17) {
        kotlin.jvm.internal.o.g(dest, "dest");
        dest.writeString(this.f83739d);
    }

    public BuyWCCoinResult(android.os.Parcel parcel) {
        kotlin.jvm.internal.o.g(parcel, "parcel");
        this.f83739d = "";
        readParcel(parcel);
    }
