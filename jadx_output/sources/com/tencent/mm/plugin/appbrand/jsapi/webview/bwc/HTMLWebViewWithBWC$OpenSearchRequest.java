...
public final class HTMLWebViewWithBWC$OpenSearchRequest extends com.tencent.mm.plugin.appbrand.ipc.AppBrandProxyUIProcessTask$ProcessRequest {
    public static final of1.a1 CREATOR = new of1.a1(null);

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private java.lang.String query;

    public HTMLWebViewWithBWC$OpenSearchRequest(java.lang.String query) {
    ...
    public HTMLWebViewWithBWC$OpenSearchRequest(android.os.Parcel parcel) {
        kotlin.jvm.internal.o.g(parcel, "parcel");
        this.query = "";
        readParcel(parcel);
    }
