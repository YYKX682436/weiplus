...
public class m1 implements kk3.b {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.appbrand.jsapi.file.n1 f81097a;

    public m1(com.tencent.mm.plugin.appbrand.jsapi.file.n1 n1Var) {
        this.f81097a = n1Var;
    }
    ...
    public void a(java.util.List list) {
        ...
        while (it.hasNext()) {
            ...
            if (multiTaskInfo != null && multiTaskInfo.field_type == 4 && multiTaskInfo.field_data != null) {
                ...
                java.lang.String string = qs0Var.getString(4);
                boolean z17 = com.tencent.mm.sdk.platformtools.t8.f192989a;
                if (string == null) {
                    string = "";
                }
                if (string.equals(bm5.f1.a()) && (aVar = this.f81097a.f81102h) != null) {
                    aVar.c0("");
                }
            }
        }
