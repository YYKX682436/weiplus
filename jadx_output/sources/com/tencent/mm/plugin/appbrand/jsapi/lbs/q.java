...
public class q extends com.tencent.mm.plugin.appbrand.jsapi.lbs.l {
    private static final int CTRL_INDEX = 586;
    public static final java.lang.String NAME = "enableLocationUpdateBackground";
    ...
    public void D(com.tencent.mm.plugin.appbrand.e9 e9Var, org.json.JSONObject jSONObject, int i17) {
        ...
        if (!(j1Var instanceof com.tencent.mm.plugin.appbrand.jsapi.lbs.k1)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.AppBrand.JsApiEnableLocationUpdateBackgroundWxa", "state manager not RuntimeLocationUpdateStateManagerWxa");
        ...
        k1Var.f81449v = c1Var;
        c1Var.a(e9Var.t3());
        k1Var.f81442r = new com.tencent.mm.plugin.appbrand.jsapi.lbs.o(this, k1Var, e9Var);
        u81.f fVar = k1Var.f81450w;
        if (fVar != null) {
            e9Var.t3().N.c(fVar);
        }
        if (fVar == null || !k1Var.f81441q) {
            fVar = new com.tencent.mm.plugin.appbrand.jsapi.lbs.p(this, k1Var);
        }
        e9Var.t3().N.a(fVar);
        k1Var.f81450w = fVar;
        k1Var.f81441q = true;
