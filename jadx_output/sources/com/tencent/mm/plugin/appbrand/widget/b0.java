...
public class b0 extends androidx.appcompat.widget.AppCompatButton {

    /* renamed from: f, reason: collision with root package name */
    public final boolean f91051f;

    /* renamed from: g, reason: collision with root package name */
    public android.graphics.RectF f91052g;

    /* renamed from: h, reason: collision with root package name */
    public boolean f91053h;

    /* renamed from: i, reason: collision with root package name */
    public float f91054i;

    /* renamed from: m, reason: collision with root package name */
    public float f91055m;
    ...
    public b0(android.content.Context context) {
        ...
        setBackgroundDrawable(new com.tencent.mm.plugin.appbrand.widget.a0(null));
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (getBackground() == null) {
            setBackground(new com.tencent.mm.plugin.appbrand.widget.a0(null));
        }
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        /*
            ...
            goto Laf
        Lf:
            boolean r0 = r8.f91053h
            if (r0 != 0) goto L26
            float r0 = r9.getRawX()
            float r2 = r9.getRawY()
            android.graphics.RectF r4 = r8.f91052g
            if (r4 != 0) goto L20
            goto L24
        L20:
