...
public class f7 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.appbrand.ui.AppBrandSearchUI f89707d;

    public f7(com.tencent.mm.plugin.appbrand.ui.AppBrandSearchUI appBrandSearchUI) {
        this.f89707d = appBrandSearchUI;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.appbrand.ui.AppBrandSearchUI appBrandSearchUI = this.f89707d;
        if (android.text.TextUtils.isEmpty(appBrandSearchUI.f89408e5)) {
        ...
        intent.putExtra("rawUrl", appBrandSearchUI.f89408e5);
