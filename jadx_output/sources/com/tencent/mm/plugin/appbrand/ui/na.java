...
public abstract class na extends com.tencent.mm.ui.v9 {
    public static void g(android.content.Context context, boolean z17) {
        ...
        if (a17 == null || a17.getWindow() == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.AppBrandUIUtil", "configFullScreen with context(%s), get NULL activity", context);
        } else {
    ...
    public static void h(android.view.Window window, boolean z17, boolean z18) {
        if (!z17) {
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.AppBrandUIUtil", e17, "[CAUGHT CRASH]", new java.lang.Object[0]);
                return;
            }
        }
        window.getDecorView().setSystemUiVisibility(i(window, true));
        window.getDecorView().setOnSystemUiVisibilityChangeListener(new com.tencent.mm.plugin.appbrand.ui.ma(z17, z18, window));
    ...
    public static int i(android.view.Window window, boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.AppBrandUIUtil", "hy: setting ui visibility: %d", java.lang.Integer.valueOf(i17));
        return i17;
    }
