...
public final class SimplifiedLoadingProgressBar extends android.view.View {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SimplifiedLoadingProgressBar(android.content.Context context) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
    }

    private final void setForegroundInsidePadding(boolean z17) {
        try {
            d56.b.h(d56.b.h(this).f("mForegroundInfo")).k("mInsidePadding", java.lang.Boolean.valueOf(z17));
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.e("Luggage.SimplifiedLoadingProgressBar", "setForegroundInsidePadding(" + z17 + ") get exception:" + e17);
        }
    }
    ...
    public void setForeground(android.graphics.drawable.Drawable drawable) {
        ...
        if (kotlin.jvm.internal.o.b(foreground, drawable)) {
            return;
        }
        ...
        if (animatable22 != null) {
            animatable22.registerAnimationCallback(new com.tencent.mm.plugin.appbrand.ui.md(animatable22, this));
        }
        setForegroundInsidePadding(false);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SimplifiedLoadingProgressBar(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        kotlin.jvm.internal.o.g(context, "context");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SimplifiedLoadingProgressBar(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
