...
public final class AppBrandUserProfileAuthorizeUI extends com.tencent.mm.ui.MMActivity {

    /* renamed from: q, reason: collision with root package name */
    public static final /* synthetic */ int f89458q = 0;

    /* renamed from: e, reason: collision with root package name */
    public java.util.List f89460e;
    ...
    public com.tencent.mm.ui.widget.MMSwitchBtn f89464i;

    /* renamed from: m, reason: collision with root package name */
    public com.tencent.mm.ui.widget.dialog.u3 f89465m;

    /* renamed from: n, reason: collision with root package name */
    public com.tencent.mm.plugin.appbrand.jsapi.auth.entity.m0 f89466n;

    /* renamed from: o, reason: collision with root package name */
    public androidx.recyclerview.widget.RecyclerView f89467o;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.List f89459d = new java.util.ArrayList();

    /* renamed from: p, reason: collision with root package name */
    public java.lang.String f89468p = "";

    public final void T6(boolean z17) {
        android.view.View findViewById = findViewById(com.tencent.mm.R.id.oux);
        int i17 = z17 ? 0 : 8;
    ...
    public void finish() {
        ...
        java.util.List list = this.f89460e;
        java.util.List list2 = this.f89459d;
        boolean z18 = true;
        if (list != null && list.size() == ((java.util.ArrayList) list2).size()) {
            ...
            while (it.hasNext()) {
                ...
                java.util.List list3 = this.f89460e;
                if (list3 != null) {
        ...
        intent.putExtra("key_result_is_open", this.f89461f);
        intent.putExtra("key_result_selected_user_id", this.f89463h);
        setResult(-1, intent);
        super.finish();
    }
    ...
    public int getLayoutId() {
        return com.tencent.mm.R.layout.f488109he;
    }
    ...
    public void onConfigurationChanged(android.content.res.Configuration newConfig) {
        ...
        com.tencent.mm.plugin.appbrand.jsapi.auth.entity.m0 m0Var = this.f89466n;
        if (m0Var == null) {
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        setBackBtn(new com.tencent.mm.plugin.appbrand.ui.cb(this));
        ...
        this.f89468p = string == null ? "" : string;
        ...
        this.f89461f = booleanValue;
        T6(booleanValue);
        if (mMUserAvatarInfo == null || string == null) {
            com.tencent.mars.xlog.Log.i("AppBrandUserProfileAuthorizeUI", "WxaUserInfoData or appId is null, finish activity");
            finish();
            return;
        }
        this.f89463h = mMUserAvatarInfo.f79467g;
        ...
        mMSwitchBtn.setCheck(this.f89461f);
        mMSwitchBtn.setSwitchListener(new com.tencent.mm.plugin.appbrand.ui.db(this));
        kotlin.jvm.internal.o.f(findViewById, "apply(...)");
        this.f89464i = (com.tencent.mm.ui.widget.MMSwitchBtn) findViewById;
        ...
        this.f89467o = (androidx.recyclerview.widget.RecyclerView) findViewById2;
        com.tencent.mm.plugin.appbrand.jsapi.auth.entity.m0 m0Var = new com.tencent.mm.plugin.appbrand.jsapi.auth.entity.m0(this, mMUserAvatarInfo, "", new com.tencent.mm.plugin.appbrand.ui.fb(this, string));
        this.f89466n = m0Var;
        m0Var.f79526h = new com.tencent.mm.plugin.appbrand.ui.hb(this);
        fl1.r1 r1Var = new fl1.r1(this.f89459d);
        androidx.recyclerview.widget.RecyclerView recyclerView = this.f89467o;
        if (recyclerView == null) {
            kotlin.jvm.internal.o.o("userInfoList");
            throw null;
        }
        recyclerView.setAdapter(r1Var);
        androidx.recyclerview.widget.RecyclerView recyclerView2 = this.f89467o;
        if (recyclerView2 == null) {
            kotlin.jvm.internal.o.o("userInfoList");
            throw null;
        }
        recyclerView2.setLayoutManager(new androidx.recyclerview.widget.LinearLayoutManager(getContext()));
        androidx.recyclerview.widget.RecyclerView recyclerView3 = this.f89467o;
        if (recyclerView3 == null) {
            kotlin.jvm.internal.o.o("userInfoList");
            throw null;
        }
        recyclerView3.setItemAnimator(null);
        r1Var.f263853f = new com.tencent.mm.plugin.appbrand.ui.ib(this);
        r1Var.f263852e = new com.tencent.mm.plugin.appbrand.ui.jb(this);
    }

    @Override // com.tencent.mm.ui.MMActivity, com.tencent.mm.ui.MMFragmentActivity, com.tencent.mm.ui.component.UIComponentActivity, androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, com.tencent.mm.hellhoundlib.activities.HellActivity, android.app.Activity
    public void onDestroy() {
        super.onDestroy();
        com.tencent.mm.ui.widget.dialog.u3 u3Var = this.f89465m;
        if (u3Var != null) {
            u3Var.dismiss();
        }
    }
