...
public final class b implements java.lang.Runnable {
    ...
    public static final com.tencent.mm.plugin.appbrand.menu.devtools.b f85871d = new com.tencent.mm.plugin.appbrand.menu.devtools.b();

    @Override // java.lang.Runnable
    public final void run() {
        of.h hVar;
        com.tencent.mm.plugin.appbrand.utils.a5.a(bm5.f1.a(), android.os.Process.myPid(), true, true);
        int myPid = android.os.Process.myPid();
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6("/proc/" + myPid + "/maps");
        if (r6Var.m() && r6Var.h()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.Luggage.ProcMapsInfo", "doParse for " + myPid);
            java.io.InputStream C = com.tencent.mm.vfs.w6.C(r6Var);
            kotlin.jvm.internal.o.f(C, "openRead(...)");
            java.io.Reader inputStreamReader = new java.io.InputStreamReader(C, r26.c.f368865a);
            ...
            while (true) {
                ...
                if (g17.size() < 5) {
                    ...
                    com.tencent.mars.xlog.Log.e("MicroMsg.Luggage.ProcMapsInfo", "doParse, invalid tokens: ".concat(arrays));
                } else {
                    ...
                    if (f07.size() < 2) {
                        ...
                        com.tencent.mars.xlog.Log.e("MicroMsg.Luggage.ProcMapsInfo", "doParse, invalid addrTokens: ".concat(arrays2));
                    } else {
                        ...
                        if (k17 == null || k18 == null) {
                            ...
                            com.tencent.mars.xlog.Log.e("MicroMsg.Luggage.ProcMapsInfo", "doParse, invalid addrTokens: ".concat(arrays3));
                        } else {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.Luggage.ProcMapsInfo", "doParse, maps can not read");
            hVar = null;
        }
        if (hVar != null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.Luggage.ProcMapsInfo", "free: " + ((of.a) ((jz5.n) hVar.f344831d).getValue()));
            ...
            java.util.Iterator it = ((java.util.Map) ((jz5.n) hVar.f344830c).getValue()).entrySet().iterator();
            int i17 = 0;
            while (it.hasNext()) {
            ...
            sb6.append(arrays4);
            com.tencent.mars.xlog.Log.i("MicroMsg.Luggage.ProcMapsInfo", sb6.toString());
        }
    }
}
