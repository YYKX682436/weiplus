...
public final class a2 implements yz5.q {
    ...
    public final p75.k f83966d;

    /* renamed from: e, reason: collision with root package name */
    public final p75.k f83967e;

    public a2(d95.b0 db6) {
        kotlin.jvm.internal.o.g(db6, "db");
        this.f83966d = db6.z("SELECT COUNT(*) FROM AppBrandWxaPkgManifestRecord WHERE appId LIKE ? AND versionMd5=? ;");
        this.f83967e = db6.z("SELECT COUNT(*) FROM AppBrandWxaPkgManifestRecord WHERE appId LIKE ? AND NewMd5=? ;");
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2, java.lang.Object obj3) {
        ...
        p75.k kVar2 = this.f83966d;
        int i17 = 0;
        if (kVar2 == null || (kVar = this.f83967e) == null) {
            return 0;
        }
