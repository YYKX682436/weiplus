...
public final class o1 implements yz5.p {
    ...
    public final p75.k f84023d;

    public o1(d95.b0 db6) {
        kotlin.jvm.internal.o.g(db6, "db");
        this.f84023d = db6.z("SELECT COUNT(*) FROM AppBrandWxaPkgManifestRecord WHERE appId =? AND version=? ;");
    }
            ...
            for (com.tencent.mm.vfs.x1 x1Var : s17) {
                ...
                if (i17 != -1 && i17 != 0) {
                    ...
                    if (i17 != 0 && i17 != com.tencent.mm.plugin.appbrand.appcache.w8.f76026a) {
                        ...
                        e0Var.bindString(1, "@LibraryAppId");
