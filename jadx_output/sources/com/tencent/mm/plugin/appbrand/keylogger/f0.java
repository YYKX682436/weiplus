...
public final class f0 implements kg1.f {
    ...
    public static final java.text.SimpleDateFormat f84150a = new java.text.SimpleDateFormat("yyyy-MM-dd", java.util.Locale.ENGLISH);

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f84151b = new java.util.HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.String f84152c;
    ...
    */
    public static java.lang.String c() {
        /*
            java.lang.String r0 = com.tencent.mm.plugin.appbrand.keylogger.f0.f84152c
        ...
        L20:
            ...
            goto L3e
        L29:
            java.lang.String r0 = com.tencent.mm.sdk.platformtools.x2.f193072b
        ...
        L3a:
            ...
            goto L3e
        L3c:
            java.lang.String r0 = r0.f68406d
        L3e:
        ...
        L51:
            ...
            com.tencent.mm.plugin.appbrand.keylogger.f0.f84152c = r0
            return r0
        */
    ...
    public static long e(java.lang.String str) {
        ...
        if (split == null || split.length != 3) {
            com.tencent.mars.xlog.Log.w("MicroMsg.DefaultKeyStepLogger", "getTimeFromDateFormatStr invalid date:%s", str);
            return 0L;
        }
        java.util.Calendar calendar = java.util.Calendar.getInstance();
        try {
            calendar.set(com.tencent.mm.sdk.platformtools.t8.P(split[0], 0), com.tencent.mm.sdk.platformtools.t8.P(split[1], 0), com.tencent.mm.sdk.platformtools.t8.P(split[2], 0));
            return calendar.getTimeInMillis();
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.w("MicroMsg.DefaultKeyStepLogger", "getTimeFromDateFormatStr exp:%s", e17);
            return 0L;
        }
    }
    ...
    public java.util.List a(java.lang.String str, long j17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.DefaultKeyStepLogger", "collectLogPathsByProcessAndDate : %s", str);
        for (int i17 = 0; i17 < G.length; i17++) {
            if (G[i17].getName().startsWith(str)) {
    ...
    public void b(java.lang.String str, java.lang.String str2, java.lang.Object... objArr) {
        ((ku5.t0) ku5.t0.f312615d).h(new com.tencent.mm.plugin.appbrand.keylogger.c0(this, str2, objArr, str), "MMTempKeyStepLogger");
    }

    public final java.lang.String d(long j17) {
        java.util.Map map = f84151b;
        ...
        java.lang.String format = java.lang.String.format("%s%s/", c(), f84150a.format(java.lang.Long.valueOf(j17)));
        com.tencent.mm.vfs.w6.u(format);
