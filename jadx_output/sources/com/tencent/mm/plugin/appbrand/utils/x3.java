...
public abstract class x3 {
    ...
    public static java.util.Map a(int i17, java.lang.Object obj) {
        ...
        for (java.lang.reflect.Field field : obj.getClass().getDeclaredFields()) {
            ...
            if (i17 == 1 && !com.tencent.mm.sdk.platformtools.t8.K0(name)) {
            ...
            if (!obj2.getClass().isPrimitive()) {
                if (!((java.util.IdentityHashMap) f90618a).containsKey(obj2.getClass())) {
                    z17 = false;
                }
            }
            if (!z17) {
        ...
        nf.f.c(hashMap);
        com.tencent.mars.xlog.Log.i("MicroMsg.ObjToMapUtil", new org.json.JSONObject(hashMap).toString());
        return hashMap;
    }
}
