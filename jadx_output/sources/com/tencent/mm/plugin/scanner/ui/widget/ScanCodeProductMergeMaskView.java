...
@kotlin.Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0007\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003:\u0001#B\u001b\b\u0016\u0012\u0006\u0010\u001c\u001a\u00020\u001b\u0012\b\u0010\u001e\u001a\u0004\u0018\u00010\u001d¢\u0006\u0004\b\u001f\u0010 B#\b\u0016\u0012\u0006\u0010\u001c\u001a\u00020\u001b\u0012\b\u0010\u001e\u001a\u0004\u0018\u00010\u001d\u0012\u0006\u0010!\u001a\u00020\u0006¢\u0006\u0004\b\u001f\u0010\"J\b\u0010\u0005\u001a\u00020\u0004H\u0002J\b\u0010\u0007\u001a\u00020\u0006H\u0014J\u0006\u0010\t\u001a\u00020\bJ\u000e\u0010\r\u001a\u00020\f2\u0006\u0010\u000b\u001a\u00020\nJ\u000e\u0010\u0010\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u000eJ\u0010\u0010\u0012\u001a\u00020\f2\u0006\u0010\u0011\u001a\u00020\u0006H\u0016J\u0010\u0010\u0015\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u0013H\u0016J\b\u0010\u0016\u001a\u00020\u0013H\u0016J\u0010\u0010\u0017\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u0013H\u0016J\b\u0010\u0018\u001a\u00020\u0013H\u0016J\b\u0010\u0019\u001a\u00020\u0013H\u0016J\u0006\u0010\u001a\u001a\u00020\u0006¨\u0006$"}, d2 = {"Lcom/tencent/mm/plugin/scanner/ui/widget/ScanCodeProductMergeMaskView;", "Lcom/tencent/mm/plugin/scanner/ui/widget/ScanCodeMaskView;", "Luy3/s;", "Luy3/u;", "Landroid/graphics/Point;", "getPreviewImageSize", "", "getLayoutId", "Ld04/j;", "getScanProductView", "Ld04/h;", "scanProductCallBack", "Ljz5/f0;", "setScanProductCallBack", "Ld04/i;", com.google.android.gms.common.internal.ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "setScanProductOnItemClickListener", "bottomHeight", "setBottomExtraHeight", "", "translationY", "setBackgroundTransY", "getBackgroundTransY", "setMarkViewTransY", "getMarkViewTransY", "getMarkViewHeight", "getQrCodeButtonHeight", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attributeSet", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "defAttr", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "d04/f0", "plugin-scan_release"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes13.dex */
public final class ScanCodeProductMergeMaskView extends com.tencent.mm.plugin.scanner.ui.widget.ScanCodeMaskView implements uy3.s, uy3.u {

    /* renamed from: a2, reason: collision with root package name */
    public static final /* synthetic */ int f159698a2 = 0;
    ...
    public boolean W1;
    public int X1;
    public com.tencent.mm.ui.widget.dialog.u3 Y1;
    public android.os.Vibrator Z1;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ScanCodeProductMergeMaskView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    private final android.graphics.Point getPreviewImageSize() {
        ...
        if (bitmap != null) {
            ...
            if (!bitmap.isRecycled()) {
                try {
                    kotlin.jvm.internal.o.d(this.V1);
                    kotlin.jvm.internal.o.d(this.V1);
                    ...
                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanCodeProductMergeMaskView", e17, "getPreviewImageSize exception", new java.lang.Object[0]);
    ...
    public final void L(android.graphics.Bitmap bitmap) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ScanCodeProductMergeMaskView", "setPreviewBitmap width: %d, height: %d", java.lang.Integer.valueOf(bitmap.getWidth()), java.lang.Integer.valueOf(bitmap.getHeight()));
        new d04.k0(this, bitmap, false).invoke();
    }
    ...
    public int getLayoutId() {
        return com.tencent.mm.R.layout.eia;
    }
    ...
    public final int getQrCodeButtonHeight() {
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ScanCodeProductMergeMaskView", e17, "getQrCodeButtonHeight", new java.lang.Object[0]);
            return 0;
        }
    }

    public final d04.j getScanProductView() {
        d04.j jVar = this.N1;
        if (jVar != null) {
            return jVar;
        }
    ...
    public void i(android.view.View view) {
        ...
        if (view instanceof android.view.TextureView) {
            if (getMScanSource() == 3) {
                ((ku5.t0) ku5.t0.f312615d).g(new d04.v0(this, (android.view.TextureView) view));
            }
        }
    }
    ...
    */
    ...
    public void o(java.lang.Object data, com.tencent.mm.plugin.scanner.view.w0 w0Var) {
        ...
        sz3.w0 w0Var2 = f0Var.f225412a;
        boolean z17 = f0Var.f225413b;
        if (!(this.X1 == 1)) {
        ...
        android.graphics.RectF rectF = w0Var2.f414140k;
        if (rectF != null) {
            ...
            if (getMScanSource() == 3) {
                ...
                android.graphics.Point previewImageSize = getPreviewImageSize();
                pointF = new android.graphics.PointF(((getMeasuredWidth() - previewImageSize.x) / 2) + (previewImageSize.x * f17), ((getMeasuredHeight() - previewImageSize.y) / 2) + (previewImageSize.y * f18));
            }
            android.widget.ImageView imageView = this.M1;
            if (imageView == null) {
                kotlin.jvm.internal.o.o("successMarkView");
            ...
            imageView.setImageResource(com.tencent.mm.R.raw.scan_success_mark_dot);
        ...
        ((ku5.t0) ku5.t0.f312615d).g(new d04.o0(this));
    ...
    public final void setScanProductCallBack(d04.h scanProductCallBack) {
        kotlin.jvm.internal.o.g(scanProductCallBack, "scanProductCallBack");
        d04.j jVar = this.N1;
        if (jVar != null) {
            jVar.setScanProductCallBack(new d04.r0(scanProductCallBack, this));
        } else {
            kotlin.jvm.internal.o.o("scanProductListView");
            throw null;
        }
    ...
    public final void setScanProductOnItemClickListener(d04.i listener) {
        kotlin.jvm.internal.o.g(listener, "listener");
        d04.j jVar = this.N1;
        if (jVar != null) {
            jVar.setScanProductOnItemClickListener(listener);
        } else {
            kotlin.jvm.internal.o.o("scanProductListView");
            throw null;
        }
    ...
    public void t(boolean z17, android.content.DialogInterface.OnCancelListener onCancelListener) {
        if (z17) {
            com.tencent.mm.ui.widget.dialog.u3 u3Var = this.Y1;
            if (u3Var != null) {
                u3Var.dismiss();
            }
            this.Y1 = db5.e1.Q(getContext(), "", getResources().getString(com.tencent.mm.R.string.i_q), false, true, onCancelListener);
            return;
        }
        com.tencent.mm.ui.widget.dialog.u3 u3Var2 = this.Y1;
        if (u3Var2 != null) {
            u3Var2.dismiss();
        }
    }
    ...
    public void z(android.view.View view) {
        ...
        super.z(view);
        android.view.View findViewById = view.findViewById(com.tencent.mm.R.id.l3s);
        kotlin.jvm.internal.o.f(findViewById, "findViewById(...)");
        this.J1 = (android.widget.ImageView) findViewById;
        android.view.View findViewById2 = view.findViewById(com.tencent.mm.R.id.l3r);
        kotlin.jvm.internal.o.f(findViewById2, "findViewById(...)");
        this.L1 = (android.widget.ImageView) findViewById2;
        android.view.View findViewById3 = view.findViewById(com.tencent.mm.R.id.jcb);
        kotlin.jvm.internal.o.f(findViewById3, "findViewById(...)");
        this.I1 = findViewById3;
        android.view.View findViewById4 = view.findViewById(com.tencent.mm.R.id.f486407l44);
        kotlin.jvm.internal.o.f(findViewById4, "findViewById(...)");
        this.K1 = (android.widget.ImageView) findViewById4;
        android.view.View findViewById5 = view.findViewById(com.tencent.mm.R.id.f486733ma3);
        kotlin.jvm.internal.o.f(findViewById5, "findViewById(...)");
        this.M1 = (android.widget.ImageView) findViewById5;
        android.view.KeyEvent.Callback findViewById6 = view.findViewById(com.tencent.mm.R.id.m_v);
    ...
    public ScanCodeProductMergeMaskView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
