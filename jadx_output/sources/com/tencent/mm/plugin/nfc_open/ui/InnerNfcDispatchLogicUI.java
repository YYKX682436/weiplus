...
public final class InnerNfcDispatchLogicUI extends com.tencent.mm.plugin.nfc_open.ui.TransparentUI {
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        if (intent == null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.Nfc.InnerNfcDispatchLogicUI", "onCreate, intent is null");
            finish();
            return;
        }
        java.util.Queue queue = bo3.e.f23024a;
        java.util.Iterator it = ((java.util.PriorityQueue) bo3.e.f23024a).iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            bo3.c cVar = (bo3.c) it.next();
            com.tencent.mars.xlog.Log.i("MicroMsg.Nfc.NfcDispatchLogic", "doDispatch, dispatch to processor: " + cVar.getName());
            if (cVar.a(this, intent)) {
                com.tencent.mars.xlog.Log.i("MicroMsg.Nfc.NfcDispatchLogic", "doDispatch, processor: " + cVar.getName() + " processed");
                break;
            }
        }
        finish();
