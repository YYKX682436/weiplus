...
public abstract class a1 {
    ...
    public static final java.util.HashMap f183889a = new java.util.HashMap();
    ...
    public static android.graphics.Bitmap a(java.lang.String str) {
        ...
        java.util.HashMap hashMap = f183889a;
        ...
        if (createBitmap != createScaledBitmap) {
            com.tencent.mars.xlog.Log.i("MicroMsg.WebView.RemoteUtil", "bitmap recycle %s", createBitmap.toString());
    ...
    public static void b(com.tencent.mm.plugin.webview.stub.v0 v0Var, int i17, java.lang.Object... objArr) {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.w("MicroMsg.WebView.RemoteUtil", "kvReport, ex = " + e17.getMessage());
        }
    }
    ...
    public static long d(java.lang.String str, long j17) {
        ...
        try {
            return android.graphics.Color.parseColor(str) & io.flutter.embedding.android.KeyboardMap.kValueMask;
        } catch (java.lang.Exception unused) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WebView.RemoteUtil", "Failed to parse color: %s", str);
            return j17;
        }
    }

    public static boolean e(android.os.Bundle bundle, java.lang.String str, java.lang.String str2, com.tencent.mm.plugin.webview.stub.z0 z0Var, java.lang.Runnable runnable) {
        if (z0Var == null) {
            if (runnable != null) {
                runnable.run();
            }
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.WebView.RemoteUtil", e17, "startUIWithWebViewUI, exp, pluginName %s, pluginEntry %s", str, str2);
            return false;
        } catch (java.lang.Exception e18) {
            if (runnable != null) {
                runnable.run();
            }
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.WebView.RemoteUtil", e18, "startUIWithWebViewUI, exp, pluginName %s, pluginEntry %s", str, str2);
            return false;
        }
    }
}
