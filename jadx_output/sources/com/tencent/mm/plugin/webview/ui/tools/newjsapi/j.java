...
public final class j extends qw4.a {
    ...
    public static final com.tencent.mm.plugin.webview.ui.tools.newjsapi.j f186264d = new com.tencent.mm.plugin.webview.ui.tools.newjsapi.j();
    ...
    public boolean a(nw4.k env, nw4.y2 msg) {
        ...
        if (z17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiAppBindGroup.", "url is null");
            gVar.e(msg.f341013c, "bindGroup:fail", null);
            return true;
        }
        ...
        if (str == null || str.length() == 0) {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiAppBindGroup.", "appId is null");
            gVar.e(msg.f341013c, "bindGroup:fail", null);
            return true;
        }
        ...
        i3Var.f436713e = str4;
        i3Var.f436714f = str5;
        ((hn.s) ((vg3.k3) i95.n0.c(vg3.k3.class))).Ai(env.f340860a, i3Var, new com.tencent.mm.plugin.webview.ui.tools.newjsapi.i(str4, env, msg));
        return true;
    }
    ...
    public java.lang.String c() {
        return com.tencent.mm.plugin.appbrand.jsapi.s3.NAME;
    }
}
