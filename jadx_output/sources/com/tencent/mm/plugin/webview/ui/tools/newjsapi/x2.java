...
public final class x2 extends qw4.a {
    ...
    public static final com.tencent.mm.plugin.webview.ui.tools.newjsapi.x2 f186650d = new com.tencent.mm.plugin.webview.ui.tools.newjsapi.x2();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:126:0x0302, code lost:
        ...
        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.JsApiRequestScanPOSPay", r0, "getRawUrl", new java.lang.Object[0]);
     */
    ...
    */
    public boolean a(nw4.k r23, nw4.y2 r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.webview.ui.tools.newjsapi.x2.a(nw4.k, nw4.y2):boolean");
    }
    ...
    public java.lang.String c() {
        return com.tencent.mm.plugin.appbrand.jsapi.pay.d2.NAME;
    }

    public final void e(nw4.k env, nw4.y2 msg, int i17, int i18, android.content.Intent intent) {
        kotlin.jvm.internal.o.g(env, "env");
        kotlin.jvm.internal.o.g(msg, "msg");
        com.tencent.mars.xlog.Log.i("MicroMsg.JsApiRequestScanPOSPay", "mmActivityResult requestCode: %d, resultCode: %d", java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
        if (!com.tencent.mm.sdk.platformtools.t8.D0(com.tencent.mm.plugin.appbrand.jsapi.pay.d2.NAME, msg.f341019i)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiRequestScanPOSPay", "request pay, wrong function");
            return;
        }
        ...
        if (i18 == -1) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiRequestScanPOSPay", "closePage: %s", java.lang.Integer.valueOf(intExtra2));
            if (intExtra2 == 1) {
                try {
        ...
        if (i18 != 5) {
            ...
            gVar.e(msg.f341013c, msg.f341019i + ":cancel", hashMap2);
            return;
        }
        ...
        if (intent != null) {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiRequestScanPOSPay", "hy: pay jsapi failed. errCode: %d, errMsg: %s", java.lang.Integer.valueOf(intExtra4), str2);
        }
