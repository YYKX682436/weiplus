...
public class f9 implements java.lang.Runnable {
    ...
    public final /* synthetic */ int f184177d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.os.Bundle f184178e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.webview.ui.tools.u7 f184179f;

    public f9(com.tencent.mm.plugin.webview.ui.tools.u7 u7Var, int i17, android.os.Bundle bundle) {
        this.f184179f = u7Var;
        this.f184177d = i17;
        this.f184178e = bundle;
    }

    @Override // java.lang.Runnable
    public void run() {
        com.tencent.mm.plugin.webview.ui.tools.u7 u7Var = this.f184179f;
        if (u7Var.f186929e.get() != null) {
            ...
            if (i17 == 3003 || i17 == 3004) {
                ...
                android.os.Bundle bundle = this.f184178e;
                if (bundle == null) {
                    com.tencent.mars.xlog.Log.w("MicroMsg.WebViewStubCallbackAIDLStub", "setMenuItemsVisible data is null.");
                    return;
                }
                java.util.ArrayList<java.lang.String> stringArrayList = bundle.getStringArrayList("menu_item_list");
                if (stringArrayList == null || stringArrayList.size() == 0) {
                    com.tencent.mars.xlog.Log.w("MicroMsg.WebViewStubCallbackAIDLStub", "setMenuItemsVisible menuItems is null or nil.");
                    return;
                }
            ...
            android.util.SparseBooleanArray sparseBooleanArray = (android.util.SparseBooleanArray) ((java.util.HashMap) ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2.f184045b).get(url);
            switch (i17) {
                case 3001:
                case 3003:
                    if (sparseBooleanArray == null) {
                        sparseBooleanArray = new android.util.SparseBooleanArray();
                        ((java.util.HashMap) ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2.f184045b).put(url, sparseBooleanArray);
                        ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2.B(url, u7Var.j());
                    }
                    java.util.Iterator it = hashSet.iterator();
                    while (it.hasNext()) {
                        int j17 = com.tencent.mm.sdk.platformtools.t8.j1((java.lang.Integer) ((java.util.HashMap) ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2.f184046c).get(it.next()), -1);
                        if (j17 >= 0) {
                            sparseBooleanArray.put(j17, true);
                        }
                    }
                    com.tencent.mm.plugin.webview.ui.tools.c6 c6Var = ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2;
                    if (c6Var.C()) {
                        c6Var.g0();
                        return;
                    }
                ...
                case 3004:
                    if (sparseBooleanArray != null) {
                        ...
                        while (it6.hasNext()) {
                            int j18 = com.tencent.mm.sdk.platformtools.t8.j1((java.lang.Integer) ((java.util.HashMap) ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2.f184046c).get(it6.next()), -1);
                            if (j18 >= 0) {
                                sparseBooleanArray.delete(j18);
                            }
                        }
                        com.tencent.mm.plugin.webview.ui.tools.c6 c6Var2 = ((com.tencent.mm.plugin.webview.ui.tools.WebViewUI) weakReference.get()).f183849q2;
                        if (c6Var2.C()) {
                            c6Var2.g0();
                            return;
                        }
