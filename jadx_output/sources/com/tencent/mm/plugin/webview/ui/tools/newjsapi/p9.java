...
public final class p9 extends qw4.a {
    ...
    public static final com.tencent.mm.plugin.webview.ui.tools.newjsapi.p9 f186434d = new com.tencent.mm.plugin.webview.ui.tools.newjsapi.p9();
    ...
    public final void B(android.content.Context context) {
        ((com.tencent.mm.plugin.appbrand.app.t2) ((com.tencent.mm.plugin.appbrand.service.k6) i95.n0.c(com.tencent.mm.plugin.appbrand.service.k6.class))).wi(context, 16, false);
    }
    ...
    public final void F(android.content.Context context) {
        if (!(bm5.o1.f22719a.h(new com.tencent.mm.repairer.config.global.RepairerConfigAddFriendVerifyRecordToCloud()) == 1)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "goToPageNewfriendsUISuffix, [AddFriendVerifyRecordToCloud] goto FMessageConversationUI (old)");
            j45.l.j(context, "subapp", ".ui.friend.FMessageConversationUI", new android.content.Intent(), null);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "goToPageNewfriendsUISuffix, [AddFriendVerifyRecordToCloud] goto AddFriendVerifyRecordUI (new)");
            android.content.Intent intent = new android.content.Intent();
            lk5.s.e(intent, true);
    ...
    public final void S(android.content.Context context) {
        ...
        if (!z17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "goToPageTimelinePublishSuffix, enable = " + z17);
        } else {
            android.content.Intent intent = new android.content.Intent();
    ...
    public final boolean Y(java.lang.String str, boolean z17, android.os.Bundle bundle) {
        ...
        boolean z18;
        try {
            android.content.Context b17 = com.tencent.mm.sdk.platformtools.x2.b();
            kotlin.jvm.internal.o.f(b17, "getContext(...)");
            android.net.Uri parse = android.net.Uri.parse(str);
            if (z17) {
                str2 = str != null ? str : "";
                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "handlePageUrl pagePath:".concat(str2));
            } else {
                java.lang.String scheme = parse.getScheme();
                str2 = parse.getHost() + parse.getPath();
                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "handlePageUrl scheme:" + scheme + " pagePath:" + str2 + " query:" + parse.getQuery());
            }
            if (r26.i0.p(str2, "page/wesport", true)) {
                ...
                if (c01.z1.x()) {
                    ...
                    j45.l.i(b17, com.google.android.gms.common.Scopes.PROFILE, ".ui.ContactInfoUI", new android.content.Intent().putExtra("Contact_User", "masssendapp"));
                }
                ...
                ((h45.q) i95.n0.c(h45.q.class)).startWalletSecuritySetting(b17, new android.content.Intent());
                ...
                if (com.tencent.mm.sdk.platformtools.f9.DiscoveryNearby.j(b17)) {
                    j45.l.h(b17, "nearby", ".ui.NearbyFriendsUI");
                } else {
                    com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "PAGE_NEARBY, disable.");
                    Z(b17);
                }
                ...
                com.tencent.mm.sdk.platformtools.a9.a();
                if (yp5.a.f464409a.a()) {
                    ...
                    com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "PAGE_TENCENTNEWS, disable.");
                    Z(b17);
                }
            } else if (r26.i0.p(str2, "page/SubscribeAccount", true)) {
                if (com.tencent.mm.sdk.platformtools.f9.HomeServiceOa.j(b17)) {
                    ...
                    if (z40.e.l4() && ((y40.i0) z40.e.get()).Di()) {
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "PAGE_SUBSCRIBEACCOUNT, disable.");
                        Z(b17);
                    }
                } else {
                    com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "PAGE_SUBSCRIBEACCOUNT, disable.");
                ...
                if (r26.i0.p(str2, "page/BaseScan", true)) {
                    ...
                    com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "PAGE_PAGE_BASESCAN, disable.");
                    ...
                    ((h45.q) i95.n0.c(h45.q.class)).startWalletBalanceRechargeUIUseCase(b17);
                } else if (r26.i0.p(str2, "page/ZeroMoney", true)) {
                    ((h45.q) i95.n0.c(h45.q.class)).startWalletBalanceEntryUseCase(b17);
                } else if (r26.i0.p(str2, "page/ZeroMoneyUse", true)) {
                    ((h45.q) i95.n0.c(h45.q.class)).startLqtDetailUseCaseInMMProcess(b17);
                } else if (r26.i0.p(str2, "page/Wallet", true)) {
                    ((h45.q) i95.n0.c(h45.q.class)).startUseCase("walletUseCase", com.tencent.kinda.gen.ITransmitKvData.create(), com.tencent.mm.plugin.webview.ui.tools.newjsapi.j9.f186287a);
                } else {
                    if (r26.i0.p(str2, "page/FetchMoney", true)) {
                        ((h45.q) i95.n0.c(h45.q.class)).startWalletBalanceFetchPageUseCase(b17, null);
                    } else if (r26.i0.p(str2, "page/BankCard", true)) {
                        ((h45.q) i95.n0.c(h45.q.class)).startUseCase("bankCard", com.tencent.kinda.gen.ITransmitKvData.create(), com.tencent.mm.plugin.webview.ui.tools.newjsapi.k9.f186317a);
                    } else if (r26.i0.p(str2, "page/HoneyPay", true)) {
                        ((h45.q) i95.n0.c(h45.q.class)).startUseCase("HoneyPayPayerUseCase", com.tencent.kinda.gen.ITransmitKvData.create(), com.tencent.mm.plugin.webview.ui.tools.newjsapi.l9.f186343a);
                        ...
                        if (r26.i0.p(str2, "page/darkmode", true)) {
                            ...
                            ((yn1.h4) ((mv.w) i95.n0.c(mv.w.class))).cj(b17, mv.a.f331472h);
                            ...
                            boolean z19 = shouldShowAppBrandEntranceInFindMoreEvent.f54780h.f7576a;
                            boolean z27 = ((uh4.c0) i95.n0.c(uh4.c0.class)).isTeenMode() && ((uh4.c0) i95.n0.c(uh4.c0.class)).G8() == 2;
                            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "shouldShowMiniProgram %s, isTeenModeAndNotAccessRight:%s", java.lang.Boolean.valueOf(z19), java.lang.Boolean.valueOf(z27));
                            if (z19 && !z27) {
                            ...
                            kotlin.jvm.internal.o.e(k17, "null cannot be cast to non-null type kotlin.String");
                            if (u11.c.f((java.lang.String) k17)) {
                                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "european user");
                                z28 = false;
                                z18 = false;
                            } else {
                                z18 = true;
                            ...
                            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "isInExperiment %s ,openLook %s, isTeenMode:%s", java.lang.Boolean.valueOf(z18), java.lang.Boolean.valueOf(z28), java.lang.Boolean.valueOf(isTeenMode));
                            if (z18 && z28 && !isTeenMode) {
                                j(b17);
                            } else {
                                y(b17);
                            }
                            ...
                            ((h45.q) i95.n0.c(h45.q.class)).startUseCase("paySettingsUseCase", com.tencent.kinda.gen.ITransmitKvData.create(), com.tencent.mm.plugin.webview.ui.tools.newjsapi.m9.f186364a);
                            ...
                            if (b17 instanceof android.app.Activity) {
                                ...
                                bundle4.putString("realname_verify_process_jump_activity", com.tencent.mm.plugin.finder.storage.t70.f127590a.U0() ? ".ui.FinderHomeAffinityUI" : ".ui.FinderHomeUI");
                                ...
                                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "context is no activity.");
                                android.content.Intent intent14 = new android.content.Intent();
                                ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).getClass();
                                intent14.setClassName(b17, com.tencent.mm.plugin.finder.storage.t70.f127590a.U0() ? "com.tencent.mm.plugin.finder.ui.FinderHomeAffinityUI" : "com.tencent.mm.plugin.finder.ui.FinderHomeUI");
                            ...
                            intent15.putExtra("kintent_hint", b17.getResources().getString(com.tencent.mm.R.string.itc));
                            ...
                            if (yp5.a.f464409a.a()) {
                                ...
                                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "PAGE_SETTINGSCAREMODEINTRO, disable.");
                                Z(b17);
                            }
                            ...
                            if (!r26.i0.p(str2, "page/chatbot", true)) {
                                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "handlePageUrl not exist path");
                                return false;
                            }
                            java.lang.String string = bundle != null ? bundle.getString(dm.i4.COL_USERNAME) : null;
                            if (string != null) {
                                com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "[+] openWeiXinPage handled. username:".concat(string));
                                ...
                                java.lang.String a17 = com.tencent.mm.ui.l2.a(string);
                                ((vh0.f3) n1Var).bj(context, string, 5, a17, new com.tencent.mm.plugin.webview.ui.tools.newjsapi.n9(a17, n1Var, context, string));
                            } else {
                                com.tencent.mars.xlog.Log.e("MicroMsg.JsApiOpenWeiXinPage", "[-] openWeiXinPage tries to open yuanbao without target username.");
                            }
                        }
                    }
                }
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.JsApiOpenWeiXinPage", th6, "handlePageErr!!", new java.lang.Object[0]);
            return false;
        }
    }
    ...
    public final void Z(android.content.Context context) {
        ...
        u1Var.g(context.getString(com.tencent.mm.R.string.f492672hf3));
        u1Var.m(com.tencent.mm.R.string.f490454vi);
        u1Var.l(com.tencent.mm.plugin.webview.ui.tools.newjsapi.o9.f186412a);
        u1Var.q(false);
    }
    ...
    public boolean a(nw4.k env, nw4.y2 msg) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "OpenWeiXinPage:" + msg.f340790a);
        java.util.Map params = msg.f340790a;
        kotlin.jvm.internal.o.f(params, "params");
        jz5.l[] lVarArr = (jz5.l[]) kz5.e1.v(params).toArray(new jz5.l[0]);
        com.tencent.mm.ipcinvoker.extension.l.a(com.tencent.mm.sdk.platformtools.w9.f193053a, j3.f.a((jz5.l[]) java.util.Arrays.copyOf(lVarArr, lVarArr.length)), com.tencent.mm.plugin.webview.ui.tools.newjsapi.h9.class, new com.tencent.mm.plugin.webview.ui.tools.newjsapi.i9(env, msg));
        return true;
    }
    ...
    public final void e(android.content.Context context) {
        c01.s7 a17 = c01.t7.a(context.getString(com.tencent.mm.R.string.fsb));
        android.content.Intent intent = new android.content.Intent();
    ...
    public final void g(android.content.Context context) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "safe center url %s", d17);
    ...
    public final void h(android.content.Context context) {
        ...
        java.lang.String string = context.getString(com.tencent.mm.R.string.iz_, java.lang.Integer.valueOf(h17), java.lang.Integer.valueOf(com.tencent.mm.sdk.platformtools.t8.q1((java.lang.Integer) l17)));
        ...
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra(com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_TITLE, context.getString(com.tencent.mm.R.string.iz9));
    ...
    public final void j(android.content.Context context) {
        if (!com.tencent.mm.plugin.websearch.l2.h(1)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiOpenWeiXinPage", "fts h5 template not avail");
            return;
        }
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(optString)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.JsApiOpenWeiXinPage", "empty query");
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "look one look clikced");
    ...
    public final void n(android.content.Context context) {
        ...
        if (!Ui) {
            com.tencent.mars.xlog.Log.i("MicroMsg.JsApiOpenWeiXinPage", "goToPageBrandServiceSuffix, enable = " + Ui);
        } else {
            android.content.Intent intent = new android.content.Intent();
    ...
    public final void o(android.content.Context context) {
        ...
        nxVar.f7466a = "gh_4ee148a6ecaa@app";
        nxVar.f7473h = "wxdfda2588e999a42d";
        nxVar.f7467b = "pages/index/index.html";
        nxVar.f7469d = com.tencent.liteav.TXLiteAVCode.WARNING_MICROPHONE_DEVICE_EMPTY;
    ...
    public final void r(android.content.Context context) {
        ...
        cf.b.a(intent);
        intent.putExtra("titile", context.getString(com.tencent.mm.R.string.f489933fw));
        intent.putExtra("list_type", 0);
        intent.addFlags(268435456);
        com.tencent.mm.ui.contact.i5.e();
        intent.putExtra("list_attr", com.tencent.mm.ui.contact.i5.g(com.tencent.mm.ui.contact.i5.f206783d, 256, 512));
