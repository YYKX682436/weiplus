package com.tencent.mm.plugin.ting.playapp.radio_channel.floatball;
...
public final class TingRadioChannelFloatBallView extends android.widget.FrameLayout implements bl4.a {

    /* renamed from: i, reason: collision with root package name */
    public static final /* synthetic */ int f174730i = 0;

    /* renamed from: d, reason: collision with root package name */
    public com.tencent.mm.ui.widget.MMRoundCornerImageView f174731d;

    /* renamed from: e, reason: collision with root package name */
    public android.view.View.OnClickListener f174732e;

    /* renamed from: f, reason: collision with root package name */
    public bl4.b f174733f;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.String f174734g;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    public final jz5.g waveSize;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public TingRadioChannelFloatBallView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void a(bl4.b bVar) {
        ...
        bl4.b bVar2 = this.f174733f;
        boolean a17 = bVar2 != null ? bVar2.a(bVar) : false;
        this.f174733f = bVar;
        java.lang.String str2 = bVar != null ? bVar.f21735d : null;
        boolean z17 = true;
        if (str2 == null || str2.length() == 0) {
            com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView = this.f174731d;
            ...
            com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView2 = this.f174731d;
        ...
        if (bVar3 != null) {
            ...
            if (z17) {
                ...
                if (kotlin.jvm.internal.o.b(str3, this.f174734g)) {
                    com.tencent.mars.xlog.Log.w("MicroMsg.TingRadioChannelFloatBallView", "updateFloatBallCover the same ignore");
                    return;
                }
                this.f174734g = str3;
                ((dl4.m0) ((ff0.t) i95.n0.c(ff0.t.class))).aj(str3, this.f174731d, z18 ? ((dl4.m0) ((ff0.t) i95.n0.c(ff0.t.class))).Ui() : 0, new zl4.h(this));
            }
        }
    }
    ...
    public void setOnCoverClickListener(android.view.View.OnClickListener onClickListener) {
        this.f174732e = onClickListener;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TingRadioChannelFloatBallView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        ...
        this.f174731d = mMRoundCornerImageView;
        if (mMRoundCornerImageView != null) {
            mMRoundCornerImageView.setVisibility(0);
        }
        com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView2 = this.f174731d;
        if (mMRoundCornerImageView2 != null) {
            mMRoundCornerImageView2.setOnClickListener(new zl4.f(this));
        }
        ...
        com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView3 = this.f174731d;
