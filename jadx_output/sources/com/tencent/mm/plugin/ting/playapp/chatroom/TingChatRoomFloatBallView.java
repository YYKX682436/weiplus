package com.tencent.mm.plugin.ting.playapp.chatroom;
...
public final class TingChatRoomFloatBallView extends android.widget.FrameLayout implements bl4.a {

    /* renamed from: i, reason: collision with root package name */
    public static final /* synthetic */ int f174712i = 0;

    /* renamed from: d, reason: collision with root package name */
    public com.tencent.mm.ui.widget.MMRoundCornerImageView f174713d;

    /* renamed from: e, reason: collision with root package name */
    public android.view.View.OnClickListener f174714e;

    /* renamed from: f, reason: collision with root package name */
    public bl4.b f174715f;

    /* renamed from: g, reason: collision with root package name */
    public java.lang.String f174716g;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    public final jz5.g waveSize;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public TingChatRoomFloatBallView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void a(bl4.b bVar) {
        ...
        bl4.b bVar2 = this.f174715f;
        boolean a17 = bVar2 != null ? bVar2.a(bVar) : false;
        this.f174715f = bVar;
        java.lang.String str2 = bVar != null ? bVar.f21735d : null;
        boolean z17 = true;
        if (str2 == null || str2.length() == 0) {
            com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView = this.f174713d;
            ...
            com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView2 = this.f174713d;
        ...
        bl4.b bVar3 = this.f174715f;
        if (bVar3 == null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.TingChatRoomFloatBallView", "updateFloatBallCover resetCover for default");
            com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView3 = this.f174713d;
            if (mMRoundCornerImageView3 != null) {
                mMRoundCornerImageView3.setImageResource(com.tencent.mm.R.drawable.d9y);
            }
            this.f174716g = "";
            return;
        }
        ...
        boolean z18 = !a17;
        com.tencent.mars.xlog.Log.i("MicroMsg.TingChatRoomFloatBallView", "updateFloatBallCover resetCover: " + z18 + ", %s", str3);
        ...
        if (z17) {
            ...
            if (kotlin.jvm.internal.o.b(str3, this.f174716g)) {
                com.tencent.mars.xlog.Log.w("MicroMsg.TingChatRoomFloatBallView", "updateFloatBallCover the same ignore");
                return;
            }
            this.f174716g = str3;
            ((dl4.m0) ((ff0.t) i95.n0.c(ff0.t.class))).aj(str3, this.f174713d, z18 ? ((dl4.m0) ((ff0.t) i95.n0.c(ff0.t.class))).Ui() : 0, new vl4.o(this));
        }
    }

    @Override // bl4.a
    public void setOnCoverClickListener(android.view.View.OnClickListener onClickListener) {
        this.f174714e = onClickListener;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TingChatRoomFloatBallView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        ...
        this.f174713d = mMRoundCornerImageView;
        if (mMRoundCornerImageView != null) {
            mMRoundCornerImageView.setVisibility(0);
        }
        com.tencent.mm.ui.widget.MMRoundCornerImageView mMRoundCornerImageView2 = this.f174713d;
        if (mMRoundCornerImageView2 != null) {
            mMRoundCornerImageView2.setOnClickListener(new vl4.m(this));
        }
