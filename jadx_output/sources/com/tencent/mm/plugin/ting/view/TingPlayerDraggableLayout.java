...
public abstract class TingPlayerDraggableLayout extends android.widget.FrameLayout implements android.view.GestureDetector.OnGestureListener {
    ...
    public TingPlayerDraggableLayout(android.content.Context context) {
        super(context);
    ...
    public final float getBorderBottom() {
        return this.edgeAttached == 2 ? this.originalTranslationY : this.originalTranslationY + this.f174823e;
    }
    ...
    public final float getBorderLeft() {
        return this.edgeAttached == 1 ? this.originalTranslationX - this.f174823e : this.originalTranslationX;
    }
    ...
    public final float getBorderPeek() {
        ...
        if (i17 == -2 || i17 == -1) {
            ...
            if (i17 == 1 || i17 == 2) {
                return getBorderHigh() - this.f174824f;
            }
            borderLow = getBorderLow();
            f17 = this.f174824f;
        }
    ...
    public final float getBorderRight() {
        return this.edgeAttached == 1 ? this.originalTranslationX : this.originalTranslationX + this.f174823e;
    }

    public final float getBorderTop() {
        return this.edgeAttached == 2 ? this.originalTranslationY - this.f174823e : this.originalTranslationY;
    }

    public final boolean getCanPeek() {
        return !(this.f174824f == -1.0f);
    }
    ...
    public final float getF174823e() {
        return this.f174823e;
    }
    ...
    public final float getF174824f() {
        return this.f174824f;
    }

    public final float getTranslation() {
        if (a()) {
            android.view.View view = this.f174822d;
            if (view != null) {
        ...
        android.view.View view2 = this.f174822d;
        if (view2 != null) {
    ...
    public final void j(int i17, boolean z17) {
        com.tencent.mars.xlog.Log.i("Finder.DrawerLayout", "settle isSettling = " + this.isSettling + ", dir=" + i17 + ", isTotally=" + z17);
        ...
        com.tencent.mars.xlog.Log.i("Finder.DrawerLayout", "settle percent = " + translation);
        ...
        translationX.setDuration(300L).setInterpolator(interpolator).setUpdateListener(new lm4.j(this)).setListener(new lm4.k(this, i17)).start();
    ...
    public boolean onFling(android.view.MotionEvent motionEvent, android.view.MotionEvent e27, float f17, float f18) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.DrawerLayout", "onFling vx = " + f17 + ", vy = " + f18);
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent motionEvent) {
        ...
        if (h(motionEvent)) {
            ...
            yj0.a.d(gestureDetector, arrayList.toArray(), "com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "onInterceptTouchEvent", "(Landroid/view/MotionEvent;)Z", "android/view/GestureDetector_EXEC_", "onTouchEvent", "(Landroid/view/MotionEvent;)Z");
            boolean onTouchEvent = gestureDetector.onTouchEvent((android.view.MotionEvent) arrayList.get(0));
            yj0.a.g(gestureDetector, onTouchEvent, "com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "onInterceptTouchEvent", "(Landroid/view/MotionEvent;)Z", "android/view/GestureDetector_EXEC_", "onTouchEvent", "(Landroid/view/MotionEvent;)Z");
            if (onTouchEvent) {
                return true;
            }
        }
        boolean onInterceptTouchEvent = super.onInterceptTouchEvent(motionEvent);
        com.tencent.mars.xlog.Log.i("Finder.DrawerLayout", "onInterceptTouchEvent e.action=" + motionEvent.getAction() + " ret=" + onInterceptTouchEvent);
    ...
    public void onLongPress(android.view.MotionEvent e17) {
        ...
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "android/view/GestureDetector$OnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V", this, array);
        kotlin.jvm.internal.o.g(e17, "e");
        yj0.a.h(this, "com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "android/view/GestureDetector$OnGestureListener", if1.m.NAME, "(Landroid/view/MotionEvent;)V");
    }
    ...
    public boolean onScroll(android.view.MotionEvent motionEvent, android.view.MotionEvent e27, float f17, float f18) {
        ...
        if (g(z17, f19) && a() == z17) {
            ...
            com.tencent.mars.xlog.Log.i("Finder.DrawerLayout", "onScroll isHorizontal = " + z17 + " exactlyMoved = " + translation);
    ...
    public boolean onSingleTapUp(android.view.MotionEvent e17) {
        ...
        java.lang.Object[] array = arrayList.toArray();
        arrayList.clear();
        yj0.a.b("com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "android/view/GestureDetector$OnGestureListener", "onSingleTapUp", "(Landroid/view/MotionEvent;)Z", this, array);
        kotlin.jvm.internal.o.g(e17, "e");
        yj0.a.i(false, this, "com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "android/view/GestureDetector$OnGestureListener", "onSingleTapUp", "(Landroid/view/MotionEvent;)Z");
        return false;
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent e17) {
        ...
        arrayList.add(e17);
        java.util.Collections.reverse(arrayList);
        yj0.a.d(gestureDetector, arrayList.toArray(), "com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "onTouchEvent", "(Landroid/view/MotionEvent;)Z", "android/view/GestureDetector_EXEC_", "onTouchEvent", "(Landroid/view/MotionEvent;)Z");
        boolean onTouchEvent = gestureDetector.onTouchEvent((android.view.MotionEvent) arrayList.get(0));
        yj0.a.g(gestureDetector, onTouchEvent, "com/tencent/mm/plugin/ting/view/TingPlayerDraggableLayout", "onTouchEvent", "(Landroid/view/MotionEvent;)Z", "android/view/GestureDetector_EXEC_", "onTouchEvent", "(Landroid/view/MotionEvent;)Z");
    ...
    public final void setContentView(android.view.View view) {
        ...
        if (!kotlin.jvm.internal.o.b(view.getParent(), this)) {
            ...
            com.tencent.mars.xlog.Log.e("Finder.DrawerLayout", "setContentView contentView should be child of FinderDrawerLayout");
        }
        this.f174822d = view;
    }
    ...
    public void setExpandHeight(float f17) {
        ...
        int i17 = this.edgeAttached;
        if (i17 == -2) {
            android.view.View view3 = this.f174822d;
            if (view3 == null) {
                kotlin.jvm.internal.o.o("contentView");
                throw null;
            }
            view3.setTranslationY(view3.getTranslationY() - this.f174823e);
        } else if (i17 == -1) {
            android.view.View view4 = this.f174822d;
            if (view4 == null) {
                kotlin.jvm.internal.o.o("contentView");
                throw null;
            }
            view4.setTranslationX(view4.getTranslationX() - this.f174823e);
        } else if (i17 == 1) {
            android.view.View view5 = this.f174822d;
            if (view5 == null) {
                kotlin.jvm.internal.o.o("contentView");
                throw null;
            }
            view5.setTranslationX(view5.getTranslationX() + this.f174823e);
        } else if (i17 == 2) {
            android.view.View view6 = this.f174822d;
            if (view6 == null) {
                kotlin.jvm.internal.o.o("contentView");
                throw null;
            }
            view6.setTranslationY(view6.getTranslationY() + this.f174823e);
        }
        android.view.View view7 = this.f174822d;
        if (view7 == null) {
            kotlin.jvm.internal.o.o("contentView");
            throw null;
        }
        this.originalTranslationX = view7.getTranslationX();
        android.view.View view8 = this.f174822d;
        if (view8 == null) {
            kotlin.jvm.internal.o.o("contentView");
            throw null;
        }
    ...
    public final void setTran(float f17) {
        ...
        kotlin.jvm.internal.o.d(translationX);
        translationX.setDuration(200L).setInterpolator(loadInterpolator).setUpdateListener(new lm4.h(this, f17)).setListener(new lm4.i(this)).start();
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TingPlayerDraggableLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TingPlayerDraggableLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
