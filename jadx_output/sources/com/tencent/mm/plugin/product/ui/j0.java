...
public class j0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.product.ui.MallProductSelectAmountView f153307d;

    public j0(com.tencent.mm.plugin.product.ui.MallProductSelectAmountView mallProductSelectAmountView) {
        this.f153307d = mallProductSelectAmountView;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.product.ui.MallProductSelectAmountView mallProductSelectAmountView = this.f153307d;
        int i17 = mallProductSelectAmountView.f153213m;
        if (i17 - 1 < mallProductSelectAmountView.f153212i) {
            com.tencent.mm.plugin.product.ui.k0 k0Var = mallProductSelectAmountView.f153214n;
            if (k0Var != null) {
                ((com.tencent.mm.plugin.product.ui.n0) k0Var).b(i17, 2);
            }
