...
public final class FinderLiveVoiceInputLayoutImpl extends com.tencent.mm.plugin.finder.voice.FinderLiveVoiceInputLayout {
    ...
    public FinderLiveVoiceInputLayoutImpl(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        kotlin.jvm.internal.o.g(context, "context");
    }

    @Override // com.tencent.mm.plugin.finder.voice.FinderLiveVoiceInputLayout
    ...
    public final void g(boolean z17, boolean z18) {
        ...
        if (getCurrentState() != getSTATE_PREPARED()) {
            ...
            if (getLongClickListener() != null) {
                ...
                kotlin.jvm.internal.o.d(longClickListener);
                com.tencent.mm.plugin.finder.voice.FinderLiveVoiceInputPanel.b(((iy2.a0) longClickListener).f295861a, com.tencent.mm.R.string.nw_);
                return;
            }
            return;
        }
        ...
        if (!j35.u.d(context, "android.permission.RECORD_AUDIO", true)) {
            ...
            com.tencent.mars.xlog.Log.i(this.f136744d, "context = " + activity);
            return;
        }
        ...
        if (eVar != null) {
            ...
            com.tencent.mm.plugin.finder.voice.FinderLiveVoiceInputPanel finderLiveVoiceInputPanel = ((iy2.z) eVar).f295915a;
            finderLiveVoiceInputPanel.getClass();
            java.lang.Object[] objArr = {java.lang.Long.valueOf(currentTimeMillis)};
            java.lang.String str = finderLiveVoiceInputPanel.f136763d;
            com.tencent.mars.xlog.Log.i(str, "VoiceDetectListener onDetectStart time %s", objArr);
            finderLiveVoiceInputPanel.f136776t = false;
            finderLiveVoiceInputPanel.f136777u = true;
            finderLiveVoiceInputPanel.f136778v = true;
            finderLiveVoiceInputPanel.e();
            finderLiveVoiceInputPanel.f136777u = false;
            iy2.c cVar = finderLiveVoiceInputPanel.f136781y;
            if (cVar != null) {
                cVar.f295892i = 3;
            }
            if (cVar != null) {
                cVar.a(finderLiveVoiceInputPanel.f136771o);
            }
            com.tencent.mars.xlog.Log.i(str, "pauseMusic");
            ...
            android.content.Context context3 = finderLiveVoiceInputPanel.f136773q;
            ...
            android.widget.TextView textView = finderLiveVoiceInputPanel.f136767h;
            if (textView != null) {
                textView.setVisibility(8);
            }
            android.view.View view = finderLiveVoiceInputPanel.f136766g;
            if (view != null) {
            ...
            if (mMEditText3 != null) {
                mMEditText3.setHint(finderLiveVoiceInputPanel.getResources().getString(com.tencent.mm.R.string.nw8));
            }
            iy2.r rVar = finderLiveVoiceInputPanel.f136770n;
            if (rVar != null) {
                ((com.tencent.mm.plugin.finder.live.plugin.wr) rVar).a(true);
            }
            android.view.View view2 = finderLiveVoiceInputPanel.f136769m;
            if (view2 != null) {
        ...
        com.tencent.mm.sdk.platformtools.b4 b4Var = this.amplitudeTimer;
        ...
        this.f136746f = sceneVoiceInputAddrProxy;
        if (sceneVoiceInputAddrProxy != null) {
            sceneVoiceInputAddrProxy.init(this.f136749i, 8, new iy2.h(this));
        }
        z21.e eVar2 = this.f136746f;
        if (eVar2 != null) {
            eVar2.start();
        }
    }
    ...
    public FinderLiveVoiceInputLayoutImpl(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        ...
        this.F = pVar;
        android.view.View inflate = android.view.View.inflate(context, com.tencent.mm.R.layout.ece, this);
        ...
        android.view.View findViewById2 = inflate.findViewById(com.tencent.mm.R.id.tqw);
