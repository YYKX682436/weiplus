...
public final class c8 implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ android.text.Spannable f102067d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.widget.TextView f102068e;

    public c8(android.text.Spannable spannable, android.widget.TextView textView) {
        this.f102067d = spannable;
        this.f102068e = textView;
    }
    ...
    public final boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        android.widget.TextView textView2 = this.f102068e;
        boolean z17 = false;
        android.text.Spannable spannable = this.f102067d;
        ...
        if (action == 0 || action == 1) {
            ...
            kotlin.jvm.internal.o.d(clickableSpanArr2);
        ...
        com.tencent.mars.xlog.Log.i("Finder.FinderUIUtil", "touch " + motionEvent.getX() + ", " + motionEvent.getY() + ", ret:" + z17);
