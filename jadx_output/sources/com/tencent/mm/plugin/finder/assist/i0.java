...
public final class i0 extends i95.w implements c61.ub {
    public static void Ak(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, android.content.Intent intent, boolean z17, boolean z18, int i17, java.lang.Object obj) {
        ...
        com.tencent.mm.plugin.finder.assist.c0 c0Var = new com.tencent.mm.plugin.finder.assist.c0(i0Var, context, intent2, z19, z27);
        ((vd0.j2) q1Var).getClass();
        v24.o0.h(context, 34359738368L, null, c0Var, 3);
    }

    public static void Qj(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.app.Activity context, android.content.Intent intent, r45.kb4 localContent, r45.fn2 fn2Var, boolean z17, boolean z18, int i17, java.lang.Object obj) {
        r45.fn2 fn2Var2 = (i17 & 8) != 0 ? null : fn2Var;
        boolean z19 = (i17 & 16) != 0 ? false : z17;
        boolean z27 = (i17 & 32) != 0 ? false : z18;
        i0Var.getClass();
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(localContent, "localContent");
        android.content.Intent intent2 = intent == null ? new android.content.Intent() : intent;
        intent2.setClass(context, com.tencent.mm.plugin.finder.ui.FinderMediaPreviewUI.class);
        intent2.putExtra("media_list_", localContent.toByteArray());
        intent2.putExtra("media_list_count", localContent.getList(0).size());
        intent2.putExtra("ref_feed_info", fn2Var2 != null ? fn2Var2.toByteArray() : null);
    ...
    public static void Rk(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, android.content.Intent intent, boolean z17, int i17, java.lang.Object obj) {
        if ((i17 & 4) != 0) {
            z17 = false;
        }
        i0Var.getClass();
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.activity.music.ui.FinderMusicTopicUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
    ...
    public static void bk(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, android.content.Intent intent, java.lang.Integer num, int i17, java.lang.Object obj) {
        if ((i17 & 2) != 0) {
            intent = null;
        }
        if ((i17 & 4) != 0) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderNewManagementUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public static void gl(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, bw5.o50 categoryItem, bw5.ar0 enterScene, boolean z17, boolean z18, int i17, java.lang.Object obj) {
        ...
        bw5.ar0 b17 = com.tencent.mm.plugin.finder.storage.cd0.f126580a.b(context, enterScene);
        ...
        il4.e eVar = new il4.e(null, 0, b17.f25422d, false, null, null, 0, 0, false, false, null, null, null, null, null, null, false, false, null, null, false, null, false, null, false, 33554427, null);
        ...
        if (z19) {
            com.tencent.mm.plugin.finder.report.k0.f125092a.a(context, "TingCategory");
        }
    }

    public static void pj(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, android.content.Intent intent, int i17, java.lang.Object obj) {
        if ((i17 & 2) != 0) {
            intent = null;
        }
        i0Var.getClass();
        ...
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderConversationUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public static /* synthetic */ com.tencent.mm.plugin.finder.view.e3 sl(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, java.lang.String str, android.content.Intent intent, int i17, yz5.l lVar, int i18, java.lang.Object obj) {
        return i0Var.pl(context, str, (i18 & 4) != 0 ? null : intent, i17, (i18 & 16) != 0 ? null : lVar);
    }

    public static final boolean wi(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, int i17, int i18, java.lang.String str) {
        i0Var.getClass();
        com.tencent.mars.xlog.Log.e("Finder.ActivityRouter", "checkShowCgiErrorAlter: errType = " + i17 + ", errCode = " + i18 + ", errMsg = " + str);
        if (i17 == 0 && i18 == 0) {
            return false;
        }
    ...
    public static void wk(com.tencent.mm.plugin.finder.assist.i0 i0Var, android.content.Context context, android.content.Intent intent, int i17, java.lang.Object obj) {
        if ((i17 & 2) != 0) {
            intent = null;
        }
        i0Var.getClass();
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderTeenModeTipsUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Ai(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderAccountManagent.class);
    ...
    public void Aj(android.content.Context context, android.content.Intent intent) {
        kotlin.jvm.internal.o.g(context, "context");
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "enterFinderGameLiveFinishUI");
        if (intent == null) {
            intent = new android.content.Intent();
        }
        android.content.Intent intent2 = !(context instanceof android.app.Activity) ? intent : null;
        ...
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.D).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Bi(android.content.Context context, android.content.Intent intent, boolean z17) {
        ...
        if (!z17) {
            ...
            com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent2);
        }
        android.content.Intent intent3 = !(context instanceof android.app.Activity) ? intent2 : null;
        if (intent3 != null) {
            intent3.addFlags(268435456);
        }
        intent2.setClass(context, com.tencent.mm.plugin.finder.activity.FinderActivityProfileUI.class);
        int i17 = com.tencent.mm.plugin.finder.activity.FinderActivityProfileUI.f101738v;
        ...
        jz5.g gVar = u92.e.f425824h;
        java.util.Iterator it = ((java.util.List) ((jz5.n) u92.e.f425824h).getValue()).iterator();
        while (it.hasNext()) {
            int intValue = ((java.lang.Number) it.next()).intValue();
            int i18 = com.tencent.mm.plugin.finder.activity.FinderActivityProfileUI.f101738v;
            r45.a34 a34Var2 = a34Var;
            java.lang.String b17 = ey2.o2.b(ey2.p2.f257467g, longExtra, stringExtra, null, intValue, 1, 4, null);
            com.tencent.mars.xlog.Log.i("Finder.ActivityProfileUI", "preloadTab cacheKey:" + b17);
            ir2.g0.a(ir2.a1.f294089r, new ba2.a(7, longExtra, java.lang.Long.valueOf(longExtra2), stringExtra2, stringExtra, 1, null, null, stringExtra3, b17, 0, a34Var2), null, null, 6, null);
            str2 = str2;
            str = str;
            a34Var = a34Var2;
        }
        ...
        int i19 = com.tencent.mm.plugin.finder.activity.FinderActivityProfileUI.f101738v;
        ...
        androidx.lifecycle.c1 a17 = pf5.u.f353936a.e(c61.l7.class).a(ir2.y1.class);
        ...
        kotlinx.coroutines.l.d(y1Var.getLifecycleScope(), null, null, new s92.e(longExtra3, str5, longExtra4, a34Var3, null), 3, null);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent2);
        java.util.Collections.reverse(arrayList);
    ...
    public void Bj(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderImagePreviewUI.class);
        android.content.Intent intent2 = !(context instanceof android.app.Activity) ? intent : null;
        if (intent2 != null) {
            intent2.addFlags(268435456);
        }
    ...
    public void Cj(android.content.Context context, android.content.Intent intent, int i17, java.util.List topicList) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderInteractionSearchUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.util.ArrayList arrayList2 = new java.util.ArrayList(kz5.d0.q(topicList, 10));
        java.util.Iterator it = topicList.iterator();
        while (it.hasNext()) {
            arrayList2.add(new com.tencent.mm.plugin.finder.feed.model.FinderParcelTopicInfo((r45.r03) it.next()));
        }
    ...
    public final void Ck(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderFriendLikeTimelineUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Di(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3, int i17, java.lang.String str4, java.lang.String str5, java.lang.String str6, int i18, java.lang.String str7) {
        ...
        l0Var.getClass();
        if (l0Var.f102303a.containsKey(str5 != null ? str5 : "")) {
            intent.putExtra("async_callback_param", str5);
        }
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "enterActivityProfileUI :" + str + " eventName:" + str2 + " entryScene:" + i17);
        java.lang.String str8 = com.tencent.mm.plugin.finder.report.s0.f125339a;
    ...
    public final void Dj(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderLikedFeedUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Dk(android.app.Activity context, android.content.Intent intent, int i17, int i18, byte[] bArr, int i19) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderGalleryTimelineUI.class);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
    ...
    public final void Ej(android.content.Context context, dk2.x4 config, java.lang.String contextId, android.content.Intent intent) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "[enterFinderLiveAnchorUI] " + config);
        ...
        if (contextId.length() == 0) {
            ...
            h0Var.f310123d = str;
            com.tencent.mars.xlog.Log.i("Finder.LiveJumpChecker", "goAnchorUIWithCheck locContextId:" + ((java.lang.String) h0Var.f310123d));
        }
        ...
        if (r9Var != null) {
            ...
            if (!zl2.r4.f473956g && com.tencent.mm.ui.bk.A()) {
                p8Var.invoke();
                r9Var = null;
            }
            ...
            if (a17 != null) {
                ...
                if (a17 != null) {
                    a17.h(context, config, (java.lang.String) h0Var.f310123d, "", intent);
                }
            }
        }
    }
    ...
    public void Ek(android.content.Context context) {
        ...
        if (context instanceof com.tencent.mm.ui.MMActivity) {
            ...
            intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderSettingGameRankUI.class);
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(intent);
            java.util.Collections.reverse(arrayList);
    ...
    public void Fj(android.content.Intent intent, android.content.Context context, long j17, long j18, java.lang.String nonceId, java.lang.String str, java.lang.String contextId, java.lang.String str2, java.lang.String str3) {
        ...
        x4Var.f234319m = (h17 == null || (liveInfo = h17.getLiveInfo()) == null) ? -1 : liveInfo.getInteger(21);
        ((com.tencent.mm.feature.finder.live.v4) ((s40.w0) i95.n0.c(s40.w0.class))).Bk(j18);
    ...
    */
    public void Fk(android.content.Context r6, android.content.Intent r7, int r8, java.lang.String r9) {
        ...
        Lc:
            ...
            com.tencent.mm.storage.u3 r1 = com.tencent.mm.storage.u3.USERINFO_MY_FINDER_LIVE_TASK_GUIDE_FLAG_BOOLEAN_SYNC
            r2 = 0
        ...
        L84:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.Fk(android.content.Context, android.content.Intent, int, java.lang.String):void");
    }
    ...
    public void Gk(android.content.Context context, android.content.Intent intent, java.lang.String authorFinderUsername) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "#enterMemberAreaUI authorFinderUsername=".concat(authorFinderUsername));
        if (ol(context, intent)) {
            return;
        }
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.member.ui.FinderMemberAreaUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Hj(android.content.Context context, android.content.Intent intent, int i17) {
        ...
        if (context instanceof com.tencent.mm.ui.MMActivity) {
            ...
            ((com.tencent.mm.ui.MMActivity) context).startActivityForResult(intent, i17);
        }
    }
    ...
    public final void Hk(android.content.Context context, android.content.Intent intent, java.lang.String authorFinderUsername, int i17, int i18) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.member.ui.FinderMemberBanUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Ij(android.app.Activity activity, android.content.Intent intent, int i17, r45.n01 info, java.lang.Integer num) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(activity, (java.lang.Class) ((jz5.n) jz2.x0.M).getValue());
    ...
    public final void Ik(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.member.ui.FinderMemberFanListUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Jj(android.app.Activity context, android.content.Intent intent, int i17) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.f302761h).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
        arrayList.add(intent);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void Jk(android.content.Context r17, com.tencent.mm.plugin.finder.storage.FinderItem r18, int r19, java.lang.String r20) {
        /*
            Method dump skipped, instructions count: 302
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.Jk(android.content.Context, com.tencent.mm.plugin.finder.storage.FinderItem, int, java.lang.String):void");
    }
    ...
    */
    public void Kj(android.content.Context r24, r45.j01 r25, android.content.Intent r26, boolean r27) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.Kj(android.content.Context, r45.j01, android.content.Intent, boolean):void");
    }
    ...
    public void Kk(android.content.Context context, android.content.Intent intent, java.lang.String authorFinderUsername) {
        ...
        kotlin.jvm.internal.o.g(intent, "intent");
        kotlin.jvm.internal.o.g(authorFinderUsername, "authorFinderUsername");
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "#enterMemberPreviewUI authorFinderUsername=".concat(authorFinderUsername));
        if (ol(context, intent)) {
            return;
        }
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.member.ui.FinderMemberPreviewUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Lj(android.app.Activity activity, android.content.Intent intent, int i17) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(activity, (java.lang.Class) ((jz5.n) jz2.x0.K).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
        arrayList.add(intent);
        ...
        activity.overridePendingTransition(com.tencent.mm.R.anim.f477886ea, com.tencent.mm.R.anim.f477882e6);
    }
    ...
    public void Lk(android.content.Context context, android.content.Intent i17, java.lang.String authorFinderUsername, int i18) {
        ...
        i17.setClass(context, com.tencent.mm.plugin.finder.ui.FinderMemberQAPostUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(i17);
        java.util.Collections.reverse(arrayList);
    ...
    */
    public boolean Mj(android.content.Context r5, java.lang.String r6) {
        /*
            ...
            r3 = 1
            if (r2 != r3) goto L52
            java.lang.String r2 = r0.f324988b
            if (r2 == 0) goto L2a
            int r2 = r2.length()
            if (r2 <= 0) goto L25
            r2 = r3
        ...
        L2b:
            ...
            l40.e r2 = (l40.e) r2
            java.lang.String r0 = r0.f324988b
            k40.f r2 = (k40.f) r2
        ...
        L52:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.Mj(android.content.Context, java.lang.String):boolean");
    }
    ...
    public final void Mk(android.content.Context context, android.content.Intent intent, int i17, int i18, java.lang.String str, java.lang.Integer num, java.lang.Integer num2) {
        ...
        android.content.Context context2 = ((context instanceof android.app.Activity) || (Ui = ((com.tencent.mm.plugin.finder.service.l3) ((zy2.c9) i95.n0.c(zy2.c9.class))).Ui()) == null) ? context : Ui;
    ...
    public final void Ni(android.content.Context context, android.content.Intent intent) {
        ...
        if (((com.tencent.mm.plugin.finder.storage.mj0) ((zy2.qb) i95.n0.c(zy2.qb.class))).isTeenMode()) {
            ...
            com.tencent.mars.xlog.Log.w("Finder.ActivityRouter", "青少年模式只看关注时，禁止进入专辑.");
            return;
        }
        if (intent == null) {
            intent = new android.content.Intent();
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderAlbumTimelineUI.class);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Nj(android.app.Activity context, android.content.Intent intent) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.L).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Nk(android.content.Context context, android.content.Intent intent, java.lang.String authorFinderUsername, int i17, int i18) {
        ...
        android.content.Intent intent2 = intent == null ? new android.content.Intent() : intent;
        r45.qt2 qt2Var = null;
        if ((context instanceof androidx.appcompat.app.AppCompatActivity ? context : null) != null) {
        ...
        eo2.d c17 = eo2.f.f255565a.c(authorFinderUsername);
        if (c17 != null) {
            Mk(context, intent2, i17, i18, authorFinderUsername, java.lang.Integer.valueOf(c17.f255560b), java.lang.Integer.valueOf(c17.f255561c));
            return;
        }
        ho2.c cVar = new ho2.c(qt2Var, authorFinderUsername, 0, 4, null);
        az2.j.u(cVar, context, null, 0L, 6, null);
        pm0.v.T(cVar.l(), new com.tencent.mm.plugin.finder.assist.e0(this, context, intent2, i17, i18, authorFinderUsername));
    }
    ...
    public void Oj(android.content.Context context, android.content.Intent intent, boolean z17) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.f302773t).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Ok(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderModifyNameUI.class);
        xy2.c.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Pj(android.app.Activity context, android.content.Intent intent) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.f302775v).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Pk(android.content.Context context, android.content.Intent intent) {
        ...
        if (((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).Ri()) {
            ...
            try {
                int i17 = com.tencent.mm.plugin.mv.ui.MusicMvMainUI.f150860h;
                intent.setClass(context, com.tencent.mm.plugin.mv.ui.MusicMvMainUI.class);
                java.util.ArrayList arrayList = new java.util.ArrayList();
                arrayList.add(intent);
                java.util.Collections.reverse(arrayList);
                ...
                com.tencent.mars.xlog.Log.e("Finder.ActivityRouter", "enterMusicMvMainUI : " + e17);
            }
        }
    }
    ...
    public final void Qk(android.content.Context context, android.content.Intent intent) {
        ...
        try {
            int i17 = com.tencent.mm.plugin.mv.ui.MusicMvRouterUI.f150889g;
            ...
            com.tencent.mars.xlog.Log.e("Finder.ActivityRouter", "enterMusicMvMakerUI : " + e17);
        }
    }
    ...
    public final void Ri(android.app.Activity context, android.content.Intent intent, int i17) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.BizProfileTimelineUI.class);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
    ...
    public final void Rj(android.content.Context context, android.content.Intent intent) {
        ...
        intent2.setClass(context, com.tencent.mm.plugin.finder.ui.FinderFinderMsgUI.class);
        ...
        bq.q0.f23514u.clear();
        int[] iArr = com.tencent.mm.plugin.finder.ui.FinderFinderMsgUI.f128577w;
        ...
        while (i17 < length) {
            ...
            java.lang.Object obj = com.tencent.mm.plugin.finder.ui.FinderFinderMsgUI.f128575u.get(i18);
            kotlin.jvm.internal.o.f(obj, "get(...)");
            ir2.g0.a(g0Var, new com.tencent.mm.plugin.finder.presenter.contract.message.FinderMessageCgiSource(1, i19, (int[]) obj, xy2.c.e(context), 1), null, null, 6, null);
            i17++;
            i18 = i27;
        }
    ...
    public final void Sj(android.content.Context context, android.content.Intent intent, long j17, java.lang.String nonceId, r45.kb4 kb4Var, java.lang.Integer num) {
        ...
        intent.putExtra("key_local_media", kb4Var != null ? kb4Var.toByteArray() : null);
        android.content.Intent intent2 = context instanceof android.app.Activity ? null : intent;
        if (intent2 != null) {
            intent2.addFlags(268435456);
        }
        intent.setClass(context, com.tencent.mm.plugin.finder.member.ui.FinderMemberQAVideoUI.class);
        if (num == null) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(intent);
            java.util.Collections.reverse(arrayList);
    ...
    public final void Sk(android.content.Context context, nr2.m paidCollectionData, boolean z17, java.lang.String str) {
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(paidCollectionData, "paidCollectionData");
        android.content.Intent intent = new android.content.Intent();
        com.tencent.mm.plugin.finder.viewmodel.component.ny nyVar = context instanceof com.tencent.mm.ui.MMFragmentActivity ? (com.tencent.mm.plugin.finder.viewmodel.component.ny) pf5.z.f353948a.a((androidx.appcompat.app.AppCompatActivity) context).a(com.tencent.mm.plugin.finder.viewmodel.component.ny.class) : null;
        r45.qt2 V6 = nyVar != null ? nyVar.V6() : null;
        intent.putExtra("collection_ref_comment_scene", V6 != null ? V6.getInteger(5) : 0);
        intent.putExtra("paid_collection_topic_id", paidCollectionData.l());
        intent.putExtra("KEY_FINDER_SELF_FLAG", z17);
        intent.putExtra("paid_collection_info", paidCollectionData.f339268d.toByteArray());
    ...
    public final void Tj(android.content.Context context, android.content.Intent intent, java.lang.String authorFinderUsername, java.lang.String finderMemberTicket, int i17, int i18, java.lang.String str, java.lang.Integer num, java.lang.Integer num2, java.lang.Integer num3, int i19) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.member.ui.FinderMemberTimelineUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Tk(android.content.Context context, android.content.Intent i17, r45.f96 location, int i18) {
        ...
        int i19 = o9Var == zy2.o9.f477516d ? 81 : (serializableExtra2 instanceof la2.a ? (la2.a) serializableExtra2 : null) == la2.a.f317501e ? 303 : 26;
        ...
        if (z17) {
            ((android.app.Activity) context).overridePendingTransition(com.tencent.mm.R.anim.f477876e0, com.tencent.mm.R.anim.f477728p);
        }
    }
    ...
    public void Ui(android.content.Context context, java.lang.String fromUsername, r45.xn1 toUser, int i17, int i18, yz5.a aVar) {
        ...
        if (toUser.getBoolean(10)) {
            db5.t7.makeText(context, com.tencent.mm.R.string.enz, 0).show();
            return;
        }
        com.tencent.mm.protocal.protobuf.FinderContact finderContact = (com.tencent.mm.protocal.protobuf.FinderContact) toUser.getCustom(0);
        if (finderContact == null || (str = finderContact.getUsername()) == null) {
            str = "";
        }
        java.lang.String str2 = str;
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "[enterChattingUIFromLive] fromUsername=" + fromUsername + " toUsername=" + str2 + " scene=" + i17);
        com.tencent.mm.protobuf.g gVar = db2.m4.f228072t;
        db2.m4.f228072t = toUser.getByteString(9);
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).getClass();
        com.tencent.mm.plugin.finder.service.m4 m4Var = com.tencent.mm.plugin.finder.service.m4.f126148a;
        com.tencent.mm.plugin.finder.assist.l lVar = new com.tencent.mm.plugin.finder.assist.l(str2, this, context, aVar, fromUsername, i18);
        if (!(str2.length() == 0)) {
            com.tencent.mm.plugin.finder.service.m4.d(m4Var, context, i17, str2, null, 0L, 0L, false, null, null, null, null, null, null, false, false, false, false, false, null, new com.tencent.mm.plugin.finder.service.i4(lVar), 524280, null);
            return;
        }
        lVar.a("", false, 0, 0, "");
        com.tencent.mars.xlog.Log.e("Finder.SessionInfoService", "[getSessionId] username=" + str2 + " is invalid, just return.");
    }
    ...
    public final void Uj(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderSettingMsgUI.class);
        xy2.c.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Uk(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.activity.poi.flutter.FinderFlutterPOIActivity.class);
        android.content.Intent intent2 = !(context instanceof android.app.Activity) ? intent : null;
        if (intent2 != null) {
            intent2.addFlags(268435456);
        }
        ...
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).yk(context, intent, o9Var == zy2.o9.f477516d ? 81 : (serializableExtra2 instanceof la2.a ? (la2.a) serializableExtra2 : null) == la2.a.f317501e ? 303 : 26, intExtra);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Vi(android.content.Context context, int i17, r45.zy1 toUser, java.lang.String lotteryId, long j17, r45.qt2 qt2Var, boolean z17) {
        ...
        java.lang.String string = toUser.getString(0);
        if (string == null) {
            string = "";
        }
        ...
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).getClass();
        com.tencent.mm.plugin.finder.service.m4 m4Var = com.tencent.mm.plugin.finder.service.m4.f126148a;
        com.tencent.mm.plugin.finder.assist.n nVar = new com.tencent.mm.plugin.finder.assist.n(this, context, qt2Var, i17);
        if (!(str.length() == 0)) {
            com.tencent.mm.plugin.finder.service.m4.d(m4Var, context, i17, str, null, j17, 0L, true, lotteryId, null, java.lang.Integer.valueOf(i18), null, null, null, false, false, false, false, false, null, new com.tencent.mm.plugin.finder.service.d4(nVar), 523560, null);
            return;
        }
        nVar.a("", false, 0, 0, "");
        com.tencent.mars.xlog.Log.e("Finder.SessionInfoService", "[getSessionId] username=" + str + " is invalid, just return.");
    }
    ...
    public final void Vj(android.content.Context context, android.content.Intent intent) {
        ...
        if (dVar.b(ya.a.SEARCH) != 0) {
            db5.e1.y(context, dVar.c(ya.a.SEARCH), "", context.getString(com.tencent.mm.R.string.l_e), null);
            return;
        }
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.search.FinderMixSearchUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Wk(android.app.Activity context, android.content.Intent intent, int i17) {
        ...
        intent.addFlags(67108864);
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPoiRelateListUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
        arrayList.add(intent);
    ...
    public final void Xj(android.content.Context context, android.content.Intent intent) {
        ...
        xy2.c.c(context, intent);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderMsgFeedDetailUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public void Xk(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPoiTimelineUI.class);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Yj(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderMultiTaskRouterUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void Yk(com.tencent.mm.ui.MMActivity activity, android.content.Intent intent, int i17, boolean z17) {
        kotlin.jvm.internal.o.g(activity, "activity");
        if (!z17) {
            if (intent == null) {
                intent = new android.content.Intent();
            }
            intent.setClass(activity, com.tencent.mm.plugin.finder.ui.FinderPostAtUI.class);
        ...
        cVar.d(intent);
        cVar.b(com.tencent.mm.plugin.finder.view.FinderAtHalfScreenDialogFragment.class);
    ...
    */
    public void Zi(android.content.Context r27, java.lang.String r28, int r29, android.content.Intent r30, java.lang.Integer r31, java.lang.Integer r32, java.lang.Integer r33, java.lang.Long r34) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.Zi(android.content.Context, java.lang.String, int, android.content.Intent, java.lang.Integer, java.lang.Integer, java.lang.Integer, java.lang.Long):void");
    }
    ...
    public final void Zj(android.content.Context context, r45.qj2 nativeDramaInfo, long j17, java.lang.String str, boolean z17, java.lang.Integer num, int i17, java.lang.String str2) {
        ...
        android.content.Intent intent = new android.content.Intent();
        intent.setClass(context, com.tencent.mm.plugin.finder.drama.detail.FinderNativeDramaDetailUI.class);
        intent.putExtra("native_drama_id", nativeDramaInfo.getLong(0));
        intent.putExtra("native_drama_info", nativeDramaInfo.toByteArray());
        ...
        if (context instanceof com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI) {
            com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI finderNativeDramaTimelineUI = (com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI) context;
            intent.putExtra("native_drama_enter_object_id", finderNativeDramaTimelineUI.getIntent().getLongExtra("native_drama_enter_object_id", 0L));
            intent.putExtra("native_drama_enter_promotion_comment_scene", finderNativeDramaTimelineUI.getIntent().getIntExtra("native_drama_enter_promotion_comment_scene", -1));
            intent.putExtra("native_drama_enter_dupflag", finderNativeDramaTimelineUI.getIntent().getStringExtra("native_drama_enter_dupflag"));
            intent.putExtra("native_drama_session_buffer", finderNativeDramaTimelineUI.getIntent().getStringExtra("native_drama_session_buffer"));
        } else {
            ...
            java.lang.String ek6 = ((com.tencent.mm.plugin.finder.report.o3) i95.n0.c(com.tencent.mm.plugin.finder.report.o3.class)).ek(j17, str, i17);
            ...
            if (((java.lang.Boolean) ((nb2.a) ((jz5.n) com.tencent.mm.plugin.finder.storage.t70.f127642cd).getValue()).r()).booleanValue()) {
                int i18 = com.tencent.mm.ui.widget.dialog.f4.f211790n;
                com.tencent.mm.ui.widget.dialog.e4 e4Var = new com.tencent.mm.ui.widget.dialog.e4(context);
                e4Var.f211776c = str3;
                e4Var.c();
            }
            com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", str3);
        }
        if (!z17) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(intent);
        ...
        intent.putExtra("key_context_id", ((com.tencent.mm.plugin.finder.viewmodel.component.ny) ((zy2.ra) uVar.b(context).c(zy2.ra.class))).V6().getString(1));
        intent.putExtra("key_click_tab_context_id", ((com.tencent.mm.plugin.finder.viewmodel.component.ny) ((zy2.ra) uVar.b(context).c(zy2.ra.class))).V6().getString(2));
        intent.putExtra("native_drama_drawer_mode", true);
        androidx.lifecycle.c1 a17 = uVar.b(context).a(com.tencent.mm.plugin.finder.drama.detail.y.class);
        kotlin.jvm.internal.o.f(a17, "get(...)");
        com.tencent.mm.plugin.finder.drama.detail.y yVar = (com.tencent.mm.plugin.finder.drama.detail.y) a17;
        ...
        yVar.f105187e = longExtra2;
        if (yVar.f105195p) {
            if (yVar.f105186d != longExtra) {
                yVar.O6();
                ...
                android.widget.FrameLayout frameLayout = yVar.f105190h;
                if (frameLayout != null) {
                    frameLayout.removeAllViews();
                }
                com.tencent.mm.ui.vas.VASCommonFragment b17 = lk5.q0.b("com.tencent.mm.plugin.finder.drama.drawer.FinderNativeDramaDetailNewUI", intent, false, 4, null);
                yVar.f105188f = b17;
                b17.q0(new com.tencent.mm.plugin.finder.drama.detail.w(yVar));
                gx2.q qVar = yVar.f105189g;
                if (qVar != null) {
                    qVar.setContentReachTop(new com.tencent.mm.plugin.finder.drama.detail.x(yVar));
                }
                com.tencent.mm.ui.vas.VASCommonFragment vASCommonFragment = yVar.f105188f;
                if (vASCommonFragment != null) {
                    beginTransaction.k(com.tencent.mm.R.id.tfd, vASCommonFragment, null);
                    beginTransaction.f();
                }
                yVar.f105186d = longExtra;
            } else {
                gx2.q qVar2 = yVar.f105189g;
                if (qVar2 != null) {
                    com.tencent.mm.plugin.finder.view.drawer.FinderDraggableLayout.m(qVar2, false, 1, null);
                }
                com.tencent.mm.ui.vas.VASCommonFragment vASCommonFragment2 = yVar.f105188f;
                if (vASCommonFragment2 != null) {
                    pf5.z zVar = pf5.z.f353948a;
                    ((com.tencent.mm.plugin.finder.drama.drawer.j) zVar.b(vASCommonFragment2).a(com.tencent.mm.plugin.finder.drama.drawer.j.class)).f105255v = longExtra2;
                    com.tencent.mm.plugin.finder.drama.drawer.e0 e0Var = (com.tencent.mm.plugin.finder.drama.drawer.e0) zVar.b(vASCommonFragment2).a(com.tencent.mm.plugin.finder.drama.drawer.e0.class);
                    e0Var.f105229s = intExtra;
                    e0Var.P6(intExtra);
                    androidx.recyclerview.widget.RecyclerView recyclerView = e0Var.f105222i;
                    ...
                    if (!(yVar.getContext() instanceof com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI)) {
                        intent.getLongExtra("native_drama_enter_object_id", 0L);
                        intent.getIntExtra("native_drama_enter_promotion_comment_scene", -1);
                        ((com.tencent.mm.plugin.finder.drama.drawer.e0) zVar.b(vASCommonFragment2).a(com.tencent.mm.plugin.finder.drama.drawer.e0.class)).getClass();
                    }
                }
            }
            vASActivity = null;
        } else if (yVar.f105186d != longExtra) {
            yVar.O6();
            androidx.fragment.app.i2 beginTransaction2 = yVar.getActivity().getSupportFragmentManager().beginTransaction();
            kotlin.jvm.internal.o.f(beginTransaction2, "beginTransaction(...)");
            android.widget.FrameLayout frameLayout2 = yVar.f105190h;
            if (frameLayout2 != null) {
                frameLayout2.removeAllViews();
            }
            com.tencent.mm.ui.vas.VASCommonFragment b18 = lk5.q0.b("com.tencent.mm.plugin.finder.drama.detail.FinderNativeDramaDetailUI", intent, false, 4, null);
            yVar.f105188f = b18;
            b18.q0(new com.tencent.mm.plugin.finder.drama.detail.u(yVar));
            gx2.q qVar3 = yVar.f105189g;
            if (qVar3 != null) {
                qVar3.setContentReachTop(new com.tencent.mm.plugin.finder.drama.detail.v(yVar));
            }
            com.tencent.mm.ui.vas.VASCommonFragment vASCommonFragment3 = yVar.f105188f;
            if (vASCommonFragment3 != null) {
                vASActivity = null;
                beginTransaction2.k(com.tencent.mm.R.id.tfd, vASCommonFragment3, null);
                beginTransaction2.f();
            } else {
                vASActivity = null;
            }
            ...
            vASActivity = null;
            gx2.q qVar4 = yVar.f105189g;
            if (qVar4 != null) {
                com.tencent.mm.plugin.finder.view.drawer.FinderDraggableLayout.m(qVar4, false, 1, null);
            }
            com.tencent.mm.ui.vas.VASCommonFragment vASCommonFragment4 = yVar.f105188f;
            if (vASCommonFragment4 != null) {
                pf5.z zVar2 = pf5.z.f353948a;
                ((com.tencent.mm.plugin.finder.drama.detail.i) zVar2.b(vASCommonFragment4).a(com.tencent.mm.plugin.finder.drama.detail.i.class)).f105162u = longExtra2;
                ((com.tencent.mm.plugin.finder.drama.detail.p) zVar2.b(vASCommonFragment4).a(com.tencent.mm.plugin.finder.drama.detail.p.class)).y7(intExtra);
                if (!(yVar.getContext() instanceof com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI)) {
                    ...
                    for (com.tencent.mm.plugin.finder.ui.fragment.FinderHomeTabFragment fragment : ((com.tencent.mm.plugin.finder.drama.detail.p) zVar2.b(vASCommonFragment4).a(com.tencent.mm.plugin.finder.drama.detail.p.class)).Y6()) {
                        kotlin.jvm.internal.o.g(fragment, "fragment");
                        com.tencent.mm.plugin.finder.drama.detail.c cVar = (com.tencent.mm.plugin.finder.drama.detail.c) pf5.z.f353948a.b(fragment).e(com.tencent.mm.plugin.finder.drama.detail.c.class);
                        if (cVar != null) {
                            cVar.f105135h = longExtra3;
                            cVar.f105136i = intExtra2;
                            cVar.f105137m = stringExtra;
                            cVar.f105138n = stringExtra2;
                        }
                    }
                }
            }
        }
        android.app.Activity context2 = yVar.getContext();
        com.tencent.mm.ui.vas.VASActivity vASActivity2 = context2 instanceof com.tencent.mm.ui.vas.VASActivity ? (com.tencent.mm.ui.vas.VASActivity) context2 : vASActivity;
        if (vASActivity2 == null || (parentActivity = vASActivity2.getParentActivity()) == null) {
            return;
        }
        ...
        com.tencent.mm.plugin.finder.drama.detail.y yVar2 = (com.tencent.mm.plugin.finder.drama.detail.y) zVar3.a((androidx.appcompat.app.AppCompatActivity) parentActivity).e(com.tencent.mm.plugin.finder.drama.detail.y.class);
        if (yVar2 != null) {
            yVar2.f105196q.add(new com.tencent.mm.plugin.finder.drama.detail.t(parentActivity));
        }
    }
    ...
    public final void Zk(android.app.Activity context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPostPlayTimelineUI.class);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void aj(android.content.Context context, java.lang.String sessionId, java.lang.String username, int i17, r45.qt2 qt2Var) {
        ...
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).getClass();
        com.tencent.mm.plugin.finder.service.m4 m4Var = com.tencent.mm.plugin.finder.service.m4.f126148a;
        com.tencent.mm.plugin.finder.assist.r rVar = new com.tencent.mm.plugin.finder.assist.r(this, context, qt2Var);
        if (username.length() == 0) {
            rVar.a("", false, 0, 0, "");
            com.tencent.mars.xlog.Log.e("Finder.SessionInfoService", "[getSessionId] username=" + username + " is invalid, just return.");
            return;
        }
        qb2.x1 J0 = m4Var.e().J0(sessionId);
        java.lang.String str = J0.field_sessionId;
        if (str == null || str.length() == 0) {
            com.tencent.mm.plugin.finder.service.m4.d(m4Var, context, 1, username, null, 0L, 0L, false, null, null, java.lang.Integer.valueOf(i17), null, null, null, false, false, false, false, false, null, new com.tencent.mm.plugin.finder.service.g4(rVar), 523768, null);
            return;
        }
        java.lang.String field_sessionId = J0.field_sessionId;
        kotlin.jvm.internal.o.f(field_sessionId, "field_sessionId");
        zy2.ab.a(m4Var, context, field_sessionId, java.lang.Integer.valueOf(i17), null, null, null, new com.tencent.mm.plugin.finder.service.h4(rVar, J0), 56, null);
    }
    ...
    public final void al(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPostPreviewUI.class);
        xy2.c.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void bj(android.content.Context context, int i17, r45.my0 my0Var) {
        ...
        o3Var.Jk(V6, true, i17, str, string2);
        i95.m c17 = i95.n0.c(c61.yb.class);
        kotlin.jvm.internal.o.f(c17, "getService(...)");
        r45.ac4 ac4Var = new r45.ac4();
        ac4Var.set(1, (com.tencent.mm.protocal.protobuf.FinderJumpInfo) my0Var.getCustom(2));
        ac4Var.set(4, 1);
    ...
    public final void bl(android.app.Activity context, java.lang.String str) {
        kotlin.jvm.internal.o.g(context, "context");
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str) || (context instanceof com.tencent.mm.plugin.finder.ui.FinderHomeUI) || (context instanceof com.tencent.mm.plugin.finder.ui.FinderSelfUI)) {
            yl(context, str);
            return;
        }
        android.content.Intent intent = new android.content.Intent();
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderRealnameVerifyRouteUI.class);
    ...
    public final void ck(android.content.Context context, android.content.Intent intent) {
        ...
        bq.p0 p0Var = bq.q0.f23513t;
        bq.q0.f23514u.clear();
        int[] iArr = com.tencent.mm.plugin.finder.ui.FinderFinderMsgUI.f128576v;
        int length = iArr.length;
        int i17 = 0;
        int i18 = 0;
        while (i17 < length) {
            ...
            int i27 = i18 + 1;
            ir2.g0 g0Var = ir2.a1.f294089r;
            java.lang.Object obj = com.tencent.mm.plugin.finder.ui.FinderFinderMsgUI.f128574t.get(i18);
            kotlin.jvm.internal.o.f(obj, "get(...)");
            ir2.g0.a(g0Var, new com.tencent.mm.plugin.finder.presenter.contract.message.FinderMessageCgiSource(1, i19, (int[]) obj, xy2.c.e(context), 0), null, null, 6, null);
            i17++;
            i18 = i27;
        }
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
    ...
    public final void cl(android.content.Context context, android.content.Intent intent, int i17) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderRelatedTimelineUI.class);
        if (context instanceof android.app.Activity) {
            android.app.Activity activity = (android.app.Activity) context;
            java.util.ArrayList arrayList = new java.util.ArrayList();
            java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
    ...
    public void dk(android.content.Context context, android.content.Intent intent, com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed, r45.do2 paidCollectionInfo, boolean z17) {
        kotlin.jvm.internal.o.g(context, "context");
        ...
        boolean z18 = false;
        if (context instanceof com.tencent.mm.plugin.finder.ui.MMLiveFinderUI) {
            intent2.putExtra("collection_ref_comment_scene", 65);
        } else {
            com.tencent.mm.plugin.finder.viewmodel.component.ny nyVar = context instanceof com.tencent.mm.ui.MMFragmentActivity ? (com.tencent.mm.plugin.finder.viewmodel.component.ny) pf5.z.f353948a.a((androidx.appcompat.app.AppCompatActivity) context).a(com.tencent.mm.plugin.finder.viewmodel.component.ny.class) : null;
            r45.qt2 V6 = nyVar != null ? nyVar.V6() : null;
            intent2.putExtra("collection_ref_comment_scene", V6 != null ? V6.getInteger(5) : 0);
        }
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "enterFinderPayCourseUI %s", pm0.v.u(mVar.l()));
        intent2.putExtra("paid_collection_topic_id", mVar.l());
        intent2.putExtra("paid_collection_feed_id", baseFinderFeed != null ? java.lang.Long.valueOf(baseFinderFeed.getItemId()) : null);
        intent2.putExtra("paid_collection_info", mVar.f339268d.toByteArray());
        intent2.putExtra("paid_collection_username", mVar.o());
        if (!z17) {
            intent2.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPaidCollectionUI.class);
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(intent2);
            java.util.Collections.reverse(arrayList);
        ...
        androidx.lifecycle.c1 a17 = zVar.a((androidx.appcompat.app.AppCompatActivity) context).a(nr2.p.class);
        kotlin.jvm.internal.o.f(a17, "get(...)");
        nr2.p pVar = (nr2.p) a17;
        long longExtra = intent2.getLongExtra("paid_collection_topic_id", 0L);
        if (longExtra == 0) {
            com.tencent.mars.xlog.Log.e("Finder.FinderPayCollectionDrawerUIC", "no id");
            return;
        }
        if (pVar.f339282d == longExtra) {
            gx2.q qVar = pVar.f339284f;
            if (qVar != null) {
        ...
        if (pVar.f339284f == null) {
            android.view.View decorView = pVar.getActivity().getWindow().getDecorView();
            android.view.ViewGroup viewGroup = decorView instanceof android.view.ViewGroup ? (android.view.ViewGroup) decorView : null;
            if (viewGroup != null) {
                android.widget.FrameLayout frameLayout = new android.widget.FrameLayout(pVar.getContext());
                frameLayout.setLayoutParams(new android.widget.FrameLayout.LayoutParams(-1, -1));
                frameLayout.setId(com.tencent.mm.R.id.f484517qf2);
                frameLayout.setBackgroundColor(frameLayout.getContext().getResources().getColor(com.tencent.mm.R.color.a9e));
                pVar.f339285g = frameLayout;
                float k17 = (i65.a.k(pVar.getContext()) + com.tencent.mm.ui.bk.p(pVar.getContext())) * kx2.a.f313278a.a(pVar.getContext());
                gx2.a aVar = new gx2.a();
                aVar.f277337c = k17;
                aVar.f277338d = new hx2.g(pVar.getContext(), 0, 0, 0, false, false, 62, null);
                android.widget.FrameLayout frameLayout2 = pVar.f339285g;
                kotlin.jvm.internal.o.d(frameLayout2);
                aVar.f277339e = new hx2.c(frameLayout2);
                aVar.f277340f = new hx2.b(pVar.getContext(), z18, 2, iVar);
                pVar.f339284f = aVar.b(viewGroup);
            }
        }
        androidx.fragment.app.i2 beginTransaction = pVar.getActivity().getSupportFragmentManager().beginTransaction();
        kotlin.jvm.internal.o.f(beginTransaction, "beginTransaction(...)");
        android.widget.FrameLayout frameLayout3 = pVar.f339285g;
        if (frameLayout3 != null) {
            frameLayout3.removeAllViews();
        }
        com.tencent.mm.ui.vas.VASCommonFragment b17 = lk5.q0.b("com.tencent.mm.plugin.finder.feed.ui.FinderPaidCollectionUI", intent2, false, 4, null);
        pVar.f339283e = b17;
        b17.q0(new nr2.n(pVar));
        gx2.q qVar2 = pVar.f339284f;
        if (qVar2 != null) {
            qVar2.setContentReachTop(new nr2.o(pVar));
        }
        com.tencent.mm.ui.vas.VASCommonFragment vASCommonFragment = pVar.f339283e;
        kotlin.jvm.internal.o.d(vASCommonFragment);
        beginTransaction.k(com.tencent.mm.R.id.f484517qf2, vASCommonFragment, null);
        beginTransaction.f();
        pVar.f339282d = longExtra;
    }
    ...
    public final void dl(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.SelectLocalFileRouterUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void ek(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPlayListUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void fj(android.app.Activity context, android.content.Intent intent, int i17) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderFavTimelineUI.class);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
    ...
    public final void fk(android.content.Context context, android.content.Intent intent, int i17, int i18, java.lang.Boolean bool, java.lang.Integer num) {
        kotlin.jvm.internal.o.g(context, "context");
        ((w40.e) i95.n0.c(w40.e.class)).getClass();
        qs2.t.a(qs2.v.f366327a, context, intent, i17, i18, bool, num, 0, false, 192, null);
    }
    ...
    public final void fl(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderTemplateCollectionUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void gk(android.content.Context context, android.content.Intent intent) {
        ...
        com.tencent.mm.plugin.finder.viewmodel.component.iy.d(com.tencent.mm.plugin.finder.viewmodel.component.ny.L1, context, intent, 0L, null, 0, 0, false, 0, null, 508, null);
        ((w40.e) i95.n0.c(w40.e.class)).getClass();
        qs2.v.f366327a.d(context, intent, null);
    }
    ...
    public void hj(android.app.Activity activity, android.content.Intent intent, int i17) {
        ...
        intent.setClass(activity, com.tencent.mm.plugin.finder.feed.ui.FinderWxProfileShowUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
        arrayList.add(intent);
    ...
    public final void hk(android.content.Context context, android.content.Intent intent) {
        kotlin.jvm.internal.o.g(context, "context");
        ((w40.e) i95.n0.c(w40.e.class)).getClass();
        qs2.v.f366327a.e(context, intent);
    }
    ...
    public void hl(android.content.Context context, android.content.Intent intent) {
        ...
        if (!(context2 instanceof android.app.Activity) && (Ui = ((com.tencent.mm.plugin.finder.service.l3) ((zy2.c9) i95.n0.c(zy2.c9.class))).Ui()) != null) {
            context2 = Ui;
        }
        ...
        if (!booleanExtra) {
            com.tencent.mm.plugin.finder.viewmodel.component.iy.d(com.tencent.mm.plugin.finder.viewmodel.component.ny.L1, context2, intent2, 0L, null, 0, 0, false, 0, null, 508, null);
        }
        ...
        if (intent2.getIntExtra("key_topic_type", 1) == 1) {
            intent2.setClass(context2, com.tencent.mm.plugin.finder.activity.topic.ui.FinderNewTopicUI.class);
        } else {
            intent2.setClass(context2, com.tencent.mm.plugin.finder.feed.ui.FinderTopicFeedUI.class);
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent2);
        java.util.Collections.reverse(arrayList);
    ...
    public final void ij(android.content.Context context, android.content.Intent intent, java.lang.String type) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderBlockListSearchUI.class);
        int i17 = com.tencent.mm.plugin.finder.ui.FinderBlockListSearchUI.f128521z;
    ...
    public void il(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderTopicTimelineUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void jk(android.content.Context context, android.content.Intent intent) {
        ...
        wd0.q1 q1Var = (wd0.q1) i95.n0.c(wd0.q1.class);
        com.tencent.mm.plugin.finder.assist.a0 a0Var = new com.tencent.mm.plugin.finder.assist.a0(this, context, intent);
        ((vd0.j2) q1Var).getClass();
    ...
    public final void jl(android.content.Context context, so2.j0 continueWatchData) {
        ...
        pf5.z zVar;
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(continueWatchData, "continueWatchData");
        android.content.Intent intent = new android.content.Intent();
        intent.putExtra("key_topic_type", 16);
        r45.zx0 zx0Var = continueWatchData.f410438d;
        long j18 = zx0Var.getLong(5);
        r45.vx0 vx0Var = (r45.vx0) zx0Var.getCustom(0);
        str = "";
        if (vx0Var != null) {
            java.lang.String string = vx0Var.getString(1);
            str = string != null ? string : "";
            j17 = vx0Var.getLong(0);
            com.tencent.mm.protobuf.g byteString = vx0Var.getByteString(22);
            bArr = byteString != null ? byteString.f192156a : null;
            i17 = vx0Var.getInteger(21);
        } else {
            j17 = 0;
            i17 = 0;
            bArr = null;
        ...
        intent.putExtra("KEY_OPEN_PLAYLIST_DRAWER", false);
        intent.putExtra("key_ref_object_id", j18);
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("Finder.ActivityRouter", th6, "enterTopicTimelineUI", new java.lang.Object[0]);
        }
        if (!(context instanceof androidx.appcompat.app.AppCompatActivity)) {
            throw new java.lang.IllegalStateException("Check failed.".toString());
        }
        ...
        jSONObject.put("ref_commentscene", V6 != null ? V6.getInteger(5) : 0);
    ...
    public final void kk(android.app.Activity context, java.lang.String username, r45.ct4 ct4Var) {
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(username, "username");
        java.lang.String string = ct4Var != null ? ct4Var.getString(4) : null;
        if (!(string == null || string.length() == 0)) {
            ((k40.f) ((l40.e) i95.n0.c(l40.e.class))).bj(username, c01.id.a(), 1);
            android.content.Intent intent = new android.content.Intent();
            intent.putExtra("rawUrl", hc2.x0.e(string, 4, false, null, 6, null));
        ...
        r45.qt2 V6 = ((com.tencent.mm.plugin.finder.viewmodel.component.ny) zVar.a((androidx.appcompat.app.AppCompatActivity) context).a(com.tencent.mm.plugin.finder.viewmodel.component.ny.class)).V6();
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "[initEditLayout] onClick username:".concat(username));
        android.content.Intent intent2 = new android.content.Intent();
        com.tencent.mm.plugin.finder.viewmodel.component.iy.d(com.tencent.mm.plugin.finder.viewmodel.component.ny.L1, context, intent2, 0L, null, 0, 0, false, 0, null, 384, null);
        ((com.tencent.mm.plugin.finder.assist.i0) i95.n0.c(com.tencent.mm.plugin.finder.assist.i0.class)).rk(context, intent2, 10010, username);
        zy2.fa nk6 = ((c61.l7) i95.n0.c(c61.l7.class)).nk();
        r45.f03 b07 = nk6.b0("FinderSetting", username);
        com.tencent.mm.plugin.finder.extension.reddot.jb S0 = zy2.ia.S0(nk6, "FinderSetting", username, false, false, 12, null);
        if (S0 != null && b07 != null) {
            com.tencent.mm.plugin.finder.report.x2.i(com.tencent.mm.plugin.finder.report.x2.f125429a, "3", S0, b07, 2, V6, 0, null, 0, 0, 480, null);
        }
    ...
    public final void kl(android.content.Context context) {
        kotlin.jvm.internal.o.g(context, "context");
        android.content.Intent intent = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.plugin.finder.ui.FinderUnOpenUI.class);
        if (!(context instanceof android.app.Activity)) {
            intent.addFlags(268435456);
        }
        java.util.ArrayList arrayList = new java.util.ArrayList();
    ...
    public final void lk(android.content.Context context, android.content.Intent intent) {
        ...
        wd0.q1 q1Var = (wd0.q1) i95.n0.c(wd0.q1.class);
        com.tencent.mm.plugin.finder.assist.b0 b0Var = new com.tencent.mm.plugin.finder.assist.b0(this, context, intent);
        ((vd0.j2) q1Var).getClass();
    ...
    public void ll(android.content.Context context, java.lang.String appId, java.lang.String enterPath, int i17, java.lang.String sceneNote) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "enter we app appId:" + appId + ",enterPath:" + enterPath + ",scene:" + i17 + ",sceneNote:" + sceneNote);
    ...
    public final void mj(android.content.Context context, android.content.Intent intent, int i17) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderBlockListUI.class);
        intent.putExtra("BLOCK_LIST_TYPE", i17);
        xy2.c.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
    ...
    */
    public void mk(android.content.Context r22, android.content.Intent r23) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.mk(android.content.Context, android.content.Intent):void");
    }
    ...
    public final void ml(android.content.Context context, android.content.Intent intent) {
        if (context instanceof androidx.appcompat.app.AppCompatActivity) {
            if (intent.getIntExtra("key_member_inlet_source", 0) == 0) {
                ...
                kotlin.jvm.internal.o.g(activity, "activity");
                eo2.b bVar = (eo2.b) pf5.z.f353948a.a(activity).e(eo2.b.class);
                intent.putExtra("key_member_inlet_source", bVar != null ? bVar.f255558d : 0);
            }
        }
    }
    ...
    public final void nj(android.content.Context context, r45.b31 b31Var, android.content.Intent i17) {
        ...
        com.tencent.mm.plugin.finder.search.l4.f125763c = b31Var;
        jx3.f.INSTANCE.idkeyStat(1265L, 2L, 1L, false);
        i17.setClass(context, com.tencent.mm.plugin.finder.search.FinderContactSearchIncludeFollowUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(i17);
        java.util.Collections.reverse(arrayList);
    ...
    public final void nk(android.content.Context context, android.content.Intent intent, int i17, int i18, int i19, int i27, int i28) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderPurchaseUI.class);
    ...
    public final void oj(android.content.Context context, r45.b31 b31Var, android.content.Intent i17) {
        ...
        com.tencent.mm.plugin.finder.search.l4.f125763c = b31Var;
        jx3.f.INSTANCE.idkeyStat(1265L, 2L, 1L, false);
        i17.setClass(context, com.tencent.mm.plugin.finder.search.FinderContactSearchUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(i17);
        java.util.Collections.reverse(arrayList);
    ...
    public final boolean ol(android.content.Context context, android.content.Intent intent) {
        ...
        com.tencent.mm.plugin.report.service.g0.INSTANCE.d(20912, 3, stringExtra, "", "");
        return true;
    }
    ...
    */
    public final void pk(android.content.Context r31) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.pk(android.content.Context):void");
    }

    public final com.tencent.mm.plugin.finder.view.e3 pl(android.content.Context context, java.lang.String str, android.content.Intent intent, int i17, yz5.l lVar) {
        kotlin.jvm.internal.o.g(context, "context");
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "jump to wx profile %s", str);
        android.content.Intent intent2 = new android.content.Intent();
        if (intent != null) {
        ...
        return com.tencent.mm.plugin.finder.view.ko.f132520a.f(context, intent2, i17, lVar);
    }
    ...
    public final void qk(android.content.Context context, android.content.Intent intent) {
        ...
        intent.addFlags(67108864);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderSelfUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void ql(android.content.Context context, java.lang.String feedUserName, so2.y0 item, java.lang.String str, int i17) {
        ...
        int i19 = i18;
        intent.putExtra("Avatar", item.f410703d.L0());
        intent.putExtra("Nickname", item.f410705f);
        intent.putExtra("CommentId", item.f410703d.t0());
        intent.putExtra("FeedId", item.f410703d.field_feedId);
        intent.putExtra("DupFlag", item.f410703d.field_dupFlag);
        intent.putExtra("memberProviderUsername", str);
        intent.putExtra("PreviewScene", i17);
        intent.putExtra("FeedNonceId", item.f410703d.field_objectNonceId);
        intent.putExtra("V5UserName", item.f410703d.Z0());
        if (item.f410703d.u0().getMsgInfo() != null) {
            r45.lz0 msgInfo = item.f410703d.u0().getMsgInfo();
            intent.putExtra("ContactMsgInfo", msgInfo != null ? msgInfo.toByteArray() : null);
        }
        sl(this, context, item.f410703d.Z0(), intent, i19, null, 16, null);
        item.f410703d.u0();
        if (item.f410703d.u0().getMsgInfo() == null) {
            com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "msgInfo is null ,feedId:" + item.f410703d.field_feedId + ",comentId:" + item.f410703d.t0());
        }
    }
    ...
    public void rj(android.app.Activity activity, android.content.Intent intent, int i17) {
        ...
        intent.addFlags(67108864);
        intent.setClass(activity, com.tencent.mm.plugin.finder.ui.FinderCreateContactUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
        arrayList.add(intent);
    ...
    public final void rk(android.app.Activity context, android.content.Intent intent, int i17, java.lang.String username) {
        ...
        intent.addFlags(67108864);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderSettingInfoUI.class);
    ...
    */
    public final void rl(in5.s0 r10, java.lang.String r11, jv2.i r12) {
        /*
            ...
            android.content.Context r10 = r10.f293121e
            if (r0 != 0) goto L3d
        ...
        L46:
            ...
            r4.putExtra(r0, r11)
            jv2.c r11 = r12.f302223d
            java.lang.String r11 = r11.field_objectNonceId
        ...
        Ldd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.rl(in5.s0, java.lang.String, jv2.i):void");
    }
    ...
    public void sj(android.app.Activity context, android.content.Intent intent, int i17) {
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.A).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        java.lang.ThreadLocal threadLocal = zj0.c.f473285a;
        arrayList.add(java.lang.Integer.valueOf(i17));
        arrayList.add(intent);
        ...
        context.overridePendingTransition(com.tencent.mm.R.anim.f477876e0, com.tencent.mm.R.anim.f477728p);
    }
    ...
    public final void sk(android.app.Activity context, android.content.Intent intent) {
        ...
        intent.addFlags(67108864);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderSettingProtectUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void tj(android.content.Context context, android.content.Intent intent) {
        ...
        intent.addFlags(67108864);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderEditTextUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void tk(android.app.Activity context, android.content.Intent intent, int i17, boolean z17) {
        ...
        if (z17) {
            ...
            intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderShareFeedAffinityUI.class);
        } else {
            intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI.class);
        }
    ...
    public void tl(android.content.Context context, com.tencent.mm.protocal.protobuf.FinderJumpInfo finderJumpInfo, java.util.Map map, com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed, yz5.l lVar) {
        org.json.JSONObject jSONObject;
        java.lang.String str;
        kotlin.jvm.internal.o.g(context, "context");
        if (finderJumpInfo == null) {
            com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "[openAddTagLiteApp] jumpInfo is null");
            return;
        }
        if (map != null) {
            try {
        ...
        sVar.f144167d = new com.tencent.mm.plugin.finder.assist.g0(lVar);
        xc2.y2.L(xc2.y2.f453343a, context, p0Var, null, sVar, null, 20, null);
    }
    ...
    public final void uj(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderFansListUI.class);
        xy2.c.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void uk(android.content.Context context, android.content.Intent intent, boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "enterFinderShare finderAffinity " + z17);
        com.tencent.mm.plugin.finder.report.v1.f125393a.d();
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void ul(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderProfileLongFeedTimelineUI.class);
    ...
    public final void vj(android.content.Context context, android.content.Intent intent, com.tencent.mm.plugin.finder.feed.model.internal.DataBuffer feedList, java.lang.String vmKey, int i17, java.lang.String str, int i18) {
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(feedList, "feedList");
        kotlin.jvm.internal.o.g(vmKey, "vmKey");
        android.content.Intent intent2 = intent == null ? new android.content.Intent() : intent;
        new com.tencent.mm.plugin.finder.feed.model.y9().b(new com.tencent.mm.plugin.finder.feed.model.r9(feedList, null, i17, null, null, 16, null), intent2);
        android.content.Intent intent3 = !(context instanceof android.app.Activity) ? intent2 : null;
        if (intent3 != null) {
            intent3.addFlags(268435456);
        }
        intent2.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderFeedListUI.class);
    ...
    public final void vk(android.content.Context context, android.content.Intent intent) {
        kotlin.jvm.internal.o.g(context, "context");
        ((w40.e) i95.n0.c(w40.e.class)).getClass();
        android.content.Intent b17 = xy2.c.b(context, com.tencent.mm.plugin.finder.feed.ui.FinderSharePostUI.class, intent, false, false, 24, null);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(b17);
        java.util.Collections.reverse(arrayList);
    ...
    public final void vl(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderProfileTimeLineUI.class);
        android.app.Activity activity = z17 ? (android.app.Activity) context : null;
        if ((activity == null || (intent2 = activity.getIntent()) == null || !intent2.getBooleanExtra("KEY_IS_FROM_FINDER_TASK", false)) ? false : true) {
            intent.putExtra("KEY_IS_FROM_FINDER_TASK", true);
        }
    ...
    public final void wj(android.content.Context context, r45.b31 b31Var, android.content.Intent i17) {
        ...
        com.tencent.mm.plugin.finder.search.l4 l4Var = com.tencent.mm.plugin.finder.search.l4.f125761a;
        com.tencent.mm.plugin.finder.search.l4.f125763c = b31Var;
        i17.setClass(context, com.tencent.mm.plugin.finder.search.FinderFeedSearchUI.class);
        i17.putExtra("key_to_comment_scene", 6);
        com.tencent.mm.plugin.finder.viewmodel.component.iy.d(com.tencent.mm.plugin.finder.viewmodel.component.ny.L1, context, i17, 0L, null, 0, 0, false, 0, null, 508, null);
        android.content.Intent intent = !(context instanceof android.app.Activity) ? i17 : null;
        if (intent != null) {
            intent.addFlags(268435456);
        }
        ...
        jx3.f.INSTANCE.idkeyStat(1265L, 1L, 1L, false);
    }
    ...
    public final void wl(android.content.Context context, android.content.Intent intent, boolean z17, boolean z18) {
        ...
        intent.setClass(context, z17 ? com.tencent.mm.plugin.finder.feed.ui.FinderFloatBallDetailUI.class : com.tencent.mm.plugin.finder.feed.ui.FinderMultiTaskUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void xj(android.content.Context context, android.content.Intent intent, int i17) {
        ...
        intent.addFlags(67108864);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderFinderSysMsgUI.class);
        xy2.c.c(context, intent);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0045, code lost:
        ...
        if (((com.tencent.mm.plugin.finder.service.l3) r5).Di((android.app.Activity) r12) == false) goto L12;
     */
    ...
    */
    public void xk(android.content.Context r12, android.content.Intent r13, int r14, boolean r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.assist.i0.xk(android.content.Context, android.content.Intent, int, boolean):void");
    }
    ...
    public final void xl(android.content.Context context, android.content.Intent intent) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderLongFeedDetailUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void yj(android.content.Context context, android.content.Intent intent, int i17) {
        ...
        intent.setClass(context, com.tencent.mm.plugin.finder.feed.ui.FinderGalleryUI.class);
        if (!z17 || i17 == 0) {
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(intent);
            java.util.Collections.reverse(arrayList);
    ...
    public final void yk(android.content.Context context, android.content.Intent intent) {
        ...
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderConversationTempUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void yl(android.app.Activity context, java.lang.String str) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            ...
            com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "fullActivity " + className + ", fromActivity " + str2);
    ...
    public void zj(android.content.Context context, android.content.Intent intent) {
        kotlin.jvm.internal.o.g(context, "context");
        com.tencent.mars.xlog.Log.i("Finder.ActivityRouter", "enterFinderGameLiveAuthUI");
        if (intent == null) {
            intent = new android.content.Intent();
        }
        android.content.Intent intent2 = !(context instanceof android.app.Activity) ? intent : null;
        ...
        jz2.x0 x0Var = jz2.x0.f302754a;
        intent.setClass(context, (java.lang.Class) ((jz5.n) jz2.x0.C).getValue());
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
    ...
    public final void zk(android.content.Context context, android.content.Intent intent) {
        ...
        intent.addFlags(67108864);
        com.tencent.mm.plugin.finder.viewmodel.component.ny.L1.c(context, intent);
        intent.setClass(context, com.tencent.mm.plugin.finder.ui.FinderWxMsgUI.class);
        java.util.ArrayList arrayList = new java.util.ArrayList();
        arrayList.add(intent);
        java.util.Collections.reverse(arrayList);
