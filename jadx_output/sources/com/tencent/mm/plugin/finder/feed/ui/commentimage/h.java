...
public final class h implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ android.view.ViewGroup f109843d;

    public h(android.view.ViewGroup viewGroup) {
        this.f109843d = viewGroup;
    }

    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    public final void onAnimationUpdate(android.animation.ValueAnimator animation) {
        kotlin.jvm.internal.o.g(animation, "animation");
        android.view.ViewGroup viewGroup = this.f109843d;
        if (viewGroup == null) {
            return;
        }
