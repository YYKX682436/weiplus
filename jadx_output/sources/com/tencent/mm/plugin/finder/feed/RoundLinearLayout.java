...
public class RoundLinearLayout extends android.widget.LinearLayout {
    ...
    public com.tencent.mm.plugin.finder.feed.f30 cornerRadius;

    /* renamed from: e, reason: collision with root package name */
    public float f106169e;

    /* renamed from: f, reason: collision with root package name */
    public final android.graphics.Path f106170f;
    ...
    public RoundLinearLayout(android.content.Context context) {
        ...
        this.f106169e = 0.5f;
        this.f106170f = new android.graphics.Path();
    }
    ...
    public final void a(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        ...
        this.cornerRadius = new com.tencent.mm.plugin.finder.feed.f30(dimension, dimension, dimension, dimension);
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r14) {
        /*
            ...
            android.graphics.Path r0 = r13.f106170f
            r0.reset()
            com.tencent.mm.plugin.finder.feed.f30 r1 = r13.cornerRadius
            if (r1 == 0) goto L75
            float r2 = r1.f106697a
            r3 = 0
        ...
        L19:
            r4 = r5
        L1a:
            float r7 = r1.f106700d
            float r8 = r1.f106699c
            float r1 = r1.f106698b
            if (r4 == 0) goto L3f
        ...
        L43:
            ...
            goto L9a
        L75:
            android.graphics.Path r5 = r13.f106170f
            r6 = 0
            r7 = 0
            int r1 = r13.getWidth()
            float r8 = (float) r1
        ...
        L9a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.feed.RoundLinearLayout.dispatchDraw(android.graphics.Canvas):void");
    }

    public final com.tencent.mm.plugin.finder.feed.f30 getCornerRadius() {
        return this.cornerRadius;
    }

    public final void setCornerRadius(com.tencent.mm.plugin.finder.feed.f30 f30Var) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoundLinearLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoundLinearLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
