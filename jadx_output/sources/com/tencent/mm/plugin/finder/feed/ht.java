...
public final class ht extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ ym5.s3 f106950d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.finder.feed.yt f106951e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ht(ym5.s3 s3Var, com.tencent.mm.plugin.finder.feed.yt ytVar) {
        super(0);
        this.f106950d = s3Var;
        this.f106951e = ytVar;
    }
    ...
    public java.lang.Object invoke() {
        ...
        com.tencent.mars.xlog.Log.i("Finder.FinderTimelineLbsMixPresenter", "[checkEmptyHeader] isEmpty=" + z17 + " reason=" + s3Var);
        boolean z18 = s3Var.f463516a != 2 && s3Var.f463517b == -2;
        so2.s sVar = ytVar.f111206p;
        if (z17 || z18) {
            if (z18) {
                ytVar.g().getDataList().clear();
