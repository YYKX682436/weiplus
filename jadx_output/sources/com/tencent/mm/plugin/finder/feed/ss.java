...
public final class ss extends com.tencent.mm.plugin.finder.feed.dj {
    public final zy2.h8 A;
    public fc2.d B;

    /* renamed from: y, reason: collision with root package name */
    public final int f109005y;

    /* renamed from: z, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.feed.model.l0 f109006z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ss(com.tencent.mm.ui.MMActivity context, int i17) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
        this.f109005y = i17;
        this.f109006z = ((com.tencent.mm.plugin.finder.viewmodel.component.w6) pf5.z.f353948a.a(context).a(com.tencent.mm.plugin.finder.viewmodel.component.w6.class)).f136307d;
    ...
    public void X(com.tencent.mm.plugin.finder.feed.model.BaseFinderFeedLoader model, com.tencent.mm.plugin.finder.feed.gj callback) {
        ...
        com.tencent.mm.plugin.finder.feed.qs qsVar = new com.tencent.mm.plugin.finder.feed.qs(this);
        com.tencent.mm.plugin.finder.feed.model.l0 l0Var = this.f109006z;
        l0Var.N0(this.f109005y, this.f106422e, qsVar);
        ...
        zy2.h8 h8Var = this.A;
        com.tencent.mm.plugin.finder.feed.rs rsVar = new com.tencent.mm.plugin.finder.feed.rs(this);
        com.tencent.mm.plugin.finder.feed.i0 i0Var = this.f106424g;
        ((com.tencent.mm.plugin.finder.feed.model.s3) h8Var).N0(rsVar, i0Var != null ? i0Var.getRecyclerView() : null);
