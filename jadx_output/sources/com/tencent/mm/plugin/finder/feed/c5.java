...
public final class c5 implements gm5.a {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.feed.a7 f106455a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ pq5.g f106456b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ fp0.r f106457c;

    public c5(com.tencent.mm.plugin.finder.feed.a7 a7Var, pq5.g gVar, fp0.r rVar) {
        this.f106455a = a7Var;
        this.f106456b = gVar;
        this.f106457c = rVar;
    }
    ...
    public java.lang.Object call(java.lang.Object obj) {
        ...
        if (((java.lang.Boolean) ((lb2.j) ((jz5.n) com.tencent.mm.plugin.finder.storage.t70.f127971ud).getValue()).r()).booleanValue() && valueOf != null) {
            com.tencent.mm.plugin.finder.storage.FinderItem finderItem = this.f106455a.f106212i;
            if (finderItem == null) {
                kotlin.jvm.internal.o.o("feedObj");
                throw null;
            }
            if (valueOf.longValue() != finderItem.getId()) {
                com.tencent.mars.xlog.Log.w("Finder.DrawerPresenter", "preload prev skip feedId not match");
                this.f106456b.j(true);
                this.f106457c.b(fp0.u.f265290f);
                return new com.tencent.mm.plugin.finder.feed.m2(false, null);
            }
        }
        if (this.f106455a.G() && vg7Var != this.f106455a.j0()) {
            ...
            sb6.append(", sortType = ");
            sb6.append(this.f106455a.j0().f388228d);
        ...
        this.f106455a.F0(((r45.j51) fVar).getInteger(4) == 1);
        this.f106455a.f106222s = ((r45.j51) fVar2.f70618d).getByteString(3);
        java.lang.StringBuilder sb7 = new java.lang.StringBuilder("preloadPrevPage after lastBuffer ");
        if (this.f106455a.f106222s == null) {
            b17 = "null";
        } else {
            com.tencent.mm.protobuf.g gVar = this.f106455a.f106222s;
        ...
        com.tencent.mm.plugin.finder.feed.a7 a7Var = this.f106455a;
        ...
        return new com.tencent.mm.plugin.finder.feed.m2(false, this.f106455a.Q(arrayList, true));
    }
}
