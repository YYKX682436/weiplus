...
public final class FinderProfileFeedLoader$createDataMerger$1$mergeLoadMore$1 extends kotlin.jvm.internal.q implements yz5.a {
    final /* synthetic */ boolean $isPullTopOp;
    ...
    public FinderProfileFeedLoader$createDataMerger$1$mergeLoadMore$1(com.tencent.mm.plugin.finder.feed.model.FinderProfileFeedLoader$createDataMerger$1 finderProfileFeedLoader$createDataMerger$1, com.tencent.mm.plugin.finder.feed.model.internal.y0 y0Var, ym5.s3 s3Var, boolean z17, com.tencent.mm.plugin.finder.feed.model.FinderProfileFeedLoader finderProfileFeedLoader, yz5.l lVar, com.tencent.mm.plugin.finder.feed.model.internal.IResponse<so2.j5> iResponse) {
        super(0);
        this.this$0 = finderProfileFeedLoader$createDataMerger$1;
        this.$op = y0Var;
        this.$reason = s3Var;
        this.$isPullTopOp = z17;
    ...
    public final void m111invoke() {
        ...
        if (this.$isPullTopOp) {
            ...
            com.tencent.mm.plugin.finder.feed.model.internal.j0.f(this.this$1.getDispatcher(), this.$reason, false, 2, null);
        }
