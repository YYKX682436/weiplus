...
public final class mb extends com.tencent.mm.plugin.finder.feed.dj {
    public final zy2.h8 A;

    /* renamed from: y, reason: collision with root package name */
    public final int f107366y;

    /* renamed from: z, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.feed.model.l0 f107367z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public mb(com.tencent.mm.ui.MMActivity context, int i17) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
        this.f107366y = i17;
        this.f107367z = ((com.tencent.mm.plugin.finder.viewmodel.component.w6) pf5.z.f353948a.a(context).a(com.tencent.mm.plugin.finder.viewmodel.component.w6.class)).f136307d;
    ...
    public void X(com.tencent.mm.plugin.finder.feed.model.BaseFinderFeedLoader model, com.tencent.mm.plugin.finder.feed.gj callback) {
        ...
        com.tencent.mm.plugin.finder.feed.kb kbVar = new com.tencent.mm.plugin.finder.feed.kb(this);
        com.tencent.mm.plugin.finder.feed.model.l0 l0Var = this.f107367z;
        l0Var.N0(this.f107366y, this.f106422e, kbVar);
        ...
        zy2.h8 h8Var = this.A;
        com.tencent.mm.plugin.finder.feed.lb lbVar = new com.tencent.mm.plugin.finder.feed.lb(this);
        com.tencent.mm.plugin.finder.feed.i0 i0Var = this.f106424g;
        ((com.tencent.mm.plugin.finder.feed.model.s3) h8Var).N0(lbVar, i0Var != null ? i0Var.getRecyclerView() : null);
        kotlin.jvm.internal.o.g(context, "context");
