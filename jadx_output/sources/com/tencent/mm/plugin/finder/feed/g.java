...
public final class g extends com.tencent.mm.plugin.finder.feed.dj {
    public final zy2.h8 A;
    public fc2.d B;

    /* renamed from: y, reason: collision with root package name */
    public final int f106791y;

    /* renamed from: z, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.feed.model.l0 f106792z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(com.tencent.mm.ui.MMActivity context, int i17) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
        this.f106791y = i17;
        this.f106792z = ((com.tencent.mm.plugin.finder.viewmodel.component.w6) pf5.z.f353948a.a(context).a(com.tencent.mm.plugin.finder.viewmodel.component.w6.class)).f136307d;
    ...
    public void X(com.tencent.mm.plugin.finder.feed.model.BaseFinderFeedLoader model, com.tencent.mm.plugin.finder.feed.gj callback) {
        ...
        com.tencent.mm.plugin.finder.feed.e eVar = new com.tencent.mm.plugin.finder.feed.e(this);
        com.tencent.mm.plugin.finder.feed.model.l0 l0Var = this.f106792z;
        l0Var.N0(this.f106791y, this.f106422e, eVar);
        ...
        zy2.h8 h8Var = this.A;
        com.tencent.mm.plugin.finder.feed.f fVar = new com.tencent.mm.plugin.finder.feed.f(this);
        com.tencent.mm.plugin.finder.feed.i0 i0Var = this.f106424g;
        ((com.tencent.mm.plugin.finder.feed.model.s3) h8Var).N0(fVar, i0Var != null ? i0Var.getRecyclerView() : null);
