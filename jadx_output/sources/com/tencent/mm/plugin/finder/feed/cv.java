...
public final class cv extends com.tencent.mm.view.recyclerview.WxRecyclerAdapter {
    ...
    public void onViewAttachedToWindow(in5.s0 holder) {
        ...
        ((androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams) layoutParams).f11941i = holder.getItemViewType() == -1 || holder.getItemViewType() == 2003;
    }
}
