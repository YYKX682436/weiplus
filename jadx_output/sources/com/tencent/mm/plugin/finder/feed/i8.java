...
public final class i8 extends com.tencent.mm.plugin.finder.feed.dj {
    public final zy2.h8 A;
    public fc2.d B;

    /* renamed from: y, reason: collision with root package name */
    public final int f106994y;

    /* renamed from: z, reason: collision with root package name */
    public final com.tencent.mm.plugin.finder.feed.model.l0 f106995z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i8(com.tencent.mm.ui.MMActivity context, int i17) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
        this.f106994y = i17;
        this.f106995z = ((com.tencent.mm.plugin.finder.viewmodel.component.w6) pf5.z.f353948a.a(context).a(com.tencent.mm.plugin.finder.viewmodel.component.w6.class)).f136307d;
    ...
    public void X(com.tencent.mm.plugin.finder.feed.model.BaseFinderFeedLoader model, com.tencent.mm.plugin.finder.feed.gj callback) {
        ...
        com.tencent.mm.plugin.finder.feed.g8 g8Var = new com.tencent.mm.plugin.finder.feed.g8(this);
        com.tencent.mm.plugin.finder.feed.model.l0 l0Var = this.f106995z;
        l0Var.N0(this.f106994y, this.f106422e, g8Var);
        ...
        zy2.h8 h8Var = this.A;
        com.tencent.mm.plugin.finder.feed.h8 h8Var2 = new com.tencent.mm.plugin.finder.feed.h8(this);
        com.tencent.mm.plugin.finder.feed.i0 i0Var = this.f106424g;
        ((com.tencent.mm.plugin.finder.feed.model.s3) h8Var).N0(h8Var2, i0Var != null ? i0Var.getRecyclerView() : null);
    ...
    public final void Z(java.lang.String str, boolean z17, int i17) {
        ...
        com.tencent.mm.plugin.finder.report.b6.f124969a.c(V6, str, z17, gVar);
    }
    ...
    public void i(com.tencent.mm.plugin.finder.model.BaseFinderFeed feed, db5.g4 menu, com.tencent.mm.ui.widget.dialog.k0 sheet, int i17) {
        ...
        if (hc2.o0.b(feed.getFeedObject().getFeedObject())) {
            ...
            if (!nv2.o.f340558e.c(feed.getFeedObject().getFeedObject())) {
                Z("fav", false, i17);
            } else {
                Z("unfav", false, i17);
            }
