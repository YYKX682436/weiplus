...
public final class ol implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.feed.tl f108665d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f108666e;

    public ol(com.tencent.mm.plugin.finder.feed.tl tlVar, android.view.View view) {
        this.f108665d = tlVar;
        this.f108666e = view;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.finder.feed.tl tlVar = this.f108665d;
        tlVar.j(true);
        android.view.View view2 = this.f108666e;
