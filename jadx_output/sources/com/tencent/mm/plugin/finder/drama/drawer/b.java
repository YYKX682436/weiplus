...
public final class b implements in5.x {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.drama.drawer.c f105199d;

    public b(com.tencent.mm.plugin.finder.drama.drawer.c cVar) {
        this.f105199d = cVar;
    }
    ...
    public void s2(androidx.recyclerview.widget.f2 adapter, android.view.View view, int i17, androidx.recyclerview.widget.k3 k3Var) {
        ...
        if (i17 >= 0) {
            com.tencent.mm.plugin.finder.drama.drawer.c cVar = this.f105199d;
            if (i17 < cVar.f105202e.size()) {
                ...
                java.lang.Object obj = cVar.f105202e.get(i17);
                ...
                c17.put("native_drama_id", pm0.v.u(cVar.f105204g));
                ...
                if (parentActivity != null && (parentActivity instanceof com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI)) {
                    ((com.tencent.mm.plugin.finder.drama.timeline.FinderNativeDramaTimelineUI) parentActivity).k7(bVar, cVar.f105204g);
                    return;
                }
                com.tencent.mm.plugin.finder.assist.i0 i0Var = (com.tencent.mm.plugin.finder.assist.i0) i95.n0.c(com.tencent.mm.plugin.finder.assist.i0.class);
                long j17 = cVar.f105204g;
                long j18 = oj2Var.getLong(0);
                r45.bn2 bn2Var2 = (r45.bn2) oj2Var.getCustom(1);
                i0Var.ak(context, null, j17, j18, null, (bn2Var2 == null || (qj2Var = (r45.qj2) bn2Var2.getCustom(0)) == null) ? null : qj2Var.getString(1), cVar.f105205h, cVar.f105206i, cVar.f105207m, cVar.f105209o);
            }
        }
    }
}
