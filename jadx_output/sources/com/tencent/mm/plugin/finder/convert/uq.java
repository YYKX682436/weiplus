...
public final class uq extends com.tencent.mm.plugin.finder.convert.rp {

    /* renamed from: h, reason: collision with root package name */
    public final java.lang.String f104731h;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public uq(com.tencent.mm.plugin.finder.convert.kp data) {
        super(com.tencent.mm.R.layout.f489035dg0, data);
        kotlin.jvm.internal.o.g(data, "data");
        this.f104731h = "Finder.FinderMsgTingRecommendMusicConvert";
    }
    ...
    public void r(in5.s0 holder, so2.i iVar, int i17, java.util.List list) {
        ...
        com.tencent.mars.xlog.Log.i(this.f104731h, sb6.toString());
        ...
        textView.setText(com.tencent.mm.pluginsdk.ui.span.c0.i(context, a18));
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(pdVar.field_refContent)) {
            ...
            if (com.tencent.mm.sdk.platformtools.t8.K0(pdVar.field_replayNickname)) {
                ...
                textView3.setText(com.tencent.mm.pluginsdk.ui.span.c0.i(context, str6));
            } else {
                android.widget.TextView textView4 = (android.widget.TextView) holder.p(com.tencent.mm.R.id.f486000ju0);
                ...
                textView4.setText(com.tencent.mm.pluginsdk.ui.span.c0.i(context, string));
            }
        }
        ...
        if (p37 != null) {
            p37.setTag(com.tencent.mm.R.id.e79, textView.getText());
