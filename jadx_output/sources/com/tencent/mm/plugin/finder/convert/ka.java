...
public final class ka implements java.lang.Runnable {

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ in5.s0 f103816d;

    public ka(in5.s0 s0Var) {
        this.f103816d = s0Var;
    }

    @Override // java.lang.Runnable
    public final void run() {
        in5.s0 s0Var = this.f103816d;
        ...
        if (finderHorizontalVideoDrawerUIC != null) {
            finderHorizontalVideoDrawerUIC.V6(s0Var);
        }
    }
}
