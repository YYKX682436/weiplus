...
public final class lq extends com.tencent.mm.plugin.finder.convert.rp {

    /* renamed from: h, reason: collision with root package name */
    public final java.lang.String f103943h;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public lq(com.tencent.mm.plugin.finder.convert.kp data) {
        super(com.tencent.mm.R.layout.b3t, data);
        kotlin.jvm.internal.o.g(data, "data");
        this.f103943h = "Finder.FinderMsgMentionedConvert";
    }
    ...
    public void r(in5.s0 holder, so2.i iVar, int i17, java.util.List list) {
        ...
        com.tencent.mars.xlog.Log.i(this.f103943h, sb6.toString());
        ...
        ((ke0.e) xVar).getClass();
        textView.setText(com.tencent.mm.pluginsdk.ui.span.c0.i(holder.f293121e, t17));
