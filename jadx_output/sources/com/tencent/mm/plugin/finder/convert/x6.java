...
public final class x6 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ in5.s0 f104928d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ so2.y0 f104929e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.finder.convert.s7 f104930f;

    public x6(in5.s0 s0Var, so2.y0 y0Var, com.tencent.mm.plugin.finder.convert.s7 s7Var) {
        this.f104928d = s0Var;
        this.f104929e = y0Var;
        this.f104930f = s7Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        in5.s0 s0Var = this.f104928d;
        android.view.View p17 = s0Var.p(com.tencent.mm.R.id.v2_);
        if (p17 != null) {
            hc2.f1.d(p17);
        }
        so2.y0 y0Var = this.f104929e;
        boolean z18 = (y0Var.f410703d.u0().getExtFlag() & 2) != 0;
        int i17 = z18 ? 4 : 3;
        com.tencent.mm.plugin.finder.convert.s7 s7Var = this.f104930f;
        s7Var.f104528e.U(y0Var, i17, new com.tencent.mm.plugin.finder.convert.w6(y0Var, i17, s7Var));
        ...
        s7Var.G(z19, (com.tencent.mm.ui.widget.imageview.WeImageView) p18);
        kotlin.jvm.internal.o.f(context, "getContext(...)");
        com.tencent.mm.plugin.finder.viewmodel.component.ny nyVar = context instanceof com.tencent.mm.ui.MMFragmentActivity ? (com.tencent.mm.plugin.finder.viewmodel.component.ny) pf5.z.f353948a.a((androidx.appcompat.app.AppCompatActivity) context).a(com.tencent.mm.plugin.finder.viewmodel.component.ny.class) : null;
        r45.qt2 V6 = nyVar != null ? nyVar.V6() : null;
        dy1.r rVar = (dy1.r) i95.n0.c(dy1.r.class);
        jz5.l[] lVarArr = new jz5.l[6];
        lVarArr[0] = new jz5.l("feed_id", pm0.v.u(s7Var.f104529f.getItemId()));
