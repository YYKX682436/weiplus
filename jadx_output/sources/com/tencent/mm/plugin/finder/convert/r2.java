...
public final class r2 extends al5.w {
    ...
    public java.lang.ref.WeakReference f104437f;
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence text, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        java.lang.ref.WeakReference weakReference = this.f104437f;
        ...
        if (drawable == null) {
            ...
            this.f104437f = new java.lang.ref.WeakReference(drawable);
        }
        if (drawable != null) {
            canvas.save();
