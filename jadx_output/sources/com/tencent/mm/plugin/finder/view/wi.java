...
public final class wi {
    public wi(kotlin.jvm.internal.i iVar) {
    }

    public final void a(java.lang.String str, android.widget.ImageView imageView) {
        if (str == null || str.length() == 0) {
            com.tencent.mm.plugin.finder.view.wi wiVar = com.tencent.mm.plugin.finder.view.xi.f133331a;
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
            sb6.append(imageView != null ? java.lang.Integer.valueOf(imageView.getId()) : null);
            sb6.append(" URL is empty");
            com.tencent.mars.xlog.Log.i("FinderQuickShareProductDialog", sb6.toString());
            if (imageView == null) {
                return;
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:172:0x0556, code lost:
        ...
        if (((r9 == null || r9.length() == 0) ? r0 : r6) == 0) goto L248;
     */
    ...
    */
    public final android.view.View b(android.content.Context r32, r45.br2 r33) {
        /*
            Method dump skipped, instructions count: 1586
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.view.wi.b(android.content.Context, r45.br2):android.view.View");
    }
}
