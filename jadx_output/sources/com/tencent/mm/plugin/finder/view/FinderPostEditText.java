...
public final class FinderPostEditText extends com.tencent.mm.ui.widget.MMEditText {
    ...
    public FinderPostEditText(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void onSelectionChanged(int i17, int i18) {
        ...
        com.tencent.mars.xlog.Log.i(this.G, "onSelectionChanged start " + i17 + ", end " + i18);
        if (this.lastSelection != i17) {
            yz5.p pVar = this.onSelectionChangedListener;
            if (pVar != null) {
                pVar.invoke(java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(this.lastSelection));
            }
            this.lastSelection = i17;
        }
    }

    public final void setLastSelection(int i17) {
        this.lastSelection = i17;
    }

    public final void setOnSelectionChangedListener(yz5.p pVar) {
        this.onSelectionChangedListener = pVar;
    }

    public FinderPostEditText(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
