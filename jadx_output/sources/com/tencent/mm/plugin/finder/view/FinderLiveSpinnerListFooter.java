...
public final class FinderLiveSpinnerListFooter extends android.widget.RelativeLayout implements on5.c {

    /* renamed from: d, reason: collision with root package name */
    public final com.tencent.mm.ui.widget.MMProcessBar f131241d;

    public FinderLiveSpinnerListFooter(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void g(on5.f refreshLayout, sn5.b oldState, sn5.b newState) {
        ...
        if (newState == sn5.b.f410156o || newState == sn5.b.f410155n) {
            com.tencent.mm.ui.widget.MMProcessBar mMProcessBar = this.f131241d;
    ...
    public FinderLiveSpinnerListFooter(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        android.view.View.inflate(getContext(), com.tencent.mm.R.layout.f488991ec2, this);
        android.view.View findViewById = findViewById(com.tencent.mm.R.id.ucg);
        kotlin.jvm.internal.o.f(findViewById, "findViewById(...)");
        this.f131241d = (com.tencent.mm.ui.widget.MMProcessBar) findViewById;
    }
}
