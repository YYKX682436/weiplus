...
public final class EllipsizedTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public final java.lang.String f130844g;

    /* renamed from: h, reason: collision with root package name */
    public int f130845h;

    /* renamed from: i, reason: collision with root package name */
    public java.lang.CharSequence f130846i;

    /* renamed from: m, reason: collision with root package name */
    public android.widget.TextView.BufferType f130847m;

    /* renamed from: n, reason: collision with root package name */
    public boolean f130848n;
    ...
    public EllipsizedTextView(android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        this.f130844g = "…";
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, b92.w2.f18546c);
        kotlin.jvm.internal.o.f(obtainStyledAttributes, "obtainStyledAttributes(...)");
        try {
            this.f130845h = obtainStyledAttributes.getDimensionPixelSize(0, 0);
        } finally {
    ...
    public final void e(int i17, int i18, boolean z17) {
        ...
        java.lang.CharSequence charSequence = this.f130846i;
        boolean z18 = charSequence instanceof android.text.SpannableString;
        java.lang.String str = this.f130844g;
        if (!z18) {
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
            java.lang.CharSequence charSequence2 = this.f130846i;
            sb6.append((java.lang.Object) (charSequence2 != null ? charSequence2.subSequence(i17, i18) : null));
            sb6.append(str);
            super.setText(sb6.toString(), this.f130847m);
            return;
        }
        ...
        super.setText(spannableStringBuilder, this.f130847m);
    }

    /* renamed from: getExtraEllipsizeWidth, reason: from getter */
    public final int getF130845h() {
        return this.f130845h;
    }

    @Override // androidx.appcompat.widget.AppCompatTextView, android.widget.TextView
    public java.lang.CharSequence getText() {
        return this.f130846i;
    }
    ...
    public void onMeasure(int i17, int i18) {
        ...
        float measureText = getPaint().measureText(this.f130844g) * 1.2f;
        if (getEllipsize() != android.text.TextUtils.TruncateAt.END || (i19 = this.f130845h) <= 0 || i19 > getMeasuredWidth() || (getLayout().getEllipsisCount(getLayout().getLineCount() - 1) <= 0 && !this.f130848n)) {
            super.setText(this.f130846i, this.f130847m);
            super.onMeasure(i17, i18);
            return;
        }
        this.f130848n = false;
        int offsetForHorizontal = getLayout().getOffsetForHorizontal(getLayout().getLineCount() - 1, (getMeasuredWidth() - measureText) - this.f130845h);
        java.lang.CharSequence charSequence = this.f130846i;
        ...
        if (this.f130847m == android.widget.TextView.BufferType.NORMAL) {
    ...
    public void setText(java.lang.CharSequence charSequence, android.widget.TextView.BufferType bufferType) {
        ...
        this.f130846i = charSequence;
        this.f130847m = bufferType;
    }
