...
public final class FinderActionBarLayout extends android.widget.LinearLayout {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinderActionBarLayout(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onLayout(boolean z17, int i17, int i18, int i19, int i27) {
        ...
        android.view.View findViewById4 = findViewById(com.tencent.mm.R.id.nuq);
        if (findViewById4 == null || (findViewById = findViewById(com.tencent.mm.R.id.hza)) == null || (findViewById2 = findViewById(com.tencent.mm.R.id.r0j)) == null || (findViewById3 = findViewById(com.tencent.mm.R.id.nfb)) == null) {
            return;
        }
    ...
    public void setLayoutParams(android.view.ViewGroup.LayoutParams layoutParams) {
        ...
        if (z18) {
            com.tencent.mm.sdk.platformtools.Log.c("FinderActionBarLayout", "stack", new java.lang.Object[0]);
        }
        com.tencent.mars.xlog.Log.i("FinderActionBarLayout", "paddingLeft:" + getPaddingLeft() + ", paddingTop:" + getPaddingTop() + ", paddingRight:" + getPaddingRight() + ", paddingBottom:" + getPaddingBottom());
        ...
        com.tencent.mars.xlog.Log.i("FinderActionBarLayout", sb6.toString());
    ...
    public void setPadding(int i17, int i18, int i19, int i27) {
        ...
        com.tencent.mars.xlog.Log.i("FinderActionBarLayout", "left:" + i17 + ", top:" + i18 + ", right:" + i19 + ", bottom:" + i27 + ", paddingLeft:" + getPaddingLeft() + ", paddingTop:" + getPaddingTop() + ", paddingRight:" + getPaddingRight() + ", paddingBottom:" + getPaddingBottom());
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("measuredHeight: ");
        sb6.append(getMeasuredHeight());
        sb6.append(", measuredWidth: ");
        sb6.append(getMeasuredWidth());
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinderActionBarLayout(android.content.Context context, android.util.AttributeSet attrs, int i17) {
