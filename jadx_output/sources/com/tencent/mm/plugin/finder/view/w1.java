...
public final class w1 extends android.view.inputmethod.BaseInputConnection {
    ...
    public final com.tencent.mm.plugin.finder.view.v1 f133278a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public w1(com.tencent.mm.plugin.finder.view.v1 v1Var, android.view.View targetView, boolean z17) {
    ...
    public boolean commitText(java.lang.CharSequence charSequence, int i17) {
        ...
        com.tencent.mm.plugin.finder.view.v1 v1Var = this.f133278a;
        if (v1Var != null) {
            df2.bl blVar = (df2.bl) v1Var;
            if (!(charSequence == null || charSequence.length() == 0)) {
                df2.pl plVar = blVar.f229816a;
                int c76 = plVar.c7();
    ...
    public boolean sendKeyEvent(android.view.KeyEvent keyEvent) {
        com.tencent.mm.plugin.finder.view.v1 v1Var;
        boolean z17 = false;
        if (keyEvent != null && keyEvent.getAction() == 0) {
            if (keyEvent != null && keyEvent.getKeyCode() == 67) {
                z17 = true;
            }
            if (z17 && (v1Var = this.f133278a) != null) {
                ((df2.bl) v1Var).a();
            }
        }
        return true;
