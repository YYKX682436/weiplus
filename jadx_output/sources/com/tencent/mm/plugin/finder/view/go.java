...
public final class go implements in5.x {
    ...
    public final /* synthetic */ java.util.ArrayList f132181d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.os.Bundle f132182e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f132183f;

    public go(java.util.ArrayList arrayList, android.os.Bundle bundle, java.lang.String str) {
        this.f132181d = arrayList;
        this.f132182e = bundle;
        this.f132183f = str;
    }
    ...
    public void s2(androidx.recyclerview.widget.f2 adapter, android.view.View view, int i17, androidx.recyclerview.widget.k3 k3Var) {
        ...
        java.lang.Object obj = this.f132181d.get(i17);
        kotlin.jvm.internal.o.f(obj, "get(...)");
        dy2.b bVar = (dy2.b) obj;
        if (bVar.f244573d.getInteger(5) == 1 && bVar.f244573d.getInteger(0) == 5) {
            android.os.Bundle bundle = this.f132182e;
            ...
            intent.putExtra("InteractionScene", kotlin.jvm.internal.o.b(valueOf, java.lang.Boolean.TRUE) ? 2 : 1);
            intent.putExtra("InteractionRequestScene", 18);
            intent.putExtra("InteractionNickname", this.f132183f);
            intent.putExtra("InteractionUsername", string);
            intent.setClass(holder.f293121e, com.tencent.mm.plugin.finder.ui.FinderWxProfileJumpDetailUI.class);
