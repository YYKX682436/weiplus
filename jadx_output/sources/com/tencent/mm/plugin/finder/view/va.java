...
public final class va implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.FinderHighLightTopicEditView f133235d;

    public va(com.tencent.mm.plugin.finder.view.FinderHighLightTopicEditView finderHighLightTopicEditView) {
        this.f133235d = finderHighLightTopicEditView;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        yz5.a aVar = this.f133235d.f131132m;
        if (aVar != null) {
            aVar.invoke();
        }
