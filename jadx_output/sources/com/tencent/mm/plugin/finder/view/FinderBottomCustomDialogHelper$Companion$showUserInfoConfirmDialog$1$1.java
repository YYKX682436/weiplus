...
public final class FinderBottomCustomDialogHelper$Companion$showUserInfoConfirmDialog$1$1 extends kotlin.jvm.internal.q implements yz5.l {
    ...
    final /* synthetic */ android.content.DialogInterface.OnDismissListener $dismiss;
    ...
    public final void invoke(boolean z17) {
        if (z17) {
            ...
            java.lang.String str3 = this.$cancel;
            android.content.DialogInterface.OnClickListener onClickListener = this.$lok;
            android.content.DialogInterface.OnClickListener onClickListener2 = this.$lcancel;
            final android.content.DialogInterface.OnDismissListener onDismissListener = this.$dismiss;
            com.tencent.mm.plugin.finder.view.FinderBottomCustomDialogHelper.Companion.showConfirmDialog$default(companion, context, null, 0, str, userInfoContainer, str2, str3, 1, onClickListener, onClickListener2, new android.content.DialogInterface.OnDismissListener() { // from class: com.tencent.mm.plugin.finder.view.FinderBottomCustomDialogHelper$Companion$showUserInfoConfirmDialog$1$1.1
