...
public final class kf implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.FinderMileStoneView f132499d;

    public kf(com.tencent.mm.plugin.finder.view.FinderMileStoneView finderMileStoneView) {
        this.f132499d = finderMileStoneView;
    }
    ...
    public final void onAnimationUpdate(android.animation.ValueAnimator animator) {
        ...
        com.tencent.mm.plugin.finder.view.FinderMileStoneView finderMileStoneView = this.f132499d;
        finderMileStoneView.getMileStoneCardContainer().setScaleX(floatValue * finderMileStoneView.getWholeScare());
        ...
        android.view.View mileStoneCancelContainer = finderMileStoneView.getMileStoneCancelContainer();
        ...
        android.view.View mileStoneSaveContainer = finderMileStoneView.getMileStoneSaveContainer();
