...
public final class cb implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.FinderHomeTabRedDotTipsBubbleView f131770d;

    public cb(com.tencent.mm.plugin.finder.view.FinderHomeTabRedDotTipsBubbleView finderHomeTabRedDotTipsBubbleView) {
        this.f131770d = finderHomeTabRedDotTipsBubbleView;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        lx2.d dVar = this.f131770d.f131143d;
        if (dVar != null) {
            dVar.h();
        }
