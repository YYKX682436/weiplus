...
public final class g0 extends com.tencent.mm.plugin.finder.gallery.m {

    /* renamed from: c, reason: collision with root package name */
    public com.tencent.mm.plugin.finder.model.BaseFinderFeed f111366c;

    /* renamed from: d, reason: collision with root package name */
    public int f111367d;

    /* renamed from: e, reason: collision with root package name */
    public com.tencent.mm.protocal.protobuf.FinderObject f111368e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g0(com.tencent.mm.plugin.finder.gallery.a data) {
        super(data);
    ...
    public androidx.recyclerview.widget.p2 e(int i17) {
        return !k() ? new com.tencent.mm.plugin.finder.gallery.f0() : new com.tencent.mm.plugin.finder.gallery.l();
    }
    ...
    public void h(com.tencent.mm.ui.MMActivity activity, int i17, int i18, android.content.Intent intent, com.tencent.mm.plugin.finder.gallery.c curActivity) {
        ...
        if (intent != null) {
            this.f111367d = intent.getIntExtra("TAB_TYPE", 0);
        }
    ...
    public void i(com.tencent.mm.ui.MMActivity activity, int i17, com.tencent.mm.plugin.finder.model.BaseFinderFeed feed, java.util.List dataList, com.tencent.mm.protobuf.g gVar, boolean z17) {
        ...
        ((com.tencent.mm.feature.textstatus.StatusThirdShareFeatureService) ((xe0.g0) i95.n0.c(xe0.g0.class))).wi(activity, intent, com.tencent.thumbplayer.tmediacodec.codec.CodecError.CONFIG_SURFACE_NULL);
    }

    public final boolean l(int i17, int i18, com.tencent.mm.ui.MMActivity mMActivity, boolean z17) {
        com.tencent.mm.plugin.finder.model.BaseFinderFeed baseFinderFeed = this.f111366c;
        com.tencent.mm.protocal.protobuf.FinderObject finderObject = this.f111368e;
        ...
        if (i17 != 10003 || i18 != -1 || finderObject == null) {
            if (i17 != 10003) {
                return false;
            }
            if (z17) {
        ...
        intent.putExtra("SELECT_TAB_TYPE", this.f111367d);
