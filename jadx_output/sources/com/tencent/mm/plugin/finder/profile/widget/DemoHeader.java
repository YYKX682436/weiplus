...
public final class DemoHeader extends android.widget.LinearLayout implements on5.d {
    ...
    public android.widget.TextView f124466d;

    /* renamed from: e, reason: collision with root package name */
    public com.tencent.mm.ui.widget.imageview.WeImageView f124467e;

    /* renamed from: f, reason: collision with root package name */
    public com.tencent.mm.ui.widget.MMProcessBar f124468f;
    ...
    public void f(on5.f refreshLayout, int i17, int i18) {
        kotlin.jvm.internal.o.g(refreshLayout, "refreshLayout");
        com.tencent.mm.ui.widget.MMProcessBar mMProcessBar = this.f124468f;
    ...
    public void g(on5.f refreshLayout, sn5.b oldState, sn5.b newState) {
        ...
        if (ordinal == 3 || ordinal == 5) {
            android.widget.TextView textView = this.f124466d;
            if (textView == null) {
                kotlin.jvm.internal.o.o("mHeaderText");
                throw null;
            }
            textView.setText("下拉开始刷新");
            com.tencent.mm.ui.widget.imageview.WeImageView weImageView = this.f124467e;
            if (weImageView == null) {
            ...
            com.tencent.mm.ui.widget.imageview.WeImageView weImageView2 = this.f124467e;
        ...
        if (ordinal != 10) {
            ...
            android.widget.TextView textView2 = this.f124466d;
            if (textView2 == null) {
                kotlin.jvm.internal.o.o("mHeaderText");
                throw null;
            }
            textView2.setText("释放立即刷新");
            com.tencent.mm.ui.widget.imageview.WeImageView weImageView3 = this.f124467e;
        ...
        android.widget.TextView textView3 = this.f124466d;
        if (textView3 == null) {
            kotlin.jvm.internal.o.o("mHeaderText");
            throw null;
        }
        textView3.setText("正在刷新");
        com.tencent.mm.ui.widget.MMProcessBar mMProcessBar2 = this.f124468f;
        if (mMProcessBar2 == null) {
            kotlin.jvm.internal.o.o("mProgressView");
            throw null;
        }
        mMProcessBar2.setVisibility(0);
        com.tencent.mm.ui.widget.imageview.WeImageView weImageView4 = this.f124467e;
    ...
    public final void j() {
        android.view.View.inflate(getContext(), com.tencent.mm.R.layout.b6u, this);
        android.view.View findViewById = findViewById(com.tencent.mm.R.id.crr);
        kotlin.jvm.internal.o.f(findViewById, "findViewById(...)");
        this.f124466d = (android.widget.TextView) findViewById;
        android.view.View findViewById2 = findViewById(com.tencent.mm.R.id.a4s);
        kotlin.jvm.internal.o.f(findViewById2, "findViewById(...)");
        this.f124467e = (com.tencent.mm.ui.widget.imageview.WeImageView) findViewById2;
        android.view.View findViewById3 = findViewById(com.tencent.mm.R.id.f485683im4);
        kotlin.jvm.internal.o.f(findViewById3, "findViewById(...)");
        this.f124468f = (com.tencent.mm.ui.widget.MMProcessBar) findViewById3;
    }
