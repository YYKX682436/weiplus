...
public final class m20 extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.viewmodel.component.f50 f135117d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m20(com.tencent.mm.plugin.finder.viewmodel.component.f50 f50Var) {
        super(0);
        this.f135117d = f50Var;
    }

    @Override // yz5.a
    public java.lang.Object invoke() {
        android.view.View findViewById = this.f135117d.findViewById(com.tencent.mm.R.id.mle);
        ...
        if (textView != null) {
            textView.setText(findViewById.getResources().getString(com.tencent.mm.R.string.enr));
        }
        return findViewById;
    }
}
