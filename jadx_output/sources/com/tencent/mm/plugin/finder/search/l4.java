...
public final class l4 {
    ...
    public static r45.b31 f125763c;

    /* renamed from: a, reason: collision with root package name */
    public static final com.tencent.mm.plugin.finder.search.l4 f125761a = new com.tencent.mm.plugin.finder.search.l4();

    /* renamed from: b, reason: collision with root package name */
    public static final int f125762b = i65.a.B(com.tencent.mm.sdk.platformtools.x2.f193071a) - i65.a.b(com.tencent.mm.sdk.platformtools.x2.f193071a, 72);

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.concurrent.ConcurrentHashMap f125764d = new java.util.concurrent.ConcurrentHashMap();
    ...
    public final android.text.Spanned b(java.lang.String origin, android.text.TextPaint textPaint, int i17, java.lang.String highLightFontColor, boolean z17) {
        ...
        kotlin.jvm.internal.o.g(highLightFontColor, "highLightFontColor");
        ...
        if (fromHtml instanceof android.text.SpannableStringBuilder) {
            ...
            if (foregroundColorSpanArr != null) {
                for (android.text.style.ForegroundColorSpan foregroundColorSpan : foregroundColorSpanArr) {
                    ...
                    sb6.append(' ');
                    sb6.append(spanEnd);
                    com.tencent.mars.xlog.Log.i("Finder.Hightlight", sb6.toString());
                }
            }
        }
        kotlin.jvm.internal.o.d(fromHtml);
        return fromHtml;
    }
