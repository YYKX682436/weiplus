...
public final class c1 implements android.view.View.OnKeyListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.uniComments.TextStatusCommentFooter f130212d;

    public c1(com.tencent.mm.plugin.finder.uniComments.TextStatusCommentFooter textStatusCommentFooter) {
        this.f130212d = textStatusCommentFooter;
    }
    ...
    public final boolean onKey(android.view.View view, int i17, android.view.KeyEvent keyEvent) {
        ...
        if (i17 == 67 && keyEvent.getAction() == 0) {
            com.tencent.mm.plugin.finder.uniComments.TextStatusCommentFooter textStatusCommentFooter = this.f130212d;
            int selectionEnd = textStatusCommentFooter.getEditText().getSelectionEnd();
            android.text.Editable text = textStatusCommentFooter.getEditText().getText();
            if (text != null) {
            ...
            if (kotlin.jvm.internal.o.b(java.lang.String.valueOf(charSequence), "\u2005")) {
                ...
                textStatusCommentFooter.getEditText().setText(textStatusCommentFooter.getEditText().getText().replace(i18, selectionEnd, ""));
                textStatusCommentFooter.getEditText().setSelection(i18);
