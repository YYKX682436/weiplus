...
public final class u implements o13.x {
    ...
    public final ym3.c f128911d;

    /* renamed from: e, reason: collision with root package name */
    public final u26.k0 f128912e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.finder.ui.at.FinderAtSomeoneSearchDataSource f128913f;

    public u(com.tencent.mm.plugin.finder.ui.at.FinderAtSomeoneSearchDataSource finderAtSomeoneSearchDataSource, ym3.c request, u26.k0 channel) {
        kotlin.jvm.internal.o.g(request, "request");
        kotlin.jvm.internal.o.g(channel, "channel");
        this.f128913f = finderAtSomeoneSearchDataSource;
        this.f128911d = request;
        this.f128912e = channel;
    }
    ...
    public void X2(p13.v vVar) {
        int i17;
        if (vVar != null) {
            if ((kotlin.jvm.internal.o.b(vVar.f351157b, this.f128913f.f128874e) ? vVar : null) != null) {
                int i18 = vVar.f351158c;
                u26.k0 k0Var = this.f128912e;
                if (i18 != 0) {
                    u26.s.a(k0Var, null, 1, null);
                    return;
                }
                ym3.d dVar = new ym3.d(this.f128911d);
