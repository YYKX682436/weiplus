...
public final class ti extends kotlin.jvm.internal.q implements yz5.a {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.view.manager.FinderLinearLayoutManager f129883d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ androidx.recyclerview.widget.RecyclerView f129884e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI f129885f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ long f129886g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ float f129887h;

    /* renamed from: i, reason: collision with root package name */
    public final /* synthetic */ boolean f129888i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ti(com.tencent.mm.plugin.finder.view.manager.FinderLinearLayoutManager finderLinearLayoutManager, androidx.recyclerview.widget.RecyclerView recyclerView, com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI finderShareFeedRelUI, long j17, float f17, boolean z17) {
        super(0);
        this.f129883d = finderLinearLayoutManager;
        this.f129884e = recyclerView;
        this.f129885f = finderShareFeedRelUI;
        this.f129886g = j17;
        this.f129887h = f17;
        this.f129888i = z17;
    }
    ...
    public java.lang.Object invoke() {
        ...
        in5.c cVar;
        androidx.recyclerview.widget.k3 p07 = this.f129884e.p0(this.f129883d.w());
        ...
        com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI finderShareFeedRelUI = this.f129885f;
        long j17 = this.f129886g;
        if (z18) {
            com.tencent.mars.xlog.Log.i(finderShareFeedRelUI.C, "checkSeek: video feedId=" + pm0.v.u(itemId) + " seekTime=" + j17 + " playSpeedRatio:" + this.f129887h + " afterSeekPlay:" + this.f129888i);
            ...
            if (finderVideoLayout2 != null) {
                long j18 = this.f129886g;
                float f17 = this.f129887h;
                boolean z19 = this.f129888i;
                com.tencent.mm.plugin.finder.ui.si siVar = new com.tencent.mm.plugin.finder.ui.si(this.f129885f, itemId, z19, s0Var);
            ...
            if (z17 && j17 > 0) {
                com.tencent.mars.xlog.Log.i(finderShareFeedRelUI.C, "[checkSeek] photo feedId=" + pm0.v.u(itemId) + " seekTime=" + j17);
