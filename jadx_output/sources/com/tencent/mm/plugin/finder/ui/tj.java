...
public final class tj implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI f129889d;

    public tj(com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI finderShareFeedRelUI) {
        this.f129889d = finderShareFeedRelUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.finder.ui.FinderShareFeedRelUI finderShareFeedRelUI = this.f129889d;
        finderShareFeedRelUI.f128814p = false;
        finderShareFeedRelUI.onBackPressed();
        finderShareFeedRelUI.f128814p = true;
