...
public final class f extends com.tencent.mm.plugin.finder.feed.model.internal.h {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.ui.fav.FinderGlobalFavLoader f129165a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(com.tencent.mm.plugin.finder.ui.fav.FinderGlobalFavLoader finderGlobalFavLoader) {
        super(finderGlobalFavLoader, false, 1, null);
        this.f129165a = finderGlobalFavLoader;
    }
    ...
    public void mergeRefresh(com.tencent.mm.plugin.finder.feed.model.internal.IResponse response, yz5.l lVar) {
        ...
        com.tencent.mm.plugin.finder.ui.fav.FinderGlobalFavLoader finderGlobalFavLoader = this.f129165a;
        com.tencent.mars.xlog.Log.i(finderGlobalFavLoader.getB(), "[onFetchRefreshDone]  reason=" + s3Var);
        java.util.List incrementList = response.getIncrementList();
        int size = incrementList != null ? incrementList.size() : 0;
        if (response.getHasMore()) {
            if (size <= finderGlobalFavLoader.getDataList().size()) {
                i17 = 2;
            }
        } else if (finderGlobalFavLoader.getDataList().size() == 0 || size == 0 || finderGlobalFavLoader.getDataList().size() <= size) {
            java.util.List incrementList2 = response.getIncrementList();
            if (incrementList2 != null && incrementList2.containsAll(kz5.n0.S0(finderGlobalFavLoader.getDataList()))) {
                i17 = 6;
            }
        }
        pm0.v.X(new com.tencent.mm.plugin.finder.ui.fav.e(this, new com.tencent.mm.plugin.finder.feed.model.internal.y0(i17, response.getIncrementList(), response.getIsNeedClear(), null, 8, null), s3Var, this.f129165a, lVar, response));
    }
}
