...
public final class d1 extends kotlin.jvm.internal.q implements yz5.l {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.playlist.s1 f122280d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d1(com.tencent.mm.plugin.finder.playlist.s1 s1Var) {
        super(1);
        this.f122280d = s1Var;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj) {
        ...
        java.util.Iterator it = this.f122280d.f122422b.f122296a.iterator();
        while (true) {
            if (!it.hasNext()) {
                obj2 = null;
                break;
