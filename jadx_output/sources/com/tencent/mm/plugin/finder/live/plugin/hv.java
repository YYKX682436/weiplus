...
public final class hv implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.plugin.iv f112871d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.protocal.protobuf.FinderJumpInfo f112872e;

    public hv(com.tencent.mm.plugin.finder.live.plugin.iv ivVar, com.tencent.mm.protocal.protobuf.FinderJumpInfo finderJumpInfo) {
        this.f112871d = ivVar;
        this.f112872e = finderJumpInfo;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.protocal.protobuf.FinderJumpInfo finderJumpInfo = this.f112872e;
        jSONObject.put("report_info", finderJumpInfo.getReport_info());
        zy2.zb.y6(zbVar, z4Var, jSONObject.toString(), null, 4, null);
        com.tencent.mm.plugin.finder.live.plugin.iv ivVar = this.f112871d;
        ivVar.y1();
        df2.nm nmVar = (df2.nm) ivVar.R0().getController(df2.nm.class);
        if (nmVar != null) {
