...
public final class pc implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.view.rc f116592d;

    public pc(com.tencent.mm.plugin.finder.live.view.rc rcVar) {
        this.f116592d = rcVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.finder.live.view.rc rcVar = this.f116592d;
        yz5.a aVar = rcVar.f116660i;
        if (aVar != null) {
            aVar.invoke();
        }
        rcVar.a();
