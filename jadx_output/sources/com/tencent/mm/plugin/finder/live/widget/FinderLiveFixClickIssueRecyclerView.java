...
public final class FinderLiveFixClickIssueRecyclerView extends androidx.recyclerview.widget.RecyclerView {
    ...
    public FinderLiveFixClickIssueRecyclerView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        if (this.animating) {
            com.tencent.mars.xlog.Log.e("FinderLiveFixClickIssueRecyclerView", "view is animating,dispatchTouchEvent consumed!!!");
            return true;
        }
    ...
    public final void setConsumedTouchEnvent(boolean z17) {
        if (z17 != this.consumedTouchEnvent) {
            com.tencent.mars.xlog.Log.i("FinderLiveFixClickIssueRecyclerView", "set consumedTouchEnvent " + z17);
        }
        this.consumedTouchEnvent = z17;
    }

    public final void setTouchEventListener(yz5.l lVar) {
