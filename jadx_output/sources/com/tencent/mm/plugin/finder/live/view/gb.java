...
public final class gb extends com.tencent.mm.plugin.finder.live.widget.e0 {
    public final java.lang.String H;
    public android.view.View I;

    /* renamed from: J, reason: collision with root package name */
    public android.view.View f116334J;
    ...
    public static final void e0(com.tencent.mm.plugin.finder.live.view.gb gbVar, java.lang.String str) {
        com.tencent.mm.plugin.webview.ui.tools.widget.q1 K2;
        if (gbVar.f118183e.getResources().getConfiguration().orientation == 2) {
            i95.m c17 = i95.n0.c(zg0.u2.class);
            kotlin.jvm.internal.o.f(c17, "getService(...)");
            K2 = zg0.u2.K2((zg0.u2) c17, gbVar.f118183e, str, null, new com.tencent.mm.plugin.webview.ui.tools.widget.n1(1.0f, 0.0f, null, false, false, 1, false, false, 0, false, false, 0, false, false, false, null, false, 0, false, 2, false, false, false, 7864014, null), 4, null);
        } else {
            i95.m c18 = i95.n0.c(zg0.u2.class);
            kotlin.jvm.internal.o.f(c18, "getService(...)");
            K2 = zg0.u2.K2((zg0.u2) c18, gbVar.f118183e, str, null, new com.tencent.mm.plugin.webview.ui.tools.widget.n1(0.0f, 0.0f, null, false, false, 1, false, false, 1, false, false, 0, false, false, false, null, false, 0, false, 2, false, false, false, 7864015, null), 4, null);
        }
        ((com.tencent.mm.plugin.webview.ui.tools.widget.m1) K2).show();
    }

    @Override // com.tencent.mm.plugin.finder.live.widget.e0
    public int A() {
        return com.tencent.mm.R.layout.axk;
    }
    ...
    public void N(android.view.View rootView) {
        ...
        this.I = rootView.findViewById(com.tencent.mm.R.id.fhp);
        this.f116334J = rootView.findViewById(com.tencent.mm.R.id.fhy);
        this.K = (android.widget.TextView) rootView.findViewById(com.tencent.mm.R.id.fhz);
        this.L = (android.view.ViewGroup) rootView.findViewById(com.tencent.mm.R.id.fji);
        this.M = (android.view.ViewGroup) rootView.findViewById(com.tencent.mm.R.id.fiw);
        this.N = (android.view.ViewGroup) rootView.findViewById(com.tencent.mm.R.id.fix);
        this.Q = rootView.findViewById(com.tencent.mm.R.id.fhs);
        android.view.View view = this.I;
        if (view != null) {
            view.setOnClickListener(new com.tencent.mm.plugin.finder.live.view.bb(this));
        }
        android.view.View view2 = this.f116334J;
        if (view2 != null) {
            view2.setOnClickListener(com.tencent.mm.plugin.finder.live.view.cb.f116232d);
        }
    ...
    */
    public final void f0(wt2.a r26, r45.jg1 r27, java.util.LinkedList r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.live.view.gb.f0(wt2.a, r45.jg1, java.util.LinkedList):void");
    }

    public final void g0(android.view.View view) {
        android.view.View findViewById = view.findViewById(com.tencent.mm.R.id.hix);
        android.view.View findViewById2 = view.findViewById(com.tencent.mm.R.id.hiy);
        android.view.View findViewById3 = view.findViewById(com.tencent.mm.R.id.hh7);
    ...
    public final void h0(android.view.View view, long j17) {
        ...
        if (findViewById2 != null) {
            findViewById2.setOnClickListener(new com.tencent.mm.plugin.finder.live.view.fb(view, this, j17));
        }
        if (findViewById != null) {
            java.util.ArrayList arrayList2 = new java.util.ArrayList();
            java.lang.ThreadLocal threadLocal2 = zj0.c.f473285a;
