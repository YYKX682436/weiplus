...
public final class l extends ym3.a {
    ...
    public java.util.ArrayList f115415d;

    public l() {
        jz5.h.b(com.tencent.mm.plugin.finder.live.ui.at.k.f115414d);
    }
    ...
    public kotlinx.coroutines.flow.j a(v65.i scope, ym3.c request) {
        ...
        java.util.ArrayList arrayList = this.f115415d;
        if (arrayList != null) {
    ...
    public void onCreate() {
        this.f115415d = new java.util.ArrayList();
        ...
        java.util.ArrayList arrayList2 = this.f115415d;
