...
public final class AutoScaledContainerView extends android.view.ViewGroup {
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AutoScaledContainerView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public AutoScaledContainerView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
