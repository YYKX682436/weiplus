...
public final class h7 extends com.tencent.mm.plugin.finder.live.widget.e0 implements android.view.View.OnClickListener {
    public final gk2.e H;
    public final te2.j0 I;

    /* renamed from: J, reason: collision with root package name */
    public android.widget.TextView f118550J;
    ...
    public final androidx.recyclerview.widget.g1 S;
    ...
    public h7(android.content.Context context, gk2.e liveData, te2.j0 j0Var) {
        ...
        this.I = j0Var;
        this.R = new bm2.t();
        this.S = new androidx.recyclerview.widget.g1(new com.tencent.mm.plugin.finder.live.widget.f7(this));
    }

    @Override // com.tencent.mm.plugin.finder.live.widget.e0
    public int A() {
        return com.tencent.mm.R.layout.amh;
    }
    ...
    public void N(android.view.View rootView) {
        ...
        android.widget.TextView textView = (android.widget.TextView) rootView.findViewById(com.tencent.mm.R.id.jyu);
        if (textView != null) {
            com.tencent.mm.ui.fk.a(textView);
        }
        this.f118550J = (android.widget.TextView) rootView.findViewById(com.tencent.mm.R.id.jyn);
        this.K = (android.widget.TextView) rootView.findViewById(com.tencent.mm.R.id.jyr);
        this.L = (com.tencent.mm.view.recyclerview.WxRecyclerView) rootView.findViewById(com.tencent.mm.R.id.jyt);
        this.M = rootView.findViewById(com.tencent.mm.R.id.elu);
        this.N = (android.widget.CheckBox) rootView.findViewById(com.tencent.mm.R.id.jyo);
        this.P = (android.widget.TextView) rootView.findViewById(com.tencent.mm.R.id.jyq);
        this.Q = (android.widget.ProgressBar) rootView.findViewById(com.tencent.mm.R.id.jys);
        android.widget.TextView textView2 = this.f118550J;
        if (textView2 != null) {
    ...
    public final void f0(boolean z17) {
        ...
        com.tencent.mm.view.recyclerview.WxRecyclerView wxRecyclerView2 = this.L;
    ...
    public final void g0(boolean z17, com.tencent.mm.plugin.finder.live.widget.e0 e0Var) {
        if (!z17) {
            java.util.Iterator it = this.R.f22298m.iterator();
            while (it.hasNext()) {
                ((dk2.vg) it.next()).f234258e = false;
            }
        ...
        te2.j0 j0Var = this.I;
        if (j0Var != null) {
            te2.l0.A0(j0Var, true, null, new com.tencent.mm.plugin.finder.live.widget.g7(this, e0Var), 2, null);
        }
    }
    ...
    public final void h0() {
        ...
        java.util.List songIdList = ((mm2.c1) eVar.a(mm2.c1.class)).Z6().f233876e;
        java.util.ArrayList dataList = ((mm2.c1) eVar.a(mm2.c1.class)).Z6().f233877f;
        dk2.vg d17 = ((mm2.c1) eVar.a(mm2.c1.class)).Z6().d();
        bm2.t tVar = this.R;
        tVar.getClass();
        kotlin.jvm.internal.o.g(songIdList, "songIdList");
        kotlin.jvm.internal.o.g(dataList, "dataList");
        java.util.ArrayList arrayList = tVar.f22299n;
        arrayList.clear();
        arrayList.add(tVar.f22300o);
        java.util.List list = tVar.f22297i;
        list.clear();
        list.addAll(songIdList);
        java.util.ArrayList arrayList2 = tVar.f22298m;
        arrayList2.clear();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x0216, code lost:
        ...
        r2.append(r0);
        r2.append(", pos:");
        r1 = (java.lang.Number) r1.f302834e;
        r2.append(r1.intValue());
        com.tencent.mars.xlog.Log.i("FinderLiveAnchorMusicEditWidget", r2.toString());
        r2 = r23;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:89:0x029c, code lost:
        ...
        ((te2.p1) r20).s(((te2.p1) r20).f418297r);
     */
    /* JADX WARN: Code restructure failed: missing block: B:90:0x02a9, code lost:
        ...
        r2 = r31;
        r2.g0(false, null);
        r22 = ((mm2.e1) r15.a(mm2.e1.class)).f328988r.getLong(0);
        r3 = ((mm2.e1) r15.a(mm2.e1.class)).f328985o;
        r25 = xy2.c.e(r2.f118183e);
        r12 = ((mm2.e1) r15.a(mm2.e1.class)).f328983m;
    ...
    */
    public void onClick(android.view.View r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.finder.live.widget.h7.onClick(android.view.View):void");
    }
}
