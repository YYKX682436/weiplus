...
public final class FinderLiveFeedDanmakuNativeView extends com.tencent.mm.danmaku.render.NativeDanmakuView implements cg2.k {
    ...
    public FinderLiveFeedDanmakuNativeView(android.content.Context context) {
        super(context);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinderLiveFeedDanmakuNativeView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinderLiveFeedDanmakuNativeView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
