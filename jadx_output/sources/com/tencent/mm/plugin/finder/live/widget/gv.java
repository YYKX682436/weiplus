...
public final class gv implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.widget.sv f118478d;

    public gv(com.tencent.mm.plugin.finder.live.widget.sv svVar) {
        this.f118478d = svVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        yz5.a aVar = this.f118478d.f119847h;
        if (aVar != null) {
            aVar.invoke();
        }
