...
public final class oc implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.view.rc f116568d;

    public oc(com.tencent.mm.plugin.finder.live.view.rc rcVar) {
        this.f116568d = rcVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.finder.live.view.rc rcVar = this.f116568d;
        yz5.a aVar = rcVar.f116659h;
        if (aVar != null) {
            aVar.invoke();
        }
        rcVar.a();
