...
public final class PassThroughScrollView extends android.widget.ScrollView {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public boolean passThroughTouch;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public PassThroughScrollView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public PassThroughScrollView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
