...
public final class mx implements db5.t4 {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.plugin.ty f113569d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ yz5.a f113570e;

    public mx(com.tencent.mm.plugin.finder.live.plugin.ty tyVar, yz5.a aVar) {
        this.f113569d = tyVar;
        this.f113570e = aVar;
    }
    ...
    public final void onMMMenuItemSelected(android.view.MenuItem menuItem, int i17) {
        ...
        com.tencent.mm.plugin.finder.live.plugin.ty tyVar = this.f113569d;
        if (itemId != tyVar.f114491t) {
            com.tencent.mm.ui.widget.dialog.k0 k0Var = tyVar.X;
            if (k0Var != null) {
                k0Var.u();
                return;
            }
        ...
        this.f113570e.invoke();
        com.tencent.mm.ui.widget.dialog.k0 k0Var2 = tyVar.X;
        if (k0Var2 != null) {
            k0Var2.u();
        }
