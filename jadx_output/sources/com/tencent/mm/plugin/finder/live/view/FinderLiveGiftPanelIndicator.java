...
public final class FinderLiveGiftPanelIndicator extends android.widget.LinearLayout {

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.String f115933d;
    ...
    public FinderLiveGiftPanelIndicator(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        kotlin.jvm.internal.o.g(context, "context");
        kotlin.jvm.internal.o.g(attrs, "attrs");
        this.f115933d = "FinderLiveGiftPanelIndicator";
        int dimensionPixelOffset = com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getDimensionPixelOffset(com.tencent.mm.R.dimen.f479646bl);
        this.INDICATOR_W = dimensionPixelOffset;
        this.INDICATOR_H = dimensionPixelOffset;
        this.INDICATOR_MARGIN = com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getDimensionPixelOffset(com.tencent.mm.R.dimen.f479644bj);
    ...
    public final java.util.ArrayList<android.widget.ImageView> getIndicatorList() {
        return this.indicatorList;
    }

    public final void setCurrentChoosedIndicator(int i17) {
        java.util.ArrayList arrayList = this.indicatorList;
        int size = arrayList.size();
        for (int i18 = 0; i18 < size; i18++) {
            if (i18 == i17) {
                ((android.widget.ImageView) arrayList.get(i18)).setImageResource(com.tencent.mm.R.drawable.a4j);
            } else {
                ((android.widget.ImageView) arrayList.get(i18)).setImageResource(com.tencent.mm.R.drawable.f481777a81);
            }
        }
    }

    public final void setIndicatorSize(int i17) {
        removeAllViews();
        java.util.ArrayList arrayList = this.indicatorList;
        arrayList.clear();
        com.tencent.mars.xlog.Log.i(this.f115933d, "setIndicatorSize indicatorSize:" + i17);
        if (i17 < 2) {
            return;
        }
        for (int i18 = 0; i18 < i17; i18++) {
            ...
            imageView.setImageResource(com.tencent.mm.R.drawable.f481777a81);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinderLiveGiftPanelIndicator(android.content.Context context, android.util.AttributeSet attrs, int i17) {
