...
public final class na implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.view.gb f116530d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ int f116531e;

    public na(com.tencent.mm.plugin.finder.live.view.gb gbVar, int i17) {
        this.f116530d = gbVar;
        this.f116531e = i17;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        yz5.p pVar = this.f116530d.W;
        if (pVar != null) {
            pVar.invoke(999, java.lang.Integer.valueOf(this.f116531e));
        }
