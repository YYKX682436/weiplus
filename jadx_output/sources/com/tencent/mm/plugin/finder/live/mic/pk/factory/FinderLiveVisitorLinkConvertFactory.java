...
public final class FinderLiveVisitorLinkConvertFactory implements in5.s {
    private final si2.c callback;
    private final gk2.e liveData;

    public FinderLiveVisitorLinkConvertFactory(gk2.e liveData, si2.c callback) {
    ...
    public in5.r getItemConvert(int type) {
        return type == 1 ? new ti2.o(this.liveData, this.callback) : type == 2 ? new ti2.p(this.liveData, this.callback) : type == 3 ? new ti2.q(this.liveData, this.callback) : type == 4 ? new ti2.l(this.liveData, this.callback) : type == -10000 ? new ti2.h() : type == 5 ? new ti2.g(this.liveData, this.callback) : createFinderEmptyConvert();
    }
