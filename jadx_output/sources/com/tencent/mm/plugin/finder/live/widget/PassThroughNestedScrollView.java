...
public final class PassThroughNestedScrollView extends androidx.core.widget.NestedScrollView {

    /* renamed from: K, reason: from kotlin metadata */
    public boolean passThroughTouch;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public PassThroughNestedScrollView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final void setPassThroughTouch(boolean z17) {
        this.passThroughTouch = z17;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PassThroughNestedScrollView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
