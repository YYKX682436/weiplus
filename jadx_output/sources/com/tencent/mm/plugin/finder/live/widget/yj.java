...
public final class yj implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.widget.dk f120450d;

    public yj(com.tencent.mm.plugin.finder.live.widget.dk dkVar) {
        this.f120450d = dkVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.view.View.OnClickListener mListener = this.f120450d.getMListener();
        if (mListener != null) {
