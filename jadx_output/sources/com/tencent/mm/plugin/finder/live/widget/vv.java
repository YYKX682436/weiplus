...
public final class vv implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.finder.live.widget.wv f120106d;

    public vv(com.tencent.mm.plugin.finder.live.widget.wv wvVar) {
        this.f120106d = wvVar;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        sf2.d3 d3Var = (sf2.d3) this.f120106d.f120236a.getController(sf2.d3.class);
        if (d3Var != null) {
            d3Var.v7(fn2.u1.f264410e, -1);
        }
