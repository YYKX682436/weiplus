...
public final class FinderLiveEmojiView extends com.tencent.mm.emoji.view.EmojiStatusView {

    /* renamed from: r, reason: collision with root package name */
    public final java.lang.String f115844r;
    ...
    public FinderLiveEmojiView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        kotlin.jvm.internal.o.g(context, "context");
        this.f115844r = "MicroMsg.FinderLiveEmojiView";
        this.emojiMaxSize = context.getResources().getDimensionPixelSize(com.tencent.mm.R.dimen.f479731dn);
        ...
        com.tencent.mm.plugin.finder.live.view.v3 v3Var = new com.tencent.mm.plugin.finder.live.view.v3(this);
    ...
    public void onAttachedToWindow() {
        ...
        com.tencent.mars.xlog.Log.i(this.f115844r, sb6.toString());
        getDelegate().reload();
    }
    ...
    public FinderLiveEmojiView(android.content.Context context, android.util.AttributeSet attributeSet) {
