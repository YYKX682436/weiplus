...
public abstract class s0 {
    public static boolean a(android.app.Activity activity) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FaceUtils", "summerper checkPermission checkCamera[%b], stack[%s], activity[%s]", valueOf, new com.tencent.mm.sdk.platformtools.z3(), activity);
        return a17;
    }
    ...
    public static boolean b(android.app.Activity activity) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FaceUtils", "hy: above 23 and no permission. requesting...");
    ...
    public static boolean c(boolean z17) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(g17) || com.tencent.mm.sdk.platformtools.t8.K0(concat2)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FaceUtils", "hy: not valid model path. start ");
            return false;
        }
        com.tencent.mm.vfs.z7 a17 = com.tencent.mm.vfs.z7.a(g17);
        java.lang.String str10 = a17.f213279f;
        if (str10 != null) {
            java.lang.String l17 = com.tencent.mm.vfs.e8.l(str10, false, false);
            if (!str10.equals(l17)) {
                a17 = new com.tencent.mm.vfs.z7(a17.f213277d, a17.f213278e, l17, a17.f213280g, a17.f213281h);
            }
        }
        com.tencent.mm.vfs.z7 a18 = com.tencent.mm.vfs.z7.a(concat2);
        java.lang.String str11 = a18.f213279f;
        if (str11 != null) {
            java.lang.String l18 = com.tencent.mm.vfs.e8.l(str11, false, false);
            if (!str11.equals(l18)) {
        ...
        if (!(!m17.a() ? false : m17.f213266a.F(m17.f213267b)) && !k(0)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.FaceUtils", "hy: no detect model in storage and sdcard");
            z18 = false;
        }
        com.tencent.mm.vfs.z2 m18 = b3Var.m(a18, null);
        if ((!m18.a() ? false : m18.f213266a.F(m18.f213267b)) || k(1)) {
            return z18;
        }
        com.tencent.mars.xlog.Log.e("MicroMsg.FaceUtils", "hy: no alignment model in storage and sdcard");
        return false;
    }
    ...
    */
    public static void d(android.content.Context r11, java.lang.String r12, java.lang.String r13) {
        ...
        L15:
            r0 = 0
            r1 = 0
            java.lang.String r3 = com.tencent.mm.vfs.w6.r(r13)     // Catch: java.lang.Throwable -> La9 java.lang.Exception -> Lac
            com.tencent.mm.vfs.w6.u(r3)     // Catch: java.lang.Throwable -> La9 java.lang.Exception -> Lac
            com.tencent.mm.vfs.z7 r13 = com.tencent.mm.vfs.z7.a(r13)     // Catch: java.lang.Throwable -> La3 java.lang.Exception -> La6
            java.lang.String r3 = r13.f213279f
            if (r3 == 0) goto L3f
            java.lang.String r7 = com.tencent.mm.vfs.e8.l(r3, r0, r0)     // Catch: java.lang.Throwable -> La3 java.lang.Exception -> La6
            ...
            java.lang.String r5 = r13.f213277d     // Catch: java.lang.Throwable -> La3 java.lang.Exception -> La6
            java.lang.String r6 = r13.f213278e     // Catch: java.lang.Throwable -> La3 java.lang.Exception -> La6
            java.lang.String r8 = r13.f213280g     // Catch: java.lang.Throwable -> La3 java.lang.Exception -> La6
            java.lang.String r9 = r13.f213281h     // Catch: java.lang.Throwable -> La3 java.lang.Exception -> La6
            r4 = r3
        ...
        L3f:
            ...
            com.tencent.mm.vfs.b3 r3 = com.tencent.mm.vfs.a3.f212781a     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
            com.tencent.mm.vfs.z2 r3 = r3.m(r13, r1)     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
            java.io.OutputStream r1 = com.tencent.mm.vfs.w6.I(r13, r3, r0)     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
        ...
        L60:
            ...
            com.tencent.mm.vfs.b3 r12 = com.tencent.mm.vfs.a3.f212781a     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
            ...
            goto L86
        L79:
            com.tencent.mm.vfs.q2 r13 = r12.f213266a     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
            java.lang.String r12 = r12.f213267b     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
            com.tencent.mm.vfs.x1 r12 = r13.m(r12)     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
            if (r12 != 0) goto L84
            goto L86
        L84:
            long r6 = r12.f213233c     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
        L86:
            ...
            com.tencent.mars.xlog.Log.i(r2, r4, r5)     // Catch: java.lang.Throwable -> L97 java.lang.Exception -> L99
        ...
        Lae:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r2, r12, r13, r0)     // Catch: java.lang.Throwable -> Lc0
            if (r1 == 0) goto Lba
            r1.close()     // Catch: java.lang.Exception -> Lbf
        Lba:
            if (r11 == 0) goto Lbf
        ...
        Lcc:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.facedetect.model.s0.d(android.content.Context, java.lang.String, java.lang.String):void");
    }

    public static java.lang.Boolean e(java.lang.String str, java.lang.String str2) {
        com.tencent.mars.xlog.Log.i("MicroMsg.FaceUtils", "SDPath: " + str + " assetPath: " + str2);
        ((k30.a) ((l30.h) i95.n0.c(l30.h.class))).getClass();
        byte[] bArr = com.tencent.mm.plugin.expansions.i0.f99751a;
        java.lang.String str3 = com.tencent.mm.sdk.platformtools.z.f193105a;
        d(com.tencent.mm.sdk.platformtools.x2.f193071a, str2, str);
        return java.lang.Boolean.valueOf(com.tencent.mm.vfs.w6.j(str));
    }
    ...
    public static java.lang.String h() {
        ...
        if (!(m17.a() ? m17.f213266a.F(m17.f213267b) : false)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.FaceUtils", "hy: face dir not exist. mk dir");
    ...
    public static android.graphics.Bitmap i(java.lang.String str) {
        try {
            ...
            java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
            sb6.append(com.tencent.mm.plugin.facedetect.model.a.f99985a);
            ...
            if (!(!m17.a() ? false : m17.f213266a.F(m17.f213267b))) {
                com.tencent.mars.xlog.Log.w("MicroMsg.FaceUtils", "hy: no last file. return");
                return null;
            }
            byte[] N = com.tencent.mm.vfs.w6.N(sb7, 0, -1);
            if (N == null) {
                com.tencent.mars.xlog.Log.w("MicroMsg.FaceUtils", "hy: nothing in file");
                return null;
            }
            byte[] a18 = com.tencent.mm.plugin.facedetect.model.r0.a(N, j(str));
            if (a18.length > 0) {
                return android.graphics.BitmapFactory.decodeByteArray(a18, 0, a18.length);
            }
            com.tencent.mars.xlog.Log.w("MicroMsg.FaceUtils", "hy: decrypt err. return null");
            return null;
    ...
    public static boolean k(int i17) {
        ...
        java.lang.String a17 = i17 != 0 ? i17 != 1 ? "" : c01.b9.f37069c.a("LAST_LOGIN_FACE_MODEL_SDCARD_PATH_ALIGNMENT", "") : c01.b9.f37069c.a("LAST_LOGIN_FACE_MODEL_SDCARD_PATH_DETECT", "");
        if (com.tencent.mm.sdk.platformtools.t8.K0(a17)) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FaceUtils", "hy: no such path for type: %d", java.lang.Integer.valueOf(i17));
            return false;
        }
        ...
        if (!(!m17.a() ? false : m17.f213266a.F(m17.f213267b))) {
            com.tencent.mars.xlog.Log.e("MicroMsg.FaceUtils", "originFile file not exist");
            return false;
        }
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6(i17 != 0 ? i17 != 1 ? "" : h().concat("/ufat.bin") : g());
        if (r6Var.m()) {
            r6Var.l();
        }
        if (i17 == 0) {
        ...
        com.tencent.mm.vfs.w6.c(a17, str);
        return true;
    }
    ...
    public static void l(byte[] bArr, java.lang.String str) {
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.FaceUtils", e17, "hy: err in save debug jpeg", new java.lang.Object[0]);
        }
    }
    ...
    public static android.graphics.Bitmap m(android.content.Context context, java.lang.String str, android.graphics.Bitmap bitmap) {
        ...
        if (bitmap == null) {
            ...
            com.tencent.mars.xlog.Log.e("pix", width + " " + height + " " + i17);
            ...
            while (true) {
                ...
                if (i37 >= height) {
                    ...
                    while (i48 < width) {
                        int i49 = (-30) * width;
                        if (!com.tencent.mm.plugin.facedetect.model.r.a(currentTimeMillis2)) {
                            int i57 = height;
                            int[] iArr10 = iArr6;
                            int i58 = -30;
                            int i59 = 0;
                    ...
                    z17 = false;
                    z18 = true;
                    com.tencent.mars.xlog.Log.e(str3, width + " " + height + " " + i47);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FaceUtils", "hy: blur using %d", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - j17));
        if (bitmap2 == null) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FaceUtils", "hy: null on blur. use default");
            bitmap2 = i(str);
            if (bitmap2 == null) {
                bitmap2 = com.tencent.mm.sdk.platformtools.x.c0(com.tencent.mm.R.drawable.c1r);
            }
            z19 = z17;
        } else {
            z19 = z18;
        ...
        if (z19) {
            ((ku5.t0) ku5.t0.f312615d).q(new com.tencent.mm.plugin.facedetect.model.q0(bitmap2, str));
        }
        return bitmap2;
    }
}
