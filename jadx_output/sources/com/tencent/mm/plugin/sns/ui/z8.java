...
public class z8 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.sns.ui.SightVideoFullScreenView f171683d;

    public z8(com.tencent.mm.plugin.sns.ui.SightVideoFullScreenView sightVideoFullScreenView) {
        this.f171683d = sightVideoFullScreenView;
    }

    @Override // java.lang.Runnable
    public void run() {
        com.tencent.mm.plugin.sns.ui.SightVideoFullScreenView sightVideoFullScreenView = this.f171683d;
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("run", "com.tencent.mm.plugin.sns.ui.SightVideoFullScreenView$4");
        try {
            com.tencent.mars.xlog.Log.i("SightVideoFullScreenView", "sightVideoStartPlay");
            com.tencent.mm.plugin.sns.ui.SightVideoFullScreenView.b(sightVideoFullScreenView).m();
            ...
            sightVideoFullScreenView.z();
        } catch (java.lang.Throwable th6) {
            com.tencent.mars.xlog.Log.e("SightVideoFullScreenView", th6.toString());
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("run", "com.tencent.mm.plugin.sns.ui.SightVideoFullScreenView$4");
    }
}
