...
public final class ImproveWNNotePageHandle extends com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveOtherTimelineItemHandle {
    public static final com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveWNNotePageHandle INSTANCE = new com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveWNNotePageHandle();
    ...
    public int getContentStyle() {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("getContentStyle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveWNNotePageHandle");
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("getContentStyle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveWNNotePageHandle");
        return 26;
    }
    ...
    public jz5.l handle(com.tencent.mm.plugin.sns.storage.SnsInfo snsInfo, com.tencent.mm.protocal.protobuf.TimeLineObject tlObj, android.view.ViewGroup layout) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("handle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveWNNotePageHandle");
        ...
        if (!qa4.f.a(tlObj).isEmpty()) {
            ...
            hj6.f0(jj4Var, access$leftIv2, hashCode, d17, snsInfo.getSnsId());
        } else {
            com.tencent.mm.plugin.sns.model.l4.hj().S(com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveOtherTimelineItemHandleKt.access$leftIv(layout), -1, com.tencent.mm.R.raw.note_sns_link_default, layout.getContext().hashCode());
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("handle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveWNNotePageHandle");
        return handle;
    }
}
