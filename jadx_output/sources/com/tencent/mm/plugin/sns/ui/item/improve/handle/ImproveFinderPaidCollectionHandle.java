...
public final class ImproveFinderPaidCollectionHandle extends com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveOtherTimelineItemHandle {
    public static final com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle INSTANCE = new com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle();

    private ImproveFinderPaidCollectionHandle() {
    }

    @Override // com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveOtherTimelineItemHandle
    public int getContentStyle() {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("getContentStyle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle");
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("getContentStyle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle");
        return 55;
    }
    ...
    public jz5.l handle(final com.tencent.mm.plugin.sns.storage.SnsInfo snsInfo, final com.tencent.mm.protocal.protobuf.TimeLineObject tlObj, android.view.ViewGroup layout) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("handle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle");
        ...
        if (tlObj.ContentObj.E == null) {
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("handle", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle");
            return handle;
        }
        ...
        ym5.a1.h(layout, new ym5.n0() { // from class: com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle$handle$2
            ...
            public void onViewExposed(android.view.View view, long j17, long j18, boolean z17) {
                r45.ev2 ev2Var;
                r45.ev2 ev2Var2;
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onViewExposed", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle$handle$2");
                ...
                if (z17) {
                    ...
                    m0Var.c(3, 7, str, null, "", integer, str2, u17, j19, Di);
                }
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onViewExposed", "com.tencent.mm.plugin.sns.ui.item.improve.handle.ImproveFinderPaidCollectionHandle$handle$2");
            }
        });
