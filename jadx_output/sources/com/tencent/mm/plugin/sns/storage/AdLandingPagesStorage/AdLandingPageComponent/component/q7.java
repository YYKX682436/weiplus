...
public class q7 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.x7 f165431d;

    public q7(com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.x7 x7Var) {
        this.f165431d = x7Var;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        boolean z17;
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onClick", "com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.AdLandingPageSightVideoComponent$7");
        ...
        com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.x7 x7Var = this.f165431d;
        boolean z18 = x7Var.C;
        ...
        if (z18) {
            x7Var.N++;
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("access$2100", "com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.AdLandingPageSightVideoComponent");
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("onSightVideoClickCheckingCanvasId", "com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.AdLandingPageSightVideoComponent");
            if (com.tencent.mm.sdk.platformtools.t8.K0(x7Var.m0().L)) {
                ...
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onSightVideoClickCheckingCanvasId", "com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.AdLandingPageSightVideoComponent");
                z17 = false;
            } else {
                ...
                if ((context instanceof android.app.Activity) && x7Var.u().d() == 2) {
                    ...
                    if (!com.tencent.mm.sdk.platformtools.t8.K0(stringExtra)) {
                        ...
                        try {
                            ...
                            str6 = "com/tencent/mm/plugin/sns/storage/AdLandingPagesStorage/AdLandingPageComponent/component/AdLandingPageSightVideoComponent$7";
                            try {
                                jSONObject.put("cid", x7Var.m0().f2817d);
                        ...
                        int[] iArr = new int[2];
                        x7Var.f165814x.getLocationOnScreen(iArr);
                        intent.putExtra("img_gallery_top", iArr[1]);
                        intent.putExtra("img_gallery_left", iArr[0]);
                        intent.putExtra("img_gallery_width", x7Var.f165814x.getWidth());
                        intent.putExtra("img_gallery_height", x7Var.f165814x.getHeight());
                ...
                str7 = "com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.AdLandingPageSightVideoComponent$7";
                int[] iArr2 = new int[2];
                x7Var.f165814x.getLocationOnScreen(iArr2);
            ...
            com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("access$2100", "com.tencent.mm.plugin.sns.storage.AdLandingPagesStorage.AdLandingPageComponent.component.AdLandingPageSightVideoComponent");
            if (z17) {
                yj0.a.h(this, str6, str5, "onClick", str4);
                com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onClick", str7);
                return;
            } else {
                str8 = str4;
                str = str5;
        ...
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("onClick", str3);
    }
}
