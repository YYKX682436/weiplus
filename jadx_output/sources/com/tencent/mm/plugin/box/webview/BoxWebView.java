...
public class BoxWebView extends com.tencent.mm.ui.widget.MMWebView {
    public android.content.Context G;

    public BoxWebView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final void I0() {
        com.tencent.mars.xlog.Log.i("MicroMsg.Flight.FlightWebView", "init FlightWebView");
        if (fp.h.c(19)) {
            return;
        }
        try {
            ...
            if (a17 instanceof java.lang.Thread) {
                ...
                com.tencent.mars.xlog.Log.i("MicroMsg.Flight.FlightWebView", "tryInterruptAwaitingWebCoreThread, webCoreThread.getState = %s", thread.getState());
                if (thread.getState() == java.lang.Thread.State.WAITING) {
                    thread.interrupt();
                }
            }
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Flight.FlightWebView", "tryInterruptAwaitingWebCoreThread, exception = %s", e17);
        }
    }
    ...
    public void J0(xq1.a aVar, xq1.c cVar) {
        ...
        getSettings().I(true);
        getSettings().J(0);
        getSettings().Q(ik1.l0.a(getContext(), getSettings().g(), (ik1.k0) nd.f.a(ik1.k0.class)));
        getSettings().P(true);
        getSettings().G(true);
        getSettings().M(false);
        getSettings().L(false);
    ...
    public BoxWebView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        this.G = context;
        I0();
    }

    public BoxWebView(android.content.Context context) {
        super(context, null);
        this.G = context;
        I0();
    }
