...
public class o4 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ java.lang.String f180558d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f180559e;

    public o4(java.lang.String str, android.content.Context context) {
        this.f180558d = str;
        this.f180559e = context;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        java.lang.String str = this.f180558d;
        com.tencent.mars.xlog.Log.i("MicroMsg.WalletIdCardTip", "go to url %s", str);
        intent.putExtra("rawUrl", str);
        intent.putExtra("geta8key_username", c01.z1.r());
        intent.putExtra("pay_channel", 1);
        com.tencent.mm.wallet_core.ui.r1.T(this.f180559e, intent);
