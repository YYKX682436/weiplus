...
public class r4 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ java.lang.String f180597d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f180598e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ android.app.Dialog f180599f;

    public r4(java.lang.String str, android.content.Context context, android.app.Dialog dialog) {
        this.f180597d = str;
        this.f180598e = context;
        this.f180599f = dialog;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        java.lang.String str = this.f180597d;
        com.tencent.mars.xlog.Log.i("MicroMsg.WalletIdCardTip", "go to url %s", str);
        intent.putExtra("rawUrl", str);
        intent.putExtra("geta8key_username", c01.z1.r());
        intent.putExtra("pay_channel", 1);
        com.tencent.mm.wallet_core.ui.r1.T(this.f180598e, intent);
        android.app.Dialog dialog = this.f180599f;
