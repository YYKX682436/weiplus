...
public class d2 implements su4.y0 {
    ...
    public final com.tencent.mm.sdk.platformtools.n3 f181493a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.List f181494b = new java.util.ArrayList();

    public d2(com.tencent.mm.sdk.platformtools.n3 n3Var) {
        for (int i17 = 0; i17 < 3; i17++) {
            this.f181494b.add(new java.util.HashMap());
        }
        this.f181493a = n3Var;
    }
    ...
    */
    public java.lang.String a(java.lang.String r6) {
        ...
        L63:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.websearch.d2.a(java.lang.String):java.lang.String");
    }

    public void b(int i17, java.lang.Object obj, java.lang.Object obj2, su4.j1 j1Var) {
        this.f181493a.post(new com.tencent.mm.plugin.websearch.c2(this, i17, obj, obj2, j1Var));
    }

    public void c(int i17, java.lang.Object obj) {
        if (obj == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.PGetController", "step_doCgiReq tag is null");
        } else {
            this.f181493a.post(new com.tencent.mm.plugin.websearch.a2(this, i17, obj));
        }
    }

    public void d(int i17, java.lang.Object obj, java.lang.Object obj2, java.lang.Runnable runnable, su4.j1 j1Var) {
        if (obj == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.WebSearch.PGetController", "step_getJsApi tag is null");
        } else {
            this.f181493a.post(new com.tencent.mm.plugin.websearch.b2(this, i17, obj, obj2, runnable, j1Var));
        }
    }
}
