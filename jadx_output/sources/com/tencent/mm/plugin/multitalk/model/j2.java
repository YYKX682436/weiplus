...
public final class j2 extends kotlin.jvm.internal.q implements yz5.l {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.multitalk.model.k2 f150020d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j2(com.tencent.mm.plugin.multitalk.model.k2 k2Var) {
        super(1);
        this.f150020d = k2Var;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj) {
        ...
        com.tencent.mm.plugin.multitalk.model.k2 k2Var = this.f150020d;
        java.lang.Integer num = (java.lang.Integer) k2Var.f150029b.get(wxUserName);
        jz5.f0 f0Var2 = jz5.f0.f302826a;
        if (num != null) {
            if (num.intValue() == 104) {
                com.tencent.mars.xlog.Log.i("MicroMsg.MultiTalkScreenCastManager", "state change from stop to stop");
            } else {
        ...
        k2Var.f150029b.put(wxUserName, 104);
