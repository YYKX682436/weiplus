...
public abstract class i1 implements com.tencent.mm.plugin.newtips.model.a {
    ...
    public final android.content.Context f148404d;

    /* renamed from: e, reason: collision with root package name */
    public android.widget.ImageView f148405e;

    /* renamed from: f, reason: collision with root package name */
    public android.widget.TextView f148406f;

    public i1(com.tencent.mm.plugin.mall.ui.MallIndexUI mallIndexUI, android.content.Context context, android.view.View view) {
        this.f148404d = context;
        a(view);
    }
    ...
    public boolean Y3(boolean z17) {
        if (!z17) {
            this.f148406f.setVisibility(8);
            return true;
        }
        this.f148406f.setVisibility(0);
        this.f148406f.setText(this.f148404d.getString(com.tencent.mm.R.string.f490501wv));
        return true;
    }
    ...
    public boolean Z3(boolean z17, r45.pm6 pm6Var) {
        ...
        if (pm6Var.f383186d > 99) {
            str = this.f148404d.getString(com.tencent.mm.R.string.f493304jo3);
        }
        this.f148406f.setText(str);
        return true;
    }
    ...
    public boolean y(boolean z17) {
        if (z17) {
            this.f148405e.setVisibility(0);
            return true;
        }
        this.f148405e.setVisibility(8);
        return true;
    }
}
