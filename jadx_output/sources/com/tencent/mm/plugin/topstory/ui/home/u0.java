...
public class u0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.topstory.ui.home.j f175085d;

    public u0(com.tencent.mm.plugin.topstory.ui.home.j jVar) {
        this.f175085d = jVar;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.topstory.ui.home.j jVar = this.f175085d;
        if (jVar.L) {
        ...
        jVar.L = true;
        wm4.u.v(jVar.f174986d, jVar.f174988f);
        jx3.f.INSTANCE.d(15449, 0);
        if (jVar.f175001s.getVisibility() == 0) {
            android.view.View view2 = jVar.f175001s;
            ...
            qn6Var.f384113d = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().z();
            qn6Var.f384121o = ((om4.m) ((pm4.r) i95.n0.c(pm4.r.class))).wi().A();
