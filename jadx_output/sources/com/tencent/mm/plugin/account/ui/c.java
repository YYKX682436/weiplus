...
public class c implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ android.content.Intent f73759d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.app.Activity f73760e;

    public c(android.content.Intent intent, android.app.Activity activity) {
        this.f73759d = intent;
        this.f73760e = activity;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        android.content.Intent intent = this.f73759d;
        if (intent != null) {
            android.app.Activity activity = this.f73760e;
            activity.finish();
            android.app.Activity activity2 = this.f73760e;
