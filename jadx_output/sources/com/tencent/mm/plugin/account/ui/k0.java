...
public class k0 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.ui.BaseLoginVoiceUI f73967d;

    public k0(com.tencent.mm.plugin.account.ui.BaseLoginVoiceUI baseLoginVoiceUI) {
        this.f73967d = baseLoginVoiceUI;
    }
    ...
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        ...
        com.tencent.mm.plugin.account.ui.BaseLoginVoiceUI baseLoginVoiceUI = this.f73967d;
        baseLoginVoiceUI.getClass();
        com.tencent.mm.sdk.platformtools.c3.b("welcome_page_show");
        gm0.k2.a(baseLoginVoiceUI, true);
        ...
        androidx.appcompat.app.AppCompatActivity context = baseLoginVoiceUI.getContext();
        ...
        yj0.a.d(context, arrayList2.toArray(), "com/tencent/mm/plugin/account/ui/BaseLoginVoiceUI", "exitApplication", "(Landroid/content/Context;Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        context.startActivity((android.content.Intent) arrayList2.get(0));
        yj0.a.f(context, "com/tencent/mm/plugin/account/ui/BaseLoginVoiceUI", "exitApplication", "(Landroid/content/Context;Landroid/content/Intent;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
    }
}
