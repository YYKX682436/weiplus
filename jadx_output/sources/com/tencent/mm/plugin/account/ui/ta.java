...
public class ta implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.ui.sa f74224d;

    public ta(com.tencent.mm.plugin.account.ui.sa saVar) {
        this.f74224d = saVar;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        com.tencent.mm.plugin.account.ui.sa saVar = this.f74224d;
