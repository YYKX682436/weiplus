...
public class p4 implements android.content.DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.account.ui.LoginHistoryUI f74108d;

    public p4(com.tencent.mm.plugin.account.ui.LoginHistoryUI loginHistoryUI) {
        this.f74108d = loginHistoryUI;
    }

    @Override // android.content.DialogInterface.OnClickListener
    public void onClick(android.content.DialogInterface dialogInterface, int i17) {
        com.tencent.mm.plugin.account.ui.LoginHistoryUI loginHistoryUI = this.f74108d;
