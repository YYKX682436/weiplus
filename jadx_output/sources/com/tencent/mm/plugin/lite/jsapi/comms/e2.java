...
public final class e2 extends com.tencent.mm.plugin.lite.api.p {

    /* renamed from: g, reason: collision with root package name */
    public final int f143563g = 1;

    public final org.json.JSONObject A(java.lang.String str) {
        q80.g0 g0Var = (q80.g0) i95.n0.c(q80.g0.class);
        jd.c cVar = this.f143442e;
        java.lang.String str2 = cVar.f299025b;
        long j17 = cVar.f299024a;
        ((com.tencent.mm.feature.lite.i) g0Var).getClass();
        java.lang.String generateLiteAppLocalId = com.tencent.mm.plugin.lite.LiteAppCenter.generateLiteAppLocalId(j17, str2, str);
        org.json.JSONObject jSONObject = new org.json.JSONObject();
        jSONObject.put(com.tencent.kinda.framework.widget.tools.ConstantsKinda.INTENT_LITEAPP_PATH, generateLiteAppLocalId);
    ...
    public void a(java.lang.String str, org.json.JSONObject jSONObject, boolean z17) {
        ...
        if (jSONObject != null) {
            java.lang.String string = jSONObject.getString(com.tencent.liteapp.storage.WxaLiteAppInfo.KEY_PAGE);
            ...
            hashMap.put(com.tencent.liteapp.storage.WxaLiteAppInfo.KEY_PAGE, string3);
            ...
            intent5.setClass(c(), com.tencent.mm.plugin.lite.ui.WxaLiteAppApiProxyUI.class);
    ...
    public void u(int i17, int i18, android.content.Intent intent) {
        com.tencent.mars.xlog.Log.i("MicroMsg.LiteAppJsApiEmoticonStorePersonalCenterPageRouter", "onPostEmoticonCompleted");
        try {
            if (intent == null) {
                com.tencent.mars.xlog.Log.i("MicroMsg.LiteAppJsApiEmoticonStorePersonalCenterPageRouter", "callback data is null");
                this.f143442e.a();
                return;
            }
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.LiteAppJsApiEmoticonStorePersonalCenterPageRouter", "onPostEmoticonCompleted path " + stringExtra);
            if (!android.text.TextUtils.isEmpty(stringExtra)) {
                this.f143442e.f(A(stringExtra), false);
                return;
            }
            ...
            if (android.text.TextUtils.isEmpty(stringExtra2)) {
                ...
                this.f143442e.f(A(((com.tencent.mm.storage.emotion.EmojiInfo) ((com.tencent.mm.feature.emoji.q0) ((com.tencent.mm.feature.emoji.api.z5) i95.n0.c(com.tencent.mm.feature.emoji.api.z5.class))).Ni(stringExtra2)).T()), false);
            }
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.LiteAppJsApiEmoticonStorePersonalCenterPageRouter", "callback error:" + e17.getMessage());
            this.f143442e.a();
        }
    }
}
