            ...
            while (it.hasNext()) {
                ...
                if (trVar.f386720e == 1) {
                    ...
                    if (j4Var.f377560g != 10002) {
                        ...
                        com.tencent.mars.xlog.Log.i("MicroMsg.LiteAppBypMsgSyncHandler", sb6.toString());
                        ...
                        if ("dispatchStore".equals(optString2)) {
                            ...
                            java.lang.String optString3 = optJSONObject2.optString(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME, "");
                            ...
                            com.tencent.mm.plugin.lite.logic.g1.s().Q(optString, optInt, optInt2, optString3, jSONObject2, optJSONObject.optBoolean("forceDispatch", false), optJSONObject.optInt("aliveDurationSeconds", 600));
                        }
                    }
                }
            }
