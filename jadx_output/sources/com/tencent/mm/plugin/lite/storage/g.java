...
public class g extends l75.n0 {
    ...
    public static final java.lang.String[] f144269e = {l75.n0.getCreateSQLs(com.tencent.mm.plugin.lite.storage.f.f144268v, "LiteAppAuthInfo")};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f144270d;

    public g(l75.k0 k0Var) {
        super(k0Var, com.tencent.mm.plugin.lite.storage.f.f144268v, "LiteAppAuthInfo", null);
        this.f144270d = k0Var;
    }

    @Override // l75.n0, l75.g0
    public boolean insert(l75.f0 f0Var) {
        this.f144270d.l("LiteAppAuthInfo", "host", ((com.tencent.mm.plugin.lite.storage.f) f0Var).convertTo());
        return true;
    }

    @Override // l75.n0
    public boolean replace(l75.f0 f0Var) {
        this.f144270d.m("LiteAppAuthInfo", "host", ((com.tencent.mm.plugin.lite.storage.f) f0Var).convertTo());
        return true;
    }
    ...
    */
    public com.tencent.mm.plugin.lite.storage.f y0(java.lang.String r9) {
        /*
            r8 = this;
            r0 = 0
            if (r9 != 0) goto L4
        ...
        L4:
            ...
            l75.k0 r3 = r8.f144270d     // Catch: java.lang.Throwable -> L38 java.lang.Exception -> L3d
            r4 = 2
        ...
        L5b:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.lite.storage.g.y0(java.lang.String):com.tencent.mm.plugin.lite.storage.f");
    }
}
