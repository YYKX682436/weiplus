...
public class n1 implements t80.e {
    ...
    public final /* synthetic */ java.util.Map f144026a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ java.util.List f144027b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f144028c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ com.tencent.liteapp.gen.LiteAppReporter f144029d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.lite.logic.g1 f144030e;

    public n1(com.tencent.mm.plugin.lite.logic.g1 g1Var, java.util.Map map, java.util.List list, java.lang.String str, com.tencent.liteapp.gen.LiteAppReporter liteAppReporter) {
        this.f144030e = g1Var;
        this.f144026a = map;
        this.f144027b = list;
        this.f144028c = str;
        this.f144029d = liteAppReporter;
    }
    ...
    public void a(int i17, int i18, java.lang.String str) {
        ...
        com.tencent.liteapp.gen.LiteAppReporter liteAppReporter = this.f144029d;
        if (liteAppReporter != null) {
            liteAppReporter.logOther(com.tencent.liteapp.gen.OtherAction.BATCH_CHECK_PACKAGE_UPDATE_FAILED, this.f144028c, i18);
        }
        com.tencent.mm.plugin.lite.logic.g1.b(this.f144030e, this.f144027b, new java.util.ArrayList(), new java.util.ArrayList(), this.f144027b, this.f144028c, this.f144029d);
        java.util.Iterator it = this.f144027b.iterator();
        while (it.hasNext()) {
            com.tencent.mm.plugin.lite.logic.g1.d(this.f144030e, (java.lang.String) it.next(), i17, i18, str, null);
        }
    }
    ...
    public void b(r45.mg mgVar, r45.mg mgVar2) {
        ...
        java.util.Map map = this.f144026a;
        com.tencent.mm.plugin.lite.logic.g1 g1Var = this.f144030e;
        if (mgVar != null && (linkedList3 = mgVar.f380466d) != null) {
            ...
            while (it.hasNext()) {
                ...
                if (wy4Var.f389586e != 0) {
                    ...
                    com.tencent.mm.plugin.lite.logic.g1.d(this.f144030e, wy4Var.f389585d, 0, wy4Var.f389586e, "pay batch check single fail", null);
                } else {
        ...
        if (mgVar2 != null && (linkedList = mgVar2.f380466d) != null) {
            ...
            while (it6.hasNext()) {
                ...
                if (wy4Var2.f389586e != 0) {
                    ...
                    com.tencent.mm.plugin.lite.logic.g1.d(this.f144030e, wy4Var2.f389585d, 0, wy4Var2.f389586e, "pay batch check single fail", null);
                } else {
        ...
        com.tencent.mm.plugin.lite.logic.g1.b(this.f144030e, this.f144027b, arrayList, arrayList2, arrayList3, this.f144028c, this.f144029d);
    }
}
