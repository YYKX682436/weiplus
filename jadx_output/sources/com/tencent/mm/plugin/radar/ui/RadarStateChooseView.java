...
public final class RadarStateChooseView extends android.widget.RelativeLayout {

    /* renamed from: h, reason: collision with root package name */
    public static final /* synthetic */ int f155006h = 0;
    ...
    public boolean f155009f;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    public ps3.o mStatus;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RadarStateChooseView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        ...
        this.f155009f = true;
        this.mStatus = ps3.o.f358116e;
    }

    private final android.view.animation.Animation getSlideInAnim() {
        return (android.view.animation.Animation) this.slideInAnim.getValue();
    }

    private final android.view.animation.Animation getSlideOutAnim() {
        return (android.view.animation.Animation) this.slideOutAnim.getValue();
    }

    public final void a() {
        int ordinal = this.mStatus.ordinal();
        if (ordinal == 0) {
            setBackgroundResource(com.tencent.mm.R.raw.radar_select);
            setVisibility(0);
        } else if (ordinal != 1) {
            setVisibility(4);
        } else {
    ...
    public final void setMStatus(ps3.o oVar) {
        kotlin.jvm.internal.o.g(oVar, "<set-?>");
        this.mStatus = oVar;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RadarStateChooseView(android.content.Context context, android.util.AttributeSet attrs, int i17) {
