...
public final class RadarSpecialTableLayout extends android.widget.TableLayout {

    /* renamed from: d, reason: collision with root package name */
    public boolean f155005d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RadarSpecialTableLayout(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RadarSpecialTableLayout(android.content.Context context) {
        super(context);
        kotlin.jvm.internal.o.g(context, "context");
    }
}
