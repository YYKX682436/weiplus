...
public final class SettingActivityItemQQMail extends s24.a {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SettingActivityItemQQMail(androidx.appcompat.app.AppCompatActivity activity) {
        super(activity);
    ...
    @Override // a24.i
    public a24.u b7() {
        return new a24.u(com.tencent.mm.plugin.setting.ui.setting_new.settings.other.SettingGroupAccessibilityItem.class, com.tencent.mm.plugin.setting.ui.setting_new.settings.other.accessibility.SettingAdditionInstalled.class);
    }
