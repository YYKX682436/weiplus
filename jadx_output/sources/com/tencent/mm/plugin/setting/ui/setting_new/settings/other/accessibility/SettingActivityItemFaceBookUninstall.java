...
public final class SettingActivityItemFaceBookUninstall extends s24.a {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SettingActivityItemFaceBookUninstall(androidx.appcompat.app.AppCompatActivity activity) {
        super(activity);
    ...
    @Override // a24.i
    public a24.u b7() {
        return new a24.u(com.tencent.mm.plugin.setting.ui.setting_new.settings.other.SettingGroupAccessibilityItem.class, com.tencent.mm.plugin.setting.ui.setting_new.settings.other.accessibility.SettingActivityItemReaderAppNewsUninstall.class);
    }
    ...
    public boolean getF161948p() {
        return (com.tencent.mm.sdk.platformtools.f9.MeSetSecurityFacebook.h() || (c01.z1.n() & 8192) == 0 || !u11.c.c()) ? false : true;
    }
