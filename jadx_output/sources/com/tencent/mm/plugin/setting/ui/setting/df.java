...
public final class df implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.setting.ui.setting.SettingsHearingAidTestUI f160944d;

    public df(com.tencent.mm.plugin.setting.ui.setting.SettingsHearingAidTestUI settingsHearingAidTestUI) {
        this.f160944d = settingsHearingAidTestUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.setting.ui.setting.SettingsHearingAidTestUI settingsHearingAidTestUI = this.f160944d;
        ...
        if (settingsHearingAidTestUI.f160476y) {
            settingsHearingAidTestUI.W6("hearing_level_test_result", 12, com.tencent.mm.plugin.setting.ui.setting.xd.f161738h.h(), false);
            ...
            settingsHearingAidAudioCardView.setSource(com.tencent.mm.plugin.setting.ui.setting.xd.f161737g.h());
            com.tencent.mm.ui.widget.button.WeButton weButton = settingsHearingAidTestUI.f160466o;
            if (weButton == null) {
                kotlin.jvm.internal.o.o("positiveBtn");
                throw null;
            }
            weButton.setOnClickListener(new com.tencent.mm.plugin.setting.ui.setting.bf(settingsHearingAidTestUI, settingsHearingAidAudioCardView));
            com.tencent.mm.ui.widget.button.WeButton weButton2 = settingsHearingAidTestUI.f160465n;
            if (weButton2 == null) {
                kotlin.jvm.internal.o.o("negativeBtn");
                throw null;
            }
            weButton2.setOnClickListener(new com.tencent.mm.plugin.setting.ui.setting.cf(settingsHearingAidTestUI, settingsHearingAidAudioCardView));
