...
public final class s implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.setting.ui.setting.i0 f161524d;

    public s(com.tencent.mm.plugin.setting.ui.setting.i0 i0Var) {
        this.f161524d = i0Var;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.setting.ui.setting.i0 i0Var = this.f161524d;
        int W6 = i0Var.W6();
        v24.e eVar = i0Var.f161306d;
        if (eVar != null) {
            v24.e.c(eVar, 11, W6, null, null, 0, 28, null);
        }
        if (!iq.b.g(i0Var.getContext()) && !iq.b.x(i0Var.getContext()) && !iq.b.c(i0Var.getContext(), true)) {
            android.content.Intent intent = new android.content.Intent();
            intent.putExtra("key_is_hide_right_btn", true);
            intent.putExtra("key_scan_report_enter_scene", 4);
            intent.putExtra("key_is_hide_right_btn", true);
            intent.putExtra("BaseScanUI_only_scan_qrcode_with_zbar", true);
            j45.l.j(i0Var.getContext(), "scanner", ".ui.BaseScanUI", intent, null);
        }
