...
public final class FontAnimTextView extends android.widget.ImageView {

    /* renamed from: r, reason: collision with root package name */
    public static final /* synthetic */ int f98776r = 0;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.String[] f98777d;

    /* renamed from: e, reason: collision with root package name */
    public final android.graphics.Typeface[] f98778e;

    /* renamed from: f, reason: collision with root package name */
    public int f98779f;

    /* renamed from: g, reason: collision with root package name */
    public final java.lang.Runnable f98780g;

    /* renamed from: h, reason: collision with root package name */
    public java.lang.CharSequence f98781h;

    /* renamed from: i, reason: collision with root package name */
    public final int f98782i;

    /* renamed from: m, reason: collision with root package name */
    public int f98783m;

    /* renamed from: n, reason: collision with root package name */
    public final android.graphics.Bitmap[] f98784n;

    /* renamed from: o, reason: collision with root package name */
    public final c32.e f98785o;
    ...
    */
    public FontAnimTextView(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            boolean r2 = kotlin.jvm.internal.o.b(r8, r2)
            if (r2 == 0) goto L39
            r8 = r1
            goto L40
        L39:
        ...
        L40:
            ...
            f11.j r8 = f11.j.b()
            r8.getClass()
            java.lang.String r8 = f11.j.f258561d
            java.lang.String r1 = f11.j.f258560c
        ...
        L60:
            if (r1 >= r7) goto L6f
            java.lang.String[] r2 = r6.f98777d
            r2 = r2[r1]
        ...
        L72:
            ...
            r6.f98778e = r7
        L90:
            android.graphics.Typeface[] r7 = r6.f98778e
            int r7 = r7.length
            r6.f98782i = r7
    ...
    */
    public final void a() {
        /*
            r9 = this;
            java.lang.CharSequence r0 = r9.f98781h
            r1 = 0
            if (r0 == 0) goto L12
            int r0 = r0.length()
            r2 = 1
        ...
        L13:
            if (r2 == 0) goto L27
            android.graphics.Bitmap[] r3 = r9.f98784n
            r4 = 0
            r5 = 0
            r6 = 0
            r7 = 6
            ...
            goto L30
        L27:
            java.lang.Runnable r0 = r9.f98780g
    ...
    public final void b() {
        int i17 = this.f98783m + 1;
        this.f98783m = i17;
        this.f98783m = i17 % this.f98782i;
        int i18 = this.f98779f;
        android.graphics.Typeface[] typefaceArr = this.f98778e;
        android.graphics.Typeface typeface = typefaceArr[i18];
        java.lang.String str = this.f98777d[i18];
        c32.e eVar = this.f98785o;
        eVar.b(str);
        int i19 = this.f98779f + 1;
        this.f98779f = i19;
        this.f98779f = i19 % typefaceArr.length;
        int i27 = this.f98783m;
        android.graphics.Bitmap[] bitmapArr = this.f98784n;
        if (bitmapArr[i27] == null) {
            ...
            fontTextView.b(this.f98781h, this.f98786p, this.f98787q, true);
            fontTextView.measure(android.view.View.MeasureSpec.makeMeasureSpec(width, Integer.MIN_VALUE), 0);
            ...
            canvas.restore();
            bitmapArr[this.f98783m] = createBitmap;
        }
        java.lang.Runnable runnable = this.f98780g;
        removeCallbacks(runnable);
        postDelayed(runnable, 100L);
        setImageBitmap(bitmapArr[this.f98783m]);
    }

    public final void c(java.lang.CharSequence charSequence, int i17, int i18) {
        this.f98781h = charSequence;
        this.f98786p = i17;
        this.f98787q = i18;
        a();
    }
    ...
    public final java.lang.CharSequence getF98781h() {
        return this.f98781h;
    }

    /* renamed from: getTextColor, reason: from getter */
    public final int getF98786p() {
        return this.f98786p;
    }
    ...
    public FontAnimTextView(android.content.Context context, android.util.AttributeSet attributeSet) {
