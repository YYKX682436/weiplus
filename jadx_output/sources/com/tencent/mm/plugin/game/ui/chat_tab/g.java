...
public class g implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.game.ui.chat_tab.h f141270d;

    public g(com.tencent.mm.plugin.game.ui.chat_tab.h hVar) {
        this.f141270d = hVar;
    }
    ...
    public void run() {
        ...
        com.tencent.mm.plugin.game.ui.chat_tab.ChatRoomTabUI chatRoomTabUI = this.f141270d.f141273d;
        int i17 = chatRoomTabUI.f141103s;
        int i18 = chatRoomTabUI.f141105u;
        int i19 = chatRoomTabUI.f141104t;
        boolean z17 = chatRoomTabUI.f141106v;
        ...
        oa.i k17 = chatRoomTabUI.f141098n.getmTabs().k(0);
        if (k17 != null && (view2 = k17.f343783f) != null) {
            android.widget.TextView textView = (android.widget.TextView) view2.findViewById(com.tencent.mm.R.id.nvo);
            android.view.View findViewById = k17.f343783f.findViewById(com.tencent.mm.R.id.nvn);
            if (i17 > 0) {
                if (k17.a()) {
        ...
        oa.i k18 = chatRoomTabUI.f141098n.getmTabs().k(1);
        if (k18 == null || (view = k18.f343783f) == null) {
            return;
        }
        android.widget.TextView textView2 = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.nvo);
        android.view.View findViewById2 = k18.f343783f.findViewById(com.tencent.mm.R.id.nvn);
        if (i18 > 0) {
            if (i18 > 99) {
