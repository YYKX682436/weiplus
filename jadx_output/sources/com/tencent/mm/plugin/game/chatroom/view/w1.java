...
public class w1 implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.game.chatroom.view.y1 f139331d;

    public w1(com.tencent.mm.plugin.game.chatroom.view.y1 y1Var) {
        this.f139331d = y1Var;
    }
    ...
    public void onAnimationUpdate(android.animation.ValueAnimator valueAnimator) {
        ...
        com.tencent.mm.plugin.game.chatroom.view.y1 y1Var = this.f139331d;
