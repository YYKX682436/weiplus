...
public abstract class f {
    public static java.lang.String a() {
        android.content.SharedPreferences sharedPreferences = com.tencent.mm.sdk.platformtools.x2.f193071a.getSharedPreferences("game_center_pref", 0);
    ...
    public static java.lang.String b() {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(d07)) {
            d07 = "CN";
        }
    ...
    public static java.lang.String c(java.lang.String str) {
        ...
        try {
            try {
                inputStream = com.tencent.mm.sdk.platformtools.x2.f193071a.getAssets().open("game_region_default.txt");
                ...
                try {
                    ...
                    com.tencent.mars.xlog.Log.e("MicroMsg.GameCenterLogic", "exception:%s", com.tencent.mm.sdk.platformtools.z3.c(e17));
                }
            } catch (java.io.IOException e18) {
                boolean z18 = com.tencent.mm.sdk.platformtools.t8.f192989a;
                com.tencent.mars.xlog.Log.e("MicroMsg.GameCenterLogic", "exception:%s", com.tencent.mm.sdk.platformtools.z3.c(e18));
                if (inputStream != null) {
                    try {
                        inputStream.close();
                    } catch (java.io.IOException e19) {
                        com.tencent.mars.xlog.Log.e("MicroMsg.GameCenterLogic", "exception:%s", com.tencent.mm.sdk.platformtools.z3.c(e19));
                    }
                }
                str2 = "";
            }
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.GameCenterLogic", "this region default title has problem %s", str2);
            return "";
            ...
            if (inputStream != null) {
                try {
                    ...
                    com.tencent.mars.xlog.Log.e("MicroMsg.GameCenterLogic", "exception:%s", com.tencent.mm.sdk.platformtools.z3.c(e27));
                }
            }
            throw th6;
        }
    ...
    public static java.util.LinkedList e(android.content.Context context) {
        ...
        linkedList.addAll(((com.tencent.mm.plugin.game.n1) ((m33.r1) i95.n0.c(m33.r1.class))).wi().f140189a);
        return linkedList;
    }
    ...
    public static com.tencent.mm.plugin.game.ui.p5 g(android.content.Context context) {
        java.lang.String d17 = d(context);
        if (com.tencent.mm.sdk.platformtools.t8.K0(d17)) {
            d17 = b();
        }
        return (com.tencent.mm.plugin.game.ui.p5) ((java.util.LinkedHashMap) r53.b.f392640a.a()).get(d17);
    }

    public static java.util.LinkedList h(android.content.Context context) {
        java.util.LinkedList linkedList = new java.util.LinkedList();
        linkedList.addAll(((com.tencent.mm.plugin.game.n1) ((m33.r1) i95.n0.c(m33.r1.class))).wi().f140190b);
        ...
        while (it.hasNext()) {
            ...
            boolean z17 = false;
            if (mVar != null) {
                com.tencent.mars.xlog.Log.i("MicroMsg.GameCenterLogic", "appinfo:[%s], appinfo flag:[%d]", mVar.field_appId, java.lang.Integer.valueOf(mVar.field_appInfoFlag));
                if ((mVar.field_appInfoFlag & 4) > 0) {
                    z17 = true;
                }
            }
            if (!z17) {
                com.tencent.mars.xlog.Log.i("MicroMsg.GameCenterLogic", "app should not show in gamecenter:[%s]", mVar.field_appName);
    ...
    public static java.lang.String i(com.tencent.mm.plugin.game.ui.p5 p5Var) {
        ...
        if (p5Var != null) {
            ...
            if ("zh_CN".equalsIgnoreCase(d17)) {
                stringBuffer.append(p5Var.f141712a);
            } else if ("zh_TW".equalsIgnoreCase(d17) || "zh_HK".equalsIgnoreCase(d17)) {
                stringBuffer.append(p5Var.f141713b);
            } else {
                stringBuffer.append(p5Var.f141714c);
            }
        }
    ...
    public static void j(android.content.Context context, java.lang.String str) {
        k(context, str, null, "WX_GameCenter", new com.tencent.mm.plugin.game.model.d(str));
    }
    ...
    */
    public static void k(android.content.Context r10, java.lang.String r11, java.lang.String r12, java.lang.String r13, com.tencent.mm.pluginsdk.model.app.a5 r14) {
        /*
            Method dump skipped, instructions count: 302
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.game.model.f.k(android.content.Context, java.lang.String, java.lang.String, java.lang.String, com.tencent.mm.pluginsdk.model.app.a5):void");
    }
