...
public final class GameEmojiLayoutManager extends androidx.recyclerview.widget.GridLayoutManager {
    public final android.graphics.Rect D;

    public GameEmojiLayoutManager(android.content.Context context, int i17) {
        super(context, i17);
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt != null) {
                ...
                if (getItemViewType(childAt) != 1) {
                    ...
                    yj0.a.d(childAt, arrayList.toArray(), "com/tencent/mm/plugin/game/luggage/ui/circle/GameEmojiLayoutManager", "updateChildren", "()V", "android/view/View_EXEC_", "setAlpha", "(F)V");
                    childAt.setAlpha(((java.lang.Float) arrayList.get(0)).floatValue());
                    yj0.a.f(childAt, "com/tencent/mm/plugin/game/luggage/ui/circle/GameEmojiLayoutManager", "updateChildren", "()V", "android/view/View_EXEC_", "setAlpha", "(F)V");
                    ...
                    yj0.a.d(childAt, arrayList2.toArray(), "com/tencent/mm/plugin/game/luggage/ui/circle/GameEmojiLayoutManager", "updateChildren", "()V", "android/view/View_EXEC_", "setAlpha", "(F)V");
