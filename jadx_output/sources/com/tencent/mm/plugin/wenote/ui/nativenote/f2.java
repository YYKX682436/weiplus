...
public class f2 extends rz4.a {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.wenote.ui.nativenote.NoteEditorUI f188204d;

    public f2(com.tencent.mm.plugin.wenote.ui.nativenote.NoteEditorUI noteEditorUI) {
        this.f188204d = noteEditorUI;
    }
    ...
    public void onScrollStateChanged(androidx.recyclerview.widget.RecyclerView recyclerView, int i17) {
        ...
        if (recyclerView.getLayoutManager() != null) {
            com.tencent.mm.plugin.wenote.ui.nativenote.NoteEditorUI noteEditorUI = this.f188204d;
            androidx.recyclerview.widget.LinearLayoutManager linearLayoutManager = (androidx.recyclerview.widget.LinearLayoutManager) noteEditorUI.f188148n.getLayoutManager();
            android.view.View childAt = linearLayoutManager.getChildAt(0);
            if (childAt != null) {
                noteEditorUI.V = childAt.getTop();
                noteEditorUI.U = linearLayoutManager.getPosition(childAt);
            }
        }
    }
}
