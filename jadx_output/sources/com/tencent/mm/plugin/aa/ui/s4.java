...
public class s4 implements km5.e {
    ...
    public final /* synthetic */ android.content.Context f72799a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.aa.ui.LaunchAAUI f72800b;

    public s4(com.tencent.mm.plugin.aa.ui.LaunchAAUI launchAAUI, android.content.Context context) {
        this.f72800b = launchAAUI;
    ...
    public void a(java.lang.Object obj) {
        ...
        com.tencent.mm.plugin.aa.ui.LaunchAAUI launchAAUI = this.f72800b;
        android.app.Dialog dialog = launchAAUI.U;
        if (dialog != null) {
            dialog.dismiss();
        }
        if (obj != null && (obj instanceof java.lang.String) && !obj.toString().equalsIgnoreCase("ok")) {
            db5.e1.E(this.f72799a, obj.toString(), "", launchAAUI.getString(com.tencent.mm.R.string.ga_), false, new com.tencent.mm.plugin.aa.ui.q4(this));
        } else if (obj == null || !(obj instanceof r45.g0)) {
            android.content.Context context = this.f72799a;
            if (obj == null || !(obj instanceof r45.a)) {
                ...
                aVar2.f211729s = str;
                aVar2.f211732v = str3;
                aVar2.E = new com.tencent.mm.plugin.aa.ui.r4(this, aVar);
                aVar2.f211733w = str2;
