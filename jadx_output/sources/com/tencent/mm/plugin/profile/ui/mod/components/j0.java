...
public final class j0 extends kr3.j {
    ...
    public final java.util.List f153930r;

    /* renamed from: s, reason: collision with root package name */
    public final java.util.List f153931s;

    /* renamed from: t, reason: collision with root package name */
    public final jz5.g f153932t;

    /* renamed from: u, reason: collision with root package name */
    public boolean f153933u;

    /* renamed from: v, reason: collision with root package name */
    public final int f153934v;

    /* renamed from: w, reason: collision with root package name */
    public final jz5.g f153935w;

    /* renamed from: x, reason: collision with root package name */
    public final jz5.g f153936x;

    /* renamed from: y, reason: collision with root package name */
    public long f153937y;

    /* renamed from: z, reason: collision with root package name */
    public long f153938z;
    ...
    public j0(androidx.appcompat.app.AppCompatActivity activity) {
        ...
        this.f153930r = new java.util.ArrayList();
        this.f153931s = new java.util.ArrayList();
        this.f153932t = jz5.h.b(new com.tencent.mm.plugin.profile.ui.mod.components.p(this));
        this.f153934v = 9;
        this.f153935w = jz5.h.b(new com.tencent.mm.plugin.profile.ui.mod.components.o(this));
        this.f153936x = jz5.h.b(new com.tencent.mm.plugin.profile.ui.mod.components.m(this, activity));
    }

    public static final java.lang.Object m7(com.tencent.mm.plugin.profile.ui.mod.components.j0 j0Var, com.tencent.mm.ui.widget.dialog.f4 f4Var, java.util.List list, int i17, kotlin.coroutines.Continuation continuation) {
        j0Var.getClass();
        ...
        java.lang.Object g17 = kotlinx.coroutines.l.g(kotlinx.coroutines.q1.f310570c, new com.tencent.mm.plugin.profile.ui.mod.components.a0(list, j0Var, i17, new java.util.ArrayList(), f4Var, null), continuation);
        return g17 == pz5.a.f359186d ? g17 : jz5.f0.f302826a;
    }

    @Override // kr3.j
    public void O6() {
        java.util.List list = this.f153931s;
        ...
        gc0.p2.T6((gc0.p2) a17, new gc0.b0(username, null), arrayList, null, new com.tencent.mm.plugin.profile.ui.mod.components.c0(username, this), 4, null);
    }
    ...
    */
    public java.lang.Object R6(kotlin.coroutines.Continuation r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.profile.ui.mod.components.j0.R6(kotlin.coroutines.Continuation):java.lang.Object");
    }

    @Override // kr3.j
    public void T6(yz5.l onResult) {
        kotlin.jvm.internal.o.g(onResult, "onResult");
        if (((com.tencent.mm.view.recyclerview.WxRecyclerView) this.f311393h) == null) {
            onResult.invoke(0);
            return;
        }
        ...
        if (!r26.n0.N(stringExtra)) {
            ...
            if (arrayList.contains(e17)) {
                ...
                if (((java.util.ArrayList) list).size() >= this.f153934v) {
                    onResult.invoke(-1);
                    return;
                }
                ...
                if (a17 == null) {
                    ...
                    ym5.a1.f(new com.tencent.mm.plugin.profile.ui.mod.components.y(this, a17, onResult));
                }
            }
        }
    }
    ...
    @Override // kr3.j
    public lr3.a Z6() {
        return new com.tencent.mm.plugin.profile.ui.mod.components.b0(this);
    }
    ...
    public boolean a7() {
        ...
        java.util.List list2 = this.f153930r;
    ...
    public android.view.View c7(java.lang.String username, com.tencent.mm.storage.z3 contact) {
        ...
        wxRecyclerView2.setAdapter((xm3.t0) ((jz5.n) this.f153936x).getValue());
        ...
        if (U6 != null) {
            ...
            com.tencent.mm.plugin.profile.ui.mod.components.u uVar = new com.tencent.mm.plugin.profile.ui.mod.components.u(h0Var, h0Var2, this);
            com.tencent.mm.plugin.profile.ui.mod.components.x xVar = new com.tencent.mm.plugin.profile.ui.mod.components.x(h0Var2, h0Var, this, wxRecyclerView2);
            java.lang.String str2 = "MicroMsg.ProfileUtilsKt";
            com.tencent.mars.xlog.Log.i("MicroMsg.ProfileUtilsKt", "contact: " + U6 + ' ' + U6.d1());
            ...
            if (d17 != null) {
                ...
                r45.o80 A0 = U6.A0();
                java.util.List list = A0 != null ? A0.f382018d : null;
                if (list == null) {
                ...
                if (U6.r2()) {
                    ...
                    while (it8.hasNext()) {
                        ...
                        if (c5Var != null) {
                            i21.q h18 = i21.q.h();
                            java.lang.String d18 = h18 != null ? h18.d(d17, c5Var.f371292d) : null;
                            if (d18 != null) {
                                com.tencent.mm.vfs.z7 a18 = com.tencent.mm.vfs.z7.a(d18);
                                ...
                                if (!m18.a() ? false : m18.f213266a.F(m18.f213267b)) {
                                    i21.q h19 = i21.q.h();
                                    java.lang.String e17 = h19 != null ? h19.e(d17, c5Var.f371292d) : null;
                                    mr3.l lVar = e17 == null ? null : new mr3.l(e17, d17, c5Var.f371292d, c5Var.f371293e, null, 0, 0, 112, null);
                                    if (lVar != null) {
                                        copyOnWriteArrayList.add(lVar);
                                    }
                                    atomicInteger.decrementAndGet();
                                    str2 = str;
                                    com.tencent.mars.xlog.Log.i(str2, "use local cache: " + i18 + ", " + d18 + ", downloading: " + atomicInteger.get());
                                } else {
                                    if (!z18) {
                                        uVar.invoke();
                                        z18 = true;
                                    }
                                    v65.i.b(lifecycleScope, null, new i21.e(d17, c5Var, i18, new com.tencent.mm.plugin.profile.b2(d18, atomicInteger, d17, c5Var, copyOnWriteArrayList, xVar), null), 1, null);
                                    str2 = str;
                                }
                                i18 = i17;
                                it8 = it;
                    ...
                    xVar.invoke(copyOnWriteArrayList);
                    return wxRecyclerView3;
                }
                java.util.ArrayList a19 = com.tencent.mm.contact.b.a(U6.f236591z1);
                ...
                while (it9.hasNext()) {
                    mr3.l a27 = mr3.l.f330874n.a(d17, (java.lang.String) it9.next(), 0);
                    if (a27 != null) {
                        arrayList3.add(a27);
                    }
                }
    ...
    public void e7() {
        super.e7();
        if (((java.util.ArrayList) this.f153931s).size() < this.f153934v || Y6()) {
            android.widget.TextView textView = this.f311391f;
            if (textView != null) {
        ...
        com.tencent.mm.plugin.mvvmlist.MvvmList.r(((xm3.t0) ((jz5.n) this.f153936x).getValue()).I, null, 1, null);
    }
    ...
    public void f7() {
        ...
        androidx.appcompat.app.AppCompatActivity activity = getActivity();
        kotlin.jvm.internal.o.g(activity, "activity");
        java.util.List list = ((kr3.q0) pf5.z.f353948a.a(activity).a(kr3.q0.class)).f311436m ? this.f153931s : this.f153930r;
        i21.q h17 = i21.q.h();
        ...
        if (f17 != null) {
            ...
            if (a17 != null) {
                com.tencent.mars.xlog.Log.i("MicroMsg.ModProfile.ModImageDescriptionUI", "saved images desc file: " + kz5.n0.g0(list, null, null, null, 0, null, com.tencent.mm.plugin.profile.ui.mod.components.q.f153970d, 31, null) + ", prefix: " + f17 + ", remarkDir: " + a17);
    ...
    public void g7(com.tencent.mm.autogen.mmdata.rpt.RemarkTagOperateLogStruct struct) {
        ...
        struct.f59982u = this.f153937y;
        struct.f59983v = this.f153938z;
    }
    ...
    public final mr3.n n7() {
        return (mr3.n) ((jz5.n) this.f153932t).getValue();
    }
    ...
    public void onActivityResult(int i17, int i18, android.content.Intent intent) {
        ...
        if (i17 == 100) {
            ...
            kotlinx.coroutines.l.d(getLifecycleScope(), null, null, new com.tencent.mm.plugin.profile.ui.mod.components.f0(username, b17, this, e4Var.c(), null), 3, null);
            return;
        }
        if (i17 == 200) {
            if (intent == null) {
            ...
            kotlinx.coroutines.l.d(getLifecycleScope(), null, null, new com.tencent.mm.plugin.profile.ui.mod.components.g0(intent, this, e4Var2.c(), null), 3, null);
            return;
        }
        if (i17 != 400) {
        ...
        if (stringArrayListExtra != null) {
            java.util.List list = this.f153931s;
            int size = ((java.util.ArrayList) list).size();
            ((java.util.ArrayList) list).removeIf(new com.tencent.mm.plugin.profile.ui.mod.components.h0(stringArrayListExtra));
            this.f153938z += size - ((java.util.ArrayList) list).size();
            e7();
        }
    }
