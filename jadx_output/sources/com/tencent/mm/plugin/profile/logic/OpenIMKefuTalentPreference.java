...
public final class OpenIMKefuTalentPreference extends com.tencent.mm.ui.base.preference.Preference {
    ...
    public OpenIMKefuTalentPreference(android.content.Context context) {
        this(context, null);
    ...
    public void M() {
        ...
        for (int i17 = 0; i17 < gk6Var.getList(2).size() && i17 < ((java.util.LinkedList) list).size(); i17++) {
            ...
            int integer = ((r45.ow6) gk6Var.getList(2).get(i17)).getInteger(1);
            ...
            java.lang.String url = ((r45.ow6) gk6Var.getList(2).get(i17)).getString(2);
    ...
    public OpenIMKefuTalentPreference(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        this.Q = (com.tencent.mm.ui.MMActivity) context;
    }

    public OpenIMKefuTalentPreference(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
