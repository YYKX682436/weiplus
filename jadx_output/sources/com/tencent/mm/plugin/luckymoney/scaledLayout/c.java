...
public class c extends com.tencent.mm.plugin.luckymoney.scaledLayout.e {
    public c(androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager) {
    ...
    @Override // com.tencent.mm.plugin.luckymoney.scaledLayout.e
    public int c() {
        return this.f145753a.getPaddingLeft();
    }
