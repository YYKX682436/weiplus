...
public final class fa extends com.tencent.mm.ui.component.UIComponent {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public fa(androidx.appcompat.app.AppCompatActivity activity) {
        super(activity);
        kotlin.jvm.internal.o.g(activity, "activity");
    }

    public static final void O6(com.tencent.mm.plugin.luckymoney.ui.fa faVar, java.lang.String str, java.lang.String str2, int i17, java.lang.String str3, com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyNewDetailUI luckyMoneyNewDetailUI) {
        ...
        faVar.getClass();
        com.tencent.mars.xlog.Log.i("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "[doClickActionJumpText] action_type: " + i17);
        ...
        if (i17 == 2) {
            ...
            j45.l.n(faVar.getContext(), com.google.android.gms.common.Scopes.PROFILE, ".ui.ContactInfoUI", intent, 2);
            gb3.m.a(86, luckyMoneyNewDetailUI != null ? luckyMoneyNewDetailUI.V2 : null);
            return;
        }
        if (i17 != 4) {
            com.tencent.mars.xlog.Log.i("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "unknow type");
            return;
        }
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).Bj(10, 2, 32, intent);
        intent.putExtra("finder_username", str3);
        if (com.tencent.mm.sdk.platformtools.t8.K0(str2)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "same_receive_link is null");
        } else {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "same_receive_link is ".concat(valueOf2));
        }
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "jump finder error, ", th6);
        }
        intent.putExtra("key_extra_info", jSONObject.toString());
        intent.putExtra("key_enter_profile_type", 52);
        ((zy2.b6) i95.n0.c(zy2.b6.class)).getClass();
        ya2.e1.f460472a.w(faVar.getContext(), intent);
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "jump finder error, ", th7);
        }
        ((c61.w8) ((zy2.pa) i95.n0.c(zy2.pa.class))).bj("red_cover_link", 1, jSONObject2, null);
        faVar.getContext().overridePendingTransition(com.tencent.mm.R.anim.f477886ea, com.tencent.mm.R.anim.f477882e6);
        gb3.m.a(82, luckyMoneyNewDetailUI != null ? luckyMoneyNewDetailUI.V2 : null);
    }

    public final void P6(int i17, java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4, com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyNewDetailUI luckyMoneyNewDetailUI) {
        java.lang.String str5;
        com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyNewDetailUI luckyMoneyNewDetailUI2;
        int i18;
        android.widget.TextView textView;
        android.widget.TextView textView2;
        android.widget.TextView textView3;
        android.widget.TextView textView4;
        com.tencent.mars.xlog.Log.i("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "[doShowTopLinkArea] actionType：" + i17 + " , actionJumpText：" + str + " , appUsername：" + str2 + ", sameReceiveLink: " + str3 + " , packetId：" + str4);
        gb3.m.f270030k = i17;
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.LuckyMoneyNewDetailUIFunctionUIC", "[doShowTopLinkArea] actionJumpText is null ,return");
            android.view.View view = luckyMoneyNewDetailUI != null ? luckyMoneyNewDetailUI.mToplinkArea : null;
            if (view == null) {
                return;
            }
        ...
        android.view.View view2 = luckyMoneyNewDetailUI != null ? luckyMoneyNewDetailUI.mToplinkArea : null;
        if (view2 != null) {
        ...
        if (luckyMoneyNewDetailUI != null && (textView4 = luckyMoneyNewDetailUI.B2) != null) {
            textView4.setText(com.tencent.mm.R.string.gki);
        }
        com.tencent.mm.wallet_core.ui.a0 a0Var = new com.tencent.mm.wallet_core.ui.a0((com.tencent.mm.wallet_core.ui.z) new com.tencent.mm.plugin.luckymoney.ui.aa(this, str4, str3, i17, str2, luckyMoneyNewDetailUI), true);
        if (com.tencent.mm.sdk.platformtools.t8.K0(str3)) {
            com.tencent.mm.wallet_core.ui.r1.w0(luckyMoneyNewDetailUI != null ? luckyMoneyNewDetailUI.f146240z2 : null, str, 0, str != null ? str.length() : 0, a0Var, getContext());
            luckyMoneyNewDetailUI2 = luckyMoneyNewDetailUI;
            ...
            str5 = "MicroMsg.LuckyMoneyNewDetailUIFunctionUIC";
            com.tencent.mm.wallet_core.ui.a0 a0Var2 = new com.tencent.mm.wallet_core.ui.a0(getResources().getColor(com.tencent.mm.R.color.a2z), getResources().getColor(com.tencent.mm.R.color.a9e), new com.tencent.mm.plugin.luckymoney.ui.ba(this, str4, str3, i17, str2, luckyMoneyNewDetailUI));
            if (str != null) {
            ...
            luckyMoneyNewDetailUI2 = luckyMoneyNewDetailUI;
            i18 = 0;
            if (luckyMoneyNewDetailUI2 != null && (textView3 = luckyMoneyNewDetailUI2.f146240z2) != null) {
                textView3.setClickable(true);
            }
            if (luckyMoneyNewDetailUI2 != null && (textView2 = luckyMoneyNewDetailUI2.f146240z2) != null) {
                textView2.setOnTouchListener(new com.tencent.mm.pluginsdk.ui.span.y0(getContext()));
            }
            if (luckyMoneyNewDetailUI2 != null && (textView = luckyMoneyNewDetailUI2.f146240z2) != null) {
                textView.setText(spannableStringBuilder);
            }
        }
        if (i17 == 2) {
            if (((luckyMoneyNewDetailUI2 == null || !luckyMoneyNewDetailUI2.f146188h) ? i18 : 1) == 0) {
                gb3.m.a(85, luckyMoneyNewDetailUI2 != null ? luckyMoneyNewDetailUI2.V2 : null);
                if (luckyMoneyNewDetailUI2 == null) {
                    return;
                }
                luckyMoneyNewDetailUI2.f146188h = true;
                return;
            }
            return;
        }
        ...
        if (((luckyMoneyNewDetailUI2 == null || !luckyMoneyNewDetailUI2.f146185g) ? i18 : 1) == 0) {
            gb3.m.a(81, luckyMoneyNewDetailUI2 != null ? luckyMoneyNewDetailUI2.V2 : null);
            if (luckyMoneyNewDetailUI2 != null) {
                luckyMoneyNewDetailUI2.f146185g = true;
            }
        }
        org.json.JSONObject jSONObject = new org.json.JSONObject();
        try {
