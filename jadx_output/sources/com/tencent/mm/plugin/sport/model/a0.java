...
public final class a0 implements android.hardware.SensorEventListener {
    ...
    public long f171771d;

    /* renamed from: e, reason: collision with root package name */
    public final java.lang.ref.WeakReference f171772e;

    public a0(android.hardware.SensorEventListener originListener) {
        kotlin.jvm.internal.o.g(originListener, "originListener");
        this.f171772e = new java.lang.ref.WeakReference(originListener);
    }

    @Override // android.hardware.SensorEventListener
    public void onAccuracyChanged(android.hardware.Sensor sensor, int i17) {
        android.hardware.SensorEventListener sensorEventListener = (android.hardware.SensorEventListener) this.f171772e.get();
    ...
    public void onSensorChanged(android.hardware.SensorEvent sensorEvent) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.SportSensorListener", sb6.toString());
        if (mm.o.j(false, 1, null)) {
            long currentTimeMillis = java.lang.System.currentTimeMillis();
            java.util.LinkedHashMap linkedHashMap = new java.util.LinkedHashMap();
            java.lang.Long valueOf = java.lang.Long.valueOf(this.f171771d);
            if (!(valueOf.longValue() > 0)) {
                valueOf = null;
            }
            if (valueOf != null) {
                valueOf.longValue();
                linkedHashMap.put("delta-millis", java.lang.Long.valueOf(currentTimeMillis - this.f171771d));
            }
            if (mm.o.k(100)) {
            ...
            this.f171771d = currentTimeMillis;
        }
    }
}
