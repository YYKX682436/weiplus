...
public class CircleAnimateView extends com.tencent.mm.plugin.gif.MMAnimateView {
    ...
    public CircleAnimateView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        this.f93381p = -2147483648L;
        this.f93379n = i65.a.f(context, com.tencent.mm.R.dimen.a0_);
        this.f93380o = i65.a.f(context, com.tencent.mm.R.dimen.a0_);
    }

    @Override // android.view.View
    public void draw(android.graphics.Canvas canvas) {
        int width = getWidth() > 0 ? getWidth() : getMeasuredWidth() > 0 ? getMeasuredWidth() : this.f93379n;
        int width2 = getWidth() > 0 ? getWidth() : getMeasuredHeight() > 0 ? getMeasuredHeight() : this.f93380o;
        ...
        super.draw(canvas2);
        if (this.f93381p >= 0) {
            float width3 = getWidth() > 0 ? getWidth() : getMeasuredWidth() > 0 ? getMeasuredWidth() : this.f93379n;
            float f17 = width3 / 2.0f;
            float width4 = (getWidth() > 0 ? getWidth() : getMeasuredHeight() > 0 ? getMeasuredHeight() : this.f93380o) / 2.0f;
            ...
            canvas2.drawArc(f17 - f18, width4 - f18, f17 + f18, f18 + width4, -90.0f, (((float) this.f93381p) / 100.0f) * 360.0f, false, paint);
        }
        int width5 = getWidth() > 0 ? getWidth() : getMeasuredWidth() > 0 ? getMeasuredWidth() : this.f93379n;
        int width6 = getWidth() > 0 ? getWidth() : getMeasuredHeight() > 0 ? getMeasuredHeight() : this.f93380o;
    ...
    public CircleAnimateView(android.content.Context context, android.util.AttributeSet attributeSet) {
