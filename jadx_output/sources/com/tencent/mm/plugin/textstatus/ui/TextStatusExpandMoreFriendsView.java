...
public final class TextStatusExpandMoreFriendsView extends android.widget.LinearLayout {
    ...
    public TextStatusExpandMoreFriendsView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final void setAvatarLayout(android.widget.LinearLayout linearLayout) {
    ...
    public final void setTvTips(android.widget.TextView textView) {
        this.tvTips = textView;
    }

    public final void setUserNameList(java.util.List<java.lang.String> list) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusExpandMoreFriendsView", sb6.toString());
        if (list == null || com.tencent.mm.sdk.platformtools.t8.L0(list)) {
            return;
        }
        android.widget.TextView textView = this.tvTips;
        if (textView != null) {
            textView.setText(list.size() == 1 ? getContext().getResources().getString(com.tencent.mm.R.string.ma7) : getContext().getResources().getString(com.tencent.mm.R.string.ma6, java.lang.Integer.valueOf(list.size())));
        }
        ...
        int dimensionPixelOffset = valueOf != null ? com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getDimensionPixelOffset(valueOf.intValue()) : 0;
        java.lang.Integer valueOf2 = java.lang.Integer.valueOf(com.tencent.mm.R.dimen.f479646bl);
        int dimensionPixelOffset2 = valueOf2 != null ? com.tencent.mm.sdk.platformtools.x2.f193071a.getResources().getDimensionPixelOffset(valueOf2.intValue()) : 0;
    ...
    public /* synthetic */ TextStatusExpandMoreFriendsView(android.content.Context context, android.util.AttributeSet attributeSet, int i17, int i18, kotlin.jvm.internal.i iVar) {
        this(context, (i18 & 2) != 0 ? null : attributeSet, (i18 & 4) != 0 ? 0 : i17);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextStatusExpandMoreFriendsView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        super(context, attributeSet, i17);
        kotlin.jvm.internal.o.g(context, "context");
        this.avatarCountLimit = 3;
        android.view.View inflate = android.view.LayoutInflater.from(getContext()).inflate(com.tencent.mm.R.layout.dol, this);
        this.root = inflate;
        if (inflate != null) {
            this.tvTips = (android.widget.TextView) inflate.findViewById(com.tencent.mm.R.id.oqc);
            this.avatarLayout = (android.widget.LinearLayout) inflate.findViewById(com.tencent.mm.R.id.hvl);
        }
    }
}
