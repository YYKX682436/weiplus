...
public final class i5 {
    ...
    public static void a(com.tencent.mm.plugin.textstatus.ui.i5 i5Var, android.content.Context context, int i17, java.lang.String userName, java.lang.String str, java.lang.Boolean bool, java.lang.Long l17, int i18, int i19, int i27, java.lang.Object obj) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.TextStatus.TextStatusCommentTransparentActivity", "start() called with: context = " + context + ", userName = " + userName + ", statusId = " + str + " isExpired:" + bool2 + " currScene:" + i29);
        if (str == null || str.length() == 0) {
            return;
        }
        android.content.Intent intent = new android.content.Intent(context, (java.lang.Class<?>) com.tencent.mm.plugin.textstatus.ui.TextStatusCommentTransparentActivity.class);
