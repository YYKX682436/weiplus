...
public final class TextStatusPreviewFinderActivity extends com.tencent.mm.plugin.secdata.ui.MMSecDataActivity {

    /* renamed from: d, reason: collision with root package name */
    public final jz5.g f173678d = jz5.h.b(new com.tencent.mm.plugin.textstatus.ui.xf(this));

    /* renamed from: e, reason: collision with root package name */
    public final jz5.g f173679e = jz5.h.b(new com.tencent.mm.plugin.textstatus.ui.wf(this));

    /* renamed from: f, reason: collision with root package name */
    public final jz5.g f173680f = jz5.h.b(new com.tencent.mm.plugin.textstatus.ui.ag(this));

    /* renamed from: g, reason: collision with root package name */
    public final jz5.g f173681g = jz5.h.b(new com.tencent.mm.plugin.textstatus.ui.uf(this));

    /* renamed from: h, reason: collision with root package name */
    public final jz5.g f173682h = jz5.h.b(new com.tencent.mm.plugin.textstatus.ui.vf(this));

    /* renamed from: i, reason: collision with root package name */
    public al5.a0 f173683i;

    @Override // com.tencent.mm.ui.MMActivity
    public int getLayoutId() {
        return com.tencent.mm.R.layout.f489564d00;
    }
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        setMMTitle("");
        hideActionbarLine();
        setBackBtn(new com.tencent.mm.plugin.textstatus.ui.yf(this));
        byte[] byteArrayExtra = getIntent().getByteArrayExtra("SELECT_OBJECT");
        if (byteArrayExtra == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.TextStatus.TextStatusPreviewFinderActivity", "finderObj bytes == null");
            finish();
            return;
        }
        ...
        java.lang.Object value = ((jz5.n) this.f173679e).getValue();
        kotlin.jvm.internal.o.f(value, "getValue(...)");
        zy2.v8.c(lVar, (android.widget.ImageView) value, avatarUrl == null ? "" : avatarUrl, null, 4, null);
        java.lang.Object value2 = ((jz5.n) this.f173680f).getValue();
        ...
        java.lang.Object value3 = ((jz5.n) this.f173682h).getValue();
        kotlin.jvm.internal.o.f(value3, "getValue(...)");
        zy2.tb.a(m1Var, (android.widget.ImageView) value3, Ai, 0, 4, null);
        java.lang.Object value4 = ((jz5.n) this.f173681g).getValue();
        kotlin.jvm.internal.o.f(value4, "getValue(...)");
        ((android.widget.Button) value4).setOnClickListener(new com.tencent.mm.plugin.textstatus.ui.zf(this));
        ((c61.l7) ((zy2.b6) i95.n0.c(zy2.b6.class))).getClass();
        ...
        if (a17 != null) {
            java.lang.Object value5 = ((jz5.n) this.f173678d).getValue();
            kotlin.jvm.internal.o.f(value5, "getValue(...)");
            a0Var2 = a17.A1("finder@inner", (android.widget.FrameLayout) value5, f17, tVar);
        }
        this.f173683i = a0Var2;
        androidx.appcompat.app.AppCompatActivity context = getContext();
        if ((context instanceof com.tencent.mm.ui.MMFragmentActivity) && (a0Var = this.f173683i) != null) {
            a0Var.J0((com.tencent.mm.ui.MMFragmentActivity) context);
        }
        al5.a0 a0Var3 = this.f173683i;
