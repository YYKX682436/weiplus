...
public final class i extends p13.t {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.fts.logic.k f137560q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(com.tencent.mm.plugin.fts.logic.k kVar, p13.u ftsRequest) {
        super(ftsRequest);
    ...
    public void p(p13.v vVar) {
        ...
        com.tencent.mm.plugin.fts.logic.k kVar = this.f137560q;
        if (vVar == null || uVar == null) {
            return;
        }
        p13.r d17 = p13.r.d(uVar.f351155q);
        int size = ((java.util.ArrayList) uVar.f351155q).size() + 3;
        com.tencent.mars.xlog.Log.i("MicroMsg.FTS.FTS5SearchChatroomMemberLogic", "search SearchCommonChatroomTask <= " + size);
        vVar.f351159d = d17;
