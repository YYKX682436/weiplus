...
public final class k1 extends p13.t {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.fts.logic.s1 f137582q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k1(com.tencent.mm.plugin.fts.logic.s1 s1Var, p13.u ftsRequest) {
        super(ftsRequest);
    ...
    public void p(p13.v vVar) {
        ...
        p75.d dVar = dm.i2.L;
        i17.f352657d = dVar.p("'%@kefu.openim'").d(dVar.p("'%@app'"));
        ...
        com.tencent.mm.plugin.fts.logic.s1 s1Var = this.f137582q;
