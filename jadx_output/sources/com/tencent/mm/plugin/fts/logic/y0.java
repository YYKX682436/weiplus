...
public class y0 extends p13.t {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.fts.logic.l f137741q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y0(com.tencent.mm.plugin.fts.logic.l lVar, p13.u uVar) {
        super(uVar);
        this.f137741q = lVar;
    }
    ...
    public void p(p13.v vVar) {
        ...
        vVar.f351159d = b17;
        w13.b bVar = this.f137741q.f137588g;
        int[] iArr = this.f351135n.f351145g;
        bVar.getClass();
        if (b17.a()) {
            o17 = new d95.d();
        } else {
            ...
            o17 = ((com.tencent.mm.plugin.fts.o) bVar.f342198f).o(java.lang.String.format("SELECT %s.docid, type, subtype, entity_id, aux_index, timestamp, content, MMHighlight(%s, %d, type, subtype), MMContactRank(%s, timestamp / 1000 - %d / 1000, subtype, ?, %d) AS Rank FROM %s NOT INDEXED JOIN %s ON (%s.docid = %s.rowid) WHERE %s MATCH '%s' AND type IN " + o13.n.m(iArr) + " ORDER BY Rank ;", bVar.r(), bVar.o(), java.lang.Long.valueOf(size), bVar.o(), java.lang.Long.valueOf(currentTimeMillis), java.lang.Long.valueOf(size), bVar.r(), bVar.o(), bVar.r(), bVar.o(), bVar.o(), f17), new java.lang.String[]{b17.f351130b});
        }
