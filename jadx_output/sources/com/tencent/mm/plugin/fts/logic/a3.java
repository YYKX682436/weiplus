...
public class a3 extends p13.t {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.fts.logic.e3 f137452q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a3(com.tencent.mm.plugin.fts.logic.e3 e3Var, p13.u uVar) {
        super(uVar);
        this.f137452q = e3Var;
    }
    ...
    public void p(p13.v vVar) {
        ...
        com.tencent.mm.plugin.fts.logic.e3 e3Var = this.f137452q;
        ...
        try {
            ...
            L0.close();
            android.database.Cursor O = e3Var.f137517h.O(vVar.f351159d, uVar.f351142d);
            ...
            vVar.f351160e.addAll(arrayList);
