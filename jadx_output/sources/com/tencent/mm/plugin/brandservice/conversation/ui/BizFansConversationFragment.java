...
public final class BizFansConversationFragment extends com.tencent.mm.chatting.BasePrivateMsgConvListFragment<hr1.e> {

    /* renamed from: w, reason: collision with root package name */
    public final int f93946w;

    /* renamed from: x, reason: collision with root package name */
    public final jz5.g f93947x = jz5.h.b(new ir1.g0(this));

    public BizFansConversationFragment(int i17) {
        this.f93946w = i17;
    }
    ...
    @Override // com.tencent.mm.chatting.BasePrivateMsgConvListFragment
    public wn.a t0() {
        return (ir1.e0) ((jz5.n) this.f93947x).getValue();
    }

    @Override // com.tencent.mm.chatting.BasePrivateMsgConvListFragment
    public java.util.List u0() {
        return this.f93946w == 5 ? kz5.b0.c(yq1.u0.Ui()) : kz5.b0.c(yq1.u0.Bi());
    }

    @Override // com.tencent.mm.chatting.BasePrivateMsgConvListFragment
    public wn.b y0() {
        return this.f93946w == 5 ? new mr1.a() : new ir1.f0();
    }
}
