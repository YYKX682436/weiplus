...
public final class c1 extends qz5.l implements yz5.p {
    ...
    public final /* synthetic */ long f94200f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f94201g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ int f94202h;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c1(long j17, java.lang.String str, kotlin.coroutines.Continuation continuation, int i17) {
    ...
    public final kotlin.coroutines.Continuation create(java.lang.Object obj, kotlin.coroutines.Continuation continuation) {
        com.tencent.mm.plugin.brandservice.ui.timeline.preload.c1 c1Var = new com.tencent.mm.plugin.brandservice.ui.timeline.preload.c1(this.f94200f, this.f94201g, continuation, this.f94202h);
        c1Var.f94199e = obj;
        return c1Var;
    }
    ...
    public java.lang.Object invoke(java.lang.Object obj, java.lang.Object obj2) {
        return ((com.tencent.mm.plugin.brandservice.ui.timeline.preload.c1) create((kotlinx.coroutines.y0) obj, (kotlin.coroutines.Continuation) obj2)).invokeSuspend(jz5.f0.f302826a);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        int i18 = this.f94198d;
        if (i18 == 0) {
            kotlin.ResultKt.throwOnFailure(obj);
            kotlinx.coroutines.y0 y0Var2 = (kotlinx.coroutines.y0) this.f94199e;
            long j17 = this.f94200f;
            this.f94199e = y0Var2;
            this.f94198d = 1;
            ...
            y0Var = (kotlinx.coroutines.y0) this.f94199e;
            kotlin.ResultKt.throwOnFailure(obj);
        }
        ...
        java.lang.String str = this.f94201g;
        synchronized (caVar) {
        ...
        if (arrayList != null) {
            if (!arrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList2.add(com.tencent.mm.plugin.brandservice.ui.timeline.preload.d.d(((java.util.ArrayList) it.next()).get(0).toString()));
                }
            ...
            while (it6.hasNext()) {
                ...
                if (hashSet.add(com.tencent.mm.plugin.brandservice.ui.timeline.preload.d.d((java.lang.String) obj4))) {
                    arrayList5.add(next);
                }
            }
            if (!arrayList5.isEmpty()) {
                ...
                if (com.tencent.mm.plugin.brandservice.ui.timeline.preload.t1.e(com.tencent.mm.plugin.brandservice.ui.timeline.preload.t1.f94435a.s(this.f94202h))) {
                    int m17 = com.tencent.mm.plugin.brandservice.ui.timeline.preload.d.m(this.f94202h);
                    java.util.ArrayList arrayList7 = new java.util.ArrayList();
                    java.util.Iterator it8 = arrayList5.iterator();
                    while (it8.hasNext()) {
                        java.lang.Object next2 = it8.next();
                        kotlin.jvm.internal.o.e(((java.util.ArrayList) next2).get(0), "null cannot be cast to non-null type kotlin.String");
                    ...
                    while (it9.hasNext()) {
                        ...
                        arrayList8.add(new com.tencent.mm.plugin.brandservice.ui.timeline.preload.z0((java.lang.String) obj8, j18, (java.lang.String) obj10));
                    }
                    java.util.ArrayList arrayList10 = new java.util.ArrayList();
                    java.util.Iterator it10 = arrayList8.iterator();
                    while (it10.hasNext()) {
                        java.lang.Object next3 = it10.next();
                        com.tencent.mm.plugin.brandservice.ui.timeline.preload.z0 z0Var = (com.tencent.mm.plugin.brandservice.ui.timeline.preload.z0) next3;
                        java.lang.String str2 = z0Var.f94485a;
                        if (!(!hy4.i.p(str2) || com.tencent.mm.plugin.brandservice.ui.timeline.preload.t1.f94443i.b(str2, z0Var.f94486b))) {
                    ...
                    if (true ^ K0.isEmpty()) {
                        ((yq1.z) ((zq1.a0) gm0.j1.s(zq1.a0.class))).y(this.f94202h, size, K0.size(), K0.size() / size, max, m17);
                        com.tencent.mm.plugin.brandservice.ui.timeline.preload.t1.f94435a.d(K0, this.f94202h, max, 2);
                        ...
                        while (it11.hasNext()) {
                            arrayList11.add(com.tencent.mm.plugin.brandservice.ui.timeline.preload.d.d(((com.tencent.mm.plugin.brandservice.ui.timeline.preload.z0) it11.next()).f94485a));
                        }
        ...
        com.tencent.mm.sdk.platformtools.ca.f192507b.remove(this.f94201g);
        return jz5.f0.f302826a;
    }
}
