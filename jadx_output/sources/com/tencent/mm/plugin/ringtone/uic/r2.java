...
public final class r2 extends androidx.recyclerview.widget.w2 {

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.plugin.ringtone.uic.b3 f158471d;

    public r2(com.tencent.mm.plugin.ringtone.uic.b3 b3Var) {
        this.f158471d = b3Var;
    }
    ...
    public void onScrolled(androidx.recyclerview.widget.RecyclerView recyclerView, int i17, int i18) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (this.f158471d.f158359o == null) {
                kotlin.jvm.internal.o.o("ringtoneVideoSnapHelper");
                throw null;
            }
            double min = java.lang.Math.min(java.lang.Math.abs((top - r5.f224749f) - r4.f158365u) / childAt.getHeight(), 1.0d) * 0.5d;
            android.view.View p17 = s0Var.p(com.tencent.mm.R.id.f486689m54);
            if (p17 != null) {
