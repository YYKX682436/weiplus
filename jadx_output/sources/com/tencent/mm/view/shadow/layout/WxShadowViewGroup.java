...
public abstract class WxShadowViewGroup extends android.view.ViewGroup {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public final jz5.g shadowHelper;

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public WxShadowViewGroup(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public WxShadowViewGroup(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
