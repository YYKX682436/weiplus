...
public final class RelativeLayoutEx extends android.widget.RelativeLayout {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public ym5.z4 translationCallback;

    public RelativeLayoutEx(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void setTransitionAlpha(float f17) {
        ...
        if (z4Var != null) {
            ((com.tencent.mm.plugin.webview.ui.tools.widget.h1) z4Var).a(this);
        }
    }

    public final void setTranslationCallback(ym5.z4 z4Var) {
    ...
    public RelativeLayoutEx(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
