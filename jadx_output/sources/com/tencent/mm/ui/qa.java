...
public class qa implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ java.lang.Runnable f209548d;

    public qa(com.tencent.mm.ui.ga gaVar, java.lang.Runnable runnable) {
        this.f209548d = runnable;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        java.lang.Runnable runnable = this.f209548d;
        if (runnable != null) {
            runnable.run();
        }
