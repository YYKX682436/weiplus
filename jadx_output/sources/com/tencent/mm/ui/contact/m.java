...
public class m implements android.widget.AbsListView.OnScrollListener {
    ...
    public final /* synthetic */ com.tencent.mm.ui.contact.AddressUI.AddressUIFragment f207020d;

    public m(com.tencent.mm.ui.contact.AddressUI.AddressUIFragment addressUIFragment) {
        this.f207020d = addressUIFragment;
    }
    ...
    public void onScroll(android.widget.AbsListView absListView, int i17, int i18, int i19) {
        ...
        com.tencent.mm.ui.contact.AddressUI.AddressUIFragment addressUIFragment = this.f207020d;
        if (!addressUIFragment.f206316x) {
            addressUIFragment.f206316x = true;
        }
        yj0.a.h(this, "com/tencent/mm/ui/contact/AddressUI$AddressUIFragment$18", "android/widget/AbsListView$OnScrollListener", "onScroll", "(Landroid/widget/AbsListView;III)V");
    }
