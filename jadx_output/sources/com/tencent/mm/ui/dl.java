...
public abstract class dl {
    ...
    public static boolean f208345a;

    /* renamed from: b, reason: collision with root package name */
    public static boolean f208346b;

    /* renamed from: c, reason: collision with root package name */
    public static java.lang.Boolean f208347c;

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.List f208348d;
    ...
    static {
        ...
        f208348d = java.util.Collections.unmodifiableList(arrayList);
    }
    ...
    public static void a(android.widget.LinearLayout linearLayout, int i17) {
        for (int i18 = 0; i18 < linearLayout.getChildCount(); i18++) {
            ...
            if ((childAt.getTag(com.tencent.mm.R.id.vc_) instanceof java.lang.Integer) && ((java.lang.Integer) childAt.getTag(com.tencent.mm.R.id.vc_)).intValue() == com.tencent.mm.R.layout.c_6) {
                android.widget.TextView textView = (android.widget.TextView) childAt.findViewById(com.tencent.mm.R.id.obc);
                int e17 = (i17 * 2) - com.tencent.mm.ui.zk.e(linearLayout.getContext(), com.tencent.mm.R.dimen.f479672c9);
                ...
                if (paint.measureText(charSequence) > f17) {
                    ...
                    textView.getContext();
                    float f18 = textSize / com.tencent.mm.ui.zk.f212638b;
                    int i19 = 0;
                    while (true) {
                        java.util.List list = f208348d;
                        if (i19 < list.size()) {
    ...
    public static int e(android.content.Context context) {
        int identifier;
        if (!f(context) || (identifier = android.content.res.Resources.getSystem().getIdentifier("navigation_bar_height", "dimen", com.eclipsesource.mmv8.Platform.ANDROID)) <= 0) {
            return 0;
        }
    ...
    public static boolean g() {
        if (f208347c == null) {
            ...
            f208347c = java.lang.Boolean.valueOf(!android.text.TextUtils.isEmpty(str) && str.equalsIgnoreCase("xiaomi"));
        }
        return f208347c.booleanValue();
    }
    ...
    public static void h(android.widget.LinearLayout linearLayout, int i17) {
        ...
        for (int i18 = 0; i18 < linearLayout.getChildCount(); i18++) {
            android.view.View childAt = linearLayout.getChildAt(i18);
            if ((childAt.getTag(com.tencent.mm.R.id.vc_) instanceof java.lang.Integer) && ((java.lang.Integer) childAt.getTag(com.tencent.mm.R.id.vc_)).intValue() == com.tencent.mm.R.layout.c_6 && (findViewById = childAt.findViewById(com.tencent.mm.R.id.cg7)) != null) {
