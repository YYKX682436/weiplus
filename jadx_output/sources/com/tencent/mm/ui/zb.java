...
public class zb extends com.tencent.mm.ui.ga implements ma5.d {
    public ma5.e A0;

    /* renamed from: y0, reason: collision with root package name */
    public com.tencent.mm.ui.MMFragment f212616y0 = null;

    /* renamed from: z0, reason: collision with root package name */
    public androidx.appcompat.app.b f212617z0;

    @Override // com.tencent.mm.ui.ga
    public s75.b B() {
        com.tencent.mm.ui.MMFragment mMFragment = this.f212616y0;
        if (mMFragment != null) {
    ...
    public androidx.appcompat.app.b F() {
        if (this.f212617z0 == null) {
            this.f212617z0 = al5.p0.N(this.A0.e());
        }
        return this.f212617z0;
    }
    ...
    public boolean onCreatePanelMenu(int i17, android.view.Menu menu) {
        this.f212616y0.onCreateOptionsMenu(menu, this.A0.f());
        return true;
    }
    ...
    public java.lang.String v() {
        return this.f212616y0.getClass().getName();
    }
