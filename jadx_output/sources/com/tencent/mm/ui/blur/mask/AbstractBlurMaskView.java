...
public abstract class AbstractBlurMaskView<CACHE> extends android.widget.FrameLayout implements jb5.d {
    ...
    public AbstractBlurMaskView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        if (this.isBlurEnabled && this.blurRenderer != null && getBlurBackground() != null) {
            ...
            if (((com.tencent.mm.ui.blur.mask.AbstractBlurMaskBackgroundView) blurBackground).isCacheEnabled) {
    ...
    public void setBlurBackground(jb5.e eVar) {
        this.blurBackground = eVar;
        invalidate();
    }

    public void setBlurEnabled(boolean z17) {
    ...
    public void setBlurRadius(int i17) {
        this.blurRadius = i17;
    }

    public final void setBlurRenderer(jb5.f fVar) {
        this.blurRenderer = fVar;
    }

    public void setOverlayColor(int i17) {
        this.overlayColor = i17;
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AbstractBlurMaskView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
        this(context, attributeSet, i17, 0, 8, null);
        kotlin.jvm.internal.o.g(context, "context");
    }

    public /* synthetic */ AbstractBlurMaskView(android.content.Context context, android.util.AttributeSet attributeSet, int i17, int i18, int i19, kotlin.jvm.internal.i iVar) {
        this(context, (i19 & 2) != 0 ? null : attributeSet, (i19 & 4) != 0 ? 0 : i17, (i19 & 8) != 0 ? 0 : i18);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractBlurMaskView(android.content.Context context, android.util.AttributeSet attributeSet, int i17, int i18) {
