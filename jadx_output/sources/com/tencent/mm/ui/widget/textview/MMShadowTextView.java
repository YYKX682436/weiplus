...
public class MMShadowTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public MMShadowTextView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    ...
    public void b(android.util.AttributeSet attrs, int i17) {
        kotlin.jvm.internal.o.g(attrs, "attrs");
        android.content.res.TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attrs, yl5.a.f463106m, i17, 0);
    ...
    public final void setShadowMaskColor(int i17) {
        this.shadowMaskColor = i17;
    }

    public final void setShadowMaskPadding(float f17) {
        this.shadowMaskPadding = f17;
    }

    public final void setShadowMaskRadius(float f17) {
        this.shadowMaskRadius = f17;
    }

    public final void setShadowTextView(android.widget.TextView textView) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MMShadowTextView(android.content.Context context, android.util.AttributeSet attrs, int i17) {
