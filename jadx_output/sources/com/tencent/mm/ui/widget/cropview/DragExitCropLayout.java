...
public class DragExitCropLayout extends com.tencent.mm.ui.widget.cropview.CropLayout {
    ...
    public boolean f211666x1;

    /* renamed from: y1, reason: collision with root package name */
    public float f211667y1;

    /* renamed from: z1, reason: collision with root package name and from kotlin metadata */
    public android.view.View bgView;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DragExitCropLayout(android.content.Context context) {
        super(context);
    ...
    public void c(android.view.MotionEvent e17) {
        ...
        super.c(e17);
        if (this.f211666x1 && (view = this.bgView) != null && (animate = view.animate()) != null && (duration = animate.setDuration(200L)) != null && (alpha = duration.alpha(1.0f)) != null) {
            alpha.start();
        }
        this.f211666x1 = false;
    }
    ...
    public boolean onScroll(android.view.MotionEvent motionEvent, android.view.MotionEvent e27, float f17, float f18) {
        ...
        if (this.isEnableDragExit && !this.isFirstCancelOrUp && !x()) {
            if ((motionEvent != null && motionEvent.getPointerCount() == 1) && e27.getPointerCount() == 1 && ((z17 = this.f211666x1) || f18 < 0.0f)) {
                if (!z17) {
                    this.f211667y1 = getContentViewScale()[0];
                }
                this.f211666x1 = true;
                float exactCenterY = (getContentRect().exactCenterY() - getVisibilityRect().centerY()) / (getVisibilityRect().height() / 2);
                B((this.f211667y1 * (1.0f - (0.6f * exactCenterY))) / getContentViewScale()[0], getContentRect().exactCenterX(), getContentRect().exactCenterY());
    ...
    public final void setBgView(android.view.View view) {
        this.bgView = view;
    }

    public final void setEnableDragExit(boolean z17) {
        this.isEnableDragExit = z17;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DragExitCropLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DragExitCropLayout(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
