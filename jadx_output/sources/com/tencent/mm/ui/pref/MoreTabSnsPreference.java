...
public final class MoreTabSnsPreference extends com.tencent.mm.plugin.newtips.NormalIconNewTipPreference {

    /* renamed from: i2, reason: collision with root package name */
    public int f209525i2;

    public MoreTabSnsPreference(android.content.Context context) {
        super(context);
        this.f209525i2 = -1;
    }
    ...
    public final void p0() {
        ...
        if (i17 != 0) {
            ...
            drawable2.setColorFilter(this.f209525i2, android.graphics.PorterDuff.Mode.SRC_ATOP);
            return;
        }
    ...
    public MoreTabSnsPreference(android.content.Context context, android.util.AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f209525i2 = -1;
    }

    public MoreTabSnsPreference(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
