...
public class aj implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ java.lang.String f203362d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.lang.String f203363e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ java.util.Map f203364f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.storage.f9 f203365g;

    /* renamed from: h, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.ui.chatting.viewitems.ChattingItemDyeingTemplate f203366h;

    public aj(com.tencent.mm.ui.chatting.viewitems.ChattingItemDyeingTemplate chattingItemDyeingTemplate, java.lang.String str, java.lang.String str2, java.util.Map map, com.tencent.mm.storage.f9 f9Var) {
        this.f203366h = chattingItemDyeingTemplate;
        this.f203362d = str;
        this.f203363e = str2;
        this.f203364f = map;
        this.f203365g = f9Var;
    ...
    public void onClick(android.view.View view) {
        ...
        java.lang.String str = this.f203362d;
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            ...
            intent.putExtra("geta8key_username", this.f203363e);
            intent.putExtra("key_enable_teen_mode_check", true);
            intent.putExtra("key_enable_fts_quick", true);
            com.tencent.mm.ui.chatting.viewitems.ChattingItemDyeingTemplate chattingItemDyeingTemplate = this.f203366h;
            ...
            java.lang.String str3 = this.f203363e;
            ...
            java.util.Map map = this.f203364f;
            ...
            g0Var.d(11608, str2, str3, 1, valueOf, str4, valueOf2, valueOf3, str5, valueOf4, cVar2.f297376h, cVar2.f297380l, java.lang.Integer.valueOf(chattingItemDyeingTemplate.b1()));
            ...
            com.tencent.mm.storage.f9 f9Var = this.f203365g;
