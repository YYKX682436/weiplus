...
public class vo implements db5.t4 {
    ...
    public final /* synthetic */ com.tencent.mm.ui.chatting.viewitems.lp f205882d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.storage.f9 f205883e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ yb5.d f205884f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f205885g;

    public vo(com.tencent.mm.ui.chatting.viewitems.lp lpVar, com.tencent.mm.storage.f9 f9Var, yb5.d dVar, android.content.Context context) {
        this.f205882d = lpVar;
        this.f205883e = f9Var;
        this.f205884f = dVar;
        this.f205885g = context;
    }

    @Override // db5.t4
    public void onMMMenuItemSelected(android.view.MenuItem menuItem, int i17) {
        com.tencent.mm.ui.chatting.viewitems.lp lpVar = this.f205882d;
        java.lang.String charSequence = lpVar.f204516n.toString();
        int itemId = menuItem.getItemId();
        com.tencent.mm.storage.f9 f9Var = this.f205883e;
        if (itemId == 0) {
        ...
        if (itemId == 1) {
            wl5.x xVar3 = lpVar.f204513k;
            if (xVar3 != null) {
                wl5.v vVar = xVar3.f447166k;
                if (vVar != null) {
                    vVar.d();
                }
                wl5.x xVar4 = lpVar.f204513k;
                xVar4.M = true;
                xVar4.i();
                lpVar.f204513k.l(0, lpVar.f204510h.getContentView().a().length());
                lpVar.f204513k.o();
                wl5.x xVar5 = lpVar.f204513k;
                if (xVar5.f447168m) {
                    xVar5.f447168m = false;
                    xVar5.n(java.lang.Boolean.TRUE);
                }
                lpVar.f204513k.r();
                wl5.v vVar2 = lpVar.f204513k.f447166k;
                if (vVar2 != null) {
                    vVar2.e();
                    return;
                }
