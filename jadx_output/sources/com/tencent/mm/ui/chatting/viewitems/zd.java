...
public class zd implements db5.t4 {
    ...
    public final /* synthetic */ com.tencent.mm.ui.chatting.viewitems.od f206127d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f206128e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.storage.f9 f206129f;

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ com.tencent.mm.ui.chatting.viewitems.ae f206130g;

    public zd(com.tencent.mm.ui.chatting.viewitems.ae aeVar, com.tencent.mm.ui.chatting.viewitems.od odVar, android.content.Context context, com.tencent.mm.storage.f9 f9Var) {
        this.f206130g = aeVar;
        this.f206127d = odVar;
        this.f206128e = context;
        this.f206129f = f9Var;
    }
    ...
    public void onMMMenuItemSelected(android.view.MenuItem menuItem, int i17) {
        ...
        r15.g gVar = null;
        com.tencent.mm.ui.chatting.viewitems.ae aeVar = this.f206130g;
        com.tencent.mm.ui.chatting.viewitems.od odVar = this.f206127d;
        if (itemId == 0) {
            android.content.Context context = com.tencent.mm.sdk.platformtools.x2.f193071a;
            java.lang.CharSequence charSequence = aeVar.f203349t;
            ...
            android.app.Activity g17 = aeVar.f203348s.g();
            int i18 = com.tencent.mm.ui.widget.dialog.f4.f211790n;
            com.tencent.mm.ui.widget.dialog.e4 e4Var = new com.tencent.mm.ui.widget.dialog.e4(g17);
            e4Var.f211776c = aeVar.f203348s.g().getResources().getString(com.tencent.mm.R.string.f490361st);
            e4Var.c();
            try {
                com.tencent.mm.ui.chatting.viewitems.er erVar2 = (com.tencent.mm.ui.chatting.viewitems.er) odVar.f205179b.getTag();
                if (erVar2 != null) {
                    java.lang.String q07 = ((com.tencent.mm.ui.chatting.component.ym) ((sb5.l2) aeVar.f203348s.f460708c.a(sb5.l2.class))).q0(erVar2.c(), false);
                    ...
                    shareMsgClipStruct.f60343e = aeVar.f203349t.length();
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.ChattingItemAppMsgTextTo", "report occur exception! %s", e17.getMessage());
                return;
            }
        }
        if (itemId == 1) {
        ...
        android.content.Context context2 = this.f206128e;
        com.tencent.mm.storage.f9 f9Var = this.f206129f;
        if (itemId == 2) {
            ...
            intent.putExtra("Retr_Msg_content", aeVar.f203349t);
            intent.putExtra("Retr_Msg_Type", 4);
            intent.putExtra("scene_from", 17);
            android.content.Context context3 = this.f206128e;
        ...
        if (itemId == 3) {
            ...
            com.tencent.mm.pluginsdk.model.a2.m(doFavoriteEvent, aeVar.f203349t.toString(), 1);
            com.tencent.mm.ui.chatting.BaseChattingUIFragment baseChattingUIFragment = aeVar.f203348s.f460717l;
        ...
        if (itemId != 4) {
            if (itemId == 136 && ((com.tencent.mm.ui.chatting.viewitems.er) odVar.f205179b.getTag()) != null) {
                if (!com.tencent.mm.sdk.platformtools.t8.J0(aeVar.f203349t)) {
                    gVar = r15.h.a(odVar.f205179b.a().toString(), aeVar.f203349t, ((java.lang.Integer) odVar.f205184g.e().first).intValue(), ((java.lang.Integer) odVar.f205184g.e().second).intValue());
                ...
                ((com.tencent.mm.ui.chatting.component.jb) ((sb5.s0) aeVar.f203348s.f460708c.a(sb5.s0.class))).o0(f9Var, gVar);
                return;
            }
            return;
        }
        java.lang.String str = "65_" + c01.id.c();
        java.lang.String charSequence2 = aeVar.f203349t.toString();
        aeVar.D(aeVar.f203348s, this.f206129f, 2, !com.tencent.mm.sdk.platformtools.t8.K0(((rq1.m0) ((rq1.l0) i95.n0.c(rq1.l0.class))).Ai(charSequence2)), charSequence2, true, str, 3);
