...
public class og implements c01.o8 {
    ...
    public final /* synthetic */ java.lang.ref.WeakReference f205200a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ android.widget.TextView f205201b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ android.content.Context f205202c;

    public og(java.lang.ref.WeakReference weakReference, android.widget.TextView textView, android.content.Context context) {
        this.f205200a = weakReference;
        this.f205201b = textView;
        this.f205202c = context;
    }

    @Override // c01.o8
    public void a(java.lang.String str, boolean z17) {
        android.widget.ImageView imageView;
        java.lang.ref.WeakReference weakReference = this.f205200a;
        ...
        android.content.Context context = this.f205202c;
        android.widget.TextView textView = this.f205201b;
