...
public final class BubbleCornorLayout extends android.widget.RelativeLayout {
    ...
    public BubbleCornorLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final android.graphics.Matrix a(float f17, float f18) {
        ...
        if (str != null) {
            ...
            if (hashCode != 3317767) {
                if (hashCode == 3387192) {
                    str.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE);
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        ...
        if (str != null) {
            ...
            if (hashCode != 3317767) {
                ...
                } else if (str.equals(com.tencent.mm.plugin.lite.LiteAppCenter.FRAMEWORK_TYPE_NONE)) {
    ...
    public final void setBUBBLE_OFFSET(int i17) {
        this.BUBBLE_OFFSET = i17;
    }

    public final void setBUBBLE_ORIENTATION(java.lang.String str) {
        this.BUBBLE_ORIENTATION = str;
    }

    public final void setBUBBLE_RADIUS(int i17) {
        this.BUBBLE_RADIUS = i17;
    }

    public final void setCORNER_RADIUS(int i17) {
        this.CORNER_RADIUS = i17;
    }

    public final void setEXTRA_PADDING(int i17) {
