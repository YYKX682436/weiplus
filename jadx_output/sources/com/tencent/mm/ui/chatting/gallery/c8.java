...
public class c8 implements android.view.animation.Animation.AnimationListener {
    ...
    public final /* synthetic */ com.tencent.mm.ui.chatting.gallery.d8 f200835a;

    public c8(com.tencent.mm.ui.chatting.gallery.d8 d8Var) {
        this.f200835a = d8Var;
    }

    @Override // android.view.animation.Animation.AnimationListener
    public void onAnimationEnd(android.view.animation.Animation animation) {
        com.tencent.mm.ui.chatting.gallery.d8 d8Var = this.f200835a;
        if (d8Var.f200869d.U.getVisibility() != 0) {
            return;
        }
        android.view.View view = d8Var.f200869d.U;
