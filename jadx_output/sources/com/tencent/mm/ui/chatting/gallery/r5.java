...
public class r5 implements al5.z3 {
    ...
    public final /* synthetic */ com.tencent.mm.ui.chatting.gallery.ImageGalleryUI f201336a;

    public r5(com.tencent.mm.ui.chatting.gallery.ImageGalleryUI imageGalleryUI) {
        this.f201336a = imageGalleryUI;
    }

    @Override // al5.z3
    public void a() {
        com.tencent.mm.ui.chatting.gallery.ImageGalleryUI imageGalleryUI = this.f201336a;
    ...
    public void onDoubleTap(float f17, float f18) {
        ...
        if (k1Var.w() == null || !imageGalleryUI.f200611g.w().isVideo()) {
            if (imageGalleryUI.f200611g.w() == null || !imageGalleryUI.f200611g.w().J2()) {
                return;
            }
        ...
        if (!imageGalleryUI.X1.getAddTouchView()) {
            ...
            if (v17.f201438p instanceof com.tencent.mm.plugin.thumbplayer.view.ThumbPlayerViewContainer) {
                ...
                if (currentView != null && (currentView instanceof com.tencent.mm.plugin.thumbplayer.view.MMTextureView)) {
                    ...
                    if (rect.bottom - rect.top > 0) {
                        imageGalleryUI.X1.setRealViewHeight(r1 - r3);
