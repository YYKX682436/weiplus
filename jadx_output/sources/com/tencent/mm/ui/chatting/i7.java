...
public final class i7 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.widget.FrameLayout f201836d;

    public i7(android.widget.FrameLayout frameLayout) {
        this.f201836d = frameLayout;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.widget.FrameLayout frameLayout = this.f201836d;
        android.content.Intent intent = new android.content.Intent(frameLayout.getContext(), (java.lang.Class<?>) com.tencent.mm.ui.schedulemsg.ScheduleMsgDetailUI.class);
