...
public final class d2 {
    ...
    public static final com.tencent.mm.ui.chatting.d2 f200411a = new com.tencent.mm.ui.chatting.d2();
    ...
    public final void a(java.lang.String str, java.lang.String str2, android.widget.TextView textView, android.content.Context context) {
        ...
        if (!(str == null || str.length() == 0)) {
            if (!(str2 == null || str2.length() == 0)) {
                if (context == null) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.C2cAppMsgRemittanceUtil", "setMiddleEllipsizeTextForRemittance: context is null");
                    return;
                }
                jz5.f0 f0Var = null;
                if (textView != null) {
                ...
                if (f0Var == null) {
                    com.tencent.mars.xlog.Log.e("MicroMsg.C2cAppMsgRemittanceUtil", "setMiddleEllipsizeTextForRemittance: textView is null");
                    return;
                }
                return;
            }
        }
        com.tencent.mars.xlog.Log.e("MicroMsg.C2cAppMsgRemittanceUtil", "setMiddleEllipsizeTextForRemittance: prefixContent or feeDesc is empty");
    }
}
