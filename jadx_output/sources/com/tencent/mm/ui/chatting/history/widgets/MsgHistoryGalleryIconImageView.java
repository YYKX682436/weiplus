...
public final class MsgHistoryGalleryIconImageView extends androidx.appcompat.widget.AppCompatImageView {
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public MsgHistoryGalleryIconImageView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public MsgHistoryGalleryIconImageView(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
