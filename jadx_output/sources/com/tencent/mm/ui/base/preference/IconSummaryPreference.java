...
public class IconSummaryPreference extends com.tencent.mm.ui.base.preference.Preference {
    ...
    public IconSummaryPreference(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public void G(int i17) {
        ...
        super.G(i17);
        if (this.W == null || (charSequence = this.f197776m) == null || charSequence.length() <= 0) {
            return;
        }
        this.W.setText(this.f197776m);
    }
    ...
    public void H(java.lang.CharSequence charSequence) {
        ...
        if (this.W == null || (charSequence2 = this.f197776m) == null || charSequence2.length() <= 0) {
            return;
        }
        this.W.setText(this.f197776m);
    }
    ...
    public void t(android.view.View view) {
        ...
        if (this.T == null) {
            this.T = (android.widget.ImageView) view.findViewById(com.tencent.mm.R.id.h_s);
        }
        if (this.U == null) {
            this.U = (android.view.ViewGroup) view.findViewById(com.tencent.mm.R.id.m4_);
        }
        if (this.V == null) {
            this.V = view.findViewById(com.tencent.mm.R.id.m47);
        }
        ...
        android.widget.TextView textView2 = (android.widget.TextView) view.findViewById(com.tencent.mm.R.id.m4g);
        this.W = textView2;
        if (textView2 != null && (charSequence = this.f197776m) != null && charSequence.length() > 0) {
            this.W.setText(this.f197776m);
        ...
        this.W.setCompoundDrawablePadding(com.tencent.mm.sdk.platformtools.j.d(this.f197770d, 2.0f));
        this.W.setVisibility(this.S);
    }
    ...
    public android.view.View u(android.view.ViewGroup viewGroup) {
        ...
        android.view.View.inflate(this.f197770d, com.tencent.mm.R.layout.bzj, viewGroup2);
        return u17;
    }

    public IconSummaryPreference(android.content.Context context, android.util.AttributeSet attributeSet, int i17) {
