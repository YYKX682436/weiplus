...
public final class l3 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ db5.h3 f209062d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ java.lang.Runnable f209063e;

    public l3(db5.h3 h3Var, java.lang.Runnable runnable) {
        this.f209062d = h3Var;
        this.f209063e = runnable;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        this.f209062d.B();
        gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_CONVERSATION_DELETE_GUIDE_BOOLEAN_SYNC, java.lang.Boolean.TRUE);
        this.f209063e.run();
