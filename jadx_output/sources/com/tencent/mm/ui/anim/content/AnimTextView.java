...
public final class AnimTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public boolean f197179q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AnimTextView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public final void b(boolean z17) {
        if (kotlin.jvm.internal.o.b(getText().toString(), this.tText)) {
            return;
        }
        int width = getWidth();
        setText(this.tText);
    ...
    public final void setTBackgroundRes(int i17) {
        this.tBackgroundRes = i17;
    }

    public final void setTBackgroundShow(boolean z17) {
        this.tBackgroundShow = z17;
    }

    public final void setTDuration(long j17) {
        this.tDuration = j17;
    }

    public final void setTPaddingLeft(int i17) {
        this.tPaddingLeft = i17;
    }

    public final void setTPaddingRight(int i17) {
        this.tPaddingRight = i17;
    }

    public final void setTText(java.lang.String str) {
        kotlin.jvm.internal.o.g(str, "<set-?>");
        this.tText = str;
    }

    public final void setTTextColor(int i17) {
        this.tTextColor = i17;
    }
}
