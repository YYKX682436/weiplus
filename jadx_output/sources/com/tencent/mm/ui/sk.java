...
public abstract class sk {
    public static android.graphics.Bitmap a(android.graphics.Bitmap bitmap, boolean z17, float f17, boolean z18) {
        ...
        if (bitmap == null || bitmap.isRecycled()) {
            com.tencent.mm.ui.yk.b("WeUIBitmapUtil", "getRoundedCornerBitmap in bitmap is null", new java.lang.Object[0]);
            return null;
        }
        ...
        if (z17) {
            com.tencent.mm.ui.yk.c("WeUIBitmapUtil", "getRoundedCornerBitmap bitmap recycle %s", bitmap);
            bitmap.recycle();
        }
        return bitmap2;
    }
