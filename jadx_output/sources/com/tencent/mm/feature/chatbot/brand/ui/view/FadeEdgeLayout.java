...
public final class FadeEdgeLayout extends android.widget.FrameLayout {
    ...
    public final android.graphics.Paint f65317i;

    /* renamed from: m, reason: collision with root package name */
    public final android.graphics.RectF f65318m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FadeEdgeLayout(android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        this.f65317i = paint;
        this.f65318m = new android.graphics.RectF();
    }
    ...
    public void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        android.graphics.RectF rectF = this.f65318m;
        android.graphics.Paint paint2 = this.f65317i;
    ...
    public final void setBottomFadeEnabled(boolean z17) {
        this.bottomFadeEnabled = z17;
        invalidate();
    }

    public final void setBottomFadeHeightPx(int i17) {
        this.bottomFadeHeightPx = i17;
        invalidate();
    }

    public final void setFadeColor(int i17) {
        this.fadeColor = i17;
        invalidate();
    }

    public final void setTopFadeEnabled(boolean z17) {
        this.topFadeEnabled = z17;
        invalidate();
    }

    public final void setTopFadeHeightPx(int i17) {
