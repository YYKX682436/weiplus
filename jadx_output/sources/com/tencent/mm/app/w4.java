    ...
    */
    public void onEvent(int r6, java.lang.String r7) {
        /*
            ...
            long r3 = com.tencent.mm.app.y4.f53932e
            long r1 = r1 - r3
        ...
        L13:
            ...
            return
        L16:
            java.util.HashSet r1 = com.tencent.mm.app.y4.f53931d
            monitor-enter(r1)
            r2 = 8
            if (r6 == r2) goto L2e
            r0 = 64
        ...
        L2e:
            ...
            com.tencent.mars.xlog.Log.i(r6, r0)     // Catch: java.lang.Throwable -> L5c
            android.os.ConditionVariable r6 = com.tencent.mm.app.y4.f53930c     // Catch: java.lang.Throwable -> L5c
            r6.open()     // Catch: java.lang.Throwable -> L5c
            com.tencent.mm.app.x4 r6 = com.tencent.mm.app.y4.f53933f     // Catch: java.lang.Throwable -> L5c
            if (r6 != 0) goto L57
            com.tencent.mm.app.x4 r6 = new com.tencent.mm.app.x4     // Catch: java.lang.Throwable -> L5c
            r0 = 0
            r6.<init>(r0)     // Catch: java.lang.Throwable -> L5c
            com.tencent.mm.app.y4.f53933f = r6     // Catch: java.lang.Throwable -> L5c
            com.tencent.mm.app.x4 r6 = com.tencent.mm.app.y4.f53933f     // Catch: java.lang.Throwable -> L5c
        ...
        L5c:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.app.w4.onEvent(int, java.lang.String):void");
    }
}
