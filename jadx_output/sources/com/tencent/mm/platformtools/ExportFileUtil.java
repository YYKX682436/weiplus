...
public final class ExportFileUtil {
    ...
    public static final java.util.concurrent.Executor f72401a;
    ...
    static {
        ...
        L17:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r0, r3, r4, r5)
        L1f:
            r3 = r2
        L20:
        ...
        L26:
            ...
            x51.w r2 = new x51.w
            r2.<init>()
            com.tencent.mm.platformtools.ExportFileUtil.f72401a = r2
        L2f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.ExportFileUtil.<clinit>():void");
    }
    ...
    public static java.lang.String b(android.content.Context context, java.lang.String str, java.lang.String str2) {
        com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "[+] Called exportImage, src: %s", str);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:163:0x022c, code lost:
        ...
        r8 = false;
        com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ExportFileUtil", r0, "rotate img failed.", new java.lang.Object[0]);
     */
    ...
    */
    public static java.lang.String c(android.content.Context r26, java.lang.String r27, java.lang.String r28, boolean r29, com.tencent.mm.sdk.platformtools.y6 r30) {
        /*
            Method dump skipped, instructions count: 993
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.ExportFileUtil.c(android.content.Context, java.lang.String, java.lang.String, boolean, com.tencent.mm.sdk.platformtools.y6):java.lang.String");
    }
    ...
    */
    public static java.lang.String d(android.content.Context r9, java.lang.String r10, java.lang.String r11) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.ExportFileUtil.d(android.content.Context, java.lang.String, java.lang.String):java.lang.String");
    }
    ...
    public static void e(android.content.Context context, java.lang.String str, java.lang.String str2, zb0.a0 a0Var) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "[+] Called exportToPublicDownloadDirWithPermissionRequest, src: %s, dest: %s", str, i17);
        h(context, new x51.u(context, str, str2), new x51.v(a0Var, str, i17));
    }

    private static java.lang.String exportImageImpl(android.content.Context context, java.lang.String str, java.lang.String str2) {
        return c(context, str, str2, false, null);
    }

    private static java.lang.String exportVideoImpl(android.content.Context context, java.lang.String str, java.lang.String str2) {
        if (android.text.TextUtils.isEmpty(str2)) {
            str2 = q75.c.b("mp4");
        }
        com.tencent.mm.vfs.w6.u(com.tencent.mm.vfs.w6.r(str2));
        if (com.tencent.mm.sdk.platformtools.u6.c(context, str, str2, android.provider.MediaStore.Video.Media.EXTERNAL_CONTENT_URI, null)) {
            return str2;
        }
        return null;
    }
    ...
    public static java.lang.String f(java.lang.String str, java.lang.String str2) {
        ...
        if (r6Var.m() && (!com.tencent.mm.sdk.platformtools.i1.c(str2) || !r6Var.getName().equals(str))) {
            com.tencent.mm.vfs.r6 r6Var2 = new com.tencent.mm.vfs.r6(k(), str);
            ...
            while (true) {
                ...
                sb6.append(lastIndexOf < 0 ? name : name.substring(0, lastIndexOf));
                sb6.append("(");
                sb6.append(i18);
                sb6.append(")");
                int lastIndexOf2 = name.lastIndexOf(46);
                sb6.append(lastIndexOf2 < 0 ? "" : name.substring(lastIndexOf2));
                r6Var3 = new com.tencent.mm.vfs.r6(s17, sb6.toString());
                i18++;
                i17++;
            }
            if (i18 > 2) {
                com.tencent.mars.xlog.Log.w("MicroMsg.ExportFileUtil", "[!] dest file [%s] exists, rename to [%s]", r6Var.o(), r6Var3.o());
            }
            com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "copy file ret: " + com.tencent.mm.vfs.w6.d(str2, r6Var.o(), false));
        }
        if (r6Var.s() != null) {
            r6Var.s().J();
        }
        java.lang.String o17 = r6Var.o();
        com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "[+] Called exportToPublicFile, src: %s, dest: %s", str2, o17);
        return o17;
    }

    public static java.lang.String g(android.content.Context context, java.lang.String str, java.lang.String str2, com.tencent.mm.sdk.platformtools.y6 y6Var) {
        com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "[+] Called exportVideo, src: %s", str);
        try {
            if (android.text.TextUtils.isEmpty(str2)) {
                str2 = q75.c.b("mp4");
            }
            com.tencent.mm.vfs.w6.u(com.tencent.mm.vfs.w6.r(str2));
            if (com.tencent.mm.sdk.platformtools.u6.c(context, str, str2, android.provider.MediaStore.Video.Media.EXTERNAL_CONTENT_URI, y6Var)) {
                return str2;
            }
            return null;
        } catch (java.lang.Throwable th6) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ExportFileUtil", th6, "exportVideoImpl fail", new java.lang.Object[0]);
            return null;
        }
    }
    ...
    public static java.lang.String i(java.lang.String str) {
        ...
        synchronized (lp0.b.class) {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CConstants", th6, "[-] Fail to get public download path from system.", new java.lang.Object[0]);
                file = null;
            }
            if (file == null) {
        ...
        return new com.tencent.mm.vfs.r6(absolutePath, str3).o();
    }
    ...
    */
    public static java.lang.String j(java.lang.String r3) {
        /*
            java.lang.String r0 = com.tencent.mm.vfs.w6.n(r3)     // Catch: java.lang.Exception -> L27
            boolean r1 = com.tencent.mm.sdk.platformtools.t8.K0(r0)     // Catch: java.lang.Exception -> L25
            if (r1 != 0) goto L1c
        ...
        L29:
            ...
            com.tencent.mars.xlog.Log.w(r1, r3)
        L40:
        ...
        L48:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.platformtools.ExportFileUtil.j(java.lang.String):java.lang.String");
    }

    public static java.lang.String k() {
        return com.tencent.mm.vfs.q7.c("c2c_export_temp");
    }

    public static void l(android.content.Context context, m3.a aVar) {
        com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "[+] Called checkStoragePermission, ctx: %s", context);
        boolean z17 = true;
        ...
        if (z17) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.ExportFileUtil", "requestPermission");
