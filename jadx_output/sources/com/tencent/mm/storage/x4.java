...
public class x4 extends l75.s0 implements xg3.x {
    ...
    public static final java.lang.String[] f196325f = {"CREATE TABLE IF NOT EXISTS DeletedConversationInfo ( userName TEXT  PRIMARY KEY , lastSeq LONG  , reserved1 INT  , reserved2 LONG  , reserved3 TEXT  ) ", "CREATE INDEX IF NOT EXISTS createTimeIndex  ON DeletedConversationInfo ( reserved2 )"};

    /* renamed from: d, reason: collision with root package name */
    public final kk.j f196326d = new jt0.j(50);

    /* renamed from: e, reason: collision with root package name */
    public final l75.k0 f196327e;
    ...
    public long m0(java.lang.String str) {
        ...
        long j17 = s07 != com.tencent.wcdb.core.Database.DictDefaultMatchValue ? s07 : 0L;
    ...
    public final long s0(java.lang.String str, java.lang.String[] strArr) {
        try {
            android.database.Cursor B = this.f196327e.B(str, strArr);
            if (B == null) {
                return 0L;
            }
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.DeletedConversationInfoStorage", e17, "longForQuery failed", new java.lang.Object[0]);
            return 0L;
        }
    }

    public boolean u0(java.lang.String str, long j17) {
        l75.k0 k0Var = this.f196327e;
        try {
            try {
                k0Var.b();
                ...
                k0Var.r();
                if (k0Var.isOpen() && k0Var.G()) {
                    k0Var.t();
                }
                doNotify(str);
                return true;
            } catch (java.lang.IllegalStateException e17) {
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.DeletedConversationInfoStorage", e17, "replaceCreateTime failed", new java.lang.Object[0]);
                if (k0Var.isOpen() && k0Var.G()) {
                    k0Var.t();
                }
                return false;
    ...
    public boolean y0(java.lang.String str, long j17) {
        ...
        try {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.DeletedConversationInfoStorage", e17, "replaceLastSeq failed", new java.lang.Object[0]);
                if (k0Var.G()) {
                    k0Var.t();
                }
                return false;
