...
public class z3 extends com.tencent.mm.contact.s implements java.lang.Cloneable {
    public static long L2 = 86400;
    public static final com.tencent.mm.sdk.platformtools.r2 M2 = new com.tencent.mm.storage.y3(64);
    ...
    public static boolean P3(java.lang.String str) {
        ...
        for (java.lang.String str2 : "wx_;wxid_;gh_;a0;a1;a2;a3;a4;a5;a6;a7;a8;a9;q0;q1;q2;q3;q4;q5;q6;q7;q8;q9;qq0;qq1;qq2;qq3;qq4;qq5;qq6;qq7;qq8;qq9;f0;f1;f2;f3;f4;f5;f6;f7;f8;f9;F0;F1;F2;F3;F4;F5;F6;F7;F8;F9;".split(";")) {
            if (!com.tencent.mm.sdk.platformtools.t8.K0(str2) && str.startsWith(str2)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean y3(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.Contact", "Contact invisibleUsername username == null or nil");
            return false;
        }
        if (m4(str)) {
            return true;
        }
        java.lang.String b17 = ((com.tencent.mm.plugin.zero.a) ((c25.e) gm0.j1.s(c25.e.class))).a().b(1, "HideWechatID", "idprefix");
        if (b17 != null) {
    ...
    @Override // com.tencent.mm.contact.s
    ...
    public boolean X4() {
        return ((long) (((int) com.tencent.mm.sdk.platformtools.t8.i1()) - this.f236576p1)) > L2;
    }

    public void Z4() {
        java.lang.String str = this.f236570l1;
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            return;
        }
        ...
        if (strArr.length > 0) {
            if (strArr.length > 2) {
                if (com.tencent.mm.storage.ha.r(strArr[0])) {
                    super.b3(com.tencent.mm.storage.ha.k().j(strArr[0], strArr[1]));
                } else {
                    super.b3(com.tencent.mm.storage.ha.k().i(strArr[0]));
                }
                super.L2(com.tencent.mm.storage.ha.k().h(strArr[0], strArr[1], strArr[2]));
                return;
            }
            if (strArr.length == 2) {
                super.b3(com.tencent.mm.storage.ha.k().i(strArr[0]));
                super.L2(com.tencent.mm.storage.ha.k().j(strArr[0], strArr[1]));
            } else {
                super.b3(com.tencent.mm.storage.ha.k().i(strArr[0]));
                super.L2("");
            }
    ...
    public com.tencent.mm.storage.z3 t3() {
        try {
            return (com.tencent.mm.storage.z3) clone();
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.Contact", e17, "", new java.lang.Object[0]);
            com.tencent.mars.xlog.Log.e("MicroMsg.Contact", "clone Contact error. e: " + e17.toString());
            return null;
        }
    }
    ...
    public java.lang.String v3() {
        ...
        java.lang.String str2 = this.f236570l1;
        return (com.tencent.mm.sdk.platformtools.t8.K0(str2) || (split = str2.split("_")) == null || split.length < 3 || (str = split[2]) == null) ? "" : str;
    }
    ...
    public java.lang.String w3() {
        ...
        java.lang.String str;
        java.lang.String str2 = this.f236570l1;
        return (com.tencent.mm.sdk.platformtools.t8.K0(str2) || (split = str2.split("_")) == null || split.length < 1 || (str = split[0]) == null) ? "" : str;
    }
    ...
    public java.lang.String x3() {
        ...
        java.lang.String str;
        java.lang.String str2 = this.f236570l1;
        return (com.tencent.mm.sdk.platformtools.t8.K0(str2) || (split = str2.split("_")) == null || split.length < 2 || (str = split[1]) == null) ? "" : str;
    }
