...
public class l4 extends pp.a implements e95.a {
    ...
    public com.tencent.mm.storage.f9 f195084f2;

    /* renamed from: g2, reason: collision with root package name */
    public int f195085g2;

    /* renamed from: h2, reason: collision with root package name */
    public boolean f195086h2;

    public l4(java.lang.String str) {
        super(str);
        this.f195086h2 = false;
    }
    ...
    public java.lang.String A0() {
        ...
        if (!com.tencent.mm.sdk.platformtools.t8.K0(k17) || !com.tencent.mm.sdk.platformtools.t8.K0(A0)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.Conversation", "[%s}]get mmkv editmsg is [%s],get conv editmsg is [%s]", h1(), com.tencent.mm.sdk.platformtools.t8.G1(k17), com.tencent.mm.sdk.platformtools.t8.G1(A0));
        }
        return com.tencent.mm.sdk.platformtools.t8.S(k17) > 0 ? k17 : A0;
    }
    ...
    public long D0() {
        ...
        return com.tencent.mm.sdk.platformtools.t8.k1(valueOf, 0L) > 0 ? valueOf.longValue() : super.D0();
    }
    ...
    public void h2(com.tencent.mm.storage.f9 f9Var) {
        W1(f9Var.P0());
        M1(f9Var.A0());
        if (f9Var.Y2()) {
            n1(f9Var.getCreateTime());
        } else if (f9Var.S2()) {
            java.util.LinkedList linkedList = bm5.d1.e(j()).f378386e;
            if (linkedList.isEmpty()) {
                n1(f9Var.getCreateTime());
            } else {
                n1(((r45.l55) linkedList.getLast()).f379155g);
            }
        } else {
            n1(f9Var.P0() == 1 ? com.tencent.wcdb.core.Database.DictDefaultMatchValue : f9Var.getCreateTime());
        }
        if (f9Var.O2()) {
            l1(f9Var.e2());
        } else {
        ...
        if (com.tencent.mm.storage.z3.z3(h1()) && !com.tencent.mm.storage.z3.z4(h1())) {
