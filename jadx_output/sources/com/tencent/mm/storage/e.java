...
public class e extends l75.n0 {
    ...
    public static final java.lang.String[] f193851e = {l75.n0.getCreateSQLs(com.tencent.mm.storage.c.E, "ABTestItem")};

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f193852d;

    public e(l75.k0 k0Var) {
        super(k0Var, com.tencent.mm.storage.c.E, "ABTestItem", null);
        this.f193852d = k0Var;
    }
    ...
    */
    public void D0(java.util.List r13, int r14) {
        ...
        L37:
            ...
            if (r2 == 0) goto Ldb
            java.lang.String r4 = r2.field_layerId
        ...
        Led:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.storage.e.D0(java.util.List, int):void");
    }

    @Override // l75.s0
    public void extraStepsAfterNotifying(l75.w0 w0Var) {
        for (fs.q qVar : ((fs.c) fs.g.f(com.tencent.mm.storage.d.class)).all()) {
            if (fs.g.d(fs.g.f266086c, qVar)) {
                ((com.tencent.mm.storage.d) ((fs.n) qVar.get())).onNotifyChange(w0Var.f316973a, w0Var);
            }
        }
    }
    ...
    public com.tencent.mm.storage.c z0(java.lang.String str) {
        com.tencent.mm.storage.c cVar = new com.tencent.mm.storage.c();
        cVar.field_layerId = str;
        boolean z17 = super.get(cVar, new java.lang.String[0]);
        if (z17 && cVar.field_endTime == 0) {
            cVar.field_endTime = com.tencent.wcdb.core.Database.DictDefaultMatchValue;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ABTestStorage", "getByLayerId, id: %s, return: %b", str, java.lang.Boolean.valueOf(z17));
        return cVar;
    }
}
