...
public class k4 extends l75.a1 implements com.tencent.mm.storage.e8 {

    /* renamed from: j, reason: collision with root package name */
    public static final java.lang.String[] f195067j;

    /* renamed from: k, reason: collision with root package name */
    public static final java.lang.String[] f195068k;

    /* renamed from: l, reason: collision with root package name */
    public static final java.lang.String f195069l;

    /* renamed from: m, reason: collision with root package name */
    public static final java.lang.String f195070m;

    /* renamed from: d, reason: collision with root package name */
    public final l75.k0 f195071d;

    /* renamed from: e, reason: collision with root package name */
    public int f195072e = 0;

    /* renamed from: f, reason: collision with root package name */
    public java.util.Map f195073f = null;

    /* renamed from: g, reason: collision with root package name */
    public final kk.j f195074g = new jt0.j(200);

    /* renamed from: h, reason: collision with root package name */
    public final kk.j f195075h = new jt0.j(400);

    /* renamed from: i, reason: collision with root package name */
    public final com.tencent.mm.storage.j4 f195076i = new com.tencent.mm.storage.j4(null);

    static {
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        f195067j = new java.lang.String[]{l75.n0.getCreateSQLs(e0Var, "rcontact"), l75.n0.getCreateSQLs(e0Var, "bottlecontact"), l75.n0.getCreateSQLs(com.tencent.mm.storage.a4.f193747r, "ContactCmdBuf"), "CREATE TABLE IF NOT EXISTS contact ( contactID INTEGER PRIMARY KEY, sex INT, type INT, showHead INT, username VARCHAR(40), nickname VARCHAR(40), pyInitial VARCHAR(40), quanPin VARCHAR(60), reserved TEXT );", "CREATE TABLE IF NOT EXISTS contact_ext ( username VARCHAR(40), Uin INTEGER DEFAULT 0, Email VARCHAR(128), Mobile VARCHAR(40), ShowFlag INTEGER DEFAULT 0 , ConType INTEGER DEFAULT 0 , ConRemark TEXT, ConRemark_PYShort TEXT, ConRemark_PYFull TEXT, ConQQMBlog TEXT, ConSMBlog TEXT, DomainList TEXT, reserved1 INT DEFAULT 0 , reserved2 INT DEFAULT 0 , reserved3 INT DEFAULT 0 , reserved4 INT DEFAULT 0 , reserved5 INT DEFAULT 0 , reserved6 TEXT, reserved7 TEXT, reserved8 TEXT, reserved9 TEXT, reserved10 TEXT, weiboflag  INT DEFAULT 0 ,weibonickname TEXT  );"};
        f195068k = new java.lang.String[]{"CREATE UNIQUE INDEX IF NOT EXISTS  contact_username_unique_index ON rcontact ( username )", "CREATE INDEX IF NOT EXISTS  contact_alias_index ON rcontact ( alias )", "CREATE INDEX IF NOT EXISTS  en_username_unique_index ON rcontact ( encryptUsername )", "CREATE UNIQUE INDEX IF NOT EXISTS  bottle_username_unique_index ON bottlecontact ( username )", "CREATE INDEX IF NOT EXISTS type_verifyFlag_index ON rcontact ( type,verifyFlag ) ", "CREATE INDEX IF NOT EXISTS contact_usernameflag_index ON rcontact ( usernameFlag ) "};
        f195069l = "showHead = 32";
        f195070m = "type & 64 !=0  AND type >= 64";
    }
    ...
    public k4(l75.k0 k0Var) {
        ...
        int columnIndex2 = f18.getColumnIndex(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
        while (true) {
            if (f18.moveToNext()) {
        ...
        java.util.Iterator<java.lang.String> it = l75.n0.getUpdateSQLs(com.tencent.mm.contact.s.G2, "bottlecontact", k0Var).iterator();
        while (it.hasNext()) {
            k0Var.A("bottlecontact", it.next());
        }
        java.util.Iterator<java.lang.String> it6 = l75.n0.getUpdateSQLs(com.tencent.mm.contact.s.G2, "rcontact", k0Var).iterator();
        while (it6.hasNext()) {
            k0Var.A("rcontact", it6.next());
        }
        for (java.lang.String str : f195068k) {
            k0Var.A("rcontact", str);
        }
        java.util.Iterator<java.lang.String> it7 = l75.n0.getUpdateSQLs(com.tencent.mm.storage.a4.f193747r, "ContactCmdBuf", k0Var).iterator();
        while (it7.hasNext()) {
    ...
    public static java.lang.String M() {
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        return "( (type & 1!=0) and type & 8=0" + c01.e2.c(dm.i4.COL_USERNAME, new java.lang.String[]{"@chatroom", "@im.chatroom"}, new java.lang.String[0]) + ")";
    }

    public static java.lang.String S() {
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder(" where (type & 1!=0) and type & 32=0   and ");
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        sb6.append("type & 8=0" + c01.e2.b(dm.i4.COL_USERNAME, "@openim", false, new java.lang.String[0]));
        return sb6.toString();
    }

    public static java.lang.String a0(java.lang.String str) {
        return com.tencent.mm.storage.z3.H3(str) ? "bottlecontact" : "rcontact";
    }

    public static java.lang.String b0() {
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        return "( (type & 1!=0) and type & 8=0" + c01.e2.b(dm.i4.COL_USERNAME, "@talkroom", false, new java.lang.String[0]) + ")";
    }

    public static java.lang.String d0() {
        java.lang.String t17 = t(false, false);
        iz5.a.g(null, t17 != null && t17.length() > 0);
        return t17 + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, " or (" + b0() + ')');
    }
    ...
    public android.database.Cursor B(java.util.List list) {
        ...
        return this.f195071d.B(sb6.toString(), null);
    }
    ...
    public android.database.Cursor C(java.util.List list) {
        ...
        return this.f195071d.B(str2 + " end", null);
    }

    public android.database.Cursor D() {
        return this.f195071d.B("select  username, alias, conRemark, domainList, nickname, pyInitial, quanPin, showHead, type, uiType, weiboFlag, weiboNickname, conRemarkPYFull, conRemarkPYShort, lvbuff, verifyFlag, encryptUsername, chatroomFlag, deleteFlag, contactLabelIds, descWordingId, openImAppid, sourceExtInfo, rowid, contactExtra from rcontact  where rowid = -1", null);
    }
    ...
    public android.database.Cursor E(java.util.List list, boolean z17) {
        ...
        sb6.append(((t(false, z17) + " AND " + f195070m) + c01.e2.b(dm.i4.COL_USERNAME, "@openim", true, new java.lang.String[0])) + o(list));
        com.tencent.mm.sdk.platformtools.r2 r2Var = com.tencent.mm.storage.z3.M2;
        sb6.append(" order by case when verifyFlag & 8 != 0 then 0 else 1 end , showHead asc,  case when length(conRemarkPYFull) > 0 then upper(conRemarkPYFull)  else upper(quanPin) end asc,  case when length(conRemark) > 0 then upper(conRemark)  else upper(quanPin) end asc,  upper(quanPin) asc,  upper(nickname) asc,  upper(username) asc ");
        java.lang.String sb7 = sb6.toString();
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "getFavCursorWithoutOpenIM favourSql = %s", sb7);
        return this.f195071d.B(sb7, null);
    }

    public java.lang.String F(java.util.List list, boolean z17) {
        return (t(false, z17) + " AND " + f195070m) + o(list);
    }

    public r45.hs0 G(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ContactStorage", "getFieldVersion failed user is null");
            return null;
        }
        com.tencent.mm.storage.a4 a4Var = new com.tencent.mm.storage.a4();
        android.database.Cursor D = this.f195071d.D("ContactCmdBuf", null, "username=?", new java.lang.String[]{str}, null, null, null, 2);
        if (D.moveToFirst()) {
            a4Var.convertFrom(D);
        }
        D.close();
        r45.hs0 hs0Var = a4Var.field_fieldUpdateCtrlInfoList;
        if (hs0Var != null) {
            hs0Var.toJSON();
        }
        return a4Var.field_fieldUpdateCtrlInfoList;
    }

    public java.util.List H(java.util.List list) {
        if (list == null || list.isEmpty()) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ContactStorage", "getFilterList: but white list is empty");
        ...
        java.lang.String sb7 = sb6.toString();
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        java.lang.String format = java.lang.String.format("select %s from %s where (%s) and (%s & %d != 0)  order by %s", dm.i4.COL_USERNAME, "rcontact", sb7, "type", 1, "showHead asc, pyInitial asc, quanPin asc, nickname asc, username asc ");
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "getFilterList: sql is %s", format);
        android.database.Cursor f17 = this.f195071d.f(format, null, 2);
        if (f17 != null) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "getFilerList: use time[%d ms] whiteList[%s], usernameList[%s]", java.lang.Long.valueOf(android.os.SystemClock.elapsedRealtime() - elapsedRealtime), list, linkedList.toString());
        return linkedList;
    }
    ...
    public java.lang.String I(java.lang.String str, java.lang.String str2, java.util.List list) {
        ...
        if (str == null || str.equals("@all.android")) {
            ...
            sb7.append(c01.e2.c(dm.i4.COL_USERNAME, new java.lang.String[]{"@chatroom", "@im.chatroom"}, new java.lang.String[0]));
            sb7.append(")");
            ...
            l75.e0 e0Var3 = com.tencent.mm.contact.s.G2;
            sb10.append(c01.e2.b(dm.i4.COL_USERNAME, "@openim", false, new java.lang.String[0]));
            sb9.append(sb10.toString());
            sb9.append(")");
            sb8.append(t17 + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, sb9.toString()));
            str3 = sb8.toString();
            ...
            sb12.append(t19 + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, " or (" + M() + ')', " or (" + b0() + ')'));
            str3 = sb12.toString();
        } else if (str.equals("@micromsg.no.verify.biz.qq.com")) {
            java.lang.StringBuilder sb13 = new java.lang.StringBuilder("");
            l75.e0 e0Var13 = com.tencent.mm.contact.s.G2;
            com.tencent.mm.sdk.platformtools.r2 r2Var = com.tencent.mm.storage.z3.M2;
            sb13.append(" where (type & 1 !=0 ) and type & 32 =0 and type & 8 =0 and verifyFlag & 8 =0" + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, " or (" + M() + ')'));
            str3 = sb13.toString();
        } else if (str.equals("@micromsg.with.all.biz.qq.com")) {
            java.lang.StringBuilder sb14 = new java.lang.StringBuilder("");
            l75.e0 e0Var14 = com.tencent.mm.contact.s.G2;
            iz5.a.g(null, " where (type & 1 !=0 ) and type & 32 =0 and type & 8 =0".length() > 0);
            sb14.append(" where (type & 1 !=0 ) and type & 32 =0 and type & 8 =0" + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, " or (" + M() + ')'));
            str3 = sb14.toString();
        } else if (str.equals("@micromsg.with.all.biz.qq.com.openim")) {
            java.lang.StringBuilder sb15 = new java.lang.StringBuilder("");
            l75.e0 e0Var15 = com.tencent.mm.contact.s.G2;
            iz5.a.g(null, " where (type & 1 !=0 ) and type & 32 =0 and type & 8 =0".length() > 0);
            sb15.append(" where (type & 1 !=0 ) and type & 32 =0 and type & 8 =0" + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, " or (" + M() + ')', " or ((username like '%@openim'))"));
            str3 = sb15.toString();
            ...
            sb16.append(t27 + c01.e2.b(dm.i4.COL_USERNAME, "@qqim", false, new java.lang.String[0]));
            str3 = sb16.toString();
        } else if (str.equals("@all.chatroom")) {
            l75.e0 e0Var16 = com.tencent.mm.contact.s.G2;
            str3 = " where (type & 1 !=0 or type & 2 !=0 or type & 4 !=0 or 1) ";
        } else if (str.equals("@verify.contact")) {
            l75.e0 e0Var17 = com.tencent.mm.contact.s.G2;
            ...
            l75.e0 e0Var18 = com.tencent.mm.contact.s.G2;
            com.tencent.mm.sdk.platformtools.r2 r2Var3 = com.tencent.mm.storage.z3.M2;
            str3 = " where (type & 1 != 0 and verifyFlag & 8 != 0) ";
        } else if (str.equals("@all.weixin.android")) {
            l75.e0 e0Var19 = com.tencent.mm.contact.s.G2;
            ...
            l75.e0 e0Var20 = com.tencent.mm.contact.s.G2;
            str3 = " where type & 1073741824!=0 ";
        } else if (str.equals("@ward.teenmode")) {
            l75.e0 e0Var21 = com.tencent.mm.contact.s.G2;
            ...
            l75.e0 e0Var22 = com.tencent.mm.contact.s.G2;
            ...
            sb17.append((str4 + " and ( username not like '%@%'" + str5 + ")") + c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, str5));
            str3 = sb17.toString();
        } else if (str.equals("@convInBox")) {
            l75.e0 e0Var23 = com.tencent.mm.contact.s.G2;
    ...
    public android.database.Cursor K() {
        ...
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        sb6.append(c01.e2.b(dm.i4.COL_USERNAME, "@micromsg.qq.com", false, new java.lang.String[0]));
        sb6.append(" or username = 'weixin'");
        return this.f195071d.f(sb6.toString(), null, 2);
    }

    public com.tencent.mm.storage.z3 L(java.lang.String str) {
        com.tencent.mm.storage.z3 z3Var = (com.tencent.mm.storage.z3) ((lt0.f) this.f195074g).i(str);
        if (z3Var != null) {
            return z3Var;
        }
        return null;
    ...
    public int O(boolean z17, java.lang.String[] strArr, java.lang.String... strArr2) {
        ...
        sb6.append(" or username = 'weixin'");
        java.lang.String sb7 = sb6.toString();
        android.database.Cursor f17 = this.f195071d.f(sb7, null, 2);
        if (f17 != null && f17.moveToFirst()) {
            i17 = f17.getInt(0);
            f17.close();
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "getNormalContactCount, sql:%s, result:%d, includeBlack:%s, time:%d", sb7, java.lang.Integer.valueOf(i17), java.lang.Boolean.valueOf(z17), java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis));
        return i17;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0083, code lost:
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(r2) != false) goto L15;
     */
    ...
    */
    public java.util.List Q() {
        ...
        L4a:
            ...
            r5.<init>(r7)
            java.lang.String r7 = ","
            java.lang.String r4 = com.tencent.mm.sdk.platformtools.t8.c1(r4, r7)
            r5.append(r4)
    ...
    public android.database.Cursor V(java.lang.String[] strArr, java.lang.String str, java.lang.String str2, java.util.List list, java.util.List list2) {
        ...
        sb6.append(" order by showHead asc,  case when length(conRemarkPYFull) > 0 then upper(conRemarkPYFull)  else upper(quanPin) end asc,  case when length(conRemark) > 0 then upper(conRemark)  else upper(quanPin) end asc,  upper(quanPin) asc,  upper(nickname) asc,  upper(username) asc ");
        java.lang.String sb7 = sb6.toString();
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", sb7);
        return this.f195071d.B(sb7, null);
    }
    ...
    public android.database.Cursor W(java.lang.String[] strArr, java.lang.String str, java.lang.String str2, java.util.List list) {
        ...
        return this.f195071d.B(str3, null);
    }

    public java.lang.String X(java.lang.String str) {
        com.tencent.mm.storage.z3 v17 = v(str);
        if (v17 == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ContactStorage", "getSendMsgTicket ca == null");
            return "";
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "getSendMsgTicket %s %s", objArr);
        return v17.a1();
    }
    ...
    public int[] Y(java.util.List list) {
        ...
        android.database.Cursor B = this.f195071d.B(str, null);
        java.lang.System.currentTimeMillis();
        java.lang.System.currentTimeMillis();
    ...
    public int[] Z(java.lang.String[] strArr, java.lang.String str, java.lang.String str2, java.lang.String str3, java.util.List list) {
        ...
        java.lang.System.currentTimeMillis();
        android.database.Cursor B = this.f195071d.B(str4, null);
        java.lang.System.currentTimeMillis();
        java.lang.System.currentTimeMillis();
        int count = B.getCount() >= 0 ? B.getCount() : 0;
        java.lang.System.currentTimeMillis();
    ...
    public void d(l75.y0 y0Var) {
        java.util.Iterator it = ((fs.c) fs.g.f(com.tencent.mm.storage.d8.class)).all().iterator();
        while (it.hasNext()) {
            ((com.tencent.mm.storage.d8) ((fs.q) it.next()).get()).g(y0Var.f316978a, this, y0Var.f316979b);
        }
    }

    public com.tencent.mm.storage.z3 e0(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            return null;
        }
    ...
    public boolean f() {
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.ContactStorage", "shouldProcessEvent db is close :%s", objArr);
        return false;
    }

    public com.tencent.mm.storage.z3 f0(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            return null;
        }
        if (com.tencent.mm.storage.z3.H3(str)) {
        ...
        com.tencent.mm.storage.z3 L = L(str);
        if (L != null) {
            return L;
        }
        com.tencent.mm.storage.z3 z3Var = new com.tencent.mm.storage.z3();
    ...
    public com.tencent.mm.storage.z3 g0(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            return null;
        }
        com.tencent.mm.storage.z3 z3Var = this.f195076i.get(str);
        if (z3Var != null) {
            s0(z3Var, false);
            return z3Var;
        }
        com.tencent.mm.storage.z3 z3Var2 = new com.tencent.mm.storage.z3();
        android.database.Cursor f17 = this.f195071d.f("select  username, alias, conRemark, domainList, nickname, pyInitial, quanPin, showHead, type, uiType, weiboFlag, weiboNickname, conRemarkPYFull, conRemarkPYShort, lvbuff, verifyFlag, encryptUsername, chatroomFlag, deleteFlag, contactLabelIds, descWordingId, openImAppid, sourceExtInfo, rowid, contactExtra from rcontact where alias=" + d95.b0.O(str), null, 2);
        if (f17.moveToFirst()) {
            z3Var2.convertFrom(f17);
            i(z3Var2);
            s0(z3Var2, false);
        }
        f17.close();
    ...
    public boolean h(java.lang.String str) {
        if (!com.tencent.mm.sdk.platformtools.t8.K0(str) && (!str.contains("@") || str.endsWith("@stranger"))) {
            lt0.f fVar = (lt0.f) this.f195075h;
            java.lang.Integer num = (java.lang.Integer) fVar.get(str);
            if (num != null) {
                return (num.intValue() & 1) != 0;
            }
            com.tencent.mm.storage.z3 n17 = n(str, true);
            if (n17 != null && (n17.d1().equals(str) || str.equals(n17.J0()))) {
                fVar.j(str, java.lang.Integer.valueOf(n17.getType()));
                return (n17.getType() & 1) != 0;
            }
            fVar.j(str, 0);
        }
        return false;
    ...
    public boolean h0(com.tencent.mm.storage.z3 z3Var) {
        return i0(z3Var) > 0;
    }

    public final void i(com.tencent.mm.storage.z3 z3Var) {
        java.util.Map map = this.f195073f;
        if (map == null || android.os.Process.myTid() != this.f195072e) {
            return;
        }
        java.lang.String d17 = z3Var.d1();
        int type = z3Var.getType();
        java.util.HashMap hashMap = (java.util.HashMap) map;
        java.lang.Integer num = (java.lang.Integer) hashMap.get(d17);
        if (num != null && (type & 1) == 0 && (num.intValue() & 1) != 0) {
            com.tencent.mars.xlog.Log.w("MicroMsg.ContactStorage", "Non-contact bug found: " + d17);
            jx3.f.INSTANCE.d(21019, 0, 0, 25601, "", d17);
        }
        hashMap.put(d17, java.lang.Integer.valueOf(type));
    }

    public int i0(com.tencent.mm.storage.z3 z3Var) {
        ...
        if (d17.length() <= 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ContactStorage", "FATAL ERROR, invalid contact, empty username");
            return -1;
        }
        z3Var.T1(z3Var.c2());
        z3Var.n3(z3Var.d2());
        com.tencent.mm.storage.j4 j4Var = this.f195076i;
        j4Var.w0(this, z3Var);
        int o07 = j4Var.o0(z3Var, false);
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "insert extensions replace=%s %s", java.lang.Integer.valueOf(o07), z3Var.d1());
        if (o07 < 0) {
            android.content.ContentValues convertTo = z3Var.convertTo();
            long currentTimeMillis = java.lang.System.currentTimeMillis();
            o07 = (int) this.f195071d.l(a0(z3Var.d1()), com.tencent.mm.contact.s.G2.f316953b, convertTo);
            int currentTimeMillis2 = (int) (java.lang.System.currentTimeMillis() - currentTimeMillis);
            boolean z18 = z65.c.f470455a;
            jx3.f.INSTANCE.m(463, z18 ? 11 : 14, z18 ? 12 : 15, currentTimeMillis2, false);
            com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "insert: username=%s, showHead=%d, verifyFlag=%d, ret=:%d take[%s]ms fg:%b", z3Var.d1(), java.lang.Integer.valueOf(z3Var.W0()), java.lang.Integer.valueOf(z3Var.f1()), java.lang.Integer.valueOf(o07), java.lang.Integer.valueOf(currentTimeMillis2), java.lang.Boolean.valueOf(z18));
            if (o07 != -1) {
                z3Var.E2 = o07;
                s0(z3Var, false);
                ...
                int f17 = z3Var.f1();
                int type = z3Var.getType();
                int i17 = z3Var.f236586x1;
                int i18 = z3Var.T;
                kotlin.jvm.internal.o.g(username, "username");
                bn0.g gVar = bn0.g.f22779a;
                bn0.a f18 = gVar.f(username);
                gVar.j(username, new bn0.a(f17, type, i17, i18, (f18 == null || (str = f18.f22772e) == null) ? "" : str));
                return o07;
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.ContactStorage", "insert failed: username=%s", z3Var.d1());
        }
        return o07;
    }
    ...
    public int j(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ContactStorage", "delCmdBuf failed user is null");
            return -1;
        }
        return this.f195071d.delete("ContactCmdBuf", "username=?", new java.lang.String[]{"" + str});
    }

    public boolean j0(java.lang.String str) {
        com.tencent.mm.storage.z3 n17 = n(str, true);
        return (n17 == null || com.tencent.mm.sdk.platformtools.t8.K0(n17.d1()) || !n17.d1().equals(str)) ? false : true;
    }
    ...
    public int k(java.lang.String str) {
        ...
        z3Var.j3(0);
        int p17 = this.f195071d.p(a0(str), z3Var.convertTo(), "username=?", new java.lang.String[]{"" + str});
        j(str);
        com.tencent.mars.xlog.Log.w("MicroMsg.ContactStorage", "delete (because the talker id , dk just mark it  disappear .) user:%s res:%s %s", str, java.lang.Integer.valueOf(p17), new com.tencent.mm.sdk.platformtools.z3());
        if (p17 == 0) {
            return p17;
        }
        l(5, this, str, z3Var);
    ...
    public void k0(java.lang.String str) {
        ...
        ((lt0.f) this.f195074g).remove(str);
        ((lt0.f) this.f195075h).remove(str);
    }
    ...
    public void l(int i17, l75.a1 a1Var, java.lang.Object obj, java.lang.Object obj2) {
        ...
        com.tencent.mm.storage.z3 z3Var = (com.tencent.mm.storage.z3) obj2;
        eVar.getClass();
        if (str != null) {
            if ((r26.n0.N(str) ^ true ? str : null) != null) {
                o75.c cVar = new o75.c(i17 != 2 ? i17 != 3 ? i17 != 4 ? i17 != 5 ? o75.b.f343581b : o75.b.f343584e : o75.b.f343583d : o75.b.f343583d : o75.b.f343582c, str, eVar.getLogTag());
                cVar.f343590d = z3Var;
                eVar.notify(cVar);
            }
        }
    ...
    public boolean l0(com.tencent.mm.storage.z3 z3Var) {
        java.lang.String str;
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "[replace] ret:%s username=%s, showHead=%d, verifyFlag=%d", java.lang.Boolean.valueOf(z17), z3Var.d1(), java.lang.Integer.valueOf(z3Var.W0()), java.lang.Integer.valueOf(z3Var.f1()));
        if (!z17) {
            android.content.ContentValues convertTo = z3Var.convertTo();
            int i17 = (int) z3Var.E2;
            if (i17 > 0) {
                convertTo.put("rowid", java.lang.Integer.valueOf(i17));
            }
            z17 = this.f195071d.m(a0(z3Var.d1()), com.tencent.mm.contact.s.G2.f316953b, convertTo) > 0;
        }
        k0(z3Var.d1());
        ...
        int f17 = z3Var.f1();
        int type = z3Var.getType();
        int i18 = z3Var.f236586x1;
        int i19 = z3Var.T;
        kotlin.jvm.internal.o.g(username, "username");
        bn0.g gVar = bn0.g.f22779a;
        bn0.a f18 = gVar.f(username);
        if (f18 == null || (str = f18.f22772e) == null) {
            str = "";
        }
        gVar.j(username, new bn0.a(f17, type, i18, i19, str));
        l(4, this, z3Var.d1(), z3Var);
        return true;
    }

    public com.tencent.mm.storage.z3 m(java.lang.String str) {
        return n(str, true);
    }

    public boolean m0(com.tencent.mm.storage.z3 z3Var) {
        return j0(z3Var.d1()) ? p0(z3Var.d1(), z3Var) == 0 : i0(z3Var) >= 0;
    }

    public final com.tencent.mm.storage.z3 n(java.lang.String str, boolean z17) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "[get]username = %s", str);
            return null;
        }
        if (com.tencent.mm.storage.z3.H3(str)) {
            str = com.tencent.mm.storage.z3.Y4(str);
        ...
        com.tencent.mm.storage.z3 z3Var = this.f195076i.get(str);
        if (z3Var != null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "[get]extensions:%s %s", str, java.lang.Integer.valueOf(z3Var.getType()));
            s0(z3Var, false);
            return z3Var;
        }
        com.tencent.mm.storage.z3 z3Var2 = new com.tencent.mm.storage.z3();
        ...
        if (z17) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "[get]getRaw:%s %s", str, java.lang.Integer.valueOf(z3Var2.getType()));
        }
        return z3Var2;
    }
    ...
    public int n0(java.lang.String str, r45.hs0 hs0Var) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ContactStorage", "setFieldVersion failed user is null");
            return -1;
        }
        com.tencent.mm.storage.a4 a4Var = new com.tencent.mm.storage.a4();
        a4Var.field_fieldUpdateCtrlInfoList = hs0Var;
        a4Var.field_username = str;
        l75.k0 k0Var = this.f195071d;
        int i17 = (k0Var.p("ContactCmdBuf", a4Var.convertTo(), "username=?", new java.lang.String[]{str}) > 0 || k0Var.l("ContactCmdBuf", dm.i4.COL_USERNAME, a4Var.convertTo()) != -1) ? 0 : -1;
        if (hs0Var != null) {
            hs0Var.toJSON();
        }
        return i17;
    ...
    public final java.lang.String o(java.util.List list) {
        ...
        java.lang.StringBuilder sb6 = new java.lang.StringBuilder("");
        for (int i17 = 0; i17 < list.size(); i17++) {
            if (!com.tencent.mm.sdk.platformtools.t8.K0((java.lang.String) list.get(i17))) {
                if (i17 == list.size() - 1) {
    ...
    public void o0(boolean z17) {
        if (z17) {
            this.f195072e = android.os.Process.myTid();
            this.f195073f = new java.util.HashMap();
        } else {
            this.f195072e = 0;
            this.f195073f = null;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "setNewInit: " + this.f195072e);
    }

    public com.tencent.mm.storage.z3 p(long j17) {
    ...
    public int p0(java.lang.String str, com.tencent.mm.storage.z3 z3Var) {
        java.lang.String str2;
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "begin to update contact :%s, usernameFlag=%d", str, java.lang.Long.valueOf(z3Var.e1()));
        if (!(z3Var.F2 > 0)) {
            return 1;
        }
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        ...
        if (o07 < 0) {
            ...
            if (convertTo.size() > 0) {
                o07 = this.f195071d.p(a0(str), convertTo, "username=?", new java.lang.String[]{"" + str});
            }
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "[update] ret=%s username=%s, showHead=%d, verifyFlag=%d, type=%d, usernameFlag=%d, take[%d]ms", java.lang.Integer.valueOf(o07), z3Var.d1(), java.lang.Integer.valueOf(z3Var.W0()), java.lang.Integer.valueOf(z3Var.f1()), java.lang.Integer.valueOf(z3Var.getType()), java.lang.Long.valueOf(z3Var.e1()), java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis));
        k0(str);
        if (!com.tencent.mm.sdk.platformtools.t8.K0(z3Var.J0())) {
            k0(z3Var.J0());
        }
        if (o07 != 0) {
            ...
            bn0.g gVar = bn0.g.f22779a;
            bn0.a f18 = gVar.f(username);
            gVar.j(username, new bn0.a(f17, type, i18, i19, (f18 == null || (str2 = f18.f22772e) == null) ? "" : str2));
        }
        return o07;
    }

    public com.tencent.mm.storage.z3 q(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            return null;
        }
        if (com.tencent.mm.storage.z3.H3(str)) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public int q0(java.lang.String r18, com.tencent.mm.storage.z3 r19) {
        /*
            Method dump skipped, instructions count: 628
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.storage.k4.q0(java.lang.String, com.tencent.mm.storage.z3):int");
    }
    ...
    public android.database.Cursor r() {
        ...
        l75.e0 e0Var = com.tencent.mm.contact.s.G2;
        sb7.append(c01.e2.b(dm.i4.COL_USERNAME, "@chatroom", false, new java.lang.String[0]));
    ...
    public int r0(java.lang.String str, java.lang.String str2) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "updateSendMsgTicketByUser %s %s", objArr);
        com.tencent.mm.storage.z3 v17 = v(str);
        if (v17 == null || com.tencent.mm.sdk.platformtools.t8.D0(v17.a1(), str2)) {
            return 0;
        }
        v17.V1(str2);
        return p0(str, v17);
    ...
    public byte[] s(java.lang.String str) {
        ...
        D.close();
        byte[] bArr = a4Var.field_cmdbuf;
        if (bArr != null) {
            int length = bArr.length;
        }
        return a4Var.field_cmdbuf;
    }

    public void s0(com.tencent.mm.storage.z3 z3Var, boolean z17) {
        if (z3Var == null || z3Var.d1() == null) {
            return;
        }
        if (z3Var.getType() != 0 || z17) {
            ((lt0.f) this.f195074g).j(z3Var.d1(), z3Var);
            ((lt0.f) this.f195075h).j(z3Var.d1(), java.lang.Integer.valueOf(z3Var.getType()));
        }
    }
    ...
    public com.tencent.mm.storage.z3 v(java.lang.String str) {
        if (com.tencent.mm.sdk.platformtools.t8.K0(str) || com.tencent.mm.storage.z3.H3(str)) {
            return null;
        }
        com.tencent.mm.storage.z3 z3Var = new com.tencent.mm.storage.z3();
        android.database.Cursor f17 = this.f195071d.f("select  *,rowid  from rcontact where username=" + d95.b0.O(str) + " or encryptUsername=" + d95.b0.O(str), null, 2);
        if (f17.moveToFirst()) {
            z3Var.convertFrom(f17);
            f17.close();
            z3Var.Z4();
    ...
    public int w(java.lang.String str, java.lang.String str2, java.util.List list) {
        ...
        android.database.Cursor f17 = this.f195071d.f(str3, null, 2);
        int i17 = 0;
        if (f17 != null && f17.moveToFirst()) {
            i17 = f17.getInt(0);
            f17.close();
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ContactStorage", "getCountByFilterType, sql:%s, count:%d, time:%d", str3, java.lang.Integer.valueOf(i17), java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis));
        return i17;
    }
    ...
    public android.database.Cursor z(java.util.List list, boolean z17) {
        ...
        return this.f195071d.B(str, null);
    }
}
