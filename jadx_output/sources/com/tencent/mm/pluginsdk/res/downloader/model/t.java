...
public final class t {
    ...
    public static final java.lang.Class[] f189709a = {java.lang.InterruptedException.class};

    /* renamed from: b, reason: collision with root package name */
    public static final java.lang.Class[] f189710b = {java.net.UnknownHostException.class, java.lang.IllegalArgumentException.class, java.net.MalformedURLException.class, java.io.IOException.class, java.io.FileNotFoundException.class, n35.a.class, n35.d.class, n35.g.class};

    /* renamed from: c, reason: collision with root package name */
    public static final java.lang.Class[] f189711c = {java.net.SocketException.class, java.net.SocketTimeoutException.class};

    public final void a(com.tencent.mm.pluginsdk.res.downloader.model.i iVar, java.net.HttpURLConnection httpURLConnection) {
        java.util.Set<java.lang.String> keySet;
        com.tencent.mm.pluginsdk.res.downloader.model.x xVar = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
        xVar.f();
        java.util.Map map = ((com.tencent.mm.pluginsdk.res.downloader.model.u) xVar.c()).f189718g;
        java.util.LinkedList<com.tencent.mm.pluginsdk.res.downloader.model.f> linkedList = null;
        ...
        if (unmodifiableMap != null && unmodifiableMap.size() != 0 && (keySet = unmodifiableMap.keySet()) != null && keySet.size() != 0) {
            ...
            for (java.lang.String str : keySet) {
                ...
                if (!com.tencent.mm.sdk.platformtools.t8.K0(str2)) {
                    linkedList.add(new com.tencent.mm.pluginsdk.res.downloader.model.f(str, str2));
                }
            }
        }
        if (linkedList != null && linkedList.size() > 0) {
            for (com.tencent.mm.pluginsdk.res.downloader.model.f fVar : linkedList) {
                httpURLConnection.addRequestProperty(fVar.f189673a, fVar.f189674b);
            }
        }
        httpURLConnection.setRequestMethod("GET");
        httpURLConnection.setDoOutput(false);
        httpURLConnection.setConnectTimeout(((com.tencent.mm.pluginsdk.res.downloader.model.u) xVar.c()).f189719h);
        httpURLConnection.setReadTimeout(((com.tencent.mm.pluginsdk.res.downloader.model.u) xVar.c()).f189720i);
        httpURLConnection.setUseCaches(false);
        if (xVar instanceof com.tencent.mm.plugin.appbrand.appcache.a9) {
    ...
    public final void b(com.tencent.mm.pluginsdk.res.downloader.model.i iVar, javax.net.ssl.HttpsURLConnection httpsURLConnection) {
        ...
        httpsURLConnection.setSSLSocketFactory(android.net.SSLCertificateSocketFactory.getDefault(((com.tencent.mm.pluginsdk.res.downloader.model.u) ((com.tencent.mm.pluginsdk.res.downloader.model.x) iVar).c()).f189721j, new android.net.SSLSessionCache(com.tencent.mm.sdk.platformtools.x2.f193071a)));
    }

    public final boolean c(com.tencent.mm.pluginsdk.res.downloader.model.i iVar, java.net.HttpURLConnection httpURLConnection) {
        com.tencent.mm.pluginsdk.res.downloader.model.x xVar = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
        long g17 = o35.a.g(xVar.e());
        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: RangeOffset = %d", xVar.f(), java.lang.Long.valueOf(g17));
        if (g17 == 0) {
            return false;
        }
    ...
    public final com.tencent.mm.pluginsdk.res.downloader.model.v f(com.tencent.mm.pluginsdk.res.downloader.model.i iVar, java.lang.Exception exc) {
        if (exc instanceof java.net.ProtocolException) {
            com.tencent.mm.pluginsdk.res.downloader.model.x xVar = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
            com.tencent.mars.xlog.Log.e("MicroMsg.ResDownloader.NetworkPerformer", "%s: Protocol not support, the protocol: %s", xVar.f(), "GET");
            return h(xVar, exc);
        }
        if (exc instanceof n35.b) {
            com.tencent.mm.pluginsdk.res.downloader.model.x xVar2 = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
            com.tencent.mars.xlog.Log.e("MicroMsg.ResDownloader.NetworkPerformer", "%s: %s [%s]", xVar2.f(), exc.getClass().getSimpleName(), exc.getMessage());
            o35.a.a(xVar2.e());
            return null;
        }
        if (f189709a[0].equals(exc.getClass())) {
            com.tencent.mm.pluginsdk.res.downloader.model.x xVar3 = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
            com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: download canceled, caused by %s", xVar3.f(), exc);
            return new com.tencent.mm.pluginsdk.res.downloader.model.v(xVar3, exc, -1, 4);
        }
        java.lang.Class[] clsArr = f189711c;
        for (int i17 = 0; i17 < 2; i17++) {
            if (clsArr[i17].equals(exc.getClass())) {
                return null;
            }
        }
        java.lang.Class[] clsArr2 = f189710b;
    ...
    public final com.tencent.mm.pluginsdk.res.downloader.model.v h(com.tencent.mm.pluginsdk.res.downloader.model.i iVar, java.lang.Exception exc) {
        int i17;
        ...
        com.tencent.mm.pluginsdk.res.downloader.model.x xVar = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: download failed, caused by %s", xVar.f(), exc);
        return new com.tencent.mm.pluginsdk.res.downloader.model.v(xVar, exc, i17, 3);
    }
    ...
    */
    ...
    public final com.tencent.mm.pluginsdk.res.downloader.model.v j(com.tencent.mm.pluginsdk.res.downloader.model.i iVar, java.net.HttpURLConnection httpURLConnection, boolean z17) {
        ...
        ?? r27 = zy.s.class;
        com.tencent.mm.pluginsdk.res.downloader.model.x xVar = (com.tencent.mm.pluginsdk.res.downloader.model.x) iVar;
        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: step4, start to read response", xVar.f());
        int i28 = -1;
        try {
            try {
                try {
                    ...
                    try {
                        ...
                        if (contentLength == 0 && 206 == responseCode && g18 > 0) {
                            ...
                            try {
                                com.tencent.mm.pluginsdk.res.downloader.model.v vVar2 = new com.tencent.mm.pluginsdk.res.downloader.model.v(xVar, 2, g18, contentType);
                                ...
                                com.tencent.mars.xlog.Log.e("MicroMsg.ResDownloader.NetworkPerformer", "%s: HttpUrlConnection getInputStream failed! %s", xVar.f(), iOException);
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    try {
                                        if (!com.tencent.mm.sdk.platformtools.t8.K0(contentEncoding)) {
                                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: append = %b, isSupportRange = %s", xVar.f(), java.lang.Boolean.valueOf(z17), java.lang.Boolean.valueOf(g17));
                                        ...
                                        while (true) {
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    socketException = e58;
                                                    com.tencent.mars.xlog.Log.e("MicroMsg.ResDownloader.NetworkPerformer", xVar.f() + ": " + socketException.getMessage());
                                                    throw socketException;
                                                } catch (java.net.UnknownHostException e59) {
                                                    throw e59;
                                                } catch (javax.net.ssl.SSLHandshakeException e66) {
                                                    sSLHandshakeException = e66;
                                                    com.tencent.mars.xlog.Log.e("MicroMsg.ResDownloader.NetworkPerformer", "%s: HttpUrlConnection SSLHandshakeException!", xVar.f());
                                                    com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.ResDownloader.NetworkPerformer", sSLHandshakeException, "", new java.lang.Object[0]);
                                        ...
                                        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: read count = %d", xVar.f(), java.lang.Integer.valueOf(i17));
                                        e47.flush();
                                        com.tencent.mars.xlog.Log.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: download complete, flush and send complete status", xVar.f());
                                        try {
                                            if (xVar.d()) {
                                                filterInputStream2 = bufferedInputStream;
                                                outputStream = e47;
                                                i19 = responseCode;
                                                vVar = new com.tencent.mm.pluginsdk.res.downloader.model.v(xVar, 2, o35.a.g(xVar.e()), contentType);
                                            } else {
                                                filterInputStream2 = bufferedInputStream;
                                                outputStream = e47;
                                                i19 = responseCode;
                                                vVar = new com.tencent.mm.pluginsdk.res.downloader.model.v(xVar, 2, contentLength, contentType);
                                            }
