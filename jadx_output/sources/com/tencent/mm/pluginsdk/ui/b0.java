...
public class b0 implements android.widget.AbsListView.OnScrollListener {
    ...
    public final android.widget.AbsListView.OnScrollListener f189903d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.LinkedList f189904e = new java.util.LinkedList();

    public b0(android.widget.AbsListView.OnScrollListener onScrollListener) {
        this.f189903d = onScrollListener;
    }

    public void a(boolean z17) {
        java.util.Iterator it = this.f189904e.iterator();
        while (it.hasNext()) {
            java.lang.ref.WeakReference weakReference = (java.lang.ref.WeakReference) it.next();
            if (weakReference == null) {
                it.remove();
            } else {
                com.tencent.mm.pluginsdk.ui.a0 a0Var = (com.tencent.mm.pluginsdk.ui.a0) weakReference.get();
                if (a0Var == null) {
                    it.remove();
                } else {
                    a0Var.onScrollStateChanged(z17);
                }
            }
        }
    }
    ...
    public void onScroll(android.widget.AbsListView absListView, int i17, int i18, int i19) {
        ...
        android.widget.AbsListView.OnScrollListener onScrollListener = this.f189903d;
