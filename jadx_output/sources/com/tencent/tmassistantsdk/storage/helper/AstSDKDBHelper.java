...
public class AstSDKDBHelper extends com.tencent.tmassistantsdk.storage.helper.SqliteHelper {
    public static final java.lang.String DB_NAME = "tmassistant_sdk.db";
    ...
    public AstSDKDBHelper(android.content.Context context, java.lang.String str, android.database.sqlite.SQLiteDatabase.CursorFactory cursorFactory, int i17) {
        super(context, DB_NAME, cursorFactory, i17);
    }
    ...
    public static synchronized com.tencent.tmassistantsdk.storage.helper.SqliteHelper getInstance() {
        ...
        synchronized (com.tencent.tmassistantsdk.storage.helper.AstSDKDBHelper.class) {
            if (mInstance == null && (context = com.tencent.tmassistantsdk.util.GlobalUtil.getInstance().getContext()) != null) {
                mInstance = new com.tencent.tmassistantsdk.storage.helper.AstSDKDBHelper(context, DB_NAME, null, 2);
            }
