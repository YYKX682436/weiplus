...
final class ConversationListApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.biz.ConversationListApiCodec INSTANCE = new com.tencent.pigeon.biz.ConversationListApiCodec();

    private ConversationListApiCodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (list2 != null) {
            return com.tencent.pigeon.biz.Conversation.INSTANCE.fromList(list2);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        } else if (!(obj instanceof com.tencent.pigeon.biz.Conversation)) {
