...
final class NotifyMsgCallbackApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.biz.NotifyMsgCallbackApiCodec INSTANCE = new com.tencent.pigeon.biz.NotifyMsgCallbackApiCodec();

    private NotifyMsgCallbackApiCodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (type == Byte.MIN_VALUE) {
            ...
            if (list != null) {
                return com.tencent.pigeon.biz.BizPayAlbum.INSTANCE.fromList(list);
            }
            return null;
        }
        if (type != -127) {
        ...
        if (list2 != null) {
            return com.tencent.pigeon.biz.NotifyMsg.INSTANCE.fromList(list2);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        } else if (!(obj instanceof com.tencent.pigeon.biz.NotifyMsg)) {
