...
final class NotifyMsgApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.biz.NotifyMsgApiCodec INSTANCE = new com.tencent.pigeon.biz.NotifyMsgApiCodec();

    private NotifyMsgApiCodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (type == Byte.MIN_VALUE) {
            ...
            if (list != null) {
                return com.tencent.pigeon.biz.BizNotificationTabInfo.INSTANCE.fromList(list);
            }
            return null;
        }
        if (type == -127) {
            ...
            if (list2 != null) {
                return com.tencent.pigeon.biz.BizPayAlbum.INSTANCE.fromList(list2);
            }
            return null;
        }
        if (type == -126) {
            ...
            if (list3 != null) {
                return com.tencent.pigeon.biz.NotifyMsg.INSTANCE.fromList(list3);
            }
            return null;
        }
        if (type == -125) {
            ...
            if (list4 != null) {
                return com.tencent.pigeon.biz.NotifyMsg.INSTANCE.fromList(list4);
            }
            return null;
        }
        if (type != -124) {
        ...
        if (list5 != null) {
            return com.tencent.pigeon.biz.NotifyTabInfo.INSTANCE.fromList(list5);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        boolean z17 = obj instanceof com.tencent.pigeon.biz.NotifyMsg;
        if (z17) {
            stream.write(130);
            ...
            stream.write(131);
            writeValue(stream, ((com.tencent.pigeon.biz.NotifyMsg) obj).toList());
        } else if (!(obj instanceof com.tencent.pigeon.biz.NotifyTabInfo)) {
