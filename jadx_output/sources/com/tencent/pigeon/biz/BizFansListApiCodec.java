...
final class BizFansListApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.biz.BizFansListApiCodec INSTANCE = new com.tencent.pigeon.biz.BizFansListApiCodec();

    private BizFansListApiCodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (list != null) {
            return com.tencent.pigeon.biz.BizInteractiveUserInfo.INSTANCE.fromList(list);
        }
        return null;
    }
