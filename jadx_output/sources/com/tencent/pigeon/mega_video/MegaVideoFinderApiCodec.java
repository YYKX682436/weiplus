...
final class MegaVideoFinderApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.mega_video.MegaVideoFinderApiCodec INSTANCE = new com.tencent.pigeon.mega_video.MegaVideoFinderApiCodec();

    private MegaVideoFinderApiCodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (type == Byte.MIN_VALUE) {
            ...
            if (list != null) {
                return com.tencent.pigeon.mega_video.MegaVideoContact.INSTANCE.fromList(list);
            }
            return null;
        }
        if (type == -127) {
            ...
            if (list2 != null) {
                return com.tencent.pigeon.mega_video.MegaVideoFeedInfo.INSTANCE.fromList(list2);
            }
            return null;
        }
        if (type != -126) {
        ...
        if (list3 != null) {
            return com.tencent.pigeon.mega_video.MegaVideoFeedInfo.INSTANCE.fromList(list3);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        if (obj instanceof com.tencent.pigeon.mega_video.MegaVideoContact) {
            stream.write(128);
            writeValue(stream, ((com.tencent.pigeon.mega_video.MegaVideoContact) obj).toList());
            return;
        }
        boolean z17 = obj instanceof com.tencent.pigeon.mega_video.MegaVideoFeedInfo;
        if (z17) {
            stream.write(129);
