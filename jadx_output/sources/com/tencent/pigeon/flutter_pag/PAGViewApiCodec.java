...
final class PAGViewApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.flutter_pag.PAGViewApiCodec INSTANCE = new com.tencent.pigeon.flutter_pag.PAGViewApiCodec();
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (type == Byte.MIN_VALUE) {
            ...
            if (list != null) {
                return com.tencent.pigeon.flutter_pag.FlutterPAGInfo.INSTANCE.fromList(list);
            }
            return null;
        }
        if (type != -127) {
        ...
        if (list2 != null) {
            return com.tencent.pigeon.flutter_pag.FlutterPAGText.INSTANCE.fromList(list2);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        if (obj instanceof com.tencent.pigeon.flutter_pag.FlutterPAGInfo) {
            stream.write(128);
            writeValue(stream, ((com.tencent.pigeon.flutter_pag.FlutterPAGInfo) obj).toList());
        } else if (!(obj instanceof com.tencent.pigeon.flutter_pag.FlutterPAGText)) {
            super.writeValue(stream, obj);
        } else {
            stream.write(129);
            writeValue(stream, ((com.tencent.pigeon.flutter_pag.FlutterPAGText) obj).toList());
        }
    }
}
