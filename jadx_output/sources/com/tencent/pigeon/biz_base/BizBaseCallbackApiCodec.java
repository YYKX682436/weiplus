...
@kotlin.Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0005\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bÂ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u001a\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0014J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0006H\u0014¨\u0006\u000f"}, d2 = {"Lcom/tencent/pigeon/biz_base/BizBaseCallbackApiCodec;", "Lio/flutter/plugin/common/StandardMessageCodec;", "", "type", "Ljava/nio/ByteBuffer;", "buffer", "", "readValueOfType", "Ljava/io/ByteArrayOutputStream;", "stream", "value", "Ljz5/f0;", "writeValue", "<init>", "()V", "mm_auto_gen_release"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes11.dex */
final class BizBaseCallbackApiCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.biz_base.BizBaseCallbackApiCodec INSTANCE = new com.tencent.pigeon.biz_base.BizBaseCallbackApiCodec();

    private BizBaseCallbackApiCodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (type == Byte.MIN_VALUE) {
            ...
            if (list != null) {
                return com.tencent.pigeon.biz_base.BizFinderLiveInfo.INSTANCE.fromList(list);
            }
            return null;
        }
        if (type == -127) {
            ...
            if (list2 != null) {
                return com.tencent.pigeon.biz_base.BizNotifyInfo.INSTANCE.fromList(list2);
            }
            return null;
        }
        if (type == -126) {
            ...
            if (list3 != null) {
                return com.tencent.pigeon.biz_base.BizNotifyTipsInfo.INSTANCE.fromList(list3);
            }
            return null;
        }
        if (type == -125) {
            ...
            if (list4 != null) {
                return com.tencent.pigeon.biz_base.Finder_Data.INSTANCE.fromList(list4);
            }
            return null;
        }
        if (type == -124) {
            ...
            if (list5 != null) {
                return com.tencent.pigeon.biz_base.MassSendCardMsg.INSTANCE.fromList(list5);
            }
            return null;
        }
        if (type == -123) {
            ...
            if (list6 != null) {
                return com.tencent.pigeon.biz_base.MassSendCardMsg.INSTANCE.fromList(list6);
            }
            return null;
        }
        if (type == -122) {
            ...
            if (list7 != null) {
                return com.tencent.pigeon.biz_base.MassSendCardMsgItem.INSTANCE.fromList(list7);
            }
            return null;
        }
        if (type == -121) {
            ...
            if (list8 != null) {
                return com.tencent.pigeon.biz_base.MockCanvasModel.INSTANCE.fromList(list8);
            }
            return null;
        }
        if (type == -120) {
            ...
            if (list9 != null) {
                return com.tencent.pigeon.biz_base.NativeBizCreationInfo.INSTANCE.fromList(list9);
            }
            return null;
        }
        if (type != -119) {
        ...
        if (list10 != null) {
            return com.tencent.pigeon.biz_base.WeApp_Data.INSTANCE.fromList(list10);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        if (obj instanceof com.tencent.pigeon.biz_base.BizNotifyInfo) {
            stream.write(129);
            writeValue(stream, ((com.tencent.pigeon.biz_base.BizNotifyInfo) obj).toList());
            return;
        }
        ...
        boolean z17 = obj instanceof com.tencent.pigeon.biz_base.MassSendCardMsg;
        if (z17) {
            stream.write(132);
        ...
        if (obj instanceof com.tencent.pigeon.biz_base.MockCanvasModel) {
            stream.write(135);
            writeValue(stream, ((com.tencent.pigeon.biz_base.MockCanvasModel) obj).toList());
        } else if (obj instanceof com.tencent.pigeon.biz_base.NativeBizCreationInfo) {
            stream.write(136);
