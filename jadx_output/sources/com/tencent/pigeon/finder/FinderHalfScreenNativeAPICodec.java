...
final class FinderHalfScreenNativeAPICodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.finder.FinderHalfScreenNativeAPICodec INSTANCE = new com.tencent.pigeon.finder.FinderHalfScreenNativeAPICodec();

    private FinderHalfScreenNativeAPICodec() {
    }
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (list != null) {
            return com.tencent.pigeon.finder.FlutterRect.INSTANCE.fromList(list);
        }
        return null;
    }
