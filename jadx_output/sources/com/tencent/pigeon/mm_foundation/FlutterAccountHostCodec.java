...
final class FlutterAccountHostCodec extends io.flutter.plugin.common.StandardMessageCodec {
    public static final com.tencent.pigeon.mm_foundation.FlutterAccountHostCodec INSTANCE = new com.tencent.pigeon.mm_foundation.FlutterAccountHostCodec();
    ...
    public java.lang.Object readValueOfType(byte type, java.nio.ByteBuffer buffer) {
        ...
        if (type == Byte.MIN_VALUE) {
            ...
            if (list != null) {
                return com.tencent.pigeon.mm_foundation.AvatarInfo.INSTANCE.fromList(list);
            }
            return null;
        }
        if (type == -127) {
            ...
            if (list2 != null) {
                return com.tencent.pigeon.mm_foundation.FlutterUserInfo.INSTANCE.fromList(list2);
            }
            return null;
        }
        if (type == -126) {
            ...
            if (list3 != null) {
                return com.tencent.pigeon.mm_foundation.FlutterUserInfo.INSTANCE.fromList(list3);
            }
            return null;
        }
        if (type == -125) {
            ...
            if (list4 != null) {
                return com.tencent.pigeon.mm_foundation.ImageLoadPerformanceInfo.INSTANCE.fromList(list4);
            }
            return null;
        }
        if (type != -124) {
        ...
        if (list5 != null) {
            return com.tencent.pigeon.mm_foundation.UserInfoResponse.INSTANCE.fromList(list5);
        }
        return null;
    }
    ...
    public void writeValue(java.io.ByteArrayOutputStream stream, java.lang.Object obj) {
        ...
        if (obj instanceof com.tencent.pigeon.mm_foundation.AvatarInfo) {
            stream.write(128);
            writeValue(stream, ((com.tencent.pigeon.mm_foundation.AvatarInfo) obj).toList());
            return;
        }
        boolean z17 = obj instanceof com.tencent.pigeon.mm_foundation.FlutterUserInfo;
        if (z17) {
            stream.write(129);
            writeValue(stream, ((com.tencent.pigeon.mm_foundation.FlutterUserInfo) obj).toList());
            return;
        }
        if (z17) {
            stream.write(130);
            writeValue(stream, ((com.tencent.pigeon.mm_foundation.FlutterUserInfo) obj).toList());
        } else if (obj instanceof com.tencent.pigeon.mm_foundation.ImageLoadPerformanceInfo) {
            stream.write(131);
            writeValue(stream, ((com.tencent.pigeon.mm_foundation.ImageLoadPerformanceInfo) obj).toList());
        } else if (!(obj instanceof com.tencent.pigeon.mm_foundation.UserInfoResponse)) {
            super.writeValue(stream, obj);
        } else {
            stream.write(132);
            writeValue(stream, ((com.tencent.pigeon.mm_foundation.UserInfoResponse) obj).toList());
        }
    }
}
