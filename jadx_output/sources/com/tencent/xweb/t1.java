...
public abstract class t1 {
    ...
    public static java.lang.Boolean f220595a;

    /* renamed from: b, reason: collision with root package name */
    public static java.lang.String f220596b;
    ...
    public static int b() {
        return com.tencent.xweb.b.m().i("child_process_crash_watch_count", "tools", 5);
    }

    public static int c() {
        return com.tencent.xweb.b.m().i("child_process_crash_watch_time", "tools", 1440) * 60 * 1000;
    }
    ...
    public static java.lang.String e() {
        java.lang.String str = f220596b;
        if (str != null) {
            return str;
        }
        f220596b = "SP_KEY_CHILD_PROCESS_CRASH_COUNT_" + new java.text.SimpleDateFormat("yyyyMMdd").format(new java.util.Date());
        by5.c4.f("XWebChildProcessMonitor", "getCrashCountKeyForToday, crashCountKeyForToday:" + f220596b);
        android.content.SharedPreferences c17 = by5.d4.c();
        if (c17 != null) {
            for (java.lang.String str2 : c17.getAll().keySet()) {
                if (str2.startsWith("SP_KEY_CHILD_PROCESS_CRASH_COUNT_") && !f220596b.equals(str2)) {
    ...
    public static synchronized boolean f() {
        synchronized (com.tencent.xweb.t1.class) {
            android.content.SharedPreferences c17 = by5.d4.c();
            if (!org.xwalk.core.XWalkEnvironment.l().equalsIgnoreCase(org.xwalk.core.XWalkEnvironment.getProcessName())) {
                return false;
            }
    ...
    public static boolean g() {
        ...
        java.lang.String str = "SP_KEY_CHILD_PROCESS_CRASH_VERSION_" + org.xwalk.core.XWalkEnvironment.d();
    ...
    public static void j(java.lang.String str) {
        ...
        if (c17 != null) {
            ...
            java.lang.String str2 = "SP_KEY_CHILD_PROCESS_CRASH_VERSION_" + org.xwalk.core.XWalkEnvironment.d();
    ...
    public static void l(boolean z17) {
        ...
        if (c17 != null) {
            ...
            org.xwalk.core.XWalkEnvironment.a("WXDK_USER");
        }
    }
