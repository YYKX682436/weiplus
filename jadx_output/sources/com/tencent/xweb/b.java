...
public class b {
    ...
    public static java.lang.String f220208b = "";

    /* renamed from: c, reason: collision with root package name */
    public static com.tencent.xweb.b f220209c;

    /* renamed from: a, reason: collision with root package name */
    public java.util.Map f220210a = new java.util.HashMap();

    public static synchronized com.tencent.xweb.b m() {
        com.tencent.xweb.b bVar;
        synchronized (com.tencent.xweb.b.class) {
            if (f220209c == null) {
                com.tencent.xweb.b bVar2 = new com.tencent.xweb.b();
                f220209c = bVar2;
                bVar2.q();
            }
            bVar = f220209c;
    ...
    public boolean a(by5.h hVar, java.util.Map map, java.lang.String[] strArr) {
        ...
        if (str.equals("executeCommand")) {
            java.lang.String[] s17 = s(hVar.f36473c);
        ...
        if (hVarArr != null && hVarArr.length != 0) {
            for (int i17 = 0; i17 < hVarArr.length; i17++) {
                ...
                if (hVar != null && (!z17 || !"revertToVersion".equals(hVar.f36472b))) {
                    ...
                    if (!hVarArr[i17].f36471a.a(false, false, "CommandCfg")) {
                        ...
                        if (hVar2.f36473c != null && (str2 = hVar2.f36474d) != null && !str2.isEmpty()) {
                            boolean a17 = a(hVarArr[i17], hashMap, hVarArr[i17].f36474d.split(","));
    ...
    public synchronized java.lang.String d() {
        ...
        java.util.Set<java.lang.String> keySet = this.f220210a.keySet();
        sb6.append(" config version = " + f220208b + "\n");
        ...
        return sb6.toString();
        java.lang.String u17 = u(k(str, this.f220210a));
        if (u17 == null) {
            u17 = "";
        }
        sb6.append(" [" + str + "] = ");
    ...
    public synchronized java.lang.String f(java.lang.String str) {
        ...
        moduleName = com.tencent.xweb.WebView.getModuleName();
        if (android.text.TextUtils.isEmpty(moduleName)) {
            moduleName = "tools";
        }
    ...
    public synchronized java.lang.String j(java.lang.String str, java.lang.String str2) {
        java.util.Map k17;
        synchronized (this) {
            k17 = k(str, this.f220210a);
        }
        if (android.text.TextUtils.isEmpty(str2)) {
            str2 = com.tencent.xweb.WebView.getModuleName();
            if (android.text.TextUtils.isEmpty(str2)) {
                str2 = "tools";
            }
        }
    ...
    public com.tencent.xweb.c1 l(java.lang.String str) {
        java.lang.String g17 = g("setfullscreenvideo", str);
        com.tencent.xweb.c1 c1Var = com.tencent.xweb.c1.HOOK_EVALUTE_JS;
        if (g17 == null || g17.isEmpty()) {
            return c1Var;
        }
        try {
            return com.tencent.xweb.c1.valueOf(g17);
    ...
    public synchronized void q() {
        ...
        f220208b = p17.getString("cStrTAGConfigVer", "");
        java.util.Map<java.lang.String, ?> all = p17.getAll();
        if (all != null && all.size() != 0) {
            java.util.Iterator<java.util.Map.Entry<java.lang.String, ?>> it = all.entrySet().iterator();
            while (it.hasNext()) {
                ...
                if (key != null && string != null) {
                    ...
                    if (hashMap.size() == 0) {
                        this.f220210a.put(key, string);
                    } else {
                        this.f220210a.put(key, hashMap);
                    }
                }
            }
            by5.c4.f(n(), "initCommandConfigs end, config version:" + f220208b + ", config map size:" + this.f220210a.size());
            return;
        }
    ...
    public synchronized void t(java.lang.String str, java.util.Map map) {
        ...
        edit.putString("cStrTAGConfigSdkVer", java.lang.String.valueOf(com.tencent.xwebsdk.BuildConfig.SDK_VERSION_CODE));
