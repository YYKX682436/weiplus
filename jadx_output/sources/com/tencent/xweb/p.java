...
public class p implements android.webkit.ValueCallback {
    ...
    public final /* synthetic */ com.tencent.xweb.o1 f220370a;

    public p(com.tencent.xweb.o1 o1Var) {
        this.f220370a = o1Var;
    }
            ...
            if (obj3 instanceof java.util.HashMap) {
                try {
                    ...
                    if ("ac_onViewStatusChange".equals(obj2)) {
                        java.lang.Integer a17 = com.tencent.xweb.t.a(hashMap, "ac_viewIndex");
                        if (a17 == null) {
                        ...
                        java.lang.Integer a18 = com.tencent.xweb.t.a(hashMap, "ac_curWidth");
                        if (a18 == null) {
                            by5.c4.c("FileReaderXWeb", "actionCallback " + ((java.lang.String) pair.first) + ", viewCurWidth is null");
                            return;
                        }
                        java.lang.Integer a19 = com.tencent.xweb.t.a(hashMap, "ac_curHeight");
                        if (a19 == null) {
                            by5.c4.c("FileReaderXWeb", "actionCallback " + ((java.lang.String) pair.first) + ", viewCurHeight is null");
                            return;
                        }
                        java.lang.Integer a27 = com.tencent.xweb.t.a(hashMap, "ac_viewTransX");
                        if (a27 == null) {
                            by5.c4.c("FileReaderXWeb", "actionCallback " + ((java.lang.String) pair.first) + ", viewTransX is null");
                            return;
                        }
                        java.lang.Integer a28 = com.tencent.xweb.t.a(hashMap, "ac_viewTransY");
                        if (a28 != null) {
                            this.f220370a.g(a17.intValue(), f17.floatValue(), a18.intValue(), a19.intValue(), a27.intValue(), a28.intValue());
                            return;
                        }
                    ...
                    com.tencent.xweb.o1 o1Var = this.f220370a;
                    if (equals) {
                        java.lang.Integer a29 = com.tencent.xweb.t.a(hashMap, "ac_totalCount");
                        if (a29 != null) {
                    ...
                    if ("ac_onPageChange".equals(pair.first)) {
                        java.lang.Integer a37 = com.tencent.xweb.t.a(hashMap, "ac_pageIndex");
                        if (a37 == null) {
                            by5.c4.c("FileReaderXWeb", "actionCallback " + ((java.lang.String) pair.first) + ", pageIndex is null");
                            return;
                        }
                        java.lang.Integer a38 = com.tencent.xweb.t.a(hashMap, "ac_pageWidth");
                        if (a38 == null) {
                            by5.c4.c("FileReaderXWeb", "actionCallback " + ((java.lang.String) pair.first) + ", pageWidth is null");
                            return;
                        }
                        java.lang.Integer a39 = com.tencent.xweb.t.a(hashMap, "ac_pageHeight");
                        if (a39 != null) {
                    ...
                    if ("ac_onThumbnailLoad".equals(pair.first)) {
                        java.lang.Integer a47 = com.tencent.xweb.t.a(hashMap, "ac_pageIndex");
                        if (hashMap == null) {
                    ...
                    if ("ac_onSingleTap".equals(pair.first)) {
                        android.view.MotionEvent b17 = com.tencent.xweb.t.b(hashMap, "ac_motionEvent");
                        if (b17 != null) {
                            o1Var.h(b17);
                            return;
                        }
                    ...
                    if ("ac_onDoubleTap".equals(pair.first)) {
                        android.view.MotionEvent b18 = com.tencent.xweb.t.b(hashMap, "ac_motionEvent");
                        if (b18 != null) {
                            o1Var.onDoubleTap(b18);
                            return;
                        }
                        by5.c4.c("FileReaderXWeb", "actionCallback " + ((java.lang.String) pair.first) + ", motion event is null");
                        return;
