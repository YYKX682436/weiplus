...
public class XWebCoreContentProvider extends android.content.ContentProvider {

    /* renamed from: d, reason: collision with root package name */
    public static final java.lang.String[] f220202d = {"com.tencent.mm"};

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.concurrent.atomic.AtomicBoolean f220203e = new java.util.concurrent.atomic.AtomicBoolean(false);

    /* renamed from: f, reason: collision with root package name */
    public static final java.util.concurrent.atomic.AtomicLong f220204f = new java.util.concurrent.atomic.AtomicLong(0);
    ...
    public static void b(android.content.Context context, com.tencent.xweb.y1 y1Var) {
        if (y1Var == null) {
            return;
        }
        java.lang.String str = y1Var.f220628a + "," + (y1Var.f220629b.length() > 100 ? y1Var.f220629b.substring(0, 99) : y1Var.f220629b) + "," + y1Var.f220630c.f220643a + "," + (y1Var.f220630c.f220644b.length() > 100 ? y1Var.f220630c.f220644b.substring(0, 99) : y1Var.f220630c.f220644b) + "," + y1Var.f220630c.f220645c + "," + (y1Var.f220630c.f220646d.length() > 100 ? y1Var.f220630c.f220646d.substring(0, 99) : y1Var.f220630c.f220646d) + ",20260502," + org.xwalk.core.XWalkEnvironment.d();
        if (context != null && !"com.tencent.mm".equals(y1Var.f220629b)) {
            ...
            try {
                ...
                contentResolver.insert(a("com.tencent.mm", y1Var.f220629b, 3, 0, ""), contentValues);
                return;
        ...
        com.tencent.xweb.x1 x1Var = new com.tencent.xweb.x1();
        x1Var.f220618a = 15625;
        x1Var.f220619b = str;
        synchronized (com.tencent.xweb.w1.f220616b) {
            ((java.util.ArrayList) com.tencent.xweb.w1.f220615a).add(x1Var);
        }
    }

    public static boolean c(java.lang.String str) {
        if (str != null && !str.isEmpty()) {
            return f220202d[0].equals(str);
        }
    ...
    public static void d() {
        ...
        java.util.List list = com.tencent.xweb.w1.f220615a;
        by5.c4.f("XWebCoreContentProvider", "CachedInfoMgr process cached info");
        synchronized (com.tencent.xweb.w1.f220616b) {
            java.util.Iterator it = ((java.util.ArrayList) com.tencent.xweb.w1.f220615a).iterator();
            while (it.hasNext()) {
                com.tencent.xweb.x1 x1Var = (com.tencent.xweb.x1) it.next();
                by5.s0.t(x1Var.f220618a, x1Var.f220619b);
            }
            ((java.util.ArrayList) com.tencent.xweb.w1.f220615a).clear();
        }
        f220203e.set(true);
    }

    public static com.tencent.xweb.z1 e(android.net.Uri uri) {
        java.lang.String str;
        int i17;
        com.tencent.xweb.z1 z1Var = new com.tencent.xweb.z1();
        z1Var.f220643a = -1;
