...
public class WeJson {
    ...
    private <T> T fromJsonArr(org.json.JSONArray jSONArray, java.lang.Class<T> cls, java.lang.Class<?> cls2) {
        ...
        throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("json 解析错误:不支持的类型:".concat(cls.getName()));
    }
    ...
    private java.util.List fromList(org.json.JSONArray jSONArray, java.lang.Class<java.util.List> cls, java.lang.Class<?> cls2) {
        ...
        if (cls2 == null) {
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("无法确定列表项的类型");
        }
        if (cls.getName().equals("java.util.List")) {
            ...
            try {
                ...
                throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("创建List类型失败,该列表不支持无参实例化", e17);
            }
        }
        for (int i17 = 0; i17 < jSONArray.length(); i17++) {
    ...
    private java.util.Map fromMap(org.json.JSONObject jSONObject, java.lang.Class<java.util.Map> cls, java.lang.Class<?> cls2) {
        ...
        if (cls.getName().equals("java.util.Map")) {
            ...
            try {
                ...
                throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("创建Map类型失败,该Map不支持无参实例化", e17);
            }
        }
    ...
    private <T> T fromPojo(org.json.JSONObject jSONObject, java.lang.Class<T> cls) {
        ...
        try {
                    ...
                    if (opt == null) {
                        ...
                        if ((modifiers & 1) != 0) {
                            try {
                                ...
                                throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("设置成员变量值失败.", e17);
                            }
                        } else {
                            ...
                            try {
                                try {
                                    ...
                                    throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("调用set方法失败.", e18);
                                }
            ...
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("必须为该类型提供一个无参构造方法:".concat(cls.getName()), e19);
        }
    }
    ...
    private <T> java.lang.Class<?> getMemberType(java.lang.Class<T> cls, java.lang.reflect.Field field) {
        ...
        if (!(genericSuperclass instanceof java.lang.reflect.ParameterizedType)) {
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("缺少泛型信息:" + cls);
        }
        java.lang.reflect.Type type = ((java.lang.reflect.ParameterizedType) genericSuperclass).getActualTypeArguments()[0];
        if (type instanceof java.lang.Class) {
            return (java.lang.Class) type;
        }
        throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("不支持嵌套泛型");
    }
    ...
    private java.lang.Object getObject(org.json.JSONArray jSONArray, int i17) {
        try {
            ...
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("JSONArray.get() cause JSONException", e17);
        }
    }
    ...
    private <T> java.lang.Class<?> getSubType(java.lang.Class<T> cls, java.lang.reflect.Field field, java.lang.Object obj) {
        ...
        if (field.getType().equals(java.util.List.class)) {
            ...
            if (!(genericType instanceof java.lang.reflect.ParameterizedType)) {
                throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("缺少泛型类型声明:" + field.getName());
            }
            ...
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("不支持嵌套泛型:" + field.getName());
        }
    ...
    public <T> T fromJson(java.lang.String str, java.lang.Class<T> cls) {
        ...
        if (cls == null) {
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("必须指定classOfT");
        }
        ...
        if (trim.startsWith("[")) {
            try {
                ...
                throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("json 解析错误" + e17.getMessage(), e17);
            }
        } else if (trim.startsWith("{")) {
            try {
                return (T) fromJsonObj(new org.json.JSONObject(trim), cls, null);
            } catch (java.lang.Exception e18) {
                throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("json 解析错误:" + e18.getMessage(), e18);
            }
        }
        throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("classOfT 指定错误");
    }
    ...
    private java.lang.Object getObject(org.json.JSONObject jSONObject, java.lang.String str) {
        try {
            ...
            throw new com.tencent.youtu.sdkkitframework.common.WeJsonException("JSONObject.get() cause JSONException", e17);
        }
    }
}
