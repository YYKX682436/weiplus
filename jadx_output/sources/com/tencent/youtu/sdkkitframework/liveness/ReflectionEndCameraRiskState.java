...
public class ReflectionEndCameraRiskState extends com.tencent.youtu.sdkkitframework.liveness.risk.BaseCameraRiskState {
    private static final com.tencent.youtu.sdkkitframework.liveness.risk.CameraRiskData.StageName RISK_STAGE = com.tencent.youtu.sdkkitframework.liveness.risk.CameraRiskData.StageName.stage_end;
    ...
    public void enterFirst() {
        ...
        if (currentStateRiskData == null) {
            ...
            this.nextStateName = com.tencent.youtu.sdkkitframework.framework.YtSDKKitCommon.StateNameHelper.StateClassName.NET_LIVENESS_REQ_RESULT_STATE;
            return;
        }
