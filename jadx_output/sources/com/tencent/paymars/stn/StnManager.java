...
public class StnManager extends com.tencent.paymars.app.BaseManager {
    ...
    public interface CallBack {
        ...
        void onLongLinkNetworkError(com.tencent.paymars.stn.ErrCmdType errCmdType, int i17, java.lang.String str, int i18);
        ...
        void onShortLinkNetworkError(com.tencent.paymars.stn.ErrCmdType errCmdType, int i17, java.lang.String str, java.lang.String str2, int i18);

        int onTaskEnd(int i17, java.lang.Object obj, int i18, int i19, com.tencent.paymars.stn.StnManager.CgiProfile cgiProfile);
    ...
    public native void OnJniStartTask(com.tencent.paymars.stn.StnManager.Task task);
    ...
    public void setCallback(com.tencent.paymars.stn.StnManager.CallBack callBack) {
    ...
    public void startTask(com.tencent.paymars.stn.StnManager.Task task) {
        OnJniStartTask(task);
    }
    ...
    public static class Task {
        ...
        public Task(com.tencent.paymars.app.Context context) {
            this.retryCount = -1;
            this.taskID = com.tencent.mars.comm.Utils.genTaskId();
            this.headers = new java.util.HashMap();
        }

        public Task(com.tencent.paymars.app.Context context, int i17, int i18, java.lang.String str, java.util.ArrayList<java.lang.String> arrayList) {
            this.retryCount = -1;
            this.taskID = com.tencent.mars.comm.Utils.genTaskId();
            ...
            this.bindCellular = false;
        }
    }

    public StnManager(com.tencent.paymars.app.Context context) {
