...
public class Context {
    ...
    protected com.tencent.paymars.app.BridgeMap interfaceMap = new com.tencent.paymars.app.BridgeMap();
    ...
    public <T> void addManager(java.lang.Class<T> cls, com.tencent.paymars.app.BaseManager baseManager) {
        if (baseManager == null) {
    ...
    public <T extends com.tencent.paymars.app.BaseManager> T getManager(java.lang.Class<T> cls) {
        cls.getName();
    ...
    public <T> void removeManager(java.lang.Class<T> cls, com.tencent.paymars.app.BaseManager baseManager) {
        if (baseManager == null) {
