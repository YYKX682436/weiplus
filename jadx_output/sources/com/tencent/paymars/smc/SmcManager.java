...
public class SmcManager extends com.tencent.paymars.app.BaseManager {
    protected com.tencent.paymars.smc.SmcManager.CallBack ICallBack;
    ...
    public interface CallBack {
        ...
        com.tencent.paymars.smc.SmcManager.BaseInfo getKVCommReqBaseInfo();
    ...
    public native void OnJniReportListIDKey(com.tencent.paymars.smc.IDKey[] iDKeyArr, boolean z17, boolean z18);

    public native void OnJniSetCallback(com.tencent.paymars.smc.SmcManager.CallBack callBack);
    ...
    public com.tencent.paymars.smc.SmcManager.CallBack getCallBack() {
    ...
    public void reportListIDKey(com.tencent.paymars.smc.IDKey[] iDKeyArr, boolean z17, boolean z18) {
        OnJniReportListIDKey(iDKeyArr, z17, z18);
    }

    public void setCallback(com.tencent.paymars.smc.SmcManager.CallBack callBack) {
    ...
    public SmcManager(com.tencent.paymars.app.Context context) {
