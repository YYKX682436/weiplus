...
public abstract class w {
    public static java.lang.String[] a(com.facebook.soloader.g gVar) {
        if (!(gVar instanceof com.facebook.soloader.h)) {
            return b(gVar);
        }
        com.facebook.soloader.h hVar = (com.facebook.soloader.h) gVar;
        int i17 = 0;
        while (true) {
            try {
                return b(hVar);
                ...
                hVar.getClass();
                java.io.FileInputStream fileInputStream = new java.io.FileInputStream(hVar.f44032d);
                hVar.f44033e = fileInputStream;
                hVar.f44034f = fileInputStream.getChannel();
            }
        }
    }

    public static java.lang.String[] b(com.facebook.soloader.g gVar) {
        long j17;
        long j18;
        long j19;
        long j27;
        ...
        if (d17 != 1179403647) {
            throw new com.facebook.soloader.v("file is not ELF: 0x" + java.lang.Long.toHexString(d17));
        }
        ...
        long j59 = 0;
        if (j18 == 0) {
            throw new com.facebook.soloader.v("ELF file does not contain dynamic linking information");
        }
        long j66 = j18;
        long j67 = 0;
        int i29 = 0;
        while (true) {
            ...
            if (j27 == 1) {
                if (i29 == Integer.MAX_VALUE) {
                    throw new com.facebook.soloader.v("malformed DT_NEEDED section");
                }
                i29++;
                i17 = c18;
            } else if (j27 == 5) {
            ...
            if (j27 != 0) {
                ...
                if (j67 == 0) {
                    throw new com.facebook.soloader.v("Dynamic section string-table not found");
                }
                int i37 = 0;
                while (true) {
                    if (i37 >= c17) {
                ...
                long j68 = 0;
                if (j29 == 0) {
                    throw new com.facebook.soloader.v("did not find file offset of DT_STRTAB table");
                }
    ...
    public static int c(com.facebook.soloader.g gVar, java.nio.ByteBuffer byteBuffer, long j17) {
        e(gVar, byteBuffer, 2, j17);
        return byteBuffer.getShort() & 65535;
    }

    public static long d(com.facebook.soloader.g gVar, java.nio.ByteBuffer byteBuffer, long j17) {
        e(gVar, byteBuffer, 4, j17);
        return byteBuffer.getInt() & io.flutter.embedding.android.KeyboardMap.kValueMask;
    }

    public static void e(com.facebook.soloader.g gVar, java.nio.ByteBuffer byteBuffer, int i17, long j17) {
        int s17;
        ...
        if (byteBuffer.remaining() > 0) {
            throw new com.facebook.soloader.v("ELF file truncated");
        }
        byteBuffer.position(0);
    }
}
