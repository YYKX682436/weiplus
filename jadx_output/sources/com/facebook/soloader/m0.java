...
public abstract class m0 extends com.facebook.soloader.f {

    /* renamed from: c, reason: collision with root package name */
    public final android.content.Context f44048c;

    /* renamed from: d, reason: collision with root package name */
    public java.lang.String f44049d;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Map f44050e;

    public m0(android.content.Context context, java.lang.String str) {
        super(i(context, str), 1);
        this.f44050e = new java.util.HashMap();
    ...
    public int a(java.lang.String str, int i17, android.os.StrictMode.ThreadPolicy threadPolicy) {
        int c17;
        synchronized (h(str)) {
            c17 = c(str, i17, this.f44022a, threadPolicy);
        }
        return c17;
    }
    ...
    public void b(int i17) {
        ...
        com.facebook.soloader.t tVar = new com.facebook.soloader.t(new java.io.File(file, "dso_lock"));
        try {
    ...
    public final void d(com.facebook.soloader.g0[] g0VarArr) {
        java.io.File file = this.f44022a;
        ...
        for (java.lang.String str : list) {
            if (!str.equals("dso_state") && !str.equals("dso_lock") && !str.equals("dso_deps") && !str.equals("dso_manifest")) {
                ...
                for (int i17 = 0; !z17 && i17 < g0VarArr.length; i17++) {
                    if (g0VarArr[i17].f44030d.equals(str)) {
                        z17 = true;
                    }
                }
                if (!z17) {
                    ...
                    file2.toString();
                    com.facebook.soloader.e0.a(file2);
                }
            }
        }
    }

    public final void e(com.facebook.soloader.i0 i0Var, byte[] bArr) {
        java.io.File file = this.f44022a;
        java.lang.String str = ((com.facebook.soloader.k0) i0Var).f44044d.f44030d;
        try {
    ...
    public final void f(com.facebook.soloader.i0 i0Var, byte[] bArr) {
        java.io.RandomAccessFile randomAccessFile;
        java.io.File file = new java.io.File(this.f44022a, ((com.facebook.soloader.k0) i0Var).f44044d.f44030d);
        ...
        try {
            try {
                ...
                try {
                    ...
                    file.toString();
                    com.facebook.soloader.e0.a(file);
                    randomAccessFile = new java.io.RandomAccessFile(file, "rw");
                }
                randomAccessFile2 = randomAccessFile;
                int available = ((com.facebook.soloader.k0) i0Var).f44045e.available();
                if (available > 1) {
                    com.facebook.soloader.SysUtil$LollipopSysdeps.fallocateIfSupported(randomAccessFile2.getFD(), available);
                }
                com.facebook.soloader.k0 k0Var = (com.facebook.soloader.k0) i0Var;
                int i17 = 0;
                while (i17 < Integer.MAX_VALUE) {
                    int read = k0Var.f44045e.read(bArr, 0, java.lang.Math.min(bArr.length, Integer.MAX_VALUE - i17));
                    if (read == -1) {
                        break;
                    }
    ...
    public byte[] g() {
        ...
        com.facebook.soloader.l0 j17 = j();
        try {
            com.facebook.soloader.g0[] g0VarArr = j17.a().f44035a;
            obtain.writeByte((byte) 1);
            obtain.writeInt(g0VarArr.length);
            for (int i17 = 0; i17 < g0VarArr.length; i17++) {
                obtain.writeString(g0VarArr[i17].f44030d);
                obtain.writeString(g0VarArr[i17].f44031e);
            }
            j17.close();
    ...
    public final java.lang.Object h(java.lang.String str) {
        ...
        synchronized (this.f44050e) {
            obj = ((java.util.HashMap) this.f44050e).get(str);
            if (obj == null) {
                obj = new java.lang.Object();
                ((java.util.HashMap) this.f44050e).put(str, obj);
            }
        }
        return obj;
    }

    public abstract com.facebook.soloader.l0 j();
    ...
    */
    public final boolean k(com.facebook.soloader.t r12, int r13, byte[] r14) {
        /*
            r11 = this;
            java.io.File r5 = new java.io.File
            java.lang.String r0 = "dso_state"
            java.io.File r7 = r11.f44022a
            r5.<init>(r7, r0)
        ...
        Lbe:
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.soloader.m0.k(com.facebook.soloader.t, int, byte[]):boolean");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void l(byte r10, com.facebook.soloader.h0 r11, com.facebook.soloader.j0 r12) {
        /*
            r9 = this;
            java.io.File r0 = new java.io.File
            java.lang.String r1 = "dso_manifest"
            java.io.File r2 = r9.f44022a
            r0.<init>(r2, r1)
            ...
            r0 = 1
            if (r10 != r0) goto L1b
            com.facebook.soloader.h0 r10 = com.facebook.soloader.h0.a(r1)     // Catch: java.lang.Throwable -> L18 java.lang.Exception -> L1b
            goto L1c
        L18:
            r10 = move-exception
            goto L9d
        ...
        L1c:
            ...
            com.facebook.soloader.g0[] r4 = new com.facebook.soloader.g0[r3]     // Catch: java.lang.Throwable -> L18
            r10.<init>(r4)     // Catch: java.lang.Throwable -> L18
        L26:
            com.facebook.soloader.g0[] r11 = r11.f44035a     // Catch: java.lang.Throwable -> L18
        ...
        L3c:
            if (r5 == 0) goto L6b
            com.facebook.soloader.g0[] r7 = r10.f44035a     // Catch: java.lang.Throwable -> L89
            int r8 = r7.length     // Catch: java.lang.Throwable -> L89
            if (r6 >= r8) goto L6b
            r8 = r4
            com.facebook.soloader.k0 r8 = (com.facebook.soloader.k0) r8     // Catch: java.lang.Throwable -> L89
            com.facebook.soloader.g0 r8 = r8.f44044d     // Catch: java.lang.Throwable -> L89
            java.lang.String r8 = r8.f44030d     // Catch: java.lang.Throwable -> L89
            r7 = r7[r6]     // Catch: java.lang.Throwable -> L89
            java.lang.String r7 = r7.f44030d     // Catch: java.lang.Throwable -> L89
            boolean r7 = r7.equals(r8)     // Catch: java.lang.Throwable -> L89
            if (r7 == 0) goto L68
            com.facebook.soloader.g0[] r7 = r10.f44035a     // Catch: java.lang.Throwable -> L89
            r7 = r7[r6]     // Catch: java.lang.Throwable -> L89
            java.lang.String r7 = r7.f44031e     // Catch: java.lang.Throwable -> L89
            r8 = r4
            com.facebook.soloader.k0 r8 = (com.facebook.soloader.k0) r8     // Catch: java.lang.Throwable -> L89
            com.facebook.soloader.g0 r8 = r8.f44044d     // Catch: java.lang.Throwable -> L89
            java.lang.String r8 = r8.f44031e     // Catch: java.lang.Throwable -> L89
            boolean r7 = r7.equals(r8)     // Catch: java.lang.Throwable -> L89
            if (r7 == 0) goto L68
            r5 = r3
        L68:
        ...
        L6b:
            ...
            r7 = r4
            com.facebook.soloader.k0 r7 = (com.facebook.soloader.k0) r7     // Catch: java.lang.Throwable -> L89
            com.facebook.soloader.g0 r7 = r7.f44044d     // Catch: java.lang.Throwable -> L89
            java.lang.String r7 = r7.f44030d     // Catch: java.lang.Throwable -> L89
        ...
        L83:
            com.facebook.soloader.k0 r4 = (com.facebook.soloader.k0) r4     // Catch: java.lang.Throwable -> L18
        ...
        L8b:
            r11 = move-exception
            if (r4 == 0) goto L98
            com.facebook.soloader.k0 r4 = (com.facebook.soloader.k0) r4     // Catch: java.lang.Throwable -> L94
        ...
        La7:
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.soloader.m0.l(byte, com.facebook.soloader.h0, com.facebook.soloader.j0):void");
    }
}
