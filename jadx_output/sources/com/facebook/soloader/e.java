...
public class e extends com.facebook.soloader.d0 {

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.Set f44019c = java.util.Collections.synchronizedSet(new java.util.HashSet());

    /* renamed from: a, reason: collision with root package name */
    public final java.lang.String f44020a;

    /* renamed from: b, reason: collision with root package name */
    public final java.io.File f44021b;

    public e(android.content.Context context) {
        java.lang.String str;
        java.lang.String a17 = com.facebook.soloader.a0.a();
        if (a17 != null) {
        ...
        str = null;
        this.f44020a = str;
        this.f44021b = new java.io.File(context.getApplicationInfo().sourceDir);
    }

    /* JADX WARN: Code restructure failed: missing block: B:18:0x004b, code lost:
    
        r5 = new com.facebook.soloader.i(r4, r6);
     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0052, code lost:
    
        if (com.facebook.soloader.c0.f44004a == false) goto L72;
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0054, code lost:
    
        com.facebook.soloader.a.a("SoLoader.getElfDependencies[", r13, "]");
     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x005b, code lost:
    
        r6 = com.facebook.soloader.w.a(r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x0072, code lost:
        ...
        com.facebook.soloader.c0.f(r9, null, null, r14 | 1, r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x0094, code lost:
        ...
        ((com.facebook.soloader.z) com.facebook.soloader.c0.f44005b).b(r1 + java.io.File.separator + r13, r14);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x0080, code lost:
        ...
        r14 = com.facebook.soloader.c0.f44004a;
     */
    ...
    */
    public int a(java.lang.String r13, int r14, android.os.StrictMode.ThreadPolicy r15) {
        /*
            ...
            if (r0 == 0) goto Lbf
            java.util.Set r0 = com.facebook.soloader.e.f44019c
            boolean r1 = r0.contains(r13)
            r2 = 0
            if (r1 == 0) goto Lbe
            java.lang.String r1 = r12.f44020a
        ...
        L24:
            ...
            boolean r6 = com.facebook.soloader.c0.f44004a     // Catch: java.lang.Throwable -> L83
            if (r6 == 0) goto L5b
            java.lang.String r6 = "SoLoader.getElfDependencies["
            java.lang.String r7 = "]"
            com.facebook.soloader.a.a(r6, r13, r7)     // Catch: java.lang.Throwable -> L83
        L5b:
            java.lang.String[] r6 = com.facebook.soloader.w.a(r5)     // Catch: java.lang.Throwable -> L7f
        ...
        L72:
            r10 = r14 | 1
            r11 = 0
            com.facebook.soloader.c0.f(r9, r11, r11, r10, r15)     // Catch: java.lang.Throwable -> L83
        L78:
            int r8 = r8 + 1
            goto L61
        L7b:
        ...
        L7f:
            r13 = move-exception
            boolean r14 = com.facebook.soloader.c0.f44004a     // Catch: java.lang.Throwable -> L83
        ...
        L8f:
            r4.close()
            r14 = r14 | 4
            com.facebook.soloader.y r15 = com.facebook.soloader.c0.f44005b     // Catch: java.lang.UnsatisfiedLinkError -> Lb1
            ...
            com.facebook.soloader.z r15 = (com.facebook.soloader.z) r15     // Catch: java.lang.UnsatisfiedLinkError -> Lb1
        ...
        Lbf:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.soloader.e.a(java.lang.String, int, android.os.StrictMode$ThreadPolicy):int");
    }
    ...
    public void b(int i17) {
        int indexOf;
        int i18;
        java.lang.String str = this.f44020a;
        ...
        java.util.zip.ZipFile zipFile = new java.util.zip.ZipFile(this.f44021b);
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (nextElement != null && nextElement.getName().startsWith(substring) && nextElement.getName().endsWith(".so") && nextElement.getMethod() == 0) {
                    f44019c.add(nextElement.getName().substring(substring.length() + 1));
                }
            }
            zipFile.close();
        } finally {
    ...
    public java.lang.String toString() {
        return com.facebook.soloader.e.class.getName() + "[root = " + this.f44020a + ']';
    }
}
