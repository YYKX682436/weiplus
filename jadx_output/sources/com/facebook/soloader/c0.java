...
public abstract class c0 {
    ...
    public static com.facebook.soloader.y f44005b;

    /* renamed from: f, reason: collision with root package name */
    public static com.facebook.soloader.m0[] f44009f;

    /* renamed from: g, reason: collision with root package name */
    public static com.facebook.soloader.d f44010g;

    /* renamed from: k, reason: collision with root package name */
    public static int f44014k;

    /* renamed from: c, reason: collision with root package name */
    public static final java.util.concurrent.locks.ReentrantReadWriteLock f44006c = new java.util.concurrent.locks.ReentrantReadWriteLock();

    /* renamed from: d, reason: collision with root package name */
    public static com.facebook.soloader.d0[] f44007d = null;

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.concurrent.atomic.AtomicInteger f44008e = new java.util.concurrent.atomic.AtomicInteger(0);

    /* renamed from: h, reason: collision with root package name */
    public static final java.util.HashSet f44011h = new java.util.HashSet();

    /* renamed from: i, reason: collision with root package name */
    public static final java.util.Map f44012i = new java.util.HashMap();

    /* renamed from: j, reason: collision with root package name */
    public static final java.util.Set f44013j = java.util.Collections.newSetFromMap(new java.util.concurrent.ConcurrentHashMap());

    /* renamed from: l, reason: collision with root package name */
    public static int f44015l = 0;

    /* renamed from: a, reason: collision with root package name */
    public static final boolean f44004a = true;

    public static void a(android.content.Context context, java.util.ArrayList arrayList, int i17) {
        if ((f44014k & 8) != 0) {
            f44009f = null;
            java.io.File i18 = com.facebook.soloader.m0.i(context, "lib-main");
            try {
                com.facebook.soloader.e0.a(i18);
                return;
        ...
        com.facebook.soloader.c cVar = new com.facebook.soloader.c(context, file, "lib-main", i17);
        arrayList2.add(cVar);
        cVar.toString();
        if (context.getApplicationInfo().splitSourceDirs != null) {
            ...
            int i27 = 0;
            while (i19 < length) {
                com.facebook.soloader.c cVar2 = new com.facebook.soloader.c(context, new java.io.File(strArr[i19]), "lib-" + i27, i17);
                cVar2.toString();
        ...
        f44009f = (com.facebook.soloader.m0[]) arrayList2.toArray(new com.facebook.soloader.m0[arrayList2.size()]);
    ...
    public static void b(java.lang.String str, int i17, android.os.StrictMode.ThreadPolicy threadPolicy) {
        ...
        com.facebook.soloader.m0[] m0VarArr;
        java.util.concurrent.locks.ReentrantReadWriteLock reentrantReadWriteLock2 = f44006c;
        ...
        try {
            ...
            try {
                ...
                while (i18 == 0) {
                    try {
                        com.facebook.soloader.d0[] d0VarArr = f44007d;
                        if (i19 < d0VarArr.length) {
                            i18 = d0VarArr[i19].a(str, i17, threadPolicy);
                            if (i18 != 3 || (m0VarArr = f44009f) == null) {
                                i19++;
                            } else {
                                for (com.facebook.soloader.m0 m0Var : m0VarArr) {
                                    synchronized (m0Var) {
            ...
            try {
                ...
                if (i18 == 0 || i18 == 3) {
                    ...
                    for (int i27 = 0; i27 < f44007d.length; i27++) {
                        sb6.append("\n\tSoSource ");
                        sb6.append(i27);
                        sb6.append(": ");
                        sb6.append(f44007d[i27].toString());
                    }
                    com.facebook.soloader.d dVar = f44010g;
                    if (dVar != null) {
                        try {
                            android.content.Context context = dVar.f44016a;
    ...
    */
    public static synchronized void c(com.facebook.soloader.y r11) {
        /*
            ...
            monitor-enter(r0)
            if (r11 != 0) goto Le
            com.facebook.soloader.y r1 = com.facebook.soloader.c0.f44005b     // Catch: java.lang.Throwable -> Lb
            if (r1 == 0) goto Le
            monitor-exit(r0)
            return
        Lb:
        ...
        Le:
            if (r11 == 0) goto L14
            com.facebook.soloader.c0.f44005b = r11     // Catch: java.lang.Throwable -> Lb
            monitor-exit(r0)
            return
        L14:
        ...
        L73:
            ...
            com.facebook.soloader.c0.f44005b = r7     // Catch: java.lang.Throwable -> Lb
            monitor-exit(r0)
            return
        L7e:
            monitor-exit(r0)
    ...
    public static void d(android.content.Context context, int i17, com.facebook.soloader.y yVar) {
        int i18;
        if (f44007d != null) {
            return;
        }
        java.util.concurrent.locks.ReentrantReadWriteLock reentrantReadWriteLock = f44006c;
        ...
        try {
            ...
            for (java.lang.String str2 : str.split(":")) {
                arrayList.add(new com.facebook.soloader.f(new java.io.File(str2), 2));
            }
            if (context != null) {
                if ((i17 & 1) != 0) {
                    f44009f = null;
                    arrayList.add(0, new com.facebook.soloader.n(context, "lib-main"));
                } else {
                    if (com.facebook.soloader.e0.d(context, f44015l)) {
                        com.facebook.soloader.e eVar = new com.facebook.soloader.e(context);
                        eVar.toString();
                        ...
                        com.facebook.soloader.d dVar = new com.facebook.soloader.d(context, i18);
                        f44010g = dVar;
                        dVar.toString();
                        arrayList.add(0, f44010g);
                    }
                    a(context, arrayList, 1);
                }
            }
            com.facebook.soloader.d0[] d0VarArr = (com.facebook.soloader.d0[]) arrayList.toArray(new com.facebook.soloader.d0[arrayList.size()]);
            reentrantReadWriteLock.writeLock().lock();
            int i27 = (f44014k & 2) != 0 ? 1 : 0;
            ...
            while (true) {
                ...
                if (length <= 0) {
                    f44007d = d0VarArr;
                    f44008e.getAndIncrement();
                    int length2 = f44007d.length;
                    return;
                } else {
    ...
    */
    ...
    public static boolean f(java.lang.String str, java.lang.String str2, java.lang.String str3, int i17, android.os.StrictMode.ThreadPolicy threadPolicy) {
        ...
        boolean z18 = false;
        if (!android.text.TextUtils.isEmpty(str2) && f44013j.contains(str2)) {
            return false;
        }
        synchronized (com.facebook.soloader.c0.class) {
            java.util.HashSet hashSet = f44011h;
                ...
                synchronized (obj) {
                            ...
                            synchronized (com.facebook.soloader.c0.class) {
                                ...
                                if (!z17) {
                                    try {
                                        ...
                                        throw new com.facebook.soloader.b0(e17, message.substring(message.lastIndexOf("unexpected e_machine:")));
                                    }
                                }
                            }
                        } catch (java.lang.Throwable th6) {
                    ...
                    if ((i17 & 16) == 0) {
                        ...
                        if (str3 != null && !z18) {
                            ...
                            try {
                                try {
                                    com.facebook.soloader.u.a(str2);
                                    throw null;
