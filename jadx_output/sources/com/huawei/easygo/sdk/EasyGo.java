...
public final class EasyGo {
    ...
    private com.huawei.easygo.manager.EasyGoManager mEasyGoManager;

    public EasyGo(android.content.Context context) {
        this.mEasyGoManager = null;
        if (getRomSupStatus(context) == 0) {
            this.mEasyGoManager = new com.huawei.easygo.manager.EasyGoManager(context);
        }
    }
    ...
    public java.util.List<java.lang.Integer> init(java.lang.String[] strArr) {
        com.huawei.easygo.manager.EasyGoManager easyGoManager = this.mEasyGoManager;
        return easyGoManager == null ? assembleInitFailRet(strArr) : easyGoManager.init(strArr);
    }

    public void invokeAsync(java.lang.String str, java.lang.String str2, org.json.JSONObject jSONObject, android.os.Bundle bundle, com.huawei.easygo.callback.IEasyGoCallback iEasyGoCallback) {
        com.huawei.easygo.manager.EasyGoManager easyGoManager = this.mEasyGoManager;
    ...
    public com.huawei.easygo.sdk.module.EasyGoRet invokeSync(java.lang.String str, java.lang.String str2, org.json.JSONObject jSONObject, android.os.Bundle bundle) {
        com.huawei.easygo.manager.EasyGoManager easyGoManager = this.mEasyGoManager;
        return easyGoManager == null ? new com.huawei.easygo.sdk.module.EasyGoRet(507, new android.os.Bundle()) : new com.huawei.easygo.sdk.module.EasyGoRet(easyGoManager.invokeSync(str, str2, jSONObject, bundle));
    }
