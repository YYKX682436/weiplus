...
public final class f {
    ...
    public static void f(r45.c2 c2Var, r45.b2 b2Var) {
        boolean isEmpty = c2Var.f371236d.isEmpty();
        java.util.LinkedList linkedList = c2Var.f371236d;
    ...
    public static nm5.b g(r45.c2 c2Var, java.lang.String str, int i17) {
        ...
        int size;
        if (!android.text.TextUtils.isEmpty(str) && c2Var != null && (size = (linkedList = c2Var.f371236d).size()) > 0) {
            int i18 = -1;
            int i19 = -1;
            for (int i27 = size - 1; i27 >= 0; i27--) {
                r45.vk6 vk6Var = (r45.vk6) linkedList.get(i27);
                int size2 = vk6Var.f388327e.size() - 1;
                while (true) {
                    if (size2 >= 0) {
                        r45.bn6 bn6Var = ((r45.b2) vk6Var.f388327e.get(size2)).f370434d;
                        java.lang.String str2 = bn6Var.f370900d;
                        int i28 = bn6Var.f370901e;
                        if (str.equals(str2)) {
                            i18 = i27;
                            i19 = size2;
                            break;
    ...
    public final boolean d(r45.c2 c2Var) {
        ...
        java.util.LinkedList linkedList = c2Var.f371236d;
        r45.vk6 vk6Var = !linkedList.isEmpty() ? (r45.vk6) linkedList.getLast() : null;
        return vk6Var != null && vk6Var.f388326d;
    }
    ...
    public final void e(r45.c2 c2Var, int i17, r45.b2 b2Var) {
        ...
        java.util.LinkedList linkedList2 = c2Var.f371236d;
        r45.vk6 vk6Var = (r45.vk6) linkedList2.getLast();
        int size = vk6Var.f388327e.size();
        if (i17 < 0 || i17 >= size) {
            return;
        }
        while (true) {
            size--;
            linkedList = vk6Var.f388327e;
            if (size < i17) {
                break;
            }
            r45.b2 b2Var2 = (r45.b2) linkedList.remove(size);
            f52.e eVar = this.f259632a;
            if (eVar != null) {
                b2Var2.f370434d.f370902f = b2Var.f370434d.f370902f;
