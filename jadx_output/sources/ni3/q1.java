...
public class q1 implements java.lang.Runnable {
    ...
    public final /* synthetic */ ni3.g2 f337703d;
    ...
    */
    public void run() {
        /*
            ...
            com.tencent.mm.storage.u3 r4 = com.tencent.mm.storage.u3.USERINFO_INSTALL_FIRST_CLIENT_VERSION_INT     // Catch: java.lang.Exception -> Lc2
            ...
            com.tencent.mm.storage.u3 r5 = com.tencent.mm.storage.u3.USERINFO_INSTALL_FIRST_TIME_LONG     // Catch: java.lang.Exception -> Lc2
            r6 = 0
            ...
            r6 = r18
            ni3.g2 r7 = r6.f337703d     // Catch: java.lang.Exception -> Lc0
            long r7 = ni3.g2.Ai(r7)     // Catch: java.lang.Exception -> Lc0
            r9 = 1
            if (r3 <= 0) goto L4f
            int r10 = o45.wf.f343029g     // Catch: java.lang.Exception -> Lc0
            if (r10 != r3) goto L4d
            goto L4f
        L4d:
            r10 = r2
        ...
        L50:
            ...
            int r3 = o45.wf.f343029g     // Catch: java.lang.Exception -> Lc0
            r11.append(r3)     // Catch: java.lang.Exception -> Lc0
            r11.append(r0)     // Catch: java.lang.Exception -> Lc0
            if (r10 == 0) goto L67
            r3 = r9
        ...
        L68:
            ...
            com.tencent.mm.plugin.report.service.g0 r3 = com.tencent.mm.plugin.report.service.g0.INSTANCE     // Catch: java.lang.Exception -> Lc0
            r11 = 418(0x1a2, double:2.065E-321)
            r13 = 1
            r15 = 1
            r17 = 1
            r10 = r3
            r10.idkeyStat(r11, r13, r15, r17)     // Catch: java.lang.Exception -> Lc0
            ...
            com.tencent.mars.xlog.Log.i(r1, r3, r0)     // Catch: java.lang.Exception -> Lc0
            goto Ld8
        Lc0:
            r0 = move-exception
            goto Lc5
