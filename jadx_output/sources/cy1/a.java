...
public class a extends i95.w implements dy1.r {
    ...
    public static java.lang.Integer f224683r;

    /* renamed from: f, reason: collision with root package name */
    public sy1.c f224686f;

    /* renamed from: p, reason: collision with root package name */
    public java.lang.ref.WeakReference f224693p;

    /* renamed from: d, reason: collision with root package name */
    public final java.lang.Boolean f224684d = java.lang.Boolean.TRUE;

    /* renamed from: e, reason: collision with root package name */
    public java.lang.Boolean f224685e = null;

    /* renamed from: g, reason: collision with root package name */
    public final java.util.Map f224687g = new java.util.HashMap();

    /* renamed from: h, reason: collision with root package name */
    public final java.util.Map f224688h = new java.util.concurrent.ConcurrentHashMap();

    /* renamed from: i, reason: collision with root package name */
    public final java.util.List f224689i = new java.util.ArrayList();

    /* renamed from: m, reason: collision with root package name */
    public final sy1.f f224690m = new sy1.f();

    /* renamed from: n, reason: collision with root package name */
    public int f224691n = 0;

    /* renamed from: o, reason: collision with root package name */
    public final java.util.Map f224692o = new java.util.HashMap();

    /* renamed from: q, reason: collision with root package name */
    public final ly1.b f224694q = new sy1.d();

    public static int Ri() {
        if (f224683r == null) {
            f224683r = java.lang.Integer.valueOf(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).Ni(e42.d0.clicfg_data_report_dynamic_params_storage_type, 0));
        }
        return f224683r.intValue();
    }
    ...
    */
    ...
    public boolean Bi(java.lang.String str) {
        if (!a.b.c().f44a || android.text.TextUtils.isEmpty(str)) {
            return false;
        }
        ry5.c f17 = ry5.c.f();
        f17.getClass();
        ...
        java.lang.String str2 = "[bindSessionId] isMainProcess ： " + a.b.c().f47d;
        if (xy5.b.f458162a != null) {
            com.tencent.mars.xlog.Log.i("enricwu.SentinelService", str2);
        }
        f17.f401703a = str;
        f17.f401704b.f401697c = str;
        f17.a(1);
        return true;
    }
        ...
        if (gz1.d.f277723p) {
            ...
            if (!arrayList.isEmpty()) {
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    dVar.s((androidx.fragment.app.Fragment) arrayList.get(size));
                }
            }
            dVar.u(fragment, false);
            dVar.s(fragment);
            dVar.d(fragment);
        }
    }
    ...
    public final void Di() {
        ...
        a.b c17 = a.b.c();
        c17.getClass();
        if (android.text.TextUtils.isEmpty(str) || c17.f48e == null) {
            return;
        }
        com.tencent.mm.sdk.platformtools.o4.M("mmkv_id_amoeba_default").putString("amoeba_distinct_id", str);
    }
    ...
    public void Dj(java.lang.String str, java.lang.Object obj, java.util.Map map, int i17, java.util.List list, boolean z17, boolean z18, boolean z19) {
        if (oj()) {
            ...
            ky1.b a17 = ky1.c.a();
            a17.f313487a = java.lang.System.currentTimeMillis();
            a17.f313488b = obj;
            a17.f313489c = str;
            a17.b(sz1.f.b(map));
            a17.c(arrayList);
    ...
    public void Fj(final ky1.c cVar) {
        if (cVar != null) {
            java.lang.String str = cVar.f313495c;
            if (u46.l.e(str) || !oj()) {
                return;
            }
            java.lang.Object obj = cVar.f313494b;
            java.lang.Object cj6 = cj(obj);
            if (cj6 != null) {
                obj = cj6;
            }
            long j17 = cVar.f313493a;
            ...
            final java.util.List list = cVar.f313497e;
            if (list == null) {
                list = ij(obj, str);
            }
            sz1.i.b(new java.lang.Runnable() { // from class: cy1.a$$a
                ...
                public final void run() {
                    ...
                    ky1.c cVar2 = cVar;
                    sb6.append(cVar2);
                    com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", sb6.toString());
                    boolean c18 = u46.l.c(cVar2.f313495c, "view_clk");
                    java.util.Map map = cVar2.f313496d;
                    ...
                    if (c18 && map != null) {
                        ...
                        if (obj2 == null || !(obj2 instanceof java.lang.String)) {
                            ...
                            fVar.f413853h = (java.lang.String) obj2;
                            fVar.f413854i = j18;
                        }
                    }
                    if (map != null) {
                        ((java.util.concurrent.ConcurrentHashMap) map).put("app_in_time", java.lang.Long.valueOf(fVar.f413857l));
                    }
                    bz1.a aVar2 = new bz1.a();
                    java.lang.String str2 = cVar2.f313495c;
                    aVar2.f36763a = str2;
                    yy1.b bVar = aVar.f224686f.f413837c;
                    if (bVar != null) {
                        hz1.a aVar3 = c17;
                        java.util.List list2 = b17;
                        if (aVar3 == null && cVar2.f313498f) {
                            aVar2.a(((yy1.a) bVar).a(list2, ry1.b.a(str2, ry1.b.c(fVar.f413847b)), map, str2));
                        } else if (m17) {
    ...
    public void Ij(long j17, java.lang.String str, java.util.Map map) {
        if (oj()) {
            ...
            a17.f313489c = str;
            a17.b(map);
            a17.c((java.util.List) ((java.util.concurrent.ConcurrentHashMap) this.f224688h).get(str));
            Jj(a17.a());
        }
    }
    ...
    public void Jj(ky1.c cVar) {
        ...
        com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", "[reportStandardEvent] eventData : " + cVar);
        bz1.a aVar = new bz1.a();
        java.lang.String str = cVar.f313495c;
        aVar.f36763a = str;
        boolean c17 = u46.l.c(str, "cgi_req");
        java.util.Map map = cVar.f313496d;
        if (c17 || u46.l.c(str, "cgi_resp")) {
            yy1.b bVar = this.f224686f.f413837c;
            if (bVar != null) {
                aVar.a(((yy1.a) bVar).a(null, ry1.b.a(str, ry1.b.c(this.f224690m.f413847b)), map, str));
            }
        } else {
            aVar.a(map);
        }
        nj(cVar.f313493a, aVar, cVar.f313497e);
    }
    ...
    */
    ...
    public dy1.r Mj(java.lang.Object obj) {
        ...
        if (obj != null && oj()) {
            ...
            if (sz1.a.n(obj)) {
                ...
                ((java.util.concurrent.ConcurrentHashMap) h17.f441416a).clear();
                ((java.util.concurrent.ConcurrentHashMap) h17.f441417b).clear();
                ((java.util.concurrent.CopyOnWriteArrayList) h17.f441418c).clear();
                ((java.util.concurrent.ConcurrentHashMap) h17.f441419d).clear();
                ((java.util.concurrent.ConcurrentHashMap) h17.f441420e).clear();
                ((java.util.concurrent.ConcurrentHashMap) h17.f441421f).clear();
            }
        }
        return this;
    }
    ...
    public void Ni(final int i17) {
        cz1.b bVar = cz1.a.a().f224978d;
        if (bVar instanceof com.tencent.mm.plugin.datareport.monitor.adapter.page.a) {
            final com.tencent.mm.plugin.datareport.monitor.adapter.page.a aVar = (com.tencent.mm.plugin.datareport.monitor.adapter.page.a) bVar;
            if (i17 == 2) {
                aVar.t(null);
            } else {
                aVar.getClass();
                sz1.i.b(new java.lang.Runnable() { // from class: com.tencent.mm.plugin.datareport.monitor.adapter.page.a$$h
                    @Override // java.lang.Runnable
                    public final void run() {
                        com.tencent.mm.plugin.datareport.monitor.adapter.page.a.this.f96752x = i17;
                    }
                });
            }
        }
    ...
    public dy1.r Nj(java.lang.Object obj) {
        if (obj != null && oj()) {
            ...
            if (!sz1.a.m(obj)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[resetSessionParams] target is not a page!!!");
                return this;
            }
            hz1.a aVar = new hz1.a(obj);
            java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) this.f224690m.f413864s;
    ...
    public void Qj(long j17, java.lang.String str, java.util.Map map, java.util.List list, boolean z17) {
        ...
        com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", "[routeEvent] eventId : " + str + ", params : " + map + ", routeRules : " + list + ", isRtReport : " + z17);
        java.util.Iterator it = list.iterator();
        while (it.hasNext()) {
            java.lang.Integer num = (java.lang.Integer) it.next();
            if (num.intValue() > 0) {
                ...
                dVar.f313500b = num.intValue();
                dVar.f313501c = z17;
                synchronized (this.f224689i) {
                    java.util.Iterator it6 = ((java.util.ArrayList) this.f224689i).iterator();
                    while (it6.hasNext()) {
                        gy1.a aVar = (gy1.a) it6.next();
                        if (aVar.b() == dVar.f313499a && aVar.a(j17, str, map, dVar)) {
                            break;
                        }
                    }
                }
    ...
    public dy1.r Rj(java.lang.Object obj, iy1.a aVar) {
        ...
        if (obj != null && aVar != null && oj()) {
            ...
            int i17 = aVar.f295747d;
            if (!m17) {
                java.util.Map map = uy1.b.f431914a;
    ...
    public dy1.r Sj(java.lang.Object obj, java.lang.String str, java.lang.Object obj2) {
        ...
        if (obj != null && !u46.l.e(str) && obj2 != null && oj()) {
            ...
            if (!sz1.a.m(obj)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setBizParam] target is not a page!!!");
                return this;
            }
            hz1.a aVar = new hz1.a(obj);
            sy1.f fVar = this.f224690m;
            fVar.getClass();
            if (!u46.l.e(str)) {
    ...
    public void Uj(java.lang.String str) {
        com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", "[setEnterMethod] enterMethod : " + str);
        this.f224690m.f413856k = str;
    }
    ...
    public long Vi(java.lang.Object obj, java.lang.String str) {
        ...
        if (sz1.a.n(obj)) {
            int i17 = uy1.a.f431907a;
            if (u46.l.e(str) || (l17 = uy1.a.l(obj, false)) == null || (obj4 = ((java.util.concurrent.ConcurrentHashMap) l17.f441453k).get(str)) == null || !(obj4 instanceof java.lang.Long)) {
                return 0L;
            }
            return ((java.lang.Long) obj4).longValue();
        }
        if (sz1.a.m(obj)) {
            int i18 = uy1.a.f431907a;
            if (u46.l.e(str) || (j17 = uy1.a.j(obj, false)) == null || (obj3 = ((java.util.concurrent.ConcurrentHashMap) j17.f441435n).get(str)) == null || !(obj3 instanceof java.lang.Long)) {
                return 0L;
            }
            return ((java.lang.Long) obj3).longValue();
        }
        if (sz1.a.i(obj)) {
            int i19 = uy1.a.f431907a;
            if (u46.l.e(str) || (h17 = uy1.a.h(obj, false)) == null || (obj2 = ((java.util.concurrent.ConcurrentHashMap) h17.f441421f).get(str)) == null || !(obj2 instanceof java.lang.Long)) {
                return 0L;
            }
            return ((java.lang.Long) obj2).longValue();
        }
        if (!sz1.a.j()) {
            com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[getLastReportTime] param target is not a right type, please cheak!!!");
            return 0L;
        }
    ...
    */
    ...
    public dy1.r Wj(java.lang.Object obj, java.lang.String str, java.lang.String str2, java.lang.Object obj2) {
        ...
        if (sz1.a.n(obj)) {
            ...
            if (l17 == null || (map3 = l17.f441446d) == null) {
                return this;
            }
            ...
            if (j17 == null || (map2 = j17.f441429h) == null) {
                return this;
            }
            ...
            if (h17 == null || (map = h17.f441417b) == null) {
                return this;
            }
            ...
            com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setEventParam] param target is not a right type, please cheak!!!");
        }
        return this;
    }
    ...
    public dy1.r Xj(java.lang.Object obj, java.lang.String str, java.util.Map map) {
        ...
        if (sz1.a.n(obj)) {
            vy1.c l17 = uy1.a.l(obj, true);
            if (l17 == null || (map4 = l17.f441446d) == null) {
                return this;
            }
            ...
            vy1.b j17 = uy1.a.j(obj, true);
            if (j17 == null || (map3 = j17.f441429h) == null) {
                return this;
            }
            ...
            vy1.a h17 = uy1.a.h(obj, true);
            if (h17 == null || (map2 = h17.f441417b) == null) {
                return this;
            }
            ...
            com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setEventParams] param target is not a right type, please cheak!!!");
        }
        return this;
    }
    ...
    public void Yj(java.lang.Object obj, java.lang.String str, long j17) {
        ...
        if (sz1.a.m(obj)) {
            ...
            ((java.util.concurrent.ConcurrentHashMap) j18.f441435n).put(str, java.lang.Long.valueOf(j17));
            return;
        }
        if (sz1.a.i(obj)) {
            int i18 = uy1.a.f431907a;
            ...
            ((java.util.concurrent.ConcurrentHashMap) h17.f441421f).put(str, java.lang.Long.valueOf(j17));
            return;
        }
        if (!sz1.a.j()) {
            com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setLastReportTime] param target is not a right type, please cheak!!!");
            return;
        }
    ...
    public java.util.Map bj(java.lang.Object obj) {
        ...
        if (sz1.a.n(obj)) {
            vy1.c l17 = uy1.a.l(obj, false);
            if (l17 == null || (map = l17.f441445c) == null) {
                return null;
            }
            return map;
        }
    ...
    public dy1.r bk(java.lang.Object obj, boolean z17) {
        if (obj != null && oj()) {
            if (!sz1.a.m(obj)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setPageIsFilterFlag] target is not a page!!!");
                return this;
            }
            java.lang.Boolean valueOf = java.lang.Boolean.valueOf(z17);
            vy1.b j17 = uy1.a.j(obj, true);
            if (j17 != null && !u46.l.e("page_is_filter")) {
                ((java.util.concurrent.ConcurrentHashMap) j17.f441432k).put("page_is_filter", valueOf);
            }
        }
        return this;
    }
    ...
    public java.lang.Object cj(java.lang.Object obj) {
        ...
        if (obj == null || (weakReference = (java.lang.ref.WeakReference) ((java.util.WeakHashMap) uy1.b.f431916c).get(obj)) == null || weakReference.get() == null) {
            return null;
        }
    ...
    public dy1.r ck(java.lang.Object obj, boolean z17) {
        if (obj != null && oj()) {
            if (!sz1.a.m(obj)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setPageIsFullSubPage] target is not a page!!!");
                return this;
            }
            java.lang.Boolean valueOf = java.lang.Boolean.valueOf(z17);
            vy1.b j17 = uy1.a.j(obj, true);
            if (j17 != null && !u46.l.e("page_is_full_subpage")) {
                ((java.util.concurrent.ConcurrentHashMap) j17.f441432k).put("page_is_full_subpage", valueOf);
            }
        }
        return this;
    }
    ...
    public long fj(java.lang.Object obj, java.lang.String str) {
        ...
        if (sz1.a.n(obj)) {
            int i17 = uy1.a.f431907a;
            if (u46.l.e(str) || (l17 = uy1.a.l(obj, false)) == null || (obj4 = ((java.util.concurrent.ConcurrentHashMap) l17.f441452j).get(str)) == null || !(obj4 instanceof java.lang.Long)) {
                return 0L;
            }
            return ((java.lang.Long) obj4).longValue();
        }
        if (sz1.a.m(obj)) {
            int i18 = uy1.a.f431907a;
            if (u46.l.e(str) || (j17 = uy1.a.j(obj, false)) == null || (obj3 = ((java.util.concurrent.ConcurrentHashMap) j17.f441434m).get(str)) == null || !(obj3 instanceof java.lang.Long)) {
                return 0L;
            }
            return ((java.lang.Long) obj3).longValue();
        }
        if (sz1.a.i(obj)) {
            int i19 = uy1.a.f431907a;
            if (u46.l.e(str) || (h17 = uy1.a.h(obj, false)) == null || (obj2 = ((java.util.concurrent.ConcurrentHashMap) h17.f441420e).get(str)) == null || !(obj2 instanceof java.lang.Long)) {
                return 0L;
            }
            return ((java.lang.Long) obj2).longValue();
        }
        if (!sz1.a.j()) {
            com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[getReportInterval] param target is not a right type, please cheak!!!");
            return 0L;
        }
        ...
        if (obj != null && !u46.l.e(str) && obj2 != null && oj()) {
            if (!sz1.a.m(obj) && !sz1.a.n(obj) && !sz1.a.i(obj)) {
                ...
                if (!u46.l.e(str) && !u46.l.e(str)) {
                    ...
                    if (b17 != null) {
                        ((java.util.concurrent.ConcurrentHashMap) b17.f441445c).put(str, obj2);
                    }
                    vy1.b a17 = uy1.b.a(obj, true);
                    if (a17 != null) {
                        ((java.util.concurrent.ConcurrentHashMap) a17.f441426e).put(str, obj2);
                    }
                }
            }
            java.lang.Object cj6 = cj(obj);
            ...
            if (sz1.a.n(obj)) {
                ...
                if (l17 != null && !u46.l.e(str)) {
                    ((java.util.concurrent.ConcurrentHashMap) l17.f441445c).put(str, obj2);
                }
            } else if (sz1.a.m(obj)) {
                vy1.b j17 = uy1.a.j(obj, true);
                if (j17 != null && !u46.l.e(str)) {
                    ((java.util.concurrent.ConcurrentHashMap) j17.f441426e).put(str, obj2);
                }
            } else if (sz1.a.i(obj)) {
                int i17 = uy1.a.f431907a;
                if (!u46.l.e(str) && (h17 = uy1.a.h(obj, true)) != null) {
                    ((java.util.concurrent.ConcurrentHashMap) h17.f441416a).put(str, obj2);
                }
            }
        }
        return this;
    ...
    public dy1.r gk(java.lang.Object obj, java.util.Map map) {
        ...
        if (obj != null && map != null && map.size() > 0 && oj()) {
            if (!sz1.a.m(obj) && !sz1.a.n(obj) && !sz1.a.i(obj)) {
                java.util.Map map2 = uy1.b.f431914a;
                if (map.size() > 0) {
                    vy1.c b17 = uy1.b.b(obj, true);
                    if (b17 != null) {
                        for (java.lang.String str : map.keySet()) {
                            if (!u46.l.e(str) && (obj3 = map.get(str)) != null) {
                                ((java.util.concurrent.ConcurrentHashMap) b17.f441445c).put(str, obj3);
                            }
                        }
                    }
                    vy1.b a17 = uy1.b.a(obj, true);
                    if (a17 != null) {
                        for (java.lang.String str2 : map.keySet()) {
                            if (!u46.l.e(str2) && (obj2 = map.get(str2)) != null) {
                                ((java.util.concurrent.ConcurrentHashMap) a17.f441426e).put(str2, obj2);
                            }
                        }
                    }
                }
            ...
            if (sz1.a.n(obj)) {
                vy1.c l17 = uy1.a.l(obj, true);
                if (l17 != null) {
                    java.util.Map map3 = l17.f441445c;
                    if (map.size() <= 0) {
                ...
                if (map.size() > 0 && (h17 = uy1.a.h(obj, true)) != null) {
                    ((java.util.concurrent.ConcurrentHashMap) h17.f441416a).putAll(map);
                }
            }
        }
        return this;
    ...
    public int hj(java.lang.Object obj) {
        ...
        if (sz1.a.m(obj)) {
            vy1.b j17 = uy1.a.j(obj, false);
            if (j17 != null) {
                java.util.Iterator it = ((java.util.concurrent.ConcurrentHashMap) j17.f441433l).keySet().iterator();
                while (it.hasNext()) {
        ...
        if (sz1.a.i(obj)) {
            vy1.a h17 = uy1.a.h(obj, false);
            if (h17 != null) {
                java.util.Iterator it6 = ((java.util.concurrent.ConcurrentHashMap) h17.f441419d).keySet().iterator();
                while (it6.hasNext()) {
        ...
        vy1.c b17 = uy1.b.b(obj, false);
        if (b17 != null) {
            java.util.Iterator it7 = ((java.util.concurrent.ConcurrentHashMap) b17.f441451i).keySet().iterator();
            while (it7.hasNext()) {
            ...
            vy1.b a17 = uy1.b.a(obj, false);
            if (a17 != null) {
                java.util.Iterator it8 = ((java.util.concurrent.ConcurrentHashMap) a17.f441433l).keySet().iterator();
                while (it8.hasNext()) {
    ...
    public dy1.r hk(java.lang.String str, java.lang.Object obj) {
        ...
        synchronized (this.f224687g) {
            ((java.util.HashMap) this.f224687g).put(str, obj);
        }
        return this;
    }
    ...
    */
                ...
                if (b18 != null && (e18 = sz1.g.e(i17)) != null) {
                    ...
                    if (arrayList.size() > 0) {
                        ...
                        while (it.hasNext()) {
                            ...
                            java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) b18.f441451i;
                            ...
                            while (true) {
                                ...
                                if (dVar.f313499a == i18 && dVar.f313500b == i19 && dVar.f313501c == z17 && dVar.f313502d == z18) {
                                    z29 = true;
                                    break;
                                }
                            }
                ...
                if (a17 != null && (b17 = sz1.g.b(i17)) != null) {
                    ...
                    if (arrayList2.size() > 0) {
                        ...
                        while (it7.hasNext()) {
                            ...
                            java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = (java.util.concurrent.ConcurrentHashMap) a17.f441433l;
                            ...
                            while (true) {
                                ...
                                if (dVar3.f313500b == i19 && dVar3.f313501c == z17) {
                                    z28 = true;
                                    break;
                                }
                            }
            ...
            if (sz1.a.n(obj2)) {
                ...
                if (l17 != null && (e17 = sz1.g.e(i17)) != null) {
                    ...
                    if (arrayList3.size() > 0) {
                        ...
                        while (it9.hasNext()) {
                            ...
                            java.util.concurrent.ConcurrentHashMap concurrentHashMap3 = (java.util.concurrent.ConcurrentHashMap) l17.f441451i;
                            ...
                            while (true) {
                                ...
                                if (dVar5.f313499a == i18 && dVar5.f313500b == i19 && dVar5.f313501c == z17 && dVar5.f313502d == z18) {
                                    z27 = true;
                                    break;
                                }
                            }
                ...
                if (arrayList4.size() > 0) {
                    ...
                    while (it11.hasNext()) {
                        ...
                        java.util.concurrent.ConcurrentHashMap concurrentHashMap4 = (java.util.concurrent.ConcurrentHashMap) h17.f441419d;
                        ...
                        while (true) {
                            ...
                            if (dVar7.f313499a == i18 && dVar7.f313500b == i19 && dVar7.f313501c == z17 && dVar7.f313502d == z18) {
                                z19 = true;
                                break;
                            }
                        }
    ...
    public dy1.r lk(java.lang.Object obj, java.lang.String str, java.lang.Object obj2) {
        ...
        if (obj != null && !u46.l.e(str) && obj2 != null && oj()) {
            ...
            if (!sz1.a.m(obj)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setSessionParam] target is not a page!!!");
                return this;
            }
            hz1.a aVar = new hz1.a(obj);
            sy1.f fVar = this.f224690m;
            fVar.getClass();
            if (!u46.l.e(str)) {
                java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = (java.util.concurrent.ConcurrentHashMap) fVar.f413864s;
                java.util.Iterator it = concurrentHashMap2.keySet().iterator();
                while (true) {
                    if (!it.hasNext()) {
                        concurrentHashMap = null;
    ...
    public dy1.r mk(java.lang.Object obj, java.util.Map map) {
        if (obj != null && map != null && map.size() > 0 && oj()) {
            ...
            if (!sz1.a.m(obj)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setSessionParams] target is not a page!!!");
                return this;
            }
            this.f224690m.g(new hz1.a(obj), map);
        }
        return this;
    }
    ...
    public final void nj(long j17, bz1.a aVar, java.util.List list) {
        ...
        com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", "[handleReportData] reportData : " + aVar + ", routeRules : " + list);
        java.util.HashMap hashMap2 = new java.util.HashMap();
        java.util.HashMap hashMap3 = new java.util.HashMap();
        synchronized (this.f224687g) {
            for (java.lang.String str : ((java.util.HashMap) this.f224687g).keySet()) {
                hashMap3.put(str, ((java.util.HashMap) this.f224687g).get(str));
            }
        }
        if (hashMap3.size() > 0) {
        ...
        wi(aVar.f36763a, hashMap4);
        this.f224690m.f413855j = aVar.f36763a;
        java.util.Map map = aVar.f36764b;
        if (map != null && ((java.util.HashMap) map).size() > 0) {
            hashMap4.putAll(map);
        }
        ly1.b bVar = this.f224686f.f413836b;
        if (bVar != null) {
            ((sy1.d) bVar).a(hashMap2);
        }
        java.lang.String str2 = aVar.f36763a;
        if (!u46.l.e(str2)) {
            hashMap2.put("report_seq", java.lang.Integer.valueOf(this.f224691n));
            this.f224691n++;
            java.util.HashMap hashMap5 = (java.util.HashMap) this.f224692o;
        ...
        if (this.f224686f.f413837c != null) {
            if (u46.l.e(aVar.f36763a)) {
                hashMap = null;
            } else {
            ...
            while (it.hasNext()) {
                ...
                synchronized (this.f224689i) {
                    ...
                    while (it6.hasNext()) {
                        ...
                        if (aVar2.b() == dVar.f313499a && aVar2.a(j17, aVar.f36763a, hashMap, dVar)) {
                            break;
                        }
                    }
                }
                java.lang.String str3 = aVar.f36763a;
                int i17 = dVar.f313499a;
                int i18 = dVar.f313500b;
                if (a.b.c().f44a) {
        ...
        if (obj != null && d17 > 0.0d && d17 <= 1.0d && oj()) {
            if (!sz1.a.n(obj)) {
                ...
                if (d17 > 0.0d && d17 <= 1.0d && (b17 = uy1.b.b(obj, true)) != null) {
                    ((java.util.concurrent.ConcurrentHashMap) b17.f441450h).put("view_exp_min_rate", java.lang.Double.valueOf(d17));
                }
            }
            java.lang.Object cj6 = cj(obj);
            if (cj6 != null) {
    ...
    public boolean oj() {
        if (!this.f224684d.booleanValue()) {
            return false;
        }
        if (this.f224685e == null) {
            this.f224685e = java.lang.Boolean.valueOf(((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.c0.clicfg_data_report_cloud_switch, true));
            com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", "[isOpenSwitch] cloudSwitch : " + this.f224685e);
        }
        return this.f224685e.booleanValue();
    }
        ...
        if (obj != null && j17 > 0 && oj()) {
            if (!sz1.a.n(obj)) {
                ...
                if (j17 > 0 && (b17 = uy1.b.b(obj, true)) != null) {
                    ((java.util.concurrent.ConcurrentHashMap) b17.f441450h).put("view_exp_min_time", java.lang.Long.valueOf(j17));
                }
            }
            java.lang.Object cj6 = cj(obj);
            if (cj6 != null) {
    ...
    public void onCreate(android.content.Context context) {
        if (oj()) {
            ...
            if (nz1.a.f341542c == null) {
                synchronized (nz1.a.class) {
                    if (nz1.a.f341542c == null) {
                        nz1.a.f341542c = new nz1.a();
                    }
                }
            }
            nz1.a aVar = nz1.a.f341542c;
            aVar.getClass();
            xj0.a.h().f454773a = aVar;
            nz1.a.f341541b = true;
            oz1.d c17 = oz1.d.c();
            c17.getClass();
            ...
            cz1.b bVar2 = a17.f224978d;
            if (bVar2 != null) {
                ((com.tencent.mm.plugin.datareport.monitor.adapter.page.a) bVar2).f96743o = bVar;
            }
            cz1.b bVar3 = a17.f224979e;
            if (bVar3 != null) {
                ((iz1.a) bVar3).f296045i = bVar;
            }
            cz1.b bVar4 = a17.f224980f;
            if (bVar4 != null) {
                ((fz1.a) bVar4).f267287d = bVar;
            }
            cz1.a a18 = cz1.a.a();
            cz1.b bVar5 = a18.f224978d;
            if (bVar5 != null) {
                com.tencent.mm.plugin.datareport.monitor.adapter.page.a aVar2 = (com.tencent.mm.plugin.datareport.monitor.adapter.page.a) bVar5;
                com.tencent.mars.xlog.Log.i("Amoeba.PageEventMonitor", "[startMonitor]");
                mz1.b.b().a(aVar2);
                rk5.b.f397141d.c(dVar);
                gz1.d.f277723p = true;
                if (nz1.a.f341542c == null) {
                    synchronized (nz1.a.class) {
                        if (nz1.a.f341542c == null) {
                ...
                nz1.a.f341542c.getClass();
                java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList = (java.util.concurrent.CopyOnWriteArrayList) nz1.a.f341540a;
                if (!copyOnWriteArrayList.contains(dVar)) {
                    copyOnWriteArrayList.add(dVar);
                }
                xj0.a.h().l(gz1.d.f277720m, gz1.d.f277727t);
                dVar.t(aVar2);
                ((a52.f) ((e42.k0) gm0.j1.s(e42.k0.class))).b(aVar2);
                ez1.g.f257841m = h62.d.vj().Ni(e42.c0.clicfg_data_report_app_event_monitor_type, 0);
                com.tencent.mars.xlog.Log.i("Amoeba.AppEventMonitor", "[startMonitor] mAppEventMonitorType : " + ez1.g.f257841m);
                mz1.b.b().a(gVar);
                ez1.g.f257854z.alive();
                sz1.i.d(ez1.f.f257839d, 300L);
                android.content.IntentFilter intentFilter = new android.content.IntentFilter();
                intentFilter.addAction("android.intent.action.SCREEN_ON");
                intentFilter.addAction("android.intent.action.SCREEN_OFF");
                com.tencent.mm.sdk.platformtools.x2.f193071a.registerReceiver(ez1.g.f257853y, intentFilter);
                gVar.P(aVar2);
                aVar2.C.alive();
                aVar2.B.alive();
            }
            cz1.b bVar6 = a18.f224979e;
            if (bVar6 != null) {
                iz1.a aVar3 = (iz1.a) bVar6;
                com.tencent.mars.xlog.Log.i("Amoeba.ViewEventMonitor", "[startMonitor]");
                ...
                ((java.util.ArrayList) jz1.e.Di().f302651u).add(aVar3);
                kz1.e Bi = kz1.e.Bi();
                Bi.getClass();
                if (kz1.e.Di()) {
                    xj0.a.h().l(kz1.e.f313838o, Bi.f313848n);
                }
                kz1.e Bi2 = kz1.e.Bi();
                Bi2.getClass();
                if (kz1.e.Di()) {
                    ((java.util.ArrayList) Bi2.f313842e).add(aVar3);
                }
            }
            cz1.b bVar7 = a18.f224980f;
            if (bVar7 != null) {
                fz1.a aVar4 = (fz1.a) bVar7;
                com.tencent.mars.xlog.Log.i("Amoeba.MultiEventMonitor", "[startMonitor]");
            ...
            ((java.util.ArrayList) bVar8.f413832a).add(new qz1.c());
            ((java.util.ArrayList) bVar8.f413832a).add(new qz1.a());
            ((java.util.ArrayList) bVar8.f413832a).add(new qz1.b());
            bVar8.f413833b = this.f224694q;
            bVar8.f413834c = new yy1.a();
            sy1.c cVar = new sy1.c(bVar8, null);
            this.f224686f = cVar;
            java.util.List list2 = cVar.f413835a;
            if (list2 != null && ((java.util.ArrayList) list2).size() > 0) {
                synchronized (this.f224689i) {
                    ((java.util.ArrayList) this.f224689i).addAll(list2);
                }
            }
            hk("sdk_version", "3.1.1");
            hk("process_id", java.lang.Integer.valueOf(android.os.Process.myPid()));
            hk("process_name", ((km0.c) gm0.j1.p().a()).f308987a);
            hk(com.tencent.thumbplayer.core.downloadproxy.api.TPDownloadProxyEnum.USER_DEVICE_ID, wo.w0.c());
            a.b.c().f44a = sz1.a.j();
            a.b.c().f49f = new my1.c();
            a.b.c().f48e = new my1.b();
            xy5.b.f458162a = new my1.a();
            a.b.c().f50g = new my1.j();
            ...
            if (context == null) {
                ...
                a19.getClass();
                java.util.concurrent.CopyOnWriteArrayList copyOnWriteArrayList2 = q5.b.f360134d;
                if (!copyOnWriteArrayList2.contains(aVar5)) {
                    copyOnWriteArrayList2.add(aVar5);
                }
                if (c18.f48e != null && n17) {
                    com.tencent.mm.sdk.platformtools.o4.M("mmkv_id_amoeba_default").putString("sentinel_main_start", "");
                }
            }
            if (com.tencent.mm.sdk.platformtools.x2.n() && sz1.a.j()) {
                Di();
            }
        }
    }
    ...
    public boolean pj(org.json.JSONObject jSONObject) {
        ...
        if (optString2.length() > 0) {
            linkedHashMap.putAll(my1.r.f332716a.a(new org.json.JSONObject(optString2)));
        }
    ...
    public dy1.r qk(android.view.View view, android.view.View view2) {
        if (view != null && view2 != null && oj()) {
            if (!sz1.a.n(view)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setViewLogicParent] target is not a view!!!");
                return this;
            }
            vy1.c l17 = uy1.a.l(view, true);
            if (l17 != null) {
                l17.f441447e = new java.lang.ref.WeakReference(view2);
            }
        }
        return this;
    }
        ...
        if (view != null && oj()) {
            if (this.f224693p == null) {
                try {
                    ...
                    androidx.fragment.app.FragmentActivity fragmentActivity = (androidx.fragment.app.FragmentActivity) declaredMethod.invoke(null, new java.lang.Object[0]);
                    if (fragmentActivity != null) {
                        this.f224693p = new java.lang.ref.WeakReference(fragmentActivity.getWindow());
                    }
                } catch (java.lang.Exception unused) {
                }
            }
            java.lang.ref.WeakReference weakReference = this.f224693p;
            if (weakReference != null && weakReference.get() != null) {
                qk(view, ((android.view.Window) this.f224693p.get()).getDecorView());
            }
        }
        return this;
    }
    ...
    public boolean sj(int i17, java.util.Map map, int i18) {
        ...
        if (com.tencent.mm.sdk.platformtools.v8.a(com.tencent.mm.sdk.platformtools.z.f193112h)) {
            map.put("uin_alpha", 1);
            z17 = true;
        }
    ...
    public void tj(final java.lang.String str, final gy1.d dVar) {
        ...
        com.tencent.mars.xlog.Log.i("Amoeba.DataReportService", "[obtainAllCommonInfo]");
        sz1.i.b(new java.lang.Runnable() { // from class: cy1.a$$g
            ...
            public final void run() {
                ...
                ry1.a a17 = ry1.b.a(str2, ry1.b.c(aVar.f224690m.f413847b));
                if (a17 != null && (map = a17.f401363b) != null && ((java.util.HashMap) map).size() > 0) {
    ...
    public dy1.r tk(android.view.View view, java.lang.String str) {
        if (view != null && !u46.l.e(str) && oj()) {
            if (!sz1.a.n(view)) {
                com.tencent.mars.xlog.Log.e("Amoeba.DataReportService", "[setViewUniqueId] target is not a view!!!");
                return this;
            }
            vy1.c l17 = uy1.a.l(view, true);
            if (l17 != null) {
    ...
    public void uj(java.lang.String str, int i17, int i18, int i19) {
        cz1.b bVar = cz1.a.a().f224978d;
        if (bVar instanceof com.tencent.mm.plugin.datareport.monitor.adapter.page.a) {
            ((com.tencent.mm.plugin.datareport.monitor.adapter.page.a) bVar).a0(java.lang.System.currentTimeMillis(), str, i17, i18, i19, 0);
        }
    }
    ...
    public void vj(java.lang.String str, int i17, int i18, int i19) {
        cz1.b bVar = cz1.a.a().f224978d;
        if (bVar instanceof com.tencent.mm.plugin.datareport.monitor.adapter.page.a) {
            ((com.tencent.mm.plugin.datareport.monitor.adapter.page.a) bVar).b0(java.lang.System.currentTimeMillis(), str, i17, i18, i19, 0);
        }
    }
    ...
    public void vk() {
        ...
        cz1.b bVar = cz1.a.a().f224978d;
        if (!(bVar instanceof com.tencent.mm.plugin.datareport.monitor.adapter.page.a) || (weakReference = this.f224693p) == null || (window = (android.view.Window) weakReference.get()) == null || !(window.getContext() instanceof android.app.Activity)) {
            return;
        }
        ((lz1.b) ((com.tencent.mm.plugin.datareport.monitor.adapter.page.a) bVar).f96743o).c(java.lang.System.currentTimeMillis(), false);
    }
    ...
    public void w8(androidx.fragment.app.Fragment fragment) {
        ...
        gz1.d.f277714d.q(fragment, false);
    }
    ...
    public void wi(java.lang.String str, java.util.Map map) {
        ...
        fVar.getClass();
        java.util.HashMap hashMap = new java.util.HashMap();
        java.util.concurrent.ConcurrentHashMap concurrentHashMap = (java.util.concurrent.ConcurrentHashMap) fVar.f413866u;
        java.util.Iterator it = concurrentHashMap.keySet().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
        ...
        fVar.getClass();
        java.util.HashMap hashMap2 = new java.util.HashMap();
        for (hz1.a aVar2 : ((java.util.concurrent.ConcurrentHashMap) fVar.f413861p).keySet()) {
            java.util.concurrent.ConcurrentHashMap concurrentHashMap2 = (java.util.concurrent.ConcurrentHashMap) fVar.f413864s;
        ...
        java.lang.String str3 = fVar.f413853h;
        if (!u46.l.e(str3)) {
            map.put("last_click_view_id", str3);
        }
        java.lang.String str4 = fVar.f413855j;
        if (!u46.l.e(str4)) {
            map.put("last_report_event_id", str4);
        }
        java.lang.String str5 = fVar.f413851f;
        if (!u46.l.e(str5)) {
            map.put("biz_id", str5);
        }
        java.lang.StringBuilder sb7 = new java.lang.StringBuilder();
        java.util.Iterator it7 = ((java.util.HashMap) fVar.f413858m).keySet().iterator();
        while (it7.hasNext()) {
        ...
        java.lang.String str6 = fVar.f413852g;
        if (u46.l.e(str6)) {
            return;
        }
        ...
        if (obj != null && !u46.l.e(str) && oj()) {
            if (!sz1.a.m(obj) && !sz1.a.n(obj) && !sz1.a.i(obj)) {
                ...
                if (!u46.l.e(str)) {
                    vy1.c b17 = uy1.b.b(obj, false);
                    if (b17 != null) {
                        ((java.util.concurrent.ConcurrentHashMap) b17.f441445c).remove(str);
                    }
                    vy1.b a17 = uy1.b.a(obj, false);
                    if (a17 != null) {
                        ((java.util.concurrent.ConcurrentHashMap) a17.f441426e).remove(str);
                    }
                }
            }
            java.lang.Object cj6 = cj(obj);
            ...
            if (sz1.a.n(obj)) {
                vy1.c l17 = uy1.a.l(obj, false);
                if (l17 != null && !u46.l.e(str)) {
                    ((java.util.concurrent.ConcurrentHashMap) l17.f441445c).remove(str);
                }
            } else if (sz1.a.m(obj)) {
                vy1.b j17 = uy1.a.j(obj, false);
                if (j17 != null && !u46.l.e(str)) {
                    ((java.util.concurrent.ConcurrentHashMap) j17.f441426e).remove(str);
                }
            } else if (sz1.a.i(obj)) {
                int i17 = uy1.a.f431907a;
                if (!u46.l.e(str) && (h17 = uy1.a.h(obj, false)) != null) {
                    ((java.util.concurrent.ConcurrentHashMap) h17.f441416a).remove(str);
                }
            }
        }
        return this;
    ...
    public dy1.r xj(java.lang.Object obj) {
        ...
        if (obj != null && oj()) {
            if (!sz1.a.m(obj) && !sz1.a.n(obj) && !sz1.a.i(obj)) {
                vy1.c b17 = uy1.b.b(obj, false);
                if (b17 != null) {
                    ((java.util.concurrent.ConcurrentHashMap) b17.f441445c).clear();
                }
                vy1.b a17 = uy1.b.a(obj, false);
                if (a17 != null) {
                    ((java.util.concurrent.ConcurrentHashMap) a17.f441426e).clear();
                }
            }
            java.lang.Object cj6 = cj(obj);
            if (cj6 != null) {
            ...
            if (sz1.a.n(obj)) {
                vy1.c l17 = uy1.a.l(obj, false);
                if (l17 != null) {
                    ((java.util.concurrent.ConcurrentHashMap) l17.f441445c).clear();
                }
            } else if (sz1.a.m(obj)) {
                vy1.b j17 = uy1.a.j(obj, false);
                if (j17 != null) {
                    ((java.util.concurrent.ConcurrentHashMap) j17.f441426e).clear();
                }
            } else if (sz1.a.i(obj) && (h17 = uy1.a.h(obj, false)) != null) {
                ((java.util.concurrent.ConcurrentHashMap) h17.f441416a).clear();
            }
