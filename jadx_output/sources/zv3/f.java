...
public final class f implements zv3.c {
    ...
    public final java.util.List f476441d;

    /* renamed from: e, reason: collision with root package name */
    public final android.graphics.Paint f476442e;

    /* renamed from: f, reason: collision with root package name */
    public final android.graphics.Bitmap f476443f;

    /* renamed from: g, reason: collision with root package name */
    public final android.graphics.Canvas f476444g;
    ...
    public f(float[] drawingRect, float[] fArr, java.util.List editorItems, int i17, int i18) {
        ...
        this.f476443f = createBitmap;
        android.graphics.Canvas canvas = new android.graphics.Canvas(createBitmap);
        this.f476444g = canvas;
        canvas.translate(-drawingRect[0], -drawingRect[1]);
    }

    public void a() {
        try {
            java.util.Iterator it = this.f476441d.iterator();
            while (it.hasNext()) {
                ((av3.a) it.next()).b();
            }
        } catch (java.lang.Exception e17) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SimpleFrameRetriever", e17, "destroy error", new java.lang.Object[0]);
        }
    }

    public android.graphics.Bitmap d(long j17) {
        java.util.List<av3.a> list = this.f476441d;
        if (list.size() == 0) {
            return null;
        }
        android.graphics.Canvas canvas = this.f476444g;
        canvas.drawColor(0, android.graphics.PorterDuff.Mode.MULTIPLY);
        for (av3.a aVar : list) {
            aVar.f(j17);
            aVar.c(canvas, this.f476442e);
        }
        return this.f476443f;
    }
    ...
    public void e() {
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SimpleFrameRetriever", e17, "start error", new java.lang.Object[0]);
        }
    }
}
