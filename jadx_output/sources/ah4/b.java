...
public abstract class b extends android.os.Binder implements ah4.c {
    ...
    public boolean onTransact(int i17, android.os.Parcel parcel, android.os.Parcel parcel2, int i18) {
        ...
        com.tencent.mm.plugin.talkroom.component.ILiveConEngineCallback_AIDL iLiveConEngineCallback_AIDL = null;
        ah4.h hVar = null;
        switch (i17) {
            case 1:
            ...
            case 3:
                ...
                if (readStrongBinder != null) {
                    ...
                    iLiveConEngineCallback_AIDL = (queryLocalInterface == null || !(queryLocalInterface instanceof com.tencent.mm.plugin.talkroom.component.ILiveConEngineCallback_AIDL)) ? new ah4.d(readStrongBinder) : (com.tencent.mm.plugin.talkroom.component.ILiveConEngineCallback_AIDL) queryLocalInterface;
                }
                int E5 = ((ah4.y) this).E5(iLiveConEngineCallback_AIDL, parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readLong(), parcel.createIntArray(), parcel.createIntArray(), parcel.readInt(), parcel.createStringArray());
                parcel2.writeNoException();
                parcel2.writeInt(E5);
                return true;
            case 4:
