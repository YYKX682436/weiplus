...
public class a implements ah4.c {
    ...
    public final android.os.IBinder f4978d;
    ...
    public byte[] C1(int[] iArr, java.lang.String str) {
        ...
        try {
            ...
            this.f4978d.transact(6, obtain, obtain2, 0);
    ...
    public int E5(com.tencent.mm.plugin.talkroom.component.ILiveConEngineCallback_AIDL iLiveConEngineCallback_AIDL, int i17, int i18, int i19, long j17, int[] iArr, int[] iArr2, int i27, java.lang.String[] strArr) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.talkroom.component.IEngine_AIDL");
            obtain.writeStrongInterface(iLiveConEngineCallback_AIDL);
            obtain.writeInt(i17);
            obtain.writeInt(i18);
            obtain.writeInt(i19);
            ...
            this.f4978d.transact(3, obtain, obtain2, 0);
            obtain2.readException();
    ...
    public int F8() {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.talkroom.component.IEngine_AIDL");
            this.f4978d.transact(2, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt();
        } finally {
            obtain2.recycle();
    ...
    public int I7() {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.talkroom.component.IEngine_AIDL");
            this.f4978d.transact(1, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt();
        } finally {
            obtain2.recycle();
    ...
    public int Nh() {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.talkroom.component.IEngine_AIDL");
            this.f4978d.transact(5, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt();
        } finally {
            obtain2.recycle();
    ...
    public ah4.n Pb(ah4.h hVar) {
        ...
        try {
            ...
            this.f4978d.transact(7, obtain, obtain2, 0);
            obtain2.readException();
            android.os.IBinder readStrongBinder = obtain2.readStrongBinder();
            int i17 = ah4.m.f5004d;
            if (readStrongBinder == null) {
                lVar = null;
            } else {
    ...
    public int yh(int i17) {
        ...
        try {
            obtain.writeInterfaceToken("com.tencent.mm.plugin.talkroom.component.IEngine_AIDL");
            obtain.writeInt(i17);
            this.f4978d.transact(4, obtain, obtain2, 0);
            obtain2.readException();
            return obtain2.readInt();
        } finally {
            obtain2.recycle();
