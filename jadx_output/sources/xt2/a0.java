...
public final class a0 {
    ...
    public static final xt2.a0 f456611a = new xt2.a0();

    public final java.lang.Object a(android.widget.TextView textView, long j17, kotlin.coroutines.Continuation continuation) {
    ...
    public final long b(long j17, r45.n32 animInfo) {
        java.util.Map map;
        java.lang.Long l17;
        kotlin.jvm.internal.o.g(animInfo, "animInfo");
        ...
        if (f6Var != null && (map = f6Var.D1) != null) {
            ...
            if (map2 != null && (l17 = (java.lang.Long) map2.get(java.lang.Integer.valueOf(animInfo.getInteger(4)))) != null) {
                return l17.longValue();
            }
        }
        return animInfo.getLong(2);
    }
    ...
    public final boolean c(long j17, r45.n32 n32Var, java.lang.String source) {
        ...
        n32Var.getLong(3);
        boolean d17 = d(n32Var.getInteger(5), b17, n32Var.getLong(3));
        com.tencent.mars.xlog.Log.i("FinderLiveShopCountDownAnimHelper", "isAnimValid from source " + source + ", startNum = " + b17 + ", animInfo = " + n32Var.toJSON() + ", valid = " + d17);
        return d17;
    }
    ...
    public final boolean d(int i17, long j17, long j18) {
        ...
        com.tencent.mars.xlog.Log.i("FinderLiveShopCountDownAnimHelper", "isNumChangeValid, startNum = " + j17 + ", endNum = " + j18 + ", expectedDirection = " + i17 + ", valid = " + z17);
        return z17;
    }
    ...
    */
    public final java.lang.Object e(android.widget.TextView r29, long r30, r45.n32 r32, java.lang.String r33, kotlin.coroutines.Continuation r34) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object f(android.widget.TextView r22, r45.n32 r23, kotlin.coroutines.Continuation r24) {
        /*
