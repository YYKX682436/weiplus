...
public final class k implements pv.g0 {
    ...
    public final jz5.g f255649a = jz5.h.b(ep1.c.f255607d);
    ...
    */
    public static final java.lang.Object a(ep1.k r2, android.view.View r3, fp1.b r4, kotlin.coroutines.Continuation r5) {
        /*
            r2.getClass()
        ...
        L16:
            ...
            r3.<init>(r2, r5)
        L1b:
            java.lang.Object r2 = r3.f255599d
    ...
    */
    ...
    public void d(pv.y floatBallPageAnimationInfo, fp1.b bVar, qn5.a aVar) {
        kotlin.jvm.internal.o.g(floatBallPageAnimationInfo, "floatBallPageAnimationInfo");
        android.view.View view = floatBallPageAnimationInfo.f358507d;
        com.tencent.mars.xlog.Log.i("MicroMsg.FloatBallPageAnimationHelper", "enterPage contentView: %s", view);
        if (view == null) {
            j(aVar);
            return;
        }
        android.content.Intent intent = floatBallPageAnimationInfo.f358506c;
        if (!ep1.m.h(intent) && !floatBallPageAnimationInfo.f358504a) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FloatBallPageAnimationHelper", "enterPage not enterFromFloatBallWithAnimation and ignore");
            j(aVar);
            return;
        }
        boolean z17 = true;
        if (!(intent != null && intent.getIntExtra("key_enter_orientation", 0) == 1) && !floatBallPageAnimationInfo.f358505b) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FloatBallPageAnimationHelper", "enterPage orientation not portrait and ignore");
            j(aVar);
        } else {
            if (bVar != null && !bVar.b()) {
                com.tencent.mars.xlog.Log.w("MicroMsg.FloatBallPageAnimationHelper", "enterPage pageAnimationAdapter needEnterAnimation false");
                j(aVar);
                return;
            }
            if (floatBallPageAnimationInfo.f358510g == null && !floatBallPageAnimationInfo.f358511h) {
                z17 = false;
            }
            floatBallPageAnimationInfo.f358511h = z17;
    ...
    public boolean e(android.content.Intent intent, android.view.View view, android.graphics.Point point, fp1.b bVar, qn5.a aVar) {
        com.tencent.mars.xlog.Log.i("MicroMsg.FloatBallPageAnimationHelper", "exitPage contentView: %s", view);
        if (view == null) {
            j(aVar);
            return false;
        }
        if (bVar != null && !bVar.c()) {
            com.tencent.mars.xlog.Log.w("MicroMsg.FloatBallPageAnimationHelper", "exitPage pageAnimationAdapter needExitAnimation false");
            j(aVar);
            return false;
        }
        pv.y yVar = new pv.y();
    ...
    public boolean f(pv.y floatBallPageAnimationInfo, fp1.b bVar, qn5.a aVar) {
        ...
        if (bVar == null || bVar.c()) {
            floatBallPageAnimationInfo.f358511h = floatBallPageAnimationInfo.f358510g != null || floatBallPageAnimationInfo.f358511h;
    ...
    public final gp1.v h() {
        return (gp1.v) ((jz5.n) this.f255649a).getValue();
    }

    public final boolean i(android.view.View view, int i17, pv.y yVar, fp1.b bVar, qn5.a aVar) {
        gp1.v h17;
        boolean z17 = yVar.f358512i;
        android.graphics.Point point = yVar.f358508e;
        if (point == null) {
            point = (z17 || (h17 = h()) == null) ? null : h17.P();
        }
        android.graphics.Point point2 = point;
        if (point2 == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.FloatBallPageAnimationHelper", "handlePageAnimation floatBallSize invalid");
            j(aVar);
            return false;
        }
        android.graphics.Point point3 = yVar.f358509f;
        if (i17 == 1) {
            kotlinx.coroutines.l.d(kotlinx.coroutines.z0.b(), null, null, new ep1.d(this, view, bVar, null), 3, null);
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.FloatBallPageAnimationHelper", "handlePageAnimation contentView.width: %s, floatBallPosition: %s", java.lang.Integer.valueOf(view.getWidth()), g17);
        ...
        kotlinx.coroutines.l.d(kotlinx.coroutines.z0.b(), null, null, new ep1.j(this, view, bVar, yVar, g17, point2, i17, aVar, null), 3, null);
        return true;
    }
