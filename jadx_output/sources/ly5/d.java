...
public class d {
    ...
    public static final java.util.regex.Pattern f322304d = java.util.regex.Pattern.compile("(?<=\\[).*?(?=\\])");

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.regex.Pattern f322305e = java.util.regex.Pattern.compile("(?<=\\()-?[0-9]*,-?[0-9]*(?=\\))");

    /* renamed from: f, reason: collision with root package name */
    public static final ly5.c f322306f = new ly5.c(null);

    /* renamed from: a, reason: collision with root package name */
    public final java.lang.String f322307a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.ArrayList f322308b = new java.util.ArrayList();
    ...
    */
    public my5.a a() {
        /*
            r6 = this;
            r0 = 0
            java.lang.String r1 = r6.f322307a
            if (r1 == 0) goto Lcd
        ...
        L85:
            ...
            goto L85
        L93:
            java.util.ArrayList r1 = r6.f322308b
            ly5.c r3 = ly5.d.f322306f     // Catch: java.lang.Exception -> Lab java.lang.Throwable -> Lc1
            ...
            int r4 = r6.f322309c     // Catch: java.lang.Exception -> Lab java.lang.Throwable -> Lc1
            r5 = 2
    ...
    public final void b(java.lang.String str) {
        ...
        java.util.regex.Matcher matcher = f322304d.matcher(str);
        java.util.ArrayList arrayList2 = new java.util.ArrayList();
        int i17 = -1;
        int i18 = -1;
        while (true) {
            boolean find = matcher.find();
            arrayList = this.f322308b;
            if (!find) {
                break;
            }
        ...
        try {
            ...
            if (trim.length() != 0 || this.f322309c != 0) {
    ...
    */
    public void c(java.lang.String r17, my5.c r18) {
        /*
            ...
            r1 = r18
            java.lang.String r2 = ""
            r1.f332857a = r2     // Catch: java.lang.Exception -> Lbf
            if (r0 == 0) goto Lbf
            boolean r3 = r0.equals(r2)     // Catch: java.lang.Exception -> Lbf
            if (r3 == 0) goto L12
            goto Lbf
        L12:
            java.util.regex.Pattern r3 = ly5.d.f322305e     // Catch: java.lang.Exception -> Lbf
        ...
        Lb7:
            ...
            goto L1e
        Lba:
            r1.f332857a = r5     // Catch: java.lang.Exception -> Lbf
            r1.f332860d = r4     // Catch: java.lang.Exception -> Lbf
        Lbf:
            return
        */
    ...
    public final long d(java.lang.String str, my5.c cVar) {
        ...
        if (split.length < 2) {
            ...
            if (this.f322309c == 0 && split2[0].equalsIgnoreCase("offset")) {
                this.f322309c = java.lang.Integer.parseInt(split2[1]);
            }
            return -1L;
        }
        if (split.length == 2) {
            try {
                ...
                cVar.f332859c = parseLong;
                cVar.f332858b = parseLong2;
                return parseLong2;
