...
public final class x5 implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.demo.RepairerPullDownWidgetDemoUI f466930d;

    public x5(com.tencent.mm.plugin.repairer.ui.demo.RepairerPullDownWidgetDemoUI repairerPullDownWidgetDemoUI) {
        this.f466930d = repairerPullDownWidgetDemoUI;
    }
    ...
    public final void run() {
        ...
        tVar.f355288d = 0;
        tVar.f355289e = 1;
        com.tencent.mm.plugin.repairer.ui.demo.RepairerPullDownWidgetDemoUI repairerPullDownWidgetDemoUI = this.f466930d;
        android.view.View view = repairerPullDownWidgetDemoUI.e;
        if (view == null) {
            kotlin.jvm.internal.o.o("btnSetDemo");
            throw null;
        }
        ...
        if (view2 == null) {
            kotlin.jvm.internal.o.o("btnSetMusic");
            throw null;
        }
        if (repairerPullDownWidgetDemoUI.d == null) {
            kotlin.jvm.internal.o.o("layoutContainer");
