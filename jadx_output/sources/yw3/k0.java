...
public final class k0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.repairer.ui.demo.RepairerDBDemoUI f466782d;

    public k0(com.tencent.mm.plugin.repairer.ui.demo.RepairerDBDemoUI repairerDBDemoUI) {
        this.f466782d = repairerDBDemoUI;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mm.plugin.repairer.ui.demo.RepairerDBDemoUI repairerDBDemoUI = this.f466782d;
        android.content.Intent className = new android.content.Intent().setClassName((android.content.Context) this.f466782d, "com.tencent.mm.plugin.repairer.ui.demo.RepairerDBSelectDemoUI");
