...
public final class i6 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ android.widget.EditText f466771d;

    public i6(android.widget.EditText editText) {
        this.f466771d = editText;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        android.text.Editable text = this.f466771d.getText();
        if (text == null || (str = text.toString()) == null) {
            str = "";
        }
        yw3.h6 h6Var = yw3.h6.f466763a;
        com.tencent.mars.xlog.Log.i("MicroMsg.UrlImageCacheService", "trydownload imgback start:".concat(str));
