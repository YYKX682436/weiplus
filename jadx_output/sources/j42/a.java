...
public class a implements j42.f {
    ...
    public final int f297661a;

    public a(int i17) {
        this.f297661a = i17;
    }

    public final com.tencent.mm.sdk.platformtools.o4 a(int i17) {
        if (i17 == 2) {
            return com.tencent.mm.sdk.platformtools.o4.M("mmkv_name_edge_computing_instant_cache_" + j62.e.g().n());
        }
        if (i17 != 1) {
            return null;
        }
        return com.tencent.mm.sdk.platformtools.o4.M("mmkv_name_edge_computing_cache_" + j62.e.g().n());
    }
    ...
    public java.util.List e(java.lang.String str) {
        ...
        byte[] j17;
        java.util.List list;
        if (u46.l.e(str) || (a17 = a(this.f297661a)) == null) {
            return null;
        }
        ...
        if (!u46.l.e(b17) && (j17 = a17.j(b17)) != null && j17.length > 0) {
            ...
            try {
                rh0Var.parseFrom(j17);
                list = r42.c.a(rh0Var);
            } catch (java.lang.Exception e17) {
                com.tencent.mars.xlog.Log.e("EdgeComputingCacheStrategyMMKV", "[EdgeComputingCacheStrategyMMKV] query parseFrom : " + b17 + ", throw Exception : " + e17.getMessage());
                list = null;
            }
            if (list != null) {
                return list;
    ...
    public long h() {
        java.util.List list;
        com.tencent.mm.sdk.platformtools.o4 a17 = a(this.f297661a);
        long j17 = 0;
        if (a17 == null) {
            return 0L;
        }
        ...
        if (b17 != null && b17.length > 0) {
            for (java.lang.String str : b17) {
                ...
                if (j18 != null && j18.length > 0) {
                    r45.rh0 rh0Var = new r45.rh0();
                    try {
                        rh0Var.parseFrom(j18);
                        list = r42.c.a(rh0Var);
                    } catch (java.lang.Exception e17) {
                        com.tencent.mars.xlog.Log.e("EdgeComputingCacheStrategyMMKV", "[EdgeComputingCacheStrategyMMKV] size parseFrom : " + str + ", throw Exception : " + e17.getMessage());
                        list = null;
                    }
                    if (list != null) {
                        j17 += list.size();
    ...
    */
    public void i(r42.a r9) {
        ...
        L3:
            ...
            return
        Lc:
            java.lang.String r1 = r9.f369509r
        ...
        L19:
            ...
            r5.<init>()
            r5.parseFrom(r2)     // Catch: java.lang.Exception -> L43
        ...
        L7c:
            ...
            long r6 = r2.f369510s
            r5.f383988e = r6
            java.lang.String r6 = r2.f369511t
            r5.f383989f = r6
            java.lang.String r2 = r2.f369509r
            r5.f383987d = r2
            java.util.LinkedList r2 = r4.f384863d
            r2.add(r5)
            goto L7c
        L9f:
            if (r4 == 0) goto Ldc
            byte[] r9 = r4.toByteArray()     // Catch: java.lang.Exception -> Lc6
