...
public class a extends android.text.SpannableString {
    ...
    public java.lang.Object[] f333217d;
    ...
    public a(java.lang.CharSequence charSequence) {
        ...
        this.f333217d = new java.lang.Object[20];
        this.f333218e = new int[60];
    ...
    public int getSpanEnd(java.lang.Object obj) {
        int i17 = this.f333219f;
        java.lang.Object[] objArr = this.f333217d;
        int[] iArr = this.f333218e;
    ...
    public void setSpan(java.lang.Object obj, int i17, int i18, int i19) {
        ...
        if (i28 >= objArr.length) {
            ...
            java.lang.System.arraycopy(this.f333218e, 0, iArr, 0, this.f333219f * 3);
            this.f333217d = objArr2;
            this.f333218e = iArr;
        }
        java.lang.Object[] objArr3 = this.f333217d;
        int i37 = this.f333219f;
        objArr3[i37] = obj;
        int[] iArr2 = this.f333218e;
        iArr2[(i37 * 3) + 0] = i17;
        iArr2[(i37 * 3) + 1] = i18;
        iArr2[(i37 * 3) + 2] = i19;
        this.f333219f = i37 + 1;
