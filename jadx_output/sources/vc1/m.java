...
public class m implements android.view.View.OnTouchListener {
    ...
    public final /* synthetic */ boolean f435006d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.widget.ImageView f435007e;

    public m(vc1.p1 p1Var, boolean z17, android.widget.ImageView imageView) {
        this.f435006d = z17;
        this.f435007e = imageView;
    }
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if (this.f435006d) {
            ...
            android.widget.ImageView imageView = this.f435007e;
            if (action == 0) {
