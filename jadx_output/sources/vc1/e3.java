...
public abstract class e3 {
    ...
    public static double f434958a = -85.0d;

    /* renamed from: b, reason: collision with root package name */
    public static double f434959b = -1000.0d;

    /* renamed from: c, reason: collision with root package name */
    public static double f434960c = -85.0d;

    /* renamed from: d, reason: collision with root package name */
    public static double f434961d = -1000.0d;
    ...
    public static java.lang.String b(com.tencent.mm.plugin.appbrand.jsapi.l lVar, org.json.JSONObject jSONObject) {
        int c17 = c(jSONObject);
        if (c17 == -1) {
            return "invalid_map_id";
        }
        return lVar.getComponentId() + "&" + c17;
    }
