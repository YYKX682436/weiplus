...
public final class o implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.feature.ecs.product.finder_feed.v3.EcsFinderFeedProductViewV3 f334231d;

    public o(com.tencent.mm.feature.ecs.product.finder_feed.v3.EcsFinderFeedProductViewV3 ecsFinderFeedProductViewV3) {
        this.f334231d = ecsFinderFeedProductViewV3;
    }

    @Override // java.lang.Runnable
    public final void run() {
        com.tencent.mm.feature.ecs.product.finder_feed.v3.EcsFinderFeedProductViewV3 ecsFinderFeedProductViewV3 = this.f334231d;
        android.graphics.Point b17 = com.tencent.mm.ui.bl.b(ecsFinderFeedProductViewV3.getContext());
        int b18 = ecsFinderFeedProductViewV3._naviHeight + b17.x + i65.a.b(ecsFinderFeedProductViewV3.getContext(), 24);
        em.e0 e0Var = ecsFinderFeedProductViewV3.vb;
        int height = b18 + e0Var.h().getHeight() + i65.a.b(ecsFinderFeedProductViewV3.getContext(), 20) + e0Var.g().getHeight() + (i65.a.b(ecsFinderFeedProductViewV3.getContext(), 16) * 2) + e0Var.e().getHeight() + i65.a.b(ecsFinderFeedProductViewV3.getContext(), 42) + i65.a.b(ecsFinderFeedProductViewV3.getContext(), 20);
        if (height < b17.y) {
            ...
            if (marginLayoutParams2 != null) {
                marginLayoutParams2.topMargin = ecsFinderFeedProductViewV3._naviHeight;
            }
            ...
            if (marginLayoutParams3 != null) {
                marginLayoutParams3.topMargin = i65.a.b(ecsFinderFeedProductViewV3.getContext(), 24);
            }
            ...
            if (marginLayoutParams4 != null) {
                marginLayoutParams4.topMargin = i65.a.b(ecsFinderFeedProductViewV3.getContext(), 20);
            }
            ...
            if (marginLayoutParams5 != null) {
                marginLayoutParams5.bottomMargin = i65.a.b(ecsFinderFeedProductViewV3.getContext(), 42);
            }
            android.widget.FrameLayout f17 = e0Var.f();
            kotlin.jvm.internal.o.f(f17, "getProductInfoContainer(...)");
            int b19 = i65.a.b(ecsFinderFeedProductViewV3.getContext(), 16);
            f17.setPadding(b19, b19, b19, b19);
            b30.z zVar = b30.z.f17588a;
            android.view.View b27 = e0Var.b();
            kotlin.jvm.internal.o.f(b27, "getBgNavi(...)");
            zVar.c(b27);
            android.view.View c17 = e0Var.c();
            kotlin.jvm.internal.o.f(c17, "getBgNaviCart(...)");
            zVar.c(c17);
            return;
        }
        ...
        int i17 = height - ecsFinderFeedProductViewV3._naviHeight;
        int b29 = i65.a.b(ecsFinderFeedProductViewV3.getContext(), 24) + i65.a.b(ecsFinderFeedProductViewV3.getContext(), 20) + (i65.a.b(ecsFinderFeedProductViewV3.getContext(), 16) * 2) + i65.a.b(ecsFinderFeedProductViewV3.getContext(), 42);
        ...
        if (marginLayoutParams8 != null) {
            marginLayoutParams8.topMargin = (int) (i65.a.b(ecsFinderFeedProductViewV3.getContext(), 24) * f18);
        }
        ...
        if (marginLayoutParams9 != null) {
            marginLayoutParams9.topMargin = (int) (i65.a.b(ecsFinderFeedProductViewV3.getContext(), 20) * f18);
        }
        ...
        if (marginLayoutParams10 != null) {
            marginLayoutParams10.bottomMargin = (int) (i65.a.b(ecsFinderFeedProductViewV3.getContext(), 42) * f18);
        }
        android.widget.FrameLayout f19 = e0Var.f();
        kotlin.jvm.internal.o.f(f19, "getProductInfoContainer(...)");
        int b37 = (int) (f18 * i65.a.b(ecsFinderFeedProductViewV3.getContext(), 16));
