...
public final class g0 extends i95.w implements com.tencent.mm.plugin.appbrand.service.c6 {

    /* renamed from: d, reason: collision with root package name */
    public final kk.l f5675d = new kk.l(50);

    /* renamed from: e, reason: collision with root package name */
    public java.lang.ref.WeakReference f5676e;

    /* JADX WARN: Multi-variable type inference failed */
    public final void Ai(android.content.Context context, int i17, com.tencent.mm.storage.db dbVar, com.tencent.mm.storage.f9 f9Var) {
        ak5.r rVar;
        ...
        if (i17 != 0) {
            if (i17 != 1) {
                if (i17 == 2) {
                    if (dbVar != null) {
                        ...
                        long j17 = dbVar.w0().f372605f;
                        int i18 = dbVar.w0().f372606g;
                        java.lang.String MsgUserName = dbVar.w0().f372608i;
                        kotlin.jvm.internal.o.f(MsgUserName, "MsgUserName");
            ...
            if (yVar != null) {
                d17.f70774q.a(11965, yVar, e75.g.MainThread, new q01.j(e0Var));
            } else {
                d17.a(11965, e0Var);
            }
            d17.g(rVar);
            this.f5676e = new java.lang.ref.WeakReference(db5.e1.P(context, context.getString(com.tencent.mm.R.string.f490468vx), 3, context.getString(com.tencent.mm.R.string.f490468vx), false, true, new ak5.f0(rVar, e0Var)));
        }
    }
        ...
        if (Bi != null) {
            ...
            while (true) {
                if (!it.hasNext()) {
                    ...
                    obj = it.next();
                    if (((com.tencent.mm.storage.db) obj).u0() == i17) {
                        break;
                    }
                }
            }
            ...
            if (dbVar != null) {
                dbVar.A0(true);
                dbVar.updateToDB(ak5.v.f5694d.a().Q4(), true);
            }
        }
    }
}
