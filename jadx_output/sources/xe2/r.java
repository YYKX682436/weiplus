...
public final class r extends we2.z {

    /* renamed from: c, reason: collision with root package name */
    public final java.lang.String f453896c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(gk2.e liveContext) {
        super(liveContext);
        kotlin.jvm.internal.o.g(liveContext, "liveContext");
        this.f453896c = "LiveGameTeamMsgInterceptor";
    }
    ...
    */
    public void d(java.util.LinkedList r18) {
        /*
            Method dump skipped, instructions count: 743
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: xe2.r.d(java.util.LinkedList):void");
    }
