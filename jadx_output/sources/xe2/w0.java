    ...
    */
    public void d(java.util.LinkedList r11) {
        ...
        L34:
            ...
            goto L43
        L36:
            r4.parseFrom(r3)     // Catch: java.lang.Exception -> L3a
            goto L43
        L3a:
            r3 = move-exception
            java.lang.Object[] r3 = new java.lang.Object[]{r3}
            com.tencent.mm.sdk.platformtools.Log.a(r6, r7, r3)
            goto L34
        L43:
            if (r4 == 0) goto Lf
            r3 = 0
            int r8 = r4.getInteger(r3)
            r9 = 1
            if (r8 == r9) goto Lf
        ...
        L5c:
            ...
            goto L6b
        L5e:
            r8.parseFrom(r4)     // Catch: java.lang.Exception -> L62
            goto L6b
        L62:
            r4 = move-exception
            java.lang.Object[] r4 = new java.lang.Object[]{r4}     // Catch: java.lang.Exception -> Ld0
            com.tencent.mm.sdk.platformtools.Log.a(r6, r7, r4)     // Catch: java.lang.Exception -> Ld0
            goto L5c
        L6b:
            ...
            if (r8 == 0) goto L7c
            java.lang.String r6 = r8.getString(r3)     // Catch: java.lang.Exception -> Ld0
            goto L7d
        L7c:
            r6 = r5
        L7d:
            ...
            r4.append(r6)     // Catch: java.lang.Exception -> Ld0
            if (r8 == 0) goto L8c
            java.lang.String r6 = r8.getString(r9)     // Catch: java.lang.Exception -> Ld0
            goto L8d
        L8c:
            r6 = r5
        L8d:
            ...
            if (r8 == 0) goto L9f
            r6 = 2
            com.tencent.mm.protobuf.f r6 = r8.getCustom(r6)     // Catch: java.lang.Exception -> Ld0
            com.tencent.mm.protocal.protobuf.FinderJumpInfo r6 = (com.tencent.mm.protocal.protobuf.FinderJumpInfo) r6     // Catch: java.lang.Exception -> Ld0
            goto La0
        L9f:
            r6 = r5
        La0:
            ...
            com.tencent.mars.xlog.Log.i(r2, r4)     // Catch: java.lang.Exception -> Ld0
            if (r8 == 0) goto Lb1
            java.lang.String r4 = r8.getString(r3)     // Catch: java.lang.Exception -> Ld0
            goto Lb2
        Lb1:
            r4 = r5
        Lb2:
            ...
            r45.rb r6 = r6.f328776a3     // Catch: java.lang.Exception -> Ld0
            if (r6 == 0) goto Lc0
            java.lang.String r5 = r6.getString(r3)     // Catch: java.lang.Exception -> Ld0
        Lc0:
            boolean r4 = kotlin.jvm.internal.o.b(r4, r5)     // Catch: java.lang.Exception -> Ld0
            if (r4 != 0) goto Lf
            androidx.lifecycle.c1 r4 = r1.a(r0)     // Catch: java.lang.Exception -> Ld0
            mm2.c1 r4 = (mm2.c1) r4     // Catch: java.lang.Exception -> Ld0
            r4.f328776a3 = r8     // Catch: java.lang.Exception -> Ld0
            goto Lf
        Ld0:
            r4 = move-exception
            java.lang.Object[] r3 = new java.lang.Object[r3]
            com.tencent.mars.xlog.Log.printErrStackTrace(r2, r4, r7, r3)
            goto Lf
        Ld8:
            return
        */
