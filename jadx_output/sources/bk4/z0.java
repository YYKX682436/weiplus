...
public final class z0 extends al5.w {
    ...
    public static final bk4.w0 f21632t = new bk4.w0(null);

    /* renamed from: u, reason: collision with root package name */
    public static final android.util.LruCache f21633u;

    /* renamed from: f, reason: collision with root package name */
    public android.graphics.drawable.Drawable f21634f;

    /* renamed from: g, reason: collision with root package name */
    public final java.lang.String f21635g;

    /* renamed from: h, reason: collision with root package name */
    public final mj4.h f21636h;

    /* renamed from: i, reason: collision with root package name */
    public final bi4.c f21637i;

    /* renamed from: m, reason: collision with root package name */
    public final bi4.d f21638m;

    /* renamed from: n, reason: collision with root package name */
    public final bi4.b f21639n;
    ...
    public java.lang.ref.WeakReference f21643r;

    /* renamed from: s, reason: collision with root package name */
    public final java.lang.String f21644s;

    static {
        i65.a.b(com.tencent.mm.sdk.platformtools.x2.f193071a, 4);
        f21633u = new bk4.v0();
    }
    ...
    public z0(android.view.View view, android.graphics.drawable.Drawable drawable, java.lang.String str, int i17, mj4.h hVar, bi4.c cVar, bi4.d iconType, bi4.b iconColor, int i18, int i19) {
        ...
        this.f21634f = drawable;
        this.f21635g = str;
        this.f21636h = hVar;
        this.f21637i = cVar;
        this.f21638m = iconType;
        this.f21639n = iconColor;
        this.f21640o = i18;
        this.f21641p = i19;
        this.f21644s = "MicroMsg.TextStatus.TSIconSpan3@" + hashCode();
        bi4.j0 x0Var = view instanceof bi4.j0 ? (bi4.j0) view : ((view instanceof android.widget.TextView) || (view instanceof com.tencent.mm.ui.base.NoMeasuredTextView)) ? new bk4.x0(view) : null;
        if (x0Var != null) {
            android.view.View view2 = x0Var.getView();
            ...
            set.add(str);
            android.view.View view3 = x0Var.getView();
            if (view3 != null) {
                view3.setTag(com.tencent.mm.R.id.nwm, set);
            }
        }
        this.f21643r = new java.lang.ref.WeakReference(x0Var);
    }
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence charSequence, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        super.draw(canvas, charSequence, i17, i18, f17 + this.f21641p, i19, i27, i28, paint);
    }
    ...
    */
    public android.graphics.drawable.Drawable getDrawable() {
        /*
            ...
            r7 = r18
            r8 = 0
            boolean r0 = r7.f21642q     // Catch: java.lang.Throwable -> Lb9
            if (r0 != 0) goto Lc3
            java.lang.String r0 = r7.f21635g
            r1 = 1
            if (r0 == 0) goto L15
        ...
        L16:
            if (r2 != 0) goto Lc3
            bk4.f0 r9 = bk4.f0.f21465a     // Catch: java.lang.Throwable -> Lb9
        ...
        L29:
            ...
            java.util.LinkedList r4 = r4.f355219m     // Catch: java.lang.Throwable -> Lb9
            if (r4 == 0) goto L38
        ...
        L39:
            if (r4 == 0) goto L3d
            java.lang.String r2 = r4.f355046d     // Catch: java.lang.Throwable -> Lb9
        L3d:
            r10 = r2
            if (r10 == 0) goto L49
        ...
        L6f:
            if (r0 == 0) goto L81
            bi4.c r0 = r7.f21637i     // Catch: java.lang.Throwable -> Lb9
        ...
        L81:
            r6 = r8
        L82:
            bk4.w0 r11 = bk4.z0.f21632t     // Catch: java.lang.Throwable -> Lb9
            java.lang.String r12 = r7.f21635g     // Catch: java.lang.Throwable -> Lb9
            bi4.d r13 = r7.f21638m     // Catch: java.lang.Throwable -> Lb9
            bi4.b r14 = r7.f21639n     // Catch: java.lang.Throwable -> Lb9
            boolean r15 = bk4.g0.j(r4)     // Catch: java.lang.Throwable -> Lb9
            int r0 = r7.f21640o     // Catch: java.lang.Throwable -> Lb9
            r16 = r0
            r17 = r6
            ...
            android.util.LruCache r0 = bk4.z0.f21633u     // Catch: java.lang.Throwable -> Lb9
            ...
            if (r0 == 0) goto Lad
            r7.f21634f = r0     // Catch: java.lang.Throwable -> Lb9
            r7.f21642q = r1     // Catch: java.lang.Throwable -> Lb9
            goto Lc3
        Lad:
        ...
        Lb9:
            ...
            java.lang.String r3 = r7.f21644s
            com.tencent.mars.xlog.Log.printErrStackTrace(r3, r0, r1, r2)
        Lc3:
            android.graphics.drawable.Drawable r0 = r7.f21634f
            return r0
        */
    ...
    public int getSize(android.graphics.Paint paint, java.lang.CharSequence charSequence, int i17, int i18, android.graphics.Paint.FontMetricsInt fontMetricsInt) {
        kotlin.jvm.internal.o.g(paint, "paint");
        return super.getSize(paint, charSequence, i17, i18, fontMetricsInt) + this.f21641p;
    }

    @Override // al5.w
    public void onClick(android.view.View view) {
        bi4.c cVar;
        mj4.h hVar = this.f21636h;
        if (hVar == null || (cVar = this.f21637i) == null || cVar != bi4.c.SNS_FEED) {
            return;
        }
