...
public final class r1 extends android.text.style.ClickableSpan {
    ...
    public final /* synthetic */ bk4.c2 f21553d;
    ...
    public void onClick(android.view.View widget) {
        ...
        android.view.View.OnClickListener onClickListener = this.f21553d.f21419j;
    ...
    public void updateDrawState(android.text.TextPaint ds6) {
        ...
        bk4.c2 c2Var = this.f21553d;
        java.lang.Integer num = c2Var.f21418i;
        if (num != null) {
            num.intValue();
            android.content.res.Resources resources = c2Var.f21410a.getResources();
            java.lang.Integer num2 = c2Var.f21418i;
