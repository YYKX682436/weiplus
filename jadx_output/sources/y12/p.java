...
public final class p {
    ...
    public static final y12.p f458877a;

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.Map f458878b;

    static {
        y12.p pVar = new y12.p();
        f458877a = pVar;
        f458878b = new java.util.LinkedHashMap();
        java.lang.String a17 = pVar.a();
        if (com.tencent.mm.vfs.w6.j(a17)) {
            try {
                cl0.g gVar = new cl0.g(com.tencent.mm.vfs.w6.M(a17));
                java.util.Iterator keys = gVar.keys();
                while (keys.hasNext()) {
                    java.lang.String str = (java.lang.String) keys.next();
                    java.lang.Object obj = gVar.get(str);
                    if (obj instanceof java.lang.Integer) {
                        java.util.Map map = f458878b;
                        kotlin.jvm.internal.o.d(str);
                        map.put(str, obj);
                    }
                }
            } catch (java.lang.Throwable unused) {
                com.tencent.mars.xlog.Log.e("StoreEmotionDesignerInfoMgr", "unable to parse saved designer id to uin map");
    ...
    public final java.lang.String a() {
        java.lang.String str = rr.s.f399149a.a() + "designerInfo/";
    ...
    */
    public final void b(int r16, boolean r17, yz5.l r18) {
        /*
            ...
            boolean r4 = com.tencent.mm.vfs.w6.j(r2)
            r5 = 0
            if (r4 == 0) goto L85
            r4 = -1
            r6 = 0
            byte[] r4 = com.tencent.mm.vfs.w6.N(r2, r6, r4)
            r7 = 1
            r45.xd0 r8 = new r45.xd0     // Catch: java.lang.Throwable -> L63
            r8.<init>()     // Catch: java.lang.Throwable -> L63
            com.tencent.mm.protobuf.f r4 = r8.parseFrom(r4)     // Catch: java.lang.Throwable -> L63
            java.lang.String r8 = "null cannot be cast to non-null type com.tencent.mm.protocal.protobuf.DesignerInfoObj"
            kotlin.jvm.internal.o.e(r4, r8)     // Catch: java.lang.Throwable -> L63
            r45.xd0 r4 = (r45.xd0) r4     // Catch: java.lang.Throwable -> L63
            r45.v75 r8 = r4.f389993d     // Catch: java.lang.Throwable -> L61
            java.lang.String r9 = "designer"
            kotlin.jvm.internal.o.f(r8, r9)     // Catch: java.lang.Throwable -> L61
            r9 = r15
            boolean r8 = r15.d(r8)     // Catch: java.lang.Throwable -> L65
            if (r8 != 0) goto L4a
            java.lang.String r8 = "local designerInfo is invalid, delete it."
            com.tencent.mars.xlog.Log.w(r1, r8)     // Catch: java.lang.Throwable -> L65
            com.tencent.mm.vfs.w6.h(r2)     // Catch: java.lang.Throwable -> L65
            r10 = r6
            r8 = r7
            goto L4c
        L4a:
        ...
        L4c:
            ...
            long r13 = r4.f389994e     // Catch: java.lang.Throwable -> L65
            long r11 = r11 - r13
    ...
    */
    public final boolean d(r45.v75 r7) {
        /*
            r6 = this;
            java.lang.String r0 = r7.f387965e
            r1 = 1
            r2 = 0
            if (r0 == 0) goto L13
            int r0 = r0.length()
        ...
        L14:
            if (r0 == 0) goto L2c
            java.lang.String r0 = r7.f387966f
            if (r0 == 0) goto L27
            int r0 = r0.length()
            if (r0 <= 0) goto L22
            r0 = r1
        ...
        L2c:
            r0 = r2
        L2d:
            java.lang.String r3 = r7.f387970m
            if (r3 == 0) goto L3e
            int r3 = r3.length()
            if (r3 <= 0) goto L39
            r3 = r1
        ...
        L3f:
            if (r3 == 0) goto L6b
            java.lang.String r3 = r7.f387967g
            if (r3 == 0) goto L52
            int r3 = r3.length()
            if (r3 <= 0) goto L4d
            r3 = r1
        ...
        L53:
            if (r3 == 0) goto L6b
            java.lang.String r3 = r7.f387969i
            if (r3 == 0) goto L66
            int r3 = r3.length()
            if (r3 <= 0) goto L61
            r3 = r1
    ...
    public final void e(r45.v75 designerInfo, java.lang.String designerId) {
        kotlin.jvm.internal.o.g(designerInfo, "designerInfo");
        kotlin.jvm.internal.o.g(designerId, "designerId");
        int i17 = designerInfo.f387964d;
        if (designerId.length() > 0) {
            ...
            try {
                ...
                com.tencent.mm.vfs.w6.S(a(), bytes, 0, bytes.length);
            } catch (java.lang.Throwable unused) {
                com.tencent.mars.xlog.Log.e("StoreEmotionDesignerInfoMgr", "unable to save designer id to uin map");
            }
        }
        if (!d(designerInfo)) {
            com.tencent.mars.xlog.Log.w("StoreEmotionDesignerInfoMgr", "designerInfo is not valid!");
            return;
        }
        ...
        xd0Var.f389993d = designerInfo;
        xd0Var.f389994e = currentTimeMillis;
        com.tencent.mm.vfs.w6.R(c17, xd0Var.toByteArray());
    }
}
