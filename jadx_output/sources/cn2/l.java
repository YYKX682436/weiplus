...
public final class l {
    ...
    public static final cn2.l f43568a = new cn2.l();

    /* renamed from: b, reason: collision with root package name */
    public static final int f43569b;

    /* renamed from: c, reason: collision with root package name */
    public static final int[] f43570c;

    static {
        ae2.in inVar = ae2.in.f3688a;
        f43569b = ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.f3834o5).getValue()).r()).intValue();
        f43570c = new int[]{14, 17, 15, 16, 20};
    }
    ...
    public final jz5.l b(dk2.zf liveMsg) {
        ...
        kotlin.jvm.internal.o.g(liveMsg, "liveMsg");
        if (liveMsg.getType() != 10005) {
            if (liveMsg.getType() != 20031) {
                return new jz5.l(java.lang.Boolean.FALSE, -1);
            }
            java.lang.Object D = liveMsg.D();
            r3 = D instanceof r45.qi1 ? (r45.qi1) D : null;
            return new jz5.l(java.lang.Boolean.TRUE, java.lang.Integer.valueOf(r3 != null ? r3.getInteger(2) : 0));
        }
        ...
        while (true) {
            ...
            if (kz5.z.F(f43570c, ((r45.yl1) next).getInteger(0))) {
                r3 = next;
                break;
            }
        }
        ...
        return new jz5.l(java.lang.Boolean.TRUE, java.lang.Integer.valueOf(zl2.r4.f473950a.r0(a17)));
    }
    ...
    public final void c(int i17, boolean z17) {
        if (zl2.r4.f473950a.w1()) {
            ...
            zy2.zb.y6((zy2.zb) c17, ml2.z4.f328395z1, gVar.toString(), null, 4, null);
        }
    }
}
