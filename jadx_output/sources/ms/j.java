...
public final class j extends wm3.a {
    ...
    public com.tencent.mm.ui.widget.dialog.f4 f330925d;
    ...
    */
    public final com.tencent.mm.ui.widget.dialog.f4 T6() {
        /*
            r3 = this;
            com.tencent.mm.ui.widget.dialog.f4 r0 = r3.f330925d
            r1 = 1
            if (r0 == 0) goto L11
            r2 = 0
            if (r0 == 0) goto Lf
    ...
    public void onStop() {
        super.onStop();
        com.tencent.mm.ui.widget.dialog.f4 f4Var = this.f330925d;
        if (f4Var != null) {
            f4Var.dismiss();
        }
        this.f330925d = null;
