...
public class c implements f91.a {
    ...
    public boolean a(android.graphics.Path path, com.tencent.mm.plugin.appbrand.canvas.action.arg.path.BasePathActionArg basePathActionArg) {
        com.tencent.mm.plugin.appbrand.canvas.action.arg.path.PathArcToActionArg pathArcToActionArg = (com.tencent.mm.plugin.appbrand.canvas.action.arg.path.PathArcToActionArg) basePathActionArg;
        if (pathArcToActionArg == null) {
            return false;
        }
        c(path, pathArcToActionArg.f77140e, pathArcToActionArg.f77141f, pathArcToActionArg.f77142g, pathArcToActionArg.f77143h, pathArcToActionArg.f77144i, pathArcToActionArg.f77145m);
        return true;
    }
