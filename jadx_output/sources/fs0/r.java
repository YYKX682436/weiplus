...
public final class r implements fs0.d {
    ...
    public void a(long j17, java.util.List frames, int i17, int i18, java.util.Map parents, java.util.Map outPts) {
        ...
        com.tencent.mars.xlog.Log.i("DecodeStrategy", "use vfr decode strategy");
        ...
        while (it.hasNext()) {
            ...
            if (((java.lang.Number) it.next()).longValue() >= j17) {
                ...
                com.tencent.mars.xlog.Log.i(str, "DropFrame, total frames = " + L0.size() + ", remain frames = " + i29 + ", cost " + (java.lang.System.currentTimeMillis() - j18) + "ms");
