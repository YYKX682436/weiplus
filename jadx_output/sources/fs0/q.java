...
public final class q implements fs0.d {
    ...
    public void a(long j17, java.util.List frames, int i17, int i18, java.util.Map parents, java.util.Map outPts) {
        ...
        com.tencent.mars.xlog.Log.i("DecodeStrategy", "use simple vfr decode strategy");
        this.f266274a = 1000000 / (i18 != 0 ? i18 : i17);
        ...
        while (it.hasNext()) {
            ...
            if (longValue >= j17) {
                ...
                if (((size == 0 || size == 1) ? Float.MAX_VALUE : ((float) (longValue - j19)) / size) >= ((float) this.f266274a)) {
