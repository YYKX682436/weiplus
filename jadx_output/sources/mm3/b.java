...
public final class b implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ mm3.n f329608d;
    ...
    public final void onClick(android.view.View view) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.Mv.MusicMvPreviewTrackUIC", "user clicked complete button, indexes=".concat(arrays));
        if (nVar.f329661o != -1) {
            nVar.f329662p = true;
        }
        nVar.f329661o = -1;
