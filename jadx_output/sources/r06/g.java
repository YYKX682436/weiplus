...
public abstract class g extends r06.v implements o06.r1 {
    ...
    public o06.r1 d(f26.v2 v2Var) {
        ...
        f26.o0 k17 = e() instanceof o06.g ? v2Var.k(getType(), f26.d3.f259145h) : v2Var.k(getType(), f26.d3.f259143f);
        if (k17 == null) {
            return null;
        }
        return k17 == getType() ? this : new r06.i1(e(), new z16.i(k17), getAnnotations());
    }
