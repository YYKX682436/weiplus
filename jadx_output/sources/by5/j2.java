    ...
    public qx5.a a(android.content.Context context, android.net.Uri uri, qx5.l lVar) {
        ...
        for (android.app.ActivityManager.RunningAppProcessInfo runningAppProcessInfo : activityManager.getRunningAppProcesses()) {
            if (runningAppProcessInfo.uid == myUid && runningAppProcessInfo.pid != myPid && (str = runningAppProcessInfo.processName) != null && str.contains("xweb_sandboxed_process")) {
                by5.c4.f("ProcessUtil", "killRenderProcess, processName:" + str + ", pid:" + runningAppProcessInfo.pid);
                ...
                yj0.a.d(obj, arrayList.toArray(), "com/tencent/xweb/util/ProcessUtil", "killRenderProcess", "(Landroid/content/Context;)V", "android/os/Process_EXEC_", "killProcess", "(I)V");
                android.os.Process.killProcess(((java.lang.Integer) arrayList.get(0)).intValue());
                yj0.a.f(obj, "com/tencent/xweb/util/ProcessUtil", "killRenderProcess", "(Landroid/content/Context;)V", "android/os/Process_EXEC_", "killProcess", "(I)V");
                z17 = true;
            }
        }
        if (!z17) {
            by5.c4.f("ProcessUtil", "killRenderProcess, try force kill render process");
            tx5.j.d(80024, null);
        }
        return qx5.a.b();
    }
