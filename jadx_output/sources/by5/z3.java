...
public abstract class z3 {
    public static boolean a(int i17) {
        boolean z17;
        int i18 = com.tencent.xweb.b.m().i("min_apk_version_for_new_data_dir", "tools", -1);
        if (i18 == -1) {
            return false;
        }
        java.lang.String g17 = com.tencent.xweb.b.m().g("min_apk_version_ignore_list", "tools");
    ...
    public static java.lang.String i(int i17) {
        java.lang.String str = n(i17) + java.io.File.separator + com.tencent.tinker.loader.shareutil.ShareConstants.DEX_PATH;
        java.io.File file = new java.io.File(str);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static java.lang.String l() {
        return org.xwalk.core.XWalkEnvironment.f347970c.getDir("xwalkplugin", 0).getAbsolutePath();
    }
    ...
    public static java.lang.String n(int i17) {
        ...
        java.lang.String absolutePath = org.xwalk.core.XWalkEnvironment.f347970c.getDir("xwalk_" + i17, 0).getAbsolutePath();
    ...
    */
    ...
    public static java.lang.String p(int i17) {
        java.lang.String str = org.xwalk.core.XWalkEnvironment.f347970c.getDir("xweb_data", 0).getAbsolutePath() + java.io.File.separator + "xweb_" + i17;
        java.io.File file = new java.io.File(str);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static boolean q(int i17) {
        java.lang.String str = org.xwalk.core.XWalkEnvironment.f347970c.getApplicationInfo().dataDir;
        if (str == null) {
            return false;
        }
        java.io.File file = new java.io.File(str);
