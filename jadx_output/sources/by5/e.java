...
public abstract class e {
    ...
    public static int f36437a;

    /* renamed from: b, reason: collision with root package name */
    public static int f36438b;
            ...
            if (i17 <= 0) {
                ...
                try {
                    if (android.os.Looper.getMainLooper() == android.os.Looper.myLooper()) {
                        java.lang.String userAgentString = new android.webkit.WebView(org.xwalk.core.XWalkEnvironment.f347970c).getSettings().getUserAgentString();
