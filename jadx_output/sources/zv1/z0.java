...
public final class z0 {
    ...
    public final void a(zv1.r rVar, java.util.List list, long j17, int i17, long j18) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", "dumpTopNFiles TOP " + min + " largest files of " + list.size() + " files:");
        int i19 = 0;
        while (true) {
            ...
            float f17 = ((float) a1Var.f476261b) / 1000000;
            if (!a1Var.f476263d) {
                str3 = "FILE";
            }
            i19++;
            java.lang.String format = java.lang.String.format("[%2d] %s %s - %.2f MB - EXEMPTED(%s)", java.util.Arrays.copyOf(new java.lang.Object[]{java.lang.Integer.valueOf(i19), str3, a1Var.f476260a, java.lang.Float.valueOf(f17), a1Var.f476264e}, 5));
        ...
        if (i27 > 0) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", format2);
        } else {
            i18 = i27;
        ...
        if (j18 > 0) {
            ...
            for (java.lang.Object obj3 : list) {
                if (((zv1.a1) obj3).f476262c > j18) {
                    arrayList.add(obj3);
                }
            }
            int min2 = java.lang.Math.min(i17, arrayList.size());
            com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", str + min2 + " largest newer files of " + arrayList.size() + " files: beforeTime=" + zv1.i0.a().format(new java.util.Date(j18)));
            if (!arrayList.isEmpty()) {
                int i28 = 0;
                while (i28 < min2) {
                    zv1.a1 a1Var2 = (zv1.a1) arrayList.get(i28);
                    i28++;
                    java.lang.String format3 = java.lang.String.format("[%2d] %s %s - %.2f MB - Time(%s) - EXEMPTED(%s)", java.util.Arrays.copyOf(new java.lang.Object[]{java.lang.Integer.valueOf(i28), a1Var2.f476263d ? obj : obj2, a1Var2.f476260a, java.lang.Float.valueOf(((float) a1Var2.f476261b) / 1000000), zv1.i0.a().format(new java.util.Date(a1Var2.f476262c)), a1Var2.f476264e}, 6));
                    kotlin.jvm.internal.o.f(format3, "format(...)");
                    com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", format3);
                }
                if (i18 > 0) {
                    ...
                    com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", format4);
                }
            }
        }
    }
