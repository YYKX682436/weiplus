...
public abstract class c implements zv1.d, zv1.q {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:104:0x02e9, code lost:
        ...
        if (((java.lang.Boolean) r6.f302833d).booleanValue() != true) goto L100;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:121:0x0344, code lost:
        ...
        r3.append(r0);
        r3.append('%');
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", r3.toString());
        r15 = r32;
        zv1.e1.f476292f.b(r29, r9, r11, r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:124:0x04b3, code lost:
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", r0.toString());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:154:0x03d9, code lost:
        ...
        com.tencent.mars.xlog.Log.w("MicroMsg.CleanCache.Utils", "Can NOT find proper timeThreshold within scannedFiles in INC order, use time of lastVisitedFile(lasest)");
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", "Threshold time: fileListCount=" + r9.size() + ", timeThreshold=" + zv1.i0.a().format(java.lang.Long.valueOf(r34)));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:159:0x042e, code lost:
        ...
        r2 = r20;
        r1.append(r2);
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", r1.toString());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:165:0x0462, code lost:
        ...
        if (((java.lang.Boolean) r9.f302833d).booleanValue() != true) goto L147;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:179:0x048a, code lost:
        ...
        r36 = r36 + ((zv1.e1) r0.next()).f476294b;
     */
    /* JADX WARN: Code restructure failed: missing block: B:181:0x0495, code lost:
    
        r6.append(r36 / r22);
        r6.append(r2);
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", r6.toString());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:90:0x0237, code lost:
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.CleanCache.Utils", "Threshold time: fileListCount=" + r9.size() + ", timeThresholdIndex=" + r11 + ", timeThreshold=" + zv1.i0.a().format(java.lang.Long.valueOf(r3)));
        r0 = r2.iterator();
        r5 = 0;
     */
    ...
    */
    public long c(long r39, com.tencent.wcdb.support.CancellationSignal r41, boolean r42) {
        /*
