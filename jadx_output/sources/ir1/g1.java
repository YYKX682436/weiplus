...
public final class g1 implements java.lang.Runnable {
    ...
    public final /* synthetic */ ir1.i1 f293975d;
    ...
    public final void run() {
        ir1.i1 i1Var = this.f293975d;
        android.view.View inflate = android.view.LayoutInflater.from(i1Var.getContext()).inflate(com.tencent.mm.R.layout.dzk, (android.view.ViewGroup) null);
        ...
        inflate.findViewById(com.tencent.mm.R.id.hkr).setOnClickListener(new ir1.d1(popupWindow));
        popupWindow.setOnDismissListener(ir1.e1.f293967d);
