...
public class g {
    ...
    public final java.lang.String f334875a;

    /* renamed from: b, reason: collision with root package name */
    public final java.util.Map f334876b;

    /* renamed from: c, reason: collision with root package name */
    public final java.util.Set f334877c;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Set f334878d;

    public g(java.lang.String str, java.util.Map map, java.util.Set set, java.util.Set set2) {
        this.f334875a = str;
        this.f334876b = java.util.Collections.unmodifiableMap(map);
        this.f334877c = java.util.Collections.unmodifiableSet(set);
        this.f334878d = set2 == null ? null : java.util.Collections.unmodifiableSet(set2);
    }
    ...
    public static n4.g a(p4.b bVar, java.lang.String str) {
        ...
        try {
            ...
            try {
                int columnIndex6 = f17.getColumnIndex(dm.i4.COL_ID);
                int columnIndex7 = f17.getColumnIndex(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.Common.COMMON_SEQ);
                ...
                while (i27 < count) {
                    ...
                    if (f17.getInt(columnIndex7) != 0) {
                        ...
                        while (it.hasNext()) {
                            ...
                            int i29 = count;
                            if (eVar.f334868d == i28) {
                                arrayList.add(eVar.f334870f);
                                arrayList2.add(eVar.f334871g);
                            }
                            b17 = list2;
                            count = i29;
                        }
                ...
                try {
                    int columnIndex11 = f17.getColumnIndex(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
                    int columnIndex12 = f17.getColumnIndex(ya.b.ORIGIN);
    ...
    public static java.util.List b(android.database.Cursor cursor) {
        int columnIndex = cursor.getColumnIndex(dm.i4.COL_ID);
        int columnIndex2 = cursor.getColumnIndex(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.Common.COMMON_SEQ);
    ...
    public static n4.f c(p4.b bVar, java.lang.String str, boolean z17) {
        ...
        try {
            ...
            int columnIndex3 = f17.getColumnIndex(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.PlayerStep.PLAYER_TRACK_NAME);
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        n4.g gVar = (n4.g) obj;
        java.lang.String str = gVar.f334875a;
        java.lang.String str2 = this.f334875a;
        if (str2 == null ? str != null : !str2.equals(str)) {
            return false;
        }
        java.util.Map map = gVar.f334876b;
        java.util.Map map2 = this.f334876b;
        if (map2 == null ? map != null : !map2.equals(map)) {
            return false;
        }
        java.util.Set set2 = gVar.f334877c;
        java.util.Set set3 = this.f334877c;
        if (set3 == null ? set2 != null : !set3.equals(set2)) {
            return false;
        }
        java.util.Set set4 = this.f334878d;
        if (set4 == null || (set = gVar.f334878d) == null) {
            return true;
        }
    ...
    public int hashCode() {
        java.lang.String str = this.f334875a;
        int hashCode = (str != null ? str.hashCode() : 0) * 31;
        java.util.Map map = this.f334876b;
        int hashCode2 = (hashCode + (map != null ? map.hashCode() : 0)) * 31;
        java.util.Set set = this.f334877c;
        return hashCode2 + (set != null ? set.hashCode() : 0);
    }

    public java.lang.String toString() {
        return "TableInfo{name='" + this.f334875a + "', columns=" + this.f334876b + ", foreignKeys=" + this.f334877c + ", indices=" + this.f334878d + '}';
    }
}
