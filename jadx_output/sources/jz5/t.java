...
public final class t implements java.util.Collection, zz5.a {
    ...
    public final boolean contains(java.lang.Object obj) {
        ...
        return kz5.z.D(this.f302847d, ((jz5.r) obj).f302844d);
    }
    ...
    */
    ...
    public boolean equals(java.lang.Object obj) {
        if (obj instanceof jz5.t) {
            return kotlin.jvm.internal.o.b(this.f302847d, ((jz5.t) obj).f302847d);
        }
        return false;
    }
    ...
    @Override // java.util.Collection
    public int hashCode() {
        return java.util.Arrays.hashCode(this.f302847d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return this.f302847d.length == 0;
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator iterator() {
        return new jz5.s(this.f302847d);
    }
    ...
    public java.lang.String toString() {
        return "UByteArray(storage=" + java.util.Arrays.toString(this.f302847d) + ')';
    }
