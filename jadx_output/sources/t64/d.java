...
public final class d {
    ...
    public static final t64.d f416017a = new t64.d();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:118:0x039e, code lost:
        ...
        r19 = r23;
        r17 = r24;
        com.tencent.mars.xlog.Log.i("AdSwapHelper", "adSwap, write all ad timeCost=" + (java.lang.System.currentTimeMillis() - r0) + ", size=" + r6);
     */
    /* JADX WARN: Code restructure failed: missing block: B:119:0x03c1, code lost:
    
        com.tencent.mm.plugin.report.service.g0.INSTANCE.A(2123, 2);
        com.tencent.mars.xlog.Log.i("AdSwapHelper", "adSwap, timeCost=" + (java.lang.System.currentTimeMillis() - r20));
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs(r19, r17);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:71:0x0236, code lost:
        ...
        r24 = r9;
        r9 = r0;
        com.tencent.mars.xlog.Log.i("AdSwapHelper", "adSwap, query all ad timeCost=" + (java.lang.System.currentTimeMillis() - r12) + ", size=" + r6);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x026b, code lost:
        ...
        r10 = ((java.lang.Number) r7.get(r4)).longValue();
        r12 = ((java.lang.Number) r9.get(r4)).longValue();
        r8 = (t64.c) r14.get(java.lang.Long.valueOf(r10));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:81:0x029a, code lost:
        ...
        r2 = (t64.c) r14.get(java.lang.Long.valueOf(r12));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:84:0x02b1, code lost:
        ...
        r43 = r22;
        r22 = r14;
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs(r43, r9);
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs(r43, r9);
        r7.field_createTime = r8.f416014a;
        r7 = new r34.b(0, null, 0, 0, 0, 0, null, null, null, false, false, null, 4095, null);
        r7.j(r12);
        r8 = r19;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:87:0x0302, code lost:
        ...
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs(r8, r9);
        r7.h(r3.b());
        r34.e.f368998a.g(r7, true);
        r3 = com.tencent.mm.plugin.sns.model.l4.Vi();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:92:0x0335, code lost:
        ...
        r3 = java.lang.Boolean.valueOf(r3.b1(r2.a().field_snsId, r2.a()));
     */
    /* JADX WARN: Code restructure failed: missing block: B:94:0x0348, code lost:
    
        r7 = new java.lang.StringBuilder();
        r7.append("doAdSwap, update ad ");
        r7.append(ca4.z0.t0(r12));
        r7.append(", ret=");
        r7.append(r3);
        r7.append(", createTime=");
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs(r43, r9);
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs(r43, r9);
        r7.append(r2.f416014a);
        com.tencent.mars.xlog.Log.i("AdSwapHelper", r7.toString());
        r4 = r4 + 1;
        r40 = r9;
        r2 = r23;
        r7 = r24;
    ...
    */
    public final int a(r45.i5 r45, java.util.LinkedList r46) {
        /*
            Method dump skipped, instructions count: 1047
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: t64.d.a(r45.i5, java.util.LinkedList):int");
    }

    public final java.util.List b(org.json.JSONArray jSONArray) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("parseSnsIdList", "com.tencent.mm.plugin.sns.ad.timeline.adop.AdSwapHelper");
        java.util.ArrayList arrayList = new java.util.ArrayList();
        int length = jSONArray.length();
        java.lang.String str = "";
        for (int i17 = 0; i17 < length; i17++) {
            long F0 = ca4.z0.F0(jSONArray.getString(i17));
            if (F0 == 0) {
                com.tencent.mars.xlog.Log.e("AdSwapHelper", "parseSnsIdList, snsId==0");
            } else {
                str = str + ',' + F0;
                arrayList.add(java.lang.Long.valueOf(F0));
            }
        }
        com.tencent.mars.xlog.Log.i("AdSwapHelper", "parseSnsIdList=" + str);
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("parseSnsIdList", "com.tencent.mm.plugin.sns.ad.timeline.adop.AdSwapHelper");
        return arrayList;
    }

    public final void c(com.tencent.mm.plugin.sns.storage.AdSnsInfo adSnsInfo) {
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markStartTimeMs("resetExpireTime", "com.tencent.mm.plugin.sns.ad.timeline.adop.AdSwapHelper");
        java.lang.String t07 = ca4.z0.t0(adSnsInfo.field_snsId);
        int currentTimeMillis = (int) (java.lang.System.currentTimeMillis() / 1000);
        com.tencent.mars.xlog.Log.i("AdSwapHelper", "resetExpireTime, snsId=" + t07 + ", geTime=" + currentTimeMillis);
        adSnsInfo.field_createAdTime = currentTimeMillis;
        if (adSnsInfo.field_exposureTime > 0) {
            adSnsInfo.field_exposureTime = currentTimeMillis;
        }
        com.tencent.mm.plugin.sns.ui.monitor.SnsMethodCalculate.markEndTimeMs("resetExpireTime", "com.tencent.mm.plugin.sns.ad.timeline.adop.AdSwapHelper");
    }
}
