...
public abstract class c {
    ...
    public static final int[] f294486a;

    /* renamed from: b, reason: collision with root package name */
    public static int f294487b;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f294488c;

    /* renamed from: d, reason: collision with root package name */
    public static boolean f294489d;

    static {
        int[] iArr;
        if (wo.v1.f447829i.f447706t != 1) {
        ...
        f294488c = true;
        f294489d = true;
        ((ku5.t0) ku5.t0.f312615d).g(it0.b.f294485d);
    }
    ...
    public static final boolean a() {
        ...
        for (int i18 = 0; i18 < i17; i18++) {
            try {
                ...
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.CameraHelper", e17, " error", new java.lang.Object[0]);
                return true;
            }
        }
        return z17 && z18;
    ...
    public static final boolean b() {
        ...
        if (g1Var == null || (i17 = g1Var.f447704r) == -1) {
            z17 = false;
        } else {
            z17 = true;
            if (i17 != 3) {
        ...
        if (fp.e0.f265183g == null) {
            fp.e0.f265183g = fp.e0.f265177a.contains("hmd global") ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE;
        }
        if (fp.e0.f265183g.booleanValue()) {
            return false;
        }
        if (fp.e0.f265184h == null) {
            fp.e0.f265184h = fp.e0.f265177a.contains("smartisan") ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE;
        }
        if (fp.e0.f265184h.booleanValue()) {
            return false;
        }
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.CameraHelper", "some device has some problem in LegecyCamera ");
            return false;
        } catch (java.lang.Exception unused2) {
            com.tencent.mars.xlog.Log.e("MicroMsg.CameraHelper", "a camera access exception happend");
            return false;
        }
    }
    ...
    public static final boolean c() {
        int i17;
        wo.g1 g1Var = wo.v1.f447829i;
        return (g1Var == null || (i17 = g1Var.f447708v) == -1) ? ((h62.d) ((e42.e0) i95.n0.c(e42.e0.class))).fj(e42.d0.clicfg_camera2_test_image_switch, false) : i17 == 1;
    }
    ...
    */
    ...
    public static final boolean e(int i17) {
        ...
        wo.g1 g1Var = wo.v1.f447829i;
        boolean z17 = true;
        if (!((g1Var == null || g1Var.f447705s == -1 || ((i18 = g1Var.f447704r) != 3 && i18 != 1)) ? false : true)) {
            return false;
        }
        ...
        if (!com.tencent.mm.sdk.platformtools.t8.K0(Zi)) {
            ...
            if (r26.n0.B(Zi, java.lang.String.valueOf(i17), false)) {
                com.tencent.mars.xlog.Log.i("MicroMsg.CameraHelper", "the scene = " + i17 + " is support record stream ");
                return z17;
            }
        }
        z17 = false;
