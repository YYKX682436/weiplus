...
public final class j implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ zu2.o f475715d;
    ...
    public final void onClick(android.view.View view) {
        ...
        zu2.o oVar = this.f475715d;
        com.tencent.mars.xlog.Log.i(oVar.f475724e, "click reason 2");
        ...
        java.util.Iterator it = oVar.f475729j.iterator();
        while (it.hasNext()) {
            jz5.l lVar = (jz5.l) it.next();
            android.widget.TextView textView = (android.widget.TextView) lVar.f302833d;
            if (textView != null) {
                textView.setTextColor(oVar.f475720a.getResources().getColor(com.tencent.mm.R.color.UN_BW_0_Alpha_0_9));
            }
            android.view.View view5 = (android.view.View) lVar.f302834e;
            if (view5 != null) {
                view5.setBackgroundResource(com.tencent.mm.R.drawable.f481528vn);
            }
        }
