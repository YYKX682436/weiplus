...
public class i extends p13.t {
    ...
    public final /* synthetic */ od2.k f344617q;
    ...
    public void p(p13.v vVar) {
        if (((com.tencent.mm.plugin.finder.storage.mj0) ((zy2.qb) i95.n0.c(zy2.qb.class))).isTeenMode()) {
            com.tencent.mars.xlog.Log.i("MicroMsg.FTS.FTS5SearchFinderFollowerLogic", "execSearch, isTeenModeAndViewNothing.");
            return;
        }
        ...
        android.database.Cursor H = this.f344617q.f344621f.H(vVar.f351159d, o13.d.f342220f, uVar.f351146h, null, true, true);
        while (H.moveToNext()) {
            try {
