...
public final class v0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ at2.y0 f13767d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.ViewGroup f13768e;

    public v0(at2.y0 y0Var, android.view.ViewGroup viewGroup) {
        this.f13767d = y0Var;
        this.f13768e = viewGroup;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        at2.y0 y0Var = this.f13767d;
        ((ct2.j) y0Var.business(ct2.j.class)).B = floatValue;
        at2.u1 u1Var = (at2.u1) y0Var.R6(at2.u1.class);
        if (u1Var != null && (a0Var = u1Var.f13762q) != null) {
            a0Var.f243158a.setPlaySpeed(floatValue);
        }
        y0Var.a7();
        org.json.JSONObject b17 = ml2.z0.b(ml2.z0.f328330a, null, 1, null);
        b17.put("select_type", java.lang.Float.valueOf(((ct2.j) y0Var.business(ct2.j.class)).B));
        ...
        at2.y0.Z6(y0Var);
        android.view.ViewGroup viewGroup = this.f13768e;
        db5.t7.m(viewGroup.getContext(), viewGroup.getContext().getResources().getString(com.tencent.mm.R.string.f1v));
