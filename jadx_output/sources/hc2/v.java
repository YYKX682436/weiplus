    ...
    */
    ...
    public static final java.util.List b(java.util.List cacheDataList, int i17) {
        ...
        for (java.lang.Object obj : cacheDataList) {
            ...
            if (i18 >= 2) {
                if (bu2.j.f24534a.i(i17, baseFinderFeed.getFeedObject().field_id)) {
                    break;
                }
                if (baseFinderFeed.getFeedObject().field_id != 0 && !i2Var.P6(i17, baseFinderFeed.getFeedObject().field_id)) {
