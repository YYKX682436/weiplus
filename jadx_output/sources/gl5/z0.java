...
public final class z0 implements java.lang.Runnable {
    ...
    public final /* synthetic */ gl5.d1 f273131d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ gl5.g0 f273132e;
    ...
    public final void run() {
        int[] iArr = new int[2];
        gl5.d1 d1Var = this.f273131d;
        d1Var.f272925b.l().getLocationOnScreen(iArr);
        int left = d1Var.c().getLeft();
        int top = d1Var.c().getTop();
        gl5.g0 g0Var = this.f273132e;
        int i17 = g0Var.f272999a + left;
        int i18 = g0Var.f273000b + top;
        int[] iArr2 = g0Var.f273001c;
        int i19 = iArr2[0] - iArr[0];
        int i27 = iArr2[1] - iArr[1];
        int intValue = ((java.lang.Number) ((jz5.n) d1Var.f272932i).getValue()).intValue();
        int h17 = i65.a.h(d1Var.f272924a, com.tencent.mm.R.dimen.f479672c9);
