...
public final class d {
    ...
    /* renamed from: a */
    public final ml2.z f327348a;

    /* renamed from: b */
    public final ml2.c0 f327349b;

    public d() {
        ml2.b bVar = new ml2.b(this);
        this.f327348a = new ml2.z(bVar);
        this.f327349b = new ml2.c0(bVar);
    }
    ...
    public final java.lang.String a(java.lang.String str, java.lang.String str2, java.lang.String str3) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("HABBYGE-MALI.Audience21053Report", "append extra " + str2 + " : " + str3 + " failed");
            return str;
        }
    }
    ...
    */
    public final java.lang.String b(com.tencent.mm.protocal.protobuf.FinderObject r12) {
        /*
            r11 = this;
            r0 = 0
            if (r12 == 0) goto L57
            com.tencent.mm.protocal.protobuf.FinderObjectDesc r1 = r12.getObjectDesc()
            r2 = 0
            r3 = 1
            if (r1 == 0) goto L14
        ...
        L18:
            if (r12 == 0) goto L57
            java.util.LinkedList r1 = r12.getFriendCommentList()
            if (r1 == 0) goto L2b
        ...
        L29:
            if (r1 != 0) goto L55
        L2b:
            r45.dm2 r12 = r12.getObject_extend()
            if (r12 == 0) goto L54
            r1 = 12
            com.tencent.mm.protobuf.f r12 = r12.getCustom(r1)
            ...
            if (r12 == 0) goto L54
            r1 = 3
            java.util.LinkedList r1 = r12.getList(r1)
            if (r1 == 0) goto L54
    ...
    public final java.lang.String c(long j17, long j18, java.lang.String str) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(Zi)) {
            ...
            Zi = java.lang.String.valueOf(eVar != null ? ((mm2.e1) eVar.a(mm2.e1.class)).f328993w : null);
            if (com.tencent.mm.sdk.platformtools.t8.K0(Zi)) {
                Zi = ((ml2.r0) i95.n0.c(ml2.r0.class)).f327881t;
            }
        }
    ...
    public final java.lang.String e(ml2.x1 x1Var, java.lang.String str) {
        if (x1Var != ml2.x1.f328202f && x1Var != ml2.x1.f328203g && x1Var != ml2.x1.f328207n && x1Var != ml2.x1.f328211r) {
            return str;
        }
        ...
        com.tencent.mars.xlog.Log.i("HABBYGE-MALI.Audience21053Report", "insertFullScreenStateToChnlExtra navigationBarHeight:" + d17 + " navigationBarHeight=" + d17);
    ...
    public final java.lang.String f(java.lang.String str, java.lang.String str2) {
        ...
        try {
            org.json.JSONObject jSONObject = str.length() == 0 ? new org.json.JSONObject() : new org.json.JSONObject(r26.i0.t(str, ";", ",", false));
            int i18 = com.tencent.mm.storage.z3.R4(str2) ? 2 : 1;
            if (!c01.e2.S(str2)) {
                i17 = 0;
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void g(androidx.recyclerview.widget.RecyclerView r63, ml2.x1 r64, java.lang.String r65, ml2.y r66, int r67, long r68, int r70) {
        /*
    ...
    public final void h(so2.j5 feed, int i17, ml2.x1 actionType, java.lang.String commentscene, java.lang.String clickSubTabContextId, java.lang.String chnlExtra) {
        ...
        boolean z17 = feed instanceof com.tencent.mm.plugin.finder.model.BaseFinderFeed;
        java.lang.String userName = z17 ? ((com.tencent.mm.plugin.finder.model.BaseFinderFeed) feed).getFeedObject().getUserName() : "";
        ...
        ml2.f0 f0Var = new ml2.f0(feed, userName, i17, q17, itemId, longValue, actionType, commentscene, intValue, b17, e0Var, true, ((java.lang.Boolean) a27).booleanValue(), 0, null, clickSubTabContextId, chnlExtra, null, 0L, null, 0, 0L, 0, null, null, null, 67002368, null);
        ae2.in inVar = ae2.in.f3688a;
        boolean z18 = ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.V0).getValue()).r()).intValue() == 1;
        if (z17 && z18) {
            i(f0Var, ((com.tencent.mm.plugin.finder.model.BaseFinderFeed) feed).getFeedObject().getFeedObject().getSessionBuffer());
        } else {
            i(f0Var, null);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0064, code lost:
        ...
        if (kotlin.jvm.internal.o.b(r4, "temp_9") != false) goto L466;
     */
    /* JADX WARN: Code restructure failed: missing block: B:12:0x006a, code lost:
    
        if (kotlin.jvm.internal.o.b(r4, "18") == false) goto L265;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:181:0x0265, code lost:
        ...
        com.tencent.mars.xlog.Log.i("HABBYGE-MALI.Audience21053Report", "onclick " + r0.getMessage());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x003e, code lost:
        ...
        if (kotlin.jvm.internal.o.b(r4, "temp_1") != false) goto L252;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0044, code lost:
    
        if (kotlin.jvm.internal.o.b(r4, "17") == false) goto L265;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x0056, code lost:
        ...
        if (kotlin.jvm.internal.o.b(r4, "temp_1") != false) goto L264;
     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x005c, code lost:
    
        if (kotlin.jvm.internal.o.b(r4, "17") != false) goto L465;
     */
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void j(ml2.x1 r23, int r24, java.lang.String r25, com.tencent.mm.plugin.finder.storage.FeedData r26, r45.qt2 r27) {
        /*
