...
public final class h implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ xu2.n f457205d;
    ...
    public final void onClick(android.view.View view) {
        ...
        xu2.n nVar = this.f457205d;
        com.tencent.mars.xlog.Log.i(nVar.f457215e, "click reason 2");
        android.view.ViewGroup viewGroup = nVar.f457216f;
        if (viewGroup != null) {
            viewGroup.setVisibility(0);
        }
        android.view.View view2 = nVar.f457217g;
        if (view2 != null) {
        ...
        java.util.Iterator it = nVar.f457221k.iterator();
        while (it.hasNext()) {
            jz5.l lVar = (jz5.l) it.next();
            android.widget.TextView textView = (android.widget.TextView) lVar.f302833d;
            if (textView != null) {
                textView.setTextColor(nVar.f457211a.getResources().getColor(com.tencent.mm.R.color.UN_BW_0_Alpha_0_9));
            }
            android.view.View view5 = (android.view.View) lVar.f302834e;
            if (view5 != null) {
                view5.setBackgroundResource(com.tencent.mm.R.drawable.f481677zt);
            }
        }
