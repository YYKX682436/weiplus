...
public final class n implements java.lang.Runnable {
    ...
    public final /* synthetic */ com.tencent.mm.view.drawer.TextStatusRecyclerViewDrawerSquares f43690d;

    public n(com.tencent.mm.view.drawer.TextStatusRecyclerViewDrawerSquares textStatusRecyclerViewDrawerSquares) {
        this.f43690d = textStatusRecyclerViewDrawerSquares;
    }

    @Override // java.lang.Runnable
    public final void run() {
        com.tencent.mm.view.drawer.TextStatusRecyclerViewDrawerSquares textStatusRecyclerViewDrawerSquares = this.f43690d;
        textStatusRecyclerViewDrawerSquares.setAlpha(1.0f);
