...
public final class h implements db5.r4 {
    ...
    public final /* synthetic */ java.util.List f401393a;
    ...
    public final void a(android.view.View view, int i17, android.view.MenuItem menuItem) {
        ...
        yz5.q qVar;
        java.util.Iterator it = this.f401393a.iterator();
        while (true) {
            if (!it.hasNext()) {
                obj = null;
                break;
        ...
        if (fVar2 == null || (qVar = fVar2.f401388e) == null) {
            return;
        }
        qVar.invoke(view, java.lang.Integer.valueOf(i17), menuItem);
    }
}
