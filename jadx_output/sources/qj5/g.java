...
public final class g implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ qj5.n f363971d;
    ...
    public final void onClick(android.view.View view) {
        ...
        qj5.n nVar = this.f363971d;
        if (nVar.f363987u2) {
            nVar.x();
            qj5.b bVar = qj5.n.I2;
            qj5.b bVar2 = qj5.n.I2;
            if (bVar2 != null) {
                ((com.tencent.mm.ui.feature.api.screenshot.h0) bVar2).b("generate_image_entry_btn", "view_clk");
            }
        } else {
            nVar.z();
            ...
            if (bVar4 != null) {
                ((com.tencent.mm.ui.feature.api.screenshot.h0) bVar4).b("restore_screenshot_btn", "view_clk");
            }
        }
