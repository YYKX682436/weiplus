...
public abstract class a {
    ...
    public static final int f451566a;

    /* renamed from: b, reason: collision with root package name */
    public static final int f451567b;

    /* JADX WARN: Can't wrap try/catch for region: R(12:1|2|3|(8:5|6|7|8|(3:10|11|12)|15|11|12)|18|6|7|8|(0)|15|11|12) */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0031, code lost:
    
        com.tencent.mars.xlog.Log.i("MicroMsg.SettingScreenBrightnessUtil", "getMinBrightness fail, fallback to 0");
     */
    ...
    static {
        ...
        L37:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: x24.a.<clinit>():void");
    }
    ...
    public static final int a(android.app.Activity activity) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.SettingScreenBrightnessUtil", "getScreenBrightness " + valueOf);
        if (valueOf == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.SettingScreenBrightnessUtil", "getScreenBrightness null, use system");
            return b(activity);
        }
        if (java.lang.Float.compare(-1.0f, valueOf.floatValue()) == 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.SettingScreenBrightnessUtil", "getScreenBrightness not set, use system");
            return b(activity);
        }
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.SettingScreenBrightnessUtil", "getScreenBrightness report " + b17);
        return b17;
    }
    ...
    public static final int b(android.app.Activity activity) {
        try {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.SettingScreenBrightnessUtil", "getSystemBrightness isAuto: " + z17 + ", systemBrightness: " + i17);
            int min = java.lang.Math.min(f451566a, i17);
            int i18 = f451567b;
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SettingScreenBrightnessUtil", e17, "getSystemBrightness no setting exception", new java.lang.Object[0]);
            return -3;
        } catch (java.lang.SecurityException e18) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SettingScreenBrightnessUtil", e18, "getSystemBrightness no permission exception", new java.lang.Object[0]);
            return -2;
        } catch (java.lang.Exception e19) {
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SettingScreenBrightnessUtil", e19, "getSystemBrightness other exception", new java.lang.Object[0]);
            return -4;
        }
    }

    public static final void c(float f17, android.app.Activity activity) {
        com.tencent.mars.xlog.Log.i("MicroMsg.SettingScreenBrightnessUtil", "setScreenBrightness value: %s, activity is %s", java.lang.Float.valueOf(f17), activity);
        if (activity == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.SettingScreenBrightnessUtil", "setScreenBrightness activity is null");
            return;
        }
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.SettingScreenBrightnessUtil", th6, "setScreenBrightness exception", new java.lang.Object[0]);
        }
    }
}
