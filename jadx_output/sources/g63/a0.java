...
public final class a0 implements l75.q0 {
    ...
    public final /* synthetic */ g63.f0 f269092d;
    ...
    public final void onNotifyChange(java.lang.String str, l75.w0 w0Var) {
        ...
        if (obj instanceof z53.i) {
            ...
            z53.n nVar = z53.o.f470261a;
            g63.f0 f0Var = this.f269092d;
            if (i17 == 1 || i17 == 2) {
                ...
                nVar.c(0, f0Var.f269107b.x(), new g63.z(f0Var));
            }
            java.util.Objects.toString(w0Var.f316976d);
        }
    }
}
