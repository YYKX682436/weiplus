...
public abstract class c {
    ...
    */
    ...
    public static void b(android.text.Spanned spanned, java.lang.StringBuilder sb6, int i17, int i18, java.util.SortedSet sortedSet) {
        while (i17 < i18) {
            ...
            if (i17 < spanStart) {
                ...
                boolean z17 = characterStyle instanceof com.tencent.mm.plugin.component.editor.model.nativenote.spans.BoldSpan;
                if (z17) {
                    sb6.append("<wx-b>");
                } else {
                    ...
                    if (z18 && ((android.text.style.StyleSpan) characterStyle).getStyle() == 1) {
                        ...
                        sb6.append(java.lang.Math.round(((int) (((android.text.style.RelativeSizeSpan) characterStyle).getSizeChange() * nx1.q.f341320d)) / nx1.q.a()));
                        sb6.append("px\">");
    ...
    public static void d(java.util.Stack stack, java.lang.StringBuilder sb6, px1.a aVar) {
        ...
        int i19 = aVar.f358817b;
        px1.p pVar2 = aVar.f358816a;
        if (i19 > i17) {
            int i27 = i19 - i17;
            aVar.f358818c = i27;
            java.lang.String str = pVar2.f358841d;
            while (i18 < i27) {
                sb6.append(str);
                i18++;
            }
        ...
        if (i19 < i17) {
            ...
            int e17 = e(stack, sb6);
            aVar.f358818c = e17;
            java.lang.String str2 = pVar2.f358841d;
            while (i18 < e17) {
                sb6.append(str2);
                i18++;
            }
    ...
    public static int e(java.util.Stack stack, java.lang.StringBuilder sb6) {
        ...
        java.lang.String str = aVar.f358816a.f358842e;
        int i17 = aVar.f358818c;
        for (int i18 = 0; i18 < i17; i18++) {
            sb6.append(str);
        }
        return aVar.f358818c;
    }
}
