...
public class k implements android.text.Html.TagHandler {
    ...
    public static final java.util.regex.Pattern f322042c = java.util.regex.Pattern.compile("\\d+");

    /* renamed from: d, reason: collision with root package name */
    public static final java.util.regex.Pattern f322043d = java.util.regex.Pattern.compile("#[a-f0-9]+");

    /* renamed from: e, reason: collision with root package name */
    public static final java.util.HashMap f322044e;

    /* renamed from: a, reason: collision with root package name */
    public final java.util.Stack f322045a = new java.util.Stack();

    /* renamed from: b, reason: collision with root package name */
    public final java.util.HashMap f322046b = new java.util.HashMap();
    ...
    public static int b(java.lang.String str) {
        int i17;
        int i18;
        java.lang.Integer num = (java.lang.Integer) f322044e.get(str.toLowerCase());
        if (num != null) {
            return num.intValue();
        }
        try {
    ...
    */
    public final void a(boolean r7) {
        /*
            r6 = this;
            java.util.Stack r0 = r6.f322045a
            boolean r1 = r0.isEmpty()
            if (r1 != 0) goto L4b
            java.lang.Object r1 = r0.peek()
            px1.a r1 = (px1.a) r1
            px1.p r2 = r1.f358816a
            r3 = 0
            r4 = 1
            if (r7 == 0) goto L20
            r2.getClass()
    ...
    public final void d(boolean z17, px1.p pVar) {
        ...
        java.util.Stack stack = this.f322045a;
        px1.a aVar = stack.isEmpty() ? null : (px1.a) stack.peek();
        if (aVar == null) {
            stack.push(new px1.a(pVar, 1, 1));
        } else if (aVar.f358816a != pVar) {
            stack.push(new px1.a(pVar, aVar.f358817b + 1, 1));
        } else {
            aVar.f358817b++;
            aVar.f358818c++;
        }
