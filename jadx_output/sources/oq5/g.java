...
public final class g {
    ...
    public static final oq5.g f347413a = new oq5.g();
        ...
        for (java.util.Map.Entry entry : linkedHashMap.entrySet()) {
            if (entry.getKey() != null) {
                ...
                if ((((java.lang.CharSequence) key).length() > 0) && (!((java.util.Collection) entry.getValue()).isEmpty())) {
                    ...
                    com.tencent.mars.xlog.Log.w("MicroMsg.LogcatInspector", "LogcatLeaking: " + size);
                    ...
                    for (java.lang.String str2 : K0) {
                        com.tencent.mars.xlog.Log.w("MicroMsg.LogcatInspector", "LogcatLeaking: " + str2);
