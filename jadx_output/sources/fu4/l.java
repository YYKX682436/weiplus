...
public class l implements d50.o {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.walletlock.model.f f266904a;

    public l(fu4.n nVar, com.tencent.mm.plugin.walletlock.model.f fVar) {
        this.f266904a = fVar;
    }
    ...
    public void b(eu5.a aVar) {
        ...
        this.f266904a.onResult(aVar.f475605a, aVar.f475606b);
    }
    ...
    public void c(int i17, eu5.a aVar) {
        ...
        com.tencent.mm.plugin.walletlock.model.f fVar = this.f266904a;
        if (i17 == 1) {
            if (fVar != null) {
                fVar.onResult(1, "not match");
                return;
            }
            return;
        }
