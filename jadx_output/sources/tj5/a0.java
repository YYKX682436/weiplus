...
public final class a0 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.ui.search.WeAppWebSearchView f419833d;

    public a0(com.tencent.mm.ui.search.WeAppWebSearchView weAppWebSearchView) {
        this.f419833d = weAppWebSearchView;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        tj5.y yVar = this.f419833d.f209851m;
        if (yVar != null) {
            kotlin.jvm.internal.o.d(view);
            yVar.onClickCancelBtn(view);
        }
