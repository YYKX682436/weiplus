...
public class b extends r06.r implements z06.a {
    ...
    public z06.a L(f26.o0 o0Var, java.util.List list, f26.o0 o0Var2, jz5.l lVar) {
        ...
        z06.b u07 = u0(e(), null, j(), null, getAnnotations(), getSource());
        if (o0Var != null) {
            int i17 = p06.k.Z0;
            r1Var = r16.h.h(u07, o0Var, p06.i.f350765a);
        }
        u07.x0(r1Var, this.f368463p, kz5.p0.f313996d, getTypeParameters(), z06.k.a(list, W(), u07), o0Var2, f(), getVisibility());
        if (lVar != null) {
            u07.z0((o06.a) lVar.f302833d, lVar.f302834e);
        }
        return u07;
    }
