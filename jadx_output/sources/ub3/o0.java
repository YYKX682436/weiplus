...
public class o0 implements android.animation.ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.luckymoney.f2f.ui.ShuffleView f426126d;

    public o0(com.tencent.mm.plugin.luckymoney.f2f.ui.ShuffleView shuffleView) {
        this.f426126d = shuffleView;
    }
    ...
    public void onAnimationUpdate(android.animation.ValueAnimator valueAnimator) {
        ...
        int i17 = 0;
        com.tencent.mm.plugin.luckymoney.f2f.ui.ShuffleView shuffleView = this.f426126d;
        if (floatValue != 0.0f) {
