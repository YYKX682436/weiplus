...
public class w2 implements wf0.w1 {
    ...
    public static final kk.l f415056c = new kk.l(20);

    /* renamed from: a, reason: collision with root package name */
    public final l75.k0 f415057a;

    /* renamed from: b, reason: collision with root package name */
    public final l75.v0 f415058b;

    public w2(l75.k0 k0Var) {
        t21.x2 x2Var = new t21.x2(this);
        this.f415058b = x2Var;
        x2Var.a(new t21.w2$$a(), android.os.Looper.getMainLooper());
        this.f415057a = k0Var;
        t21.b3.f414706a.forEach(new java.util.function.Consumer() { // from class: t21.w2$$b
            ...
            public final void accept(java.lang.Object obj) {
                ...
                l75.k0 k0Var2 = w2Var.f415057a;
                java.lang.String str = a3Var.f414701a;
                java.util.ArrayList arrayList = t21.b3.f414706a;
                ...
                bVar.b(new qt0.e(k0Var2, strArr, a3Var.f414701a, "videoinfo", 1));
            }
        });
    }
    ...
    public static int E(java.lang.String str, int i17, byte[] bArr) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + " invalid fileName");
            a17 = fp.k.a();
        } else if (i17 < 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + "[" + str + "]  invalid startOffset:" + i17);
            a17 = fp.k.a();
        } else {
            if (!com.tencent.mm.sdk.platformtools.t8.M0(bArr)) {
                ...
                try {
                    try {
                        ...
                        com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + "[" + str + "] \t\tOffset:" + i17 + " failed:[" + e17.getMessage() + "]");
                        int a18 = 0 - fp.k.a();
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + "[" + str + "]  invalid writeBuf");
            a17 = fp.k.a();
        }
        return 0 - a17;
    }
    ...
    public static java.lang.String p() {
        ...
        com.tencent.mm.vfs.r6 h07 = lp0.b.h0("media");
        if (!h07.m()) {
            h07.J();
        }
        com.tencent.mm.vfs.r6 r6Var = new com.tencent.mm.vfs.r6(h07.o() + "/video");
        if (!r6Var.m()) {
            r6Var.J();
        }
        return r6Var.o();
    ...
    public static t21.z2 y(java.lang.String str, int i17, int i18) {
        ...
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + " invalid fileName");
            z2Var.f415075d = 0 - fp.k.a();
            return z2Var;
        }
        if (i17 < 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + "[" + str + "]  invalid readOffset:" + i17);
            z2Var.f415075d = 0 - fp.k.a();
            return z2Var;
        }
        if (i18 <= 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + "[" + str + "]  invalid readLen");
            z2Var.f415075d = 0 - fp.k.a();
            return z2Var;
        }
        fp.j jVar = new fp.j();
        z2Var.f415072a = new byte[i18];
        java.io.RandomAccessFile randomAccessFile = null;
        try {
            try {
                ...
                randomAccessFile.seek(i17);
                jVar.a();
                int read = randomAccessFile.read(z2Var.f415072a, 0, i18);
                jVar.a();
                jVar.a();
                if (read < 0) {
                    read = 0;
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "ERR:" + fp.k.c() + "[" + str + "] \t\tOffset:" + z2Var.f415074c + " failed:[" + e17.getMessage() + "]");
                z2Var.f415075d = 0 - fp.k.a();
                if (randomAccessFile != null) {
                    try {
                        randomAccessFile.close();
    ...
    public void A(wf0.u1 u1Var) {
        this.f415058b.j(u1Var);
    }

    public boolean B(java.lang.String str, java.lang.String str2, java.lang.String str3) {
        long j17;
        if (ih.a.h("clicfg_video_service_ignore_hash", true) || com.tencent.mm.sdk.platformtools.t8.K0(str2) || com.tencent.mm.sdk.platformtools.t8.K0(str3)) {
            return false;
        }
        java.lang.String str4 = str2 + "##" + str3;
        com.tencent.mars.xlog.Log.i("MicroMsg.VideoInfoStorage", "saveVideoHash path:%s xml:%s stack:%s", str, str4, new com.tencent.mm.sdk.platformtools.z3());
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        if (com.tencent.mm.sdk.platformtools.t8.K0(str) || com.tencent.mm.sdk.platformtools.t8.K0(str4)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "saveVideoHash failed , path:%s xml:%s", str, str4);
        } else {
            int[] f17 = f(str);
            if (f17 != null && f17.length >= 33) {
                ...
                if (vector.size() == 1 && str4.equals(vector.get(0))) {
                    com.tencent.mars.xlog.Log.w("MicroMsg.VideoInfoStorage", "saveVideoHash Check exist now return,time:%d,  path:%s,hash:%s, xml:%s", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - currentTimeMillis), str, stringBuffer.toString(), str4);
                    return true;
                }
                if (vector.size() >= 1) {
                    j17 = currentTimeMillis;
                    com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 102, java.lang.Integer.valueOf(i17), "", "", java.lang.Integer.valueOf(vector.size()));
                    com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "saveVideoHash Err Check  xml diff OR  select more than one row,  rowCount:%d size:%d ", java.lang.Integer.valueOf(vector.size()), java.lang.Integer.valueOf(i17));
                ...
                contentValues.put("CreateTime", java.lang.Long.valueOf(com.tencent.mm.sdk.platformtools.t8.i1()));
                ...
                com.tencent.mars.xlog.Log.i("MicroMsg.VideoInfoStorage", "summersafecdn saveVideoHash time:%d insert:%d path:%s hash:%s xml:%s", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - j17), java.lang.Long.valueOf(l17), str, stringBuffer, str4);
                if (l17 < 0) {
                    com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 103, java.lang.Integer.valueOf(i17));
                    com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "saveVideoHash insert failed :%d  path:%s", java.lang.Long.valueOf(l17), str);
                }
                return true;
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "saveVideoHash  readHash failed :%s", str);
        }
        return false;
    }
    ...
    public boolean C(t21.v2 v2Var) {
        ...
        if (android.text.TextUtils.isEmpty(v2Var.f415020r)) {
            v2Var.n("");
        }
        pt0.p.G6(v2Var.f415016n, v2Var.f415020r);
        pt0.p.G6(v2Var.K, v2Var.L);
        android.content.ContentValues b17 = v2Var.b();
        if (b17.size() <= 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "update failed, no values set");
        } else {
            if (this.f415057a.p(t21.b3.a(v2Var.d()), b17, "filename= ?", new java.lang.String[]{v2Var.d()}) > 0) {
                ...
                wf0.r1 r1Var = new wf0.r1(v2Var.d(), wf0.s1.UPDATE, t1Var, v2Var.f415026x, v2Var.f415027y);
                l75.v0 v0Var = this.f415058b;
                v0Var.d(r1Var);
                v0Var.c();
                return true;
            }
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "update failed, fileName:%s", v2Var.d());
        }
        return false;
    }
    ...
    public boolean D(java.lang.String str, long j17) {
        ...
        return this.f415057a.p(t21.b3.a(str), contentValues, "filename= ?", new java.lang.String[]{str}) > 0;
    }

    public void b(wf0.u1 u1Var, android.os.Looper looper) {
        this.f415058b.a(u1Var, looper);
    }

    public boolean c(java.lang.String str, java.lang.String str2) {
        z(str2);
        if (this.f415057a.delete(t21.b3.a(str), "filename= ?", new java.lang.String[]{"" + str}) <= 0) {
            return false;
        }
    ...
    public boolean d(java.lang.String str) {
        if (android.text.TextUtils.isEmpty(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "deleteSnsAdByMediaId >> media is no valid");
            return false;
        }
        z(str);
        int delete = this.f415057a.delete("videoinfo2", "media_id= ?", new java.lang.String[]{str});
        com.tencent.mars.xlog.Log.i("MicroMsg.VideoInfoStorage", "deleteSnsAdByMediaId >> %s, %d", str, java.lang.Integer.valueOf(delete));
        return delete > 0;
    }
    ...
    */
    public final int[] f(java.lang.String r17) {
        /*
            ...
            long r4 = com.tencent.mm.vfs.w6.k(r17)
            int r4 = (int) r4
        ...
        L20:
            ...
            com.tencent.mm.vfs.z7 r14 = com.tencent.mm.vfs.z7.a(r17)     // Catch: java.lang.Throwable -> L75 java.lang.Exception -> L78
            java.io.RandomAccessFile r14 = com.tencent.mm.vfs.w6.A(r14, r10)     // Catch: java.lang.Throwable -> L75 java.lang.Exception -> L78
            r15 = r10
        L34:
            if (r15 >= r5) goto L50
            int r5 = r15 * r11
        ...
        L50:
            ...
            com.tencent.mars.xlog.Log.i(r8, r5, r6)     // Catch: java.lang.Exception -> L73 java.lang.Throwable -> L91
        ...
        L7a:
            ...
            java.lang.String r0 = com.tencent.mm.sdk.platformtools.z3.c(r0)     // Catch: java.lang.Throwable -> L91
            r3[r9] = r0     // Catch: java.lang.Throwable -> L91
            com.tencent.mars.xlog.Log.e(r8, r2, r3)     // Catch: java.lang.Throwable -> L91
            if (r14 == 0) goto L8f
        ...
        L99:
            ...
            com.tencent.mars.xlog.Log.e(r8, r1, r0)
    ...
    public t21.v2 g(java.lang.String str) {
        ...
        try {
            ...
            sb6.append(str2);
            sb6.append("'");
            android.database.Cursor f17 = this.f415057a.f(sb6.toString(), null, 2);
            if (f17 == null) {
                return null;
            }
            if (f17.moveToFirst()) {
    ...
    public java.util.List h(com.tencent.mm.storage.f9 f9Var, java.lang.String str) {
        java.util.ArrayList arrayList = new java.util.ArrayList();
        if (str == null || android.text.TextUtils.isEmpty(str)) {
            try {
                return f9Var.I0() > 0 ? l(f9Var) : j(f9Var);
            } catch (java.lang.Exception e17) {
                com.tencent.mars.xlog.Log.printErrStackTrace("MicroMsg.VideoInfoStorage", e17, "getByMsg error[%s]", e17.toString());
                return arrayList;
            }
        }
        t21.v2 g17 = g(str);
    ...
    public java.lang.String[] i(java.lang.String str, int i17) {
        ...
        com.tencent.mars.xlog.Log.i("MicroMsg.VideoInfoStorage", "checkVideoHash in fullCheckRatio:%s path:%s stack:%s", valueOf, str, new com.tencent.mm.sdk.platformtools.z3());
        long currentTimeMillis = java.lang.System.currentTimeMillis();
        java.lang.String str3 = "";
        if (com.tencent.mm.sdk.platformtools.t8.K0(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "checkVideoHash failed , path:%s ", str);
        } else {
            int[] f17 = f(str);
            if (f17 == null || f17.length < 33) {
                str2 = "";
                com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "checkVideoHash  readHash failed :%s", str);
            } else {
                java.lang.String str4 = "delete from VideoHash where CreateTime < " + (com.tencent.mm.sdk.platformtools.t8.i1() - 432000);
                l75.k0 k0Var2 = this.f415057a;
                ...
                while (true) {
                    ...
                    if (com.tencent.mm.sdk.platformtools.t8.K0(string) || com.tencent.mm.sdk.platformtools.t8.K0(string2)) {
                        ...
                        iArr = f17;
                        i18 = length;
                        com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 104, java.lang.Integer.valueOf(i19));
                        com.tencent.mars.xlog.Log.w("MicroMsg.VideoInfoStorage", "checkVideoHash select error [%s][%s]", string, string2);
                    } else {
                        iArr = f17;
                        if (length != string.length()) {
                            com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 105, java.lang.Integer.valueOf(i19));
                            com.tencent.mars.xlog.Log.w("MicroMsg.VideoInfoStorage", "checkVideoHash err length file:%d cursor:%d", java.lang.Integer.valueOf(length), java.lang.Integer.valueOf(string.length()));
                            j17 = currentTimeMillis;
                            i18 = length;
                        } else {
                            j17 = currentTimeMillis;
                ...
                if (i29 < 0 || vector3.size() <= 0) {
                    com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 201, java.lang.Integer.valueOf(i19));
                    com.tencent.mars.xlog.Log.w("MicroMsg.VideoInfoStorage", "checkVideoHash cursor empty maxHitIndex:%d vector:%d", java.lang.Integer.valueOf(i29), java.lang.Integer.valueOf(vector3.size()));
                } else {
                    int intValue = ((java.lang.Integer) vector3.get(i29)).intValue();
                    int i47 = (intValue * 100) / 256;
                    if (i47 < 77) {
                        com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 202, java.lang.Integer.valueOf(i19), java.lang.Integer.valueOf(intValue), 0, java.lang.Integer.valueOf(vector4.size()));
                        com.tencent.mars.xlog.Log.w("MicroMsg.VideoInfoStorage", "checkVideoHash NotEnoughHit. time:%d hit:%d percentMatch:%s arr:%d path:%s", java.lang.Long.valueOf(java.lang.System.currentTimeMillis() - j19), java.lang.Integer.valueOf(intValue), java.lang.Integer.valueOf(i47), java.lang.Integer.valueOf(iArr2.length - 1), str);
                    } else {
                        ...
                        if (i48 > 0) {
                            ...
                            com.tencent.mm.plugin.report.service.g0.INSTANCE.d(12696, 203, java.lang.Integer.valueOf(i19), java.lang.Integer.valueOf(intValue), 0, java.lang.Integer.valueOf(vector4.size()), 0, "", "", "", java.lang.Integer.valueOf(i48));
                            com.tencent.mars.xlog.Log.e("MicroMsg.VideoInfoStorage", "checkVideoHash Not ONE hash hit this path, give up duplicate:%s path:%s", java.lang.Integer.valueOf(i48), str);
                        } else {
                            long currentTimeMillis2 = java.lang.System.currentTimeMillis() - j19;
                            long k17 = com.tencent.mm.sdk.platformtools.t8.k1((java.lang.Long) vector4.get(i29), 0L);
                            ...
                            com.tencent.mars.xlog.Log.i("MicroMsg.VideoInfoStorage", "checkVideoHash Succ time:%s hit:%s match:%s%% savetime:%s path:%s xml:%s orgpath:%s", java.lang.Long.valueOf(currentTimeMillis2), java.lang.Integer.valueOf(intValue), java.lang.Integer.valueOf(i47), java.lang.Long.valueOf(k17), str, str9, vector2.get(i29));
                            ...
                            com.tencent.mars.xlog.Log.i("MicroMsg.VideoInfoStorage", "checkVideoHashByteDiff should:%s now:%s ratio:%s percentMatch:%s debuger:%s", java.lang.Boolean.valueOf(z18), java.lang.Long.valueOf(currentTimeMillis3), java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i47), java.lang.Boolean.valueOf(z65.c.a()));
                            if (z18 || z65.c.a()) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List j(com.tencent.mm.storage.f9 r7) {
        /*
            r6 = this;
            ...
            com.tencent.mm.sdk.platformtools.t8.n(r1)     // Catch: java.lang.Exception -> L6a
            r4.append(r1)     // Catch: java.lang.Exception -> L6a
            java.lang.String r1 = "' AND "
            r4.append(r1)     // Catch: java.lang.Exception -> L6a
            r4.append(r3)     // Catch: java.lang.Exception -> L6a
            r4.append(r0)     // Catch: java.lang.Exception -> L6a
            long r0 = r7.getMsgId()     // Catch: java.lang.Exception -> L6a
            r4.append(r0)     // Catch: java.lang.Exception -> L6a
            java.lang.String r7 = r4.toString()     // Catch: java.lang.Exception -> L6a
            l75.k0 r0 = r6.f415057a     // Catch: java.lang.Exception -> L6a
            r1 = 2
        ...
        L6a:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r1, r7, r3, r0)
            return r2
        */
    ...
    */
    public final java.util.List k(oi3.g r9) {
        /*
            ...
            r2 = 0
            r3 = 0
            int r4 = r9.f345617d     // Catch: java.lang.Throwable -> L87 java.lang.Exception -> L89
            int r4 = r4 + 3
            java.lang.String r4 = r9.getString(r4)     // Catch: java.lang.Throwable -> L87 java.lang.Exception -> L89
            int r5 = r9.f345617d
            ...
            com.tencent.mm.sdk.platformtools.t8.n(r1)     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            r6.append(r1)     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            java.lang.String r1 = "' AND "
            r6.append(r1)     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            r6.append(r4)     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            ...
            int r5 = r5 + r2
            long r0 = r9.getLong(r5)     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            r6.append(r0)     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            java.lang.String r9 = r6.toString()     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            l75.k0 r0 = r8.f415057a     // Catch: java.lang.Throwable -> L7f java.lang.Exception -> L81
            r1 = 2
        ...
        L8c:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r1, r0, r4, r5)     // Catch: java.lang.Throwable -> La2
            if (r9 == 0) goto La1
            r9.close()
        La1:
            return r3
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List l(com.tencent.mm.storage.f9 r7) {
        /*
            r6 = this;
    ...
    */
    public final java.util.List m(oi3.g r9) {
        ...
        L8c:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r1, r0, r4, r2)     // Catch: java.lang.Throwable -> La2
            if (r9 == 0) goto La1
            r9.close()
        La1:
            return r3
    ...
    public java.util.List n(int i17) {
        ...
        java.util.Iterator it = t21.b3.f414706a.iterator();
        while (it.hasNext()) {
            java.lang.String str2 = ((t21.a3) it.next()).f414701a;
            if (i17 <= 0) {
                str = " ) ";
            } else {
                str = " LIMIT " + i17 + " )";
            ...
            try {
                cursor = this.f415057a.f(str3, null, 2);
    ...
    */
    public java.util.List o(int r9, int r10, long r11) {
        /*
            ...
            r0.<init>()
            java.util.ArrayList r1 = t21.b3.f414706a
        ...
        Lb:
            ...
            t21.a3 r2 = (t21.a3) r2
            java.lang.String r2 = r2.f414701a
            ...
            r3.<init>()
            r4 = 0
            l75.k0 r5 = r8.f415057a     // Catch: java.lang.Throwable -> L66 java.lang.Exception -> L68
            r6 = 2
        ...
        L68:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r5, r2, r6, r7)     // Catch: java.lang.Throwable -> L66
            if (r4 == 0) goto L78
        L75:
            r4.close()
        L78:
    ...
    public android.database.Cursor w(int i17, com.tencent.wcdb.support.CancellationSignal cancellationSignal) {
        l75.k0 k0Var = this.f415057a;
        if (k0Var == null) {
            return null;
        }
        return k0Var.d(false, "videoinfo2", new java.lang.String[]{com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_FILENAME, "forward_msg_local_id", "msglocalid", "msgsvrid"}, "msg_talker IS NULL", new java.lang.String[0], null, null, null, i17 + "", cancellationSignal);
    }
    ...
    public boolean x(t21.v2 v2Var, boolean z17) {
        ...
        v2Var.U = -1;
        android.content.ContentValues b17 = v2Var.b();
        if (((int) this.f415057a.l(t21.b3.a(v2Var.d()), com.tencent.mm.plugin.mmsight.segment.FFmpegMetadataRetriever.METADATA_KEY_FILENAME, b17)) == -1) {
            return false;
        }
        if (!z17) {
            return true;
        }
        wf0.r1 r1Var = new wf0.r1(v2Var.d(), wf0.s1.INSERT, wf0.t1.NORMAL, v2Var.f415026x, v2Var.f415027y);
        l75.v0 v0Var = this.f415058b;
        v0Var.d(r1Var);
        v0Var.c();
        return true;
