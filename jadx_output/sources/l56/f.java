...
public abstract class f {
    ...
    public final java.lang.String f316681a;

    /* renamed from: b, reason: collision with root package name */
    public final l56.j f316682b;

    /* renamed from: c, reason: collision with root package name */
    public final l56.e f316683c = new l56.e();

    /* renamed from: d, reason: collision with root package name */
    public final l56.e f316684d = new l56.e();

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Map f316685e = new java.util.HashMap();

    /* renamed from: f, reason: collision with root package name */
    public java.net.HttpURLConnection f316686f;
    ...
    public l56.g a() {
        java.net.HttpURLConnection httpURLConnection = this.f316686f;
        l56.j jVar = this.f316682b;
        httpURLConnection.setRequestMethod(jVar.name());
        java.net.HttpURLConnection httpURLConnection2 = this.f316686f;
        java.util.HashMap hashMap = (java.util.HashMap) this.f316685e;
        ...
        if (jVar.equals(l56.j.PUT) || jVar.equals(l56.j.POST)) {
            java.net.HttpURLConnection httpURLConnection3 = this.f316686f;
            try {
                byte[] bytes = this.f316684d.a().getBytes(java.nio.charset.Charset.defaultCharset().name());
        ...
        return new l56.g(this.f316686f);
    }

    public java.lang.String b() {
        l56.e eVar = this.f316683c;
        eVar.getClass();
        java.lang.String str = this.f316681a;
    ...
    public l56.g c() {
        try {
            ...
            if (this.f316686f == null) {
                java.lang.System.setProperty("http.keepAlive", "false");
                this.f316686f = (java.net.HttpURLConnection) new java.net.URL(b17).openConnection();
            }
            return a();
