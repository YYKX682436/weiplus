...
public class g {
    ...
    public final int f316687a;

    /* renamed from: b, reason: collision with root package name */
    public java.lang.String f316688b;

    /* renamed from: c, reason: collision with root package name */
    public final java.io.InputStream f316689c;

    public g(java.net.HttpURLConnection httpURLConnection) {
        boolean z17;
        try {
            httpURLConnection.connect();
            this.f316687a = httpURLConnection.getResponseCode();
            ...
            int i17 = this.f316687a;
            if (i17 >= 200 && i17 < 400) {
                z17 = true;
            }
            this.f316689c = z17 ? httpURLConnection.getInputStream() : httpURLConnection.getErrorStream();
    ...
    public java.lang.String a() {
        int read;
        java.lang.String str = this.f316688b;
        if (str == null) {
            java.io.InputStream inputStream = this.f316689c;
            n56.c.b(inputStream, "Cannot get String from a null object");
            try {
                char[] cArr = new char[65536];
                java.lang.StringBuilder sb6 = new java.lang.StringBuilder();
                java.io.InputStreamReader inputStreamReader = new java.io.InputStreamReader(inputStream, com.tencent.mapsdk.internal.rv.f51270c);
                do {
