...
public class d implements i7.e {
    ...
    public w6.z0 a(w6.z0 z0Var, t6.l lVar) {
        byte[] bArr;
        java.nio.ByteBuffer asReadOnlyBuffer = ((s6.f) ((h7.f) z0Var.get()).f279333d.f279332a.f279349a).f403296d.asReadOnlyBuffer();
        ...
        if (bVar != null && bVar.f360287a == 0) {
            if (bVar.f360288b == bVar.f360289c.length) {
