...
public class f implements yj0.b {
    ...
    public final /* synthetic */ g52.h f268896a;
    ...
    public void b(java.lang.String str, java.lang.String str2, java.lang.String str3, java.lang.String str4, java.lang.String str5, java.lang.Object obj, java.lang.Object[] objArr) {
        ...
        g52.h hVar = this.f268896a;
        if (equals) {
            if (objArr[0] instanceof android.content.Intent) {
                com.tencent.mars.xlog.Log.i("HABBYGE-MALI.HellActivityStub", "mOnActivityListener, startActivity: %s, %s, %s, %d, %s", str, str2, obj.getClass().getName(), java.lang.Integer.valueOf(obj.hashCode()), "from: mContextListener");
        ...
        if ("startActivities".equals(str4)) {
            ...
            if (obj2 instanceof android.content.Intent[]) {
                ...
                if (intentArr.length > 0) {
                    com.tencent.mars.xlog.Log.i("HABBYGE-MALI.HellActivityStub", "mOnActivityListener, startActivities: %s, %s, %s, %d, %s", str, str2, obj.getClass().getName(), java.lang.Integer.valueOf(obj.hashCode()), "from: mContextListener");
                    g52.i iVar2 = hVar.f268898a;
                    if (iVar2 != null) {
