...
public final class a1 {
    ...
    public static final mn2.a1 f329907a = new mn2.a1();
    ...
    */
    public final hp0.d a(java.lang.String r9) {
        ...
        L45:
            if (r5 == 0) goto L6e
            mn2.a1 r9 = mn2.a1.f329907a     // Catch: java.lang.Exception -> L72
            ...
            com.tencent.mars.xlog.Log.w(r3, r9)     // Catch: java.lang.Exception -> L72
            return r4
        L6b:
            jz5.f0 r0 = jz5.f0.f302826a     // Catch: java.lang.Exception -> L72
            goto L6f
        L6e:
            r0 = r4
        L6f:
    ...
    public final java.net.HttpURLConnection b(java.lang.String url) {
        ...
        com.tencent.mars.xlog.Log.i("Finder.ImageDownloader", "[openConnection] url:".concat(url));
        ...
        com.tencent.mars.xlog.Log.i("Finder.ImageDownloader", "[openConnection] contentLength=" + httpURLConnection.getContentLength() + " responseCode=" + httpURLConnection.getResponseCode() + " responseMessage=" + httpURLConnection.getResponseMessage() + " url:" + url + ' ');
