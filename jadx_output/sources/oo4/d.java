...
public final class d {
    ...
    public static final oo4.d f347197a = new oo4.d();

    /* renamed from: b, reason: collision with root package name */
    public static final java.util.List f347198b = kz5.c0.i(13, 14, 16);

    /* renamed from: c, reason: collision with root package name */
    public static final jz5.g f347199c = jz5.h.b(oo4.c.f347196d);
    ...
    public final r45.ej2 c(bw5.jr reportInfoScene) {
        ...
        return com.tencent.mm.plugin.finder.report.p2.f125237a.m(reportInfoScene);
    }
    ...
    public final java.util.Map d(android.os.Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderRefFeedId by parse:" + j17);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderRefFeedId by default");
        }
        int i18 = 0;
        if (bundle != null) {
            i17 = bundle.getInt("key_ref_enter_scene", 0);
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderRefEnterScene by parse:" + i17);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderRefEnterScene by default:");
            i17 = 0;
        }
        ...
        if (bundle != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderContextId by parse:" + str);
        ...
        if (bundle != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderContextId by parse:" + str2);
        ...
        if (bundle != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderCommentScene by parse:" + i18);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getFinderCommentScene by default:");
        }
        ...
        if (bundle != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getEditId by parse:" + str3);
            kotlin.jvm.internal.o.d(str3);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getEditId by default");
            str3 = "";
        }
        lVarArr[5] = new jz5.l("editid", str3);
        if (bundle != null) {
            str4 = bundle.getString("KEY_TEMPLATE_ID", "");
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getTemplateId by parse:" + str4);
            kotlin.jvm.internal.o.d(str4);
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.TimelineEditorModelParser", "getTemplateId by default");
        }
    ...
    public final java.util.Map e(java.lang.String str, com.tencent.mm.plugin.recordvideo.model.audio.AudioCacheInfo audioCacheInfo) {
        if (audioCacheInfo == null) {
            return new java.util.LinkedHashMap();
        }
        r45.pg4 pg4Var = audioCacheInfo.A;
        java.lang.String str2 = pg4Var != null ? pg4Var.f383024m : null;
        if (str2 == null) {
            str2 = "";
        }
        java.lang.String e17 = audioCacheInfo.e();
    ...
    */
    public final void g(com.tencent.mm.plugin.recordvideo.model.audio.AudioCacheInfo r17, bw5.jr r18, java.lang.String r19) {
        /*
    ...
    public final void j(int i17, java.lang.String viewId, android.os.Bundle bundle, java.util.Map dynamicMap, android.view.View view, boolean z17, boolean z18) {
        ...
        kotlin.jvm.internal.o.g(dynamicMap, "dynamicMap");
    ...
    public final void l(bw5.jr reportInfoScene, r45.ej2 ej2Var) {
        ...
        kotlin.jvm.internal.o.f(c17, "getService(...)");
        kotlin.jvm.internal.o.g(reportInfoScene, "reportInfoScene");
        com.tencent.mm.plugin.finder.report.p2.f125237a.S(reportInfoScene, ej2Var);
    }
}
