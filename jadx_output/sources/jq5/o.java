...
public final class o {
    ...
    public static final jq5.o f301283a = new jq5.o();

    public final java.lang.String a(android.content.Context context, int i17, int i18, int i19) {
        kotlin.jvm.internal.o.g(context, "context");
        if (i19 > 0) {
            java.lang.String string = context.getString(com.tencent.mm.R.string.nsk, java.lang.Integer.valueOf(i19));
            kotlin.jvm.internal.o.f(string, "getString(...)");
            return string;
        }
        if (i17 > 0 && i18 > 0) {
            java.lang.String string2 = context.getString(com.tencent.mm.R.string.nso, java.lang.Integer.valueOf(i17), java.lang.Integer.valueOf(i18));
            kotlin.jvm.internal.o.f(string2, "getString(...)");
            return string2;
        }
        if (i17 > 0) {
            java.lang.String string3 = context.getString(com.tencent.mm.R.string.nss, java.lang.Integer.valueOf(i17));
        ...
        java.lang.String string4 = context.getString(com.tencent.mm.R.string.nzf, java.lang.Integer.valueOf(i18));
    ...
    public final void b(android.content.Context context) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.WeDrop.WeDropUtils", "goToDownload: " + e17);
        }
    }
    ...
    public final void c(android.content.Context context) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.WeDrop.WeDropUtils", "goToSystemAlbum use image/*");
            ...
            try {
                ...
                com.tencent.mars.xlog.Log.e("MicroMsg.WeDrop.WeDropUtils", "open album fail: " + e17.getMessage());
            }
        }
    }
}
