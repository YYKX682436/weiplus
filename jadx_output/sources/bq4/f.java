...
public final class f implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.plugin.vlog.ui.video.textstatus.RecordTextStatusEditVideoPluginLayout f23592d;

    public f(com.tencent.mm.plugin.vlog.ui.video.textstatus.RecordTextStatusEditVideoPluginLayout recordTextStatusEditVideoPluginLayout) {
        this.f23592d = recordTextStatusEditVideoPluginLayout;
    }
    ...
    public final void onClick(android.view.View view) {
        ...
        this.f23592d.getEditFinishPlugin().onClick(view);
