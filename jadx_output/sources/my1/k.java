...
public class k extends i95.w implements fy1.e {
    ...
    public static volatile my1.k f332694e;

    /* renamed from: d, reason: collision with root package name */
    public final java.util.Map f332695d = new java.util.HashMap();
    ...
    public final java.util.Map Bi(java.util.Map map, java.util.Map map2, ky1.d dVar) {
        int i17;
        if (map2 != null && map != null && map.size() > 0 && dVar.f313499a == 1 && ((i17 = dVar.f313500b) == 5 || i17 == 9 || i17 == 999)) {
    ...
    public final java.lang.Object Di(java.lang.Object obj) {
        ...
        try {
            ...
            if (str.contains("jm|")) {
                ...
                return split5.length > 0 ? io.flutter.plugin.common.JSONUtil.unwrap(new org.json.JSONObject(split5[split5.length - 1])) : obj;
            }
            if (!str.contains("jl|")) {
                return obj;
            }
            java.lang.String[] split6 = str.split("jl\\|");
            return split6.length > 0 ? io.flutter.plugin.common.JSONUtil.unwrap(new org.json.JSONArray(split6[split6.length - 1])) : obj;
