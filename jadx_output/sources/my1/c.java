            ...
            while (it.hasNext()) {
                ...
                if (list != null) {
                    for (ky1.d dVar : list) {
                        ...
                        hashMap.put("route_type", java.lang.Integer.valueOf(dVar.f313499a));
                        hashMap.put("route_rule", java.lang.Integer.valueOf(dVar.f313500b));
                        hashMap.put("is_rt_report", java.lang.Boolean.valueOf(dVar.f313501c));
                        hashMap.put("is_batch_report", java.lang.Boolean.valueOf(dVar.f313502d));
