...
public class p {
    ...
    public static volatile android.content.SharedPreferences f36913a;

    /* renamed from: b, reason: collision with root package name */
    public static android.content.Context f36914b;

    public static synchronized android.content.SharedPreferences a() {
        android.content.SharedPreferences sharedPreferences;
        synchronized (c.t.m.sapp.c.p.class) {
            if (f36913a == null) {
                f36913a = f36914b.getSharedPreferences("TLocationSDK", 0);
            }
            sharedPreferences = f36913a;
        }
    ...
    public static android.content.SharedPreferences a(java.lang.String str) {
        ...
        return f36914b.getSharedPreferences(str, "com.tencent.mobileqq".equals(f36914b.getPackageName()) ? 4 : 0);
    }
