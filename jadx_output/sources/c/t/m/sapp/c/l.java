...
public class l {
    ...
    public static final byte[] f36904a = {84, 101, 110, 99, 101, 110, 116, 76, 111, 99, 97, 116, 105, 111, 110, 49};

    /* renamed from: b, reason: collision with root package name */
    public static final byte[] f36905b = new byte[0];

    /* renamed from: c, reason: collision with root package name */
    public static final byte[] f36906c = new byte[0];

    public static java.lang.String a(java.lang.String str) {
        try {
            return new java.lang.String(a(android.util.Base64.decode(str.getBytes(), 2)), com.tencent.mapsdk.internal.rv.f51270c);
    ...
    public static byte[] a(byte[] bArr, int i17, int i18, byte[] bArr2, byte[] bArr3, int i19) {
        ...
        if (bArr != null && bArr.length != 0 && i17 >= 0 && i18 > 0) {
            try {
                ...
                return a17 == null ? f36906c : a17.doFinal(bArr, i17, i18);
            } catch (java.lang.Throwable unused) {
                return f36906c;
            }
        }
    ...
    public static javax.crypto.Cipher a(java.lang.String str, int i17) {
        ...
        javax.crypto.Cipher cipher = javax.crypto.Cipher.getInstance("AES/CBC/PKCS5Padding");
        cipher.init(i17, secretKeySpec, new javax.crypto.spec.IvParameterSpec(f36904a));
        return cipher;
    }
