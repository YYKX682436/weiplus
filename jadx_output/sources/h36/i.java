...
public class i extends h36.f {
    ...
    public byte[] g(long j17, int i17, long j18, int i18, byte[] bArr, byte[] bArr2, int i19, int i27, long[] jArr, int i28, long j19, int i29, int i37, int i38, int i39, int i47, byte[] bArr3) {
        ...
        h36.h hVar2 = this.f278594g;
        byte[] bArr15 = hVar2.f278605k;
        byte[] d17 = hVar2.f278598d.d();
        byte[] bArr16 = this.f278594g.f278608n;
        ...
        this.f278594g.f278618x = a(bArr4);
        ...
        oicq.wlogin_sdk.tools.util.q(bArr19, i48, 262);
        oicq.wlogin_sdk.tools.util.q(bArr19, 2, length2);
        byte[] bArr21 = new byte[i68];
        java.lang.System.arraycopy(bArr19, i48, bArr21, i48, i68);
        oicq.wlogin_sdk.tools.util.b("req2 a1:", oicq.wlogin_sdk.tools.util.h(bArr21));
        int i69 = i48;
        byte[] i76 = aVar.i(j17, j19, i59, i28);
        byte[] i77 = gVar.i(i37, i38, i39, i47);
        byte[] i78 = oVar.i(i19, i27, jArr);
        byte[] i79 = d0Var.i(this.f278594g.f278605k);
        ...
        if (bArr3.length > 0) {
            ...
            oicq.wlogin_sdk.tools.util.q(bArr17, 0, 264);
            int i86 = 0 + 2;
            oicq.wlogin_sdk.tools.util.q(bArr17, i86, 0);
            int i87 = i86 + 2;
            if (length3 > 128 - 4) {
            ...
            int i88 = i87 + length3;
            oicq.wlogin_sdk.tools.util.q(bArr11, 2, i88 - 4);
            bArr22 = new byte[i88];
        ...
        if (bArr15.length > 0) {
            ...
            oicq.wlogin_sdk.tools.util.q(bArr18, 0, 265);
            int i89 = 0 + 2;
            oicq.wlogin_sdk.tools.util.q(bArr18, i89, 0);
            int i96 = i89 + 2;
            if (length4 > 128 - 4) {
            ...
            int i97 = i96 + length4;
            oicq.wlogin_sdk.tools.util.q(bArr10, 2, i97 - 4);
            bArr8 = new byte[i97];
        ...
        byte[] bytes = new java.lang.String(com.eclipsesource.mmv8.Platform.ANDROID).getBytes();
        byte[] bytes2 = android.os.Build.VERSION.RELEASE.getBytes();
        h36.h hVar3 = this.f278594g;
        byte[] bArr28 = bArr22;
        byte[] i98 = uVar.i(bytes, bytes2, hVar3.f278607m, hVar3.f278606l, new byte[0], hVar3.f278609o);
        h36.h hVar4 = this.f278594g;
        byte[] i99 = wVar.i(hVar4.f278613s, hVar4.f278614t, hVar4.f278615u, 0, hVar4.f278612r, hVar4.f278605k);
        h36.h hVar5 = this.f278594g;
        byte[] i100 = c0Var.i(bArr8, i98, i99, f0Var.i(j17, hVar5.f278610p, hVar5.f278611q), this.f278594g.f278596b);
        ...
        d(com.tencent.liteav.TXLiteAVCode.WARNING_VIRTUAL_BACKGROUND_DEVICE_UNSURPORTED, this.f278592e, h36.f.f278587h, j18, 0, 0, i59, 0, b(bArr29, this.f278593f, i102));
        int i105 = this.f278589b;
        byte[] bArr30 = new byte[i105];
        java.lang.System.arraycopy(this.f278591d, 0, bArr30, 0, i105);
        return bArr30;
    }
    ...
    public byte[] h(long j17, int i17, long j18, int i18, byte[] bArr, byte[] bArr2, int i19, byte[] bArr3, int i27, int i28, long[] jArr, int i29, long j19, int i37, int i38, int i39, int i47, int i48, byte[] bArr4) {
        ...
        int i59;
        h36.h hVar = this.f278594g;
        int i66 = hVar.f278603i;
        hVar.f278600f = j18;
        oicq.wlogin_sdk.tools.util.b("IMEI", oicq.wlogin_sdk.tools.util.h(hVar.f278605k));
        h36.h hVar2 = this.f278594g;
        byte[] bArr15 = hVar2.f278596b;
        byte[] bArr16 = hVar2.f278605k;
        byte[] d17 = hVar2.f278598d.d();
        byte[] bArr17 = this.f278594g.f278608n;
        j36.j0 j0Var = new j36.j0();
        j36.k0 k0Var = new j36.k0();
        byte[] bArr18 = new byte[128];
        j36.o oVar = new j36.o();
        ...
        h36.h hVar3 = this.f278594g;
        int i69 = hVar3.f278614t;
        byte[] bArr21 = hVar3.f278605k;
        byte[] bArr22 = new byte[90];
        oicq.wlogin_sdk.tools.util.q(bArr22, 0, 2);
        oicq.wlogin_sdk.tools.util.r(bArr22, 2, oicq.wlogin_sdk.tools.util.o());
        oicq.wlogin_sdk.tools.util.r(bArr22, 6, 5);
        oicq.wlogin_sdk.tools.util.r(bArr22, 10, (int) j17);
        oicq.wlogin_sdk.tools.util.r(bArr22, 14, i66);
        oicq.wlogin_sdk.tools.util.s(bArr22, 18, j18);
        ...
        oicq.wlogin_sdk.tools.util.r(bArr22, length4, 0);
        int i77 = length4 + 4;
        bArr22[i77 + 0] = (byte) (i69 >> 0);
        int i78 = i77 + 1;
        if (bArr21 == null || bArr21.length <= 0) {
            byte[] bArr23 = new byte[16];
            oicq.wlogin_sdk.tools.util.r(bArr23, 0, oicq.wlogin_sdk.tools.util.o());
            oicq.wlogin_sdk.tools.util.r(bArr23, 4, oicq.wlogin_sdk.tools.util.o());
            oicq.wlogin_sdk.tools.util.r(bArr23, 8, oicq.wlogin_sdk.tools.util.o());
            oicq.wlogin_sdk.tools.util.r(bArr23, 12, oicq.wlogin_sdk.tools.util.o());
        } else {
        ...
        oicq.wlogin_sdk.tools.util.s(bArr24, 16, j18);
        byte[] b17 = k36.e.b(bArr22, 0, 90, k36.d.k(bArr24));
        int length5 = b17.length;
        oicq.wlogin_sdk.tools.util.q(bArr18, 0, 262);
        oicq.wlogin_sdk.tools.util.q(bArr18, 2, 0);
        if (length5 > 124) {
        ...
        int i79 = length5 + 4;
        oicq.wlogin_sdk.tools.util.q(bArr5, 2, i79 - 4);
        ...
        if (bArr4.length > 0) {
            ...
            byte[] bArr32 = bArr19;
            oicq.wlogin_sdk.tools.util.q(bArr32, 0, 264);
            int i96 = 0 + 2;
            oicq.wlogin_sdk.tools.util.q(bArr32, i96, 0);
            int i97 = i96 + 2;
            if (length6 > 128 - 4) {
            ...
            int i98 = i97 + length6;
            oicq.wlogin_sdk.tools.util.q(bArr32, 2, i98 - 4);
            bArr9 = new byte[i98];
        ...
        if (bArr10.length > 0) {
            ...
            oicq.wlogin_sdk.tools.util.q(bArr20, 0, 265);
            int i99 = 0 + 2;
            oicq.wlogin_sdk.tools.util.q(bArr20, i99, 0);
            int i100 = i99 + 2;
            if (length7 > 128 - 4) {
            ...
            oicq.wlogin_sdk.tools.util.q(bArr14, 2, i101 - 4);
        ...
        h36.h hVar5 = this.f278594g;
        byte[] bArr36 = bArr9;
        byte[] i102 = uVar.i(bytes, bytes2, hVar5.f278607m, hVar5.f278606l, new byte[0], hVar5.f278609o);
        h36.h hVar6 = this.f278594g;
        byte[] i103 = wVar.i(hVar6.f278613s, hVar6.f278614t, hVar6.f278615u, 0, hVar6.f278612r, hVar6.f278605k);
        h36.h hVar7 = this.f278594g;
        byte[] i104 = c0Var.i(bArr6, i102, i103, f0Var.i(j17, hVar7.f278610p, hVar7.f278611q), this.f278594g.f278596b);
        ...
        d(com.tencent.liteav.TXLiteAVCode.WARNING_VIRTUAL_BACKGROUND_DEVICE_UNSURPORTED, this.f278592e, h36.f.f278587h, j18, 0, 0, i49, 0, b(bArr38, this.f278593f, i106));
        int i109 = this.f278589b;
        byte[] bArr39 = new byte[i109];
        java.lang.System.arraycopy(this.f278591d, 0, bArr39, 0, i109);
        return bArr39;
    }
}
