...
public class g extends l01.w {
    ...
    public final /* synthetic */ android.graphics.drawable.Drawable f314769h;
    ...
    public void d() {
        ...
        if (((android.widget.ImageView) weakReference.get()) == null || (drawable = this.f314769h) == null) {
            return;
        }
