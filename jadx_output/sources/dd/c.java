...
public final class c {
    ...
    public final org.json.JSONObject a(android.os.Bundle bundle) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace("DynamicModuleUtil", e17, "bundleToJson", new java.lang.Object[0]);
            return null;
        }
    }

    public final void b(org.json.JSONObject json, com.tencent.kinda.gen.ITransmitKvData kvData) {
        kotlin.jvm.internal.o.g(json, "json");
        kotlin.jvm.internal.o.g(kvData, "kvData");
        ...
        while (keys.hasNext()) {
            ...
            if (obj instanceof java.lang.Integer) {
                ...
                kvData.putInt(next, ((java.lang.Number) obj).intValue());
            } else if (obj instanceof java.lang.Boolean) {
                kotlin.jvm.internal.o.d(obj);
                kvData.putBool(next, ((java.lang.Boolean) obj).booleanValue());
            } else if (obj instanceof java.lang.Long) {
                kotlin.jvm.internal.o.d(obj);
                kvData.putLong(next, ((java.lang.Number) obj).longValue());
            } else if (obj instanceof java.lang.String) {
                kvData.putString(next, (java.lang.String) obj);
            }
        }
    }
    ...
    public final org.json.JSONObject d(int i17, java.util.Map map) {
        ...
        java.lang.String str = (java.lang.String) dd.d.f228872b.get(java.lang.Integer.valueOf(i17));
        if (str == null) {
            str = "ok";
        }
    ...
    public final org.json.JSONObject f(org.json.JSONObject jSONObject, java.lang.String str) {
        ...
        if (!jSONObject.has(ya.b.SUCCESS)) {
