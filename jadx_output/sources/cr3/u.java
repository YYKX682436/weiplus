...
public class u extends np.c {
    ...
    public final /* synthetic */ cr3.d0 f221964d;
    ...
    public void a(int i17, int i18, java.lang.String str, c01.g1 g1Var) {
        ...
        vg3.c cVar2 = vg3.c.f436658m;
        int i19 = this.f338780a;
        cr3.d0 d0Var = this.f221964d;
        ...
        if (i27 == 0) {
            ...
            db5.t7.makeText(mMActivity, com.tencent.mm.R.string.hmp, 1).show();
            return;
        }
        d0Var.f221932e.E2();
        ...
        if (!com.tencent.mm.sdk.platformtools.t8.K0(this.f338782c)) {
            ...
            str = mMActivity.getString(com.tencent.mm.R.string.hmo);
        }
        db5.e1.y(mMActivity, str, str2, mMActivity.getString(com.tencent.mm.R.string.l_e), new cr3.t(this));
        cr3.d0.a(d0Var);
    }
}
