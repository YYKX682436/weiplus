...
public class u {
    ...
    public android.content.Context f460965a;

    /* renamed from: b, reason: collision with root package name */
    public yd.n f460966b;

    /* renamed from: c, reason: collision with root package name */
    public volatile yd.e f460967c;

    /* renamed from: f, reason: collision with root package name */
    public com.tencent.magicbrush.MagicBrush f460970f;

    /* renamed from: d, reason: collision with root package name */
    public volatile int f460968d = 0;

    /* renamed from: e, reason: collision with root package name */
    public final java.util.Queue f460969e = new java.util.LinkedList();

    /* renamed from: g, reason: collision with root package name */
    public final yd.t f460971g = new yd.t(null);
    ...
    */
    public void a(yd.q r6, java.lang.String r7) {
        ...
        L4a:
            ...
            com.tencent.mars.xlog.Log.printErrStackTrace(r0, r6, r1, r7)
        L52:
            return
        L53:
    ...
    public void b(java.lang.String str) {
        com.tencent.mars.xlog.Log.i("MicroMsg.GameInspector", "hy: on js logged : %s", str);
        synchronized (this.f460969e) {
            if (this.f460968d != 1) {
                ((java.util.LinkedList) this.f460969e).add(str);
            } else {
                if (this.f460967c == null) {
                    return;
                }
                yd.e eVar = this.f460967c;
                eVar.f460939a.post(new yd.p(this, str));
            }
        }
    }
}
