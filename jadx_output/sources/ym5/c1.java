...
public final class c1 extends al5.w {
    ...
    public java.lang.ref.WeakReference f463229f;
    ...
    public void draw(android.graphics.Canvas canvas, java.lang.CharSequence text, int i17, int i18, float f17, int i19, int i27, int i28, android.graphics.Paint paint) {
        ...
        java.lang.ref.WeakReference weakReference = this.f463229f;
        ...
        if (drawable == null) {
            ...
            this.f463229f = new java.lang.ref.WeakReference(drawable);
        }
        if (drawable != null) {
            canvas.save();
