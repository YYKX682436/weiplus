...
public final class c extends ih3.n {
    ...
    public java.lang.CharSequence b(java.util.Map values, java.lang.String head, android.os.Bundle bundle, java.lang.ref.WeakReference weakReference, java.lang.ref.WeakReference weakReference2) {
        ...
        java.lang.String b17 = fp.s0.b(str4, com.tencent.mapsdk.internal.rv.f51270c);
        java.lang.String str8 = "<_wc_custom_link_ color= \"" + str6 + "\" href=\"weixin://ecsnewxmljump?jumpinfo=" + fp.s0.b(str3, com.tencent.mapsdk.internal.rv.f51270c) + "&scene=" + i17 + "&action=" + intValue + "&reportextradata=" + b17 + "\">" + str5 + "</_wc_custom_link_>";
        com.tencent.mars.xlog.Log.i("MicroMsg.SysMsgTemplateLinkHandlerEcsJumpInfo", str8);
        return str8;
    }
}
