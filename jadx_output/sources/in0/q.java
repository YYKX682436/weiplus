...
public final class q extends tn0.w0 {
    ...
    public int f292770a2;

    public q(boolean z17) {
        super(true, z17);
        this.P1 = 1;
        this.R1 = new in0.c(this);
        this.U1 = new com.tencent.mm.sdk.platformtools.b4("anchor_sei_sender", (com.tencent.mm.sdk.platformtools.a4) new in0.b(this), true);
    ...
    public static final java.lang.String S0(in0.q qVar, java.lang.String sdkUserId, float f17, java.lang.String gestureId, java.lang.String randomId, float f18, float f19, float f27, float f28, java.lang.String giftComboId, int i17) {
        ...
        if (i17 == 0) {
            ...
            jSONObject2.put(dm.i4.COL_ID, gestureId);
    ...
    public void E(hn0.i callback) {
        ...
        boolean z17 = false;
        while (it.hasNext() && !(z17 = ((java.lang.Boolean) ((yz5.a) it.next()).invoke()).booleanValue())) {
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", "#enterRoom isSetMuteImageBlock=" + z17);
        if (!z17) {
        ...
        if (eVar2 != null) {
            eVar2.f438183a.enableAudioEarMonitoring(false);
        }
    }
    ...
    public int G(jn0.a params) {
        ...
        fn0.g gVar2 = fn0.g.f264195a;
        hn0.g gVar3 = fn0.g.f264196b;
        boolean z17 = gVar3 != null && ((java.lang.Number) ((lb2.j) ((jz5.n) ae2.in.L6).getValue()).r()).intValue() == 1;
        kn0.p pVar = this.D;
        if (!z17) {
            kn0.i iVar = this.C;
        ...
        sb6.append(params.f300476b);
        sb6.append(", dontFinish:");
        sb6.append(params.f300477c);
        sb6.append(", generateType:");
        sb6.append(params.f300478d);
        sb6.append(", opType:");
        sb6.append(params.f300479e);
        sb6.append(", staticFloatImage:");
        android.graphics.Bitmap bitmap = params.f300480f;
        sb6.append(bitmap);
        sb6.append(", isScreenShareMode:");
        sb6.append(pVar.f309589i);
        sb6.append(" isVoiceRoomMode: ");
        sb6.append(Z());
        com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", sb6.toString());
        if (!Z()) {
            boolean z19 = pVar.f309589i;
            fo0.n nVar = this.f420767p;
            if (!z19 && !pVar.e()) {
                if (!((gVar3 == null || (e1Var = (mm2.e1) dk2.ef.f233372a.i(mm2.e1.class)) == null || e1Var.R6() != 3) ? false : true)) {
                    ...
                    go0.f1 f1Var = this.f420771r.f273767p;
    ...
    @Override // tn0.w0
    public fo0.n O() {
        com.tencent.mars.xlog.Log.w("MicroMsg.LiveCoreAnchor", "getLiveMiniManager not support.");
    ...
    public final void T0(cl0.g gVar) {
        ...
        int i17;
        zn0.v d17;
        org.json.JSONObject jSONObject = U().f474319w;
        if (jSONObject != null) {
            ...
            for (int i18 = 0; i18 < length; i18++) {
                ...
                if (optJSONObject == null || (str = optJSONObject.optString(com.tencent.tmassistantsdk.downloadservice.DownloadInfo.UID)) == null) {
                    str = "";
                } else {
                    zn0.v d18 = zn0.x.f474414a.d(str);
                    if (d18 != null) {
                        if (d18.f474410h <= this.T.f309502a) {
                ...
                zn0.a0 U = U();
                com.tencent.trtc.TRTCCloudDef.TRTCMixUser tRTCMixUser = (com.tencent.trtc.TRTCCloudDef.TRTCMixUser) U.f474318v.get(str);
                if (tRTCMixUser != null && (d17 = zn0.x.f474414a.d(str)) != null) {
                    optInt = U.a(d17.f474412m, tRTCMixUser, optInt);
                }
                U().getClass();
                if (fn0.g.f264195a.o(str)) {
    ...
    public final void U0(cl0.g gVar) {
        if (this.f292770a2 != -1) {
            ...
            gVar2.o("recordScreenScene", this.f292770a2);
    ...
    public final org.json.JSONObject V0() {
        ...
        om2.g gVar2;
        org.json.JSONObject jSONObject = new org.json.JSONObject();
        fn0.g gVar3 = fn0.g.f264195a;
        hn0.g gVar4 = fn0.g.f264196b;
        jSONObject.putOpt("version", java.lang.Integer.valueOf((gVar4 == null || (gVar2 = (om2.g) dk2.ef.f233372a.i(om2.g.class)) == null) ? 0 : gVar2.f346314u));
        java.lang.String str = null;
        r45.yx1 Q6 = (gVar4 == null || (gVar = (om2.g) dk2.ef.f233372a.i(om2.g.class)) == null) ? null : gVar.Q6();
        org.json.JSONObject jSONObject2 = new org.json.JSONObject();
        if (Q6 != null) {
            java.lang.String str2 = Q6.f391469r;
            if (str2 == null) {
                str2 = "";
            }
            jSONObject2.putOpt(com.tencent.tmassistantsdk.downloadservice.DownloadInfo.UID, str2);
            java.lang.String str3 = Q6.f391459e;
            if (str3 == null) {
                str3 = "";
            }
            jSONObject2.putOpt("uiqId", str3);
            r45.by1 by1Var = Q6.f391466o;
            jSONObject2.putOpt("sName", (by1Var == null || (ay1Var2 = by1Var.f371143d) == null) ? null : ay1Var2.f370351e);
            r45.by1 by1Var2 = Q6.f391466o;
            if (by1Var2 != null && (ay1Var = by1Var2.f371143d) != null) {
                str = ay1Var.f370350d;
            }
    ...
    public final org.json.JSONObject W0() {
        ...
        kn0.d dVar = this.T;
        sb6.append(dVar.f309502a);
        com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", sb6.toString());
        if (this.S1 <= dVar.f309502a) {
            int i17 = this.Q1;
            java.util.regex.Pattern pattern = pm0.v.f356802a;
            this.Q1 = i17 | 1;
        } else {
        ...
        zn0.a0 U = U();
        if (kz5.n0.O(i19, U != null ? java.lang.Integer.valueOf(U.f474316t) : null)) {
            this.Q1 |= 8;
        } else {
            this.Q1 &= -9;
        }
        jSONObject.putOpt("userId", pVar.f309586f);
        jSONObject.putOpt("userStatus", java.lang.Integer.valueOf(this.Q1));
        r45.rm1 rm1Var = this.M;
        jSONObject.putOpt("songId", java.lang.Integer.valueOf(rm1Var != null ? rm1Var.getInteger(0) : 0));
        r45.rm1 rm1Var2 = this.M;
        jSONObject.putOpt("songType", java.lang.Integer.valueOf(rm1Var2 != null ? rm1Var2.getInteger(2) : 0));
        r45.rm1 rm1Var3 = this.M;
        java.lang.Object string = rm1Var3 != null ? rm1Var3.getString(1) : null;
        if (string == null) {
            string = "";
        }
        jSONObject.putOpt("listenId", string);
        ...
        jSONObject.putOpt(com.tencent.thumbplayer.tplayer.plugins.report.TPReportKeys.Common.COMMON_SEQ, java.lang.Integer.valueOf(this.P1));
    ...
    public final cl0.g X0() {
        ...
        try {
            ...
            cl0.g gVar2 = new cl0.g();
            gVar2.s("lm", java.lang.Integer.valueOf(U().f474322z));
            gVar2.s("lsm", java.lang.Integer.valueOf(U().A));
            com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", "prepareAnchorSeiInfo liveMode: " + U().f474322z + " subMode: " + U().A);
        ...
        this.P1++;
        this.T1 = gVar;
        com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", "genAnchorSeiInfo json:" + gVar + " localSeq: " + this.P1 + " anchorInfoLinkMicJson: " + U().f474319w);
        return gVar;
    }
    ...
    public final void Y0(org.json.JSONObject jSONObject, org.json.JSONObject jSONObject2) {
        ...
        hn0.i iVar = this.A;
        if (iVar != null) {
            iVar.callback(24, bundle);
        }
    }

    public void Z0(java.lang.String str) {
        go0.q1 g17;
        com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", "refreshMicUserView, userId:" + str);
        if (str == null || (g17 = U().g(str)) == null) {
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.LiveCoreAnchor", "refreshMicUserView, find renderSurface for userId:" + this.D.f309586f);
    ...
    public final void a1(java.util.List luaRes) {
        kotlin.jvm.internal.o.g(luaRes, "luaRes");
    ...
    public void c1(lo0.b0 b0Var) {
        ...
        hn0.h.b(this, this.f420774u, b0Var, 0, 4, null);
    }
    ...
    public void h0() {
        ...
        if (livePreviewView != null) {
            livePreviewView.f(new in0.e(this, elapsedRealtime), new in0.f(this));
        }
    }
    ...
    public void m0() {
        ...
        this.f420759f.removeCallbacks(this.R1);
        this.f420780y = null;
        this.f420783z = null;
        this.Z1 = null;
    }
    ...
    public int n() {
        ...
        this.E = true;
        go0.f0 f0Var = this.f420771r;
        f0Var.h(in0.m.f292763d);
        in0.n nVar = in0.n.f292764d;
        f0Var.getClass();
    ...
    public void q(java.util.ArrayList arrayList, int i17) {
        ...
        kotlin.jvm.internal.o.f(arrayList2, "getRemoteUserConfigList(...)");
        synchronized (arrayList2) {
            java.util.Iterator it = arrayList2.iterator();
            while (it.hasNext()) {
                ((zn0.v) it.next()).f474410h = 0;
            }
        }
        this.S1 = 0;
        if (arrayList != null) {
            ...
            while (it6.hasNext()) {
                com.tencent.trtc.TRTCCloudDef.TRTCVolumeInfo tRTCVolumeInfo = (com.tencent.trtc.TRTCCloudDef.TRTCVolumeInfo) it6.next();
                if (com.tencent.mm.sdk.platformtools.t8.D0(this.D.f309586f, tRTCVolumeInfo.userId)) {
                    this.S1 = tRTCVolumeInfo.volume;
                } else {
                    zn0.v d17 = zn0.x.f474414a.d(tRTCVolumeInfo.userId);
                    if (d17 != null) {
                        d17.f474410h = tRTCVolumeInfo.volume;
                    }
                }
            }
        }
        ...
        if (arrayList != null) {
            ...
            while (it7.hasNext()) {
                com.tencent.trtc.TRTCCloudDef.TRTCVolumeInfo tRTCVolumeInfo2 = (com.tencent.trtc.TRTCCloudDef.TRTCVolumeInfo) it7.next();
                java.lang.String userId = tRTCVolumeInfo2.userId;
                kotlin.jvm.internal.o.f(userId, "userId");
                arrayList3.add(new com.tencent.mm.live.core.core.model.UserVolumeInfo(userId, tRTCVolumeInfo2.volume, tRTCVolumeInfo2.vad));
            }
        }
        android.os.Bundle bundle = new android.os.Bundle();
