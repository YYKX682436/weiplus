...
public final class c {
    ...
    public final java.lang.String b(java.lang.String str) {
        if (str != null) {
            return kotlin.jvm.internal.o.b(p52.h.f352040y, str) ? p52.h.f352039x : "";
        }
        com.tencent.mars.xlog.Log.i("HABBYGE-MALI.HellFinderConfig", "getSnsAdData finderUsername is null");
        return "";
    }
    ...
    public final void d(java.lang.String str, java.lang.String str2) {
        ...
        if (z65.c.a()) {
            com.tencent.mm.sdk.platformtools.Log.c(str, str2, new java.lang.Object[0]);
        } else {
    ...
    public final void f(java.lang.String str, java.lang.String str2) {
        ...
        p52.h.f352039x = str;
        p52.h.f352040y = str2;
        d("HABBYGE-MALI.HellFinderConfig", "setSnsAdData, snsAdData=" + p52.h.f352039x + ", snsFinderUsername=" + p52.h.f352040y);
    }
    ...
    public final java.util.Map h(java.util.Map map, int i17) {
        ...
        if (map != null) {
            for (java.util.Map.Entry entry : map.entrySet()) {
                if (kotlin.jvm.internal.o.b(entry.getKey(), "udf_kv")) {
                    java.lang.Object value = entry.getValue();
                    kotlin.jvm.internal.o.e(value, "null cannot be cast to non-null type kotlin.collections.Map<kotlin.String, kotlin.Any?>");
