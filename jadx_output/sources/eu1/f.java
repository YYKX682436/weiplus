...
public class f {
    ...
    public static boolean f256751b;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f256752c;

    /* renamed from: a, reason: collision with root package name */
    public final android.content.Context f256753a;

    public f(android.content.Context context) {
        this.f256753a = context;
        f256752c = false;
    }
    ...
    public static java.util.ArrayList e(int i17) {
        if (i17 == 1) {
            ...
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "getCardIds() ids == null || ids.size() == 0 for showType == " + i17);
            return f(i17);
        }
        if (i17 != 2) {
            return null;
    ...
    public static java.util.ArrayList f(int i17) {
        ...
        if (jVar == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "getCardIdsByType() data == null for showType = " + i17);
            return null;
        }
        ...
        if (i17 == 1) {
            ...
            if (linkedList != null && linkedList.size() > 0) {
                while (i18 < jVar.f266846a.size()) {
                    fu1.k kVar = (fu1.k) jVar.f266846a.get(i18);
                    if (!arrayList2.contains(kVar.f266856b)) {
                        java.lang.String J0 = xt1.t0.nj().J0(kVar.f266856b);
                        if (!android.text.TextUtils.isEmpty(J0) && !arrayList.contains(J0)) {
                            arrayList.add(J0);
                        } else if (!arrayList.contains(kVar.f266855a)) {
                            arrayList.add(kVar.f266855a);
                        }
                        arrayList2.add(kVar.f266856b);
                    }
                    i18++;
                }
        ...
        java.util.LinkedList linkedList2 = jVar.f266847b;
        if (linkedList2 != null && linkedList2.size() > 0) {
            while (i18 < jVar.f266847b.size()) {
                fu1.k kVar2 = (fu1.k) jVar.f266847b.get(i18);
                if (!arrayList2.contains(kVar2.f266856b)) {
                    java.lang.String J02 = xt1.t0.nj().J0(kVar2.f266856b);
                    if (!android.text.TextUtils.isEmpty(J02) && !arrayList.contains(J02)) {
                        arrayList.add(J02);
                    } else if (!arrayList.contains(kVar2.f266855a)) {
                        arrayList.add(kVar2.f266855a);
                    }
                    arrayList2.add(kVar2.f266856b);
                }
                i18++;
            }
    ...
    public static java.lang.String i(android.content.Context context, java.util.ArrayList arrayList, int i17) {
        if (arrayList == null || arrayList.size() == 0) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "getShareUserName， username_list == null || username_list.size() == 0");
            return "";
        }
        ...
        if (context != null) {
            return (arrayList.size() == 1 || arrayList.size() == 2) ? context.getString(com.tencent.mm.R.string.avf, sb6.toString()) : context.getString(com.tencent.mm.R.string.auz, sb6.toString(), java.lang.Integer.valueOf(arrayList.size()));
        }
        com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "context == null");
        return "";
    }
    ...
    public static boolean m(java.lang.String str) {
        ...
        while (it.hasNext()) {
            ...
            if (nVar != null && str.equals(nVar.f266862a) && nVar.f266863b == 1) {
                return true;
            }
        }
        return false;
    ...
    public static void p(android.content.Context context, tt1.j jVar) {
        com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "updateShareCardData()");
        com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "card id:" + jVar.g() + " cardtpid:" + jVar.f());
        java.lang.String g17 = jVar.g();
        java.lang.String f17 = jVar.f();
        if (f256751b) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "is isUpdating data, don't do updateCardIdsListByCardId");
        } else {
            com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "do updateCardIdsListByCardId");
            f256751b = true;
        ...
        if (context != null) {
            ...
            com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "updateCardCountbyCardTpId() card_tp_id:" + f18);
            java.util.Map map = (java.util.Map) xt1.t0.Di().a("key_share_card_count_map");
            if (map == null) {
                map = new java.util.HashMap();
            }
        ...
        for (int i17 = 0; i17 < arrayList.size(); i17++) {
            ...
            if (a17 != null && a17.equals(pVar.f266866a)) {
                pVar.f266870e = false;
                pVar.f266868c--;
                pVar.f266869d.remove(g18);
    ...
    public static void r(java.lang.String str) {
        com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "updateShareUserInfo()");
        if (android.text.TextUtils.isEmpty(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "updateShareUserInfo(), card_tp_id is empty");
        } else {
            s75.d.b(new eu1.d(str, new com.tencent.mm.sdk.platformtools.n3(android.os.Looper.getMainLooper())), "updateShareUserInfo_thread");
        }
    }

    public int g() {
        android.database.Cursor f17 = xt1.t0.cj().f456461d.f("select count(*) from UserCardInfo where (status=0 OR status=5) AND card_type=10", null, 2);
        if (f17 != null) {
    ...
    public void j() {
        if (((fu1.j) xt1.t0.Di().a("key_share_card_layout_data")) != null) {
            com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "the share card layout cache is valid!");
            return;
        }
        com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "initShareCardLayoutData, data cache is empty!, load data from db!");
        java.lang.String str = (java.lang.String) gm0.j1.u().c().m(com.tencent.mm.storage.u3.USERINFO_CARD_SHARECARD_LAYOUT_JSON_STRING_SYNC, "");
        if (android.text.TextUtils.isEmpty(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "initShareCardLayoutData, json is empty");
            return;
        }
        fu1.j b17 = lu1.i0.b(str);
        if (b17 == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "load share card layout data fail!");
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "load share card layout data success!");
    ...
    public boolean l() {
        ...
        return jVar.f266850e;
    }

    public final void n(fu1.j jVar, boolean z17) {
        java.lang.String str;
        if (jVar == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "don't parserShareCardListData, data is null");
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "parserShareCardListData()");
        ...
        java.util.LinkedList linkedList = jVar.f266846a;
        android.content.Context context = this.f256753a;
        if (linkedList != null && linkedList.size() > 0) {
            int i17 = 0;
            while (i17 < jVar.f266846a.size()) {
                fu1.k kVar = (fu1.k) jVar.f266846a.get(i17);
                java.lang.String str7 = str6;
                if (android.text.TextUtils.isEmpty(kVar.f266857c)) {
                    str = str5;
                } else {
                    str = str5;
                    map.put(kVar.f266856b, kVar.f266857c);
                }
                int D0 = xt1.t0.nj().D0(kVar.f266856b);
                java.lang.String str8 = str4;
                map2.put(kVar.f266856b, java.lang.Integer.valueOf(D0));
                java.lang.String str9 = str3;
                java.lang.String str10 = str2;
                map3.put(kVar.f266856b, i(context, xt1.t0.nj().L0(kVar.f266856b, 99), D0));
                if (!arrayList4.contains(kVar.f266856b)) {
                    java.lang.String J0 = xt1.t0.nj().J0(kVar.f266856b);
                    if (!android.text.TextUtils.isEmpty(J0) && !arrayList.contains(J0)) {
                        arrayList.add(J0);
                    } else if (!arrayList.contains(kVar.f266855a)) {
                    ...
                    arrayList4.add(kVar.f266856b);
                    fu1.n nVar = new fu1.n();
                    nVar.f266862a = kVar.f266856b;
                    nVar.f266863b = kVar.f266858d;
                    arrayList3.add(nVar);
                }
                i17++;
                str6 = str7;
        ...
        java.util.LinkedList linkedList2 = jVar.f266847b;
        if (linkedList2 != null && linkedList2.size() > 0) {
            for (int i18 = 0; i18 < jVar.f266847b.size(); i18++) {
                fu1.k kVar2 = (fu1.k) jVar.f266847b.get(i18);
                if (!android.text.TextUtils.isEmpty(kVar2.f266857c)) {
                    map.put(kVar2.f266856b, kVar2.f266857c);
                }
                int D02 = xt1.t0.nj().D0(kVar2.f266856b);
                map2.put(kVar2.f266856b, java.lang.Integer.valueOf(D02));
                map3.put(kVar2.f266856b, i(context, xt1.t0.nj().L0(kVar2.f266856b, 99), D02));
                if (!arrayList4.contains(kVar2.f266856b)) {
                    java.lang.String J02 = xt1.t0.nj().J0(kVar2.f266856b);
                    if (!android.text.TextUtils.isEmpty(J02) && !arrayList2.contains(J02)) {
                        arrayList2.add(J02);
                    } else if (!arrayList2.contains(kVar2.f266855a)) {
                        arrayList2.add(kVar2.f266855a);
                    }
                    arrayList4.add(kVar2.f266856b);
                    fu1.n nVar2 = new fu1.n();
                    nVar2.f266862a = kVar2.f266856b;
                    nVar2.f266863b = kVar2.f266858d;
        ...
        xt1.t0.Di().b("key_share_card_local_city", jVar.f266848c);
    ...
    public final void o(fu1.j jVar, fu1.j jVar2, boolean z17) {
        ...
        if (jVar == null && jVar2 == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "don't updateCategoryType(), newData == null && oldData == null");
            return;
        }
        if (jVar != null && jVar.f266847b == null && jVar.f266846a == null && jVar2 != null && jVar2.f266847b == null && jVar2.f266846a == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "don't updateCategoryType(), newData.local_city_list == null && oldData.local_city_list == null");
            return;
        }
        com.tencent.mars.xlog.Log.i("MicroMsg.ShareCardDataMgr", "updateCategoryType()");
        ...
        if (z17) {
            ...
            size = (jVar2 == null || (linkedList2 = jVar2.f266846a) == null || linkedList2.size() < 0) ? 0 : jVar2.f266846a.size();
            size2 = (jVar2 == null || (linkedList = jVar2.f266847b) == null || linkedList.size() < 0) ? 0 : jVar2.f266847b.size();
        }
        java.lang.System.currentTimeMillis();
        long F = gm0.j1.u().f273153f.F(java.lang.Long.valueOf(java.lang.Thread.currentThread().getId()));
        if (jVar != null && (linkedList7 = jVar.f266846a) != null && linkedList7.size() > 0) {
            for (int i17 = 0; i17 < jVar.f266846a.size(); i17++) {
                fu1.k kVar = (fu1.k) jVar.f266846a.get(i17);
                int i18 = i17 + size;
                xt1.t0.nj().b1(kVar.f266856b, 10, i18);
                fu1.f fVar = new fu1.f();
                fVar.f266838a = kVar.f266856b;
                fVar.f266839b = i18;
                arrayList.add(fVar);
            }
            if (!z17 && jVar2 != null && (linkedList8 = jVar2.f266846a) != null) {
                jVar.f266846a.addAll(linkedList8);
            }
        } else if (jVar != null && !z17 && jVar2 != null && (linkedList3 = jVar2.f266846a) != null) {
            jVar.f266846a = linkedList3;
        }
        xt1.t0.Di().b("key_share_card_local_city_category_info_list", arrayList);
        if (jVar != null && (linkedList5 = jVar.f266847b) != null && linkedList5.size() > 0) {
            for (int i19 = 0; i19 < jVar.f266847b.size(); i19++) {
                fu1.k kVar2 = (fu1.k) jVar.f266847b.get(i19);
                int i27 = i19 + size2;
                xt1.t0.nj().b1(kVar2.f266856b, 0, i27);
                fu1.f fVar2 = new fu1.f();
                fVar2.f266838a = kVar2.f266856b;
                fVar2.f266839b = i27;
                arrayList2.add(fVar2);
            }
            if (!z17 && jVar2 != null && (linkedList6 = jVar2.f266847b) != null) {
                jVar.f266847b.addAll(linkedList6);
            }
        } else if (jVar != null && !z17 && jVar2 != null && (linkedList4 = jVar2.f266847b) != null) {
            jVar.f266847b = linkedList4;
        }
    ...
    public void q(java.lang.String str, boolean z17) {
        if (android.text.TextUtils.isEmpty(str)) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "updateGetShareLayoutData json is empty");
            return;
        }
        ...
        fu1.j jVar = (fu1.j) xt1.t0.Di().a("key_share_card_layout_data");
        if (b17 == null) {
            com.tencent.mars.xlog.Log.e("MicroMsg.ShareCardDataMgr", "updateGetShareLayoutData data == null");
            o(b17, jVar, z17);
            xt1.t0.Di().b("key_share_card_layout_data", b17);
            return;
        }
        if (z17) {
            gm0.j1.u().c().x(com.tencent.mm.storage.u3.USERINFO_CARD_SHARECARD_LAYOUT_JSON_STRING_SYNC, str);
        }
        n(b17, z17);
        o(b17, jVar, z17);
        xt1.t0.Di().b("key_share_card_layout_data", b17);
        java.util.LinkedList linkedList = b17.f266846a;
        int size = (linkedList == null || linkedList.size() <= 0) ? 0 : b17.f266846a.size();
        java.util.LinkedList linkedList2 = b17.f266847b;
        if (linkedList2 != null && linkedList2.size() > 0) {
            size += b17.f266847b.size();
        }
        if (size > 0) {
