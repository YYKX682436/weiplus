...
public class g1 implements android.view.View.OnClickListener {
    ...
    public final /* synthetic */ com.tencent.mm.ui.widget.dialog.j f369113d;

    /* renamed from: e, reason: collision with root package name */
    public final /* synthetic */ android.view.View f369114e;

    /* renamed from: f, reason: collision with root package name */
    public final /* synthetic */ db5.d5 f369115f;

    public g1(com.tencent.mm.ui.widget.dialog.j jVar, android.view.View view, db5.d5 d5Var) {
        this.f369113d = jVar;
        this.f369114e = view;
        this.f369115f = d5Var;
    }
    ...
    public void onClick(android.view.View view) {
        ...
        com.tencent.mm.ui.widget.dialog.j jVar = this.f369113d;
        if (jVar != null) {
            android.view.View view2 = this.f369114e;
            jVar.a(true, r35.j1.a(view2), r35.j1.b(view2));
        }
        db5.d5 d5Var = this.f369115f;
        d5Var.dismiss();
