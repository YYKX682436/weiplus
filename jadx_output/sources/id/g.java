...
public final class g {
    ...
    public static final id.g f290453a = new id.g();
    ...
    public final boolean a(javax.crypto.SecretKey secretKey) {
        try {
            ...
            com.tencent.mars.xlog.Log.e("LiteAppWxPayUtil", "invalid key spec");
            return false;
        }
    }
    ...
    public final byte[] b(java.lang.String keyId, byte[] encrypted) {
        ...
        try {
            ...
            com.tencent.mars.xlog.Log.e("LiteAppWxPayUtil", "decryptData error, invalid encrypted data：%s", objArr);
            java.lang.Object[] objArr2 = new java.lang.Object[1];
            java.lang.Throwable cause2 = e17.getCause();
            objArr2[0] = cause2 != null ? cause2.getMessage() : null;
            com.tencent.mars.xlog.Log.printErrStackTrace("LiteAppWxPayUtil", e17, "decryptData error:", objArr2);
            throw e17;
        } catch (java.lang.Exception e18) {
            com.tencent.mars.xlog.Log.e("LiteAppWxPayUtil", "decryptData error: " + e18.getMessage());
            com.tencent.mars.xlog.Log.printErrStackTrace("LiteAppWxPayUtil", e18, "decryptData error:", e18.getMessage());
            throw e18;
        }
    }
    ...
    public final void d(java.security.KeyStore keyStore, java.lang.String str) {
        ...
        com.tencent.mars.xlog.Log.e("LiteAppWxPayUtil", "The keyId is not exist: " + str);
