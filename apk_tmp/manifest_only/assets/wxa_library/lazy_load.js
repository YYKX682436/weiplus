;if (this.NativeGlobal && this.NativeGlobal.initModule) {
    ...
    lazyLoadModels.push(new LazyLoadModel(that.NativeGlobal, 'XInference'));
    lazyLoadModels.push(new LazyLoadModel(that.NativeGlobal, 'Puppet'));
    lazyLoadModels.push(new LazyLoadModel(that.NativeGlobal, 'GameAccelerator'));
