...
if (typeof wx !== 'undefined') {
  if (typeof wxNative === 'undefined') {
    ...
    wxNative = (function () {
      ...
      var _startBindPhone = function (args) {
        _invokeMethod("startBindPhone", args);
      };

      var _openBizPublishImage = function (args) {
        _invokeMethod("openBizPublishImage", args);
      };
      ...
      var _callLiteAppConnectEvent = function(args) {
        _invokeMethod("callLiteAppConnectEvent", args);
      }

      var _dispatchLiteAppAction = function(args) {
        _invokeMethod("dispatchLiteAppAction", args);
      }
      ...
      var _privateOpenServiceNotifyChat = function(args) {
        _invokeMethod("privateOpenServiceNotifyChat", args);
      }

      var _privateGetProfileConfig = function(args) {
        _invokeMethod("privateGetProfileConfig", args);
      }
      ...
      var _chooseBizPoi = function (args) {
         _invokeMethod("chooseBizPoi", args);
      };

      var _startWebSearch = function(args) {
        _invokeMethod("startWebSearch", args);
      };

      var _preloadWebSearchPage = function(args) {
        _invokeMethod("preloadWebSearchPage", args);
      };

      var _startCircleToSearch = function (args) {
        _invokeMethod("startCircleToSearch", args);
      };

      var _openCameraForImageSearch = function (args) {
        _invokeMethod("openCameraForImageSearch", args);
      };

      var _handleEcsActionSync = function (args) {
         _invokeMethod("handleEcsActionSync", args);
      };

      var _bizChooseImage = function (args) {
         _invokeMethod("bizChooseImage", args);
      };

      var _openWCPaySpecificView = function(args) {
         _invokeMethod("openWCPaySpecificView", args);
      };

      var _setHalfScreenState = function(args) {
        _invokeMethod("setHalfScreenState", args);
      };
      /**** Add JsApi Here ****/
      ...
      var methodsList = {
        ...
        startBindPhone: _startBindPhone,
        openBizPublishImage: _openBizPublishImage,
        ...
        callLiteAppConnectEvent: _callLiteAppConnectEvent,
        dispatchLiteAppAction: _dispatchLiteAppAction,
        ...
        privateOpenServiceNotifyChat: _privateOpenServiceNotifyChat,
        privateGetProfileConfig: _privateGetProfileConfig,
        showSmileyPanel: _showSmileyPanel,
        chooseBizPoi: _chooseBizPoi,
        startWebSearch: _startWebSearch,
        preloadWebSearchPage: _preloadWebSearchPage,
        startCircleToSearch: _startCircleToSearch,
        openCameraForImageSearch: _openCameraForImageSearch,
        handleEcsActionSync: _handleEcsActionSync,
        bizChooseImage: _bizChooseImage,
        openWCPaySpecificView: _openWCPaySpecificView,
        setHalfScreenState: _setHalfScreenState,
      };
      /**** Add JsApiEvent Here ****/
